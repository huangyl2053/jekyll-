...
//import jp.co.ndensan.reams.db.dba.persistence.basic.helper.DbT1001HihokenshaDaichoEntityMock;
...
//            int count = sut.insert(DbT1001HihokenshaDaichoEntityMock.getSpiedInstance(new RString("1"), new RString("1"), new RString("1")));
...
//            sut.insert(DbT1001HihokenshaDaichoEntityMock.getSpiedInstance(市町村コード, 被保険者番号, 識別コード));
//            sut.insert(DbT1001HihokenshaDaichoEntityMock.getSpiedInstance(市町村コード, new RString("002"), new RString("2")));
//        }
//
//        @Test
//        public void 市町村コードと被保険者番号から検索したとき_同じ値の市町村コードと被保険者番号をもったデータが取得できる() {
//            DbT1001HihokenshaDaichoEntity selected = sut.select(
...
//        @Override
//        protected void setUp() {
//            sut.insert(DbT1001HihokenshaDaichoEntityMock.getSpiedInstance(かぶった市町村コード, かぶった被保険者番号, かぶった識別コード));
//            sut.insert(DbT1001HihokenshaDaichoEntityMock.getSpiedInstance(new RString("bbbb"), かぶった被保険者番号, new RString("22")));
//            sut.insert(DbT1001HihokenshaDaichoEntityMock.getSpiedInstance(かぶった市町村コード, new RString("0003"), かぶった識別コード));
//        }
//
//        @Test
//        public void 複数件該当する被保険者番号で検索したとき_結果は2件() {
//            List<DbT1001HihokenshaDaichoEntity> result = sut.select(
...
//        @Override
//        protected void setUp() {
//            sut.insert(DbT1001HihokenshaDaichoEntityMock.getSpiedInstance(市町村コード, 被保険者番号, new RString("1")));
//            sut.insert(DbT1001HihokenshaDaichoEntityMock.getSpiedInstance(市町村コード, new RString("002"), new RString("2")));
//        }
//
//        @Test
//        public void 取得したデータの資格喪失年月日を変更してupdateしたとき_資格喪失年月日が変更される() {
//            DbT1001HihokenshaDaichoEntity before = sut.select(
...
//            sut.update(before);
//
//            DbT1001HihokenshaDaichoEntity updated = sut.select(
//                    new ShichosonCode(市町村コード), new KaigoHihokenshaNumber(被保険者番号));
//            assertThat(updated.getShikakuSoshitsuDate(), is(資格喪失年月日));
//        }
//
//        @Test
//        public void 存在しない行をupdateをしたとき_返り値は0() {
//            DbT1001HihokenshaDaichoEntity 存在しない行 = sut.select(
//                    new ShichosonCode(市町村コード), new KaigoHihokenshaNumber(new RString("003")));
//
//            int result = sut.update(存在しない行);
//
...
//            DbT1001HihokenshaDaichoEntity entity = sut.select(
//                    new ShichosonCode(市町村コード), new KaigoHihokenshaNumber(被保険者番号));
//
...
//            sut.delete(entity);
//
//            DbT1001HihokenshaDaichoEntity deleted = sut.select(
//                    new ShichosonCode(市町村コード), new KaigoHihokenshaNumber(被保険者番号));
...
//                    DbT1001HihokenshaDaichoEntityMock.getSpiedInstance(new RString("市町村コード"), new RString("被保険者番号"), new RString("識別コード"));
//            int count = sut.delete(entity);
...
//            DbT1001HihokenshaDaichoEntity entity =
//                    DbT1001HihokenshaDaichoEntityMock.getSpiedInstance(市町村コード, 新しい被保険者番号, new RString("新識別コード"));
//
//            sut.insertOrUpdate(entity);
//
//            DbT1001HihokenshaDaichoEntity selected = sut.select(
