...
public class BbKakuteiShinkokuDataCsvEntity {

    @FldField (order = 10, length = 6)
    private RString 市町村コード１;
    @FldField (order = 20, length = 4)
    ...
    @FldField (order = 170, length = 5, align = Align.Left, paddingChar = "0")
    ...
    @FldField (order = 200, length = 5)
    private RString 特別徴収収入額_３月;
    @FldField (order = 210, length = 5, align = Align.Left, paddingChar = "0")
    ...
    @FldField (order = 240, length = 5)
    private RString 特別徴収収入額_５月;
    @FldField (order = 250, length = 5, align = Align.Left, paddingChar = "0")
    ...
    @FldField (order = 280, length = 5)
    private RString 特別徴収収入額_７月;
    @FldField (order = 290, length = 5, align = Align.Left, paddingChar = "0")
    ...
    @FldField (order = 320, length = 5)
    private RString 特別徴収収入額_９月;
    @FldField (order = 330, length = 5, align = Align.Left, paddingChar = "0")
    ...
    @FldField (order = 360, length = 5)
    private RString 特別徴収収入額_１１月;
    @FldField (order = 370, length = 5, align = Align.Left, paddingChar = "0")
    ...
    @FldField (order = 690, length = 24, align = Align.Left, paddingChar = " ")
    private RString 予備;
    @FldField (order = 700, length = 14, align = Align.Left, paddingChar = "0")
