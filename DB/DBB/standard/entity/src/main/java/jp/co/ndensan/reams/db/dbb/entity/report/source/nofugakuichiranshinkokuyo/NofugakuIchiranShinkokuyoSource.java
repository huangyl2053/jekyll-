 ...
 */
package jp.co.ndensan.reams.db.dbb.entity.report.source.nofugakuichiranshinkokuyo;
...
/**
 * 帳票設計_DBBRP91003-1_納付額一覧表（確定申告用）のソースクラスです。
 *
 * @reamsid_L DBB-1890-040 qinzhen
 */
public class NofugakuIchiranShinkokuyoSource implements IReportSource {
