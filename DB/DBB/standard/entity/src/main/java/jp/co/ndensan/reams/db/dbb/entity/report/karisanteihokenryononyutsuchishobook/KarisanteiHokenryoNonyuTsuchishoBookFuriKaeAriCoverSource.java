...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    // <DBB100020_KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCover.rse>
    ...
    @ReportItem(name = "cover_hyojicode1", length = 11, order = 8)
    public RString hyojicode1;
    @ReportItem(name = "cover_hyojicode2", length = 9, order = 9)
    public RString hyojicode2;
    @ReportItem(name = "cover_hyojicode3", length = 9, order = 10)
    public RString hyojicode3;
    @ReportItem(name = "cover_keisanMeisaishoKi1", length = 2, order = 11)
    public RString keisanMeisaishoKi1;
    @ReportItem(name = "cover_keisanMeisaishoNokigenKaishi1", length = 11, order = 12)
    public RString keisanMeisaishoNokigenKaishi1;
    @ReportItem(name = "cover_listList1_1", length = 1, order = 13)
    ...
    @ReportItem(name = "cover_tsuchoNo", order = 24)
    ...
    @ReportItem(name = "cover_kozaNo", length = 13, order = 37)
    ...
    @ReportItem(name = "cover_kozaIraishoRightJusho", order = 66)
    ...
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuGaku1", length = 10, order = 68)
    public RString nokibetsuMeisaishoTokuchoNofuGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuZumiGaku1", length = 10, order = 69)
    public RString nokibetsuMeisaishoTokuchoNofuZumiGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoSaGaku1", length = 10, order = 70)
    public RString nokibetsuMeisaishoTokuchoSaGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoTsuchishoNo", order = 71)
    public RString nokibetsuMeisaishoTsuchishoNo;
    @ReportItem(name = "cover_nokibetsuMeisaishoSetaiCode", length = 15, order = 72)
    public RString nokibetsuMeisaishoSetaiCode;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuGaku2", length = 10, order = 73)
    public RString nokibetsuMeisaishoTokuchoNofuGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuZumiGaku2", length = 10, order = 74)
    public RString nokibetsuMeisaishoTokuchoNofuZumiGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoSaGaku2", length = 10, order = 75)
    public RString nokibetsuMeisaishoTokuchoSaGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoHohokenshaName", order = 76)
    ...
    @ReportItem(name = "cover_kozaIraishoLeftHihokenshaName", order = 78)
    public RString kozaIraishoLeftHihokenshaName;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuGaku3", length = 10, order = 79)
    public RString nokibetsuMeisaishoTokuchoNofuGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuZumiGaku3", length = 10, order = 80)
    public RString nokibetsuMeisaishoTokuchoNofuZumiGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoSaGaku3", length = 10, order = 81)
    public RString nokibetsuMeisaishoTokuchoSaGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuGaku4", length = 10, order = 82)
    public RString nokibetsuMeisaishoTokuchoNofuGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuZumiGaku4", length = 10, order = 83)
    public RString nokibetsuMeisaishoTokuchoNofuZumiGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoSaGaku4", length = 10, order = 84)
    public RString nokibetsuMeisaishoTokuchoSaGaku4;
    @ReportItem(name = "cover_kozaIraishoLeftShikibetsuCode", length = 15, order = 85)
    public RString kozaIraishoLeftShikibetsuCode;
    @ReportItem(name = "cover_kozaIraishoRightShikibetsuCode", length = 15, order = 86)
    public RString kozaIraishoRightShikibetsuCode;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi1", length = 4, order = 87)
    public RString nokibetsuMeisaishoKi1;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku1", length = 10, order = 88)
    public RString nokibetsuMeisaishoFuchoNofuGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku1", length = 10, order = 89)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku1", length = 10, order = 90)
    public RString nokibetsuMeisaishoFuchoSaGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen1", length = 11, order = 91)
    public RString nokibetsuMeisaishoNokigen1;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi2", length = 4, order = 92)
    public RString nokibetsuMeisaishoKi2;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku2", length = 10, order = 93)
    public RString nokibetsuMeisaishoFuchoNofuGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku2", length = 10, order = 94)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku2", length = 10, order = 95)
    public RString nokibetsuMeisaishoFuchoSaGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen2", length = 11, order = 96)
    public RString nokibetsuMeisaishoNokigen2;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi3", length = 4, order = 97)
    public RString nokibetsuMeisaishoKi3;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku3", length = 10, order = 98)
    public RString nokibetsuMeisaishoFuchoNofuGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku3", length = 10, order = 99)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku3", length = 10, order = 100)
    public RString nokibetsuMeisaishoFuchoSaGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen3", length = 11, order = 101)
    public RString nokibetsuMeisaishoNokigen3;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi4", length = 4, order = 102)
    public RString nokibetsuMeisaishoKi4;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku4", length = 10, order = 103)
    public RString nokibetsuMeisaishoFuchoNofuGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku4", length = 10, order = 104)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku4", length = 10, order = 105)
    public RString nokibetsuMeisaishoFuchoSaGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen4", length = 11, order = 106)
    public RString nokibetsuMeisaishoNokigen4;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi5", length = 4, order = 107)
    public RString nokibetsuMeisaishoKi5;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku5", length = 10, order = 108)
    public RString nokibetsuMeisaishoFuchoNofuGaku5;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku5", length = 10, order = 109)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku5;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku5", length = 10, order = 110)
    public RString nokibetsuMeisaishoFuchoSaGaku5;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen5", length = 11, order = 111)
    public RString nokibetsuMeisaishoNokigen5;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi6", length = 4, order = 112)
    public RString nokibetsuMeisaishoKi6;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku6", length = 10, order = 113)
    public RString nokibetsuMeisaishoFuchoNofuGaku6;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku6", length = 10, order = 114)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku6;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku6", length = 10, order = 115)
    public RString nokibetsuMeisaishoFuchoSaGaku6;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen6", length = 11, order = 116)
    public RString nokibetsuMeisaishoNokigen6;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku7", length = 10, order = 117)
    public RString nokibetsuMeisaishoFuchoNofuGaku7;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku7", length = 10, order = 118)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku7;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku7", length = 10, order = 119)
    public RString nokibetsuMeisaishoFuchoSaGaku7;
    @ReportItem(name = "cover_renban", length = 10, order = 120)
    public RString renban;
    @ReportItem(name = "cover_hokenshaName", length = 10, order = 121)
    public RString hokenshaName;
    @ReportItem(name = "cover_pagerenban3", length = 10, order = 122)
    public RString pagerenban3;
    @ReportItem(name = "cover_pagerenban4", length = 10, order = 123)
    public RString pagerenban4;
    @ReportItem(name = "cover_yubinNo1", length = 8, order = 124)
    public RString yubinNo1;
    @ReportItem(name = "cover_gyoseiku1", length = 14, order = 125)
    public RString gyoseiku1;
    @ReportItem(name = "cover_jusho3", length = 20, order = 126)
    public RString jusho3;
    @ReportItem(name = "cover_jushoText", order = 127)
    public RString jushoText;
    @ReportItem(name = "cover_jusho1", length = 20, order = 128)
    public RString jusho1;
    @ReportItem(name = "cover_jusho2", length = 20, order = 129)
    public RString jusho2;
    @ReportItem(name = "cover_katagakiText", order = 130)
    public RString katagakiText;
    @ReportItem(name = "cover_katagaki2", length = 20, order = 131)
    public RString katagaki2;
    @ReportItem(name = "cover_katagakiSmall2", length = 30, order = 132)
    public RString katagakiSmall2;
    @ReportItem(name = "cover_katagaki1", length = 20, order = 133)
    public RString katagaki1;
    @ReportItem(name = "cover_katagakiSmall1", length = 30, order = 134)
    public RString katagakiSmall1;
    @ReportItem(name = "cover_shimei2", length = 20, order = 135)
    public RString shimei2;
    @ReportItem(name = "cover_shimeiSmall2", length = 40, order = 136)
    public RString shimeiSmall2;
    @ReportItem(name = "cover_shimeiText", order = 137)
    public RString shimeiText;
    @ReportItem(name = "cover_meishoFuyo2", length = 3, order = 138)
    public RString meishoFuyo2;
    @ReportItem(name = "cover_shimeiSmall1", length = 40, order = 139)
    public RString shimeiSmall1;
    @ReportItem(name = "cover_dainoKubunMei", length = 8, order = 140)
    public RString dainoKubunMei;
    @ReportItem(name = "cover_shimei1", length = 20, order = 141)
    public RString shimei1;
    @ReportItem(name = "cover_meishoFuyo1", length = 3, order = 142)
    public RString meishoFuyo1;
    @ReportItem(name = "cover_samabunShimeiText", order = 143)
    public RString samabunShimeiText;
    @ReportItem(name = "cover_samaBun2", length = 3, order = 144)
    public RString samaBun2;
    @ReportItem(name = "cover_samabunShimeiSmall2", length = 40, order = 145)
    public RString samabunShimeiSmall2;
    @ReportItem(name = "cover_kakkoLeft2", length = 1, order = 146)
    public RString kakkoLeft2;
    @ReportItem(name = "cover_samabunShimei2", length = 20, order = 147)
    public RString samabunShimei2;
    @ReportItem(name = "cover_kakkoRight2", length = 1, order = 148)
    public RString kakkoRight2;
    @ReportItem(name = "cover_kakkoLeft1", length = 1, order = 149)
    public RString kakkoLeft1;
    @ReportItem(name = "cover_samabunShimei1", length = 20, order = 150)
    public RString samabunShimei1;
    @ReportItem(name = "cover_samaBun1", length = 3, order = 151)
    public RString samaBun1;
    @ReportItem(name = "cover_kakkoRight1", length = 1, order = 152)
    public RString kakkoRight1;
    @ReportItem(name = "cover_samabunShimeiSmall1", length = 40, order = 153)
    public RString samabunShimeiSmall1;
    @ReportItem(name = "cover_customerBarCode", order = 154)
    public RString customerBarCode;
    @ReportItem(name = "cover_denshiKoin", order = 155)
    public RString denshiKoin;
    @ReportItem(name = "cover_hakkoYMD", length = 12, order = 156)
    public RString hakkoYMD;
    @ReportItem(name = "cover_koinMojiretsu", length = 4, order = 157)
    public RString koinMojiretsu;
    @ReportItem(name = "cover_ninshoshaShimeiKakenai", order = 158)
    public RString ninshoshaShimeiKakenai;
    @ReportItem(name = "cover_ninshoshaShimeiKakeru", order = 159)
    public RString ninshoshaShimeiKakeru;
    @ReportItem(name = "cover_ninshoshaYakushokuMei", length = 15, order = 160)
    public RString ninshoshaYakushokuMei;
    @ReportItem(name = "cover_koinShoryaku", length = 15, order = 161)
