...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    // <DBB100022_KarisanteiNonyuTsuchishoBookFuriKaeAriRenchoCover.rse>
    ...
    @ReportItem(name = "cover_kaisanMeisaishoHihokenshaName", order = 6)
    public RString kaisanMeisaishoHihokenshaName;
    @ReportItem(name = "cover_kaisanMeisaishoSetaiNushiName", order = 7)
    public RString kaisanMeisaishoSetaiNushiName;
    @ReportItem(name = "cover_listList1_1", length = 1, order = 8)
    public RString listList1_1;
    @ReportItem(name = "cover_keisanMeisaishoTsuchishoNo", order = 9)
    public RString keisanMeisaishoTsuchishoNo;
    @ReportItem(name = "cover_keisanMeisaishoSetaiCode", length = 15, order = 10)
    public RString keisanMeisaishoSetaiCode;
    @ReportItem(name = "cover_Hyojicode1", length = 11, order = 11)
    public RString hyojicode1;
    @ReportItem(name = "cover_Hyojicode2", length = 9, order = 12)
    public RString hyojicode2;
    @ReportItem(name = "cover_Hyojicode3", length = 9, order = 13)
    public RString hyojicode3;
    @ReportItem(name = "cover_keisanMeisaishoKi1", length = 2, order = 14)
    public RString keisanMeisaishoKi1;
    @ReportItem(name = "cover_keisanMeisaishoNokigenKaishi1", length = 11, order = 15)
    ...
    @ReportItem(name = "cover_noutsuRenban", length = 8, order = 56)
    ...
    @ReportItem(name = "cover_kozaIraishoLeftJusho", order = 67)
    public RString kozaIraishoLeftJusho;
    @ReportItem(name = "cover_kozaIraishoRightJusho", order = 68)
    public RString kozaIraishoRightJusho;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuGaku1", length = 10, order = 69)
    public RString nokibetsuMeisaishoTokuchoNofuGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuZumiGaku1", length = 10, order = 70)
    public RString nokibetsuMeisaishoTokuchoNofuZumiGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoSaGaku1", length = 10, order = 71)
    public RString nokibetsuMeisaishoTokuchoSaGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoTsuchishoNo", order = 72)
    public RString nokibetsuMeisaishoTsuchishoNo;
    @ReportItem(name = "cover_nokibetsuMeisaishoSetaiCode", length = 15, order = 73)
    public RString nokibetsuMeisaishoSetaiCode;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuGaku2", length = 10, order = 74)
    public RString nokibetsuMeisaishoTokuchoNofuGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuZumiGaku2", length = 10, order = 75)
    public RString nokibetsuMeisaishoTokuchoNofuZumiGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoSaGaku2", length = 10, order = 76)
    public RString nokibetsuMeisaishoTokuchoSaGaku2;
    @ReportItem(name = "cover_kozaIraishoRightHihokenshaName", order = 77)
    ...
    @ReportItem(name = "cover_kozaIraishoLeftHihokenshaName", order = 79)
    public RString kozaIraishoLeftHihokenshaName;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuGaku3", length = 10, order = 80)
    public RString nokibetsuMeisaishoTokuchoNofuGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuZumiGaku3", length = 10, order = 81)
    public RString nokibetsuMeisaishoTokuchoNofuZumiGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoSaGaku3", length = 10, order = 82)
    public RString nokibetsuMeisaishoTokuchoSaGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuGaku4", length = 10, order = 83)
    public RString nokibetsuMeisaishoTokuchoNofuGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuZumiGaku4", length = 10, order = 84)
    public RString nokibetsuMeisaishoTokuchoNofuZumiGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoSaGaku4", length = 10, order = 85)
    public RString nokibetsuMeisaishoTokuchoSaGaku4;
    @ReportItem(name = "cover_kozaIraishoLeftShikibetsuCode", length = 15, order = 86)
    public RString kozaIraishoLeftShikibetsuCode;
    @ReportItem(name = "cover_kozaIraishoRightShikibetsuCode", length = 15, order = 87)
    public RString kozaIraishoRightShikibetsuCode;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi1", length = 4, order = 88)
    public RString nokibetsuMeisaishoKi1;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku1", length = 10, order = 89)
    public RString nokibetsuMeisaishoFuchoNofuGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku1", length = 10, order = 90)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku1", length = 10, order = 91)
    public RString nokibetsuMeisaishoFuchoSaGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen1", length = 11, order = 92)
    public RString nokibetsuMeisaishoNokigen1;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi2", length = 4, order = 93)
    public RString nokibetsuMeisaishoKi2;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku2", length = 10, order = 94)
    public RString nokibetsuMeisaishoFuchoNofuGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku2", length = 10, order = 95)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku2", length = 10, order = 96)
    public RString nokibetsuMeisaishoFuchoSaGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen2", length = 11, order = 97)
    public RString nokibetsuMeisaishoNokigen2;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi3", length = 4, order = 98)
    public RString nokibetsuMeisaishoKi3;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku3", length = 10, order = 99)
    public RString nokibetsuMeisaishoFuchoNofuGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku3", length = 10, order = 100)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku3", length = 10, order = 101)
    public RString nokibetsuMeisaishoFuchoSaGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen3", length = 11, order = 102)
    public RString nokibetsuMeisaishoNokigen3;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi4", length = 4, order = 103)
    public RString nokibetsuMeisaishoKi4;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku4", length = 10, order = 104)
    public RString nokibetsuMeisaishoFuchoNofuGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku4", length = 10, order = 105)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku4", length = 10, order = 106)
    public RString nokibetsuMeisaishoFuchoSaGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen4", length = 11, order = 107)
    public RString nokibetsuMeisaishoNokigen4;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi5", length = 4, order = 108)
    public RString nokibetsuMeisaishoKi5;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku5", length = 10, order = 109)
    public RString nokibetsuMeisaishoFuchoNofuGaku5;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku5", length = 10, order = 110)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku5;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku5", length = 10, order = 111)
    public RString nokibetsuMeisaishoFuchoSaGaku5;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen5", length = 11, order = 112)
    public RString nokibetsuMeisaishoNokigen5;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi6", length = 4, order = 113)
    public RString nokibetsuMeisaishoKi6;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku6", length = 10, order = 114)
    public RString nokibetsuMeisaishoFuchoNofuGaku6;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku6", length = 10, order = 115)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku6;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku6", length = 10, order = 116)
    public RString nokibetsuMeisaishoFuchoSaGaku6;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen6", length = 11, order = 117)
    public RString nokibetsuMeisaishoNokigen6;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku7", length = 10, order = 118)
    public RString nokibetsuMeisaishoFuchoNofuGaku7;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku7", length = 10, order = 119)
    public RString nokibetsuMeisaishoFuchoNofuZumiGaku7;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku7", length = 10, order = 120)
    public RString nokibetsuMeisaishoFuchoSaGaku7;
    @ReportItem(name = "cover_pagerenban3", length = 10, order = 121)
    public RString pagerenban3;
    @ReportItem(name = "cover_pagerenban4", length = 10, order = 122)
    public RString pagerenban4;
    @ReportItem(name = "cover_denshiKoin", order = 123)
    public RString denshiKoin;
    @ReportItem(name = "cover_hakkoYMD", length = 12, order = 124)
    public RString hakkoYMD;
    @ReportItem(name = "cover_ninshoshaYakushokuMei", length = 15, order = 125)
    public RString ninshoshaYakushokuMei;
    @ReportItem(name = "cover_ninshoshaYakushokuMei1", order = 126)
    public RString ninshoshaYakushokuMei1;
    @ReportItem(name = "cover_koinMojiretsu", length = 4, order = 127)
    public RString koinMojiretsu;
    @ReportItem(name = "cover_ninshoshaYakushokuMei2", order = 128)
    public RString ninshoshaYakushokuMei2;
    @ReportItem(name = "cover_ninshoshaShimeiKakenai", order = 129)
    public RString ninshoshaShimeiKakenai;
    @ReportItem(name = "cover_ninshoshaShimeiKakeru", order = 130)
    public RString ninshoshaShimeiKakeru;
    @ReportItem(name = "cover_koinShoryaku", length = 15, order = 131)
    public RString koinShoryaku;
    @ReportItem(name = "cover_yubinNo", length = 8, order = 132)
    public RString yubinNo;
    @ReportItem(name = "cover_gyoseiku", length = 14, order = 133)
    public RString gyoseiku;
    @ReportItem(name = "cover_jusho3", length = 20, order = 134)
    public RString jusho3;
    @ReportItem(name = "cover_jushoText", order = 135)
    public RString jushoText;
    @ReportItem(name = "cover_jusho1", length = 20, order = 136)
    public RString jusho1;
    @ReportItem(name = "cover_jusho2", length = 20, order = 137)
    public RString jusho2;
    @ReportItem(name = "cover_katagakiText", order = 138)
    public RString katagakiText;
    @ReportItem(name = "cover_katagaki2", length = 20, order = 139)
    public RString katagaki2;
    @ReportItem(name = "cover_katagakiSmall2", length = 30, order = 140)
    public RString katagakiSmall2;
    @ReportItem(name = "cover_katagaki1", length = 20, order = 141)
    public RString katagaki1;
    @ReportItem(name = "cover_katagakiSmall1", length = 30, order = 142)
    public RString katagakiSmall1;
    @ReportItem(name = "cover_shimei2", length = 20, order = 143)
    public RString shimei2;
    @ReportItem(name = "cover_shimeiSmall2", length = 40, order = 144)
    public RString shimeiSmall2;
    @ReportItem(name = "cover_shimeiText", order = 145)
    public RString shimeiText;
    @ReportItem(name = "cover_meishoFuyo2", length = 3, order = 146)
    public RString meishoFuyo2;
    @ReportItem(name = "cover_shimeiSmall1", length = 40, order = 147)
    public RString shimeiSmall1;
    @ReportItem(name = "cover_dainoKubunMei", length = 8, order = 148)
    public RString dainoKubunMei;
    @ReportItem(name = "cover_shimei1", length = 20, order = 149)
    public RString shimei1;
    @ReportItem(name = "cover_meishoFuyo1", length = 3, order = 150)
    public RString meishoFuyo1;
    @ReportItem(name = "cover_samabunShimeiText", order = 151)
    public RString samabunShimeiText;
    @ReportItem(name = "cover_samaBun2", length = 3, order = 152)
    public RString samaBun2;
    @ReportItem(name = "cover_samabunShimeiSmall2", length = 40, order = 153)
    public RString samabunShimeiSmall2;
    @ReportItem(name = "cover_kakkoLeft2", length = 1, order = 154)
    public RString kakkoLeft2;
    @ReportItem(name = "cover_samabunShimei2", length = 20, order = 155)
    public RString samabunShimei2;
    @ReportItem(name = "cover_kakkoRight2", length = 1, order = 156)
    public RString kakkoRight2;
    @ReportItem(name = "cover_kakkoLeft1", length = 1, order = 157)
    public RString kakkoLeft1;
    @ReportItem(name = "cover_samabunShimei1", length = 20, order = 158)
    public RString samabunShimei1;
    @ReportItem(name = "cover_samaBun1", length = 3, order = 159)
    public RString samaBun1;
    @ReportItem(name = "cover_kakkoRight1", length = 1, order = 160)
    public RString kakkoRight1;
    @ReportItem(name = "cover_samabunShimeiSmall1", length = 40, order = 161)
    public RString samabunShimeiSmall1;
    @ReportItem(name = "cover_customerBarCode", order = 162)
