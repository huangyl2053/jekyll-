...
public class DE940200DatEntity {

    @FldField (order = 10, length = 6)
    ...
    @FldField (order = 150, length = 6)
    private RString 特別徴収調定額_１月;
    @FldField (order = 160, length = 6)
    private RString 特別徴収調定額_２月;
    @FldField (order = 170, length = 6)
    private RString 特別徴収調定額_３月;
    @FldField (order = 180, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収調定額_４月;
    @FldField (order = 190, length = 6)
    private RString 特別徴収調定額_５月;
    @FldField (order = 200, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収調定額_６月;
    @FldField (order = 210, length = 6)
    private RString 特別徴収調定額_７月;
    @FldField (order = 220, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収調定額_８月;
    @FldField (order = 230, length = 6)
    private RString 特別徴収調定額_９月;
    @FldField (order = 240, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収調定額_１０月;
    @FldField (order = 250, length = 6)
    private RString 特別徴収調定額_１１月;
    @FldField (order = 260, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収調定額_１２月;
    @FldField (order = 270, length = 6)
    private RString 特別徴収収入額_１月;
    @FldField (order = 280, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収収入額_２月;
    @FldField (order = 290, length = 6)
    private RString 特別徴収収入額_３月;
    @FldField (order = 300, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収収入額_４月;
    @FldField (order = 310, length = 6)
    private RString 特別徴収収入額_５月;
    @FldField (order = 320, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収収入額_６月;
    @FldField (order = 330, length = 6)
    private RString 特別徴収収入額_７月;
    @FldField (order = 340, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収収入額_８月;
    @FldField (order = 350, length = 6)
    private RString 特別徴収収入額_９月;
    @FldField (order = 360, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収収入額_１０月;
    @FldField (order = 370, length = 6)
    private RString 特別徴収収入額_１１月;
    @FldField (order = 380, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収収入額_１２月;
    @FldField (order = 390, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収過年度分調定額;
    @FldField (order = 400, length = 6, align = Align.Left, paddingChar = "0")
    private RString 特別徴収過年度分収入額;
    @FldField (order = 410, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収調定額_１月;
    @FldField (order = 420, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収調定額_２月;
    @FldField (order = 430, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収調定額_３月;
    @FldField (order = 440, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収調定額_４月;
    @FldField (order = 450, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収調定額_５月;
    @FldField (order = 460, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収調定額_６月;
    @FldField (order = 470, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収調定額_７月;
    @FldField (order = 480, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収調定額_８月;
    @FldField (order = 490, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収調定額_９月;
    @FldField (order = 500, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収調定額_１０月;
    @FldField (order = 510, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収調定額_１１月;
    @FldField (order = 520, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収調定額_１２月;
    @FldField (order = 530, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収収入額_１月;
    @FldField (order = 540, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収収入額_２月;
    @FldField (order = 550, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収収入額_３月;
    @FldField (order = 560, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収収入額_４月;
    @FldField (order = 570, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収収入額_５月;
    @FldField (order = 580, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収収入額_６月;
    @FldField (order = 590, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収収入額_７月;
    @FldField (order = 600, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収収入額_８月;
    @FldField (order = 610, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収収入額_９月;
    @FldField (order = 620, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収収入額_１０月;
    @FldField (order = 630, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収収入額_１１月;
    @FldField (order = 640, length = 6, align = Align.Left, paddingChar = "0")
    private RString 普通徴収収入額_１２月;
    @FldField (order = 650, length = 6)
    private RString 普通徴収過年度分調定額;
    @FldField (order = 660, length = 6, align = Align.Left, paddingChar = "0")
