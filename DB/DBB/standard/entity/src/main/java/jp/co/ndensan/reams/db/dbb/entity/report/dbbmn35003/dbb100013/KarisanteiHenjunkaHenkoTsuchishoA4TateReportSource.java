package jp.co.ndensan.reams.db.dbb.entity.report.dbbmn35003.dbb100013;
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "page", length = 7, order = 48)
    public RString page;
    @ReportItem(name = "yubinNo1", length = 8, order = 49)
    public RString yubinNo1;
    @ReportItem(name = "gyoseiku1", length = 14, order = 50)
    public RString gyoseiku1;
    @ReportItem(name = "jusho3", length = 20, order = 51)
    public RString jusho3;
    @ReportItem(name = "jushoText", order = 52)
    public RString jushoText;
    @ReportItem(name = "jusho1", length = 20, order = 53)
    public RString jusho1;
    @ReportItem(name = "jusho2", length = 20, order = 54)
    public RString jusho2;
    @ReportItem(name = "katagakiText", order = 55)
    public RString katagakiText;
    @ReportItem(name = "katagaki2", length = 20, order = 56)
    public RString katagaki2;
    @ReportItem(name = "katagakiSmall2", length = 30, order = 57)
    public RString katagakiSmall2;
    @ReportItem(name = "katagaki1", length = 20, order = 58)
    public RString katagaki1;
    @ReportItem(name = "katagakiSmall1", length = 30, order = 59)
    public RString katagakiSmall1;
    @ReportItem(name = "shimei2", length = 20, order = 60)
    public RString shimei2;
    @ReportItem(name = "shimeiSmall2", length = 40, order = 61)
    public RString shimeiSmall2;
    @ReportItem(name = "shimeiText", order = 62)
    public RString shimeiText;
    @ReportItem(name = "meishoFuyo2", length = 3, order = 63)
    public RString meishoFuyo2;
    @ReportItem(name = "shimeiSmall1", length = 40, order = 64)
    public RString shimeiSmall1;
    @ReportItem(name = "dainoKubunMei", length = 8, order = 65)
    public RString dainoKubunMei;
    @ReportItem(name = "shimei1", length = 20, order = 66)
    public RString shimei1;
    @ReportItem(name = "meishoFuyo1", length = 3, order = 67)
    public RString meishoFuyo1;
    @ReportItem(name = "samabunShimeiText", order = 68)
    public RString samabunShimeiText;
    @ReportItem(name = "samaBun2", length = 3, order = 69)
    public RString samaBun2;
    @ReportItem(name = "samabunShimeiSmall2", length = 40, order = 70)
    public RString samabunShimeiSmall2;
    @ReportItem(name = "kakkoLeft2", length = 1, order = 71)
    public RString kakkoLeft2;
    @ReportItem(name = "samabunShimei2", length = 20, order = 72)
    public RString samabunShimei2;
    @ReportItem(name = "kakkoRight2", length = 1, order = 73)
    public RString kakkoRight2;
    @ReportItem(name = "kakkoLeft1", length = 1, order = 74)
    public RString kakkoLeft1;
    @ReportItem(name = "samabunShimei1", length = 20, order = 75)
    public RString samabunShimei1;
    @ReportItem(name = "samaBun1", length = 3, order = 76)
    public RString samaBun1;
    @ReportItem(name = "kakkoRight1", length = 1, order = 77)
    public RString kakkoRight1;
    @ReportItem(name = "samabunShimeiSmall1", length = 40, order = 78)
    public RString samabunShimeiSmall1;
    @ReportItem(name = "customerBarCode", order = 79)
    public RString customerBarCode;
    @ReportItem(name = "denshiKoin", order = 80)
    public RString denshiKoin;
    @ReportItem(name = "hakkoYMD", length = 12, order = 81)
    public RString hakkoYMD;
    @ReportItem(name = "ninshoshaYakushokuMei", length = 15, order = 82)
    public RString ninshoshaYakushokuMei;
    @ReportItem(name = "koinMojiretsu", length = 4, order = 83)
    public RString koinMojiretsu;
    @ReportItem(name = "ninshoshaShimeiKakeru", order = 84)
    public RString ninshoshaShimeiKakeru;
    @ReportItem(name = "ninshoshaShimeiKakenai", order = 85)
    public RString ninshoshaShimeiKakenai;
    @ReportItem(name = "koinShoryaku", length = 15, order = 86)
    public RString koinShoryaku;
    @ReportItem(name = "yubinBango", length = 8, order = 87)
    public RString yubinBango;
    @ReportItem(name = "shozaichi", order = 88)
    public RString shozaichi;
    @ReportItem(name = "tantoName", order = 89)
    public RString tantoName;
    @ReportItem(name = "choshaBushoName", order = 90)
    public RString choshaBushoName;
    @ReportItem(name = "naisenLabel", length = 4, order = 91)
    public RString naisenLabel;
    @ReportItem(name = "naisenNo", length = 20, order = 92)
