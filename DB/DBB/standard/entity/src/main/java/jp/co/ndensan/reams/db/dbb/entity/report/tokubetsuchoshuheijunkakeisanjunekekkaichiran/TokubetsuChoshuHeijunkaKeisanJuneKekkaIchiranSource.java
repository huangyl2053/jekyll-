package jp.co.ndensan.reams.db.dbb.entity.report.tokubetsuchoshuheijunkakeisanjunekekkaichiran;
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listCenter_1", length = 2, order = 27)
    public RString listCenter_1;
    @ReportItem(name = "listCenter_2", length = 7, order = 28)
    public RString listCenter_2;
    @ReportItem(name = "listCenter_3", length = 7, order = 29)
    ...
    @ReportItem(name = "listLower_3", length = 11, order = 33)
    public RString listLower_3;
    @ReportItem(name = "listLower_4", length = 20, order = 34)
    public RString listLower_4;
    @ReportItem(name = "listLower_5", length = 20, order = 35)
    public RString listLower_5;
    @ReportItem(name = "listLower_6", length = 7, order = 36)
    public RString listLower_6;
    @ReportItem(name = "listLower_7", length = 7, order = 37)
    public RString listLower_7;
    @ReportItem(name = "listLower_8", length = 7, order = 38)
    public RString listLower_8;
    @ReportItem(name = "listLower_9", length = 7, order = 39)
    public RString listLower_9;
    @ReportItem(name = "listLower_10", length = 7, order = 40)
    public RString listLower_10;
    @ReportItem(name = "listLower_11", length = 7, order = 41)
