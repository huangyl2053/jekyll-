...
/**
 * バッチ設計_DBBBT22002_汎用リスト 所得情報NoRenbanCsvEntityのクラス
 *
...
public class HanyoListShotokuJohoNoRenbanCsvEntity {
    ...
    @CsvField(order = 410, name = "送付先氏名")
    private RString 送付先氏名;
    @CsvField(order = 420, name = "送付先氏名カナ")
    private RString 送付先氏名カナ;
    @CsvField(order = 430, name = "送付先住所コード")
    private RString 送付先住所コード;
    @CsvField(order = 440, name = "送付先郵便番号")
    private RString 送付先郵便番号;
    @CsvField(order = 450, name = "送付先住所番地方書")
    private RString 送付先住所番地方書;
    @CsvField(order = 460, name = "送付先住所")
    private RString 送付先住所;
    @CsvField(order = 470, name = "送付先番地")
    private RString 送付先番地;
    @CsvField(order = 480, name = "送付先方書")
    private RString 送付先方書;
    @CsvField(order = 490, name = "送付先行政区コード")
    private RString 送付先行政区コード;
    @CsvField(order = 500, name = "送付先行政区名")
    private RString 送付先行政区名;
    @CsvField(order = 510, name = "被保険者番号")
    private RString 被保険者番号;
    @CsvField(order = 520, name = "資格取得事由")
    private RString 資格取得事由;
    @CsvField(order = 530, name = "資格取得日")
    private RString 資格取得日;
    @CsvField(order = 540, name = "資格取得届出日")
    private RString 資格取得届出日;
    @CsvField(order = 550, name = "喪失事由")
    private RString 喪失事由;
    @CsvField(order = 560, name = "資格喪失日")
    private RString 資格喪失日;
    @CsvField(order = 570, name = "資格喪失届日")
    private RString 資格喪失届日;
    @CsvField(order = 580, name = "資格区分")
    private RString 資格区分;
    @CsvField(order = 590, name = "住所地特例状態")
    private RString 住所地特例状態;
    @CsvField(order = 600, name = "（資格）証記載保険者番号")
    private RString 資格証記載保険者番号;
    @CsvField(order = 610, name = "保険料段階")
    private RString 保険料段階;
    @CsvField(order = 620, name = "賦課年度")
    private RString 賦課年度;
    @CsvField(order = 630, name = "課税区分（減免前）")
    private RString 課税区分減免前;
    @CsvField(order = 640, name = "課税区分（減免後）")
    private RString 課税区分減免後;
    @CsvField(order = 650, name = "合計所得金額")
    private RString 合計所得金額;
    @CsvField(order = 660, name = "公的年金等収入")
    private RString 公的年金等収入;
    @CsvField(order = 670, name = "公的年金等所得")
    private RString 公的年金等所得;
    @CsvField(order = 680, name = "住民税更正日")
    private RString 住民税更正日;
    @CsvField(order = 690, name = "激変緩和区分")
