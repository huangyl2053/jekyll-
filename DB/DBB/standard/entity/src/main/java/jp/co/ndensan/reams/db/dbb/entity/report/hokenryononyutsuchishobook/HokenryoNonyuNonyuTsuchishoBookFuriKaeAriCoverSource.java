...
/**
 *
 * 保険料納入通知書（本算定）【ブックタイプ】納付書連帳 （口振依頼あり）通知書帳票Sourceです。
 *
 * @reamsid_L DBB-9110-010 huangh
 */
public class HokenryoNonyuNonyuTsuchishoBookFuriKaeAriCoverSource implements IReportSource {
    ...
    public RString cover_nokibetsuMeisaishoNendoBun;
