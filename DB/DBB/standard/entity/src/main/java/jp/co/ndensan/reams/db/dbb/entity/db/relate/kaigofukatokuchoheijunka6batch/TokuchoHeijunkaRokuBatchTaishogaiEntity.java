...
public final class TaishogaiEntity implements Cloneable, Serializable {
     ...
     * @param 備考コード RString
     */
    public TaishogaiEntity(RString 特別徴収義務者コード, FukaJohoRelateEntity 対象外データTemp,
