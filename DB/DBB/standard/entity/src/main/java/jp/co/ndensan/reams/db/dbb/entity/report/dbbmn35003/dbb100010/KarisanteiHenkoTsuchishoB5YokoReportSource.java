...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "kakkoLeft2", length = 1, order = 74)
    public RString kakkoLeft2;
    @ReportItem(name = "samabunShimei2", length = 20, order = 75)
    public RString samabunShimei2;
    @ReportItem(name = "kakkoRight2", length = 1, order = 76)
    public RString kakkoRight2;
    @ReportItem(name = "kakkoLeft1", length = 1, order = 77)
    public RString kakkoLeft1;
    @ReportItem(name = "samabunShimei1", length = 20, order = 78)
    public RString samabunShimei1;
    @ReportItem(name = "samaBun1", length = 3, order = 79)
    public RString samaBun1;
    @ReportItem(name = "kakkoRight1", length = 1, order = 80)
    ...
    @ReportItem(name = "naisenLabel", length = 4, order = 95)
