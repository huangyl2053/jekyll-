...
/**
 * 特別徴収開始通知書（本算定） シーラタイプ（連帳）帳票Source
 *
 * @reamsid_L DBB-0780-070 xuhao
 *
 */
public class TokubetsuChoshuKaishiTsuchishoSealerRenchoSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "nendo4", length = 4, order = 1)
    ...
    @ReportItem(name = "tsukiSu", length = 4, order = 8)
    public RString tsukiSu;
    @ReportItem(name = "kikan", length = 23, order = 9)
    public RString kikan;
    @ReportItem(name = "shotokuDankai", length = 5, order = 10)
    public RString shotokuDankai;
    @ReportItem(name = "hihokenshaJusho", order = 11)
    public RString hihokenshaJusho;
    @ReportItem(name = "hokenryoCalGaku", length = 7, order = 12)
    public RString hokenryoCalGaku;
    @ReportItem(name = "fuchoNofuGaku", length = 7, order = 13)
    public RString fuchoNofuGaku;
    @ReportItem(name = "hokenryoRitsu", length = 7, order = 14)
    ...
    @ReportItem(name = "hokenryoGaku4Gatsu", length = 7, order = 22)
    public RString hokenryoGaku4Gatsu;
    @ReportItem(name = "tokuchotaishonenkinName", length = 20, order = 23)
    public RString tokuchotaishonenkinName;
    @ReportItem(name = "hokenryoGakuZen10Gatsu2", length = 7, order = 24)
    public RString hokenryoGakuZen10Gatsu2;
    @ReportItem(name = "nendo", length = 4, order = 25)
    public RString nendo;
    @ReportItem(name = "hokenryoGaku6Gatsu", length = 7, order = 26)
    public RString hokenryoGaku6Gatsu;
    @ReportItem(name = "hokenryoGakuZen12Gatsu2", length = 7, order = 27)
    public RString hokenryoGakuZen12Gatsu2;
    @ReportItem(name = "hokenryoNenGaku", length = 11, order = 28)
    public RString hokenryoNenGaku;
    @ReportItem(name = "nendo3", length = 4, order = 29)
