...
/**
 * 介護保険料減免取消通知書 A4縦タイプSourceするクラスです。
 *
 * @reamsid_L DBB-0740-060 chenaoqi
 */
public class KaigoHokenHokenryoGenmenTorikeshiTsuchishoA4TateSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "genmenTorikeshiYMD", length = 11, order = 14)
    public RString genmenTorikeshiYMD;
    @ReportItem(name = "torikeshiGenmenGaku", length = 10, order = 15)
    public RString torikeshiGenmenGaku;
    @ReportItem(name = "torikeshiMaeHokenryoGaku", length = 10, order = 16)
    public RString torikeshiMaeHokenryoGaku;
    @ReportItem(name = "torikeshiAtoHokenryoGaku", length = 10, order = 17)
    public RString torikeshiAtoHokenryoGaku;
    @ReportItem(name = "torikeshiRiyu1", length = 30, order = 18)
    public RString torikeshiRiyu1;
    @ReportItem(name = "torikeshiRiyu2", length = 30, order = 19)
    public RString torikeshiRiyu2;
    @ReportItem(name = "listKibetsu_1", length = 2, order = 20)
    public RString listKibetsu_1;
    @ReportItem(name = "listKibetsu_2", length = 2, order = 21)
    public RString listKibetsu_2;
    @ReportItem(name = "listKibetsu_3", length = 7, order = 22)
    public RString listKibetsu_3;
    @ReportItem(name = "listKibetsu_4", length = 7, order = 23)
    public RString listKibetsu_4;
    @ReportItem(name = "listKibetsu_5", length = 7, order = 24)
    public RString listKibetsu_5;
    @ReportItem(name = "listKibetsu_6", length = 2, order = 25)
    public RString listKibetsu_6;
    @ReportItem(name = "listKibetsu_7", length = 2, order = 26)
    public RString listKibetsu_7;
    @ReportItem(name = "listKibetsu_8", length = 7, order = 27)
    public RString listKibetsu_8;
    @ReportItem(name = "listKibetsu_9", length = 7, order = 28)
    public RString listKibetsu_9;
    @ReportItem(name = "listKibetsu_10", length = 7, order = 29)
    public RString listKibetsu_10;
    @ReportItem(name = "listzuiji_1", length = 2, order = 30)
    ...
    @ReportItem(name = "naisenLabel", length = 4, order = 77)
    public RString naisenLabel;
    @ReportItem(name = "naisenNo", length = 20, order = 78)
    public RString naisenNo;
    @ReportItem(name = "telNo", length = 20, order = 79)
