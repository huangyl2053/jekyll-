...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "HyojicodeName2", length = 6, order = 4)
    public RString HyojicodeName2;
    @ReportItem(name = "hyojiKomoku21", length = 8, order = 5)
    public RString hyojiKomoku21;
    @ReportItem(name = "HyojicodeName3", length = 6, order = 6)
    public RString HyojicodeName3;
    @ReportItem(name = "hyojiKomoku31", length = 8, order = 7)
    public RString hyojiKomoku31;
    @ReportItem(name = "Hyojicode1", length = 15, order = 8)
    public RString Hyojicode1;
    @ReportItem(name = "Hyojicode2", length = 15, order = 9)
    public RString Hyojicode2;
    @ReportItem(name = "Hyojicode3", length = 15, order = 10)
    ...
    @ReportItem(name = "ki1", length = 2, order = 13)
    public RString ki1;
    @ReportItem(name = "hihokenshaName", order = 14)
    public RString hihokenshaName;
    @ReportItem(name = "nokiKaishi1", length = 11, order = 15)
    public RString nokiKaishi1;
    @ReportItem(name = "tsuki1", length = 2, order = 16)
    public RString tsuki1;
    @ReportItem(name = "nokiShuryo1", length = 11, order = 17)
    public RString nokiShuryo1;
    @ReportItem(name = "ki2", length = 2, order = 18)
    public RString ki2;
    @ReportItem(name = "nokiKaishi2", length = 11, order = 19)
    public RString nokiKaishi2;
    @ReportItem(name = "tsuki2", length = 2, order = 20)
    public RString tsuki2;
    @ReportItem(name = "setaiNushiName", order = 21)
    public RString setaiNushiName;
    @ReportItem(name = "nokiShuryo2", length = 11, order = 22)
    public RString nokiShuryo2;
    @ReportItem(name = "ki3", length = 2, order = 23)
    public RString ki3;
    @ReportItem(name = "nokiKaishi3", length = 11, order = 24)
    public RString nokiKaishi3;
    @ReportItem(name = "tsuki3", length = 2, order = 25)
    public RString tsuki3;
    @ReportItem(name = "nendo1", length = 4, order = 26)
    public RString nendo1;
    @ReportItem(name = "nokiShuryo3", length = 11, order = 27)
    public RString nokiShuryo3;
    @ReportItem(name = "hokenryoGaku", length = 10, order = 28)
    public RString hokenryoGaku;
    @ReportItem(name = "ki4", length = 2, order = 29)
    public RString ki4;
    @ReportItem(name = "nokiKaishi4", length = 11, order = 30)
    public RString nokiKaishi4;
    @ReportItem(name = "nendo2", length = 4, order = 31)
    public RString nendo2;
    @ReportItem(name = "shotokuDankai", length = 5, order = 32)
    public RString shotokuDankai;
    @ReportItem(name = "tsuki4", length = 2, order = 33)
    public RString tsuki4;
    @ReportItem(name = "nokiShuryo4", length = 11, order = 34)
    public RString nokiShuryo4;
    @ReportItem(name = "ki5", length = 2, order = 35)
    public RString ki5;
    @ReportItem(name = "nendo3", length = 6, order = 36)
    public RString nendo3;
    @ReportItem(name = "yen1", length = 1, order = 37)
    public RString yen1;
    @ReportItem(name = "nokiKaishi5", length = 11, order = 38)
    public RString nokiKaishi5;
    @ReportItem(name = "santeiKisoKingaku1", length = 10, order = 39)
    public RString santeiKisoKingaku1;
    @ReportItem(name = "komokuTitle1", length = 8, order = 40)
    public RString komokuTitle1;
    @ReportItem(name = "tsuki5", length = 2, order = 41)
    public RString tsuki5;
    @ReportItem(name = "nokiShuryo5", length = 11, order = 42)
    public RString nokiShuryo5;
    @ReportItem(name = "nendo4", length = 6, order = 43)
    public RString nendo4;
    @ReportItem(name = "yen2", length = 1, order = 44)
    public RString yen2;
    @ReportItem(name = "santeiKisoKingaku2", length = 10, order = 45)
    public RString santeiKisoKingaku2;
    @ReportItem(name = "ki6", length = 2, order = 46)
    public RString ki6;
    @ReportItem(name = "nokiKaishi6", length = 11, order = 47)
    public RString nokiKaishi6;
    @ReportItem(name = "komokuTitle2", length = 8, order = 48)
    public RString komokuTitle2;
    @ReportItem(name = "tsuki6", length = 2, order = 49)
    public RString tsuki6;
    @ReportItem(name = "nendo5", length = 6, order = 50)
    public RString nendo5;
    @ReportItem(name = "yen3", length = 1, order = 51)
    public RString yen3;
    @ReportItem(name = "nokiShuryo6", length = 11, order = 52)
    public RString nokiShuryo6;
    @ReportItem(name = "santeiKisoKingaku3", length = 10, order = 53)
    public RString santeiKisoKingaku3;
    @ReportItem(name = "komokuTitle3", length = 8, order = 54)
    public RString komokuTitle3;
    @ReportItem(name = "bankCode", length = 7, order = 55)
    public RString bankCode;
    @ReportItem(name = "santeiKisoKi", length = 2, order = 56)
    public RString santeiKisoKi;
    @ReportItem(name = "kozaMeigi", order = 57)
    public RString kozaMeigi;
    @ReportItem(name = "santeiKisoGenmenGaku", length = 10, order = 58)
    public RString santeiKisoGenmenGaku;
    @ReportItem(name = "santeiKisoKariGokeiGaku", length = 10, order = 59)
    public RString santeiKisoKariGokeiGaku;
    @ReportItem(name = "kozaShurui", length = 3, order = 60)
    public RString kozaShurui;
    @ReportItem(name = "santeiKisoKiTitle1", length = 4, order = 61)
    public RString santeiKisoKiTitle1;
    @ReportItem(name = "santeiKisoZanteikiHokenryoGaku1", length = 10, order = 62)
    public RString santeiKisoZanteikiHokenryoGaku1;
    @ReportItem(name = "kozaNo", length = 14, order = 63)
    public RString kozaNo;
    @ReportItem(name = "santeiKisoKiTitle2", length = 4, order = 64)
    public RString santeiKisoKiTitle2;
    @ReportItem(name = "santeiKisoZanteikiHokenryoGaku2", length = 10, order = 65)
    public RString santeiKisoZanteikiHokenryoGaku2;
    @ReportItem(name = "bankName", order = 66)
    ...
    @ReportItem(name = "nofushoKi1", length = 2, order = 140)
    public RString nofushoKi1;
    @ReportItem(name = "nofushoTsuki1", length = 2, order = 141)
    ...
    @ReportItem(name = "nofushoKakko11", length = 1, order = 148)
    public RString nofushoKakko11;
    @ReportItem(name = "nofushoHonninName1", order = 149)
