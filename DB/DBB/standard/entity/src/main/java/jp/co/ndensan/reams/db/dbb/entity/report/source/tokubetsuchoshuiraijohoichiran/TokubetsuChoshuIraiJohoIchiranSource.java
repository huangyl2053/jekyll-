 ...
 */
package jp.co.ndensan.reams.db.dbb.entity.report.source.tokubetsuchoshuiraijohoichiran;
 ...
 */
public class TokubetsuChoshuIraiJohoIchiranSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "hyojicodeName1", length = 8, order = 17)
    public RString hyojicodeName1;
    @ReportItem(name = "hyojicodeName2", length = 8, order = 18)
    ...
    @ReportItem(name = "listUpper_3", length = 40, order = 22)
    public RString listUpper_3;
    @ReportItem(name = "listUpper_4", length = 10, order = 23)
    public RString listUpper_4;
    @ReportItem(name = "listUpper_5", length = 9, order = 24)
    public RString listUpper_5;
    @ReportItem(name = "listUpper_6", length = 11, order = 25)
    public RString listUpper_6;
    @ReportItem(name = "listUpper_7", length = 11, order = 26)
    public RString listUpper_7;
    @ReportItem(name = "listUpper_8", length = 11, order = 27)
    public RString listUpper_8;
    @ReportItem(name = "listUpper_9", length = 14, order = 28)
    public RString listUpper_9;
    @ReportItem(name = "listUpper_10", length = 14, order = 29)
    ...
    @ReportItem(name = "listLower_3", length = 20, order = 33)
    public RString listLower_3;
    @ReportItem(name = "listLower_4", length = 1, order = 34)
    public RString listLower_4;
    @ReportItem(name = "listLower_5", length = 8, order = 35)
    public RString listLower_5;
    @ReportItem(name = "listLower_6", length = 35, order = 36)
...
// </editor-fold>
    ...
    /**
     * TokubetsuChoshuIraiJohoIchiranSourceのENUM
     */
