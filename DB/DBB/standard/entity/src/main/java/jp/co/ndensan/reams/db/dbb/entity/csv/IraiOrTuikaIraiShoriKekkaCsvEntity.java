...
/**
 * バッチ設計_DBB241001_特徴配信データ取り込みの処理結果件数表CSVのエンティティクラスです。
 *
...
public class IraiOrTuikaIraiShoriKekkaCsvEntity {
    ...
    @CsvField(order = 5, name = "エラー件数")
    private RString エラー件数;
    @CsvField(order = 6, name = "停止件数")
