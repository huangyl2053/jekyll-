 ...
 */
package jp.co.ndensan.reams.db.dbb.entity.db.relate.fukajoho.kibetsu;
...
public class KibetsuEntity implements Cloneable, Serializable {
     ...
     */
    private List<UrT0705ChoteiKyotsuEntity> 調定共通Entity;
    ...
    public void initializeMd5ToEntities() {
        ...
        for (UrT0705ChoteiKyotsuEntity entity : this.調定共通Entity) {
            entity.initializeMd5();
        }
    }
    private static final long serialVersionUID = 3774666457531893365L;
}
