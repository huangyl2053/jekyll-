...
/**
 * 特別徴収開始通知書（仮算定）帳票 B5横タイプSource
 *
 * @reamsid_L DBB-0790-060 lijunjun
 */
public class TokubetsuChoshuKaishiTsuchishoKariB5Source implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "atenaRenban1", length = 8, order = 11)
    public RString atenaRenban1;
    @ReportItem(name = "nendo3", length = 4, order = 12)
    public RString nendo3;
    @ReportItem(name = "hokenryoGokei", length = 11, order = 13)
    ...
    @ReportItem(name = "pageCount2", length = 6, order = 43)
    public RString pageCount2;
    @ReportItem(name = "hokenshaName", length = 10, order = 44)
    public RString hokenshaName;
    @ReportItem(name = "pageCount1", length = 6, order = 45)
    public RString pageCount1;
    @ReportItem(name = "denshiKoin", order = 46)
    public RString denshiKoin;
    @ReportItem(name = "hakkoYMD", length = 12, order = 47)
    public RString hakkoYMD;
    @ReportItem(name = "koinMojiretsu", length = 4, order = 48)
    public RString koinMojiretsu;
    @ReportItem(name = "ninshoshaShimeiKakenai", order = 49)
    public RString ninshoshaShimeiKakenai;
    @ReportItem(name = "ninshoshaShimeiKakeru", order = 50)
    public RString ninshoshaShimeiKakeru;
    @ReportItem(name = "ninshoshaYakushokuMei", length = 15, order = 51)
    public RString ninshoshaYakushokuMei;
    @ReportItem(name = "koinShoryaku", length = 15, order = 52)
    public RString koinShoryaku;
    @ReportItem(name = "yubinNo1", length = 8, order = 53)
    public RString yubinNo1;
    @ReportItem(name = "gyoseiku1", length = 14, order = 54)
    public RString gyoseiku1;
    @ReportItem(name = "jusho3", length = 20, order = 55)
    public RString jusho3;
    @ReportItem(name = "jushoText", order = 56)
    public RString jushoText;
    @ReportItem(name = "jusho1", length = 20, order = 57)
    public RString jusho1;
    @ReportItem(name = "jusho2", length = 20, order = 58)
    public RString jusho2;
    @ReportItem(name = "katagakiText", order = 59)
    public RString katagakiText;
    @ReportItem(name = "katagaki2", length = 20, order = 60)
    public RString katagaki2;
    @ReportItem(name = "katagakiSmall2", length = 30, order = 61)
    public RString katagakiSmall2;
    @ReportItem(name = "katagaki1", length = 20, order = 62)
    public RString katagaki1;
    @ReportItem(name = "katagakiSmall1", length = 30, order = 63)
    public RString katagakiSmall1;
    @ReportItem(name = "shimei2", length = 20, order = 64)
    public RString shimei2;
    @ReportItem(name = "shimeiSmall2", length = 40, order = 65)
    public RString shimeiSmall2;
    @ReportItem(name = "shimeiText", order = 66)
    public RString shimeiText;
    @ReportItem(name = "meishoFuyo2", length = 3, order = 67)
    public RString meishoFuyo2;
    @ReportItem(name = "shimeiSmall1", length = 40, order = 68)
    public RString shimeiSmall1;
    @ReportItem(name = "dainoKubunMei", length = 8, order = 69)
    public RString dainoKubunMei;
    @ReportItem(name = "shimei1", length = 20, order = 70)
    public RString shimei1;
    @ReportItem(name = "meishoFuyo1", length = 3, order = 71)
    public RString meishoFuyo1;
    @ReportItem(name = "samabunShimeiText", order = 72)
    public RString samabunShimeiText;
    @ReportItem(name = "samaBun2", length = 3, order = 73)
    public RString samaBun2;
    @ReportItem(name = "samabunShimeiSmall2", length = 40, order = 74)
    public RString samabunShimeiSmall2;
    @ReportItem(name = "kakkoLeft2", length = 1, order = 75)
    public RString kakkoLeft2;
    @ReportItem(name = "samabunShimei2", length = 20, order = 76)
    public RString samabunShimei2;
    @ReportItem(name = "kakkoRight2", length = 1, order = 77)
    ...
    @ReportItem(name = "kakkoRight1", length = 1, order = 81)
    public RString kakkoRight1;
    @ReportItem(name = "samabunShimeiSmall1", length = 40, order = 82)
    public RString samabunShimeiSmall1;
    @ReportItem(name = "customerBarCode", order = 83)
