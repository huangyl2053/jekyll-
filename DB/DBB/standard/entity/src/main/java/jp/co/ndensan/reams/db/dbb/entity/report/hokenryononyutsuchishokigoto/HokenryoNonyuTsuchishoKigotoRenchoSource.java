...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "yubinNo", length = 8, order = 88)
    public RString yubinNo;
    @ReportItem(name = "gyoseiku", length = 14, order = 89)
    public RString gyoseiku;
    @ReportItem(name = "jusho3", length = 20, order = 90)
    public RString jusho3;
    @ReportItem(name = "jushoText", order = 91)
    public RString jushoText;
    @ReportItem(name = "jusho1", length = 20, order = 92)
    public RString jusho1;
    @ReportItem(name = "jusho2", length = 20, order = 93)
    public RString jusho2;
    @ReportItem(name = "katagaki2", length = 20, order = 94)
    public RString katagaki2;
    @ReportItem(name = "katagakiText", order = 95)
    public RString katagakiText;
    @ReportItem(name = "katagakiSmall2", length = 30, order = 96)
    public RString katagakiSmall2;
    @ReportItem(name = "katagaki1", length = 20, order = 97)
    public RString katagaki1;
    @ReportItem(name = "katagakiSmall1", length = 30, order = 98)
    public RString katagakiSmall1;
    @ReportItem(name = "shimei2", length = 20, order = 99)
    public RString shimei2;
    @ReportItem(name = "shimeiSmall2", length = 40, order = 100)
    public RString shimeiSmall2;
    @ReportItem(name = "shimeiText", order = 101)
    public RString shimeiText;
    @ReportItem(name = "meishoFuyo2", length = 3, order = 102)
    public RString meishoFuyo2;
    @ReportItem(name = "dainoKubunMei", length = 8, order = 103)
    public RString dainoKubunMei;
    @ReportItem(name = "shimei1", length = 20, order = 104)
    public RString shimei1;
    @ReportItem(name = "shimeiSmall1", length = 40, order = 105)
    public RString shimeiSmall1;
    @ReportItem(name = "meishoFuyo1", length = 3, order = 106)
    public RString meishoFuyo1;
    @ReportItem(name = "kakkoLeft2", length = 1, order = 107)
    public RString kakkoLeft2;
    @ReportItem(name = "samabunShimei2", length = 20, order = 108)
    public RString samabunShimei2;
    @ReportItem(name = "samabunShimeiSmall2", length = 40, order = 109)
    public RString samabunShimeiSmall2;
    @ReportItem(name = "samabunShimeiText", order = 110)
    public RString samabunShimeiText;
    @ReportItem(name = "samaBun2", length = 3, order = 111)
    public RString samaBun2;
    @ReportItem(name = "kakkoRight2", length = 1, order = 112)
    public RString kakkoRight2;
    @ReportItem(name = "kakkoLeft1", length = 1, order = 113)
    public RString kakkoLeft1;
    @ReportItem(name = "samabunShimei1", length = 20, order = 114)
    public RString samabunShimei1;
    @ReportItem(name = "samabunShimeiSmall1", length = 40, order = 115)
    public RString samabunShimeiSmall1;
    @ReportItem(name = "samaBun1", length = 3, order = 116)
    public RString samaBun1;
    @ReportItem(name = "kakkoRight1", length = 1, order = 117)
    public RString kakkoRight1;
    @ReportItem(name = "customerBarCode", order = 118)
    public RString customerBarCode;
    @ReportItem(name = "ryoshushoKanendo", length = 6, order = 119)
    public RString ryoshushoKanendo;
    @ReportItem(name = "ryoshushoNendo", length = 6, order = 120)
    public RString ryoshushoNendo;
    @ReportItem(name = "ryoshushoKanendobun", length = 9, order = 121)
    public RString ryoshushoKanendobun;
    @ReportItem(name = "ryoshushoKi", length = 2, order = 122)
    public RString ryoshushoKi;
    @ReportItem(name = "ryoshushoTsuki", length = 2, order = 123)
    public RString ryoshushoTsuki;
    @ReportItem(name = "ryoshushoYubinNo", length = 8, order = 124)
    public RString ryoshushoYubinNo;
    @ReportItem(name = "ryoshushoGyoseikuName", length = 14, order = 125)
    public RString ryoshushoGyoseikuName;
    @ReportItem(name = "ryoshushoJusho", order = 126)
    public RString ryoshushoJusho;
    @ReportItem(name = "ryoshushoKatagaki", order = 127)
    public RString ryoshushoKatagaki;
    @ReportItem(name = "ryoshushoSofusakiName", order = 128)
    public RString ryoshushoSofusakiName;
    @ReportItem(name = "ryoshushoKakko1", length = 1, order = 129)
    public RString ryoshushoKakko1;
    @ReportItem(name = "ryoshushoHonninName", order = 130)
    public RString ryoshushoHonninName;
    @ReportItem(name = "ryoshushoKakko2", length = 1, order = 131)
    public RString ryoshushoKakko2;
    @ReportItem(name = "ryoshushoKakko3", length = 3, order = 132)
    public RString ryoshushoKakko3;
    @ReportItem(name = "ryoshushoTsuchishoNo", order = 133)
    public RString ryoshushoTsuchishoNo;
    @ReportItem(name = "ryoshushoSetaiCode", length = 15, order = 134)
    public RString ryoshushoSetaiCode;
    @ReportItem(name = "ryoshushohyojicodeName1", order = 135)
    public RString ryoshushohyojicodeName1;
    @ReportItem(name = "ryoshushohyojicode1", length = 20, order = 136)
    public RString ryoshushohyojicode1;
    @ReportItem(name = "ryoshushohyojicodeName2", order = 137)
    public RString ryoshushohyojicodeName2;
    @ReportItem(name = "ryoshushohyojicode2", length = 20, order = 138)
    public RString ryoshushohyojicode2;
    @ReportItem(name = "ryoshushohyojicodeName3", order = 139)
    public RString ryoshushohyojicodeName3;
    @ReportItem(name = "ryoshushoHyojicode3", length = 20, order = 140)
    public RString ryoshushoHyojicode3;
    @ReportItem(name = "ryoshushoNokigen", length = 11, order = 141)
    public RString ryoshushoNokigen;
    @ReportItem(name = "ryoshushoNofugaku", length = 10, order = 142)
    public RString ryoshushoNofugaku;
    @ReportItem(name = "ryoshushoNofuin", length = 2, order = 143)
    public RString ryoshushoNofuin;
    @ReportItem(name = "ryoshushoRyoshuHizukein", length = 4, order = 144)
    public RString ryoshushoRyoshuHizukein;
    @ReportItem(name = "ryoshushoZuiji", length = 2, order = 145)
    public RString ryoshushoZuiji;
    @ReportItem(name = "ryoshushoRenban", length = 10, order = 146)
    public RString ryoshushoRenban;
    @ReportItem(name = "ryoshushoShichosonMei1", length = 10, order = 147)
    public RString ryoshushoShichosonMei1;
    @ReportItem(name = "ryoshushoShichosonMei2", length = 10, order = 148)
    public RString ryoshushoShichosonMei2;
    @ReportItem(name = "nofushoKanendo", length = 6, order = 149)
    public RString nofushoKanendo;
    @ReportItem(name = "nofushoNendo", length = 6, order = 150)
    public RString nofushoNendo;
    @ReportItem(name = "nofushoKanendobun", length = 9, order = 151)
    public RString nofushoKanendobun;
    @ReportItem(name = "nofushoKi", length = 2, order = 152)
    public RString nofushoKi;
    @ReportItem(name = "nofushoTsuki", length = 2, order = 153)
    public RString nofushoTsuki;
    @ReportItem(name = "nofushoOcr1", length = 6, order = 154)
    public RString nofushoOcr1;
    @ReportItem(name = "nofushoOcr2", length = 16, order = 155)
    public RString nofushoOcr2;
    @ReportItem(name = "nofushoOcr3", length = 17, order = 156)
    public RString nofushoOcr3;
    @ReportItem(name = "nofushoOcr4", length = 12, order = 157)
    public RString nofushoOcr4;
    @ReportItem(name = "nofushoNofugaku", length = 10, order = 158)
    public RString nofushoNofugaku;
    @ReportItem(name = "nofushoSofusakiName", order = 159)
    public RString nofushoSofusakiName;
    @ReportItem(name = "nofushoKakko1", length = 1, order = 160)
    public RString nofushoKakko1;
    @ReportItem(name = "nofushoHonninName1", order = 161)
    public RString nofushoHonninName1;
    @ReportItem(name = "nofushoKakko2", length = 1, order = 162)
    public RString nofushoKakko2;
    @ReportItem(name = "nofushoKakko3", length = 3, order = 163)
    public RString nofushoKakko3;
    @ReportItem(name = "nofushoTsuchishoNo", order = 164)
    public RString nofushoTsuchishoNo;
    @ReportItem(name = "nofushoSetaiCode", length = 15, order = 165)
    public RString nofushoSetaiCode;
    @ReportItem(name = "nofushohyojicodeName1", order = 166)
    public RString nofushohyojicodeName1;
    @ReportItem(name = "nofushohyojicode1", length = 20, order = 167)
    public RString nofushohyojicode1;
    @ReportItem(name = "nofushohyojicodeName2", order = 168)
    public RString nofushohyojicodeName2;
    @ReportItem(name = "nofushohyojicode2", length = 20, order = 169)
    public RString nofushohyojicode2;
    @ReportItem(name = "nofushohyojicodeName3", order = 170)
    public RString nofushohyojicodeName3;
    @ReportItem(name = "nofushohyojicode3", length = 20, order = 171)
    public RString nofushohyojicode3;
    @ReportItem(name = "nofushoNokigen", length = 11, order = 172)
    public RString nofushoNokigen;
    @ReportItem(name = "nofushoNofuin", length = 2, order = 173)
    public RString nofushoNofuin;
    @ReportItem(name = "nofushoRyoshuHizukein", length = 4, order = 174)
    public RString nofushoRyoshuHizukein;
    @ReportItem(name = "nofushoZuiji", length = 2, order = 175)
    public RString nofushoZuiji;
    @ReportItem(name = "nofushoShichosonMei", order = 176)
    public RString nofushoShichosonMei;
    @ReportItem(name = "denshiKoin", order = 177)
    public RString denshiKoin;
    @ReportItem(name = "hakkoYMD", length = 12, order = 178)
    public RString hakkoYMD;
    @ReportItem(name = "ninshoshaYakushokuMei", length = 15, order = 179)
    public RString ninshoshaYakushokuMei;
    @ReportItem(name = "ninshoshaYakushokuMei1", order = 180)
    public RString ninshoshaYakushokuMei1;
    @ReportItem(name = "ninshoshaYakushokuMei2", order = 181)
    public RString ninshoshaYakushokuMei2;
    @ReportItem(name = "koinMojiretsu", length = 4, order = 182)
    public RString koinMojiretsu;
    @ReportItem(name = "ninshoshaShimeiKakenai", order = 183)
    public RString ninshoshaShimeiKakenai;
    @ReportItem(name = "ninshoshaShimeiKakeru", order = 184)
    public RString ninshoshaShimeiKakeru;
    @ReportItem(name = "koinShoryaku", length = 15, order = 185)
