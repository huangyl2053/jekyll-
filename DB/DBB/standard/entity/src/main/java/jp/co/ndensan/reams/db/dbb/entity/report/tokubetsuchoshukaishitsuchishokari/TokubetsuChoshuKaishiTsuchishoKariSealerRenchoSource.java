...
/**
 * 特別徴収開始通知書（仮算定）帳票 シーラタイプ連帳Source
 *
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "nendo4", length = 4, order = 5)
    public RString nendo4;
    @ReportItem(name = "hokenryoGokei", length = 11, order = 6)
    ...
    @ReportItem(name = "nendo9", length = 4, order = 25)
    public RString nendo9;
    @ReportItem(name = "nendo", length = 4, order = 26)
    public RString nendo;
    @ReportItem(name = "hyojicodeName1", length = 8, order = 27)
    public RString hyojicodeName1;
    @ReportItem(name = "hyojicodeName2", length = 8, order = 28)
    public RString hyojicodeName2;
    @ReportItem(name = "hyojicodeName3", length = 8, order = 29)
    public RString hyojicodeName3;
    @ReportItem(name = "hokenryoGaku4Gatsu1", length = 7, order = 30)
    public RString hokenryoGaku4Gatsu1;
    @ReportItem(name = "hokenryoGaku6Gatsu1", length = 7, order = 31)
    public RString hokenryoGaku6Gatsu1;
    @ReportItem(name = "hokenryoGaku8Gatsu1", length = 7, order = 32)
    ...
    @ReportItem(name = "denshiKoin", order = 36)
    public RString denshiKoin;
    @ReportItem(name = "hakkoYMD", length = 12, order = 37)
    ...
    @ReportItem(name = "ninshoshaYakushokuMei", length = 15, order = 41)
    public RString ninshoshaYakushokuMei;
    @ReportItem(name = "koinShoryaku", length = 15, order = 42)
    public RString koinShoryaku;
    @ReportItem(name = "yubinNo1", length = 8, order = 43)
    public RString yubinNo1;
    @ReportItem(name = "gyoseiku1", length = 14, order = 44)
    ...
    @ReportItem(name = "katagakiText", order = 49)
    public RString katagakiText;
    @ReportItem(name = "katagaki2", length = 20, order = 50)
    ...
    @ReportItem(name = "shimeiSmall1", length = 40, order = 58)
    public RString shimeiSmall1;
    @ReportItem(name = "dainoKubunMei", length = 8, order = 59)
    public RString dainoKubunMei;
    @ReportItem(name = "shimei1", length = 20, order = 60)
    public RString shimei1;
    @ReportItem(name = "meishoFuyo1", length = 3, order = 61)
    public RString meishoFuyo1;
    @ReportItem(name = "samabunShimeiText", order = 62)
    public RString samabunShimeiText;
    @ReportItem(name = "samaBun2", length = 3, order = 63)
    ...
    @ReportItem(name = "kakkoRight1", length = 1, order = 71)
    public RString kakkoRight1;
    @ReportItem(name = "samabunShimeiSmall1", length = 40, order = 72)
