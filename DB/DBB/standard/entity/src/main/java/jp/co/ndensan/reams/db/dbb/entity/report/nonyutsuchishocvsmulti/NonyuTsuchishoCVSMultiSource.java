...
public class NonyuTsuchishoCVSMultiSource implements IReportSource {
    ...
    //納付書
    @ReportItem(name = "detail_listList1_1", length = 2, order = 180)
    public RString detail_listList1_1;
    @ReportItem(name = "detail_notsuRenban1", length = 10, order = 181)
    public RString detail_notsuRenban1;
    @ReportItem(name = "detail_pageCount1", length = 10, order = 182)
    public RString detail_pageCount1;
    @ReportItem(name = "detail_notsuRenban2", length = 10, order = 183)
    public RString detail_notsuRenban2;
    @ReportItem(name = "detail_pageCount2", length = 10, order = 184)
    public RString detail_pageCount2;
    @ReportItem(name = "detail_renban", length = 10, order = 185)
    public RString detail_renban;
    @ReportItem(name = "hokenshaName", length = 10, order = 186)
    public RString detail_hokenshaName;
    @ReportItem(name = "detail_notsuRenban3", length = 10, order = 187)
    public RString detail_notsuRenban3;
    @ReportItem(name = "detail_pageCount3", length = 10, order = 188)
    public RString detail_pageCount3;
    @ReportItem(name = "detail_kamokumei", order = 189)
    public RString detail_kamokumei;
    @ReportItem(name = "detail_ryoshushoNendo1", order = 190)
    public RString detail_ryoshushoNendo1;
    @ReportItem(name = "detail_nendoNenbun", order = 191)
    public RString detail_nendoNenbun;
    @ReportItem(name = "detail_kibetsu", order = 192)
    public RString detail_kibetsu;
    @ReportItem(name = "detail_ryoshushoNenbun1", order = 193)
    public RString detail_ryoshushoNenbun1;
    @ReportItem(name = "detail_gokeigaku", length = 15, order = 194)
    public RString detail_gokeigaku;
    @ReportItem(name = "detail_shunoKikanBango1", length = 5, order = 105)
    public RString detail_shunoKikanBango1;
    @ReportItem(name = "detail_nofuBango", length = 20, order = 196)
    public RString detail_nofuBango;
    @ReportItem(name = "detail_kakuninBango1", length = 5, order = 197)
    public RString detail_kakuninBango1;
    @ReportItem(name = "detail_nofuKubun1", length = 3, order = 198)
    public RString detail_nofuKubun1;
    @ReportItem(name = "detail_nokigenTitle", length = 12, order = 199)
    public RString detail_nokigenTitle;
    @ReportItem(name = "detail_ocrId1", length = 3, order = 200)
    public RString detail_ocrId1;
    @ReportItem(name = "detail_tsuchishoNo", length = 20, order = 201)
    public RString detail_tsuchishoNo;
    @ReportItem(name = "detail_nokigenYmd", length = 16, order = 202)
    public RString detail_nokigenYmd;
    @ReportItem(name = "detail_hakkoYmd", length = 16, order = 203)
    public RString detail_hakkoYmd;
    @ReportItem(name = "detail_honzei", length = 15, order = 204)
    public RString detail_honzei;
    @ReportItem(name = "detail_tokusokuTesuryo", length = 5, order = 205)
    public RString detail_tokusokuTesuryo;
    @ReportItem(name = "detail_ocr11", length = 39, order = 206)
    public RString detail_ocr11;
    @ReportItem(name = "detail_ocrCut1", length = 1, order = 207)
    public RString detail_ocrCut1;
    @ReportItem(name = "detail_entaikin", length = 15, order = 208)
    public RString detail_entaikin;
    @ReportItem(name = "detail_ocr21", length = 44, order = 209)
    public RString detail_ocr21;
    @ReportItem(name = "detail_shimei", order = 210)
    public RString detail_shimei;
    @ReportItem(name = "detail_biko11", length = 30, order = 211)
    public RString detail_biko11;
    @ReportItem(name = "detail_biko21", length = 30, order = 212)
    ...
    @ReportItem(name = "detail_cvsBarcodeNaiyo11", length = 33, order = 215)
    public RString detail_cvsBarcodeNaiyo11;
    @ReportItem(name = "detail_cvsBarcodeNaiyo21", length = 33, order = 216)
    public RString detail_cvsBarcodeNaiyo21;
    @ReportItem(name = "detail_cvsToriatsukaikigen1", length = 16, order = 217)
    public RString detail_cvsToriatsukaikigen1;
    @ReportItem(name = "detail_funyuFukanBango1", length = 12, order = 218)
    public RString detail_funyuFukanBango1;
    @ReportItem(name = "detail_ryoshushoNendo2", order = 219)
    public RString detail_ryoshushoNendo2;
    @ReportItem(name = "detail_ryoshushoNenbun2", order = 220)
    public RString detail_ryoshushoNenbun2;
    @ReportItem(name = "detail_shunoKikanBango2", length = 5, order = 221)
    public RString detail_shunoKikanBango2;
    @ReportItem(name = "detail_kakuninBango2", length = 5, order = 222)
    public RString detail_kakuninBango2;
    @ReportItem(name = "detail_nofuKubun2", length = 3, order = 223)
    public RString detail_nofuKubun2;
    @ReportItem(name = "detail_ocrId2", length = 3, order = 224)
    public RString detail_ocrId2;
    @ReportItem(name = "detail_ocr12", length = 39, order = 225)
    public RString detail_ocr12;
    @ReportItem(name = "detail_ocrCut2", length = 1, order = 226)
    public RString detail_ocrCut2;
    @ReportItem(name = "detail_ocr22", length = 44, order = 227)
    public RString detail_ocr22;
    @ReportItem(name = "biko12", length = 30, order = 228)
    public RString detail_biko12;
    @ReportItem(name = "detail_biko22", length = 30, order = 229)
    public RString detail_biko22;
    @ReportItem(name = "detail_barcodeCvsBarcode2", order = 230)
    public RString detail_barcodeCvsBarcode2;
    @ReportItem(name = "cvsBarcodeNaiyo12", length = 33, order = 231)
    public RString detail_cvsBarcodeNaiyo12;
    @ReportItem(name = "detail_cvsBarcodeNaiyo22", length = 33, order = 232)
    public RString detail_cvsBarcodeNaiyo22;
    @ReportItem(name = "detail_cvsToriatsukaikigen2", length = 16, order = 233)
    public RString detail_cvsToriatsukaikigen2;
    @ReportItem(name = "detail_funyuFukanBango2", length = 12, order = 234)
    public RString detail_funyuFukanBango2;
    @ReportItem(name = "detail_ryoshushoNendo3", order = 235)
    public RString detail_ryoshushoNendo3;
    @ReportItem(name = "detail_ryoshushoNenbun3", order = 236)
    public RString detail_ryoshushoNenbun3;
    @ReportItem(name = "detail_shunoKikanBango3", length = 5, order = 237)
    public RString detail_shunoKikanBango3;
    @ReportItem(name = "detail_kakuninBango3", length = 5, order = 238)
    public RString detail_kakuninBango3;
    @ReportItem(name = "detail_nofuKubun3", length = 3, order = 239)
    public RString detail_nofuKubun3;
    @ReportItem(name = "detail_ocrId3", length = 3, order = 240)
    public RString detail_ocrId3;
    @ReportItem(name = "detail_ocr13", length = 39, order = 241)
    public RString detail_ocr13;
    @ReportItem(name = "detail_ocrCut3", length = 1, order = 242)
    public RString detail_ocrCut3;
    @ReportItem(name = "detail_ocr23", length = 44, order = 243)
    public RString detail_ocr23;
    @ReportItem(name = "detail_biko13", length = 30, order = 244)
    public RString detail_biko13;
    @ReportItem(name = "detail_biko23", length = 30, order = 245)
    public RString detail_biko23;
    @ReportItem(name = "detail_barcodeCvsBarcode3", order = 246)
    public RString detail_barcodeCvsBarcode3;
    @ReportItem(name = "detail_cvsBarcodeNaiyo13", length = 33, order = 247)
    public RString detail_cvsBarcodeNaiyo13;
    @ReportItem(name = "detail_cvsBarcodeNaiyo23", length = 33, order = 248)
    public RString detail_cvsBarcodeNaiyo23;
    @ReportItem(name = "detail_cvsToriatsukaikigen3", length = 16, order = 249)
    public RString detail_cvsToriatsukaikigen3;
    @ReportItem(name = "detail_funyuFukanBango3", length = 12, order = 250)
