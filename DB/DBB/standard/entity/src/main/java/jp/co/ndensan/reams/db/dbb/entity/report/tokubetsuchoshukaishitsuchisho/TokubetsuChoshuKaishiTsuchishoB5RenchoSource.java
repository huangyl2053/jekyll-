...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    //SUPPRESS CHECKSTYLE STRING-USE-CHECK//
    public static final String ITEM_TSUCHISHONO1 = "tsuchishoNo1";
    ...
    @ReportItem(name = "tsuchishoNo1", order = 30)
    public RString tsuchishoNo1;
    @ReportItem(name = "setaiCode1", length = 15, order = 31)
    ...
    @ReportItem(name = "pageCount1", length = 6, order = 47)
    public RString pageCount1;
    @ReportItem(name = "yubinNo", length = 8, order = 48)
    public RString yubinNo;
    @ReportItem(name = "gyoseiku", length = 14, order = 49)
    ...
    @ReportItem(name = "denshiKoin1", order = 79)
    public RString denshiKoin1;
    @ReportItem(name = "hakkoYMD1", length = 12, order = 80)
    public RString hakkoYMD1;
    @ReportItem(name = "ninshoshaYakushokuMei5", length = 15, order = 81)
    public RString ninshoshaYakushokuMei5;
    @ReportItem(name = "ninshoshaYakushokuMei3", order = 82)
    public RString ninshoshaYakushokuMei3;
    @ReportItem(name = "koinMojiretsu1", length = 4, order = 83)
    public RString koinMojiretsu1;
    @ReportItem(name = "ninshoshaYakushokuMei4", order = 84)
    public RString ninshoshaYakushokuMei4;
    @ReportItem(name = "ninshoshaShimeiKakenai1", order = 85)
    public RString ninshoshaShimeiKakenai1;
    @ReportItem(name = "ninshoshaShimeiKakeru1", order = 86)
    public RString ninshoshaShimeiKakeru1;
    @ReportItem(name = "koinShoryaku1", length = 15, order = 87)
    public RString koinShoryaku1;
// </editor-fold>
