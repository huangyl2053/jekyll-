...
/**
 *
 * 保険料納入通知書（本算定）【ブックタイプ】納付書連帳 （口振依頼なし）通知書_連帳帳票Sourceです。
 *
...
public class HokenryoNonyuTsuchishoBookFuriKaeNashiRenchoCoverSource implements IReportSource {
    ...
    @ReportItem(name = "cover_keisanMeisaishoNokigenKaishi1", length = 11, order = 9)
    public RString cover_keisanMeisaishoNokigenKaishi1;
    @ReportItem(name = "cover_hyojicode1", length = 11, order = 10)
    public RString cover_hyojicode1;
    @ReportItem(name = "cover_hyojicode2", length = 9, order = 11)
    public RString cover_hyojicode2;
    @ReportItem(name = "cover_hyojicode3", length = 9, order = 12)
    public RString cover_hyojicode3;
    @ReportItem(name = "cover_keisanMeisaishoKi1", length = 2, order = 13)
    ...
    @ReportItem(name = "cover_keisanMeisaishoNokigenKaishi2", length = 11, order = 20)
    public RString cover_keisanMeisaishoNokigenKaishi2;
    @ReportItem(name = "cover_keisanMeisaishoKi2", length = 2, order = 21)
    ...
    @ReportItem(name = "cover_keisanMeisaishoShotokuDankai", length = 8, order = 38)
    public RString cover_keisanMeisaishoShotokuDankai;
    @ReportItem(name = "cover_keisanMeisaishoTsuki4", length = 2, order = 39)
    public RString cover_keisanMeisaishoTsuki4;
    @ReportItem(name = "cover_keisanMeisaishoNokigenShuryo4", length = 11, order = 40)
    ...
    @ReportItem(name = "cover_keisanMeisaishoGenmenGaku", length = 10, order = 46)
    public RString cover_keisanMeisaishoGenmenGaku;
    @ReportItem(name = "cover_keisanMeisaishoCalHokenryoGaku", length = 10, order = 47)
    ...
    @ReportItem(name = "cover_kaisanMeisaishoFuchoGokeiGaku", length = 10, order = 53)
    public RString cover_kaisanMeisaishoFuchoGokeiGaku;
    @ReportItem(name = "cover_keisanMeisaishoTokuchoGokeiGaku", length = 10, order = 54)
    ...
    @ReportItem(name = "cover_keisanMeisaishoHokenryoGokeiGaku", length = 15, order = 88)
    public RString cover_keisanMeisaishoHokenryoGokeiGaku;
    @ReportItem(name = "cover_keisanMeisaishoTsuki10", length = 2, order = 89)
    public RString cover_keisanMeisaishoTsuki10;
    @ReportItem(name = "cover_keisanMeisaishoNokigenShuryo10", length = 11, order = 90)
    ...
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoSaGaku1", length = 10, order = 95)
    ...
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuGaku2", length = 10, order = 100)
    public RString cover_nokibetsuMeisaishoTokuchoNofuGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuZumiGaku2", length = 10, order = 101)
    public RString cover_nokibetsuMeisaishoTokuchoNofuZumiGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoSaGaku2", length = 10, order = 102)
    ...
    @ReportItem(name = "cover_nokibetsuMeisaishoTokuchoNofuGaku4", length = 10, order = 109)
    public RString cover_nokibetsuMeisaishoTokuchoNofuGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi1", length = 4, order = 110)
    public RString cover_nokibetsuMeisaishoKi1;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku1", length = 10, order = 111)
    public RString cover_nokibetsuMeisaishoFuchoNofuGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku1", length = 10, order = 112)
    public RString cover_nokibetsuMeisaishoFuchoNofuZumiGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku1", length = 10, order = 113)
    public RString cover_nokibetsuMeisaishoFuchoSaGaku1;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen1", length = 11, order = 114)
    public RString cover_nokibetsuMeisaishoNokigen1;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi2", length = 4, order = 115)
    public RString cover_nokibetsuMeisaishoKi2;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku2", length = 10, order = 116)
    public RString cover_nokibetsuMeisaishoFuchoNofuGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku2", length = 10, order = 117)
    public RString cover_nokibetsuMeisaishoFuchoNofuZumiGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku2", length = 10, order = 118)
    public RString cover_nokibetsuMeisaishoFuchoSaGaku2;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen2", length = 11, order = 119)
    public RString cover_nokibetsuMeisaishoNokigen2;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi3", length = 4, order = 120)
    public RString cover_nokibetsuMeisaishoKi3;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku3", length = 10, order = 121)
    public RString cover_nokibetsuMeisaishoFuchoNofuGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku3", length = 10, order = 122)
    public RString cover_nokibetsuMeisaishoFuchoNofuZumiGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku3", length = 10, order = 123)
    public RString cover_nokibetsuMeisaishoFuchoSaGaku3;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen3", length = 11, order = 124)
    public RString cover_nokibetsuMeisaishoNokigen3;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi4", length = 4, order = 125)
    public RString cover_nokibetsuMeisaishoKi4;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku4", length = 10, order = 126)
    public RString cover_nokibetsuMeisaishoFuchoNofuGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku4", length = 10, order = 127)
    public RString cover_nokibetsuMeisaishoFuchoNofuZumiGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku4", length = 10, order = 128)
    public RString cover_nokibetsuMeisaishoFuchoSaGaku4;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen4", length = 11, order = 129)
    public RString cover_nokibetsuMeisaishoNokigen4;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi5", length = 4, order = 130)
    public RString cover_nokibetsuMeisaishoKi5;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku5", length = 10, order = 131)
    public RString cover_nokibetsuMeisaishoFuchoNofuGaku5;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku5", length = 10, order = 132)
    public RString cover_nokibetsuMeisaishoFuchoNofuZumiGaku5;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku5", length = 10, order = 133)
    public RString cover_nokibetsuMeisaishoFuchoSaGaku5;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen5", length = 11, order = 134)
    public RString cover_nokibetsuMeisaishoNokigen5;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi6", length = 4, order = 135)
    public RString cover_nokibetsuMeisaishoKi6;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku6", length = 10, order = 136)
    public RString cover_nokibetsuMeisaishoFuchoNofuGaku6;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku6", length = 10, order = 137)
    public RString cover_nokibetsuMeisaishoFuchoNofuZumiGaku6;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku6", length = 10, order = 138)
    public RString cover_nokibetsuMeisaishoFuchoSaGaku6;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen6", length = 11, order = 139)
    public RString cover_nokibetsuMeisaishoNokigen6;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi7", length = 4, order = 140)
    public RString cover_nokibetsuMeisaishoKi7;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku7", length = 10, order = 141)
    public RString cover_nokibetsuMeisaishoFuchoNofuGaku7;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku7", length = 10, order = 142)
    ...
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku7", length = 10, order = 144)
    public RString cover_nokibetsuMeisaishoFuchoSaGaku7;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi8", length = 4, order = 145)
    public RString cover_nokibetsuMeisaishoKi8;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku8", length = 10, order = 146)
    public RString cover_nokibetsuMeisaishoFuchoNofuGaku8;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku8", length = 10, order = 147)
    public RString cover_nokibetsuMeisaishoFuchoNofuZumiGaku8;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku8", length = 10, order = 148)
    public RString cover_nokibetsuMeisaishoFuchoSaGaku8;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen8", length = 11, order = 149)
    public RString cover_nokibetsuMeisaishoNokigen8;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi9", length = 4, order = 150)
    public RString cover_nokibetsuMeisaishoKi9;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku9", length = 10, order = 151)
    public RString cover_nokibetsuMeisaishoFuchoNofuGaku9;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku9", length = 10, order = 152)
    public RString cover_nokibetsuMeisaishoFuchoNofuZumiGaku9;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku9", length = 10, order = 153)
    public RString cover_nokibetsuMeisaishoFuchoSaGaku9;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen9", length = 11, order = 154)
    public RString cover_nokibetsuMeisaishoNokigen9;
    @ReportItem(name = "cover_nokibetsuMeisaishoKi10", length = 4, order = 155)
    public RString cover_nokibetsuMeisaishoKi10;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku10", length = 10, order = 156)
    public RString cover_nokibetsuMeisaishoFuchoNofuGaku10;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku10", length = 10, order = 157)
    public RString cover_nokibetsuMeisaishoFuchoNofuZumiGaku10;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku10", length = 10, order = 158)
    public RString cover_nokibetsuMeisaishoFuchoSaGaku10;
    @ReportItem(name = "cover_nokibetsuMeisaishoNokigen10", length = 11, order = 159)
    public RString cover_nokibetsuMeisaishoNokigen10;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuGaku11", length = 10, order = 160)
    public RString cover_nokibetsuMeisaishoFuchoNofuGaku11;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoNofuZumiGaku11", length = 10, order = 161)
    public RString cover_nokibetsuMeisaishoFuchoNofuZumiGaku11;
    @ReportItem(name = "cover_nokibetsuMeisaishoFuchoSaGaku11", length = 10, order = 162)
    public RString cover_nokibetsuMeisaishoFuchoSaGaku11;
    @ReportItem(name = "cover_pagerenban3", length = 10, order = 163)
    public RString cover_pagerenban3;
    @ReportItem(name = "cover_yubinNo", length = 8, order = 164)
    public RString cover_yubinNo;
    @ReportItem(name = "cover_gyoseiku", length = 14, order = 165)
    public RString cover_gyoseiku;
    @ReportItem(name = "cover_jusho3", length = 20, order = 166)
    public RString cover_jusho3;
    @ReportItem(name = "cover_jushoText", order = 167)
    public RString cover_jushoText;
    @ReportItem(name = "cover_jusho1", length = 20, order = 168)
    public RString cover_jusho1;
    @ReportItem(name = "cover_jusho2", length = 20, order = 169)
    public RString cover_jusho2;
    @ReportItem(name = "cover_katagakiText", order = 170)
    public RString cover_katagakiText;
    @ReportItem(name = "cover_katagaki2", length = 20, order = 171)
    public RString cover_katagaki2;
    @ReportItem(name = "cover_katagakiSmall2", length = 30, order = 172)
    public RString cover_katagakiSmall2;
    @ReportItem(name = "cover_katagaki1", length = 20, order = 173)
    public RString cover_katagaki1;
    @ReportItem(name = "cover_katagakiSmall1", length = 30, order = 174)
    public RString cover_katagakiSmall1;
    @ReportItem(name = "cover_shimei2", length = 20, order = 175)
    public RString cover_shimei2;
    @ReportItem(name = "cover_shimeiSmall2", length = 40, order = 176)
    public RString cover_shimeiSmall2;
    @ReportItem(name = "cover_shimeiText", order = 177)
    public RString cover_shimeiText;
    @ReportItem(name = "cover_meishoFuyo2", length = 3, order = 178)
    public RString cover_meishoFuyo2;
    @ReportItem(name = "cover_shimeiSmall1", length = 40, order = 179)
    public RString cover_shimeiSmall1;
    @ReportItem(name = "cover_dainoKubunMei", length = 8, order = 180)
    public RString cover_dainoKubunMei;
    @ReportItem(name = "cover_shimei1", length = 20, order = 181)
    public RString cover_shimei1;
    @ReportItem(name = "cover_meishoFuyo1", length = 3, order = 182)
    public RString cover_meishoFuyo1;
    @ReportItem(name = "cover_samabunShimeiText", order = 183)
    public RString cover_samabunShimeiText;
    @ReportItem(name = "cover_samaBun2", length = 3, order = 184)
    public RString cover_samaBun2;
    @ReportItem(name = "cover_samabunShimeiSmall2", length = 40, order = 185)
    public RString cover_samabunShimeiSmall2;
    @ReportItem(name = "cover_kakkoLeft2", length = 1, order = 186)
    public RString cover_kakkoLeft2;
    @ReportItem(name = "cover_samabunShimei2", length = 20, order = 187)
    public RString cover_samabunShimei2;
    @ReportItem(name = "cover_kakkoRight2", length = 1, order = 188)
    public RString cover_kakkoRight2;
    @ReportItem(name = "cover_kakkoLeft1", length = 1, order = 189)
    public RString cover_kakkoLeft1;
    @ReportItem(name = "cover_samabunShimei1", length = 20, order = 190)
    public RString cover_samabunShimei1;
    @ReportItem(name = "cover_samaBun1", length = 3, order = 191)
    public RString cover_samaBun1;
    @ReportItem(name = "cover_kakkoRight1", length = 1, order = 192)
    public RString cover_kakkoRight1;
    @ReportItem(name = "cover_samabunShimeiSmall1", length = 40, order = 193)
    public RString cover_samabunShimeiSmall1;
    @ReportItem(name = "cover_customerBarCode", order = 194)
    public RString cover_customerBarCode;
    @ReportItem(name = "cover_denshiKoin", order = 195)
    public RString cover_denshiKoin;
    @ReportItem(name = "cover_hakkoYMD", length = 12, order = 196)
    public RString cover_hakkoYMD;
    @ReportItem(name = "cover_ninshoshaYakushokuMei", length = 15, order = 197)
    public RString cover_ninshoshaYakushokuMei;
    @ReportItem(name = "cover_ninshoshaYakushokuMei1", order = 198)
    public RString cover_ninshoshaYakushokuMei1;
    @ReportItem(name = "cover_koinMojiretsu", length = 4, order = 199)
    public RString cover_koinMojiretsu;
    @ReportItem(name = "cover_ninshoshaYakushokuMei2", order = 200)
    public RString cover_ninshoshaYakushokuMei2;
    @ReportItem(name = "cover_ninshoshaShimeiKakenai", order = 201)
    public RString cover_ninshoshaShimeiKakenai;
    @ReportItem(name = "cover_ninshoshaShimeiKakeru", order = 202)
    public RString cover_ninshoshaShimeiKakeru;
    @ReportItem(name = "cover_koinShoryaku", length = 15, order = 203)
    public RString cover_koinShoryaku;
    @ReportItem(name = "cover_nofuzumishoTitleNendoBun1", length = 9, order = 204)
    public RString cover_nofuzumishoTitleNendoBun1;
    @ReportItem(name = "cover_nofuzumishoTitleKi1", length = 2, order = 205)
    public RString cover_nofuzumishoTitleKi1;
    @ReportItem(name = "cover_nofuzumishoTitleTsuki1", length = 2, order = 206)
    public RString cover_nofuzumishoTitleTsuki1;
    @ReportItem(name = "cover_nofozumishoTitleNendo1", length = 6, order = 207)
    public RString cover_nofozumishoTitleNendo1;
    @ReportItem(name = "cover_ryoshushoTitleNendo1", length = 6, order = 208)
    public RString cover_ryoshushoTitleNendo1;
    @ReportItem(name = "cover_ryoshushoTitleTsuki1", length = 2, order = 209)
    public RString cover_ryoshushoTitleTsuki1;
    @ReportItem(name = "cover_nofushoTitleNendo1", length = 6, order = 210)
    public RString cover_nofushoTitleNendo1;
    @ReportItem(name = "cover_nofushoTitleKi1", length = 2, order = 211)
    public RString cover_nofushoTitleKi1;
    @ReportItem(name = "cover_nofushoTitleTsuki1", length = 2, order = 212)
    public RString cover_nofushoTitleTsuki1;
    @ReportItem(name = "cover_ryoshushoTitleKi1", length = 2, order = 213)
    public RString cover_ryoshushoTitleKi1;
    @ReportItem(name = "cover_ryoshushoJusho1", order = 214)
    public RString cover_ryoshushoJusho1;
    @ReportItem(name = "cover_nofuzumishoTsuchishoNo1", order = 215)
    public RString cover_nofuzumishoTsuchishoNo1;
    @ReportItem(name = "cover_nofuzumishoOCR11", length = 19, order = 216)
    public RString cover_nofuzumishoOCR11;
    @ReportItem(name = "cover_ryoshushoKatagaki1", order = 217)
    public RString cover_ryoshushoKatagaki1;
    @ReportItem(name = "cover_nofuzumishoSetaiCode1", length = 15, order = 218)
    public RString cover_nofuzumishoSetaiCode1;
    @ReportItem(name = "cover_nofuzumishoOCR21", length = 20, order = 219)
    public RString cover_nofuzumishoOCR21;
    @ReportItem(name = "cover_ryoshushoHihokenshaName1", order = 220)
    public RString cover_ryoshushoHihokenshaName1;
    @ReportItem(name = "cover_nofushoHihokenshaName1", order = 221)
    public RString cover_nofushoHihokenshaName1;
    @ReportItem(name = "cover_nofuzumishoOCR31", length = 12, order = 222)
    public RString cover_nofuzumishoOCR31;
    @ReportItem(name = "cover_nofuzumishoNokigen1", length = 11, order = 223)
    public RString cover_nofuzumishoNokigen1;
    @ReportItem(name = "cover_ryoshushoTsuchishoNo1", order = 224)
    public RString cover_ryoshushoTsuchishoNo1;
    @ReportItem(name = "cover_nofushoTsuchishoNo1", order = 225)
    public RString cover_nofushoTsuchishoNo1;
    @ReportItem(name = "cover_ryoshushoHokenryoGaku1", length = 10, order = 226)
    public RString cover_ryoshushoHokenryoGaku1;
    @ReportItem(name = "cover_nofushoHokenryoGaku1", length = 10, order = 227)
    public RString cover_nofushoHokenryoGaku1;
    @ReportItem(name = "cover_nofuzumishoNofuGaku1", length = 10, order = 228)
    public RString cover_nofuzumishoNofuGaku1;
    @ReportItem(name = "cover_ryoshushoNokigen1", length = 11, order = 229)
    public RString cover_ryoshushoNokigen1;
    @ReportItem(name = "cover_nofushoNokigen1", length = 11, order = 230)
    public RString cover_nofushoNokigen1;
    @ReportItem(name = "cover_nofuzumishoJusho1", order = 231)
    public RString cover_nofuzumishoJusho1;
    @ReportItem(name = "cover_nofuzumishoKatagaki1", length = 30, order = 232)
    public RString cover_nofuzumishoKatagaki1;
    @ReportItem(name = "cover_ryoshushoNofuIn1", length = 2, order = 233)
    public RString cover_ryoshushoNofuIn1;
    @ReportItem(name = "cover_nofushoNofuIn1", length = 2, order = 234)
    public RString cover_nofushoNofuIn1;
    @ReportItem(name = "cover_nofuzumishoNofuIn1", length = 2, order = 235)
    public RString cover_nofuzumishoNofuIn1;
    @ReportItem(name = "cover_ryoshushoKozaCom1", length = 4, order = 236)
    public RString cover_ryoshushoKozaCom1;
    @ReportItem(name = "cover_nofushoKozaCom1", length = 4, order = 237)
    public RString cover_nofushoKozaCom1;
    @ReportItem(name = "cover_nofuzumishoHihokenshaName1", order = 238)
    public RString cover_nofuzumishoHihokenshaName1;
    @ReportItem(name = "cover_nofuzumishoKozaCom1", length = 4, order = 239)
    public RString cover_nofuzumishoKozaCom1;
    @ReportItem(name = "cover_ryoshushoZuiji1", length = 2, order = 240)
    public RString cover_ryoshushoZuiji1;
    @ReportItem(name = "cover_nofushoZuiji1", length = 2, order = 241)
    public RString cover_nofushoZuiji1;
    @ReportItem(name = "cover_nofuzumishoZuiji1", length = 2, order = 242)
    public RString cover_nofuzumishoZuiji1;
    @ReportItem(name = "cover_nofuzumishoshichosonName1", order = 243)
    public RString cover_nofuzumishoshichosonName1;
    @ReportItem(name = "cover_pagerenban4", length = 10, order = 244)
