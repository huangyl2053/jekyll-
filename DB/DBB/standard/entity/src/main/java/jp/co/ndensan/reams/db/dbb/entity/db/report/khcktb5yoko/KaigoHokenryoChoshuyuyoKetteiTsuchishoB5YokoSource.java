package jp.co.ndensan.reams.db.dbb.entity.db.report.khcktb5yoko;
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listKibetsu_4", length = 2, order = 8)
    public RString listKibetsu_4;
    @ReportItem(name = "listKibetsu_5", length = 2, order = 9)
    public RString listKibetsu_5;
    @ReportItem(name = "listKibetsu_6", length = 7, order = 10)
    public RString listKibetsu_6;
    @ReportItem(name = "listKibetsu_7", length = 19, order = 11)
    public RString listKibetsu_7;
    @ReportItem(name = "listZuiji_1", length = 2, order = 12)
    ...
    @ReportItem(name = "hyojicode1", length = 11, order = 16)
    public RString hyojicode1;
    @ReportItem(name = "hyojicode2", length = 9, order = 17)
    public RString hyojicode2;
    @ReportItem(name = "hyojicode3", length = 9, order = 18)
    ...
    @ReportItem(name = "hihokenshaNo", length = 10, order = 21)
    public RString hihokenshaNo;
    @ReportItem(name = "shikibetsucode", length = 15, order = 22)
    public RString shikibetsucode;
    @ReportItem(name = "choteiNendo", length = 4, order = 23)
    public RString choteiNendo;
    @ReportItem(name = "fukaNendo", length = 4, order = 24)
    public RString fukaNendo;
    @ReportItem(name = "ketteiKekka", length = 4, order = 25)
