...
/**
 * 介護保険料減免決定通知書 B5横タイプするクラスです。
 *
 * @reamsid_L DBB-0740-030 surun
 */
public class KaigoHokenryoGenmenKetteiTsuchishoYokoSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">

    @ReportItem(name = "bunshoNo", length = 36, order = 1)
    public RString bunshoNo;
    @ReportItem(name = "genmenKetteiYMD", length = 11, order = 2)
    public RString genmenKetteiYMD;
    @ReportItem(name = "hokenSanshutsuMae", length = 10, order = 3)
    public RString hokenSanshutsuMae;
    @ReportItem(name = "hokenSanshutsuAto", length = 10, order = 4)
    public RString hokenSanshutsuAto;
    @ReportItem(name = "genmenGakuMae", length = 10, order = 5)
    public RString genmenGakuMae;
    @ReportItem(name = "genmenGakuAto", length = 10, order = 6)
    public RString genmenGakuAto;
    @ReportItem(name = "hokenGakuMae", length = 10, order = 7)
    public RString hokenGakuMae;
    @ReportItem(name = "hokenGakuAto", length = 10, order = 8)
    public RString hokenGakuAto;
    @ReportItem(name = "genmenRiyu1", length = 30, order = 9)
    public RString genmenRiyu1;
    @ReportItem(name = "genmenRiyu2", length = 30, order = 10)
    public RString genmenRiyu2;
    @ReportItem(name = "listKibetsu_1", length = 2, order = 11)
    public RString listKibetsu_1;
    @ReportItem(name = "listKibetsu_2", length = 2, order = 12)
    public RString listKibetsu_2;
    @ReportItem(name = "listKibetsu_3", length = 7, order = 13)
    public RString listKibetsu_3;
    @ReportItem(name = "listKibetsu_4", length = 7, order = 14)
    public RString listKibetsu_4;
    @ReportItem(name = "listKibetsu_5", length = 2, order = 15)
    public RString listKibetsu_5;
    @ReportItem(name = "listKibetsu_6", length = 2, order = 16)
    public RString listKibetsu_6;
    @ReportItem(name = "listKibetsu_7", length = 7, order = 17)
    public RString listKibetsu_7;
    @ReportItem(name = "listKibetsu_8", length = 7, order = 18)
    public RString listKibetsu_8;
    @ReportItem(name = "listZuiji_1", length = 2, order = 19)
    ...
    @ReportItem(name = "hyojicode1", length = 11, order = 23)
    public RString hyojicode1;
    @ReportItem(name = "hyojicode2", length = 9, order = 24)
    public RString hyojicode2;
    @ReportItem(name = "hyojicode3", length = 9, order = 25)
    public RString hyojicode3;
    @ReportItem(name = "setaiCode", length = 15, order = 26)
    public RString setaiCode;
    @ReportItem(name = "tsuchishoNo", order = 27)
    public RString tsuchishoNo;
    @ReportItem(name = "hihokenshaNo", length = 10, order = 28)
    public RString hihokenshaNo;
    @ReportItem(name = "shikibetsuCode", length = 15, order = 29)
    public RString shikibetsuCode;
    @ReportItem(name = "choteiNendo", length = 4, order = 30)
    public RString choteiNendo;
    @ReportItem(name = "fukaNendo", length = 4, order = 31)
    public RString fukaNendo;
    @ReportItem(name = "ketteiKekka", length = 4, order = 32)
    ...
    @ReportItem(name = "shimei2", length = 20, order = 46)
    ...
    @ReportItem(name = "shimei1", length = 20, order = 52)
