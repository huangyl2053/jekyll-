 ...
 */
package jp.co.ndensan.reams.db.dbb.entity.report.source.nofugakuichirancodefumei;
...
/**
 * 帳票設計_DBBRP91003-2_納付額一覧表（識別コード不明分）のソースクラスです。
 *
 * @reamsid_L DBB-1890-050 qinzhen
 */
public class NofugakuIchiranCodeFumeiSource implements IReportSource {
