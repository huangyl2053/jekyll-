...
public final class DbT2002FukaEntityGenerator {
    ...
    public static final RString DEFAULT_資格喪失事由 = new RString("01");
    public static final RString DEFAULT_生活保護扶助種類 = new RString("01");
    public static final FlexibleDate DEFAULT_生保開始日 = new FlexibleDate("20141216");
    public static final FlexibleDate DEFAULT_生保廃止日 = new FlexibleDate("20141216");
    public static final FlexibleDate DEFAULT_老年開始日 = new FlexibleDate("20141216");
    public static final FlexibleDate DEFAULT_老年廃止日 = new FlexibleDate("20141216");
    public static final FlexibleDate DEFAULT_賦課期日 = new FlexibleDate("20141216");
    ...
    public static final RString DEFAULT_保険料段階 = new RString("010");
    public static final RString DEFAULT_保険料算定段階1 = new RString("010");
    public static final Decimal DEFAULT_算定年額保険料1 = new Decimal(1);
    public static final FlexibleYearMonth DEFAULT_月割開始年月1 = new FlexibleYearMonth("201401");
    public static final FlexibleYearMonth DEFAULT_月割終了年月1 = new FlexibleYearMonth("201401");
    public static final RString DEFAULT_保険料算定段階2 = new RString("010");
    ...
    public static final RString DEFAULT_調定事由4 = new RString("01");
    public static final RString DEFAULT_更正月 = new RString("01");
    ...
    public static final Decimal DEFAULT_特徴歳出還付額 = new Decimal(1);
    public static final Decimal DEFAULT_普徴歳出還付額 = new Decimal(1);
...
//        entity.setTkSaishutsuKampuGaku(DEFAULT_特徴歳出還付額);
//        entity.setFuSaishutsuKampuGaku(DEFAULT_普徴歳出還付額);
        return entity;
    }
}
