...
public final class DbT2002FukaEntityGenerator {
    ...
    public static final FlexibleYearMonth DEFAULT_月割開始年月1 = new FlexibleYear("1990");
    public static final FlexibleYearMonth DEFAULT_月割終了年月1 = new FlexibleYear("1990");
    public static final RString DEFAULT_保険料算定段階2 = new RString("Data");
    public static final Decimal DEFAULT_算定年額保険料2 = new Decimal(0);
    public static final FlexibleYearMonth DEFAULT_月割開始年月2 = new FlexibleYear("1990");
    public static final FlexibleYearMonth DEFAULT_月割終了年月2 = new FlexibleYear("1990");
    ...
    public static final Decimal DEFAULT_減免前介護保険料（年額） = new Decimal(0);
    public static final Decimal DEFAULT_減免額 = new Decimal(0);
    public static final Decimal DEFAULT_確定介護保険料（年額） = new Decimal(0);
    public static final RString DEFAULT_保険料段階（仮算定時） = new RString("Data");
    ...
    public static DbT2002FukaEntity createDbT2002FukaEntity() {
        ...
        entity.setGemmenMaeHokenryo(DEFAULT_減免前介護保険料（年額）);
        entity.setGemmenGaku(DEFAULT_減免額);
        entity.setKakuteiHokenryo(DEFAULT_確定介護保険料（年額）);
        entity.setHokenryoDankaiKarisanntei(DEFAULT_保険料段階（仮算定時）);
