...
public final class DbT2002FukaEntityGenerator {
    ...
    public static final RString DEFAULT_資格喪失事由 = new RString("00");
    public static final RString DEFAULT_生活保護扶助種類 = new RString("00");
    ...
    public static final RString DEFAULT_保険料段階 = new RString("001");
    public static final RString DEFAULT_保険料算定段階1 = new RString("001");
    ...
    public static final RString DEFAULT_保険料算定段階2 = new RString("001");
    ...
    public static final RString DEFAULT_保険料段階_仮算定時 = new RString("001");
    ...
    public static final RString DEFAULT_口座区分 = new RString("0");
    public static final RString DEFAULT_境界層区分 = new RString("0");
    public static final RString DEFAULT_職権区分 = new RString("0");
