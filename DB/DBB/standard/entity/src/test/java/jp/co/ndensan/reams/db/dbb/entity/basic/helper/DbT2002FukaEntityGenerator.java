...
public final class DbT2002FukaEntityGenerator {
    ...
    public static final int DEFAULT_世帯員数 = 0;
    ...
    public static final YMDHMS DEFAULT_調定日時 = new YMDHMS(RDateTime.of(1990, 1, 1, 8, 30, 0, 0));
    ...
    public static final int DEFAULT_徴収方法履歴番号 = 0;
    public static final YMDHMS DEFAULT_異動基準日時 = new YMDHMS(RDateTime.of(1990, 1, 1, 8, 30, 0, 0));
