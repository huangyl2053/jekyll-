...
public final class DbT2006ChoshuYuyoEntityGenerator {
    ...
    public static final FlexibleDate DEFAULT_徴収猶予申請年月日 = new FlexibleDate("20141216");
    public static final FlexibleDate DEFAULT_徴収猶予決定年月日 = new FlexibleDate("20141216");
    public static final FlexibleDate DEFAULT_徴収猶予取消年月日 = new FlexibleDate("20141216");
    ...
    public static final Code DEFAULT_徴収猶予種類コード = new Code("001");
    public static final RString DEFAULT_徴収猶予事由 = new RString("1");
    public static final Code DEFAULT_徴収猶予取消種類コード = new Code("001");
