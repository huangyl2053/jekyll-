...
public final class DbT2001ChoshuHohoEntityGenerator {
    ...
    public static final RString DEFAULT_仮徴収・基礎年金番号 = new RString("Data");
    public static final RString DEFAULT_仮徴収・年金コード = new RString("Data");
    public static final RString DEFAULT_仮徴収・捕捉月 = new RString("Data");
    public static final RString DEFAULT_本徴収・基礎年金番号 = new RString("Data");
    public static final RString DEFAULT_本徴収・年金コード = new RString("Data");
    public static final RString DEFAULT_本徴収・捕捉月 = new RString("Data");
    public static final RString DEFAULT_翌年度仮徴収・基礎年金番号 = new RString("Data");
    public static final RString DEFAULT_翌年度仮徴収・年金コード = new RString("Data");
    public static final RString DEFAULT_翌年度仮徴収・捕捉月 = new RString("Data");
    ...
    public static DbT2001ChoshuHohoEntity createDbT2001ChoshuHohoEntity() {
        ...
        entity.setKariNenkinNo(DEFAULT_仮徴収・基礎年金番号);
        entity.setKariNenkinCode(DEFAULT_仮徴収・年金コード);
        entity.setKariHosokuM(DEFAULT_仮徴収・捕捉月);
        entity.setHonNenkinNo(DEFAULT_本徴収・基礎年金番号);
        entity.setHonNenkinCode(DEFAULT_本徴収・年金コード);
        entity.setHonHosokuM(DEFAULT_本徴収・捕捉月);
        entity.setYokunendoKariNenkinNo(DEFAULT_翌年度仮徴収・基礎年金番号);
        entity.setYokunendoKariNenkinCode(DEFAULT_翌年度仮徴収・年金コード);
        entity.setYokunendoKariHosokuM(DEFAULT_翌年度仮徴収・捕捉月);
