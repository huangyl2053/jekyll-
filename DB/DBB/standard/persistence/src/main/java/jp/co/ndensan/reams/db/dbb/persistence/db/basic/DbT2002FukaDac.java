...
import static jp.co.ndensan.reams.db.dbb.entity.db.basic.DbT2002Fuka.choteiTimestamp;
...
public class DbT2002FukaDac implements ISaveable<DbT2002FukaEntity> {
    ...
    public DbT2002FukaEntity selectFor任意対象比較(
            ...
            FlexibleYear 賦課年度,
            HihokenshaNo 被保険者番号,
            RDateTime 更生日時) throws NullPointerException {
        requireNonNull(調定年度, UrSystemErrorMessages.値がnull.getReplacedMessage("調定年度"));
        requireNonNull(賦課年度, UrSystemErrorMessages.値がnull.getReplacedMessage("賦課年度"));
     ...
     */
    @Transaction
    public List<DbT2002FukaEntity> select(FlexibleYear 調定年度,
            FlexibleYear 賦課年度,
