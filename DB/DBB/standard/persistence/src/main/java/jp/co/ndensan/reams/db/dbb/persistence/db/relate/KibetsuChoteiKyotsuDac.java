...
public class KibetsuChoteiKyotsuDac implements IPersistable<UrT0705ChoteiKyotsuEntity> {
     ...
     */
    @Transaction
    public UrT0705ChoteiKyotsuEntity select介護期別調定共通ByKey(
            FlexibleYear 調定年度, FlexibleYear 賦課年度, TsuchishoNo 通知書番号, Decimal 履歴番号, RString 徴収方法, int 期) {
        ...
        return createModel(介護期別Dac.selectByKey(調定年度, 賦課年度, 通知書番号, 履歴番号, 徴収方法, 期));
    }
     ...
     */
    @Transaction
    public List<UrT0705ChoteiKyotsuEntity> select介護期別調定共通一覧(
            FlexibleYear 調定年度, FlexibleYear 賦課年度, TsuchishoNo 通知書番号, Decimal 履歴番号) {
        ...
        List<UrT0705ChoteiKyotsuEntity> 期別調定共通リスト = new ArrayList<>();
    ...
    private UrT0705ChoteiKyotsuEntity createModel(DbT2003KibetsuEntity 介護期別エンティティ) {
        ...
        return new UrT0705ChoteiKyotsuEntity();
