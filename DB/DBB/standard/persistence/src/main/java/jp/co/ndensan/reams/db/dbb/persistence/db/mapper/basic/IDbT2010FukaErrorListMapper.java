 ...
 */
public interface IDbT2010FukaErrorListMapper {

    /**
     * {@link DbT2010FukaErrorListEntity}を取得します。
     *
     * @return {@link DbT2010FukaErrorListEntity}
     * @deprecated マッピング検証用のメソッドであるため、テストコード以外から使用しないで下さい。
     */
    DbT2010FukaErrorListEntity getEntity();
}
