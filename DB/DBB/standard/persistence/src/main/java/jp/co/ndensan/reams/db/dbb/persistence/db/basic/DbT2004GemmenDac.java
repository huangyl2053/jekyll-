...
import static jp.co.ndensan.reams.db.dbb.entity.db.basic.DbT2004Gemmen.choteiNendo;
import static jp.co.ndensan.reams.db.dbb.entity.db.basic.DbT2004Gemmen.fukaNendo;
import static jp.co.ndensan.reams.db.dbb.entity.db.basic.DbT2004Gemmen.rirekiNo;
import static jp.co.ndensan.reams.db.dbb.entity.db.basic.DbT2004Gemmen.tsuchishoNo;
 ...
 */
public class DbT2004GemmenDac implements ISaveable<DbT2004GemmenEntity> {
    ...
    /**
     * DbT2004GemmenEntityを登録します。状態によってinsert/update/delete処理に振り分けられます。
     *
     * @param entity entity
     * @return 登録件数
     */
    @Transaction
    @Override
    public int save(DbT2004GemmenEntity entity) {
     ...
     */
    @Transaction
    public DbT2004GemmenEntity get減免の情報(
            FlexibleYear 調定年度,
            FlexibleYear 賦課年度,
            TsuchishoNo 通知書番号) {
