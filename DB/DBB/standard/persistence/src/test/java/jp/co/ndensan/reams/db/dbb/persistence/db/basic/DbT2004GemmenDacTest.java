...
public class DbT2004GemmenDacTest extends DbbTestDacBase {
    ...
    public static class updateのテスト extends DbbTestDacBase {
        ...
        public void 介護賦課減免エンティティを渡すと_updateは_介護賦課減免を更新する() {
            DbT2004GemmenEntity updateRecord = sut.selectByKey(
                    DEFAULT_調定年度,
                    DEFAULT_賦課年度,
                    DEFAULT_通知書番号,
                    DEFAULT_履歴番号);
            updateRecord.setJotaiKubun(new RString("2"));
            ...
            assertThat(updateRecord.getJotaiKubun(), is(updatedRecord.getJotaiKubun()));
        }
    }
    ...
    public static class deleteのテスト extends DbbTestDacBase {
        ...
        public void 介護賦課減免エンティティを渡すと_deleteは_介護賦課減免を削除する() {
            DbT2004GemmenEntity deletedEntity = sut.selectByKey(
                    DEFAULT_調定年度,
                    DEFAULT_賦課年度,
                    DEFAULT_通知書番号,
                    DEFAULT_履歴番号);
