...
import static jp.co.ndensan.reams.db.dbb.entity.basic.helper.UrT0705ChoteiKyotsuEntityGenerator.*;
...
/**
 * {@link ChoteiKyotsuDac}のテストです。
 *
 * @author N8156 宮本 康
 */
@RunWith(Enclosed.class)
public class ChoteiKyotsuDacTest extends DbbTestDacBase {

    private static ChoteiKyotsuDac sut;

    @BeforeClass
    public static void setUpClass() {
        sut = InstanceProvider.create(ChoteiKyotsuDac.class);
    }
