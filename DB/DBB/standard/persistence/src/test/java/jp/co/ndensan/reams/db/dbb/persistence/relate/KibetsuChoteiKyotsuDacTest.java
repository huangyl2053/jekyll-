...
public class KibetsuChoteiKyotsuDacTest {
    ...
    private static KibetsuDac 介護期別Dac;
    private static ChoteiKyotsuDac 調定共通Dac;
    ...
    public static void setUpClass() {
        ...
        介護期別Dac = InstanceProvider.create(KibetsuDac.class);
        調定共通Dac = InstanceProvider.create(ChoteiKyotsuDac.class);
    }
