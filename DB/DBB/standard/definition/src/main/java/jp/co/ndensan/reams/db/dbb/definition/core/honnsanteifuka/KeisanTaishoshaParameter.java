...
public final class KeisanTaishoshaParameter implements IMyBatisParameter {
    ...
    private final FlexibleDate 調定年度_修正後;
     ...
     * @param 調定年度_修正後 FlexibleDate
     */
    private KeisanTaishoshaParameter(FlexibleYear 調定年度,
            FlexibleYear 賦課年度,
            FlexibleDate 資格基準日,
            FlexibleDate 調定年度_修正後) {
        this.調定年度 = 調定年度;
        this.賦課年度 = 賦課年度;
        this.資格基準日 = 資格基準日;
        this.調定年度_修正後 = 調定年度_修正後;
    }
    ...
    public static KeisanTaishoshaParameter createSelectByKeyParam(FlexibleYear 調定年度,
            ...
            FlexibleDate 資格基準日,
            FlexibleDate 調定年度_修正後) {
        return new KeisanTaishoshaParameter(調定年度, 賦課年度, 資格基準日, 調定年度_修正後);
    }
}
