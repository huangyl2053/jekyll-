 ...
 */
package jp.co.ndensan.reams.db.dbb.definition.batchprm.honsanteiidokanendoikkatsuhakko;
...
/**
 * 本算定異動（過年度）通知書一括発行バッチのパラメータです。
 *
 * @reamsid_L DBB-0920-030 zhangrui
 */
@SuppressWarnings("PMD.UnusedPrivateField")
@lombok.Getter
@lombok.Setter
public class HonSanteiIdoKanendoIkkatsuHakkoBatchParameter extends BatchParameterBase {
    ...
    private List<RString> 決定_対象賦課年度;
    ...
    private List<RString> 変更_対象賦課年度;
    ...
    private List<RString> 納入_対象賦課年度;
