...
/**
 * 保険料ランクの情報を特定するためのMyBatis用パラメータクラスです。
 *
...
public final class HokenryoDankaiJohoRelateMapperParameter {
     ...
     */
    private HokenryoDankaiJohoRelateMapperParameter(
     ...
     * @return 身体手帳検索パラメータ
     */
    public static HokenryoDankaiJohoRelateMapperParameter createSelectByKeyParam(
            FlexibleYear 賦課年度,
            RString ランク区分) {
        return new HokenryoDankaiJohoRelateMapperParameter(賦課年度, ランク区分, true, true);
    }
}
