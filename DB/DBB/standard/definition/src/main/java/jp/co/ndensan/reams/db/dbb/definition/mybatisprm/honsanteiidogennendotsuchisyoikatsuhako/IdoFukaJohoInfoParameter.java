...
public class IdoFukaJohoInfoParameter extends KozaSearchParameter implements IMyBatisParameter {
     ...
     * @param 最新調定日時 YMDHMS
     */
    public IdoFukaJohoInfoParameter(
            FlexibleYear 調定年度,
            FlexibleYear 賦課年度,
            RString 処理日,
     ...
     * @return パラメータ
     */
    public static IdoFukaJohoInfoParameter createSelectByKeyParam(
            FlexibleYear 調定年度,
            FlexibleYear 賦課年度,
            RString 処理日,
            IKozaSearchKey searchkey,
            ...
            RString 科目コード,
            YMDHMS 最新調定日時) {
        return new IdoFukaJohoInfoParameter(調定年度, 賦課年度, 処理日, searchkey, list, 科目コード, 最新調定日時);
    }
}
