...
public final class IdoOrZenkenFukaSelectParameter implements IMyBatisParameter {
     ...
     * @return パラメータ
     */
    public static IdoOrZenkenFukaSelectParameter createSelectByKeyParam(
            int 出力期,
            RString 口座区分,
            RString 処理対象,
            RString 通知書プリント条件,
            RString 出力順) {
        return new IdoOrZenkenFukaSelectParameter(出力期, 口座区分, 処理対象, 通知書プリント条件, 出力順);
    }
}
