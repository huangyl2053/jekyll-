...
// テストクラス名は適切に変更してください
    public static class createSelectByKeyParamテスト extends DbbTestBase {
        ...
        public void 主キー1にNullを指定すると_NullPointerExceptionが発生する() {
            ChoshuYuyoMapperParameter sut = ChoshuYuyoMapperParameter.createSelectByKeyParam(null, 主キー2);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー2にNullを指定すると_NullPointerExceptionが発生する() {
            ChoshuYuyoMapperParameter sut = ChoshuYuyoMapperParameter.createSelectByKeyParam(主キー1, null);
        }

        @Test
        public void 引数にNull以外を指定すると_パラメータが生成できる() {
            ChoshuYuyoMapperParameter sut = ChoshuYuyoMapperParameter.createSelectByKeyParam(主キー1, 主キー2);
...
// 用途に応じたパラメータ生成メソッドのテストクラスを追加してください。
    public static class createSelectListParamテスト extends DbbTestBase {
        ...
        @Test(expected = NullPointerException.class)
        public void 主キー1にNullを指定すると_NullPointerExceptionが発生する() {
            ChoshuYuyoMapperParameter sut = ChoshuYuyoMapperParameter.createSelectListParam(null);
        }

        @Test
        public void 引数にNull意外を指定すると_パラメータが生成できる() {
            ChoshuYuyoMapperParameter sut = ChoshuYuyoMapperParameter.createSelectListParam(主キー1);
