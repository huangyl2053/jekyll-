...
/**
 * 特徴依頼金額計算方法6月のテストクラスです。
 *
 * @author LDNS
 */
public class TokuchoIraikingakuKeisanHoho6GatsuTest extends DbbTestBase {

    @Test(expected = NullPointerException.class)
    public void 引数がNullである場合_toValueは_NullPointerExceptionが発生する() {
        TokuchoIraikingakuKeisanHoho6Gatsu.toValue(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void 引数に想定外の99999を指定した場合_toValueは_IllegalArgumentExceptionが発生する() {
        TokuchoIraikingakuKeisanHoho6Gatsu.toValue(new RString("99999"));
    }
    ...
    @Test
    public void 引数に3を指定した場合_toValueは_年額を納期数_5期_で割るを返す() {
        assertThat(TokuchoIraikingakuKeisanHoho6Gatsu.toValue(new RString("3")), is(TokuchoIraikingakuKeisanHoho6Gatsu.年額を納期数_5期_で割る));
    }
    ...
    @Test
    public void 年額を納期数_5期_で割るを指定した場合_getコードは_3を返す() {
        assertThat(TokuchoIraikingakuKeisanHoho6Gatsu.年額を納期数_5期_で割る.getコード(), is(new RString("3")));
    }
