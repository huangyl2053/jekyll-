...
public class TokuchoKaishiTsuki8GatsuHosokuTest extends DbbTestBase {
    ...
    public void 引数に02を指定した場合_toValueは_02月を返す() {
        assertThat(TokuchoKaishiTsuki8GatsuHosoku.toValue(new RString("02")), is(TokuchoKaishiTsuki8GatsuHosoku._02月));
    }

    @Test
    public void 引数に04を指定した場合_toValueは_04月を返す() {
        assertThat(TokuchoKaishiTsuki8GatsuHosoku.toValue(new RString("04")), is(TokuchoKaishiTsuki8GatsuHosoku._04月));
    }
    ...
    public void _02月を指定した場合_getコードは_02を返す() {
        assertThat(TokuchoKaishiTsuki8GatsuHosoku._02月.getコード(), is(new RString("02")));
    }

    @Test
    public void _04月を指定した場合_getコードは_04を返す() {
        assertThat(TokuchoKaishiTsuki8GatsuHosoku._04月.getコード(), is(new RString("04")));
    }
    ...
    public void _02月を指定した場合_get名称は__2月開始を返す() {
        assertThat(TokuchoKaishiTsuki8GatsuHosoku._02月.get名称(), is(new RString("_2月開始")));
    }

    @Test
    public void _04月を指定した場合_get名称は__4月開始_待機を返す() {
        assertThat(TokuchoKaishiTsuki8GatsuHosoku._04月.get名称(), is(new RString("_4月開始_待機")));
    }
    ...
    public void _02月を指定した場合_get略称は_02月を返す() {
        assertThat(TokuchoKaishiTsuki8GatsuHosoku._02月.get略称(), is(new RString("02月")));
    }

    @Test
    public void _04月を指定した場合_get略称は_04月を返す() {
        assertThat(TokuchoKaishiTsuki8GatsuHosoku._04月.get略称(), is(new RString("04月")));
    }
