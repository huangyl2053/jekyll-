...
public class HenkoJiyuTest extends DbbTestBase {
    ...
    @Test
    public void 氏名変更を指定した場合_get略称は_氏名変更を返す() {
        assertThat(HenkoJiyu.氏名変更.get略称(), is(new RString("氏名変更")));
    }

    @Test
    public void _生年月日変更を指定した場合_get略称は_を返す() {
        assertThat(HenkoJiyu.生年月日変更.get略称(), is(new RString("〃")));
    }

    @Test
    public void 性別変更を指定した場合_get略称は_を返す() {
        assertThat(HenkoJiyu.性別変更.get略称(), is(new RString("〃")));
    }

    @Test
    public void 住所等変更を指定した場合_get略称は_を返す() {
        assertThat(HenkoJiyu.住所等変更.get略称(), is(new RString("〃")));
    }

    @Test
    public void 行政区変更を指定した場合_get略称は_を返す() {
        assertThat(HenkoJiyu.行政区変更.get略称(), is(new RString("〃")));
    }

    @Test
    public void 代納人変更を指定した場合_get略称は_を返す() {
        assertThat(HenkoJiyu.代納人変更.get略称(), is(new RString("〃")));
    }

    @Test
    public void 連絡先変更を指定した場合_get略称は_を返す() {
        assertThat(HenkoJiyu.連絡先変更.get略称(), is(new RString("〃")));
    }

    @Test
    public void 口座情報変更を指定した場合_get略称は_を返す() {
        assertThat(HenkoJiyu.口座情報変更.get略称(), is(new RString("〃")));
    }

    @Test
    public void 資格変更を指定した場合_get略称は_を返す() {
        assertThat(HenkoJiyu.資格変更.get略称(), is(new RString("〃")));
    }

    @Test
    public void 老齢年金変更を指定した場合_get略称は_を返す() {
        assertThat(HenkoJiyu.老齢年金変更.get略称(), is(new RString("〃")));
    }

    @Test
    public void 生活保護変更を指定した場合_get略称は_を返す() {
        assertThat(HenkoJiyu.生活保護変更.get略称(), is(new RString("〃")));
    }

    @Test
    public void 所得更正を指定した場合_get略称は_を返す() {
        assertThat(HenkoJiyu.所得更正.get略称(), is(new RString("〃")));
    }

    @Test
    public void 世帯員変更を指定した場合_get略称は_を返す() {
        assertThat(HenkoJiyu.世帯員変更.get略称(), is(new RString("〃")));
    }
