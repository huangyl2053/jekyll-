...
/**
 * dgTokuchoTaishoshaDoteiShoriKakuninKoiki_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgTokuchoTaishoshaDoteiShoriKakuninKoiki_Row extends DataRow {
    ...
    public dgTokuchoTaishoshaDoteiShoriKakuninKoiki_Row() {
        super();
        this.txtShichosonCode = new TextBox();
        this.txtShichosonMei = new TextBox();
        ...
        this.setOriginalData("txtShichosonMei", txtShichosonMei);
    ...
    public dgTokuchoTaishoshaDoteiShoriKakuninKoiki_Row(TextBox txtShichosonCode, TextBox txtShichosonMei, TextBox txtShoriMei, TextBox txtJokyo, TextBox txtShoriNichiji) {
        super();
        this.setOriginalData("txtShichosonCode", txtShichosonCode);
        this.setOriginalData("txtShichosonMei", txtShichosonMei);
        this.setOriginalData("txtShoriMei", txtShoriMei);
