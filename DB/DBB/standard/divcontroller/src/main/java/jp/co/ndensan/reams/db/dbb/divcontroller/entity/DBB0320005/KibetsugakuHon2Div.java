...
/**
 * KibetsugakuHon2 のクラスファイル 
 * 
 * @author 自動生成
 */
public class KibetsugakuHon2Div extends Panel {
    /*
     * [ private の作成 ]
     ...
     */
    @JsonProperty("ccdKiwarigakuHon2")
    private KiwarigakuDiv ccdKiwarigakuHon2;
