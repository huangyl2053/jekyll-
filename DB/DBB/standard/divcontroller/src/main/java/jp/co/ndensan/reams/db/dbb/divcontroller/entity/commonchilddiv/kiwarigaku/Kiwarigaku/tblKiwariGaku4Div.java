...
public class tblKiwariGaku4Div extends TablePanel {
    ...
    /*
     * setcelTokuchoKiGokei
     * @param celTokuchoKiGokei celTokuchoKiGokei
     */
    @JsonProperty("celTokuchoKiGokei")
    ...
    /*
     * setcelTokuchoKibetsuGakuGokei
     * @param celTokuchoKibetsuGakuGokei celTokuchoKibetsuGakuGokei
     */
    @JsonProperty("celTokuchoKibetsuGakuGokei")
    ...
    /*
     * setcelTokuchoNofuGakuGokei
     * @param celTokuchoNofuGakuGokei celTokuchoNofuGakuGokei
     */
    @JsonProperty("celTokuchoNofuGakuGokei")
    ...
    /*
     * setcelFuchoKiGokei
     * @param celFuchoKiGokei celFuchoKiGokei
     */
    @JsonProperty("celFuchoKiGokei")
    ...
    /*
     * setcelFuchoKibetsuGakuGokei
     * @param celFuchoKibetsuGakuGokei celFuchoKibetsuGakuGokei
     */
    @JsonProperty("celFuchoKibetsuGakuGokei")
    ...
    /*
     * setcelFuchoNofuGakuGokei
     * @param celFuchoNofuGakuGokei celFuchoNofuGakuGokei
     */
    @JsonProperty("celFuchoNofuGakuGokei")
...
class celTokuchoKiGokeiAttblKiwariGaku4 extends TableCell {
    ...
    /*
     * setlblTokuchoKiGokei
     * @param lblTokuchoKiGokei lblTokuchoKiGokei
     */
    @JsonProperty("lblTokuchoKiGokei")
...
class celTokuchoKibetsuGakuGokeiAttblKiwariGaku4 extends TableCell {
    ...
    /*
     * setlblTokuKibetsuGakuGokei
     * @param lblTokuKibetsuGakuGokei lblTokuKibetsuGakuGokei
     */
    @JsonProperty("lblTokuKibetsuGakuGokei")
...
class celTokuchoNofuGakuGokeiAttblKiwariGaku4 extends TableCell {
    ...
    /*
     * setlblTokuNofuGakuGokei
     * @param lblTokuNofuGakuGokei lblTokuNofuGakuGokei
     */
    @JsonProperty("lblTokuNofuGakuGokei")
...
class celFuchoKiGokeiAttblKiwariGaku4 extends TableCell {
    ...
    /*
     * setlblFuchoKiGokei
     * @param lblFuchoKiGokei lblFuchoKiGokei
     */
    @JsonProperty("lblFuchoKiGokei")
...
class celFuchoKibetsuGakuGokeiAttblKiwariGaku4 extends TableCell {
    ...
    /*
     * setlblFuchoKibetsuGakuGokei
     * @param lblFuchoKibetsuGakuGokei lblFuchoKibetsuGakuGokei
     */
    @JsonProperty("lblFuchoKibetsuGakuGokei")
...
class celFuchoNofuGakuGokeiAttblKiwariGaku4 extends TableCell {
    ...
    /*
     * setlblFuchoNofuGakuGokei
     * @param lblFuchoNofuGakuGokei lblFuchoNofuGakuGokei
     */
    @JsonProperty("lblFuchoNofuGakuGokei")
