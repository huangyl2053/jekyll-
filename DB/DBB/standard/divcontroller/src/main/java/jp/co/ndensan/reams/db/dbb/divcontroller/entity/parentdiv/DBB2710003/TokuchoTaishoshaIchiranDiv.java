...
public class TokuchoTaishoshaIchiranDiv extends Panel {
     ...
     */
    @JsonProperty("TokuchoTaishoshaIchiranSelectJoken")
    private TokuchoTaishoshaIchiranSelectJokenDiv TokuchoTaishoshaIchiranSelectJoken;
     ...
     */
    /*
     * getTokuchoTaishoshaIchiranSelectJoken
     * @return TokuchoTaishoshaIchiranSelectJoken
     */
    @JsonProperty("TokuchoTaishoshaIchiranSelectJoken")
    public TokuchoTaishoshaIchiranSelectJokenDiv getTokuchoTaishoshaIchiranSelectJoken() {
        return TokuchoTaishoshaIchiranSelectJoken;
    }

    /*
     * setTokuchoTaishoshaIchiranSelectJoken
     * @param TokuchoTaishoshaIchiranSelectJoken TokuchoTaishoshaIchiranSelectJoken
     */
    @JsonProperty("TokuchoTaishoshaIchiranSelectJoken")
    public void setTokuchoTaishoshaIchiranSelectJoken(TokuchoTaishoshaIchiranSelectJokenDiv TokuchoTaishoshaIchiranSelectJoken) {
        this.TokuchoTaishoshaIchiranSelectJoken = TokuchoTaishoshaIchiranSelectJoken;
    }
    ...
    public TextBox getTxtKaishiYM() {
        return this.getTokuchoTaishoshaIchiranSelectJoken().getTxtKaishiYM();
    }

    @JsonIgnore
    public void  setTxtKaishiYM(TextBox txtKaishiYM) {
        this.getTokuchoTaishoshaIchiranSelectJoken().setTxtKaishiYM(txtKaishiYM);
    }
