...
public class FukaHikakuZennendo1Div extends Panel {
    ...
    @JsonProperty("lblNengakuHokensryo1")
    private Label lblNengakuHokensryo1;
    ...
    @JsonProperty("lblNengakuHokensryo1")
    public Label getLblNengakuHokensryo1() {
        return lblNengakuHokensryo1;
    }

    @JsonProperty("lblNengakuHokensryo1")
    public void setLblNengakuHokensryo1(Label lblNengakuHokensryo1) {
        this.lblNengakuHokensryo1=lblNengakuHokensryo1;
    }
