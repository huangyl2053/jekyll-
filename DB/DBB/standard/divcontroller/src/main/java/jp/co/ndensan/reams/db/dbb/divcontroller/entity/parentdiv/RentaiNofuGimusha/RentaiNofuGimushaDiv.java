package jp.co.ndensan.reams.db.dbb.divcontroller.entity.parentdiv.RentaiNofuGimusha;
/**
 * このコードはツールによって生成されました。
 * このファイルへの変更は、再生成時には損失するため
 * 不正な動作の原因になります。
 */
import jp.co.ndensan.reams.db.dbb.divcontroller.entity.parentdiv.RentaiNofuGimusha.IRentaiNofuGimushaDiv;
