...
public class SokujiFukaKouseiKanryoDiv extends Panel {
     ...
     */
    @JsonProperty("SokujiFukaKouseiKanryoMsg")
    public KaigoKanryoMessageDiv getSokujiFukaKouseiKanryoMsg() {
        return SokujiFukaKouseiKanryoMsg;
    }

    @JsonProperty("SokujiFukaKouseiKanryoMsg")
    public void setSokujiFukaKouseiKanryoMsg(KaigoKanryoMessageDiv SokujiFukaKouseiKanryoMsg) {
        this.SokujiFukaKouseiKanryoMsg=SokujiFukaKouseiKanryoMsg;
    }
