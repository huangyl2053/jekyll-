 ...
 */
public class IkkatsuGenmenValidationHandler {
     ...
     */
    public IkkatsuGenmenValidationHandler(IkkatsuGenmenDiv div) {
        this.div = div;
    }
    ...
    private ValidationDictionary createDictionary() {
        ...
        return new ValidationDictionaryBuilder().
                add(IdocheckMessages.必須設定項目_決定日, div.getTxtKetteiYMD()).
                build();
    }

    private static enum KokuhorenTorikomiListSpec implements IPredicate<IkkatsuGenmenDiv> {

        必須設定項目_決定日 {
                    @Override
                    public boolean apply(IkkatsuGenmenDiv div) {
                        return div.getTxtKetteiYMD().getValue() != null
                        && !div.getTxtKetteiYMD().getValue().isEmpty();
                    }
                }
    }
