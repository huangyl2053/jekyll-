...
public class dgTaishoshaIchiran_Row extends DataRow {
    ...
    public dgTaishoshaIchiran_Row(RString txtChoteiNendo, RString txtTsuchiNo, RString txtHihoNo, RString txtName, TextBoxFlexibleDate txtUmareYmd, RString txtSeibetsu, RString txtShubetsu, RString txtJusho, RString txtShikbetsuCode) {
        super();
