...
public class dgShotokuShokaiHyoHakko_Row extends DataRow {
    ...
    private RString txtShikaku;
    private RString txtTennyumaeJusho;
    private TextBoxFlexibleDate txtTennnyubi;
    private RString txtKetsugo04;
    private RString txtTenshutsusakiJusho;
    private TextBoxFlexibleDate txtTenshutsubi;
    ...
    public TextBoxFlexibleDate getTxtTennnyubi() {
        return txtTennnyubi;
    }
    ...
    public TextBoxFlexibleDate getTxtTenshutsubi() {
        return txtTenshutsubi;
    }
    ...
    public void setTxtShikaku(RString txtShikaku) {
        this.setOriginalData("txtShikaku", txtShikaku);
        this.txtShikaku = txtShikaku;
    }
    ...
    public void setTxtTennnyubi(TextBoxFlexibleDate txtTennnyubi) {
        this.setOriginalData("txtTennnyubi", txtTennnyubi);
        this.txtTennnyubi = txtTennnyubi;
    }
    ...
    public void setTxtTenshutsubi(TextBoxFlexibleDate txtTenshutsubi) {
        this.setOriginalData("txtTenshutsubi", txtTenshutsubi);
        this.txtTenshutsubi = txtTenshutsubi;
    }
