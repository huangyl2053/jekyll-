...
public class SokujiKouseiJumin {
    ...
    public ResponseData<SokujiKouseiJuminDiv> onLoad_SokujiKouseiJumin(SokujiKouseiJuminDiv sokujiKouseiJuminDiv) {
        ...
        sokujiKouseiJuminDiv.getSokujiKouseiKihon().getTxtShutokuYmd().setValue(new RDate(SokujiKouseiKihonData.get(0).get("資格取得日").toString()));
        ...
        sokujiKouseiJuminDiv.getSokujiKouseiKihon().getTxtSoshitsuYmd().setValue(new RDate(SokujiKouseiKihonData.get(0).get("資格喪失日").toString()));
