...
/**
 * dgTanitsuShoriJoken_Row のクラスファイル
 *
 * @reamsid_L DBB-1890-010 chenhui
 */
public class dgTanitsuShoriJoken_Row extends DataRow {
    ...
    public dgTanitsuShoriJoken_Row() {
        super();
    ...
    public dgTanitsuShoriJoken_Row(RString txtCityCode, RString txtCityName, RString txtCityShikibetsuId, RString txtShukeibiKbnData, TextBox txtShukeibiKbn, TextBox txtKikanStHosei, TextBox txtKikanEdHosei, TextBox txtZenShoriNichiji, TextBoxDate txtZenShoriYMD, TextBoxTime txtZenShoriTime) {
        super();
        this.setOriginalData("txtCityCode", txtCityCode);
        this.setOriginalData("txtCityName", txtCityName);
        this.setOriginalData("txtCityShikibetsuId", txtCityShikibetsuId);
