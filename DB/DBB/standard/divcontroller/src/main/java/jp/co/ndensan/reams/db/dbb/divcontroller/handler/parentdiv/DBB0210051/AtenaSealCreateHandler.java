...
public class AtenaSealCreateHandler {
    ...
    private final RString 定数_000000 = new RString("000000");
    private final RString 定数_000001 = new RString("000001");
    private final RString 全市町村 = new RString("全市町村");
    private final RString 定数_111 = new RString("111");
    private final RString 定数_112 = new RString("112");
    private final RString 定数_120 = new RString("120");
    private final RString 定数_00 = new RString("00");
    private final RString 定数_0 = new RString("0");
    private final RString 定数_1 = new RString("1");
    private final RString 定数_2 = new RString("2");
    private final RString 定数_3 = new RString("3");
    private final RString 定数_4 = new RString("4");
    private final RString 定数_5 = new RString("5");
    private final RString 定数_6 = new RString("6");
    private final RString 定数_7 = new RString("7");
    private final RString 定数_12 = new RString("12");
    ...
    private final RString 現住所 = new RString("現住所");
    private final RString 送付先又は代納人 = new RString("送付先又は代納人");
    private final RString 表示する = new RString("表示する");
    private final RString 表示しない = new RString("表示しない");
    ...
    //TODO QA1505
    private final ReportId 帳票分類ID = ReportIdDBZ.DBZ100001.getReportId();
    ...
    public DBB021051_AtenaSealSakuseiParameter setバッチパラメータ() {
        ...
        RString 資格区分 = 資格区分取得(div.getDdlShikakuKubun().getSelectedKey());
    ...
    private RString 資格区分取得(RString 資格区分のkey) {
