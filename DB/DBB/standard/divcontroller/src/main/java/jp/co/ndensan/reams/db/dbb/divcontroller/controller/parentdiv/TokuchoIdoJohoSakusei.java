...
import jp.co.ndensan.reams.db.dbb.divcontroller.entity.parentdiv.TokuchoIdoJohoSakuseiDiv;
...
//        panel.getTbldgTokuchoIdoJoho().getLblTokuchotsuikaIrai06().setText(cg06.getAsRString("特徴追加依頼"));
        ...
        //7月
        ControlGenerator cg07 = new ControlGenerator(demoDataList.get(INDEX_3));
        ...
        //8月
        ControlGenerator cg08 = new ControlGenerator(demoDataList.get(INDEX_4));
...
//        panel.getTbldgTokuchoIdoJoho().getLblTokuchotsuikaIrai08().setText(cg08.getAsRString("特徴追加依頼"));
        ...
        //9月
        ControlGenerator cg09 = new ControlGenerator(demoDataList.get(INDEX_5));
        ...
        //10月
        ControlGenerator cg10 = new ControlGenerator(demoDataList.get(INDEX_6));
...
//        panel.getTbldgTokuchoIdoJoho().getLblTokuchotsuikaIrai10().setText(cg10.getAsRString("特徴追加依頼"));
        //11月
        ControlGenerator cg11 = new ControlGenerator(demoDataList.get(INDEX_7));
        ...
        //12月
        ControlGenerator cg12 = new ControlGenerator(demoDataList.get(INDEX_8));
...
//        panel.getTbldgTokuchoIdoJoho().getLblTokuchotsuikaIrai12().setText(cg12.getAsRString("特徴追加依頼"));
        //1月
        ControlGenerator cg01 = new ControlGenerator(demoDataList.get(INDEX_9));
        ...
        //2月
        ControlGenerator cg02 = new ControlGenerator(demoDataList.get(INDEX_10));
...
//        panel.getTbldgTokuchoIdoJoho().getLblTokuchotsuikaIrai02().setText(cg02.getAsRString("特徴追加依頼"));
        ...
        //3月
        ControlGenerator cg03 = new ControlGenerator(demoDataList.get(INDEX_11));
