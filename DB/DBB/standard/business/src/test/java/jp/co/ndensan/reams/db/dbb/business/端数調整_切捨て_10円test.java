 ...
 * @author n3336
 */
public class 端数調整_切捨て_10円test {
    
    public 端数調整_切捨て_10円test() {
    }
    ...
    @Test
    public void _10円切捨てできているか(){
        I端数調整 test = new 端数調整_切捨て_10円();
        assertThat(test.Calc端数(new Decimal("9999")), is(new Decimal("9990")));
    }
    
    @Test
    public void _10円切捨てできているか_末尾0の場合(){
        I端数調整 test = new 端数調整_切捨て_10円();
