 ...
 */
public class HokenryoNonyuTsuchishoGinfuriFourKiRenchoReport extends INonyuTsuchisho<HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource> {
    ...
    public static HokenryoNonyuTsuchishoGinfuriFourKiRenchoReport createFrom(
        ...
        return new HokenryoNonyuTsuchishoGinfuriFourKiRenchoReport(本算定納入通知書情報, ninshoshaSource);
    }
    ...
    private HokenryoNonyuTsuchishoGinfuriFourKiRenchoReport getNewReport(List<NonyuTsuchiShoKiJoho> 納入通知書期情報リストReport) {
        ...
        HokenryoNonyuTsuchishoGinfuriFourKiRenchoReport report
                = HokenryoNonyuTsuchishoGinfuriFourKiRenchoReport
