...
/**
 * 保険料納入通知書（本算定過年度）【コンビニ角公タイプ】のBuilderのインターフェースクラスです。
 *
 */
interface IKanendoNonyuTsuchishoCVSKakukoBuilder extends IReportBuilder<KanendoNonyuTsuchishoCVSKakukoSource> {
