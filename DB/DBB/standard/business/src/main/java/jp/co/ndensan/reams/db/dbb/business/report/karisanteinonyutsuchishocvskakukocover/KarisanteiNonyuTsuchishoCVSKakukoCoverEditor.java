...
//    private final RString HOSHI_28 = new RString("****************************");
     ...
     */
    protected KarisanteiNonyuTsuchishoCVSKakukoCoverEditor(KariSanteiNonyuTsuchiShoJoho item) {
        this.item = item;
    }

    @Override
    public KarisanteiNonyuTsuchishoCVSKakukoCoverSource edit(KarisanteiNonyuTsuchishoCVSKakukoCoverSource source) {
        return editSource(source);
    }

    private KarisanteiNonyuTsuchishoCVSKakukoCoverSource editSource(KarisanteiNonyuTsuchishoCVSKakukoCoverSource source) {
