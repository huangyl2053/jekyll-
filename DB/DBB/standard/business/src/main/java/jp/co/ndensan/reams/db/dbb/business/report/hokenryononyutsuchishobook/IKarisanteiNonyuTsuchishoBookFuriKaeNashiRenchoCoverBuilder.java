...
/**
 *
 * 保険料納入通知書（仮算定）【ブックタイプ】（口振依頼なし）通知書_連帳 IKarisanteiNonyuTsuchishoBookFuriKaeNashiRenchoCoverBuilder
 */
public interface IKarisanteiNonyuTsuchishoBookFuriKaeNashiRenchoCoverBuilder
        extends IReportBuilder<KarisanteiNonyuTsuchishoBookFuriKaeNashiRenchoCoverSource> {
