 ...
 */
package jp.co.ndensan.reams.db.dbb.business.core.choshuyuyo.kibetsuchochuyuyo;
 ...
 */
public class KibetsuChoshuYuyo extends ModelBase<KibetsuChoshuYuyoIdentifier, DbT2007KibetsuChoshuYuyoEntity, KibetsuChoshuYuyo>
    ...
    /**
     * 介護期別徴収猶予のみを変更対象とします。<br/> {@link DbT2007KibetsuChoshuYuyoEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
    ...
    /**
     * 保持する介護期別徴収猶予を削除対象とします。<br/> {@link DbT2007KibetsuChoshuYuyoEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば削除状態にします。
     *
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private static final long serialVersionUID = -8053103643698434949L;
        private final DbT2007KibetsuChoshuYuyoEntity entity;
        private final KibetsuChoshuYuyoIdentifier id;
