...
public class TokubetsuChoshuKaishiTsuchishoB5RenchoReport extends Report<TokubetsuChoshuKaishiTsuchishoB5RenchoSource> {
     ...
     */
    public TokubetsuChoshuKaishiTsuchishoB5RenchoReport(EditedHonSanteiTsuchiShoKyotsu 編集後本算定通知書共通情報, RString 宛名連番) {
    ...
    public void writeBy(ReportSourceWriter<TokubetsuChoshuKaishiTsuchishoB5RenchoSource> writer) {
        setItem();
        ITokubetsuChoshuKaishiTsuchishoB5RenchoEditor editor = new TokubetsuChoshuKaishiTsuchishoB5RenchoEditor(target);
