...
//    private final RString HOSHI_28 = new RString("****************************");
     ...
     */
    protected NonyuTsuchishoCVSMultiRenchoCoverEditor(KariSanteiNonyuTsuchiShoJoho item) {
        this.item = item;
    }

    @Override
    public NonyuTsuchishoCVSMultiRenchoCoverSource edit(NonyuTsuchishoCVSMultiRenchoCoverSource source) {
        return editSource(source);
    }

    private NonyuTsuchishoCVSMultiRenchoCoverSource editSource(NonyuTsuchishoCVSMultiRenchoCoverSource source) {
