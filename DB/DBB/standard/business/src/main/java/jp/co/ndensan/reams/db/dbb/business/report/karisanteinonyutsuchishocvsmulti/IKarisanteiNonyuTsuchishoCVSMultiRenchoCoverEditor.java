...
/**
 * 保険料納入通知書（仮算定）【コンビニマルチ収納タイプ】（連帳）Coverのエディターのインターフェースクラスです
 *
 * @reamsid_L DBB-9110-050 huangh
 */
public interface IKarisanteiNonyuTsuchishoCVSMultiRenchoCoverEditor extends IReportEditor<KarisanteiNonyuTsuchishoCVSMultiRenchoSource> {
