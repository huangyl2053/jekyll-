...
/**
 * 介護保険料減免取消通知書 B5横タイプIBuilderするクラスです。
 *
 * @reamsid_L DBB-0740-060 chenaoqi
 */
public interface IGemmenTorikesiTsuchiShoB5YokoBuilder extends
        IReportBuilder<KaigoHokenHokenryoGenmenTorikeshiTsuchishoB5YokoSource> {
