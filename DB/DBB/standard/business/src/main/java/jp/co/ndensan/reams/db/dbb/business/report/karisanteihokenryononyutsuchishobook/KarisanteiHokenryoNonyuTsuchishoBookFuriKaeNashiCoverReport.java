...
public class KarisanteiHokenryoNonyuTsuchishoBookFuriKaeNashiCoverReport
     ...
     */
    public KarisanteiHokenryoNonyuTsuchishoBookFuriKaeNashiCoverReport(
    ...
    public List<NonyuTsuchisho<KarisanteiHokenryoNonyuTsuchishoBookFuriKaeNashiCoverSource>> devidedByPage() {
        ...
        KarisanteiHokenryoNonyuTsuchishoBookFuriKaeNashiCoverReport reportCover
                = new KarisanteiHokenryoNonyuTsuchishoBookFuriKaeNashiCoverReport(仮算定納入通知書情報Cover, ninshoshaSource);
        ...
        for (NonyuTsuchiShoKiJoho 納入通知書期情報 : 納入通知書期情報リスト) {
            if (!isBegin) {
                ...
                reportDetail = new KarisanteiHokenryoNonyuTsuchishoBookFuriKaeNashiCoverReport(仮算定納入通知書情報Detail, ninshoshaSource);
