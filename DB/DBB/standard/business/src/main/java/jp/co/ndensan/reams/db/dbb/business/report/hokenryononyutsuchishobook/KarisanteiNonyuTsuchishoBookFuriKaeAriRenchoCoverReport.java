...
public class KarisanteiNonyuTsuchishoBookFuriKaeAriRenchoCoverReport
        extends Report<KarisanteiNonyuTsuchishoBookFuriKaeAriRenchoCoverSource> {
     ...
     */
    public static KarisanteiNonyuTsuchishoBookFuriKaeAriRenchoCoverReport createFrom(@NonNull HokenryoNonyuTsuchishoBookItem item) {
    ...
    public void writeBy(ReportSourceWriter<KarisanteiNonyuTsuchishoBookFuriKaeAriRenchoCoverSource> writer) {
        IKarisanteiNonyuTsuchishoBookFuriKaeAriRenchoCoverEditor editor
                = new KarisanteiNonyuTsuchishoBookFuriKaeAriRenchoCoverEditor(item, null, 1);
