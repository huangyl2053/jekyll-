...
/**
 * 保険料納入通知書（本算定）【ブックタイプ】（口振依頼あり）通知書_連帳 IHokenryoNonyuTsuchishoBookFuriKaeAriRenchoCoverEditor
 *
 * @reamsid_L DBB-9110-010 huangh
 */
public interface IHokenryoNonyuTsuchishoBookFuriKaeAriRenchoCoverEditor
        extends IReportEditor<HokenryoNonyuNonyuTsuchishoBookFuriKaeAriRenchoCoverSource> {
