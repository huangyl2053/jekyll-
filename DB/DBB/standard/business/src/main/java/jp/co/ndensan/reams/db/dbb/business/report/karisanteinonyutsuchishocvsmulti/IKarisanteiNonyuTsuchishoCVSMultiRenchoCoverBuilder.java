...
/**
 * 保険料納入通知書（仮算定）【コンビニマルチ収納タイプ】RenchoCoverのBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBB-9110-050 huangh
 */
interface IKarisanteiNonyuTsuchishoCVSMultiRenchoCoverBuilder extends IReportBuilder<KarisanteiNonyuTsuchishoCVSMultiSource> {
