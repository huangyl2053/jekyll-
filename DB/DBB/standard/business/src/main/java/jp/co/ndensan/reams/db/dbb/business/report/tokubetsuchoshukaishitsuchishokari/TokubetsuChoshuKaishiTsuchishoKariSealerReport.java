...
public class TokubetsuChoshuKaishiTsuchishoKariSealerReport extends
     ...
     */
    public TokubetsuChoshuKaishiTsuchishoKariSealerReport(KariTokuchoKaishiTsuchisyoJoho 仮算定特徴開始通知書情報) {
     ...
     */
    public static TokubetsuChoshuKaishiTsuchishoKariSealerReport createForm(
            @NonNull KariTokuchoKaishiTsuchisyoJoho 仮算定特徴開始通知書情報) {
        return new TokubetsuChoshuKaishiTsuchishoKariSealerReport(仮算定特徴開始通知書情報);
    }

    @Override
    public void writeBy(ReportSourceWriter<TokubetsuChoshuKaishiTsuchishoKariSealerSource> writer) {
        setItem();
        ITokubetsuChoshuKaishiTsuchishoKariSealerEditor editor = new TokubetsuChoshuKaishiTsuchishoKariSealerEditor(target);
