...
/**
 * 保険料納入通知書（本算定）【ブック（口振依頼あり通知書＋納付書）タイプ】のエディターのインターフェースクラスです。
 *
 * @reamsid_L DBB-9110-100 xuyue
 */
public interface INonyuTsuchishoBookFuriKaeAriEditor extends IReportEditor<FuriKaeAriCoverToNofushoReportSource> {
