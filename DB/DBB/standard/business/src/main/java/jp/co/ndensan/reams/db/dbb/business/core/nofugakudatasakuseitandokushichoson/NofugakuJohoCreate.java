...
public class NofugakuJohoCreate {
    ...
    public BbKakuteiShinkokuDataCsvEntity setCSV情報(DbT2016NofugakuJohoTemp 納付額情報,
        ...
        csvEntity.setタイムスタンプ(new RString(YMDHMS.now().toString()));
        ...
        csvEntity.set作成日時(new RString(YMDHMS.now().toString()));
        return csvEntity;
    }
    ...
    public DE940110DatEntity setDE940110Dat情報(DbT2016NofugakuJohoTemp 納付額情報,
        ...
        dataEntity.setタイムスタンプ(new RString(YMDHMS.now().toString()));
        ...
        dataEntity.set作成日時(new RString(YMDHMS.now().toString()));
        return dataEntity;
    }
