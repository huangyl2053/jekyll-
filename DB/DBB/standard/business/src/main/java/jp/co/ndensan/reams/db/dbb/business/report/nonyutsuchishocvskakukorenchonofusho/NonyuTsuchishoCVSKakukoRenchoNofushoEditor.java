...
import jp.co.ndensan.reams.db.dbb.entity.report.nonyutsuchishocvskakuko.NonyuTsuchishoCVSKakukoRenchoNofushoSource;
...
//    private final RString HOSHI_28 = new RString("****************************");
     ...
     */
    protected NonyuTsuchishoCVSKakukoRenchoNofushoEditor(KariSanteiNonyuTsuchiShoJoho item) {
        this.item = item;
//        this.index = index;
    }

    @Override
    public NonyuTsuchishoCVSKakukoRenchoNofushoSource edit(NonyuTsuchishoCVSKakukoRenchoNofushoSource source) {
        return editSource(source);
    }

    private NonyuTsuchishoCVSKakukoRenchoNofushoSource editSource(NonyuTsuchishoCVSKakukoRenchoNofushoSource source) {
