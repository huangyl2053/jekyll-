...
/**
 * 特別徴収開始通知書（本算定） B5横タイプ2（連帳）帳票IBuilder
 */
public interface ITokubetsuChoshuKaishiTsuchishoB52RenchoBuilder extends
        IReportBuilder<TokubetsuChoshuKaishiTsuchishoB52RenchoSource> {
