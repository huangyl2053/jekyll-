 ...
 */
public class HokenryoNonyuTsuchishoGinfuriFiveKiReport extends NonyuTsuchisho<HokenryoNonyuTsuchishoGinfuriFiveKiSource> {
     ...
     */
    public HokenryoNonyuTsuchishoGinfuriFiveKiReport(HonSanteiNonyuTsuchiShoJoho 本算定納入通知書情報, NinshoshaSource ninshoshaSource) {
    ...
    private void edit(ReportSourceWriter<HokenryoNonyuTsuchishoGinfuriFiveKiSource> writer,
            List<NonyuTsuchiShoKiJoho> 納入通知書期情報リストEdit, int 連番) {
        IHokenryoNonyuTsuchishoGinfuriFiveKiEditor editor
                = new HokenryoNonyuTsuchishoGinfuriFiveKiEditor(本算定納入通知書情報, ninshoshaSource, 納入通知書期情報リストEdit, 連番);
    ...
    @Override
    public List<NonyuTsuchisho<HokenryoNonyuTsuchishoGinfuriFiveKiSource>> devidedByPage() {
        List<NonyuTsuchiShoKiJoho> 納入通知書期情報リスト = 本算定納入通知書情報.get納入通知書期情報リスト();
        List<NonyuTsuchisho<HokenryoNonyuTsuchishoGinfuriFiveKiSource>> reportLst = new ArrayList<>();
    ...
    private HokenryoNonyuTsuchishoGinfuriFiveKiReport getNewReport(List<NonyuTsuchiShoKiJoho> 納入通知書期情報リストReport) {
        ...
        HokenryoNonyuTsuchishoGinfuriFiveKiReport report
                = new HokenryoNonyuTsuchishoGinfuriFiveKiReport(本算定納入通知書情報Report, ninshoshaSource);
        return report;
    }
    ...
    private void 前中後期のedit(List<NonyuTsuchiShoKiJoho> 納入通知書期情報リスト,
            ReportSourceWriter<HokenryoNonyuTsuchishoGinfuriFiveKiSource> writer) {
    ...
    private void 前中後期のdevidedEdit(
            ...
            List<NonyuTsuchisho<HokenryoNonyuTsuchishoGinfuriFiveKiSource>> reportLst) {
