...
public class KarisanteiNonyuTsuchishoCVSKakukoReport extends NonyuTsuchisho<KarisanteiNonyuTsuchishoCVSKakukoSource> {
    ...
    private final List<NonyuTsuchisho<KarisanteiNonyuTsuchishoCVSKakukoSource>> nonyuTsuchishoList = new ArrayList<>();
    ...
    private void set準備データ(ReportSourceWriter<KarisanteiNonyuTsuchishoCVSKakukoSource> reportSourceWriter) {
