...
/**
 * 帳票設計_DBBRP43002_4_特別徴収開始通知書（本算定）TokubetsuChoshuKaishiItem
 */
@SuppressWarnings("PMD.UnusedPrivateField")
@lombok.Getter
@lombok.Setter
public class TokubetsuChoshuKaishiItem {
    ...
    private RString titleChoshugaku;
    ...
    private RString listLower_10;
    private RString listLower_11;
}
