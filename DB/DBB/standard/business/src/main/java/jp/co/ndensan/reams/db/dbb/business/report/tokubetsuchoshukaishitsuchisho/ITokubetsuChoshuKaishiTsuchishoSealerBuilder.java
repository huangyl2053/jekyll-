...
/**
 * 特別徴収開始通知書（本算定） シーラタイプ帳票IBuilder
 *
 * @reamsid_L DBB-0780-070 xuhao
 */
public interface ITokubetsuChoshuKaishiTsuchishoSealerBuilder extends
        IReportBuilder<TokubetsuChoshuKaishiTsuchishoSealerSource> {
