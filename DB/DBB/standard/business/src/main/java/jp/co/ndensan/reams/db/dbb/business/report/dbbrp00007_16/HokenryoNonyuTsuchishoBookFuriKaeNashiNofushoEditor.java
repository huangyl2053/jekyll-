...
/**
 * 保険料納入通知書（本算定過年度）【ブックタイプ】（口振依頼なし）納付書 HokenryoNonyuTsuchishoBookFuriKaeNashiNofushoEditor
 *
 * @reamsid_L DBB-9110-160 wangjie2
 */
public class HokenryoNonyuTsuchishoBookFuriKaeNashiNofushoEditor implements IHokenryoNonyuTsuchishoBookFuriKaeNashiEditor {
     ...
     */
    public HokenryoNonyuTsuchishoBookFuriKaeNashiNofushoEditor(
    ...
    private void edit印字位置5(HokenryoNonyuTsuchishoBookFuriKaeNashiCoverSource source) {
    ...
    private void edit印字位置4(HokenryoNonyuTsuchishoBookFuriKaeNashiCoverSource source) {
    ...
    private void edit印字位置3(HokenryoNonyuTsuchishoBookFuriKaeNashiCoverSource source) {
    ...
    private void edit印字位置2(HokenryoNonyuTsuchishoBookFuriKaeNashiCoverSource source) {
