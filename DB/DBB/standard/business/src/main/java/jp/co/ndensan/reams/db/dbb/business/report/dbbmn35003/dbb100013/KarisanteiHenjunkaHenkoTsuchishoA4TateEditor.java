 ...
 */
class KarisanteiHenjunkaHenkoTsuchishoA4TateEditor implements IKarisanteiHenjunkaHenkoTsuchishoA4TateEditor {

    private final KarisanteiHenjunkaHenkoTsuchishoA4TateItem item;

    public KarisanteiHenjunkaHenkoTsuchishoA4TateEditor(KarisanteiHenjunkaHenkoTsuchishoA4TateItem item) {
        this.item = item;
