...
import jp.co.ndensan.reams.db.dbb.entity.report.nonyutsuchishocvsmulti.NonyuTsuchishoCVSMultiRenchoNofushoSource;
...
//    private final RString HOSHI_28 = new RString("****************************");
     ...
     */
    protected NonyuTsuchishoCVSMultiRenchoNofushoEditor(KariSanteiNonyuTsuchiShoJoho item) {
        this.item = item;
//        this.index = index;
    }

    @Override
    public NonyuTsuchishoCVSMultiRenchoNofushoSource edit(NonyuTsuchishoCVSMultiRenchoNofushoSource source) {
        return editSource(source);
    }

    private NonyuTsuchishoCVSMultiRenchoNofushoSource editSource(NonyuTsuchishoCVSMultiRenchoNofushoSource source) {
