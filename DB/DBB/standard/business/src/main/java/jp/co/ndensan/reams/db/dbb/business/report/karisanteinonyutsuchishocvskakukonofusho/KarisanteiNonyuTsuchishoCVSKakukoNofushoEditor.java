...
//    private final RString HOSHI_28 = new RString("****************************");
     ...
     */
    protected KarisanteiNonyuTsuchishoCVSKakukoNofushoEditor(KariSanteiNonyuTsuchiShoJoho item) {
        this.item = item;
//        this.index = index;
    }

    @Override
    public KarisanteiNonyuTsuchishoCVSKakukoNofushoSource edit(KarisanteiNonyuTsuchishoCVSKakukoNofushoSource source) {
        return editSource(source);
    }

    private KarisanteiNonyuTsuchishoCVSKakukoNofushoSource editSource(KarisanteiNonyuTsuchishoCVSKakukoNofushoSource source) {
