 ...
 */
public enum NonyuTsuchIchiranOutPutOrder implements IReportItems {
    ...
    private NonyuTsuchIchiranOutPutOrder(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
        this.項目ID = 項目ID;
