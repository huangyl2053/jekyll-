...
//    private final RString HOSHI_28 = new RString("****************************");
     ...
     */
    protected NonyuTsuchishoCVSMultiCoverEditor(KariSanteiNonyuTsuchiShoJoho item) {
        this.item = item;
    }

    @Override
    public NonyuTsuchishoCVSMultiCoverSource edit(NonyuTsuchishoCVSMultiCoverSource source) {
        return editSource(source);
    }

    private NonyuTsuchishoCVSMultiCoverSource editSource(NonyuTsuchishoCVSMultiCoverSource source) {
