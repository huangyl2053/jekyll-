...
public class HokenryoNonyuTsuchishoBookRenchoNofushoEditor implements IHokenryoNonyuTsuchishoBookRenchoNofushoEditor {
    ...
    private void edit印字位置2_1(HokenryoNonyuTsuchishoBookRenchoNofushoSource source,
        ...
        source.nofuzumishoOCR11 = is納入通知書期情報がある ? 納入通知書期情報.getOcr().get(INT1) : 星19;
        source.nofuzumishoOCR21 = is納入通知書期情報がある ? 納入通知書期情報.getOcr().get(INT2) : 星20;
    ...
    private void edit印字位置3_1(HokenryoNonyuTsuchishoBookRenchoNofushoSource source,
        ...
        source.nofuzumishoOCR12 = is納入通知書期情報がある ? 納入通知書期情報.getOcr().get(INT1) : 星19;
        source.nofuzumishoOCR22 = is納入通知書期情報がある ? 納入通知書期情報.getOcr().get(INT2) : 星20;
    ...
    private void edit印字位置4_1(HokenryoNonyuTsuchishoBookRenchoNofushoSource source,
        ...
        source.nofuzumishoOCR13 = is納入通知書期情報がある ? 納入通知書期情報.getOcr().get(INT1) : 星19;
        source.nofuzumishoOCR23 = is納入通知書期情報がある ? 納入通知書期情報.getOcr().get(INT2) : 星20;
    ...
    private void edit印字位置5_1(HokenryoNonyuTsuchishoBookRenchoNofushoSource source,
        ...
        source.nofuzumishoOCR14 = is納入通知書期情報がある ? 納入通知書期情報.getOcr().get(INT1) : 星19;
        source.nofuzumishoOCR24 = is納入通知書期情報がある ? 納入通知書期情報.getOcr().get(INT2) : 星20;
