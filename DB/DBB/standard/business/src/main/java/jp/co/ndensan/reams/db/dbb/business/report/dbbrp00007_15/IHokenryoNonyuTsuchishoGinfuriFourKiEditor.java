...
/**
 *
 * 保険料納入通知書（本算定過年度）【銀振タイプ】帳票項目定義_4期 IHokenryoNonyuTsuchishoGinfuriFourKiEditor
 */
public interface IHokenryoNonyuTsuchishoGinfuriFourKiEditor extends IReportEditor<HokenryoNonyuTsuchishoGinfuriFourKiSource> {
