...
/**
 *
 * 保険料納入通知書（仮算定）【ブックタイプ】納付書 IHokenryoNonyuTsuchishoBookNofushoBuilder
 */
public interface IHokenryoNonyuTsuchishoBookNofushoBuilder extends IReportBuilder<HokenryoNonyuTsuchishoBookNofushoSource> {
