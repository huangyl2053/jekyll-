...
public enum DBB200021_TokubetsuChoshuIdojohoIchiranEnum implements IReportItems {
    ...
    市町村コード(new RString("0016"), new RString("市町村コード"),
            Contents.ENCLOSURE.concat(new RString("ueT0511NenkinTokuchoKaifuJoho_koseiCityCode").concat(Contents.ENCLOSURE))),
    /**
     * 被保険者番号
     */
    被保険者番号(new RString("0104"), new RString("被保険者番号"),
            Contents.ENCLOSURE.concat(new RString("ueT0511NenkinTokuchoKaifuJoho_hihokenshaNo").concat(Contents.ENCLOSURE))),
    /**
     * 年金コード
     */
    年金コード(new RString("0206"), new RString("年金コード"),
            Contents.ENCLOSURE.concat(new RString("ueT0511NenkinTokuchoKaifuJoho_nenkinCode").concat(Contents.ENCLOSURE))),
    /**
     * 年金番号
     */
    年金番号(new RString("0207"), new RString("年金番号"),
            Contents.ENCLOSURE.concat(new RString("ueT0511NenkinTokuchoKaifuJoho_kisoNenkinNo").concat(Contents.ENCLOSURE)));
    ...
    private static class Contents {
        ...
        static final RString ENCLOSURE = new RString("\"");
    }
