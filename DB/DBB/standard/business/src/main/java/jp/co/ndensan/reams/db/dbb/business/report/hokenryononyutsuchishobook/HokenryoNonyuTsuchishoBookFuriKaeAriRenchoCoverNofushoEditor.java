...
/**
 * 保険料納入通知書（本算定）【ブックタイプ】（口振依頼あり）連帳納付書 NonyuTsuchishoBookFuriKaeAriCoverEditor
 *
 * @reamsid_L DBB-9110-010 huangh
 */
public class HokenryoNonyuTsuchishoBookFuriKaeAriRenchoCoverNofushoEditor implements IHokenryoNonyuTsuchishoBookFuriKaeAriRenchoCoverEditor {
     ...
     * @param ページ ページ
     */
    public HokenryoNonyuTsuchishoBookFuriKaeAriRenchoCoverNofushoEditor(
    ...
    private void edit印字位置5(HokenryoNonyuNonyuTsuchishoBookFuriKaeAriRenchoCoverSource source) {
    ...
    private void edit印字位置4(HokenryoNonyuNonyuTsuchishoBookFuriKaeAriRenchoCoverSource source) {
    ...
    private void edit印字位置3(HokenryoNonyuNonyuTsuchishoBookFuriKaeAriRenchoCoverSource source) {
    ...
    private void edit印字位置2(HokenryoNonyuNonyuTsuchishoBookFuriKaeAriRenchoCoverSource source) {
