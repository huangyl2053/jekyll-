 ...
 */
public class NonyuTsuchishoBookFuriKaeAriCoverNofushoEditor implements INonyuTsuchishoBookFuriKaeAriCoverEditor {
     ...
     */
    public NonyuTsuchishoBookFuriKaeAriCoverNofushoEditor(
    ...
    private void edit印字位置5(NonyuTsuchishoBookFuriKaeAriCoverSource source) {
    ...
    private void edit印字位置4(NonyuTsuchishoBookFuriKaeAriCoverSource source) {
    ...
    private void edit印字位置3(NonyuTsuchishoBookFuriKaeAriCoverSource source) {
    ...
    private void edit印字位置2(NonyuTsuchishoBookFuriKaeAriCoverSource source) {
