...
/**
 * 介護保険料徴収猶予決定通知書帳票Item
 */
@Getter
@Setter
@SuppressWarnings("PMD.UnusedPrivateField")
public class KaigoHokenryoChoshuyuyoKetteiTsuchishoItem {

    private RString bunshoNo;
    private RString ketteiYMD;
    private RString ketteiRiyu1;
    private RString ketteiRiyu2;
