...
/**
 * 保険料納入通知書（本算定）【ブックタイプ】（口振依頼なし）通知書_連帳 HokenryoNonyuTsuchishoBookFuriKaeNashiRenchoCoverEditor
 *
...
public class HokenryoNonyuTsuchishoBookFuriKaeNashiRenchoCoverEditor implements IHokenryoNonyuTsuchishoBookFuriKaeNashiRenchoCoverEditor {
     ...
     * @return HokenryoNonyuTsuchishoBookFuriKaeNashiRenchoCoverSource
     */
    @Override
    ...
    private void editレイヤ１(HokenryoNonyuTsuchishoBookFuriKaeNashiRenchoCoverSource source) {
        ...
        source.cover_keisanMeisaishoKi6 = 編集後本算定通知書共通情報.get編集後口座().get金融機関名CombinedWith支店名();
    ...
    private void editCompNofushoBookItem(HokenryoNonyuTsuchishoBookFuriKaeNashiRenchoCoverSource source) {
        ...
        if (1 == 納入通知書期情報リスト.get(0).getブック開始位置()) {
            source.cover_nofuzumishoTitleNendoBun1 = 本算定納入通知書情報.get納付書共通().get賦課年度表記();
            source.cover_nofuzumishoTitleKi1 = 納入通知書期情報リスト.get(0).get期表記();
            source.cover_nofuzumishoTitleTsuki1 = 納入通知書期情報リスト.get(0).get月表記();
            source.cover_nofozumishoTitleNendo1 = 本算定納入通知書情報.get納付書共通().get調定年度表記();
            source.cover_ryoshushoTitleNendo1 = 本算定納入通知書情報.get納付書共通().get調定年度表記();
            source.cover_ryoshushoTitleKi1 = 納入通知書期情報リスト.get(0).get期表記();
            source.cover_ryoshushoTitleTsuki1 = 納入通知書期情報リスト.get(0).get月表記();
            source.cover_nofushoTitleNendo1 = 本算定納入通知書情報.get納付書共通().get調定年度表記();
            source.cover_nofushoTitleKi1 = 納入通知書期情報リスト.get(0).get期表記();
            source.cover_nofushoTitleTsuki1 = 納入通知書期情報リスト.get(0).get月表記();
            // TODO 納入通知書期情報.OCRの一行目の印字文字列
            source.cover_nofuzumishoOCR11 = 納入通知書期情報リスト.get(0).getOcrid();
            // TODO 納入通知書期情報.OCRの二行目の印字文字列
            source.cover_nofuzumishoOCR21 = 納入通知書期情報リスト.get(0).getOcrid();
            // TODO 納入通知書期情報.OCRの三行目の印字文字列
            source.cover_nofuzumishoOCR31 = 納入通知書期情報リスト.get(0).getOcrid();
            source.cover_nofuzumishoNokigen1 = 納入通知書期情報リスト.get(0).get納期限表記();
            source.cover_ryoshushoHokenryoGaku1 = 納入通知書期情報リスト.get(0).get領収証書納付額欄();
            source.cover_nofushoHokenryoGaku1 = 納入通知書期情報リスト.get(0).get納付書納付額欄();
            source.cover_nofuzumishoNofuGaku1 = 納入通知書期情報リスト.get(0).get納付書納付額欄();
            source.cover_ryoshushoNokigen1 = 納入通知書期情報リスト.get(0).get納期限表記();
            source.cover_nofushoNokigen1 = 納入通知書期情報リスト.get(0).get納期限表記();
            source.cover_ryoshushoNofuIn1 = 納入通知書期情報リスト.get(0).get領収日付印欄();
            source.cover_nofushoNofuIn1 = 納入通知書期情報リスト.get(0).get領収日付欄();
            source.cover_nofuzumishoNofuIn1 = 納入通知書期情報リスト.get(0).get領収日付欄();
            source.cover_ryoshushoKozaCom1 = 納入通知書期情報リスト.get(0).get領収証書領収印欄();
            source.cover_nofushoKozaCom1 = 納入通知書期情報リスト.get(0).get納付書領収印欄();
            source.cover_nofuzumishoKozaCom1 = 納入通知書期情報リスト.get(0).get納付書領収印欄();
            source.cover_ryoshushoZuiji1 = 納入通知書期情報リスト.get(0).get随時表記();
            source.cover_nofushoZuiji1 = 納入通知書期情報リスト.get(0).get随時表記();
            source.cover_nofuzumishoZuiji1 = 納入通知書期情報リスト.get(0).get随時表記();
        } else {
            source.cover_nofuzumishoTitleNendoBun1 = new RString("*********");
            source.cover_nofuzumishoTitleKi1 = new RString("**");
            source.cover_nofuzumishoTitleTsuki1 = new RString("**");
            source.cover_nofozumishoTitleNendo1 = new RString("******");
            source.cover_ryoshushoTitleNendo1 = new RString("******");
            source.cover_ryoshushoTitleKi1 = new RString("**");
            source.cover_ryoshushoTitleTsuki1 = new RString("**");
            source.cover_nofushoTitleNendo1 = new RString("******");
            source.cover_nofushoTitleKi1 = new RString("**");
            source.cover_nofushoTitleTsuki1 = new RString("**");
            source.cover_nofuzumishoOCR11 = new RString("*******************");
            source.cover_nofuzumishoOCR21 = new RString("********************");
            source.cover_nofuzumishoOCR21 = new RString("************");
            source.cover_nofuzumishoNokigen1 = new RString("***********");
            source.cover_ryoshushoHokenryoGaku1 = new RString("**********");
            source.cover_nofushoHokenryoGaku1 = new RString("**********");
            source.cover_nofuzumishoNofuGaku1 = new RString("**********");
            source.cover_ryoshushoNokigen1 = new RString("***********");
            source.cover_nofushoNokigen1 = new RString("***********");
            source.cover_ryoshushoNofuIn1 = new RString("**");
            source.cover_nofushoNofuIn1 = new RString("**");
            source.cover_nofuzumishoNofuIn1 = new RString("**");
        }
        source.cover_ryoshushoJusho1 = 本算定納入通知書情報.get納付書共通().get住所();
        source.cover_nofuzumishoTsuchishoNo1 = 本算定納入通知書情報.get納付書共通().get通知書番号().value();
        source.cover_ryoshushoKatagaki1 = 本算定納入通知書情報.get納付書共通().get方書();
        source.cover_nofuzumishoSetaiCode1 = 本算定納入通知書情報.get納付書共通().get世帯コード().value();
        source.cover_ryoshushoHihokenshaName1 = 本算定納入通知書情報.get納付書共通().get納付者氏名();
        source.cover_nofushoHihokenshaName1 = 本算定納入通知書情報.get納付書共通().get納付者氏名();
        source.cover_ryoshushoTsuchishoNo1 = 本算定納入通知書情報.get納付書共通().get通知書番号().value();
        source.cover_nofushoTsuchishoNo1 = 本算定納入通知書情報.get納付書共通().get通知書番号().value();
        source.cover_nofuzumishoJusho1 = 本算定納入通知書情報.get納付書共通().get住所();
        source.cover_nofuzumishoKatagaki1 = 本算定納入通知書情報.get納付書共通().get方書();
        source.cover_nofuzumishoHihokenshaName1 = 本算定納入通知書情報.get納付書共通().get納付者氏名();
        source.cover_nofuzumishoshichosonName1 = 本算定納入通知書情報.get納付書共通().get納付書市町村名();
