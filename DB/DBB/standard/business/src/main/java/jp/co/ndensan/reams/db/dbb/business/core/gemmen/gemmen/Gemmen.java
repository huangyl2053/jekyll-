...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * 介護賦課減免のみを変更対象とします。<br/> {@link DbT2004GemmenEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
     * @return 変更対象処理実施後の{@link Gemmen}
     */
    public Gemmen modifiedModel() {
        DbT2004GemmenEntity modifiedEntity = entity.clone();
    ...
    /**
     * 保持する介護賦課減免を削除対象とします。<br/> {@link DbT2004GemmenEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば削除状態にします。
     *
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private static final long serialVersionUID = -6182915166254484410L;
        private final DbT2004GemmenEntity entity;
        private final GemmenIdentifier id;
