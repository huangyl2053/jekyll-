...
/**
 * 介護保険料減免取消通知書 A4縦タイプEditorするクラスです。
 *
 * @reamsid_L DBB-0740-060 chenaoqi
 */
public class GemmenTorikesiTsuchiShoA4TateEditor implements IGemmenTorikesiTsuchiShoA4TateEditor {
     ...
     * @param i int
     */
    public GemmenTorikesiTsuchiShoA4TateEditor(
            RString 文書番号,
    ...
    @Override
    public KaigoHokenHokenryoGenmenTorikeshiTsuchishoA4TateSource edit(KaigoHokenHokenryoGenmenTorikeshiTsuchishoA4TateSource source) {
    ...
    private void set表示コード(KaigoHokenHokenryoGenmenTorikeshiTsuchishoA4TateSource source) {
        if (表示コード != null) {
    ...
    private void set更正前後期割額リスト(KaigoHokenHokenryoGenmenTorikeshiTsuchishoA4TateSource source) {
    ...
    private void set認証者ソース(KaigoHokenHokenryoGenmenTorikeshiTsuchishoA4TateSource source) {
    ...
    private void set介護問合せ先ソースビルダー(KaigoHokenHokenryoGenmenTorikeshiTsuchishoA4TateSource source) {
