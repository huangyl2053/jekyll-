...
/**
 * 特別徴収平準化_仮算定額変更通知書_発行一覧表エディターのインターフェースクラスです。
 */
interface ITokuChoHeijunkaKariSanteigakuHakkoIchiranEditor
        extends IReportEditor<TokuChoHeijunkaKariSanteigakuHakkoIchiranReportSource> {
