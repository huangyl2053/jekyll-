...
/**
 * 介護保険料徴収猶予取消通知書 A4縦タイプreportするクラスです。
 *
 * @reamsid_L DBB-0740-070 chenaoqi
 */
public class ChoshuYuyoTorikesiTsuchiShoA4TateReport extends Report<KaigoHokenHokenryoChoshuyoyoTorikeshiTsuchishoA4TateSource> {
     ...
     */
    public ChoshuYuyoTorikesiTsuchiShoA4TateReport(
            RString 文書番号,
    ...
    @Override
    public void writeBy(ReportSourceWriter<KaigoHokenHokenryoChoshuyoyoTorikeshiTsuchishoA4TateSource> writer) {
        for (int i = INDEX_ZERO; i < INDEX_FOURTEEN; i++) {
            IChoshuYuyoTorikesiTsuchiShoA4TateEditor editor = new ChoshuYuyoTorikesiTsuchiShoA4TateEditor(
                    文書番号,
                    徴収猶予取消通知書情報,
                    通知書定型文,
                    介護問合せ先ソースビルダー,
                    ...
                    随時リスト,
                    編集後宛先, i);
            IChoshuYuyoTorikesiTsuchiShoA4TateBuilder builder = new ChoshuYuyoTorikesiTsuchiShoA4TateBuilder(editor);
