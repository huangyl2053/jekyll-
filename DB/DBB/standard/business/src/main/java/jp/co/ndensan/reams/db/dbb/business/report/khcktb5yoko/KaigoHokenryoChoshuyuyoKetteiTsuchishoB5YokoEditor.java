...
/**
 * 介護保険料徴収猶予決定通知書B5横タイプ帳票Editor
 *
 * @reamsid_L DBB-0740-040 sunhui
 */
public class KaigoHokenryoChoshuyuyoKetteiTsuchishoB5YokoEditor
        implements IKaigoHokenryoChoshuyuyoKetteiTsuchishoB5YokoEditor {
     ...
     * @param 編集後宛先 編集後宛先
     */
    public KaigoHokenryoChoshuyuyoKetteiTsuchishoB5YokoEditor(RString 文書番号,
    ...
    public KaigoHokenryoChoshuyuyoKetteiTsuchishoB5YokoSource edit(
        ...
        if (徴収猶予決定通知書情報.get年度区分() == GennenKanen.現年度) {
...
//        source.samaKata = sofuSource.samaKata;
    ...
    private List<RString> get随時リストを生成する(KitsukiList 期月リスト_普徴, int index) {
        ...
        if (FuchokiJohoTsukiShoriKubun.随時.equals(普徴期月.get月処理区分())
                ...
                || KanendoTsukiShoriKubun.随時 == 普徴期月.get月処理区分()) {
