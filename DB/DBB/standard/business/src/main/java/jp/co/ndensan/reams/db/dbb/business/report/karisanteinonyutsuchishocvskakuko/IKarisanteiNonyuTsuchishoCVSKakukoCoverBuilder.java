...
/**
 * 保険料納入通知書（仮算定）【コンビニ角公タイプ】CoverのBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBB-9110-060 huangh
 */
interface IKarisanteiNonyuTsuchishoCVSKakukoCoverBuilder extends IReportBuilder<KarisanteiNonyuTsuchishoCVSKakukoSource> {
