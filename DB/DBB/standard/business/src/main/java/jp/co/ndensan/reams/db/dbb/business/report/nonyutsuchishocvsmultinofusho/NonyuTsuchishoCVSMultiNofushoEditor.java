 ...
 */
public class NonyuTsuchishoCVSMultiNofushoEditor implements INonyuTsuchishoCVSMultiNofushoEditor {
     ...
     */
    public NonyuTsuchishoCVSMultiNofushoEditor(
    ...
    public NonyuTsuchishoCVSMultiSource edit(NonyuTsuchishoCVSMultiSource source) {
        editSource(source);
        source.layout = NonyuTsuchishoCVSMultiSource.Layouts.DBB100026_NonyuTsuchishoCVSMultiNofusho;
        return source;
    }
    ...
    private NonyuTsuchishoCVSMultiSource edit納付書1(NonyuTsuchishoCVSMultiSource source) {
    ...
    private NonyuTsuchishoCVSMultiSource edit納付書2(NonyuTsuchishoCVSMultiSource source) {
    ...
    private NonyuTsuchishoCVSMultiSource edit納付書3(NonyuTsuchishoCVSMultiSource source) {
