...
//    private final RString HOSHI_28 = new RString("****************************");
     ...
     */
    protected NonyuTsuchishoCVSMultiNofushoEditor(KariSanteiNonyuTsuchiShoJoho item) {
        this.item = item;
//        this.index = index;
    }

    @Override
    public NonyuTsuchishoCVSMultiNofushoSource edit(NonyuTsuchishoCVSMultiNofushoSource source) {
        return editSource(source);
    }

    private NonyuTsuchishoCVSMultiNofushoSource editSource(NonyuTsuchishoCVSMultiNofushoSource source) {
