...
/**
 * 保険料納入通知書（本算定）【銀振タイプ】帳票項目定義_4期_連帳 HokenryoNonyuTsuchishoGinfuriFourKiRenchoEditor
 *
 * @reamsid_L DBB-9110-090 huangh
 */
public class HokenryoNonyuTsuchishoGinfuriFourKiRenchoEditor implements IHokenryoNonyuTsuchishoGinfuriFourKiRenchoEditor {
     ...
     */
    public HokenryoNonyuTsuchishoGinfuriFourKiRenchoEditor(HonSanteiNonyuTsuchiShoJoho 本算定納入通知書情報,
    ...
    @Override
    public HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource edit(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source) {
    ...
    private void editCompSofubutsuAtesaki(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source) {
    ...
    private void editCompSofubutsuAtesaki2(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source, SofubutsuAtesakiSource 送付物宛先ソース) {
    ...
    private void editCompSofubutsuAtesaki1(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source, SofubutsuAtesakiSource 送付物宛先ソース) {
    ...
    private void editDBBCompNofushoItem(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source,
    ...
    private void editDBBCompNofushoItem_納入通知書期情報(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置1,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置2,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置3,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置4,
    ...
    private void editDBBCompNofushoItem_納入通知書期情報2(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置1,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置2,
            NofuShoKyotsu 納付書共通) {
    ...
    private void editCompNinshosha(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source) {
    ...
    private void editレイヤ１(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置1,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置2,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置3,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置4) {
    ...
    private void editレイヤ１_納入通知書期情報(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置1,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置2,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置3,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置4) {
    ...
    private void edit通知開始終了期(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source) {
    ...
    private void editレイヤ１_編集後本算定通知書共通情報(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source) {
    ...
    private void edit算定基礎保険料額(HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source, List<Kitsuki> 出力期リスト,
    ...
    private void edit編集後口座And編集後個人(
            HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource source, EditedKojin 編集後個人, EditedKoza 編集後口座) {
        if (編集後個人 != null) {
