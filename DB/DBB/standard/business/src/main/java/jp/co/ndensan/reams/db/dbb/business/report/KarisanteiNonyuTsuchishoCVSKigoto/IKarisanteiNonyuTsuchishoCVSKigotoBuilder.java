...
/**
 *
 * 保険料納入通知書（仮算定）【コンビニ期毎タイプ】IKarisanteiNonyuTsuchishoCVSKigotoBuilder
 */
public interface IKarisanteiNonyuTsuchishoCVSKigotoBuilder extends IReportBuilder<KarisanteiNonyuTsuchishoCVSKigotoSource> {
