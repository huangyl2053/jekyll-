...
/**
 * 保険料納入通知書（仮算定）【コンビニ角公タイプ】（連帳）納付書のEditorです。
 *
...
public class KarisanteiNonyuTsuchishoCVSKakukoRenchoNofushoEditor implements IKarisanteiNonyuTsuchishoCVSKakukoRenchoNofushoEditor {
     ...
     */
    protected KarisanteiNonyuTsuchishoCVSKakukoRenchoNofushoEditor(
    ...
    private KarisanteiNonyuTsuchishoCVSKakukoRenchoSource edit納付書1(KarisanteiNonyuTsuchishoCVSKakukoRenchoSource source, int pageCount1) {
    ...
    private KarisanteiNonyuTsuchishoCVSKakukoRenchoSource edit納付書2(KarisanteiNonyuTsuchishoCVSKakukoRenchoSource source, int pageCount1) {
    ...
    private KarisanteiNonyuTsuchishoCVSKakukoRenchoSource edit納付書3(KarisanteiNonyuTsuchishoCVSKakukoRenchoSource source, int pageCount1) {
    ...
    private KarisanteiNonyuTsuchishoCVSKakukoRenchoSource edit納付書4(KarisanteiNonyuTsuchishoCVSKakukoRenchoSource source, int pageCount1) {
