...
/**
 * 介護保険料徴収猶予取消通知書 B5横タイプIEditorするクラスです。
 *
 * @reamsid_L DBB-0740-070 chenaoqi
 */
public interface IChoshuYuyoTorikesiTsuchiShoB5YokoEditor extends
        IReportEditor<KaigoHokenHokenryoChoshuyoyoTorikeshiTsuchishoB5YokoSource> {
