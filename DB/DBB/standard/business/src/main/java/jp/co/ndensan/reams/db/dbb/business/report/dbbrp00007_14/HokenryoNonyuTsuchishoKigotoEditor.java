...
public class HokenryoNonyuTsuchishoKigotoEditor implements IHokenryoNonyuTsuchishoKigotoEditor {
     ...
     * @param 連番 連番
     */
    protected HokenryoNonyuTsuchishoKigotoEditor(HonSanteiNonyuTsuchiShoJoho 本算定納入通知書情報,
    ...
    private void editCompNofushoItemAndCompRyoshushoItem(HokenryoNonyuTsuchishoKigotoSource source) {
    ...
    private void edit納期(HokenryoNonyuTsuchishoKigotoSource source, List<AfterEditInformation> 普徴納期情報リスト) {
    ...
    private void edit更正後(HokenryoNonyuTsuchishoKigotoSource source, EditedHonSanteiTsuchiShoKyotsuBeforeOrAfterCorrection 更正後) {
        if (null == 更正後) {
            return;
        }
