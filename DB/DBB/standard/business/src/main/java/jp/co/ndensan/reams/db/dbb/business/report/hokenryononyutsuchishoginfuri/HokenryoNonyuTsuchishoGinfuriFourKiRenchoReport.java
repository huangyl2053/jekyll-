 ...
 */
public class HokenryoNonyuTsuchishoGinfuriFourKiRenchoReport extends NonyuTsuchisho<HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource> {
    ...
    @Override
    public List<NonyuTsuchisho<HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource>> devidedByPage() {
        List<NonyuTsuchiShoKiJoho> 納入通知書期情報リスト = 本算定納入通知書情報.get納入通知書期情報リスト();
        List<NonyuTsuchisho<HokenryoNonyuTsuchishoGinfuriFourKiRenchoSource>> reportLst = new ArrayList<>();
    ...
    private HokenryoNonyuTsuchishoGinfuriFourKiRenchoReport getNewReport(List<NonyuTsuchiShoKiJoho> 納入通知書期情報リストReport) {
