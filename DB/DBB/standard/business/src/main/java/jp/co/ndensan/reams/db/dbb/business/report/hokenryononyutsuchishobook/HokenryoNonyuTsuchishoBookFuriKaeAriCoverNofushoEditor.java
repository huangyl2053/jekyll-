...
/**
 * 保険料納入通知書（本算定）【ブックタイプ】（口振依頼あり）納付書 NonyuTsuchishoBookFuriKaeAriCoverEditor
 *
 * @reamsid_L DBB-9110-010 huangh
 */
public class HokenryoNonyuTsuchishoBookFuriKaeAriCoverNofushoEditor implements IHokenryoNonyuTsuchishoBookFuriKaeAriCoverEditor {
     ...
     * @param ページ ページ
     */
    public HokenryoNonyuTsuchishoBookFuriKaeAriCoverNofushoEditor(
    ...
    private void edit印字位置5(HokenryoNonyuNonyuTsuchishoBookFuriKaeAriCoverSource source) {
    ...
    private void edit印字位置4(HokenryoNonyuNonyuTsuchishoBookFuriKaeAriCoverSource source) {
    ...
    private void edit印字位置3(HokenryoNonyuNonyuTsuchishoBookFuriKaeAriCoverSource source) {
    ...
    private void edit印字位置2(HokenryoNonyuNonyuTsuchishoBookFuriKaeAriCoverSource source) {
