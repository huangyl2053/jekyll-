...
public class HokenryoNonyuTsuchishoGinfuriFiveKiReport extends NonyuTsuchisho<HokenryoNonyuTsuchishoGinfuriFiveKiSource> {
     ...
     */
    protected HokenryoNonyuTsuchishoGinfuriFiveKiReport(HonSanteiNonyuTsuchiShoJoho 本算定納入通知書情報, NinshoshaSource ninshoshaSource) {
    ...
    public static HokenryoNonyuTsuchishoGinfuriFiveKiReport createFrom(
        ...
        return new HokenryoNonyuTsuchishoGinfuriFiveKiReport(本算定納入通知書情報, ninshoshaSource);
    }
    ...
    private HokenryoNonyuTsuchishoGinfuriFiveKiReport getNewReport(List<NonyuTsuchiShoKiJoho> 納入通知書期情報リストReport) {
        ...
        HokenryoNonyuTsuchishoGinfuriFiveKiReport report
                = HokenryoNonyuTsuchishoGinfuriFiveKiReport
