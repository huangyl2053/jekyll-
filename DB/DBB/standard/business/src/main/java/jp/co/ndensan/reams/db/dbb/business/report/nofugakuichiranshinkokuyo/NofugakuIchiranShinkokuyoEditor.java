...
/**
 *
 * 帳票設計_DBBRP91003-1_納付額一覧表（確定申告用）のEditorrクラスです。
 *
 * @reamsid_L DBB-1890-040 qinzhen
 */
public class NofugakuIchiranShinkokuyoEditor implements
        INofugakuIchiranShinkokuyoEditor {
    ...
    public NofugakuIchiranSource edit(NofugakuIchiranSource source) {
        ...
        source.sortJunArea3 = get並び順(NUM_2);
        source.sortJunArea4 = get並び順(NUM_3);
        source.sortJunArea5 = get並び順(NUM_4);
