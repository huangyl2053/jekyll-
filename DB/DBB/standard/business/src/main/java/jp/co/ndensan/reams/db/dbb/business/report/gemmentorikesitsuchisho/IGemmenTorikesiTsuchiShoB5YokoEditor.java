...
/**
 * 介護保険料減免取消通知書 B5横タイプIEditorするクラスです。
 *
 * @reamsid_L DBB-0740-060 chenaoqi
 */
public interface IGemmenTorikesiTsuchiShoB5YokoEditor extends
        IReportEditor<KaigoHokenHokenryoGenmenTorikeshiTsuchishoB5YokoSource> {
