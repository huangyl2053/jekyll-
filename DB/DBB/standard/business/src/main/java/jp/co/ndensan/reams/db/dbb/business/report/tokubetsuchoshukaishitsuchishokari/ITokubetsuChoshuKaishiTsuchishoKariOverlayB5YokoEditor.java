...
/**
 * 特別徴収開始通知書（仮算定）帳票 B5横・オーバレイタイプIEditor
 */
public interface ITokubetsuChoshuKaishiTsuchishoKariOverlayB5YokoEditor extends
        IReportEditor<TokubetsuChoshuKaishiTsuchishoKariOverlayB5YokoSource> {
