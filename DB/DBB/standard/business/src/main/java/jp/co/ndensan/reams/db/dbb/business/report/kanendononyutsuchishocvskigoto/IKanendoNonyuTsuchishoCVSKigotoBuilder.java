...
/**
 * 保険料納入通知書（本算定過年度）【コンビニ期毎タイプ】のBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBB-9110-190 huangh
 */
interface IKanendoNonyuTsuchishoCVSKigotoBuilder extends IReportBuilder<KanendoNonyuTsuchishoCVSKigotoSource> {
