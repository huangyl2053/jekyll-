...
//    private final RString HOSHI_28 = new RString("****************************");
     ...
     * @param index index
     */
    protected KarisanteiNonyuTsuchishoCVSMultiRenchoNofushoEditor(KariSanteiNonyuTsuchiShoJoho item, int index) {
        this.item = item;
        this.index = index;
    }

    @Override
    public KarisanteiNonyuTsuchishoCVSMultiRenchoNofushoSource edit(KarisanteiNonyuTsuchishoCVSMultiRenchoNofushoSource source) {
        return editSource(source);
    }

    private KarisanteiNonyuTsuchishoCVSMultiRenchoNofushoSource editSource(KarisanteiNonyuTsuchishoCVSMultiRenchoNofushoSource source) {
