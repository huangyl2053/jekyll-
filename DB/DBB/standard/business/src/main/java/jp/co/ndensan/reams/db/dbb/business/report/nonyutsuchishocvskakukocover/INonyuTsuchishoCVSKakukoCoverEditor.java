...
/**
 * 保険料納入通知書（本算定）【コンビニ角公タイプ】Coverのエディターのインターフェースクラスです
 *
 * @reamsid_L DBB-9110-120 huangh
 */
public interface INonyuTsuchishoCVSKakukoCoverEditor extends IReportEditor<NonyuTsuchishoCVSKakukoCoverSource> {
