 ...
 */
public class KarisanteiNonyuTsuchishoCVSMultiRenchoReport extends NonyuTsuchisho<KarisanteiNonyuTsuchishoCVSMultiRenchoSource> {
    ...
    @Override
    public List<NonyuTsuchisho<KarisanteiNonyuTsuchishoCVSMultiRenchoSource>> devidedByPage() {
        List<NonyuTsuchisho<KarisanteiNonyuTsuchishoCVSMultiRenchoSource>> nonyuTsuchishoList = new ArrayList<>();
        List<NonyuTsuchiShoKiJoho> 納入通知書期情報リスト = item.get納入通知書期情報リスト();
    ...
    private void editCover(List<NonyuTsuchisho<KarisanteiNonyuTsuchishoCVSMultiRenchoSource>> nonyuTsuchishoList,
    ...
    private void editDetail(List<NonyuTsuchisho<KarisanteiNonyuTsuchishoCVSMultiRenchoSource>> nonyuTsuchishoList,
