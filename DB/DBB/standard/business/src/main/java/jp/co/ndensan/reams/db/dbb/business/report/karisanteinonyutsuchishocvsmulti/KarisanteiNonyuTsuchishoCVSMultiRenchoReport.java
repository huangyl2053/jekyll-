...
public class KarisanteiNonyuTsuchishoCVSMultiRenchoReport extends NonyuTsuchisho<KarisanteiNonyuTsuchishoCVSMultiRenchoSource> {
    ...
    private final List<NonyuTsuchisho<KarisanteiNonyuTsuchishoCVSMultiRenchoSource>> nonyuTsuchishoList = new ArrayList<>();
    ...
    private void writeLine(ReportSourceWriter<KarisanteiNonyuTsuchishoCVSMultiRenchoSource> reportSourceWriter) {
        ...
        if (HenshuHaniKubun.全てのレイアウト.equals(item.get編集範囲区分())) {
            IKarisanteiNonyuTsuchishoCVSMultiRenchoCoverEditor renchoCoverEditor
                    = new KarisanteiNonyuTsuchishoCVSMultiRenchoCoverEditor(item, ninshoshaSource);
    ...
    private void set準備データ(ReportSourceWriter<KarisanteiNonyuTsuchishoCVSMultiRenchoSource> reportSourceWriter) {
