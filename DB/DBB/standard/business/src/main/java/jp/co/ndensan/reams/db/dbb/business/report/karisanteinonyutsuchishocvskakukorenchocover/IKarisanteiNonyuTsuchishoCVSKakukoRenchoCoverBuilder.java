...
/**
 * 保険料納入通知書（仮算定）【コンビニ角公タイプ】（連帳）CoverのBuilderのインターフェースクラスです。
 *
 */
interface IKarisanteiNonyuTsuchishoCVSKakukoRenchoCoverBuilder extends IReportBuilder<KarisanteiNonyuTsuchishoCVSKakukoRenchoCoverSource> {
