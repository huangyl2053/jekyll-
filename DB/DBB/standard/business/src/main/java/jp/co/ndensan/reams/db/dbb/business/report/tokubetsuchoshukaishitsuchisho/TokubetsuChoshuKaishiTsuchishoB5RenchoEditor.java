...
public class TokubetsuChoshuKaishiTsuchishoB5RenchoEditor implements
     ...
     */
    public TokubetsuChoshuKaishiTsuchishoB5RenchoEditor(TokubetsuChoshuKaishiTsuchishoB5Item item) {
        this.item = item;
    }
    ...
    public TokubetsuChoshuKaishiTsuchishoB5RenchoSource edit(TokubetsuChoshuKaishiTsuchishoB5RenchoSource source) {
        ...
        source.hokenryoGaku8Gatsu = item.get保険料額2月本徴収額();
        ...
        // TODO 世帯主名
        // TODO 様方
        source.hakkoYMD1 = item.get発行年月日();
        source.denshiKoin1 = item.get電子公印();
        source.koinMojiretsu1 = item.get公印文字列();
        source.koinShoryaku1 = item.get公印書略();
        source.ninshoshaShimeiKakenai1 = item.get承認者公印掛けない();
        source.ninshoshaShimeiKakeru1 = item.get承認者公印掛ける();
        source.ninshoshaYakushokuMei3 = item.get承認者役職名();
        source.ninshoshaYakushokuMei4 = item.get承認者役職名１();
        source.ninshoshaYakushokuMei5 = item.get承認者役職名２();
        return source;
    }
