 ...
 */
public class NonyuTsuchishoBookFuriKaeAriCoverEditor implements INonyuTsuchishoBookFuriKaeAriCoverEditor {
     ...
     */
    protected NonyuTsuchishoBookFuriKaeAriCoverEditor(
     ...
     */
    @Override
    public NonyuTsuchishoBookFuriKaeAriCoverSource edit(NonyuTsuchishoBookFuriKaeAriCoverSource source) {
        editレイヤ１(source);
    ...
    private void editレイヤ１(NonyuTsuchishoBookFuriKaeAriCoverSource source) {
        // レイヤ１
        ...
        source.nokibetsuMeisaishoNendoBun = RStringUtil.convert半角to全角(編集後本算定通知書共通情報.get賦課年度_年度あり()).concat(分);
    ...
    private void editCompNinshosha(NonyuTsuchishoBookFuriKaeAriCoverSource source) {
    ...
    private void editCompSofubutsuAtesaki(NonyuTsuchishoBookFuriKaeAriCoverSource source) {
