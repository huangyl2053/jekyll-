...
/**
 *
 * 保険料納入通知書（仮算定）【ブックタイプ】（口振依頼なし）通知書 IKarisanteiHokenryoNonyuTsuchishoBookFuriKaeNashiCoverEditor
 */
public interface IKarisanteiHokenryoNonyuTsuchishoBookFuriKaeNashiCoverEditor
        extends IReportEditor<KarisanteiHokenryoNonyuTsuchishoBookFuriKaeNashiCoverSource> {
