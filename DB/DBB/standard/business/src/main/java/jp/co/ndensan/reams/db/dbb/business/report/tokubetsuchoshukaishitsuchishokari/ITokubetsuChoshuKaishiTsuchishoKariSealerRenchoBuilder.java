...
/**
 * 特別徴収開始通知書（仮算定）帳票 シーラタイプ連帳IBuilder
 *
 * @reamsid_L DBB-0790-050 lijunjun
 */
public interface ITokubetsuChoshuKaishiTsuchishoKariSealerRenchoBuilder extends
        IReportBuilder<TokubetsuChoshuKaishiTsuchishoKariSealerRenchoSource> {
