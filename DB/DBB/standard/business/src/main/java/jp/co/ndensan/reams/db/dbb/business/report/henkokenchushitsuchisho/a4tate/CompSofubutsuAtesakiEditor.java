 ...
 */
public class CompSofubutsuAtesakiEditor implements IKaigoHokenryogakuHenkoKenChushiTsuchishoA4TateEditor {
     ...
     * インスタンスを生成します。
     *
     * @param item KaigoHokenryogakuHenkoKenChushiTsuchishoBusiness
     */
    protected CompSofubutsuAtesakiEditor(KaigoHokenryogakuHenkoKenChushiTsuchishoBusiness item) {
        this.item = item;
    }
