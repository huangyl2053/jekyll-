...
import jp.co.ndensan.reams.db.dbb.entity.report.nonyutsuchishocvskakuko.NonyuTsuchishoCVSKakukoNofushoSource;
...
//    private final RString HOSHI_28 = new RString("****************************");
     ...
     */
    protected NonyuTsuchishoCVSKakukoNofushoEditor(KariSanteiNonyuTsuchiShoJoho item) {
        this.item = item;
//        this.index = index;
    }

    @Override
    public NonyuTsuchishoCVSKakukoNofushoSource edit(NonyuTsuchishoCVSKakukoNofushoSource source) {
        return editSource(source);
    }

    private NonyuTsuchishoCVSKakukoNofushoSource editSource(NonyuTsuchishoCVSKakukoNofushoSource source) {
