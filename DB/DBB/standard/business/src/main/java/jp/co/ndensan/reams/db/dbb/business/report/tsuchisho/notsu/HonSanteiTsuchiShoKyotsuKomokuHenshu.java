...
public class HonSanteiTsuchiShoKyotsuKomokuHenshu {
    ...
    public EditedHonSanteiTsuchiShoKyotsu create本算定通知書共通情報(HonSanteiTsuchiShoKyotsu 本算定通知書情報) {
        ...
        Decimal 特徴既に納付すべき額;
        Decimal 特徴今後納付すべき額_調定元に;
        Decimal 特徴今後納付すべき額_収入元に;
        Decimal 既に納付すべき額;
        Decimal 今後納付すべき額_調定元に;
        ...
        if (本算定通知書情報.get発行日() != null) {
            ...
            特徴現在期 = new TokuchoKiUtil().get期月リスト().get月の期(Tsuki.toValue(月.padZeroToLeft(2))).get期();
        } else {
            本算定通知書情報.set発行日(RDate.MIN);
        }
        ...
        if (GennenKanen.現年度.equals(現年度_過年度区分)) {
            ...
            普徴今後納付すべき額_収入元に = 納付済額.subtract(普徴納付済額_未到来期含む).minusToZero();
            Decimal 特徴納付済額 = get特徴納付済額(賦課情報_更正後, 1, SIZE_6);
            特徴今後納付すべき額_調定元に = 特徴納付済額.subtract(特徴既に納付すべき額);
            特徴今後納付すべき額_収入元に = 特徴納付済額.subtract(特徴納付済額_未到来期含む).minusToZero();
            既に納付すべき額 = 普徴既に納付すべき額.add(特徴既に納付すべき額);
            特別徴収額合計 = 特徴既に納付すべき額.add(特徴今後納付すべき額_調定元に);
            ...
            FukaJoho 賦課情報_更正前 = null == 本算定通知書情報.get賦課の情報_更正前() ? null : 本算定通知書情報.get賦課の情報_更正前().get賦課情報();
            ...
            普徴納付済額 = 普徴納付済額.add(普徴納付済額_現年度);
            特徴納付済額 = 特徴納付済額.add(特徴納付済額_現年度);
    ...
    private void edit編集後本算定通知書共通情報(HonSanteiTsuchiShoKyotsu 本算定通知書情報, EditedHonSanteiTsuchiShoKyotsu shoKyotsu,
        ...
        shoKyotsu.set特徴今後納付すべき額_調定元に(特徴今後納付すべき額_調定元に);
    ...
    private EditedHonSanteiTsuchiShoKyotsuBeforeOrAfterCorrection get更正前(HonSanteiTsuchiShoKyotsu 本算定通知書情報) {
        ...
        if (本算定通知書情報.get賦課の情報_更正前() != null) {
            ...
            更正前.set普通徴収額合計(get普徴納付済額(本算定通知書情報.get賦課の情報_更正前().get賦課情報(), 1, SIZE_14));
        }
    ...
    private EditedHonSanteiTsuchiShoKyotsuBeforeOrAfterCorrection get更正後(HonSanteiTsuchiShoKyotsu 本算定通知書情報) {
        ...
        更正後.set普通徴収額合計(get普徴納付済額(本算定通知書情報.get賦課の情報_更正後().get賦課情報(), 1, SIZE_14));
    ...
    private List<CharacteristicsPhase> get特徴期別金額リスト(FukaJoho 賦課情報) {
        ...
        for (int i = 期_1; i <= 期_6; i++) {
            if (期_1 == i) {
                ...
                characteristicsPhase1.set期(new RString(期_1));
                ...
                characteristicsPhase2.set期(new RString(期_2));
                ...
                characteristicsPhase3.set期(new RString(期_3));
                ...
                characteristicsPhase4.set期(new RString(期_4));
                ...
                characteristicsPhase5.set期(new RString(期_5));
                ...
                characteristicsPhase6.set期(new RString(期_6));
