...
public class NonyuTsuchishoBookFuriKaeAriCoverReport extends INonyuTsuchisho<NonyuTsuchishoBookFuriKaeAriCoverSource> {
    ...
    public static NonyuTsuchishoBookFuriKaeAriCoverReport createFrom(
        ...
        return new NonyuTsuchishoBookFuriKaeAriCoverReport(本算定納入通知書情報, ninshoshaSource);
    }
    ...
    private void edit納入通知書期情報(List<NonyuTsuchiShoKiJoho> 納入通知書期情報リスト, HenshuHaniKubun 編集範囲区分,
            ReportSourceWriter<NonyuTsuchishoBookFuriKaeAriCoverSource> writer) {
        int 通知書の連番 = INT_1;
    ...
    private void edit通知書(List<NonyuTsuchiShoKiJoho> 納入通知書期情報リストEdit, int 通知書の連番,
        ...
        INonyuTsuchishoBookFuriKaeAriCoverEditor editor
                = new NonyuTsuchishoBookFuriKaeAriCoverEditor(
                        本算定納入通知書情報, 通知書の連番, ninshoshaSource);
        INonyuTsuchishoBookFuriKaeAriCoverBuilder builder
                = new NonyuTsuchishoBookFuriKaeAriCoverBuilder(editor);
    ...
    private void edit納付書(List<NonyuTsuchiShoKiJoho> 納入通知書期情報リストEdit, int 通知書の連番,
            ReportSourceWriter<NonyuTsuchishoBookFuriKaeAriCoverSource> writer) {
        INonyuTsuchishoBookFuriKaeAriCoverEditor editor
                = new NonyuTsuchishoBookFuriKaeAriCoverNofushoEditor(本算定納入通知書情報, 納入通知書期情報リストEdit, 通知書の連番);
        INonyuTsuchishoBookFuriKaeAriCoverBuilder builder
                = new NonyuTsuchishoBookFuriKaeAriCoverBuilder(editor);
        writer.writeLine(builder);
    }
    ...
    public List<INonyuTsuchisho> devidedByPage() {
        ...
        NonyuTsuchishoBookFuriKaeAriCoverReport reportCover
                = NonyuTsuchishoBookFuriKaeAriCoverReport.createFrom(本算定納入通知書情報Cover, ninshoshaSource);
        ...
        NonyuTsuchishoBookFuriKaeAriCoverReport reportDetail;
        ...
        for (NonyuTsuchiShoKiJoho 納入通知書期情報 : 納入通知書期情報リスト) {
            if (!isBegin) {
                ...
                if (detail設定数 >= INT_4) {
                    ...
                    reportDetail = NonyuTsuchishoBookFuriKaeAriCoverReport
