...
public class TokubetsuChoshuKaishiTsuchishoSealerRenchoEditor implements ITokubetsuChoshuKaishiTsuchishoSealerRenchoEditor {
    ...
    public TokubetsuChoshuKaishiTsuchishoSealerRenchoSource edit(TokubetsuChoshuKaishiTsuchishoSealerRenchoSource source) {
        ...
        if (編集後本算定通知書共通情報.get更正後() != null) {
            ...
            if (編集後本算定通知書共通情報.get更正後().get期間_自() != null && 編集後本算定通知書共通情報.get更正後().get期間_至() != null) {
                RString 期間_自 = (new FlexibleYear(編集後本算定通知書共通情報.get更正後().get期間_自())).wareki().eraType(EraType.KANJI)
                        .firstYear(FirstYear.GAN_NEN).fillType(FillType.BLANK).toDateString();
                RString 期間_至 = (new FlexibleYear(編集後本算定通知書共通情報.get更正後().get期間_至())).wareki().eraType(EraType.KANJI)
                        .firstYear(FirstYear.GAN_NEN).fillType(FillType.BLANK).toDateString();
    ...
    private void editorSource(TokubetsuChoshuKaishiTsuchishoSealerRenchoSource source) {
        if (編集後本算定通知書共通情報.get編集後個人() != null) {
