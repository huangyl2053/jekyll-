 ...
 */
public class HokenryoNonyuTsuchishoBookFuriKaeNashiRenchoNofushoEditor implements IHokenryoNonyuTsuchishoBookFuriKaeNashiRenchoCoverEditor {
    ...
    private void edit印字位置5(HokenryoNonyuTsuchishoBookFuriKaeNashiRenchoCoverSource source) {
    ...
    private void edit印字位置4(HokenryoNonyuTsuchishoBookFuriKaeNashiRenchoCoverSource source) {
    ...
    private void edit印字位置3(HokenryoNonyuTsuchishoBookFuriKaeNashiRenchoCoverSource source) {
    ...
    private void edit印字位置2(HokenryoNonyuTsuchishoBookFuriKaeNashiRenchoCoverSource source) {
