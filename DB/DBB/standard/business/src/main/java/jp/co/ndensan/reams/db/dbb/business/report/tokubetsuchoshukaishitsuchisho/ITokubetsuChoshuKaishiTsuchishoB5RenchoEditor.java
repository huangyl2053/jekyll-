...
/**
 * 特別徴収開始通知書（本算定） B5横タイプ（連帳）帳票IEditor
 *
 * @reamsid_L DBB-0780-070 xuhao
 */
public interface ITokubetsuChoshuKaishiTsuchishoB5RenchoEditor extends
        IReportEditor<TokubetsuChoshuKaishiTsuchishoB5RenchoSource> {
