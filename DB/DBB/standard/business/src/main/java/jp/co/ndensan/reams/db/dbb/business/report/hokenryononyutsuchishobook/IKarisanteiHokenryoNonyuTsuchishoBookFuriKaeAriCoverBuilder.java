...
/**
 *
 * 保険料納入通知書（仮算定）【ブックタイプ】（口振依頼あり）通知書 IKarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverBuilder
 */
public interface IKarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverBuilder
        extends IReportBuilder<KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverSource> {
