...
public class KarisanteiNonyuTsuchishoCVSMultiRenchoNofushoEditor implements IKarisanteiNonyuTsuchishoCVSMultiRenchoNofushoEditor {
    ...
    public KarisanteiNonyuTsuchishoCVSMultiSource edit(KarisanteiNonyuTsuchishoCVSMultiSource source) {
        editSource(source);
        source.layout = KarisanteiNonyuTsuchishoCVSMultiSource.Layouts.DBB100027_NonyuTsuchishoCVSMultiRenchoNofusho;
        return source;
    }
    ...
    private KarisanteiNonyuTsuchishoCVSMultiSource edit納付書4(KarisanteiNonyuTsuchishoCVSMultiSource source) {
