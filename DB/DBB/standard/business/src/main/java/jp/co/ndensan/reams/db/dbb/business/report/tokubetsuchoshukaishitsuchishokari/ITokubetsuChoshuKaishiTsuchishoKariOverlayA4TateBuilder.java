...
/**
 * 特別徴収開始通知書（仮算定）帳票 A4縦・オーバーレイタイプIBuilder
 */
public interface ITokubetsuChoshuKaishiTsuchishoKariOverlayA4TateBuilder extends
        IReportBuilder<TokubetsuChoshuKaishiTsuchishoKariOverlayA4TateSource> {
