...
/**
 * 特別徴収開始通知書（仮算定）帳票 A4縦・オーバーレイタイプIEditor
 */
public interface ITokubetsuChoshuKaishiTsuchishoKariOverlayA4TateEditor extends
        IReportEditor<TokubetsuChoshuKaishiTsuchishoKariOverlayA4TateSource> {
