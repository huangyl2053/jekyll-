...
/**
 * 保険料納入通知書（仮算定）【コンビニ角公タイプ】Coverのエディターのインターフェースクラスです
 *
 * @reamsid_L DBB-9110-060 huangh
 */
public interface IKarisanteiNonyuTsuchishoCVSKakukoCoverEditor extends IReportEditor<KarisanteiNonyuTsuchishoCVSKakukoSource> {
