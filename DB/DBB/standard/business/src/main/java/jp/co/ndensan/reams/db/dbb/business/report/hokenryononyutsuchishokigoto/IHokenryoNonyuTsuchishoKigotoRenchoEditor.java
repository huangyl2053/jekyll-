...
/**
 * 保険料納入通知書（本算定）【期毎タイプ】IHokenryoNonyuTsuchishoKigotoRenchoEditor
 *
 * @reamsid_L DBB-9110-080 huangh
 */
public interface IHokenryoNonyuTsuchishoKigotoRenchoEditor extends IReportEditor<HokenryoNonyuTsuchishoKigotoRenchoSource> {
