...
/**
 * 保険料納入通知書（仮算定）【コンビニマルチ収納タイプ】RenchoCoverのBuilder
 *
...
public class KarisanteiNonyuTsuchishoCVSMultiRenchoCoverBuilder implements IKarisanteiNonyuTsuchishoCVSMultiRenchoCoverBuilder {
    ...
    private final IKarisanteiNonyuTsuchishoCVSMultiRenchoCoverEditor coverEditor;
     ...
     */
    public KarisanteiNonyuTsuchishoCVSMultiRenchoCoverBuilder(IKarisanteiNonyuTsuchishoCVSMultiRenchoCoverEditor coverEditor) {
