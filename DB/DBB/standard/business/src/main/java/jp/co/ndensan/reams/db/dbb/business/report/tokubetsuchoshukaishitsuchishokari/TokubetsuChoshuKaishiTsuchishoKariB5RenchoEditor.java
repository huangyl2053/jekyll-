...
public class TokubetsuChoshuKaishiTsuchishoKariB5RenchoEditor implements
     ...
     * @param 宛名連番 RString
     */
    public TokubetsuChoshuKaishiTsuchishoKariB5RenchoEditor(EditedAtesaki 編集後宛先,
    ...
    private void editorSource(TokubetsuChoshuKaishiTsuchishoKariB5RenchoSource source) {
    ...
    private void editorSource_1(TokubetsuChoshuKaishiTsuchishoKariB5RenchoSource source) {
    ...
    private void editorSource_2(TokubetsuChoshuKaishiTsuchishoKariB5RenchoSource source) {
        if (仮算定特徴開始通知書情報.get編集後仮算定通知書共通情報().get調定年度() != null) {
