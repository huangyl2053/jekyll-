...
/**
 * 段階別被保険者数一覧表帳票インターフェースです。
 *
 * @reamsid_L DBB-1820-060 zhouchuanlin
 */
public interface IShotokuDankaiBetsuHihokenshasuIchiranEditor extends IReportEditor<ShotokuDankaiBetsuHihokenshasuIchiranSource> {
