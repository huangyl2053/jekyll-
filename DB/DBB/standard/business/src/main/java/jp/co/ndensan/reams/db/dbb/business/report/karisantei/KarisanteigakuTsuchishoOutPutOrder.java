 ...
 */
public enum KarisanteigakuTsuchishoOutPutOrder implements IReportItems {
     ...
     * 調定事由
     */
    調定事由(new RString("0212"), new RString("調定事由"), new RString("\"dbT2015KeisangoJoho_choteiJiyu1\""));

    private final RString 項目ID;
    private final RString フォームフィールド名;
    private final RString myBatis項目名;

    private KarisanteigakuTsuchishoOutPutOrder(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
        this.項目ID = 項目ID;
