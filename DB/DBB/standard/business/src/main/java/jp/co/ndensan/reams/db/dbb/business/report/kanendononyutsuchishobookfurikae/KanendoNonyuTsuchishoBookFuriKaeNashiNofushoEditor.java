 ...
 */
public class KanendoNonyuTsuchishoBookFuriKaeNashiNofushoEditor implements IKanendoNonyuTsuchishoBookFuriKaeNashiEditor {
     ...
     */
    public KanendoNonyuTsuchishoBookFuriKaeNashiNofushoEditor(
    ...
    private void edit印字位置5(KanendoNonyuTsuchishoBookFuriKaeNashiSource source) {
    ...
    private void edit印字位置4(KanendoNonyuTsuchishoBookFuriKaeNashiSource source) {
    ...
    private void edit印字位置3(KanendoNonyuTsuchishoBookFuriKaeNashiSource source) {
    ...
    private void edit印字位置2(KanendoNonyuTsuchishoBookFuriKaeNashiSource source) {
