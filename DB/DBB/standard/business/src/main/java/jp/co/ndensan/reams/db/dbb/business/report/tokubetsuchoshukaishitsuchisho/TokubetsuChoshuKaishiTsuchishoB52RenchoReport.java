...
public class TokubetsuChoshuKaishiTsuchishoB52RenchoReport extends Report<TokubetsuChoshuKaishiTsuchishoB52RenchoSource> {
     ...
     */
    public TokubetsuChoshuKaishiTsuchishoB52RenchoReport(EditedHonSanteiTsuchiShoKyotsu 編集後本算定通知書共通情報, RString 宛名連番) {
     ...
     * @return TokubetsuChoshuKaishiTsuchishoB52RenchoReportクラス
     */
    public static TokubetsuChoshuKaishiTsuchishoB52RenchoReport createForm(
            @NonNull EditedHonSanteiTsuchiShoKyotsu 編集後本算定通知書共通情報,
            RString 宛名連番) {
        return new TokubetsuChoshuKaishiTsuchishoB52RenchoReport(編集後本算定通知書共通情報, 宛名連番);
    }

    @Override
    public void writeBy(ReportSourceWriter<TokubetsuChoshuKaishiTsuchishoB52RenchoSource> writer) {
        setItem();
        ITokubetsuChoshuKaishiTsuchishoB52RenchoEditor editor = new TokubetsuChoshuKaishiTsuchishoB52RenchoEditor(target);
