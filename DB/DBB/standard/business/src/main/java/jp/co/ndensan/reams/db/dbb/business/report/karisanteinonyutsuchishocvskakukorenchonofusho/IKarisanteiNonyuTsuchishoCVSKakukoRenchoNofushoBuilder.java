...
/**
 * 保険料納入通知書（仮算定）【コンビニ角公タイプ】納付書のBuilderのインターフェースクラスです。
 *
 */
interface IKarisanteiNonyuTsuchishoCVSKakukoRenchoNofushoBuilder extends IReportBuilder<KarisanteiNonyuTsuchishoCVSKakukoRenchoNofushoSource> {
