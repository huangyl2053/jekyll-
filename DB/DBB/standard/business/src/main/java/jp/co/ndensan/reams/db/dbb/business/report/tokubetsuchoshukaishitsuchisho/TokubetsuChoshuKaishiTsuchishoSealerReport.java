...
public class TokubetsuChoshuKaishiTsuchishoSealerReport extends Report<TokubetsuChoshuKaishiTsuchishoSealerSource> {
     ...
     */
    public TokubetsuChoshuKaishiTsuchishoSealerReport(EditedHonSanteiTsuchiShoKyotsu 編集後本算定通知書共通情報) {
     ...
     */
    public static TokubetsuChoshuKaishiTsuchishoSealerReport createForm(
            @NonNull EditedHonSanteiTsuchiShoKyotsu 編集後本算定通知書共通情報) {
        return new TokubetsuChoshuKaishiTsuchishoSealerReport(編集後本算定通知書共通情報);
    }

    @Override
    public void writeBy(ReportSourceWriter<TokubetsuChoshuKaishiTsuchishoSealerSource> writer) {
        setItem();
        ITokubetsuChoshuKaishiTsuchishoSealerEditor editor = new TokubetsuChoshuKaishiTsuchishoSealerEditor(target);
