...
public class NofugakuIchiranCodeFumeiEditor implements
    ...
    @Override
    public NofugakuIchiranCodeFumeiSource edit(NofugakuIchiranCodeFumeiSource source) {
    ...
    private void getlist6_4(NofugakuIchiranCodeFumeiSource source, Decimal middle1, Decimal middle2, Decimal middle3,
    ...
    private void get収入額以外分(NofugakuIchiranCodeFumeiSource source, Decimal middle2, Decimal middle5, Decimal middle6) {
    ...
    private void get期別額(NofugakuIchiranCodeFumeiSource source) {
