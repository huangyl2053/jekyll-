...
/**
 * 保険料納入通知書（本算定過年度）【銀振タイプ】帳票項目定義_4期 HokenryoNonyuTsuchishoGinfuriFourKiEditor
 *
 * @reamsid_L DBB-9110-150 wangjie2
 */
public class KanendoHokenryoNonyuTsuchishoGinfuriFourKiEditor implements IKanendoHokenryoNonyuTsuchishoGinfuriFourKiEditor {
     ...
     */
    public KanendoHokenryoNonyuTsuchishoGinfuriFourKiEditor(HonSanteiNonyuTsuchiShoJoho 本算定納入通知書情報,
    ...
    @Override
    public KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource edit(KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource source) {
    ...
    private void editCompSofubutsuAtesaki(KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource source) {
    ...
    private void editCompSofubutsuAtesaki2(KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource source, SofubutsuAtesakiSource 送付物宛先ソース) {
    ...
    private void editCompSofubutsuAtesaki1(KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource source, SofubutsuAtesakiSource 送付物宛先ソース) {
    ...
    private void editDBBCompNofushoItem(KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource source,
    ...
    private void editDBBCompNofushoItem_納入通知書期情報(KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource source,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置1,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置2,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置3,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置4,
    ...
    private void editCompNinshosha(KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource source) {
    ...
    private void editレイヤ１(KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource source,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置1,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置2,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置3,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置4) {
    ...
    private void editレイヤ１_納入通知書期情報(KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource source,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置1,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置2,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置3,
            NonyuTsuchiShoKiJoho 納入通知書期情報印字位置4) {
    ...
    private void edit通知開始終了期(KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource source) {
    ...
    private void editレイヤ１_編集後本算定通知書共通情報(KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource source) {
    ...
    private void edit編集後口座And編集後個人(
            KanendoHokenryoNonyuTsuchishoGinfuriFourKiSource source, EditedKojin 編集後個人, EditedKoza 編集後口座) {
        if (編集後個人 != null) {
