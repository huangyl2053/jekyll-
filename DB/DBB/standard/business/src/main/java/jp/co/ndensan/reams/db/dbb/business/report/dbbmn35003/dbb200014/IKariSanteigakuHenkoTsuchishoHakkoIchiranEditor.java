...
/**
 * 仮算定額変更通知書発行一覧表エディターのインターフェースクラスです。
 */
interface IKariSanteigakuHenkoTsuchishoHakkoIchiranEditor extends IReportEditor<KariSanteigakuHenkoTsuchishoHakkoIchiranReportSource> {
