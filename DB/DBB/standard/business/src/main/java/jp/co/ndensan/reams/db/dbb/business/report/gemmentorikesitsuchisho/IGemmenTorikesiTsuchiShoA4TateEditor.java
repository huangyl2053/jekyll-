...
/**
 * 介護保険料減免取消通知書 A4縦タイプIEditorするクラスです。
 *
 * @reamsid_L DBB-0740-060 chenaoqi
 */
public interface IGemmenTorikesiTsuchiShoA4TateEditor extends
        IReportEditor<KaigoHokenHokenryoGenmenTorikeshiTsuchishoA4TateSource> {
