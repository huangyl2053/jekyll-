...
/**
 * 特別徴収開始通知書（本算定） B5横タイプ（連帳）帳票IBuilder
 */
public interface ITokubetsuChoshuKaishiTsuchishoB5RenchoBuilder extends
        IReportBuilder<TokubetsuChoshuKaishiTsuchishoB5RenchoSource> {
