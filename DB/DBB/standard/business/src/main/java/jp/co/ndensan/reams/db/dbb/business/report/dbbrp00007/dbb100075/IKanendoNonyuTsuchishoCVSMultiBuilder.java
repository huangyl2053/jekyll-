...
/**
 * 保険料納入通知書（本算定過年度）【コンビニマルチ収納タイプ通知書】Builderのインターフェースクラスです。
 */
interface IKanendoNonyuTsuchishoCVSMultiBuilder extends IReportBuilder<KanendoNonyuTsuchishoCVSMultiReportSource> {
