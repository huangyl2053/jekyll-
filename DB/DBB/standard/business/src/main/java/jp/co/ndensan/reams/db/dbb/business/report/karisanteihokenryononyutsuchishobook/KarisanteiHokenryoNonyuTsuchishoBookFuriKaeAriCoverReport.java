...
public class KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverReport
        extends NonyuTsuchisho<KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverSource> {
     ...
     */
    protected KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverReport(
     ...
     */
    public static KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverReport createFrom(
            @NonNull KariSanteiNonyuTsuchiShoJoho 仮算定納入通知書情報, NinshoshaSource ninshoshaSource) {
        return new KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverReport(仮算定納入通知書情報, ninshoshaSource);
    }
    ...
    private void edit納入通知書期情報(List<NonyuTsuchiShoKiJoho> 納入通知書期情報リスト, HenshuHaniKubun 編集範囲区分,
            ReportSourceWriter<KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverSource> writer) {
        int 通知書の連番 = INT1;
    ...
    private void edit納付書(List<NonyuTsuchiShoKiJoho> 納入通知書期情報リストEdit, int 通知書の連番,
        ...
        IKarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverEditor editor
                = new HokenryoNonyuTsuchishoBookNofushoEditor(仮算定納入通知書情報, 納入通知書期情報リストEdit, 通知書の連番);
        IKarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverBuilder builder
                = new KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverBuilder(editor);
    ...
    private void edit通知書(List<NonyuTsuchiShoKiJoho> 納入通知書期情報リストEdit, int 通知書の連番,
        ...
        IKarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverEditor editor
                = new KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverEditor(
                        仮算定納入通知書情報, 納入通知書期情報リストEdit, ninshoshaSource, 通知書の連番);
        IKarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverBuilder builder
                = new KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverBuilder(editor);
        writer.writeLine(builder);
    }
    ...
    @Override
    public List<NonyuTsuchisho<KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverSource>> devidedByPage() {
        List<NonyuTsuchisho<KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverSource>> nonyuTsuchishoList = new ArrayList<>();
        List<NonyuTsuchiShoKiJoho> 納入通知書期情報リスト = 仮算定納入通知書情報.get納入通知書期情報リスト();
        KariSanteiNonyuTsuchiShoJoho 仮算定納入通知書情報Cover = getNew仮算定納入通知書情報(HenshuHaniKubun.Coverのみ, 納入通知書期情報リスト);
        KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverReport reportCover
                = KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverReport.createFrom(仮算定納入通知書情報Cover, ninshoshaSource);
        ...
        KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverReport reportDetail;
        ...
        for (NonyuTsuchiShoKiJoho 納入通知書期情報 : 納入通知書期情報リスト) {
            if (!isBegin) {
                ...
                if (detail設定数 >= INT4) {
                    ...
                    reportDetail = KarisanteiHokenryoNonyuTsuchishoBookFuriKaeAriCoverReport
