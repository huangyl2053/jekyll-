...
/**
 * 保険料納入通知書（仮算定）【コンビニマルチ収納タイプ】（連帳）CoverのBuilderのインターフェースクラスです。
 *
 */
interface IKarisanteiNonyuTsuchishoCVSMultiRenchoCoverBuilder extends IReportBuilder<KarisanteiNonyuTsuchishoCVSMultiRenchoCoverSource> {
