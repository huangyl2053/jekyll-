...
/**
 * 特別徴収平準化_仮算定額変更通知書_発行一覧表Builderのインターフェースクラスです。
 */
interface ITokuChoHeijunkaKariSanteigakuHenkoTsuchishoHakkoIchiranBuilder extends IReportBuilder<TokuChoHeijunkaKariSanteigakuHenkoTsuchishoHakkoIchiranReportSource> {
