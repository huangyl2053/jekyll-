...
/**
 *
 * 保険料納入通知書（本算定過年度）【ブックタイプ】（口振依頼あり）通知書_連帳 INonyuTsuchishoBookFuriKaeAriRenchoCoverEditor
 */
public interface INonyuTsuchishoBookFuriKaeAriRenchoCoverEditor extends IReportEditor<NonyuTsuchishoBookFuriKaeAriRenchoCoverSource> {
