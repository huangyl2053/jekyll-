...
/**
 * 帳票設計_DBBPR45002_保険料納入通知書（本算定過年度異動）発行一覧表 Editorのインタフェースです。
 *
 * Sourceは帳票設計_DBBRP43002_2_保険料納入通知書（本算定）発行一覧表と同じです。
 *
 * @reamsid_L DBB-0920-050 zhangrui
 */
public interface IHonsanteiKanendoIdoNonyutsuchishoHakkoIchiranEditor extends IReportEditor<NonyuTsuchIchiranSource> {
