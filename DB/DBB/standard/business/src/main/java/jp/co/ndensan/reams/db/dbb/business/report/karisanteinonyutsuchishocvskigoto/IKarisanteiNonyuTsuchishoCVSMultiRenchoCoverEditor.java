...
/**
 * 保険料納入通知書（仮算定）【コンビニ期毎タイプ】連帳 IKarisanteiNonyuTsuchishoCVSMultiRenchoCoverEditor
 *
 * @reamsid_L DBB-9110-070 wangjie2
 */
public interface IKarisanteiNonyuTsuchishoCVSMultiRenchoCoverEditor extends IReportEditor<KarisanteiNonyuTsuchishoCVSMultiRenchoCoverSource> {
