 ...
 */
public class KaigoHokenHokenryogakuKetteiTsuchishoB5YokoEditor implements IKaigoHokenHokenryogakuKetteiTsuchishoB5YokoEditor {
     ...
     */
    protected KaigoHokenHokenryogakuKetteiTsuchishoB5YokoEditor(KaigoHokenHokenryogakuKetteiTsuchishoBusiness item) {
        this.item = item;
    }
...
//  reportSource.bankCode = item.get本算定決定通知書情報().get編集後本算定通知書共通情報().
        ...
        //reportSource.birthYMD = item.get本算定決定通知書情報().get編集後本算定通知書共通情報().
        ...
        //reportSource.seibetsu = 編集後本算定通知書共通情報.get
        //reportSource.setaiCode = 編集後本算定通知書共通情報.get世帯コード
    ...
    private void set通知文1と通知区分(KaigoHokenHokenryogakuKetteiTsuchishoB5YokoReportSource reportSource,
    ...
    private void set転入者通知文(KaigoHokenHokenryogakuKetteiTsuchishoB5YokoReportSource reportSource,
            EditedHonSanteiTsuchiShoKyotsu 編集後本算定通知書共通情報) {
