...
/**
 * 保険料納入通知書（仮算定）【コンビニマルチ収納タイプ】NofushoのBuilder
 *
...
public class KarisanteiNonyuTsuchishoCVSMultiNofushoBuilder implements IKarisanteiNonyuTsuchishoCVSMultiNofushoBuilder {
    ...
    private final IKarisanteiNonyuTsuchishoCVSMultiNofushoEditor coverEditor;
     ...
     */
    public KarisanteiNonyuTsuchishoCVSMultiNofushoBuilder(IKarisanteiNonyuTsuchishoCVSMultiNofushoEditor coverEditor) {
