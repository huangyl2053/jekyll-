...
/**
 * 介護保険料徴収猶予取消通知書 B5横タイプEditorするクラスです。
 *
 * @reamsid_L DBB-0740-070 chenaoqi
 */
public class ChoshuYuyoTorikesiTsuchiShoB5YokoEditor implements IChoshuYuyoTorikesiTsuchiShoB5YokoEditor {
     ...
     * @param i int
     */
    public ChoshuYuyoTorikesiTsuchiShoB5YokoEditor(
            RString 文書番号,
    ...
    @Override
    public KaigoHokenHokenryoChoshuyoyoTorikeshiTsuchishoB5YokoSource edit(KaigoHokenHokenryoChoshuyoyoTorikeshiTsuchishoB5YokoSource source) {
    ...
    private void set表示コード(KaigoHokenHokenryoChoshuyoyoTorikeshiTsuchishoB5YokoSource source) {
    ...
    private void set徴収猶予の情報(KaigoHokenHokenryoChoshuyoyoTorikeshiTsuchishoB5YokoSource source) {
        if (徴収猶予取消通知書情報.get徴収猶予の情報() != null) {
            ...
            //TODO
            source.listTorikeshiAtoNoki_1 = RString.EMPTY;
        }
    }

    private void set期別徴収猶予期間リスト(KaigoHokenHokenryoChoshuyoyoTorikeshiTsuchishoB5YokoSource source) {
    ...
    private void set編集後宛先(KaigoHokenHokenryoChoshuyoyoTorikeshiTsuchishoB5YokoSource source) {
        if (編集後宛先 != null) {
    ...
    private void set認証者ソース(KaigoHokenHokenryoChoshuyoyoTorikeshiTsuchishoB5YokoSource source) {
    ...
    private void set介護問合せ先ソースビルダー(KaigoHokenHokenryoChoshuyoyoTorikeshiTsuchishoB5YokoSource source) {
