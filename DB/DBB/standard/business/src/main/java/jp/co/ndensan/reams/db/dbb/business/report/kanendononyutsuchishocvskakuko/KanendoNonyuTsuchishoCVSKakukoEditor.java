...
public class KanendoNonyuTsuchishoCVSKakukoEditor implements IKanendoNonyuTsuchishoCVSKakukoEditor {
     ...
     */
    protected KanendoNonyuTsuchishoCVSKakukoEditor(
    ...
    @Override
    public KanendoNonyuTsuchishoCVSKakukoSource edit(KanendoNonyuTsuchishoCVSKakukoSource source) {
        editSource(source);
        return source;
    }

    private KanendoNonyuTsuchishoCVSKakukoSource editSource(KanendoNonyuTsuchishoCVSKakukoSource source) {
        ...
        source.pageCount2 = new RString(item.get連番()).concat(new RString("-2"));
        if (ShoriKubun.バッチ.equals(item.get処理区分())) {
        ...
        source.pageCount3 = new RString(item.get連番()).concat(new RString("-3"));
    ...
    private KanendoNonyuTsuchishoCVSKakukoSource edit宛先(KanendoNonyuTsuchishoCVSKakukoSource source) {
    ...
    private KanendoNonyuTsuchishoCVSKakukoSource edit明細(KanendoNonyuTsuchishoCVSKakukoSource source) {
    ...
    private void edit納付書(KanendoNonyuTsuchishoCVSKakukoSource source) {
    ...
    private void edit雛形部品(KanendoNonyuTsuchishoCVSKakukoSource source) {
    ...
    private void editCompSofubutsuAtesaki(KanendoNonyuTsuchishoCVSKakukoSource source) {
    ...
    private void 納入通知書期情報設定(KanendoNonyuTsuchishoCVSKakukoSource source) {
    ...
    private void 編集後個人相関設定(KanendoNonyuTsuchishoCVSKakukoSource source) {
    ...
    private void 更正後情報相関設定(KanendoNonyuTsuchishoCVSKakukoSource source) {
    ...
    private void 計算明細書納付額設定(KanendoNonyuTsuchishoCVSKakukoSource source) {
