...
public class HokenryoNonyuTsuchishoBookFuriKaeNashiReport extends Report<HokenryoNonyuTsuchishoBookFuriKaeNashiCoverSource> {
     ...
     */
    protected HokenryoNonyuTsuchishoBookFuriKaeNashiReport(NonyuTsuchishoBookItem item) {
        this.item = item;
    }
     ...
     */
    public static HokenryoNonyuTsuchishoBookFuriKaeNashiReport createFrom(NonyuTsuchishoBookItem item) {
        return new HokenryoNonyuTsuchishoBookFuriKaeNashiReport(item);
    }
...
//        = AssociationFinderFactory.createInstance().getAssociation();
        ...
        for (NonyuTsuchiShoKiJoho 納入通知書期情報 : 納入通知書期情報リスト) {
            ...
            IHokenryoNonyuTsuchishoBookFuriKaeNashiEditor editor = new HokenryoNonyuTsuchishoBookFuriKaeNashiEditor(item,
