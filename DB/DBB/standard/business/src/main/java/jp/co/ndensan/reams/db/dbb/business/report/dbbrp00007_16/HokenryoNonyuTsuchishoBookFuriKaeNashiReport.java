...
public class HokenryoNonyuTsuchishoBookFuriKaeNashiReport extends NonyuTsuchisho<HokenryoNonyuTsuchishoBookFuriKaeNashiCoverSource> {
    ...
    public static HokenryoNonyuTsuchishoBookFuriKaeNashiReport createFrom(
        ...
        return new HokenryoNonyuTsuchishoBookFuriKaeNashiReport(本算定納入通知書情報, ninshoshaSource);
    }
    ...
    public List<NonyuTsuchisho<HokenryoNonyuTsuchishoBookFuriKaeNashiCoverSource>> devidedByPage() {
        ...
        HokenryoNonyuTsuchishoBookFuriKaeNashiReport reportCover
                = HokenryoNonyuTsuchishoBookFuriKaeNashiReport.createFrom(本算定納入通知書情報Cover, ninshoshaSource);
        ...
        for (NonyuTsuchiShoKiJoho 納入通知書期情報 : 納入通知書期情報リスト) {
            if (!isBegin) {
                ...
                if (detail設定数 >= INT4) {
                    ...
                    reportDetail = HokenryoNonyuTsuchishoBookFuriKaeNashiReport
