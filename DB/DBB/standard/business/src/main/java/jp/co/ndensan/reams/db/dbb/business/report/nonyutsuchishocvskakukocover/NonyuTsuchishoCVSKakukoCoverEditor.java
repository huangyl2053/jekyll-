...
//    private final RString HOSHI_28 = new RString("****************************");
     ...
     */
    protected NonyuTsuchishoCVSKakukoCoverEditor(KariSanteiNonyuTsuchiShoJoho item) {
        this.item = item;
    }

    @Override
    public NonyuTsuchishoCVSKakukoCoverSource edit(NonyuTsuchishoCVSKakukoCoverSource source) {
        return editSource(source);
    }

    private NonyuTsuchishoCVSKakukoCoverSource editSource(NonyuTsuchishoCVSKakukoCoverSource source) {
