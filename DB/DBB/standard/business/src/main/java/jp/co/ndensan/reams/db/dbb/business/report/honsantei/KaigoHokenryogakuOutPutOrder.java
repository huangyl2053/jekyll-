...
/**
 * 保険料額決定通知書発行一覧表の出力順クラスです。
 *
 * @reamsid_L DBB-0780-050 xicongwang
 */
public enum KaigoHokenryogakuOutPutOrder implements IReportItems {
    ...
    private KaigoHokenryogakuOutPutOrder(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
        this.項目ID = 項目ID;
