...
/**
 * 保険料納入通知書（仮算定）【コンビニマルチ収納タイプ】NofushoのBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBB-9110-050 huangh
 */
interface IKarisanteiNonyuTsuchishoCVSMultiNofushoBuilder extends IReportBuilder<KarisanteiNonyuTsuchishoCVSMultiSource> {
