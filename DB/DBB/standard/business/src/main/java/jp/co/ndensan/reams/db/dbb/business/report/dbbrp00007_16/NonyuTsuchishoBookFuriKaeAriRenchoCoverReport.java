...
public class NonyuTsuchishoBookFuriKaeAriRenchoCoverReport extends Report<NonyuTsuchishoBookFuriKaeAriRenchoCoverSource> {
     ...
     */
    protected NonyuTsuchishoBookFuriKaeAriRenchoCoverReport(NonyuTsuchishoBookItem item) {
        this.item = item;
    }
     ...
     */
    public NonyuTsuchishoBookFuriKaeAriRenchoCoverReport createFrom(NonyuTsuchishoBookItem item) {
        return new NonyuTsuchishoBookFuriKaeAriRenchoCoverReport(item);
    }
