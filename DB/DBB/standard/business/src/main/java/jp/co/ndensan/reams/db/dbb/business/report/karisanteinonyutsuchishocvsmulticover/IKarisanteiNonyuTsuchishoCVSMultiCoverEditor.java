...
/**
 * 保険料納入通知書（仮算定）【コンビニマルチ収納タイプ】Coverのエディターのインターフェースクラスです
 *
 */
public interface IKarisanteiNonyuTsuchishoCVSMultiCoverEditor extends IReportEditor<KarisanteiNonyuTsuchishoCVSMultiCoverSource> {
