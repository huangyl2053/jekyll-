...
/**
 *
 * 保険料納入通知書（本算定過年度）【銀振タイプ】帳票項目定義_5期_連帳 IHokenryoNonyuTsuchishoGinfuriFiveKiRenchoEditor
 */
public interface IHokenryoNonyuTsuchishoGinfuriFiveKiRenchoEditor extends IReportEditor<HokenryoNonyuTsuchishoGinfuriFiveKiRenchoSource> {
