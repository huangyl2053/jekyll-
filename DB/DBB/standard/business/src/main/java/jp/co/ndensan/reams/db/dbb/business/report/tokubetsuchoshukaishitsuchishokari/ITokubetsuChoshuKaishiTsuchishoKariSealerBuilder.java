...
/**
 * 特別徴収開始通知書（仮算定）帳票 シーラタイプIBuilder
 *
 * @reamsid_L DBB-0790-050 lijunjun
 */
public interface ITokubetsuChoshuKaishiTsuchishoKariSealerBuilder extends
        IReportBuilder<TokubetsuChoshuKaishiTsuchishoKariSealerSource> {
