...
/**
 *
 * 介護保険料額変更兼特別徴収中止通知書のA4縦タイプのReportです。
 *
 * @reamsid_L DBB-9080-020 sunhaidi
 */
public class KaigoHokenryogakuHenkoKenChushiTsuchishoA4TateReport
        extends Report<KaigoHokenryogakuHenkoKenChushiTsuchishoA4TateReportSource> {
     ...
     */
    public KaigoHokenryogakuHenkoKenChushiTsuchishoA4TateReport(
            List<KaigoHokenryogakuHenkoKenChushiTsuchishoBusiness> items) {
        this.items = items;
    }

    @Override
    public void writeBy(ReportSourceWriter<KaigoHokenryogakuHenkoKenChushiTsuchishoA4TateReportSource> reportSourceWriter) {
        for (KaigoHokenryogakuHenkoKenChushiTsuchishoBusiness item : items) {
            KaigoHokenryogakuHenkoKenChushiTsuchishoA4TateEditor yokoEditor = new KaigoHokenryogakuHenkoKenChushiTsuchishoA4TateEditor(item);
            ...
            for (int i = 1; i <= 特徴期リスト.size(); i++) {
                ...
                kibetsuBusiness.setListKibetsu_6(特徴期.padRight(SPACE, 2));
                kibetsuBusiness.setListKibetsu_7(特徴月);
                ...
                KaigoHokenryogakuHenkoKenChushiTsuchishoA4TateBuilder builder
                        = new KaigoHokenryogakuHenkoKenChushiTsuchishoA4TateBuilder(yokoEditor,
                                kibetsuEditor,
    ...
    private void set普徴期別金額(KibetsuBusiness kibetsuBusiness,
        ...
        if (Decimal.ZERO.equals(更正前_普徴期別金額)
            ...
            kibetsuBusiness.setListKibetsu_4(new RString(更正前_普徴期別金額.toString()));
            kibetsuBusiness.setListKibetsu_5(new RString(更正後_普徴期別金額.toString()));
        }
    }
    ...
    private void set特徴期別金額(KibetsuBusiness kibetsuBusiness,
        ...
        if (Decimal.ZERO.equals(更正前_特徴期別金額)
            ...
            kibetsuBusiness.setListKibetsu_8(new RString(更正前_特徴期別金額.toString()));
            kibetsuBusiness.setListKibetsu_9(new RString(更正後_特徴期別金額.toString()));
        }
    }
