...
/**
 * 保険料納入通知書（本算定過年度）【コンビニマルチ収納タイプ】のBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBB-9110-170 huangh
 */
interface IKanendoNonyuTsuchishoCVSMultiBuilder extends IReportBuilder<KanendoNonyuTsuchishoCVSMultiSource> {
