...
/**
 * 保険料納入通知書（本算定過年度）【ブックタイプ】（口振依頼あり）通知書 INonyuTsuchishoBookFuriKaeAriCoverBuilder
 *
 * @reamsid_L DBB-9110-160 wangjie2
 */
public interface IKanendoNonyuTsuchishoBookFuriKaeAriBuilder extends IReportBuilder<KanendoNonyuTsuchishoBookFuriKaeAriSource> {
