...
public class TokubetsuChoshuKaishiTsuchishoKariB5RenchoReport extends
     ...
     * @param 宛名連番 RString
     */
    public TokubetsuChoshuKaishiTsuchishoKariB5RenchoReport(KariTokuchoKaishiTsuchisyoJoho 仮算定特徴開始通知書情報, RString 宛名連番) {
     ...
     */
    public static TokubetsuChoshuKaishiTsuchishoKariB5RenchoReport createForm(
            @NonNull KariTokuchoKaishiTsuchisyoJoho 仮算定特徴開始通知書情報,
            RString 宛名連番) {
        return new TokubetsuChoshuKaishiTsuchishoKariB5RenchoReport(仮算定特徴開始通知書情報, 宛名連番);
    }

    @Override
    public void writeBy(ReportSourceWriter<TokubetsuChoshuKaishiTsuchishoKariB5RenchoSource> writer) {
        setItem();
        ITokubetsuChoshuKaishiTsuchishoKariB5RenchoEditor editor = new TokubetsuChoshuKaishiTsuchishoKariB5RenchoEditor(target);
