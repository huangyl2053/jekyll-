...
/**
 * 保険料納入通知書（仮算定）【コンビニ角公タイプ】納付書のエディターのインターフェースクラスです
 *
 */
public interface IKarisanteiNonyuTsuchishoCVSKakukoRenchoNofushoEditor extends IReportEditor<KarisanteiNonyuTsuchishoCVSKakukoRenchoNofushoSource> {
