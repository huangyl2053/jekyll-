...
/**
 * 保険料納入通知書（本算定）【コンビニマルチ収納タイプ】CoverのBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBB-9110-110 huangh
 */
interface INonyuTsuchishoCVSMultiCoverBuilder extends IReportBuilder<NonyuTsuchishoCVSMultiCoverSource> {
