...
module DBB {
     ...
     * Kiwarigakuクラスのみで継承して使えます。
     */
    export class Kiwarigaku_Design extends Uz.CommonChildDiv {
        ...
        public set TokuchoKiText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[25]["fieldName"] + "_" + this.layout.items[0].items[0].items[25].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[25]["fieldName"] + "_" + this.layout.items[0].items[0].items[25].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiText4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[53]["fieldName"] + "_" + this.layout.items[0].items[0].items[53].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[53]["fieldName"] + "_" + this.layout.items[0].items[0].items[53].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiText5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[67]["fieldName"] + "_" + this.layout.items[0].items[0].items[67].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[67]["fieldName"] + "_" + this.layout.items[0].items[0].items[67].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiVisible1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[6]["fieldName"] + "_" + this.layout.items[0].items[0].items[6].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[6]["fieldName"] + "_" + this.layout.items[0].items[0].items[6].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiVisible2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[25]["fieldName"] + "_" + this.layout.items[0].items[0].items[25].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[25]["fieldName"] + "_" + this.layout.items[0].items[0].items[25].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiVisible3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[39]["fieldName"] + "_" + this.layout.items[0].items[0].items[39].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[39]["fieldName"] + "_" + this.layout.items[0].items[0].items[39].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiVisible4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[53]["fieldName"] + "_" + this.layout.items[0].items[0].items[53].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[53]["fieldName"] + "_" + this.layout.items[0].items[0].items[53].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiVisible5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[67]["fieldName"] + "_" + this.layout.items[0].items[0].items[67].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[67]["fieldName"] + "_" + this.layout.items[0].items[0].items[67].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiVisible6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[81]["fieldName"] + "_" + this.layout.items[0].items[0].items[81].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[81]["fieldName"] + "_" + this.layout.items[0].items[0].items[81].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuKibetsuGakuText1() {
        ...
        public set TokuKibetsuGakuText1(value) {
        ...
        public get TokuKibetsuGakuText2() {
        ...
        public set TokuKibetsuGakuText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[26]["fieldName"] + "_" + this.layout.items[0].items[0].items[26].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[26]["fieldName"] + "_" + this.layout.items[0].items[0].items[26].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuKibetsuGakuText3() {
        ...
        public set TokuKibetsuGakuText3(value) {
        ...
        public get TokuKibetsuGakuText4() {
        ...
        public set TokuKibetsuGakuText4(value) {
        ...
        public get TokuKibetsuGakuText5() {
        ...
        public set TokuKibetsuGakuText5(value) {
        ...
        public get TokuKibetsuGakuText6() {
        ...
        public set TokuKibetsuGakuText6(value) {
        ...
        public get TokuKibetsuGakuVisible1() {
        ...
        public set TokuKibetsuGakuVisible1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[7]["fieldName"] + "_" + this.layout.items[0].items[0].items[7].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[7]["fieldName"] + "_" + this.layout.items[0].items[0].items[7].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuKibetsuGakuVisible2() {
        ...
        public set TokuKibetsuGakuVisible2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[26]["fieldName"] + "_" + this.layout.items[0].items[0].items[26].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[26]["fieldName"] + "_" + this.layout.items[0].items[0].items[26].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuKibetsuGakuVisible3() {
        ...
        public set TokuKibetsuGakuVisible3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[40]["fieldName"] + "_" + this.layout.items[0].items[0].items[40].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[40]["fieldName"] + "_" + this.layout.items[0].items[0].items[40].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuKibetsuGakuVisible4() {
        ...
        public set TokuKibetsuGakuVisible4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[54]["fieldName"] + "_" + this.layout.items[0].items[0].items[54].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[54]["fieldName"] + "_" + this.layout.items[0].items[0].items[54].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuKibetsuGakuVisible5() {
        ...
        public set TokuKibetsuGakuVisible5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[68]["fieldName"] + "_" + this.layout.items[0].items[0].items[68].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[68]["fieldName"] + "_" + this.layout.items[0].items[0].items[68].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuKibetsuGakuVisible6() {
        ...
        public set TokuKibetsuGakuVisible6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[82]["fieldName"] + "_" + this.layout.items[0].items[0].items[82].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[82]["fieldName"] + "_" + this.layout.items[0].items[0].items[82].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuNofuGakuText1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[13]["fieldName"] + "_" + this.layout.items[0].items[0].items[13].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[13]["fieldName"] + "_" + this.layout.items[0].items[0].items[13].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuNofuGakuText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[27]["fieldName"] + "_" + this.layout.items[0].items[0].items[27].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[27]["fieldName"] + "_" + this.layout.items[0].items[0].items[27].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuNofuGakuText3(value) {
        ...
        public set TokuNofuGakuText4(value) {
        ...
        public set TokuNofuGakuText5(value) {
        ...
        public set TokuNofuGakuText6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[83]["fieldName"] + "_" + this.layout.items[0].items[0].items[83].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[83]["fieldName"] + "_" + this.layout.items[0].items[0].items[83].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuNofuGakuText8() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuText8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuText9() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuText9(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuText10() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuText10(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuText11() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuText11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuText12() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuText12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuText13() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuText13(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuText14() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuText14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuVisible1() {
        ...
        public set TokuNofuGakuVisible1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[13]["fieldName"] + "_" + this.layout.items[0].items[0].items[13].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[13]["fieldName"] + "_" + this.layout.items[0].items[0].items[13].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuNofuGakuVisible2() {
        ...
        public set TokuNofuGakuVisible2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[27]["fieldName"] + "_" + this.layout.items[0].items[0].items[27].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[27]["fieldName"] + "_" + this.layout.items[0].items[0].items[27].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuNofuGakuVisible3() {
        ...
        public set TokuNofuGakuVisible3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[41]["fieldName"] + "_" + this.layout.items[0].items[0].items[41].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[41]["fieldName"] + "_" + this.layout.items[0].items[0].items[41].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuNofuGakuVisible4() {
        ...
        public set TokuNofuGakuVisible4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[55]["fieldName"] + "_" + this.layout.items[0].items[0].items[55].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[55]["fieldName"] + "_" + this.layout.items[0].items[0].items[55].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuNofuGakuVisible5() {
        ...
        public set TokuNofuGakuVisible5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[69]["fieldName"] + "_" + this.layout.items[0].items[0].items[69].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[69]["fieldName"] + "_" + this.layout.items[0].items[0].items[69].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuNofuGakuVisible6() {
        ...
        public set TokuNofuGakuVisible6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[83]["fieldName"] + "_" + this.layout.items[0].items[0].items[83].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[83]["fieldName"] + "_" + this.layout.items[0].items[0].items[83].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuNofuGakuVisible7() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuVisible7(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuVisible8() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuVisible8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuVisible9() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuVisible9(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuVisible10() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuVisible10(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuVisible11() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuVisible11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuVisible12() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuVisible12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuVisible13() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuVisible13(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public get TokuNofuGakuVisible14() {
            return Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"];
        }
        
        public set TokuNofuGakuVisible14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"]) != undefined ) {
                Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"])["visible"] = value;
            } else {
        ...
        public set FuchoKiText1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[14]["fieldName"] + "_" + this.layout.items[0].items[0].items[14].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[14]["fieldName"] + "_" + this.layout.items[0].items[0].items[14].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[63]["fieldName"] + "_" + this.layout.items[0].items[0].items[63].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[63]["fieldName"] + "_" + this.layout.items[0].items[0].items[63].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[84]["fieldName"] + "_" + this.layout.items[0].items[0].items[84].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[84]["fieldName"] + "_" + this.layout.items[0].items[0].items[84].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[105]["fieldName"] + "_" + this.layout.items[0].items[0].items[105].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[105]["fieldName"] + "_" + this.layout.items[0].items[0].items[105].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[14]["fieldName"] + "_" + this.layout.items[0].items[0].items[14].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[14]["fieldName"] + "_" + this.layout.items[0].items[0].items[14].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[21]["fieldName"] + "_" + this.layout.items[0].items[0].items[21].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[21]["fieldName"] + "_" + this.layout.items[0].items[0].items[21].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[28]["fieldName"] + "_" + this.layout.items[0].items[0].items[28].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[28]["fieldName"] + "_" + this.layout.items[0].items[0].items[28].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[35]["fieldName"] + "_" + this.layout.items[0].items[0].items[35].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[35]["fieldName"] + "_" + this.layout.items[0].items[0].items[35].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[42]["fieldName"] + "_" + this.layout.items[0].items[0].items[42].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[42]["fieldName"] + "_" + this.layout.items[0].items[0].items[42].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[49]["fieldName"] + "_" + this.layout.items[0].items[0].items[49].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[49]["fieldName"] + "_" + this.layout.items[0].items[0].items[49].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible7(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[56]["fieldName"] + "_" + this.layout.items[0].items[0].items[56].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[56]["fieldName"] + "_" + this.layout.items[0].items[0].items[56].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[63]["fieldName"] + "_" + this.layout.items[0].items[0].items[63].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[63]["fieldName"] + "_" + this.layout.items[0].items[0].items[63].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible9(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[70]["fieldName"] + "_" + this.layout.items[0].items[0].items[70].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[70]["fieldName"] + "_" + this.layout.items[0].items[0].items[70].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible10(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[77]["fieldName"] + "_" + this.layout.items[0].items[0].items[77].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[77]["fieldName"] + "_" + this.layout.items[0].items[0].items[77].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[84]["fieldName"] + "_" + this.layout.items[0].items[0].items[84].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[84]["fieldName"] + "_" + this.layout.items[0].items[0].items[84].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[91]["fieldName"] + "_" + this.layout.items[0].items[0].items[91].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[91]["fieldName"] + "_" + this.layout.items[0].items[0].items[91].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible13(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[98]["fieldName"] + "_" + this.layout.items[0].items[0].items[98].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[98]["fieldName"] + "_" + this.layout.items[0].items[0].items[98].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiVisible14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[105]["fieldName"] + "_" + this.layout.items[0].items[0].items[105].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[105]["fieldName"] + "_" + this.layout.items[0].items[0].items[105].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuText1() {
        ...
        public set FuchoKibetsuGakuText1(value) {
        ...
        public get FuchoKibetsuGakuText2() {
        ...
        public set FuchoKibetsuGakuText2(value) {
        ...
        public get FuchoKibetsuGakuText3() {
        ...
        public set FuchoKibetsuGakuText3(value) {
        ...
        public get FuchoKibetsuGakuText4() {
        ...
        public set FuchoKibetsuGakuText4(value) {
        ...
        public get FuchoKibetsuGakuText5() {
        ...
        public set FuchoKibetsuGakuText5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[43]["fieldName"] + "_" + this.layout.items[0].items[0].items[43].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[43]["fieldName"] + "_" + this.layout.items[0].items[0].items[43].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuText6() {
        ...
        public set FuchoKibetsuGakuText6(value) {
        ...
        public get FuchoKibetsuGakuText7() {
        ...
        public set FuchoKibetsuGakuText7(value) {
        ...
        public get FuchoKibetsuGakuText8() {
        ...
        public set FuchoKibetsuGakuText8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[64]["fieldName"] + "_" + this.layout.items[0].items[0].items[64].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[64]["fieldName"] + "_" + this.layout.items[0].items[0].items[64].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuText9() {
        ...
        public set FuchoKibetsuGakuText9(value) {
        ...
        public get FuchoKibetsuGakuText10() {
        ...
        public set FuchoKibetsuGakuText10(value) {
        ...
        public get FuchoKibetsuGakuText11() {
        ...
        public set FuchoKibetsuGakuText11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[85]["fieldName"] + "_" + this.layout.items[0].items[0].items[85].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[85]["fieldName"] + "_" + this.layout.items[0].items[0].items[85].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuText12() {
        ...
        public set FuchoKibetsuGakuText12(value) {
        ...
        public get FuchoKibetsuGakuText13() {
        ...
        public set FuchoKibetsuGakuText13(value) {
        ...
        public get FuchoKibetsuGakuText14() {
        ...
        public set FuchoKibetsuGakuText14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[106]["fieldName"] + "_" + this.layout.items[0].items[0].items[106].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[106]["fieldName"] + "_" + this.layout.items[0].items[0].items[106].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible1() {
        ...
        public set FuchoKibetsuGakuVisible1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[15]["fieldName"] + "_" + this.layout.items[0].items[0].items[15].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[15]["fieldName"] + "_" + this.layout.items[0].items[0].items[15].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible2() {
        ...
        public set FuchoKibetsuGakuVisible2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[22]["fieldName"] + "_" + this.layout.items[0].items[0].items[22].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[22]["fieldName"] + "_" + this.layout.items[0].items[0].items[22].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible3() {
        ...
        public set FuchoKibetsuGakuVisible3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[29]["fieldName"] + "_" + this.layout.items[0].items[0].items[29].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[29]["fieldName"] + "_" + this.layout.items[0].items[0].items[29].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible4() {
        ...
        public set FuchoKibetsuGakuVisible4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[36]["fieldName"] + "_" + this.layout.items[0].items[0].items[36].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[36]["fieldName"] + "_" + this.layout.items[0].items[0].items[36].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible5() {
        ...
        public set FuchoKibetsuGakuVisible5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[43]["fieldName"] + "_" + this.layout.items[0].items[0].items[43].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[43]["fieldName"] + "_" + this.layout.items[0].items[0].items[43].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible6() {
        ...
        public set FuchoKibetsuGakuVisible6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[50]["fieldName"] + "_" + this.layout.items[0].items[0].items[50].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[50]["fieldName"] + "_" + this.layout.items[0].items[0].items[50].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible7() {
        ...
        public set FuchoKibetsuGakuVisible7(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[57]["fieldName"] + "_" + this.layout.items[0].items[0].items[57].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[57]["fieldName"] + "_" + this.layout.items[0].items[0].items[57].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible8() {
        ...
        public set FuchoKibetsuGakuVisible8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[64]["fieldName"] + "_" + this.layout.items[0].items[0].items[64].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[64]["fieldName"] + "_" + this.layout.items[0].items[0].items[64].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible9() {
        ...
        public set FuchoKibetsuGakuVisible9(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[71]["fieldName"] + "_" + this.layout.items[0].items[0].items[71].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[71]["fieldName"] + "_" + this.layout.items[0].items[0].items[71].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible10() {
        ...
        public set FuchoKibetsuGakuVisible10(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[78]["fieldName"] + "_" + this.layout.items[0].items[0].items[78].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[78]["fieldName"] + "_" + this.layout.items[0].items[0].items[78].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible11() {
        ...
        public set FuchoKibetsuGakuVisible11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[85]["fieldName"] + "_" + this.layout.items[0].items[0].items[85].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[85]["fieldName"] + "_" + this.layout.items[0].items[0].items[85].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible12() {
        ...
        public set FuchoKibetsuGakuVisible12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[92]["fieldName"] + "_" + this.layout.items[0].items[0].items[92].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[92]["fieldName"] + "_" + this.layout.items[0].items[0].items[92].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible13() {
        ...
        public set FuchoKibetsuGakuVisible13(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[99]["fieldName"] + "_" + this.layout.items[0].items[0].items[99].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[99]["fieldName"] + "_" + this.layout.items[0].items[0].items[99].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsuGakuVisible14() {
        ...
        public set FuchoKibetsuGakuVisible14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[106]["fieldName"] + "_" + this.layout.items[0].items[0].items[106].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[106]["fieldName"] + "_" + this.layout.items[0].items[0].items[106].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoNofuGakuText1(value) {
        ...
        public set FuchoNofuGakuText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[23]["fieldName"] + "_" + this.layout.items[0].items[0].items[23].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[23]["fieldName"] + "_" + this.layout.items[0].items[0].items[23].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoNofuGakuText3(value) {
        ...
        public set FuchoNofuGakuText4(value) {
        ...
        public set FuchoNofuGakuText5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[44]["fieldName"] + "_" + this.layout.items[0].items[0].items[44].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[44]["fieldName"] + "_" + this.layout.items[0].items[0].items[44].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoNofuGakuText6(value) {
        ...
        public set FuchoNofuGakuText7(value) {
        ...
        public set FuchoNofuGakuText8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[65]["fieldName"] + "_" + this.layout.items[0].items[0].items[65].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[65]["fieldName"] + "_" + this.layout.items[0].items[0].items[65].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoNofuGakuText9(value) {
        ...
        public get FuchoNofuGakuText10() {
        ...
        public set FuchoNofuGakuText10(value) {
        ...
        public get FuchoNofuGakuText11() {
        ...
        public set FuchoNofuGakuText11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[86]["fieldName"] + "_" + this.layout.items[0].items[0].items[86].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[86]["fieldName"] + "_" + this.layout.items[0].items[0].items[86].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuText12() {
        ...
        public set FuchoNofuGakuText12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[93]["fieldName"] + "_" + this.layout.items[0].items[0].items[93].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[93]["fieldName"] + "_" + this.layout.items[0].items[0].items[93].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuText13() {
        ...
        public set FuchoNofuGakuText13(value) {
        ...
        public get FuchoNofuGakuText14() {
        ...
        public set FuchoNofuGakuText14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[107]["fieldName"] + "_" + this.layout.items[0].items[0].items[107].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[107]["fieldName"] + "_" + this.layout.items[0].items[0].items[107].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible1() {
        ...
        public set FuchoNofuGakuVisible1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[16]["fieldName"] + "_" + this.layout.items[0].items[0].items[16].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[16]["fieldName"] + "_" + this.layout.items[0].items[0].items[16].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible2() {
        ...
        public set FuchoNofuGakuVisible2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[23]["fieldName"] + "_" + this.layout.items[0].items[0].items[23].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[23]["fieldName"] + "_" + this.layout.items[0].items[0].items[23].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible3() {
        ...
        public set FuchoNofuGakuVisible3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[30]["fieldName"] + "_" + this.layout.items[0].items[0].items[30].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[30]["fieldName"] + "_" + this.layout.items[0].items[0].items[30].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible4() {
        ...
        public set FuchoNofuGakuVisible4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[37]["fieldName"] + "_" + this.layout.items[0].items[0].items[37].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[37]["fieldName"] + "_" + this.layout.items[0].items[0].items[37].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible5() {
        ...
        public set FuchoNofuGakuVisible5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[44]["fieldName"] + "_" + this.layout.items[0].items[0].items[44].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[44]["fieldName"] + "_" + this.layout.items[0].items[0].items[44].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible6() {
        ...
        public set FuchoNofuGakuVisible6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[51]["fieldName"] + "_" + this.layout.items[0].items[0].items[51].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[51]["fieldName"] + "_" + this.layout.items[0].items[0].items[51].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible7() {
        ...
        public set FuchoNofuGakuVisible7(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[58]["fieldName"] + "_" + this.layout.items[0].items[0].items[58].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[58]["fieldName"] + "_" + this.layout.items[0].items[0].items[58].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible8() {
        ...
        public set FuchoNofuGakuVisible8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[65]["fieldName"] + "_" + this.layout.items[0].items[0].items[65].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[65]["fieldName"] + "_" + this.layout.items[0].items[0].items[65].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible9() {
        ...
        public set FuchoNofuGakuVisible9(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[72]["fieldName"] + "_" + this.layout.items[0].items[0].items[72].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[72]["fieldName"] + "_" + this.layout.items[0].items[0].items[72].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible10() {
        ...
        public set FuchoNofuGakuVisible10(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[79]["fieldName"] + "_" + this.layout.items[0].items[0].items[79].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[79]["fieldName"] + "_" + this.layout.items[0].items[0].items[79].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible11() {
        ...
        public set FuchoNofuGakuVisible11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[86]["fieldName"] + "_" + this.layout.items[0].items[0].items[86].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[86]["fieldName"] + "_" + this.layout.items[0].items[0].items[86].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible12() {
        ...
        public set FuchoNofuGakuVisible12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[93]["fieldName"] + "_" + this.layout.items[0].items[0].items[93].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[93]["fieldName"] + "_" + this.layout.items[0].items[0].items[93].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible13() {
        ...
        public set FuchoNofuGakuVisible13(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[100]["fieldName"] + "_" + this.layout.items[0].items[0].items[100].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[100]["fieldName"] + "_" + this.layout.items[0].items[0].items[100].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNofuGakuVisible14() {
        ...
        public set FuchoNofuGakuVisible14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[107]["fieldName"] + "_" + this.layout.items[0].items[0].items[107].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[107]["fieldName"] + "_" + this.layout.items[0].items[0].items[107].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuKibetsugakuKeiText() {
        ...
        public set TokuKibetsugakuKeiText(value) {
        ...
        public get TokuKibetsugakuKeiVisible() {
        ...
        public set TokuKibetsugakuKeiVisible(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[110]["fieldName"] + "_" + this.layout.items[0].items[0].items[110].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[110]["fieldName"] + "_" + this.layout.items[0].items[0].items[110].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuNofugakuKeiText() {
        ...
        public set TokuNofugakuKeiText(value) {
        ...
        public get TokuNofugakuKeiVisible() {
        ...
        public set TokuNofugakuKeiVisible(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[111]["fieldName"] + "_" + this.layout.items[0].items[0].items[111].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[111]["fieldName"] + "_" + this.layout.items[0].items[0].items[111].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsugakuKeiText() {
        ...
        public set FuchoKibetsugakuKeiText(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[113]["fieldName"] + "_" + this.layout.items[0].items[0].items[113].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[113]["fieldName"] + "_" + this.layout.items[0].items[0].items[113].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoKibetsugakuKeiVisible() {
        ...
        public set FuchoKibetsugakuKeiVisible(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[113]["fieldName"] + "_" + this.layout.items[0].items[0].items[113].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[113]["fieldName"] + "_" + this.layout.items[0].items[0].items[113].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoNoufugakuKeiText() {
        ...
        public set FuchoNoufugakuKeiText(value) {
        ...
        public get FuchoNofugakuKeiVisible() {
        ...
        public set FuchoNofugakuKeiVisible(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[114]["fieldName"] + "_" + this.layout.items[0].items[0].items[114].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[114]["fieldName"] + "_" + this.layout.items[0].items[0].items[114].items[0]["fieldName"]) != undefined ) {
        ...
        constructor($parentElement: JQuery, isDesignMode: bool, fieldName: string) {
            super($parentElement, isDesignMode, Kiwarigaku_Design.myLayout, fieldName);
        }
...
=======
     "html": "<table border=\"1\" cellspacing=0 cellpadding=0 span style=\"font-size:11pt\">\n  <tbody>\n    <tr bgcolor=\"LightBlue\"><td id='R1C1'></td><td colspan=\"3\" id='R1C2'></td><td colspan=\"3\"  id='R1C6'></td></tr>\n    <tr bgcolor=\"LightBlue\" ><td id='R2C1'></td><td id='R2C2'></td><td id='R2C3'></td><td id='R2C4'></td><td id='R2C5'></td><td id='R2C6'></td><td id='R2C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R3C1'></td><td bgcolor=\"LightBlue\" id='R3C2'></td><td id='R3C3'></td><td id='R3C4'></td><td bgcolor=\"LightBlue\" id='R3C5'></td><td id='R3C6'></td><td id='R3C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R4C1'></td><td bgcolor=\"LightBlue\" id='R4C2'></td><td id='R4C3'></td><td id='R4C4'></td><td bgcolor=\"LightBlue\" id='R4C5'></td><td id='R4C6'></td><td id='R4C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R5C1'></td><td bgcolor=\"LightBlue\" id='R5C2'></td><td id='R5C3'></td><td id='R5C4'></td><td bgcolor=\"LightBlue\" id='R5C5'></td><td id='R5C6'></td><td id='R5C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R6C1'></td><td bgcolor=\"LightBlue\" id='R6C2'></td><td id='R6C3'></td><td id='R6C4'></td><td bgcolor=\"LightBlue\" id='R6C5'></td><td id='R6C6'></td><td id='R6C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R7C1'></td><td bgcolor=\"LightBlue\" id='R7C2'></td><td id='R7C3'></td><td id='R7C4'></td><td bgcolor=\"LightBlue\" id='R7C5'></td><td id='R7C6'></td><td id='R7C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R8C1'></td><td bgcolor=\"LightBlue\" id='R8C2'></td><td id='R8C3'></td><td id='R8C4'></td><td bgcolor=\"LightBlue\" id='R8C5'></td><td id='R8C6'></td><td id='R8C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R9C1'></td><td bgcolor=\"LightBlue\" id='R9C2'></td><td id='R9C3'></td><td id='R9C4'></td><td bgcolor=\"LightBlue\" id='R9C5'></td><td id='R9C6'></td><td id='R9C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R10C1'></td><td bgcolor=\"LightBlue\" id='R10C2'></td><td id='R10C3'></td><td id='R10C4'></td><td bgcolor=\"LightBlue\" id='R10C5'></td><td id='R10C6'></td><td id='R10C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R11C1'></td><td bgcolor=\"LightBlue\" id='R11C2'></td><td id='R11C3'></td><td id='R11C4'></td><td bgcolor=\"LightBlue\" id='R11C5'></td><td id='R11C6'></td><td id='R11C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R12C1'></td><td bgcolor=\"LightBlue\" id='R12C2'></td><td id='R12C3'></td><td id='R12C4'></td><td bgcolor=\"LightBlue\" id='R12C5'></td><td id='R12C6'></td><td id='R12C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R13C1'></td><td bgcolor=\"LightBlue\" id='R13C2'></td><td id='R13C3'></td><td id='R13C4'></td><td bgcolor=\"LightBlue\" id='R13C5'></td><td id='R13C6'></td><td id='R13C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R14C1'></td><td bgcolor=\"LightBlue\" id='R14C2'></td><td id='R14C3'></td><td id='R14C4'></td><td bgcolor=\"LightBlue\" id='R14C5'></td><td id='R14C6'></td><td id='R14C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R15C1'></td><td bgcolor=\"LightBlue\" id='R15C2'></td><td id='R15C3'></td><td id='R15C4'></td><td bgcolor=\"LightBlue\" id='R15C5'></td><td id='R15C6'></td><td id='R15C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R16C1'></td><td bgcolor=\"LightBlue\" id='R16C2'></td><td id='R16C3'></td><td id='R16C4'></td><td bgcolor=\"LightBlue\" id='R16C5'></td><td id='R16C6'></td><td id='R16C7'></td></tr>\n    <tr><td bgcolor=\"LightBlue\" id='R17C1'></td><td bgcolor=\"LightBlue\" id='R17C2'></td><td id='R17C3'></td><td id='R17C4'></td><td bgcolor=\"LightBlue\" id='R17C5'></td><td id='R17C6'></td><td id='R17C7'></td></tr>\n  </tbody>\n</table>\n"
>>>>>>> develop
    }
   ],
   "controlType": "Panel",
