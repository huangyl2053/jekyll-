...
module DBB {
     ...
     * KiwarigakuMaeAtoクラスのみで継承して使えます。
     */
    export class KiwarigakuMaeAto_Design extends Uz.CommonChildDiv {
    
        public get TokuchoKiText1() {
        ...
        public set TokuchoKiText1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[6]["fieldName"] + "_" + this.layout.items[0].items[0].items[6].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[6]["fieldName"] + "_" + this.layout.items[0].items[0].items[6].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[34]["fieldName"] + "_" + this.layout.items[0].items[0].items[34].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[34]["fieldName"] + "_" + this.layout.items[0].items[0].items[34].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiText3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[54]["fieldName"] + "_" + this.layout.items[0].items[0].items[54].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[54]["fieldName"] + "_" + this.layout.items[0].items[0].items[54].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiText4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[74]["fieldName"] + "_" + this.layout.items[0].items[0].items[74].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[74]["fieldName"] + "_" + this.layout.items[0].items[0].items[74].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiText5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[94]["fieldName"] + "_" + this.layout.items[0].items[0].items[94].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[94]["fieldName"] + "_" + this.layout.items[0].items[0].items[94].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoKiText6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[114]["fieldName"] + "_" + this.layout.items[0].items[0].items[114].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[114]["fieldName"] + "_" + this.layout.items[0].items[0].items[114].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoMaeText1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[7]["fieldName"] + "_" + this.layout.items[0].items[0].items[7].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[7]["fieldName"] + "_" + this.layout.items[0].items[0].items[7].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoMaeText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[35]["fieldName"] + "_" + this.layout.items[0].items[0].items[35].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[35]["fieldName"] + "_" + this.layout.items[0].items[0].items[35].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoMaeText3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[55]["fieldName"] + "_" + this.layout.items[0].items[0].items[55].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[55]["fieldName"] + "_" + this.layout.items[0].items[0].items[55].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoMaeText4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[75]["fieldName"] + "_" + this.layout.items[0].items[0].items[75].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[75]["fieldName"] + "_" + this.layout.items[0].items[0].items[75].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoMaeText5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[95]["fieldName"] + "_" + this.layout.items[0].items[0].items[95].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[95]["fieldName"] + "_" + this.layout.items[0].items[0].items[95].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoMaeText6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[115]["fieldName"] + "_" + this.layout.items[0].items[0].items[115].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[115]["fieldName"] + "_" + this.layout.items[0].items[0].items[115].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoMaeKeiText(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[155]["fieldName"] + "_" + this.layout.items[0].items[0].items[155].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[155]["fieldName"] + "_" + this.layout.items[0].items[0].items[155].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoTextVisi1() {
        ...
        public set TokuchoAtoTextVisi1(value) {
        ...
        public get TokuchoAtoTextVisi2() {
        ...
        public set TokuchoAtoTextVisi2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[36]["fieldName"] + "_" + this.layout.items[0].items[0].items[36].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[36]["fieldName"] + "_" + this.layout.items[0].items[0].items[36].items[1]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoTextVisi3() {
        ...
        public set TokuchoAtoTextVisi3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[56]["fieldName"] + "_" + this.layout.items[0].items[0].items[56].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[56]["fieldName"] + "_" + this.layout.items[0].items[0].items[56].items[1]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoTextVisi4() {
        ...
        public set TokuchoAtoTextVisi4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[76]["fieldName"] + "_" + this.layout.items[0].items[0].items[76].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[76]["fieldName"] + "_" + this.layout.items[0].items[0].items[76].items[1]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoTextVisi5() {
        ...
        public set TokuchoAtoTextVisi5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[96]["fieldName"] + "_" + this.layout.items[0].items[0].items[96].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[96]["fieldName"] + "_" + this.layout.items[0].items[0].items[96].items[1]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoTextVisi6() {
        ...
        public set TokuchoAtoTextVisi6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[116]["fieldName"] + "_" + this.layout.items[0].items[0].items[116].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[116]["fieldName"] + "_" + this.layout.items[0].items[0].items[116].items[1]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoLabelVisi1() {
        ...
        public set TokuchoAtoLabelVisi1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[16]["fieldName"] + "_" + this.layout.items[0].items[0].items[16].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[16]["fieldName"] + "_" + this.layout.items[0].items[0].items[16].items[1]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoLabelVisi2() {
        ...
        public set TokuchoAtoLabelVisi2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[36]["fieldName"] + "_" + this.layout.items[0].items[0].items[36].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[36]["fieldName"] + "_" + this.layout.items[0].items[0].items[36].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoLabelVisi3() {
        ...
        public set TokuchoAtoLabelVisi3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[56]["fieldName"] + "_" + this.layout.items[0].items[0].items[56].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[56]["fieldName"] + "_" + this.layout.items[0].items[0].items[56].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoLabelVisi4() {
        ...
        public set TokuchoAtoLabelVisi4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[76]["fieldName"] + "_" + this.layout.items[0].items[0].items[76].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[76]["fieldName"] + "_" + this.layout.items[0].items[0].items[76].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoLabelVisi5() {
        ...
        public set TokuchoAtoLabelVisi5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[96]["fieldName"] + "_" + this.layout.items[0].items[0].items[96].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[96]["fieldName"] + "_" + this.layout.items[0].items[0].items[96].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoLabelVisi6() {
        ...
        public set TokuchoAtoLabelVisi6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[116]["fieldName"] + "_" + this.layout.items[0].items[0].items[116].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[116]["fieldName"] + "_" + this.layout.items[0].items[0].items[116].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoLabelText1() {
        ...
        public set TokuchoAtoLabelText1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[16]["fieldName"] + "_" + this.layout.items[0].items[0].items[16].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[16]["fieldName"] + "_" + this.layout.items[0].items[0].items[16].items[1]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoLabelText2() {
        ...
        public set TokuchoAtoLabelText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[36]["fieldName"] + "_" + this.layout.items[0].items[0].items[36].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[36]["fieldName"] + "_" + this.layout.items[0].items[0].items[36].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoLabelText3() {
        ...
        public set TokuchoAtoLabelText3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[56]["fieldName"] + "_" + this.layout.items[0].items[0].items[56].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[56]["fieldName"] + "_" + this.layout.items[0].items[0].items[56].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoLabelText4() {
        ...
        public set TokuchoAtoLabelText4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[76]["fieldName"] + "_" + this.layout.items[0].items[0].items[76].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[76]["fieldName"] + "_" + this.layout.items[0].items[0].items[76].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoLabelText5() {
        ...
        public set TokuchoAtoLabelText5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[96]["fieldName"] + "_" + this.layout.items[0].items[0].items[96].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[96]["fieldName"] + "_" + this.layout.items[0].items[0].items[96].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuchoAtoLabelText6() {
        ...
        public set TokuchoAtoLabelText6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[116]["fieldName"] + "_" + this.layout.items[0].items[0].items[116].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[116]["fieldName"] + "_" + this.layout.items[0].items[0].items[116].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoAtoKeiVisi(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[156]["fieldName"] + "_" + this.layout.items[0].items[0].items[156].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[156]["fieldName"] + "_" + this.layout.items[0].items[0].items[156].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoAtoKeiText(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[156]["fieldName"] + "_" + this.layout.items[0].items[0].items[156].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[156]["fieldName"] + "_" + this.layout.items[0].items[0].items[156].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoZougenText1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[17]["fieldName"] + "_" + this.layout.items[0].items[0].items[17].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[17]["fieldName"] + "_" + this.layout.items[0].items[0].items[17].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoZougenText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[37]["fieldName"] + "_" + this.layout.items[0].items[0].items[37].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[37]["fieldName"] + "_" + this.layout.items[0].items[0].items[37].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoZougenText3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[57]["fieldName"] + "_" + this.layout.items[0].items[0].items[57].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[57]["fieldName"] + "_" + this.layout.items[0].items[0].items[57].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoZougenText4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[77]["fieldName"] + "_" + this.layout.items[0].items[0].items[77].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[77]["fieldName"] + "_" + this.layout.items[0].items[0].items[77].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoZougenText5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[97]["fieldName"] + "_" + this.layout.items[0].items[0].items[97].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[97]["fieldName"] + "_" + this.layout.items[0].items[0].items[97].items[0]["fieldName"]) != undefined ) {
        ...
        public set TokuchoZougenText6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[117]["fieldName"] + "_" + this.layout.items[0].items[0].items[117].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[117]["fieldName"] + "_" + this.layout.items[0].items[0].items[117].items[0]["fieldName"]) != undefined ) {
        ...
        public get TokuchoZougenKeiText() {
        ...
        public set TokuchoZougenKeiText(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[157]["fieldName"] + "_" + this.layout.items[0].items[0].items[157].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[157]["fieldName"] + "_" + this.layout.items[0].items[0].items[157].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[18]["fieldName"] + "_" + this.layout.items[0].items[0].items[18].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[18]["fieldName"] + "_" + this.layout.items[0].items[0].items[18].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[28]["fieldName"] + "_" + this.layout.items[0].items[0].items[28].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[28]["fieldName"] + "_" + this.layout.items[0].items[0].items[28].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[38]["fieldName"] + "_" + this.layout.items[0].items[0].items[38].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[38]["fieldName"] + "_" + this.layout.items[0].items[0].items[38].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[48]["fieldName"] + "_" + this.layout.items[0].items[0].items[48].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[48]["fieldName"] + "_" + this.layout.items[0].items[0].items[48].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[58]["fieldName"] + "_" + this.layout.items[0].items[0].items[58].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[58]["fieldName"] + "_" + this.layout.items[0].items[0].items[58].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[68]["fieldName"] + "_" + this.layout.items[0].items[0].items[68].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[68]["fieldName"] + "_" + this.layout.items[0].items[0].items[68].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText7(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[78]["fieldName"] + "_" + this.layout.items[0].items[0].items[78].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[78]["fieldName"] + "_" + this.layout.items[0].items[0].items[78].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[88]["fieldName"] + "_" + this.layout.items[0].items[0].items[88].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[88]["fieldName"] + "_" + this.layout.items[0].items[0].items[88].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText9(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[98]["fieldName"] + "_" + this.layout.items[0].items[0].items[98].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[98]["fieldName"] + "_" + this.layout.items[0].items[0].items[98].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText10(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[108]["fieldName"] + "_" + this.layout.items[0].items[0].items[108].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[108]["fieldName"] + "_" + this.layout.items[0].items[0].items[108].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[118]["fieldName"] + "_" + this.layout.items[0].items[0].items[118].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[118]["fieldName"] + "_" + this.layout.items[0].items[0].items[118].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[128]["fieldName"] + "_" + this.layout.items[0].items[0].items[128].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[128]["fieldName"] + "_" + this.layout.items[0].items[0].items[128].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText13(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[138]["fieldName"] + "_" + this.layout.items[0].items[0].items[138].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[138]["fieldName"] + "_" + this.layout.items[0].items[0].items[138].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoKiText14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[148]["fieldName"] + "_" + this.layout.items[0].items[0].items[148].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[148]["fieldName"] + "_" + this.layout.items[0].items[0].items[148].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[19]["fieldName"] + "_" + this.layout.items[0].items[0].items[19].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[19]["fieldName"] + "_" + this.layout.items[0].items[0].items[19].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[29]["fieldName"] + "_" + this.layout.items[0].items[0].items[29].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[29]["fieldName"] + "_" + this.layout.items[0].items[0].items[29].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[39]["fieldName"] + "_" + this.layout.items[0].items[0].items[39].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[39]["fieldName"] + "_" + this.layout.items[0].items[0].items[39].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[49]["fieldName"] + "_" + this.layout.items[0].items[0].items[49].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[49]["fieldName"] + "_" + this.layout.items[0].items[0].items[49].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[59]["fieldName"] + "_" + this.layout.items[0].items[0].items[59].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[59]["fieldName"] + "_" + this.layout.items[0].items[0].items[59].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[69]["fieldName"] + "_" + this.layout.items[0].items[0].items[69].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[69]["fieldName"] + "_" + this.layout.items[0].items[0].items[69].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText7(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[79]["fieldName"] + "_" + this.layout.items[0].items[0].items[79].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[79]["fieldName"] + "_" + this.layout.items[0].items[0].items[79].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[89]["fieldName"] + "_" + this.layout.items[0].items[0].items[89].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[89]["fieldName"] + "_" + this.layout.items[0].items[0].items[89].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText9(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[99]["fieldName"] + "_" + this.layout.items[0].items[0].items[99].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[99]["fieldName"] + "_" + this.layout.items[0].items[0].items[99].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText10(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[109]["fieldName"] + "_" + this.layout.items[0].items[0].items[109].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[109]["fieldName"] + "_" + this.layout.items[0].items[0].items[109].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[119]["fieldName"] + "_" + this.layout.items[0].items[0].items[119].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[119]["fieldName"] + "_" + this.layout.items[0].items[0].items[119].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[129]["fieldName"] + "_" + this.layout.items[0].items[0].items[129].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[129]["fieldName"] + "_" + this.layout.items[0].items[0].items[129].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText13(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[139]["fieldName"] + "_" + this.layout.items[0].items[0].items[139].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[139]["fieldName"] + "_" + this.layout.items[0].items[0].items[139].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeText14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[149]["fieldName"] + "_" + this.layout.items[0].items[0].items[149].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[149]["fieldName"] + "_" + this.layout.items[0].items[0].items[149].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoMaeKeiText(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[159]["fieldName"] + "_" + this.layout.items[0].items[0].items[159].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[159]["fieldName"] + "_" + this.layout.items[0].items[0].items[159].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[20]["fieldName"] + "_" + this.layout.items[0].items[0].items[20].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[20]["fieldName"] + "_" + this.layout.items[0].items[0].items[20].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[30]["fieldName"] + "_" + this.layout.items[0].items[0].items[30].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[30]["fieldName"] + "_" + this.layout.items[0].items[0].items[30].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[40]["fieldName"] + "_" + this.layout.items[0].items[0].items[40].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[40]["fieldName"] + "_" + this.layout.items[0].items[0].items[40].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[50]["fieldName"] + "_" + this.layout.items[0].items[0].items[50].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[50]["fieldName"] + "_" + this.layout.items[0].items[0].items[50].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[60]["fieldName"] + "_" + this.layout.items[0].items[0].items[60].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[60]["fieldName"] + "_" + this.layout.items[0].items[0].items[60].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[70]["fieldName"] + "_" + this.layout.items[0].items[0].items[70].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[70]["fieldName"] + "_" + this.layout.items[0].items[0].items[70].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi7(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[80]["fieldName"] + "_" + this.layout.items[0].items[0].items[80].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[80]["fieldName"] + "_" + this.layout.items[0].items[0].items[80].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[90]["fieldName"] + "_" + this.layout.items[0].items[0].items[90].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[90]["fieldName"] + "_" + this.layout.items[0].items[0].items[90].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi9(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[100]["fieldName"] + "_" + this.layout.items[0].items[0].items[100].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[100]["fieldName"] + "_" + this.layout.items[0].items[0].items[100].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi10(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[110]["fieldName"] + "_" + this.layout.items[0].items[0].items[110].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[110]["fieldName"] + "_" + this.layout.items[0].items[0].items[110].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[120]["fieldName"] + "_" + this.layout.items[0].items[0].items[120].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[120]["fieldName"] + "_" + this.layout.items[0].items[0].items[120].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[130]["fieldName"] + "_" + this.layout.items[0].items[0].items[130].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[130]["fieldName"] + "_" + this.layout.items[0].items[0].items[130].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi13(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[140]["fieldName"] + "_" + this.layout.items[0].items[0].items[140].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[140]["fieldName"] + "_" + this.layout.items[0].items[0].items[140].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoTextVisi14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[150]["fieldName"] + "_" + this.layout.items[0].items[0].items[150].items[1]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[150]["fieldName"] + "_" + this.layout.items[0].items[0].items[150].items[1]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelVisi1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[20]["fieldName"] + "_" + this.layout.items[0].items[0].items[20].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[20]["fieldName"] + "_" + this.layout.items[0].items[0].items[20].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelVisi2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[30]["fieldName"] + "_" + this.layout.items[0].items[0].items[30].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[30]["fieldName"] + "_" + this.layout.items[0].items[0].items[30].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelVisi3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[40]["fieldName"] + "_" + this.layout.items[0].items[0].items[40].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[40]["fieldName"] + "_" + this.layout.items[0].items[0].items[40].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelVisi4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[50]["fieldName"] + "_" + this.layout.items[0].items[0].items[50].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[50]["fieldName"] + "_" + this.layout.items[0].items[0].items[50].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelVisi5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[60]["fieldName"] + "_" + this.layout.items[0].items[0].items[60].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[60]["fieldName"] + "_" + this.layout.items[0].items[0].items[60].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelVisi6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[70]["fieldName"] + "_" + this.layout.items[0].items[0].items[70].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[70]["fieldName"] + "_" + this.layout.items[0].items[0].items[70].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelVisi7(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[80]["fieldName"] + "_" + this.layout.items[0].items[0].items[80].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[80]["fieldName"] + "_" + this.layout.items[0].items[0].items[80].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelVisi8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[90]["fieldName"] + "_" + this.layout.items[0].items[0].items[90].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[90]["fieldName"] + "_" + this.layout.items[0].items[0].items[90].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelVisi9(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[100]["fieldName"] + "_" + this.layout.items[0].items[0].items[100].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[100]["fieldName"] + "_" + this.layout.items[0].items[0].items[100].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoAtoLabelVisi10() {
        ...
        public set FuchoAtoLabelVisi10(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[110]["fieldName"] + "_" + this.layout.items[0].items[0].items[110].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[110]["fieldName"] + "_" + this.layout.items[0].items[0].items[110].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoAtoLabelVisi11() {
        ...
        public set FuchoAtoLabelVisi11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[120]["fieldName"] + "_" + this.layout.items[0].items[0].items[120].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[120]["fieldName"] + "_" + this.layout.items[0].items[0].items[120].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoAtoLabelVisi12() {
        ...
        public set FuchoAtoLabelVisi12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[130]["fieldName"] + "_" + this.layout.items[0].items[0].items[130].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[130]["fieldName"] + "_" + this.layout.items[0].items[0].items[130].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoAtoLabelVisi13() {
        ...
        public set FuchoAtoLabelVisi13(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[140]["fieldName"] + "_" + this.layout.items[0].items[0].items[140].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[140]["fieldName"] + "_" + this.layout.items[0].items[0].items[140].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoAtoLabelVisi14() {
        ...
        public set FuchoAtoLabelVisi14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[150]["fieldName"] + "_" + this.layout.items[0].items[0].items[150].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[150]["fieldName"] + "_" + this.layout.items[0].items[0].items[150].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelText1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[20]["fieldName"] + "_" + this.layout.items[0].items[0].items[20].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[20]["fieldName"] + "_" + this.layout.items[0].items[0].items[20].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[30]["fieldName"] + "_" + this.layout.items[0].items[0].items[30].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[30]["fieldName"] + "_" + this.layout.items[0].items[0].items[30].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelText3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[40]["fieldName"] + "_" + this.layout.items[0].items[0].items[40].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[40]["fieldName"] + "_" + this.layout.items[0].items[0].items[40].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelText4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[50]["fieldName"] + "_" + this.layout.items[0].items[0].items[50].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[50]["fieldName"] + "_" + this.layout.items[0].items[0].items[50].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelText5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[60]["fieldName"] + "_" + this.layout.items[0].items[0].items[60].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[60]["fieldName"] + "_" + this.layout.items[0].items[0].items[60].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelText6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[70]["fieldName"] + "_" + this.layout.items[0].items[0].items[70].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[70]["fieldName"] + "_" + this.layout.items[0].items[0].items[70].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelText7(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[80]["fieldName"] + "_" + this.layout.items[0].items[0].items[80].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[80]["fieldName"] + "_" + this.layout.items[0].items[0].items[80].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelText8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[90]["fieldName"] + "_" + this.layout.items[0].items[0].items[90].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[90]["fieldName"] + "_" + this.layout.items[0].items[0].items[90].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoLabelText9(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[100]["fieldName"] + "_" + this.layout.items[0].items[0].items[100].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[100]["fieldName"] + "_" + this.layout.items[0].items[0].items[100].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoAtoLabelText10() {
        ...
        public set FuchoAtoLabelText10(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[110]["fieldName"] + "_" + this.layout.items[0].items[0].items[110].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[110]["fieldName"] + "_" + this.layout.items[0].items[0].items[110].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoAtoLabelText11() {
        ...
        public set FuchoAtoLabelText11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[120]["fieldName"] + "_" + this.layout.items[0].items[0].items[120].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[120]["fieldName"] + "_" + this.layout.items[0].items[0].items[120].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoAtoLabelText12() {
        ...
        public set FuchoAtoLabelText12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[130]["fieldName"] + "_" + this.layout.items[0].items[0].items[130].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[130]["fieldName"] + "_" + this.layout.items[0].items[0].items[130].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoAtoLabelText13() {
        ...
        public set FuchoAtoLabelText13(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[140]["fieldName"] + "_" + this.layout.items[0].items[0].items[140].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[140]["fieldName"] + "_" + this.layout.items[0].items[0].items[140].items[0]["fieldName"]) != undefined ) {
        ...
        public get FuchoAtoLabelText14() {
        ...
        public set FuchoAtoLabelText14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[150]["fieldName"] + "_" + this.layout.items[0].items[0].items[150].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[150]["fieldName"] + "_" + this.layout.items[0].items[0].items[150].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoKeiVisi(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[160]["fieldName"] + "_" + this.layout.items[0].items[0].items[160].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[160]["fieldName"] + "_" + this.layout.items[0].items[0].items[160].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoAtoKeiText(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[160]["fieldName"] + "_" + this.layout.items[0].items[0].items[160].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[160]["fieldName"] + "_" + this.layout.items[0].items[0].items[160].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[21]["fieldName"] + "_" + this.layout.items[0].items[0].items[21].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[21]["fieldName"] + "_" + this.layout.items[0].items[0].items[21].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[31]["fieldName"] + "_" + this.layout.items[0].items[0].items[31].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[31]["fieldName"] + "_" + this.layout.items[0].items[0].items[31].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[41]["fieldName"] + "_" + this.layout.items[0].items[0].items[41].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[41]["fieldName"] + "_" + this.layout.items[0].items[0].items[41].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[51]["fieldName"] + "_" + this.layout.items[0].items[0].items[51].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[51]["fieldName"] + "_" + this.layout.items[0].items[0].items[51].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[61]["fieldName"] + "_" + this.layout.items[0].items[0].items[61].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[61]["fieldName"] + "_" + this.layout.items[0].items[0].items[61].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[71]["fieldName"] + "_" + this.layout.items[0].items[0].items[71].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[71]["fieldName"] + "_" + this.layout.items[0].items[0].items[71].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText7(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[81]["fieldName"] + "_" + this.layout.items[0].items[0].items[81].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[81]["fieldName"] + "_" + this.layout.items[0].items[0].items[81].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[91]["fieldName"] + "_" + this.layout.items[0].items[0].items[91].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[91]["fieldName"] + "_" + this.layout.items[0].items[0].items[91].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText9(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[101]["fieldName"] + "_" + this.layout.items[0].items[0].items[101].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[101]["fieldName"] + "_" + this.layout.items[0].items[0].items[101].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText10(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[111]["fieldName"] + "_" + this.layout.items[0].items[0].items[111].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[111]["fieldName"] + "_" + this.layout.items[0].items[0].items[111].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[121]["fieldName"] + "_" + this.layout.items[0].items[0].items[121].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[121]["fieldName"] + "_" + this.layout.items[0].items[0].items[121].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[131]["fieldName"] + "_" + this.layout.items[0].items[0].items[131].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[131]["fieldName"] + "_" + this.layout.items[0].items[0].items[131].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText13(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[141]["fieldName"] + "_" + this.layout.items[0].items[0].items[141].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[141]["fieldName"] + "_" + this.layout.items[0].items[0].items[141].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenText14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[151]["fieldName"] + "_" + this.layout.items[0].items[0].items[151].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[151]["fieldName"] + "_" + this.layout.items[0].items[0].items[151].items[0]["fieldName"]) != undefined ) {
        ...
        public set FuchoZougenKeiText(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[161]["fieldName"] + "_" + this.layout.items[0].items[0].items[161].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[161]["fieldName"] + "_" + this.layout.items[0].items[0].items[161].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText1(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[22]["fieldName"] + "_" + this.layout.items[0].items[0].items[22].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[22]["fieldName"] + "_" + this.layout.items[0].items[0].items[22].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText2(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[32]["fieldName"] + "_" + this.layout.items[0].items[0].items[32].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[32]["fieldName"] + "_" + this.layout.items[0].items[0].items[32].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText3(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[42]["fieldName"] + "_" + this.layout.items[0].items[0].items[42].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[42]["fieldName"] + "_" + this.layout.items[0].items[0].items[42].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText4(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[52]["fieldName"] + "_" + this.layout.items[0].items[0].items[52].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[52]["fieldName"] + "_" + this.layout.items[0].items[0].items[52].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText5(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[62]["fieldName"] + "_" + this.layout.items[0].items[0].items[62].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[62]["fieldName"] + "_" + this.layout.items[0].items[0].items[62].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText6(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[72]["fieldName"] + "_" + this.layout.items[0].items[0].items[72].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[72]["fieldName"] + "_" + this.layout.items[0].items[0].items[72].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText7(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[82]["fieldName"] + "_" + this.layout.items[0].items[0].items[82].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[82]["fieldName"] + "_" + this.layout.items[0].items[0].items[82].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText8(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[92]["fieldName"] + "_" + this.layout.items[0].items[0].items[92].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[92]["fieldName"] + "_" + this.layout.items[0].items[0].items[92].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText9(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[102]["fieldName"] + "_" + this.layout.items[0].items[0].items[102].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[102]["fieldName"] + "_" + this.layout.items[0].items[0].items[102].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText10(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[112]["fieldName"] + "_" + this.layout.items[0].items[0].items[112].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[112]["fieldName"] + "_" + this.layout.items[0].items[0].items[112].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText11(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[122]["fieldName"] + "_" + this.layout.items[0].items[0].items[122].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[122]["fieldName"] + "_" + this.layout.items[0].items[0].items[122].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText12(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[132]["fieldName"] + "_" + this.layout.items[0].items[0].items[132].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[132]["fieldName"] + "_" + this.layout.items[0].items[0].items[132].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText13(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[142]["fieldName"] + "_" + this.layout.items[0].items[0].items[142].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[142]["fieldName"] + "_" + this.layout.items[0].items[0].items[142].items[0]["fieldName"]) != undefined ) {
        ...
        public set NokigenText14(value) {
            if ( $("#" + this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[152]["fieldName"] + "_" + this.layout.items[0].items[0].items[152].items[0]["fieldName"]).length > 0 && 
                 Uz.JSControlUtil.getJSControl(this.fieldName + "_" + this.layout.items[0]["fieldName"] + "_" + this.layout.items[0].items[0]["fieldName"] + "_" + this.layout.items[0].items[0].items[152]["fieldName"] + "_" + this.layout.items[0].items[0].items[152].items[0]["fieldName"]) != undefined ) {
