...
module DBB {
     ...
     * HonKakushuTsuchiUchiwakeKakuninクラスのみで継承して使えます。
     */
    export class HonKakushuTsuchiUchiwakeKakunin_Design extends Uz.CommonChildDiv {
    
        constructor($parentElement: JQuery, isDesignMode: bool, fieldName: string) {
            super($parentElement, isDesignMode, HonKakushuTsuchiUchiwakeKakunin_Design.myLayout, fieldName);
        }
