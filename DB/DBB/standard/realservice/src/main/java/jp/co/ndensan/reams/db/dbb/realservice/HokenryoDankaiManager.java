...
public class HokenryoDankaiManager {
     ...
     */
    public Optional<HokenryoDankai> get保険料段階(FlexibleYear 賦課年度, LasdecCode 市町村コード, RString 段階区分) {
        List<DbT2013HokenryoDankaiEntity> modelList = isランク対象(賦課年度, 市町村コード)
     ...
     */
    @Transaction
    public IItemList<DbT2013HokenryoDankaiEntity> get保険料段階一覧(FlexibleYear 賦課年度) {
     ...
     */
    @Transaction
    public int save保険料段階(DbT2013HokenryoDankaiEntity 保険料段階モデル) {
