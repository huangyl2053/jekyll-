...
public class InsFukaErrorTbl2Process extends BatchProcessBase<FukaJohoTmpHachiEntity> {
    ...
    private static final RString MAPPERPATH = new RString("jp.co.ndensan.reams.db.dbb.persistence.db.mapper.relate"
            + ".tokuchoheinjunka8gatsu.ITokuchoHeinjunka8GatsuBatchMapper.do特徴停止_賦課エラー一覧へ登録");
    ...
    protected IBatchReader createReader() {
        TokuchoHeinjunka8GatsuMyBatisParameter parm = new TokuchoHeinjunka8GatsuMyBatisParameter();
        parm.set賦課年度(parameter.get賦課年度());
        return new BatchDbReader(MAPPERPATH, parm);
    }
    ...
    protected void process(FukaJohoTmpHachiEntity fukaJohoResult) {
        ...
        insFukaErrorTbl1TmpEntity.setErrorCode(エラーコード);
