 ...
 */
public class FuchoKarisanteiKoshingoProcess extends BatchProcessBase<FuchoKariTsuchishoIkkatsuHakkoTempEntity> {
    ...
    private static final RString MAPPERPATH = new RString("jp.co.ndensan.reams.db.dbb.persistence.db.mapper.relate."
            + "fuchokaritsuchishoikkatsuhakko.IFuchoKarisanteiTsuchishoHakkoMapper.get普徴仮算定の更新後データ_計算後情報");
