...
public class InsFukaKeisanTempProcess extends BatchProcessBase<FukaCalculateEntity> {
    ...
    private FukaCalculateEntity 賦課計算中間Entity;
    ...
    public void initialize() {
        賦課計算中間Entity = new FukaCalculateEntity();
    ...
    protected void process(FukaCalculateEntity entity) {
        ...
        if (通知書番号.equals(entity.getTsuchishoNo())
            ...
            tableWriter.insert(CreatCalCulateEntity.createInstance().creat賦課Entity(tempEntity, 賦課計算中間Entity));
        } else {
            tempEntity = new FukaCalculateTempEntity();
            tableWriter.insert(CreatCalCulateEntity.createInstance().creat賦課計算Entity(tempEntity, 賦課計算中間Entity));
            tableWriter.insert(CreatCalCulateEntity.createInstance().creat賦課Entity(tempEntity, 賦課計算中間Entity));
