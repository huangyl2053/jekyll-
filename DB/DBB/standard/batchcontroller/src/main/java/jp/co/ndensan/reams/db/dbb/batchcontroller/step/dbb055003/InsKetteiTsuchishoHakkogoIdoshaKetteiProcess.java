...
/**
 * 決定通知書発行後異動者登録するクラスです。
 *
 * @reamsid_L DBB-0920-030 huzongcheng
 */
public class InsKetteiTsuchishoHakkogoIdoshaKetteiProcess extends SimpleBatchProcessBase {
    ...
    protected void process() {
        ...
        service.insTsuchishoHakkogoIdoshaKettei(processParameter.get帳票作成日時(),
                出力帳票.get出力順ID(), new ReportId(出力帳票.get帳票ID()), processParameter.get決定_対象賦課年度());
    }
