 ...
 */
public class PntKetteiTsuchishoProcess extends SimpleBatchProcessBase {
    ...
    protected void process() {
        ...
        try {
            service.pntKetteiTsuchisho(processParameter.get調定年度(), processParameter.get決定_対象賦課年度(),
                    processParameter.get帳票作成日時(), processParameter.get決定_発行日(), processParameter.get決定_文書番号(),
