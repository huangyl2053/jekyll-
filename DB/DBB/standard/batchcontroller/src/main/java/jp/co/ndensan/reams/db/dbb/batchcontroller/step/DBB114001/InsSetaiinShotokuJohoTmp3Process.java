...
/**
 * 世帯員所得情報Temp３テーブルに登録のクラスです。
 *
 * @reamsid_L DBB-1720-040 lijunjun
 */
public class InsSetaiinShotokuJohoTmp3Process extends BatchProcessBase<SetaiShotokuTempEntity> {

    private static final RString SELECTPATH = new RString("jp.co.ndensan.reams.db.dbb.persistence.db"
            + ".mapper.relate.shotokushokaihyo.IShotokushokaihyoMapper.select世帯員所得3");
    private static final RString 世帯員所得情報TEMP = new RString("TmpSetaiShotoku3");
    @BatchWriter
