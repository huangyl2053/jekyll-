 ...
 */
public class CaluculateFukaTokuchoTeishiProcess extends SimpleBatchProcessBase {
    ...
    protected void process() {
        ...
        manager.caluculateFukaTokuchoTeishi(processParameter.get調定年度(), processParameter.get賦課年度(),
