 ...
 */
public class InsIdoTsuchishoHakkogoIdoshaKetteiProcess extends SimpleBatchProcessBase {
    ...
    protected void process() {
        ...
        manager.insTsuchishoHakkogoIdoshaKettei(processParameter.get帳票作成日時(),
