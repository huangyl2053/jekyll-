...
/**
 * 収入情報から計算中間Tempのデータを更新する処理クラスです。
 *
 * @reamsid_L DBB-9060-010 duanzhanli
 */
public class ShuyuJohoUpdateProcess extends BatchProcessBase<KeisangoJohoSakuseiRelateEntity> {

    private static final RString 収入情報取得 = new RString("jp.co.ndensan.reams.db.dbb.persistence.db.mapper.relate.keisangojoho."
            + "IKeisangoJohoSakuseiMapper.get収入情報");
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(収入情報取得, setMybatisParamter());
    }
