 ...
 */
public class SelectZenFukaDataProcess extends BatchKeyBreakBase<FukaJohoCalculateEntity> {

    private static final RString MYBATIS_SELECT_ID
            = new RString("jp.co.ndensan.reams.db.dbb.persistence.db.mapper.relate.fuchokarisanteifuka."
                    + "IFuchoKarisanteiFukaMapper.get計算根拠前年度情報");
    private static final RString TABLE_NAME = new RString("FukaZenNendoTemp");
    ...
    protected void createWriter() {
        tempTableWriter = new BatchEntityCreatedTempTableWriter(TABLE_NAME, FukaJohoTempEntity.class);
    }
    ...
    protected void keyBreakProcess(FukaJohoCalculateEntity entity) {
        if (isBreak(entity, getBefore())) {
            ...
            tempTableWriter.insert(中間Entity);
            中間Entity = new FukaJohoTempEntity();
        }
    }
