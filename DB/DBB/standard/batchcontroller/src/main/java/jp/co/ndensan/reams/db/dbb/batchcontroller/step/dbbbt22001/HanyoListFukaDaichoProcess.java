 ...
 */
public class HanyoListFukaDaichoProcess extends BatchProcessBase<HanyoListFukaDaichoEntity> {
    ...
    protected void process(HanyoListFukaDaichoEntity entity) {
        if (is出力データ(entity)) {
            csvWriter.writeLine(csvEditor.editor(entity, processParameter, 連番, 保険料段階リスト, 構成市町村マスタlist,
