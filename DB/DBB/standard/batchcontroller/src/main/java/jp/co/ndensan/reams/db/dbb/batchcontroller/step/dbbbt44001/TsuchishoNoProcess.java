 ...
 */
public class TsuchishoNoProcess extends SimpleBatchProcessBase {
    ...
    protected void process() {
        business.getTsuchishoNo(processParameter.get賦課年度(), processParameter.get調定年度(), processParameter.get抽出開始日時(),
