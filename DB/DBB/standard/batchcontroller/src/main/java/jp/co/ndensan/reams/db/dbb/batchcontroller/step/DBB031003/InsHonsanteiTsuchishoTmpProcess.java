...
/**
 * 本算定通知書一時テーブルに登録するクラスです。
 *
 * @reamsid_L DBB-0780-050 xicongwang
 */
public class InsHonsanteiTsuchishoTmpProcess extends BatchProcessBase<HonsanteiTsuchishoTempEntity> {

    private static final RString MAPPERPATH = new RString("jp.co.ndensan.reams.db.dbb.persistence.db.mapper.relate."
            + "honsanteitsuchishoikkatsuhakko.IHonsanteiTsuchishoIkkatsuHakkoMapper.select計算後情報");
