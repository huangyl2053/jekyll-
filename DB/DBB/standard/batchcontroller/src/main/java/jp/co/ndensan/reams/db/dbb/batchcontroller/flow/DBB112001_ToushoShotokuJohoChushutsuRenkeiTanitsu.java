...
/**
 * 所得情報抽出・連携_当初単一のバッチFlowです。
 *
 * @reamsid_L DBB-1690-060 gongliang
 */
public class DBB112001_ToushoShotokuJohoChushutsuRenkeiTanitsu extends BatchFlowBase<DBB112001_ToushoShotokuJohoChushutsuRenkeiTanitsuParameter> {
