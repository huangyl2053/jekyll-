...
public class FukaJohoHenshuProcess extends BatchProcessBase<DbT2002FukaJohoTempTableEntity> {
    ...
    private void save普徴期別(DbT2002FukaJohoTempTableEntity 賦課情報,
        ...
        if (初期金額.compareTo(賦課情報.getFuKibetsuGaku01()) == -1) {
