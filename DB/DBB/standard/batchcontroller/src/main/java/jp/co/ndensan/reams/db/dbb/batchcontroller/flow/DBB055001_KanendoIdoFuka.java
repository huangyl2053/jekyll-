 ...
 */
public class DBB055001_KanendoIdoFuka extends BatchFlowBase<DBB055001_KanendoIdoFukaParameter> {

    private DBB055001_KanendoIdoFukaParameter parameter;
    ...
    private static final RString SETAISHOTOKUKAZEIHANTEI_FLOW = new RString("DBB002001_SetaiinHaaku");
    ...
    private DBB055003_KanendoIdoTsuchishoHakkoParameter getHonSanteiIdoKanendoFukaBatchParameter() {
        DBB055003_KanendoIdoTsuchishoHakkoParameter param = new DBB055003_KanendoIdoTsuchishoHakkoParameter();
