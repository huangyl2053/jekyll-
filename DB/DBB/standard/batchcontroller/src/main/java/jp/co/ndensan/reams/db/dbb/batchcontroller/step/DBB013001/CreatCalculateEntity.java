...
/**
 * 特徴平準化（特徴8月分）賦課計算中間一時テーブルに登録を作成のクラスです。
 *
...
public class CreatCalculateEntity {
    ...
    /**
     * にて生成した{@link CreatCalculateEntity}のインスタンスを返します。
     *
     * @return CreatCalculateEntity
     */
    ...
    private void 金額設定(FukaCalculateTempEntity tempEntity, FukaCalculateEntity fukaTmpEntity) {
        ...
        } else if (徴収方法_普通.equals(賦課の情報.getChoshuHouhou())) {
            普通徴収金額設定(tempEntity, 賦課の情報.getKi());
        }
    }

    private void 普通徴収金額設定(FukaCalculateTempEntity fukaTmpEntity, int ki) {
        switch (ki) {
            case 期_01:
                fukaTmpEntity.setFuKibetsuGaku01(fukaTmpEntity.getFuKibetsuGaku01());
                break;
            case 期_02:
                fukaTmpEntity.setFuKibetsuGaku02(fukaTmpEntity.getFuKibetsuGaku02());
                break;
            case 期_03:
                fukaTmpEntity.setFuKibetsuGaku03(fukaTmpEntity.getFuKibetsuGaku03());
                break;
            case 期_04:
                fukaTmpEntity.setFuKibetsuGaku04(fukaTmpEntity.getFuKibetsuGaku04());
                break;
            case 期_05:
                fukaTmpEntity.setFuKibetsuGaku05(fukaTmpEntity.getFuKibetsuGaku05());
                break;
            case 期_06:
                fukaTmpEntity.setFuKibetsuGaku06(fukaTmpEntity.getFuKibetsuGaku06());
                break;
            case 期_07:
                fukaTmpEntity.setFuKibetsuGaku07(fukaTmpEntity.getFuKibetsuGaku07());
                break;
            case 期_08:
                fukaTmpEntity.setFuKibetsuGaku08(fukaTmpEntity.getFuKibetsuGaku08());
                break;
            case 期_09:
                fukaTmpEntity.setFuKibetsuGaku09(fukaTmpEntity.getFuKibetsuGaku09());
                break;
            case 期_10:
                fukaTmpEntity.setFuKibetsuGaku10(fukaTmpEntity.getFuKibetsuGaku10());
                break;
            case 期_11:
                fukaTmpEntity.setFuKibetsuGaku11(fukaTmpEntity.getFuKibetsuGaku11());
                break;
            case 期_12:
                fukaTmpEntity.setFuKibetsuGaku12(fukaTmpEntity.getFuKibetsuGaku12());
                break;
            case 期_13:
                fukaTmpEntity.setFuKibetsuGaku13(fukaTmpEntity.getFuKibetsuGaku13());
                break;
            case 期_14:
                fukaTmpEntity.setFuKibetsuGaku14(fukaTmpEntity.getFuKibetsuGaku14());
                break;
            default:
                break;
        }
    ...
    private void 特別徴収金額設定(FukaCalculateTempEntity fukaTmpEntity, int ki) {
        switch (ki) {
            case 期_01:
                fukaTmpEntity.setTkKibetsuGaku01(fukaTmpEntity.getTkKibetsuGaku01());
                break;
            case 期_02:
                fukaTmpEntity.setTkKibetsuGaku02(fukaTmpEntity.getTkKibetsuGaku02());
                break;
            case 期_03:
                fukaTmpEntity.setTkKibetsuGaku03(fukaTmpEntity.getTkKibetsuGaku03());
                break;
            case 期_04:
                fukaTmpEntity.setTkKibetsuGaku04(fukaTmpEntity.getTkKibetsuGaku04());
                break;
            case 期_05:
                fukaTmpEntity.setTkKibetsuGaku05(fukaTmpEntity.getTkKibetsuGaku05());
                break;
            case 期_06:
                fukaTmpEntity.setTkKibetsuGaku06(fukaTmpEntity.getTkKibetsuGaku06());
                break;
            default:
                break;
        }
    ...
    private void set介護賦課Entity(FukaCalculateTempEntity entity,
        ...
        if (対象者データEntity != null) {
            ...
            entity.setDbT2002_fukaNendo(対象者データEntity.getFukaNendo());
            entity.setDbT2002_tsuchishoNo(対象者データEntity.getTsuchishoNo());
            entity.setDbT2002_rirekiNo(対象者データEntity.getRirekiNo());
            entity.setDbT2002_hihokenshaNo(対象者データEntity.getHihokenshaNo());
            entity.setDbT2002_shikibetsuCode(対象者データEntity.getShikibetsuCode());
            entity.setDbT2002_setaiCode(対象者データEntity.getSetaiCode());
            entity.setDbT2002_setaiInsu(対象者データEntity.getSetaiInsu());
            entity.setDbT2002_shikakuShutokuYMD(対象者データEntity.getShikakuShutokuYMD());
            entity.setDbT2002_shikakuShutokuJiyu(対象者データEntity.getShikakuShutokuJiyu());
            entity.setDbT2002_shikakuSoshitsuYMD(対象者データEntity.getShikakuSoshitsuYMD());
            entity.setDbT2002_shikakuSoshitsuJiyu(対象者データEntity.getShikakuSoshitsuJiyu());
            entity.setDbT2002_seihofujoShurui(対象者データEntity.getSeihofujoShurui());
            entity.setDbT2002_seihoKaishiYMD(対象者データEntity.getSeihoKaishiYMD());
            entity.setDbT2002_seihoHaishiYMD(対象者データEntity.getSeihoHaishiYMD());
            entity.setDbT2002_ronenKaishiYMD(対象者データEntity.getRonenKaishiYMD());
            entity.setDbT2002_ronenHaishiYMD(対象者データEntity.getRonenHaishiYMD());
            entity.setDbT2002_fukaYMD(対象者データEntity.getFukaYMD());
            entity.setDbT2002_kazeiKubun(対象者データEntity.getKazeiKubun());
            entity.setDbT2002_setaikazeiKubun(対象者データEntity.getSetaikazeiKubun());
            entity.setDbT2002_gokeiShotokuGaku(対象者データEntity.getGokeiShotokuGaku());
            entity.setDbT2002_nenkinShunyuGaku(対象者データEntity.getNenkinShunyuGaku());
            entity.setDbT2002_hokenryoDankai(対象者データEntity.getHokenryoDankai());
            entity.setDbT2002_hokenryoDankai1(対象者データEntity.getHokenryoDankai1());
            entity.setDbT2002_nengakuHokenryo1(対象者データEntity.getNengakuHokenryo1());
            entity.setDbT2002_tsukiwariStartYM1(対象者データEntity.getTsukiwariStartYM1());
            entity.setDbT2002_tsukiwariEndYM1(対象者データEntity.getTsukiwariEndYM1());
            entity.setDbT2002_hokenryoDankai2(対象者データEntity.getHokenryoDankai2());
            entity.setDbT2002_nengakuHokenryo2(対象者データEntity.getNengakuHokenryo2());
            entity.setDbT2002_tsukiwariStartYM2(対象者データEntity.getTsukiwariStartYM2());
            entity.setDbT2002_tsukiwariEndYM2(対象者データEntity.getTsukiwariEndYM2());
            entity.setDbT2002_choteiNichiji(対象者データEntity.getChoteiNichiji());
            entity.setDbT2002_choteiJiyu1(対象者データEntity.getChoteiJiyu1());
            entity.setDbT2002_choteiJiyu2(対象者データEntity.getChoteiJiyu2());
            entity.setDbT2002_choteiJiyu3(対象者データEntity.getChoteiJiyu3());
            entity.setDbT2002_choteiJiyu4(対象者データEntity.getChoteiJiyu4());
            entity.setDbT2002_koseiM(対象者データEntity.getKoseiM());
            entity.setDbT2002_gemmenMaeHokenryo(対象者データEntity.getGemmenMaeHokenryo());
            entity.setDbT2002_gemmenGaku(対象者データEntity.getGemmenGaku());
            entity.setDbT2002_kakuteiHokenryo(対象者データEntity.getKakuteiHokenryo());
            entity.setDbT2002_hokenryoDankaiKarisanntei(対象者データEntity.getHokenryoDankaiKarisanntei());
            entity.setDbT2002_choshuHohoRirekiNo(対象者データEntity.getChoshuHohoRirekiNo());
            entity.setDbT2002_idoKijunNichiji(対象者データEntity.getIdoKijunNichiji());
            entity.setDbT2002_kozaKubun(対象者データEntity.getKozaKubun());
            entity.setDbT2002_kyokaisoKubun(対象者データEntity.getKyokaisoKubun());
            entity.setDbT2002_shokkenKubun(対象者データEntity.getShokkenKubun());
            entity.setDbT2002_fukaShichosonCode(対象者データEntity.getFukaShichosonCode());
            entity.setDbT2002_tkSaishutsuKampuGaku(対象者データEntity.getTkSaishutsuKampuGaku());
            entity.setDbT2002_fuSaishutsuKampuGaku(対象者データEntity.getFuSaishutsuKampuGaku());
            entity.setBikouCode(対象者データEntity.get備考コード());
        }
    }
    ...
    private void set期別金額(FukaCalculateTempEntity 中間Entity, FukaCalculateEntity entity) {
        ...
        if (対象者データEntity != null) {
            ...
            中間Entity.setTkKibetsuGaku02(対象者データEntity.getTokubetsuChoteigaku02());
            中間Entity.setTkKibetsuGaku03(対象者データEntity.getTokubetsuChoteigaku03());
            中間Entity.setTkKibetsuGaku04(対象者データEntity.getTokubetsuChoteigaku04());
            中間Entity.setTkKibetsuGaku05(対象者データEntity.getTokubetsuChoteigaku05());
            中間Entity.setTkKibetsuGaku06(対象者データEntity.getTokubetsuChoteigaku06());
            中間Entity.setFuKibetsuGaku01(対象者データEntity.getFuchoChoteigaku01());
            中間Entity.setFuKibetsuGaku02(対象者データEntity.getFuchoChoteigaku02());
            中間Entity.setFuKibetsuGaku03(対象者データEntity.getFuchoChoteigaku03());
            中間Entity.setFuKibetsuGaku04(対象者データEntity.getFuchoChoteigaku04());
            中間Entity.setFuKibetsuGaku05(対象者データEntity.getFuchoChoteigaku05());
            中間Entity.setFuKibetsuGaku06(対象者データEntity.getFuchoChoteigaku06());
            中間Entity.setFuKibetsuGaku07(対象者データEntity.getFuchoChoteigaku07());
            中間Entity.setFuKibetsuGaku08(対象者データEntity.getFuchoChoteigaku08());
            中間Entity.setFuKibetsuGaku09(対象者データEntity.getFuchoChoteigaku09());
            中間Entity.setFuKibetsuGaku10(対象者データEntity.getFuchoChoteigaku10());
            中間Entity.setFuKibetsuGaku11(対象者データEntity.getFuchoChoteigaku11());
            中間Entity.setFuKibetsuGaku12(対象者データEntity.getFuchoChoteigaku12());
            中間Entity.setFuKibetsuGaku13(対象者データEntity.getFuchoChoteigaku13());
            中間Entity.setFuKibetsuGaku14(対象者データEntity.getFuchoChoteigaku14());
        }
    }
    ...
    public void creat賦課計算Entity(FukaCalculateTempEntity entity,
        ...
        set資格情報Temp(賦課計算entity, entity);
        set月別Temp(賦課計算entity, entity);
        set徴収方法Newest(賦課計算entity, entity);
        set口座(賦課計算entity, entity);
    }
     ...
     * @param index int
     */
    public void creat世帯員所得情報Entity(FukaCalculateTempEntity entity,
            SetaiShotokuEntity 世帯員所得情報Entity,
            int index) {
        set世帯員所得情報_1(entity, 世帯員所得情報Entity, index);
        set世帯員所得情報_2(entity, 世帯員所得情報Entity, index);
        set世帯員所得情報_3(entity, 世帯員所得情報Entity, index);
        set世帯員所得情報_4(entity, 世帯員所得情報Entity, index);
        set世帯員所得情報_5(entity, 世帯員所得情報Entity, index);
        set世帯員所得情報_6(entity, 世帯員所得情報Entity, index);
        set世帯員所得情報_7(entity, 世帯員所得情報Entity, index);
        set世帯員所得情報_8(entity, 世帯員所得情報Entity, index);
        set世帯員所得情報_9(entity, 世帯員所得情報Entity, index);
        set世帯員所得情報_10(entity, 世帯員所得情報Entity, index);
    }

    private void set世帯員所得情報_10(FukaCalculateTempEntity entity,
            SetaiShotokuEntity 世帯員所得情報Entity, int index) {
        if (世帯員所得情報Entity != null) {
            switch (index) {
                case INDEX_46:
    ...
    private void set世帯員所得情報_9(FukaCalculateTempEntity entity,
            SetaiShotokuEntity 世帯員所得情報Entity, int index) {
        if (世帯員所得情報Entity != null) {
            switch (index) {
                case INDEX_41:
    ...
    private void set世帯員所得情報_8(FukaCalculateTempEntity entity,
            SetaiShotokuEntity 世帯員所得情報Entity, int index) {
        if (世帯員所得情報Entity != null) {
            switch (index) {
                case INDEX_36:
    ...
    private void set世帯員所得情報_7(FukaCalculateTempEntity entity,
            SetaiShotokuEntity 世帯員所得情報Entity, int index) {
        if (世帯員所得情報Entity != null) {
            switch (index) {
                case INDEX_31:
    ...
    private void set世帯員所得情報_6(FukaCalculateTempEntity entity,
            SetaiShotokuEntity 世帯員所得情報Entity, int index) {
        if (世帯員所得情報Entity != null) {
            switch (index) {
                case INDEX_26:
    ...
    private void set世帯員所得情報_5(FukaCalculateTempEntity entity,
            SetaiShotokuEntity 世帯員所得情報Entity, int index) {
        if (世帯員所得情報Entity != null) {
            switch (index) {
                case INDEX_21:
    ...
    private void set世帯員所得情報_4(FukaCalculateTempEntity entity,
            SetaiShotokuEntity 世帯員所得情報Entity, int index) {
        if (世帯員所得情報Entity != null) {
            switch (index) {
                case INDEX_16:
    ...
    private void set世帯員所得情報_3(FukaCalculateTempEntity entity,
            SetaiShotokuEntity 世帯員所得情報Entity, int index) {
        if (世帯員所得情報Entity != null) {
            switch (index) {
                case INDEX_11:
    ...
    private void set世帯員所得情報_2(FukaCalculateTempEntity entity,
            SetaiShotokuEntity 世帯員所得情報Entity, int index) {
        if (世帯員所得情報Entity != null) {
            switch (index) {
                case INDEX_6:
    ...
    private void set世帯員所得情報_1(FukaCalculateTempEntity entity,
            SetaiShotokuEntity 世帯員所得情報Entity, int index) {
        if (世帯員所得情報Entity != null) {
            switch (index) {
                case INDEX_1:
