...
/**
 * 特徴仮算定計算後賦課情報Tempに登録（通常分）processクラスです。
 *
 * @reamsid_L DBB-0700-010 xuhao
 */
public class InsTokuchoKarisanteiFUkaJohoTemp1Process extends BatchProcessBase<TokuchoKarisanteiKekkaIchiranEntity> {
    ...
    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbb.persistence.db.mapper.relate.tokuchokarisanteifuka."
            + "ITokuchoKariSanteiFukaMapper.select特徴仮算定結果情報");
    ...
    @Override
    protected void process(TokuchoKarisanteiKekkaIchiranEntity entity) {
        TokuchoKariKeisangoFukaTempEntity 特徴仮算定計算後賦課情報Entity = new TokuchoKariKeisangoFukaTempEntity();
        TokuchoKariSanteiFukaManagerBatch.createInstance().set特徴仮算定結果情報(特徴仮算定計算後賦課情報Entity, entity);
