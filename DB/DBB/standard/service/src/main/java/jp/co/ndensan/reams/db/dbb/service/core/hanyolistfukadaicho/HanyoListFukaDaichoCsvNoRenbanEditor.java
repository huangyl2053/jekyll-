...
public class HanyoListFukaDaichoCsvNoRenbanEditor {
     ...
     * @param バッチ処理日 RDate
     * @return HanyoListFukaDaichoNoRenbanCsvEntity
     */
    public HanyoListFukaDaichoNoRenbanCsvEntity editor(HanyoListFukaDaichoEntity entity,
            HanyoListFukaDaichoProcessParameter parameter, HokenryoDankaiList 保険料段階リスト,
        ...
        HanyoListFukaDaichoNoRenbanCsvEntity csvEntity = new HanyoListFukaDaichoNoRenbanCsvEntity();
    ...
    private void editその他(HanyoListFukaDaichoNoRenbanCsvEntity csvEntity, FlexibleDate バッチ処理日) {
        if (賦課台帳.is本算定後()) {
    ...
    private void 受給者台帳Newestの設定(HanyoListFukaDaichoNoRenbanCsvEntity csvEntity) {
    ...
    private void edit介護賦課(HanyoListFukaDaichoNoRenbanCsvEntity csvEntity, FlexibleDate バッチ処理日) {
    ...
    private void set普徴納付額(HanyoListFukaDaichoNoRenbanCsvEntity csvEntity, DbT2003KibetsuEntity entity) {
        switch (entity.getKi()) {
            case INT_ONE:
    ...
    private void edit老年と生保(HanyoListFukaDaichoNoRenbanCsvEntity csvEntity, FlexibleDate バッチ処理日) {
    ...
    private void edit宛名(HanyoListFukaDaichoNoRenbanCsvEntity csvEntity, HanyoListFukaDaichoEntity entity) {
    ...
    private void edit地区(HanyoListFukaDaichoNoRenbanCsvEntity csvEntity,
    ...
    private void edit前住所(HanyoListFukaDaichoNoRenbanCsvEntity csvEntity, HanyoListFukaDaichoEntity entity) {
        IKojin 宛名 = ShikibetsuTaishoFactory.createKojin(entity.get宛名());
    ...
    private void edit宛先(HanyoListFukaDaichoNoRenbanCsvEntity csvEntity,
            HanyoListFukaDaichoEntity entity) {
    ...
    private void edit資格(HanyoListFukaDaichoNoRenbanCsvEntity csvEntity, HanyoListFukaDaichoEntity entity) {
    ...
    private void edit資格Two(HanyoListFukaDaichoNoRenbanCsvEntity csvEntity, HanyoListFukaDaichoEntity entity,
    ...
    private void set保険者番号By広住特措置元市町村コード(HanyoListFukaDaichoNoRenbanCsvEntity csvEntity,
