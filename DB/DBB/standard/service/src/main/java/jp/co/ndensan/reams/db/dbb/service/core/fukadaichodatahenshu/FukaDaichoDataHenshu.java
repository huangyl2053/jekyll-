...
public class FukaDaichoDataHenshu extends FukaDaichoDataHenshuFath {
    ...
    private boolean is普徴金額がある;
    private boolean is特徴金額がある;
    ...
    public EditedKariSanteiFukaDaichoJoho create編集後仮算定賦課台帳情報(FukaDaichoInfo 賦課台帳情報, boolean has更正前) {
        ...
        if (賦課台帳情報.get代納人情報_更正後() != null) {
            代納人個人 = new EditedKojin(賦課台帳情報.get代納人情報_更正後().to個人(),
                    賦課台帳情報.get帳票制御共通(), 賦課台帳情報.get地方公共団体());
        }
        ...
        if (賦課台帳情報.get帳票制御共通() != null && 賦課の情報_更正後.get宛名() != null) {
            本人個人 = new EditedKojin(賦課の情報_更正後.get宛名(), 賦課台帳情報.get帳票制御共通(), 賦課台帳情報.get地方公共団体());
        }
        ...
        if (本人個人 != null) {
            編集後仮算定賦課台帳情報.set本人生年月日(本人個人.get生年月日_パターン4());
    ...
    public EditedHonSanteiFukaDaichoJoho create編集後本算定賦課台帳情報(FukaDaichoInfo 賦課台帳情報, boolean has更正前) {
        ...
        if (本人個人 != null) {
            編集後本算定賦課台帳情報.set本人生年月日(本人個人.get生年月日_パターン4());
    ...
    private void set編集後本算定賦課台帳情報(EditedHonSanteiFukaDaichoJoho 編集後本算定賦課台帳情報, FukaDaichoInfo 賦課台帳情報, boolean has更正前) {
        ...
        if (賦課の情報_更正前 != null && 賦課台帳情報.get帳票制御共通() != null && 賦課の情報_更正前.get宛名() != null) {
            本人個人_更正前 = new EditedKojin(賦課の情報_更正前.get宛名(), 賦課台帳情報.get帳票制御共通(), 賦課台帳情報.get地方公共団体());
        }
        ...
        set普通徴収_本算定(false, 賦課の情報_更正前, 賦課台帳情報.get収入情報(), new KitsukiList(普徴期月リスト), 編集後本算定賦課台帳情報);
        set普通徴収_本算定(true, 賦課の情報_更正後, 賦課台帳情報.get収入情報(), new KitsukiList(普徴期月リスト), 編集後本算定賦課台帳情報);
        ...
        if (GennenKanen.現年度.equals(年度区分)) {
            set特別徴収_本算定(false, 賦課の情報_更正前, 賦課台帳情報.get収入情報(), new KitsukiList(特徴期月リスト), 編集後本算定賦課台帳情報);
            set特別徴収_本算定(true, 賦課の情報_更正後, 賦課台帳情報.get収入情報(), new KitsukiList(特徴期月リスト), 編集後本算定賦課台帳情報);
            set特別徴収_増減額(編集後本算定賦課台帳情報);
            set特別徴収_収入額(賦課台帳情報.get収入情報(), 編集後本算定賦課台帳情報);
        } else {
            set特別徴収更正後(賦課の情報_更正後, 賦課台帳情報.get収入情報(), 編集後本算定賦課台帳情報);
        }
    ...
    private void set特別徴収更正後(FukaAtena 賦課の情報, ShunyuJoho 収入情報, EditedHonSanteiFukaDaichoJoho 編集後本算定賦課台帳情報) {
    ...
    private void set本算定賦課内訳_増減額(EditedHonSanteiFukaDaichoJoho 編集後本算定賦課台帳情報) {
        ...
        if (本算定賦課内訳_更正前 == null) {
            ...
            本算定賦課内訳.set確定年額保険料(本算定賦課内訳_更正後.get確定年額保険料());
        } else {
            ...
            本算定賦課内訳.set確定年額保険料(get増減額(本算定賦課内訳_更正後.get確定年額保険料(), 本算定賦課内訳_更正前.get確定年額保険料()));
        }
    ...
    private void set編集後仮算定賦課台帳情報(EditedKariSanteiFukaDaichoJoho 編集後仮算定賦課台帳情報, FukaDaichoInfo 賦課台帳情報, boolean has更正前) {
        ...
        if (賦課台帳情報.get前年度情報() != null) {
            ...
            編集後仮算定賦課台帳情報.set前年度保険料率(
                    (賦課台帳情報.get前年度情報().get算定年額保険料2() != null && 賦課台帳情報.get前年度情報().get算定年額保険料2().intValue() != 0)
    ...
    private TokubetsuChoshu get特別徴収(boolean 前後区分, FukaAtena 賦課の情報, ShunyuJoho 収入情報,
        ...
        if (is特徴金額がある) {
            特別徴収.set特徴調定月(new RString(new KoseiTsukiHantei().
                    find更正月(賦課情報.get調定日時().getDate()).get月AsInt()).padLeft(RString.HALF_SPACE, INT_2).concat(FORMAT_月));
            特別徴収.set特徴調定月の期(FORMAT_LEFT.concat(get月の期(期月リスト_特徴, new KoseiTsukiHantei().
                    find更正月(賦課情報.get調定日時().getDate()))).concat(FORMAT_RIGHT));
            Decimal 特別期別合計 = get特徴仮算定保険料(賦課情報, INT_1, INT_6);
            特別徴収.set特徴仮算定保険料(DecimalFormatter.toコンマ区切りRString(特別期別合計, 0));
            if (前後区分) {
                Decimal 特別収入合計 = get特徴収入済額(収入情報, INT_1, INT_6);
    ...
    private FutsuChoshu get普通徴収(boolean 前後区分, FukaAtena 賦課の情報, ShunyuJoho 収入情報,
        ...
        if (is普徴金額がある) {
            普通徴収.set普徴調定月(new RString(new KoseiTsukiHantei().
                    find更正月(賦課情報.get調定日時().getDate()).get月AsInt()).padLeft(RString.HALF_SPACE, INT_2).concat(FORMAT_月));
            普通徴収.set普徴調定月の期(FORMAT_LEFT.concat(get月の期(期月リスト_普徴, new KoseiTsukiHantei().
                    find更正月(賦課情報.get調定日時().getDate()))).concat(FORMAT_RIGHT));
            Decimal 普徴期別合計 = get普徴納付済額(賦課情報, INT_1, INT_14);
            RString 普徴確定年額保険料 = DecimalFormatter.toコンマ区切りRString(普徴期別合計, 0);
            普通徴収.set普徴確定年額保険料(定数_ゼロ.equals(普徴確定年額保険料) ? RString.EMPTY : 普徴確定年額保険料);
            if (前後区分) {
                Decimal 普徴収入合計 = get普徴収入済額(収入情報, INT_1, INT_14);
                普通徴収.set普徴納付済額(定数_ゼロ.equals(DecimalFormatter.toコンマ区切りRString(普徴収入合計, 0))
                        ? RString.EMPTY : DecimalFormatter.toコンマ区切りRString(普徴収入合計, 0));
    ...
    private RString get月の期(KitsukiList 期月リスト, Kitsuki 期月) {
        int 期 = 期月リスト.get月の期(期月.get月()).get期AsInt();
        return new RString(期);
    }
    ...
    private void set特別徴収_増減額(EditedHonSanteiFukaDaichoJoho 編集後本算定賦課台帳情報) {
        ...
        if (特別徴収更正前 == null) {
            特別徴収増減額.set特徴確定年額保険料(定数_ゼロ.equals(特別徴収更正後.get特徴確定年額保険料())
                    ? RString.EMPTY : 特別徴収更正後.get特徴確定年額保険料());
            特別徴収増減額.set特徴金額１(特別徴収更正後.get特徴金額１());
            特別徴収増減額.set特徴金額２(特別徴収更正後.get特徴金額２());
            特別徴収増減額.set特徴金額３(特別徴収更正後.get特徴金額３());
            特別徴収増減額.set特徴金額４(特別徴収更正後.get特徴金額４());
            特別徴収増減額.set特徴金額５(特別徴収更正後.get特徴金額５());
            特別徴収増減額.set特徴金額６(特別徴収更正後.get特徴金額６());
            特別徴収増減額.set調整額歳出還付(定数_ゼロ.equals(特別徴収更正後.get調整額歳出還付())
                    ? RString.EMPTY : 特別徴収更正後.get調整額歳出還付());
        } else {
            RString 特徴確定年額保険料 = get増減額(特別徴収更正後.get特徴確定年額保険料(), 特別徴収更正前.get特徴確定年額保険料());
            特別徴収増減額.set特徴確定年額保険料(定数_ゼロ.equals(特徴確定年額保険料) ? RString.EMPTY : 特徴確定年額保険料);
            特別徴収増減額.set特徴金額１(get増減額(特別徴収更正後.get特徴金額１(), 特別徴収更正前.get特徴金額１()));
            特別徴収増減額.set特徴金額２(get増減額(特別徴収更正後.get特徴金額２(), 特別徴収更正前.get特徴金額２()));
            特別徴収増減額.set特徴金額３(get増減額(特別徴収更正後.get特徴金額３(), 特別徴収更正前.get特徴金額３()));
            特別徴収増減額.set特徴金額４(get増減額(特別徴収更正後.get特徴金額４(), 特別徴収更正前.get特徴金額４()));
            特別徴収増減額.set特徴金額５(get増減額(特別徴収更正後.get特徴金額５(), 特別徴収更正前.get特徴金額５()));
            特別徴収増減額.set特徴金額６(get増減額(特別徴収更正後.get特徴金額６(), 特別徴収更正前.get特徴金額６()));
            RString 調整額歳出還付 = get増減額(特別徴収更正後.get調整額歳出還付(), 特別徴収更正前.get調整額歳出還付());
            特別徴収増減額.set調整額歳出還付(定数_ゼロ.equals(調整額歳出還付) ? RString.EMPTY : 調整額歳出還付);
        }
        特別徴収増減額.set特徴金額７(RString.EMPTY);
        特別徴収増減額.set特徴金額８(RString.EMPTY);
        特別徴収増減額.set特徴金額９(RString.EMPTY);
    ...
    private void set普通徴収_増減額(EditedKariSanteiFukaDaichoJoho 編集後仮算定賦課台帳情報) {
        ...
        if (普通徴収更正前 == null) {
            ...
            普通徴収.set普徴納付済額(普通徴収更正後.get普徴納付済額());
            普通徴収.set普徴今後納付すべき額(普通徴収更正後.get普徴今後納付すべき額());
        } else {
            ...
            普通徴収.set普徴納付済額(get増減額(普通徴収更正後.get普徴納付済額(), 普通徴収更正前.get普徴納付済額()));
            普通徴収.set普徴今後納付すべき額(get増減額(普通徴収更正後.get普徴今後納付すべき額(), 普通徴収更正前.get普徴今後納付すべき額()));
        }
    ...
    private void set普通徴収_増減額(EditedHonSanteiFukaDaichoJoho 編集後本算定賦課台帳情報) {
        ...
        普通徴収.set普徴今後納付すべき額(RString.EMPTY);
        if (普通徴収更正前 == null) {
            普通徴収.set普徴確定年額保険料(定数_ゼロ.equals(普通徴収更正後.get普徴確定年額保険料())
                    ? RString.EMPTY : 普通徴収更正後.get普徴確定年額保険料());
            普通徴収.set普徴金額１(普通徴収更正後.get普徴金額１());
            普通徴収.set普徴金額２(普通徴収更正後.get普徴金額２());
            普通徴収.set普徴金額３(普通徴収更正後.get普徴金額３());
            普通徴収.set普徴金額４(普通徴収更正後.get普徴金額４());
            ...
            普通徴収.set普徴金額１３(普通徴収更正後.get普徴金額１３());
            普通徴収.set普徴金額１４(普通徴収更正後.get普徴金額１４());
            普通徴収.set調整額歳出還付(定数_ゼロ.equals(普通徴収更正後.get調整額歳出還付()) ? RString.EMPTY : 普通徴収更正後.get調整額歳出還付());
        } else {
            RString 普徴確定年額保険料 = get増減額(普通徴収更正後.get普徴確定年額保険料(), 普通徴収更正前.get普徴確定年額保険料());
            普通徴収.set普徴確定年額保険料(定数_ゼロ.equals(普徴確定年額保険料) ? RString.EMPTY : 普徴確定年額保険料);
            普通徴収.set普徴金額１(get増減額(普通徴収更正後.get普徴金額１(), 普通徴収更正前.get普徴金額１()));
            普通徴収.set普徴金額２(get増減額(普通徴収更正後.get普徴金額２(), 普通徴収更正前.get普徴金額２()));
            普通徴収.set普徴金額３(get増減額(普通徴収更正後.get普徴金額３(), 普通徴収更正前.get普徴金額３()));
            ...
            普通徴収.set普徴金額１３(get増減額(普通徴収更正後.get普徴金額１３(), 普通徴収更正前.get普徴金額１３()));
            普通徴収.set普徴金額１４(get増減額(普通徴収更正後.get普徴金額１４(), 普通徴収更正前.get普徴金額１４()));
            RString 調整額歳出還付 = get増減額(普通徴収更正後.get調整額歳出還付(), 普通徴収更正前.get調整額歳出還付());
            普通徴収.set調整額歳出還付(定数_ゼロ.equals(調整額歳出還付) ? RString.EMPTY : 調整額歳出還付);
        }
