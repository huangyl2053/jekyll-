...
/**
 * {link ChoshuYuyoRelateManager}のテストクラスです。
 */
@RunWith(Enclosed.class)
public class ChoshuYuyoRelateManagerTest {

    // 介護賦課徴収猶予
    private static DbT2006ChoshuYuyoDac dac;
    private static ChoshuYuyoRelateManager sut;
...
// 介護賦課徴収猶予
        ...
        sut = new ChoshuYuyoRelateManager(provider, dac,
                介護期別徴収猶予Manager);
    }
    ...
    public static class createInstanceのテスト {
        ...
        public void createInstanceのテスト_戻り値はnullでない() {
            ChoshuYuyoRelateManager result = ChoshuYuyoRelateManager.createInstance();
        ...
        public void createInstanceのテスト_クラスのインスタンスが取得できる() {
            ChoshuYuyoRelateManager result = ChoshuYuyoRelateManager.createInstance();
            assertThat(result, instanceOf(ChoshuYuyoRelateManager.class));
        }
    }
