...
@lombok.Getter
@OnNextSchema("rgdb")
public class JigyouHoukokuTokTyhyouEUCEntity extends DbTableEntityBase<JigyouHoukokuTokTyhyouEUCEntity> implements IDbAccessable {
    ...
    static {
        TABLE_NAME = (new RString("tempJigyoHokokuTokeiMotoData"));
    }
