...
@lombok.Getter
public class JigyoHokokuRenkeiHeadEucCsvEntity implements IJigyoHokokuRenkeiEucCsvEntity {
    ...
    @CsvField(order = 30, name = "審査年月日")
    private final RString 審査年月日;
    @CsvField(order = 40, name = "作成年月日")
    private final RString 作成年月日;
    @CsvField(order = 50, name = "連合会名称")
     ...
     * @param 保険者名称 RString
     */
    public JigyoHokokuRenkeiHeadEucCsvEntity(
            RString 交換情報識別番号,
            RString レコード種別番号,
            RString 審査年月日,
            RString 作成年月日,
