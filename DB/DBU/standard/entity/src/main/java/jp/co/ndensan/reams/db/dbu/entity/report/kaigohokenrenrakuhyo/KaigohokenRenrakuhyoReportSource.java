package jp.co.ndensan.reams.db.dbu.entity.report.kaigohokenrenrakuhyo;
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "tashoshitsu1Check", length = 1, order = 20)
    public RString tashoshitsu1Check;
    @ReportItem(name = "koshitsu1Kingaku", length = 6, order = 21)
    public RString koshitsu1Kingaku;
    @ReportItem(name = "roken1Check", length = 1, order = 22)
    public RString roken1Check;
    @ReportItem(name = "tashoshitsu1Kingaku", length = 6, order = 23)
    public RString tashoshitsu1Kingaku;
    @ReportItem(name = "tokuyo1Check", length = 1, order = 24)
    public RString tokuyo1Check;
    @ReportItem(name = "roken1Kingaku", length = 6, order = 25)
    public RString roken1Kingaku;
    @ReportItem(name = "junKoshitsu1Check", length = 1, order = 26)
    public RString junKoshitsu1Check;
    @ReportItem(name = "tokuyo1Kingaku", length = 6, order = 27)
    public RString tokuyo1Kingaku;
    @ReportItem(name = "junKoshitsu1Kingaku", length = 6, order = 28)
    public RString junKoshitsu1Kingaku;
    @ReportItem(name = "junKoshitsu2Check", length = 1, order = 29)
    public RString junKoshitsu2Check;
    @ReportItem(name = "koshitsu2Check", length = 1, order = 30)
    public RString koshitsu2Check;
    @ReportItem(name = "tashoshitsu2Check", length = 1, order = 31)
    public RString tashoshitsu2Check;
    @ReportItem(name = "roken2Check", length = 1, order = 32)
    public RString roken2Check;
    @ReportItem(name = "tokuyo2Check", length = 1, order = 33)
    public RString tokuyo2Check;
    @ReportItem(name = "koshitsu2Kingaku", length = 6, order = 34)
    public RString koshitsu2Kingaku;
    @ReportItem(name = "tashoshitsu2Kingaku", length = 6, order = 35)
    public RString tashoshitsu2Kingaku;
    @ReportItem(name = "roken2Kingaku", length = 6, order = 36)
    public RString roken2Kingaku;
    @ReportItem(name = "tokuyo2Kingaku", length = 6, order = 37)
    public RString tokuyo2Kingaku;
    @ReportItem(name = "junKoshitsu2Kingaku", length = 6, order = 38)
    public RString junKoshitsu2Kingaku;
    @ReportItem(name = "roken3Check", length = 1, order = 39)
    public RString roken3Check;
    @ReportItem(name = "tokuyo3Check", length = 1, order = 40)
    public RString tokuyo3Check;
    @ReportItem(name = "junKoshitsu3Check", length = 1, order = 41)
    public RString junKoshitsu3Check;
    @ReportItem(name = "koshitsu3Check", length = 1, order = 42)
    public RString koshitsu3Check;
    @ReportItem(name = "tashoshitsu3Check", length = 1, order = 43)
    public RString tashoshitsu3Check;
    @ReportItem(name = "koshitsu3Kingaku", length = 6, order = 44)
    public RString koshitsu3Kingaku;
    @ReportItem(name = "tashoshitsu3Kingaku", length = 6, order = 45)
    public RString tashoshitsu3Kingaku;
    @ReportItem(name = "roken3Kingaku", length = 6, order = 46)
    public RString roken3Kingaku;
    @ReportItem(name = "tokuyo3Kingaku", length = 6, order = 47)
    public RString tokuyo3Kingaku;
    @ReportItem(name = "junKoshitsu3Kingaku", length = 6, order = 48)
    public RString junKoshitsu3Kingaku;
    @ReportItem(name = "junKoshitsuKijunCheck", length = 1, order = 49)
    public RString junKoshitsuKijunCheck;
    @ReportItem(name = "koshitsuKijunCheck", length = 1, order = 50)
    public RString koshitsuKijunCheck;
    @ReportItem(name = "tashoshitsuKijunCheck", length = 1, order = 51)
    public RString tashoshitsuKijunCheck;
    @ReportItem(name = "koshitsuKijunKingaku", length = 6, order = 52)
    public RString koshitsuKijunKingaku;
    @ReportItem(name = "rokenKijunCheck", length = 1, order = 53)
    public RString rokenKijunCheck;
    @ReportItem(name = "tashoshitsuKijunKingaku", length = 6, order = 54)
    public RString tashoshitsuKijunKingaku;
    @ReportItem(name = "tokuyoKijunCheck", length = 1, order = 55)
    public RString tokuyoKijunCheck;
    @ReportItem(name = "rokenKijunKingaku", length = 6, order = 56)
    public RString rokenKijunKingaku;
    @ReportItem(name = "tokuyoKijunKingaku", length = 6, order = 57)
    public RString tokuyoKijunKingaku;
    @ReportItem(name = "junKoshitsuKijunKingaku", length = 6, order = 58)
    ...
    @ReportItem(name = "shokuhi3Kingaku", length = 6, order = 62)
    public RString shokuhi3Kingaku;
    @ReportItem(name = "shokuhi2Kingaku", length = 6, order = 63)
    public RString shokuhi2Kingaku;
    @ReportItem(name = "shokuhi4Check", length = 1, order = 64)
    public RString shokuhi4Check;
    @ReportItem(name = "shokuhi1Kingaku", length = 6, order = 65)
    public RString shokuhi1Kingaku;
    @ReportItem(name = "shokuhiOtherKingaku", length = 6, order = 66)
    public RString shokuhiOtherKingaku;
    @ReportItem(name = "shokuhi2Check", length = 1, order = 67)
    public RString shokuhi2Check;
    @ReportItem(name = "shokuhi4Kingaku", length = 6, order = 68)
    ...
    @ReportItem(name = "kaigoHokenryo1Check", length = 1, order = 86)
    public RString kaigoHokenryo1Check;
    @ReportItem(name = "kaigoHokenryo1Kingaku", length = 6, order = 87)
    public RString kaigoHokenryo1Kingaku;
    @ReportItem(name = "kaigoHokenryo5Check", length = 1, order = 88)
    public RString kaigoHokenryo5Check;
    @ReportItem(name = "kaigoHokenryo4Check", length = 1, order = 89)
    public RString kaigoHokenryo4Check;
    @ReportItem(name = "kaigoHokenryo4Kingaku", length = 6, order = 90)
    public RString kaigoHokenryo4Kingaku;
    @ReportItem(name = "kaigoHokenryo3Check", length = 1, order = 91)
    public RString kaigoHokenryo3Check;
    @ReportItem(name = "kaigoHokenryo5Kingaku", length = 6, order = 92)
    public RString kaigoHokenryo5Kingaku;
    @ReportItem(name = "kaigoHokenryo2Check", length = 1, order = 93)
    public RString kaigoHokenryo2Check;
    @ReportItem(name = "kaigoHokenryo6Kingaku", length = 6, order = 94)
    public RString kaigoHokenryo6Kingaku;
    @ReportItem(name = "kaigoHokenryo6Check", length = 1, order = 95)
    public RString kaigoHokenryo6Check;
    @ReportItem(name = "kaigoHokenryo2Kingaku", length = 6, order = 96)
    public RString kaigoHokenryo2Kingaku;
    @ReportItem(name = "kaigoHokenryo3Kingaku", length = 6, order = 97)
    ...
    @ReportItem(name = "kaigoHokenryo7Check", length = 1, order = 104)
    public RString kaigoHokenryo7Check;
    @ReportItem(name = "kaigoHokenryo7Kingaku", length = 6, order = 105)
    public RString kaigoHokenryo7Kingaku;
    @ReportItem(name = "kaigoHokenryo11Check", length = 1, order = 106)
    public RString kaigoHokenryo11Check;
    @ReportItem(name = "kaigoHokenryo10Check", length = 1, order = 107)
    public RString kaigoHokenryo10Check;
    @ReportItem(name = "kaigoHokenryo10Kingaku", length = 6, order = 108)
    public RString kaigoHokenryo10Kingaku;
    @ReportItem(name = "kaigoHokenryo9Check", length = 1, order = 109)
    public RString kaigoHokenryo9Check;
    @ReportItem(name = "kaigoHokenryo11Kingaku", length = 6, order = 110)
    public RString kaigoHokenryo11Kingaku;
    @ReportItem(name = "kaigoHokenryo8Check", length = 1, order = 111)
    public RString kaigoHokenryo8Check;
    @ReportItem(name = "kaigoHokenryoOtherKingaku", length = 6, order = 112)
    public RString kaigoHokenryoOtherKingaku;
    @ReportItem(name = "kaigoHokenryoOtherCheck", length = 1, order = 113)
    public RString kaigoHokenryoOtherCheck;
    @ReportItem(name = "kaigoHokenryo8Kingaku", length = 6, order = 114)
    public RString kaigoHokenryo8Kingaku;
    @ReportItem(name = "kaigoHokenryo9Kingaku", length = 6, order = 115)
