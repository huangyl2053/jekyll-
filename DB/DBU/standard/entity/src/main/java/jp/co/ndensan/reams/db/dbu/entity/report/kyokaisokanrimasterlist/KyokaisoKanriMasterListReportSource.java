...
package jp.co.ndensan.reams.db.dba.entity.report.kyokaisokanrimasterlist;
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listUpper_2", length = 30, order = 15)
    public RString listUpper_2;
    @ReportItem(name = "listUpper_3", length = 1, order = 16)
    public RString listUpper_3;
    @ReportItem(name = "listUpper_4", length = 3, order = 17)
    public RString listUpper_4;
    @ReportItem(name = "listUpper_5", length = 3, order = 18)
    ...
    @ReportItem(name = "listUpper_9", length = 13, order = 22)
    public RString listUpper_9;
    @ReportItem(name = "listLower_1", length = 15, order = 23)
    public RString listLower_1;
    @ReportItem(name = "listLower_2", length = 14, order = 24)
    public RString listLower_2;
    @ReportItem(name = "listLower_3", length = 15, order = 25)
    public RString listLower_3;
    @ReportItem(name = "listLower_4", length = 10, order = 26)
    public RString listLower_4;
    @ReportItem(name = "listLower_5", length = 10, order = 27)
    public RString listLower_5;
    @ReportItem(name = "listLower_6", length = 11, order = 28)
    public RString listLower_6;
    @ReportItem(name = "listLower_7", length = 11, order = 29)
    public RString listLower_7;
    @ReportItem(name = "listLower_8", length = 11, order = 30)
    public RString listLower_8;
    @ReportItem(name = "listLower_9", length = 11, order = 31)
    public RString listLower_9;
    @ReportItem(name = "listLower_10", length = 5, order = 32)
