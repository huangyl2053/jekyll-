 ...
 */
package jp.co.ndensan.reams.db.dbu.entity.db.relate.jigyohokokucompyoshiki3003;
...
/**
 * 介護事業状況報告月報・一般状況（様式1-3） のパラメータクラスです。
 *
...
public class JigyohokokuCompYoshiki3003Data {
    ...
    private RString 減額免除認定表の利用者負担_4;
    private RString 減額免除認定表の利用者負担_5;
    private RString 減額免除認定表の利用者負担_6;
}
