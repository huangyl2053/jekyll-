 ...
 */
package jp.co.ndensan.reams.db.dbu.entity.db.relate.jigyohokokucompyoshiki14;
...
/**
 * 介護事業状況報告月報・一般状況（様式1-4） の一覧項目定義クラスです。
 *
...
public class JigyohokokuCompYoshiki14Change {
     ...
     *
     */
    public JigyohokokuCompYoshiki14Change(RString list_1,
            RString list_2,
            RString list_3,
            RString list_4,
            RString list_5,
