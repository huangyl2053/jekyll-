...
/**
 * 介護事業状況報告月報・一般状況（様式1-5） の一覧項目定義クラスです。
 *
...
public class JigyohokokuCompYoshiki152OldChange {
     ...
     * @param list1_10 居宅介護_介護給付の計
     * @param list1_11 居宅介護_合計
     * @param list2_1 地域密着型_要支援1
     * @param list2_2 地域密着型_要支援2
     * @param list2_3 地域密着型_予防給付の計
     ...
     * @param list2_11 地域密着型_介護給付の計
     * @param list2_12 地域密着型_合計
     */
    public JigyohokokuCompYoshiki152OldChange(RString list1_1,
            RString list1_2,
            RString list1_3,
            RString list1_4,
            RString list1_5,
