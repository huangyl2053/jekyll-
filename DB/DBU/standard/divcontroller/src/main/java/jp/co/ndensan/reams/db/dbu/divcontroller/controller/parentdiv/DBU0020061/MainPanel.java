...
//            }
            Decimal a = div.getDaiichigohiHokenshazogenUchiWake().getTblSetaiSu().getTxtTonenZoTennyu().getValue().add(
                    div.getDaiichigohiHokenshazogenUchiWake().getTxtTonenZoShokkenfukkatsu().getValue());
            Decimal b = div.getDaiichigohiHokenshazogenUchiWake().getTblSetaiSu().
                    getTxtTonenZorokugosaitotatsu().getValue();
            Decimal c = div.getDaiichigohiHokenshazogenUchiWake().getTblSetaiSu().getTxtTonenZoTekiyojogaihi().getValue();
