...
public class BenmeiTorokuMeisaiPanelDiv extends Panel {
    ...
    /*
     * gettxtMultiLineBenmeisya
     * @return txtMultiLineBenmeisya
     */
    @JsonProperty("txtMultiLineBenmeisya")
    ...
    /*
     * settxtMultiLineBenmeisya
     * @param txtMultiLineBenmeisya txtMultiLineBenmeisya
     */
    @JsonProperty("txtMultiLineBenmeisya")
    public void setTxtMultiLineBenmeisya(TextBoxMultiLine txtMultiLineBenmeisya) {
        this.txtMultiLineBenmeisya = txtMultiLineBenmeisya;
    }

    /*
     * gettxtMultiLineShobunNaiyo
     * @return txtMultiLineShobunNaiyo
     */
    @JsonProperty("txtMultiLineShobunNaiyo")
    ...
    /*
     * settxtMultiLineShobunNaiyo
     * @param txtMultiLineShobunNaiyo txtMultiLineShobunNaiyo
     */
    @JsonProperty("txtMultiLineShobunNaiyo")
    public void setTxtMultiLineShobunNaiyo(TextBoxMultiLine txtMultiLineShobunNaiyo) {
        this.txtMultiLineShobunNaiyo = txtMultiLineShobunNaiyo;
    }

    /*
     * gettxtMultiLineBenmeiNaiyo
     * @return txtMultiLineBenmeiNaiyo
     */
    @JsonProperty("txtMultiLineBenmeiNaiyo")
    ...
    /*
     * settxtMultiLineBenmeiNaiyo
     * @param txtMultiLineBenmeiNaiyo txtMultiLineBenmeiNaiyo
     */
    @JsonProperty("txtMultiLineBenmeiNaiyo")
    public void setTxtMultiLineBenmeiNaiyo(TextBoxMultiLine txtMultiLineBenmeiNaiyo) {
        this.txtMultiLineBenmeiNaiyo = txtMultiLineBenmeiNaiyo;
    }
