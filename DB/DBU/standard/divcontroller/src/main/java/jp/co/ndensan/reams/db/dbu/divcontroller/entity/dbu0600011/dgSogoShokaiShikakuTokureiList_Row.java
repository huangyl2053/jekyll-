...
/**
 * dgSogoShokaiShikakuTokureiList_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgSogoShokaiShikakuTokureiList_Row extends DataRow {

    private RString tekiyoJiyu;
    private RString tekiyoDate;
    private RString tekiyoTodokedeDate;
    private RString kaijoJiyu;
    private RString kaijoDate;
    private RString kaijoTodokedeDate;
    ...
    public dgSogoShokaiShikakuTokureiList_Row() {
        super();
        this.tekiyoJiyu = RString.EMPTY;
        this.tekiyoDate = RString.EMPTY;
        this.tekiyoTodokedeDate = RString.EMPTY;
        this.kaijoJiyu = RString.EMPTY;
        this.kaijoDate = RString.EMPTY;
        this.kaijoTodokedeDate = RString.EMPTY;
    ...
    public dgSogoShokaiShikakuTokureiList_Row(RString tekiyoJiyu, RString tekiyoDate, RString tekiyoTodokedeDate, RString kaijoJiyu, RString kaijoDate, RString kaijoTodokedeDate, RString sochiHokenshaMeisho, RString sochiHihokenshaNo, RString nyushoDate, RString taishoDate, RString shisetsuShurui, RString nyushoShisetsu) {
        super();
    ...
    public RString getTekiyoDate() {
        return tekiyoDate;
    }

    public RString getTekiyoTodokedeDate() {
    ...
    public RString getKaijoDate() {
        return kaijoDate;
    }

    public RString getKaijoTodokedeDate() {
    ...
    public RString getNyushoDate() {
        return nyushoDate;
    }

    public RString getTaishoDate() {
        return taishoDate;
    }
    ...
    public void setTekiyoDate(RString tekiyoDate) {
        this.setOriginalData("tekiyoDate", tekiyoDate);
        this.tekiyoDate = tekiyoDate;
    }

    public void setTekiyoTodokedeDate(RString tekiyoTodokedeDate) {
        this.setOriginalData("tekiyoTodokedeDate", tekiyoTodokedeDate);
        this.tekiyoTodokedeDate = tekiyoTodokedeDate;
    }
    ...
    public void setKaijoDate(RString kaijoDate) {
        this.setOriginalData("kaijoDate", kaijoDate);
        this.kaijoDate = kaijoDate;
    }

    public void setKaijoTodokedeDate(RString kaijoTodokedeDate) {
        this.setOriginalData("kaijoTodokedeDate", kaijoTodokedeDate);
        this.kaijoTodokedeDate = kaijoTodokedeDate;
    }
    ...
    public void setNyushoDate(RString nyushoDate) {
        this.setOriginalData("nyushoDate", nyushoDate);
        this.nyushoDate = nyushoDate;
    }

    public void setTaishoDate(RString taishoDate) {
        this.setOriginalData("taishoDate", taishoDate);
        this.taishoDate = taishoDate;
    }
