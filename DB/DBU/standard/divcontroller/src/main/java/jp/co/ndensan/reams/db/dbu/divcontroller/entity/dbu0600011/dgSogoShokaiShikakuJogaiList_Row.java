...
/**
 * dgSogoShokaiShikakuJogaiList_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgSogoShokaiShikakuJogaiList_Row extends DataRow {
    ...
    public dgSogoShokaiShikakuJogaiList_Row() {
        super();
    ...
    public dgSogoShokaiShikakuJogaiList_Row(RString tekiyoJiyu, RString tekiyoDate, RString tekiyoTodokedeDate, RString kaijoJiyu, RString kaijoDate, RString kaijoTodokedeDate, RString nyushoDate, RString taishoDate, RString shisetsu) {
        super();
