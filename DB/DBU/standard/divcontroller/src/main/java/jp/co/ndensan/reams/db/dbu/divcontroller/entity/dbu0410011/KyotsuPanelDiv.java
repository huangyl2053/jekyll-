...
public class KyotsuPanelDiv extends Panel {
    ...
    @JsonProperty("btnHihokenshashoHakko")
    private Button btnHihokenshashoHakko;
    ...
    @JsonProperty("btnHihokenshashoHakko")
    public Button getBtnHihokenshashoHakko() {
        return btnHihokenshashoHakko;
    }

    @JsonProperty("btnHihokenshashoHakko")
    public void setBtnHihokenshashoHakko(Button btnHihokenshashoHakko) {
        this.btnHihokenshashoHakko=btnHihokenshashoHakko;
    }
