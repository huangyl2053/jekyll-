...
/**
 * dgKaigoHokenryoGaitosha_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgKaigoHokenryoGaitosha_Row extends DataRow {
    ...
    public dgKaigoHokenryoGaitosha_Row() {
        super();
    ...
    public dgKaigoHokenryoGaitosha_Row(RString dankaiKubun, RString dankai, RString tokureiHyoki, RString dankaiAndTokurei, TextBoxNum hokenryo) {
        super();
        this.setOriginalData("dankaiKubun", dankaiKubun);
        this.setOriginalData("dankai", dankai);
        this.setOriginalData("tokureiHyoki", tokureiHyoki);
