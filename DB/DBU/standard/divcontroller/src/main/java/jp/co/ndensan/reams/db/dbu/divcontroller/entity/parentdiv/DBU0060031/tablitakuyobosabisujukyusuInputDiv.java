...
public class tablitakuyobosabisujukyusuInputDiv extends TabPanel {
     ...
     */
    @JsonProperty("dgItakuyobosabisujukyusu")
    private DataGrid<dgItakuyobosabisujukyusu_Row> dgItakuyobosabisujukyusu;
     ...
     */
    /*
     * getdgItakuyobosabisujukyusu
     * @return dgItakuyobosabisujukyusu
     */
    @JsonProperty("dgItakuyobosabisujukyusu")
    ...
    /*
     * setdgItakuyobosabisujukyusu
     * @param dgItakuyobosabisujukyusu dgItakuyobosabisujukyusu
     */
    @JsonProperty("dgItakuyobosabisujukyusu")
    public void setDgItakuyobosabisujukyusu(DataGrid<dgItakuyobosabisujukyusu_Row> dgItakuyobosabisujukyusu) {
        this.dgItakuyobosabisujukyusu = dgItakuyobosabisujukyusu;
    }
