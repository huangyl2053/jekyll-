...
public class HokenryoNofuGengakuDiv extends Panel {
    ...
    @JsonProperty("tekiyoState")
    private RString tekiyoState;
     ...
     */
    @JsonProperty("tekiyoState")
    public RString getTekiyoState() {
        return tekiyoState;
    }

    /*
     * settekiyoState
     * @param tekiyoState tekiyoState
     */
    @JsonProperty("tekiyoState")
    public void setTekiyoState(RString tekiyoState) {
        this.tekiyoState = tekiyoState;
    }
