 ...
 */
public class JigyoHokokuDataCSVDBU060700Process extends BatchProcessBase<JigyoHokokuDataCsvRelateEntity> {
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(MYBATIS_SELECT_ID, processParameter
                .toJigyoHokokuDataCSVMybitisParamter(ShukeiNo.利用者負担第五段階_0700.getコード()));
    }
