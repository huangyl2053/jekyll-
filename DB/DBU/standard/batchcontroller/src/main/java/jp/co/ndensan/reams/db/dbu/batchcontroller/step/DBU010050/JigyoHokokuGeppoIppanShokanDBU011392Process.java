 ...
 */
public class JigyoHokokuGeppoIppanShokanDBU011392Process extends BatchProcessBase<JyukyushaJohoKonkyoCSVRelateEntity> {
    ...
    protected void createWriter() {
        eucFilePath = Path.combinePath(processParameter.getCsvFilePath(), new RString("DBU011392.csv"));
