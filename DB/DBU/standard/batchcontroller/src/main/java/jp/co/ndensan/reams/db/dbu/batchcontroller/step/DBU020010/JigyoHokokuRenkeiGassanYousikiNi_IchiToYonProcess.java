...
public class JigyoHokokuRenkeiGassanYousikiNi_IchiToYonProcess extends BatchProcessBase<DbT7021JigyoHokokuTokeiDataEntity> {
    ...
    protected void afterExecute() {
        get様式２_様式２の４のCSV出力(processParameter.get保険者番号(), processParameter.get保険者名称());
        eucCsvWriter.close();
    }
    ...
    private void get様式２から様式２の６のデータ編集(DbT7021JigyoHokokuTokeiDataEntity entity, RString 集計番号, RString 縦番号,
