 ...
 */
public class JigyoHokokuGeppoDBU011392Process extends BatchProcessBase<KyufuJissekiKonkyoRelateEntity> {
    ...
    private static final EucEntityId EUC_ENTITY_ID = new EucEntityId("DBU011392");
    ...
    protected void createWriter() {
        ...
        eucFilePath = Path.combinePath(manager.getEucOutputDirectry(), new RString("DBU011392.csv"));
