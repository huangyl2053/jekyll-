...
import jp.co.ndensan.reams.db.dbu.persistence.db.mapper.relate.jigyohokokunenpohokenkyufukogaku.IJigyoHokokuNenpoHokenkyufuKogakuMapper;
 ...
 */
public class JigyoHokokuNenpoHokenkyufuKogakuUpdateProcess extends BatchProcessBase<GassanJigyouHoukokuTokeiEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbu.persistence.db.mapper.relate.jigyohokokunenpohokenkyufukogaku."
            + "IJigyoHokokuNenpoHokenkyufuKogakuMapper.getJigyouHokokuTokeiJyoho");
    private JigyoHokokuNenpoHokenkyufuKogakuProcessParamter processParameter;
    private IJigyoHokokuNenpoHokenkyufuKogakuMapper mapper;
    @BatchWriter
    private BatchPermanentTableWriter<DbT7021JigyoHokokuTokeiDataEntity> dbT7021EntityWriter;

    @Override
    protected void initialize() {
        mapper = getMapper(IJigyoHokokuNenpoHokenkyufuKogakuMapper.class);
