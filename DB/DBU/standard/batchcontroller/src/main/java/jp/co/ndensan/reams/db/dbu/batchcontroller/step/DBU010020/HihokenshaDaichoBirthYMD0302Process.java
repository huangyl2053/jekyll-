 ...
 */
public class HihokenshaDaichoBirthYMD0302Process extends BatchProcessBase<IchigoHihokenshaJohoKonkyoCSVEntity> {
    ...
    protected void initialize() {
        集計番号 = ShukeiNo.一般状況_2_第2号被保険者増減内訳_当月中減.getコード();
