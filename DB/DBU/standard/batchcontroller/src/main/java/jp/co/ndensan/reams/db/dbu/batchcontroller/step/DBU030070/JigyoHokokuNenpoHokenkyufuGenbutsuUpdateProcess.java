...
import jp.co.ndensan.reams.db.dbu.persistence.db.mapper.relate.jigyohokokunenpohokenkyufugenbutsu.IJigyoHokokuNenpoHokenkyufuGenbutsuMapper;
 ...
 */
public class JigyoHokokuNenpoHokenkyufuGenbutsuUpdateProcess extends BatchProcessBase<GassanJigyouHoukokuTokeiEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbu.persistence.db.mapper.relate.jigyohokokunenpohokenkyufugenbutsu."
            + "IJigyoHokokuNenpoHokenkyufuGenbutsuMapper.getJigyouHokokuTokeiJyoho");
    private JigyoHokokuNenpoHokenkyufuGenbutsuProcessParamter processParameter;
    private IJigyoHokokuNenpoHokenkyufuGenbutsuMapper mapper;
    @BatchWriter
    private BatchPermanentTableWriter<DbT7021JigyoHokokuTokeiDataEntity> dbT7021EntityWriter;

    @Override
    protected void initialize() {
        mapper = getMapper(IJigyoHokokuNenpoHokenkyufuGenbutsuMapper.class);
