 ...
 */
public class JigyoHokokuGeppoDBU031392Process extends BatchProcessBase<KyufuJissekiKonkyoRelateEntity> {
    ...
    protected void createWriter() {
        eucFilePath = Path.combinePath(processParameter.getCsvFilePath(), new RString("DBU031392.csv"));
