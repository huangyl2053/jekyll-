...
public class JigyoHokokuNenpoIppanGenbutsuDBU300107Process extends BatchProcessBase<GassanJigyouHoukokuTokeiEntity> {
    ...
    protected void afterExecute() {
        ...
        reportData.set地域密着型_経過的要介護_1(getValue(syukeiNo1200, 数値_11));
        reportData.set地域密着型_経過的要介護_2(getValue(syukeiNo1200, 数値_12));
        reportData.set地域密着型_経過的要介護_3(getValue(syukeiNo1200, 数値_13));
        reportData.set地域密着型_要介護1_1(getValue(syukeiNo1200, 数値_21));
        reportData.set地域密着型_要介護1_2(getValue(syukeiNo1200, 数値_22));
        reportData.set地域密着型_要介護1_3(getValue(syukeiNo1200, 数値_23));
        reportData.set地域密着型_要介護2_1(getValue(syukeiNo1200, 数値_31));
        reportData.set地域密着型_要介護2_2(getValue(syukeiNo1200, 数値_32));
        reportData.set地域密着型_要介護2_3(getValue(syukeiNo1200, 数値_33));
        reportData.set地域密着型_要介護3_1(getValue(syukeiNo1200, 数値_41));
        reportData.set地域密着型_要介護3_2(getValue(syukeiNo1200, 数値_42));
        reportData.set地域密着型_要介護3_3(getValue(syukeiNo1200, 数値_43));
        reportData.set地域密着型_要介護4_1(getValue(syukeiNo1200, 数値_51));
        reportData.set地域密着型_要介護4_2(getValue(syukeiNo1200, 数値_52));
        reportData.set地域密着型_要介護4_3(getValue(syukeiNo1200, 数値_53));
        reportData.set地域密着型_要介護5_1(getValue(syukeiNo1200, 数値_61));
        reportData.set地域密着型_要介護5_2(getValue(syukeiNo1200, 数値_62));
        reportData.set地域密着型_要介護5_3(getValue(syukeiNo1200, 数値_63));
        reportData.setその他1(getValue(syukeiNo1200, 数値_71));
        reportData.setその他2(getValue(syukeiNo1200, 数値_72));
        reportData.setその他3(getValue(syukeiNo1200, 数値_73));
        reportData.set地域密着型_介護給付計_1(getValue(syukeiNo1200, 数値_81));
        reportData.set地域密着型_介護給付計_2(getValue(syukeiNo1200, 数値_82));
        reportData.set地域密着型_介護給付計_3(getValue(syukeiNo1200, 数値_83));
        reportData.set地域密着型_合計1(getValue(syukeiNo1200, 数値_121));
        reportData.set地域密着型_合計2(getValue(syukeiNo1200, 数値_122));
        reportData.set地域密着型_合計3(getValue(syukeiNo1200, 数値_123));
