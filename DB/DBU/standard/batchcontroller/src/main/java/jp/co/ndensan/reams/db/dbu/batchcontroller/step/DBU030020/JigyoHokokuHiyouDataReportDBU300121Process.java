...
/**
 * 事業状況報告年報帳票出力_市町村特別給付-費用額のバッチ処理クラスです。
 *
 * @reamsid_L DBU-5610-030 chengsanyuan
 *
 */
public class JigyoHokokuHiyouDataReportDBU300121Process extends BatchProcessBase<JigyoHokokuReportDataRelateEntity> {
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(MYBATIS_SELECT_ID, processParameter.toGetReportDataParm(集計番号フラグ_市町村特別給付費用額));
    }
