...
import jp.co.ndensan.reams.db.dbu.business.report.jigyohokokucompyoshiki3003.JigyohokokuCompYoshiki3003Report;
 ...
 */
public class JigyouHoukokuTokeiReportDBU300003Process extends BatchProcessBase<JigyoHokokuDataRelateEntity> {
    ...
    @BatchWriter
    private BatchReportWriter<JigyohokokuCompYoshiki3003ReportSource> batchWrite;
    private ReportSourceWriter<JigyohokokuCompYoshiki3003ReportSource> reportSourceWriter;
    ...
    protected void process(JigyoHokokuDataRelateEntity entity) {
        if (ShukeiNo.一般状況_7_利用者負担減額_免除認定_再掲_第2号被保険者分.getコード().equals(entity.getSyukeiNo().value())) {
        ...
        } else if (ShukeiNo.一般状況_6_食費_居住費に係る負担限度額認定_再掲_第2号被保険者分.getコード().equals(entity.getSyukeiNo().value())) {
    ...
    protected void afterExecute() {
        JigyohokokuCompYoshiki3003Data reportData = new JigyohokokuCompYoshiki3003Data();
        ...
        reportData.set表1のタイトル(new RString("（６）食費・居住費に係る負担限度額認定（再掲：第２号被保険者分）"));
        ...
        setその他(reportData);
        set合計(reportData);
        reportData.set左下表2のタイトル1(new RString("（７）利用者負担減額・免除認定"));
        reportData.set右下表3のタイトル(new RString("（８）介護老人福祉施設旧措置入所者に係る減額・免除認定（再掲：第２号被保険者分）"));
        reportData.set左下表2のタイトル2(new RString("　　（再掲：第２号被保険者分）"));
        ...
        JigyohokokuCompYoshiki3003Report report = new JigyohokokuCompYoshiki3003Report(reportData);
        report.writeBy(reportSourceWriter);

    }

    private void set介護老人福祉施設(JigyohokokuCompYoshiki3003Data reportData) {
    ...
    private void set介護老人保健施設(JigyohokokuCompYoshiki3003Data reportData) {
    ...
    private void set介護療養型医療施設(JigyohokokuCompYoshiki3003Data reportData) {
    ...
    private void set地域密着型介護老人福祉施設入居者生活介護(JigyohokokuCompYoshiki3003Data reportData) {
    ...
    private void setその他(JigyohokokuCompYoshiki3003Data reportData) {
    ...
    private void set合計(JigyohokokuCompYoshiki3003Data reportData) {
    ...
    private void set利用者負担減額_免除認定表の利用者負担(JigyohokokuCompYoshiki3003Data reportData) {
        reportData.set利用者負担減額免除認定表の利用者負担_1(getValue(syukeiNo0900, 数値_101));
        reportData.set利用者負担減額免除認定表の利用者負担_2(getValue(syukeiNo0900, 数値_201));
        reportData.set利用者負担減額免除認定表の利用者負担_3(getValue(syukeiNo0900, 数値_301));
        reportData.set利用者負担減額免除認定表の利用者負担_4(getValue(syukeiNo0900, 数値_401));
        reportData.set利用者負担減額免除認定表の利用者負担_5(getValue(syukeiNo0900, 数値_501));
    }

    private void set介護老人福祉施設旧措置入所者に係る減額_減免認定表の特定負担限度額(JigyohokokuCompYoshiki3003Data reportData) {
        reportData.set特定負担限度額の申請件数(getValue(syukeiNo1020, 数値_101));
        reportData.set減額減免認定表の特定負担限度額_食費_1(getValue(syukeiNo1020, 数値_201));
        reportData.set減額減免認定表の特定負担限度額_食費_2(getValue(syukeiNo1020, 数値_301));
        reportData.set減額減免認定表の特定負担限度額_食費_3(getValue(syukeiNo1020, 数値_401));
        reportData.set減額減免認定表の特定負担限度額_食費_4(getValue(syukeiNo1020, 数値_501));
        reportData.set減額減免認定表の特定負担限度額_食費_5(getValue(syukeiNo1020, 数値_601));
        reportData.set減額減免認定表の特定負担限度額_食費_6(getValue(syukeiNo1020, 数値_701));
        reportData.set減額減免認定表の特定負担限度額_居住費_1(getValue(syukeiNo1020, 数値_202));
        reportData.set減額減免認定表の特定負担限度額_居住費_2(getValue(syukeiNo1020, 数値_302));
        reportData.set減額減免認定表の特定負担限度額_居住費_3(getValue(syukeiNo1020, 数値_402));
        reportData.set減額減免認定表の特定負担限度額_居住費_4(getValue(syukeiNo1020, 数値_502));
        reportData.set減額減免認定表の特定負担限度額_居住費_5(getValue(syukeiNo1020, 数値_602));
        reportData.set減額減免認定表の特定負担限度額_居住費_6(getValue(syukeiNo1020, 数値_702));
    }

    private void set介護老人福祉施設旧措置入所者に係る減額_免除認定表の利用者負担(JigyohokokuCompYoshiki3003Data reportData) {
        reportData.set減額免除認定表の利用者負担_1(getValue(syukeiNo1002, 数値_101));
        reportData.set減額免除認定表の利用者負担_2(getValue(syukeiNo1002, 数値_201));
        reportData.set減額免除認定表の利用者負担_3(getValue(syukeiNo1002, 数値_301));
        reportData.set減額免除認定表の利用者負担_4(getValue(syukeiNo1002, 数値_401));
        reportData.set減額免除認定表の利用者負担_5(getValue(syukeiNo1002, 数値_501));
    }
