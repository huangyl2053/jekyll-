...
public class JigyoHokokuShiryouReportDBU300009Process extends BatchProcessBase<JigyoHokokuShiryouRelateEntity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbu.persistence.db.mapper.relate.hokenkyufugassanshinsaym."
            + "IJigyoHokokuRenkeiHokenkyufuGassanShinsaYMMapper.getJigyouHokoku_Hokensha");
    private static final RString 構成市町村 = new RString("1");
    private static final RString 旧市町村 = new RString("2");
    private JigyoHokokuGeppoHokenkyufuGenbutsuProcessParameter processParameter;
    @BatchWriter
    ...
    protected void createWriter() {
        様式_01batchWrite = BatchReportFactory.createBatchReportWriter(ReportIdDBU.DBU300009.getReportId().value()).create();
...
//        business.set処理日時(new RString(processParameter.get処理日時().toString()));
        ...
        if (ShukeiNoyoshiki2._1_介護給付_予防給付1総数_件数.getコード().equals(entity.getSyukeiNo())
