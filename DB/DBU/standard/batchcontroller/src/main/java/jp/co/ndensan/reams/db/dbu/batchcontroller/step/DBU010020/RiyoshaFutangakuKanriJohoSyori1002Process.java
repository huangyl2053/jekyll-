 ...
 */
public class RiyoshaFutangakuKanriJohoSyori1002Process extends BatchProcessBase<RiyoshaFutangakuGemmenJohoKonkyoCSVEntity> {
    ...
    protected void initialize() {
        集計番号 = ShukeiNo.一般状況_8_介護老人福祉施設旧措置入所者に係る減額_免除認定_再掲_第2号被保険者分_利用者負担.getコード();
