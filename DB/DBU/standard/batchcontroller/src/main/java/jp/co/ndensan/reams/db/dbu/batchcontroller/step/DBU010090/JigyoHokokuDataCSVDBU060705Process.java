 ...
 */
public class JigyoHokokuDataCSVDBU060705Process extends BatchProcessBase<JigyoHokokuDataCsvRelateEntity> {
    ...
    private static final EucEntityId EUC_ENTITY_ID = new EucEntityId("DBU060705");
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(MYBATIS_SELECT_ID, processParameter
                .toJigyoHokokuDataCSVMybitisParamter(ShukeiNo.合計_07.getコード()));
    }

    @Override
    protected void createWriter() {
        manager = new FileSpoolManager(UzUDE0835SpoolOutputType.EucOther, EUC_ENTITY_ID, UzUDE0831EucAccesslogFileType.Csv);
        eucFilePath = Path.combinePath(manager.getEucOutputDirectry(), new RString("DBU060705.CSV"));
    ...
    protected void afterExecute() {
        ...
        RString zipFilePath = new RString(Path.combinePath(manager.getEucOutputDirectry(), new RString("DBU060705.zip")).toString());
