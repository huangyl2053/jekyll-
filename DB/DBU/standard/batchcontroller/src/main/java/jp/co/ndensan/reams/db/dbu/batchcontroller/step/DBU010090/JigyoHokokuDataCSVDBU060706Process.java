...
public class JigyoHokokuDataCSVDBU060706Process extends BatchProcessBase<JigyoHokokuDataCsvRelateEntity> {
    ...
    private static final EucEntityId EUC_ENTITY_ID = new EucEntityId("DBU060706");
    ...
    protected void createWriter() {
        ...
        eucFilePath = Path.combinePath(manager.getEucOutputDirectry(), new RString("DBU060706.CSV"));
    ...
    protected void afterExecute() {
        ...
        RString zipFilePath = new RString(Path.combinePath(manager.getEucOutputDirectry(), new RString("DBU060706.zip")).toString());
