...
/**
 * 処理結果確認リスト負担割合エラーフラグ分のバッチ処理クラスです。
 *
 * @reamsid_L DBU-5570-030 xuyannan
 */
public class ShoriKekkaKakuninListFutanWariaiProcess extends BatchProcessBase<TempDwbTKyufujissekiShukeiKonkyo1Entity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbu.persistence.db.mapper.relate.hokenkyufushokankettei."
            + "IJigyoHokokuRenkeiHokenkyufuShokanKetteiMapper.getShoriKekkaKakuninListByFutanWariai");
    ...
    private static final RString 内容1 = new RString("負担割合情報が存在しません。");
