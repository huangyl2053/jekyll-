 ...
 */
public class TokuteiNyushoshaJohoSyori1030Process extends BatchProcessBase<TokuteiNyushoshaGengakuNinteiJohoCSVEntity> {
    ...
    protected void initialize() {
        集計番号 = ShukeiNo.一般状況_10_利用者負担第4段階における_食費_居住費の特例減額措置.getコード();
