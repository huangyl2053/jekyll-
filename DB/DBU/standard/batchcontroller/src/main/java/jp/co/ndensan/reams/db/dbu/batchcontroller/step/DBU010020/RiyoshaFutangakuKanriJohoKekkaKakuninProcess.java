...
/**
 * 利用者負担減額管理情報の確認リストのバッチ処理クラスです。
 *
 * @reamsid_L DBU-5530-030 wangxiaodong
 */
public class RiyoshaFutangakuKanriJohoKekkaKakuninProcess extends BatchProcessBase<ShoriKekkaKakuninListRelateEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString("jp.co.ndensan.reams.db.dbu.persistence."
            + "db.mapper.relate.jigyohokokugeppoippan.IJigyoHokokuGeppoIppanMapper.getRiyoshaFutangakuGemmenHihokenshaDaichoSyoriKakuninRisuto");
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(MYBATIS_SELECT_ID, processParameter.toJigyoHokokuGeppoShoriKekkaKakuninListMybatisParameter());
    }
