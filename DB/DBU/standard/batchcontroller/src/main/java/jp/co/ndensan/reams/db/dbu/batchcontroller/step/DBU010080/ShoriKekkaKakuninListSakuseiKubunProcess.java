...
/**
 * 処理結果確認リスト作成区分エラーフラグ分のバッチ処理クラスです。
 *
 * @reamsid_L DBU-5570-030 xuyannan
 */
public class ShoriKekkaKakuninListSakuseiKubunProcess extends BatchProcessBase<TempDwbTKyufujissekiShukeiKonkyo1Entity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbu.persistence.db.mapper.relate.hokenkyufushokankettei."
            + "IJigyoHokokuRenkeiHokenkyufuShokanKetteiMapper.getShoriKekkaKakuninListBySakuseiKubun");
    ...
    private static final RString 内容1 = new RString("給付実績と負担割合の給付率が異なります。");
    private static final RString 処理名称 = new RString("保険給付決定状況償還分決定年月");
    private static final RString 内容２_１ = new RString("90％で計算しています。");
    private static final RString 内容２_２ = new RString("80％で計算しています。");
