...
public class JigyoHokokuShiryouReportDBU300021Process extends BatchProcessBase<JigyoHokokuShiryouRelateEntity> {
    ...
    protected void createWriter() {
        様式_03batchWrite = BatchReportFactory.createBatchReportWriter(ReportIdDBU.DBU300021.getReportId().value()).create();
    ...
    protected void process(JigyoHokokuShiryouRelateEntity entity) {
        ...
        if (ShukeiNoyoshiki2._1_介護給付_予防給付2二割負担被保険者分_再掲_件数.getコード().equals(entity.getSyukeiNo())
