...
public class JigyoHokokuRenkei11_14GassanProcess extends BatchProcessBase<DbT7021JigyoHokokuTokeiDataEntity> {
    ...
    protected void initialize() {
        ...
        fileName.append("DUJRENF05_");
        fileName.append(processParameter.get過去集計年月());
        fileName.append("_");
        fileName.append(processParameter.get保険者番号());
        fileName.append(".csv");
        eucFilePath = Path.combinePath(spoolWorkPath, fileName.toRString());
    ...
    private void setヘッダレコード(RString 保険者番号, RString 保険者名称) {
        eucCsvWriter.writeLine(new JigyoHokokuRenkeiHeadEucCsvEntity(
                RString.EMPTY,
                new RString("H1"),
