 ...
 */
public class JigyoHokokuGeppoDBU031393Process extends BatchProcessBase<KyufuJissekiKonkyoRelateEntity> {
    ...
    protected void createWriter() {
        eucFilePath = Path.combinePath(processParameter.getCsvFilePath(), new RString("DBU031393.csv"));
