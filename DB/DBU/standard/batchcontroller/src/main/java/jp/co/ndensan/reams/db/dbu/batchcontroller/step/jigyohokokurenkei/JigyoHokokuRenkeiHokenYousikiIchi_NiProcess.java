...
public class JigyoHokokuRenkeiHokenYousikiIchi_NiProcess extends BatchProcessBase<DbT7021JigyoHokokuTokeiDataEntity> {
    ...
    private void get様式１の２総括のCSV出力(DbT7021JigyoHokokuTokeiDataEntity entity) {
        JigyoHokokuRenkeiEntity jigyoHokokuRenkeiEntity
                = get様式１の２の項目編集(entity, new RString("0710"), new RString("0600"), new RString("0720"), new RString("0702"));
