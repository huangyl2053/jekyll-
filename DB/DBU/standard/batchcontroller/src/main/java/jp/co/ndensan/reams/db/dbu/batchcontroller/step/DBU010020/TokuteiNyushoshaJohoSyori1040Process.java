 ...
 */
public class TokuteiNyushoshaJohoSyori1040Process extends BatchProcessBase<TokuteiNyushoshaGengakuNinteiJohoCSVEntity> {
    ...
    protected void initialize() {
        集計番号 = ShukeiNo.一般状況_9_食費_居住費に係る負担限度額認定_再掲_税制改正による激変緩和措置を受けている者.getコード();
