 ...
 */
public class TokuteiNyushoshaJohoSyori0720Process extends BatchProcessBase<TokuteiNyushoshaGengakuNinteiJohoCSVEntity> {
    ...
    protected void initialize() {
        集計番号 = ShukeiNo.一般状況_5_介護老人福祉施設旧措置入所者に係る減額_免除認定_総数_特定負担限度額.getコード();
