 ...
 */
public class TokuteiNyushoshaJohoSyori1010Process extends BatchProcessBase<TokuteiNyushoshaGengakuNinteiJohoCSVEntity> {
    ...
    protected void initialize() {
        集計番号 = ShukeiNo.一般状況_6_食費_居住費に係る負担限度額認定_再掲_第2号被保険者分.getコード();
