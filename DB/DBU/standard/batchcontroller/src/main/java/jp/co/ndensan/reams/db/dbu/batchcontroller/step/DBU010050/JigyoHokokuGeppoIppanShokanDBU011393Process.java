 ...
 */
public class JigyoHokokuGeppoIppanShokanDBU011393Process extends BatchProcessBase<JyukyushaJohoKonkyoCSVRelateEntity> {
    ...
    protected void createWriter() {
        eucFilePath = Path.combinePath(processParameter.getCsvFilePath(), new RString("DBU011393.csv"));
