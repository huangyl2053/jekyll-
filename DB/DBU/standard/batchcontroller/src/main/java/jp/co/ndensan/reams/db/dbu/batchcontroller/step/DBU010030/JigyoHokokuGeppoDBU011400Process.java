 ...
 */
public class JigyoHokokuGeppoDBU011400Process extends BatchProcessBase<KyufuJissekiKonkyoRelateEntity> {
    ...
    private static final EucEntityId EUC_ENTITY_ID = new EucEntityId("DBU011400");
...
//    private static final RString ダブル引用符 = new RString("\"");
    ...
    protected void createWriter() {
        ...
        eucFilePath = Path.combinePath(manager.getEucOutputDirectry(), new RString("DBU011400.csv"));
