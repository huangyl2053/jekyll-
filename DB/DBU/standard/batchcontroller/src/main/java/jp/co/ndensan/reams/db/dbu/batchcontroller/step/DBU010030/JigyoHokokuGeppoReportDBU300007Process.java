...
import jp.co.ndensan.reams.db.dbu.business.report.jigyohokokucompyoshiki153.JigyohokokuCompYoshiki153Report;
 ...
 *
 */
public class JigyoHokokuGeppoReportDBU300007Process extends BatchProcessBase<JigyouHoukokuTokTyhyouRelateEntity> {
    ...
    @BatchWriter
    private BatchReportWriter<JigyohokokuCompYoshiki153ReportSource> batchWrite;
    private ReportSourceWriter<JigyohokokuCompYoshiki153ReportSource> reportSourceWriter;
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(MYBATIS_SELECT_ID, processParameter.to事業報告統計データ_14MybitisParamter());
    }
    ...
    protected void afterExecute() {
        JigyohokokuCompYoshiki153Variables reportData = new JigyohokokuCompYoshiki153Variables();
        ...
        reportData.set要支援合計_1(getValue(syukeiNo1391, 数値_103));
        reportData.set要支援合計_2(getValue(syukeiNo1391, 数値_203));
        reportData.set要支援合計_3(getValue(syukeiNo1391, 数値_303));
        reportData.set要支援合計_4(getValue(syukeiNo1392, 数値_103));
        reportData.set要支援合計_5(getValue(syukeiNo1392, 数値_203));
        reportData.set要支援合計_6(getValue(syukeiNo1392, 数値_303));
        reportData.set要支援合計_7(getValue(syukeiNo1393, 数値_103));
        reportData.set要支援合計_8(getValue(syukeiNo1393, 数値_203));
        reportData.set要支援合計_9(getValue(syukeiNo1393, 数値_303));
        reportData.set要支援合計_10(getValue(syukeiNo1393, 数値_403));
        ...
        reportData.set要介護合計_1(getValue(syukeiNo1391, 数値_111));
        reportData.set要介護合計_2(getValue(syukeiNo1391, 数値_211));
        reportData.set要介護合計_3(getValue(syukeiNo1391, 数値_311));
        reportData.set要介護合計_4(getValue(syukeiNo1392, 数値_111));
        reportData.set要介護合計_5(getValue(syukeiNo1392, 数値_211));
        reportData.set要介護合計_6(getValue(syukeiNo1392, 数値_311));
        reportData.set要介護合計_7(getValue(syukeiNo1393, 数値_111));
        reportData.set要介護合計_8(getValue(syukeiNo1393, 数値_211));
        reportData.set要介護合計_9(getValue(syukeiNo1393, 数値_311));
        reportData.set要介護合計_10(getValue(syukeiNo1393, 数値_411));
        ...
        JigyohokokuCompYoshiki153Report report = new JigyohokokuCompYoshiki153Report(reportData);
