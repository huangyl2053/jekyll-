 ...
 */
public class JigyouHoukokuTokeiReportDBU300001NikaiProcess extends BatchProcessBase<JigyoHokokuDataRelateEntity> {
    ...
    private void setMybatisParameter() {
        ...
        mybatisParameter.setSyukeiYM(processParameter.get集計年月().minusMonth(1));
