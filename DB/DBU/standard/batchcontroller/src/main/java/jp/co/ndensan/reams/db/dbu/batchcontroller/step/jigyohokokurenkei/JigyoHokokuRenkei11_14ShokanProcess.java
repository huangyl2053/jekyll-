...
/**
 * 様式別連携情報作成のバッチ処理・一般状況（１１）～（１４）償還分_審査年月に対応するのCSV出力のプロセスクラスです。
 *
 * @reamsid_L DBU-4050-020 lijia
 */
public class JigyoHokokuRenkei11_14ShokanProcess extends BatchProcessBase<DbT7021JigyoHokokuTokeiDataEntity> {
    ...
    protected void initialize() {
        if (processParameter.is出力_一般状況11_14償還分_審査年月()) {
            myBatisSelsectId = new RString(
                    ...
                    + "get事業報告統計償還分審査年月情報の取得");
        }
        if (processParameter.is出力_一般状況11_14償還分_決定年月()) {
            myBatisSelsectId = new RString(
                    "jp.co.ndensan.reams.db.dbu.persistence.db.mapper.relate.jigyohokokurenkei.IJigyoHokokuRenkeiMapper."
                    + "get事業報告統計償還分決定年月情報の取得");
        }
        csvFileName = new RString("DUJRENF07_" + processParameter.get過去集計年月()
    ...
    protected void afterExecute() {
        get様式１の６レコード１のCSV出力();
        get様式１の６レコード２OR３のCSV出力(new RString("T2"));
        get様式１の６レコード２OR３のCSV出力(new RString("T3"));
        get様式１の６レコード４のCSV出力();
        eucCsvWriter.writeLine(
    ...
    private void get様式１の６レコード４のCSV出力() {
        eucCsvWriter.writeLine(
                new JigyoHokokuRenkei11or14Record4EucCsvEntity(
                        ...
                        record1Entity.getD054(),
                        record1Entity.getD055(),
                        record1Entity.getD056(),
                        record1Entity.getD057(),
                        record1Entity.getD058(),
                        record1Entity.getD059(),
                        record1Entity.getD060(),
                        record1Entity.getD061(),
                        record1Entity.getD062(),
                        record1Entity.getD063(),
                        record1Entity.getD064(),
                        record1Entity.getD065(),
                        record1Entity.getD066(),
                        record1Entity.getD067(),
                        record1Entity.getD068(),
                        record1Entity.getD069(),
                        record1Entity.getD070(),
                        record1Entity.getD071(),
                        record1Entity.getD072(),
                        record1Entity.getD073(),
                        record1Entity.getD074(),
                        record1Entity.getD075(),
                        record1Entity.getD076(),
                        record1Entity.getD077(),
                        record1Entity.getD078(),
                        record1Entity.getD079(),
                        record1Entity.getD080(),
                        record1Entity.getD081(),
                        record1Entity.getD082(),
                        record1Entity.getD083(),
                        record1Entity.getD084(),
                        record1Entity.getD085(),
                        record1Entity.getD086(),
                        record1Entity.getD087(),
                        record1Entity.getD088(),
                        record1Entity.getD089(),
                        record1Entity.getD090(),
                        record1Entity.getD091(),
                        record1Entity.getD092(),
                        record1Entity.getD093(),
                        record1Entity.getD094(),
                        record1Entity.getD095(),
                        record1Entity.getD096(),
                        record1Entity.getD097(),
                        record1Entity.getD098(),
                        record1Entity.getD099(),
                        record1Entity.getD100()
                )
        );
    }
