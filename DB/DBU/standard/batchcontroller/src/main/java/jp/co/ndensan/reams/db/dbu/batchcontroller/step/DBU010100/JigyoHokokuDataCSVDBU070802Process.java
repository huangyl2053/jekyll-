 ...
 */
public class JigyoHokokuDataCSVDBU070802Process extends BatchProcessBase<JigyoHokokuDataCsvRelateEntity> {
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(MYBATIS_SELECT_ID, processParameter.toJigyoHokokuDataCSVMybitisParamter(ShukeiNo.一般.getコード()));
    }

    @Override
    protected void createWriter() {
        eucFilePath = Path.combinePath(processParameter.getCsvFilePath(), new RString("DBU070802.CSV"));
