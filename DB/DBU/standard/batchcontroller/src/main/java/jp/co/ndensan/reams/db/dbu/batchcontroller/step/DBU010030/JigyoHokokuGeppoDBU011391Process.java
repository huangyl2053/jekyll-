 ...
 */
public class JigyoHokokuGeppoDBU011391Process extends BatchProcessBase<KyufuJissekiKonkyoRelateEntity> {
    ...
    private static final EucEntityId EUC_ENTITY_ID = new EucEntityId("DBU011391");
    ...
    protected void createWriter() {
        ...
        eucFilePath = Path.combinePath(manager.getEucOutputDirectry(), new RString("DBU011391.csv"));
