 ...
 */
public class JigyoHokokuDataCSVDBU070804Process extends BatchProcessBase<JigyoHokokuDataCsvRelateEntity> {
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(MYBATIS_SELECT_ID, processParameter.toJigyoHokokuDataCSVMybitisParamter(ShukeiNo.低所得者Ⅰ.getコード()));
    }

    @Override
    protected void createWriter() {
        eucFilePath = Path.combinePath(processParameter.getCsvFilePath(), new RString("DBU070804.CSV"));
