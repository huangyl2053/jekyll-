 ...
 */
public class JigyoHokokuDataCSVDBU060701Process extends BatchProcessBase<JigyoHokokuDataCsvRelateEntity> {
    ...
    private static final EucEntityId EUC_ENTITY_ID = new EucEntityId("DBU060701");
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(MYBATIS_SELECT_ID, processParameter
                .toJigyoHokokuDataCSVMybitisParamter(ShukeiNo.利用者負担第四段階_0701.getコード()));
    }

    @Override
    protected void createWriter() {
        manager = new FileSpoolManager(UzUDE0835SpoolOutputType.EucOther, EUC_ENTITY_ID, UzUDE0831EucAccesslogFileType.Csv);
        eucFilePath = Path.combinePath(manager.getEucOutputDirectry(), new RString("DBU060701.CSV"));
    ...
    protected void afterExecute() {
        ...
        RString zipFilePath = new RString(Path.combinePath(manager.getEucOutputDirectry(), new RString("DBU060701.zip")).toString());
