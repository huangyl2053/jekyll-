 ...
 *
 */
public class JigyoHokokuDataTorokuProcess extends BatchProcessBase<JigyoHokokuDataRelateEntity> {
    ...
    protected void initialize() {
        mapper = getMapper(IJigyoJokyoHokokuShiryoNempoSakuseiItiMapper.class);
