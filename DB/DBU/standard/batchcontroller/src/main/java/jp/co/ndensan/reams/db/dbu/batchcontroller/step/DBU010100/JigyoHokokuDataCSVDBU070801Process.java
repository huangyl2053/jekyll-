 ...
 */
public class JigyoHokokuDataCSVDBU070801Process extends BatchProcessBase<JigyoHokokuDataCsvRelateEntity> {
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(MYBATIS_SELECT_ID, processParameter.toJigyoHokokuDataCSVMybitisParamter(ShukeiNo.現役並み所得者.getコード()));
    }

    @Override
    protected void createWriter() {
        eucFilePath = Path.combinePath(processParameter.getCsvFilePath(), new RString("DBU070801.CSV"));
