...
/**
 * 介護事業状況報告月報・一般状況（様式1-5）_新様式 のインターフェースクラスです。
 *
 * @reamsid_L DBU-5540-060 dangjingjing
 */
public interface IJigyohokokuCompYoshiki153Editor extends IReportEditor<JigyohokokuCompYoshiki153ReportSource> {
