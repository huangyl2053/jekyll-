...
/**
 *事業状況報告年報（様式１・２　市町村特別給付）Editorのインターフェースクラスです。
 * 
 * @reamsid_L DBU-5610-050 yaoyahui
 */
public interface IJigyohokokuNenpoYoshiki28Editor extends IReportEditor<JigyohokokuNenpoYoshiki28ReportSource> {
