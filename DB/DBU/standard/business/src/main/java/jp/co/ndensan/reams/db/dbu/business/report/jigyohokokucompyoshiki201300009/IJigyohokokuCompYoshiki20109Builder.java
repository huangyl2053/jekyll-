...
/**
 * 介護事業状況報告年報（様式2-3）のBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBU-5600-220 wangrenze
 */
public interface IJigyohokokuCompYoshiki20109Builder extends IReportBuilder<JigyohokokuCompYoshiki20109ReportSource> {
}
