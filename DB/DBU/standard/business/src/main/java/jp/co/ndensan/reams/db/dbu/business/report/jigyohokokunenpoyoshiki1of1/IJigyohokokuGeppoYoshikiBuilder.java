...
/**
 * 事業状況報告年報（様式１・２　被保険者数） のBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBU-5610-040 sunhaidi
 */
public interface IJigyohokokuGeppoYoshikiBuilder extends IReportBuilder<JigyohokokuNenpoYoshiki1of1ReportSource> {
}
