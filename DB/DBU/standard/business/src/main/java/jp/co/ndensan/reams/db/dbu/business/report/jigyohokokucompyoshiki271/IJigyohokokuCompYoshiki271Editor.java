...
/**
 * 介護事業状況報告月報・保険給付決定状況（様式2-7-1）のEditorインタ—フェ—スです。
 *
 * @reamsid_L DBU-5580-040 wanghuafeng
 */
public interface IJigyohokokuCompYoshiki271Editor extends IReportEditor<JigyohokokuCompYoshiki271ReportSource> {
