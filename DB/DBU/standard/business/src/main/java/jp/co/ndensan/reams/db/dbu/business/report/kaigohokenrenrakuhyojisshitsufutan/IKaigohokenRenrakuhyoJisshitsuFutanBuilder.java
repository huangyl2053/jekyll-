...
/**
 * 介護保険連絡票_実質負担軽減者用のBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBU-1290-060 wangrenze
 */
public interface IKaigohokenRenrakuhyoJisshitsuFutanBuilder extends IReportBuilder<KaigohokenRenrakuhyoJisshitsuFutanReportSource> {
}
