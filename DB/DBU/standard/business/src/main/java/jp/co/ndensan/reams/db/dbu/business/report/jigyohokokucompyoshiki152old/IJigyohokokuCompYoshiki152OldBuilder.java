...
/**
 * 介護事業状況報告月報・一般状況（様式1-5） Builderのインターフェースクラスです。
 *
 * @reamsid_L DBU-5550-040 dangjingjing
 */
public interface IJigyohokokuCompYoshiki152OldBuilder extends IReportBuilder<JigyohokokuCompYoshiki152OldReportSource> {
