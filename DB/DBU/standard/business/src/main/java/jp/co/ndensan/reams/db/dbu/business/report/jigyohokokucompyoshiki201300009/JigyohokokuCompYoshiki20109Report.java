 ...
 */
public class JigyohokokuCompYoshiki20109Report extends Report<JigyohokokuCompYoshiki20109ReportSource> {

    private final JigyohokokuCompYoshiki20109Entity data;
     ...
     */
    public JigyohokokuCompYoshiki20109Report(JigyohokokuCompYoshiki20109Entity data) {
        this.data = data;
    }
     ...
     * インスタンスを生成します。
     *
     * @param entity JigyohokokuCompYoshiki20109Entity
     * @return JigyohokokuCompYoshiki20109Report
     */
    public static JigyohokokuCompYoshiki20109Report createReport(JigyohokokuCompYoshiki20109Entity entity) {
        return new JigyohokokuCompYoshiki20109Report(entity);
    }

    @Override
    public void writeBy(ReportSourceWriter<JigyohokokuCompYoshiki20109ReportSource> reportSourceWriter) {
        for (JigyohokokuCompYoshiki20109BodyData dataBody : getBodyData()) {
            IJigyohokokuCompYoshiki20109Editor editor = new JigyohokokuCompYoshiki20109Editor(data);
            IJigyohokokuCompYoshiki20109Editor bodyEditor = new JigyohokokuCompYoshiki20109BodyEditor(dataBody);
            IJigyohokokuCompYoshiki20109Builder builder = new JigyohokokuCompYoshiki20109Builder(editor, bodyEditor);
            reportSourceWriter.writeLine(builder);
        }
    }

    private List<JigyohokokuCompYoshiki20109BodyData> getBodyData() {
        List<JigyohokokuCompYoshiki20109BodyData> dataBodyList = new ArrayList<>();
        dataBodyList.add(new JigyohokokuCompYoshiki20109BodyData(
    ...
    private List<JigyohokokuCompYoshiki20109BodyData> getBodyData1(List<JigyohokokuCompYoshiki20109BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuCompYoshiki20109BodyData(
    ...
    private List<JigyohokokuCompYoshiki20109BodyData> getBodyData2(List<JigyohokokuCompYoshiki20109BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuCompYoshiki20109BodyData(
    ...
    private List<JigyohokokuCompYoshiki20109BodyData> getBodyData3(List<JigyohokokuCompYoshiki20109BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuCompYoshiki20109BodyData(
