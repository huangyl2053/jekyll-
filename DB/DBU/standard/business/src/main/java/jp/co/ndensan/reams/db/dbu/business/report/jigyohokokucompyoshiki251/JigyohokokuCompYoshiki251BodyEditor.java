...
public class JigyohokokuCompYoshiki251BodyEditor implements IJigyohokokuCompYoshiki251Editor {
    ...
    private JigyohokokuCompYoshiki251ReportSource editSource(JigyohokokuCompYoshiki251ReportSource source) {
        ...
        source.list2_2 = intToRString(entity.get要支援１());
        source.list2_3 = intToRString(entity.get要支援２());
        source.list2_4 = intToRString(entity.get計１());
        source.list2_5 = intToRString(entity.get経過的要介護());
        source.list2_6 = intToRString(entity.get要介護１());
        source.list2_7 = intToRString(entity.get要介護２());
        source.list2_8 = intToRString(entity.get要介護３());
        source.list2_9 = intToRString(entity.get要介護４());
        source.list2_10 = intToRString(entity.get要介護５());
        source.list2_11 = intToRString(entity.get計２());
        source.list2_12 = intToRString(entity.get合計());
