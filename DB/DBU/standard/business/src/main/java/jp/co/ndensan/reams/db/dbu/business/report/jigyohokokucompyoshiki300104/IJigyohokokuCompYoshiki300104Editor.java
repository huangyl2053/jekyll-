...
/**
 * 介護事業状況報告年報（様式1-3）Editorのインターフェースクラスです。
 *
 * @reamsid_L DBU-5600-130 lishengli
 */
public interface IJigyohokokuCompYoshiki300104Editor extends IReportEditor<JigyohokokuCompYoshiki300103ReportSource> {
