...
/**
 * 介護事業状況報告年報（様式2）Editorのインターフェースクラスです。
 *
 * @reamsid_L DBU-5600-190 zhaoran
 */
public interface IJigyohokokuCompYoshikiNenho202Editor extends IReportEditor<JigyohokokuCompYoshikiNenho202ReportSource> {
