 ...
 */
public class JigyohokokuCompYoshikinenho201Report extends Report<JigyohokokuCompYoshikinenho201ReportSource> {

    private final JigyohokokuCompYoshikinenho201Data data;

    /**
     * インスタンスを生成します。
     *
     * @param data JigyohokokuCompYoshikinenho201Data
     */
    public JigyohokokuCompYoshikinenho201Report(JigyohokokuCompYoshikinenho201Data data) {
        this.data = data;
    }
    ...
    public void writeBy(ReportSourceWriter<JigyohokokuCompYoshikinenho201ReportSource> reportSourceWriter) {
        for (JigyohokokuCompYoshikinenho201BodyData dataBody : getBodyData()) {
            ...
            IJigyohokokuCompYoshikinenho201Editor bodyEditor = new JigyohokokuCompYoshikinenho201BodyEditor(dataBody);
            IJigyohokokuCompYoshikinenho201Builder builder = new JigyohokokuCompYoshikinenho201Builder(editor, bodyEditor);
            reportSourceWriter.writeLine(builder);
        }

    }

    private List<JigyohokokuCompYoshikinenho201BodyData> getBodyData() {
        List<JigyohokokuCompYoshikinenho201BodyData> dataBodyList = new ArrayList<>();
        dataBodyList.add(new JigyohokokuCompYoshikinenho201BodyData(
    ...
    private List<JigyohokokuCompYoshikinenho201BodyData> getBodyData1(List<JigyohokokuCompYoshikinenho201BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuCompYoshikinenho201BodyData(
    ...
    private List<JigyohokokuCompYoshikinenho201BodyData> getBodyData2(List<JigyohokokuCompYoshikinenho201BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuCompYoshikinenho201BodyData(
    ...
    private List<JigyohokokuCompYoshikinenho201BodyData> getBodyData3(List<JigyohokokuCompYoshikinenho201BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuCompYoshikinenho201BodyData(
