...
/**
 * 介護事業状況報告年報（様式1-2）のReportです。
 *
 * @reamsid_L DBU-5600-120 lishengli
 */
public class JigyohokokuCompYoshiki300103Report extends Report<JigyohokokuCompYoshiki300103ReportSource> {
     ...
     */
    public JigyohokokuCompYoshiki300103Report(JigyohokokuCompYoshiki300103Data data) {
        this.data = data;
    }
    ...
    public void writeBy(ReportSourceWriter<JigyohokokuCompYoshiki300103ReportSource> reportSourceWriter) {
        for (JigyohokokuCompYoshiki12Change dataBody : getBodyData()) {
            IJigyohokokuCompYoshiki300103Editor editor = new JigyohokokuCompYoshiki300103Editor(data);
            IJigyohokokuCompYoshiki300103Editor bodyEditor = new JigyohokokuCompYoshiki300103BodyEditor(dataBody);
            IJigyohokokuCompYoshiki300103Builder builder = new JigyohokokuCompYoshiki300103Builder(editor, bodyEditor);
