...
/**
 * 介護事業状況報告月報・一般状況（様式1-5）_新様式 Builderのインターフェースクラスです。
 *
 * @reamsid_L DBU-5540-050 dangjingjing
 */
public interface IJigyohokokuCompYoshiki152Builder extends IReportBuilder<JigyohokokuCompYoshiki152ReportSource> {
