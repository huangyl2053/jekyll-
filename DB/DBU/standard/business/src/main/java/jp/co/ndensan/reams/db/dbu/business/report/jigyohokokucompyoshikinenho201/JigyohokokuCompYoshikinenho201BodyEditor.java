 ...
 */
public class JigyohokokuCompYoshikinenho201BodyEditor implements IJigyohokokuCompYoshikinenho201Editor {

    private final JigyohokokuCompYoshikinenho201BodyData item;

    /**
     * インスタンスを生成します。
     *
     * @param item JigyohokokuCompYoshikinenho201BodyData
     */
    protected JigyohokokuCompYoshikinenho201BodyEditor(JigyohokokuCompYoshikinenho201BodyData item) {
        this.item = item;
    }
