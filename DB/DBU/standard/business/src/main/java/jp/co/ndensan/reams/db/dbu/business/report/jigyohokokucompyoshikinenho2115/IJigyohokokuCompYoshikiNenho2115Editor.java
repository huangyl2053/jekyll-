...
/**
 * 介護事業状況報告年報（様式2-4）Editorのインターフェースクラスです。
 *
 * @reamsid_L DBU-5600-240 zhaoran
 */
public interface IJigyohokokuCompYoshikiNenho2115Editor extends IReportEditor<JigyohokokuCompYoshikiNenho2115ReportSource> {
