 ...
 */
public class JigyohokokuCompYoshiki25Report extends Report<JigyohokokuCompYoshikiReportSource> {
    ...
    private List<JigyohokokuGeppoYoshiki25BodyData> getBodyData() {
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki25BodyData(data.get件数_要支援1_1(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki25BodyData(
