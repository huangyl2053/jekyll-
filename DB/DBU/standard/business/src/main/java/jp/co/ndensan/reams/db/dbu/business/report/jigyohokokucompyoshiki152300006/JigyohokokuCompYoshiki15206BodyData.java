...
public class JigyohokokuCompYoshiki15206BodyData {
     ...
     * @param listList1_4 経過的要介護
     * @param listList1_5 要介護１
     * @param listList1_6 要介護２
     * @param listList1_7 要介護３
     * @param listList1_8 要介護4
     * @param listList1_9 要介護５
     * @param listList1_10 要介護計
     * @param listList1_11 合計
     *
     * @param listList2_1 要支援１
     * @param listList2_2 要支援２
     * @param listList2_3 要支援計
     * @param listList2_4 経過的要介護
     * @param listList2_5 要介護１
     * @param listList2_6 要介護２
     * @param listList2_7 要介護３
     * @param listList2_8 要介護４
     * @param listList2_9 要介護５
     * @param listList2_10 その他
     * @param listList2_11 要介護計
     * @param listList2_12 合計
     */
    public JigyohokokuCompYoshiki15206BodyData(
            RString listList1_1,
            RString listList1_2,
            RString listList1_3,
            RString listList1_4,
