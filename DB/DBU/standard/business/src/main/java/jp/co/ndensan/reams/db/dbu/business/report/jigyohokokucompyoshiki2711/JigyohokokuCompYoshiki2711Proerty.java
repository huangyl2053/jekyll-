...
/**
 * 介護事業状況報告年報（様式2-7）のProertyです。
 *
 * @reamsid_L DBU-5600-280 guoqilin
 */
public class JigyohokokuCompYoshiki2711Proerty extends ReportPropertyBase<JigyohokokuCompYoshiki2711ReportSource> {

    /**
     * コンストラクタです。
     */
    public JigyohokokuCompYoshiki2711Proerty() {
