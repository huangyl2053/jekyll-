 ...
 */
public class JigyohokokuCompYoshiki202Editor implements IJigyohokokuCompYoshiki202Editor {
    ...
    private final JigyohokokuCompYoshiki202Data item;

    /**
     * インスタンスを生成します。
     *
     * @param item JigyohokokuCompYoshiki202Data
     */
    protected JigyohokokuCompYoshiki202Editor(JigyohokokuCompYoshiki202Data item) {
        this.item = item;
    }
    ...
    private JigyohokokuCompYoshiki202ReportSource editSource(JigyohokokuCompYoshiki202ReportSource source) {
        ...
        source.sakuseinichiji = get作成日時(printdate).toRString();
