...
/**
 *
 * 介護事業状況報告月報（様式2-6）のReportです。
 *
 * @reamsid_L DBU-5600-270 guoqilin
 */
public class JigyohokokuCompYoshiki26Report extends Report<JigyohokokuCompYoshikiReportSource> {

    private final JigyohokokuCompYoshiki26 data;
    ...
    @Override
    public void writeBy(ReportSourceWriter<JigyohokokuCompYoshikiReportSource> writer) {
        for (JigyohokokuGeppoYoshiki26BodyData dataBody : getBodyData()) {
            IJigyohokokuCompYoshiki26Editor editor = new JigyohokokuCompYoshiki26Editor(data);
            IJigyohokokuCompYoshiki26Editor bodyEditor = new JigyohokokuCompYoshiki26BodyEditor(dataBody);
            IJigyohokokuCompYoshiki26Builder builder = new JigyohokokuCompYoshiki26Builder(editor, bodyEditor);
            writer.writeLine(builder);
        }
    }

    private List<JigyohokokuGeppoYoshiki26BodyData> getBodyData() {
        List<JigyohokokuGeppoYoshiki26BodyData> dataBodyList = new ArrayList<>();
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(data.get件数_要支援1_1(),
                data.get件数_要支援2_1(), data.get件数_要支援計_1(), data.get件数_非該当_1(),
                ...
                data.get給付費_要支援1_1(), data.get給付費_要支援2_1(), data.get給付費_要支援計_1(), data.get給付費_非該当_1(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_2(), data.get件数_要支援2_2(), data.get件数_要支援計_2(), data.get件数_非該当_2(),
                ...
                data.get給付費_要支援1_2(), data.get給付費_要支援2_2(), data.get給付費_要支援計_2(), data.get給付費_非該当_2(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_3(), data.get件数_要支援2_3(), data.get件数_要支援計_3(), data.get件数_非該当_3(),
                ...
                data.get給付費_要支援1_3(), data.get給付費_要支援2_3(), data.get給付費_要支援計_3(), data.get給付費_非該当_3(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                ...
                data.get件数_要支援計_4(), data.get件数_非該当_4(), data.get件数_経過的要介護_4(),
                ...
                data.get給付費_要支援1_4(), data.get給付費_要支援2_4(), data.get給付費_要支援計_4(),
                data.get給付費_非該当_4(), data.get給付費_経過的要介護_4(), data.get給付費_要介護1_4(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                ...
                data.get件数_非該当_5(), data.get件数_経過的要介護_5(), data.get件数_要介護1_5(),
                data.get件数_要介護2_5(), data.get件数_要介護3_5(), data.get件数_要介護4_5(), data.get件数_要介護5_5(),
                data.get件数_要介護計_5(), data.get件数_合計_5(), data.get給付費_要支援1_5(), data.get給付費_要支援2_5(),
                data.get給付費_要支援計_5(), data.get給付費_非該当_5(), data.get給付費_経過的要介護_5(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_6(), data.get件数_要支援2_6(), data.get件数_要支援計_6(), data.get件数_非該当_6(),
                ...
                data.get給付費_要支援1_6(), data.get給付費_要支援2_6(), data.get給付費_要支援計_6(), data.get給付費_非該当_6(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_7(), data.get件数_要支援2_7(), data.get件数_要支援計_7(),
                data.get件数_非該当_7(), data.get件数_経過的要介護_7(), data.get件数_要介護1_7(),
                data.get件数_要介護2_7(), data.get件数_要介護3_7(), data.get件数_要介護4_7(), data.get件数_要介護5_7(),
                data.get件数_要介護計_7(), data.get件数_合計_7(), data.get給付費_要支援1_7(), data.get給付費_要支援2_7(),
                data.get給付費_要支援計_7(), data.get給付費_非該当_7(), data.get給付費_経過的要介護_7(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_8(), data.get件数_要支援2_8(), data.get件数_要支援計_8(), data.get件数_非該当_8(),
                ...
                data.get給付費_要支援1_8(), data.get給付費_要支援2_8(), data.get給付費_要支援計_8(), data.get給付費_非該当_8(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_9(), data.get件数_要支援2_9(), data.get件数_要支援計_9(), data.get件数_非該当_9(),
                ...
                data.get給付費_要支援1_9(), data.get給付費_要支援2_9(), data.get給付費_要支援計_9(), data.get給付費_非該当_9(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_10(), data.get件数_要支援2_10(), data.get件数_要支援計_10(), data.get件数_非該当_10(),
                ...
                data.get給付費_要支援1_10(), data.get給付費_要支援2_10(), data.get給付費_要支援計_10(), data.get給付費_非該当_10(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_11(), data.get件数_要支援2_11(), data.get件数_要支援計_11(), data.get件数_非該当_11(),
                ...
                data.get給付費_要支援1_11(), data.get給付費_要支援2_11(), data.get給付費_要支援計_11(), data.get給付費_非該当_11(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_12(), data.get件数_要支援2_12(), data.get件数_要支援計_12(), data.get件数_非該当_12(),
                ...
                data.get給付費_要支援1_12(), data.get給付費_要支援2_12(), data.get給付費_要支援計_12(), data.get給付費_非該当_12(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_13(), data.get件数_要支援2_13(), data.get件数_要支援計_13(), data.get件数_非該当_13(),
                ...
                data.get給付費_要支援1_13(), data.get給付費_要支援2_13(), data.get給付費_要支援計_13(), data.get給付費_非該当_13(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_14(), data.get件数_要支援2_14(), data.get件数_要支援計_14(), data.get件数_非該当_14(),
                ...
                data.get給付費_要支援1_14(), data.get給付費_要支援2_14(), data.get給付費_要支援計_14(), data.get給付費_非該当_14(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_15(), data.get件数_要支援2_15(), data.get件数_要支援計_15(), data.get件数_非該当_15(),
                ...
                data.get給付費_要支援1_15(), data.get給付費_要支援2_15(), data.get給付費_要支援計_15(),
                data.get給付費_非該当_15(), data.get給付費_経過的要介護_15(), data.get給付費_要介護1_15(),
                data.get給付費_要介護2_15(), data.get給付費_要介護3_15(), data.get給付費_要介護4_15(), data.get給付費_要介護5_15(),
                data.get給付費_要介護計_15(), data.get給付費_合計_15()));
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_16(), data.get件数_要支援2_16(), data.get件数_要支援計_16(), data.get件数_非該当_16(),
                ...
                data.get給付費_要支援1_16(), data.get給付費_要支援2_16(), data.get給付費_要支援計_16(), data.get給付費_非該当_16(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(
                data.get件数_要支援1_17(), data.get件数_要支援2_17(), data.get件数_要支援計_17(), data.get件数_非該当_17(),
                ...
                data.get給付費_要支援1_17(), data.get給付費_要支援2_17(), data.get給付費_要支援計_17(), data.get給付費_非該当_17(),
