 ...
 */
public class JigyohokokuCompYoshiki26Report extends Report<JigyohokokuCompYoshiki26ReportSource> {
    ...
    @Override
    public void writeBy(ReportSourceWriter<JigyohokokuCompYoshiki26ReportSource> writer) {
    ...
    private List<JigyohokokuGeppoYoshiki26BodyData> getBodyData() {
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(empty, data.get件数_要支援1_1(),
                data.get件数_要支援2_1(), data.get件数_要支援計_1(),
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(empty,
        ...
        dataBodyList.add(new JigyohokokuGeppoYoshiki26BodyData(empty,
                data.get件数_要支援1_5(), data.get件数_要支援2_5(), data.get件数_要支援計_5(), data.get件数_経過的要介護_5(),
                data.get件数_要介護1_5(), data.get件数_要介護2_5(), data.get件数_要介護3_5(), data.get件数_要介護4_5(),
                data.get件数_要介護5_5(), data.get件数_要介護計_5(), data.get件数_合計_5(),
