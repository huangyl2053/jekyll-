...
/**
 * 介護事業状況報告年報・一般状況（様式1-5）のEditorのインターフェースクラスです。
 *
 * @reamsid_L DBU-5600-160 wangrenze
 */
public interface IJigyohokokuCompYoshiki15206Editor extends IReportEditor<JigyohokokuCompYoshiki15206ReportSource> {
