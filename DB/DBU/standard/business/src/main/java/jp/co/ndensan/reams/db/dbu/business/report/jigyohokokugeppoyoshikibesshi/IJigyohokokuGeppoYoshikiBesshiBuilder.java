...
/**
 * 介護事業状況報告月報・一般状況（別紙） Builderのインターフェースクラスです。
 *
 * @reamsid_L DBU-5530-090 dangjingjing
 */
public interface IJigyohokokuGeppoYoshikiBesshiBuilder extends IReportBuilder<JigyohokokuGeppoYoshikiBesshiReportSource> {
