...
/**
 * 介護事業状況報告年報・一般状況（様式1-5）のBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBU-5600-170 wangrenze
 */
public interface IJigyohokokuCompYoshiki15307Builder extends IReportBuilder<JigyohokokuCompYoshiki15307ReportSource> {
}
