...
import jp.co.ndensan.reams.db.dbu.entity.db.relate.jigyohokokucompyoshikinenno2111.JigyohokokuCompYoshikinenho2111Data;
...
/**
 * 介護事業状況報告年報（様式2-2）のReportです。
 *
 * @reamsid_L DBU-5600-200 zhaoran
 */
public class JigyohokokuCompYoshikinenho2111Report extends Report<JigyohokokuCompYoshikinenho2111ReportSource> {

    private final JigyohokokuCompYoshikinenho2111Data data;

    /**
     * インスタンスを生成します。
     *
     * @param data JigyohokokuCompYoshikinenho2111Data
     */
    public JigyohokokuCompYoshikinenho2111Report(JigyohokokuCompYoshikinenho2111Data data) {
        this.data = data;
    }

    @Override
    public void writeBy(ReportSourceWriter<JigyohokokuCompYoshikinenho2111ReportSource> reportSourceWriter) {
        for (JigyohokokuCompYoshikinenho2111BodyData dataBody : getBodyData()) {
            IJigyohokokuCompYoshikinenho2111Editor editor = new JigyohokokuCompYoshikinenho2111Editor(data);
            IJigyohokokuCompYoshikinenho2111Editor bodyEditor = new JigyohokokuCompYoshikinenho2111BodyEditor(dataBody);
            IJigyohokokuCompYoshikinenho2111Builder builder = new JigyohokokuCompYoshikinenho2111Builder(editor, bodyEditor);
            reportSourceWriter.writeLine(builder);
        }

    }

    private List<JigyohokokuCompYoshikinenho2111BodyData> getBodyData() {
        List<JigyohokokuCompYoshikinenho2111BodyData> dataBodyList = new ArrayList<>();
        dataBodyList.add(new JigyohokokuCompYoshikinenho2111BodyData(
    ...
    private List<JigyohokokuCompYoshikinenho2111BodyData> getBodyData1(List<JigyohokokuCompYoshikinenho2111BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuCompYoshikinenho2111BodyData(
    ...
    private List<JigyohokokuCompYoshikinenho2111BodyData> getBodyData2(List<JigyohokokuCompYoshikinenho2111BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuCompYoshikinenho2111BodyData(
    ...
    private List<JigyohokokuCompYoshikinenho2111BodyData> getBodyData3(List<JigyohokokuCompYoshikinenho2111BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuCompYoshikinenho2111BodyData(
