...
/**
 * 介護事業状況報告年報（様式2-3）のEditorのインターフェースクラスです。
 *
 * @reamsid_L DBU-5600-230 wangrenze
 */
public interface IJigyohokokuCompYoshiki20210Editor extends IReportEditor<JigyohokokuCompYoshiki20210ReportSource> {
