...
import jp.co.ndensan.reams.db.dbu.entity.db.relate.jigyohokokugeppoyoshiki212016.JigyohokokuGeppoYoshiki212016Data;
 ...
 */
public class JigyohokokuGeppoYoshiki212016Report extends Report<JigyohokokuGeppoYoshiki212016ReportSource> {

    private final JigyohokokuGeppoYoshiki212016Data data;

    /**
     * インスタンスを生成します。
     *
     * @param data JigyohokokuGeppoYoshiki212016Data
     */
    public JigyohokokuGeppoYoshiki212016Report(JigyohokokuGeppoYoshiki212016Data data) {
        this.data = data;
    }

    @Override
    public void writeBy(ReportSourceWriter<JigyohokokuGeppoYoshiki212016ReportSource> reportSourceWriter) {
        for (JigyohokokuGeppoYoshiki212016BodyData dataBody : getBodyData()) {
            IJigyohokokuGeppoYoshiki212016Editor editor = new JigyohokokuGeppoYoshiki212016Editor(data);
            IJigyohokokuGeppoYoshiki212016Editor bodyEditor = new JigyohokokuGeppoYoshiki212016BodyEditor(dataBody);
            IJigyohokokuGeppoYoshiki212016Builder builder = new JigyohokokuGeppoYoshiki212016Builder(editor, bodyEditor);
            reportSourceWriter.writeLine(builder);
        }

    }

    private List<JigyohokokuGeppoYoshiki212016BodyData> getBodyData() {
        List<JigyohokokuGeppoYoshiki212016BodyData> dataBodyList = new ArrayList<>();
        dataBodyList.add(new JigyohokokuGeppoYoshiki212016BodyData(
    ...
    private List<JigyohokokuGeppoYoshiki212016BodyData> getBodyData1(List<JigyohokokuGeppoYoshiki212016BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuGeppoYoshiki212016BodyData(
    ...
    private List<JigyohokokuGeppoYoshiki212016BodyData> getBodyData2(List<JigyohokokuGeppoYoshiki212016BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuGeppoYoshiki212016BodyData(
    ...
    private List<JigyohokokuGeppoYoshiki212016BodyData> getBodyData3(List<JigyohokokuGeppoYoshiki212016BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuGeppoYoshiki212016BodyData(
