...
/**
 * 介護事業状況報告年報（様式1-2）Builderのインターフェースクラスです。
 *
 * @reamsid_L DBU-5600-120 lishengli
 */
public interface IJigyohokokuCompYoshiki300103Builder extends IReportBuilder<JigyohokokuCompYoshiki300103ReportSource> {
}
