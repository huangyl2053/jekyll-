...
/**
 * 介護事業状況報告年報（様式1-5）Builderのインターフェースクラスです。
 *
 * @reamsid_L DBU-5600-150 lishengli
 */
public interface IJigyohokokuCompYoshiki151300106Builder extends IReportBuilder<JigyohokokuCompYoshiki151300106ReportSource> {
