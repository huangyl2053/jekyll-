...
/**
 * 事業報告月報様式_04のReportのクラスです。
 *
 * @reamsid_L DBU-5560-080 wanghuafeng
 */
public class JigyohokokuGeppoYoshiki2220161Report extends Report<JigyohokokuGeppoYoshiki2220161ReportSource> {
    ...
    @Override
    public void writeBy(ReportSourceWriter<JigyohokokuGeppoYoshiki2220161ReportSource> reportSourceWriter) {
    ...
    private List<JigyohokokuCompResultEntity> get縦番号2(RString 縦番号, RString 横番号, Decimal 集計結果) {
        if (十八行目.equals(縦番号)) {
            list = get横番号(横番号, INDEX_18, Decimal.ZERO);
