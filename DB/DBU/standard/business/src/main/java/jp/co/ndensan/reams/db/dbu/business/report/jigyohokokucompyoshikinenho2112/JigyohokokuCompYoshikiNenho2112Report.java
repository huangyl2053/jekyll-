...
import jp.co.ndensan.reams.db.dbu.entity.db.relate.jigyohokokucompyoshikinenno2112.JigyohokokuCompYoshikiNenho2112Data;
 ...
 */
public class JigyohokokuCompYoshikiNenho2112Report extends Report<JigyohokokuCompYoshikiNenho2112ReportSource> {

    private final JigyohokokuCompYoshikiNenho2112Data data;

    /**
     * インスタンスを生成します。
     *
     * @param data JigyohokokuCompYoshikiNenho2112Data
     */
    public JigyohokokuCompYoshikiNenho2112Report(JigyohokokuCompYoshikiNenho2112Data data) {
        this.data = data;
    }

    @Override

    public void writeBy(ReportSourceWriter<JigyohokokuCompYoshikiNenho2112ReportSource> reportSourceWriter) {
        for (JigyohokokuCompYoshikiNenho2112BodyData dataBody : getBodyData()) {
            IJigyohokokuCompYoshikiNenho2112Editor editor = new JigyohokokuCompYoshikiNenho2112Editor(data);
            IJigyohokokuCompYoshikiNenho2112Editor bodyEditor = new JigyohokokuCompYoshikiNenho2112BodyEditor(dataBody);
            IJigyohokokuCompYoshikiNenho2112Builder builder = new JigyohokokuCompYoshikiNenho2112Builder(editor, bodyEditor);
            reportSourceWriter.writeLine(builder);
        }

    }

    private List<JigyohokokuCompYoshikiNenho2112BodyData> getBodyData() {
        List<JigyohokokuCompYoshikiNenho2112BodyData> dataBodyList = new ArrayList<>();
        dataBodyList.add(new JigyohokokuCompYoshikiNenho2112BodyData(
    ...
    private List<JigyohokokuCompYoshikiNenho2112BodyData> getBodyData1(List<JigyohokokuCompYoshikiNenho2112BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuCompYoshikiNenho2112BodyData(
    ...
    private List<JigyohokokuCompYoshikiNenho2112BodyData> getBodyData2(List<JigyohokokuCompYoshikiNenho2112BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuCompYoshikiNenho2112BodyData(
    ...
    private List<JigyohokokuCompYoshikiNenho2112BodyData> getBodyData3(List<JigyohokokuCompYoshikiNenho2112BodyData> dataBodyList) {
        dataBodyList.add(new JigyohokokuCompYoshikiNenho2112BodyData(
