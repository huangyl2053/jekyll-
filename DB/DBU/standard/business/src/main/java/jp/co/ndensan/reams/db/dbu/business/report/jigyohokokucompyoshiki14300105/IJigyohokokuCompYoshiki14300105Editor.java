...
/**
 * 介護事業状況報告年報（様式1-4）のインターフェースクラスです。
 *
 * @reamsid_L DBU-5600-140 lishengli
 */
public interface IJigyohokokuCompYoshiki14300105Editor extends IReportEditor<JigyohokokuCompYoshiki14300105ReportSource> {
