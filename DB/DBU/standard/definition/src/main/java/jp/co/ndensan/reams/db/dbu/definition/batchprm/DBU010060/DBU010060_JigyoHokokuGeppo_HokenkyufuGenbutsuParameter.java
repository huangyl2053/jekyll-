 ...
 */
package jp.co.ndensan.reams.db.dbu.definition.batchprm.DBU010060;

import java.util.List;
import jp.co.ndensan.reams.db.dbu.definition.processprm.hokenkyufugassanshinsaym.JigyoHokokuGeppoHokenkyufuGenbutsuProcessParameter;
...
/**
 * 保険給付決定状況【現物分・償還分合算（審査年月）】のパラメータクラスです。
 *
...
public class DBU010060_JigyoHokokuGeppo_HokenkyufuGenbutsuParameter extends BatchParameterBase {
     ...
     * コンストラクタです。
     */
    public DBU010060_JigyoHokokuGeppo_HokenkyufuGenbutsuParameter() {
    }

    /**
     * Process用のパラメータを生成します。
     *
     * @return JigyoHokokuGeppoHokenkyufuGenbutsuProcessParameter
     */
    public JigyoHokokuGeppoHokenkyufuGenbutsuProcessParameter toProcessParamter() {
        return new JigyoHokokuGeppoHokenkyufuGenbutsuProcessParameter(
                プリントコントロール区分,
                集計年月,
                報告年月,
                作成日付,
