 ...
 */
package jp.co.ndensan.reams.db.dbu.definition.mybatisprm.hokenkyufugassanshinsaym;
...
/**
 * 保険給付決定状況【現物分・償還分合算（審査年月）】のMybatisパラメータクラスです。
 *
 * @reamsid_L DBU-5560-030 xuyannan
 */
@SuppressWarnings("PMD.UnusedPrivateField")
@Getter
public class JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter implements IMyBatisParameter {
     ...
     *
     */
    private JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter(
     ...
     */
    public static JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter create根拠CSV情報作成Paramter(
            RString 集計年月) {
        return new JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter(
                RString.EMPTY,
                RString.EMPTY,
                集計年月,
                RString.EMPTY,
     ...
     * @return JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter
     */
    public static JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter create処理日付管理マスタへ登録Paramter(
            RString 集計年月,
            RString 市町村コード,
            RString 構成市町村区分,
            RString 旧市町村区分,
     ...
     * @return JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter
     */
    public static JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter create事業状況報告取得Paramter(
     ...
     * @return JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter
     */
    public static JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter delete事業状況報告取得Paramter(RString 集計年月) {
        return new JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter(
                RString.EMPTY,
     ...
     * @return JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter
     */
    public static JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter get集計結果値のParameter(
            RString 市町村コード,
            RString 旧町村コード,
            RString 構成市町村区分,
            RString 旧市町村区分,
     ...
     * @return JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter
     */
    public static JigyoHokokuGeppoHokenkyufuGenbutsuMybatisParameter set事業報告統計データのParameter(
            RString 市町村コード,
            RString 旧町村コード,
            RString 構成市町村区分,
            RString 旧市町村区分,
