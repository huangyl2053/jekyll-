 ...
 */
package jp.co.ndensan.reams.db.dbu.definition.processprm.jigyohokokunenpoippangenbutsu;
...
@Getter
public class JigyoHokokuNenpoIppanGenbutsuProcessParamter implements IBatchProcessParameter {
     ...
     */
    public JigyoHokokuNenpoIppanGenbutsuProcessParamter(RString プリントコントロール区分,
            RString 報告年度,
            RString 報告開始年月,
            RString 報告終了年月,
            RString 集計年度,
     ...
     */
    public JigyoHokokuNenpoIppanGenbutsuMybatisParamter toDeleteDataMybitisParamter() {
        return JigyoHokokuNenpoIppanGenbutsuMybatisParamter.createDeleteDataParam(集計年度,
     ...
     * @return JigyoHokokuNenpoIppanGenbutsuMybatisParamter
     */
    public JigyoHokokuNenpoIppanGenbutsuMybatisParamter toSelectDataMybitisParamter() {
        return JigyoHokokuNenpoIppanGenbutsuMybatisParamter.createSelectDataParam(集計開始年月,
     ...
     * @return JigyoHokokuNenpoIppanGenbutsuMybatisParamter
     */
    public JigyoHokokuNenpoIppanGenbutsuMybatisParamter toInsertDataMybitisParamter() {
        return JigyoHokokuNenpoIppanGenbutsuMybatisParamter.createInsertDataParam(市町村コード,
     ...
     */
    public JigyoHokokuNenpoIppanGenbutsuMybatisParamter toSelectReportDataMybitisParamter() {
        return JigyoHokokuNenpoIppanGenbutsuMybatisParamter.createSelectReportDataParam(市町村コード,
