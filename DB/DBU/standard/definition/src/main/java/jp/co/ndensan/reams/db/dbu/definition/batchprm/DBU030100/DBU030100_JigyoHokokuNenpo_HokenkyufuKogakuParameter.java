 ...
 */
package jp.co.ndensan.reams.db.dbu.definition.batchprm.DBU030100;
...
/**
 * 事業状況報告資料（年報）作成　保険給付決定状況(高額分)のバッチパラメータクラスです。
 *
...
public class DBU030100_JigyoHokokuNenpo_HokenkyufuKogakuParameter extends BatchParameterBase {
     ...
     *
     * @return JigyoHokokuNenpoHokenkyufuKogakuProcessParamter
     */
    public JigyoHokokuNenpoHokenkyufuKogakuProcessParamter toProcessParamter() {
        return new JigyoHokokuNenpoHokenkyufuKogakuProcessParamter(
                プリントコントロール区分,
                報告年度,
                報告開始年月,
                報告終了年月,
