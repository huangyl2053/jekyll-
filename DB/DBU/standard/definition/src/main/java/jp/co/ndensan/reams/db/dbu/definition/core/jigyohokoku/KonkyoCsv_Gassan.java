...
public enum KonkyoCsv_Gassan {
    ...
    /**
     * コード:DBU070801 名称:高額医療合算介護（介護予防）サービス費　ア　現役並み所得者（上位所得者） 略称:定義なし
     */
    現役並み所得者("DBU070801", "高額医療合算介護（介護予防）サービス費　ア　現役並み所得者（上位所得者）"),
    /**
     * コード:DBU070802 名称:高額医療合算介護（介護予防）サービス費　イ　一般 略称:定義なし
     */
    一般("DBU070802", "高額医療合算介護（介護予防）サービス費　イ　一般"),
    /**
     * コード:DBU070803 名称:高額医療合算介護（介護予防）サービス費　ウ　低所得者Ⅱ 略称:定義なし
     */
    低所得者Ⅱ("DBU070803", "高額医療合算介護（介護予防）サービス費　ウ　低所得者Ⅱ"),
    /**
     * コード:DBU070804 名称:高額医療合算介護（介護予防）サービス費　エ　低所得者Ⅰ 略称:定義なし
     */
    低所得者Ⅰ("DBU070804", "高額医療合算介護（介護予防）サービス費　エ　低所得者Ⅰ"),
    /**
     * コード:DBU070805 名称:高額医療合算介護（介護予防）サービス費　オ　合計 略称:定義なし
     */
    合計("DBU070805", "高額医療合算介護（介護予防）サービス費　オ　合計");
