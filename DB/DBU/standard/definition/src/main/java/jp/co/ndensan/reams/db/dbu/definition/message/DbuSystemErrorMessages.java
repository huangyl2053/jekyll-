...
/**
 * DBUのシステムエラーメッセージ定義列挙型です。
 *
 * @author N9606 漢那 憲作
 */
public enum DbuSystemErrorMessages {
     ...
     */
    public RString getReplacedMessage(RString... replacers) {
        ...
        while (true) {
            replaced = new RString(replaced.toString().replaceFirst(Pattern.quote(replacee.toString()), replacers[i++].toString()));
