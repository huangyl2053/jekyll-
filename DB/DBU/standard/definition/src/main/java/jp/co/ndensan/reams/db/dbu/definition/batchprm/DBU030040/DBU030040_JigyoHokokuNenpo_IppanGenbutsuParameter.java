 ...
 */
package jp.co.ndensan.reams.db.dbu.definition.batchprm.DBU030040;
...
/**
 * 事業状況報告資料（年報）作成　一般状況（１２～１４）のバッチパラメータクラスです。
 *
...
public class DBU030040_JigyoHokokuNenpo_IppanGenbutsuParameter extends BatchParameterBase {
     ...
     *
     * @return JigyoHokokuNenpoIppanGenbutsuProcessParamter
     */
    public JigyoHokokuNenpoIppanGenbutsuProcessParamter toProcessParamter() {
        return new JigyoHokokuNenpoIppanGenbutsuProcessParamter(
                プリントコントロール区分,
                報告年度,
                報告開始年月,
                報告終了年月,
