...
import static jp.co.ndensan.reams.db.dbu.entity.db.basic.DbT7021JigyoHokokuTokeiDataEntityGenerator.DEFAULT_報告年;
import static jp.co.ndensan.reams.db.dbu.entity.db.basic.DbT7021JigyoHokokuTokeiDataEntityGenerator.DEFAULT_報告月;
import static jp.co.ndensan.reams.db.dbu.entity.db.basic.DbT7021JigyoHokokuTokeiDataEntityGenerator.DEFAULT_市町村コード;
import static jp.co.ndensan.reams.db.dbu.entity.db.basic.DbT7021JigyoHokokuTokeiDataEntityGenerator.DEFAULT_横番号;
import static jp.co.ndensan.reams.db.dbu.entity.db.basic.DbT7021JigyoHokokuTokeiDataEntityGenerator.DEFAULT_統計対象区分;
import static jp.co.ndensan.reams.db.dbu.entity.db.basic.DbT7021JigyoHokokuTokeiDataEntityGenerator.DEFAULT_縦番号;
import static jp.co.ndensan.reams.db.dbu.entity.db.basic.DbT7021JigyoHokokuTokeiDataEntityGenerator.DEFAULT_表番号;
import static jp.co.ndensan.reams.db.dbu.entity.db.basic.DbT7021JigyoHokokuTokeiDataEntityGenerator.DEFAULT_集計単位;
import static jp.co.ndensan.reams.db.dbu.entity.db.basic.DbT7021JigyoHokokuTokeiDataEntityGenerator.DEFAULT_集計対象年;
import static jp.co.ndensan.reams.db.dbu.entity.db.basic.DbT7021JigyoHokokuTokeiDataEntityGenerator.DEFAULT_集計対象月;
import static jp.co.ndensan.reams.db.dbu.entity.db.basic.DbT7021JigyoHokokuTokeiDataEntityGenerator.DEFAULT_集計番号;
