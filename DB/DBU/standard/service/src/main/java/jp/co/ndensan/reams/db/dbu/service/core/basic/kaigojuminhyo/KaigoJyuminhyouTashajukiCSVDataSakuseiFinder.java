...
public class KaigoJyuminhyouTashajukiCSVDataSakuseiFinder {
    ...
    public static void main(String[] args) {
        KaigoJyuminhyouTashajukiDataEntity tashajukientity = new KaigoJyuminhyouTashajukiDataEntity();
        tashajukientity.set被保険者番号(new HihokenshaNo(" "));
        tashajukientity.set異動日(new FlexibleDate(""));
        tashajukientity.set枝番(new RString(""));
        tashajukientity.set異動事由コード(new RString(""));
        tashajukientity.set市町村コード(new LasdecCode(""));
        tashajukientity.set識別コード(new ShikibetsuCode(""));
        tashajukientity.set資格取得事由コード(new RString(""));
        tashajukientity.set資格取得年月日(new FlexibleDate(""));
        tashajukientity.set資格取得届出年月日(new FlexibleDate(""));
        tashajukientity.set第1号資格取得年月日(new FlexibleDate(""));
        tashajukientity.set被保険者区分コード(new RString(""));
        tashajukientity.set資格変更事由コード(new RString(""));
        tashajukientity.set資格喪失年月日(new FlexibleDate(""));
        tashajukientity.set資格喪失届出年月日(new FlexibleDate(""));
        tashajukientity.set資格変更事由コード(new RString(""));
        tashajukientity.set資格変更年月日(new FlexibleDate(""));
        tashajukientity.set資格変更届出年月日(new FlexibleDate(""));
        tashajukientity.set住所地特例適用事由コード(new RString(""));
        tashajukientity.set適用年月日(new FlexibleDate(""));
        tashajukientity.set適用届出年月日(new FlexibleDate(""));
        tashajukientity.set住所地特例解除事由コード(new RString(""));
        tashajukientity.set解除年月日(new FlexibleDate(""));
        tashajukientity.set解除届出年月日(new FlexibleDate(""));
        tashajukientity.set住所地特例フラグ(new RString(""));
        tashajukientity.set広域内住所地特例フラグ(new RString(""));
        tashajukientity.set広住特措置元市町村コード(new LasdecCode(""));
        tashajukientity.set旧市町村コード(new LasdecCode(""));
        tashajukientity.set論理削除フラグ(false);
        tashajukientity.set挿入日時(RDateTime.now());
        tashajukientity.set更新日時(RDateTime.now());
        tashajukientity.set受給者市町村コード(new LasdecCode(""));
        tashajukientity.set受給者被保険者番号(new HihokenshaNo(""));
        tashajukientity.set受給者履歴番号(new RString(""));
        tashajukientity.set受給者枝番(new RString(""));
        tashajukientity.set受給者申請書管理番号(new ShinseishoKanriNo(""));
        tashajukientity.set受給者申請状況区分(new RString(""));
        tashajukientity.set受給者支所コード(new RString(""));
        tashajukientity.set受給者直近フラグ(false);
        tashajukientity.set受給者識別コード(new ShikibetsuCode(""));
        tashajukientity.set受給者受給申請事由(new Code(""));
        tashajukientity.set受給者申請理由(new RString(""));
        tashajukientity.set受給者届出者申請者関係コード(new Code(""));
        tashajukientity.set受給者届出者本人との関係(new RString(""));
        tashajukientity.set受給者受給申請年月日(new FlexibleDate(""));
        tashajukientity.set受給者２号特定疾病コード(new Code(""));
        tashajukientity.set受給者審査会依頼年月日(new FlexibleDate(""));
        tashajukientity.set受給者要介護認定状態区分コード(new Code(""));
        tashajukientity.set受給者認定有効期間開始年月日(new FlexibleDate(""));
        tashajukientity.set受給者認定有効期間終了年月日(new FlexibleDate(""));
        tashajukientity.set受給者認定年月日(new FlexibleDate(""));
        tashajukientity.set受給者指定サービス種類01(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類02(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類03(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類04(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類05(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類06(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類07(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類08(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類09(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類10(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類11(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類12(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類13(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類14(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類15(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類16(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類17(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類18(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類19(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類20(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類21(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類22(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類23(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類24(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類25(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類26(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類27(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類28(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類29(new ServiceShuruiCode(""));
        tashajukientity.set受給者指定サービス種類30(new ServiceShuruiCode(""));
        tashajukientity.set受給者喪失年月日(new FlexibleDate(""));
        tashajukientity.set受給者直近異動年月日(new FlexibleDate(""));
        tashajukientity.set受給者直近異動事由コード(new Code(""));
        tashajukientity.set受給者有効無効区分(new Code(""));
        tashajukientity.set受給者データ区分(new Code(""));
        tashajukientity.set受給者同一連番(new RString(""));
        tashajukientity.set受給者異動理由(new RString(""));
        tashajukientity.set受給者申請書区分(new Code(""));
        tashajukientity.set受給者削除事由コード(new Code(""));
        tashajukientity.set受給者要支援者認定申請区分(false);
        tashajukientity.set受給者支給限度単位数(new Decimal(12));
        tashajukientity.set受給者支給限度有効開始年月日(new FlexibleDate(""));
        tashajukientity.set受給者支給限度有効終了年月日(new FlexibleDate(""));
        tashajukientity.set受給者短期入所支給限度日数(5);
        tashajukientity.set受給者短期入所支給限度開始年月日(new FlexibleDate(""));
        tashajukientity.set受給者短期入所支給限度終了年月日(new FlexibleDate(""));
        tashajukientity.set受給者当初認定有効開始年月日(new FlexibleDate(""));
        tashajukientity.set受給者当初認定有効終了年月日(new FlexibleDate(""));
        tashajukientity.set受給者受給資格証明書発行年月日１(new FlexibleDate(""));
        tashajukientity.set受給者受給資格証明書発行年月日２(new FlexibleDate(""));
        tashajukientity.set受給者診断命令書発行年月日(new FlexibleDate(""));
        tashajukientity.set受給者２号申請受理通知書発行年月日(new FlexibleDate(""));
        tashajukientity.set受給者認定結果通知書発行年月日(new FlexibleDate(""));
        tashajukientity.set受給者区分変更通知書発行年月日(new FlexibleDate(""));
        tashajukientity.set受給者サービス変更通知書発行年月日(new FlexibleDate(""));
        tashajukientity.set受給者認定却下通知書発行年月日(new FlexibleDate(""));
        tashajukientity.set受給者認定取消通知書発行年月日(new FlexibleDate(""));
        tashajukientity.set受給者資格取得前申請フラグ(false);
        tashajukientity.set受給者旧措置者フラグ(false);
        tashajukientity.set受給者論理削除フラグ(false);
        tashajukientity.set受給者挿入日時(RDateTime.now());
        tashajukientity.set受給者更新日時(RDateTime.now());

        RString codeHenkanKubun = new RString("1");

        List<KaigoJyuminhyouTashajukiDataEntity> tashajyukiList = new ArrayList<>();
        tashajyukiList.add(tashajukientity);
        KaigoJyuminhyouTashajukiCSVDataSakuseiFinder finder = new KaigoJyuminhyouTashajukiCSVDataSakuseiFinder();
        finder.getKaigoJyuminhyouTashajukiHachiCSVData(tashajyukiList, codeHenkanKubun);
