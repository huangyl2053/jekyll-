...
import jp.co.ndensan.reams.db.dbu.persistence.relate.DbT1001HihokenshaDaichoRelateDac;
import jp.co.ndensan.reams.db.dbu.persistence.relate.DbT1002TekiyoJogaishaRelateDac;
import jp.co.ndensan.reams.db.dbu.persistence.relate.DbT1003TashichosonJushochiTokureiRelateDac;
...
public class SikakuIdoCheckManager {
    ...
    private final DbT1001HihokenshaDaichoRelateDac hihokenshaDaiRelateDac;
    private final DbT1002TekiyoJogaishaRelateDac tekiyoJogaishaRelateDac;
    private final DbT1003TashichosonJushochiTokureiRelateDac tashichosonJushochiRelateDac;
    ...
    public SikakuIdoCheckManager() {
        hihokenshaDaiRelateDac = InstanceProvider.create(DbT1001HihokenshaDaichoRelateDac.class);
        tekiyoJogaishaRelateDac = InstanceProvider.create(DbT1002TekiyoJogaishaRelateDac.class);
        tashichosonJushochiRelateDac = InstanceProvider.create(DbT1003TashichosonJushochiTokureiRelateDac.class);
    }
