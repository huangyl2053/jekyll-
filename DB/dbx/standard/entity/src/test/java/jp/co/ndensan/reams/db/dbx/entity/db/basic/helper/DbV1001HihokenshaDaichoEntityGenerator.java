...
/**
 * 被保険者台帳管理Aliveエンティティのテスト用インスタンスを作成する補助クラスです。
 */
public final class DbV1001HihokenshaDaichoEntityGenerator {

    public static final HihokenshaNo DEFAULT_被保険者番号 = new HihokenshaNo("0123400001");
     ...
     */
    private DbV1001HihokenshaDaichoEntityGenerator() {
    }

    public static DbV1001HihokenshaDaichoEntity createDbV1001HihokenshaDaichoEntity() {
        DbV1001HihokenshaDaichoEntity entity = new DbV1001HihokenshaDaichoEntity();
