...
public final class DbT7060KaigoJigyoshaEntityGenerator {
    ...
    public static final ShiteiKijunGaitoJigyoshoKubun DEFAULT_指定基準該当等事業所区分 = new ShiteiKijunGaitoJigyoshoKubun(new RString("1"));
    public static final RString DEFAULT_所在市町村 = new RString("電算");
    public static final RString DEFAULT_サービス実施地域 = new RString("三島");
    public static final HojinsShubetsu DEFAULT_法人等種別 = new HojinsShubetsu(new RString("01"));
