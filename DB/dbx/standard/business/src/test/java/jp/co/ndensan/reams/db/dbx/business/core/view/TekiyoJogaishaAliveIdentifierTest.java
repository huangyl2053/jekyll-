...
/**
 * {@link TekiyoJogaishaAliveIdentifier}のテストクラスです。
 */
@RunWith(Enclosed.class)
public class TekiyoJogaishaAliveIdentifierTest extends DbxTestBase {
...
//TODO 主キー値を適切な値に置換してください
    ...
    public static class シリアライズテスト extends DbxTestBase {
        ...
        public void シリアライズできる() {
            TekiyoJogaishaAliveIdentifier sut = new TekiyoJogaishaAliveIdentifier(主キー名1, 主キー名2, edaNo);
