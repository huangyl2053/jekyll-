...
/**
 * 特定施設入居者生活介護_短期利用型以外_養護老人ホームを表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 特定施設入居者生活介護_短期利用型以外_養護老人ホーム
 * @bizDomain
 ...
 * @reference
 */
public class TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_YogoRojinHome
    ...
    /**
     * 特定施設入居者生活介護_短期利用型以外_養護老人ホームを表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.特定施設入居者生活介護_短期利用型以外_養護老人ホーム.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 特定施設入居者生活介護_短期利用型以外_養護老人ホーム
     */
    public TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_YogoRojinHome(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 特定施設入居者生活介護_短期利用型以外_養護老人ホームを表す文字列
     */
    public TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_YogoRojinHome(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_YogoRojinHome other
                = (TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_YogoRojinHome) obj;
