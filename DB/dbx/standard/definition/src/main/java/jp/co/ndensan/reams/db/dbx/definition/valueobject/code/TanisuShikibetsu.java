 ...
 * @reference
 */
public class TanisuShikibetsu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.単位数識別.getCodeShubetsu();
    }
     ...
     * @param code 単位数識別
     */
    public TanisuShikibetsu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 単位数識別を表す文字列
     */
    public TanisuShikibetsu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TanisuShikibetsu other = (TanisuShikibetsu) obj;
