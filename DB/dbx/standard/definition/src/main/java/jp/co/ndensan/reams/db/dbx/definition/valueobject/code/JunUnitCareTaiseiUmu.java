 ...
 * @reference
 */
public class JunUnitCareTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.準ユニットケア体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 準ユニットケア体制の有無
     */
    public JunUnitCareTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 準ユニットケア体制の有無を表す文字列
     */
    public JunUnitCareTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JunUnitCareTaiseiUmu other = (JunUnitCareTaiseiUmu) obj;
