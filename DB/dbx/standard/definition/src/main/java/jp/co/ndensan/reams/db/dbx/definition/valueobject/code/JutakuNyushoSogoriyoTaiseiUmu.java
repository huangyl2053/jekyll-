...
/**
 * 在宅_入所相互利用体制の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 在宅_入所相互利用体制有無
 * @bizDomain
 ...
 * @reference
 */
public class JutakuNyushoSogoriyoTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.在宅_入所相互利用体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 在宅_入所相互利用体制の有無
     */
    public JutakuNyushoSogoriyoTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 在宅_入所相互利用体制の有無を表す文字列
     */
    public JutakuNyushoSogoriyoTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JutakuNyushoSogoriyoTaiseiUmu other = (JutakuNyushoSogoriyoTaiseiUmu) obj;
