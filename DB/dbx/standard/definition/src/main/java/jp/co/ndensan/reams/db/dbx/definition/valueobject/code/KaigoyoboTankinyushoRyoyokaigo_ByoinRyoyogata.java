...
/**
 * 介護予防短期入所療養介護_病院療養型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防短期入所療養介護_病院療養型
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboTankinyushoRyoyokaigo_ByoinRyoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防短期入所療養介護_病院療養型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防短期入所療養介護_病院療養型
     */
    public KaigoyoboTankinyushoRyoyokaigo_ByoinRyoyogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防短期入所療養介護_病院療養型を表す文字列
     */
    public KaigoyoboTankinyushoRyoyokaigo_ByoinRyoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTankinyushoRyoyokaigo_ByoinRyoyogata other = (KaigoyoboTankinyushoRyoyokaigo_ByoinRyoyogata) obj;
