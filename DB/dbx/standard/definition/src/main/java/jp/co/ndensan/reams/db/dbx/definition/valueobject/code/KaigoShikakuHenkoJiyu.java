 ...
 * @reference
 */
public class KaigoShikakuHenkoJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護資格変更事由.getCodeShubetsu();
    }
     ...
     * @param code 介護資格変更事由
     */
    public KaigoShikakuHenkoJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護資格変更事由を表す文字列
     */
    public KaigoShikakuHenkoJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoShikakuHenkoJiyu other = (KaigoShikakuHenkoJiyu) obj;
