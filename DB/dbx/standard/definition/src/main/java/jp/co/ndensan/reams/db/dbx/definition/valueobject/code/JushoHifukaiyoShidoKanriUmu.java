 ...
 * @reference
 */
public class JushoHifukaiyoShidoKanriUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.重症皮膚潰瘍指導管理の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 重症皮膚潰瘍指導管理の有無
     */
    public JushoHifukaiyoShidoKanriUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 重症皮膚潰瘍指導管理の有無を表す文字列
     */
    public JushoHifukaiyoShidoKanriUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JushoHifukaiyoShidoKanriUmu other = (JushoHifukaiyoShidoKanriUmu) obj;
