...
/**
 * 療養環境基準_平成19年3月以前を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 療養環境基準_平成19年3月以前
 * @bizDomain
 ...
 * @reference
 */
public class RyoyokankyoKijun_BeforeH19_3 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.療養環境基準_平成19年3月以前.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 療養環境基準_平成19年3月以前
     */
    public RyoyokankyoKijun_BeforeH19_3(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 療養環境基準_平成19年3月以前を表す文字列
     */
    public RyoyokankyoKijun_BeforeH19_3(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RyoyokankyoKijun_BeforeH19_3 other = (RyoyokankyoKijun_BeforeH19_3) obj;
