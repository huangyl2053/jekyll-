...
/**
 * ターミナルケア体制_看取り介護体制_の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName ターミナルケア体制_看取り介護体制_の有無
 * @bizDomain
 ...
 * @reference
 */
public class TerminalCareTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * ターミナルケア体制_看取り介護体制_の有無を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.ターミナルケア体制_看取り介護体制_の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code ターミナルケア体制_看取り介護体制_の有無
     */
    public TerminalCareTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code ターミナルケア体制_看取り介護体制_の有無を表す文字列
     */
    public TerminalCareTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TerminalCareTaiseiUmu other = (TerminalCareTaiseiUmu) obj;
