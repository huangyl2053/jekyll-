 ...
 * @reference
 */
public class KangoTaiseiKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.看護体制加算.getCodeShubetsu();
    }
     ...
     * @param code 看護体制加算
     */
    public KangoTaiseiKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 看護体制加算を表す文字列
     */
    public KangoTaiseiKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KangoTaiseiKasan other = (KangoTaiseiKasan) obj;
