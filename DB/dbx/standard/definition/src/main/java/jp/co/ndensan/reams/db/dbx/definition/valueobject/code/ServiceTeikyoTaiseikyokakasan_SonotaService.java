...
/**
 * サービス提供体制強化加算_その他サービスを表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName サービス提供体制強化加算_その他サービス
 * @bizDomain
 ...
 * @reference
 */
public class ServiceTeikyoTaiseikyokakasan_SonotaService implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * サービス提供体制強化加算_その他サービスを表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.サービス提供体制強化加算_その他サービス.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code サービス提供体制強化加算_その他サービス
     */
    public ServiceTeikyoTaiseikyokakasan_SonotaService(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code サービス提供体制強化加算_その他サービスを表す文字列
     */
    public ServiceTeikyoTaiseikyokakasan_SonotaService(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ServiceTeikyoTaiseikyokakasan_SonotaService other = (ServiceTeikyoTaiseikyokakasan_SonotaService) obj;
