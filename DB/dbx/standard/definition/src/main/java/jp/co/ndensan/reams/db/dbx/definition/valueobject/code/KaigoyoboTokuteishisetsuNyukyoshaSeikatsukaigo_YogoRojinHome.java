...
/**
 * 介護予防特定施設入居者生活介護_養護老人ホームを表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防特定施設入居者生活介護_養護老人ホーム
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboTokuteishisetsuNyukyoshaSeikatsukaigo_YogoRojinHome implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 介護予防特定施設入居者生活介護_養護老人ホームを表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防特定施設入居者生活介護_養護老人ホーム.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防特定施設入居者生活介護_養護老人ホーム
     */
    public KaigoyoboTokuteishisetsuNyukyoshaSeikatsukaigo_YogoRojinHome(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防特定施設入居者生活介護_養護老人ホームを表す文字列
     */
    public KaigoyoboTokuteishisetsuNyukyoshaSeikatsukaigo_YogoRojinHome(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTokuteishisetsuNyukyoshaSeikatsukaigo_YogoRojinHome other = (KaigoyoboTokuteishisetsuNyukyoshaSeikatsukaigo_YogoRojinHome) obj;
