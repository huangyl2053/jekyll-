 ...
 * @reference
 */
public class KaigoKofushoShurui implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護交付証種類.getCodeShubetsu();
    }
     ...
     * @param code 介護交付証種類
     */
    public KaigoKofushoShurui(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護交付証種類を表す文字列
     */
    public KaigoKofushoShurui(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoKofushoShurui other = (KaigoKofushoShurui) obj;
