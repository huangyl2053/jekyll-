...
/**
 * 介護予防小規模多機能型居宅介護を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防小規模多機能型居宅介護
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboShokiboTakinogataKyotakukaigo implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防小規模多機能型居宅介護.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防小規模多機能型居宅介護
     */
    public KaigoyoboShokiboTakinogataKyotakukaigo(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防小規模多機能型居宅介護を表す文字列
     */
    public KaigoyoboShokiboTakinogataKyotakukaigo(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboShokiboTakinogataKyotakukaigo other = (KaigoyoboShokiboTakinogataKyotakukaigo) obj;
