 ...
 * @reference
 */
public class NinchishoSemmonCareKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.認知症専門ケア加算.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 認知症専門ケア加算
     */
    public NinchishoSemmonCareKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 認知症専門ケア加算を表す文字列
     */
    public NinchishoSemmonCareKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final NinchishoSemmonCareKasan other = (NinchishoSemmonCareKasan) obj;
