...
/**
 * 個別機能訓練体制の有無_通所介護以外を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 個別機能訓練体制の有無_通所介護以外
 * @bizDomain
 ...
 * @reference
 */
public class KobetsuKinokunrentaiseiUmu_Tsushokaigoigai implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.個別機能訓練体制の有無_通所介護以外.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 個別機能訓練体制の有無_通所介護以外
     */
    public KobetsuKinokunrentaiseiUmu_Tsushokaigoigai(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 個別機能訓練体制の有無_通所介護以外を表す文字列
     */
    public KobetsuKinokunrentaiseiUmu_Tsushokaigoigai(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuKinokunrentaiseiUmu_Tsushokaigoigai other = (KobetsuKinokunrentaiseiUmu_Tsushokaigoigai) obj;
