...
/**
 * 介護老人保健施設_平成17年9月以前を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護老人保健施設_平成17年9月以前
 * @bizDomain
 ...
 * @reference
 */
public class Kaigorojinhokenshisetsu_BeforeH17_9 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護老人保健施設_平成17年9月以前.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護老人保健施設_平成17年9月以前
     */
    public Kaigorojinhokenshisetsu_BeforeH17_9(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護老人保健施設_平成17年9月以前を表す文字列
     */
    public Kaigorojinhokenshisetsu_BeforeH17_9(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Kaigorojinhokenshisetsu_BeforeH17_9 other = (Kaigorojinhokenshisetsu_BeforeH17_9) obj;
