...
public class ShinsakaiIinListTest {
    ...
    public static class get審査会委員のテスト extends DbeTestBase {
        ...
        public void 指定した審査会委員コードに対応した委員が取得できる() {
            ShinsakaiIinCode code = new ShinsakaiIinCode(new RString("00000001"));
            sut = ShinsakaiMockBusinessCreator.create審査会委員List(code.value().toString(), "00000002", "00000003");
        ...
        public void 対応した委員が存在しない場合_IllegalArgumentExceptionが発生する() {
            ShinsakaiIinCode code = new ShinsakaiIinCode(new RString("00000000"));
            sut = ShinsakaiMockBusinessCreator.create審査会委員List("00000001", "00000002", "00000003");
            sut.get審査会委員(code);
        }
    }
    ...
    public static class isEmptyのテスト extends DbeTestBase {
        ...
        public void 空のリストのとき_trueが返る() {
            sut = ShinsakaiMockBusinessCreator.create審査会委員List();
