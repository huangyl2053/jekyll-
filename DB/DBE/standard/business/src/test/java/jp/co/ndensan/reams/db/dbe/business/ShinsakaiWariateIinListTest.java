...
public class ShinsakaiWariateIinListTest {
    ...
    @Test
    public void 審査会開催番号1_審査会開催年月日19990101_審査会委員コードA001を指定したとき_審査会開催番号に1を持つ審査会割当委員が返る() {
        result = sut.get審査会割当委員(開催番号, 開催年月日, 委員コード);
        assertThat(result.get審査会情報().get審査会開催番号(), is(開催番号));
    }

    @Test
    public void 審査会開催番号1_審査会開催年月日19990101_審査会委員コードA001を指定したとき_開催年月日に19990101を持つ審査会割当委員が返る() {
        result = sut.get審査会割当委員(開催番号, 開催年月日, 委員コード);
        assertThat(result.get審査会情報().get審査会開催年月日(), is(開催年月日));
    }
