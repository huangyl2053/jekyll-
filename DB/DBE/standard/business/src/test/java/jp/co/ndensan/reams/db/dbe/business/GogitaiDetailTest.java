...
public class GogitaiDetailTest {

    private static GogitaiDetail sut1;
    ...
    public static class コンストラクタのテスト extends DbeTestBase {
        ...
        public void 必要項目が引数に渡されているとき_インスタンスが生成される() {
            sut1 = new GogitaiDetail(合議体番号_1, 合議体名称_ABC, 有効期間開始年月日_19990101, 有効期間終了年月日_20100101,
                    開始終了予定時刻_0930_1730, 審査会開催場所_A001, 0, 0, 0, null, null);
            assertThat(sut1, is(instanceOf(GogitaiDetail.class)));
        }

        @Test(expected = NullPointerException.class)
        public void 合議体番号にnullが渡されたとき_NullPointerExceptionが発生する() {
            sut1 = new GogitaiDetail(null, 合議体名称_ABC, 有効期間開始年月日_19990101, 有効期間終了年月日_20100101,
        ...
        public void 合議体名称にnullが渡されたとき_NullPointerExceptionが発生する() {
            sut1 = new GogitaiDetail(合議体番号_1, null, 有効期間開始年月日_19990101, 有効期間終了年月日_20100101,
                    開始終了予定時刻_0930_1730, 審査会開催場所_A001, 審査会予定定員_5, 審査会自動割当定員_4,
                    審査会委員定員_6, 精神科医師存在_存在, 合議体ダミー_正規);
        }
        ...
        public void 有効期間開始年月日にnullが渡されたとき_NullPointerExceptionが発生する() {
            sut1 = new GogitaiDetail(合議体番号_1, 合議体名称_ABC, null, 有効期間終了年月日_20100101,
                    開始終了予定時刻_0930_1730, 審査会開催場所_A001, 審査会予定定員_5, 審査会自動割当定員_4,
                    審査会委員定員_6, 精神科医師存在_存在, 合議体ダミー_正規);
        }
        ...
        public void 有効期間終了年月日にnullが渡されたとき_NullPointerExceptionが発生する() {
            sut1 = new GogitaiDetail(合議体番号_1, 合議体名称_ABC, 有効期間開始年月日_19990101, null,
                    開始終了予定時刻_0930_1730, 審査会開催場所_A001, 審査会予定定員_5, 審査会自動割当定員_4,
                    審査会委員定員_6, 精神科医師存在_存在, 合議体ダミー_正規);
        }
    ...
    public static class hashCodeのテスト extends DbeTestBase {
        ...
        public void インスタンスが持つすべての要素が同一であるとき_hashCodeは同値になる() {
            sut1 = new GogitaiDetail(合議体番号_1, 合議体名称_ABC, 有効期間開始年月日_19990101, 有効期間終了年月日_20100101,
                    開始終了予定時刻_0930_1730, 審査会開催場所_A001, 審査会予定定員_5, 審査会自動割当定員_4,
                    審査会委員定員_6, 精神科医師存在_存在, 合議体ダミー_正規);
            sut2 = new GogitaiDetail(合議体番号_1, 合議体名称_ABC, 有効期間開始年月日_19990101, 有効期間終了年月日_20100101,
                    開始終了予定時刻_0930_1730, 審査会開催場所_A001, 審査会予定定員_5, 審査会自動割当定員_4,
                    審査会委員定員_6, 精神科医師存在_存在, 合議体ダミー_正規);
    ...
    public static class equalsのテスト extends DbeTestBase {
        ...
        public void 合議体番号が同値で無い場合_falseを返す() {
            sut2 = new GogitaiDetail(new GogitaiNo(12), 合議体名称_ABC, 有効期間開始年月日_19990101, 有効期間終了年月日_20100101, 開始終了予定時刻_0930_1730, 審査会開催場所_A001,
        ...
        public void 合議体名称が同値で無い場合_falseを返す() {
            sut2 = new GogitaiDetail(合議体番号_1, new RString("EDF"), 有効期間開始年月日_19990101, 有効期間終了年月日_20100101, 開始終了予定時刻_0930_1730, 審査会開催場所_A001,
                    審査会予定定員_5, 審査会自動割当定員_4, 審査会委員定員_6, 精神科医師存在_存在, 合議体ダミー_正規);
            assertThat(sut1.equals(sut2), is(false));
        }
        ...
        public void 有効期間終了年月日が同値で無い場合_falseを返す() {
            sut2 = new GogitaiDetail(合議体番号_1, 合議体名称_ABC, 有効期間開始年月日_19990101, new FlexibleDate("23232323"), 開始終了予定時刻_0930_1730, 審査会開催場所_A001,
                    審査会予定定員_5, 審査会自動割当定員_4, 審査会委員定員_6, 精神科医師存在_存在, 合議体ダミー_正規);
            assertThat(sut1.equals(sut2), is(false));
        }
        ...
        public void 開始予定時刻が同値で無い場合_falseを返す() {
            sut2 = new GogitaiDetail(合議体番号_1, 合議体名称_ABC, 有効期間開始年月日_19990101, 有効期間終了年月日_20100101, new Range<>(new TimeString("0000"), new TimeString("1730")), 審査会開催場所_A001,
                    審査会予定定員_5, 審査会自動割当定員_4, 審査会委員定員_6, 精神科医師存在_存在, 合議体ダミー_正規);
            assertThat(sut1.equals(sut2), is(false));
        }
        ...
        public void 終了予定時刻が同値で無い場合_falseを返す() {
            sut2 = new GogitaiDetail(合議体番号_1, 合議体名称_ABC, 有効期間開始年月日_19990101, 有効期間終了年月日_20100101, new Range<>(new TimeString("0930"), new TimeString("2359")), 審査会開催場所_A001,
                    審査会予定定員_5, 審査会自動割当定員_4, 審査会委員定員_6, 精神科医師存在_存在, 合議体ダミー_正規);
            assertThat(sut1.equals(sut2), is(false));
        }
        ...
        public void 審査会開催場所が同値で無い場合_falseを返す() {
            sut2 = new GogitaiDetail(合議体番号_1, 合議体名称_ABC, 有効期間開始年月日_19990101, 有効期間終了年月日_20100101, 開始終了予定時刻_0930_1730, create審査会開催場所("B001"),
                    審査会予定定員_5, 審査会自動割当定員_4, 審査会委員定員_6, 精神科医師存在_存在, 合議体ダミー_正規);
            assertThat(sut1.equals(sut2), is(false));
        }
        ...
        public void 審査会予定定員が同値で無い場合_falseを返す() {
            sut2 = new GogitaiDetail(合議体番号_1, 合議体名称_ABC, 有効期間開始年月日_19990101, 有効期間終了年月日_20100101, 開始終了予定時刻_0930_1730, 審査会開催場所_A001,
