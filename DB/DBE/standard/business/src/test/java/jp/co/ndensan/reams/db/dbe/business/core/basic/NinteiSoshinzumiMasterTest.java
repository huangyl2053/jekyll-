...
//TODO 主キー名を置換してください
        ...
        public void 主キー名1がnullである場合に_NullPointerExceptionが発生する() {
            sut = new NinteiSoshinzumiMaster(null, 主キー名2);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー名2がnullである場合に_NullPointerExceptionが発生する() {
            sut = new NinteiSoshinzumiMaster(主キー名1, null);
        }

        @Test
        public void 指定したキーが保持するDbT5190NinteiSoshinzumiMasterEntityにセットされている() {
            sut = new NinteiSoshinzumiMaster(主キー名1, 主キー名2);
    ...
    public static class Entityコンストラクタテスト extends DbeTestBase {
        ...
        public void 指定したEntityがnullである場合_NullPointerExceptionとなる() {
            sut = new NinteiSoshinzumiMaster(null);
        }
