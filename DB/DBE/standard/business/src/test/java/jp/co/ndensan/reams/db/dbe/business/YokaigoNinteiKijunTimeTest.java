...
public class YokaigoNinteiKijunTimeTest {
    ...
    public static class コンストラクタのテスト extends DbeTestBase {
        ...
        private Map<YokaigoNinteiKijunTimeItem, Integer> 要介護認定等基準時間;
        private int 基準時間_合計;
        private int 食事基準時間;
        private int 排泄基準時間;
        private int 移動基準時間;
        ...
        public void setUp() {
            ...
            要介護認定等基準時間 = new EnumMap<>(YokaigoNinteiKijunTimeItem.class);
