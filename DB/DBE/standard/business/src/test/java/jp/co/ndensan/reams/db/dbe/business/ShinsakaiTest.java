...
public class ShinsakaiTest {
    ...
    public static class コンストラクタのテスト extends DbeTestBase {
        ...
        public void 割当委員Listにnullが渡されたとき_NullPointerExceptionが発生する() {
            sut = new Shinsakai(ShinsakaiMockBusinessCreator.create審査会情報(1, "19990101"), null);
        }

        @Test(expected = IllegalArgumentException.class)
        public void 審査会情報と_割当委員がそれぞれ持つ審査会情報が一致しないとき_IllegalArgumentExceptionが発生する() {
            sut = new Shinsakai(ShinsakaiMockBusinessCreator.create審査会情報(2, "19990101"), createList(3));
        }

        @Test
        public void 必要な条件を満たしたとき_インスタンスが生成される() {
            sut = new Shinsakai(ShinsakaiMockBusinessCreator.create審査会情報(1, "19990101"), createList(3));
