...
/**
 * 帳票設計_DBE621003_認定調査報酬支払通知書のIChosaHoshuShiharaiBodyEditorです。
 *
 * @reamsid_L DBE-1980-041 xuyongchao
 */
public interface IChosaHoshuShiharaiBodyEditor extends IReportEditor<ChosaHoshuShiharaiReportSource> {
