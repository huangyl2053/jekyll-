...
/**
 *
 * 認定調査督促対象者一覧表ヘッダエディターのインターフェースクラスです。
 */
interface INinteiChosaTokusokuTaishoshaIchiranhyoEditor extends IReportEditor<NinteiChosaTokusokuTaishoshaIchiranhyoReportSource> {
}
