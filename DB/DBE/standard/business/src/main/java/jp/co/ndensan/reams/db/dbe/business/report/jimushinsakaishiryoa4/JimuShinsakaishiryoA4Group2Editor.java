...
public class JimuShinsakaishiryoA4Group2Editor implements IJimuShinsakaishiryoA4Editor {
     ...
     * @param index int
     */
    protected JimuShinsakaishiryoA4Group2Editor(IchijihanteikekkahyoA4Entity item, int index) {
        this.item = item;
        this.index = index;
    }
    ...
    private JimuShinsakaishiryoA4ReportSource editSource1(JimuShinsakaishiryoA4ReportSource source) {
