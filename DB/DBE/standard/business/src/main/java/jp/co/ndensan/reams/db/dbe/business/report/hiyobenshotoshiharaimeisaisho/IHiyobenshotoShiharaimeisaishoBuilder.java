...
/**
 * 介護認定審査委員報酬・費用弁償等支払明細書Builderのインターフェースクラスです。
 *
 * @reamsid_L DBE-1980-048 suguangjun
 */
interface IHiyobenshotoShiharaimeisaishoBuilder extends IReportBuilder<HiyobenshotoShiharaimeisaishoReportSource> {
}
