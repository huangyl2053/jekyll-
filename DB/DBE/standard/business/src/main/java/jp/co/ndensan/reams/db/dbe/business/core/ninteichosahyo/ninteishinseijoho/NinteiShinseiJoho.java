...
public class NinteiShinseiJoho
    ...
    public NinteiShinseiJoho(NinteiShinseiJohoEntity entity) {
        ...
        for (NinteichosaIraiJohoEntity niniEntity : entity.get認定調査依頼情報Entity()) {
            ninteichosaIraiJohoList.add(new NinteichosaIraiJoho(niniEntity));
        }
    ...
    /**
     * 要介護認定申請情報が保持する認定調査依頼情報に対して、指定の識別子に該当する認定調査依頼情報を返します。
     *
     * @param id 認定調査依頼情報の識別子
     * @return 認定調査依頼情報
     * @throws IllegalStateException 指定の識別子に該当する認定調査依頼情報がない場合
     */
    ...
    /**
     * 要介護認定申請情報が保持する認定調査依頼情報をリストで返します。
     *
     * @return 認定調査依頼情報リスト
     */
