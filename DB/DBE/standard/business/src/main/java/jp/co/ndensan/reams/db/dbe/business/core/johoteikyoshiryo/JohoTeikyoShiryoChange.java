...
public final class JohoTeikyoShiryoChange {
    ...
    public static JohoTeikyoShiryo createBusiness(YouKaiGoNinTeiKekTesuChiRelateEntity entity,
        ...
        JohoTeikyoShiryo headItem = new JohoTeikyoShiryo(RDate.getNowDate(),
                ...
                RString.isNullOrEmpty(entity.getNijiHanteiNinteiYukoKaishiYMD()) ? null : new RDate(entity.getNijiHanteiNinteiYukoKaishiYMD().toString()),
                RString.isNullOrEmpty(entity.getNijiHanteiNinteiYukoShuryoYMD()) ? null : new RDate(entity.getNijiHanteiNinteiYukoShuryoYMD().toString()),
