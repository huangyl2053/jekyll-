...
/**
 * 要介護認定情報提供一式その他資料情報Builderクラスです。
 *
 * @author N3212 竹内 和紀
 */
public class JohoTeikyoIsshikiSonoTashiryoBuilder implements IJohoTeikyoIsshikiBuilder {
     ...
     */
    public JohoTeikyoIsshikiSonoTashiryoBuilder(SonoTashiryoEntity item) {
        this.item = item;
    }
     ...
     * 帳票ソースをビルドします。
     *
     * @return {@link YokaigoNinteiJohoTeikyoIsshikiReportSource}
     */
    @Override
    public YokaigoNinteiJohoTeikyoIsshikiReportSource build() {
        ...
        source.layout = JohoTeikyoIsshiki.Sonotashiryo.getFormGroupIndex();
        return source;
    }
}
