 ...
 * @author N3212 竹内 和紀
 */
public final class NinteiChosaJohohyo42EntityEditor {
    ...
    private NinteiChosaJohohyo42EntityEditor() {
    }
    ...
    public static NinteiChosaJohohyoEntity edit(YokaigoNinteiJohoTeikyoEntity yokaigoNinteiJohoTeikyoEntity,
        ...
        ninteiChosaJohohyoEntity.set麻痺拘縮2_リスト_42(get麻痺拘縮2_リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set移動リスト_42(get移動リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set複雑動作リスト_42(get複雑動作リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set特別介護リスト_42(get特別介護リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set身の回りリスト_42(get身の回りリスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set意思疎通リスト_42(get意思疎通リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set問題行動リスト_42(get問題行動リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set特別な医療リスト_42(get特別な医療リスト(認定調査票調査項目List));
        return ninteiChosaJohohyoEntity;
    }
