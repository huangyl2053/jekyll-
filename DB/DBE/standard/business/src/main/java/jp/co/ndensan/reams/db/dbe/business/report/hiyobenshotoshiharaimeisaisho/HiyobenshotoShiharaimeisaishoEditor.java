...
public class HiyobenshotoShiharaimeisaishoEditor implements IHiyobenshotoShiharaimeisaishoEditor {
    ...
    public HiyobenshotoShiharaimeisaishoReportSource edit(HiyobenshotoShiharaimeisaishoReportSource source) {
        ...
        source.hoshuhi1 = kinngakuFormat(item.get報酬1());
        source.hiyobensho1 = kinngakuFormat(item.get費用弁償1());
        source.shokeiKingaku1 = kinngakuFormat(item.get小計1());
        source.gensenShotokuzei1 = kinngakuFormat(item.get所得税1());
        source.sashihikishikyugaku1 = kinngakuFormat(item.get差引支払額1());
        ...
        source.shussekiKaisu1 = kinngakuFormat(item.get審査会出席回数1());
        source.shichosonName1 = item.get市町村名称1();
        source.shinsainName2 = item.get審査会委員氏名2();
        source.hoshuhi2 = kinngakuFormat(item.get報酬2());
        source.hiyobensho2 = kinngakuFormat(item.get費用弁償2());
        source.shokeiKingaku2 = kinngakuFormat(item.get小計2());
        source.gensenShotokuzei2 = kinngakuFormat(item.get所得税2());
        source.sashihikishikyugaku2 = kinngakuFormat(item.get差引支払額2());
        ...
        source.shussekiKaisu2 = kinngakuFormat(item.get審査会出席回数2());
        source.shichosonName2 = item.get市町村名称2();
        source.shinsainName3 = item.get審査会委員氏名3();
        source.hoshuhi3 = kinngakuFormat(item.get報酬3());
        source.hiyobensho3 = kinngakuFormat(item.get費用弁償3());
        source.shokeiKingaku3 = kinngakuFormat(item.get小計3());
        source.gensenShotokuzei3 = kinngakuFormat(item.get所得税3());
        source.sashihikishikyugaku3 = kinngakuFormat(item.get差引支払額3());
        ...
        source.shussekiKaisu3 = kinngakuFormat(item.get審査会出席回数3());
        source.shichosonName3 = item.get市町村名称3();
        source.shinsainName4 = item.get審査会委員氏名4();
        source.hoshuhi4 = kinngakuFormat(item.get報酬4());
        source.hiyobensho4 = kinngakuFormat(item.get費用弁償4());
        source.shokeiKingaku4 = kinngakuFormat(item.get小計4());
        source.gensenShotokuzei4 = kinngakuFormat(item.get所得税4());
        source.sashihikishikyugaku4 = kinngakuFormat(item.get差引支払額4());
        ...
        source.shussekiKaisu4 = kinngakuFormat(item.get審査会出席回数4());
