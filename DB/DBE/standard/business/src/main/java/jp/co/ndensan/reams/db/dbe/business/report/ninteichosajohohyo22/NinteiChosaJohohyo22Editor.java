 ...
 */
public class NinteiChosaJohohyo22Editor implements INinteiChosaJohohyo22Editor {
     ...
     * @param index Index
     */
    protected NinteiChosaJohohyo22Editor(NinteiChosaJohohyoEntity entity, int index) {
        this.entity = entity;
        this.index = index;
    }
     ...
     */
    @Override
    public NinteiChosaJohohyo22ReportSource edit(NinteiChosaJohohyo22ReportSource source) {
        editSource_22(source);
        return source;
    }

    private NinteiChosaJohohyo22ReportSource editSource_22(NinteiChosaJohohyo22ReportSource source) {
