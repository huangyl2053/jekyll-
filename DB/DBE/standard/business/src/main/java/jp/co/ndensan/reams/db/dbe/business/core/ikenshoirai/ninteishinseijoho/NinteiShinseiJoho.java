...
public class NinteiShinseiJoho extends ParentModelBase<NinteiShinseiJohoIdentifier, DbT5101NinteiShinseiJohoEntity, NinteiShinseiJoho> implements Serializable {
    ...
    public NinteiShinseiJoho(NinteiShinseiJohoRelateEntity entity) {
        ...
        for (DbT5301ShujiiIkenshoIraiJohoEntity dbT5301Entity : entity.get主治医意見書作成依頼情報Entity()) {
            shujiiIkenshoIraiJohoList.add(new ShujiiIkenshoIraiJoho(dbT5301Entity));
        }
    ...
    public NinteiShinseiJoho deleted() {
        ...
        return new NinteiShinseiJoho(
                deletedEntity, id, shujiiIkenshoIraiJoho.deleted());
    }

    @Override
    public boolean hasChanged() {
        return hasChangedEntity() || shujiiIkenshoIraiJoho.hasAnyChanged();
    }
    ...
    public NinteiShinseiJoho modifiedModel() {
        ...
        return new NinteiShinseiJoho(
                modifiedEntity, id, shujiiIkenshoIraiJoho);
    }
     ...
     *
     * @return List<ShujiiIkenshoIraiJoho>
     */
    ...
    protected Object writeReplace() {
        return new _SerializationProxy(entity, id, shujiiIkenshoIraiJoho);
    }
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private Object readResolve() {
            return new NinteiShinseiJoho(this.entity, this.id, this.shujiiIkenshoIraiJoho);
        }
    }
    ...
    public NinteiShinseiJohoBuilder createBuilderForEdit() {
        return new NinteiShinseiJohoBuilder(entity, id, shujiiIkenshoIraiJoho);
    }
