...
public class NinteichosahyoShisetsuRiyo extends ModelBase<NinteichosahyoShisetsuRiyoIdentifier, DbT5210NinteichosahyoShisetsuRiyoEntity, NinteichosahyoShisetsuRiyo> implements Serializable {
    ...
    public NinteichosahyoShisetsuRiyo(DbT5210NinteichosahyoShisetsuRiyoEntity entity) {
        this.entity = requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage("認定調査票（概況調査）施設利用"));
        this.id = new NinteichosahyoShisetsuRiyoIdentifier(
    ...
    /**
     * 認定調査票（概況調査）施設利用の識別子{@link NinteichosahyoShisetsuRiyoIdentifier}を返します。
     *
     * @return 認定調査票（概況調査）施設利用の識別子{@link NinteichosahyoShisetsuRiyoIdentifier}
     */
    @Override
    ...
    public NinteichosahyoShisetsuRiyo modifiedModel() {
        DbT5210NinteichosahyoShisetsuRiyoEntity modifiedEntity = entity.clone();
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private static final long serialVersionUID = -20924314167132981L;
        private final DbT5210NinteichosahyoShisetsuRiyoEntity entity;
        private final NinteichosahyoShisetsuRiyoIdentifier id;
     ...
     * 編集後のインスタンスを取得する場合は{@link NinteichosahyoShisetsuRiyoBuilder.createBuilderForEdit#build()}を使用してください。
     *
     * @return Builder
     */
    ...
    public boolean equals(Object obj) {
        ...
        final NinteichosahyoShisetsuRiyo other = (NinteichosahyoShisetsuRiyo) obj;
