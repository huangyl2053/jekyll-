...
/**
 * 要介護認定情報提供一式認定調査票情報42のReportです。
 *
 * @author N3212 竹内 和紀
 */
public class JohoTeikyoIsshikiNinteiChosaJohohyo42Report extends Report<YokaigoNinteiJohoTeikyoIsshikiReportSource> {
     ...
     */
    public JohoTeikyoIsshikiNinteiChosaJohohyo42Report(NinteiChosaJohohyoEntity entity) {
        this.entity = entity;
    }
    ...
    public void writeBy(ReportSourceWriter<YokaigoNinteiJohoTeikyoIsshikiReportSource> reportSourceWriter) {
        ...
        for (int i = 0; i < maxCount; i++) {
            IJohoTeikyoIsshikiBuilder builder = new JohoTeikyoIsshikiNinteiChosaJohohyo42Builder(entity, i);
