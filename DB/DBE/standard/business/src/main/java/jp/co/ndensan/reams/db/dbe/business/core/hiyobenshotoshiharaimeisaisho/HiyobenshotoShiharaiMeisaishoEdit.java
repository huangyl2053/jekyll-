...
public class HiyobenshotoShiharaiMeisaishoEdit {
    ...
    public HiyobenshotoShiharaimeisaisho getHiyobenshotoShiharaiMeisai(HiyobenshotoShiharaimeisaisho meisaisho,
        ...
        Decimal 小計 = new Decimal(entity.getHoshu()).add(entity.getShinsakaiKotsuhi()).roundUpTo(0);
        Decimal 差引支払額 = 小計.subtract(entity.getShinsakaiKojoZeigaku()).roundUpTo(0);
        if (index % INDEX_4 == 1) {
            ...
            meisaisho.set小計1(decimalToRString(小計));
            ...
            meisaisho.set小計2(decimalToRString(小計));
            ...
            meisaisho.set小計3(decimalToRString(小計));
            ...
            meisaisho.set小計4(decimalToRString(小計));
