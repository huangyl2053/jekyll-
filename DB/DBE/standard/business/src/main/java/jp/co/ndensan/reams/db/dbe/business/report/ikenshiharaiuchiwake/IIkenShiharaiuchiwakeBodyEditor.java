...
/**
 * 帳票設計_DBE622004_主治医意見書作成料支払内訳確認書のIIkenShiharaiuchiwakeBodyEditorです。
 *
 * @reamsid_L DBE-1980-047 xuyongchao
 */
public interface IIkenShiharaiuchiwakeBodyEditor extends IReportEditor<IkenShiharaiuchiwakeReportSource> {
