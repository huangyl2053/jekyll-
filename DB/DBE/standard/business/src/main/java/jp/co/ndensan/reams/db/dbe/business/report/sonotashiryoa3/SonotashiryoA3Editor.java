...
public class SonotashiryoA3Editor implements ISonotashiryoA3Editor {
     ...
     * @param index index
     */
    protected SonotashiryoA3Editor(JimuSonotashiryoBusiness business, int index) {
    ...
    public SonotashiryoA3ReportSource edit(SonotashiryoA3ReportSource source) {
        ...
        source.imgSonotashiryo1 = business.get左のその他資料イメージ(index);
        source.imgSonotashiryo2 = business.get右のその他資料イメージ(index);
