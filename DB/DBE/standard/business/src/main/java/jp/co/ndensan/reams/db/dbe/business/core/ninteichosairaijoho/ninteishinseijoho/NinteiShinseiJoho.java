 ...
 */
package jp.co.ndensan.reams.db.dbe.business.core.ninteichosairaijoho.ninteishinseijoho;
...
public class NinteiShinseiJoho
    ...
    public NinteiShinseiJoho(ShinseishoKanriNo 申請書管理番号) {
        ...
        this.id = new NinteiShinseiJohoIdentifier(申請書管理番号);

        this.ninteichosaIraiJoho = Models.create(new ArrayList<NinteichosaIraiJoho>());
    ...
    public NinteiShinseiJoho(NinteiShinseiJohoRelateEntity entity) {
        ...
        for (DbT5201NinteichosaIraiJohoEntity ninteichosaIraiJohoEntity : entity.get認定調査依頼情報Entity()) {
            ninteichosaIraiJohoList.add(new NinteichosaIraiJoho(ninteichosaIraiJohoEntity));
        }
        this.ninteichosaIraiJoho = Models.create(ninteichosaIraiJohoList);
    ...
    NinteiShinseiJoho(
        ...
        this.entity = entity;
        this.id = id;
        this.ninteichosaIraiJoho = ninteichosaIraiJoho;
     ...
     * 要介護認定申請情報配下の要素である精神手帳任意項目情報の{@link Models#deleteOrRemoveAll() }を実行します。
    ...
    public NinteiShinseiJoho deleted() {
        ...
        return new NinteiShinseiJoho(
                deletedEntity, id, ninteichosaIraiJoho.deleted());
    }

    @Override
    public boolean hasChanged() {

        return hasChangedEntity() || ninteichosaIraiJoho.hasAnyChanged();
    ...
    public NinteiShinseiJoho modifiedModel() {
        ...
        return new NinteiShinseiJoho(
                modifiedEntity, id, ninteichosaIraiJoho);
    }

    /**
     * 要介護認定申請情報が保持する精神手帳任意項目情報に対して、指定の識別子に該当する精神手帳任意項目情報を返します。
     *
     * @param id 精神手帳任意項目情報の識別子
     * @return 精神手帳任意項目情報
     * @throws IllegalStateException 指定の識別子に該当する精神手帳任意項目情報がない場合
     */
    public NinteichosaIraiJoho getNinteichosaIraiJoho(NinteichosaIraiJohoIdentifier id) {
        if (ninteichosaIraiJoho.contains(id)) {
            return ninteichosaIraiJoho.clone().get(id);
        }
        //TODO メッセージの検討
    ...
    /**
     * 要介護認定申請情報が保持する精神手帳任意項目情報をリストで返します。
     *
     * @return 精神手帳任意項目情報リスト
     */
    public List<NinteichosaIraiJoho> getNinteichosaIraiJohoList() {
        return new ArrayList<>(ninteichosaIraiJoho.values());
    ...
    protected Object writeReplace() {
        return new _SerializationProxy(entity, id, ninteichosaIraiJoho);
    }

    private static final class _SerializationProxy implements Serializable {

        private static final long serialVersionUID = 1315750448731743867L;
        ...
        private Object readResolve() {
            return new NinteiShinseiJoho(this.entity, this.id, this.ninteichosaIraiJoho);
        }
    }
    ...
    public NinteiShinseiJohoBuilder createBuilderForEdit() {
        return new NinteiShinseiJohoBuilder(entity, id, ninteichosaIraiJoho);
    }
