...
public class NinteiChosaJohohyo42Builder implements INinteiChosaJohohyo42Builder {
     ...
     * @param index Index
     */
    public NinteiChosaJohohyo42Builder(NinteiChosaJohohyoEntity entity, int index) {
        this.entity = entity;
        this.index = index;
    }
    ...
    public NinteiChosaJohohyo42ReportSource build() {
        NinteiChosaJohohyo42ReportSource source = new NinteiChosaJohohyo42ReportSource();
