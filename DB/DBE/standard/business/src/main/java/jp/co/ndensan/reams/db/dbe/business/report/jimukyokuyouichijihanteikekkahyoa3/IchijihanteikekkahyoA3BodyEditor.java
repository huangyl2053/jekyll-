...
public class IchijihanteikekkahyoA3BodyEditor implements IIchijihanteikekkahyoA3Editor {
    ...
    private IchijihanteikekkahyoA3ReportSource editSource(IchijihanteikekkahyoA3ReportSource source) {
        source.listshujiiikensho1_1 = item.getListshujiiikensho1_1();
        source.listshujiiikensho1_2 = item.getListshujiiikensho1_2();
        source.listshujiiikensho1_3 = item.getListshujiiikensho1_3();
        source.listshujiiikensho1_4 = item.getListshujiiikensho1_4();
