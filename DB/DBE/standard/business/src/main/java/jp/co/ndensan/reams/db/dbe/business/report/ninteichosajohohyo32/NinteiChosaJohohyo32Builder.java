...
public class NinteiChosaJohohyo32Builder implements INinteiChosaJohohyo32Builder {
     ...
     * @param index Index
     */
    public NinteiChosaJohohyo32Builder(NinteiChosaJohohyoEntity entity, int index) {
        this.entity = entity;
        this.index = index;
    }
    ...
    public NinteiChosaJohohyo32ReportSource build() {
        NinteiChosaJohohyo32ReportSource source = new NinteiChosaJohohyo32ReportSource();
