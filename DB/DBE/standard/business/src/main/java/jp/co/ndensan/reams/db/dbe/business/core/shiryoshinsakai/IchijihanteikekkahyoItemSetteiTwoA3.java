...
public class IchijihanteikekkahyoItemSetteiTwoA3 {
    ...
    private final boolean is特記事項符号印字する;

    /**
     * コンストラクタです。
     */
    public IchijihanteikekkahyoItemSetteiTwoA3() {
    ...
    public RString get麻痺特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get麻痺調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
    ...
    public RString get拘縮特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get拘縮調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get寝返特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get寝返調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get起き上特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get起き上調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get座位保持特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get座位保持調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get両足での立位特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get両足での立位調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get歩行特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get歩行調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get立ち上特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get立ち上調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get片足での立位特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get片足での立位調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get洗身特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get洗身調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString getつめ切り特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(getつめ切り調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get視力特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get視力調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get聴力特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get聴力調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get移乗特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get移乗調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get移動特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get移動調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString getえん下特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(getえん下調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get食事摂取特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get食事摂取調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get排尿特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get排尿調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get排便特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get排便調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get口腔清潔特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get口腔清潔調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get洗顔特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get洗顔調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get整髪特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get整髪調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get上衣の着脱特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get上衣の着脱調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString getズボン等の着脱特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(getズボン等の着脱調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get外出頻度特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get外出頻度調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get意思の伝達特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get意思の伝達調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get毎日の日課を理解特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get毎日の日課を理解調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get生年月日特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get生年月日調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get短期記憶特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get短期記憶調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get自分の名前特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get自分の名前調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get今の季節を理解特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get今の季節を理解調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get場所の理解特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get場所の理解調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get徘徊特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get徘徊調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get外出して戻特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get外出して戻調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get被害的特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get被害的調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get作話特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get作話調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get感情が不安定特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get感情が不安定調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get昼夜逆転特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get昼夜逆転調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get同じ話をする特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get同じ話をする調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get大声を出す特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get大声を出す調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get介護に抵抗特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get介護に抵抗調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get落ち着きなし特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get落ち着きなし調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get一人で出たがる特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get一人で出たがる調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get収集癖特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get収集癖調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get物や衣類を壊す特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get物や衣類を壊す調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString getひどい物忘れ特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(getひどい物忘れ調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get独り言独り笑い特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get独り言独り笑い調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get自分勝手特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get自分勝手調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get話がまとまらない特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get話がまとまらない調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get薬の内服特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get薬の内服調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get金銭の管理特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get金銭の管理調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get日常の意思決定特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get日常の意思決定調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get集団への不適応特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get集団への不適応調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get買い物特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get買い物調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get簡単な調理特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get簡単な調理調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get点滴の管理特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get点滴の管理調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get中心静脈栄養特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get中心静脈栄養調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get透析特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get透析調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString getストーマの処置特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(getストーマの処置調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get酸素療法特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get酸素療法調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString getレスピレーター特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(getレスピレーター調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get気管切開の処置特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get気管切開の処置調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get疼痛の看護特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get疼痛の看護調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString get経管栄養特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(get経管栄養調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString getモニター測定特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(getモニター測定調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString getじょくそうの処置特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(getじょくそうの処置調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }
    ...
    public RString getカテーテル特記事項有無(Code 厚労省IF識別コード, List<RString> 認定調査特記事項番号) {
        if (認定調査特記事項番号.contains(getカテーテル調査特記事項番号(厚労省IF識別コード.getColumnValue()))) {
            return is特記事項符号印字する ? 特記事項有 : RString.EMPTY;
        }
        return RString.EMPTY;
    }

    private RString get麻痺調査特記事項番号(RString 厚労省IF識別コード) {
    ...
    private RString get拘縮調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get寝返調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get起き上調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get座位保持調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
        } else if (KoroshoInterfaceShikibetsuCode.V02A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get両足での立位調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get歩行調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get立ち上調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get片足での立位調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get洗身調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString getつめ切り調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get視力調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get聴力調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get移乗調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get移動調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
        } else if (KoroshoInterfaceShikibetsuCode.V02A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString getえん下調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get食事摂取調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get排尿調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get排便調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get口腔清潔調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get洗顔調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get整髪調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get上衣の着脱調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString getズボン等の着脱調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get外出頻度調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
        } else if (KoroshoInterfaceShikibetsuCode.V02A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
    ...
    private RString get意思の伝達調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get毎日の日課を理解調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get生年月日調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get短期記憶調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get自分の名前調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get今の季節を理解調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get場所の理解調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get徘徊調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get外出して戻調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get被害的調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get作話調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get感情が不安定調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get昼夜逆転調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get同じ話をする調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get大声を出す調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get介護に抵抗調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get落ち着きなし調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get一人で出たがる調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get収集癖調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get物や衣類を壊す調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString getひどい物忘れ調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get独り言独り笑い調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
        } else if (KoroshoInterfaceShikibetsuCode.V02A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
    ...
    private RString get自分勝手調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
        } else if (KoroshoInterfaceShikibetsuCode.V02A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
    ...
    private RString get薬の内服調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get金銭の管理調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get日常の意思決定調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
        } else if (KoroshoInterfaceShikibetsuCode.V02A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
    ...
    private RString get集団への不適応調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
        } else if (KoroshoInterfaceShikibetsuCode.V02A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
    ...
    private RString get買い物調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
        } else if (KoroshoInterfaceShikibetsuCode.V02A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
    ...
    private RString get簡単な調理調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
        } else if (KoroshoInterfaceShikibetsuCode.V02A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
    ...
    private RString get話がまとまらない調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
        } else if (KoroshoInterfaceShikibetsuCode.V02A.getCode().equals(厚労省IF識別コード)) {
            return RString.EMPTY;
    ...
    private RString get点滴の管理調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get中心静脈栄養調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get透析調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString getストーマの処置調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get酸素療法調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString getレスピレーター調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get気管切開の処置調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get疼痛の看護調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString get経管栄養調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString getモニター測定調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString getじょくそうの処置調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
    ...
    private RString getカテーテル調査特記事項番号(RString 厚労省IF識別コード) {
        if (KoroshoInterfaceShikibetsuCode.V99A.getCode().equals(厚労省IF識別コード)) {
