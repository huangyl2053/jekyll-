...
/**
 * 帳票設計_DBE621002_主治医意見書作成報酬支払通知書のIShujiiHoshuShiharaiEditorです。
 *
 * @reamsid_L DBE-1980-040 xuyongchao
 */
public interface IShujiiHoshuShiharaiEditor extends IReportEditor<ShujiiHoshuShiharaiReportSource> {
}
