...
public class ShinsakaishukeihyoShinseiReport extends Report<ShinsakaiShukeihyoShinseiReportSource> {
    ...
    private List<ShinsakaiShukeihyoShinseiBody> getBodyData(ShinsakaiShukeihyoShinsei data) {
        ...
        dataBodyList.add(new ShinsakaiShukeihyoShinseiBody(data.get申_新規申請_受付数(),
                data.get申_新規申請_調査数(),
                data.get申_新規申請_意見書数(),
                data.get申_新規申請_審査会数(),
        ...
        dataBodyList.add(new ShinsakaiShukeihyoShinseiBody(data.get申_更新申請_受付数(),
                data.get申_更新申請_調査数(),
                data.get申_更新申請_意見書数(),
                data.get申_更新申請_審査会数(),
        ...
        dataBodyList.add(new ShinsakaiShukeihyoShinseiBody(data.get申_区分変更申請_受付数(),
        ...
        dataBodyList.add(new ShinsakaiShukeihyoShinseiBody(data.get申_転入_受付数(),
                data.get申_転入_調査数(),
                data.get申_転入_意見書数(),
                data.get申_転入_審査会数(),
                data.get申_転入_二次判定数(),
        ...
        dataBodyList.add(new ShinsakaiShukeihyoShinseiBody(data.get申_合計_受付数(),
                data.get申_合計_調査数(),
                data.get申_合計_意見書数(),
                data.get申_合計_審査会数(),
                data.get申_合計_二次判定数(),
