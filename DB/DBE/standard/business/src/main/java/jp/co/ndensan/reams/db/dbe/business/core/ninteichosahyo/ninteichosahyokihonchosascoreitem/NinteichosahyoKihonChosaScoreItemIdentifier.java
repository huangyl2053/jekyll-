...
/**
 * 認定調査票（基本調査素点項目）の識別子です。
 */
@SuppressWarnings("PMD.UnusedPrivateField")
@lombok.Value
public class NinteichosahyoKihonChosaScoreItemIdentifier implements Serializable {
     ...
     * @param 連番 連番
     */
    public NinteichosahyoKihonChosaScoreItemIdentifier(ShinseishoKanriNo 申請書管理番号,
            int 要介護認定調査履歴番号,
            int 連番) {
