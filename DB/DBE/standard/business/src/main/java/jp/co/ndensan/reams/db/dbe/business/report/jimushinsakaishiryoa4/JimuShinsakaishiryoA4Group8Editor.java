 ...
 */
public class JimuShinsakaishiryoA4Group8Editor implements IJimuShinsakaishiryoA4Editor {
     ...
     */
    protected JimuShinsakaishiryoA4Group8Editor(JimuTuikaSiryoBusiness business) {
        this.business = business;
    }

    @Override
    public JimuShinsakaishiryoA4ReportSource edit(JimuShinsakaishiryoA4ReportSource source) {
        source.shinsakaiNo = get審査会番号(business.get審査会開催番号());
