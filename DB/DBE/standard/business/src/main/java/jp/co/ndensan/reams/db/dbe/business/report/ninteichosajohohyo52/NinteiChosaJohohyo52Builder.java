...
public class NinteiChosaJohohyo52Builder implements INinteiChosaJohohyo52Builder {
     ...
     * @param index Index
     */
    public NinteiChosaJohohyo52Builder(NinteiChosaJohohyoEntity entity, int index) {
        this.entity = entity;
        this.index = index;
    }
    ...
    public NinteiChosaJohohyo52ReportSource build() {
        NinteiChosaJohohyo52ReportSource source = new NinteiChosaJohohyo52ReportSource();
