 ...
 */
public class JimuShinsakaishiryoA4Group7Editor implements IJimuShinsakaishiryoA4Editor {
     ...
     * @param index index
     */
    protected JimuShinsakaishiryoA4Group7Editor(JimuSonotashiryoBusiness business, int index) {
