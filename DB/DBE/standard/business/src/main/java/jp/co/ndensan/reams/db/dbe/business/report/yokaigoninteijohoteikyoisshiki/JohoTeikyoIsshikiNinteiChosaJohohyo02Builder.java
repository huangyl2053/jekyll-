...
/**
 * 要介護認定情報提供一式認定調査票情報02Builderクラスです。
 *
 * @author N3212 竹内 和紀
 */
public class JohoTeikyoIsshikiNinteiChosaJohohyo02Builder implements IJohoTeikyoIsshikiBuilder {
     ...
     * @param index Index
     */
    public JohoTeikyoIsshikiNinteiChosaJohohyo02Builder(NinteiChosaJohohyoEntity entity, int index) {
        this.entity = entity;
        this.index = index;
    }
    ...
    public YokaigoNinteiJohoTeikyoIsshikiReportSource build() {
        ...
        source.layout = JohoTeikyoIsshiki.NinteiChosaJohohyo_DBE091002.getFormGroupIndex();
