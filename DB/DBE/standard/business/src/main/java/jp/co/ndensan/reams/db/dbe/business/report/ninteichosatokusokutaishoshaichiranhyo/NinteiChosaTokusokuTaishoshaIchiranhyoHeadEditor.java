 ...
 *
 */
public class NinteiChosaTokusokuTaishoshaIchiranhyoHeadEditor implements NinteiChosaTokusokuTaishoshaIchiranhyoEditor {
     ...
     */
    protected NinteiChosaTokusokuTaishoshaIchiranhyoHeadEditor(NinteiChosaTokusokuTaishoshaIchiranhyoItem item) {
        this.item = item;
    }
    ...
    private NinteiChosaTokusokuTaishoshaIchiranhyoReportSource editSource(NinteiChosaTokusokuTaishoshaIchiranhyoReportSource source) {
        ...
        source.listLower2_1 = item.getListUpper2_1();
        source.listLower2_2 = item.getListUpper2_2();
