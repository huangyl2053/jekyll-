...
public class IinShinsakaishiryoA4Group2Editor implements IIinShinsakaishiryoA4Editor {
     ...
     * @param index int
     */
    protected IinShinsakaishiryoA4Group2Editor(IchijihanteikekkahyoA4Entity item, int index) {
        this.item = item;
        this.index = index;
    }
    ...
    private IinShinsakaishiryoA4ReportSource editSource1(IinShinsakaishiryoA4ReportSource source) {
