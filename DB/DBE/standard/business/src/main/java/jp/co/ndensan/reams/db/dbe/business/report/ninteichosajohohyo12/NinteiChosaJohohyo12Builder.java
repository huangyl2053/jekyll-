...
public class NinteiChosaJohohyo12Builder implements INinteiChosaJohohyo12Builder {
     ...
     * @param index Index
     */
    public NinteiChosaJohohyo12Builder(NinteiChosaJohohyoEntity entity, int index) {
        this.entity = entity;
        this.index = index;
    }
    ...
    public NinteiChosaJohohyo12ReportSource build() {
        NinteiChosaJohohyo12ReportSource source = new NinteiChosaJohohyo12ReportSource();
