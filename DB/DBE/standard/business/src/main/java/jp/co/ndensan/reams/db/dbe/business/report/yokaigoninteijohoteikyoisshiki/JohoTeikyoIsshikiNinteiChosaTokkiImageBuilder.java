 ...
 * @author N3212 竹内 和紀
 */
public class JohoTeikyoIsshikiNinteiChosaTokkiImageBuilder implements IJohoTeikyoIsshikiBuilder {
     ...
     */
    public JohoTeikyoIsshikiNinteiChosaTokkiImageBuilder(NinteiChosaTokkiImageEntity item, int index, int indexpage) {
        this.item = item;
        this.index = index;
    ...
    private int getレイアウト() {
        if (indexpage == 1) {
            return JohoTeikyoIsshiki.NinteiChosaTokkiImage1.getFormGroupIndex();
        }
        return JohoTeikyoIsshiki.NinteiChosaTokkiImage2.getFormGroupIndex();
    }
