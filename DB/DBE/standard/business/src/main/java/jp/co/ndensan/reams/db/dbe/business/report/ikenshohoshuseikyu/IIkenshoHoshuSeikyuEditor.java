...
/**
 * 帳票設計_DBE621004_主治医意見書作成報酬請求書のIIkenshoHoshuSeikyuEditorです。
 *
 * @reamsid_L DBE-1980-042 xuyongchao
 */
public interface IIkenshoHoshuSeikyuEditor extends IReportEditor<IkenshoHoshuSeikyuReportSource> {
