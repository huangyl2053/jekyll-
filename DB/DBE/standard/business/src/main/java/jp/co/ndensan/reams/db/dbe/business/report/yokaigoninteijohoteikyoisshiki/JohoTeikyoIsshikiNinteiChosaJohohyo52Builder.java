...
/**
 * 要介護認定情報提供一式認定調査票情報52Builderクラスです。
 *
 * @author N3212 竹内 和紀
 */
public class JohoTeikyoIsshikiNinteiChosaJohohyo52Builder implements IJohoTeikyoIsshikiBuilder {
     ...
     * @param index Index
     */
    public JohoTeikyoIsshikiNinteiChosaJohohyo52Builder(NinteiChosaJohohyoEntity entity, int index) {
        this.entity = entity;
        this.index = index;
    }
    ...
    public YokaigoNinteiJohoTeikyoIsshikiReportSource build() {
        ...
        source.layout = JohoTeikyoIsshiki._99ANinteiChosaJohohyo.getFormGroupIndex();
        return source;
    }
