 ...
 */
public class ShinsaHanteiJokyoProperty extends ReportPropertyBase<ShinsaHanteiJokyoReportSource> {

    /**
     * インスタンスを生成します。
     */
    public ShinsaHanteiJokyoProperty() {
        super(SubGyomuCode.DBE認定支援, ReportIdDBE.DBE701001.getReportId());
    }
}
