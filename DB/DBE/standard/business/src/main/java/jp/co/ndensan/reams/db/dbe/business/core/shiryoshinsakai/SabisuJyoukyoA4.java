...
public class SabisuJyoukyoA4 {
    ...
    private void set基準時間の積み上げグラフ(IchijihanteikekkahyoA4Entity 項目, ItiziHanteiEntity entity) {
        ...
        if (0 < getNumber(entity.getKijunJikanShokuji())) {
            イメージリストA4.add(new EachBarImage(getNumber(entity.getKijunJikanShokuji()), BarImageType.PATTERN1));
        }
        if (0 < getNumber(entity.getKijunJikanHaisetsu())) {
            イメージリストA4.add(new EachBarImage(getNumber(entity.getKijunJikanHaisetsu()), BarImageType.PATTERN2));
        }
        if (0 < getNumber(entity.getKijunJikanIdo())) {
            イメージリストA4.add(new EachBarImage(getNumber(entity.getKijunJikanIdo()), BarImageType.PATTERN3));
        }
        if (0 < getNumber(entity.getKijunJikanSeiketsuHoji())) {
            イメージリストA4.add(new EachBarImage(getNumber(entity.getKijunJikanSeiketsuHoji()), BarImageType.PATTERN4));
        }
        if (0 < getNumber(entity.getKijunJikanKansetsuCare())) {
            イメージリストA4.add(new EachBarImage(getNumber(entity.getKijunJikanKansetsuCare()), BarImageType.PATTERN5));
        }
        if (0 < getNumber(entity.getKijunJikanBPSDKanren())) {
            イメージリストA4.add(new EachBarImage(getNumber(entity.getKijunJikanBPSDKanren()), BarImageType.PATTERN6));
        }
        if (0 < getNumber(entity.getKijunJikanKinoKunren())) {
            イメージリストA4.add(new EachBarImage(getNumber(entity.getKijunJikanKinoKunren()), BarImageType.PATTERN7));
        }
        if (0 < getNumber(entity.getKijunJikanIryoKanren())) {
            イメージリストA4.add(new EachBarImage(getNumber(entity.getKijunJikanIryoKanren()), BarImageType.PATTERN8));
        }
        if (0 < getNumber(entity.getKijunJikanNinchishoKasan())) {
            イメージリストA4.add(new EachBarImage(getNumber(entity.getKijunJikanNinchishoKasan()), BarImageType.PATTERN9));
        }
