...
/**
 * DBE230004_主治医意見書作成依頼履歴一覧表のBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBE-1590-032 zuotao
 */
public interface IIkenshoirairirekiIchiranBuilder extends IReportBuilder<IkenshoirairirekiIchiranReportSource> {
}
