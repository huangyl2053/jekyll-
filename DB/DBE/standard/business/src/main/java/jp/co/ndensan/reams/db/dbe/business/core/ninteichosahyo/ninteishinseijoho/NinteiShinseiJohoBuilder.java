 ...
 */
package jp.co.ndensan.reams.db.dbe.business.core.ninteichosahyo.ninteishinseijoho;
...
public class NinteiShinseiJohoBuilder {
    ...
    private final Models<NinteichosaIraiJohoIdentifier, NinteichosaIraiJoho> ninteichosaIraiJoho;
     ...
     * @param ninteichosaIraiJoho {@link Models}
     *
     */
    NinteiShinseiJohoBuilder(
            DbT5101NinteiShinseiJohoEntity entity,
            NinteiShinseiJohoIdentifier id,
            Models<NinteichosaIraiJohoIdentifier, NinteichosaIraiJoho> ninteichosaIraiJoho
    ) {
        this.entity = entity.clone();
        this.id = id;
        this.ninteichosaIraiJoho = ninteichosaIraiJoho.clone();
     ...
     * @return {@link NinteiShinseiJohoBuilder}
     */
    public NinteiShinseiJohoBuilder set前回認定有効期間_開始(FlexibleDate 前回認定有効期間_開始) {
     ...
     * @return {@link NinteiShinseiJohoBuilder}
     */
    public NinteiShinseiJohoBuilder set前回認定有効期間_終了(FlexibleDate 前回認定有効期間_終了) {
    ...
    public NinteiShinseiJohoBuilder set二号医療保険者名(RString 二号医療保険者名) {
        requireNonNull(二号医療保険者名, UrSystemErrorMessages.値がnull.getReplacedMessage("二号医療保険者名"));
        entity.setNigoIryoHokenshaName(二号医療保険者名);
        return this;
    }
     ...
     * 二号医療保険記号番号を設定します。
     *
     * @param 二号医療保険記号番号 二号医療保険記号番号
     * @return {@link NinteiShinseiJohoBuilder}
     */
    public NinteiShinseiJohoBuilder set二号医療保険記号番号(RString 二号医療保険記号番号) {
        requireNonNull(二号医療保険記号番号, UrSystemErrorMessages.値がnull.getReplacedMessage("二号医療保険記号番号"));
        entity.setNigoIryoHokenKigoBango(二号医療保険記号番号);
        return this;
    }
     ...
     * @return {@link NinteiShinseiJohoBuilder}
     */
    public NinteiShinseiJohoBuilder set二号特定疾病コード(Code 二号特定疾病コード) {
    ...
    /**
     * 認定調査依頼情報のキー情報について判定します。<br>
     * 要介護認定申請情報に関連できる認定調査依頼情報である場合、下記の処理に遷移します。<br>
     * キーが一致する場合は認定調査依頼情報リストに認定調査依頼情報{@link NinteichosaIraiJoho}をセットします。<br>
    ...
    public NinteiShinseiJohoBuilder setNinteichosaIraiJoho(NinteichosaIraiJoho 認定調査依頼情報) {
        if (hasSameIdentifier(認定調査依頼情報.identifier())) {
            ninteichosaIraiJoho.add(認定調査依頼情報);
            return this;
        }
        throw new IllegalArgumentException(UrErrorMessages.不正.toString());
    }

    private boolean hasSameIdentifier(NinteichosaIraiJohoIdentifier 認定調査依頼情報識別子) {
        return id.get申請書管理番号().equals(認定調査依頼情報識別子.get申請書管理番号());
    }
    ...
    public NinteiShinseiJoho build() {
        return new NinteiShinseiJoho(entity, id, ninteichosaIraiJoho);
    }
}
