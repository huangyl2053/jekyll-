 ...
 */
public class NinteiChosaJohohyo32Editor implements INinteiChosaJohohyo32Editor {
     ...
     * @param index Index
     */
    protected NinteiChosaJohohyo32Editor(NinteiChosaJohohyoEntity entity, int index) {
        this.entity = entity;
        this.index = index;
    }
     ...
     */
    @Override
    public NinteiChosaJohohyo32ReportSource edit(NinteiChosaJohohyo32ReportSource source) {
        editSource_32(source);
        return source;
    }
