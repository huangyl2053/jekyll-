 ...
 * @author N3212 竹内 和紀
 */
public final class ChosahyoJoho09BEucEntityEditor {
    ...
    private ChosahyoJoho09BEucEntityEditor() {
    }

    /**
     * DBE010002_ChosahyoJoho09BEucEntityを編集して返します。
     *
     ...
     * @return DBE010002_ChosahyoJoho09BEucEntity
     */
    public static DBE010002_ChosahyoJoho09BEucEntity edit(ChosahyoEntity entity,
        ...
        DBE010002_ChosahyoJoho09BEucEntity eucEntity = new DBE010002_ChosahyoJoho09BEucEntity();
        ...
        eucEntity.set定期巡回_随時対応型訪問介護看護(getサービスの状況(サービスの状況List, Renban._19.getValue()));
        eucEntity.set看護小規模多機能型居宅介護(getサービスの状況(サービスの状況List, Renban._20.getValue()));
    ...
    private static RString get調査項目06名称(RString code) {
        return (code != null && !code.trim().isEmpty()) ? ChosaAnser06.toValue(code).get名称() : RString.EMPTY;
    }

    private static RString get調査項目07名称(RString code) {
        return (code != null && !code.trim().isEmpty()) ? ChosaAnser07.toValue(code).get名称() : RString.EMPTY;
    }
    ...
    private static RString get調査項目10名称(RString code) {
        return (code != null && !code.trim().isEmpty()) ? ChosaAnser10.toValue(code).get名称() : RString.EMPTY;
    }
    ...
    private static RString get調査項目12名称(RString code) {
        return (code != null && !code.trim().isEmpty()) ? ChosaAnser12.toValue(code).get名称() : RString.EMPTY;
    }
