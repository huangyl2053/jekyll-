...
public final class ChosahyoJoho09BEucEntityEditor {
    ...
    private static RString get調査項目06名称(RString code) {
        return (!code.trim().isEmpty()) ? ChosaAnser06.toValue(code).get名称() : RString.EMPTY;
    }

    private static RString get調査項目07名称(RString code) {
        return (!code.trim().isEmpty()) ? ChosaAnser07.toValue(code).get名称() : RString.EMPTY;
    }
    ...
    private static RString get調査項目10名称(RString code) {
        return (!code.trim().isEmpty()) ? ChosaAnser10.toValue(code).get名称() : RString.EMPTY;
    }
    ...
    private static RString get調査項目12名称(RString code) {
        return (!code.trim().isEmpty()) ? ChosaAnser12.toValue(code).get名称() : RString.EMPTY;
    }
