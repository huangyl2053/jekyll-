...
/**
 * 委員用一次判定+特記事項A3Editorです。
 *
 * @reamsid_L DBE-0150-330 lishengli
 */
public class IinTokkiTextPage1A3Editor implements IIinTokkiTextA3Editor {
     ...
     * インスタンスを生成します。
     *
     * @param item {@link IchijihanteikekkahyoA3Business}
     * @param 特記事項List List<RString>
     * @param index int
     */
    protected IinTokkiTextPage1A3Editor(IchijihanteikekkahyoA3Business item, List<RString> 特記事項List, int index) {
        this.item = item;
    ...
    private IinTokkiTextA3ReportSource editSource1(IinTokkiTextA3ReportSource source) {
    ...
    private IinTokkiTextA3ReportSource editSource2(IinTokkiTextA3ReportSource source) {
