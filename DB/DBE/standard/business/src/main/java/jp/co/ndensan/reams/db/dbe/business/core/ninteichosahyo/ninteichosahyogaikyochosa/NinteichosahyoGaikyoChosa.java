...
public class NinteichosahyoGaikyoChosa
     ...
     * 認定調査票（概況調査）配下の要素である認定調査票（概況特記）情報の{@link Models#deleteOrRemoveAll() }と 認定調査票（基本調査）情報の{@link Models#deleteOrRemoveAll() }と 認定調査票（概況調査）記入項目情報の{@link Models#deleteOrRemoveAll()
