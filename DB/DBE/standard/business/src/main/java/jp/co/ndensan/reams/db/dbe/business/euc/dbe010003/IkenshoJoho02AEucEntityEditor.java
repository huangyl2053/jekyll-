...
/**
 * 申請者意見書情報02ACSVエンティティ編集クラスです。
 *
 * @author N3212 竹内 和紀
 */
public class IkenshoJoho02AEucEntityEditor {

    private static final RString 改行 = new RString("<br/>");
    private static final RString 下矢印 = new RString("↓");

    private IkenshoJoho02AEucEntityEditor() {
    }

    /**
     * DBE010003_IkenshoJoho02AEucEntityを編集して返します。
     *
     ...
     * @return DBE010003_IkenshoJoho02AEucEntity
     */
    public static DBE010003_IkenshoJoho02AEucEntity edit(IkenshoJohoEntity entity,
            List<DbT5303ShujiiIkenshoKinyuItemEntity> 記入項目List,
            List<DbT5304ShujiiIkenshoIkenItemEntity> 意見項目List) {
        DBE010003_IkenshoJoho02AEucEntity eucEntity = new DBE010003_IkenshoJoho02AEucEntity();
