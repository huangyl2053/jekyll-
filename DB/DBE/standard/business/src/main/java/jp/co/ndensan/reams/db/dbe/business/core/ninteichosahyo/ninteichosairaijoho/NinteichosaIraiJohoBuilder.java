...
public class NinteichosaIraiJohoBuilder {
    ...
    NinteichosaIraiJohoBuilder(
        ...
        this.id = id;
        this.ninteichosahyoGaikyoChosa = ninteichosahyoGaikyoChosa.clone();
    ...
    /**
     * 認定調査票（概況調査）情報のキー情報について判定します。<br>
     * 認定調査依頼情報に関連できる認定調査票（概況調査）情報である場合、下記の処理に遷移します。<br>
     * キーが一致する場合は認定調査票（概況調査）情報リストに認定調査票（概況調査）情報{@link NinteichosahyoGaikyoChosa}をセットします。<br>
     * キーが一致しない場合、新たに追加します。<br>
     *
     * @param 認定調査票_概況調査_情報 {@link NinteichosahyoGaikyoChosa}
     * @return {@link NinteichosaIraiJohoBuilder}
     * @throws IllegalStateException キーが一致しない場合
     */
    public NinteichosaIraiJohoBuilder setNinteichosahyoGaikyoChosa(NinteichosahyoGaikyoChosa 認定調査票_概況調査_情報) {
        if (hasSameIdentifier(認定調査票_概況調査_情報.identifier())) {
            ninteichosahyoGaikyoChosa.add(認定調査票_概況調査_情報);
            return this;
        }
        throw new IllegalArgumentException(UrErrorMessages.不正.toString());
    }

    private boolean hasSameIdentifier(NinteichosahyoGaikyoChosaIdentifier 認定調査票_概況調査_情報識別子) {
        return (id.get申請書管理番号().equals(認定調査票_概況調査_情報識別子.get申請書管理番号())
                && id.get認定調査依頼履歴番号() == 認定調査票_概況調査_情報識別子.get認定調査依頼履歴番号());
    }
    ...
    public NinteichosaIraiJoho build() {
        return new NinteichosaIraiJoho(entity, id, ninteichosahyoGaikyoChosa);
    }
}
