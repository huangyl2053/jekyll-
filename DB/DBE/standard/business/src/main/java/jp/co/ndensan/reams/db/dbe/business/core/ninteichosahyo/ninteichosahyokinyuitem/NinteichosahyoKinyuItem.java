 ...
 */
public class NinteichosahyoKinyuItem
        extends ModelBase<NinteichosahyoKinyuItemIdentifier, DbT5209NinteichosahyoKinyuItemEntity, NinteichosahyoKinyuItem>
    ...
    /**
     * 認定調査票（概況調査）記入項目のみを変更対象とします。<br/> {@link DbT5209NinteichosahyoKinyuItemEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
    ...
    /**
     * 保持する認定調査票（概況調査）記入項目を削除対象とします。<br/> {@link DbT5209NinteichosahyoKinyuItemEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば削除状態にします。
     *
