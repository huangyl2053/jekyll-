...
public class ChosahyoJoho06AEucEntityEditor {
    ...
    public static DBE010002_ChosahyoJoho06AEucEntity edit(ChosahyoEntity entity,
        ...
        eucEntity.set障害高齢者の日常生活自立度(ShogaiNichijoSeikatsuJiritsudoCode.toValue(entity.getShogaiNichijoSeikatsuJiritsudoCode().value()).get名称());
        eucEntity.set認知症高齢者の日常生活自立度コード(entity.getNinchishoNichijoSeikatsuJiritsudoCode().value());
        eucEntity.set認知症高齢者の日常生活自立度(NinchishoNichijoSeikatsuJiritsudoCode.toValue(entity.getNinchishoNichijoSeikatsuJiritsudoCode().value()).get名称());
