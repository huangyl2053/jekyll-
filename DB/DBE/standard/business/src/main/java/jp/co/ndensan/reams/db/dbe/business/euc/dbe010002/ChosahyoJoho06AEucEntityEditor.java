...
/**
 * 申請者調査票情報06ACSVエンティティ編集クラスです。
 *
 * @author N3212 竹内 和紀
 */
public class ChosahyoJoho06AEucEntityEditor {
    ...
    /**
     * DBE010002_ChosahyoJoho06AEucEntityを編集して返します。
     *
     ...
     * @return DBE010002_ChosahyoJoho06AEucEntity
     */
    public static DBE010002_ChosahyoJoho06AEucEntity edit(ChosahyoEntity entity,
        ...
        DBE010002_ChosahyoJoho06AEucEntity eucEntity = new DBE010002_ChosahyoJoho06AEucEntity();
        ...
        eucEntity.set両足での立位(get調査項目04名称(get調査項目(調査項目List, Renban._15.getValue())));
        eucEntity.set歩行(get調査項目02名称(get調査項目(調査項目List, Renban._16.getValue())));
        eucEntity.set移乗(get調査項目20名称(get調査項目(調査項目List, Renban._17.getValue())));
        eucEntity.set移動(get調査項目20名称(get調査項目(調査項目List, Renban._18.getValue())));
        ...
        eucEntity.set洗身(get調査項目21名称(get調査項目(調査項目List, Renban._21.getValue())));
        eucEntity.setじょくそう(get調査項目01名称(get調査項目(調査項目List, Renban._22.getValue())));
        eucEntity.set他の皮膚疾患(get調査項目01名称(get調査項目(調査項目List, Renban._23.getValue())));
        eucEntity.setえん下(get調査項目11名称(get調査項目(調査項目List, Renban._24.getValue())));
        eucEntity.set食事摂取(get調査項目20名称(get調査項目(調査項目List, Renban._25.getValue())));
        eucEntity.set飲水摂取(get調査項目20名称(get調査項目(調査項目List, Renban._26.getValue())));
        eucEntity.set排尿(get調査項目20名称(get調査項目(調査項目List, Renban._27.getValue())));
        eucEntity.set排便(get調査項目20名称(get調査項目(調査項目List, Renban._28.getValue())));
        eucEntity.set口腔清潔(get調査項目22名称(get調査項目(調査項目List, Renban._29.getValue())));
        eucEntity.set洗顔(get調査項目22名称(get調査項目(調査項目List, Renban._30.getValue())));
        eucEntity.set整髪(get調査項目22名称(get調査項目(調査項目List, Renban._31.getValue())));
        eucEntity.setつめ切り(get調査項目22名称(get調査項目(調査項目List, Renban._32.getValue())));
        eucEntity.set上衣の着脱(get調査項目20名称(get調査項目(調査項目List, Renban._33.getValue())));
        eucEntity.setズボン等の着脱(get調査項目20名称(get調査項目(調査項目List, Renban._34.getValue())));
        eucEntity.set薬の内服(get調査項目22名称(get調査項目(調査項目List, Renban._35.getValue())));
        eucEntity.set金銭の管理(get調査項目22名称(get調査項目(調査項目List, Renban._36.getValue())));
        eucEntity.set電話の利用(get調査項目22名称(get調査項目(調査項目List, Renban._37.getValue())));
        eucEntity.set日常の意思決定(get調査項目17名称(get調査項目(調査項目List, Renban._38.getValue())));
        eucEntity.set視力(get調査項目08名称(get調査項目(調査項目List, Renban._39.getValue())));
        eucEntity.set聴力(get調査項目09名称(get調査項目(調査項目List, Renban._40.getValue())));
        eucEntity.set意思の伝達(get調査項目14名称(get調査項目(調査項目List, Renban._41.getValue())));
        eucEntity.set指示への反応(get調査項目23名称(get調査項目(調査項目List, Renban._42.getValue())));
        eucEntity.set毎日の日課を理解(get調査項目15名称(get調査項目(調査項目List, Renban._43.getValue())));
        eucEntity.set生年月日をいう(get調査項目15名称(get調査項目(調査項目List, Renban._44.getValue())));
        eucEntity.set短期記憶(get調査項目15名称(get調査項目(調査項目List, Renban._45.getValue())));
        eucEntity.set自分の名前をいう(get調査項目15名称(get調査項目(調査項目List, Renban._46.getValue())));
        eucEntity.set今の季節を理解(get調査項目15名称(get調査項目(調査項目List, Renban._47.getValue())));
        eucEntity.set場所の理解(get調査項目15名称(get調査項目(調査項目List, Renban._48.getValue())));
        eucEntity.set被害的(get調査項目16名称(get調査項目(調査項目List, Renban._49.getValue())));
        eucEntity.set作話(get調査項目16名称(get調査項目(調査項目List, Renban._50.getValue())));
        eucEntity.set幻視幻聴(get調査項目16名称(get調査項目(調査項目List, Renban._51.getValue())));
        eucEntity.set感情が不安定(get調査項目16名称(get調査項目(調査項目List, Renban._52.getValue())));
        eucEntity.set昼夜逆転(get調査項目16名称(get調査項目(調査項目List, Renban._53.getValue())));
        eucEntity.set暴言暴行(get調査項目16名称(get調査項目(調査項目List, Renban._54.getValue())));
        eucEntity.set同じ話をする(get調査項目16名称(get調査項目(調査項目List, Renban._55.getValue())));
        eucEntity.set大声をだす(get調査項目16名称(get調査項目(調査項目List, Renban._56.getValue())));
        eucEntity.set介護に抵抗(get調査項目16名称(get調査項目(調査項目List, Renban._57.getValue())));
        eucEntity.set常時の徘徊(get調査項目16名称(get調査項目(調査項目List, Renban._58.getValue())));
        eucEntity.set落ち着きなし(get調査項目16名称(get調査項目(調査項目List, Renban._59.getValue())));
        eucEntity.set外出して戻れない(get調査項目16名称(get調査項目(調査項目List, Renban._60.getValue())));
        eucEntity.set一人で出たがる(get調査項目16名称(get調査項目(調査項目List, Renban._61.getValue())));
        eucEntity.set収集癖(get調査項目16名称(get調査項目(調査項目List, Renban._62.getValue())));
        eucEntity.set火の不始末(get調査項目16名称(get調査項目(調査項目List, Renban._63.getValue())));
        eucEntity.set物や衣類を壊す(get調査項目16名称(get調査項目(調査項目List, Renban._64.getValue())));
        eucEntity.set不潔行為(get調査項目16名称(get調査項目(調査項目List, Renban._65.getValue())));
        eucEntity.set異食行動(get調査項目16名称(get調査項目(調査項目List, Renban._66.getValue())));
        eucEntity.setひどい物忘れ(get調査項目16名称(get調査項目(調査項目List, Renban._67.getValue())));
        eucEntity.set点滴の管理(get調査項目01名称(get調査項目(調査項目List, Renban._68.getValue())));
        eucEntity.set中心静脈栄養(get調査項目01名称(get調査項目(調査項目List, Renban._69.getValue())));
        eucEntity.set透析(get調査項目01名称(get調査項目(調査項目List, Renban._70.getValue())));
        eucEntity.setストーマ(get調査項目01名称(get調査項目(調査項目List, Renban._71.getValue())));
        eucEntity.set酸素療法(get調査項目01名称(get調査項目(調査項目List, Renban._72.getValue())));
        eucEntity.setレスピレーター(get調査項目01名称(get調査項目(調査項目List, Renban._73.getValue())));
        eucEntity.set気管切開の処置(get調査項目01名称(get調査項目(調査項目List, Renban._74.getValue())));
        eucEntity.set疼痛の看護(get調査項目01名称(get調査項目(調査項目List, Renban._75.getValue())));
        eucEntity.set経管栄養(get調査項目01名称(get調査項目(調査項目List, Renban._76.getValue())));
        eucEntity.setモニター測定(get調査項目01名称(get調査項目(調査項目List, Renban._77.getValue())));
        eucEntity.setじょくそうの処置(get調査項目01名称(get調査項目(調査項目List, Renban._78.getValue())));
        eucEntity.setカテーテル(get調査項目01名称(get調査項目(調査項目List, Renban._79.getValue())));
        eucEntity.set日中の生活(get調査項目24名称(get調査項目(調査項目List, Renban._80.getValue())));
        eucEntity.set外出頻度(get調査項目13名称(get調査項目(調査項目List, Renban._81.getValue())));
        eucEntity.set状況の変化(get調査項目01名称(get調査項目(調査項目List, Renban._82.getValue())));
    ...
    private static RString get調査項目11名称(RString code) {
        return (code != null && !code.trim().isEmpty()) ? ChosaAnser11.toValue(code).get名称() : RString.EMPTY;
    }

    private static RString get調査項目13名称(RString code) {
        return (code != null && !code.trim().isEmpty()) ? ChosaAnser13.toValue(code).get名称() : RString.EMPTY;
    }
    ...
    private static RString get調査項目17名称(RString code) {
        return (code != null && !code.trim().isEmpty()) ? ChosaAnser17.toValue(code).get名称() : RString.EMPTY;
    }
    ...
    private static RString get調査項目24名称(RString code) {
        return (code != null && !code.trim().isEmpty()) ? ChosaAnser24.toValue(code).get名称() : RString.EMPTY;
    }
