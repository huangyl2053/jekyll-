...
class NinteiChosaTokkiImageBuilder implements INinteiChosaTokkiImageBuilder {
     ...
     */
    public NinteiChosaTokkiImageBuilder(NinteiChosaTokkiImageEntity item, int index, int indexpage) {
        this.item = item;
        this.index = index;
    ...
    public NinteiChosaTokkiImageReportSource build() {
        NinteiChosaTokkiImageReportSource source = new NinteiChosaTokkiImageReportSource();
