...
/**
 *
 * 介護保険指定医依頼兼主治医意見書提出依頼書Builderのインターフェースクラスです。
 */
interface IShujiiIkenshoTeishutsuIraishoBuilder extends IReportBuilder<ShujiiIkenshoTeishutsuIraishoReportSource> {
