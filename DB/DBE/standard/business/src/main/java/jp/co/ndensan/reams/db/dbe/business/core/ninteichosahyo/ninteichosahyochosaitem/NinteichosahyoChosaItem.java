...
public class NinteichosahyoChosaItem extends ModelBase<NinteichosahyoChosaItemIdentifier, DbT5211NinteichosahyoChosaItemEntity, NinteichosahyoChosaItem> implements Serializable {
    ...
    public NinteichosahyoChosaItem(DbT5211NinteichosahyoChosaItemEntity entity) {
        this.entity = requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage("認定調査票（基本調査）調査項目"));
        this.id = new NinteichosahyoChosaItemIdentifier(
    ...
    /**
     * 認定調査票（基本調査）調査項目の識別子{@link NinteichosahyoChosaItemIdentifier}を返します。
     *
     * @return 認定調査票（基本調査）調査項目の識別子{@link NinteichosahyoChosaItemIdentifier}
     */
    @Override
    ...
    public NinteichosahyoChosaItem modifiedModel() {
        DbT5211NinteichosahyoChosaItemEntity modifiedEntity = entity.clone();
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private static final long serialVersionUID = -7116104095428582275L;
        private final DbT5211NinteichosahyoChosaItemEntity entity;
        private final NinteichosahyoChosaItemIdentifier id;
     ...
     * 編集後のインスタンスを取得する場合は{@link NinteichosahyoChosaItemBuilder.createBuilderForEdit#build()}を使用してください。
     *
     * @return Builder
     */
    ...
    public boolean equals(Object obj) {
        ...
        final NinteichosahyoChosaItem other = (NinteichosahyoChosaItem) obj;
