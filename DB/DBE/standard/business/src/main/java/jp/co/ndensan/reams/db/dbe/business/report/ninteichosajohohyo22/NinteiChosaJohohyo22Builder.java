...
public class NinteiChosaJohohyo22Builder implements INinteiChosaJohohyo22Builder {
     ...
     * @param index Index
     */
    public NinteiChosaJohohyo22Builder(NinteiChosaJohohyoEntity entity, int index) {
        this.entity = entity;
        this.index = index;
    }
    ...
    public NinteiChosaJohohyo22ReportSource build() {
        NinteiChosaJohohyo22ReportSource source = new NinteiChosaJohohyo22ReportSource();
