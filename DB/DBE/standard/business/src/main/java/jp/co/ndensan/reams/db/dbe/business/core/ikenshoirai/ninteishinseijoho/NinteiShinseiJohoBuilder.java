...
import jp.co.ndensan.reams.db.dbe.business.core.ikenshoirai.shujiiikenshoiraijoho.ShujiiIkenshoIraiJohoIdentifier;
...
public class NinteiShinseiJohoBuilder {
    ...
    NinteiShinseiJohoBuilder(
        ...
        this.id = id;
        this.shujiiIkenshoIraiJoho = shujiiIkenshoIraiJoho.clone();
    }
     ...
     * @return {@link NinteiShinseiJohoBuilder}
     */
    public NinteiShinseiJohoBuilder set２号医療保険者名(RString 二号医療保険者名) {
        requireNonNull(二号医療保険者名, UrSystemErrorMessages.値がnull.getReplacedMessage("２号医療保険者名"));
     ...
     * @return {@link NinteiShinseiJohoBuilder}
     */
    public NinteiShinseiJohoBuilder set２号医療保険記号番号(RString 二号医療保険記号番号) {
        requireNonNull(二号医療保険記号番号, UrSystemErrorMessages.値がnull.getReplacedMessage("２号医療保険記号番号"));
     ...
     * @return {@link NinteiShinseiJohoBuilder}
     */
    public NinteiShinseiJohoBuilder set２号特定疾病コード(Code 二号特定疾病コード) {
    ...
    /**
     * 主治医意見書作成依頼情報のキー情報について判定します。<br>
     * 主治医意見書作成依頼情報に関連できる主治医意見書作成依頼情報である場合、下記の処理に遷移します。<br>
     * キーが一致する場合は主治医意見書作成依頼情報リストに主治医意見書作成依頼情報{@link ShujiiIkenshoIraiJoho}をセットします。<br>
     ...
     */
    public NinteiShinseiJohoBuilder setShujiiIkenshoIraiJoho(ShujiiIkenshoIraiJoho 主治医意見書作成依頼情報) {
        if (hasSameIdentifier(主治医意見書作成依頼情報.identifier())) {
    ...
    private boolean hasSameIdentifier(ShujiiIkenshoIraiJohoIdentifier 主治医意見書作成依頼情報識別子) {
    ...
    public NinteiShinseiJoho build() {
        return new NinteiShinseiJoho(entity, id, shujiiIkenshoIraiJoho);
    }
}
