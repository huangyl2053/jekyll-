...
/**
 * 要介護認定情報提供一式一次判定結果Builderクラスです。
 *
 * @author N3212 竹内 和紀
 */
public class JohoTeikyoIsshikiIIchijihanteikekkahyoBuilder implements IJohoTeikyoIsshikiBuilder {
     ...
     * @param index Index
     */
    public JohoTeikyoIsshikiIIchijihanteikekkahyoBuilder(IchijihanteikekkahyoEntity item, int index) {
        this.item = item;
        this.index = index;
    }
    ...
    private void editSource1(YokaigoNinteiJohoTeikyoIsshikiReportSource source) {
    ...
    private void editSource2(YokaigoNinteiJohoTeikyoIsshikiReportSource source) {
    ...
    private void editSource3(YokaigoNinteiJohoTeikyoIsshikiReportSource source) {
