 ...
 */
package jp.co.ndensan.reams.db.dbe.business.core.ninteischedule.ninteishinseijoho;
...
public class NinteiShinseiJohoBuilder {
    ...
    public NinteiShinseiJohoBuilder set前回認定有効期間_開始(FlexibleDate 前回認定有効期間_開始) {
        requireNonNull(前回認定有効期間_開始, UrSystemErrorMessages.値がnull.getReplacedMessage("前回認定有効期間_開始"));
    ...
    public NinteiShinseiJohoBuilder set前回認定有効期間_終了(FlexibleDate 前回認定有効期間_終了) {
        requireNonNull(前回認定有効期間_終了, UrSystemErrorMessages.値がnull.getReplacedMessage("前回認定有効期間_終了"));
     ...
     * @return {@link NinteiShinseiJohoBuilder}
     */
    public NinteiShinseiJohoBuilder set2号医療保険者名(RString 医療保険者名) {
        requireNonNull(医療保険者名, UrSystemErrorMessages.値がnull.getReplacedMessage("医療保険者名"));
        entity.setNigoIryoHokenshaName(医療保険者名);
        return this;
    }
     ...
     * @return {@link NinteiShinseiJohoBuilder}
     */
    public NinteiShinseiJohoBuilder set2号医療保険記号番号(RString 医療保険記号番号) {
        requireNonNull(医療保険記号番号, UrSystemErrorMessages.値がnull.getReplacedMessage("医療保険記号番号"));
        entity.setNigoIryoHokenKigoBango(医療保険記号番号);
        return this;
    }
     ...
     * 特定疾病コード2号を設定します。
     *
     * @param 特定疾病コード2号 特定疾病コード2号
     * @return {@link NinteiShinseiJohoBuilder}
     */
    public NinteiShinseiJohoBuilder set2号特定疾病コード(Code 特定疾病コード2号) {
        requireNonNull(特定疾病コード2号, UrSystemErrorMessages.値がnull.getReplacedMessage("特定疾病コード2号"));
        entity.setNigoTokuteiShippeiCode(特定疾病コード2号);
        return this;
    }
