 ...
 */
public class NinteiChosaJohohyo12Editor implements INinteiChosaJohohyo12Editor {
     ...
     * @param index Index
     */
    protected NinteiChosaJohohyo12Editor(NinteiChosaJohohyoEntity entity, int index) {
        this.entity = entity;
        this.index = index;
    }
     ...
     */
    @Override
    public NinteiChosaJohohyo12ReportSource edit(NinteiChosaJohohyo12ReportSource source) {
        editSource_12(source);
        return source;
    }

    private NinteiChosaJohohyo12ReportSource editSource_12(NinteiChosaJohohyo12ReportSource source) {
