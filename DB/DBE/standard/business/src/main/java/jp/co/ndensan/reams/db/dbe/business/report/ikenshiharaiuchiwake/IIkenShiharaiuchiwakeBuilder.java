...
/**
 * 帳票設計_DBE622004_主治医意見書作成料支払内訳確認書のIIkenShiharaiuchiwakeBuilderです。
 *
 * @reamsid_L DBE-1980-047 xuyongchao
 */
interface IIkenShiharaiuchiwakeBuilder extends IReportBuilder<IkenShiharaiuchiwakeReportSource> {
