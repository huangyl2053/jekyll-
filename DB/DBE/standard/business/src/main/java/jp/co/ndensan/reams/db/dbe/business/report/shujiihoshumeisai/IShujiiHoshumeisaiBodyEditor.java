...
/**
 * 帳票設計_DBE622001_主治医意見書作成報酬支払明細書のIShujiiHoshumeisaiBodyEditorです。
 *
 * @reamsid_L DBE-1980-044 xuyongchao
 */
public interface IShujiiHoshumeisaiBodyEditor extends IReportEditor<ShujiiHoshumeisaiReportSource> {
