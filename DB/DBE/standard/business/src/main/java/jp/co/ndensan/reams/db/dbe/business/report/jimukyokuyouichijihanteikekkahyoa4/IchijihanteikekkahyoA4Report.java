...
public class IchijihanteikekkahyoA4Report extends Report<IchijihanteikekkahyoA4ReportSource> {
     ...
     */
    public IchijihanteikekkahyoA4Report(JimukyokuyouIchijihanteikekkahyoEntity item) {
        this.item = item;
    }
    ...
    private IchijihanteikekkahyoA4Body getBody1() {
        ...
        body.setListshujiiikensho_1(item.get認知症高齢者の日常生活自立度());
        body.setListshujiiikensho_2(get段階改善1(item.get認知症高齢者の日常生活自立度の改善()));
        body.setListshujiiikensho_3(get段階改善2(item.get認知症高齢者の日常生活自立度の改善()));
        body.setListshujiiikensho_4(item.get前回の認知症高齢者の日常生活自立度());
    ...
    private IchijihanteikekkahyoA4Body getBody2() {
        IchijihanteikekkahyoA4Body body = new IchijihanteikekkahyoA4Body();
        body.setListshujiiikensho_1(item.get短期記憶());
        body.setListshujiiikensho_2(get段階改善1(item.get短期記憶の改善()));
        body.setListshujiiikensho_3(get段階改善2(item.get短期記憶の改善()));
        body.setListshujiiikensho_4(item.get前回の短期記憶());
    ...
    private IchijihanteikekkahyoA4Body getBody3() {
        IchijihanteikekkahyoA4Body body = new IchijihanteikekkahyoA4Body();
        body.setListshujiiikensho_1(item.get日常の意思決定を行うための認知能力());
        body.setListshujiiikensho_2(get段階改善1(item.get日常の意思決定を行うための認知能力の改善()));
        body.setListshujiiikensho_3(get段階改善2(item.get日常の意思決定を行うための認知能力の改善()));
        body.setListshujiiikensho_4(item.get前回の日常の意思決定を行うための認知能力());
    ...
    private IchijihanteikekkahyoA4Body getBody4() {
        IchijihanteikekkahyoA4Body body = new IchijihanteikekkahyoA4Body();
        body.setListshujiiikensho_1(item.get自分の意思の伝達能力());
        body.setListshujiiikensho_2(get段階改善1(item.get自分の意思の伝達能力の改善()));
        body.setListshujiiikensho_3(get段階改善2(item.get自分の意思の伝達能力の改善()));
        body.setListshujiiikensho_4(item.get前回の自分の意思の伝達能力());
    ...
    private IchijihanteikekkahyoA4Body getBody5() {
        IchijihanteikekkahyoA4Body body = new IchijihanteikekkahyoA4Body();
        body.setListshujiiikensho_1(item.get食事行為());
        body.setListshujiiikensho_2(get段階改善1(item.get食事行為の改善()));
        body.setListshujiiikensho_3(get段階改善2(item.get食事行為の改善()));
        body.setListshujiiikensho_4(item.get前回の食事行為());
