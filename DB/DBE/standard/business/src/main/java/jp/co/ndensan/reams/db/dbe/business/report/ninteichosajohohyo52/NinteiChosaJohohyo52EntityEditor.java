 ...
 * @author N3212 竹内 和紀
 */
public class NinteiChosaJohohyo52EntityEditor {
    ...
    private NinteiChosaJohohyo52EntityEditor() {
    }
    ...
    public static NinteiChosaJohohyoEntity edit(YokaigoNinteiJohoTeikyoEntity yokaigoNinteiJohoTeikyoEntity,
        ...
        ninteiChosaJohohyoEntity.setサービス区分リスト_52(getサービス状況02(認定調査票サービス状況List,
                認定調査票サービス状況フラグList, yokaigoNinteiJohoTeikyoEntity.getサービス区分コード()));
        ninteiChosaJohohyoEntity.set麻痺拘縮1_リスト_52(get麻痺拘縮1_リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set麻痺拘縮2_リスト_52(get麻痺拘縮2_リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set移動リスト_52(set移動リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set複雑動作リスト_52(get複雑動作リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set特別介護リスト_52(get特別介護リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set身の回りリスト_52(get身の回りリスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set意思疎通リスト_52(get意思疎通リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set問題行動リスト_52(get問題行動リスト(認定調査票調査項目List));
        ninteiChosaJohohyoEntity.set特別な医療リスト_52(set特別な医療リスト(認定調査票調査項目List));
        return ninteiChosaJohohyoEntity;
    }

    private static List<RString> set特別な医療リスト(List<NinteichosahyoChosaItem> 認定調査票調査項目List) {
        ...
        特別な医療リスト.add(get名称01(認定調査票調査項目List, 連番79));
        特別な医療リスト.add(get名称01(認定調査票調査項目List, 連番80));
        特別な医療リスト.add(get名称01(認定調査票調査項目List, 連番81));
        特別な医療リスト.add(get名称01(認定調査票調査項目List, 連番82));
        特別な医療リスト.add(get名称01(認定調査票調査項目List, 連番83));
        特別な医療リスト.add(get名称01(認定調査票調査項目List, 連番84));
        return 特別な医療リスト;
    }
    ...
    private static List<RString> get問題行動リスト(List<NinteichosahyoChosaItem> 認定調査票調査項目List) {
        ...
        問題行動リスト.add(get名称16(認定調査票調査項目List, 連番67));
        問題行動リスト.add(get名称16(認定調査票調査項目List, 連番68));
        問題行動リスト.add(get名称16(認定調査票調査項目List, 連番69));
        問題行動リスト.add(get名称16(認定調査票調査項目List, 連番70));
        問題行動リスト.add(get名称16(認定調査票調査項目List, 連番71));
        問題行動リスト.add(get名称16(認定調査票調査項目List, 連番72));
        return 問題行動リスト;
    }

    private static List<RString> get意思疎通リスト(List<NinteichosahyoChosaItem> 認定調査票調査項目List) {
        List<RString> 意思疎通リスト = new ArrayList<>();
        意思疎通リスト.add(get名称08(認定調査票調査項目List, 連番44));
        意思疎通リスト.add(get名称09(認定調査票調査項目List, 連番45));
        意思疎通リスト.add(get名称14(認定調査票調査項目List, 連番46));
        意思疎通リスト.add(get名称23(認定調査票調査項目List, 連番47));
        意思疎通リスト.add(get名称15(認定調査票調査項目List, 連番48));
        意思疎通リスト.add(get名称15(認定調査票調査項目List, 連番49));
        意思疎通リスト.add(get名称15(認定調査票調査項目List, 連番50));
        意思疎通リスト.add(get名称15(認定調査票調査項目List, 連番51));
        意思疎通リスト.add(get名称15(認定調査票調査項目List, 連番52));
        意思疎通リスト.add(get名称15(認定調査票調査項目List, 連番53));
        return 意思疎通リスト;
    }
    ...
    private static List<RString> get身の回りリスト(List<NinteichosahyoChosaItem> 認定調査票調査項目List) {
        ...
        身の回りリスト.add(get名称22(認定調査票調査項目List, 連番32));
        身の回りリスト.add(get名称22(認定調査票調査項目List, 連番33));
        身の回りリスト.add(get名称22(認定調査票調査項目List, 連番34));
        身の回りリスト.add(get名称34(認定調査票調査項目List, 連番35));
        身の回りリスト.add(get名称34(認定調査票調査項目List, 連番36));
        身の回りリスト.add(get名称34(認定調査票調査項目List, 連番37));
        身の回りリスト.add(get名称34(認定調査票調査項目List, 連番38));
        身の回りリスト.add(get名称22(認定調査票調査項目List, 連番39));
        身の回りリスト.add(get名称22(認定調査票調査項目List, 連番40));
        身の回りリスト.add(get名称22(認定調査票調査項目List, 連番41));
        身の回りリスト.add(get名称16(認定調査票調査項目List, 連番42));
        身の回りリスト.add(get名称16(認定調査票調査項目List, 連番43));
        return 身の回りリスト;
    }
    ...
    private static List<RString> get特別介護リスト(List<NinteichosahyoChosaItem> 認定調査票調査項目List) {
        ...
        特別介護リスト.add(get名称01(認定調査票調査項目List, 連番23));
        特別介護リスト.add(get名称30(認定調査票調査項目List, 連番24));
        特別介護リスト.add(get名称31(認定調査票調査項目List, 連番25));
        特別介護リスト.add(get名称16(認定調査票調査項目List, 連番26));
        特別介護リスト.add(get名称16(認定調査票調査項目List, 連番27));
        特別介護リスト.add(get名称32(認定調査票調査項目List, 連番28));
        特別介護リスト.add(get名称32(認定調査票調査項目List, 連番29));
        特別介護リスト.add(get名称33(認定調査票調査項目List, 連番30));
        return 特別介護リスト;
    }
    ...
    private static List<RString> get複雑動作リスト(List<NinteichosahyoChosaItem> 認定調査票調査項目List) {
        ...
        複雑動作リスト.add(get名称21(認定調査票調査項目List, 連番21));
        return 複雑動作リスト;
    }
    ...
    private static List<RString> set移動リスト(List<NinteichosahyoChosaItem> 認定調査票調査項目List) {
        ...
        移動リスト.add(get名称03(認定調査票調査項目List, 連番14));
        移動リスト.add(get名称04(認定調査票調査項目List, 連番15));
        移動リスト.add(get名称02(認定調査票調査項目List, 連番16));
    ...
    private static void setマスキング情報(NinteiChosaJohohyoEntity ninteiEntity,
            YokaigoNinteiJohoTeikyoEntity entity, RString 認定調査票マスキング区分) throws IllegalArgumentException, NullPointerException {
    ...
    private static RString get名称34(List<NinteichosahyoChosaItem> 認定調査票調査項目List, int 連番) {
        if (連番 < 認定調査票調査項目List.size()) {
            if (RString.isNullOrEmpty(認定調査票調査項目List.get(連番).get調査項目())) {
                return RString.EMPTY;
            }
            return ChosaAnser34.toValue(認定調査票調査項目List.get(連番).get調査項目()).get名称();
        }
        return RString.EMPTY;
    }

    private static RString get名称32(List<NinteichosahyoChosaItem> 認定調査票調査項目List, int 連番) {
        if (連番 < 認定調査票調査項目List.size()) {
            if (RString.isNullOrEmpty(認定調査票調査項目List.get(連番).get調査項目())) {
                return RString.EMPTY;
            }
            return ChosaAnser32.toValue(認定調査票調査項目List.get(連番).get調査項目()).get名称();
        }
        return RString.EMPTY;
    }

    private static RString get名称31(List<NinteichosahyoChosaItem> 認定調査票調査項目List, int 連番) {
        if (連番 < 認定調査票調査項目List.size()) {
            if (RString.isNullOrEmpty(認定調査票調査項目List.get(連番).get調査項目())) {
                return RString.EMPTY;
            }
            return ChosaAnser31.toValue(認定調査票調査項目List.get(連番).get調査項目()).get名称();
        }
        return RString.EMPTY;
    }

    private static RString get名称30(List<NinteichosahyoChosaItem> 認定調査票調査項目List, int 連番) {
        if (連番 < 認定調査票調査項目List.size()) {
            if (RString.isNullOrEmpty(認定調査票調査項目List.get(連番).get調査項目())) {
                return RString.EMPTY;
            }
            return ChosaAnser30.toValue(認定調査票調査項目List.get(連番).get調査項目()).get名称();
        }
        return RString.EMPTY;
    }
    ...
    private static RString get名称33(List<NinteichosahyoChosaItem> 認定調査票調査項目List, int 連番) {
        if (連番 < 認定調査票調査項目List.size()) {
            if (RString.isNullOrEmpty(認定調査票調査項目List.get(連番).get調査項目())) {
                return RString.EMPTY;
            }
            return ChosaAnser33.toValue(認定調査票調査項目List.get(連番).get調査項目()).get名称();
        }
        return RString.EMPTY;
    }
