...
//        if (A_99.equals(厚労省IF識別コード)) {
//            return IkenshoKomokuMapping99A.被害的.getコード();
//        } else if (A_02.equals(厚労省IF識別コード)) {
//            return IkenshoKomokuMapping02A.被害的.getコード();
//        } else if (A_06.equals(厚労省IF識別コード)) {
//            return IkenshoKomokuMapping06A.被害的.getコード();
//        } else if (A_09.equals(厚労省IF識別コード)) {
//            return IkenshoKomokuMapping09A.被害的.getコード();
//        } else if (B_09.equals(厚労省IF識別コード)) {
//            return IkenshoKomokuMapping09B.被害的.getコード();
//        }
        return RString.EMPTY;
    }
