 ...
 * 判定結果情報出力（保険者）クラスです。
 */
public class HanteiKekkaJouhouShuturyokuManager {
     ...
     * コンストラクタです。
     */
    HanteiKekkaJouhouShuturyokuManager() {
     ...
     */
    HanteiKekkaJouhouShuturyokuManager(MapperProvider mapperProvider) {
        this.mapperProvider = mapperProvider;
    }

    /**
     * {@link InstanceProvider#create}にて生成した{@link HanteiKekkaJouhouShuturyokuManager}のインスタンスを返します。
     *
     * @return
     * {@link InstanceProvider#create}にて生成した{@link HanteiKekkaJouhouShuturyokuManager}のインスタンス
     */
    public static HanteiKekkaJouhouShuturyokuManager createInstance() {
        return InstanceProvider.create(HanteiKekkaJouhouShuturyokuManager.class);
    }
