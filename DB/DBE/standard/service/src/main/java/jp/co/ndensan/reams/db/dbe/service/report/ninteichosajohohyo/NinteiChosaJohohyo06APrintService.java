...
import jp.co.ndensan.reams.db.dbe.business.report.ninteichosajohohyo32.NinteiChosaJohohyo06AProperty;
...
/**
 * 認定調査票情報_06AのPrinterクラスです。
 *
 * @author N3212 竹内 和紀
 */
public class NinteiChosaJohohyo06APrintService implements INinteiChosaJohohyoPrintService {
     ...
     * @param reportManager
     */
    public NinteiChosaJohohyo06APrintService(ReportManager reportManager) {
    ...
    public void print(YokaigoNinteiJohoTeikyoBusiness business,
        ...
        try (ReportAssembler<NinteiChosaJohohyo32ReportSource> assembler = createAssembler(new NinteiChosaJohohyo06AProperty(), reportManager)) {
            ...
            NinteiChosaJohohyo32Report report = new NinteiChosaJohohyo32Report(NinteiChosaJohohyo32EntityEditor.edit(business.toEntity(),
