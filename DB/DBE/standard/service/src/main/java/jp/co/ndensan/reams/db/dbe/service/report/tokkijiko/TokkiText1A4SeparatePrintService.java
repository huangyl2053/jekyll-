...
import jp.co.ndensan.reams.db.dbe.business.report.tokkitext1a4.TokkiText1A4SeparateProperty;
...
/**
 * 特記事項(１つずつ)のPrinterクラスです。
 *
 * @author N3212 竹内 和紀
 */
public class TokkiText1A4SeparatePrintService implements ITokkiJikoPrintService {
     ...
     * @param reportManager
     */
    public TokkiText1A4SeparatePrintService(ReportManager reportManager) {
    ...
    public void print(YokaigoNinteiJohoTeikyoBusiness business, List<NinteichosaRelate> 特記事項List,
        ...
        try (ReportAssembler<TokkiText1ReportSource> assembler = createAssembler(new TokkiText1A4SeparateProperty(), reportManager)) {
            ReportSourceWriter<TokkiText1ReportSource> reportSourceWriter = new ReportSourceWriter(assembler);
            TokkiText1A4Report report
                    = new TokkiText1A4Report(TokkiText1A4SeparateEditor.edit(business.toEntity(), 特記事項List, 特記事項マスキング区分));
