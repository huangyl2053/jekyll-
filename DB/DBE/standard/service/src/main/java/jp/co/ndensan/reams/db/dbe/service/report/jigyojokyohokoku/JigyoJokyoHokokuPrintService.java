...
public class JigyoJokyoHokokuPrintService {
     ...
     */
    public SourceDataCollection print(List<JigyoJokyoHokoku> reportJoho) {
    ...
    private static List<JigyoJokyoHokokuReport> toReports(List<JigyoJokyoHokoku> reportJoho) {
