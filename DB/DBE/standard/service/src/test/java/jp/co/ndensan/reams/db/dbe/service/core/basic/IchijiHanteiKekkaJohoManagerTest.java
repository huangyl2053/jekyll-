...
public class IchijiHanteiKekkaJohoManagerTest {
    ...
    public static class get要介護認定一次判定結果情報 extends DbeTestBase {
        ...
        public void 引数の主キー型1にnullを指定した場合_NullPointerExceptionが発生する() {
            主キー型2 主キー2 = DbT5116IchijiHanteiKekkaJohoEntityGenerator.DEFAULT_主キー2;
            sut.get要介護認定一次判定結果情報(null, 主キー2);
        }

        @Test(expected = NullPointerException.class)
        public void 引数の主キー型2にnullを指定した場合_NullPointerExceptionが発生する() {
            主キー型1 主キー1 = DbT5116IchijiHanteiKekkaJohoEntityGenerator.DEFAULT_主キー1;
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get主キー1().value(), is(DbT5116IchijiHanteiKekkaJohoEntityGenerator.DEFAULT_主キー1.value()));
        }
    }
    ...
    public static class get要介護認定一次判定結果情報一覧 extends FdaTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get(0).get主キー1().value(), is(DbT5116IchijiHanteiKekkaJohoEntityGenerator.DEFAULT_主キー1.value()));
        }
    }
