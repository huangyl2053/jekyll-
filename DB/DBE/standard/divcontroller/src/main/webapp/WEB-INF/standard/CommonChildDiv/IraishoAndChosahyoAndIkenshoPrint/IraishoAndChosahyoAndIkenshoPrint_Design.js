...
(function (DBE) {
    (function (IraishoAndChosahyoAndIkenshoPrint) {
        ...
        IraishoAndChosahyoAndIkenshoPrint.Events = Events;
        ...
        var Controls = (function () {
            ...
            Controls.myType = function () {
                return "IraishoAndChosahyoAndIkenshoPrint";
            };

            Controls.prototype.convFiledNameSelf = function () {
                return this._myName + "_" + DBE.IraishoAndChosahyoAndIkenshoPrint.Controls.myType();
            };

            Controls.prototype.convFiledName = function (fieldName) {
                return this._myName + "_" + DBE.IraishoAndChosahyoAndIkenshoPrint.Controls.myType() + "_" + fieldName;
            };

            Controls.prototype.IraishoAndChosahyoAndIkenshoPrint = function () {
        ...
        IraishoAndChosahyoAndIkenshoPrint.Controls = Controls;
