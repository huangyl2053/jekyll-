...
public class dgListOfCommonMemo_Row extends DataRow {
    ...
    public dgListOfCommonMemo_Row(RString no, Button edit, RString jotai, RString creator, RString importance, RString memo, RString memokubun, RString chikucode, RString memono) {
        super();
        this.setOriginalData("no", no);
        this.setOriginalData("edit", edit);
        this.setOriginalData("jotai", jotai);
