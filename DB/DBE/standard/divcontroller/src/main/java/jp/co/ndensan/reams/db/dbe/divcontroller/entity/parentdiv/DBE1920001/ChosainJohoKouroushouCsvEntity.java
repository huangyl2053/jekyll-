...
public class ChosainJohoKouroushouCsvEntity {

    @CsvField(order = 1, name = "シーケンシャル番号")
    private RString シーケンシャル番号;
    @CsvField(order = 1, name = "機能コード")
    private RString 機能コード;
    @CsvField(order = 1, name = "識別コード")
    private RString 識別コード;
    @CsvField(order = 1, name = "委託先コード")
    private RString 委託先コード;
    @CsvField(order = 1, name = "調査員コード")
    private RString 調査員コード;
    @CsvField(order = 1, name = "調査員名称")
    private RString 調査員名称;
    @CsvField(order = 1, name = "資格コード")
    private RString 資格コード;
    @CsvField(order = 1, name = "状況")
    private RString 状況;
    private int 項目数;
}
