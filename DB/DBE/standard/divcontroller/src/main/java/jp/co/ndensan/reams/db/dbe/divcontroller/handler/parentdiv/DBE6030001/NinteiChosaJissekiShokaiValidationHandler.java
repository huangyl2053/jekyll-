 ...
 *
 */
public class NinteiChosaJissekiShokaiValidationHandler {
     ...
     * コンストラクタです。
     *
     * @param div NinteiChosaJissekiShokaiDiv
     */
    public NinteiChosaJissekiShokaiValidationHandler(NinteiChosaJissekiShokaiDiv div) {
        this.div = div;
    }
    ...
    public ValidationMessageControlPairs validateForCheckedDataCount() {
        ...
        if (div.getDgNinteiChosaJisseki().getSelectedItems().isEmpty()) {
