...
import jp.co.ndensan.reams.db.dbe.divcontroller.entity.ShujiiIkenshoIraishoPublishingOptionsDiv;
import jp.co.ndensan.reams.db.dbe.divcontroller.entity.ShujiiIkenshoIraishoRelatedDatesDiv;
import jp.co.ndensan.reams.db.dbe.divcontroller.entity.ShujiiIkenshoIraishoTargetPersonsDiv;
...
public class IkenshoIraiIkkatuHakkoTabDiv extends TabPanel {
    ...
    @JsonProperty("btnToPublishOfIkensho")
    private Button btnToPublishOfIkensho;
    ...
    @JsonProperty("btnToPublishOfIkensho")
    public Button getBtnToPublishOfIkensho() {
        return btnToPublishOfIkensho;
    }

    @JsonProperty("btnToPublishOfIkensho")
    public void setBtnToPublishOfIkensho(Button btnToPublishOfIkensho) {
        this.btnToPublishOfIkensho=btnToPublishOfIkensho;
    }
