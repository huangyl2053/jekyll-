 ...
 * 不正な動作の原因になります。
 */
import jp.co.ndensan.reams.db.dbe.divcontroller.entity.IChosaKikanDialogDiv;
 ...
 * @author 自動生成
 */
public class ChosaKikanDialogDiv extends Panel implements IChosaKikanDialogDiv {
    /*
     * [ private の作成 ]
