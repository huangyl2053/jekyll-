...
public class TaishoshaIchiranDiv extends Panel {
    ...
    @JsonProperty("btnTaishoshaOutput")
    private ButtonDownLoad btnTaishoshaOutput;
    ...
    /*
     * getbtnTaishoshaOutput
     * @return btnTaishoshaOutput
     */
    @JsonProperty("btnTaishoshaOutput")
    ...
    /*
     * setbtnTaishoshaOutput
     * @param btnTaishoshaOutput btnTaishoshaOutput
     */
    @JsonProperty("btnTaishoshaOutput")
    public void setBtnTaishoshaOutput(ButtonDownLoad btnTaishoshaOutput) {
        this.btnTaishoshaOutput = btnTaishoshaOutput;
    }
