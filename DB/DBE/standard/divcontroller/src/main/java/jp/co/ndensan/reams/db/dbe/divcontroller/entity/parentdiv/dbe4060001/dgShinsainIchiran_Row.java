package jp.co.ndensan.reams.db.dbe.divcontroller.entity.parentdiv.dbe4060001;
/**
 * このコードはツールによって生成されました。
 * このファイルへの変更は、以下の状況下で不正な動作の原因になったり、
 * コードが再生成されるときに損失したりします。
 * Fri Jul 04 12:25:00 JST 2014 
 */
...
/**
 * dgShinsainIchiran_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgShinsainIchiran_Row extends DataRow {
    ...
    public dgShinsainIchiran_Row() {
        ...
        this.shinsainJokyo = RString.EMPTY;
        this.shinsainKaishibi = RString.EMPTY;
        this.shinsainShuryobi = RString.EMPTY;
        this.gogitaichoKbn = RString.EMPTY;
        this.shukketsuKbn = RString.EMPTY;
    }

    public dgShinsainIchiran_Row(RString shinsainNo, RString shinsainShimei, RString shozokukikan, RString seibetsu, RString shinsainKbn, RString shinsainJokyo, RString shinsainKaishibi, RString shinsainShuryobi, RString gogitaichoKbn, RString shukketsuKbn) {
        super();
