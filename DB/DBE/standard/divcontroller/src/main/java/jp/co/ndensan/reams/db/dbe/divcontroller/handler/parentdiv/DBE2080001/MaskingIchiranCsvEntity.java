...
public class MaskingIchiranCsvEntity {
    ...
    @CsvField(order = 50, name = "(被保険者)被保番号")
    private final RString 被保険者_被保番号;
    @CsvField(order = 60, name = "(被保険者)氏名")
    private final RString 被保険者_氏名;
    @CsvField(order = 70, name = "(申請区分)申請時")
    private final RString 申請区分_申請時;
    @CsvField(order = 80, name = "(調査依頼)完了日")
    private final RString 調査依頼_完了日;
    @CsvField(order = 90, name = "(調査票入手)完了日")
    private final RString 調査票入手_完了日;
    @CsvField(order = 100, name = "(意見書依頼)完了日")
    private final RString 意見書依頼_完了日;
    @CsvField(order = 110, name = "(意見書入手)完了日")
