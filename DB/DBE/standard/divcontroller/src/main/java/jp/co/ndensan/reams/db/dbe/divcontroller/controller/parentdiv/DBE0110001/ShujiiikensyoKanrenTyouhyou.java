...
import jp.co.ndensan.reams.db.dbe.divcontroller.handler.parentdiv.DBE0110001.ShujiiikensyoKanrenTyouhyouValidationHandler;
...
public class ShujiiikensyoKanrenTyouhyou {
    ...
    public ResponseData<ShujiiikensyoKanrenTyouhyouDiv> onClick_btnMove(ShujiiikensyoKanrenTyouhyouDiv div) {
        ...
        ValidationMessageControlPairs validPairs = getValidationHandler(div).check帳票選択(validationMessages);
    ...
    private ShujiiikensyoKanrenTyouhyouValidationHandler getValidationHandler(ShujiiikensyoKanrenTyouhyouDiv div) {
        return new ShujiiikensyoKanrenTyouhyouValidationHandler(div);
    }
