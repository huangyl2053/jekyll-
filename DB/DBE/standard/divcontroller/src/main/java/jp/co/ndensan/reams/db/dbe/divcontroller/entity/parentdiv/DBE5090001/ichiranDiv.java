...
public class ichiranDiv extends Panel {
     ...
     */
    @JsonProperty("dgCreateTargetSummary")
    private DataGrid<dgCreateTargetSummary_Row> dgCreateTargetSummary;
     ...
     */
    /*
     * getdgCreateTargetSummary
     * @return dgCreateTargetSummary
     */
    @JsonProperty("dgCreateTargetSummary")
    ...
    /*
     * setdgCreateTargetSummary
     * @param dgCreateTargetSummary dgCreateTargetSummary
     */
    @JsonProperty("dgCreateTargetSummary")
    public void setDgCreateTargetSummary(DataGrid<dgCreateTargetSummary_Row> dgCreateTargetSummary) {
        this.dgCreateTargetSummary = dgCreateTargetSummary;
    }
