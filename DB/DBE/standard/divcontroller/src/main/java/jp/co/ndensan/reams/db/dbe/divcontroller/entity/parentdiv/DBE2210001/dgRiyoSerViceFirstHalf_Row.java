...
/**
 * dgRiyoSerViceFirstHalf_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgRiyoSerViceFirstHalf_Row extends DataRow {
    ...
    public dgRiyoSerViceFirstHalf_Row() {
        super();
    ...
    public dgRiyoSerViceFirstHalf_Row(TextBox serviceMeisho, TextBoxNum serviceJokyo, RString tani) {
        super();
        this.setOriginalData("serviceMeisho", serviceMeisho);
        this.setOriginalData("serviceJokyo", serviceJokyo);
        this.setOriginalData("tani", tani);
