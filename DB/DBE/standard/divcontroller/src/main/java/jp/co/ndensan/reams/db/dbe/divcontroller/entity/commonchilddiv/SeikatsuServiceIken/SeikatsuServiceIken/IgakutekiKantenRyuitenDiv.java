...
/**
 * IgakutekiKantenRyuiten のクラスファイル 
 * 
...
public class IgakutekiKantenRyuitenDiv extends Panel {
    ...
    private RadioButton radKetsuatsu;
    @JsonProperty("txtKetsuatsu")
    private TextBox txtKetsuatsu;
    @JsonProperty("radIdo")
    private RadioButton radIdo;
    @JsonProperty("txtIdo")
    private TextBox txtIdo;
    @JsonProperty("radSesshoku")
    private RadioButton radSesshoku;
    @JsonProperty("txtSesshoku")
    private TextBox txtSesshoku;
    @JsonProperty("radUndo")
    private RadioButton radUndo;
    @JsonProperty("txtUndo")
    private TextBox txtUndo;
    @JsonProperty("radEnka")
    private RadioButton radEnka;
    @JsonProperty("txtEnka")
    private TextBox txtEnka;
    @JsonProperty("txtSonotaRyuiJiko")
    private TextBox txtSonotaRyuiJiko;
