...
/**
 * PublishingConditionForJimukyoku のクラスファイル 
 * 
 * @author 自動生成
 */
public class PublishingConditionForJimukyokuDiv extends Panel {
    ...
    /*
     * setchkPrintChoyoJimu
     * @param chkPrintChoyoJimu chkPrintChoyoJimu
     */
    @JsonProperty("chkPrintChoyoJimu")
    public void setChkPrintChoyoJimu(CheckBoxList chkPrintChoyoJimu) {
        this.chkPrintChoyoJimu = chkPrintChoyoJimu;
    }
    ...
    /*
     * getchkPrintChohyoShinsakaiJimu
     * @return chkPrintChohyoShinsakaiJimu
     */
    @JsonProperty("chkPrintChohyoShinsakaiJimu")
    ...
    /*
     * setchkPrintChohyoShinsakaiJimu
     * @param chkPrintChohyoShinsakaiJimu chkPrintChohyoShinsakaiJimu
     */
    @JsonProperty("chkPrintChohyoShinsakaiJimu")
