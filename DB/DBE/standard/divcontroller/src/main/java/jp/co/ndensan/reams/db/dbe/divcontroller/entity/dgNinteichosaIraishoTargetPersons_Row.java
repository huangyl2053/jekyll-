...
/**
 * dgNinteichosaIraishoTargetPersons_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgNinteichosaIraishoTargetPersons_Row extends DataRow {
    ...
    public dgNinteichosaIraishoTargetPersons_Row() {
        super();
    }

    public dgNinteichosaIraishoTargetPersons_Row(RString chosaKikanCode, RString chosaKikanName, RString chosainCode, RString chosainName, RString hihokenshaNo, RString hihokenshaName, RString shinseiDate, RString shinseiKubun, RString chosaIraiDate, RString iraishoHakkoDate) {
        super();
