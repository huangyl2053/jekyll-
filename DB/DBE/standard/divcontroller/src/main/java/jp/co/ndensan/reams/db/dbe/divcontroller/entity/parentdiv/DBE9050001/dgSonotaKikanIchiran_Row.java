...
public class dgSonotaKikanIchiran_Row extends DataRow {
    ...
    public dgSonotaKikanIchiran_Row() {
        ...
        this.setOriginalData("kikanKana", kikanKana);
        this.setOriginalData("yubinNo", yubinNo);
        this.setOriginalData("jusho", jusho);
        this.setOriginalData("jushoKana", jushoKana);
    ...
    public void setKikanKana(RString kikanKana) {
        this.setOriginalData("kikanKana", kikanKana);
        this.kikanKana = kikanKana;
    }
