...
public class NinteiChosainJikanMasterHandler {
    ...
    private void 一括設定時間枠一と一括設定時間枠二(FlexibleDate 予定日,
        ...
        switch (Integer.parseInt(時間枠.toString())) {
            case 時間枠_1:
                ...
                set一括設定Model(予定日, row.getSyoriKben01(), 時間の処理(認定調査予定開始時間), 時間の処理(認定調査予定終了時間), 時間枠);
                break;
            case 時間枠_2:
                ...
                set一括設定Model(予定日, row.getSyoriKben02(), 時間の処理(認定調査予定開始時間), 時間の処理(認定調査予定終了時間), 時間枠);
                break;
            default:
                break;
        }
    ...
    private void 一括設定時間枠三と一括設定時間枠四(FlexibleDate 予定日,
        ...
        switch (Integer.parseInt(時間枠.toString())) {
            case 時間枠_3:
                ...
                set一括設定Model(予定日, row.getSyoriKben03(), 時間の処理(認定調査予定開始時間), 時間の処理(認定調査予定終了時間), 時間枠);
                break;
            case 時間枠_4:
                ...
                set一括設定Model(予定日, row.getSyoriKben04(), 時間の処理(認定調査予定開始時間), 時間の処理(認定調査予定終了時間), 時間枠);
                break;
            default:
                break;
        }
    ...
    private void 一括設定時間枠五と一括設定時間枠六(FlexibleDate 予定日,
        ...
        switch (Integer.parseInt(時間枠.toString())) {
            case 時間枠_5:
                ...
                set一括設定Model(予定日, row.getSyoriKben05(), 時間の処理(認定調査予定開始時間), 時間の処理(認定調査予定終了時間), 時間枠);
                break;
            case 時間枠_6:
                ...
                set一括設定Model(予定日, row.getSyoriKben06(), 時間の処理(認定調査予定開始時間), 時間の処理(認定調査予定終了時間), 時間枠);
                break;
            default:
                break;
        }
    ...
    private void 一括設定時間枠七と一括設定時間枠八(FlexibleDate 予定日,
        ...
        switch (Integer.parseInt(時間枠.toString())) {
            case 時間枠_7:
                ...
                set一括設定Model(予定日, row.getSyoriKben07(), 時間の処理(認定調査予定開始時間), 時間の処理(認定調査予定終了時間), 時間枠);
                break;
            case 時間枠_8:
                ...
                set一括設定Model(予定日, row.getSyoriKben08(), 時間の処理(認定調査予定開始時間), 時間の処理(認定調査予定終了時間), 時間枠);
                break;
            default:
                break;
        }
    ...
    private void 一括設定時間枠九と一括設定時間枠十(FlexibleDate 予定日,
        ...
        switch (Integer.parseInt(時間枠.toString())) {
            case 時間枠_9:
                ...
                set一括設定Model(予定日, row.getSyoriKben09(), 時間の処理(認定調査予定開始時間), 時間の処理(認定調査予定終了時間), 時間枠);
                break;
            case 時間枠_10:
                ...
                set一括設定Model(予定日, row.getSyoriKben10(), 時間の処理(認定調査予定開始時間), 時間の処理(認定調査予定終了時間), 時間枠);
                break;
            default:
                break;
        }
    ...
    private void 一括設定時間枠一と一括設定時間枠二(
        ...
        switch (Integer.parseInt(時間枠.toString())) {
            case 時間枠_1:
                row.setChosaJikanwaku01(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                row.setHiddenChosaJikanwaku01(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                break;
            case 時間枠_2:
                row.setChosaJikanwaku02(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                row.setHiddenChosaJikanwaku02(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                break;
            default:
                break;
        }
    ...
    private void 一括設定時間枠三と一括設定時間枠四(
        ...
        switch (Integer.parseInt(時間枠.toString())) {
            case 時間枠_3:
                row.setChosaJikanwaku03(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                row.setHiddenChosaJikanwaku03(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                break;
            case 時間枠_4:
                row.setChosaJikanwaku04(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                row.setHiddenChosaJikanwaku04(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                break;
            default:
                break;
        }
    ...
    private void 一括設定時間枠五と一括設定時間枠六(
        ...
        switch (Integer.parseInt(時間枠.toString())) {
            case 時間枠_5:
                row.setChosaJikanwaku05(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                row.setHiddenChosaJikanwaku05(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                break;
            case 時間枠_6:
                row.setChosaJikanwaku06(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                row.setHiddenChosaJikanwaku06(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                break;
            default:
                break;
        }
    ...
    private void 一括設定時間枠七と一括設定時間枠八(
        ...
        switch (Integer.parseInt(時間枠.toString())) {
            case 時間枠_7:
                row.setChosaJikanwaku07(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                row.setHiddenChosaJikanwaku07(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                break;
            case 時間枠_8:
                row.setChosaJikanwaku08(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                row.setHiddenChosaJikanwaku08(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                break;
            default:
                break;
        }
    ...
    private void 一括設定時間枠九と一括設定時間枠十(
        ...
        switch (Integer.parseInt(時間枠.toString())) {
            case 時間枠_9:
                row.setChosaJikanwaku09(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                row.setHiddenChosaJikanwaku09(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                break;
            case 時間枠_10:
                row.setChosaJikanwaku10(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                row.setHiddenChosaJikanwaku10(予定時間(認定調査予定開始時間, 認定調査予定終了時間));
                break;
            default:
                break;
        }
...
//        div.getMainPanel().getBtnNinteiChosaIkkatsuInput().setDisabled(true);
    ...
    private RString 開始_終了時間の取得(RString 時間枠) {
        ...
        switch (Integer.parseInt(時間枠.toString())) {
            case 時間枠_1:
                開始_終了時間 = BusinessConfig.get(ConfigNameDBE.調査スケジュール時間枠1, SubGyomuCode.DBE認定支援);
                break;
            case 時間枠_2:
                開始_終了時間 = BusinessConfig.get(ConfigNameDBE.調査スケジュール時間枠2, SubGyomuCode.DBE認定支援);
                break;
            case 時間枠_3:
                開始_終了時間 = BusinessConfig.get(ConfigNameDBE.調査スケジュール時間枠3, SubGyomuCode.DBE認定支援);
                break;
            case 時間枠_4:
                開始_終了時間 = BusinessConfig.get(ConfigNameDBE.調査スケジュール時間枠4, SubGyomuCode.DBE認定支援);
                break;
            case 時間枠_5:
                開始_終了時間 = BusinessConfig.get(ConfigNameDBE.調査スケジュール時間枠5, SubGyomuCode.DBE認定支援);
                break;
            case 時間枠_6:
                開始_終了時間 = BusinessConfig.get(ConfigNameDBE.調査スケジュール時間枠6, SubGyomuCode.DBE認定支援);
                break;
            case 時間枠_7:
                開始_終了時間 = BusinessConfig.get(ConfigNameDBE.調査スケジュール時間枠7, SubGyomuCode.DBE認定支援);
                break;
            case 時間枠_8:
                開始_終了時間 = BusinessConfig.get(ConfigNameDBE.調査スケジュール時間枠8, SubGyomuCode.DBE認定支援);
                break;
            case 時間枠_9:
                開始_終了時間 = BusinessConfig.get(ConfigNameDBE.調査スケジュール時間枠9, SubGyomuCode.DBE認定支援);
                break;
            case 時間枠_10:
                開始_終了時間 = BusinessConfig.get(ConfigNameDBE.調査スケジュール時間枠10, SubGyomuCode.DBE認定支援);
                break;
            default:
                break;
        }
