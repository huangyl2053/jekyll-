...
public class dgTaishoshaIchiran_Row extends DataRow {
    ...
    private TextBoxNum saiChosaIraiKaisu;
    private RString iryoKikan;
    private RString shujii;
    private TextBoxNum saiSakuseiIraiKaisu;
    ...
    public dgTaishoshaIchiran_Row() {
        ...
        this.saiChosaIraiKaisu = new TextBoxNum();
        this.iryoKikan = RString.EMPTY;
        this.shujii = RString.EMPTY;
        this.saiSakuseiIraiKaisu = new TextBoxNum();
        ...
        this.setOriginalData("saiChosaIraiKaisu", saiChosaIraiKaisu);
        this.setOriginalData("iryoKikan", iryoKikan);
        this.setOriginalData("shujii", shujii);
        this.setOriginalData("saiSakuseiIraiKaisu", saiSakuseiIraiKaisu);
    ...
    public TextBoxNum getSaiChosaIraiKaisu() {
    ...
    public TextBoxNum getSaiSakuseiIraiKaisu() {
    ...
    public void setSaiChosaIraiKaisu(TextBoxNum saiChosaIraiKaisu) {
        this.setOriginalData("saiChosaIraiKaisu", saiChosaIraiKaisu);
        this.saiChosaIraiKaisu = saiChosaIraiKaisu;
    }
    ...
    public void setSaiSakuseiIraiKaisu(TextBoxNum saiSakuseiIraiKaisu) {
        this.setOriginalData("saiSakuseiIraiKaisu", saiSakuseiIraiKaisu);
        this.saiSakuseiIraiKaisu = saiSakuseiIraiKaisu;
    }
