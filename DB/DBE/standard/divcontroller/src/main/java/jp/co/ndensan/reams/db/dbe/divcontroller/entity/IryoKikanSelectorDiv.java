 ...
 * 不正な動作の原因になります。
 */
import jp.co.ndensan.reams.db.dbe.divcontroller.entity.IIryoKikanSelectorDiv;
import com.fasterxml.jackson.annotation.JsonProperty;
import jp.co.ndensan.reams.db.dbe.divcontroller.entity.IryoKikanDiv;
 ...
 * @author 自動生成
 */
public class IryoKikanSelectorDiv extends Panel implements IIryoKikanSelectorDiv {
    /*
     * [ private の作成 ]
