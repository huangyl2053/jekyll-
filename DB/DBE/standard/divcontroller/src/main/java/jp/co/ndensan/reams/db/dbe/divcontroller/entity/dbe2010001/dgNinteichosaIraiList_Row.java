...
public class dgNinteichosaIraiList_Row extends DataRow {
    ...
    private TextBoxFlexibleDate 依頼日;
    private TextBoxFlexibleDate 依頼書発行日;
    private TextBoxFlexibleDate 依頼完了日;
    private RString 調査依頼区分;
    private RString 調査回数;
    private RString 認定調査履歴番号;
    private TextBoxFlexibleDate 調査期限;
    ...
    private RString 督促年月日;
    private RString 督促回数;
    private TextBoxFlexibleDate 督促期限;
    ...
    public dgNinteichosaIraiList_Row(RString 保険者番号, RString 保険者, RString 支所コード, RString 支所, RString 被保険者番号, RString 氏名, RString カナ氏名, RString 氏名Withカナ, TextBoxFlexibleDate 認定申請日, RString 認定申請区分申請時, RString 申請書管理番号, TextBoxFlexibleDate 依頼日, TextBoxFlexibleDate 依頼書発行日, TextBoxFlexibleDate 依頼完了日, RString 調査依頼区分, RString 調査回数, RString 認定調査履歴番号, TextBoxFlexibleDate 調査期限, RString 調査委託先コード, RString 調査委託先, RString 調査員コード, RString 調査員, RString 前回調査委託先コード, RString 前回調査委託先, RString 前回調査員コード, RString 前回調査員, RString 審査会開催地区コード, RString 審査会開催地区, RString 督促年月日, RString 督促回数, TextBoxFlexibleDate 督促期限, TextBoxFlexibleDate 督促発行日, RString 住所, RString 郵便番号, RString 入所施設, RString データ出力) {
        super();
        ...
        this.setOriginalData("依頼日", 依頼日);
        this.setOriginalData("依頼書発行日", 依頼書発行日);
        this.setOriginalData("依頼完了日", 依頼完了日);
        this.setOriginalData("調査依頼区分", 調査依頼区分);
        this.setOriginalData("調査回数", 調査回数);
        this.setOriginalData("認定調査履歴番号", 認定調査履歴番号);
        this.setOriginalData("調査期限", 調査期限);
        ...
        this.setOriginalData("督促期限", 督促期限);
    ...
    public TextBoxFlexibleDate get依頼日() {
        return 依頼日;
    }

    public TextBoxFlexibleDate get依頼書発行日() {
        return 依頼書発行日;
    }

    public TextBoxFlexibleDate get依頼完了日() {
        return 依頼完了日;
    }
    ...
    public TextBoxFlexibleDate get調査期限() {
        return 調査期限;
    }
    ...
    public TextBoxFlexibleDate get督促期限() {
        return 督促期限;
    }
    ...
    public void set依頼日(TextBoxFlexibleDate 依頼日) {
        this.setOriginalData("依頼日", 依頼日);
        this.依頼日 = 依頼日;
    }

    public void set依頼書発行日(TextBoxFlexibleDate 依頼書発行日) {
        this.setOriginalData("依頼書発行日", 依頼書発行日);
        this.依頼書発行日 = 依頼書発行日;
    }

    public void set依頼完了日(TextBoxFlexibleDate 依頼完了日) {
        this.setOriginalData("依頼完了日", 依頼完了日);
        this.依頼完了日 = 依頼完了日;
    }
    ...
    public void set調査期限(TextBoxFlexibleDate 調査期限) {
        this.setOriginalData("調査期限", 調査期限);
        this.調査期限 = 調査期限;
    }
    ...
    public void set督促年月日(RString 督促年月日) {
        this.setOriginalData("督促年月日", 督促年月日);
        this.督促年月日 = 督促年月日;
    }
    ...
    public void set督促期限(TextBoxFlexibleDate 督促期限) {
        this.setOriginalData("督促期限", 督促期限);
        this.督促期限 = 督促期限;
    }
