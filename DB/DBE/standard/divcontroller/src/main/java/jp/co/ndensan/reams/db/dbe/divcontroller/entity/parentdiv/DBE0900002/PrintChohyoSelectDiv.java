...
/**
 * PrintChohyoSelect のクラスファイル 
 * 
 * @author 自動生成
 */
public class PrintChohyoSelectDiv extends Panel {
     ...
     */
    @JsonProperty("radOutputHoho")
    private RadioButton radOutputHoho;
    ...
    private CheckBoxList chkTokkiJiko;
    @JsonProperty("radTokkiJikoMasking")
    private RadioButton radTokkiJikoMasking;
    @JsonProperty("chkShujiiIkensho")
    private CheckBoxList chkShujiiIkensho;
    @JsonProperty("radShujiiMasking")
    private RadioButton radShujiiMasking;
    @JsonProperty("chkSonotaShiryo")
    private CheckBoxList chkSonotaShiryo;
    @JsonProperty("radSonotaShiryoMasking")
    private RadioButton radSonotaShiryoMasking;
    ...
    /*
     * setradOutputHoho
     * @param radOutputHoho radOutputHoho
     */
    @JsonProperty("radOutputHoho")
    public void setRadOutputHoho(RadioButton radOutputHoho) {
        this.radOutputHoho = radOutputHoho;
    }
    ...
    /*
     * setchkTokkiJiko
     * @param chkTokkiJiko chkTokkiJiko
     */
    @JsonProperty("chkTokkiJiko")
    ...
    /*
     * getradTokkiJikoMasking
     * @return radTokkiJikoMasking
     */
    @JsonProperty("radTokkiJikoMasking")
     ...
     * @param radTokkiJikoMasking radTokkiJikoMasking
     */
    @JsonProperty("radTokkiJikoMasking")
    ...
    /*
     * setradShujiiMasking
     * @param radShujiiMasking radShujiiMasking
     */
    @JsonProperty("radShujiiMasking")
    public void setRadShujiiMasking(RadioButton radShujiiMasking) {
        this.radShujiiMasking = radShujiiMasking;
    }

    /*
     * getchkSonotaShiryo
     * @return chkSonotaShiryo
     */
    @JsonProperty("chkSonotaShiryo")
    ...
    /*
     * setchkSonotaShiryo
     * @param chkSonotaShiryo chkSonotaShiryo
     */
    @JsonProperty("chkSonotaShiryo")
    ...
    /*
     * getradSonotaShiryoMasking
     * @return radSonotaShiryoMasking
     */
    @JsonProperty("radSonotaShiryoMasking")
     ...
     * @param radSonotaShiryoMasking radSonotaShiryoMasking
     */
    @JsonProperty("radSonotaShiryoMasking")
    public void setRadSonotaShiryoMasking(RadioButton radSonotaShiryoMasking) {
        this.radSonotaShiryoMasking = radSonotaShiryoMasking;
    }

    /*
     * getchkIchijiHanteiKekka
     * @return chkIchijiHanteiKekka
     */
    @JsonProperty("chkIchijiHanteiKekka")
    ...
    /*
     * setchkIchijiHanteiKekka
     * @param chkIchijiHanteiKekka chkIchijiHanteiKekka
     */
    @JsonProperty("chkIchijiHanteiKekka")
