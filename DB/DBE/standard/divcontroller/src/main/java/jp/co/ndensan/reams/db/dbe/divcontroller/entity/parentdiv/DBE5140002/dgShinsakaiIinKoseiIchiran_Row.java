...
public class dgShinsakaiIinKoseiIchiran_Row extends DataRow {
    ...
    public dgShinsakaiIinKoseiIchiran_Row() {
        super();
    ...
    public RString getShinsakaiInnShikaku() {
        return shinsakaiInnShikaku;
    }
    ...
    public RString getShinsakaiIinKaishibi() {
        return shinsakaiIinKaishibi;
    }

    public RString getShinsakaiIinShuryobi() {
        return shinsakaiIinShuryobi;
    }
    ...
    public void setShinsakaiInnShikaku(RString shinsakaiInnShikaku) {
        this.setOriginalData("shinsakaiInnShikaku", shinsakaiInnShikaku);
        this.shinsakaiInnShikaku = shinsakaiInnShikaku;
    }
    ...
    public void setShinsakaiIinShuryobi(RString shinsakaiIinShuryobi) {
        this.setOriginalData("shinsakaiIinShuryobi", shinsakaiIinShuryobi);
        this.shinsakaiIinShuryobi = shinsakaiIinShuryobi;
    }
