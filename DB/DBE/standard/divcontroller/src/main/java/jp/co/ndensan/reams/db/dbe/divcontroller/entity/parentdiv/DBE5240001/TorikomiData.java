...
public class TorikomiData implements Serializable {
    ...
    @CsvField(order = 6, name = "審査員1")
    private RString 審査員1;
    @CsvField(order = 7, name = "審査員2")
    private RString 審査員2;
    @CsvField(order = 8, name = "審査員3")
    private RString 審査員3;
    @CsvField(order = 9, name = "審査員4")
    private RString 審査員4;
    @CsvField(order = 10, name = "審査員5")
    private RString 審査員5;
    @CsvField(order = 11, name = "審査員6")
    private RString 審査員6;
    @CsvField(order = 12, name = "審査員7")
    private RString 審査員7;
    @CsvField(order = 13, name = "審査員8")
    private RString 審査員8;
    @CsvField(order = 14, name = "ID2")
    private RString ID2;
    @CsvField(order = 15, name = "保険者番号")
    private RString 保険者番号;
    @CsvField(order = 16, name = "被保険者番号")
    private RString 被保険者番号;
    @CsvField(order = 17, name = "非該当")
    private RString 非該当;
    @CsvField(order = 18, name = "要支援1")
    private RString 要支援1;
    @CsvField(order = 19, name = "要支援2")
    private RString 要支援2;
    @CsvField(order = 20, name = "要介護1")
    private RString 要介護1;
    @CsvField(order = 21, name = "要介護2")
    private RString 要介護2;
    @CsvField(order = 22, name = "要介護3")
    private RString 要介護3;
    @CsvField(order = 23, name = "要介護4")
    private RString 要介護4;
    @CsvField(order = 24, name = "要介護5")
    private RString 要介護5;
    @CsvField(order = 25, name = "状態像1")
    private RString 状態像1;
    @CsvField(order = 26, name = "状態像2")
    private RString 状態像2;
    @CsvField(order = 27, name = "再調査")
    private RString 再調査;
    @CsvField(order = 28, name = "取下げ")
    private RString 取下げ;
    @CsvField(order = 29, name = "認定有効期間")
