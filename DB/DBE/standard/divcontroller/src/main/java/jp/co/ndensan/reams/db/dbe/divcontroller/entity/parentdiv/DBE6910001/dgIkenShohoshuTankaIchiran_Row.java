...
public class dgIkenShohoshuTankaIchiran_Row extends DataRow {
    ...
    public dgIkenShohoshuTankaIchiran_Row(RString columnState, RString zaitakuShisetsuKubun, RString zaitakuShisetsuKubunCode, RString ikenshoSakuseiKaisuKubun, RString ikenshoSakuseiKaisuKubunCode, TextBoxFlexibleDate kaishiYM, TextBoxFlexibleDate shuryoYM, TextBoxNum tanka) {
        super();
        this.setOriginalData("columnState", columnState);
        this.setOriginalData("zaitakuShisetsuKubun", zaitakuShisetsuKubun);
        this.setOriginalData("zaitakuShisetsuKubunCode", zaitakuShisetsuKubunCode);
