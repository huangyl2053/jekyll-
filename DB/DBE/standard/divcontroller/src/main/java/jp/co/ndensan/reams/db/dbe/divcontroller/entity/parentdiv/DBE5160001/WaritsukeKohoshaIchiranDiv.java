...
public class WaritsukeKohoshaIchiranDiv extends Panel {
    ...
    @JsonProperty("chkKohoshaFilter")
    private CheckBoxList chkKohoshaFilter;
    ...
    /*
     * setchkKohoshaFilter
     * @param chkKohoshaFilter chkKohoshaFilter
     */
    @JsonProperty("chkKohoshaFilter")
    public void setChkKohoshaFilter(CheckBoxList chkKohoshaFilter) {
        this.chkKohoshaFilter = chkKohoshaFilter;
    }
