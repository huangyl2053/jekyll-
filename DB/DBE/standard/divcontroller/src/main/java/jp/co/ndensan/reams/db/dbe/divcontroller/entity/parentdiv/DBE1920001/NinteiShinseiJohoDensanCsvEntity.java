...
public class NinteiShinseiJohoDensanCsvEntity {
    ...
    @CsvField(order = 405, name = "前回結果 経管栄養")
    private RString 経管栄養;
    @CsvField(order = 406, name = "前回結果 モニター測定")
    ...
    private RString 訪問介護_ホームヘルプサービス_;
    ...
    @CsvField(order = 175, name = "市町村コード")
    private RString 市町村コード;
    @CsvField(order = 176, name = "本人連絡先2")
    private RString 本人連絡先2;
    @CsvField(order = 177, name = "特定疾病コード")
    private RString 特定疾病コード;
    @CsvField(order = 178, name = "入所事業所コード")
    private RString 入所事業所コード;
    @CsvField(order = 179, name = "入所施設名(カナ)")
    private RString 入所施設名_カナ;
    @CsvField(order = 180, name = "入所施設郵便番号")
    private RString 入所施設郵便番号;
    @CsvField(order = 181, name = "入所施設電話番号")
    private RString 入所施設電話番号;
    @CsvField(order = 182, name = "本人緊急連絡先名称1")
    private RString 本人緊急連絡先名称1;
    @CsvField(order = 183, name = "本人緊急連絡先住所1")
    private RString 本人緊急連絡先住所1;
    @CsvField(order = 184, name = "本人緊急連絡先番号1")
    private RString 本人緊急連絡先番号1;
    @CsvField(order = 185, name = "本人緊急連絡先名称2")
    private RString 本人緊急連絡先名称2;
    @CsvField(order = 186, name = "本人緊急連絡先住所2")
    private RString 本人緊急連絡先住所2;
    @CsvField(order = 187, name = "本人緊急連絡先番号2")
    private RString 本人緊急連絡先番号2;
    @CsvField(order = 188, name = "申請者関係コード")
    private RString 申請者関係コード;
    @CsvField(order = 189, name = "本人との関係")
    private RString 本人との関係;
    @CsvField(order = 190, name = "申請者氏名")
    private RString 申請者氏名;
    @CsvField(order = 191, name = "申請者氏名カナ")
    private RString 申請者氏名カナ;
    @CsvField(order = 192, name = "申請代行事業者名")
    private RString 申請代行事業者名;
    @CsvField(order = 193, name = "申請代行事業者名カナ")
    private RString 申請代行事業者名カナ;
    @CsvField(order = 194, name = "申請者郵便番号")
    private RString 申請者郵便番号;
    @CsvField(order = 195, name = "申請者住所")
    private RString 申請者住所;
    @CsvField(order = 196, name = "申請者連絡先")
    private RString 申請者連絡先;
    @CsvField(order = 197, name = "調査委託先コード")
