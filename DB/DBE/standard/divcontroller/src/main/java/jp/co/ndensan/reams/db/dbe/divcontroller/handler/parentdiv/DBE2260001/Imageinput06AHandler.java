...
public class Imageinput06AHandler {
    ...
    public ShujiiIkenshoJoho set06A項目(ShujiiIkenshoJoho joho, dgshinseishaichiran_Row row, TorokuData data) {
        ...
        if (KoroshoIfShikibetsuCode.認定ｿﾌﾄ2006_新要介護認定適用区分が未適用.getコード().equals(data.getT5101_厚労省IF識別コード())) {
            for (ShujiiIkenshoKinyuItem item : itemList) {
                joho = set06A記入項目1(joho, row, data, item);
                joho = set06A記入項目2(joho, row, data, item);
                joho = set06A記入項目3(joho, row, data, item);
                joho = set06A記入項目4(joho, row, data, item);
            }
            for (ShujiiIkenshoIkenItem 意見項目 : 意見項目List) {
                joho = set06A意見項目1(joho, row, data, 意見項目);
                joho = set06A意見項目2(joho, row, data, 意見項目);
                joho = set06A意見項目3(joho, row, data, 意見項目);
                joho = set06A意見項目4(joho, row, data, 意見項目);
                joho = set06A意見項目5(joho, row, data, 意見項目);
                joho = set06A意見項目6(joho, row, data, 意見項目);
                joho = set06A意見項目7(joho, row, data, 意見項目);
                joho = set06A意見項目8(joho, row, data, 意見項目);
                joho = set06A意見項目9(joho, row, data, 意見項目);
                joho = set06A意見項目10(joho, row, data, 意見項目);
                joho = set06A意見項目11(joho, row, data, 意見項目);
                joho = set06A意見項目12(joho, row, data, 意見項目);
                joho = set06A意見項目13(joho, row, data, 意見項目);
            }
        }
        return joho;
    }

    private ShujiiIkenshoJoho set06A記入項目1(ShujiiIkenshoJoho joho,
    ...
    private ShujiiIkenshoJoho set06A記入項目2(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoKinyuItem item) {
    ...
    private ShujiiIkenshoJoho set06A記入項目3(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoKinyuItem item) {
    ...
    private ShujiiIkenshoJoho set06A記入項目4(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoKinyuItem item) {
    ...
    private ShujiiIkenshoJoho set06A意見項目1(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
    ...
    private ShujiiIkenshoJoho set06A意見項目2(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
    ...
    private ShujiiIkenshoJoho set06A意見項目3(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
    ...
    private ShujiiIkenshoJoho set06A意見項目4(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
    ...
    private ShujiiIkenshoJoho set06A意見項目5(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
    ...
    private ShujiiIkenshoJoho set06A意見項目6(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
    ...
    private ShujiiIkenshoJoho set06A意見項目7(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
    ...
    private ShujiiIkenshoJoho set06A意見項目8(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
    ...
    private ShujiiIkenshoJoho set06A意見項目9(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
    ...
    private ShujiiIkenshoJoho set06A意見項目10(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
    ...
    private ShujiiIkenshoJoho set06A意見項目11(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
    ...
    private ShujiiIkenshoJoho set06A意見項目12(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
    ...
    private ShujiiIkenshoJoho set06A意見項目13(ShujiiIkenshoJoho joho,
            dgshinseishaichiran_Row row,
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
