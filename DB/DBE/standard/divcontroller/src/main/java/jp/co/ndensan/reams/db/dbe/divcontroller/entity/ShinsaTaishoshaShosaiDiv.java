...
public class ShinsaTaishoshaShosaiDiv extends TablePanel {
    ...
    @JsonIgnore
    public Button getBtnIchijiHanteiKekka() {
        return this.tblIchijiHantei.getBtnIchijiHanteiKekka();
    }
...
class tblIchijiHanteiAtShinsaTaishoshaShosai extends TableCell {
    @JsonProperty("btnIchijiHanteiKekka")
    private Button btnIchijiHanteiKekka;

    @JsonProperty("btnIchijiHanteiKekka")
    public Button getBtnIchijiHanteiKekka() {
        return btnIchijiHanteiKekka;
    }

    @JsonProperty("btnIchijiHanteiKekka")
    public void setBtnIchijiHanteiKekka(Button btnIchijiHanteiKekka) {
        this.btnIchijiHanteiKekka=btnIchijiHanteiKekka;
    }
