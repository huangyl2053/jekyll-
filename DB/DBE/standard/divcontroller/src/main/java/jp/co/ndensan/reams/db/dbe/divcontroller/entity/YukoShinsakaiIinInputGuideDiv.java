 ...
 * 不正な動作の原因になります。
 */
import jp.co.ndensan.reams.db.dbe.divcontroller.entity.IYukoShinsakaiIinInputGuideDiv;
 ...
 * @author 自動生成
 */
public class YukoShinsakaiIinInputGuideDiv extends Panel implements IYukoShinsakaiIinInputGuideDiv {
    /*
     * [ private の作成 ]
