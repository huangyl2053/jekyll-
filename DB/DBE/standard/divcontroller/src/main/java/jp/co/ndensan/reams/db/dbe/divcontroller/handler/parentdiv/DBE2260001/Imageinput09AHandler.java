...
public class Imageinput09AHandler {
    ...
    public ShujiiIkenshoJoho set09A項目(ShujiiIkenshoJoho joho, dgshinseishaichiran_Row row, TorokuData data) {
        ...
        if (KoroshoIfShikibetsuCode.認定ｿﾌﾄ2009.getコード().equals(data.getT5101_厚労省IF識別コード())) {
            for (ShujiiIkenshoKinyuItem item : itemList) {
                item = set09A記入項目1(data, item);
                item = set09A記入項目2(data, item);
                item = set09A記入項目3(data, item);
                item = set09A記入項目4(data, item);
            ...
            for (ShujiiIkenshoIkenItem 意見項目 : 意見項目List) {
                ...
                意見項目 = set09A意見項目7(data, 意見項目);
                意見項目 = set09A意見項目8(row, data, 意見項目);
                意見項目 = set09A意見項目9(data, 意見項目);
                意見項目 = set09A意見項目10(data, 意見項目);
                意見項目 = set09A意見項目11(data, 意見項目);
                意見項目 = set09A意見項目12(data, 意見項目);
    ...
    private void set新規の記入項目1(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.その他.getコード())) {
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.その他の精神_神経症状.getコード())) {
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.専門医受診の有無.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.身長.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.体重.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.四肢欠損.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.麻痺_その他.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.筋力の低下.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.関節の拘縮.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の記入項目2(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.関節の痛み.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.じょくそう.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.その他の皮膚疾患.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.栄養_食生活上の留意点.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.病態_その他.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.病態_対処方針.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.その他の医療系のサービス.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.介護サービスの留意事項_血圧.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.介護サービスの留意事項_嚥下.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の記入項目3(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.介護サービスの留意事項_摂食.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!記入項目連番レスト.contains(IkenshoKinyuMapping09A.介護サービスの留意事項_移動.getコード())) {
            ShujiiIkenshoKinyuItem なしデータ = new ShujiiIkenshoKinyuItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目1(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.点滴の管理.getコード())) {
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.中心静脈栄養.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.透析.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.ストーマの処置.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.酸素療法.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.レスピレーター.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.気管切開の処置.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.疼痛の看護.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.経管栄養.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目2(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.モニター測定.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.じょくそうの処置.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.カテーテル.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.寝たきり度.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.認知症高齢者の日常生活自立度.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.短期記憶.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.認知能力.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.伝達能力.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.認知症の周辺症状.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目3(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.幻視_幻聴.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.妄想.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.昼夜逆転.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.暴言.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.暴行.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.介護への抵抗.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.徘徊_認知症の周辺症状.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.火の不始末.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.過去6カ月の体重の変化.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目4(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.不潔行為.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.異食行動.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.性的問題行動.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.その他.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.その他の精神_神経症状.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.専門医受診の有無.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.利き腕.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.四肢欠損.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.麻痺.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目5(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.麻痺_右上肢.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.筋力の低下.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.筋力の低下_程度.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.じょくそう.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.じょくそう_程度.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.その他の皮膚疾患.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.その他の皮膚疾患_程度.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.関節の拘縮.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.関節の拘縮_程度.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目6(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.関節の痛み.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.関節の痛み_程度.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.屋外歩行.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.車いすの使用.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.歩行補助具_装具の使用_用いていない.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.歩行補助具_装具の使用_屋外で使用.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.歩行補助具_装具の使用_屋内で使用.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.失調_不随意運動.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.失調_不随意運動_上肢_左.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目7(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.失調_不随意運動_体幹_右.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.失調_不随意運動_下肢_右.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.失調_不随意運動_下肢_左.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.尿失禁.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.転倒_骨折.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.移動能力の低下.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.褥瘡.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.食事行為.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.現在の栄養状態.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目8(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.易感染性.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.心肺機能の低下.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.がん等による疼痛.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.脱水.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.病態_その他.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問診療.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問診療_必要性.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問看護.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問看護_必要性.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目10(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問歯科衛生指導_必要性.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問薬剤管理指導.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問薬剤管理指導_必要性.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問栄養食事指導.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問栄養食事指導_必要性.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.その他の医療系のサービス.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.その他の医療系のサービス_必要性.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.介護サービスの留意事項_血圧.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.介護サービスの留意事項_嚥下.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目9(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問リハビリテーション.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問リハビリテーション_必要性.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.通所リハビリテーション.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.通所リハビリテーション_必要性.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.短期入所療養介護.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.短期入所療養介護_必要性.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問歯科診療.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問歯科診療_必要性.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.訪問歯科衛生指導.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目11(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.介護サービスの留意事項_摂食.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.介護サービスの留意事項_移動.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.感染症の有無.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.失調_不随意運動_体幹_左.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.看護職員による相談.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.看護職員による相談_必要性.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.麻痺_右上肢_程度.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.麻痺_左上肢.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.麻痺_左上肢_程度.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目12(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.麻痺_右下肢_程度.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.麻痺_左下肢.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.麻痺_左下肢_程度.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.麻痺_その他.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.麻痺_その他_程度.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.閉じこもり.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.意欲低下.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.徘徊_可能性が高い病態.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.低栄養.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
    ...
    private void set新規の意見項目13(ShujiiIkenshoJohoBuilder builder, dgshinseishaichiran_Row row, TorokuData data) {
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.摂食_嚥下機能低下.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.生活機能の維持_改善の見通し.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.麻痺_右下肢.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.失調_不随意運動_上肢_右.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
        ...
        if (!意見項目連番レスト.contains(IkenshoKomokuMapping09A.介護サービスの留意事項_運動.getコード())) {
            ShujiiIkenshoIkenItem なしデータ = new ShujiiIkenshoIkenItem(new ShinseishoKanriNo(row.getShinseishoKanriNo()),
                    data.getT5301_主治医意見書作成依頼履歴番号(), rStringToInt(IkenshoKomokuMapping09A.介護サービスの留意事項_運動.getコード()));
    ...
    private ShujiiIkenshoKinyuItem set09A記入項目1(
            TorokuData data,
        ...
        if (IkenshoKinyuMapping09A.その他.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.その他.getコード());
        }
        if (IkenshoKinyuMapping09A.その他の精神_神経症状.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.その他の精神_神経症状.getコード());
        }
        if (IkenshoKinyuMapping09A.専門医受診の有無.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.専門医受診の有無.getコード());
        }
        if (IkenshoKinyuMapping09A.身長.getコード().equals(new RString(item.get連番()))) {
            item = item.createBuilderForEdit().set記入項目(空白).build();
            記入項目連番レスト.add(IkenshoKinyuMapping09A.身長.getコード());
        }
        if (IkenshoKinyuMapping09A.体重.getコード().equals(new RString(item.get連番()))) {
            item = item.createBuilderForEdit().set記入項目(空白).build();
            記入項目連番レスト.add(IkenshoKinyuMapping09A.体重.getコード());
        }
        return item;
    }

    private ShujiiIkenshoKinyuItem set09A記入項目2(
            TorokuData data,
            ShujiiIkenshoKinyuItem item) {
        if (IkenshoKinyuMapping09A.四肢欠損.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.四肢欠損.getコード());
        }
        if (IkenshoKinyuMapping09A.麻痺_その他.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.麻痺_その他.getコード());
        }
        if (IkenshoKinyuMapping09A.筋力の低下.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.筋力の低下.getコード());
        }
        if (IkenshoKinyuMapping09A.関節の拘縮.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.関節の拘縮.getコード());
        }
        return item;
    }

    private ShujiiIkenshoKinyuItem set09A記入項目3(
            TorokuData data,
            ShujiiIkenshoKinyuItem item) {
        if (IkenshoKinyuMapping09A.関節の痛み.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.関節の痛み.getコード());
        }
        if (IkenshoKinyuMapping09A.じょくそう.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.じょくそう.getコード());
        }
        if (IkenshoKinyuMapping09A.その他の皮膚疾患.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.その他の皮膚疾患.getコード());
        }
        if (IkenshoKinyuMapping09A.栄養_食生活上の留意点.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.栄養_食生活上の留意点.getコード());
        }
        if (IkenshoKinyuMapping09A.病態_その他.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.病態_その他.getコード());
        }
        if (IkenshoKinyuMapping09A.病態_対処方針.getコード().equals(new RString(item.get連番()))) {
            item = item.createBuilderForEdit().set記入項目(空白).build();
            記入項目連番レスト.add(IkenshoKinyuMapping09A.病態_対処方針.getコード());
        }
        if (IkenshoKinyuMapping09A.その他の医療系のサービス.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.その他の医療系のサービス.getコード());
        }
        if (IkenshoKinyuMapping09A.介護サービスの留意事項_血圧.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.介護サービスの留意事項_血圧.getコード());
        }
        return item;
    }

    private ShujiiIkenshoKinyuItem set09A記入項目4(
            TorokuData data,
            ShujiiIkenshoKinyuItem item) {
        if (IkenshoKinyuMapping09A.介護サービスの留意事項_嚥下.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.介護サービスの留意事項_嚥下.getコード());
        }
        if (IkenshoKinyuMapping09A.介護サービスの留意事項_摂食.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.介護サービスの留意事項_摂食.getコード());
        }
        if (IkenshoKinyuMapping09A.介護サービスの留意事項_移動.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.介護サービスの留意事項_移動.getコード());
        }
        if (IkenshoKinyuMapping09A.介護サービスの留意事項_運動.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.介護サービスの留意事項_運動.getコード());
        }
        if (IkenshoKinyuMapping09A.介護サービスの留意事項_その他.getコード().equals(new RString(item.get連番()))) {
            item = item.createBuilderForEdit().set記入項目(空白).build();
            記入項目連番レスト.add(IkenshoKinyuMapping09A.介護サービスの留意事項_その他.getコード());
        }
        if (IkenshoKinyuMapping09A.感染症の有無.getコード().equals(new RString(item.get連番()))) {
            ...
            記入項目連番レスト.add(IkenshoKinyuMapping09A.感染症の有無.getコード());
        }
        return item;
    }
    ...
    private ShujiiIkenshoIkenItem set09A意見項目1(dgshinseishaichiran_Row row,
        ...
        if (IkenshoKomokuMapping09A.点滴の管理.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.点滴の管理.getコード());
        }
        if (IkenshoKomokuMapping09A.中心静脈栄養.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.中心静脈栄養.getコード());
        }
        if (IkenshoKomokuMapping09A.透析.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.透析.getコード());
        }
        if (IkenshoKomokuMapping09A.ストーマの処置.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.ストーマの処置.getコード());
        }
        if (IkenshoKomokuMapping09A.酸素療法.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.酸素療法.getコード());
        }
        if (IkenshoKomokuMapping09A.レスピレーター.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.レスピレーター.getコード());
        }
        if (IkenshoKomokuMapping09A.気管切開の処置.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.気管切開の処置.getコード());
        }
        ...
        if (IkenshoKomokuMapping09A.モニター測定.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.モニター測定.getコード());
        }
        if (IkenshoKomokuMapping09A.じょくそうの処置.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.じょくそうの処置.getコード());
        }
        if (IkenshoKomokuMapping09A.カテーテル.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.カテーテル.getコード());
        }
        if (IkenshoKomokuMapping09A.寝たきり度.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.寝たきり度.getコード());
        }
        if (IkenshoKomokuMapping09A.認知症高齢者の日常生活自立度.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.認知症高齢者の日常生活自立度.getコード());
        }
        if (IkenshoKomokuMapping09A.短期記憶.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.短期記憶.getコード());
        }
        if (IkenshoKomokuMapping09A.認知能力.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.認知能力.getコード());
        }
        if (IkenshoKomokuMapping09A.伝達能力.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.伝達能力.getコード());
        }
        return item;
    }

    private ShujiiIkenshoIkenItem set09A意見項目3(
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
        if (IkenshoKomokuMapping09A.認知症の周辺症状.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.認知症の周辺症状.getコード());
        }
        if (IkenshoKomokuMapping09A.幻視_幻聴.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.幻視_幻聴.getコード());
        }
        if (IkenshoKomokuMapping09A.妄想.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.妄想.getコード());
        }
        if (IkenshoKomokuMapping09A.昼夜逆転.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.昼夜逆転.getコード());
        }
        if (IkenshoKomokuMapping09A.暴言.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.暴言.getコード());
        }
        if (IkenshoKomokuMapping09A.暴行.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.暴行.getコード());
        }
        if (IkenshoKomokuMapping09A.介護への抵抗.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.介護への抵抗.getコード());
        }
        if (IkenshoKomokuMapping09A.徘徊_認知症の周辺症状.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.徘徊_認知症の周辺症状.getコード());
        }
        if (IkenshoKomokuMapping09A.火の不始末.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.火の不始末.getコード());
        }
        if (IkenshoKomokuMapping09A.過去6カ月の体重の変化.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.過去6カ月の体重の変化.getコード());
        ...
        if (IkenshoKomokuMapping09A.不潔行為.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.不潔行為.getコード());
        }
        if (IkenshoKomokuMapping09A.異食行動.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.異食行動.getコード());
        }
        if (IkenshoKomokuMapping09A.性的問題行動.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.性的問題行動.getコード());
        }
        if (IkenshoKomokuMapping09A.その他.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.その他.getコード());
        }
        if (IkenshoKomokuMapping09A.その他の精神_神経症状.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.その他の精神_神経症状.getコード());
        }
        if (IkenshoKomokuMapping09A.専門医受診の有無.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.専門医受診の有無.getコード());
        }
        if (IkenshoKomokuMapping09A.利き腕.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.利き腕.getコード());
        }
        if (IkenshoKomokuMapping09A.四肢欠損.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.四肢欠損.getコード());
        }
        return item;
    }

    private ShujiiIkenshoIkenItem set09A意見項目5(
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
        if (IkenshoKomokuMapping09A.麻痺.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.麻痺.getコード());
        }
        if (IkenshoKomokuMapping09A.麻痺_右上肢.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.麻痺_右上肢.getコード());
        }
        if (IkenshoKomokuMapping09A.筋力の低下.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.筋力の低下.getコード());
        }
        if (IkenshoKomokuMapping09A.筋力の低下_程度.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.筋力の低下_程度.getコード());
        }
        if (IkenshoKomokuMapping09A.じょくそう.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.じょくそう.getコード());
        }
        if (IkenshoKomokuMapping09A.じょくそう_程度.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.じょくそう_程度.getコード());
        }
        if (IkenshoKomokuMapping09A.その他の皮膚疾患.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.その他の皮膚疾患.getコード());
        }
        if (IkenshoKomokuMapping09A.その他の皮膚疾患_程度.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.その他の皮膚疾患_程度.getコード());
        }
        if (IkenshoKomokuMapping09A.関節の拘縮.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.関節の拘縮.getコード());
        }
        return item;
    }

    private ShujiiIkenshoIkenItem set09A意見項目6(
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
        if (IkenshoKomokuMapping09A.関節の拘縮_程度.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.関節の拘縮_程度.getコード());
        }
        if (IkenshoKomokuMapping09A.関節の痛み.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.関節の痛み.getコード());
        }
        if (IkenshoKomokuMapping09A.関節の痛み_程度.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.関節の痛み_程度.getコード());
        }
        if (IkenshoKomokuMapping09A.屋外歩行.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.屋外歩行.getコード());
        }
        if (IkenshoKomokuMapping09A.車いすの使用.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.車いすの使用.getコード());
        }
        if (IkenshoKomokuMapping09A.歩行補助具_装具の使用_用いていない.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.歩行補助具_装具の使用_用いていない.getコード());
        }
        if (IkenshoKomokuMapping09A.歩行補助具_装具の使用_屋外で使用.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.歩行補助具_装具の使用_屋外で使用.getコード());
        }
        if (IkenshoKomokuMapping09A.歩行補助具_装具の使用_屋内で使用.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.歩行補助具_装具の使用_屋内で使用.getコード());
        }
        if (IkenshoKomokuMapping09A.失調_不随意運動.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.失調_不随意運動.getコード());
        }
        return item;
    }

    private ShujiiIkenshoIkenItem set09A意見項目7(
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
        if (IkenshoKomokuMapping09A.失調_不随意運動_上肢_右.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.失調_不随意運動_上肢_右.getコード());
        }
        if (IkenshoKomokuMapping09A.失調_不随意運動_上肢_左.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.失調_不随意運動_上肢_左.getコード());
        }
        if (IkenshoKomokuMapping09A.失調_不随意運動_体幹_右.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.失調_不随意運動_体幹_右.getコード());
        }
        if (IkenshoKomokuMapping09A.失調_不随意運動_下肢_右.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.失調_不随意運動_下肢_右.getコード());
        }
        if (IkenshoKomokuMapping09A.失調_不随意運動_下肢_左.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.失調_不随意運動_下肢_左.getコード());
        }
        if (IkenshoKomokuMapping09A.尿失禁.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.尿失禁.getコード());
        }
        if (IkenshoKomokuMapping09A.転倒_骨折.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.転倒_骨折.getコード());
        }
        if (IkenshoKomokuMapping09A.移動能力の低下.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.移動能力の低下.getコード());
        }
        if (IkenshoKomokuMapping09A.褥瘡.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.褥瘡.getコード());
        }
        return item;
    }

    private ShujiiIkenshoIkenItem set09A意見項目8(
        ...
        if (IkenshoKomokuMapping09A.食事行為.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.食事行為.getコード());
        }
        ...
        if (IkenshoKomokuMapping09A.心肺機能の低下.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.心肺機能の低下.getコード());
        }
        if (IkenshoKomokuMapping09A.がん等による疼痛.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.がん等による疼痛.getコード());
        }
        if (IkenshoKomokuMapping09A.脱水.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.脱水.getコード());
        }
        if (IkenshoKomokuMapping09A.病態_その他.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.病態_その他.getコード());
        }
        if (IkenshoKomokuMapping09A.訪問診療.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問診療.getコード());
        }
        if (IkenshoKomokuMapping09A.訪問診療_必要性.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問診療_必要性.getコード());
        }
        return item;
    }

    private ShujiiIkenshoIkenItem set09A意見項目9(
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
        if (IkenshoKomokuMapping09A.訪問看護.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問看護.getコード());
        }
        if (IkenshoKomokuMapping09A.訪問看護_必要性.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問看護_必要性.getコード());
        }
        if (IkenshoKomokuMapping09A.訪問リハビリテーション.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問リハビリテーション.getコード());
        }
        if (IkenshoKomokuMapping09A.訪問リハビリテーション_必要性.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問リハビリテーション_必要性.getコード());
        }
        if (IkenshoKomokuMapping09A.通所リハビリテーション.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.通所リハビリテーション.getコード());
        }
        if (IkenshoKomokuMapping09A.通所リハビリテーション_必要性.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.通所リハビリテーション_必要性.getコード());
        }
        if (IkenshoKomokuMapping09A.短期入所療養介護.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.短期入所療養介護.getコード());
        }
        if (IkenshoKomokuMapping09A.短期入所療養介護_必要性.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.短期入所療養介護_必要性.getコード());
        }
        if (IkenshoKomokuMapping09A.訪問歯科診療.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問歯科診療.getコード());
        }
        return item;
    }

    private ShujiiIkenshoIkenItem set09A意見項目10(
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
        if (IkenshoKomokuMapping09A.訪問歯科診療_必要性.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問歯科診療_必要性.getコード());
        }
        if (IkenshoKomokuMapping09A.訪問歯科衛生指導.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問歯科衛生指導.getコード());
        }
        if (IkenshoKomokuMapping09A.訪問歯科衛生指導_必要性.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問歯科衛生指導_必要性.getコード());
        }
        if (IkenshoKomokuMapping09A.訪問薬剤管理指導.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問薬剤管理指導.getコード());
        }
        if (IkenshoKomokuMapping09A.訪問薬剤管理指導_必要性.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問薬剤管理指導_必要性.getコード());
        }
        if (IkenshoKomokuMapping09A.訪問栄養食事指導.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問栄養食事指導.getコード());
        }
        if (IkenshoKomokuMapping09A.訪問栄養食事指導_必要性.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.訪問栄養食事指導_必要性.getコード());
        }
        if (IkenshoKomokuMapping09A.その他の医療系のサービス.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.その他の医療系のサービス.getコード());
        }
        if (IkenshoKomokuMapping09A.その他の医療系のサービス_必要性.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.その他の医療系のサービス_必要性.getコード());
        }
        return item;
    }

    private ShujiiIkenshoIkenItem set09A意見項目11(
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
        if (IkenshoKomokuMapping09A.介護サービスの留意事項_血圧.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.介護サービスの留意事項_血圧.getコード());
        }
        if (IkenshoKomokuMapping09A.介護サービスの留意事項_嚥下.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.介護サービスの留意事項_嚥下.getコード());
        }
        if (IkenshoKomokuMapping09A.介護サービスの留意事項_摂食.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.介護サービスの留意事項_摂食.getコード());
        }
        if (IkenshoKomokuMapping09A.介護サービスの留意事項_移動.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.介護サービスの留意事項_移動.getコード());
        }
        if (IkenshoKomokuMapping09A.感染症の有無.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.感染症の有無.getコード());
        }
        if (IkenshoKomokuMapping09A.失調_不随意運動_体幹_左.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.失調_不随意運動_体幹_左.getコード());
        }
        if (IkenshoKomokuMapping09A.看護職員による相談.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.看護職員による相談.getコード());
        }
        if (IkenshoKomokuMapping09A.看護職員による相談_必要性.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.看護職員による相談_必要性.getコード());
        }
        return item;
    }

    private ShujiiIkenshoIkenItem set09A意見項目12(
            TorokuData data,
            ShujiiIkenshoIkenItem item) {
        if (IkenshoKomokuMapping09A.麻痺_右上肢_程度.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.麻痺_右上肢_程度.getコード());
        }
        if (IkenshoKomokuMapping09A.麻痺_左上肢.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.麻痺_左上肢.getコード());
        }
        if (IkenshoKomokuMapping09A.麻痺_左上肢_程度.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.麻痺_左上肢_程度.getコード());
        }
        if (IkenshoKomokuMapping09A.麻痺_右下肢.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.麻痺_右下肢.getコード());
        }
        if (IkenshoKomokuMapping09A.麻痺_右下肢_程度.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.麻痺_右下肢_程度.getコード());
        }
        if (IkenshoKomokuMapping09A.麻痺_左下肢.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.麻痺_左下肢.getコード());
        }
        if (IkenshoKomokuMapping09A.麻痺_左下肢_程度.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.麻痺_左下肢_程度.getコード());
        }
        if (IkenshoKomokuMapping09A.麻痺_その他.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.麻痺_その他.getコード());
        }
        if (IkenshoKomokuMapping09A.麻痺_その他_程度.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.麻痺_その他_程度.getコード());
        }
        if (IkenshoKomokuMapping09A.閉じこもり.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.閉じこもり.getコード());
        }
        if (IkenshoKomokuMapping09A.意欲低下.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.意欲低下.getコード());
        }
        if (IkenshoKomokuMapping09A.徘徊_可能性が高い病態.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.徘徊_可能性が高い病態.getコード());
        }
        if (IkenshoKomokuMapping09A.低栄養.getコード().equals(new RString(item.get連番()))) {
            ...
            意見項目連番レスト.add(IkenshoKomokuMapping09A.低栄養.getコード());
        }
        if (IkenshoKomokuMapping09A.摂食_嚥下機能低下.getコード().equals(new RString(item.get連番()))) {
            item = item.createBuilderForEdit().set意見項目(data.get嚥下()).build();
            意見項目連番レスト.add(IkenshoKomokuMapping09A.摂食_嚥下機能低下.getコード());
        }
        if (IkenshoKomokuMapping09A.生活機能の維持_改善の見通し.getコード().equals(new RString(item.get連番()))) {
            item = item.createBuilderForEdit().set意見項目(空白).build();
            意見項目連番レスト.add(IkenshoKomokuMapping09A.生活機能の維持_改善の見通し.getコード());
        }
        if (IkenshoKomokuMapping09A.介護サービスの留意事項_運動.getコード().equals(new RString(item.get連番()))) {
            item = item.createBuilderForEdit().set意見項目(data.get運動()).build();
            意見項目連番レスト.add(IkenshoKomokuMapping09A.介護サービスの留意事項_運動.getコード());
        }
        return item;
    }
