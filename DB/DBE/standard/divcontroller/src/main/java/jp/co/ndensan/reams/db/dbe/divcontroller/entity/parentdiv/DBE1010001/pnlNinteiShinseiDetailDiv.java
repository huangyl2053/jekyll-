...
public class pnlNinteiShinseiDetailDiv extends Panel {
    ...
    public ButtonDialog getBtnTorisageTeikeibun() {
        return this.getTabShinseishaJoho().getTplShinseijoho().getSinseiTorisage().getBtnTorisageTeikeibun();
    }

    @JsonIgnore
    public void  setBtnTorisageTeikeibun(ButtonDialog btnTorisageTeikeibun) {
        this.getTabShinseishaJoho().getTplShinseijoho().getSinseiTorisage().setBtnTorisageTeikeibun(btnTorisageTeikeibun);
    }
    ...
    public pnlEnkiDiv getPnlEnki() {
        return this.getTabShinseishaJoho().getTplEnki().getPnlEnki();
    }

    @JsonIgnore
    public void  setPnlEnki(pnlEnkiDiv pnlEnki) {
        this.getTabShinseishaJoho().getTplEnki().setPnlEnki(pnlEnki);
    }

    @JsonIgnore
    public TextBoxDate getTxtEnkiKetteiYMD() {
        return this.getTabShinseishaJoho().getTplEnki().getPnlEnki().getTxtEnkiKetteiYMD();
    }

    @JsonIgnore
    public void  setTxtEnkiKetteiYMD(TextBoxDate txtEnkiKetteiYMD) {
        this.getTabShinseishaJoho().getTplEnki().getPnlEnki().setTxtEnkiKetteiYMD(txtEnkiKetteiYMD);
    }

    @JsonIgnore
    public TextBoxDateRange getTxtEnkiMikomiKikan() {
        return this.getTabShinseishaJoho().getTplEnki().getPnlEnki().getTxtEnkiMikomiKikan();
    }

    @JsonIgnore
    public void  setTxtEnkiMikomiKikan(TextBoxDateRange txtEnkiMikomiKikan) {
        this.getTabShinseishaJoho().getTplEnki().getPnlEnki().setTxtEnkiMikomiKikan(txtEnkiMikomiKikan);
    }

    @JsonIgnore
    public Label getLblEnkiRiyu() {
        return this.getTabShinseishaJoho().getTplEnki().getPnlEnki().getLblEnkiRiyu();
    }

    @JsonIgnore
    public void  setLblEnkiRiyu(Label lblEnkiRiyu) {
        this.getTabShinseishaJoho().getTplEnki().getPnlEnki().setLblEnkiRiyu(lblEnkiRiyu);
    }

    @JsonIgnore
    public ButtonDialog getBtnEnkiRiyuTeikeibun() {
        return this.getTabShinseishaJoho().getTplEnki().getPnlEnki().getBtnEnkiRiyuTeikeibun();
    }

    @JsonIgnore
    public void  setBtnEnkiRiyuTeikeibun(ButtonDialog btnEnkiRiyuTeikeibun) {
        this.getTabShinseishaJoho().getTplEnki().getPnlEnki().setBtnEnkiRiyuTeikeibun(btnEnkiRiyuTeikeibun);
    }

    @JsonIgnore
    public TextBoxMultiLine getTxtEnkiRiyu() {
        return this.getTabShinseishaJoho().getTplEnki().getPnlEnki().getTxtEnkiRiyu();
    }

    @JsonIgnore
    public void  setTxtEnkiRiyu(TextBoxMultiLine txtEnkiRiyu) {
        this.getTabShinseishaJoho().getTplEnki().getPnlEnki().setTxtEnkiRiyu(txtEnkiRiyu);
    }

    @JsonIgnore
    public TextBoxDate getTxtEnkiTsuchiHakkoYMD() {
        return this.getTabShinseishaJoho().getTplEnki().getPnlEnki().getTxtEnkiTsuchiHakkoYMD();
    }

    @JsonIgnore
    public void  setTxtEnkiTsuchiHakkoYMD(TextBoxDate txtEnkiTsuchiHakkoYMD) {
        this.getTabShinseishaJoho().getTplEnki().getPnlEnki().setTxtEnkiTsuchiHakkoYMD(txtEnkiTsuchiHakkoYMD);
    }

    @JsonIgnore
    public TextBoxNum getTxtEnkiTsuchishoHakkoCount() {
        return this.getTabShinseishaJoho().getTplEnki().getPnlEnki().getTxtEnkiTsuchishoHakkoCount();
    }

    @JsonIgnore
    public void  setTxtEnkiTsuchishoHakkoCount(TextBoxNum txtEnkiTsuchishoHakkoCount) {
        this.getTabShinseishaJoho().getTplEnki().getPnlEnki().setTxtEnkiTsuchishoHakkoCount(txtEnkiTsuchishoHakkoCount);
    }
    ...
    public pnlShinseishaJohoDiv getPnlShinseishaJoho() {
        return this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho();
    }

    @JsonIgnore
    public void  setPnlShinseishaJoho(pnlShinseishaJohoDiv pnlShinseishaJoho) {
        this.getTabShinseishaJoho().getTplShinseishaJoho().setPnlShinseishaJoho(pnlShinseishaJoho);
    }

    @JsonIgnore
    public TextBoxAtenaMeisho getTxtJohoAtenaMeisho() {
        return this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().getTxtJohoAtenaMeisho();
    }

    @JsonIgnore
    public void  setTxtJohoAtenaMeisho(TextBoxAtenaMeisho txtJohoAtenaMeisho) {
        this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().setTxtJohoAtenaMeisho(txtJohoAtenaMeisho);
    }

    @JsonIgnore
    public TextBoxAtenaKanaMeisho getTxtJohoAtenaKanaMeisho() {
        return this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().getTxtJohoAtenaKanaMeisho();
    }

    @JsonIgnore
    public void  setTxtJohoAtenaKanaMeisho(TextBoxAtenaKanaMeisho txtJohoAtenaKanaMeisho) {
        this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().setTxtJohoAtenaKanaMeisho(txtJohoAtenaKanaMeisho);
    }

    @JsonIgnore
    public TextBoxDate getTxtJohoBirthday() {
        return this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().getTxtJohoBirthday();
    }

    @JsonIgnore
    public void  setTxtJohoBirthday(TextBoxDate txtJohoBirthday) {
        this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().setTxtJohoBirthday(txtJohoBirthday);
    }

    @JsonIgnore
    public RadioButton getRadJohoSeibetsu() {
        return this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().getRadJohoSeibetsu();
    }

    @JsonIgnore
    public void  setRadJohoSeibetsu(RadioButton radJohoSeibetsu) {
        this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().setRadJohoSeibetsu(radJohoSeibetsu);
    }

    @JsonIgnore
    public TextBoxYubinNo getTxtJohoYubinNo() {
        return this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().getTxtJohoYubinNo();
    }

    @JsonIgnore
    public void  setTxtJohoYubinNo(TextBoxYubinNo txtJohoYubinNo) {
        this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().setTxtJohoYubinNo(txtJohoYubinNo);
    }

    @JsonIgnore
    public TextBoxJusho getTxtJohoJusho() {
        return this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().getTxtJohoJusho();
    }

    @JsonIgnore
    public void  setTxtJohoJusho(TextBoxJusho txtJohoJusho) {
        this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().setTxtJohoJusho(txtJohoJusho);
    }

    @JsonIgnore
    public TextBoxTelNo getTxtJohoTelNo() {
        return this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().getTxtJohoTelNo();
    }

    @JsonIgnore
    public void  setTxtJohoTelNo(TextBoxTelNo txtJohoTelNo) {
        this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().setTxtJohoTelNo(txtJohoTelNo);
    }

    @JsonIgnore
    public TextBox getTxtJohoNenrei() {
        return this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().getTxtJohoNenrei();
    }

    @JsonIgnore
    public void  setTxtJohoNenrei(TextBox txtJohoNenrei) {
        this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().setTxtJohoNenrei(txtJohoNenrei);
    }

    @JsonIgnore
    public IHokenshaListDiv getCcdShozokuShichoson() {
        return this.getTabShinseishaJoho().getTplShinseishaJoho().getPnlShinseishaJoho().getCcdShozokuShichoson();
    }
