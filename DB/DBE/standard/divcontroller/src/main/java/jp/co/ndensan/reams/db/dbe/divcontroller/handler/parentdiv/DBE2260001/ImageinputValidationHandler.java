...
public class ImageinputValidationHandler {
    ...
    public ValidationMessageControlPairs check一覧対象未選択() {
        ...
        validationMessages.add(new ValidationMessageControlPair(new ImageinputValidationHandler.CheckMessages(UrErrorMessages.選択されていない,
                "取込み対象")));
    ...
    public ValidationMessageControlPairs check対象を選択() {
        ValidationMessageControlPairs validationMessages = new ValidationMessageControlPairs();
        validationMessages.add(new ValidationMessageControlPair(new ImageinputValidationHandler.CheckMessages(UrErrorMessages.更新不可_汎用,
                "NGのデータを選択する")));
        return validationMessages;
    }
