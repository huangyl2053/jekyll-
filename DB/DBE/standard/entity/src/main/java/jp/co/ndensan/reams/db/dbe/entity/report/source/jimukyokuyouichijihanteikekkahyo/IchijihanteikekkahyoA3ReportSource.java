...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "hokenshaName", length = 30, order = 29)
    public RString hokenshaName;
    @ReportItem(name = "hihokenNo", length = 10, order = 30)
    public RString hihokenNo;
    @ReportItem(name = "hokenshaNo", length = 6, order = 31)
    public RString hokenshaNo;
    @ReportItem(name = "shichosonName", length = 10, order = 32)
    public RString shichosonName;
    @ReportItem(name = "listFuseigo1_1", length = 1, order = 33)
    public RString listFuseigo1_1;
    @ReportItem(name = "listFuseigo1_2", length = 1, order = 34)
    public RString listFuseigo1_2;
    @ReportItem(name = "listIchigun_1", length = 22, order = 35)
    public RString listIchigun_1;
    @ReportItem(name = "listIchigun_2", length = 1, order = 36)
    public RString listIchigun_2;
    @ReportItem(name = "listIchigun_3", length = 1, order = 37)
    public RString listIchigun_3;
    @ReportItem(name = "listIchigun_4", length = 22, order = 38)
    public RString listIchigun_4;
    @ReportItem(name = "chosaItakusakiName", length = 30, order = 39)
    public RString chosaItakusakiName;
    @ReportItem(name = "chosaItakusakiNo", length = 12, order = 40)
    public RString chosaItakusakiNo;
    @ReportItem(name = "chosainNo", length = 8, order = 41)
    public RString chosainNo;
    @ReportItem(name = "chosainName", length = 30, order = 42)
    public RString chosainName;
    @ReportItem(name = "chosainShikaku", length = 20, order = 43)
    public RString chosainShikaku;
    @ReportItem(name = "chosaJisshiBasho", length = 30, order = 44)
    public RString chosaJisshiBasho;
    @ReportItem(name = "chosaJisshiDate1", length = 9, order = 45)
    public RString chosaJisshiDate1;
    @ReportItem(name = "iryokikanNo", length = 12, order = 46)
    public RString iryokikanNo;
    @ReportItem(name = "iryokikanName", length = 30, order = 47)
    public RString iryokikanName;
    @ReportItem(name = "ishiName", length = 30, order = 48)
    public RString ishiName;
    @ReportItem(name = "ishiNo", length = 8, order = 49)
    public RString ishiNo;
    @ReportItem(name = "tokuteishippeiName", length = 40, order = 50)
    public RString tokuteishippeiName;
    @ReportItem(name = "ichijiHanteiKekka", length = 12, order = 51)
    public RString ichijiHanteiKekka;
    @ReportItem(name = "kijunGokeiTime", length = 30, order = 52)
    public RString kijunGokeiTime;
    @ReportItem(name = "zenkaiKijunGokeiTime", length = 30, order = 53)
    public RString zenkaiKijunGokeiTime;
    @ReportItem(name = "listFuseigo2_1", length = 1, order = 54)
    public RString listFuseigo2_1;
    @ReportItem(name = "listFuseigo2_2", length = 1, order = 55)
    public RString listFuseigo2_2;
    @ReportItem(name = "listNigun_1", length = 22, order = 56)
    public RString listNigun_1;
    @ReportItem(name = "listNigun_2", length = 1, order = 57)
    public RString listNigun_2;
    @ReportItem(name = "listNigun_3", length = 1, order = 58)
    public RString listNigun_3;
    @ReportItem(name = "listNigun_4", length = 22, order = 59)
    public RString listNigun_4;
    @ReportItem(name = "listkijunTime_1", length = 7, order = 60)
    public RString listkijunTime_1;
    @ReportItem(name = "listkijunTime_2", length = 7, order = 61)
    public RString listkijunTime_2;
    @ReportItem(name = "listkijunTime_3", length = 7, order = 62)
    public RString listkijunTime_3;
    @ReportItem(name = "listkijunTime_4", length = 7, order = 63)
    public RString listkijunTime_4;
    @ReportItem(name = "listkijunTime_5", length = 7, order = 64)
    public RString listkijunTime_5;
    @ReportItem(name = "listkijunTime_6", length = 7, order = 65)
    public RString listkijunTime_6;
    @ReportItem(name = "listkijunTime_7", length = 7, order = 66)
    public RString listkijunTime_7;
    @ReportItem(name = "listkijunTime_8", length = 7, order = 67)
    public RString listkijunTime_8;
    @ReportItem(name = "listkijunTime_9", length = 7, order = 68)
    public RString listkijunTime_9;
    @ReportItem(name = "keikokuNo", length = 120, order = 69)
    public RString keikokuNo;
    @ReportItem(name = "listFuseigo3_1", length = 1, order = 70)
    public RString listFuseigo3_1;
    @ReportItem(name = "listFuseigo3_2", length = 1, order = 71)
    public RString listFuseigo3_2;
    @ReportItem(name = "listSangun_1", length = 22, order = 72)
    public RString listSangun_1;
    @ReportItem(name = "listSangun_2", length = 1, order = 73)
    public RString listSangun_2;
    @ReportItem(name = "listSangun_3", length = 1, order = 74)
    public RString listSangun_3;
    @ReportItem(name = "listSangun_4", length = 22, order = 75)
    public RString listSangun_4;
    @ReportItem(name = "listChukanhyoka_1", length = 5, order = 76)
    public RString listChukanhyoka_1;
    @ReportItem(name = "listChukanhyoka_2", length = 5, order = 77)
    public RString listChukanhyoka_2;
    @ReportItem(name = "listChukanhyoka_3", length = 5, order = 78)
    public RString listChukanhyoka_3;
    @ReportItem(name = "listChukanhyoka_4", length = 5, order = 79)
    public RString listChukanhyoka_4;
    @ReportItem(name = "listChukanhyoka_5", length = 5, order = 80)
    public RString listChukanhyoka_5;
    @ReportItem(name = "ｌistSeikatsujiritsu_1", length = 2, order = 81)
    public RString ｌistSeikatsujiritsu_1;
    @ReportItem(name = "ｌistSeikatsujiritsu_2", length = 1, order = 82)
    public RString ｌistSeikatsujiritsu_2;
    @ReportItem(name = "listFuseigo4_1", length = 1, order = 83)
    public RString listFuseigo4_1;
    @ReportItem(name = "listFuseigo4_2", length = 1, order = 84)
    public RString listFuseigo4_2;
    @ReportItem(name = "listYongun_1", length = 22, order = 85)
    public RString listYongun_1;
    @ReportItem(name = "listYongun_2", length = 1, order = 86)
    public RString listYongun_2;
    @ReportItem(name = "listYongun_3", length = 1, order = 87)
    public RString listYongun_3;
    @ReportItem(name = "listYongun_4", length = 22, order = 88)
    public RString listYongun_4;
    @ReportItem(name = "chosaNinchishoJiritsudo", length = 2, order = 89)
    public RString chosaNinchishoJiritsudo;
    @ReportItem(name = "ikenNinchiJiritsudo", length = 2, order = 90)
    public RString ikenNinchiJiritsudo;
    @ReportItem(name = "manzensei", length = 6, order = 91)
    public RString manzensei;
    @ReportItem(name = "jotainoanteisei", length = 4, order = 92)
    public RString jotainoanteisei;
    @ReportItem(name = "kyufukubun", length = 4, order = 93)
    public RString kyufukubun;
    @ReportItem(name = "sabisuName", length = 15, order = 94)
    public RString sabisuName;
    @ReportItem(name = "sabisuText1", order = 95)
    public RString sabisuText1;
    @ReportItem(name = "sabisuText2", order = 96)
    public RString sabisuText2;
    @ReportItem(name = "listFuseigo5_1", length = 1, order = 97)
    public RString listFuseigo5_1;
    @ReportItem(name = "listFuseigo5_2", length = 1, order = 98)
    public RString listFuseigo5_2;
    @ReportItem(name = "listGogun_1", length = 22, order = 99)
    public RString listGogun_1;
    @ReportItem(name = "listGogun_2", length = 1, order = 100)
    public RString listGogun_2;
    @ReportItem(name = "listGogun_3", length = 1, order = 101)
    public RString listGogun_3;
    @ReportItem(name = "listGogun_4", length = 22, order = 102)
    public RString listGogun_4;
    @ReportItem(name = "listtokubetsunaIryo1_1", length = 2, order = 103)
    public RString listtokubetsunaIryo1_1;
    @ReportItem(name = "listtokubetsunaIryo1_2", length = 1, order = 104)
    public RString listtokubetsunaIryo1_2;
    @ReportItem(name = "listtokubetsunaIryo1_3", length = 1, order = 105)
    public RString listtokubetsunaIryo1_3;
    @ReportItem(name = "listtokubetsunaIryo1_4", length = 1, order = 106)
    public RString listtokubetsunaIryo1_4;
    @ReportItem(name = "listtokubetsunaIryo2_1", length = 2, order = 107)
    public RString listtokubetsunaIryo2_1;
    @ReportItem(name = "listtokubetsunaIryo2_2", length = 1, order = 108)
    public RString listtokubetsunaIryo2_2;
    @ReportItem(name = "listtokubetsunaIryo2_3", length = 1, order = 109)
    public RString listtokubetsunaIryo2_3;
    @ReportItem(name = "listtokubetsunaIryo2_4", length = 1, order = 110)
    public RString listtokubetsunaIryo2_4;
    @ReportItem(name = "listshujiiikensho1_1", length = 18, order = 111)
    public RString listshujiiikensho1_1;
    @ReportItem(name = "listshujiiikensho1_2", length = 1, order = 112)
    public RString listshujiiikensho1_2;
    @ReportItem(name = "listshujiiikensho1_3", length = 1, order = 113)
    public RString listshujiiikensho1_3;
    @ReportItem(name = "listshujiiikensho1_4", length = 18, order = 114)
