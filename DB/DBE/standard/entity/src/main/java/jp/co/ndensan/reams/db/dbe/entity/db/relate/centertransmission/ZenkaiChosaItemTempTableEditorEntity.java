...
/**
 * 前回調査項目一時テーブルのProcessを編集するentityです。
 *
 * @reamsid_L DBE-1520-020 wangxiaodong
 */
public class ZenkaiChosaItemTempTableEditorEntity {
    ...
    private final ZenkaiNinteichosahyoChosaItemTempEntity tempEntity;

    /**
     * コンストラクタです。
     *
     * @param entity ZenkaiNinteichosahyoChosaItemTempEntity
     */
    public ZenkaiChosaItemTempTableEditorEntity(ZenkaiNinteichosahyoChosaItemTempEntity entity) {
     ...
     */
    public void set前回調査項目(ZenkaiChosaItemEntity entity) {
    ...
    private void set調査項目By連番10以降(ZenkaiChosaItemEntity entity) {
    ...
    private void set調査項目By連番20以降(ZenkaiChosaItemEntity entity) {
    ...
    private void set調査項目By連番30以降(ZenkaiChosaItemEntity entity) {
    ...
    private void set調査項目By連番40以降(ZenkaiChosaItemEntity entity) {
    ...
    private void set調査項目By連番50以降(ZenkaiChosaItemEntity entity) {
    ...
    private void set調査項目By連番60以降(ZenkaiChosaItemEntity entity) {
    ...
    private void set調査項目By連番70以降(ZenkaiChosaItemEntity entity) {
