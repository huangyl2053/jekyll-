 ...
 */
public class NinteiChosaJohohyo52ReportSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "ichijiHanteiKekka", length = 9, order = 37)
    public RString ichijiHanteiKekka;
    @ReportItem(name = "nijiHanteiKekka", length = 4, order = 38)
    public RString nijiHanteiKekka;
    @ReportItem(name = "nijihanteiKaishiYMD", length = 11, order = 39)
    public RString nijihanteiKaishiYMD;
    @ReportItem(name = "ｙukokikan", length = 2, order = 40)
    public RString ｙukokikan;
    @ReportItem(name = "nijihanteishuryoYMD", length = 11, order = 41)
    public RString nijihanteishuryoYMD;
    @ReportItem(name = "listSangun_1", length = 20, order = 42)
    public RString listSangun_1;
    @ReportItem(name = "jotaizo", length = 26, order = 43)
    public RString jotaizo;
    @ReportItem(name = "henkoJiyu", length = 20, order = 44)
    public RString henkoJiyu;
    @ReportItem(name = "tokuteishippeiName", length = 40, order = 45)
    public RString tokuteishippeiName;
    @ReportItem(name = "listYongun_1", length = 20, order = 46)
    public RString listYongun_1;
    @ReportItem(name = "shinsakaiIken", length = 70, order = 47)
    public RString shinsakaiIken;
    @ReportItem(name = "zenkaiNijihanteiDate", length = 11, order = 48)
    public RString zenkaiNijihanteiDate;
    @ReportItem(name = "zenkaiNijihanteikekka", length = 4, order = 49)
    public RString zenkaiNijihanteikekka;
    @ReportItem(name = "zenHanteiKaishiYMD", length = 11, order = 50)
    public RString zenHanteiKaishiYMD;
    @ReportItem(name = "zenkaiYukokikan", length = 2, order = 51)
    public RString zenkaiYukokikan;
    @ReportItem(name = "zenHanteishuryoYMD", length = 11, order = 52)
    public RString zenHanteishuryoYMD;
    @ReportItem(name = "listGogun_1", length = 20, order = 53)
    public RString listGogun_1;
    @ReportItem(name = "chosaJisshiYMD", length = 11, order = 54)
    public RString chosaJisshiYMD;
    @ReportItem(name = "chosaJisshiBashoTxit", order = 55)
    public RString chosaJisshiBashoTxit;
    @ReportItem(name = "imgChosaJisshiBasho", order = 56)
    public RString imgChosaJisshiBasho;
    @ReportItem(name = "chosaJisshiBasho", length = 6, order = 57)
    public RString chosaJisshiBasho;
    @ReportItem(name = "chosainName", length = 30, order = 58)
    public RString chosainName;
    @ReportItem(name = "chosaItakusakiName", length = 30, order = 59)
    public RString chosaItakusakiName;
    @ReportItem(name = "listSabisujokyo1_1", length = 3, order = 60)
    public RString listSabisujokyo1_1;
    @ReportItem(name = "listRokugun_1", length = 20, order = 61)
    public RString listRokugun_1;
    @ReportItem(name = "listRokugun1_1", length = 20, order = 62)
    public RString listRokugun1_1;
    @ReportItem(name = "imgTokubetsukyufu", order = 63)
    public RString imgTokubetsukyufu;
    @ReportItem(name = "tokubetsukyufuTxit", order = 64)
    public RString tokubetsukyufuTxit;
    @ReportItem(name = "imgZaitakusabisu", order = 65)
    public RString imgZaitakusabisu;
    @ReportItem(name = "zaitakusabisuTxit", order = 66)
    public RString zaitakusabisuTxit;
    @ReportItem(name = "listIryo_1", length = 20, order = 67)
    public RString listIryo_1;
    @ReportItem(name = "shisetsuriyo", length = 25, order = 68)
    public RString shisetsuriyo;
    @ReportItem(name = "imgShisetsuName", order = 69)
    public RString imgShisetsuName;
    @ReportItem(name = "shisetsuNameTxit", order = 70)
    public RString shisetsuNameTxit;
    @ReportItem(name = "imgShisetsujusho", order = 71)
    public RString imgShisetsujusho;
    @ReportItem(name = "shisetsujushoTxit", order = 72)
    public RString shisetsujushoTxit;
    @ReportItem(name = "imgShisetsuTel", order = 73)
    public RString imgShisetsuTel;
    @ReportItem(name = "shisetsuTxitTel", order = 74)
    public RString shisetsuTxitTel;
    @ReportItem(name = "listChosaJiritsudo_1", length = 3, order = 75)
