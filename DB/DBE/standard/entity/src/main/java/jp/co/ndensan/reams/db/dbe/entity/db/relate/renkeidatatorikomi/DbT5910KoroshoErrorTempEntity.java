...
/**
 * 認定調査委託先情報エラー一時テーブルのエンティティクラスです。
 *
...
@lombok.Setter
@OnNextSchema("rgdb")
public class DbT5910KoroshoErrorTempEntity extends DbTableEntityBase<DbT5910KoroshoErrorTempEntity> implements IDbAccessable {
