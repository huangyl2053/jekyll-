 ...
 */
public class DbT5131TenshutsuEntity extends DbTableEntityBase<DbT5131TenshutsuEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">
    @TableName
    public static final RString TABLE_NAME = new RString("DbT5131Tenshutsu");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT5131TenshutsuEntity}と等しいか判定します。
     * 
     * @param other 比較するエンティティ
     * @return 
     * 比較するエンティティが同じ主キーを持つ{@literal DbT5131TenshutsuEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT5131TenshutsuEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT5131TenshutsuEntity entity) {
