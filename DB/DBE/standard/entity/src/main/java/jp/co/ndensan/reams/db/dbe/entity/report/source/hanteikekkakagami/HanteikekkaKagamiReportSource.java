...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "kikanNameText", order = 11)
    public RString kikanNameText;
    @ReportItem(name = "customerBarCode", order = 12)
    public RString customerBarCode;
    @ReportItem(name = "pageCount", length = 8, order = 13)
    public RString pageCount;
    @ReportItem(name = "yubinNo", length = 8, order = 14)
    ...
    @ReportItem(name = "shinsakaiKaisaiNo", length = 8, order = 20)
