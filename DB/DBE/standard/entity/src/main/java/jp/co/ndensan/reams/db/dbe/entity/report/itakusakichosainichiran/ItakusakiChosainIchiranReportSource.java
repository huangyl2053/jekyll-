package jp.co.ndensan.reams.db.dbe.entity.report.itakusakichosainichiran;
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "shujiiCode", length = 17, order = 3)
    public RString shujiiCode;
    @ReportItem(name = "title", length = 50, order = 4)
    ...
    @ReportItem(name = "page3", length = 20, order = 16)
    public RString page3;
    @ReportItem(name = "page4", length = 20, order = 17)
    public RString page4;
    @ReportItem(name = "page5", length = 20, order = 18)
    ...
    @ReportItem(name = "listIchiranhyoUpper_9", length = 2, order = 27)
    public RString listIchiranhyoUpper_9;
    @ReportItem(name = "listIchiranhyoUpper_10", length = 10, order = 28)
    public RString listIchiranhyoUpper_10;
    @ReportItem(name = "listIchiranhyoUpper_11", length = 2, order = 29)
    public RString listIchiranhyoUpper_11;
    @ReportItem(name = "listIchiranhyoLower1_1", length = 20, order = 30)
    public RString listIchiranhyoLower1_1;
    @ReportItem(name = "listIchiranhyoLower1_2", length = 10, order = 31)
    public RString listIchiranhyoLower1_2;
    @ReportItem(name = "listIchiranhyoLower1_3", length = 14, order = 32)
    public RString listIchiranhyoLower1_3;
    @ReportItem(name = "listIchiranhyoLower2_1", length = 10, order = 33)
    public RString listIchiranhyoLower2_1;
    @ReportItem(name = "listIchiranhyoLower2_2", length = 1, order = 34)
    public RString listIchiranhyoLower2_2;
    @ReportItem(name = "listIchiranhyoLower2_3", length = 10, order = 35)
    public RString listIchiranhyoLower2_3;
// </editor-fold>
