package jp.co.ndensan.reams.db.dbe.entity.report.source.ninteichosahyogaikyochosa;
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "shinseishaNameKana", length = 20, order = 46)
    public RString shinseishaNameKana;
    @ReportItem(name = "seibetsuMan", length = 2, order = 47)
    public RString seibetsuMan;
    @ReportItem(name = "shinseishaYubinNo", length = 8, order = 48)
    public RString shinseishaYubinNo;
    @ReportItem(name = "shinseishTelNo", length = 13, order = 49)
    public RString shinseishTelNo;
    @ReportItem(name = "shinseishaName", length = 20, order = 50)
    public RString shinseishaName;
    @ReportItem(name = "seibetsuWoman", length = 2, order = 51)
    public RString seibetsuWoman;
    @ReportItem(name = "shinseishaJusho", length = 60, order = 52)
    public RString shinseishaJusho;
    @ReportItem(name = "kazokuRenrakusakiTel1", length = 13, order = 53)
    public RString kazokuRenrakusakiTel1;
    @ReportItem(name = "meiji", length = 2, order = 54)
    public RString meiji;
    @ReportItem(name = "taisho", length = 2, order = 55)
    public RString taisho;
    @ReportItem(name = "showa", length = 2, order = 56)
    public RString showa;
    @ReportItem(name = "kazokuRenrakusakiYubinNo", length = 8, order = 57)
    public RString kazokuRenrakusakiYubinNo;
    @ReportItem(name = "kazokuRenrakusakiTel2", length = 13, order = 58)
    public RString kazokuRenrakusakiTel2;
    @ReportItem(name = "kazokuRenrakusakiJusho", length = 60, order = 59)
    public RString kazokuRenrakusakiJusho;
    @ReportItem(name = "birthMM", length = 2, order = 60)
    public RString birthMM;
    @ReportItem(name = "birthYY", length = 2, order = 61)
    public RString birthYY;
    @ReportItem(name = "birthDD", length = 2, order = 62)
    public RString birthDD;
    @ReportItem(name = "age", length = 3, order = 63)
    public RString age;
    @ReportItem(name = "shinseishatonoKankei", length = 10, order = 64)
    public RString shinseishatonoKankei;
    @ReportItem(name = "kazokuRenrakusakiName", length = 15, order = 65)
    public RString kazokuRenrakusakiName;
    @ReportItem(name = "nikaime", length = 2, order = 66)
    public RString nikaime;
    @ReportItem(name = "shokai", length = 2, order = 67)
    public RString shokai;
    @ReportItem(name = "higaito", length = 2, order = 68)
    public RString higaito;
    @ReportItem(name = "yoshien", length = 2, order = 69)
    public RString yoshien;
    @ReportItem(name = "yoshiendo", length = 2, order = 70)
    public RString yoshiendo;
    @ReportItem(name = "yokaigo", length = 2, order = 71)
    public RString yokaigo;
    @ReportItem(name = "yokaigodo", length = 3, order = 72)
    public RString yokaigodo;
    @ReportItem(name = "zenkaiNinteiYYYY", length = 4, order = 73)
    public RString zenkaiNinteiYYYY;
    @ReportItem(name = "zenkaiNinteiMM", length = 2, order = 74)
    public RString zenkaiNinteiMM;
    @ReportItem(name = "zenkaiNinteiDD", length = 2, order = 75)
