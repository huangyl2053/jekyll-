...
/**
 * 認定調査票（概況調査）2002Aテーブルの項目定義クラスです。
 */
public enum DbT5202NinteichosahyoGaikyoChosa2002A implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    ...
    private DbT5202NinteichosahyoGaikyoChosa2002A(int maxLength, int scale) {
