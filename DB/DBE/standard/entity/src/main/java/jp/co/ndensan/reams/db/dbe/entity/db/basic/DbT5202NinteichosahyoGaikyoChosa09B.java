...
/**
 * 認定調査票（概況調査）09Bテーブルの項目定義クラスです。
 */
public enum DbT5202NinteichosahyoGaikyoChosa09B implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.3">
    ...
    private DbT5202NinteichosahyoGaikyoChosa09B(int maxLength, int scale) {
