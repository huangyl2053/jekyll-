...
public class IchijihanteiSumidataIDataShutsuryokuRelateEntity {
    ...
    private RString 前回予防通所リハビリ;
    private RString 前回予防短期入所生活介護;
    ...
    private RString 前回介護通所リハビリ;
    private RString 前回介護短期入所生活介護;
    ...
    private RString 前回介護グループホーム;
    private RString 前回介護施設入居者生活介護;
    private RString 前回老人福祉施設入所者生活介護;
    private RString 前回介護訪問介護看護;
