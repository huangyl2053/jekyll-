 ...
 */
package jp.co.ndensan.reams.db.dbe.entity.report.source.jimushinsakaishiryoa4;
...
/**
 * 事務局審査会資料組み合わせ一覧A4のReportSourceです。
 *
 * @reamsid_L DBE-0150-200 lishengli
 */
public class JimuShinsakaishiryoA4ReportSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "gogitaiNo", length = 3, order = 50)
    public RString gogitaiNo;
    @ReportItem(name = "shinseiCount", length = 2, order = 51)
    public RString shinseiCount;
    @ReportItem(name = "hihokenshaKubun", length = 7, order = 52)
    public RString hihokenshaKubun;
    @ReportItem(name = "zenkaiNijihanteikekka", length = 4, order = 53)
    public RString zenkaiNijihanteikekka;
    @ReportItem(name = "zenkaiYukokikan", length = 4, order = 54)
    public RString zenkaiYukokikan;
    @ReportItem(name = "zenkaiNijiKaishiYMD", length = 9, order = 55)
    public RString zenkaiNijiKaishiYMD;
    @ReportItem(name = "zenkaiNijishuryoYMD", length = 9, order = 56)
    ...
    @ReportItem(name = "hihokenshaName", length = 30, order = 61)
    public RString hihokenshaName;
    @ReportItem(name = "hihokenshaNo", length = 10, order = 62)
    public RString hihokenshaNo;
    @ReportItem(name = "shozokuName", length = 20, order = 63)
    public RString shozokuName;
    @ReportItem(name = "hokenshaNo", length = 6, order = 64)
    public RString hokenshaNo;
    @ReportItem(name = "listTokki1_1", length = 1, order = 65)
    public RString listTokki1_1;
    @ReportItem(name = "listIchigun_1", length = 22, order = 66)
    public RString listIchigun_1;
    @ReportItem(name = "listIchigun_2", length = 1, order = 67)
    public RString listIchigun_2;
    @ReportItem(name = "listIchigun_3", length = 1, order = 68)
    public RString listIchigun_3;
    @ReportItem(name = "listIchigun_4", length = 22, order = 69)
    public RString listIchigun_4;
    @ReportItem(name = "shichosonName", length = 10, order = 70)
    public RString shichosonName;
    @ReportItem(name = "chosaItakusakiNo", length = 12, order = 71)
    public RString chosaItakusakiNo;
    @ReportItem(name = "chosaItakusakiName", length = 30, order = 72)
    public RString chosaItakusakiName;
    @ReportItem(name = "chosainNo", length = 8, order = 73)
    public RString chosainNo;
    @ReportItem(name = "chosainName", length = 30, order = 74)
    public RString chosainName;
    @ReportItem(name = "chosainShikaku", length = 20, order = 75)
    public RString chosainShikaku;
    @ReportItem(name = "iryokikanName", length = 30, order = 76)
    public RString iryokikanName;
    @ReportItem(name = "iryokikanNo", length = 12, order = 77)
    public RString iryokikanNo;
    @ReportItem(name = "ishiNo", length = 8, order = 78)
    public RString ishiNo;
    @ReportItem(name = "ishiName", length = 30, order = 79)
    public RString ishiName;
    @ReportItem(name = "ichijiHanteiKekka", length = 12, order = 80)
    public RString ichijiHanteiKekka;
    @ReportItem(name = "nijiHanteiKekka", length = 12, order = 81)
    public RString nijiHanteiKekka;
    @ReportItem(name = "nijihanteiKaishiYMD", length = 9, order = 82)
    public RString nijihanteiKaishiYMD;
    @ReportItem(name = "nijihanteishuryoYMD", length = 9, order = 83)
    public RString nijihanteishuryoYMD;
    @ReportItem(name = "ｙukokikan", length = 4, order = 84)
    public RString ｙukokikan;
    @ReportItem(name = "tokuteishippeiName", length = 40, order = 85)
    public RString tokuteishippeiName;
    @ReportItem(name = "jotaizo", length = 26, order = 86)
    public RString jotaizo;
    @ReportItem(name = "kijunGokeiTime", length = 30, order = 87)
    public RString kijunGokeiTime;
    @ReportItem(name = "gurafuKijunTime", order = 88)
    public RString gurafuKijunTime;
    @ReportItem(name = "listTokki2_1", length = 1, order = 89)
    public RString listTokki2_1;
    @ReportItem(name = "listNigun_1", length = 22, order = 90)
    public RString listNigun_1;
    @ReportItem(name = "listNigun_2", length = 1, order = 91)
    public RString listNigun_2;
    @ReportItem(name = "listNigun_3", length = 1, order = 92)
    public RString listNigun_3;
    @ReportItem(name = "listNigun_4", length = 22, order = 93)
    public RString listNigun_4;
    @ReportItem(name = "listkijunTime_1", length = 7, order = 94)
    public RString listkijunTime_1;
    @ReportItem(name = "listkijunTime_2", length = 7, order = 95)
    public RString listkijunTime_2;
    @ReportItem(name = "listkijunTime_3", length = 7, order = 96)
    public RString listkijunTime_3;
    @ReportItem(name = "listkijunTime_4", length = 7, order = 97)
    public RString listkijunTime_4;
    @ReportItem(name = "listkijunTime_5", length = 7, order = 98)
    public RString listkijunTime_5;
    @ReportItem(name = "listkijunTime_6", length = 7, order = 99)
    public RString listkijunTime_6;
    @ReportItem(name = "listkijunTime_7", length = 7, order = 100)
    public RString listkijunTime_7;
    @ReportItem(name = "listkijunTime_8", length = 7, order = 101)
    public RString listkijunTime_8;
    @ReportItem(name = "listkijunTime_9", length = 7, order = 102)
    public RString listkijunTime_9;
    @ReportItem(name = "keikokuNo", length = 120, order = 103)
    public RString keikokuNo;
    @ReportItem(name = "listChukanhyoka_1", length = 5, order = 104)
    public RString listChukanhyoka_1;
    @ReportItem(name = "listChukanhyoka_2", length = 5, order = 105)
    public RString listChukanhyoka_2;
    @ReportItem(name = "listChukanhyoka_3", length = 5, order = 106)
    public RString listChukanhyoka_3;
    @ReportItem(name = "listChukanhyoka_4", length = 5, order = 107)
    public RString listChukanhyoka_4;
    @ReportItem(name = "listChukanhyoka_5", length = 5, order = 108)
    public RString listChukanhyoka_5;
    @ReportItem(name = "listTokki3_1", length = 1, order = 109)
    public RString listTokki3_1;
    @ReportItem(name = "listSangun_1", length = 22, order = 110)
    public RString listSangun_1;
    @ReportItem(name = "listSangun_2", length = 1, order = 111)
    public RString listSangun_2;
    @ReportItem(name = "listSangun_3", length = 1, order = 112)
    public RString listSangun_3;
    @ReportItem(name = "listSangun_4", length = 22, order = 113)
    public RString listSangun_4;
    @ReportItem(name = "listTokki8_1", length = 1, order = 114)
    public RString listTokki8_1;
    @ReportItem(name = "ｌistNichijoseikatsujiritsudo_1", length = 2, order = 115)
    public RString ｌistNichijoseikatsujiritsudo_1;
    @ReportItem(name = "chosaNinchishoJiritsudo", length = 2, order = 116)
    public RString chosaNinchishoJiritsudo;
    @ReportItem(name = "ikenNinchishoJiritsudo", length = 2, order = 117)
    public RString ikenNinchishoJiritsudo;
    @ReportItem(name = "manzensei", length = 6, order = 118)
    public RString manzensei;
    @ReportItem(name = "jotainoanteisei", length = 4, order = 119)
    public RString jotainoanteisei;
    @ReportItem(name = "kyufukubun", length = 4, order = 120)
    public RString kyufukubun;
    @ReportItem(name = "listTokki4_1", length = 1, order = 121)
    public RString listTokki4_1;
    @ReportItem(name = "listYongun_1", length = 22, order = 122)
    public RString listYongun_1;
    @ReportItem(name = "listYongun_2", length = 1, order = 123)
    public RString listYongun_2;
    @ReportItem(name = "listYongun_3", length = 1, order = 124)
    public RString listYongun_3;
    @ReportItem(name = "listYongun_4", length = 22, order = 125)
    public RString listYongun_4;
    @ReportItem(name = "sabisuKubun", length = 15, order = 126)
    public RString sabisuKubun;
    @ReportItem(name = "sabisuName1", order = 127)
    public RString sabisuName1;
    @ReportItem(name = "sabisuKaisu1", length = 11, order = 128)
    public RString sabisuKaisu1;
    @ReportItem(name = "sabisuName2", order = 129)
    public RString sabisuName2;
    @ReportItem(name = "sabisuKaisu2", length = 11, order = 130)
    public RString sabisuKaisu2;
    @ReportItem(name = "sabisuName3", order = 131)
    public RString sabisuName3;
    @ReportItem(name = "sabisuKaisu3", length = 11, order = 132)
    public RString sabisuKaisu3;
    @ReportItem(name = "sabisuName4", order = 133)
    public RString sabisuName4;
    @ReportItem(name = "sabisuKaisu4", length = 11, order = 134)
    public RString sabisuKaisu4;
    @ReportItem(name = "sabisuName5", order = 135)
    public RString sabisuName5;
    @ReportItem(name = "sabisuKaisu5", length = 11, order = 136)
    public RString sabisuKaisu5;
    @ReportItem(name = "sabisuName6", order = 137)
    public RString sabisuName6;
    @ReportItem(name = "sabisuKaisu6", length = 11, order = 138)
    public RString sabisuKaisu6;
    @ReportItem(name = "sabisuName7", order = 139)
    public RString sabisuName7;
    @ReportItem(name = "sabisuKaisu7", length = 11, order = 140)
    public RString sabisuKaisu7;
    @ReportItem(name = "sabisuName8", order = 141)
    public RString sabisuName8;
    @ReportItem(name = "sabisuKaisu8", length = 11, order = 142)
    public RString sabisuKaisu8;
    @ReportItem(name = "sabisuName9", order = 143)
    public RString sabisuName9;
    @ReportItem(name = "sabisuKaisu9", length = 11, order = 144)
    public RString sabisuKaisu9;
    @ReportItem(name = "sabisuName10", order = 145)
    public RString sabisuName10;
    @ReportItem(name = "sabisuKaisu10", length = 11, order = 146)
    public RString sabisuKaisu10;
    @ReportItem(name = "sabisuName11", order = 147)
    public RString sabisuName11;
    @ReportItem(name = "sabisuKaisu11", length = 11, order = 148)
    public RString sabisuKaisu11;
    @ReportItem(name = "sabisuName12", order = 149)
    public RString sabisuName12;
    @ReportItem(name = "sabisuKaisu12", length = 11, order = 150)
    public RString sabisuKaisu12;
    @ReportItem(name = "sabisuName13", order = 151)
    public RString sabisuName13;
    @ReportItem(name = "sabisuKaisu13", length = 11, order = 152)
    public RString sabisuKaisu13;
    @ReportItem(name = "sabisuName14", order = 153)
    public RString sabisuName14;
    @ReportItem(name = "sabisuKaisu14", length = 11, order = 154)
    public RString sabisuKaisu14;
    @ReportItem(name = "sabisuName15", order = 155)
    public RString sabisuName15;
    @ReportItem(name = "sabisuKaisu15", length = 11, order = 156)
    public RString sabisuKaisu15;
    @ReportItem(name = "listTokki5_1", length = 1, order = 157)
    public RString listTokki5_1;
    @ReportItem(name = "listGogun_1", length = 22, order = 158)
    public RString listGogun_1;
    @ReportItem(name = "listGogun_2", length = 1, order = 159)
    public RString listGogun_2;
    @ReportItem(name = "listGogun_3", length = 1, order = 160)
    public RString listGogun_3;
    @ReportItem(name = "listGogun_4", length = 22, order = 161)
    public RString listGogun_4;
    @ReportItem(name = "sabisuName16", order = 162)
    public RString sabisuName16;
    @ReportItem(name = "sabisuKaisu16", length = 11, order = 163)
    public RString sabisuKaisu16;
    @ReportItem(name = "sabisuName17", order = 164)
    public RString sabisuName17;
    @ReportItem(name = "sabisuKaisu17", length = 11, order = 165)
    public RString sabisuKaisu17;
    @ReportItem(name = "sabisuName18", order = 166)
    public RString sabisuName18;
    @ReportItem(name = "sabisuKaisu18", length = 11, order = 167)
    public RString sabisuKaisu18;
    @ReportItem(name = "sabisuName19", order = 168)
    public RString sabisuName19;
    @ReportItem(name = "sabisuKaisu19", length = 11, order = 169)
    public RString sabisuKaisu19;
    @ReportItem(name = "sabisuName20", order = 170)
    public RString sabisuName20;
    @ReportItem(name = "sabisuKaisu20", length = 11, order = 171)
    public RString sabisuKaisu20;
    @ReportItem(name = "sabisuName21", order = 172)
    public RString sabisuName21;
    @ReportItem(name = "sabisuKaisu21", length = 11, order = 173)
    public RString sabisuKaisu21;
    @ReportItem(name = "listshujiiikensho_1", length = 18, order = 174)
    public RString listshujiiikensho_1;
    @ReportItem(name = "listshujiiikensho_2", length = 1, order = 175)
    public RString listshujiiikensho_2;
    @ReportItem(name = "listshujiiikensho_3", length = 1, order = 176)
    public RString listshujiiikensho_3;
    @ReportItem(name = "listshujiiikensho_4", length = 18, order = 177)
    public RString listshujiiikensho_4;
    @ReportItem(name = "listTokki6_1", length = 1, order = 178)
    public RString listTokki6_1;
    @ReportItem(name = "listTokubetsunaIryo1_1", length = 2, order = 179)
    public RString listTokubetsunaIryo1_1;
    @ReportItem(name = "listTokubetsunaIryo1_2", length = 1, order = 180)
    public RString listTokubetsunaIryo1_2;
    @ReportItem(name = "listTokki7_1", length = 1, order = 181)
    public RString listTokki7_1;
    @ReportItem(name = "listTokubetsunaIryo2_1", length = 2, order = 182)
    public RString listTokubetsunaIryo2_1;
    @ReportItem(name = "listTokubetsunaIryo2_2", length = 1, order = 183)
