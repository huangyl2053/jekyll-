...
/**
 * 前回サービスの状況一時テーブルのProcessを編集するentityです。
 *
 * @reamsid_L DBE-1520-020 wangxiaodong
 */
public class ZenkaiServiceJokyoTempTableEditorEntity {
    ...
    private final ZenkaiChosahyoServiceJokyoTempEntity tempEntity;

    /**
     * コンストラクタです。
     *
     * @param entity ZenkaiChosahyoServiceJokyoTempEntity
     */
    public ZenkaiServiceJokyoTempTableEditorEntity(ZenkaiChosahyoServiceJokyoTempEntity entity) {
     ...
     * 連番でサービスの状況を設定します。
     *
     * @param entity ZenkaiServiceJokyoEntity
     */
    public void set前回サービスの状況(ZenkaiServiceJokyoEntity entity) {
    ...
    private void setサービスの状況By連番10以降(ZenkaiServiceJokyoEntity entity) {
