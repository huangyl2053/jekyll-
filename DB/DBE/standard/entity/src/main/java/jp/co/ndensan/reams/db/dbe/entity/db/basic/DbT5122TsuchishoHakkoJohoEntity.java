 ...
 */
public class DbT5122TsuchishoHakkoJohoEntity extends DbTableEntityBase<DbT5122TsuchishoHakkoJohoEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">

    @TableName
    public static final RString TABLE_NAME = new RString("DbT5122TsuchishoHakkoJoho");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT5122TsuchishoHakkoJohoEntity}と等しいか判定します。
     *
     * @param other 比較するエンティティ
     * @@return 比較するエンティティが同じ主キーを持つ{@literal DbT5122TsuchishoHakkoJohoEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT5122TsuchishoHakkoJohoEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT5122TsuchishoHakkoJohoEntity entity) {
