...
/**
 * 事務局用一次判定結果票A4のReportSourceクラスです。
 *
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "keikokuNo", length = 120, order = 77)
    public RString keikokuNo;
    @ReportItem(name = "listChukanhyoka_1", length = 5, order = 78)
    public RString listChukanhyoka_1;
    @ReportItem(name = "listChukanhyoka_2", length = 5, order = 79)
    public RString listChukanhyoka_2;
    @ReportItem(name = "listChukanhyoka_3", length = 5, order = 80)
    public RString listChukanhyoka_3;
    @ReportItem(name = "listChukanhyoka_4", length = 5, order = 81)
    public RString listChukanhyoka_4;
    @ReportItem(name = "listChukanhyoka_5", length = 5, order = 82)
    public RString listChukanhyoka_5;
    @ReportItem(name = "listtokki3_1", length = 1, order = 83)
    public RString listtokki3_1;
    @ReportItem(name = "listSangun_1", length = 22, order = 84)
    public RString listSangun_1;
    @ReportItem(name = "listSangun_2", length = 1, order = 85)
    public RString listSangun_2;
    @ReportItem(name = "listSangun_3", length = 1, order = 86)
    public RString listSangun_3;
    @ReportItem(name = "listSangun_4", length = 22, order = 87)
    public RString listSangun_4;
    @ReportItem(name = "listtokki8_1", length = 1, order = 88)
    public RString listtokki8_1;
    @ReportItem(name = "ｌistNichijoseikatsujiritsudo_1", length = 2, order = 89)
    public RString ｌistNichijoseikatsujiritsudo_1;
    @ReportItem(name = "chosaNinchishoJiritsudo", length = 2, order = 90)
    public RString chosaNinchishoJiritsudo;
    @ReportItem(name = "ikenNinchishoJiritsudo", length = 2, order = 91)
    public RString ikenNinchishoJiritsudo;
    @ReportItem(name = "manzensei", length = 6, order = 92)
    public RString manzensei;
    @ReportItem(name = "jotainoanteisei", length = 4, order = 93)
    public RString jotainoanteisei;
    @ReportItem(name = "kyufukubun", length = 4, order = 94)
    public RString kyufukubun;
    @ReportItem(name = "listtokki4_1", length = 1, order = 95)
    public RString listtokki4_1;
    @ReportItem(name = "listYongun_1", length = 22, order = 96)
    public RString listYongun_1;
    @ReportItem(name = "listYongun_2", length = 1, order = 97)
    public RString listYongun_2;
    @ReportItem(name = "listYongun_3", length = 1, order = 98)
    public RString listYongun_3;
    @ReportItem(name = "listYongun_4", length = 22, order = 99)
    public RString listYongun_4;
    @ReportItem(name = "sabisuName", length = 15, order = 100)
    public RString sabisuName;
    @ReportItem(name = "sabisuText", order = 101)
    public RString sabisuText;
    @ReportItem(name = "listtokki5_1", length = 1, order = 102)
    public RString listtokki5_1;
    @ReportItem(name = "listGogun_1", length = 22, order = 103)
    public RString listGogun_1;
    @ReportItem(name = "listGogun_2", length = 1, order = 104)
    public RString listGogun_2;
    @ReportItem(name = "listGogun_3", length = 1, order = 105)
    public RString listGogun_3;
    @ReportItem(name = "listGogun_4", length = 22, order = 106)
    public RString listGogun_4;
    @ReportItem(name = "listshujiiikensho_1", length = 18, order = 107)
    public RString listshujiiikensho_1;
    @ReportItem(name = "listshujiiikensho_2", length = 1, order = 108)
    public RString listshujiiikensho_2;
    @ReportItem(name = "listshujiiikensho_3", length = 1, order = 109)
    public RString listshujiiikensho_3;
    @ReportItem(name = "listshujiiikensho_4", length = 18, order = 110)
    public RString listshujiiikensho_4;
    @ReportItem(name = "listtokki6_1", length = 1, order = 111)
    public RString listtokki6_1;
    @ReportItem(name = "listtokubetsunaIryo1_1", length = 2, order = 112)
    public RString listtokubetsunaIryo1_1;
    @ReportItem(name = "listtokubetsunaIryo1_2", length = 1, order = 113)
    public RString listtokubetsunaIryo1_2;
    @ReportItem(name = "listtokki7_1", length = 1, order = 114)
    public RString listtokki7_1;
    @ReportItem(name = "listtokubetsunaIryo2_1", length = 2, order = 115)
    public RString listtokubetsunaIryo2_1;
    @ReportItem(name = "listtokubetsunaIryo2_2", length = 1, order = 116)
