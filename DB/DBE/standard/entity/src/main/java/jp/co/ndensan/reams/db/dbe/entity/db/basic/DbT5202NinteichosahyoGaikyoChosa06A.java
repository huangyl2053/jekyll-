...
/**
 * 認定調査票（概況調査）06Aテーブルの項目定義クラスです。
 */
public enum DbT5202NinteichosahyoGaikyoChosa06A implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.3">
    ...
    private DbT5202NinteichosahyoGaikyoChosa06A(int maxLength, int scale) {
