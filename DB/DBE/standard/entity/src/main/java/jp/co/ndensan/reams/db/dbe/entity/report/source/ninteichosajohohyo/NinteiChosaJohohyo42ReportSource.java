 ...
 */
public class NinteiChosaJohohyo42ReportSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listRokugun_1", length = 20, order = 60)
    public RString listRokugun_1;
    @ReportItem(name = "listSabisujokyo_1", length = 3, order = 61)
    ...
    @ReportItem(name = "listIryo_1", length = 20, order = 65)
    public RString listIryo_1;
    @ReportItem(name = "imgZaitakusabisu", order = 66)
    public RString imgZaitakusabisu;
    @ReportItem(name = "zaitakusabisuTxit", order = 67)
