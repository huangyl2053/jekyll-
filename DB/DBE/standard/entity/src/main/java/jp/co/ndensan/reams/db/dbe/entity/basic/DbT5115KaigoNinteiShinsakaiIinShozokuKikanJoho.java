 ...
 */
public enum DbT5115KaigoNinteiShinsakaiIinShozokuKikanJoho implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    ...
    private DbT5115KaigoNinteiShinsakaiIinShozokuKikanJoho(int maxLength, int scale) {
