...
/**
 * 認定調査票（基本調査）06Aテーブルの項目定義クラスです。
 */
public enum DbT5203NinteichosahyoKihonChosa06A implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.3">
    ...
    private DbT5203NinteichosahyoKihonChosa06A(int maxLength, int scale) {
