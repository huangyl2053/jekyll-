...
package jp.co.ndensan.reams.db.dbe.entity.report.source.kaigohokenshindanmeireisho;
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "tsuchibun2", length = 45, order = 10)
    ...
    @ReportItem(name = "iryokikanName", order = 22)
    public RString iryokikanName;
    @ReportItem(name = "tantoIshiName", order = 23)
    public RString tantoIshiName;
    @ReportItem(name = "iryokikanJusho", order = 24)
    public RString iryokikanJusho;
    @ReportItem(name = "telNo", length = 14, order = 25)
    public RString telNo;
    @ReportItem(name = "jushinKikan", length = 25, order = 26)
    public RString jushinKikan;
    @ReportItem(name = "jushinArea", order = 27)
    public RString jushinArea;
    @ReportItem(name = "tsuchibun3", length = 45, order = 28)
    public RString tsuchibun3;
    @ReportItem(name = "tsuchibun4", length = 45, order = 29)
    public RString tsuchibun4;
    @ReportItem(name = "tsuchibun5", length = 45, order = 30)
    public RString tsuchibun5;
    @ReportItem(name = "tsuchibun6", length = 45, order = 31)
    public RString tsuchibun6;
    @ReportItem(name = "tsuchibun7", length = 45, order = 32)
    public RString tsuchibun7;
    @ReportItem(name = "tsuchibun8", length = 45, order = 33)
    public RString tsuchibun8;
    @ReportItem(name = "tsuchibun9", length = 45, order = 34)
    public RString tsuchibun9;
    @ReportItem(name = "tsuchibun10", length = 45, order = 35)
    public RString tsuchibun10;
    @ReportItem(name = "tsuchibun11", length = 45, order = 36)
    public RString tsuchibun11;
    @ReportItem(name = "tsuchibun12", length = 45, order = 37)
    public RString tsuchibun12;
    @ReportItem(name = "tsuchibun13", length = 45, order = 38)
    public RString tsuchibun13;
    @ReportItem(name = "tsuchibun14", length = 45, order = 39)
    public RString tsuchibun14;
    @ReportItem(name = "tsuchibun15", length = 45, order = 40)
    public RString tsuchibun15;
    @ReportItem(name = "tsuchibun16", length = 45, order = 41)
    public RString tsuchibun16;
    @ReportItem(name = "tsuchibun17", length = 45, order = 42)
    public RString tsuchibun17;
    @ReportItem(name = "remban", length = 4, order = 43)
