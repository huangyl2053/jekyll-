...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "shinsakaiTsuikasha", length = 2, order = 6)
    ...
    @ReportItem(name = "listShinsei_10", length = 3, order = 16)
    public RString listShinsei_10;
    @ReportItem(name = "listShinsei_11", length = 4, order = 17)
    public RString listShinsei_11;
    @ReportItem(name = "listZenkaiｙukokikan_1", length = 19, order = 18)
    public RString listZenkaiｙukokikan_1;
    @ReportItem(name = "listYukokikan_1", length = 19, order = 19)
