...
/**
 * 要介護認定主治医意見書情報2009Bテーブルの項目定義クラスです。
 */
public enum DbT5302ShujiiIkenshoJoho2009B implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    ...
    private DbT5302ShujiiIkenshoJoho2009B(int maxLength, int scale) {
