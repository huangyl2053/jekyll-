...
/**
 * 前回認定調査票（基本調査）調査項目一時テーブルです。
 *
 * @reamsid_L DBE-1520-020 wangxiaodong
 */
@OnNextSchema("rgdb")
public class ZenkaiNinteichosahyoChosaItemTempEntity extends DbTableEntityBase<ZenkaiNinteichosahyoChosaItemTempEntity> implements IDbAccessable {

    /**
     * 前回認定調査票（基本調査）調査項目一時テーブル
     */
    @TableName
    public static final RString TABLE_NAME;

    static {
        TABLE_NAME = (new RString("ZenkaiNinteichosahyoChosaItemTemp"));
    }
     ...
     */
    @Override
    public void shallowCopy(ZenkaiNinteichosahyoChosaItemTempEntity entity) {
