...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "ichijiHanteiKekka", length = 12, order = 26)
    public RString ichijiHanteiKekka;
    @ReportItem(name = "kijunGokeiTime", length = 30, order = 27)
    public RString kijunGokeiTime;
    @ReportItem(name = "listFuseigo1_1", length = 1, order = 28)
    public RString listFuseigo1_1;
    @ReportItem(name = "listFuseigo1_2", length = 1, order = 29)
    public RString listFuseigo1_2;
    @ReportItem(name = "listIchigun_1", length = 22, order = 30)
    public RString listIchigun_1;
    @ReportItem(name = "listIchigun_2", length = 1, order = 31)
    public RString listIchigun_2;
    @ReportItem(name = "listIchigun_3", length = 1, order = 32)
    public RString listIchigun_3;
    @ReportItem(name = "listIchigun_4", length = 22, order = 33)
    public RString listIchigun_4;
    @ReportItem(name = "zenkaiKijunGokeiTime", length = 30, order = 34)
    public RString zenkaiKijunGokeiTime;
    @ReportItem(name = "listkijunTime_1", length = 7, order = 35)
    public RString listkijunTime_1;
    @ReportItem(name = "listkijunTime_2", length = 7, order = 36)
    public RString listkijunTime_2;
    @ReportItem(name = "listkijunTime_3", length = 7, order = 37)
    public RString listkijunTime_3;
    @ReportItem(name = "listkijunTime_4", length = 7, order = 38)
    public RString listkijunTime_4;
    @ReportItem(name = "listkijunTime_5", length = 7, order = 39)
    public RString listkijunTime_5;
    @ReportItem(name = "listkijunTime_6", length = 7, order = 40)
    public RString listkijunTime_6;
    @ReportItem(name = "listkijunTime_7", length = 7, order = 41)
    public RString listkijunTime_7;
    @ReportItem(name = "listkijunTime_8", length = 7, order = 42)
    public RString listkijunTime_8;
    @ReportItem(name = "listkijunTime_9", length = 7, order = 43)
    public RString listkijunTime_9;
    @ReportItem(name = "listFuseigo2_1", length = 1, order = 44)
    public RString listFuseigo2_1;
    @ReportItem(name = "listFuseigo2_2", length = 1, order = 45)
    public RString listFuseigo2_2;
    @ReportItem(name = "listNigun_1", length = 22, order = 46)
    public RString listNigun_1;
    @ReportItem(name = "listNigun_2", length = 1, order = 47)
    public RString listNigun_2;
    @ReportItem(name = "listNigun_3", length = 1, order = 48)
    public RString listNigun_3;
    @ReportItem(name = "listNigun_4", length = 22, order = 49)
    public RString listNigun_4;
    @ReportItem(name = "chosaJisshiDate1", length = 9, order = 50)
    public RString chosaJisshiDate1;
    @ReportItem(name = "chosaJisshiBasho", length = 30, order = 51)
    public RString chosaJisshiBasho;
    @ReportItem(name = "tokuteishippeiName", length = 40, order = 52)
    ...
    @ReportItem(name = "shisetsuShubetsu", length = 22, order = 98)
    public RString kaigo_shisetsuShubetsu;
    @ReportItem(name = "imgSisetuName", order = 99)
    public RString kaigo_imgSisetuName;
    @ReportItem(name = "tokuteiFukushiKikan", length = 2, order = 100)
    public RString kaigo_tokuteiFukushiKikan;
    @ReportItem(name = "imgSisetuAddress", order = 101)
    public RString kaigo_imgSisetuAddress;
    @ReportItem(name = "imgSisetuTel", order = 102)
    public RString kaigo_imgSisetuTel;
    @ReportItem(name = "listYobokyufu1_1", length = 3, order = 103)
    public RString yobo_listYobokyufu1_1;
    @ReportItem(name = "listYobokyufu_1", length = 3, order = 104)
    public RString yobo_listYobokyufu_1;
    @ReportItem(name = "shisetsuShubetsu", length = 22, order = 105)
    public RString yobo_shisetsuShubetsu;
    @ReportItem(name = "imgSisetuName", order = 106)
    public RString yobo_imgSisetuName;
    @ReportItem(name = "imgSisetuAddress", order = 107)
    public RString yobo_imgSisetuAddress;
    @ReportItem(name = "imgSisetuTel", order = 108)
