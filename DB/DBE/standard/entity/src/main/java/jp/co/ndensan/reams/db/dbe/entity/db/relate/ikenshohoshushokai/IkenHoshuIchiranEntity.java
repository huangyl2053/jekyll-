...
public class IkenHoshuIchiranEntity implements IIkenHoshuIchiranCsvEucEntity {
    ...
    @CsvField(order = 12, name = "被保険者氏名")
    private final RString 被保険者氏名;
    @CsvField(order = 13, name = "在宅_新")
    private final RString 在新;
    @CsvField(order = 14, name = "在宅_継")
    private final RString 在継;
    @CsvField(order = 15, name = "施設_新")
    private final RString 施新;
    @CsvField(order = 16, name = "施設_継")
    private final RString 施継;
    @CsvField(order = 17, name = "報酬額_作成料")
    private final RString 作成料;
    @CsvField(order = 18, name = "報酬額_診療費等")
    private final RString 診断検査費用;
    @CsvField(order = 19, name = "合計")
