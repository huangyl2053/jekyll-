...
@lombok.Getter
@lombok.Setter
public class DBE010003_IkenshoJoho09BEucEntity {
    ...
    @CsvField(order = 73, name = "点滴の管理")
    private RString 点滴の管理;
    @CsvField(order = 74, name = "中心静脈栄養")
    private RString 中心静脈栄養;
    @CsvField(order = 75, name = "透析")
    private RString 透析;
    @CsvField(order = 76, name = "ストーマの処置")
    private RString ストーマの処置;
    @CsvField(order = 77, name = "酸素療法")
    private RString 酸素療法;
    @CsvField(order = 78, name = "レスピレーター")
    private RString レスピレーター;
    @CsvField(order = 79, name = "気管切開の処置")
    private RString 気管切開の処置;
    @CsvField(order = 80, name = "疼痛の看護")
    private RString 疼痛の看護;
    @CsvField(order = 81, name = "経管栄養")
    private RString 経管栄養;
    @CsvField(order = 82, name = "モニター測定")
    private RString モニター測定;
    @CsvField(order = 83, name = "じょくそうの処置")
    private RString じょくそうの処置;
    @CsvField(order = 84, name = "カテーテル")
    private RString カテーテル;
    @CsvField(order = 85, name = "寝たきり度")
    private RString 寝たきり度;
    @CsvField(order = 86, name = "認知症高齢者の日常生活自立度")
    private RString 認知症高齢者の日常生活自立度;
    @CsvField(order = 87, name = "短期記憶")
    private RString 短期記憶;
    @CsvField(order = 88, name = "認知能力")
    private RString 認知能力;
    @CsvField(order = 89, name = "伝達能力")
    private RString 伝達能力;
    @CsvField(order = 90, name = "認知症の周辺症状")
    private RString 認知症の周辺症状;
    @CsvField(order = 91, name = "幻視・幻聴")
    private RString 幻視_幻聴;
    @CsvField(order = 92, name = "妄想")
    private RString 妄想;
    @CsvField(order = 93, name = "昼夜逆転")
    private RString 昼夜逆転;
    @CsvField(order = 94, name = "暴言")
    private RString 暴言;
    @CsvField(order = 95, name = "暴行")
    private RString 暴行;
    @CsvField(order = 96, name = "介護への抵抗")
    private RString 介護への抵抗;
    @CsvField(order = 97, name = "徘徊_認知症の周辺症状")
    private RString 徘徊_認知症の周辺症状;
    @CsvField(order = 98, name = "火の不始末")
    private RString 火の不始末;
    @CsvField(order = 99, name = "不潔行為")
    private RString 不潔行為;
    @CsvField(order = 100, name = "異食行動")
    private RString 異食行動;
    @CsvField(order = 101, name = "性的問題行動")
    private RString 性的問題行動;
    @CsvField(order = 102, name = "その他")
    private RString その他;
    @CsvField(order = 103, name = "その他_症状")
    private RString その他_症状;
    @CsvField(order = 104, name = "その他の精神・神経症状")
    private RString その他の精神_神経症状;
    @CsvField(order = 105, name = "その他の精神・神経症状名")
    private RString その他の精神_神経症状名;
    @CsvField(order = 106, name = "専門医受診の有無")
    ...
    private RString 身長;
    @CsvField(order = 110, name = "体重")
    private RString 体重;
    @CsvField(order = 111, name = "過去6カ月の体重の変化")
    private RString 過去6カ月の体重の変化;
    @CsvField(order = 112, name = "四肢欠損")
    private RString 四肢欠損;
    @CsvField(order = 113, name = "四肢欠損_部位")
    private RString 四肢欠損_部位;
    @CsvField(order = 114, name = "麻痺")
    private RString 麻痺;
    @CsvField(order = 115, name = "麻痺_右上肢")
    private RString 麻痺_右上肢;
    @CsvField(order = 116, name = "麻痺_右上肢　程度")
    private RString 麻痺_右上肢_程度;
    @CsvField(order = 117, name = "麻痺_左上肢")
    private RString 麻痺_左上肢;
    @CsvField(order = 118, name = "麻痺_左上肢　程度")
    private RString 麻痺_左上肢_程度;
    @CsvField(order = 119, name = "麻痺_右下肢")
    private RString 麻痺_右下肢;
    @CsvField(order = 120, name = "麻痺_右下肢　程度")
    private RString 麻痺_右下肢_程度;
    @CsvField(order = 121, name = "麻痺_左下肢")
    private RString 麻痺_左下肢;
    @CsvField(order = 122, name = "麻痺_左下肢　程度")
    private RString 麻痺_左下肢_程度;
    @CsvField(order = 123, name = "麻痺_その他")
    private RString 麻痺_その他;
    @CsvField(order = 124, name = "麻痺_その他_部位")
    private RString 麻痺_その他_部位;
    @CsvField(order = 125, name = "麻痺_その他　程度")
    private RString 麻痺_その他_程度;
    @CsvField(order = 126, name = "筋力の低下")
    private RString 筋力の低下;
    @CsvField(order = 127, name = "筋力の低下_部位")
    private RString 筋力の低下_部位;
    @CsvField(order = 128, name = "筋力の低下　程度")
    private RString 筋力の低下_程度;
    @CsvField(order = 129, name = "関節の拘縮")
    private RString 関節の拘縮;
    @CsvField(order = 130, name = "関節の拘縮_部位")
    private RString 関節の拘縮_部位;
    @CsvField(order = 131, name = "関節の拘縮　程度")
    private RString 関節の拘縮_程度;
    @CsvField(order = 132, name = "関節の痛み")
    private RString 関節の痛み;
    @CsvField(order = 133, name = "関節の痛み_部位")
    private RString 関節の痛み_部位;
    @CsvField(order = 134, name = "関節の痛み　程度")
    private RString 関節の痛み_程度;
    @CsvField(order = 135, name = "失調・不随意運動")
    private RString 失調_不随意運動;
    @CsvField(order = 136, name = "失調・不随意運動_上肢_右")
    private RString 失調_不随意運動_上肢_右;
    @CsvField(order = 137, name = "失調・不随意運動_上肢_左")
    private RString 失調_不随意運動_上肢_左;
    @CsvField(order = 138, name = "失調・不随意運動_下肢_右")
    private RString 失調_不随意運動_下肢_右;
    @CsvField(order = 139, name = "失調・不随意運動_下肢_左")
    ...
    @CsvField(order = 142, name = "じょくそう")
    private RString じょくそう;
    @CsvField(order = 143, name = "じょくそう_部位")
    private RString じょくそう_部位;
    @CsvField(order = 144, name = "じょくそう_程度")
    private RString じょくそう_程度;
    @CsvField(order = 145, name = "その他の皮膚疾患")
    private RString その他の皮膚疾患;
    @CsvField(order = 146, name = "その他の皮膚疾患_部位")
    private RString その他の皮膚疾患_部位;
    @CsvField(order = 147, name = "その他の皮膚疾患　程度")
    private RString その他の皮膚疾患_程度;
    @CsvField(order = 148, name = "屋外歩行")
    private RString 屋外歩行;
    @CsvField(order = 149, name = "車いすの使用")
    private RString 車いすの使用;
    @CsvField(order = 150, name = "歩行補助具・装具の使用_用いていない")
    private RString 歩行補助具_装具の使用_用いていない;
    @CsvField(order = 151, name = "歩行補助具・装具の使用_屋外で使用")
    private RString 歩行補助具_装具の使用_屋外で使用;
    @CsvField(order = 152, name = "歩行補助具・装具の使用_屋内で使用")
    private RString 歩行補助具_装具の使用_屋内で使用;
    @CsvField(order = 153, name = "食事行為")
    private RString 食事行為;
    @CsvField(order = 154, name = "現在の栄養状態")
    private RString 現在の栄養状態;
    @CsvField(order = 155, name = "栄養・食生活上の留意点")
    private RString 栄養_食生活上の留意点;
    @CsvField(order = 156, name = "尿失禁")
    private RString 尿失禁;
    @CsvField(order = 157, name = "転倒・骨折")
    private RString 転倒_骨折;
    @CsvField(order = 158, name = "移動能力の低下")
    private RString 移動能力の低下;
    @CsvField(order = 159, name = "褥瘡")
    private RString 褥瘡;
    @CsvField(order = 160, name = "心肺機能の低下")
    private RString 心肺機能の低下;
    @CsvField(order = 161, name = "閉じこもり")
    private RString 閉じこもり;
    @CsvField(order = 162, name = "意欲低下")
    private RString 意欲低下;
    @CsvField(order = 163, name = "徘徊_可能性が高い病態")
    private RString 徘徊_可能性が高い病態;
    @CsvField(order = 164, name = "低栄養")
    private RString 低栄養;
    @CsvField(order = 165, name = "摂食・嚥下機能低下")
    private RString 摂食_嚥下機能低下;
    @CsvField(order = 166, name = "脱水")
    private RString 脱水;
    @CsvField(order = 167, name = "易感染性")
    private RString 易感染性;
    @CsvField(order = 168, name = "がん等による疼痛")
    private RString がん等による疼痛;
    @CsvField(order = 169, name = "病態_その他")
    private RString 病態_その他;
    @CsvField(order = 170, name = "病態_その他_詳細")
    private RString 病態_その他_詳細;
    @CsvField(order = 171, name = "病態_対処方針")
    private RString 病態_対処方針;
    @CsvField(order = 172, name = "生活機能の維持・改善の見通し")
    private RString 生活機能の維持_改善の見通し;
    @CsvField(order = 173, name = "訪問診療")
    private RString 訪問診療;
    @CsvField(order = 174, name = "訪問診療_必要性")
    private RString 訪問診療_必要性;
    @CsvField(order = 175, name = "訪問看護")
    private RString 訪問看護;
    @CsvField(order = 176, name = "訪問看護_必要性")
    private RString 訪問看護_必要性;
    @CsvField(order = 177, name = "看護職員による相談")
    private RString 看護職員による相談;
    @CsvField(order = 178, name = "看護職員による相談_必要性")
    private RString 看護職員による相談_必要性;
    @CsvField(order = 179, name = "訪問歯科診療")
    private RString 訪問歯科診療;
    @CsvField(order = 180, name = "訪問歯科診療_必要性")
    private RString 訪問歯科診療_必要性;
    @CsvField(order = 181, name = "訪問薬剤管理指導")
    private RString 訪問薬剤管理指導;
    @CsvField(order = 182, name = "訪問薬剤管理指導_必要性")
    private RString 訪問薬剤管理指導_必要性;
    @CsvField(order = 183, name = "訪問リハビリテーション")
    private RString 訪問リハビリテーション;
    @CsvField(order = 184, name = "訪問リハビリテーション_必要性")
    private RString 訪問リハビリテーション_必要性;
    @CsvField(order = 185, name = "短期入所療養介護")
    private RString 短期入所療養介護;
    @CsvField(order = 186, name = "短期入所療養介護_必要性")
    private RString 短期入所療養介護_必要性;
    @CsvField(order = 187, name = "訪問歯科衛生指導")
    private RString 訪問歯科衛生指導;
    @CsvField(order = 188, name = "訪問歯科衛生指導_必要性")
    private RString 訪問歯科衛生指導_必要性;
    @CsvField(order = 189, name = "訪問栄養食事指導")
    private RString 訪問栄養食事指導;
    @CsvField(order = 190, name = "訪問栄養食事指導_必要性")
    private RString 訪問栄養食事指導_必要性;
    @CsvField(order = 191, name = "通所リハビリテーション")
    private RString 通所リハビリテーション;
    @CsvField(order = 192, name = "通所リハビリテーション_必要性")
    private RString 通所リハビリテーション_必要性;
    @CsvField(order = 193, name = "その他の医療系のサービス")
    private RString その他の医療系のサービス;
    @CsvField(order = 194, name = "その他の医療系のサービス_詳細")
    private RString その他の医療系のサービス_詳細;
    @CsvField(order = 195, name = "その他の医療系のサービス_必要性")
    private RString その他の医療系のサービス_必要性;
    @CsvField(order = 196, name = "介護サービスの留意事項_血圧")
    private RString 介護サービスの留意事項_血圧;
    @CsvField(order = 197, name = "介護サービスの留意事項_血圧_詳細")
    private RString 介護サービスの留意事項_血圧_詳細;
    @CsvField(order = 198, name = "介護サービスの留意事項_移動")
    private RString 介護サービスの留意事項_移動;
    @CsvField(order = 199, name = "介護サービスの留意事項_移動_詳細")
    private RString 介護サービスの留意事項_移動_詳細;
    @CsvField(order = 200, name = "介護サービスの留意事項_摂食")
    private RString 介護サービスの留意事項_摂食;
    @CsvField(order = 201, name = "介護サービスの留意事項_摂食_詳細")
    private RString 介護サービスの留意事項_摂食_詳細;
    @CsvField(order = 202, name = "介護サービスの留意事項_運動")
    private RString 介護サービスの留意事項_運動;
    @CsvField(order = 203, name = "介護サービスの留意事項_運動_詳細")
    private RString 介護サービスの留意事項_運動_詳細;
    @CsvField(order = 204, name = "介護サービスの留意事項_嚥下")
    private RString 介護サービスの留意事項_嚥下;
    @CsvField(order = 205, name = "介護サービスの留意事項_嚥下_詳細")
    private RString 介護サービスの留意事項_嚥下_詳細;
    @CsvField(order = 206, name = "介護サービスの留意事項_その他")
    private RString 介護サービスの留意事項_その他;
    @CsvField(order = 207, name = "感染症の有無")
    private RString 感染症の有無;
    @CsvField(order = 208, name = "感染症の有無_詳細")
    private RString 感染症の有無_詳細;
    @CsvField(order = 209, name = "特記事項")
    private RString 特記事項;
    @CsvField(order = 210, name = "二次判定結果の連絡確認")
    private RString 二次判定結果の連絡確認;
    @CsvField(order = 211, name = "意見書メモ")
