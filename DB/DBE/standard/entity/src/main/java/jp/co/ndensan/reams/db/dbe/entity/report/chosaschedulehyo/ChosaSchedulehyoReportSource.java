...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "chosaTaishoYM", length = 12, order = 5)
    public RString chosaTaishoYM;
    @ReportItem(name = "List1_1", length = 2, order = 6)
    public RString List1_1;
    @ReportItem(name = "List1_2", length = 1, order = 7)
    public RString List1_2;
    @ReportItem(name = "List1_3", length = 1, order = 8)
    public RString List1_3;
    @ReportItem(name = "List1_4", length = 3, order = 9)
    ...
    @ReportItem(name = "List1_7", length = 1, order = 12)
    public RString List1_7;
    @ReportItem(name = "List1_8", length = 3, order = 13)
    public RString List1_8;
    @ReportItem(name = "List1_9", length = 1, order = 14)
    public RString List1_9;
    @ReportItem(name = "List1_10", length = 3, order = 15)
    public RString List1_10;
    @ReportItem(name = "List1_11", length = 1, order = 16)
    public RString List1_11;
    @ReportItem(name = "List1_12", length = 3, order = 17)
    public RString List1_12;
    @ReportItem(name = "List1_13", length = 1, order = 18)
    public RString List1_13;
    @ReportItem(name = "List1_14", length = 3, order = 19)
