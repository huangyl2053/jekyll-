...
@lombok.Getter
@lombok.Setter
public class DBE010002_ChosahyoJoho02AEucEntity {
    ...
    @CsvField(order = 81, name = "両足での立位")
    private RString 両足での立位;
    @CsvField(order = 82, name = "歩行")
    private RString 歩行;
    @CsvField(order = 83, name = "移乗")
    private RString 移乗;
    @CsvField(order = 84, name = "移動")
    private RString 移動;
    @CsvField(order = 85, name = "立ち上がり")
    private RString 立ち上がり;
    @CsvField(order = 86, name = "片足での立位")
    private RString 片足での立位;
    @CsvField(order = 87, name = "洗身")
    private RString 洗身;
    @CsvField(order = 88, name = "じょくそう")
    private RString じょくそう;
    @CsvField(order = 89, name = "他の皮膚疾患")
    private RString 他の皮膚疾患;
    @CsvField(order = 90, name = "えん下")
    private RString えん下;
    @CsvField(order = 91, name = "食事摂取")
    private RString 食事摂取;
    @CsvField(order = 92, name = "飲水摂取")
    private RString 飲水摂取;
    @CsvField(order = 93, name = "排尿")
    private RString 排尿;
    @CsvField(order = 94, name = "排便")
    private RString 排便;
    @CsvField(order = 95, name = "口腔清潔")
    private RString 口腔清潔;
    @CsvField(order = 96, name = "洗顔")
    private RString 洗顔;
    @CsvField(order = 97, name = "整髪")
    private RString 整髪;
    @CsvField(order = 98, name = "つめ切り")
    private RString つめ切り;
    @CsvField(order = 99, name = "上衣の着脱")
    private RString 上衣の着脱;
    @CsvField(order = 100, name = "ズボン等の着脱")
    private RString ズボン等の着脱;
    @CsvField(order = 101, name = "薬の内服")
    private RString 薬の内服;
    @CsvField(order = 102, name = "金銭の管理")
    private RString 金銭の管理;
    @CsvField(order = 103, name = "電話の利用")
    private RString 電話の利用;
    @CsvField(order = 104, name = "日常の意思決定")
    private RString 日常の意思決定;
    @CsvField(order = 105, name = "視力")
    private RString 視力;
    @CsvField(order = 106, name = "聴力")
    private RString 聴力;
    @CsvField(order = 107, name = "意思の伝達")
    private RString 意思の伝達;
    @CsvField(order = 108, name = "指示への反応")
    private RString 指示への反応;
    @CsvField(order = 109, name = "毎日の日課を理解")
    private RString 毎日の日課を理解;
    @CsvField(order = 110, name = "生年月日をいう")
    private RString 生年月日をいう;
    @CsvField(order = 111, name = "短期記憶")
    private RString 短期記憶;
    @CsvField(order = 112, name = "自分の名前をいう")
    private RString 自分の名前をいう;
    @CsvField(order = 113, name = "今の季節を理解")
    private RString 今の季節を理解;
    @CsvField(order = 114, name = "場所の理解")
    private RString 場所の理解;
    @CsvField(order = 115, name = "被害的")
    private RString 被害的;
    @CsvField(order = 116, name = "作話")
    private RString 作話;
    @CsvField(order = 117, name = "幻視幻聴")
    private RString 幻視幻聴;
    @CsvField(order = 118, name = "感情が不安定")
    private RString 感情が不安定;
    @CsvField(order = 119, name = "昼夜逆転")
    private RString 昼夜逆転;
    @CsvField(order = 120, name = "暴言暴行")
    private RString 暴言暴行;
    @CsvField(order = 121, name = "同じ話をする")
    private RString 同じ話をする;
    @CsvField(order = 122, name = "大声をだす")
    private RString 大声をだす;
    @CsvField(order = 123, name = "介護に抵抗")
    private RString 介護に抵抗;
    @CsvField(order = 124, name = "常時の徘徊")
    private RString 常時の徘徊;
    @CsvField(order = 125, name = "落ち着きなし")
    private RString 落ち着きなし;
    @CsvField(order = 126, name = "外出して戻れない")
    private RString 外出して戻れない;
    @CsvField(order = 127, name = "一人で出たがる")
    private RString 一人で出たがる;
    @CsvField(order = 128, name = "収集癖")
    private RString 収集癖;
    @CsvField(order = 129, name = "火の不始末")
    private RString 火の不始末;
    @CsvField(order = 130, name = "物や衣類を壊す")
    private RString 物や衣類を壊す;
    @CsvField(order = 131, name = "不潔行為")
    private RString 不潔行為;
    @CsvField(order = 132, name = "異食行動")
    private RString 異食行動;
    @CsvField(order = 133, name = "ひどい物忘れ")
