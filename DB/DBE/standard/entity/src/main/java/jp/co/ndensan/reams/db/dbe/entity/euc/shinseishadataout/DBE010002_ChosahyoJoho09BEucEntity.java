...
@lombok.Getter
@lombok.Setter
public class DBE010002_ChosahyoJoho09BEucEntity {
    ...
    @CsvField(order = 66, name = "定期巡回・随時対応型訪問介護看護")
    private RString 定期巡回_随時対応型訪問介護看護;
    @CsvField(order = 67, name = "看護小規模多機能型居宅介護")
    private RString 看護小規模多機能型居宅介護;
    @CsvField(order = 68, name = "市町村特別給付")
    private RString 市町村特別給付;
    @CsvField(order = 69, name = "介護保険給付外の在宅サービス")
    private RString 介護保険給付外の在宅サービス;
    @CsvField(order = 70, name = "現在の状況コード")
    private RString 現在の状況コード;
    @CsvField(order = 71, name = "現在の状況")
    private RString 現在の状況;
    @CsvField(order = 72, name = "利用施設名")
    private RString 利用施設名;
    @CsvField(order = 73, name = "特記事項")
    private RString 特記事項;
    @CsvField(order = 74, name = "麻痺等（左上肢）")
    private RString 麻痺等_左上肢;
    @CsvField(order = 75, name = "麻痺等（右上肢）")
    private RString 麻痺等_右上肢;
    @CsvField(order = 76, name = "麻痺等（左下肢）")
    private RString 麻痺等_左下肢;
    @CsvField(order = 77, name = "麻痺等（右下肢）")
    private RString 麻痺等_右下肢;
    @CsvField(order = 78, name = "麻痺等（その他）")
    private RString 麻痺等_その他;
    @CsvField(order = 79, name = "拘縮（肩関節）")
    private RString 拘縮_肩関節;
    @CsvField(order = 80, name = "拘縮（股関節）")
    private RString 拘縮_股関節;
    @CsvField(order = 81, name = "拘縮（膝関節）")
    private RString 拘縮_膝関節;
    @CsvField(order = 82, name = "拘縮（その他）")
    ...
    private RString 歩行;
    @CsvField(order = 88, name = "立ち上がり")
    private RString 立ち上がり;
    @CsvField(order = 89, name = "片足での立位")
    private RString 片足での立位;
    @CsvField(order = 90, name = "洗身")
    private RString 洗身;
    @CsvField(order = 91, name = "つめ切り")
    private RString つめ切り;
    @CsvField(order = 92, name = "視力")
    private RString 視力;
    @CsvField(order = 93, name = "聴力")
    private RString 聴力;
    @CsvField(order = 94, name = "移乗")
    private RString 移乗;
    @CsvField(order = 95, name = "移動")
    private RString 移動;
    @CsvField(order = 96, name = "えん下")
    private RString えん下;
    ...
    @CsvField(order = 105, name = "外出頻度")
    private RString 外出頻度;
    @CsvField(order = 106, name = "意思の伝達")
    private RString 意思の伝達;
    @CsvField(order = 107, name = "毎日の日課を理解")
    private RString 毎日の日課を理解;
    @CsvField(order = 108, name = "生年月日をいう")
    private RString 生年月日をいう;
    @CsvField(order = 109, name = "短期記憶")
    private RString 短期記憶;
    @CsvField(order = 110, name = "自分の名前をいう")
    private RString 自分の名前をいう;
    @CsvField(order = 111, name = "今の季節を理解")
    private RString 今の季節を理解;
    @CsvField(order = 112, name = "場所の理解")
    private RString 場所の理解;
    @CsvField(order = 113, name = "徘徊")
    private RString 徘徊;
    @CsvField(order = 114, name = "外出して戻れない")
    private RString 外出して戻れない;
    @CsvField(order = 115, name = "被害的")
    private RString 被害的;
    @CsvField(order = 116, name = "作話")
    private RString 作話;
    @CsvField(order = 117, name = "感情が不安定")
    private RString 感情が不安定;
    @CsvField(order = 118, name = "昼夜逆転")
    private RString 昼夜逆転;
    @CsvField(order = 119, name = "同じ話をする")
    private RString 同じ話をする;
    @CsvField(order = 120, name = "大声を出す")
    private RString 大声を出す;
    @CsvField(order = 121, name = "介護に抵抗")
    private RString 介護に抵抗;
    @CsvField(order = 122, name = "落ち着きなし")
    private RString 落ち着きなし;
    @CsvField(order = 123, name = "一人で出たがる")
    private RString 一人で出たがる;
    @CsvField(order = 124, name = "収集癖")
    private RString 収集癖;
    @CsvField(order = 125, name = "物や衣類を壊す")
    private RString 物や衣類を壊す;
    @CsvField(order = 126, name = "ひどい物忘れ")
    private RString ひどい物忘れ;
    @CsvField(order = 127, name = "独り言独り笑い")
    private RString 独り言独り笑い;
    @CsvField(order = 128, name = "自分勝手に行動する")
    private RString 自分勝手に行動する;
    @CsvField(order = 129, name = "話がまとまらない")
    private RString 話がまとまらない;
    @CsvField(order = 130, name = "薬の内服")
    private RString 薬の内服;
    @CsvField(order = 131, name = "金銭の管理")
    private RString 金銭の管理;
    @CsvField(order = 132, name = "日常の意思決定")
    private RString 日常の意思決定;
    @CsvField(order = 133, name = "集団への不適応")
    private RString 集団への不適応;
    @CsvField(order = 134, name = "買い物")
    private RString 買い物;
    @CsvField(order = 135, name = "簡単な調理")
    private RString 簡単な調理;
    @CsvField(order = 136, name = "点滴の管理")
    private RString 点滴の管理;
    @CsvField(order = 137, name = "中心静脈栄養")
    private RString 中心静脈栄養;
    @CsvField(order = 138, name = "透析")
    private RString 透析;
    @CsvField(order = 139, name = "ストーマの処置")
    private RString ストーマの処置;
    @CsvField(order = 140, name = "酸素療法")
    private RString 酸素療法;
    @CsvField(order = 141, name = "レスピレーター")
    private RString レスピレーター;
    @CsvField(order = 142, name = "気管切開の処置")
    private RString 気管切開の処置;
    @CsvField(order = 143, name = "疼痛の看護")
    private RString 疼痛の看護;
    @CsvField(order = 144, name = "経管栄養")
    private RString 経管栄養;
    @CsvField(order = 145, name = "モニター測定")
    private RString モニター測定;
    @CsvField(order = 146, name = "じょくそうの処置")
    private RString じょくそうの処置;
    @CsvField(order = 147, name = "カテーテル")
    private RString カテーテル;
    @CsvField(order = 148, name = "障害高齢者の日常生活自立度コード")
    private RString 障害高齢者の日常生活自立度コード;
    @CsvField(order = 149, name = "障害高齢者の日常生活自立度")
    private RString 障害高齢者の日常生活自立度;
    @CsvField(order = 150, name = "認知症高齢者の日常生活自立度コード")
    private RString 認知症高齢者の日常生活自立度コード;
    @CsvField(order = 151, name = "認知症高齢者の日常生活自立度")
    private RString 認知症高齢者の日常生活自立度;
    @CsvField(order = 152, name = "判定区分コード")
    private RString 判定区分コード;
    @CsvField(order = 153, name = "判定区分")
    private RString 判定区分;
    @CsvField(order = 154, name = "一次判定日")
    private RString 一次判定日;
    @CsvField(order = 155, name = "一次判定結果コード")
    private RString 一次判定結果コード;
    @CsvField(order = 156, name = "一次判定結果")
    private RString 一次判定結果;
    @CsvField(order = 157, name = "一次判定結果コード（認知症加算）")
    private RString 一次判定結果コード_認知症加算;
    @CsvField(order = 158, name = "一次判定結果（認知症加算）")
    private RString 一次判定結果_認知症加算;
    @CsvField(order = 159, name = "要介護認定基準時間")
    private RString 要介護認定基準時間;
    @CsvField(order = 160, name = "要基準時間（食事）")
    private RString 要基準時間_食事;
    @CsvField(order = 161, name = "要基準時間（排泄）")
    private RString 要基準時間_排泄;
    @CsvField(order = 162, name = "要基準時間（移動）")
    private RString 要基準時間_移動;
    @CsvField(order = 163, name = "要基準時間（清潔保持）")
    private RString 要基準時間_清潔保持;
    @CsvField(order = 164, name = "要基準時間（間接ケア）")
    private RString 要基準時間_間接ケア;
    @CsvField(order = 165, name = "要基準時間（BPSD問題）")
    private RString 要基準時間_BPSD問題;
    @CsvField(order = 166, name = "要基準時間（機能訓練）")
    private RString 要基準時間_機能訓練;
    @CsvField(order = 167, name = "要基準時間（医療関連）")
    private RString 要基準時間_医療関連;
    @CsvField(order = 168, name = "要基準時間（認知症加算）")
    private RString 要基準時間_認知症加算;
    @CsvField(order = 169, name = "中間評価項目得点第１群")
    private RString 中間評価項目得点第１群;
    @CsvField(order = 170, name = "中間評価項目得点第２群")
    private RString 中間評価項目得点第２群;
    @CsvField(order = 171, name = "中間評価項目得点第３群")
    private RString 中間評価項目得点第３群;
    @CsvField(order = 172, name = "中間評価項目得点第４群")
    private RString 中間評価項目得点第４群;
    @CsvField(order = 173, name = "中間評価項目得点第５群")
    private RString 中間評価項目得点第５群;
    @CsvField(order = 174, name = "一次判定警告コード")
    private RString 一次判定警告コード;
    @CsvField(order = 175, name = "状態の安定性コード")
    private RString 状態の安定性コード;
    @CsvField(order = 176, name = "状態の安定性")
    private RString 状態の安定性;
    @CsvField(order = 177, name = "認知症自立度Ⅱ以上の蓋然性")
    private RString 認知症自立度Ⅱ以上の蓋然性;
    @CsvField(order = 178, name = "給付区分コード")
    private RString 給付区分コード;
    @CsvField(order = 179, name = "給付区分")
