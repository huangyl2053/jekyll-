...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "chushutsuKind", length = 5, order = 1)
    public RString chushutsuKind;
    @ReportItem(name = "chushutsuKikan", length = 23, order = 2)
    public RString chushutsuKikan;
    @ReportItem(name = "joken1", length = 8, order = 3)
    public RString joken1;
    @ReportItem(name = "joken2", length = 10, order = 4)
    public RString joken2;
    @ReportItem(name = "joken3", length = 11, order = 5)
    public RString joken3;
    @ReportItem(name = "joken4", length = 11, order = 6)
