 ...
 */
package jp.co.ndensan.reams.db.dbe.entity.report.source.syujiyikensho;
...
/**
 * 主治医意見書作成依頼発行一覧表Sourceクラスです。
 */
public class IkenshoSakuseiIraiHakkoIchiranhyoReportSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">

    @ReportItem(name = "printTimeStamp", length = 34, order = 1)
    public RString printTimeStamp;
    @ReportItem(name = "chushutsuKind", length = 5, order = 2)
    public RString chushutsuKind;
    @ReportItem(name = "chushutsuKikan", length = 23, order = 3)
    public RString chushutsuKikan;
    @ReportItem(name = "joken1", length = 8, order = 4)
    public RString joken1;
    @ReportItem(name = "joken2", length = 10, order = 5)
    public RString joken2;
    @ReportItem(name = "joken3", length = 11, order = 6)
    public RString joken3;
    @ReportItem(name = "joken4", length = 11, order = 7)
