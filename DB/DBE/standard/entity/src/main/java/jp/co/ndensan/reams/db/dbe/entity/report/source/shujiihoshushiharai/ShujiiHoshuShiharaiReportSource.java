 ...
 */
package jp.co.ndensan.reams.db.dbe.entity.report.source.shujiihoshushiharai;
...
/**
 * 帳票設計_DBE621002_主治医意見書作成報酬支払通知書のReportSourceです。
 *
 * @reamsid_L DBE-1980-040 xuyongchao
 */
public class ShujiiHoshuShiharaiReportSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listGokei_2", length = 8, order = 22)
