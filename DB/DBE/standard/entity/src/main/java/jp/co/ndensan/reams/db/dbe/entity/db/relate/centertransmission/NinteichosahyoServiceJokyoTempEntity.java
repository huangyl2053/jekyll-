...
/**
 * 調査票（概況調査）サービスの状況一時テーブルです。
 *
 * @reamsid_L DBE-1450-020 wangxiaodong
 */
@OnNextSchema("rgdb")
public class NinteichosahyoServiceJokyoTempEntity extends DbTableEntityBase<NinteichosahyoServiceJokyoTempEntity> implements IDbAccessable {
    ...
    static {
        TABLE_NAME = (new RString("NinteichosahyoServiceJokyoTemp"));
    }
     ...
     */
    @Override
    public void shallowCopy(NinteichosahyoServiceJokyoTempEntity entity) {
