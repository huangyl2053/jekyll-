...
@lombok.Getter
@lombok.Setter
public class DBE010003_IkenshoJoho06AEucEntity {
    ...
    @CsvField(order = 177, name = "訪問歯科診療")
    private RString 訪問歯科診療;
    @CsvField(order = 178, name = "訪問歯科診療_必要性")
    private RString 訪問歯科診療_必要性;
    @CsvField(order = 179, name = "訪問薬剤管理指導")
    private RString 訪問薬剤管理指導;
    @CsvField(order = 180, name = "訪問薬剤管理指導_必要性")
    private RString 訪問薬剤管理指導_必要性;
    @CsvField(order = 181, name = "訪問リハビリテーション")
    private RString 訪問リハビリテーション;
    @CsvField(order = 182, name = "訪問リハビリテーション_必要性")
    private RString 訪問リハビリテーション_必要性;
    @CsvField(order = 183, name = "短期入所療養介護")
    private RString 短期入所療養介護;
    @CsvField(order = 184, name = "短期入所療養介護_必要性")
    private RString 短期入所療養介護_必要性;
    @CsvField(order = 185, name = "訪問歯科衛生指導")
    private RString 訪問歯科衛生指導;
    @CsvField(order = 186, name = "訪問歯科衛生指導_必要性")
    private RString 訪問歯科衛生指導_必要性;
    @CsvField(order = 187, name = "訪問栄養食事指導")
    private RString 訪問栄養食事指導;
    @CsvField(order = 188, name = "訪問栄養食事指導_必要性")
    private RString 訪問栄養食事指導_必要性;
    @CsvField(order = 189, name = "通所リハビリテーション")
    private RString 通所リハビリテーション;
    @CsvField(order = 190, name = "通所リハビリテーション_必要性")
    private RString 通所リハビリテーション_必要性;
    @CsvField(order = 191, name = "その他の医療系のサービス")
    private RString その他の医療系のサービス;
    @CsvField(order = 192, name = "その他の医療系のサービス_詳細")
    private RString その他の医療系のサービス_詳細;
    @CsvField(order = 193, name = "その他の医療系のサービス_必要性")
    private RString その他の医療系のサービス_必要性;
    @CsvField(order = 194, name = "介護サービスの留意事項_血圧")
    private RString 介護サービスの留意事項_血圧;
    @CsvField(order = 195, name = "介護サービスの留意事項_血圧_詳細")
    private RString 介護サービスの留意事項_血圧_詳細;
    @CsvField(order = 196, name = "介護サービスの留意事項_移動")
    private RString 介護サービスの留意事項_移動;
    @CsvField(order = 197, name = "介護サービスの留意事項_移動_詳細")
    private RString 介護サービスの留意事項_移動_詳細;
    @CsvField(order = 198, name = "介護サービスの留意事項_摂食")
    private RString 介護サービスの留意事項_摂食;
    @CsvField(order = 199, name = "介護サービスの留意事項_摂食_詳細")
    private RString 介護サービスの留意事項_摂食_詳細;
    @CsvField(order = 200, name = "介護サービスの留意事項_運動")
    private RString 介護サービスの留意事項_運動;
    @CsvField(order = 201, name = "介護サービスの留意事項_運動_詳細")
    private RString 介護サービスの留意事項_運動_詳細;
    @CsvField(order = 202, name = "介護サービスの留意事項_嚥下")
    private RString 介護サービスの留意事項_嚥下;
    @CsvField(order = 203, name = "介護サービスの留意事項_嚥下_詳細")
    private RString 介護サービスの留意事項_嚥下_詳細;
    @CsvField(order = 204, name = "介護サービスの留意事項_その他")
    private RString 介護サービスの留意事項_その他;
    @CsvField(order = 205, name = "感染症の有無")
    private RString 感染症の有無;
    @CsvField(order = 206, name = "感染症の有無_詳細")
    private RString 感染症の有無_詳細;
    @CsvField(order = 207, name = "特記事項")
    private RString 特記事項;
    @CsvField(order = 208, name = "二次判定結果の連絡確認")
    private RString 二次判定結果の連絡確認;
    @CsvField(order = 209, name = "意見書メモ")
