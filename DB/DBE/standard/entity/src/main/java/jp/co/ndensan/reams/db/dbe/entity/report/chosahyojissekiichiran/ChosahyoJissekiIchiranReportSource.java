...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listChosaJissekiIchiran_1", length = 6, order = 2)
    public RString listChosaJissekiIchiran_1;
    @ReportItem(name = "listChosaJissekiIchiran_2", length = 12, order = 3)
    public RString listChosaJissekiIchiran_2;
    @ReportItem(name = "listChosaJissekiIchiran_3", length = 40, order = 4)
    public RString listChosaJissekiIchiran_3;
    @ReportItem(name = "listChosaJissekiIchiran_4", length = 20, order = 5)
    public RString listChosaJissekiIchiran_4;
    @ReportItem(name = "listChosaJissekiIchiran_5", length = 10, order = 6)
