...
/**
 * 転入情報テーブルのエンティティクラスです。
 */
public class DbT5129TennyuEntity extends DbTableEntityBase<DbT5129TennyuEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">
    @TableName
    public static final RString TABLE_NAME = new RString("DbT5129Tennyu");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT5129TennyuEntity}と等しいか判定します。
     * 
     * @param other 比較するエンティティ
     * @return 
     * 比較するエンティティが同じ主キーを持つ{@literal DbT5129TennyuEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT5129TennyuEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT5129TennyuEntity entity) {
