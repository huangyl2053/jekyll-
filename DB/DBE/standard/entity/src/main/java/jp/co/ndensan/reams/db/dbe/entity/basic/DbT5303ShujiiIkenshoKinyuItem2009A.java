...
/**
 * 要介護認定主治医意見書記入項目2009Aテーブルの項目定義クラスです。
 */
public enum DbT5303ShujiiIkenshoKinyuItem2009A implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    ...
    private DbT5303ShujiiIkenshoKinyuItem2009A(int maxLength, int scale) {
