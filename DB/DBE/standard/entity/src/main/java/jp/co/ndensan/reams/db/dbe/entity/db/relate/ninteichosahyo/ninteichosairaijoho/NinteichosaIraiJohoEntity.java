...
@lombok.Getter
@lombok.Setter
public class NinteichosaIraiJohoEntity implements Serializable {
     ...
     * NinteichosaIraiJohoEntityが持つ{@link DbT5201NinteichosaIraiJohoEntity}と<br/> {@link NinteichosahyoGaikyoChosaEntity}のMD5値を計算し、設定します。
     */
