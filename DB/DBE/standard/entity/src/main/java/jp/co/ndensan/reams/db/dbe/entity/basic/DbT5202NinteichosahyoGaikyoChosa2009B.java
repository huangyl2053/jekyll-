...
/**
 * 認定調査票（概況調査）2009Bテーブルの項目定義クラスです。
 */
public enum DbT5202NinteichosahyoGaikyoChosa2009B implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    ...
    private DbT5202NinteichosahyoGaikyoChosa2009B(int maxLength, int scale) {
