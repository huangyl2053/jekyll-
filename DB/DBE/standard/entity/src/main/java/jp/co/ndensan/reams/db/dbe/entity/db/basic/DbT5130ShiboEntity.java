...
/**
 * 死亡情報テーブルのエンティティクラスです。
 */
public class DbT5130ShiboEntity extends DbTableEntityBase<DbT5130ShiboEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">
    @TableName
    public static final RString TABLE_NAME = new RString("DbT5130Shibo");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT5130ShiboEntity}と等しいか判定します。
     * 
     * @param other 比較するエンティティ
     * @return 
     * 比較するエンティティが同じ主キーを持つ{@literal DbT5130ShiboEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT5130ShiboEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT5130ShiboEntity entity) {
