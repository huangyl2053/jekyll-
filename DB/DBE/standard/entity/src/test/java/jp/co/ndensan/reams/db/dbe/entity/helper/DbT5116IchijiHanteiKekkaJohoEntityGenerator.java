...
public final class DbT5116IchijiHanteiKekkaJohoEntityGenerator {
    ...
    public static final Code DEFAULT_要介護認定一次判定警告コード = new Code("01");
    public static final Code DEFAULT_要介護認定状態の安定性コード = new Code("01");
    public static final Decimal DEFAULT_認知症自立度Ⅱ以上の蓋然性 = new Decimal(1);
    public static final Code DEFAULT_認知機能及び状態安定性から推定される給付区分コード = new Code("01");
    public static final Code DEFAULT_運動能力の低下していない認知症高齢者の指標コード = new Code("01");
    ...
    public static final Code DEFAULT_認知症高齢者の日常生活自立度の蓋然性評価コード = new Code("01");
    public static final int DEFAULT_認知症高齢者の日常生活自立度の蓋然性評価 = 1;
    public static final RString DEFAULT_一次判定結果送付区分 = new RString("名称");
    public static final FlexibleDate DEFAULT_一次判定結果送付年月日 = new FlexibleDate("20141030");
    public static final RString DEFAULT_チャート = new RString("名称");
    public static final RString DEFAULT_状態像 = new RString("名称");
