...
public final class DbT5102NinteiKekkaJohoEntityGenerator {
    ...
    public static final FlexibleDate DEFAULT_二次判定認定有効開始年月日 = new FlexibleDate("20150402");
    public static final FlexibleDate DEFAULT_二次判定認定有効終了年月日 = new FlexibleDate("20150402");
