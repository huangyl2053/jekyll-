...
public final class DbT5222NinteiChosaScheduleMemoEntityGenerator {
    ...
    public static final FlexibleDate DEFAULT_メモ年月日 = new FlexibleDate("20150402");
    public static final Code DEFAULT_調査地区コード = new Code("1");
    public static final Code DEFAULT_メモ区分 = new Code("1");
    public static final int DEFAULT_連番 = 1;
    public static final Code DEFAULT_メモ指定調査地区コード = new Code("1");
    public static final RString DEFAULT_作成者 = new RString("1");
    public static final Code DEFAULT_メモ重要度 = new Code("1");
    public static final RString DEFAULT_メモ内容 = new RString("1");
