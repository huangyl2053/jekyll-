...
public class ShinsakaiKaisaiBashoMapperTest extends TestBase {
    ...
    public static class to審査会開催場所のテスト {
        ...
        public void 開催場所名に山田家を持つEntityが渡されたとき_開催場所名に山田家を持つ審査会開催場所が返る() {
            sut = ShinsakaiKaisaiBashoMapper.to審査会開催場所(createEntity());
            assertThat(sut.get開催場所名(), is(開催場所名_山田家));
        }
    ...
    public static class to審査会開催場所Entityのテスト {
        ...
        public void 開催地区コードにchiku01を持つ審査会開催場所が渡されたとき_開催地区コードにchiku01を持つEntityが返る() {
            sut = ShinsakaiKaisaiBashoMapper.to審査会開催場所Entity(createKaisaiBasho());
            assertThat(sut.getShinsakaiKaisaiChikuCode(), is(new Code(開催地区_chiku01_name01.getCode())));
        }
