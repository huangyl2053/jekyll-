...
import static jp.co.ndensan.reams.db.dbe.entity.db.basic.helper.DbT5123NinteiKeikakuJohoEntityGenerator.DEFAULT_申請書管理番号;
...
public class DbT5123NinteiKeikakuJohoDacTest extends DbeTestDacBase {
    ...
    public static class updateのテスト extends DbeTestDacBase {
        ...
        public void 要介護認定計画情報エンティティを渡すと_updateは_要介護認定計画情報を更新する() {
            ...
            updateRecord.setIkenshoTorokuYoteiYMD(new FlexibleDate("20150401"));
            ...
            assertThat(updateRecord.getIkenshoTorokuYoteiYMD(), is(updatedRecord.getIkenshoTorokuYoteiYMD()));
        }
    }
