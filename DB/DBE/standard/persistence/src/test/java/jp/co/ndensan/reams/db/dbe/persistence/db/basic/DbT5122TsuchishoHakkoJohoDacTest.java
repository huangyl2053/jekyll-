...
import static jp.co.ndensan.reams.db.dbe.entity.db.basic.helper.DbT5122TsuchishoHakkoJohoEntityGenerator.DEFAULT_申請書管理番号;
...
public class DbT5122TsuchishoHakkoJohoDacTest extends DbeTestDacBase {
    ...
    public static class updateのテスト extends DbeTestDacBase {
        ...
        public void 通知書発行情報エンティティを渡すと_updateは_通知書発行情報を更新する() {
            ...
            updateRecord.setTsuchiKubun(new Code("0004"));
            ...
            assertThat(updateRecord.getTsuchiKubun(), is(updatedRecord.getTsuchiKubun()));
        }
    }
