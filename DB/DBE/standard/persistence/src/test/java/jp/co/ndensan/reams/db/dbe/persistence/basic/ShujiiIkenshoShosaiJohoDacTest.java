...
public class ShujiiIkenshoShosaiJohoDacTest extends DbeTestDacBase {
    ...
    public static class insertOrUpdate extends DbeTestDacBase {
        ...
        public void 指定した主治医意見書詳細情報が存在する時_insertOrUpdateは_該当の情報を更新する() {
            ...
            assertThat(sut.select(既存管理番号, createRirekiNo()).getIk_tokkiJiko(), is(更新用特記事項));
        }
    ...
    private static DbT5013ShujiiIkenshoShosaiJohoEntity createEntity(int flg) {
        ...
        entity.setIk_tokkiJiko(flg == AS_更新データ ? 更新用特記事項 : entity.getIk_tokkiJiko());
