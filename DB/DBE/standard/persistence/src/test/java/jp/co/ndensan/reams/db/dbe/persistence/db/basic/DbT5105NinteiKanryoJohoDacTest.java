...
import static jp.co.ndensan.reams.db.dbe.entity.db.basic.helper.DbT5105NinteiKanryoJohoEntityGenerator.DEFAULT_申請書管理番号;
...
public class DbT5105NinteiKanryoJohoDacTest extends DbeTestDacBase {
    ...
    public static class updateのテスト extends DbeTestDacBase {
        ...
        public void 要介護認定完了情報エンティティを渡すと_updateは_要介護認定完了情報を更新する() {
            ...
            updateRecord.setMaskingKanryoYMD(new FlexibleDate("20150402"));
            ...
            assertThat(updateRecord.getMaskingKanryoYMD(), is(updatedRecord.getMaskingKanryoYMD()));
        }
    }
