...
//        ImageinputMapperParamter param = ImageinputMapperParamter.createParamter(new RString("206029"), new RString("0620000002"), new RString("20170302"));
        ImageinputMapperParamter param = ImageinputMapperParamter.createParamter(new RString("206029"), new RString("0000008371"), new RString("20170301"));
        ...
        System.out.println("\t取下区分：" + entity.get取下区分コード());
...
//        ImageinputMapperParamter param = ImageinputMapperParamter.createParamter(new RString("206029"), new RString("0620000002"), new RString("20170302"));
        ...
        System.out.println("\t取下区分：" + entity.getTorisageKubunCode());
