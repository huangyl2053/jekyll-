...
import jp.co.ndensan.reams.db.dbe.entity.db.basic.DbT5052KoseiShichosonShishoMaster;
import static jp.co.ndensan.reams.db.dbe.entity.db.basic.DbT5052KoseiShichosonShishoMaster.shichosonCode;
import static jp.co.ndensan.reams.db.dbe.entity.db.basic.DbT5052KoseiShichosonShishoMaster.shishoCode;
...
public class DbT5052KoseiShichosonShishoMasterDac implements ISaveable<DbT5052KoseiShichosonShishoMasterEntity> {
     ...
     */
    @Transaction
    public List<DbT5052KoseiShichosonShishoMasterEntity> selectByShichosonCode(LasdecCode 市町村コード) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
