...
public interface IHoshuShiharaiJunbiPanelMapper {
     ...
     */
    List<HoshuShiharaiJunbiRelateEntity> get認定調査対象(HoshushiharaiJumbiPanelBatchMybitisParameter 検索条件);
     ...
     * @return HoshuShiharaiJunbiRelateEntity 検索結果の{@link HoshuShiharaiJunbiRelateEntity}
     */
    List<HoshuShiharaiJunbiRelateEntity> get主治医意見書作成報酬(HoshushiharaiJumbiPanelBatchMybitisParameter 検索条件);
     ...
     * @return HoshuShiharaiJunbiRelateEntity 検索結果の{@link HoshuShiharaiJunbiRelateEntity}
     */
    List<HoshuShiharaiJunbiRelateEntity> get審査会委員報酬(HoshushiharaiJumbiPanelBatchMybitisParameter 検索条件);
}
