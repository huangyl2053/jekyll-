...
import jp.co.ndensan.reams.db.dbe.entity.db.relate.ninteikekkajoho.NinteiKekkaJohoEntity;
...
public interface INinteiKekkaJohoMapper {
     ...
     */
    NinteiKekkaJohoEntity getNinteiShinseiJohoEntity(NinteiKekkaJohoMapperParameter 要介護認定結果情報検索条件);
}
