 ...
 * 要介護認定進捗情報の、主治医意見書作成依頼完了年月日が"00000000"以降で、主治医意見書登録完了年月日が"00000000"のデータを取得します。
 *
 * @author N8187 久保田 英男
 */
public class ShujiiIkenshoTorikomiTaishoshaDac {
    ...
    /**
     * 指定された証記載保険者番号に該当する、主治医意見書取込対象者を取得します。
     *
    ...
    /**
     * 指定された証記載保険者番号及び支所コードに該当する、主治医意見書取込対象者を取得します。
     *
     * @param 証記載保険者番号 証記載保険者番号
     * @param 支所コード 支所コード
     * @return 介護認定処理対象者エンティティのリスト
