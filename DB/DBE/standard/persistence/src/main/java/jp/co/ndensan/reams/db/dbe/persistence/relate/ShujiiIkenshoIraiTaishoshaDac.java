...
public class ShujiiIkenshoIraiTaishoshaDac implements IShujiiIkenshoIraiTaishoshaDac {
    ...
    @Override
    public List<DbT5005NinteiShinchokuJohoEntity> select主治医意見書作成依頼対象者(ShoKisaiHokenshaNo 証記載保険者番号) {
    ...
    @Override
    public List<DbT5005NinteiShinchokuJohoEntity> select主治医意見書作成依頼対象者(ShoKisaiHokenshaNo 証記載保険者番号, RString 支所コード) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
