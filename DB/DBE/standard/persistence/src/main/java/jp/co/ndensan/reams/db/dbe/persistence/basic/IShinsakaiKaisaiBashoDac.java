...
public interface IShinsakaiKaisaiBashoDac
     ...
     */
    @Transaction
    DbT5104ShinsakaiKaisaiBashoJohoEntity select(KaisaiBashoCode 審査会開催場所);
     ...
     */
    @Transaction
    DbT5104ShinsakaiKaisaiBashoJohoEntity select(KaisaiBashoCode 審査会開催場所, boolean 開催場所状況);
     ...
     */
    @Transaction
    List<DbT5104ShinsakaiKaisaiBashoJohoEntity> selectAll(boolean 開催場所状況);
