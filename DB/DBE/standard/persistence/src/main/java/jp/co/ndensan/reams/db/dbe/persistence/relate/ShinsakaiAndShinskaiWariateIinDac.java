...
public class ShinsakaiAndShinskaiWariateIinDac {
     ...
     * @param 割当委員EntityList 割当委員EntityList
     * @return 更新件数
     */
    @Transaction
    public int insertOrUpdate(DbT5101ShinsakaiJohoEntity 審査会Entity,
        ...
        更新件数 += shinsakaiDac.insertOrUpdate(審査会Entity);
     ...
     */
    @Transaction
    public int delete(DbT5101ShinsakaiJohoEntity 審査会Entity,
            List<DbT5106ShinsakaiWariateIinJohoEntity> 割当委員EntityList) {
        wariateDac = InstanceProvider.create(ShinsakaiWariateIinJohoDac.class);
        shinsakaiDac = InstanceProvider.create(ShinsakaiJohoDac.class);
        ...
        削除件数 += shinsakaiDac.delete(審査会Entity);
        for (DbT5106ShinsakaiWariateIinJohoEntity 割当委員Entity : 割当委員EntityList) {
