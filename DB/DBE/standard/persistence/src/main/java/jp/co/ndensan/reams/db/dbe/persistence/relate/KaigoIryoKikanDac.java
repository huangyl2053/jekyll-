...
import jp.co.ndensan.reams.ur.urz.entity.IryoKikan;
...
public class KaigoIryoKikanDac implements IKaigoIryoKikanDac {
    ...
    public List<KaigoIryoKikanEntity> select(ITrueFalseCriteria criteria) {
        ...
        return accessor.select().
                ...
                leftJoin(IryoKikan.class, using(DbT7011ShujiiIryoKikanJoho.kaigoIryokikanCode)).
                where(criteria).
                toList(KaigoIryoKikanEntity.class);
    }

    @Override
    public KaigoIryoKikanEntity select(ShichosonCode 市町村コード, KaigoIryoKikanCode 介護医療機関コード) {
        DbAccessor accessor = new DbAccessor(session);
        return accessor.select().
                table(DbT7011ShujiiIryoKikanJoho.class).
                leftJoin(IryoKikan.class, using(DbT7011ShujiiIryoKikanJoho.kaigoIryokikanCode)).
    ...
    @Override
    public KaigoIryoKikanEntity select(ShichosonCode 市町村コード, KaigoIryoKikanCode 介護医療機関コード, IryoKikanJokyo 医療機関状況) {
        DbAccessor accessor = new DbAccessor(session);
        return accessor.select().
                table(DbT7011ShujiiIryoKikanJoho.class).
                leftJoin(IryoKikan.class, using(DbT7011ShujiiIryoKikanJoho.kaigoIryokikanCode)).
    ...
    @Override
    public List<KaigoIryoKikanEntity> select(ShichosonCode 市町村コード) {
        DbAccessor accessor = new DbAccessor(session);
        return accessor.select().
                table(DbT7011ShujiiIryoKikanJoho.class).
                leftJoin(IryoKikan.class, using(DbT7011ShujiiIryoKikanJoho.kaigoIryokikanCode)).
    ...
    @Override
    public List<KaigoIryoKikanEntity> select(ShichosonCode 市町村コード, IryoKikanJokyo 医療機関状況) {
        DbAccessor accessor = new DbAccessor(session);
        return accessor.select().
                table(DbT7011ShujiiIryoKikanJoho.class).
                leftJoin(IryoKikan.class, using(DbT7011ShujiiIryoKikanJoho.kaigoIryokikanCode)).
