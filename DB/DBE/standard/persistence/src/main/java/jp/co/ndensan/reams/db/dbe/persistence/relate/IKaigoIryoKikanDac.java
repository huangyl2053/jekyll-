...
public interface IKaigoIryoKikanDac {
     ...
     */
    @Transaction
    KaigoIryoKikanEntity select(LasdecCode 市町村コード, KaigoIryoKikanCode 介護医療機関コード);
     ...
     */
    @Transaction
    KaigoIryoKikanEntity select(LasdecCode 市町村コード, KaigoIryoKikanCode 介護医療機関コード, IryoKikanJokyo 医療機関の状況);
     ...
     */
    @Transaction
    List<KaigoIryoKikanEntity> select(LasdecCode 市町村コード);
     ...
     */
    @Transaction
    List<KaigoIryoKikanEntity> select(LasdecCode 市町村コード, IryoKikanJokyo 医療機関の状況);
}
