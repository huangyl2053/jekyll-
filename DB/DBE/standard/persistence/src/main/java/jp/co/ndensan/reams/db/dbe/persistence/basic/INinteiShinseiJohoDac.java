...
public interface INinteiShinseiJohoDac extends IUpdatable<DbT5001NinteiShinseiJohoEntity> {
     ...
     */
    @Transaction
    List<DbT5001NinteiShinseiJohoEntity> selectAllBy認定申請年月日(ShichosonCode 市町村コード, Range<FlexibleDateOld> 認定申請年月日範囲);
     ...
     */
    @Transaction
    List<DbT5001NinteiShinseiJohoEntity> selectAllBy取下げ年月日(ShichosonCode 市町村コード, Range<FlexibleDateOld> 取下げ年月日範囲);
}
