...
/**
 * 認定調査票_特記事項_項目有りの帳票出力処理クラスです。
 */
public class NinteiChosaTokkiJikoKomokuAri extends BatchProcessBase<HomonChosaIraishoRelateEntity> {
    ...
    private static final ReportIdDBZ 帳票 = ReportIdDBZ.DBE221021;
