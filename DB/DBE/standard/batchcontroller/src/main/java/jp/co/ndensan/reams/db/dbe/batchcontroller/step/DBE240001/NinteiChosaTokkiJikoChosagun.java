 ...
 */
public class NinteiChosaTokkiJikoChosagun extends BatchProcessBase<HomonChosaIraishoRelateEntity> {
    ...
    protected void initialize() {
        ...
        帳票 = new ReportId(DbBusinessConfig.get(
                ConfigNameDBE.認定調査票_特記事項_調査群記載あり_帳票ID, RDate.getNowDate(), SubGyomuCode.DBE認定支援, processParamter.getShichosonCode()));
    }
