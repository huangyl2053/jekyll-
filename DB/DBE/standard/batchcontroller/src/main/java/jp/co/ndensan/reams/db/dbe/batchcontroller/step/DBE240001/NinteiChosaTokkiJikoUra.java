...
/**
 * 認定調査票OCR_特記事項片面の帳票出力処理クラスです。
 */
public class NinteiChosaTokkiJikoUra extends BatchProcessBase<HomonChosaIraishoRelateEntity> {
    ...
    protected void initialize() {
        ...
        帳票 = new ReportId(DbBusinessConfig.get(
                ConfigNameDBE.認定調査票_特記事項_帳票ID_裏, RDate.getNowDate(), SubGyomuCode.DBE認定支援, processParamter.getShichosonCode()));
    }
