...
public class ChosahyoGaikyochosa_221001Process extends BatchProcessBase<HomonChosaIraishoRelateEntity> {
    ...
    private static final ReportId 帳票ID = ReportIdDBE.DBE221001.getReportId();
    ...
    private void update認定調査依頼情報(HomonChosaIraishoRelateEntity entity) {
        ...
        RString 認定調査期限設定方法 = DbBusinessConifg.get(ConfigNameDBE.認定調査期限設定方法,
                RDate.getNowDate(),
    ...
    private void バッチ出力条件リストの出力() {
        ...
        ReportOutputJokenhyoItem reportOutputJokenhyoItem = new ReportOutputJokenhyoItem(
                ...
                市町村名,
                ジョブ番号,
                ReportIdDBE.DBE221001.getReportName(),
                出力ページ数,
                csv出力有無,
                csvファイル名,
                出力条件);
