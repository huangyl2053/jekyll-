...
/**
 * 認定調査票_特記事項_項目無し_手入力の帳票出力処理クラスです。
 */
public class NinteiChosaTokkiJikoKomokuNashiTenyuryoku extends BatchProcessBase<HomonChosaIraishoRelateEntity> {
    ...
    private static final ReportIdDBZ 帳票 = ReportIdDBZ.DBE221025;
