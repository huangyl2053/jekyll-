...
/**
 * 主治医意見書記入用紙_片面_デザインの出力処理クラスです。
 */
public class KinyuYoshiKatamenDesign extends BatchProcessBase<ShujiiIkenshoTeishutsuIraishoHakkoRelateEntity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString(
            ...
            + "get主治医意見書提出依頼書発行");
    private static final ReportIdDBZ 帳票 = ReportIdDBZ.DBE231014;
