...
public class ChosahyoTokkijiko_221022Process extends BatchProcessBase<HomonChosaIraishoRelateEntity> {
    ...
    private static final ReportId 帳票ID = ReportIdDBZ.DBE221003.getReportId();
    ...
    protected void process(HomonChosaIraishoRelateEntity entity) {
        ChosahyoTokkijikoReport report = new ChosahyoTokkijikoReport(business.setDBE221022Item(entity), 帳票ID);
    ...
    private void バッチ出力条件リストの出力() {
        ...
        ReportOutputJokenhyoItem reportOutputJokenhyoItem = new ReportOutputJokenhyoItem(
                ...
                ReportIdDBZ.DBE221003.getReportName(),
