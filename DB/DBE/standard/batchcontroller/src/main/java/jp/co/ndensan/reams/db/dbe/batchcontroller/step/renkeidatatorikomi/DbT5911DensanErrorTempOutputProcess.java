 ...
 */
public class DbT5911DensanErrorTempOutputProcess extends BatchProcessBase<DbT5911ErrorTempEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbe.persistence.db.mapper.relate.renkeidatatorikomi.IDbT5911TempMapper.get医療機関エラー情報_電算");
    ...
    @BatchWriter
    private EucCsvWriter<DbT5911ErrorTempEUCEntity> eucCsvWriter;
    ...
    protected void process(DbT5911ErrorTempEntity entity) {
        eucCsvWriter.writeLine(new RenkeiDataTorikomiBusiness().setDbT5911ErrorTempEUCEntity(entity));
    }
