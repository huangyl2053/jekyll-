...
import jp.co.ndensan.reams.db.dbe.business.core.ninteichosadataoutput.DbT5210GetProcessKeyBreakCore;
...
/**
 * 認定調査票（概況調査）施設利用情報を取得し取得したEntityを一時テーブルにセットする処理です。
 */
public class DbT5210GetProcess extends BatchKeyBreakBase<NinteiChosaDataOutputBatchRelateEntity> {
    ...
    private DbT5210GetProcessKeyBreakCore keyBreakCore;
    ...
    protected void beforeExecute() {
        keyBreakCore = new DbT5210GetProcessKeyBreakCore();
    }
