...
//import static jp.co.ndensan.reams.db.dbe.batchcontroller.step.DBE581001.TsutishoHakkoCommonProcess.get地方公共団体;
import jp.co.ndensan.reams.db.dbe.business.report.dbe581001.YokaigoNinteiEnkiTshuchishoReport;
...
import jp.co.ndensan.reams.db.dbe.entity.db.relate.enkitsuchisho.YokaigoNinteiEnkiTshuchishoEntity;
...
//        sofubutsuAtesakiSource = 編集後宛先.getSofubutsuAtesakiSource().get送付物宛先ソース();
    ...
    private void outputJokenhyoFactory() {
        ...
        ReportOutputJokenhyoItem item = new ReportOutputJokenhyoItem(
                ReportIdDBE.DBE581001.getReportId().getColumnValue(),
                association.getLasdecCode_().getColumnValue(),
                association.get市町村名(),
                new RString(String.valueOf(JobContextHolder.getJobId())),
                ReportIdDBE.DBE581001.getReportName(),
                ページ数,
                new RString("無し"),
                RString.EMPTY,
                contribute());
