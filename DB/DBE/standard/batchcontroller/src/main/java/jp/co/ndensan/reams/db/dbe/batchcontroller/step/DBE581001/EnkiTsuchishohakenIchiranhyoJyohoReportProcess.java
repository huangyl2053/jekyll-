 ...
 */
package jp.co.ndensan.reams.db.dbe.batchcontroller.step.DBE581001;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.Collections;
import java.util.List;
import jp.co.ndensan.reams.db.dbe.business.report.dbe581002.NinteiEnkiTsuchishoHakkoIchiranhyoReport;
import jp.co.ndensan.reams.db.dbe.definition.processprm.enkitsuchisho.EnkiTsuchishohakenIchiranhyoJyohoProcessParameter;
import jp.co.ndensan.reams.db.dbe.definition.core.reportid.ReportIdDBE;
import jp.co.ndensan.reams.db.dbe.entity.db.relate.enkitsuchisho.EnkiTsuchishoEntity;
import jp.co.ndensan.reams.db.dbe.entity.report.dbe581002.NinteiEnkiTsuchishoHakkoIchiranhyoReportSource;
...
public class EnkiTsuchishohakenIchiranhyoJyohoReportProcess extends BatchKeyBreakBase<EnkiTsuchishoEntity> {
    ...
    protected void createWriter() {
        batchReportWriter = BatchReportFactory.createBatchReportWriter(REPORT_DBE581002.value())
    ...
    private void outputJokenhyoFactory() {
        ...
        ReportOutputJokenhyoItem item = new ReportOutputJokenhyoItem(
                ReportIdDBE.DBE581002.getReportId().getColumnValue(),
                association.getLasdecCode_().getColumnValue(),
                association.get市町村名(),
                new RString(String.valueOf(JobContextHolder.getJobId())),
                ReportIdDBE.DBE581002.getReportName(),
                ページ数,
                new RString("無し"),
                RString.EMPTY,
                contribute());
