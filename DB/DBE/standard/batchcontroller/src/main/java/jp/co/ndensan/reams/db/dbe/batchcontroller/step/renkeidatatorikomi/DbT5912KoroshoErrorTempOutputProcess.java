 ...
 */
public class DbT5912KoroshoErrorTempOutputProcess extends BatchProcessBase<DbT5912ErrorTempEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbe.persistence.db.mapper.relate.renkeidatatorikomi.IDbT5912TempMapper.get主治医エラー情報_厚労省");
    ...
    @BatchWriter
    private EucCsvWriter<DbT5912KoroshoErrorTempEUCEntity> eucCsvWriter;
    ...
    protected void process(DbT5912ErrorTempEntity entity) {
        eucCsvWriter.writeLine(new RenkeiDataTorikomiBusiness().setDbT5912KoroshoErrorTempEUCEntity(entity));
    }
