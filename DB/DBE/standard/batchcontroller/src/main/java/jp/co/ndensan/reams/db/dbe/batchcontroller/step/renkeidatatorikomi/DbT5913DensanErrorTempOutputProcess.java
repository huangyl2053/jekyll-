 ...
 */
public class DbT5913DensanErrorTempOutputProcess extends BatchProcessBase<DbT5913ErrorTempEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbe.persistence.db.mapper.relate.renkeidatatorikomi.IDbT5913TempMapper.get調査員エラー情報_電算");
    ...
    @BatchWriter
    private EucCsvWriter<DbT5913ErrorTempEUCEntity> eucCsvWriter;
    ...
    protected void process(DbT5913ErrorTempEntity entity) {
        eucCsvWriter.writeLine(new RenkeiDataTorikomiBusiness().setDbT5913ErrorTempEUCEntity(entity));
    }
