...
public class ShujiiIkenshoTeishutsuIraishoProcess extends BatchProcessBase<ShujiiIkenshoTeishutsuIraishoHakkoRelateEntity> {
    ...
    private ShujiiIkenshoTeishutsuIraishoItem setItem(ShujiiIkenshoTeishutsuIraishoHakkoRelateEntity entity) {
        ...
        get年号(new FlexibleDate(entity.get生年月日()), item);
    ...
    private void get年号(FlexibleDate 生年月日, ShujiiIkenshoTeishutsuIraishoItem item) {
    ...
    private void set認証者情報(ShujiiIkenshoTeishutsuIraishoItem item) {
    ...
    private void バッチ出力条件リストの出力() {
        ...
        ReportOutputJokenhyoItem reportOutputJokenhyoItem = new ReportOutputJokenhyoItem(
                ...
                市町村名,
                ジョブ番号,
                ReportIdDBE.DBE236001.getReportName(),
                出力ページ数,
                csv出力有無,
                csvファイル名,
                出力条件);
