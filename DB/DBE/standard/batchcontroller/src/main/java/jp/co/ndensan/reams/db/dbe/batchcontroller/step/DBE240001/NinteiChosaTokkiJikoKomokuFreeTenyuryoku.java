...
/**
 * 認定調査票_特記事項_フリータイプ_手入力の帳票出力処理クラスです。
 */
public class NinteiChosaTokkiJikoKomokuFreeTenyuryoku extends BatchProcessBase<HomonChosaIraishoRelateEntity> {
    ...
    private static final ReportIdDBZ 帳票 = ReportIdDBZ.DBE221026;
