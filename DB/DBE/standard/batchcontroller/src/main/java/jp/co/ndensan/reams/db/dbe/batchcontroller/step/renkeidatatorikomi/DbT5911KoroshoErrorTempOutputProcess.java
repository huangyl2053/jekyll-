...
/**
 *
 * 主治医医療機関情報エラー一時テーブルより、CSVファイルを出力_バッチフ処理クラスです。
 *
 * @reamsid_L DBE-1490-020 duanzhanli
 */
public class DbT5911KoroshoErrorTempOutputProcess extends BatchProcessBase<DbT5911ErrorTempEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbe.persistence.db.mapper.relate.renkeidatatorikomi.IDbT5911TempMapper.get医療機関エラー情報_厚労省");
    private static final EucEntityId EUC_ENTITY_ID = new EucEntityId("DBE192005");
    ...
    @BatchWriter
    private EucCsvWriter<DbT5911KoroshoErrorTempEUCEntity> eucCsvWriter;

    @Override
    protected void initialize() {
        manager = new FileSpoolManager(UzUDE0835SpoolOutputType.EucOther, EUC_ENTITY_ID, UzUDE0831EucAccesslogFileType.Csv);
        eucFilePath = Path.combinePath(manager.getEucOutputDirectry(), new RString("ShujiiIryoKikanJohoErrList.CSV"));
    }
    ...
    @Override
    protected void process(DbT5911ErrorTempEntity entity) {
        eucCsvWriter.writeLine(new RenkeiDataTorikomiBusiness().setDbT5911KoroshoErrorTempEUCEntity(entity));
    }
    ...
    private void outputJokenhyoFactory() {
        ...
        EucFileOutputJokenhyoItem item = new EucFileOutputJokenhyoItem(
                ...
                new RString("主治医医療機関情報エラーリストファイル.CSV"),
                new RString("ShujiiIryoKikanJohoErrList.CSV"),
