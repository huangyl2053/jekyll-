...
public class KihonChosaKomokuDataOutputProcess extends BatchProcessBase<KihonChosaKomokuDataRelateEntity> {
    ...
    protected IBatchReader createReader() {
        ShinsaTaishoDataOutPutMybatisParameter parameter
                = new ShinsaTaishoDataOutPutMybatisParameter(
                        processParamter.getKaisaiBangou(),
                        KoroshoIfShikibetsuCode.認定ｿﾌﾄ2009_SP3.getコード());
