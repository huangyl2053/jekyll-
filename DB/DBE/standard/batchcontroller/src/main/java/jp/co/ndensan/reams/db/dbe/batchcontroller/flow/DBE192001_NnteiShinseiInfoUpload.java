    ...
    protected void defineFlow() {
        ...
        if (取込み対象ファイルリスト != null && !取込み対象ファイルリスト.isEmpty()) {
            ...
            if (!processParamter.is法改正後フラグ()) {
                ...
                主治医情報ファイル名 = DbBusinessConfig.get(ConfigNameDBE.主治医データ取込みファイル名, 基準日, SubGyomuCode.DBE認定支援, getParameter().get市町村コード());
                医療機関ファイル名 = DbBusinessConfig.get(ConfigNameDBE.主治医医療機関データ取込みファイル名, 基準日, SubGyomuCode.DBE認定支援, getParameter().get市町村コード());
                認定調査員ファイル名 = DbBusinessConfig.get(ConfigNameDBE.認定調査員データ取込みファイル名, 基準日, SubGyomuCode.DBE認定支援, getParameter().get市町村コード());
                調査委託先ファイル名 = DbBusinessConfig.get(ConfigNameDBE.認定調査委託先データ取込みファイル名, 基準日, SubGyomuCode.DBE認定支援, getParameter().get市町村コード());
            } else {
                認定申請ファイル名 = DbBusinessConfig.get(ConfigNameDBE.要介護認定申請連携データ取込みファイル名_新, 基準日, SubGyomuCode.DBE認定支援, getParameter().get市町村コード());
                主治医情報ファイル名 = DbBusinessConfig.get(ConfigNameDBE.主治医データ取込みファイル名_新, 基準日, SubGyomuCode.DBE認定支援, getParameter().get市町村コード());
                医療機関ファイル名 = DbBusinessConfig.get(ConfigNameDBE.主治医医療機関データ取込みファイル名_新, 基準日, SubGyomuCode.DBE認定支援, getParameter().get市町村コード());
                認定調査員ファイル名 = DbBusinessConfig.get(ConfigNameDBE.認定調査員データ取込みファイル名_新, 基準日, SubGyomuCode.DBE認定支援, getParameter().get市町村コード());
                調査委託先ファイル名 = DbBusinessConfig.get(ConfigNameDBE.認定調査委託先データ取込みファイル名_新, 基準日, SubGyomuCode.DBE認定支援, getParameter().get市町村コード());
            }
...
//
//<editor-fold defaultstate="collapsed" desc="電算：４マスタ">
    ...
    //<editor-fold defaultstate="collapsed" desc="電算：調査委託先">
    ...
    protected IBatchFlowCommand insert認定調査委託先一時TBL_電算() {
        return importCsv(調査委託先ファイル, 調査委託先一時テーブルNAME, DbTableType.TEMPORARY)
                .encode(encodeForParam).hasHeader(false).define();
    }
    ...
    //<editor-fold defaultstate="collapsed" desc="電算：調査員">
    ...
    protected IBatchFlowCommand insert認定調査員一時TBL_電算() {
        return importCsv(認定調査員ファイル, 認定調査員一時テーブルNAME, DbTableType.TEMPORARY)
                .encode(encodeForParam).hasHeader(false).define();
    }
    ...
    //<editor-fold defaultstate="collapsed" desc="電算：医療機関">
    ...
    protected IBatchFlowCommand insert主治医医療機関一時TBL_電算() {
        return importCsv(医療機関ファイル, 医療機関一時テーブルNAME, DbTableType.TEMPORARY)
                .encode(encodeForParam).hasHeader(false).define();
    }
    ...
    //<editor-fold defaultstate="collapsed" desc="電算：主治医">
    ...
    protected IBatchFlowCommand insert主治医情報一時TBL_電算() {
        return importCsv(主治医情報ファイル, 主治医情報一時テーブルNAME, DbTableType.TEMPORARY)
                .encode(encodeForParam).hasHeader(false).define();
    }
...
//</editor-fold>
//
//<editor-fold defaultstate="collapsed" desc="厚労省：４マスタ">
    ...
    //<editor-fold defaultstate="collapsed" desc="厚労省：調査委託先">
    ...
    //<editor-fold defaultstate="collapsed" desc="厚労省：調査員">
    ...
    //<editor-fold defaultstate="collapsed" desc="厚労省：医療機関">
    ...
    //<editor-fold defaultstate="collapsed" desc="厚労省：主治医">
...
//</editor-fold>
//
//<editor-fold defaultstate="collapsed" desc="電算：申請情報">
...
//</editor-fold>
//
//<editor-fold defaultstate="collapsed" desc="厚労省：申請">
...
//</editor-fold>
//
//<editor-fold defaultstate="collapsed" desc="東芝：申請情報">
