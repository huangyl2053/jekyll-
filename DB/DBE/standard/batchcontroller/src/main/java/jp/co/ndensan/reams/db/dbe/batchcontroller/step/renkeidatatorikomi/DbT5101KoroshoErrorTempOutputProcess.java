 ...
 */
public class DbT5101KoroshoErrorTempOutputProcess extends BatchProcessBase<DbT5101ErrorTempEntity> {
    ...
    @BatchWriter
    private EucCsvWriter<DbT5101KoroshoErrorTempEUCEntity> eucCsvWriter;
    ...
    protected void process(DbT5101ErrorTempEntity entity) {
        eucCsvWriter.writeLine(new RenkeiDataTorikomiBusiness().setDbT5101KoroshoErrorTempEUCEntity(entity));
    }
