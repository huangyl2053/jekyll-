 ...
 * 調査員一覧情報の取得バッチクラスです。
 */
public class YouKaiGoNinTeiKekTesuChiProcess extends BatchProcessBase<ItakusakiChosainIchiranRelateEntity> {
   ...
   @Override
   protected void process(ItakusakiChosainIchiranRelateEntity t) {
