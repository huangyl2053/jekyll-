 ...
 */
public class NinteiChosaTokkiJikoKomokuFree extends BatchProcessBase<HomonChosaIraishoRelateEntity> {
    ...
    private static final ReportIdDBZ 帳票 = ReportIdDBZ.DBE221023;
