...
import jp.co.ndensan.reams.db.dbe.business.core.ninteichosadataoutput.DbT5209GetProcessKeyBreakCore;
...
/**
 * 認定調査票（概況調査）記入項目情報を取得し取得したEntityを一時テーブルにセットする処理です。
 */
public class DbT5209GetProcess extends BatchKeyBreakBase<NinteiChosaDataOutputBatchRelateEntity> {
    ...
    private DbT5209GetProcessKeyBreakCore keyBreakCore;
    ...
    protected void beforeExecute() {
        keyBreakCore = new DbT5209GetProcessKeyBreakCore();
    }
