...
/**
 * 認定調査票OCR_特記事項両面の帳票出力処理クラスです。
 */
public class NinteiChosaTokkiJikoOCRRyomen extends BatchProcessBase<HomonChosaIraishoRelateEntity> {
    ...
    private static final ReportIdDBZ 帳票 = ReportIdDBZ.DBE221031;
