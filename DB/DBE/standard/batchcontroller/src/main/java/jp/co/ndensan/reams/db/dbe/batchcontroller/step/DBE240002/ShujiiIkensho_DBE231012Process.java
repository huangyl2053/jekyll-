...
/**
 * 帳票「DBE231012_主治医意見書記入用紙」の出力処理クラスです。
 *
 * @reamsid_L DBE-0080-130 duanzhanli
 */
public class ShujiiIkensho_DBE231012Process extends BatchProcessBase<ShujiiIkenshoTeishutsuIraishoHakkoRelateEntity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString(
            ...
            + "get主治医意見書提出依頼書発行");
    private static final ReportId 帳票ID = ReportIdDBZ.DBE231001.getReportId();
    ...
    protected void process(ShujiiIkenshoTeishutsuIraishoHakkoRelateEntity entity) {
        IkenshokinyuyoshiReport report = new IkenshokinyuyoshiReport(new IraishoIkkatsuHakkoBusiness(entity, processParamter).setDBE231012Item());
    ...
    protected void afterExecute() {
        ...
        OutputJokenhyoFactory.createInstance(new IraishoIkkatsuHakkoBusiness(null, processParamter).
                バッチ出力条件リストの出力(市町村名,
                        出力ページ数,
                        導入団体コード,
                        ReportIdDBZ.DBE231001.getReportId().value(), ReportIdDBZ.DBE231001.getReportName())).print();
    }
}
