...
public class ChosahyoKihonchosaProcess extends BatchProcessBase<HomonChosaIraishoRelateEntity> {
    ...
    private static final ReportId 帳票ID = ReportIdDBZ.DBE221012.getReportId();
    ...
    protected void process(HomonChosaIraishoRelateEntity entity) {
        ChosahyoKihonchosaKatamenReport report = ChosahyoKihonchosaKatamenReport.createFrom(business.setChosahyoKihonchosaKatamenItem(entity));
    ...
    private void バッチ出力条件リストの出力() {
        ...
        ReportOutputJokenhyoItem reportOutputJokenhyoItem = new ReportOutputJokenhyoItem(
                ...
                ReportIdDBZ.DBE221012.getReportName(),
