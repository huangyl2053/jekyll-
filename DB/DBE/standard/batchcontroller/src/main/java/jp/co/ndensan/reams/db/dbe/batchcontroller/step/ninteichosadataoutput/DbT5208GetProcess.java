...
import jp.co.ndensan.reams.db.dbe.business.core.ninteichosadataoutput.DbT5208GetProcessKeyBreakCore;
...
/**
 * 認定調査票（概況調査）サービスの状況フラグ情報を取得し取得したEntityを一時テーブルにセットする処理です。
 */
public class DbT5208GetProcess extends BatchKeyBreakBase<NinteiChosaDataOutputBatchRelateEntity> {
    ...
    private DbT5208GetProcessKeyBreakCore keyBreakCore;
    ...
    protected void beforeExecute() {
        keyBreakCore = new DbT5208GetProcessKeyBreakCore();
    }
