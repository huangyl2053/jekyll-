 ...
 */
public class DbT5910DensanErrorTempOutputProcess extends BatchProcessBase<DbT5910ErrorTempEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbe.persistence.db.mapper.relate.renkeidatatorikomi.IDbT5910TempMapper.get委託先一時エラー情報_電算");
    ...
    @BatchWriter
    private EucCsvWriter<DbT5910ErrorTempEUCEntity> eucCsvWriter;
    ...
    protected void process(DbT5910ErrorTempEntity entity) {
        eucCsvWriter.writeLine(new RenkeiDataTorikomiBusiness().setDbT5910ErrorTempEUCEntity(entity));
    }
