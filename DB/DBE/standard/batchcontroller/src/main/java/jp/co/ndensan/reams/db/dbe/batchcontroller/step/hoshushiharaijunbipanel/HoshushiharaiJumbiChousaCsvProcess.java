 ...
 */
public class HoshushiharaiJumbiChousaCsvProcess extends BatchProcessBase<HoshushiharaiJumbiPanelBatchRelateEntity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString(
            ...
            + ".get認定調査対象");
    private static final EucEntityId EUC_ENTITY_ID = new EucEntityId("DBE622003");
    ...
    protected void process(HoshushiharaiJumbiPanelBatchRelateEntity entity) {
        ...
        batchsimplewriter.writeLine(business.setEucCsvEntity(entity, get口座情報(new KamokuCode("003"), 業務固有キー),
                processParameter.getFurikomishiteiday(), new RString("1")));
    }
