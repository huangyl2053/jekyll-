...
/**
 * 認定調査票_特記事項_フリータイプの帳票出力処理クラスです。
 */
public class NinteiChosaTokkiJikoFree extends BatchProcessBase<HomonChosaIraishoRelateEntity> {
    ...
    protected void initialize() {
        ...
        帳票 = new ReportId(DbBusinessConfig.get(
                ConfigNameDBE.認定調査票_特記事項_フリー様式_帳票ID, RDate.getNowDate(), SubGyomuCode.DBE認定支援, processParamter.getShichosonCode()));
    }
    ...
    protected void process(HomonChosaIraishoRelateEntity entity) {
        ChosahyoTokkijikoFreeReport report = ChosahyoTokkijikoFreeReport.createFrom(business.setDBE221022Item(entity));
