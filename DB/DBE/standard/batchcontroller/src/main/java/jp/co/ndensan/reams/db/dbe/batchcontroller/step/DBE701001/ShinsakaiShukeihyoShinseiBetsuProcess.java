 ...
 */
public class ShinsakaiShukeihyoShinseiBetsuProcess extends BatchProcessBase<ShinsakaiShukeihyoShinseiBetsuEntity> {
    ...
    @Override
    protected void process(ShinsakaiShukeihyoShinseiBetsuEntity current) {
        isデータあり = true;
        new ShinsakaiShukeihyoShinseiBetsuEditor(parameter, current, shukeihyoShinseiBetsu).set介護認定審査会集計表申請区分別();
    }
