...
public class ShinsakaiWariateIinManagerTest {
    ...
    public static class get審査会参加割当委員Listのテスト extends DbeTestBase {
        ...
        public void 開催年月日を指定して_その日に審査会に参加する委員を2件取得できる() {
            ShinsakaiWariateIinList result = sut.get審査会参加割当委員List(new ShinsakaiKaisaiYMD(new FlexibleDate("19990101")));
        ...
        private ShinsakaiWariateIinJohoDac create割当委員情報DacMock(int 件数) {
            ...
            when(割当委員Dac.select(any(ShinsakaiKaisaiYMD.class))).thenReturn(審査会情報);
            return 割当委員Dac;
        }
    }
    ...
    public static class saveのテスト extends DbeTestBase {
        ...
        public void 情報を更新した場合_trueが返る() {
            ...
            ShinsakaiWariateIin 割当委員 = ShinsakaiTestBusinessCreator.create審査会割当委員(1, "19990101", "iin01");
    ...
    private static List<DbT5106ShinsakaiWariateIinJohoEntity> create審査会割当委員(int 件数) {
        ...
        for (int i = 0; i < 件数; i++) {
            list.add(ShinsakaiTestEntityCreator.create審査会割当委員情報EntitySpy(1, "19990101", "iin01"));
        }
        return list;
    }
    ...
    private static ShinsakaiIinManager create委員Manager() {
        ...
        ShinsakaiIin 審査会情報 = ShinsakaiTestBusinessCreator.create審査会委員("iin01");
