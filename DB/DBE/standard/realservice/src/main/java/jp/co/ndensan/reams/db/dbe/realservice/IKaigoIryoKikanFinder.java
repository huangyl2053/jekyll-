...
public interface IKaigoIryoKikanFinder {
     ...
     * @return 介護医療機関情報
     */
    KaigoIryoKikan get介護医療機関(ShichosonCode 市町村コード, KaigoIryoKikanCode 介護医療機関コード);
     ...
     * @return 介護医療機関情報
     */
    KaigoIryoKikan get介護医療機関(ShichosonCode 市町村コード, KaigoIryoKikanCode 介護医療機関コード, IryoKikanJokyo 医療機関の状況);
