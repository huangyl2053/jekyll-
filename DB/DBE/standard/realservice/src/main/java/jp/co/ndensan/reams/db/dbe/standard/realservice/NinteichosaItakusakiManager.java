 ...
 */
package jp.co.ndensan.reams.db.dbe.standard.realservice;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;
import jp.co.ndensan.reams.db.dbe.standard.business.HatsubanJoho;
...
import jp.co.ndensan.reams.db.dbe.standard.business.NinteichosaItakusaki;
import jp.co.ndensan.reams.db.dbe.standard.entity.basic.DbT5020HatsubanKanriJohoEntity;
import jp.co.ndensan.reams.db.dbe.standard.entity.basic.DbT7010NinteichosaItakusakiJohoEntity;
import jp.co.ndensan.reams.db.dbe.standard.entity.mapper.HatsubanJohoMapper;
import jp.co.ndensan.reams.db.dbe.standard.entity.mapper.NinteichosaItakusakiMapper;
import jp.co.ndensan.reams.db.dbe.standard.persistence.IHatsubanKanriJohoDac;
import jp.co.ndensan.reams.db.dbe.standard.persistence.INinteichosaItakusakiDac;
