...
public class ShinsakaiWariateIinManager {
     ...
     * @return 審査会割当委員List
     */
    public ShinsakaiWariateIinList get審査会参加割当委員List(ShinsakaiKaisaiYMD 開催年月日) {
    ...
    private ShinsakaiDetail get審査会情報(DbT5106ShinsakaiWariateIinJohoEntity 割当委員Entity) {
        ...
        ShinsakaiKaisaiYMD 開催年月日 = new ShinsakaiKaisaiYMD(割当委員Entity.getShinsakaiKaisaiYMD());
