...
public class NinchishoKoreishaJiritsudoGaizenseiHyokaCodeTest {
    ...
    public static class コンストラクタのテスト extends DbeTestBase {
        ...
        public void 引数に20桁より大きい文字列が渡されたとき_IllegalArgumentExceptionが発生する() {
            sut = new NinchishoKoreishaJiritsudoGaizenseiHyokaCode(new RString("012345678901234567890"));
        }

        @Test
        public void 引数に20桁以内の文字列が渡されたとき_インスタンスが生成される() {
            sut = new NinchishoKoreishaJiritsudoGaizenseiHyokaCode(new RString("01234567890123456789"));
            assertThat(sut, is(instanceOf(NinchishoKoreishaJiritsudoGaizenseiHyokaCode.class)));
        }
    }
}
