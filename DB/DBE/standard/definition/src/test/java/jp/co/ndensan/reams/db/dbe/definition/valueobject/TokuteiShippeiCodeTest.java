...
/**
 * 特定疾病コードを保持するクラスのテストクラスです。
 *
 * @author N8156 宮本 康
 */
@RunWith(Enclosed.class)
public class TokuteiShippeiCodeTest extends DbeTestBase {

    private static final TokuteiShippeiCode 基準コード = new TokuteiShippeiCode(new Code(new RString("1234")));
    private static final TokuteiShippeiCode 基準より小さいコード = new TokuteiShippeiCode(new Code(new RString("1111")));
    private static final TokuteiShippeiCode 基準より大きいコード = new TokuteiShippeiCode(new Code(new RString("2222")));
    private static final TokuteiShippeiCode 基準と異なるコード = new TokuteiShippeiCode(new Code(new RString("5678")));

    public static class コンストラクタ {

        @Test(expected = NullPointerException.class)
        public void 引数がNULLの時_コンストラクタは_NullPointerExceptionを投げる() {
            new TokuteiShippeiCode(null);
        }
    }
