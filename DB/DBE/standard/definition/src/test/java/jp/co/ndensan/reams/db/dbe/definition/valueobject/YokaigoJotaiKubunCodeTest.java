...
/**
 * 要介護状態区分コードを保持するクラスのテストクラスです。
 *
 * @author N8156 宮本 康
 */
@RunWith(Enclosed.class)
public class YokaigoJotaiKubunCodeTest extends DbeTestBase {

    private static final YokaigoJotaiKubunCode 基準コード = new YokaigoJotaiKubunCode(new Code(new RString("1234")));
    private static final YokaigoJotaiKubunCode 基準より小さいコード = new YokaigoJotaiKubunCode(new Code(new RString("1111")));
    private static final YokaigoJotaiKubunCode 基準より大きいコード = new YokaigoJotaiKubunCode(new Code(new RString("2222")));
    private static final YokaigoJotaiKubunCode 基準と異なるコード = new YokaigoJotaiKubunCode(new Code(new RString("5678")));

    public static class コンストラクタ {

        @Test(expected = NullPointerException.class)
        public void 引数がNULLの時_コンストラクタは_NullPointerExceptionを投げる() {
            new YokaigoJotaiKubunCode(null);
        }
    }
