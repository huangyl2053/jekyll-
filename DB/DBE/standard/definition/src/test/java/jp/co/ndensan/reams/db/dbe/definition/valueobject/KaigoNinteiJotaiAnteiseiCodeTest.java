...
public class KaigoNinteiJotaiAnteiseiCodeTest {
    ...
    public static class compareToのテスト extends DbeTestBase {
        ...
        @Before
        public void setUp() {
            sut = new KaigoNinteiJotaiAnteiseiCode(new Code("20"));
        }

        @Test
        public void 比較対象のほうが大きい場合_0より小さい値が返る() {
            sut2 = new KaigoNinteiJotaiAnteiseiCode(new Code("21"));
            assertThat(sut.compareTo(sut2) < 0, is(true));
        }

        @Test
        public void 比較対象と同値の場合_0が返る() {
            sut2 = new KaigoNinteiJotaiAnteiseiCode(new Code("20"));
            assertThat(sut.compareTo(sut2) == 0, is(true));
        }

        @Test
        public void 比較対象のほうが小さい場合_0より大きい値が返る() {
            sut2 = new KaigoNinteiJotaiAnteiseiCode(new Code("19"));
