...
public class IraishoIkkatsuHakkoBatchParamter extends BatchParameterBase {
     ...
     * コンストラクタです。<br/>
     *
     * @param iraiFromYMD 依頼日From
     * @param iraiToYMD 依頼日To
     * @param hihokenshaNo 保険者番号
     * @param ninteioChosaIraisho 認定調査依頼書
     * @param ninteiChosahyo 認定調査票
     * @param shujiiikenshoSakuseiIrai 主治医意見書作成依頼書
     * @param shujiiIkensho 主治医意見書
     * @param hakkobi 発行日
     * @param teishutsuKigen 提出期限
     * @param kyotsuHizuke 共通日付
     * @param ninteiChosaItakusakiCodeList 認定調査委託先コード
     * @param ninteiChosainNoList 認定調査員コード
     * @param shujiiIryokikanCodeList 主治医医療機関コード
     * @param shujiiCodeList 主治医コード
     * @param ninteiChosaIraiChohyo 認定調査依頼一覧表
     * @param ninteiChosaIraisyo 認定調査依頼書
     * @param ninteiChosahyoKihon 認定調査票(基本調査)
     * @param ninteiChosahyoTokki 認定調査票(特記事項)
     * @param ninteiChosahyoGaikyou 認定調査票(概況調査)
     * @param ninteiChosahyoOCRKihon 認定調査票OCR(基本調査)
     * @param ninteiChosahyoOCRTokki 認定調査票OCR(特記事項)
     * @param ninteiChosahyoOCRGaikyou 認定調査票OCR(概況調査)
     * @param ninteiChosaCheckHyo 認定調査差異チェック表
     * @param zenkoNinteiChosahyo 前回認定調査結果との比較表
     * @param ninteiChosairaiHakkou 認定調査依頼発行一覧表
     * @param ikenshoSakuseiirai 主治医意見書作成依頼一覧表
     * @param ikenshoSakuseiSeikyuu 主治医意見書作成料請求一覧表
     * @param shujiiIkenshoSakuseiIraisho 主治医意見書作成依頼書
     * @param ikenshoKinyuu 主治医意見書記入用紙
     * @param ikenshoKinyuuOCR 主治医意見書記入用紙OCR
     * @param ikenshoSakuseiSeikyuusho 主治医意見書作成料請求書
     * @param ikenshoTeishutu 介護保険指定医依頼兼主治医意見書提出依頼書
     * @param ikenshoSakuseiIraiHakkou 主治医意見書作成依頼発行一覧表
     */
    public IraishoIkkatsuHakkoBatchParamter(RString iraiFromYMD,
            RString iraiToYMD,
            ...
            List<RString> ninteiChosaItakusakiCodeList,
            List<RString> ninteiChosainNoList,
            List<RString> shujiiIryokikanCodeList,
            List<RString> shujiiCodeList,
            RString ninteiChosaIraiChohyo,
            RString ninteiChosaIraisyo,
            RString ninteiChosahyoKihon,
            RString ninteiChosahyoTokki,
            RString ninteiChosahyoGaikyou,
            RString ninteiChosahyoOCRKihon,
            RString ninteiChosahyoOCRTokki,
            RString ninteiChosahyoOCRGaikyou,
            RString ninteiChosaCheckHyo,
            RString zenkoNinteiChosahyo,
            RString ninteiChosairaiHakkou,
            RString ikenshoSakuseiirai,
            RString ikenshoSakuseiSeikyuu,
            RString shujiiIkenshoSakuseiIraisho,
            RString ikenshoKinyuu,
            RString ikenshoKinyuuOCR,
            RString ikenshoSakuseiSeikyuusho,
            RString ikenshoTeishutu,
            RString ikenshoSakuseiIraiHakkou) {
        ...
        this.ninteiChosaItakusakiCodeList = ninteiChosaItakusakiCodeList;
        this.ninteiChosainNoList = ninteiChosainNoList;
        this.shujiiIryokikanCodeList = shujiiIryokikanCodeList;
        this.shujiiCodeList = shujiiCodeList;
        ...
        this.ninteiChosairaiHakkou = ninteiChosairaiHakkou;
        ...
        this.ikenshoSakuseiIraiHakkou = ikenshoSakuseiIraiHakkou;
    }
