...
@Getter
public class ShujiiIkenMybatisParameter implements IMyBatisParameter {
     ...
     */
    private ShujiiIkenMybatisParameter(
     ...
     */
    public static ShujiiIkenMybatisParameter createSelectByKeyParam(
            RString shujiiikenshoSakuseiIrai,
            RString shujiiIkensho,
            List<GridParameter> shujiiIkenshoSakuseiIraiList,
            RString iraiFromYMD,
        ...
        return new ShujiiIkenMybatisParameter(shujiiikenshoSakuseiIrai,
                shujiiIkensho,
