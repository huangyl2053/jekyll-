 ...
 */
package jp.co.ndensan.reams.db.dbe.definition.batchprm.ikenshojohoprint;
...
public class IkenshoJohoPrintBatchParameter extends BatchParameterBase {
    ...
    private final RString 主治医意見書５項目確認一覧表作成条件;
     ...
     */
    public IkenshoJohoPrintBatchParameter(
