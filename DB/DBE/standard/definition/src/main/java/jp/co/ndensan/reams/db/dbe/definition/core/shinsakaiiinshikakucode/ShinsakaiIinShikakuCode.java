 ...
 */
package jp.co.ndensan.reams.db.dbe.definition.core.shinsakaiiinshikakucode;
 ...
 *
 */
public class ShinsakaiIinShikakuCode implements Comparable<ShinsakaiIinShikakuCode>, ICodeWrapValueObject, IDbColumnMappable, IValidatable {
//public class ShinsakaiIinShikakuCode implements Comparable<ShinsakaiIinShikakuCode>, IValueObject<Code>, IDbColumnMappable, IValidatable {
    ...
    /**
     * DB等からコンストラクタを利用して直接マッピングされた、<br/> {@link ShinsakaiIinShikakuCode}が持つcodeについてバリデーションを実施します。
     *
     ...
     * @throws IllegalArgumentException {@link ShinsakaiIinShikakuCodeSpec}の仕様を満たさない場合
     */
