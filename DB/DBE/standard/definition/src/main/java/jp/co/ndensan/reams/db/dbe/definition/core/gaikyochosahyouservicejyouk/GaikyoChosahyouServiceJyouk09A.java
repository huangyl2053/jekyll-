...
/**
 * 概況調査票サービスの状況09Aを表す列挙型です。
 *
 * @reamsid_L DBE-9999-023 wangchao
 */
public enum GaikyoChosahyouServiceJyouk09A {
     ...
     */
    特定施設入居者生活介護("10", get単位_回(), get単位_月(), get給付区分_介護予防(), "(介護予防)特定施設入居者生活介護"),
    /**
    ...
    private GaikyoChosahyouServiceJyouk09A(String code, String tani1, String tani2, String kyuufuKubun, String fullname) {
    ...
    /**
     * 概況調査票サービスの状況09Aの連番を返します。
     *
     * @return 概況調査票サービスの状況09Aの連番
     */
    ...
    /**
     * 概況調査票サービスの状況09Aの単位1を返します。
     *
     * @return 概況調査票サービスの状況09Aの単位1
     */
    ...
    /**
     * 概況調査票サービスの状況09Aの単位2を返します。
     *
     * @return 概況調査票サービスの状況09Aの単位2
     */
    ...
    /**
     * 概況調査票サービスの状況09Aの給付区分を返します。
     *
     * @return 概況調査票サービスの状況09Aの給付区分2
     */
    ...
    /**
     * 概況調査票サービスの状況09Aの帳票上の文言を返します。
     *
     * @return 概況調査票サービスの状況09Aの帳票上の文言
     */
    ...
    /**
     * 概況調査票サービスの状況09Aの連番と一致する内容を探します。
     *
     * @param code 概況調査票サービスの状況09Aの連番
     * @return {@code code} に対応する概況調査票サービスの状況09A
     */
    public static GaikyoChosahyouServiceJyouk09A toValue(RString code) {

        for (GaikyoChosahyouServiceJyouk09A values : GaikyoChosahyouServiceJyouk09A.values()) {
            if (values.code.equals(code)) {
                return values;
            }
        }
        throw new IllegalArgumentException(UrSystemErrorMessages.変換不可.getReplacedMessage("概況調査票サービスの状況09A"));
    }
    
    /**
     * 指定した給付区分の概況調査票サービス状況09Aのレコード数を返します。
     *
     * @param kyufuKubun 給付区分
     * @return {@kyufuKubun 給付区分} に対応する概況調査票サービス状況09Aのレコード数
     */
    public static int get給付サービスRecordSize(RString kyufuKubun) {
        int size = 0;
        for (GaikyoChosahyouServiceJyouk09A values : GaikyoChosahyouServiceJyouk09A.values()) {
            if (values.get給付区分().equals(kyufuKubun)) {
                size++;
            }
        }
        return size;
