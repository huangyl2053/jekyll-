...
public class NinteichosahyoRegulationOf2006 implements INinteichosahyoRegulation {
    ...
    private static void initialize基本調査定義() {
        ...
        builder.set調査項目("1-1", NinteichosaItemKubunOfKihon.麻痺等の有無_左上肢, "（左－上肢）", Choice.Checked.values());
        builder.set調査項目("1-1", NinteichosaItemKubunOfKihon.麻痺等の有無_右上肢, "（右－上肢）", Choice.Checked.values());
        builder.set調査項目("1-1", NinteichosaItemKubunOfKihon.麻痺等の有無_左下肢, "（左－下肢）", Choice.Checked.values());
        builder.set調査項目("1-1", NinteichosaItemKubunOfKihon.麻痺等の有無_右下肢, "（右－下肢）", Choice.Checked.values());
        ...
        builder.set調査項目("1-2", NinteichosaItemKubunOfKihon.関節の動く範囲の制限_肩関節, "（肩関節）", Choice.Checked.values());
        builder.set調査項目("1-2", NinteichosaItemKubunOfKihon.関節の動く範囲の制限_肘関節, "（肘関節）", Choice.Checked.values());
        builder.set調査項目("1-2", NinteichosaItemKubunOfKihon.関節の動く範囲の制限_股関節, "（股関節）", Choice.Checked.values());
        builder.set調査項目("1-2", NinteichosaItemKubunOfKihon.関節の動く範囲の制限_膝関節, "（膝関節）", Choice.Checked.values());
        builder.set調査項目("1-2", NinteichosaItemKubunOfKihon.関節の動く範囲の制限_足関節, "（足関節）", Choice.Checked.values());
