...
@Getter
public class NinteiChosaMybitisParamter implements IMyBatisParameter {
     ...
     */
    private NinteiChosaMybitisParamter(RString 依頼日From,
            RString 依頼日To,
            RString 認定調査依頼書,
            RString 認定調査票,
     ...
     */
    public static NinteiChosaMybitisParamter createSelectByKeyParam(RString 依頼日From,
            RString 依頼日To,
            RString 認定調査依頼書,
            RString 認定調査票,
            List<GridParameter> 認定調査依頼リスト) {
        ...
        return new NinteiChosaMybitisParamter(依頼日From,
                依頼日To,
                認定調査依頼書,
                認定調査票,
                認定調査依頼リスト,
