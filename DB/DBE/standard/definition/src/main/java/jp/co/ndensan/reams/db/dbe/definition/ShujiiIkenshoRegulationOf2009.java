...
public class ShujiiIkenshoRegulationOf2009 implements IShujiiIkenshoRegulation {
    ...
    private static void initialize() {
        ...
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.傷病, ShujiiIkenshoItemSubGroup.Of2009.傷病_治療内容);
        builder.set意見書項目("", ShujiiIkenshoItemKubun.治療内容, "", Choice.FreeInput.values());
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.特別医療, ShujiiIkenshoItemSubGroup.Of2009.処置内容);
        ...
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.特別医療, ShujiiIkenshoItemSubGroup.Of2009.特別対応);
        ...
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.特別医療, ShujiiIkenshoItemSubGroup.Of2009.失禁対応);
        builder.set意見書項目("", ShujiiIkenshoItemKubun.カテーテル, "カテーテル（コンドームカテーテル、留置カテーテル 等）", Choice.Checked.values());
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.心身状態, ShujiiIkenshoItemSubGroup.Of2009.自立度);
        ...
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.心身状態, ShujiiIkenshoItemSubGroup.Of2009.中核症状);
        ...
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.心身状態, ShujiiIkenshoItemSubGroup.Of2009.周辺症状);
        ...
        builder.set意見書項目("", ShujiiIkenshoItemKubun.認知症_その他, "その他", Choice.Checked.values());
        builder.set意見書項目("", ShujiiIkenshoItemKubun.認知症_その他内容, "", Choice.FreeInput.values());
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.心身状態, ShujiiIkenshoItemSubGroup.Of2009.精神_神経症状);
        ...
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.心身状態, ShujiiIkenshoItemSubGroup.Of2009.身体状態);
        ...
        builder.set意見書項目("", ShujiiIkenshoItemKubun.麻痺_その他, "その他", Choice.Checked.values());
        ...
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.生活機能_サービス, ShujiiIkenshoItemSubGroup.Of2009.移動);
        ...
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.生活機能_サービス, ShujiiIkenshoItemSubGroup.Of2009.栄養_食生活);
        ...
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.生活機能_サービス, ShujiiIkenshoItemSubGroup.Of2009.状態_対処方針);
        ...
        builder.set意見書項目("", ShujiiIkenshoItemKubun.その他状態, "その他", Choice.Checked.values());
        builder.set意見書項目("", ShujiiIkenshoItemKubun.その他状態内容, "その他", Choice.FreeInput.values());
        builder.set意見書項目("", ShujiiIkenshoItemKubun.状態対処方針, "対処方針", Choice.FreeInput.values());
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.生活機能_サービス, ShujiiIkenshoItemSubGroup.Of2009.維持_改善見通し);
        builder.set意見書項目("", ShujiiIkenshoItemKubun.介護の必要な程度に関する予後の見直し, "", Choice.Kitai.values());
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.生活機能_サービス, ShujiiIkenshoItemSubGroup.Of2009.管理の必要性);
        ...
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.生活機能_サービス, ShujiiIkenshoItemSubGroup.Of2009.留意事項);
        ...
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.生活機能_サービス, ShujiiIkenshoItemSubGroup.Of2009.感染症);
        ...
        builder.set意見書項目グループ(ShujiiIkenshoItemGroup.Of2009.特記事項, ShujiiIkenshoItemSubGroup.OfCommon.なし);
