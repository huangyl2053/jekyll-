...
public class JisshiJokyoTokeiProcessParameter implements IBatchProcessParameter {
    ...
    /**
     * JisshiJokyoTokeiMyBatisParameterに転換します。
     *
     * @return JisshiJokyoTokeiMyBatisParameter
     */
    public JisshiJokyoTokeiMyBatisParameter toJisshiJokyoTokeiMyBatisParameter() {

        return new JisshiJokyoTokeiMyBatisParameter(
                isEmptyHokensyaNo,
                hokensyaNo,
                hihokenshaKubun,
                isEmptyGogitaiNo,
