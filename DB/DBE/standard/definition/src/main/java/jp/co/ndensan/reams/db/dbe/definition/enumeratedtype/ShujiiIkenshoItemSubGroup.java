...
/**
 * 主治医意見書の項目サブグループを扱うクラスです。
 *
 * @author N8156 宮本 康
 */
public class ShujiiIkenshoItemSubGroup {

    /**
     * 共通の意見書項目サブグループを表す列挙型です。
     */
    public enum OfCommon implements IShujiiIkenshoItemSubGroup {
    ...
    /**
     * 2009年の意見書項目サブグループを表す列挙型です。
     */
    public enum Of2009 implements IShujiiIkenshoItemSubGroup {
