...
/**
 * 介護認定審査会集計表（判定別）のProcessParameterです。
 *
...
public class ShinsakaishukeihyoHanteiBetsuProcessParameter implements IBatchProcessParameter {
     ...
     */
    public ShinsakaishukeihyoHanteiBetsuProcessParameter(
    ...
    /**
     * ShinsakaishukeihyoHanteiBetsuMyBatisParameterに転換します。
     *
     * @return ShinsakaishukeihyoHanteiBetsuMyBatisParameter
     */
    public ShinsakaishukeihyoHanteiBetsuMyBatisParameter toShinsakaishukeihyoHanteiBetsuMyBatisParameter() {

        return new ShinsakaishukeihyoHanteiBetsuMyBatisParameter(
                isEmptyHokensyaNo,
                hokensyaNo,
                hihokenshaKubun,
                isEmptyGogitaiNo,
