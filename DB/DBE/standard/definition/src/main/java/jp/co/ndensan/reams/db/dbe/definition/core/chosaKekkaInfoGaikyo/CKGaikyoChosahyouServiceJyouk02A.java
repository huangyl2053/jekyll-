 ...
 */
public enum CKGaikyoChosahyouServiceJyouk02A implements IGaikyoChosahyoServiceJokyo {
    ...
    private CKGaikyoChosahyouServiceJyouk02A(String code, String tani1, String tani2, String fullname) {
     ...
     */
    public static CKGaikyoChosahyouServiceJyouk02A toValue(RString code) {
        for (CKGaikyoChosahyouServiceJyouk02A values : CKGaikyoChosahyouServiceJyouk02A.values()) {
    ...
    public RString get給付区分() {
        throw new IllegalArgumentException(UrErrorMessages.存在しない.getMessage().replace("概況調査票サービスの状況02Aには給付区分").evaluate());
    }
}
