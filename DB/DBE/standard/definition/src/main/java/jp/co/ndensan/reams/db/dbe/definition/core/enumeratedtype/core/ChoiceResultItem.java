 ...
 */
package jp.co.ndensan.reams.db.dbe.definition.core.enumeratedtype.core;

import jp.co.ndensan.reams.uz.uza.lang.RString;

/**
 * 回答結果項目（選択結果項目）を扱うクラスです。
 *
 * @author N8156 宮本 康
 */
public class ChoiceResultItem {

    /**
     * 「チェック有無」を表す列挙型です。<br />
     * 単純に調査結果の有無だけを指定する場合に使用します。
     */
    public enum Checked implements IAnswerResultItem {
     ...
     * 「ない／ある」の選択肢を表す列挙型です。
     */
    public enum NaiAru implements IAnswerResultItem {
     ...
     * 「ない／ある」の選択肢を表す列挙型です。
     */
    public enum NaiAru2 implements IAnswerResultItem {
     ...
     */
    public enum DekiruDekinai implements IAnswerResultItem {
     ...
     * 「できる／できない」の選択肢を表す列挙型です。
     */
    public enum DekiruDekinai2 implements IAnswerResultItem {
     ...
     * 「できる／できない」の選択肢を表す列挙型です。
     */
    public enum DekiruDekinai3 implements IAnswerResultItem {
     ...
     * 「できる／できない」の選択肢を表す列挙型です。
     */
    public enum DekiruDekinai4 implements IAnswerResultItem {
     ...
     * 「できる／できない」の選択肢を表す列挙型です。
     */
    public enum DekiruDekinai5 implements IAnswerResultItem {
     ...
     * 「できる／できない」の選択肢を表す列挙型です。
     */
    public enum DekiruDekinai6 implements IAnswerResultItem {
     ...
     * 「できる／できない」の選択肢を表す列挙型です。
     */
    public enum DekiruDekinai7 implements IAnswerResultItem {
     ...
     * 「介助」の選択肢を表す列挙型です。
     */
    public enum Kaijo implements IAnswerResultItem {
     ...
     * 「介助」の選択肢を表す列挙型です。
     */
    public enum Kaijo2 implements IAnswerResultItem {
     ...
     * 「介助」の選択肢を表す列挙型です。
     */
    public enum Kaijo3 implements IAnswerResultItem {
     ...
     * 「視力」の選択肢を表す列挙型です。
     */
    public enum Shiryoku implements IAnswerResultItem {
     ...
     * 「聴力」の選択肢を表す列挙型です。
     */
    public enum Choryoku implements IAnswerResultItem {
     ...
     * 「外出頻度」の選択肢を表す列挙型です。
     */
    public enum Gaishutsu implements IAnswerResultItem {
     ...
     * 「指示」の選択肢を表す列挙型です。
     */
    public enum Shiji implements IAnswerResultItem {
     ...
     */
    public enum ShogaiJiritsu implements IAnswerResultItem {
     ...
     */
    public enum NinchishoJiritsu implements IAnswerResultItem {
     ...
     * 「サービス区分」の選択肢を表す列挙型です。
     */
    public enum ServiceKubun implements IAnswerResultItem {
     ...
     * 「施設利用」の選択肢を表す列挙型です。
     */
    public enum ShisetsuRiyo implements IAnswerResultItem {
     ...
     * 「安定性」の選択肢を表す列挙型です。
     */
    public enum Antei implements IAnswerResultItem {
     ...
     */
    public enum MondaiNashiAri implements IAnswerResultItem {
     ...
     * 「認知能力」の選択肢を表す列挙型です。
     */
    public enum Ninchi implements IAnswerResultItem {
     ...
     * 「伝達能力」の選択肢を表す列挙型です。
     */
    public enum Dentatsu implements IAnswerResultItem {
     ...
     * 「なし／あり」の選択肢を表す列挙型です。
     */
    public enum NashiAri implements IAnswerResultItem {
     ...
     * 「なし／あり」の選択肢を表す列挙型です。
     */
    public enum NashiAri2 implements IAnswerResultItem {
     ...
     * 「なし／あり」の選択肢を表す列挙型です。
     */
    public enum NashiAri3 implements IAnswerResultItem {
     ...
     * 「あり／なし」の選択肢を表す列挙型です。
     */
    public enum AriNashi implements IAnswerResultItem {
     ...
     * 「右／左」の選択肢を表す列挙型です。
     */
    public enum MigiHidari implements IAnswerResultItem {
     ...
     * 「増加／減少」の選択肢を表す列挙型です。
     */
    public enum ZokaGensho implements IAnswerResultItem {
     ...
     * 「程度」の選択肢を表す列挙型です。
     */
    public enum Teido implements IAnswerResultItem {
     ...
     * 「介助」の選択肢を表す列挙型です。
     */
    public enum Kaijo4 implements IAnswerResultItem {
     ...
     * 「車いすの使用」の選択肢を表す列挙型です。
     */
    public enum Kurumaisu implements IAnswerResultItem {
     ...
     * 「食事行為」の選択肢を表す列挙型です。
     */
    public enum Shokuji implements IAnswerResultItem {
     ...
     * 「状態」の選択肢を表す列挙型です。
     */
    public enum Jotai implements IAnswerResultItem {
     ...
     * 「期待」の選択肢を表す列挙型です。
     */
    public enum Kitai implements IAnswerResultItem {
