 ...
 */
public enum CKGaikyoChosahyouServiceJyouk99A implements IGaikyoChosahyoServiceJokyo {
    ...
    private CKGaikyoChosahyouServiceJyouk99A(String code, String tani1, String tani2, String fullname) {
     ...
     */
    public static CKGaikyoChosahyouServiceJyouk99A toValue(RString code) {
        for (CKGaikyoChosahyouServiceJyouk99A values : CKGaikyoChosahyouServiceJyouk99A.values()) {
    ...
    public RString get給付区分() {
        throw new IllegalArgumentException(UrErrorMessages.存在しない.getMessage().replace("概況調査票サービスの状況99Aには給付区分").evaluate());
    }
}
