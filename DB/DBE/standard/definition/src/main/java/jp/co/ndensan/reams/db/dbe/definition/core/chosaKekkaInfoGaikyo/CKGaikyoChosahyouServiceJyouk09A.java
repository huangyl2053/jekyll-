 ...
 */
public enum CKGaikyoChosahyouServiceJyouk09A implements IGaikyoChosahyoServiceJokyo {
    ...
    private CKGaikyoChosahyouServiceJyouk09A(String code, String tani1, String tani2, String kyuufuKubun, String fullname) {
     ...
     */
    public static CKGaikyoChosahyouServiceJyouk09A toValue(RString code) {

        for (CKGaikyoChosahyouServiceJyouk09A values : CKGaikyoChosahyouServiceJyouk09A.values()) {
     ...
     * @return {
     * @kyufuKubun 給付区分} に対応する概況調査票サービス状況09Aのレコード数
     */
