...
/**
 * 主治医意見書の項目グループを扱うクラスです。
 *
 * @author N8156 宮本 康
 */
public class ShujiiIkenshoItemGroup {

    /**
     * 共通の意見書項目グループを表す列挙型です。
     */
    public enum OfCommon implements IShujiiIkenshoItemGroup {
        ...
        private OfCommon(String no, String name, String shortName) {
    ...
    /**
     * 2009年の意見書項目グループを表す列挙型です。
     */
    public enum Of2009 implements IShujiiIkenshoItemGroup {
        ...
        private Of2009(String no, String name, String shortName) {
            this.no = new RString(no);
            this.name = new RString(name);
            this.shortName = new RString(shortName);
        }
