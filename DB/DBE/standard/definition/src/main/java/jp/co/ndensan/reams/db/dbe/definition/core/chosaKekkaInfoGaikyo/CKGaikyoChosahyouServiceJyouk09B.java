 ...
 */
public enum CKGaikyoChosahyouServiceJyouk09B implements IGaikyoChosahyoServiceJokyo {
    ...
    private CKGaikyoChosahyouServiceJyouk09B(String code, String tani1, String tani2, String kyuufuKubun, String fullname) {
     ...
     */
    public static CKGaikyoChosahyouServiceJyouk09B toValue(RString code) {

        for (CKGaikyoChosahyouServiceJyouk09B values : CKGaikyoChosahyouServiceJyouk09B.values()) {
    ...
    /**
     * 指定した給付区分の概況調査票サービス状況09Bのレコード数を返します。
     *
     * @param kyufuKubun 給付区分
     * @return {
     * @kyufuKubun 給付区分} に対応する概況調査票サービス状況09Bのレコード数
     */
