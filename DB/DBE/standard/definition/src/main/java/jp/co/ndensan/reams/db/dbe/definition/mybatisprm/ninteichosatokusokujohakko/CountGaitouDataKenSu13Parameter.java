 ...
 */
package jp.co.ndensan.reams.db.dbe.definition.mybatisprm.ninteichosatokusokujohakko;
...
public final class CountGaitouDataKenSu13Parameter {

    private final FlexibleDate temp_ninteichosaKigenYMD;
    private final boolean temp_taishoumono_Equal_1;
    ...
    private CountGaitouDataKenSu13Parameter(NinteiChosaTokusokujoHakkoTempData tempData) {
        ...
        this.temp_taishoumono_Equal_1 = tempData.getTemp_印刷済対象者().equals(new RString("1"));
