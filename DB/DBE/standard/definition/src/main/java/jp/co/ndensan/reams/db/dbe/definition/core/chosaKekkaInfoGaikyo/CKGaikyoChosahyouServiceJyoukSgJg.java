...
/**
 * 調査結果用概況調査票サービスの状況総合事業対応を表す列挙型です。
 *
 * @reamsid_L DBE-9999-023
 */
public enum CKGaikyoChosahyouServiceJyoukSgJg implements IGaikyoChosahyoServiceJokyo {
    ...
    private CKGaikyoChosahyouServiceJyoukSgJg(String code, String tani1, String tani2, String kyuufuKubun, String fullname) {
     ...
     */
    public static CKGaikyoChosahyouServiceJyoukSgJg toValue(RString code) {

        for (CKGaikyoChosahyouServiceJyoukSgJg values : CKGaikyoChosahyouServiceJyoukSgJg.values()) {
