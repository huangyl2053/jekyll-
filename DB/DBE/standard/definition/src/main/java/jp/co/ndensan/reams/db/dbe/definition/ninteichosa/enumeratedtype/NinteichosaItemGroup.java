...
public class NinteichosaItemGroup {
    ...
    public enum OfCommon implements INinteichosaItemGroup {
        ...
        private OfCommon(String no, String name, String shortName, boolean kihonChosaGroup) {
    ...
    public enum Of2006 implements INinteichosaItemGroup {
         ...
         */
        サービス状況("", "サービス状況", "サービス状況", false),
        /**
         * 調査項目グループが「概況特記事項」であることを表します。
         */
        概況特記事項("", "概況特記事項", "概況特記事項", false),
        /**
        ...
        private Of2006(String no, String name, String shortName, boolean kihonChosaGroup) {
            this.no = new RString(no);
            this.name = new RString(name);
            this.shortName = new RString(shortName);
            this.kihonChosaGroup = kihonChosaGroup;
    ...
    public enum Of2009 implements INinteichosaItemGroup {
        ...
        private Of2009(String no, String name, String shortName, boolean kihonChosaGroup) {
            this.no = new RString(no);
            this.name = new RString(name);
            this.shortName = new RString(shortName);
            this.kihonChosaGroup = kihonChosaGroup;
