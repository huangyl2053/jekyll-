 ...
 */
package jp.co.ndensan.reams.db.dbe.definition.enumeratedtype.message;

import java.util.regex.Pattern;
import static jp.co.ndensan.reams.db.dbe.definition.enumeratedtype.message.MessageCreateHelper.toCode;
import jp.co.ndensan.reams.uz.uza.lang.RString;

/**
 * DBEのシステムエラーメッセージ定義列挙型です。
 *
 * @author N9606 漢那 憲作
 */
public enum DbeSystemErrorMessages {
    ...
    private DbeSystemErrorMessages(int no, String message) {
