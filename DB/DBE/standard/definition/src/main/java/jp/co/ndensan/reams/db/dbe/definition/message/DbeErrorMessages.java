...
public enum DbeErrorMessages implements IMessageGettable {
    ...
    予定登録済みのため合議体情報削除不可(79, "開催予定が登録されているため削除できません。開催予定を削除してから再実行してください。"),
    割当委員存在のため合議体情報削除不可(80, "委員が割り当てられているため削除できません。委員の割り当てを解除してから再実行してください。"),
    合議体NO_有効期間重複(81, "同じ合議体Noで有効期間の重複する合議体が存在します。設定を変更してください。"),
    和暦に変換不可(82, "和暦に変換できません。再入力してください。"),
    完了済みのため不可(83, "?が完了済みのため、?できません。"),
    zipファイル複数(84, "一度に取り込むことのできるZIPファイルは1件のみです。1件ずつアップロードしてください。");
