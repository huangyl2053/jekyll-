...
/**
 * 認定調査結果と主治医意見書のチェックリストのバッチ処理クラスパラメータクラスです。
 *
...
public class ChosahyoIkenshoCheckListProcessParamter implements IBatchProcessParameter {
     ...
     *
     * @return 認定調査結果と主治医意見書のチェックリストのMybatisパラメーターク
     */
    public ChosahyoIkenshoCheckListParamter toMybitisParamter() {
        return ChosahyoIkenshoCheckListParamter.createParamter(認定調査結果と主治医意見書のチェックリスト申請日From,
