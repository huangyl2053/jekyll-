...
class ShujiiIkenshoRegulationBuilder<E extends IShujiiIkenshoItemKubun> {
    ...
    private IShujiiIkenshoItemGroup 意見書項目グループ = ShujiiIkenshoItemGroup.OfCommon.なし;
    private IShujiiIkenshoItemSubGroup 意見書項目サブグループ = ShujiiIkenshoItemSubGroup.OfCommon.なし;
    ...
    private void set意見書項目(String 意見書項目番号, E 意見書項目区分, String 表示名称, IAnsweringItem[] 選択肢, boolean 主要項目) {
        意見書定義.put(意見書項目区分,
                ...
                this.意見書項目サブグループ == ShujiiIkenshoItemSubGroup.OfCommon.なし ? 意見書項目グループ内番号++ : 意見書項目グループ内番号,
                this.意見書項目サブグループ != ShujiiIkenshoItemSubGroup.OfCommon.なし ? 意見書項目サブグループ内番号++ : 意見書項目サブグループ内番号,
