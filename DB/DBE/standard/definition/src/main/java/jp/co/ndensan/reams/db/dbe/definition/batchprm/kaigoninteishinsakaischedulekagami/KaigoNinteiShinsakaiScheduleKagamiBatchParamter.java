 ...
 */
package jp.co.ndensan.reams.db.dbe.definition.batchprm.kaigoninteishinsakaischedulekagami;
...
/**
 *
 * 介護認定審査会スケジュール表かがみですためのバッチ用パラメータクラスです。
 */
@lombok.Getter
@lombok.Setter
@SuppressWarnings("PMD.UnusedPrivateField")
public class KaigoNinteiShinsakaiScheduleKagamiBatchParamter extends BatchParameterBase {
     ...
     */
    public KaigoNinteiShinsakaiScheduleKagamiBatchParamter(
     ...
     */
    public KaigoNinteiShinsakaiScheduleKagamiProcessParamter toKaigoNinteiShinsakaiScheduleProcessParamter() {
