...
/**
 * 介護認定審査会集計表（申請区分別）のProcessParameterです。
 *
...
public class ShinsakaiShukeihyoShinseiBetsuProcessParameter implements IBatchProcessParameter {
    ...
    /**
     * ShinsakaiShukeihyoShinseiBetsuMyBatisParameterに転換します。
     *
     * @return ShinsakaiShukeihyoShinseiBetsuMyBatisParameter
     */
    public ShinsakaiShukeihyoShinseiBetsuMyBatisParameter toShinsakaiShukeihyoShinseiBetsuMyBatisParameter() {

        return new ShinsakaiShukeihyoShinseiBetsuMyBatisParameter(
                isEmptyHokensyaNo,
                hokensyaNo,
                hihokenshaKubun,
                isEmptyGogitaiNo,
