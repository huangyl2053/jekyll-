...
public class MockNinteichosaItakusakiJohoEntity {
    ...
    public static NinteichosaItakusakiJohoEntity getSpiedInstance() {
        ...
        NinteichosaItakusakiJohoEntity ninteichosaItakusakiJohoEntity = new NinteichosaItakusakiJohoEntity(
