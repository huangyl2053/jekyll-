 ...
 * @author N1013 松本直樹
 */
public class NinteichosaItakusakiJohoEntity implements IDbAccessable {
     ...
     */
    NinteichosaItakusakiJohoEntity() {
    }
     ...
     * @param 機関の区分
     */
    public NinteichosaItakusakiJohoEntity(RString 市町村コード, KaigoJigyoshaNo 介護事業者番号,
     ...
     */
    public NinteichosaItakusakiJohoEntity(NinteichosaItakusaki 認定調査委託先) {
