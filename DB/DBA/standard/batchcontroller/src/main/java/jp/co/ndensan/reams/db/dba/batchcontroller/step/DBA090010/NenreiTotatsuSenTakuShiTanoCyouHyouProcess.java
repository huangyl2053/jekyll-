...
/**
 * 年齢到達予定者選択した帳票を作成、宛名識別対象一時テーブル1の帳票を作成、データを作成します。
 *
...
public class NenreiTotatsuSenTakuShiTanoCyouHyouProcess extends BatchProcessBase<AtenaSealCreateDBZ100001Entity> {
    ...
    private void iTeraTion(List<AtenaSealCreateDBZ100001Entity> listDBZ100001,
        ...
        for (int i = 0; i < listDBZ100001.size(); i++) {
            ...
            if (i + 1 == listDBZ100001.size()) {
                can終了 = true;
                cyouHyou(business, i, listDBZ100001, listBusiness);
                break;
            }
    ...
    private void cyouHyou(AtenaSealReportBusiness business, int i, List<AtenaSealCreateDBZ100001Entity> listDBZ100001,
            List<AtenaSealReportBusiness> listBusiness) {
