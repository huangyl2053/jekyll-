 ...
 */
public class ShikakuShutokuToNenreiTotatsuToJukyuNinteiShinseityuIgaiCyouHyouProcess extends BatchProcessBase<AtenaSealCreateDBZ100001Entity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dba.persistence.db.mapper.relate.atenasealcreate.IAtenaSealCreateDBZ100001Mapper.getChuuShutsuTaishouSha6List");
    ...
    private static final RString TABLE_宛名識別対象一時テーブル6 = new RString("DbWT2009AtenaShikibetuTaisyou6");
    ...
    @BatchWriter
    BatchEntityCreatedTempTableWriter 宛名識別対象一時テーブル6;
    @BatchWriter
    ...
    protected void createWriter() {
        ...
        宛名識別対象一時テーブル5 = new BatchEntityCreatedTempTableWriter(TABLE_宛名識別対象一時テーブル5,
                DbTAtenaSealCreateTempTableEntity.class);
        宛名識別対象一時テーブル6 = new BatchEntityCreatedTempTableWriter(TABLE_宛名識別対象一時テーブル6,
                DbTAtenaSealCreateTempTableEntity.class);
    ...
    protected void afterExecute() {
        ...
        if (listDBZ100001.isEmpty()) {
            ...
            Collections.sort(listDBZ100001, new ShikakuShutokuToNenreiTotatsuToJukyuNinteiShinseityuIgaiCyouHyouProcess.コードComparator());
