 ...
 */
public class NenreiTotatsuSenTakuShiTaProcess extends BatchProcessBase<AtenaSealCreateRelateEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dba.persistence.db.mapper.relate.atenasealcreate.IAtenaSealCreateMapper.getTekiyoKaisha");
    ...
    protected void process(AtenaSealCreateRelateEntity entity) {
        宛名識別対象一時テーブル1.insert(new AtenaSealCreateResult().set宛名識別対象一時テーブル1(entity, processParamter, koikiZenShichosonJoho));
    }
