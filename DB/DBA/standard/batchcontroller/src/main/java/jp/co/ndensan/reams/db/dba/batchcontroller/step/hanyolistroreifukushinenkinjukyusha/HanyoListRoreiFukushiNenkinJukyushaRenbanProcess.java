...
public class HanyoListRoreiFukushiNenkinJukyushaRenbanProcess extends BatchProcessBase<HanyoListRoreiFukushiNenkinJukyushaRelateEntity> {
    ...
    private HanyoListRoreiFukushiNenkinJukyushaRenbanCsvEntity setBlank() {
        HanyoListRoreiFukushiNenkinJukyushaRenbanCsvEntity entity = new HanyoListRoreiFukushiNenkinJukyushaRenbanCsvEntity();
        entity.set連番(RString.EMPTY);
