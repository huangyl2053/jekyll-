...
public class HanyoListTaShichosonJushochiTokureishaRenbanProcess extends BatchProcessBase<HanyoListTaShichosonJushochiTokureishaRelateEntity> {
    ...
    private HanyoListTaShichosonJushochiTokureishaRenbanCsvEntity setBlank() {
        HanyoListTaShichosonJushochiTokureishaRenbanCsvEntity entity = new HanyoListTaShichosonJushochiTokureishaRenbanCsvEntity();
    ...
    private RString get出力順() {
        ...
        IOutputOrder outputOrder = finder.get出力順(SubGyomuCode.DBA介護資格, ReportIdDBA.DBA701002.getReportId(),
