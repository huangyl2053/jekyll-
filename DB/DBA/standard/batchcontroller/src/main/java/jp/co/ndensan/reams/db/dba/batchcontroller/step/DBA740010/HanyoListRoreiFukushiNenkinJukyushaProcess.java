 ...
 */
package jp.co.ndensan.reams.db.dba.batchcontroller.step.DBA740010;
...
/**
 * 汎用リスト_老齢福祉年金受給者のデータを作成します。
 *
 * @reamsid_L DBA-1620-030 yaodongsheng
 */
public class HanyoListRoreiFukushiNenkinJukyushaProcess extends BatchProcessBase<HanyoListRoreiFukushiNenkinJukyushaRelateEntity> {
    ...
    private EucCsvWriter<HanyoListRoreiFukushiNenkinJukyushaCsvEntity> eucCsvWriter;
