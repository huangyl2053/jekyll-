 ...
 */
package jp.co.ndensan.reams.db.dba.model.hihokenshashikakuhakko;
...
public class HihokenshashoModel implements Serializable {
    ...
    private final HihokenshashoB4PrintPosition position;
    ...
    public HihokenshashoModel(HihokenshaDaichoModel hihokenshaDaicho, IKojin kojinJoho, HihokenshaShikakuHakkoModel shikakuHakko,
            HihokenshashoB4PrintPosition position) throws NullPointerException {
     ...
     */
    public HihokenshashoModel(HihokenshaDaichoModel hihokenshaDaicho, IKojin kojinJoho, HihokenshaShikakuHakkoModel shikakuHakko) {
        this(hihokenshaDaicho, kojinJoho, shikakuHakko, HihokenshashoB4PrintPosition.指定無し);
    }
     ...
     * @return 印字位置
     */
    public HihokenshashoB4PrintPosition getPosition() {
        return position;
    }
