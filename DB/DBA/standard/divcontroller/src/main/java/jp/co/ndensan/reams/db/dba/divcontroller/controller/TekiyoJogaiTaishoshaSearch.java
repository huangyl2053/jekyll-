...
public class TekiyoJogaiTaishoshaSearch {
    ...
    private static final RString GAITOSHA_DATA = new RString("DBA2050011/gaitoshaListData.yml");
     ...
     * @return レスポンス
     */
    public ResponseData onClick_btnToSearch(TekiyoJogaiTaishoshaSearchDiv searchDiv) {
     ...
     * @return レスポンス
     */
    public ResponseData onClick_btnToResearch(TekiyoJogaiTaishoshaSearchDiv searchDiv) {
        ResponseData<TekiyoJogaiTaishoshaSearchDiv> response = new ResponseData<>();
