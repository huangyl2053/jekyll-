...
/**
 * 被保険者照会における対象者検索に対応するControllerです。
 *
 * @author n8178 城間篤人
 */
public class HihokenshaShokaiTaishoSearch {

    private static final RString GAITOSHA_DATA = new RString("DBA4010011/gaitoshaListData.yml");
     ...
     * @return レスポンス
     */
    public ResponseData onClick_BtnToSearch(HihokenshaShokaiTaishoSearchDiv searchDiv) {
     ...
     * @return レスポンス
     */
    public ResponseData onClickBtnToResearch(HihokenshaShokaiTaishoSearchDiv searchDiv) {
        ResponseData<HihokenshaShokaiTaishoSearchDiv> response = new ResponseData<>();
