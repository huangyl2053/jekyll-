...
public class ShikakuKihonJohoHandler {
     ...
     */
    public TashichosonJushochiTokurei 他市町村住所地特例連絡票の編集(Models<TashichosonJushochiTokureiIdentifier, TashichosonJushochiTokurei> 他市町村住所地特例,
        ...
        return tashichosonJushochiTokurei.createBuilderForEdit().set他特例連絡票発行年月日(new FlexibleDate(div.
