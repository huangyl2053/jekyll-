...
public class tplIryoHokenDiv extends TabPanel {
     ...
     */
    @JsonProperty("IryoHokenRirekii")
    private IryoHokenRirekiiDiv IryoHokenRirekii;
    ...
    /*
     * setIryoHokenRirekii
     * @param IryoHokenRirekii IryoHokenRirekii
     */
    @JsonProperty("IryoHokenRirekii")
    public void setIryoHokenRirekii(IryoHokenRirekiiDiv IryoHokenRirekii) {
        this.IryoHokenRirekii = IryoHokenRirekii;
    }
    ...
    public IIryohokenRirekiCommonChildDiv getCcdIryoHokenRireki() {
        return this.getIryoHokenRirekii().getCcdIryoHokenRireki();
    }
