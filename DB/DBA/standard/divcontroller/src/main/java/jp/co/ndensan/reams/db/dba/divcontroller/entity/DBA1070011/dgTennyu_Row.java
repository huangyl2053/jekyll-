...
/**
 * dgTennyu_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgTennyu_Row extends DataRow {
    ...
    public dgTennyu_Row(DataGridSetting gridSetting) {
        super();
