...
/**
 * 他特例施設退所通知書発行のバリデーションハンドラークラスです。
 *
...
public class TatokureiTaishoTsuchishoHakkoValidationHandler {
     ...
     */
    public TatokureiTaishoTsuchishoHakkoValidationHandler(TatokureiTaishoTsuchishoHakkoDiv div) {
        this.div = div;
    }
    ...
    public ValidationMessageControlPairs validateForReportPublish() {
        ...
        if ((!yakushoMei.isNullOrEmpty()) && (!onchu.isNullOrEmpty())
                ...
                && !div.getTajutokuTekiyoJohoIchiran().getReportPublish().isIsPublish()) {
