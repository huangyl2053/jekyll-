...
public class FubanHohoMainHandler {
    ...
    public void setFubanHoho() {
        ...
        div.getFubanHoho().getDdlHihokenshaBangoFubanHoho().setSelectedKey(DbBusinessConifg.get(
                ConfigNameDBA.被保険者番号付番方法_付番方法, RDate.getNowDate(), SubGyomuCode.DBA介護資格, LasdecCode.EMPTY, RString.EMPTY));
        div.getFubanHoho().getFubanMotoJoho().getDdlFubanmotoJoho().setSelectedKey(DbBusinessConifg.get(
                ConfigNameDBA.被保険者番号付番方法_カスタマイズ付番_付番元情報, RDate.getNowDate(), SubGyomuCode.DBA介護資格));
        RString 開始位置 = DbBusinessConifg.get(ConfigNameDBA.被保険者番号付番方法_カスタマイズ付番_付番元情報_開始位置, RDate.getNowDate(),
        ...
        RString 有効桁数 = DbBusinessConifg.get(ConfigNameDBA.被保険者番号付番方法_カスタマイズ付番_付番元情報_有効桁数, RDate.getNowDate(),
                SubGyomuCode.DBA介護資格);
        ...
        RString 前付加桁数 = DbBusinessConifg.get(ConfigNameDBA.被保険者番号付番方法_カスタマイズ付番_前付与番号_桁数, RDate.getNowDate(),
                SubGyomuCode.DBA介護資格);
        ...
        div.getFubanHoho().getMaeFukaJoho().getTxtMaeFukaCode().setValue(DbBusinessConifg.get(
                ConfigNameDBA.被保険者番号付番方法_カスタマイズ付番_前付与番号, RDate.getNowDate(), SubGyomuCode.DBA介護資格));
        RString 後付加桁数 = DbBusinessConifg.get(ConfigNameDBA.被保険者番号付番方法_カスタマイズ付番_後付与番号_桁数, RDate.getNowDate(),
                SubGyomuCode.DBA介護資格);
        ...
        div.getFubanHoho().getAtoFukaJoho().getTxtAtoFukaCode().setValue(DbBusinessConifg.get(
