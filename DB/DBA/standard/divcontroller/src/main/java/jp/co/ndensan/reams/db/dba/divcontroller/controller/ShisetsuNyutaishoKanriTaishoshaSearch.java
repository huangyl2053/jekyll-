...
/**
 * 施設入退所管理の処理対象となる個人を検索するDivControllerです。
 *
 * @author n8178 城間篤人
 */
public class ShisetsuNyutaishoKanriTaishoshaSearch {

    private static final RString GAITOSHA_DATA = new RString("DBA2020011/gaitoshaListData.yml");
     ...
     * @return レスポンス
     */
    public ResponseData onClick_btnToSearch(ShisetsuNyutaishoKanriTaishoshaSearchDiv searchDiv) {
     ...
     * @return レスポンス
     */
    public ResponseData onClick_btnToResearch(ShisetsuNyutaishoKanriTaishoshaSearchDiv searchDiv) {
        ResponseData<ShisetsuNyutaishoKanriTaishoshaSearchDiv> response = new ResponseData<>();
