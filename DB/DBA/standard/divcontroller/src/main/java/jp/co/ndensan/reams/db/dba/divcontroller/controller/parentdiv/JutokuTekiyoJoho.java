...
//TODO n3317 塚田萌　ビルドを通すためコメントアウト。divがなくてエラーなので、divを再生成して見直してください。
///*
...
//import jp.co.ndensan.reams.db.dba.divcontroller.entity.dba2030011.tplIryoHokenDiv;
//import jp.co.ndensan.reams.db.dba.divcontroller.entity.dba2030011.tplRofukuNenkinDiv;
//import jp.co.ndensan.reams.db.dba.divcontroller.entity.dba2030011.tplSeikatsuHogoDiv;
//import jp.co.ndensan.reams.db.dba.divcontroller.entity.dba2030011.tplShikakuJohoDiv;
//import jp.co.ndensan.reams.db.dba.divcontroller.entity.dba2030011.tplShisetsuNyutaishoDiv;
//import jp.co.ndensan.reams.db.dba.divcontroller.entity.dba2030011.JutokuTekiyoJohoDiv;
...
// * @author n8178 城間篤人
// */
//public class JutokuTekiyoJoho {
//
//    private final static RString HIHOKENSHA_DAICHO_DATA = new RString("DBA2030011/shikakuTokuso.yml");
//    private final static RString IRYO_HOKEN_DATA = new RString("DBA2030011/iryoHoken.yml");
//    private final static RString ROFUKU_NENKIN_DATA = new RString("DBA2030011/rofukuNenkin.yml");
//    private final static RString SEIKATSU_HOGO_DATA = new RString("DBA2030011/seikatsuHogo.yml");
//    private final static RString SHISETSU_NYUTAISHO_DATA = new RString("DBA2030011/shisetsuNyutaisho.yml");
//
...
//     */
//    private void setShikakuJoho(JutokuTekiyoJohoDiv jutokuTekiyoJohoDiv, RString shikibetsuCode) {
...
//     * @param shikibetsuCode 識別コード
//     */
//    private void setIryoHoken(JutokuTekiyoJohoDiv jutokuTekiyoJohoDiv, RString shikibetsuCode) {
...
//     * @param shikibetsuCode 識別コード
//     */
//    private void setRofukuNenkin(JutokuTekiyoJohoDiv jutokuTekiyoJohoDiv, RString shikibetsuCode) {
...
//     * @param shikibetsuCode 識別コード
//     */
//    private void setSeikatsuHogo(JutokuTekiyoJohoDiv jutokuTekiyoJohoDiv, RString shikibetsuCode) {
...
//     * @param shikibetsuCode 識別コード
//     */
//    private void setShisetsuNyutaisho(JutokuTekiyoJohoDiv jutokuTekiyoJohoDiv, RString shikibetsuCode) {
...
//     * @return レスポンス
//     */
//    public ResponseData onSelectOfModifyButton_dgJutokuTekiyoRireki(JutokuTekiyoJohoDiv jutokuTekiyoJohoDiv, JutokuTekiyoSearchDiv searchDiv) {
//        ResponseData<JutokuTekiyoJohoDiv> response = new ResponseData<>();
//        tplShikakuJohoDiv tplShikakuJoho = jutokuTekiyoJohoDiv.getTabInputs().getTplShikakuJoho();
//
//        jutokuTekiyoJohoDiv.setShikakuInputMode(SHIKAKU_MODIFY);
...
//     * @return レスポンス
//     */
//    public ResponseData onSelectOfDeleteButton_dgJutokuTekiyoRireki(JutokuTekiyoJohoDiv jutokuTekiyoJohoDiv, JutokuTekiyoSearchDiv searchDiv) {
//        ResponseData<JutokuTekiyoJohoDiv> response = new ResponseData<>();
//        tplShikakuJohoDiv tplShikakuJoho = jutokuTekiyoJohoDiv.getTabInputs().getTplShikakuJoho();
//
...
//     * @return レスポンス
//     */
//    public ResponseData onClick_btnUpdateShikaku(JutokuTekiyoJohoDiv jutokuTekiyoJohoDiv, JutokuTekiyoSearchDiv searchDiv) {
//        ResponseData<JutokuTekiyoJohoDiv> response = new ResponseData<>();
//        tplShikakuJohoDiv tplShikakuJoho = jutokuTekiyoJohoDiv.getTabInputs().getTplShikakuJoho();
//        int selectRowNum;
...
//     * @return レスポンス
//     */
//    public ResponseData onClick_btnAddIryoHoken(JutokuTekiyoJohoDiv jutokuTekiyoJohoDiv, JutokuTekiyoSearchDiv searchDiv) {
//        ResponseData<JutokuTekiyoJohoDiv> response = new ResponseData<>();
//        tplIryoHokenDiv tplIryoHoken = jutokuTekiyoJohoDiv.getTabInputs().getTplIryoHoken();
//
//        jutokuTekiyoJohoDiv.setIryoHokenInputMode(IRYO_HOKEN_ADD);
...
//     * @return レスポンス
//     */
//    public ResponseData onSelectOfModifyButton_dgIryoHokenRireki(JutokuTekiyoJohoDiv jutokuTekiyoJohoDiv, JutokuTekiyoSearchDiv searchDiv) {
//        ResponseData<JutokuTekiyoJohoDiv> response = new ResponseData<>();
//        tplIryoHokenDiv tplIryoHoken = jutokuTekiyoJohoDiv.getTabInputs().getTplIryoHoken();
//
...
//     * @return レスポンス
//     */
//    public ResponseData onSelectOfDeleteButton_dgIryoHokenRireki(JutokuTekiyoJohoDiv jutokuTekiyoJohoDiv, JutokuTekiyoSearchDiv searchDiv) {
//        ResponseData<JutokuTekiyoJohoDiv> response = new ResponseData<>();
//        tplIryoHokenDiv tplIryoHoken = jutokuTekiyoJohoDiv.getTabInputs().getTplIryoHoken();
//
...
//     * @return レスポンス
//     */
//    public ResponseData onClick_btnUpdateIryoHoken(JutokuTekiyoJohoDiv jutokuTekiyoJohoDiv, JutokuTekiyoSearchDiv searchDiv) {
//        ResponseData<JutokuTekiyoJohoDiv> response = new ResponseData<>();
//        tplIryoHokenDiv tplIryoHoken = jutokuTekiyoJohoDiv.getTabInputs().getTplIryoHoken();
//        int selectRowNum;
//
