...
/**
 * 住所地特例適用処理の対象者検索を行うDivControllerです。
 *
 * @author n8178 城間篤人
 */
public class JutokuTekiyoSearch {

    private static final RString GAITOSHA_DATA = new RString("DBA2030011/gaitoshaListData.yml");
     ...
     * @return レスポンス
     */
    public ResponseData onClick_btnToSearch(JutokuTekiyoSearchDiv searchDiv) {
        ResponseData<JutokuTekiyoSearchDiv> response = new ResponseData<>();

        setGaitoshaList(searchDiv.getSearchResultOfHihokensha().getDgSearchResult());
     ...
     * @return レスポンス
     */
    public ResponseData onClick_btnToResearch(JutokuTekiyoSearchDiv searchDiv) {
        ResponseData<JutokuTekiyoSearchDiv> response = new ResponseData<>();

        resetGaitoshaList(searchDiv.getSearchResultOfHihokensha().getDgSearchResult());
