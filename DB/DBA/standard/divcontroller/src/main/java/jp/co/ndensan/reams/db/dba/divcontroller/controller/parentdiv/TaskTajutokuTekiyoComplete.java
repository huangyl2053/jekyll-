...
import jp.co.ndensan.reams.db.dba.divcontroller.entity.parentdiv.dba204001t.TaskTajutokuTaishosaJohoDiv;
import jp.co.ndensan.reams.db.dba.divcontroller.entity.parentdiv.dba204001t.TaskTajutokuTekiyoCompleteDiv;
...
//        AtenaShokaiSimpleDiv atena = taishoshaJohoDiv.getAtenaJoho();
        completeDiv.getComplete().setSuccessMessage(new RString("他市町村住所地特例適用を更新しました。")); //,
