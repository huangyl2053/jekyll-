...
public class JiGyoSyaHandler {
    ...
    public void search_Jigyosya(JigyoshaMode mode) {
        ...
        if (ShisetsuType.toValue(mode.getJigyoshaShubetsu()).toRString().equals(ShisetsuType.介護保険施設.toRString())) {
            ...
            List<ServiceJigyoshaInputGuide> Jigyosha = JigyoshaInputGuideFinder.createInstance().getServiceJigyoshaInputGuide(
            ...
            if (Jigyosha != null && !Jigyosha.isEmpty()) {
                ...
                for (ServiceJigyoshaInputGuide jigyoshaInput : Jigyosha) {
                    ...
                    dgJigyoshaItiran.setTxtJigyoshaNo(new RString("0000000003"));
...
//                    dgJigyoshaItiran.setTxtJigyoshaNo(jigyoshaInput.get事業者番号().value());
    ...
    public void load(JigyoshaMode mode) {
        ...
        if (ShisetsuType.toValue(mode.getJigyoshaShubetsu()).toRString().equals(ShisetsuType.介護保険施設.toRString())) {
            ...
            div.getTaishoJigyoshaKensaku().getTxtMaxHyojiKensu().setValue(new Decimal("100"));
            ...
            div.getTaishoJigyoshaKensaku().getDdlJigyoshaKubun().setDataSource(get事業者種別());
    ...
    private List<KeyValueDataSource> get事業者種別() {

        List<KeyValueDataSource> dataSource = new ArrayList();

        KeyValueDataSource KeyValue1 = new KeyValueDataSource();
        KeyValueDataSource KeyValue2 = new KeyValueDataSource();
        KeyValue1.setKey(new RString("01"));
        KeyValue2.setKey(new RString("02"));
        KeyValue1.setValue(new RString("住所地特例対象施設"));
        KeyValue2.setValue(new RString("適用除外施設"));
