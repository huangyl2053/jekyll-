...
public class JigyoshaService {
    ...
    public ResponseData<JigyoshaServiceDiv> onClick_Modoru(JigyoshaServiceDiv div) {
        ...
        boolean changeFlg = hasChangedJigyoshaServiceKihon(div, beforeDiv) || hasChangedJigyoshaServiceShosai(div, beforeDiv);
    ...
    private boolean hasChangedJigyoshaServiceShosai(JigyoshaServiceDiv div, DbT7063KaigoJigyoshaShiteiServiceEntity beforeDiv) {
        return (!div.getJigyoshaServiceShosai().getDdlShisetsunadoKubun().getSelectedKey().equals(beforeDiv.getShisetsunadoKubun().value()))
    ...
    private boolean hasChangedJigyoshaServiceKihon(JigyoshaServiceDiv div, DbT7063KaigoJigyoshaShiteiServiceEntity beforeDiv) {
        return (!div.getJigyoshaServiceKihon().getJigyosha().getTxtJigyoshaNo().getValue().equals(beforeDiv.getJigyoshaNo().value()))
               ...
               || (hasChangedYukoKaishiYMD(div, beforeDiv))
               || (hasChangedYukoShuryoYMD(div, beforeDiv))
    ...
    private boolean hasChangedYukoShuryoYMD(JigyoshaServiceDiv div, DbT7063KaigoJigyoshaShiteiServiceEntity beforeDiv) {
        return (div.getJigyoshaServiceKihon().getJigyosha().getTxtYukoShuryoYMD().getValue().isEmpty() && !beforeDiv.getYukoShuryoYMD().isEmpty())
    ...
    private boolean hasChangedYukoKaishiYMD(JigyoshaServiceDiv div, DbT7063KaigoJigyoshaShiteiServiceEntity beforeDiv) {
        return (div.getJigyoshaServiceKihon().getJigyosha().getTxtYukoKaishiYMD().getValue().isEmpty() && !beforeDiv.getYukoKaishiYMD().isEmpty())
