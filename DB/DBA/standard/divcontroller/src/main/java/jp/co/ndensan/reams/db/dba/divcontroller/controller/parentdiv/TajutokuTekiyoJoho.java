...
import jp.co.ndensan.reams.db.dba.divcontroller.entity.parentdiv.DBA2040011.TajutokuTekiyoJohoDiv;
import jp.co.ndensan.reams.db.dba.divcontroller.entity.parentdiv.DBA2040011.TekiyoJiyuInputDiv;
import jp.co.ndensan.reams.db.dba.divcontroller.entity.parentdiv.DBA2040011.dgJushochiTokureiRireki_Row;
 ...
 * @author n8178 城間篤人
 */
public class TajutokuTekiyoJoho {

    private static final RString TAJUTOKU_JOHO = new RString("DBA2040011/tajutokuTekiyo.yml");
...
//        tajutokuDiv.getJutokuJohoInput().getShisetsuJohoInput().getShisetsuJoho().getLblOtherShisetsuShurui().setText(new RString("keyKannai"));
     ...
     * @return レスポンス
     */
    public ResponseData onClick_btnTekiyoJohoToroku(TajutokuTekiyoJohoDiv tajutokuDiv, TajutokuTaishoshaSearchDiv searchDiv) {
        ResponseData<TajutokuTekiyoJohoDiv> response = new ResponseData<>();
     ...
     * @return レスポンス
     */
    public ResponseData onSelectByModifyButton_dgJushochiTokureiRireki(TajutokuTekiyoJohoDiv tajutokuDiv, TajutokuTaishoshaSearchDiv searchDiv) {
        ResponseData<TajutokuTekiyoJohoDiv> response = new ResponseData<>();
