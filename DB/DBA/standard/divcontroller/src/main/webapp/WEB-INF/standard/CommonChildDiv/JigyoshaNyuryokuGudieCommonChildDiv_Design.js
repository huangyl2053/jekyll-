    ...
    (function (JigyoshaNyuryokuGudieCommonChildDiv) {
        ...
        var Controls = (function () {
            ...
            Controls.prototype.convFiledNameSelf = function () {
                return this._myName + "_" + DBA.JigyoshaNyuryokuGudieCommonChildDiv.Controls.myType();
            };

            Controls.prototype.convFiledName = function (fieldName) {
                return this._myName + "_" + DBA.JigyoshaNyuryokuGudieCommonChildDiv.Controls.myType() + "_" + fieldName;
            };
