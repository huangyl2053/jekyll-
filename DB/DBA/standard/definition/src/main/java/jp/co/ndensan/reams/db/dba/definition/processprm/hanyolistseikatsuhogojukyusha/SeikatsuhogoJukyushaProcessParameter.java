 ...
 */
package jp.co.ndensan.reams.db.dba.definition.processprm.hanyolistseikatsuhogojukyusha;
...
public class SeikatsuhogoJukyushaProcessParameter implements IBatchProcessParameter {
     ...
     * @param jukyushaJoho_Nihonjin 生保受給者情報・日本人
     * @param jukyushaJoho_Gaikokujin 生保受給者情報・外国人
     ...
     */
    public SeikatsuhogoJukyushaMybatisParameter toSeikatsuhogoJukyushaMybatisParameter(RString psmShikibetsuTaisho, RString psmAtesaki) {
        return SeikatsuhogoJukyushaMybatisParameter.creatParameter(
