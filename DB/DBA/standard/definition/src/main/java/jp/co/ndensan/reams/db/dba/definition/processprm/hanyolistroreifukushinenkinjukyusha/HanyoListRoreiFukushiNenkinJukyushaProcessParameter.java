 ...
 */
package jp.co.ndensan.reams.db.dba.definition.processprm.hanyolistroreifukushinenkinjukyusha;
...
/**
 * 汎用リスト_老齢福祉年金受給者バッチ処理パラメータークラスです。
 *
...
@Getter
@Setter
public class HanyoListRoreiFukushiNenkinJukyushaProcessParameter implements IBatchProcessParameter {
     ...
     */
    public HanyoListRoreiFukushiNenkinJukyushaProcessParameter(
            RString chohyoId,
