 ...
 */
package jp.co.ndensan.reams.db.dba.definition.core.jushochitokureitekiyojiyu;
...
public class JushochitokureiTekiyoJiyu implements IDbColumnMappable, IValidatable, IValueObject<RString> {
    ...
    /**
     * DB等からコンストラクタを利用して直接マッピングされた、<br/> {@link JushochitokureiTekiyoJiyu}が持つcodeについてバリデーションを実施します。
     *
     ...
     * @throws IllegalArgumentException {@link JushochitokureiTekiyoJiyuSpec}の仕様を満たさない場合
     */
