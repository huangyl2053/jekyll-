 ...
 */
package jp.co.ndensan.reams.db.dba.definition.mybatisprm.hanyolisttekiyojogaisha;
...
@Getter
@Setter
public class HanyoListTekiyoJogaishaMybatisParameter implements IMyBatisParameter {
    ...
    private final boolean is適用除外者のみ;
    private final boolean is適用除外解除者のみ;
     ...
     * @param is適用除外者のみ is適用除外者のみ
     * @param is適用除外解除者のみ is適用除外解除者のみ
     ...
     */
    protected HanyoListTekiyoJogaishaMybatisParameter(
            RString kijunYMD,
        ...
        this.is適用除外者のみ = is適用除外者のみ;
        this.is適用除外解除者のみ = is適用除外解除者のみ;
     ...
     */
    public static HanyoListTekiyoJogaishaMybatisParameter creatParameter(
            Decimal 宛名抽出年齢開始,
            Decimal 宛名抽出年齢終了,
            RDate 宛名抽出生年月日開始,
            RDate 宛名抽出生年月日終了,
        ...
        boolean is適用除外者のみ = false;
        boolean is適用除外解除者のみ = false;
        ...
        return new HanyoListTekiyoJogaishaMybatisParameter(
                基準日,
                範囲抽出日From,
                範囲抽出日To,
                is直近,
