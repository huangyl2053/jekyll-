 ...
 */
package jp.co.ndensan.reams.db.dba.definition.processprm.hanyolisttekiyojogaisha;
...
@Getter
@Setter
public class HanyoListTekiyoJogaishaProcessParameter implements IBatchProcessParameter {
     ...
     */
    public HanyoListTekiyoJogaishaProcessParameter(
            RString chohyoId,
