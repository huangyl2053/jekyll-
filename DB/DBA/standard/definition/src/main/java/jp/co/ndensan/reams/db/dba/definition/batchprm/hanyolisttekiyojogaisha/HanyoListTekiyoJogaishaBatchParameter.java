 ...
 */
package jp.co.ndensan.reams.db.dba.definition.batchprm.hanyolisttekiyojogaisha;
...
@Getter
@Setter
public class HanyoListTekiyoJogaishaBatchParameter extends BatchParameterBase {
     ...
     * コンストラクタです。
     */
    public HanyoListTekiyoJogaishaBatchParameter() {
    }
