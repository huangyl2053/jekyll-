package jp.co.ndensan.reams.db.dba.entity.report.kyufuhikariireshinseisho;
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "shikibetsu", length = 1, order = 6)
    public RString shikibetsu;
    ...
    @ReportItem(name = "tsuchiBun2", order = 10)
