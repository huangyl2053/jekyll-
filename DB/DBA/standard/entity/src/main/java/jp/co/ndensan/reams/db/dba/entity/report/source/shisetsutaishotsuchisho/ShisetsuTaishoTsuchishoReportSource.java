package jp.co.ndensan.reams.db.dba.entity.report.source.shisetsutaishotsuchisho;
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "taishogoYubinNo", length = 11, order = 23)
    public RString taishogoYubinNo;
    @ReportItem(name = "taishogoJusho", order = 24)
    public RString taishogoJusho;
    @ReportItem(name = "taishoYMD", length = 16, order = 25)
    public RString taishoYMD;
    @ReportItem(name = "taishoJiyu", length = 11, order = 26)
    ...
    @ReportItem(name = "hakkoYMD1", length = 12, order = 33)
    ...
    @ReportItem(name = "koinMojiretsu", length = 4, order = 36)
    public RString koinMojiretsu;
    @ReportItem(name = "ninshoshaShimeiKakenai", order = 37)
