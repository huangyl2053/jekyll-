...
public class HanyoListRoreiFukushiNenkinJukyushaRenbanCsvEntity {
    ...
    @CsvField(order = 55, name = "老齢福祉年金開始日")
    private RString 老齢福祉年金開始日;
    @CsvField(order = 56, name = "老齢福祉年金終了日")
    private RString 老齢福祉年金終了日;
    @CsvField(order = 57, name = "生活保護開始日")
    private RString 生活保護開始日;
    @CsvField(order = 58, name = "生活保護終了日")
    private RString 生活保護終了日;
    @CsvField(order = 59, name = "生活保護種別")
    private RString 生活保護種別;
    @CsvField(order = 60, name = "医療保険種別")
    private RString 医療保険種別;
    @CsvField(order = 61, name = "医療保険番号")
    private RString 医療保険番号;
    @CsvField(order = 62, name = "医療保険者名")
    private RString 医療保険者名;
    @CsvField(order = 63, name = "医療保険記号番号")
