...
/**
 * 転出保留対象者テーブルのエンティティクラスです。
 * <br/> 転入の際の資格異動を保留になった介護被保険者を管理する
 */
public class DbT1011TenshutsuHoryuTaishoshaEntity extends DbTableEntityBase<DbT1011TenshutsuHoryuTaishoshaEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    @TableName
    public static final RString TABLE_NAME = new RString("DbT1011TenshutsuHoryuTaishosha");
     ...
     * 登録異動届出年月日のsetメソッドです。
     * 
     * @param torokuTodokedeYMD 登録異動届出年月日
     */
     ...
     * 消除異動届出年月日のsetメソッドです。
     * 
     * @param shojoTodokedeYMD 消除異動届出年月日
     */
     ...
     * 
     * @param tenshutsuKakuteiTsuchiYMD 転出確定異動通知年月日
     */
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT1011TenshutsuHoryuTaishoshaEntity}と等しいか判定します。
     * 
     * @param other 比較するエンティティ
     * @@return 
     * 比較するエンティティが同じ主キーを持つ{@literal DbT1011TenshutsuHoryuTaishoshaEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT1011TenshutsuHoryuTaishoshaEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT1011TenshutsuHoryuTaishoshaEntity entity) {
    ...
    public RString getMd5() {
        return super.toMd5(shikibetsuCode, rirekiNo, shichosonCode, sakuseiJiyuCode, setaiCode, juminShubetsuCode, juminJotaiCode, atenaShimei, atenaKanaShimei, seinengappiYMD, seibetsuCode, idoJiyuCode, torokuIdoYMD, torokuTodokedeYMD, shojoIdoYMD, shojoTodokedeYMD, tenshutsuYoteiIdoYMD, tenshutsuKakuteiIdoYMD, tenshutsuKakuteiTsuchiYMD, zenkokuJushoCode, jusho, banchi, katagaki, tenshutsuYoteiZenkokuJushoCode, tenshutsuYoteiJusho, tenshutsuYoteiBanchi, tenshutsuYoteiKatagaki, tenshutsuKakuteiZenkokuJushoCode, tenshutsuKakuteiJusho, tenshutsuKakuteiBanchi, tenshutsuKakuteiKatagaki);
    }
