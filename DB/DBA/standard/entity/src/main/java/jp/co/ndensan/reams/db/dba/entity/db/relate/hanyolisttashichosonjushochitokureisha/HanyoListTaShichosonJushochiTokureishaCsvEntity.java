...
public class HanyoListTaShichosonJushochiTokureishaCsvEntity {
    ...
    @CsvField(order = 54, name = "他住所特例適用事由")
    private RString 他住所特例適用事由;
    @CsvField(order = 55, name = "他住所特例適用日")
    private RString 他住所特例適用日;
    @CsvField(order = 56, name = "他住所特例適用届出日")
    private RString 他住所特例適用届出日;
    @CsvField(order = 57, name = "他住所特例解除事由")
    private RString 他住所特例解除事由;
    @CsvField(order = 58, name = "他住所特例解除日")
    private RString 他住所特例解除日;
    @CsvField(order = 59, name = "他住所特例解除届出日")
    private RString 他住所特例解除届出日;
    @CsvField(order = 60, name = "他住所特例施設コード")
    private RString 他住所特例施設コード;
    @CsvField(order = 61, name = "他住所特例施設名称")
    private RString 他住所特例施設名称;
    @CsvField(order = 62, name = "他住所特例施設郵便番号")
    private RString 他住所特例施設郵便番号;
    @CsvField(order = 63, name = "他住所特例施設住所")
    private RString 他住所特例施設住所;
    @CsvField(order = 64, name = "他住所特例施設電話番号")
    private RString 他住所特例施設電話番号;
    @CsvField(order = 65, name = "他住所特例入所日")
    private RString 他住所特例入所日;
    @CsvField(order = 66, name = "他住所特例退所日")
    private RString 他住所特例退所日;
    @CsvField(order = 67, name = "前保険者番号")
    private RString 前保険者番号;
    @CsvField(order = 68, name = "他被保険者番号")
    private RString 他被保険者番号;
    @CsvField(order = 69, name = "他住所特例連絡票発行日")
    private RString 他住所特例連絡票発行日;
    @CsvField(order = 70, name = "施設退所通知発行日")
    private RString 施設退所通知発行日;
    @CsvField(order = 71, name = "施設変更通知発行日")
    private RString 施設変更通知発行日;
    @CsvField(order = 72, name = "医療保険種別")
    private RString 医療保険種別;
    @CsvField(order = 73, name = "医療保険番号")
    private RString 医療保険番号;
    @CsvField(order = 74, name = "医療保険者名")
    private RString 医療保険者名;
    @CsvField(order = 75, name = "医療保険記号番号")
