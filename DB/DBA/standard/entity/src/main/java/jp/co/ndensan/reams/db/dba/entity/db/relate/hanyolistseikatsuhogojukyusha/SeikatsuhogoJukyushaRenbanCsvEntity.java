...
public class SeikatsuhogoJukyushaRenbanCsvEntity {
    ...
    @CsvField(order = 64, name = "資格_証記載保険者番号")
    private RString 資格_証記載保険者番号;
    @CsvField(order = 65, name = "老齢福祉年金開始日")
    private RString 老齢福祉年金開始日;
    @CsvField(order = 66, name = "老齢福祉年金終了日")
    private RString 老齢福祉年金終了日;
    @CsvField(order = 67, name = "生活保護開始日")
    private RString 生活保護開始日;
    @CsvField(order = 68, name = "生活保護終了日")
    private RString 生活保護終了日;
    @CsvField(order = 69, name = "生活保護種別")
