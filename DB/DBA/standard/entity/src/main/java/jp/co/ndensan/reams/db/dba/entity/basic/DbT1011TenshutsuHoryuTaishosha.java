...
/**
 * 転出保留対象者テーブルの項目定義クラスです。
 * <br/> 転入の際の資格異動を保留になった介護被保険者を管理する
 */
public enum DbT1011TenshutsuHoryuTaishosha implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    ...
    private DbT1011TenshutsuHoryuTaishosha(int maxLength, int scale) {
