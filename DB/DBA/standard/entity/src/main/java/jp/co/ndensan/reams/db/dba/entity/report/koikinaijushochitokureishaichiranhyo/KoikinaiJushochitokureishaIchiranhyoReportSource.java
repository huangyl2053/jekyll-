...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listUpper_2", length = 24, order = 15)
    public RString listUpper_2;
    @ReportItem(name = "listUpper_3", length = 10, order = 16)
    public RString listUpper_3;
    @ReportItem(name = "listUpper_4", length = 11, order = 17)
    public RString listUpper_4;
    @ReportItem(name = "listUpper_5", length = 9, order = 18)
    ...
    @ReportItem(name = "listLower_2", length = 12, order = 27)
    public RString listLower_2;
    @ReportItem(name = "listLower_3", length = 1, order = 28)
    public RString listLower_3;
    @ReportItem(name = "listLower_4", length = 15, order = 29)
    public RString listLower_4;
    @ReportItem(name = "listLower_5", length = 20, order = 30)
    public RString listLower_5;
    @ReportItem(name = "listLower_6", length = 10, order = 31)
    ...
    @ReportItem(name = "listLower_9", length = 10, order = 34)
    public RString listLower_9;
    @ReportItem(name = "listLower_10", length = 6, order = 35)
