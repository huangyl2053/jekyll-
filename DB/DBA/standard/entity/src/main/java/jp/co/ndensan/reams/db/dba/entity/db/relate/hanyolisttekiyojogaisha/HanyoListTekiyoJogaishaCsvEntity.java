...
public class HanyoListTekiyoJogaishaCsvEntity {
    ...
    @CsvField(order = 54, name = "適用除外適用事由")
    private RString 適用除外適用事由;
    @CsvField(order = 55, name = "適用除外適用日")
    private RString 適用除外適用日;
    @CsvField(order = 56, name = "適用除外適用届出日")
    private RString 適用除外適用届出日;
    @CsvField(order = 57, name = "適用除外解除事由")
    private RString 適用除外解除事由;
    @CsvField(order = 58, name = "適用除外解除日")
    private RString 適用除外解除日;
    @CsvField(order = 59, name = "適用除外解除届出日")
    private RString 適用除外解除届出日;
    @CsvField(order = 60, name = "適用除外施設コード")
    private RString 適用除外施設コード;
    @CsvField(order = 61, name = "適用除外施設名称")
    private RString 適用除外施設名称;
    @CsvField(order = 62, name = "適用除外入所日")
    private RString 適用除外入所日;
    @CsvField(order = 63, name = "適用除外退所日")
    private RString 適用除外退所日;
    @CsvField(order = 64, name = "適用除外施設郵便番号")
    private RString 適用除外施設郵便番号;
    @CsvField(order = 65, name = "適用除外施設住所")
    private RString 適用除外施設住所;
    @CsvField(order = 66, name = "適用除外施設電話番号")
    private RString 適用除外施設電話番号;
    @CsvField(order = 67, name = "施設退所通知発行日")
    private RString 施設退所通知発行日;
    @CsvField(order = 68, name = "施設変更通知発行日")
