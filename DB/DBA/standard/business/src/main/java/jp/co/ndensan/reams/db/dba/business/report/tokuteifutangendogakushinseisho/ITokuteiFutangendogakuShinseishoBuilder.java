...
/**
 * 介護保険特定負担限度額申請書Builderのインターフェースクラスです。
 */
public interface ITokuteiFutangendogakuShinseishoBuilder
        extends IReportBuilder<TokuteiFutangendogakuShinseishoReportSource> {
}
