...
public class HihokenshashoB4Builder implements IHihokenshashoBuilder {
     ...
     */
    public HihokenshashoB4Builder(HihokenshashoB4SourceBuilder hihokenshashoB4, IAtesakiSourceBuilder atesaki) throws NullPointerException {
    ...
    public HihokenshashoB4 build() {
        ...
        switch (hihokenshashoB4.get印字位置()) {
            case 上部:
                source.atesakiSource1 = atesaki.buildSource();
                break;
            default:
                source.atesakiSource2 = atesaki.buildSource();
                break;
        }
        return source;
    }
