...
/**
 * 被保険者証発行管理一覧表ヘッダエディターのインターフェースクラスです。
 *
 * @reamsid_L DBA-0600-070 lishengli
 */
interface IHihokenshashoHakkoKanriIchiranhyoEditor extends IReportEditor<HihokenshashoHakkoKanriIchiranhyoReportSource> {
