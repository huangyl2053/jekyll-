...
/**
 * 転入転出未登録一覧表ヘッダエディターのインターフェースクラスです。
 *
 * @reamsid_L DBU-4110-040 yaodongsheng
 */
interface ITennyuTenshutsuMiTorokuIchiranhyoEditor extends IReportEditor<TennyuTenshutsuMitorokuIchiranhyoReportSource> {
}
