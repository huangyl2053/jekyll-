 ...
 * 受給資格証明書Builderクラスです。
 */
public class JukyuShikakuShomeishoBuilderImpl implements IJukyuShikakuShomeishoBuilder {
     ...
     */
    JukyuShikakuShomeishoBuilderImpl(IJukyuShikakuShomeishoEditor bodyEditor) {
