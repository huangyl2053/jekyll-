...
/**
 * 喪失事由（他特/除外）のコードマスタ情報を表すクラスです。
 *
 * @author N9606 漢那 憲作
 */
public class SoshitsuJiyuTatokuJogai implements ICodeValueObject {
     ...
     * @param option3 任意情報3
     */
    public SoshitsuJiyuTatokuJogai(Code code, RString codeMeisho, RString codeRyakusho, RString option1, RString option2, RString option3) {
        this.code = code;
     ...
     */
    public SoshitsuJiyuTatokuJogai(Code code, RString codeMeisho, RString codeRyakusho) {
