...
/**
 * 介護保険償還払受領委任払申請書エディターのインターフェースクラスです。
 */
public interface IShokanharaiJuryoIninShinseishoEditor extends
        IReportEditor<ShokanharaiJuryoIninShinseishoReportSource> {
