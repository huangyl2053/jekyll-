...
public final class TokubetsuChiikiKasanGenmenTaishoShinseishoBackReport extends
     ...
     */
    public static TokubetsuChiikiKasanGenmenTaishoShinseishoBackReport createReport(
            @NonNull TokubetsuChiikiKasanGenmenTaishoShinseishoBackBodyItem bodyItem) {
        return new TokubetsuChiikiKasanGenmenTaishoShinseishoBackReport(bodyItem);
    }

    private TokubetsuChiikiKasanGenmenTaishoShinseishoBackReport(
            TokubetsuChiikiKasanGenmenTaishoShinseishoBackBodyItem bodyItem) {
        this.bodyItem = bodyItem;
    }

    @Override
    public void writeBy(ReportSourceWriter<TokubetsuChiikiKasanGenmenTaishoShinseishoBackReportSource> writer) {
        ITokubetsuChiikiKasanGenmenTaishoShinseishoBackEditor bodyEditor
                = new TokubetsuChiikiKasanGenmenTaishoShinseishoBackBodyEditor(bodyItem);
        ITokubetsuChiikiKasanGenmenTaishoShinseishoBackBuilder builder
                = new TokubetsuChiikiKasanGenmenTaishoShinseishoBackBuilderImpl(bodyEditor);
