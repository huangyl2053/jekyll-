...
/**
 *
 * 介護保険居宅介護（予防）福祉用具購入費支給（受領委任払）申請書のエディターのインターフェースクラスです。
 */
public interface IFukushiYoguKonyuhiShinseishoJuryoIninHaraiEditor
        extends IReportEditor<FukushiYoguKonyuhiShinseishoJuryoIninHaraiReportSource> {
