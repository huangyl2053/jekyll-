...
/**
 * 他市町村住所地特例者台帳Builderのインターフェースクラスです。
 *
 * @reamsid_L DBA-0402-030 xuyannan
 */
public interface ITashichosonJushochitokureishaDaichoBuilder extends IReportBuilder<TashichosonJushochitokureishaDaichoReportSource> {
