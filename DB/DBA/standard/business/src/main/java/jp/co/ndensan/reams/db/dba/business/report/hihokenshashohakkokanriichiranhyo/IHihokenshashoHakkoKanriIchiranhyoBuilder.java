...
/**
 * 被保険者証発行管理一覧表Builderのインターフェースクラスです。
 *
 * @reamsid_L DBA-0600-070 lishengli
 */
interface IHihokenshashoHakkoKanriIchiranhyoBuilder extends IReportBuilder<HihokenshashoHakkoKanriIchiranhyoReportSource> {
