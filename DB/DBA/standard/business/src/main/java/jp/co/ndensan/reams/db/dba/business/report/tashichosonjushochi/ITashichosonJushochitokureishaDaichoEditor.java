...
/**
 * 他市町村住所地特例者台帳エディターのインターフェースクラスです。
 *
 * @reamsid_L DBA-0402-030 xuyannan
 */
public interface ITashichosonJushochitokureishaDaichoEditor extends IReportEditor<TashichosonJushochitokureishaDaichoReportSource> {
