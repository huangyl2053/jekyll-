...
/**
 *
 * 介護保険受給資格証明書交付申請書のBuilderインターフェースです。
 * @reamsid_L DBA-0540-682 dongyabin
 */
public interface IJukyuShikakuShomeishokoufuShinseishoBuilder extends IReportBuilder<JukyuShikakuShomeishokoufuShinseishoReportSource> {
}
