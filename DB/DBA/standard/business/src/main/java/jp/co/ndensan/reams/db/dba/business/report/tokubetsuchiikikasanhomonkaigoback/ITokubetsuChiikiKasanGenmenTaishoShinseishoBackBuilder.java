...
/**
 *
 * 特別地域加算減免・訪問介護等利用者負担減額対象確認申請書Builderのインターフェースです。
 */
interface ITokubetsuChiikiKasanGenmenTaishoShinseishoBackBuilder extends IReportBuilder<TokubetsuChiikiKasanGenmenTaishoShinseishoBackReportSource> {
}
