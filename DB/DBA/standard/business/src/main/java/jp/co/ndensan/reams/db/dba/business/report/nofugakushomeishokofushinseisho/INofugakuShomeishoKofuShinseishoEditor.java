...
/**
 *
 * 介護保険料納付額証明書交付申請書エディターのインターフェースクラスです。
 *
 * @reamsid_L DBA-0540-694 yaodongsheng
 */
public interface INofugakuShomeishoKofuShinseishoEditor extends IReportEditor<NofugakuShomeishoKofuShinseishoReportSource> {
