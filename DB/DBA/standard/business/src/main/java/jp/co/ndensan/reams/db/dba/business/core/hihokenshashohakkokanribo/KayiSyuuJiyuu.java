 ...
 * 回収事由です。
 */
public class KayiSyuuJiyuu implements Comparable<KayiSyuuJiyuu> {
    ...
    @Override
    public int compareTo(KayiSyuuJiyuu kayisyuujiyuu) {
        return this.getコード().compareTo(kayisyuujiyuu.getコード());
    }
}
