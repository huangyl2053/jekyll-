...
/**
 *
 * 介護保険居宅介護（予防）住宅改修費支給（受領委任払）申請書のエディターのインターフェースクラスです。
 */
public interface IJutakuKaishuhiShikyuShinseishoJuryoIninHaraiEditor
        extends IReportEditor<JutakuKaishuhiShikyuShinseishoJuryoIninHaraiReportSource> {
