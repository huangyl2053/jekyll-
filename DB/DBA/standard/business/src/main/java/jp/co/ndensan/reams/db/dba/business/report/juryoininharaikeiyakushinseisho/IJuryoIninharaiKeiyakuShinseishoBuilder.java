...
/**
 *
 * 介護保険受領委任払い契約申請書Builderのインターフェースクラスです。
 */
public interface IJuryoIninharaiKeiyakuShinseishoBuilder extends IReportBuilder<JuryoIninharaiKeiyakuShinseishoReportSource> {
}
