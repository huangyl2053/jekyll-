...
/**
 * 介護保険被保険者証等再交付申請書ヘッダエディターのインターフェースクラスです。
 * 
 * @reamsid_L DBA-0540-689  suguangjun 
 */
interface IHihokenshashoSaikoufuShinseishoEditor extends IReportEditor<HihokenshashoSaikoufuShinseishoReportSource> {
}
