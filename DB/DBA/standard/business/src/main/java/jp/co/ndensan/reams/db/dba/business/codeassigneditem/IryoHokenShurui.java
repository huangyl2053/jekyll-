...
/**
 * 医療保険種類のコードマスタ情報を表すクラスです。
 *
 * @author N9606 漢那 憲作
 */
public class IryoHokenShurui implements ICodeValueObject {
     ...
     * @param option3 任意情報3
     */
    public IryoHokenShurui(Code code, RString codeMeisho, RString codeRyakusho, RString option1, RString option2, RString option3) {
        this.code = code;
     ...
     */
    public IryoHokenShurui(Code code, RString codeMeisho, RString codeRyakusho) {
