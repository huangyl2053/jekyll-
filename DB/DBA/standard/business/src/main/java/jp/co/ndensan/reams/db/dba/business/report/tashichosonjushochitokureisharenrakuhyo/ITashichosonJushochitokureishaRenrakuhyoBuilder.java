...
/**
 *
 * 介護保険他市町村住所地特例者連絡票Builderのインターフェースクラスです。
 */
interface ITashichosonJushochitokureishaRenrakuhyoBuilder extends IReportBuilder<TashichosonJushochitokureishaRenrakuhyoReportSource> {
