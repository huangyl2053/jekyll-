...
/**
 * 社会福祉法人等利用者負担軽減対象確認申請書のインターフェースクラスです。
 *
 */
interface IShakaiFukushiHojinFutanKeigenTaishoKakuninShinseishoEditor extends
        IReportEditor<ShakaiFukushiHojinFutanKeigenTaishoKakuninShinseishoReportSource> {
}
