...
/**
 *
 * 介護保険受領委任払い取扱事業者登録申請書Builderのインターフェースクラスです。
 * @reamsid_L DBA-0540-684 dongyabin
 */
public interface IJuryoIninharaiToriatsukaiJigyoshaTorokuShinseishBuilder extends 
        IReportBuilder<JuryoIninharaiToriatsukaiJigyoshaTorokuShinseishoReportSource> {
}
