...
/**
 * 軽度者に対する福祉用具貸与の取り扱いの特例に関する確認申請書Builderのインターフェースクラスです。
 *
 */
public interface IKeidoshaFukushiYoguTaiyoKakuninShinseishoBuilder extends IReportBuilder<KeidoshaFukushiYoguTaiyoKakuninShinseishoReportSource> {
