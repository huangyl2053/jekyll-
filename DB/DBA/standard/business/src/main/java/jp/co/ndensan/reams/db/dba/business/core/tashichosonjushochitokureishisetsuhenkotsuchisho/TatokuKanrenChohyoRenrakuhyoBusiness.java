 ...
 */
public class TatokuKanrenChohyoRenrakuhyoBusiness {

    private final TatokuKanrenChohyoRenrakuhyoEntity entity;

    /**
     * コンストラクタです。
     *
     * @param entity TatokuKanrenChohyoRenrakuhyoEntity
     */
    public TatokuKanrenChohyoRenrakuhyoBusiness(TatokuKanrenChohyoRenrakuhyoEntity entity) {
        this.entity = entity;
    }
