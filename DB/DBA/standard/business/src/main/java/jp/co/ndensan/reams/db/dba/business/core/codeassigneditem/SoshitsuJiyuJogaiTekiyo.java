...
/**
 * 喪失事由（除外適用）のコードマスタ情報を表すクラスです。
 *
 * @author N9606 漢那 憲作
 */
public class SoshitsuJiyuJogaiTekiyo implements ICodeValueObject {
     ...
     * @param option3 任意情報3
     */
    public SoshitsuJiyuJogaiTekiyo(Code code, RString codeMeisho, RString codeRyakusho, RString option1, RString option2, RString option3) {
        this.code = code;
     ...
     */
    public SoshitsuJiyuJogaiTekiyo(Code code, RString codeMeisho, RString codeRyakusho) {
