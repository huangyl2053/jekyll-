...
class IdoCheckListBodyEditor implements IIdoCheckListEditor {
    ...
    protected IdoCheckListBodyEditor(IdoCheckListItem item) {
        this.item = item;
    }
    ...
    private IdoCheckListReportSource editBody(IdoCheckListReportSource source) {
        ...
        source.fuseigoCount = item.getFuseigoCount();
        return source;
    }
