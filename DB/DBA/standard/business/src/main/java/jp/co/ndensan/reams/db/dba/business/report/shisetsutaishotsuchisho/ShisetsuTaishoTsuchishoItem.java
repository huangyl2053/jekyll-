...
public class ShisetsuTaishoTsuchishoItem {
    ...
    private RString taishogoYubinNo;
    private RString taishogoJusho;
    private RString taishoYMD;
    private RString taishoJiyu;
    private RString shisetsuName;
    private RString shisetsuTelNo;
    private RString shisetsuFaxNo;
