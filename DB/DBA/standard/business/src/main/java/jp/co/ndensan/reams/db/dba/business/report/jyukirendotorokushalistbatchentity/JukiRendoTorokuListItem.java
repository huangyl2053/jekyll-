 ...
 */
package jp.co.ndensan.reams.db.dba.business.report.jyukirendotorokushalistbatchentity;
...
@Getter
public class JukiRendoTorokuListItem {
    ...
    private final RString fuseigoCountTitle;
    private final RString fuseigoCount;

    public JukiRendoTorokuListItem(RString printTimeStamp, RString taishoJohotitle, RString shichosonCode,
            RString shichosonName, RString shutsuryokujun1, RString shutsuryokujun2, RString shutsuryokujun3,
            RString shutsuryokujun4, RString shutsuryokujun5, RString kaipage1, RString kaipage2, RString kaipage3,
            RString kaipage4, RString kaipage5, RString kaishiTitle, RString shuryoTitle, RString kubunTitle,
            RString idoJohoTitle1, RString idoJohoTitle2, RString idoJohoTitle3, RString kaishiYmdTitle,
            RString shuryoYmdTitle, RString idoJohoTitle4, RString idoJohoTitle5, RString idoJohoTitle6,
            RString listUpper_1, RString listUpper_2, RString listUpper_3, RString listUpper_4, RString listUpper_5,
            RString listUpper_6, RString listUpper_7, RString listUpper_8, RString listUpper_9, RString listUpper_10,
            RString listUpper_11, RString listUpper_12, RString listUpper_13, RString listUpper_14,
            RString listHihokenshaNo_1, RString listLower_1, RString listLower_2, RString listLower_3,
            RString listLower_4, RString listLower_5, RString listLower_6, RString listLower_7, RString listLower_8,
            RString listLower_9, RString listLower_10, RString listLower_11, RString listLower_12, RString listLower_13,
            RString listLower_14, RString fuseigoCountTitle, RString fuseigoCount) {
        ...
        this.fuseigoCountTitle = fuseigoCountTitle;
        this.fuseigoCount = fuseigoCount;
    }
}
