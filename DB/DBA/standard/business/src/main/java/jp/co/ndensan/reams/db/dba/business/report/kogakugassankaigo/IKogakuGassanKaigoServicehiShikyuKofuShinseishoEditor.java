...
/**
 *
 * 高額医療合算介護（介護予防）サービス費支給兼自己負担額証明書交付申請書のエディターのインターフェースクラスです。
 */
public interface IKogakuGassanKaigoServicehiShikyuKofuShinseishoEditor
        extends IReportEditor<KogakuGassanKaigoServicehiShikyuKofuShinseishoReportSource> {
