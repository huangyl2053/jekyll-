 ...
 */
package jp.co.ndensan.reams.db.dba.business.core.hanyolisttekiyojogaisha;
 ...
 */
public class HanyoListTekiyoJogaishaResult {
     ...
     */
    public HanyoListTekiyoJogaishaCsvEntity setEucCsvEntity(
            HanyoListTekiyoJogaishaProcessParameter processParameter,
            HanyoListTekiyoJogaishaRelateEntity entity,
            List<KoseiShichosonMaster> koseiShichosonJoho,
            Association association) {
        HanyoListTekiyoJogaishaCsvEntity eucCsvEntity = new HanyoListTekiyoJogaishaCsvEntity();
        ...
        eucCsvEntity.set適用除外適用事由(JogaiTekiyoJiyu.toValue(entity.get適用除外適用事由()).get名称());
        ...
        eucCsvEntity.set適用除外解除日(set年月日(processParameter, entity.get適用除外解除日()));
        eucCsvEntity.set適用除外解除届出日(set年月日(processParameter, entity.get適用除外解除届出日()));
        eucCsvEntity.set適用除外施設コード(entity.get適用除外施設コード());
        eucCsvEntity.set適用除外施設名称(entity.get適用除外施設名称());
        eucCsvEntity.set適用除外入所日(set年月日(processParameter, entity.get適用除外入所日()));
        eucCsvEntity.set適用除外退所日(set年月日(processParameter, entity.get適用除外退所日()));
        eucCsvEntity.set適用除外施設郵便番号(set郵便番号(entity.get適用除外施設郵便番号()));
        eucCsvEntity.set適用除外施設住所(entity.get適用除外施設住所());
        eucCsvEntity.set適用除外施設電話番号(entity.get適用除外施設電話番号());
     ...
     * @return HanyoListTekiyoJogaishaRenbanCsvEntity
     */
    public HanyoListTekiyoJogaishaRenbanCsvEntity setRenbanEucCsvEntity(
            HanyoListTekiyoJogaishaProcessParameter processParameter,
            HanyoListTekiyoJogaishaRelateEntity entity,
            List<KoseiShichosonMaster> koseiShichosonJoho,
            int i,
            Association association) {
        HanyoListTekiyoJogaishaRenbanCsvEntity eucRenbanCsvEntity = new HanyoListTekiyoJogaishaRenbanCsvEntity();
        ...
        eucRenbanCsvEntity.set適用除外適用事由(JogaiTekiyoJiyu.toValue(entity.get適用除外適用事由()).get名称());
        ...
        eucRenbanCsvEntity.set適用除外解除日(set年月日(processParameter, entity.get適用除外解除日()));
        eucRenbanCsvEntity.set適用除外解除届出日(set年月日(processParameter, entity.get適用除外解除届出日()));
        eucRenbanCsvEntity.set適用除外施設コード(entity.get適用除外施設コード());
        eucRenbanCsvEntity.set適用除外施設名称(entity.get適用除外施設名称());
        eucRenbanCsvEntity.set適用除外入所日(set年月日(processParameter, entity.get適用除外入所日()));
        eucRenbanCsvEntity.set適用除外退所日(set年月日(processParameter, entity.get適用除外退所日()));
        eucRenbanCsvEntity.set適用除外施設郵便番号(set郵便番号(entity.get適用除外施設郵便番号()));
        eucRenbanCsvEntity.set適用除外施設住所(entity.get適用除外施設住所());
        eucRenbanCsvEntity.set適用除外施設電話番号(entity.get適用除外施設電話番号());
     ...
     */
    public List<RString> get出力条件(HanyoListTekiyoJogaishaProcessParameter processParameter, List<KaigoDonyuKeitai> kaigoDonyuKeitai) {
    ...
    private RString set年月日(HanyoListTekiyoJogaishaProcessParameter processParameter, FlexibleDate 年月日) {
    ...
    /**
     * 帳票分類ID「DBA701003_HanyoListTekiyoJogaisha」（汎用リスト 適用除外者）出力順設定可能項目です。
     */
