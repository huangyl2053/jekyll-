...
/**
 * 年齢到達者登録リスト帳票のボディエディタクラスです。
 *
 * @reamsid_L DBA-0570-060 xuyue
 */
class NenreitotatsuKakuninListBodyEdiotr implements INenreitotatsuKakuninListEdiotr {

    private final NenreitotatsuKakuninListItem item;

    public NenreitotatsuKakuninListBodyEdiotr(NenreitotatsuKakuninListItem item) {
        this.item = item;
    }
    ...
    private NenreitotatsuKakuninListReportSource editBody(NenreitotatsuKakuninListReportSource source) {
