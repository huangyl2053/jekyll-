 ...
 */
package jp.co.ndensan.reams.db.dba.service.report.homonkaigoriyoushafutangakugengakushinseisho;

import java.util.ArrayList;
import java.util.List;
import jp.co.ndensan.reams.db.dba.business.core.tokuteifutangendogakushinseisho.HihokenshaKihonBusiness;
import jp.co.ndensan.reams.db.dba.business.report.homonkaigoriyoushafutangakugengakushinseisho.HomonkaigoRiyoushaFutangakuGengakuShinseishoItem;
import jp.co.ndensan.reams.db.dba.business.report.homonkaigoriyoushafutangakugengakushinseisho.HomonkaigoRiyoushaFutangakuGengakuShinseishoProerty;
import jp.co.ndensan.reams.db.dba.business.report.homonkaigoriyoushafutangakugengakushinseisho.HomonkaigoRiyoushaFutangakuGengakuShinseishoReport;
...
/**
 * 訪問介護利用者負担額減額申請書Printクラスです。
 *
 * @reamsid_L DBA-0540-420 zhengshukai
 */
public class HomonkaigoRiyoushaFutangakuGengakuShinseisho {
    ...
    /**
     * 訪問介護利用者負担額減額申請書Printします。
     *
     * @param 識別コード 識別コード
     * @param 被保険者番号 被保険者番号
     * @return 訪問介護利用者負担額減額申請書_帳票作成
     */
    public SourceDataCollection createHomonkaigoRiyoushaFutangakuGengakuShinseishoChohyo(ShikibetsuCode 識別コード, HihokenshaNo 被保険者番号) {
    ...
    private List<HomonkaigoRiyoushaFutangakuGengakuShinseishoReport> toReports(
            HihokenshaKihonBusiness entity, RString ninshoshaYakushokuMei) {
        List<HomonkaigoRiyoushaFutangakuGengakuShinseishoReport> list = new ArrayList<>();
        ...
        list.add(HomonkaigoRiyoushaFutangakuGengakuShinseishoReport.createReport(item));
        return list;
    }
    ...
    private RString get帳票文言() {
        ...
        TsuchishoTeikeibunInfo tsuchishoTeikeibunInfo = tsuchisho.get通知書定形文検索(
                ...
                new ReportId("DBD800005_HomonKaigoRiyoshaFutangakuGengakuShinseisho"),
                KamokuCode.EMPTY,
                1,
                1,
