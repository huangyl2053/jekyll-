 ...
 */
package jp.co.ndensan.reams.db.dba.service.core.kyufugengakumenjyoshinseisho;

import java.util.ArrayList;
import java.util.List;
import jp.co.ndensan.reams.db.dba.business.core.tokuteifutangendogakushinseisho.HihokenshaKihonBusiness;
import jp.co.ndensan.reams.db.dba.business.report.kyufugengakumenjyoshinseisho.KyufugengakuMenjyoShinseishoItem;
import jp.co.ndensan.reams.db.dba.business.report.kyufugengakumenjyoshinseisho.KyufugengakuMenjyoShinseishoProerty;
import jp.co.ndensan.reams.db.dba.business.report.kyufugengakumenjyoshinseisho.KyufugengakuMenjyoShinseishoReport;
...
public class KyufugakuGengakuMenjoShinseisho {
     ...
     * @param 識別コード 識別コード
     * @param 被保険者番号 被保険者番号
     * @return 給付額減額免除申請書_帳票作成
     */
    public SourceDataCollection createKyufugakuGengakuMenjoShinseishoChohyo(
            ShikibetsuCode 識別コード, HihokenshaNo 被保険者番号) {
        KyufugengakuMenjyoShinseishoProerty proerty = new KyufugengakuMenjyoShinseishoProerty();
        try (ReportManager reportManager = new ReportManager()) {
            try (ReportAssembler<KyufugengakuMenjyoShinseishoReportSource> assembler = createAssembler(proerty, reportManager)) {
                ReportSourceWriter<KyufugengakuMenjyoShinseishoReportSource> reportSourceWriter
                ...
                for (KyufugengakuMenjyoShinseishoReport report : toReports(get被保険者基本情報(識別コード, 被保険者番号),
