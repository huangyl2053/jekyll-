 ...
 */
package jp.co.ndensan.reams.db.dba.service.core.kyokaisogaitosha.kyokaisosochishinsei;
...
import jp.co.ndensan.reams.db.dba.persistence.db.basic.DbT1013KyokaisoSochiShinseiDac;
...
public class KyokaisoSochiShinseiManager {
     ...
     * 境界層措置申請を全件返します。
     *
     * @return KyokaisoSochiShinseiの{@code list}
     */
    @Transaction
