...
public class JigyoshaInputGuideFinder {
     ...
     */
    public List<ServiceShuruiJigyoshaInputGuide> getServiceShuruiJigyoshaInputGuidea(RYearMonth systemDate) {
     ...
     */
    public List<ServiceJigyoshaInputGuide> getTekiyoJogaiInputGuide(JigyoshaInputGuideParameter params) {
        JigyoshaInputGuideMapper jigyoshaInputGuideMapper = this.mapperProvider.create(JigyoshaInputGuideMapper.class);
     ...
     */
    public List<ServiceJigyoshaInputGuide> getOtherTokureiInputGuide(JigyoshaInputGuideParameter params) {
        JigyoshaInputGuideMapper jigyoshaInputGuideMapper = this.mapperProvider.create(JigyoshaInputGuideMapper.class);
