    ...
    private List<HihokenshaEntity> get被保険者情報(HihokenshaDaichoSakuseiParameter parameter) {
        ...
        ShikibetsuTaishoSearchKeyBuilder key = new ShikibetsuTaishoSearchKeyBuilder(
                ShikibetsuTaishoGyomuHanteiKeyFactory.createInstance(
                        GyomuCode.UR業務共通, KensakuYusenKubun.住登外優先));
    ...
    private List<HihokenshaDaichoDivisionEntity> get分割した被保険者台帳管理リスト(
        ...
        for (DbT1001HihokenshaDaichoEntity entity : entityList) {
            if ((nocount + 1) % NOCOUNT_5 == 0) {
                ...
                CodeMaster.getCodeMeisho(new CodeShubetsu(CODESHUBETSU_0117), new Code(
                        entity.getShikakuShutokuJiyuCode()));
                ...
                CodeMaster.getCodeMeisho(new CodeShubetsu(CODESHUBETSU_0121), new Code(
                        entity.getShikakuSoshitsuJiyuCode()));
                ...
                CodeMaster.getCodeMeisho(new CodeShubetsu(CODESHUBETSU_0126), new Code(
