...
import jp.co.ndensan.reams.db.dba.entity.db.basic.DbT1013KyokaisoSochiShinsei;
import static jp.co.ndensan.reams.db.dba.entity.db.basic.DbT1013KyokaisoSochiShinsei.hihokenshaNo;
import static jp.co.ndensan.reams.db.dba.entity.db.basic.DbT1013KyokaisoSochiShinsei.linkNo;
import static jp.co.ndensan.reams.db.dba.entity.db.basic.DbT1013KyokaisoSochiShinsei.rirekiNo;
...
public class DbT1013KyokaisoSochiShinseiDac implements ISaveable<DbT1013KyokaisoSochiShinseiEntity> {
     ...
     * 境界層措置申請を全件返します。
     *
     * @return DbT1013KyokaisoSochiShinseiEntityの{@code list}
     */
    @Transaction
