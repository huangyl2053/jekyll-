...
public interface IKyokaisoGaitoshaMapper {
    ...
    /**
     * 主キー1に合致する境界層該当者のリストを取得します。
     *
     * @param 境界層該当者検索条件 境界層該当者検索条件
     * @return KyokaisoGaitoshaEntityの{@code list}
     */
    List<KyokaisoGaitoshaEntity> select境界層該当者リストBy主キー1(KyokaisoGaitoshaMapperParameter 境界層該当者検索条件);
}
