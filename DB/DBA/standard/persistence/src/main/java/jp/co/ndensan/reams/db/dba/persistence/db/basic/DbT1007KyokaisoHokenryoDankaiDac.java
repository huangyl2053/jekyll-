...
import jp.co.ndensan.reams.db.dba.entity.db.basic.DbT1007KyokaisoHokenryoDankai;
import static jp.co.ndensan.reams.db.dba.entity.db.basic.DbT1007KyokaisoHokenryoDankai.hihokenshaNo;
import static jp.co.ndensan.reams.db.dba.entity.db.basic.DbT1007KyokaisoHokenryoDankai.linkNo;
import static jp.co.ndensan.reams.db.dba.entity.db.basic.DbT1007KyokaisoHokenryoDankai.rirekiNo;
import static jp.co.ndensan.reams.db.dba.entity.db.basic.DbT1007KyokaisoHokenryoDankai.tekiyoKaishiYM;
...
public class DbT1007KyokaisoHokenryoDankaiDac implements ISaveable<DbT1007KyokaisoHokenryoDankaiEntity> {
     ...
     * 境界層保険料段階を全件返します。
     *
     * @return DbT1007KyokaisoHokenryoDankaiEntityの{@code list}
     */
    @Transaction
