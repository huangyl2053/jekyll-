...
public abstract class KoseiShichosonMasterManagerBase implements IKoseiShichosonMasterManager {
     ...
     */
    @Override
    public abstract IItemList<IKoseiShichosonMaster> findAll構成市町村();
     ...
     */
    @Override
    public abstract Optional<IKoseiShichosonMaster> find構成市町村by証記載保険者番号(ShoKisaiHokenshaNo 証記載保険者番号);
     ...
     */
    @Override
    public abstract Optional<IKoseiShichosonMaster> find構成市町村by市町村コード(LasdecCode 市町村コード);
