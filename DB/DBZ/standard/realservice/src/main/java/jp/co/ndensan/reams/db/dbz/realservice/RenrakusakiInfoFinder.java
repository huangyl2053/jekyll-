...
public class RenrakusakiInfoFinder {
     ...
     */
    public List<RenrakusakiJoho> getRenrakusakiList(RString hokenshaNo, RString hihoNo) {
        ...
        for (DbT5050RenrakusakiJohoEntity entity : entityList) {
            RenrakusakiJoho renrakusakiInfo = RenrakusakiInfoMapper.toRenrakusakiInfo(entity);
