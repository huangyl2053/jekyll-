...
public interface IZenkaiNinteiKekkaJohoMapper {
     ...
     * 受給_結果詳細情報を取得します。
     *
     * @param shinseishoKanriNo 前回申請管理番号
     * @return KekkaShosaiJohoRelateEntity
     */
    KekkaShosaiJohoRelateEntity get受給_結果詳細情報(RString shinseishoKanriNo);
     ...
     * @return KekkaShosaiJohoRelateEntity
     */
    KekkaShosaiJohoRelateEntity get認定_結果詳細情報(RString shinseishoKanriNo);
}
