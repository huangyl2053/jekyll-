...
import static jp.co.ndensan.reams.db.dbz.entity.basic.DbT4913ChosainJoho.*;
 ...
 * @author n8223 朴義一
 */
public class DbT4913ChosainJohoDac implements IModifiable<IChosainJohoEntity> {
     ...
     */
    @Transaction
    public Optional<DbT4913ChosainJohoEntity> selectByKey(
            LasdecCode 市町村コード,
     ...
     */
    @Transaction
    public ItemList<DbT4913ChosainJohoEntity> selectAll() {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
