 ...
 * @author n8223 朴義一
 */
public class KaigoJogaiTokureiTaishoShisetsuDac implements IModifiable<DbT1005KaigoJogaiTokureiTaishoShisetsuEntity> {
     ...
     */
    @Transaction
    public IItemList<DbT1005KaigoJogaiTokureiTaishoShisetsuEntity> select介護除外住所地特例対象施設一覧By事業者種別(RString 事業者種別) {
        ...
        List<DbT1005KaigoJogaiTokureiTaishoShisetsuEntity> 台帳リスト = new ArrayList<>();
    ...
    private DbT1005KaigoJogaiTokureiTaishoShisetsuEntity createModel(DbT1005KaigoJogaiTokureiTaishoShisetsuEntity 介護除外住所地特例対象施設エンティティ) {
        if (介護除外住所地特例対象施設エンティティ == null) {
            return null;
        }

        return new DbT1005KaigoJogaiTokureiTaishoShisetsuEntity();
    }

    @Override
    public int insert(DbT1005KaigoJogaiTokureiTaishoShisetsuEntity data) {

        if (data == null) {
            return 0;
        }

        return 介護除外住所地特例対象施設Dac.save(data);
    }

    @Override
    public int update(DbT1005KaigoJogaiTokureiTaishoShisetsuEntity data) {
    ...
    @Override
    public int delete(DbT1005KaigoJogaiTokureiTaishoShisetsuEntity data) {
