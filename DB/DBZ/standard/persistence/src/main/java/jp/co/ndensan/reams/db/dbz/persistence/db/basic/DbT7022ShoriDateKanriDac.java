...
public class DbT7022ShoriDateKanriDac implements ISaveable<DbT7022ShoriDateKanriEntity> {
     ...
     */
    @Transaction
    public List<DbT7022ShoriDateKanriEntity> selectBySomeColumns(
            SubGyomuCode サブ業務コード,
            RString 処理名,
            FlexibleYear 年度,
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select(
            SubGyomuCode サブ業務コード,
            LasdecCode 市町村コード,
            RString 処理名) throws NullPointerException {
        requireNonNull(サブ業務コード, UrSystemErrorMessages.値がnull.getReplacedMessage(サブ業務コードメッセージ.toString()));
     ...
     */
    @Transaction
    public List<DbT7022ShoriDateKanriEntity> select処理状況_通知書作成(FlexibleYear 調定年度, RString 処理名) {
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select前回抽出期間情報の取得(LasdecCode 市町村コード)
     ...
     */
    @Transaction
    public List<DbT7022ShoriDateKanriEntity> select非課税年金対象者情報for広域(
            SubGyomuCode サブ業務コード,
            RString 処理名,
            RString 処理枝番,
            FlexibleYear 年度) throws NullPointerException {
     ...
     */
    @Transaction
    public List<DbT7022ShoriDateKanriEntity> select非課税年金対象者情報forチェック(
            SubGyomuCode サブ業務コード,
            RString 処理名,
            RString 年度内通番,
            FlexibleYear 年度,
