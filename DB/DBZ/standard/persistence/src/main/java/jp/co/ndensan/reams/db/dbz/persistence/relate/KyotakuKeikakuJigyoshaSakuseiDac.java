...
public class KyotakuKeikakuJigyoshaSakuseiDac implements IModifiable<KyotakuKeikakuJigyoshaSakuseiModel> {
     ...
     */
    @Transaction
    public Optional<KyotakuKeikakuJigyoshaSakuseiModel> selectByKey(RString 被保険者番号,
            RString 証記載保険者番号,
        ...
        return Optional.ofNullable(createModel(居宅給付計画事業者作成Dac.selectByKey(被保険者番号, 証記載保険者番号,
                識別コード, 対象年月, 処理日時)));
    }
     ...
     */
    @Transaction
    public Optional<KyotakuKeikakuJigyoshaSakuseiModel> select直近居宅給付計画事業者作成(RString 被保険者番号,
            RString 証記載保険者番号,
            ShikibetsuCode 識別コード,
            FlexibleYearMonth 対象年月) {
