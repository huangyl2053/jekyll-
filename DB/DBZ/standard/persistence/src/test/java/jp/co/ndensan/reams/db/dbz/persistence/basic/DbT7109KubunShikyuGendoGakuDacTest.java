...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7109KubunShikyuGendoGakuEntityGenerator.DEFAULT_処理日時;
...
public class DbT7109KubunShikyuGendoGakuDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 居宅サービス区分支給限度額エンティティを渡すと_updateは_居宅サービス区分支給限度額を更新する() {
            DbT7109KubunShikyuGendoGakuEntity updateRecord = DbT7109KubunShikyuGendoGakuEntityGenerator.createDbT7109KubunShikyuGendoGakuEntity();
