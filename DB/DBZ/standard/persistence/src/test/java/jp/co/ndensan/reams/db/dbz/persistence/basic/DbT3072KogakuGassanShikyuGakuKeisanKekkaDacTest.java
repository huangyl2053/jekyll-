...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3072KogakuGassanShikyuGakuKeisanKekkaEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3072KogakuGassanShikyuGakuKeisanKekkaEntityGenerator.DEFAULT_対象年度;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3072KogakuGassanShikyuGakuKeisanKekkaEntityGenerator.DEFAULT_支給申請書整理番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3072KogakuGassanShikyuGakuKeisanKekkaEntityGenerator.DEFAULT_被保険者番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3072KogakuGassanShikyuGakuKeisanKekkaEntityGenerator.DEFAULT_証記載保険者番号;
...
public class DbT3072KogakuGassanShikyuGakuKeisanKekkaDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 高額合算支給額計算結果エンティティを渡すと_updateは_高額合算支給額計算結果を更新する() {
            DbT3072KogakuGassanShikyuGakuKeisanKekkaEntity updateRecord = DbT3072KogakuGassanShikyuGakuKeisanKekkaEntityGenerator.createDbT3072KogakuGassanShikyuGakuKeisanKekkaEntity();
