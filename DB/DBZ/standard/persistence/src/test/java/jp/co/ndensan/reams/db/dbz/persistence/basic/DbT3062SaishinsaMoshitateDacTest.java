...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3062SaishinsaMoshitateEntityGenerator.DEFAULT_サービス提供年月;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3062SaishinsaMoshitateEntityGenerator.DEFAULT_サービス種類コード;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3062SaishinsaMoshitateEntityGenerator.DEFAULT_サービス項目コード;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3062SaishinsaMoshitateEntityGenerator.DEFAULT_事業所番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3062SaishinsaMoshitateEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3062SaishinsaMoshitateEntityGenerator.DEFAULT_被保険者番号;
...
public class DbT3062SaishinsaMoshitateDacTest extends DbzTestDacBase {

    private static final RString キー_01 = new RString("01");
    private static final RString キー_02 = new RString("02");
    private static final RString キー_03 = new RString("03");
    private static DbT3062SaishinsaMoshitateDac sut;
    private static final JigyoshaNo 事業所番号_1 = new JigyoshaNo(new RString("3"));
    private static final JigyoshaNo 事業所番号_2 = new JigyoshaNo(new RString("4"));
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 再審査申立エンティティを渡すと_updateは_再審査申立を更新する() {
            DbT3062SaishinsaMoshitateEntity updateRecord = DbT3062SaishinsaMoshitateEntityGenerator.createDbT3062SaishinsaMoshitateEntity();
