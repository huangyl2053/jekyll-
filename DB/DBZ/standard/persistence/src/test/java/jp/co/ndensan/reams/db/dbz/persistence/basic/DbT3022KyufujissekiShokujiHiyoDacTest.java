...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_サービス提供年月;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_レコード種別コード;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_事業所番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_交換情報識別番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_入力識別番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_被保険者番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_証記載保険者番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_通し番号;
...
public class DbT3022KyufujissekiShokujiHiyoDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 給付実績食事費用エンティティを渡すと_updateは_給付実績食事費用を更新する() {
            DbT3022KyufujissekiShokujiHiyoEntity updateRecord = DbT3022KyufujissekiShokujiHiyoEntityGenerator.createDbT3022KyufujissekiShokujiHiyoEntity();
