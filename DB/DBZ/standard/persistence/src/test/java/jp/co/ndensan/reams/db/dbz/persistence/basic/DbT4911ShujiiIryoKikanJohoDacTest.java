...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT4911ShujiiIryoKikanJohoEntityGenerator.*;
...
public class DbT4911ShujiiIryoKikanJohoDacTest extends DbdTestDacBase {
    ...
    public static class selectByKeyのテスト extends DbdTestDacBase {
        ...
        public void 存在する主キーを渡すと_selectByKeyは_該当のエンティティを返す() {
            Optional<DbT4911ShujiiIryoKikanJohoEntity> insertedRecord = sut.selectByKey(
                    DEFAULT_市町村コード,
                    DEFAULT_主治医医療機関コード);
        ...
        @Test
        public void 存在しない主キーを渡すと_selectByKeyは_Optionalのemptyを返す() {
            Optional<DbT4911ShujiiIryoKikanJohoEntity> empty = Optional.empty();
            Optional<DbT4911ShujiiIryoKikanJohoEntity> insertedRecord = sut.selectByKey(
                    notDEFAULT_市町村コード,
                    DEFAULT_主治医医療機関コード);
    ...
    public static class selectAllのテスト extends DbdTestDacBase {
        ...
        public void 主治医医療機関情報が存在しない場合_selectAllは_空のリストを返す() {
            ItemList<DbT4911ShujiiIryoKikanJohoEntity> empty = ItemList.empty();
    ...
    public static class updateのテスト extends DbdTestDacBase {
        ...
        public void 主治医医療機関情報エンティティを渡すと_updateは_主治医医療機関情報を更新する() {
            DbT4911ShujiiIryoKikanJohoEntity updateRecord = DbT4911ShujiiIryoKikanJohoEntityGenerator.createDbT4911ShujiiIryoKikanJohoEntity();
            updateRecord.setIryoKikanMeisho(new RString("あいうえお"));

            sut.update(updateRecord);

            Optional<DbT4911ShujiiIryoKikanJohoEntity> updatedRecord = sut.selectByKey(
                    DEFAULT_市町村コード,
                    DEFAULT_主治医医療機関コード);
