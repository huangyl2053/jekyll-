...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7050KaigoHokenshaEntityGenerator.DEFAULT_市町村コード;
...
public class DbT7050KaigoHokenshaDacTest extends DbzTestDacBase {
    ...
    private static final LasdecCode 市町村コード3 = new LasdecCode(new RString("323456"));
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 介護保険者エンティティを渡すと_updateは_介護保険者を更新する() {
            DbT7050KaigoHokenshaEntity updateRecord = DbT7050KaigoHokenshaEntityGenerator.createDbT7050KaigoHokenshaEntity();
