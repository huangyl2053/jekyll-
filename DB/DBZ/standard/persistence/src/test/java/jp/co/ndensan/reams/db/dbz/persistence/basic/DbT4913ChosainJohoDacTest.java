...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT4913ChosainJohoEntityGenerator.*;
...
public class DbT4913ChosainJohoDacTest extends DbdTestDacBase {
    ...
    public static class selectByKeyのテスト extends DbdTestDacBase {
        ...
        public void 存在する主キーを渡すと_selectByKeyは_該当のエンティティを返す() {
            Optional<DbT4913ChosainJohoEntity> insertedRecord = sut.selectByKey(
                    DEFAULT_市町村コード,
                    DEFAULT_認定調査委託先コード,
                    DEFAULT_認定調査員コード);
    ...
    public static class updateのテスト extends DbdTestDacBase {
        ...
        public void 調査員情報エンティティを渡すと_updateは_調査員情報を更新する() {
            ...
            Optional<DbT4913ChosainJohoEntity> updatedRecord = sut.selectByKey(
                    OTHER_市町村コード,
                    OTHER_認定調査委託先コード,
                    OTHER_認定調査員コード);
    ...
    public static class deleteのテスト extends DbdTestDacBase {
        ...
        public void 調査員情報エンティティを渡すと_deleteは_調査員情報を削除する() {
            Optional<DbT4913ChosainJohoEntity> deleteRecord = sut.selectByKey(
                    DEFAULT_市町村コード,
                    DEFAULT_認定調査委託先コード,
                    DEFAULT_認定調査員コード);
