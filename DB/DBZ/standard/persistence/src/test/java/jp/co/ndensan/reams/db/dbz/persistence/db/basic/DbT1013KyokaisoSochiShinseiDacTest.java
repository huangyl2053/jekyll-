...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT1013KyokaisoSochiShinseiEntityGenerator.DEFAULT_履歴番号;
...
public class DbT1013KyokaisoSochiShinseiDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 境界層措置申請エンティティを渡すと_updateは_境界層措置申請を更新する() {
            DbT1013KyokaisoSochiShinseiEntity updateRecord = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_履歴番号);
            updateRecord.setShinseiYMD(new FlexibleDate("19990101"));
    ...
    public static class deleteのテスト extends DbzTestDacBase {
        ...
        public void 境界層措置申請エンティティを渡すと_deleteは_境界層措置申請を削除する() {
            DbT1013KyokaisoSochiShinseiEntity deletedEntity = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_履歴番号);
