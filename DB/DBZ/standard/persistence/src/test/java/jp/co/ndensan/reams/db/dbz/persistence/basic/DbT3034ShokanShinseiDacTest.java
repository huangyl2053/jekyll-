...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3034ShokanShinseiEntityGenerator.DEFAULT_サービス提供年月;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3034ShokanShinseiEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3034ShokanShinseiEntityGenerator.DEFAULT_整理番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3034ShokanShinseiEntityGenerator.DEFAULT_被保険者番号;
...
public class DbT3034ShokanShinseiDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 償還払支給申請エンティティを渡すと_updateは_償還払支給申請を更新する() {
            DbT3034ShokanShinseiEntity updateRecord = DbT3034ShokanShinseiEntityGenerator.createDbT3034ShokanShinseiEntity();
