...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3057KogakuShikyuHanteiKekkaEntityGenerator.DEFAULT_サービス提供年月;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3057KogakuShikyuHanteiKekkaEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3057KogakuShikyuHanteiKekkaEntityGenerator.DEFAULT_被保険者番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3057KogakuShikyuHanteiKekkaEntityGenerator.DEFAULT_証記載保険者番号;
...
public class DbT3057KogakuShikyuHanteiKekkaDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 高額介護サービス費支給判定結果エンティティを渡すと_updateは_高額介護サービス費支給判定結果を更新する() {
            DbT3057KogakuShikyuHanteiKekkaEntity updateRecord = DbT3057KogakuShikyuHanteiKekkaEntityGenerator.createDbT3057KogakuShikyuHanteiKekkaEntity();
