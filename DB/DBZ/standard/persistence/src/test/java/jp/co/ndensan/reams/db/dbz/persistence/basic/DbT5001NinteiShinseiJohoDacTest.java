...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT5001NinteiShinseiJohoEntityGenerator.*;
...
/**
 * {@link DbT5001NinteiShinseiJohoDac}のテストです。
 *
 * @author n8187 久保田 英男
 */
@RunWith(Enclosed.class)
public class DbT5001NinteiShinseiJohoDacTest extends DbzTestDacBase {

    private static DbT5001NinteiShinseiJohoDac sut;

    @BeforeClass
    public static void setUpClass() {
        sut = InstanceProvider.create(DbT5001NinteiShinseiJohoDac.class);
    }
    ...
    public static class selectByKeyのテスト extends DbzTestDacBase {
        ...
        public void 存在する主キーを渡すと_selectByKeyは_該当のエンティティを返す() {
            DbT5001NinteiShinseiJohoEntity insertedRecord = sut.selectByKey(
                    DEFAULT_申請書管理番号,
                    DEFAULT_処理日時);
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 要介護認定申請情報エンティティを渡すと_updateは_要介護認定申請情報を更新する() {
            DbT5001NinteiShinseiJohoEntity updateRecord = DbT5001NinteiShinseiJohoEntityGenerator.createDbT5001NinteiShinseiJohoEntity();
            updateRecord.setZenYukoKikan(75);

            sut.update(updateRecord);

            DbT5001NinteiShinseiJohoEntity updatedRecord = sut.selectByKey(
                    DEFAULT_申請書管理番号,
                    DEFAULT_処理日時);

            assertThat(updateRecord.getZenYukoKikan(), is(updatedRecord.getZenYukoKikan()));
        }
    }
