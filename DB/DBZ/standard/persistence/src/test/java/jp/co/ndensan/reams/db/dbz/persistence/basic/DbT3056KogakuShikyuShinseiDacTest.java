...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3056KogakuShikyuShinseiEntityGenerator.DEFAULT_サービス提供年月;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3056KogakuShikyuShinseiEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3056KogakuShikyuShinseiEntityGenerator.DEFAULT_被保険者番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3056KogakuShikyuShinseiEntityGenerator.DEFAULT_証記載保険者番号;
...
public class DbT3056KogakuShikyuShinseiDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 高額介護サービス費支給申請エンティティを渡すと_updateは_高額介護サービス費支給申請を更新する() {
            DbT3056KogakuShikyuShinseiEntity updateRecord = DbT3056KogakuShikyuShinseiEntityGenerator.createDbT3056KogakuShikyuShinseiEntity();
