...
/**
 * {@link DbT4102NinteiKekkaJohoDac}のテストです。
 */
@Ignore
@RunWith(Enclosed.class)
public class DbT4102NinteiKekkaJohoDacTest extends DbzTestDacBase {

    private static final RString キー_01 = new RString("01");
    private static final RString キー_02 = new RString("02");
    private static final RString キー_03 = new RString("03");
    private static DbT4102NinteiKekkaJohoDac sut;

    @BeforeClass
    public static void setUpClass() {
        sut = InstanceProvider.create(DbT4102NinteiKekkaJohoDac.class);
    }
    ...
    public static class selectByKeyのテスト extends DbzTestDacBase {
        ...
        public void 存在する主キーを渡すと_selectByKeyは_該当のエンティティを返す() {
            DbT4102NinteiKekkaJohoEntity insertedRecord = sut.selectByKey(
                    DEFAULT_申請書管理番号);
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 要介護認定結果情報エンティティを渡すと_updateは_要介護認定結果情報を更新する() {
            DbT4102NinteiKekkaJohoEntity updateRecord = sut.selectByKey(
                    DEFAULT_申請書管理番号);
...
//            updateRecord.set変更したい項目(75);
            ...
            DbT4102NinteiKekkaJohoEntity updatedRecord = sut.selectByKey(
                    DEFAULT_申請書管理番号);
...
//            assertThat(updateRecord.get変更したい項目(), is(updatedRecord.get変更したい項目()));
    ...
    public static class deleteのテスト extends DbzTestDacBase {
        ...
        public void 要介護認定結果情報エンティティを渡すと_deleteは_要介護認定結果情報を削除する() {
            DbT4102NinteiKekkaJohoEntity deletedEntity = sut.selectByKey(
                    DEFAULT_申請書管理番号);
