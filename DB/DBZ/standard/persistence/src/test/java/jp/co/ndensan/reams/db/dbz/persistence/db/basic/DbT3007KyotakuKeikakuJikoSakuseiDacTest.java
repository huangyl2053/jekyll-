...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3007KyotakuKeikakuJikoSakuseiEntityGenerator.*;
...
public class DbT3007KyotakuKeikakuJikoSakuseiDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 居宅給付計画自己作成エンティティを渡すと_updateは_居宅給付計画自己作成を更新する() {
            DbT3007KyotakuKeikakuJikoSakuseiEntity updateRecord = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_対象年月,
                    DEFAULT_履歴番号);
            updateRecord.setKeikakuHenkoJiyu(new RString("test"));
            ...
            assertThat(updateRecord.getKeikakuHenkoJiyu(), is(updatedRecord.getKeikakuHenkoJiyu()));
        }
    }
    ...
    public static class deleteのテスト extends DbzTestDacBase {
        ...
        public void 居宅給付計画自己作成エンティティを渡すと_deleteは_居宅給付計画自己作成を削除する() {
            DbT3007KyotakuKeikakuJikoSakuseiEntity deletedEntity = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_対象年月,
                    DEFAULT_履歴番号);
