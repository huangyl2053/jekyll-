...
public class NinteiShinseiJohoDacTest {
    ...
    private static DbT4101NinteiShinseiJohoDac 要介護認定申請情報Dac;
    private static final ShinseishoKanriNo 申請書管理番号1 = DbT4101NinteiShinseiJohoEntityGenerator.DEFAULT_申請書管理番号;
    private static final ShinseishoKanriNo 申請書管理番号2 = new ShinseishoKanriNo(new RString("9234567890"));
//    private static final YMDHMS 処理日時1 = DbT4101NinteiShinseiJohoEntityGenerator.DEFAULT_処理日時;
...
//            NinteiShinseiJohoModel model = new NinteiShinseiJohoModel(DbT4101NinteiShinseiJohoEntityGenerator.createDbT5001NinteiShinseiJohoEntity());
...
//            assertThat(sut.deletePhysical(model), is(1));
    ...
    private static class TestSupport {
        ...
        public static void insertDbT5001(
                ...
                YMDHMS 処理日時) {
//            DbT5001NinteiShinseiJohoEntity entity = DbT4101NinteiShinseiJohoEntityGenerator.createDbT5001NinteiShinseiJohoEntity();
