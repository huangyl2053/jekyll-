...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_受付年月日;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_被保険者番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_識別コード;
...
public class DbT3103NijiYoboCheckListHanteiKekkaDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 二次予防チェックリスト判定結果エンティティを渡すと_updateは_二次予防チェックリスト判定結果を更新する() {
            DbT3103NijiYoboCheckListHanteiKekkaEntity updateRecord = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.createDbT3103NijiYoboCheckListHanteiKekkaEntity();
