...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3047ShokanServicePlan200904EntityGenerator.DEFAULT_サービス提供年月;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3047ShokanServicePlan200904EntityGenerator.DEFAULT_事業者番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3047ShokanServicePlan200904EntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3047ShokanServicePlan200904EntityGenerator.DEFAULT_居宅サービス計画作成依頼届出年月日;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3047ShokanServicePlan200904EntityGenerator.DEFAULT_指定基準該当事業者区分コード;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3047ShokanServicePlan200904EntityGenerator.DEFAULT_整理番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3047ShokanServicePlan200904EntityGenerator.DEFAULT_明細行番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3047ShokanServicePlan200904EntityGenerator.DEFAULT_様式番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3047ShokanServicePlan200904EntityGenerator.DEFAULT_被保険者番号;
...
public class DbT3047ShokanServicePlan200904DacTest extends DbzTestDacBase {
    ...
    public static class selectByKeyのテスト extends DbzTestDacBase {
        ...
        @Test(expected = NullPointerException.class)
        public void 指定基準該当事業者区分コードがnullの場合_selectByKeyは_NullPointerExceptionを発生させる() {
            sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_サービス提供年月,
                    DEFAULT_整理番号,
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 償還払請求サービス計画200904エンティティを渡すと_updateは_償還払請求サービス計画200904を更新する() {
            DbT3047ShokanServicePlan200904Entity updateRecord = DbT3047ShokanServicePlan200904EntityGenerator.createDbT3047ShokanServicePlan200904Entity();
