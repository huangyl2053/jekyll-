...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT5305IkenshoImageJohoEntityGenerator.DEFAULT_マスキングデータ区分;
...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT5305IkenshoImageJohoEntityGenerator.DEFAULT_取込みページ番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT5305IkenshoImageJohoEntityGenerator.DEFAULT_帳票ID;
...
/**
 * {@link DbT5305IkenshoImageJohoDac}のテストです。
 */
@Ignore
@RunWith(Enclosed.class)
public class DbT5305IkenshoImageJohoDacTest extends DbzTestDacBase {

    private static final RString キー_01 = new RString("01");
    private static final RString キー_02 = new RString("02");
    private static final RString キー_03 = new RString("03");
    private static DbT5305IkenshoImageJohoDac sut;

    @BeforeClass
    public static void setUpClass() {
        sut = InstanceProvider.create(DbT5305IkenshoImageJohoDac.class);
    }
    ...
    public static class selectByKeyのテスト extends DbzTestDacBase {
        ...
        public void 存在する主キーを渡すと_selectByKeyは_該当のエンティティを返す() {
            DbT5305IkenshoImageJohoEntity insertedRecord = sut.selectByKey(
                    DEFAULT_申請書管理番号,
                    DEFAULT_主治医意見書作成依頼履歴番号,
                    DEFAULT_帳票ID,
                    DEFAULT_マスキングデータ区分,
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 要介護認定意見書イメージ情報エンティティを渡すと_updateは_要介護認定意見書イメージ情報を更新する() {
            DbT5305IkenshoImageJohoEntity updateRecord = sut.selectByKey(
                    DEFAULT_申請書管理番号,
                    DEFAULT_主治医意見書作成依頼履歴番号,
                    DEFAULT_帳票ID,
                    DEFAULT_マスキングデータ区分,
            ...
            DbT5305IkenshoImageJohoEntity updatedRecord = sut.selectByKey(
                    DEFAULT_申請書管理番号,
                    DEFAULT_主治医意見書作成依頼履歴番号,
                    DEFAULT_帳票ID,
                    DEFAULT_マスキングデータ区分,
    ...
    public static class deleteのテスト extends DbzTestDacBase {
        ...
        public void 要介護認定意見書イメージ情報エンティティを渡すと_deleteは_要介護認定意見書イメージ情報を削除する() {
            DbT5305IkenshoImageJohoEntity deletedEntity = sut.selectByKey(
                    DEFAULT_申請書管理番号,
                    DEFAULT_主治医意見書作成依頼履歴番号,
                    DEFAULT_帳票ID,
                    DEFAULT_マスキングデータ区分,
