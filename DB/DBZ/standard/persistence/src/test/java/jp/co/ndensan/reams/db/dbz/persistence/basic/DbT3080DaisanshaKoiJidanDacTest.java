...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3080DaisanshaKoiJidanEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3080DaisanshaKoiJidanEntityGenerator.DEFAULT_示談報告書受付年月日;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3080DaisanshaKoiJidanEntityGenerator.DEFAULT_第三者行為届出管理番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3080DaisanshaKoiJidanEntityGenerator.DEFAULT_被保険者番号;
...
public class DbT3080DaisanshaKoiJidanDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 介護第三者行為示談エンティティを渡すと_updateは_介護第三者行為示談を更新する() {
            DbT3080DaisanshaKoiJidanEntity updateRecord = DbT3080DaisanshaKoiJidanEntityGenerator.createDbT3080DaisanshaKoiJidanEntity();
