...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT4116IchijiHanteiKekkaJohoEntityGenerator.DEFAULT_申請書管理番号;
...
/**
 * {@link DbT4116IchijiHanteiKekkaJohoDac}のテストです。
 */
@Ignore
@RunWith(Enclosed.class)
public class DbT4116IchijiHanteiKekkaJohoDacTest extends DbzTestDacBase {

    private static final RString キー_01 = new RString("01");
    private static final RString キー_02 = new RString("02");
    private static final RString キー_03 = new RString("03");
    private static DbT4116IchijiHanteiKekkaJohoDac sut;

    @BeforeClass
    public static void setUpClass() {
        sut = InstanceProvider.create(DbT4116IchijiHanteiKekkaJohoDac.class);
    }
    ...
    public static class selectByKeyのテスト extends DbzTestDacBase {
        ...
        public void 存在する主キーを渡すと_selectByKeyは_該当のエンティティを返す() {
            DbT4116IchijiHanteiKekkaJohoEntity insertedRecord = sut.selectByKey(
                    DEFAULT_申請書管理番号);
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 要介護認定一次判定結果情報エンティティを渡すと_updateは_要介護認定一次判定結果情報を更新する() {
            DbT4116IchijiHanteiKekkaJohoEntity updateRecord = sut.selectByKey(
                    DEFAULT_申請書管理番号);
            ...
            DbT4116IchijiHanteiKekkaJohoEntity updatedRecord = sut.selectByKey(
                    DEFAULT_申請書管理番号);
    ...
    public static class deleteのテスト extends DbzTestDacBase {
        ...
        public void 要介護認定一次判定結果情報エンティティを渡すと_deleteは_要介護認定一次判定結果情報を削除する() {
            DbT4116IchijiHanteiKekkaJohoEntity deletedEntity = sut.selectByKey(
                    DEFAULT_申請書管理番号);
