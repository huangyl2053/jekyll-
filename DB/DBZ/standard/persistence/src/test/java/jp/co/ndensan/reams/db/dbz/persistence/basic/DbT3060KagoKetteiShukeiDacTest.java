...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3060KagoKetteiShukeiEntityGenerator.DEFAULT_保険者区分;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3060KagoKetteiShukeiEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3060KagoKetteiShukeiEntityGenerator.DEFAULT_取扱年月;
...
public class DbT3060KagoKetteiShukeiDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 過誤決定集計エンティティを渡すと_updateは_過誤決定集計を更新する() {
            DbT3060KagoKetteiShukeiEntity updateRecord = DbT3060KagoKetteiShukeiEntityGenerator.createDbT3060KagoKetteiShukeiEntity();
