...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7119ServiceCodeEntityGenerator.DEFAULT_サービス種類コード;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7119ServiceCodeEntityGenerator.DEFAULT_サービス項目コード;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7119ServiceCodeEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7119ServiceCodeEntityGenerator.DEFAULT_適用開始年月;
...
public class DbT7119ServiceCodeDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void サービスコードエンティティを渡すと_updateは_サービスコードを更新する() {
            DbT7119ServiceCodeEntity updateRecord = DbT7119ServiceCodeEntityGenerator.createDbT7119ServiceCodeEntity();
