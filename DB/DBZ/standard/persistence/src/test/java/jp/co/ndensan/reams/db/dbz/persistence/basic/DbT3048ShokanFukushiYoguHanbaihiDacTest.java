...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3048ShokanFukushiYoguHanbaihiEntityGenerator.DEFAULT_サービス提供年月;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3048ShokanFukushiYoguHanbaihiEntityGenerator.DEFAULT_事業者番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3048ShokanFukushiYoguHanbaihiEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3048ShokanFukushiYoguHanbaihiEntityGenerator.DEFAULT_整理番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3048ShokanFukushiYoguHanbaihiEntityGenerator.DEFAULT_様式番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3048ShokanFukushiYoguHanbaihiEntityGenerator.DEFAULT_被保険者番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3048ShokanFukushiYoguHanbaihiEntityGenerator.DEFAULT_順次番号;
...
public class DbT3048ShokanFukushiYoguHanbaihiDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 償還払請求福祉用具販売費エンティティを渡すと_updateは_償還払請求福祉用具販売費を更新する() {
            DbT3048ShokanFukushiYoguHanbaihiEntity updateRecord = DbT3048ShokanFukushiYoguHanbaihiEntityGenerator.createDbT3048ShokanFukushiYoguHanbaihiEntity();
