...
public class KoikiShichosonSecurityDacTest extends DbzTestDacBase {
    ...
    private static final ITrueFalseCriteria 検索条件_該当2件 = Restrictions.eq(new RString("000001"), DbT7057KoikiShichosonSecurity.shichosonCode);
    ...
    private static void initializeEntityData(int count) {
        for (int i = 1; i <= count; i++) {
            sut.insert(new KoikiShichosonSecurityModel(createEntity(i)));
        }
    }
