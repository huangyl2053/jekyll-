...
// TODO 検索条件に合わせてのテストケースを追記して下さい。
    public static class select不服審査申立情報ByKeyTest extends DbzTestDacBase {
        ...
        public void setUp() {
            ...
            TestSupport.insertDbT7001(主キー21);
            TestSupport.insertDbT7001(主キー22);
...
//        }
        ...
        public void データが見つかない検索条件を渡すと_nullを返す() {
            FufukuMoshitateMapperParameter 不服審査申立情報検索条件 = FufukuMoshitateMapperParameter.createSelectByKeyParam(主キー21);
...
//        }
        ...
        public void データが見つかない検索条件を渡すと__空のリストを返す() {
            FufukuMoshitateMapperParameter 不服審査申立情報検索条件 = FufukuMoshitateMapperParameter.createSelectListParam(new ShikibetsuCode("012345"));
