...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7118SogoJigyoShuruiShikyuGendoGakuEntityGenerator.DEFAULT_サービス種類コード;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7118SogoJigyoShuruiShikyuGendoGakuEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7118SogoJigyoShuruiShikyuGendoGakuEntityGenerator.DEFAULT_要介護状態区分;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7118SogoJigyoShuruiShikyuGendoGakuEntityGenerator.DEFAULT_適用開始年月;
...
public class DbT7118SogoJigyoShuruiShikyuGendoGakuDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 介護予防_日常生活支援総合事業種類支給限度額エンティティを渡すと_updateは_介護予防_日常生活支援総合事業種類支給限度額を更新する() {
            DbT7118SogoJigyoShuruiShikyuGendoGakuEntity updateRecord = DbT7118SogoJigyoShuruiShikyuGendoGakuEntityGenerator.createDbT7118SogoJigyoShuruiShikyuGendoGakuEntity();
