...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7114UwanoseServiceShuruiShikyuGendoGakuEntityGenerator.DEFAULT_サービス種類コード;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7114UwanoseServiceShuruiShikyuGendoGakuEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7114UwanoseServiceShuruiShikyuGendoGakuEntityGenerator.DEFAULT_要介護状態区分;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7114UwanoseServiceShuruiShikyuGendoGakuEntityGenerator.DEFAULT_適用開始年月;
...
public class DbT7114UwanoseServiceShuruiShikyuGendoGakuDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 上乗せサービス種類支給限度額エンティティを渡すと_updateは_上乗せサービス種類支給限度額を更新する() {
            DbT7114UwanoseServiceShuruiShikyuGendoGakuEntity updateRecord = DbT7114UwanoseServiceShuruiShikyuGendoGakuEntityGenerator.createDbT7114UwanoseServiceShuruiShikyuGendoGakuEntity();
