...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7120TokuteiShinryoServiceCodeEntityGenerator.DEFAULT_サービス種類コード;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7120TokuteiShinryoServiceCodeEntityGenerator.DEFAULT_サービス項目コード;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7120TokuteiShinryoServiceCodeEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT7120TokuteiShinryoServiceCodeEntityGenerator.DEFAULT_適用開始年月;
...
public class DbT7120TokuteiShinryoServiceCodeDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 特定診療サービスコードエンティティを渡すと_updateは_特定診療サービスコードを更新する() {
            DbT7120TokuteiShinryoServiceCodeEntity updateRecord = DbT7120TokuteiShinryoServiceCodeEntityGenerator.createDbT7120TokuteiShinryoServiceCodeEntity();
