...
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3036ShokanHanteiKekkaEntityGenerator.DEFAULT_サービス提供年月;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3036ShokanHanteiKekkaEntityGenerator.DEFAULT_処理日時;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3036ShokanHanteiKekkaEntityGenerator.DEFAULT_整理番号;
import static jp.co.ndensan.reams.db.dbz.entity.basic.helper.DbT3036ShokanHanteiKekkaEntityGenerator.DEFAULT_被保険者番号;
...
public class DbT3036ShokanHanteiKekkaDacTest extends DbzTestDacBase {
    ...
    public static class updateのテスト extends DbzTestDacBase {
        ...
        public void 償還払支給判定結果エンティティを渡すと_updateは_償還払支給判定結果を更新する() {
            DbT3036ShokanHanteiKekkaEntity updateRecord = DbT3036ShokanHanteiKekkaEntityGenerator.createDbT3036ShokanHanteiKekkaEntity();
