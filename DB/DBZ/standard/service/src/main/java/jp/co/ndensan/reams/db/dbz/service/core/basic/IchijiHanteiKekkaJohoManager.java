...
public class IchijiHanteiKekkaJohoManager {
    ...
    private final DbT4116IchijiHanteiKekkaJohoDac dac;

    /**
     * コンストラクタです。
     */
    public IchijiHanteiKekkaJohoManager() {
        dac = InstanceProvider.create(DbT4116IchijiHanteiKekkaJohoDac.class);
    }

    /**
     * テスト用コンストラクタです。
     *
     * @param dac {@link DbT4116IchijiHanteiKekkaJohoDac}
     */
    IchijiHanteiKekkaJohoManager(DbT4116IchijiHanteiKekkaJohoDac dac) {
        this.dac = dac;
    }
    ...
    public IchijiHanteiKekkaJoho get要介護認定一次判定結果情報(
        ...
        DbT4116IchijiHanteiKekkaJohoEntity entity = dac.selectByKey(
                申請書管理番号);
        if (entity == null) {
            return null;
        }
    ...
    public List<IchijiHanteiKekkaJoho> get要介護認定一次判定結果情報一覧() {
        ...
        for (DbT4116IchijiHanteiKekkaJohoEntity entity : dac.selectAll()) {
            entity.initializeMd5();
