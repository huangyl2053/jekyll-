 ...
 */
package jp.co.ndensan.reams.db.dbz.service.core.shokaishukanri;

import java.util.List;
import jp.co.ndensan.reams.db.dbx.definition.core.valueobject.domain.HihokenshaNo;
import jp.co.ndensan.reams.db.dbz.entity.db.basic.DbT7037ShoKofuKaishuEntity;
import jp.co.ndensan.reams.db.dbz.service.core.shokaishukanri.param.SyokofukaisyuzyohouParameter;
...
public class ShoKaishuKanri {
    ...
    public void updShoKofuKaishu(HihokenshaNo 被保険者番号, List<SyokofukaisyuzyohouParameter> syokofukaisyuzyohouEntitys) {
        for (SyokofukaisyuzyohouParameter syokofukaisyuzyohouEntity : syokofukaisyuzyohouEntitys) {
            ...
            } else if (削除.equals(syokofukaisyuzyohouEntity.get更新_削除区分())) {
