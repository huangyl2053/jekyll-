 ...
 */
package jp.co.ndensan.reams.db.dbz.service.core.kaigoninteishikakuinfo;
...
public class KaigoNinteiShikakuInfoFinder {
    ...
    public KaigoNinteiShikakuInfoBusiness getKaigoNinteiShikakuInfo(HihokenshaNo hihokenshaNo, LasdecCode shichosonCode) {
        ...
        return new KaigoNinteiShikakuInfoBusiness(dbT4001JukyushaDaichoEntity, dbT1001HihokenshaDaichoEntity);
    }
}
