...
import jp.co.ndensan.reams.db.dbz.persistence.db.mapper.basic.NinteiChosaIkkatsuInputMapper;
...
public class NinteiChosaIkkatsuInputManager {
    ...
    private final NinteiChosaIkkatsuInputMapper mapper;

    /**
     * コンストラクタです。
     */
    public NinteiChosaIkkatsuInputManager() {
        mapper = InstanceProvider.create(NinteiChosaIkkatsuInputMapper.class);
    }
     ...
     */
    NinteiChosaIkkatsuInputManager(NinteiChosaIkkatsuInputMapper mapper) {
        this.mapper = mapper;
    }
