...
import jp.co.ndensan.reams.db.dbz.persistence.basic.DbT4116IchijiHanteiKekkaJohoDac;
...
public class IchijiHanteiKekkaJohoManagerTest {
    ...
    public static class get要介護認定一次判定結果情報 extends DbeTestBase {
        ...
        public void 引数の主キー型1にnullを指定した場合_NullPointerExceptionが発生する() {
            主キー型2 主キー2 = DbT4116IchijiHanteiKekkaJohoEntityGenerator.DEFAULT_主キー2;
            sut.get要介護認定一次判定結果情報(null, 主キー2);
        }

        @Test(expected = NullPointerException.class)
        public void 引数の主キー型2にnullを指定した場合_NullPointerExceptionが発生する() {
            主キー型1 主キー1 = DbT4116IchijiHanteiKekkaJohoEntityGenerator.DEFAULT_主キー1;
            sut.get要介護認定一次判定結果情報(主キー1, null);
        }
        ...
        public void 検索結果がnullの場合() {
            ...
            主キー型1 主キー1 = DbT4116IchijiHanteiKekkaJohoEntityGenerator.DEFAULT_主キー1;
            主キー型2 主キー2 = DbT4116IchijiHanteiKekkaJohoEntityGenerator.DEFAULT_主キー2;
            IchijiHanteiKekkaJoho result = sut.get要介護認定一次判定結果情報(主キー1, 主キー2);
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get主キー1().value(), is(DbT4116IchijiHanteiKekkaJohoEntityGenerator.DEFAULT_主キー1.value()));
        }
    }

    // TODO 主キー型、主キー値については使用するエンティティに合わせて適切に置換してください。
    public static class get要介護認定一次判定結果情報一覧 extends FdaTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get(0).get主キー1().value(), is(DbT4116IchijiHanteiKekkaJohoEntityGenerator.DEFAULT_主キー1.value()));
        }
    }

    public static class save要介護認定一次判定結果情報 extends XxxTestBase {
        ...
        public void updateに成功するとtrueが返る() {
            ...
            IchijiHanteiKekkaJoho 要介護認定一次判定結果情報 = new IchijiHanteiKekkaJoho(entity);
            要介護認定一次判定結果情報 = 要介護認定一次判定結果情報.createBuilderForEdit().set任意項目1(new RString("任意項目1を変更")).build();
