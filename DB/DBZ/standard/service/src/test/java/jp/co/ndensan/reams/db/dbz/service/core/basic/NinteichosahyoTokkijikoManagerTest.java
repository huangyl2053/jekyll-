...
import jp.co.ndensan.reams.db.dbz.persistence.basic.DbT5205NinteichosahyoTokkijikoDac;
...
public class NinteichosahyoTokkijikoManagerTest {
    ...
    public static class get認定調査票_特記情報 extends DbzTestBase {
        ...
        public void 引数の主キー型1にnullを指定した場合_NullPointerExceptionが発生する() {
            主キー型2 主キー2 = DbT5205NinteichosahyoTokkijikoEntityGenerator.DEFAULT_主キー2;
            sut.get認定調査票_特記情報(null, 主キー2);
        }

        @Test(expected = NullPointerException.class)
        public void 引数の主キー型2にnullを指定した場合_NullPointerExceptionが発生する() {
            主キー型1 主キー1 = DbT5205NinteichosahyoTokkijikoEntityGenerator.DEFAULT_主キー1;
            sut.get認定調査票_特記情報(主キー1, null);
        }
        ...
        public void 検索結果がnullの場合() {
            ...
            主キー型1 主キー1 = DbT5205NinteichosahyoTokkijikoEntityGenerator.DEFAULT_主キー1;
            主キー型2 主キー2 = DbT5205NinteichosahyoTokkijikoEntityGenerator.DEFAULT_主キー2;
            NinteichosahyoTokkijiko result = sut.get認定調査票_特記情報(主キー1, 主キー2);
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get主キー1().value(), is(DbT5205NinteichosahyoTokkijikoEntityGenerator.DEFAULT_主キー1.value()));
        }
    }
    ...
    public static class get認定調査票_特記情報一覧 extends DbzTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get(0).get主キー1().value(), is(DbT5205NinteichosahyoTokkijikoEntityGenerator.DEFAULT_主キー1.value()));
        }
    }

    public static class save認定調査票_特記情報 extends XxxTestBase {
        ...
        public void updateに成功するとtrueが返る() {
            ...
            NinteichosahyoTokkijiko 認定調査票_特記情報 = new NinteichosahyoTokkijiko(entity);
            認定調査票_特記情報 = 認定調査票_特記情報.createBuilderForEdit().set任意項目1(new RString("任意項目1を変更")).build();
