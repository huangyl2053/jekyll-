...
public class ChikuShichosonManagerTest {
    ...
    public static class get地区市町村 extends DbzTestBase {
        ...
        public void 引数の主キー型1にnullを指定した場合_NullPointerExceptionが発生する() {
            LasdecCode 主キー2 = DbT5224ChikuShichosonEntityGenerator.DEFAULT_市町村コード;
            sut.get地区市町村(null, 主キー2);
        }

        @Test(expected = NullPointerException.class)
        public void 引数の主キー型2にnullを指定した場合_NullPointerExceptionが発生する() {
            Code 主キー1 = DbT5224ChikuShichosonEntityGenerator.DEFAULT_調査地区コード;
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get調査地区コード().value(), is(DbT5224ChikuShichosonEntityGenerator.DEFAULT_調査地区コード.value()));
        }
    }
    ...
    public static class get地区市町村一覧 extends DbzTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get(0).get調査地区コード().value(), is(DbT5224ChikuShichosonEntityGenerator.DEFAULT_調査地区コード.value()));
        }
    }
    ...
    public static class save地区市町村 extends DbzTestBase {
        ...
        public void updateに成功するとtrueが返る() {
            ...
            ChikuShichoson 地区市町村 = new ChikuShichoson(entity);
            地区市町村 = 地区市町村.createBuilderForEdit().set優先番号(3).build();
