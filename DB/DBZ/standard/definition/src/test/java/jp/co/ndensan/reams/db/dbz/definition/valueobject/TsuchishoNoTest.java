...
public class TsuchishoNoTest extends DbbTestBase {

    private static TsuchishoNo sut;
    private static TsuchishoNo other;
    ...
    public static class hashCode extends DbbTestBase {
        ...
        @Test
        public void 同じ値を持つ通知書番号のhashCodeは_同値になる() {
            sut = new TsuchishoNo(new RString("010"));
            other = new TsuchishoNo(new RString("010"));
    ...
    public static class equals extends DbbTestBase {
        ...
        @Test
        public void 異なる通知書番号と比較した場合_falseが返る() {
            other = new TsuchishoNo(new RString("011"));
            assertThat(sut.equals(other), is(false));
        }

        @Test
        public void 同じ通知書番号と比較した場合_trueが返る() {
            other = new TsuchishoNo(new RString("010"));
