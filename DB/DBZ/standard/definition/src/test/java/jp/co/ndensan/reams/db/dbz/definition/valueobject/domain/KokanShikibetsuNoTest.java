...
/**
 * KokanShikibetsuNoのテストです。
 *
 * @author N3327 三浦 凌
 */
@RunWith(Enclosed.class)
public class KokanShikibetsuNoTest extends DbzTestBase {

    public KokanShikibetsuNoTest() {
    }

    public static class valueAndGetColumnValue_createFromRString extends DbzTestBase {

        private KokanShikibetsuNo sut;
        private RString value;

        @Before
        public void setUp() {
            value = new RString("12");
            sut = new KokanShikibetsuNo(value);
        }
    ...
    public static class CompareTo extends DbzTestBase {
        ...
        public void compareToは_自身と値が同じものを比較したときは_0を返す() {
            KokanShikibetsuNo sut = new KokanShikibetsuNo("0");
            KokanShikibetsuNo other = new KokanShikibetsuNo("0");
        ...
        public void compareToは_自身より値が小さいものと比較したときは_0より大きい値を返す() {
            KokanShikibetsuNo sut = new KokanShikibetsuNo(new RString("1"));
            KokanShikibetsuNo other = new KokanShikibetsuNo(new RString("0"));
        ...
        public void compareToは_自身より値が大きいものと比較したときは_0より小さい値を返す() {
            KokanShikibetsuNo sut = new KokanShikibetsuNo("0");
            KokanShikibetsuNo other = new KokanShikibetsuNo("1");
    ...
    public static class Equals extends DbzTestBase {
        ...
        public void equalsは_比較対象がnullなら_falseを返す() {
            KokanShikibetsuNo sut = new KokanShikibetsuNo("0");
            assertThat(sut.equals((KokanShikibetsuNo) null), is(false));
        }

        @Test
        public void equalsは_比較対象がKokanShikibetsuNoのインスタンスでないなら_falseを返す() {
            RString target = new RString("0");
            KokanShikibetsuNo sut = new KokanShikibetsuNo(target);
        ...
        public void equalsは_同じ文字列を持ったRStringから生成されたインスタンス同士では_trueを返す() {
            KokanShikibetsuNo sut = new KokanShikibetsuNo(new RString("0"));
            KokanShikibetsuNo other = new KokanShikibetsuNo(new RString("0"));
            assertThat(sut.equals(other), is(true));
        }
        ...
        public void equalsは_異なる文字列から生成されたインスタンス同士では_falseを返す() {
            KokanShikibetsuNo sut = new KokanShikibetsuNo("1");
            KokanShikibetsuNo other = new KokanShikibetsuNo("0");
        ...
        public void equalsは_ある文字列と_それと異なる文字列を持ったRStringから生成されたインスタンス同士では_falseを返す() {
            KokanShikibetsuNo sut = new KokanShikibetsuNo("0");
            KokanShikibetsuNo other = new KokanShikibetsuNo(new RString("1"));
            assertThat(sut.equals(other), is(false));
        }
    }
    ...
    public static class HashCode extends DbzTestBase {
        ...
        public void hashCodeは_同じ文字列から生成されたインスタンスは_同じ値を返す() {
            KokanShikibetsuNo sut = new KokanShikibetsuNo("12");
            KokanShikibetsuNo other = new KokanShikibetsuNo("12");
            assertThat(sut.hashCode(), is(other.hashCode()));
        }

        @Test
        public void hashCodeは_同じ文字列を持ったRStringから生成されたインスタンスは_同じ値を返す() {
            KokanShikibetsuNo sut = new KokanShikibetsuNo(new RString("12"));
            KokanShikibetsuNo other = new KokanShikibetsuNo(new RString("12"));
            assertThat(sut.hashCode(), is(other.hashCode()));
        }
    ...
    public static class isEmpty extends DbzTestBase {
        ...
        public void EMPTYのisEmptyは_trueを返す() {
            KokanShikibetsuNo sut = KokanShikibetsuNo.EMPTY;
