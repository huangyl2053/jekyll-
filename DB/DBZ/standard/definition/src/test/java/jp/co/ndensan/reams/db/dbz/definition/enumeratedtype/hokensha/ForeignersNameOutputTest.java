...
/**
 * ForeignersNameOutputのテストです。
 *
 * @author N3327 三浦 凌
 */
@RunWith(Enclosed.class)
public class ForeignersNameOutputTest extends DbzTestBase {

    public ForeignersNameOutputTest() {
    }

    public static class toValue extends DbzTestBase {

        private ForeignersNameOutput sut;

        @Test
        public void toValue_は引数のcodeに該当するオブジェクトが存在する時_それを返す() {
            ForeignersNameOutput item = ForeignersNameOutput.正式名;
