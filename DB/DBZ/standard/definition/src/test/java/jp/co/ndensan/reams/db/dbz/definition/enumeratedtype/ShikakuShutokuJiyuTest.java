...
public class ShikakuShutokuJiyuTest extends DbzTestBase {
    ...
    public static class ToValue extends DbzTestBase {
        ...
        public void toValueは_nullを受け取った場合_EMPTYを返す() {
            assertThat(ShikakuShutokuJiyu.toValue(null), is(ShikakuShutokuJiyu.EMPTY));
        }

        @Test
        public void toValueは_空の文字列を受け取った場合_EMPTY() {
            assertThat(ShikakuShutokuJiyu.toValue(RString.EMPTY), is(ShikakuShutokuJiyu.EMPTY));
        }
