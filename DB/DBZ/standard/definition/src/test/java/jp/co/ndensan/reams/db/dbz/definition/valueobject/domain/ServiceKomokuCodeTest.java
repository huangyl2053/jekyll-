...
/**
 * ServiceKomokuCodeのテストです。
 *
 * @author N3327 三浦 凌
 */
@RunWith(Enclosed.class)
public class ServiceKomokuCodeTest extends DbzTestBase {

    public ServiceKomokuCodeTest() {
    }

    public static class valueAndGetColumnValue_createFromRString extends DbzTestBase {

        private ServiceKomokuCode sut;
        private RString value;

        @Before
        public void setUp() {
            value = new RString("12");
            sut = new ServiceKomokuCode(value);
        }
    ...
    public static class CompareTo extends DbzTestBase {
        ...
        public void compareToは_自身と値が同じものを比較したときは_0を返す() {
            ServiceKomokuCode sut = new ServiceKomokuCode("0");
            ServiceKomokuCode other = new ServiceKomokuCode("0");
        ...
        public void compareToは_自身より値が小さいものと比較したときは_0より大きい値を返す() {
            ServiceKomokuCode sut = new ServiceKomokuCode(new RString("1"));
            ServiceKomokuCode other = new ServiceKomokuCode(new RString("0"));
        ...
        public void compareToは_自身より値が大きいものと比較したときは_0より小さい値を返す() {
            ServiceKomokuCode sut = new ServiceKomokuCode("0");
            ServiceKomokuCode other = new ServiceKomokuCode("1");
    ...
    public static class Equals extends DbzTestBase {
        ...
        public void equalsは_比較対象がnullなら_falseを返す() {
            ServiceKomokuCode sut = new ServiceKomokuCode("0");
            assertThat(sut.equals((ServiceKomokuCode) null), is(false));
        }

        @Test
        public void equalsは_比較対象がServiceKomokuCodeのインスタンスでないなら_falseを返す() {
            RString target = new RString("0");
            ServiceKomokuCode sut = new ServiceKomokuCode(target);
        ...
        public void equalsは_同じ文字列を持ったRStringから生成されたインスタンス同士では_trueを返す() {
            ServiceKomokuCode sut = new ServiceKomokuCode(new RString("0"));
            ServiceKomokuCode other = new ServiceKomokuCode(new RString("0"));
            assertThat(sut.equals(other), is(true));
        }
        ...
        public void equalsは_異なる文字列から生成されたインスタンス同士では_falseを返す() {
            ServiceKomokuCode sut = new ServiceKomokuCode("1");
            ServiceKomokuCode other = new ServiceKomokuCode("0");
        ...
        public void equalsは_ある文字列と_それと異なる文字列を持ったRStringから生成されたインスタンス同士では_falseを返す() {
            ServiceKomokuCode sut = new ServiceKomokuCode("0");
            ServiceKomokuCode other = new ServiceKomokuCode(new RString("1"));
            assertThat(sut.equals(other), is(false));
        }
    }
    ...
    public static class HashCode extends DbzTestBase {
        ...
        public void hashCodeは_同じ文字列から生成されたインスタンスは_同じ値を返す() {
            ServiceKomokuCode sut = new ServiceKomokuCode("12");
            ServiceKomokuCode other = new ServiceKomokuCode("12");
            assertThat(sut.hashCode(), is(other.hashCode()));
        }

        @Test
        public void hashCodeは_同じ文字列を持ったRStringから生成されたインスタンスは_同じ値を返す() {
            ServiceKomokuCode sut = new ServiceKomokuCode(new RString("12"));
            ServiceKomokuCode other = new ServiceKomokuCode(new RString("12"));
            assertThat(sut.hashCode(), is(other.hashCode()));
        }
    ...
    public static class isEmpty extends DbzTestBase {
        ...
        public void EMPTYと同じ値を持たないインスタンスのisEmptyは_falseを返す() {
            ...
            assertThat(sut.value(), is(not(ServiceKomokuCode.EMPTY.value())));
