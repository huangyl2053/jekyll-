...
public class JigyohokokuGeppoHoseiHyojiTest extends DbzTestBase {
    ...
    @Test
    public void 引数に012を指定した場合_toValueは_保険者_償還_審査年月_居宅介護_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("012")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_居宅介護_介護予防_サービス受給者数));
    }

    @Test
    public void 引数に013を指定した場合_toValueは_保険者_償還_決定年月_居宅介護_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("013")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_居宅介護_介護予防_サービス受給者数));
    }
    ...
    @Test
    public void 引数に015を指定した場合_toValueは_保険者_償還_審査年月_地域密着型_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("015")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_地域密着型_介護予防_サービス受給者数));
    }

    @Test
    public void 引数に016を指定した場合_toValueは_保険者_償還_決定年月_地域密着型_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("016")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_地域密着型_介護予防_サービス受給者数));
    }
    ...
    @Test
    public void 引数に018を指定した場合_toValueは_保険者_償還_審査年月_施設介護サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("018")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_施設介護サービス受給者数));
    }

    @Test
    public void 引数に019を指定した場合_toValueは_保険者_償還_決定年月_施設介護サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("019")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_施設介護サービス受給者数));
    }

    @Test
    public void 引数に020を指定した場合_toValueは_保険者_別紙_第１号被保険者のいる世帯を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("020")), is(JigyohokokuGeppoHoseiHyoji.保険者_別紙_第１号被保険者のいる世帯));
    }
    ...
    @Test
    public void 引数に025を指定した場合_toValueは_保険者_償還_審査年月_介護給付_予防給付1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("025")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_介護給付_予防給付1総数));
    }

    @Test
    public void 引数に026を指定した場合_toValueは_保険者_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("026")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲));
    }

    @Test
    public void 引数に027を指定した場合_toValueは_保険者_償還_審査年月_介護給付_予防給付3総数特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("027")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_介護給付_予防給付3総数特例分));
    }

    @Test
    public void 引数に028を指定した場合_toValueは_保険者_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("028")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分));
    }

    @Test
    public void 引数に029を指定した場合_toValueは_保険者_償還_決定年月_介護給付_予防給付1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("029")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_介護給付_予防給付1総数));
    }

    @Test
    public void 引数に030を指定した場合_toValueは_保険者_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("030")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲));
    }

    @Test
    public void 引数に031を指定した場合_toValueは_保険者_償還_決定年月_介護給付_予防給付3総数特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("031")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_介護給付_予防給付3総数特例分));
    }

    @Test
    public void 引数に032を指定した場合_toValueは_保険者_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("032")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分));
    }
    ...
    @Test
    public void 引数に035を指定した場合_toValueは_保険者_償還_審査年月_特定入所者介護_介護予防_サービス費1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("035")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_特定入所者介護_介護予防_サービス費1総数));
    }

    @Test
    public void 引数に036を指定した場合_toValueは_保険者_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("036")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分));
    }

    @Test
    public void 引数に037を指定した場合_toValueは_保険者_償還_決定年月_特定入所者介護_介護予防_サービス費1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("037")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_特定入所者介護_介護予防_サービス費1総数));
    }

    @Test
    public void 引数に038を指定した場合_toValueは_保険者_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("038")), is(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分));
    }
    ...
    @Test
    public void 引数に112を指定した場合_toValueは_構成市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("112")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数));
    }

    @Test
    public void 引数に113を指定した場合_toValueは_構成市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("113")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数));
    }
    ...
    @Test
    public void 引数に115を指定した場合_toValueは_構成市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("115")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数));
    }

    @Test
    public void 引数に116を指定した場合_toValueは_構成市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("116")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数));
    }
    ...
    @Test
    public void 引数に118を指定した場合_toValueは_構成市町村_償還_審査年月_施設介護サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("118")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_施設介護サービス受給者数));
    }

    @Test
    public void 引数に119を指定した場合_toValueは_構成市町村_償還_決定年月_施設介護サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("119")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_施設介護サービス受給者数));
    }

    @Test
    public void 引数に120を指定した場合_toValueは_構成市町村_別紙_第１号被保険者のいる世帯を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("120")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_別紙_第１号被保険者のいる世帯));
    }
    ...
    @Test
    public void 引数に125を指定した場合_toValueは_構成市町村_償還_審査年月_介護給付_予防給付1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("125")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_介護給付_予防給付1総数));
    }

    @Test
    public void 引数に126を指定した場合_toValueは_構成市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("126")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲));
    }

    @Test
    public void 引数に127を指定した場合_toValueは_構成市町村_償還_審査年月_介護給付_予防給付3総数特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("127")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_介護給付_予防給付3総数特例分));
    }

    @Test
    public void 引数に128を指定した場合_toValueは_構成市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("128")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分));
    }

    @Test
    public void 引数に129を指定した場合_toValueは_構成市町村_償還_決定年月_介護給付_予防給付1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("129")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_介護給付_予防給付1総数));
    }

    @Test
    public void 引数に130を指定した場合_toValueは_構成市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("130")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲));
    }

    @Test
    public void 引数に131を指定した場合_toValueは_構成市町村_償還_決定年月_介護給付_予防給付3総数特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("131")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_介護給付_予防給付3総数特例分));
    }

    @Test
    public void 引数に132を指定した場合_toValueは_構成市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("132")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分));
    }
    ...
    @Test
    public void 引数に135を指定した場合_toValueは_構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("135")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数));
    }

    @Test
    public void 引数に136を指定した場合_toValueは_構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("136")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分));
    }

    @Test
    public void 引数に137を指定した場合_toValueは_構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("137")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数));
    }

    @Test
    public void 引数に138を指定した場合_toValueは_構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("138")), is(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分));
    }
    ...
    @Test
    public void 引数に212を指定した場合_toValueは_旧市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("212")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数));
    }

    @Test
    public void 引数に213を指定した場合_toValueは_旧市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("213")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数));
    }
    ...
    @Test
    public void 引数に215を指定した場合_toValueは_旧市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("215")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数));
    }

    @Test
    public void 引数に216を指定した場合_toValueは_旧市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("216")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数));
    }
    ...
    @Test
    public void 引数に218を指定した場合_toValueは_旧市町村_償還_審査年月_施設介護サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("218")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_施設介護サービス受給者数));
    }

    @Test
    public void 引数に219を指定した場合_toValueは_旧市町村_償還_決定年月_施設介護サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("219")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_施設介護サービス受給者数));
    }

    @Test
    public void 引数に220を指定した場合_toValueは_旧市町村_別紙_第１号被保険者のいる世帯を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("220")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_別紙_第１号被保険者のいる世帯));
    }
    ...
    @Test
    public void 引数に225を指定した場合_toValueは_旧市町村_償還_審査年月_介護給付_予防給付1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("225")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_介護給付_予防給付1総数));
    }

    @Test
    public void 引数に226を指定した場合_toValueは_旧市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("226")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲));
    }

    @Test
    public void 引数に227を指定した場合_toValueは_旧市町村_償還_審査年月_介護給付_予防給付3総数特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("227")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_介護給付_予防給付3総数特例分));
    }

    @Test
    public void 引数に228を指定した場合_toValueは_旧市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("228")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分));
    }

    @Test
    public void 引数に229を指定した場合_toValueは_旧市町村_償還_決定年月_介護給付_予防給付1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("229")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_介護給付_予防給付1総数));
    }

    @Test
    public void 引数に230を指定した場合_toValueは_旧市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("230")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲));
    }

    @Test
    public void 引数に231を指定した場合_toValueは_旧市町村_償還_決定年月_介護給付_予防給付3総数特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("231")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_介護給付_予防給付3総数特例分));
    }

    @Test
    public void 引数に232を指定した場合_toValueは_旧市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("232")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分));
    }
    ...
    @Test
    public void 引数に235を指定した場合_toValueは_旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("235")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数));
    }

    @Test
    public void 引数に236を指定した場合_toValueは_旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("236")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分));
    }

    @Test
    public void 引数に237を指定した場合_toValueは_旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("237")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数));
    }

    @Test
    public void 引数に238を指定した場合_toValueは_旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.toValue(new RString("238")), is(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分));
    }
    ...
    @Test
    public void 保険者_償還_審査年月_居宅介護_介護予防_サービス受給者数を指定した場合_getコードは_012を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_居宅介護_介護予防_サービス受給者数.getコード(), is(new RString("012")));
    }

    @Test
    public void 保険者_償還_決定年月_居宅介護_介護予防_サービス受給者数を指定した場合_getコードは_013を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_居宅介護_介護予防_サービス受給者数.getコード(), is(new RString("013")));
    }
    ...
    @Test
    public void 保険者_償還_審査年月_地域密着型_介護予防_サービス受給者数を指定した場合_getコードは_015を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_地域密着型_介護予防_サービス受給者数.getコード(), is(new RString("015")));
    }

    @Test
    public void 保険者_償還_決定年月_地域密着型_介護予防_サービス受給者数を指定した場合_getコードは_016を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_地域密着型_介護予防_サービス受給者数.getコード(), is(new RString("016")));
    }
    ...
    @Test
    public void 保険者_償還_審査年月_施設介護サービス受給者数を指定した場合_getコードは_018を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_施設介護サービス受給者数.getコード(), is(new RString("018")));
    }

    @Test
    public void 保険者_償還_決定年月_施設介護サービス受給者数を指定した場合_getコードは_019を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_施設介護サービス受給者数.getコード(), is(new RString("019")));
    }

    @Test
    public void 保険者_別紙_第１号被保険者のいる世帯を指定した場合_getコードは_020を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_別紙_第１号被保険者のいる世帯.getコード(), is(new RString("020")));
    }
    ...
    @Test
    public void 保険者_償還_審査年月_介護給付_予防給付1総数を指定した場合_getコードは_025を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_介護給付_予防給付1総数.getコード(), is(new RString("025")));
    }

    @Test
    public void 保険者_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲を指定した場合_getコードは_026を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲.getコード(), is(new RString("026")));
    }

    @Test
    public void 保険者_償還_審査年月_介護給付_予防給付3総数特例分を指定した場合_getコードは_027を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_介護給付_予防給付3総数特例分.getコード(), is(new RString("027")));
    }

    @Test
    public void 保険者_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を指定した場合_getコードは_028を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分.getコード(), is(new RString("028")));
    }

    @Test
    public void 保険者_償還_決定年月_介護給付_予防給付1総数を指定した場合_getコードは_029を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_介護給付_予防給付1総数.getコード(), is(new RString("029")));
    }

    @Test
    public void 保険者_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲を指定した場合_getコードは_030を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲.getコード(), is(new RString("030")));
    }

    @Test
    public void 保険者_償還_決定年月_介護給付_予防給付3総数特例分を指定した場合_getコードは_031を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_介護給付_予防給付3総数特例分.getコード(), is(new RString("031")));
    }

    @Test
    public void 保険者_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を指定した場合_getコードは_032を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分.getコード(), is(new RString("032")));
    }
    ...
    @Test
    public void 保険者_償還_審査年月_特定入所者介護_介護予防_サービス費1総数を指定した場合_getコードは_035を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_特定入所者介護_介護予防_サービス費1総数.getコード(), is(new RString("035")));
    }

    @Test
    public void 保険者_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を指定した場合_getコードは_036を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分.getコード(), is(new RString("036")));
    }

    @Test
    public void 保険者_償還_決定年月_特定入所者介護_介護予防_サービス費1総数を指定した場合_getコードは_037を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_特定入所者介護_介護予防_サービス費1総数.getコード(), is(new RString("037")));
    }

    @Test
    public void 保険者_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を指定した場合_getコードは_038を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分.getコード(), is(new RString("038")));
    }
    ...
    @Test
    public void 構成市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数を指定した場合_getコードは_112を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数.getコード(), is(new RString("112")));
    }

    @Test
    public void 構成市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数を指定した場合_getコードは_113を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数.getコード(), is(new RString("113")));
    }
    ...
    @Test
    public void 構成市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数を指定した場合_getコードは_115を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数.getコード(), is(new RString("115")));
    }

    @Test
    public void 構成市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数を指定した場合_getコードは_116を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数.getコード(), is(new RString("116")));
    }
    ...
    @Test
    public void 構成市町村_償還_審査年月_施設介護サービス受給者数を指定した場合_getコードは_118を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_施設介護サービス受給者数.getコード(), is(new RString("118")));
    }

    @Test
    public void 構成市町村_償還_決定年月_施設介護サービス受給者数を指定した場合_getコードは_119を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_施設介護サービス受給者数.getコード(), is(new RString("119")));
    }

    @Test
    public void 構成市町村_別紙_第１号被保険者のいる世帯を指定した場合_getコードは_120を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_別紙_第１号被保険者のいる世帯.getコード(), is(new RString("120")));
    }
    ...
    @Test
    public void 構成市町村_償還_審査年月_介護給付_予防給付1総数を指定した場合_getコードは_125を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_介護給付_予防給付1総数.getコード(), is(new RString("125")));
    }

    @Test
    public void 構成市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲を指定した場合_getコードは_126を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲.getコード(), is(new RString("126")));
    }

    @Test
    public void 構成市町村_償還_審査年月_介護給付_予防給付3総数特例分を指定した場合_getコードは_127を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_介護給付_予防給付3総数特例分.getコード(), is(new RString("127")));
    }

    @Test
    public void 構成市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を指定した場合_getコードは_128を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分.getコード(), is(new RString("128")));
    }

    @Test
    public void 構成市町村_償還_決定年月_介護給付_予防給付1総数を指定した場合_getコードは_129を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_介護給付_予防給付1総数.getコード(), is(new RString("129")));
    }

    @Test
    public void 構成市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲を指定した場合_getコードは_130を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲.getコード(), is(new RString("130")));
    }

    @Test
    public void 構成市町村_償還_決定年月_介護給付_予防給付3総数特例分を指定した場合_getコードは_131を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_介護給付_予防給付3総数特例分.getコード(), is(new RString("131")));
    }

    @Test
    public void 構成市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を指定した場合_getコードは_132を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分.getコード(), is(new RString("132")));
    }
    ...
    @Test
    public void 構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数を指定した場合_getコードは_135を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数.getコード(), is(new RString("135")));
    }

    @Test
    public void 構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を指定した場合_getコードは_136を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分.getコード(), is(new RString("136")));
    }

    @Test
    public void 構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数を指定した場合_getコードは_137を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数.getコード(), is(new RString("137")));
    }

    @Test
    public void 構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を指定した場合_getコードは_138を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分.getコード(), is(new RString("138")));
    }
    ...
    @Test
    public void 旧市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数を指定した場合_getコードは_212を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数.getコード(), is(new RString("212")));
    }

    @Test
    public void 旧市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数を指定した場合_getコードは_213を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数.getコード(), is(new RString("213")));
    }
    ...
    @Test
    public void 旧市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数を指定した場合_getコードは_215を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数.getコード(), is(new RString("215")));
    }

    @Test
    public void 旧市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数を指定した場合_getコードは_216を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数.getコード(), is(new RString("216")));
    }
    ...
    @Test
    public void 旧市町村_償還_審査年月_施設介護サービス受給者数を指定した場合_getコードは_218を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_施設介護サービス受給者数.getコード(), is(new RString("218")));
    }

    @Test
    public void 旧市町村_償還_決定年月_施設介護サービス受給者数を指定した場合_getコードは_219を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_施設介護サービス受給者数.getコード(), is(new RString("219")));
    }

    @Test
    public void 旧市町村_別紙_第１号被保険者のいる世帯を指定した場合_getコードは_220を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_別紙_第１号被保険者のいる世帯.getコード(), is(new RString("220")));
    }
    ...
    @Test
    public void 旧市町村_償還_審査年月_介護給付_予防給付1総数を指定した場合_getコードは_225を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_介護給付_予防給付1総数.getコード(), is(new RString("225")));
    }

    @Test
    public void 旧市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲を指定した場合_getコードは_226を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲.getコード(), is(new RString("226")));
    }

    @Test
    public void 旧市町村_償還_審査年月_介護給付_予防給付3総数特例分を指定した場合_getコードは_227を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_介護給付_予防給付3総数特例分.getコード(), is(new RString("227")));
    }

    @Test
    public void 旧市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を指定した場合_getコードは_228を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分.getコード(), is(new RString("228")));
    }

    @Test
    public void 旧市町村_償還_決定年月_介護給付_予防給付1総数を指定した場合_getコードは_229を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_介護給付_予防給付1総数.getコード(), is(new RString("229")));
    }

    @Test
    public void 旧市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲を指定した場合_getコードは_230を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲.getコード(), is(new RString("230")));
    }

    @Test
    public void 旧市町村_償還_決定年月_介護給付_予防給付3総数特例分を指定した場合_getコードは_231を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_介護給付_予防給付3総数特例分.getコード(), is(new RString("231")));
    }

    @Test
    public void 旧市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を指定した場合_getコードは_232を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分.getコード(), is(new RString("232")));
    }
    ...
    @Test
    public void 旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数を指定した場合_getコードは_235を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数.getコード(), is(new RString("235")));
    }

    @Test
    public void 旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を指定した場合_getコードは_236を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分.getコード(), is(new RString("236")));
    }

    @Test
    public void 旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数を指定した場合_getコードは_237を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数.getコード(), is(new RString("237")));
    }

    @Test
    public void 旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を指定した場合_getコードは_238を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分.getコード(), is(new RString("238")));
    }
    ...
    @Test
    public void 保険者_償還_審査年月_居宅介護_介護予防_サービス受給者数を指定した場合_get名称は_保険者_償還_審査年月_居宅介護_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_居宅介護_介護予防_サービス受給者数.get名称(), is(new RString("保険者／償還（審査年月）／居宅介護（介護予防）サービス受給者数")));
    }

    @Test
    public void 保険者_償還_決定年月_居宅介護_介護予防_サービス受給者数を指定した場合_get名称は_保険者_償還_決定年月_居宅介護_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_居宅介護_介護予防_サービス受給者数.get名称(), is(new RString("保険者／償還（決定年月）／居宅介護（介護予防）サービス受給者数")));
    }
    ...
    @Test
    public void 保険者_償還_審査年月_地域密着型_介護予防_サービス受給者数を指定した場合_get名称は_保険者_償還_審査年月_地域密着型_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_地域密着型_介護予防_サービス受給者数.get名称(), is(new RString("保険者／償還（審査年月）／地域密着型（介護予防）サービス受給者数")));
    }

    @Test
    public void 保険者_償還_決定年月_地域密着型_介護予防_サービス受給者数を指定した場合_get名称は_保険者_償還_決定年月_地域密着型_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_地域密着型_介護予防_サービス受給者数.get名称(), is(new RString("保険者／償還（決定年月）／地域密着型（介護予防）サービス受給者数")));
    }
    ...
    @Test
    public void 保険者_償還_審査年月_施設介護サービス受給者数を指定した場合_get名称は_保険者_償還_審査年月_施設介護サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_施設介護サービス受給者数.get名称(), is(new RString("保険者／償還（審査年月）／施設介護サービス受給者数")));
    }

    @Test
    public void 保険者_償還_決定年月_施設介護サービス受給者数を指定した場合_get名称は_保険者_償還_決定年月_施設介護サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_施設介護サービス受給者数.get名称(), is(new RString("保険者／償還（決定年月）／施設介護サービス受給者数")));
    }

    @Test
    public void 保険者_別紙_第１号被保険者のいる世帯を指定した場合_get名称は_保険者_別紙_第１号被保険者のいる世帯を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_別紙_第１号被保険者のいる世帯.get名称(), is(new RString("保険者／（別紙）第１号被保険者のいる世帯")));
    }
    ...
    @Test
    public void 保険者_償還_審査年月_介護給付_予防給付1総数を指定した場合_get名称は_保険者_償還_審査年月_介護給付_予防給付1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_介護給付_予防給付1総数.get名称(), is(new RString("保険者／償還（審査年月）／介護給付・予防給付①総数")));
    }

    @Test
    public void 保険者_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲を指定した場合_get名称は_保険者_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲.get名称(), is(new RString("保険者／償還（審査年月）／介護給付・予防給付②第２号被保険者分（再掲）")));
    }

    @Test
    public void 保険者_償還_審査年月_介護給付_予防給付3総数特例分を指定した場合_get名称は_保険者_償還_審査年月_介護給付_予防給付3総数特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_介護給付_予防給付3総数特例分.get名称(), is(new RString("保険者／償還（審査年月）／介護給付・予防給付③総数特例分")));
    }

    @Test
    public void 保険者_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を指定した場合_get名称は_保険者_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分.get名称(), is(new RString("保険者／償還（審査年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分）")));
    }

    @Test
    public void 保険者_償還_決定年月_介護給付_予防給付1総数を指定した場合_get名称は_保険者_償還_決定年月_介護給付_予防給付1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_介護給付_予防給付1総数.get名称(), is(new RString("保険者／償還（決定年月）／介護給付・予防給付①総数")));
    }

    @Test
    public void 保険者_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲を指定した場合_get名称は_保険者_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲.get名称(), is(new RString("保険者／償還（決定年月）／介護給付・予防給付②第２号被保険者分（再掲）")));
    }

    @Test
    public void 保険者_償還_決定年月_介護給付_予防給付3総数特例分を指定した場合_get名称は_保険者_償還_決定年月_介護給付_予防給付3総数特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_介護給付_予防給付3総数特例分.get名称(), is(new RString("保険者／償還（決定年月）／介護給付・予防給付③総数特例分")));
    }

    @Test
    public void 保険者_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を指定した場合_get名称は_保険者_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分.get名称(), is(new RString("保険者／償還（決定年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分）")));
    }
    ...
    @Test
    public void 保険者_償還_審査年月_特定入所者介護_介護予防_サービス費1総数を指定した場合_get名称は_保険者_償還_審査年月_特定入所者介護_介護予防_サービス費1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_特定入所者介護_介護予防_サービス費1総数.get名称(), is(new RString("保険者／償還（審査年月）／特定入所者介護（介護予防）サービス費①総数")));
    }

    @Test
    public void 保険者_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を指定した場合_get名称は_保険者_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分.get名称(), is(new RString("保険者／償還（審査年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分")));
    }

    @Test
    public void 保険者_償還_決定年月_特定入所者介護_介護予防_サービス費1総数を指定した場合_get名称は_保険者_償還_決定年月_特定入所者介護_介護予防_サービス費1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_特定入所者介護_介護予防_サービス費1総数.get名称(), is(new RString("保険者／償還（決定年月）／特定入所者介護（介護予防）サービス費①総数")));
    }

    @Test
    public void 保険者_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を指定した場合_get名称は_保険者_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.保険者_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分.get名称(), is(new RString("保険者／償還（決定年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分")));
    }
    ...
    @Test
    public void 構成市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数を指定した場合_get名称は_構成市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数.get名称(), is(new RString("構成市町村／償還（審査年月）／居宅介護（介護予防）サービス受給者数")));
    }

    @Test
    public void 構成市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数を指定した場合_get名称は_構成市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数.get名称(), is(new RString("構成市町村／償還（決定年月）／居宅介護（介護予防）サービス受給者数")));
    }
    ...
    @Test
    public void 構成市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数を指定した場合_get名称は_構成市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数.get名称(), is(new RString("構成市町村／償還（審査年月）／地域密着型（介護予防）サービス受給者数")));
    }

    @Test
    public void 構成市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数を指定した場合_get名称は_構成市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数.get名称(), is(new RString("構成市町村／償還（決定年月）／地域密着型（介護予防）サービス受給者数")));
    }
    ...
    @Test
    public void 構成市町村_償還_審査年月_施設介護サービス受給者数を指定した場合_get名称は_構成市町村_償還_審査年月_施設介護サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_施設介護サービス受給者数.get名称(), is(new RString("構成市町村／償還（審査年月）／施設介護サービス受給者数")));
    }

    @Test
    public void 構成市町村_償還_決定年月_施設介護サービス受給者数を指定した場合_get名称は_構成市町村_償還_決定年月_施設介護サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_施設介護サービス受給者数.get名称(), is(new RString("構成市町村／償還（決定年月）／施設介護サービス受給者数")));
    }

    @Test
    public void 構成市町村_別紙_第１号被保険者のいる世帯を指定した場合_get名称は_構成市町村_別紙_第１号被保険者のいる世帯を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_別紙_第１号被保険者のいる世帯.get名称(), is(new RString("構成市町村／（別紙）第１号被保険者のいる世帯")));
    }
    ...
    @Test
    public void 構成市町村_償還_審査年月_介護給付_予防給付1総数を指定した場合_get名称は_構成市町村_償還_審査年月_介護給付_予防給付1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_介護給付_予防給付1総数.get名称(), is(new RString("構成市町村／償還（審査年月）／介護給付・予防給付①総数")));
    }

    @Test
    public void 構成市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲を指定した場合_get名称は_構成市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲.get名称(), is(new RString("構成市町村／償還（審査年月）／介護給付・予防給付②第２号被保険者分（再掲）")));
    }

    @Test
    public void 構成市町村_償還_審査年月_介護給付_予防給付3総数特例分を指定した場合_get名称は_構成市町村_償還_審査年月_介護給付_予防給付3総数特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_介護給付_予防給付3総数特例分.get名称(), is(new RString("構成市町村／償還（審査年月）／介護給付・予防給付③総数特例分")));
    }

    @Test
    public void 構成市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を指定した場合_get名称は_構成市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分.get名称(), is(new RString("構成市町村／償還（審査年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分）")));
    }

    @Test
    public void 構成市町村_償還_決定年月_介護給付_予防給付1総数を指定した場合_get名称は_構成市町村_償還_決定年月_介護給付_予防給付1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_介護給付_予防給付1総数.get名称(), is(new RString("構成市町村／償還（決定年月）／介護給付・予防給付①総数")));
    }

    @Test
    public void 構成市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲を指定した場合_get名称は_構成市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲.get名称(), is(new RString("構成市町村／償還（決定年月）／介護給付・予防給付②第２号被保険者分（再掲）")));
    }

    @Test
    public void 構成市町村_償還_決定年月_介護給付_予防給付3総数特例分を指定した場合_get名称は_構成市町村_償還_決定年月_介護給付_予防給付3総数特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_介護給付_予防給付3総数特例分.get名称(), is(new RString("構成市町村／償還（決定年月）／介護給付・予防給付③総数特例分")));
    }

    @Test
    public void 構成市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を指定した場合_get名称は_構成市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分.get名称(), is(new RString("構成市町村／償還（決定年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分）")));
    }
    ...
    @Test
    public void 構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数を指定した場合_get名称は_構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数.get名称(), is(new RString("構成市町村／償還（審査年月）／特定入所者介護（介護予防）サービス費①総数")));
    }

    @Test
    public void 構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を指定した場合_get名称は_構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分.get名称(), is(new RString("構成市町村／償還（審査年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分")));
    }

    @Test
    public void 構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数を指定した場合_get名称は_構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数.get名称(), is(new RString("構成市町村／償還（決定年月）／特定入所者介護（介護予防）サービス費①総数")));
    }

    @Test
    public void 構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を指定した場合_get名称は_構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分.get名称(), is(new RString("構成市町村／償還（決定年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分")));
    }
    ...
    @Test
    public void 旧市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数を指定した場合_get名称は_旧市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数.get名称(), is(new RString("旧市町村／償還（審査年月）／居宅介護（介護予防）サービス受給者数")));
    }

    @Test
    public void 旧市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数を指定した場合_get名称は_旧市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数.get名称(), is(new RString("旧市町村／償還（決定年月）／居宅介護（介護予防）サービス受給者数")));
    }
    ...
    @Test
    public void 旧市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数を指定した場合_get名称は_旧市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数.get名称(), is(new RString("旧市町村／償還（審査年月）／地域密着型（介護予防）サービス受給者数")));
    }

    @Test
    public void 旧市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数を指定した場合_get名称は_旧市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数.get名称(), is(new RString("旧市町村／償還（決定年月）／地域密着型（介護予防）サービス受給者数")));
    }
    ...
    @Test
    public void 旧市町村_償還_審査年月_施設介護サービス受給者数を指定した場合_get名称は_旧市町村_償還_審査年月_施設介護サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_施設介護サービス受給者数.get名称(), is(new RString("旧市町村／償還（審査年月）／施設介護サービス受給者数")));
    }

    @Test
    public void 旧市町村_償還_決定年月_施設介護サービス受給者数を指定した場合_get名称は_旧市町村_償還_決定年月_施設介護サービス受給者数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_施設介護サービス受給者数.get名称(), is(new RString("旧市町村／償還（決定年月）／施設介護サービス受給者数")));
    }

    @Test
    public void 旧市町村_別紙_第１号被保険者のいる世帯を指定した場合_get名称は_旧市町村_別紙_第１号被保険者のいる世帯を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_別紙_第１号被保険者のいる世帯.get名称(), is(new RString("旧市町村／（別紙）第１号被保険者のいる世帯")));
    }
    ...
    @Test
    public void 旧市町村_償還_審査年月_介護給付_予防給付1総数を指定した場合_get名称は_旧市町村_償還_審査年月_介護給付_予防給付1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_介護給付_予防給付1総数.get名称(), is(new RString("旧市町村／償還（審査年月）／介護給付・予防給付①総数")));
    }

    @Test
    public void 旧市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲を指定した場合_get名称は_旧市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲.get名称(), is(new RString("旧市町村／償還（審査年月）／介護給付・予防給付②第２号被保険者分（再掲）")));
    }

    @Test
    public void 旧市町村_償還_審査年月_介護給付_予防給付3総数特例分を指定した場合_get名称は_旧市町村_償還_審査年月_介護給付_予防給付3総数特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_介護給付_予防給付3総数特例分.get名称(), is(new RString("旧市町村／償還（審査年月）／介護給付・予防給付③総数特例分")));
    }

    @Test
    public void 旧市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を指定した場合_get名称は_旧市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分.get名称(), is(new RString("旧市町村／償還（審査年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分）")));
    }

    @Test
    public void 旧市町村_償還_決定年月_介護給付_予防給付1総数を指定した場合_get名称は_旧市町村_償還_決定年月_介護給付_予防給付1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_介護給付_予防給付1総数.get名称(), is(new RString("旧市町村／償還（決定年月）／介護給付・予防給付①総数")));
    }

    @Test
    public void 旧市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲を指定した場合_get名称は_旧市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲.get名称(), is(new RString("旧市町村／償還（決定年月）／介護給付・予防給付②第２号被保険者分（再掲）")));
    }

    @Test
    public void 旧市町村_償還_決定年月_介護給付_予防給付3総数特例分を指定した場合_get名称は_旧市町村_償還_決定年月_介護給付_予防給付3総数特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_介護給付_予防給付3総数特例分.get名称(), is(new RString("旧市町村／償還（決定年月）／介護給付・予防給付③総数特例分")));
    }

    @Test
    public void 旧市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を指定した場合_get名称は_旧市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分.get名称(), is(new RString("旧市町村／償還（決定年月）／介護給付・予防給付④第２号被保険者分（再掲_特例分）")));
    }
    ...
    @Test
    public void 旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数を指定した場合_get名称は_旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数.get名称(), is(new RString("旧市町村／償還（審査年月）／特定入所者介護（介護予防）サービス費①総数")));
    }

    @Test
    public void 旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を指定した場合_get名称は_旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分.get名称(), is(new RString("旧市町村／償還（審査年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分")));
    }

    @Test
    public void 旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数を指定した場合_get名称は_旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数.get名称(), is(new RString("旧市町村／償還（決定年月）／特定入所者介護（介護予防）サービス費①総数")));
    }

    @Test
    public void 旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を指定した場合_get名称は_旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分を返す() {
        assertThat(JigyohokokuGeppoHoseiHyoji.旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分.get名称(), is(new RString("旧市町村／償還（決定年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分")));
    }
