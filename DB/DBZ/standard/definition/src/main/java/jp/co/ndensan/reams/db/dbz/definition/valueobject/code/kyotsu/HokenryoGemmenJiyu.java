 ...
 * @author n3327 三浦 凌
 */
public class HokenryoGemmenJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBZCodeShubetsu.保険料減免事由.getCodeShubetsu();
    }
     ...
     * @param code 保険料減免事由
     */
    public HokenryoGemmenJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 保険料減免事由を表す文字列
     */
    public HokenryoGemmenJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HokenryoGemmenJiyu other = (HokenryoGemmenJiyu) obj;
