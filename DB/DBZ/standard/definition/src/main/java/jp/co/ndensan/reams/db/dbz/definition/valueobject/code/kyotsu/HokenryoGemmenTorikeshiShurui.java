...
/**
 * 保険料減免取消種類を表すドメインクラスです。
 *
 * @author n3327 三浦 凌
 */
public class HokenryoGemmenTorikeshiShurui implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBZCodeShubetsu.保険料減免取消種類.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 保険料減免取消種類
     */
    public HokenryoGemmenTorikeshiShurui(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 保険料減免取消種類を表す文字列
     */
    public HokenryoGemmenTorikeshiShurui(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HokenryoGemmenTorikeshiShurui other = (HokenryoGemmenTorikeshiShurui) obj;
