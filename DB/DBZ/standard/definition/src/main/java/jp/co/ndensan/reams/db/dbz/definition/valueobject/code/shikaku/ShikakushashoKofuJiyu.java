...
/**
 * 資格者証交付事由を表すドメインクラスです。
 *
 * @author n8187 久保田 英男
 */
public class ShikakushashoKofuJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBACodeShubetsu.資格者証交付事由.getCodeShubetsu();
    }
     ...
     * @param code 資格者証交付事由
     */
    public ShikakushashoKofuJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 資格者証交付事由を表す文字列
     */
    public ShikakushashoKofuJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShikakushashoKofuJiyu other = (ShikakushashoKofuJiyu) obj;
