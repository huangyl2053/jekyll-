...
public enum JigyohokokuGeppoHoseiHyoji {
     ...
     */
    保険者_償還_審査年月_居宅介護_介護予防_サービス受給者数("012", "保険者／償還（審査年月）／居宅介護（介護予防）サービス受給者数"),
    /**
     * コード:013 名称:保険者／償還（決定年月）／居宅介護（介護予防）サービス受給者数 略称:定義なし
     */
    保険者_償還_決定年月_居宅介護_介護予防_サービス受給者数("013", "保険者／償還（決定年月）／居宅介護（介護予防）サービス受給者数"),
    /**
     ...
     */
    保険者_償還_審査年月_地域密着型_介護予防_サービス受給者数("015", "保険者／償還（審査年月）／地域密着型（介護予防）サービス受給者数"),
    /**
     * コード:016 名称:保険者／償還（決定年月）／地域密着型（介護予防）サービス受給者数 略称:定義なし
     */
    保険者_償還_決定年月_地域密着型_介護予防_サービス受給者数("016", "保険者／償還（決定年月）／地域密着型（介護予防）サービス受給者数"),
    /**
     ...
     */
    保険者_償還_審査年月_施設介護サービス受給者数("018", "保険者／償還（審査年月）／施設介護サービス受給者数"),
    /**
     * コード:019 名称:保険者／償還（決定年月）／施設介護サービス受給者数 略称:定義なし
     */
    保険者_償還_決定年月_施設介護サービス受給者数("019", "保険者／償還（決定年月）／施設介護サービス受給者数"),
    /**
     * コード:020 名称:保険者／（別紙）第１号被保険者のいる世帯 略称:定義なし
     */
    保険者_別紙_第１号被保険者のいる世帯("020", "保険者／（別紙）第１号被保険者のいる世帯"),
    /**
     ...
     */
    保険者_償還_審査年月_介護給付_予防給付1総数("025", "保険者／償還（審査年月）／介護給付・予防給付①総数"),
    /**
     * コード:026 名称:保険者／償還（審査年月）／介護給付・予防給付②第２号被保険者分（再掲） 略称:定義なし
     */
    保険者_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲("026", "保険者／償還（審査年月）／介護給付・予防給付②第２号被保険者分（再掲）"),
    /**
     * コード:027 名称:保険者／償還（審査年月）／介護給付・予防給付③総数特例分 略称:定義なし
     */
    保険者_償還_審査年月_介護給付_予防給付3総数特例分("027", "保険者／償還（審査年月）／介護給付・予防給付③総数特例分"),
    /**
     * コード:028 名称:保険者／償還（審査年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分） 略称:定義なし
     */
    保険者_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分("028", "保険者／償還（審査年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分）"),
    /**
     * コード:029 名称:保険者／償還（決定年月）／介護給付・予防給付①総数 略称:定義なし
     */
    保険者_償還_決定年月_介護給付_予防給付1総数("029", "保険者／償還（決定年月）／介護給付・予防給付①総数"),
    /**
     * コード:030 名称:保険者／償還（決定年月）／介護給付・予防給付②第２号被保険者分（再掲） 略称:定義なし
     */
    保険者_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲("030", "保険者／償還（決定年月）／介護給付・予防給付②第２号被保険者分（再掲）"),
    /**
     * コード:031 名称:保険者／償還（決定年月）／介護給付・予防給付③総数特例分 略称:定義なし
     */
    保険者_償還_決定年月_介護給付_予防給付3総数特例分("031", "保険者／償還（決定年月）／介護給付・予防給付③総数特例分"),
    /**
     * コード:032 名称:保険者／償還（決定年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分） 略称:定義なし
     */
    保険者_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分("032", "保険者／償還（決定年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分）"),
    /**
     ...
     */
    保険者_償還_審査年月_特定入所者介護_介護予防_サービス費1総数("035", "保険者／償還（審査年月）／特定入所者介護（介護予防）サービス費①総数"),
    /**
     * コード:036 名称:保険者／償還（審査年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分 略称:定義なし
     */
    保険者_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分("036", "保険者／償還（審査年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分"),
    /**
     * コード:037 名称:保険者／償還（決定年月）／特定入所者介護（介護予防）サービス費①総数 略称:定義なし
     */
    保険者_償還_決定年月_特定入所者介護_介護予防_サービス費1総数("037", "保険者／償還（決定年月）／特定入所者介護（介護予防）サービス費①総数"),
    /**
     * コード:038 名称:保険者／償還（決定年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分 略称:定義なし
     */
    保険者_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分("038", "保険者／償還（決定年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分"),
    /**
     ...
     */
    構成市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数("112", "構成市町村／償還（審査年月）／居宅介護（介護予防）サービス受給者数"),
    /**
     * コード:113 名称:構成市町村／償還（決定年月）／居宅介護（介護予防）サービス受給者数 略称:定義なし
     */
    構成市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数("113", "構成市町村／償還（決定年月）／居宅介護（介護予防）サービス受給者数"),
    /**
     ...
     */
    構成市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数("115", "構成市町村／償還（審査年月）／地域密着型（介護予防）サービス受給者数"),
    /**
     * コード:116 名称:構成市町村／償還（決定年月）／地域密着型（介護予防）サービス受給者数 略称:定義なし
     */
    構成市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数("116", "構成市町村／償還（決定年月）／地域密着型（介護予防）サービス受給者数"),
    /**
     ...
     */
    構成市町村_償還_審査年月_施設介護サービス受給者数("118", "構成市町村／償還（審査年月）／施設介護サービス受給者数"),
    /**
     * コード:119 名称:構成市町村／償還（決定年月）／施設介護サービス受給者数 略称:定義なし
     */
    構成市町村_償還_決定年月_施設介護サービス受給者数("119", "構成市町村／償還（決定年月）／施設介護サービス受給者数"),
    /**
     * コード:120 名称:構成市町村／（別紙）第１号被保険者のいる世帯 略称:定義なし
     */
    構成市町村_別紙_第１号被保険者のいる世帯("120", "構成市町村／（別紙）第１号被保険者のいる世帯"),
    /**
     ...
     */
    構成市町村_償還_審査年月_介護給付_予防給付1総数("125", "構成市町村／償還（審査年月）／介護給付・予防給付①総数"),
    /**
     * コード:126 名称:構成市町村／償還（審査年月）／介護給付・予防給付②第２号被保険者分（再掲） 略称:定義なし
     */
    構成市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲("126", "構成市町村／償還（審査年月）／介護給付・予防給付②第２号被保険者分（再掲）"),
    /**
     * コード:127 名称:構成市町村／償還（審査年月）／介護給付・予防給付③総数特例分 略称:定義なし
     */
    構成市町村_償還_審査年月_介護給付_予防給付3総数特例分("127", "構成市町村／償還（審査年月）／介護給付・予防給付③総数特例分"),
    /**
     * コード:128 名称:構成市町村／償還（審査年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分） 略称:定義なし
     */
    構成市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分("128", "構成市町村／償還（審査年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分）"),
    /**
     * コード:129 名称:構成市町村／償還（決定年月）／介護給付・予防給付①総数 略称:定義なし
     */
    構成市町村_償還_決定年月_介護給付_予防給付1総数("129", "構成市町村／償還（決定年月）／介護給付・予防給付①総数"),
    /**
     * コード:130 名称:構成市町村／償還（決定年月）／介護給付・予防給付②第２号被保険者分（再掲） 略称:定義なし
     */
    構成市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲("130", "構成市町村／償還（決定年月）／介護給付・予防給付②第２号被保険者分（再掲）"),
    /**
     * コード:131 名称:構成市町村／償還（決定年月）／介護給付・予防給付③総数特例分 略称:定義なし
     */
    構成市町村_償還_決定年月_介護給付_予防給付3総数特例分("131", "構成市町村／償還（決定年月）／介護給付・予防給付③総数特例分"),
    /**
     * コード:132 名称:構成市町村／償還（決定年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分） 略称:定義なし
     */
    構成市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分("132", "構成市町村／償還（決定年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分）"),
    /**
     ...
     */
    構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数("135", "構成市町村／償還（審査年月）／特定入所者介護（介護予防）サービス費①総数"),
    /**
     * コード:136 名称:構成市町村／償還（審査年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分 略称:定義なし
     */
    構成市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分("136", "構成市町村／償還（審査年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分"),
    /**
     * コード:137 名称:構成市町村／償還（決定年月）／特定入所者介護（介護予防）サービス費①総数 略称:定義なし
     */
    構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数("137", "構成市町村／償還（決定年月）／特定入所者介護（介護予防）サービス費①総数"),
    /**
     * コード:138 名称:構成市町村／償還（決定年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分 略称:定義なし
     */
    構成市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分("138", "構成市町村／償還（決定年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分"),
    /**
     ...
     */
    旧市町村_償還_審査年月_居宅介護_介護予防_サービス受給者数("212", "旧市町村／償還（審査年月）／居宅介護（介護予防）サービス受給者数"),
    /**
     * コード:213 名称:旧市町村／償還（決定年月）／居宅介護（介護予防）サービス受給者数 略称:定義なし
     */
    旧市町村_償還_決定年月_居宅介護_介護予防_サービス受給者数("213", "旧市町村／償還（決定年月）／居宅介護（介護予防）サービス受給者数"),
    /**
     ...
     */
    旧市町村_償還_審査年月_地域密着型_介護予防_サービス受給者数("215", "旧市町村／償還（審査年月）／地域密着型（介護予防）サービス受給者数"),
    /**
     * コード:216 名称:旧市町村／償還（決定年月）／地域密着型（介護予防）サービス受給者数 略称:定義なし
     */
    旧市町村_償還_決定年月_地域密着型_介護予防_サービス受給者数("216", "旧市町村／償還（決定年月）／地域密着型（介護予防）サービス受給者数"),
    /**
     ...
     */
    旧市町村_償還_審査年月_施設介護サービス受給者数("218", "旧市町村／償還（審査年月）／施設介護サービス受給者数"),
    /**
     * コード:219 名称:旧市町村／償還（決定年月）／施設介護サービス受給者数 略称:定義なし
     */
    旧市町村_償還_決定年月_施設介護サービス受給者数("219", "旧市町村／償還（決定年月）／施設介護サービス受給者数"),
    /**
     * コード:220 名称:旧市町村／（別紙）第１号被保険者のいる世帯 略称:定義なし
     */
    旧市町村_別紙_第１号被保険者のいる世帯("220", "旧市町村／（別紙）第１号被保険者のいる世帯"),
    /**
     ...
     */
    旧市町村_償還_審査年月_介護給付_予防給付1総数("225", "旧市町村／償還（審査年月）／介護給付・予防給付①総数"),
    /**
     * コード:226 名称:旧市町村／償還（審査年月）／介護給付・予防給付②第２号被保険者分（再掲） 略称:定義なし
     */
    旧市町村_償還_審査年月_介護給付_予防給付2第２号被保険者分_再掲("226", "旧市町村／償還（審査年月）／介護給付・予防給付②第２号被保険者分（再掲）"),
    /**
     * コード:227 名称:旧市町村／償還（審査年月）／介護給付・予防給付③総数特例分 略称:定義なし
     */
    旧市町村_償還_審査年月_介護給付_予防給付3総数特例分("227", "旧市町村／償還（審査年月）／介護給付・予防給付③総数特例分"),
    /**
     * コード:228 名称:旧市町村／償還（審査年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分） 略称:定義なし
     */
    旧市町村_償還_審査年月_介護給付_予防給付4第２号被保険者分_再掲_特例分("228", "旧市町村／償還（審査年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分）"),
    /**
     * コード:229 名称:旧市町村／償還（決定年月）／介護給付・予防給付①総数 略称:定義なし
     */
    旧市町村_償還_決定年月_介護給付_予防給付1総数("229", "旧市町村／償還（決定年月）／介護給付・予防給付①総数"),
    /**
     * コード:230 名称:旧市町村／償還（決定年月）／介護給付・予防給付②第２号被保険者分（再掲） 略称:定義なし
     */
    旧市町村_償還_決定年月_介護給付_予防給付2第２号被保険者分_再掲("230", "旧市町村／償還（決定年月）／介護給付・予防給付②第２号被保険者分（再掲）"),
    /**
     * コード:231 名称:旧市町村／償還（決定年月）／介護給付・予防給付③総数特例分 略称:定義なし
     */
    旧市町村_償還_決定年月_介護給付_予防給付3総数特例分("231", "旧市町村／償還（決定年月）／介護給付・予防給付③総数特例分"),
    /**
     * コード:232 名称:旧市町村／償還（決定年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分） 略称:定義なし
     */
    旧市町村_償還_決定年月_介護給付_予防給付4第２号被保険者分_再掲_特例分("232", "旧市町村／償還（決定年月）／介護給付・予防給付④第２号被保険者分（再掲：特例分）"),
    /**
     ...
     */
    旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費1総数("235", "旧市町村／償還（審査年月）／特定入所者介護（介護予防）サービス費①総数"),
    /**
     * コード:236 名称:旧市町村／償還（審査年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分 略称:定義なし
     */
    旧市町村_償還_審査年月_特定入所者介護_介護予防_サービス費2第２号被保険者分("236", "旧市町村／償還（審査年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分"),
    /**
     * コード:237 名称:旧市町村／償還（決定年月）／特定入所者介護（介護予防）サービス費①総数 略称:定義なし
     */
    旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費1総数("237", "旧市町村／償還（決定年月）／特定入所者介護（介護予防）サービス費①総数"),
    /**
     * コード:238 名称:旧市町村／償還（決定年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分 略称:定義なし
     */
    旧市町村_償還_決定年月_特定入所者介護_介護予防_サービス費2第２号被保険者分("238", "旧市町村／償還（決定年月）／特定入所者介護（介護予防）サービス費②第２号被保険者分"),
    /**
