...
public enum NinteichosaKomokuMapping09B {
    ...
    private NinteichosaKomokuMapping09B(String code, String fullname) {
        this.code = new RString(code);
        this.fullName = new RString(fullname);
    }

    /**
     * 認定調査票09B（データベース内連番）のコードを返します。
     *
     * @return 認定調査票09B（データベース内連番）のコード
     */
    ...
    /**
     * 認定調査票09B（データベース内連番）の名称を返します。
     *
     * @return 認定調査票09B（データベース内連番）の名称
     */
    ...
    /**
     * 認定調査票09B（データベース内連番）のコードと一致する内容を探します。
     *
     * @param code 認定調査票09B（データベース内連番）のコード
     * @return {@code code} に対応する認定調査票09B（データベース内連番）
     */
    public static NinteichosaKomokuMapping09B toValue(RString code) {
        ...
        throw new IllegalArgumentException(UrSystemErrorMessages.変換不可.getReplacedMessage(" 認定調査票09B（データベース内連番）"));
    }
}
