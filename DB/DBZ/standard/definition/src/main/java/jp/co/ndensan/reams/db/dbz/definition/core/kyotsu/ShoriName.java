...
public enum ShoriName {
     ...
     */
    住宅改修理由書作成手数料支給不支給決定通知書作成("住宅改修理由書作成手数料支給不支給決定通知書作成"),
    /**
     * コード:無し 名称:納付額データ作成 略称:定義なし
     */
    納付額データ作成("納付額データ作成"),
    ...
    /**
     * コード:無し 名称:給付振込データ作成_事業高額 略称:定義なし
     */
    給付振込データ作成_事業高額("給付振込データ作成_事業高額"),
    /**
     * コード:無し 名称:給付振込データ作成_事業高額合算 略称:定義なし
     */
    給付振込データ作成_事業高額合算("給付振込データ作成_事業高額合算"),
    /**
    ...
    /**
     * コード:無し 名称:高額サービス等支給不支給決定通知書一括作成_受付日 略称:定義なし
     */
    高額サービス等支給不支給決定通知書一括作成_受付日("高額サービス等支給不支給決定通知書一括作成_受付日"),
    /**
     * コード:無し 名称:高額サービス等支給不支給決定通知書一括作成_決定日 略称:定義なし
     */
    高額サービス等支給不支給決定通知書一括作成_決定日("高額サービス等支給不支給決定通知書一括作成_決定日"),
    /**
     * コード:無し 名称:高額サービス等支給不支給決定通知書一括作成_決定者受付年月 略称:定義なし
     */
    高額サービス等支給不支給決定通知書一括作成_決定者受付年月("高額サービス等支給不支給決定通知書一括作成_決定者受付年月"),
    /**
     * コード:無し 名称:事業高額サービス等支給不支給決定通知書一括作成 略称:定義なし
     */
    事業高額サービス等支給不支給決定通知書一括作成("事業高額サービス等支給不支給決定通知書一括作成"),
    /**
     * コード:無し 名称:事業高額サービス等支給不支給決定通知書一括作成_受付日 略称:定義なし
     */
    事業高額サービス等支給不支給決定通知書一括作成_受付日("事業高額サービス等支給不支給決定通知書一括作成_受付日"),
    /**
     * コード:無し 名称:事業高額サービス等支給不支給決定通知書一括作成_決定日 略称:定義なし
     */
    事業高額サービス等支給不支給決定通知書一括作成_決定日("事業高額サービス等支給不支給決定通知書一括作成_決定日"),
    /**
     * コード:無し 名称:事業高額サービス等支給不支給決定通知書一括作成_決定者受付年月 略称:定義なし
     */
    事業高額サービス等支給不支給決定通知書一括作成_決定者受付年月("事業高額サービス等支給不支給決定通知書一括作成_決定者受付年月"),
    /**
