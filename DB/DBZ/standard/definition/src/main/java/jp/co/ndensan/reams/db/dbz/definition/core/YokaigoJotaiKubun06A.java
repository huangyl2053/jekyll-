 ...
 * @reference
 */
public enum YokaigoJotaiKubun06A implements IYokaigoJotaiKubun {
    ...
    private YokaigoJotaiKubun06A(String code) {
     ...
     */
    public static YokaigoJotaiKubun06A toValue(RString code) throws IllegalArgumentException {
        for (YokaigoJotaiKubun06A data : values()) {
