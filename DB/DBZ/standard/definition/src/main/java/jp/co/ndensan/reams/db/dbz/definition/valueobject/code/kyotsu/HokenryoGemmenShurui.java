 ...
 * @author n3327 三浦 凌
 */
public class HokenryoGemmenShurui implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBZCodeShubetsu.保険料減免種類.getCodeShubetsu();
    }
     ...
     * @param code 保険料減免種類
     */
    public HokenryoGemmenShurui(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 保険料減免種類を表す文字列
     */
    public HokenryoGemmenShurui(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HokenryoGemmenShurui other = (HokenryoGemmenShurui) obj;
