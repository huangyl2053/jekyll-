...
/**
 * 保険料徴収猶予種類を表すドメインクラスです。
 *
 * @author n3327 三浦 凌
 */
public class HokenryoChoshuYuyoShurui implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     * コンストラクタです。
     *
     * @param code 保険料徴収猶予種類
     */
    public HokenryoChoshuYuyoShurui(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 保険料徴収猶予種類を表す文字列
     */
    public HokenryoChoshuYuyoShurui(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HokenryoChoshuYuyoShurui other = (HokenryoChoshuYuyoShurui) obj;
