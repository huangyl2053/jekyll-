...
/**
 * 意見書項目マッピング06Aを表す列挙型です。
 *
 * @reamsid_L DBZ-9999-023 wangchao
 */
public enum IkenshoKomokuMapping06A implements IIkenshoKomokuMapping {
    ...
    /**
     * コード:90 名称:訪問歯科診療 略称:定義なし
     */
    訪問歯科診療(90, "医学的管理の必要性（訪問歯科診療）"),
    /**
     * コード:91 名称:訪問歯科診療_必要性 略称:定義なし
     */
    訪問歯科診療_必要性(91, "医学的管理の必要性（訪問歯科診療）必要性"),
    /**
     * コード:92 名称:訪問薬剤管理指導 略称:定義なし
     */
    訪問薬剤管理指導(92, "医学的管理の必要性（訪問薬剤管理指導）"),
    /**
     * コード:93 名称:訪問薬剤管理指導_必要性 略称:定義なし
     */
    訪問薬剤管理指導_必要性(93, "医学的管理の必要性（訪問薬剤管理指導）必要性"),
    /**
     * コード:94 名称:訪問リハビリテーション 略称:定義なし
     */
    訪問リハビリテーション(94, "医学的管理の必要性（訪問リハビリテーション）"),
    /**
     * コード:95 名称:訪問リハビリテーション_必要性 略称:定義なし
     */
    訪問リハビリテーション_必要性(95, "医学的管理の必要性（訪問リハビリテーション）必要性"),
    /**
     * コード:96 名称:短期入所療養介護 略称:定義なし
     */
    短期入所療養介護(96, "医学的管理の必要性（短期入所療養介護）"),
    /**
     * コード:97 名称:短期入所療養介護_必要性 略称:定義なし
     */
    短期入所療養介護_必要性(97, "医学的管理の必要性（短期入所療養介護）必要性"),
    /**
     * コード:98 名称:訪問栄養食事指導 略称:定義なし
     */
    訪問歯科衛生指導(98, "医学的管理の必要性（訪問歯科衛生指導）"),
    /**
     * コード:99 名称:訪問栄養食事指導 略称:定義なし
     */
    訪問歯科衛生指導_必要性(99, "医学的管理の必要性（訪問歯科衛生指導）必要性"),
    /**
     * コード:100 名称:訪問栄養食事指導 略称:定義なし
     */
    訪問栄養食事指導(100, "医学的管理の必要性（訪問栄養食事指導）"),
    /**
     * コード:101 名称:訪問栄養食事指導_必要性 略称:定義なし
     */
    訪問栄養食事指導_必要性(101, "医学的管理の必要性（訪問栄養食事指導）必要性"),
    /**
     * コード:102 名称:通所リハビリテーション 略称:定義なし
     */
    通所リハビリテーション(102, "医学的管理の必要性（通所リハビリテーション）"),
    /**
     * コード:103 名称:通所リハビリテーション_必要性 略称:定義なし
     */
    通所リハビリテーション_必要性(103, "医学的管理の必要性（通所リハビリテーション）必要性"),
    /**
     * コード:104 名称:その他の医療系のサービス 略称:定義なし
     */
    その他の医療系のサービス(104, "医学的管理の必要性（その他の医療系のサービス）"),
    /**
     * コード:105 名称:その他の医療系のサービス_必要性 略称:定義なし
     */
    その他の医療系のサービス_必要性(105, "医学的管理の必要性（その他の医療系のサービス）必要性"),
    /**
     * コード:106名称:介護サービスの留意事項_血圧 略称:定義なし
     */
    介護サービスの留意事項_血圧(106, "介護サービスの留意事項（血圧）"),
    /**
     * コード:107 名称:介護サービスの留意事項_移動 略称:定義なし
     */
    介護サービスの留意事項_移動(107, "介護サービスの留意事項（移動）"),
    /**
     * コード:108 名称:介護サービスの留意事項_摂食 略称:定義なし
     */
    介護サービスの留意事項_摂食(108, "介護サービスの留意事項（摂食）"),
    /**
     * コード:109 名称:介護サービスの留意事項運動 略称:定義なし
     */
    介護サービスの留意事項_運動(109, "介護サービスの留意事項（運動）"),
    /**
     * コード:110 名称:介護サービスの留意事項_嚥下 略称:定義なし
     */
    介護サービスの留意事項_嚥下(110, "介護サービスの留意事項（嚥下）"),
    /**
     * コード:111 名称:感染症の有無 略称:定義なし
     */
    感染症の有無(111, "感染症の有無");
    ...
    private IkenshoKomokuMapping06A(int 連番, String fullname) {
        this.連番 = 連番;
    ...
    /**
     * 意見書項目マッピング06Aのコードを返します。
     *
     * @return 意見書項目マッピング06Aのコード
     */
    @Override
    ...
    /**
     * 意見書項目マッピング06Aの名称を返します。
     *
     * @return 意見書項目マッピング06Aの名称
     */
    @Override
    ...
    /**
     * 意見書項目マッピング06Aのコードと一致する内容を探します。
     *
     * @param code 意見書項目マッピング06Aのコード
     * @return {@code code} に対応する意見書項目マッピング06A
     */
    public static IkenshoKomokuMapping06A toValue(RString code) {
        for (IkenshoKomokuMapping06A ikenshoKomokuMapping99A : IkenshoKomokuMapping06A.values()) {
            if (ikenshoKomokuMapping99A.code.equals(code)) {
                return ikenshoKomokuMapping99A;
            }
        }
        throw new IllegalArgumentException(UrSystemErrorMessages.変換不可.getReplacedMessage("意見書項目マッピング06A"));
    }
}
