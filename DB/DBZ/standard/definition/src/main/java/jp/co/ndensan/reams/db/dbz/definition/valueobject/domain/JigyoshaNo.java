 ...
 * @author N3317 塚田 萌
 */
public final class JigyoshaNo implements IValueObject<RString>, Comparable<JigyoshaNo>, IDbColumnMappable, Serializable {
    ...
    public int compareTo(JigyoshaNo 比較対象) {
        return Objects.compare(this.事業者番号, 比較対象.事業者番号, Comparators.naturalOrder());
    }
