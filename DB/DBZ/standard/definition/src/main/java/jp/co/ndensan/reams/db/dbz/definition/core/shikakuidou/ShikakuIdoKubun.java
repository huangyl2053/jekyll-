...
public enum ShikakuIdoKubun {
    ...
    /**
     * 資格異動を表す区分のコードと一致する内容を探します。
     *
     * @param code 資格異動を表す区分のコード
     * @return {@code code} に対応する資格異動を表す区分
     */
    public static ShikakuIdoKubun toValue(RString code) {
        ...
        throw new IllegalArgumentException(UrSystemErrorMessages.変換不可.getReplacedMessage("資格異動を表す区分"));
    }
}
