...
/**
 *
 * 意見書記入項目マッピング99Aを表す列挙型です。
 */
public enum IkenshoKinyuMapping99A {
    ...
    private IkenshoKinyuMapping99A(String code, String fullname) {
        this.code = new RString(code);
        this.fullName = new RString(fullname);
    }

    /**
     * 意見書記入項目マッピング99Aのコードを返します。
     *
     * @return 意見書記入項目マッピング99Aのコード
     */
    ...
    /**
     * 意見書記入項目マッピング99Aの名称を返します。
     *
     * @return 意見書記入項目マッピング99Aの名称
     */
    ...
    /**
     * 意見書記入項目マッピング99Aのコードと一致する内容を探します。
     *
     * @param code 意見書記入項目マッピング99Aのコード
     * @return {@code code} に対応する意見書記入項目マッピング99A
     */
    public static IkenshoKinyuMapping99A toValue(RString code) {
        for (IkenshoKinyuMapping99A ikenshoKinyuMapping99A : IkenshoKinyuMapping99A.values()) {
            if (ikenshoKinyuMapping99A.code.equals(code)) {
                return ikenshoKinyuMapping99A;
            }
        }
        throw new IllegalArgumentException(UrSystemErrorMessages.変換不可.getReplacedMessage("意見書記入項目マッピング99A"));
    }
}
