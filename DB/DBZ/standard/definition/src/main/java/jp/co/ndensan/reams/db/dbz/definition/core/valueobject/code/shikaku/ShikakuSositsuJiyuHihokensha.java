...
/**
 * 介護資格喪失事由（被保険者）を表すドメインクラスです。
 *
 * @author n8187 久保田 英男
 */
public class ShikakuSositsuJiyuHihokensha implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBACodeShubetsu.介護資格喪失事由_被保険者.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護資格喪失事由（被保険者）
     */
    public ShikakuSositsuJiyuHihokensha(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護資格喪失事由（被保険者）を表す文字列
     */
    public ShikakuSositsuJiyuHihokensha(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShikakuSositsuJiyuHihokensha other = (ShikakuSositsuJiyuHihokensha) obj;
