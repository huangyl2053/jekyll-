...
/**
 * 被保険者証交付事由を表すドメインクラスです。
 *
 * @author n8187 久保田 英男
 */
public class HihokenshashoKofuJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBACodeShubetsu.被保険者証交付事由.getCodeShubetsu();
    }
    
    /**
     * コンストラクタです。
     *
     * @param code 被保険者証交付事由
     */
    public HihokenshashoKofuJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 被保険者証交付事由を表す文字列
     */
    public HihokenshashoKofuJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HihokenshashoKofuJiyu other = (HihokenshashoKofuJiyu) obj;
