...
/**
 *
 * 意見書記入項目マッピング06Aを表す列挙型です。
 */
public enum IkenshoKinyuMapping06A {
    ...
    private IkenshoKinyuMapping06A(String code, String fullname) {
        this.code = new RString(code);
        this.fullName = new RString(fullname);
    }

    /**
     * 意見書記入項目マッピング06Aのコードを返します。
     *
     * @return 意見書記入項目マッピング06Aのコード
     */
    ...
    /**
     * 意見書記入項目マッピング06Aの名称を返します。
     *
     * @return 意見書記入項目マッピング06Aの名称
     */
    ...
    /**
     * 意見書記入項目マッピング06Aのコードと一致する内容を探します。
     *
     * @param code 意見書記入項目マッピング06Aのコード
     * @return {@code code} に対応する意見書記入項目マッピング06A
     */
    public static IkenshoKinyuMapping06A toValue(RString code) {
        for (IkenshoKinyuMapping06A ikenshoKinyuMapping02A : IkenshoKinyuMapping06A.values()) {
            if (ikenshoKinyuMapping02A.code.equals(code)) {
                return ikenshoKinyuMapping02A;
            }
        }
        throw new IllegalArgumentException(UrSystemErrorMessages.変換不可.getReplacedMessage("意見書記入項目マッピング06A"));
    }
}
