...
/**
 * 保険料徴収猶予取消種類を表すドメインクラスです。
 *
 * @author n3327 三浦 凌
 */
public class HokenryoChoshuYuyoTorikeshiShurui implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBZCodeShubetsu.保険料徴収猶予取消種類.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 保険料徴収猶予取消種類
     */
    public HokenryoChoshuYuyoTorikeshiShurui(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 保険料徴収猶予取消種類を表す文字列
     */
    public HokenryoChoshuYuyoTorikeshiShurui(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HokenryoChoshuYuyoTorikeshiShurui other = (HokenryoChoshuYuyoTorikeshiShurui) obj;
