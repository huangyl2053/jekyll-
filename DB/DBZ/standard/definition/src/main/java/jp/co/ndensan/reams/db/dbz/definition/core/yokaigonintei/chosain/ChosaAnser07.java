...
public enum ChosaAnser07 {
    ...
    private ChosaAnser07(String code, String fullname, String ryakusho) {
     ...
     */
    public static ChosaAnser07 toValue(RString code) {
        for (ChosaAnser07 anser07 : ChosaAnser07.values()) {
            if (anser07.code.equals(code)) {
                return anser07;
            }
        }
