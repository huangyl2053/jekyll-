...
public enum DbzErrorMessages implements IMessageGettable, IValidationMessage {
    ...
    必須項目を入力_追加メッセージあり(2, "必須項目を入力してください。:%1"),
    入力値が不正(3, "入力値が不正です。"),
    入力値が不正_追加メッセージあり(4, "入力値が不正です。:%1"),
    不正(5, "%1が不正です。"),
    既に存在(6, "%1が既に存在します。"),
    ...
    期間が不正(9, "期間が不正です。"),
    期間が重複(10, "期間が重複しています。"),
    期間が不正_追加メッセージあり１(11, "期間が不正です。終了日（%1）－開始日（%2）"),
    期間が不正_追加メッセージあり２(12, "期間が不正です。%1－%2"),
    大小関係が不正(13, "大小関係が不正です。(%1)"),
    ...
    対象データなし_追加メッセージあり(22, "対象のデータがありません。:%1"),
    対象者を選択(23, "対象者を選択してください。"),
    対象行を選択(24, "対象の行を選択してください。"),
    選択されていない(25, "%1が選択されていません。"),
    選択行が不正(26, "選択行は不正です。"),
    ...
    異常終了(32, "異常終了しました。"),
    更新に失敗(33, "%1更新に失敗しました。"),
    対象ファイルが存在しない(34, "対象のファイルは存在していません。：%1"),
    指定ファイルが存在しない(35, "指定されたファイルは存在しません。：%1"),
    ファイル名取得エラー(36, "テキストファイル・ファイル名取得エラー"),
    ファイルOPENエラー(37, "テキストファイルＯＰＥＮエラー(%1)"),
    ファイルREADエラー(38, "テキストファイルＲＥＡＤエラー(%1)"),
    ファイルCLOSEエラー(39, "テキストファイルＣＬＯＳＥエラー(%1)"),
    ファイルFETCHエラー(40, "テキストファイルＦＥＴＣＨエラー(%1)"),
    ファイルWRITEエラー(41, "テキストファイルＷＲＩＴＥエラー(%1)"),
    出力順序を指定(42, "出力順序を指定してください。"),
    出力項目を指定(43, "出力項目を指定してください。"),
    確定不可(44, "最新の取得日として登録できません。:(%1)    "),
    指定数誤り(45, "%1の数が不正です。%2してください。"),
    実行不可(46, "%1ため%2できません。");
