...
public enum DbzErrorMessages implements IMessageGettable, IValidationMessage {
    ...
    理由付き確定不可(1, "%1のため確定できません。"),
    編集後更新指示(2, "編集されています。更新処理を行ってください。"),
    理由付き完了不可(3, "%1のため完了できません。"),
    理由付き登録不可(4, "%1のため登録できません。"),
    複数必須項目相関チェックエラー(5, "%1が入力されている場合、%2が入力されている必要があります。"),
    期間が不正_未来日付不可(6, "%1は%2より未来の日付を設定できません。"),
    検索結果件数不正(7, "検索結果の件数が不正です。"),
    期間が不正_過去日付不可(8, "%1は%2より過去の日付を設定できません。"),
