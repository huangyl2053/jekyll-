...
public enum ChosaAnser21 {
     ...
     */
    行っていない("4", "行っていない", "行っていない");
    private final RString code;
    private final RString fullName;
    private final RString ryakusho;

    private ChosaAnser21(String code, String fullname, String ryakusho) {
     ...
     */
    public static ChosaAnser21 toValue(RString code) {
        for (ChosaAnser21 anser21 : ChosaAnser21.values()) {
            if (anser21.code.equals(code)) {
                return anser21;
            }
        }
