...
/**
 * 意見書項目マッピング09Bを表す列挙型です。
 *
 * @reamsid_L DBZ-9999-023 wangchao
 */
public enum IkenshoKomokuMapping09B implements IIkenshoKomokuMapping {
    ...
    private IkenshoKomokuMapping09B(int 連番, String fullname) {
        this.連番 = 連番;
    ...
    /**
     * 意見書項目マッピング09Bのコードを返します。
     *
     * @return 意見書項目マッピング09Bのコード
     */
    @Override
    ...
    /**
     * 意見書項目マッピング09Bの名称を返します。
     *
     * @return 意見書項目マッピング09Bの名称
     */
    @Override
    ...
    /**
     * 意見書項目マッピング09Bのコードと一致する内容を探します。
     *
     * @param code 意見書項目マッピング09Bのコード
     * @return {@code code} に対応する意見書項目マッピング09B
     */
    public static IkenshoKomokuMapping09B toValue(RString code) {
        for (IkenshoKomokuMapping09B ikenshoKomokuMapping09B : IkenshoKomokuMapping09B.values()) {
            if (ikenshoKomokuMapping09B.code.equals(code)) {
                return ikenshoKomokuMapping09B;
            }
        }
        throw new IllegalArgumentException(UrSystemErrorMessages.変換不可.getReplacedMessage("意見書項目マッピング09B"));
    }
}
