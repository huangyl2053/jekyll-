...
/**
 * 保険料徴収猶予取消事由を表すドメインクラスです。
 *
 * @author n3327 三浦 凌
 */
public class HokenryoChoshuYuyoTorikeshiJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBZCodeShubetsu.保険料徴収猶予取消事由.getCodeShubetsu();
    }
    
    /**
     * コンストラクタです。
     *
     * @param code 保険料徴収猶予取消事由
     */
    public HokenryoChoshuYuyoTorikeshiJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 保険料徴収猶予取消事由を表す文字列
     */
    public HokenryoChoshuYuyoTorikeshiJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HokenryoChoshuYuyoTorikeshiJiyu other = (HokenryoChoshuYuyoTorikeshiJiyu) obj;
