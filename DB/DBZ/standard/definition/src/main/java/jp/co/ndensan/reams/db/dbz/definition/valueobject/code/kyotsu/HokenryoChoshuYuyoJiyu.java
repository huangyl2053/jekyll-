...
/**
 * 保険料徴収猶予事由を表すドメインクラスです。
 *
 * @author n3327 三浦 凌
 */
public class HokenryoChoshuYuyoJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBZCodeShubetsu.保険料徴収猶予事由.getCodeShubetsu();
    }
    
    /**
     * コンストラクタです。
     *
     * @param code 保険料徴収猶予事由
     */
    public HokenryoChoshuYuyoJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 保険料徴収猶予事由を表す文字列
     */
    public HokenryoChoshuYuyoJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HokenryoChoshuYuyoJiyu other = (HokenryoChoshuYuyoJiyu) obj;
