...
public final class YouKaiGoNinTeiShinNiTeiParameter {
    ...
    private YouKaiGoNinTeiShinNiTeiParameter(
     ...
     * @param ichiGojiHanteiYMDFrom 1.5次判定日From
     * @param ichiGojiHanteiYMDTo 1.5次判定日To
     * @param ichiGojiHanteiKekkaCode 1.5次判定結果
     * @param nijiHanteiKekkaInputHoho 二次判定結果
     * @param nijiHanteiNinteiYukoKikan 認定有効期間
     * @param nijiHanteiNinteiYMDFrom 認定有効開始日From
     * @param nijiHanteiNinteiYMDTo 認定有効開始日To
     * @param nijiHanteiShuryoYMDFrom 認定有効終了日From
     * @param nijiHanteiShuryoYMDTo 認定有効終了日To
     * @param nijiHanteiKekkaInputYMDFrom 二次判定結果From
     * @param nijiHanteiKekkaInputYMDTo 二次判定結果To
     * @param shinsakaiKaisaiYMDFrom 開催日From
     * @param shinsakaiKaisaiYMDTo 開催日To
     * @param shinsakaiKaisaiNoFrom 開催番号From
     * @param shinsakaiKaisaiNoTo 開催番号To
     ...
     * @param geninShikkanCode 原因疾患
     * @param ninteiShinseiYMDSystemFrom 経過日数Form
     * @param ninteiShinseiYMDSystemTo 経過日数To
     * @param isKoShiTaiJyo 更新対象
     * @param ninteiShinseiYukoKubunCode 有効無効区分
     * @param isIchijiHanteiKanryoYMD 一次判定完了年月日
     * @param isNinteiShinseiJohoYMD 認定申請情報登録完了年月日
     * @param isMaskingKanryoYMD マスキング完了年月日
     * @param isNinteichosaIraiKanryoYMD 調査依頼完了年月日
     * @param isNinteiShinsakaiWariateYMD 認定審査会割り当て完了年月日
     * @param isIkenshoSakuseiIraiKanryoYMD 主治医意見書作成依頼完了年月日
     * @param isNinteiShinsakaiKanryoYMD 認定審査会完了年月日
     * @param isNinteichosaKanryoYMD 認定調査完了年月日
    ...
    public static YouKaiGoNinTeiShinNiTeiParameter createParam_認定(
        ...
        return new YouKaiGoNinTeiShinNiTeiParameter(
                ...
                ninteiShinseiYMDTo,
                !seinengappiYMDFrom.isEmpty(),
                seinengappiYMDFrom,
                !seinengappiYMDTo.isEmpty(),
                seinengappiYMDTo,
                ...
                !ninteichosaJisshiYMDFrom.isEmpty(),
                ninteichosaJisshiYMDFrom,
                !ninteichosaJisshiYMDTo.isEmpty(),
                ...
                ishiKubunCode,
                !ikenshoJuryoYMDFrom.isEmpty(),
                ikenshoJuryoYMDFrom,
                !ikenshoJuryoYMDTo.isEmpty(),
                ikenshoJuryoYMDTo,
                !RString.isNullOrEmpty(neTaKiRi),
                neTaKiRi,
                !RString.isNullOrEmpty(niChiDo),
                niChiDo,
                !ichijiHanteiYMDFrom.isEmpty(),
                ichijiHanteiYMDFrom,
                !ichijiHanteiYMDTo.isEmpty(),
                ichijiHanteiYMDTo,
                !RString.isNullOrEmpty(ichijiHanteiKekkaCode.value()),
                ichijiHanteiKekkaCode,
                !ichiGojiHanteiYMDFrom.isEmpty(),
                ichiGojiHanteiYMDFrom,
                !ichiGojiHanteiYMDTo.isEmpty(),
                ichiGojiHanteiYMDTo,
                ...
                !nijiHanteiNinteiYMDFrom.isEmpty(),
                nijiHanteiNinteiYMDFrom,
                !nijiHanteiNinteiYMDTo.isEmpty(),
                nijiHanteiNinteiYMDTo,
                !nijiHanteiShuryoYMDFrom.isEmpty(),
                nijiHanteiShuryoYMDFrom,
                !nijiHanteiShuryoYMDTo.isEmpty(),
                nijiHanteiShuryoYMDTo,
                !nijiHanteiKekkaInputYMDFrom.isEmpty(),
                nijiHanteiKekkaInputYMDFrom,
                !nijiHanteiKekkaInputYMDTo.isEmpty(),
                nijiHanteiKekkaInputYMDTo,
                !shinsakaiKaisaiYMDFrom.isEmpty(),
                shinsakaiKaisaiYMDFrom,
                !shinsakaiKaisaiYMDTo.isEmpty(),
                ...
                !zenkaiYukoKikanStartFrom.isEmpty(),
                zenkaiYukoKikanStartFrom,
                !zenkaiYukoKikanStartTo.isEmpty(),
                ...
                isIchijiHanteiKanryoYMD,
                isNinteiShinseiJohoYMD,
                isMaskingKanryoYMD,
                isNinteichosaIraiKanryoYMD,
                isNinteiShinsakaiWariateYMD,
                isIkenshoSakuseiIraiKanryoYMD,
                isNinteiShinsakaiKanryoYMD,
                isNinteichosaKanryoYMD,
                isIkenshoTorokuKanryoYMD,
                isCenterSoshinYMD,
                false,
                limitCount
        );
