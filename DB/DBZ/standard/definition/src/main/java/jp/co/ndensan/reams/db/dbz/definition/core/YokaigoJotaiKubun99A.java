 ...
 * @reference
 */
public enum YokaigoJotaiKubun99A implements IYokaigoJotaiKubun {
    ...
    非該当("01"),
    /**
     * 要介護状態区分が「みなし非該当」であることを表します。<br />
     * コード：09
     */
    みなし非該当("09"),
    /**
     * 要介護状態区分が「経過的要介護」であることを表します。<br />
     * コード：11
     */
    経過的要介護("11"),
    /**
     * 要介護状態区分が「みなし要支援」であることを表します。<br />
     * コード：19
     */
    みなし要支援("19"),
    /**
    ...
    private YokaigoJotaiKubun99A(String code) {
     ...
     */
    public static YokaigoJotaiKubun99A toValue(RString code) throws IllegalArgumentException {
        for (YokaigoJotaiKubun99A data : values()) {
