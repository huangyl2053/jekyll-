...
/**
 * 要介護状態区分の列挙型です。（厚労省認定ソフト2009（SP3）版）
 *
 * @author N8156 宮本 康
 * @jpName
 * @bizDomain
 ...
 * @reference
 */
public enum YokaigoJotaiKubun09B implements IYokaigoJotaiKubun {
    ...
    private YokaigoJotaiKubun09B(String code) {
     ...
     */
    public static YokaigoJotaiKubun09B toValue(RString code) throws IllegalArgumentException {
        for (YokaigoJotaiKubun09B data : values()) {
