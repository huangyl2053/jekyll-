...
public enum NinteichosaKomokuMapping02A implements INinteichosaKomokuMapping {
     ...
     */
    座位保持("14", "座位保持", "2-3", "3", "203", "1"),
    /**
     * コード:15 名称:両足での立位 表示番号:2-4 パターンNo:3 特記事項番号:204 略称:定義なし
     */
    両足での立位("15", "両足での立位", "2-4", "3", "204", "1"),
    /**
     * コード:16 名称:歩行 表示番号:2-5 パターンNo:4 特記事項番号:205 略称:定義なし
     */
    歩行("16", "歩行", "2-5", "4", "205", "1"),
    /**
     * コード:17 名称:移乗 表示番号:2-6 パターンNo:2 特記事項番号:206 略称:定義なし
     */
    移乗("17", "移乗", "2-6", "2", "206", "1"),
    /**
     * コード:18 名称:移動　表示番号:2-7 パターンNo:20 特記事項番号:207 略称:定義なし
     */
    移動("18", "移動", "2-7", "20", "207", "1"),
    /**
