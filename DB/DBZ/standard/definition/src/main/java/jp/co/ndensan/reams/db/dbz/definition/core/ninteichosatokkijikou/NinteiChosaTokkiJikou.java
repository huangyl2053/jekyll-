...
public enum NinteiChosaTokkiJikou {
    ...
    集団への不適用("5-4", "集団への不適用", "504", "C3060-xx.png"),
    ...
    public static NinteiChosaTokkiJikou getMax特記事項番号() {
        return NinteiChosaTokkiJikou.values()[NinteiChosaTokkiJikou.values().length - 1];
    }

    public static NinteiChosaTokkiJikou getMin特記事項番号() {
        return NinteiChosaTokkiJikou.values()[0];
    }
}
