...
/**
 * 特別徴収停止事由を表すドメインクラスです。
 *
 * @author n3327 三浦 凌
 */
public class TokubetsuChoshuTeishiJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBZCodeShubetsu.特別徴収停止事由.getCodeShubetsu();
    }
     ...
     * @param code 特別徴収停止事由
     */
    public TokubetsuChoshuTeishiJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 特別徴収停止事由を表す文字列
     */
    public TokubetsuChoshuTeishiJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TokubetsuChoshuTeishiJiyu other = (TokubetsuChoshuTeishiJiyu) obj;
