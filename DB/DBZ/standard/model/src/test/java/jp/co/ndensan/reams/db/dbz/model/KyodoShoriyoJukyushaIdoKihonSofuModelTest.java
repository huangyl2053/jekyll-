...
public class KyodoShoriyoJukyushaIdoKihonSofuModelTest extends DbzTestBase {
    ...
    public static class getterSetterTest extends DbzTestBase {
        ...
        public void 戻り値の処理日時は_設定した値と同じ処理日時を返す() {
            sut.set処理日時(DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntityGenerator.DEFAULT_処理日時);
            assertThat(sut.get処理日時(), is(DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntityGenerator.DEFAULT_処理日時));
        }
