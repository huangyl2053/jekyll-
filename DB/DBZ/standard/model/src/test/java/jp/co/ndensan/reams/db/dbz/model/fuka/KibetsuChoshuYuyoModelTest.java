...
public class KibetsuChoshuYuyoModelTest extends DbzTestBase {
    ...
    public static class getterSetterTest extends DbzTestBase {
        ...
        public void 戻り値の調定年度は_設定した値と同じ調定年度を返す() {
            ChoteiNendo 調定年度 = new ChoteiNendo(DbT2007KibetsuChoshuYuyoEntityGenerator.DEFAULT_調定年度);
            sut.set調定年度(調定年度);
        ...
        public void 戻り値の賦課年度は_設定した値と同じ賦課年度を返す() {
            FukaNendo 賦課年度 = new FukaNendo(DbT2007KibetsuChoshuYuyoEntityGenerator.DEFAULT_賦課年度);
            sut.set賦課年度(賦課年度);
        ...
        public void 戻り値の徴収方法は_設定した値と同じ徴収方法を返す() {
            ...
            assertThat(sut.get徴収方法().code(), is(DbT2007KibetsuChoshuYuyoEntityGenerator.DEFAULT_徴収方法));
        }
    ...
    public static class getStateTest extends DbzTestBase {
        ...
        public void 状態Modifinedの取得確認() {
            ...
            sut.getEntity().setYuyoStartYMD(new FlexibleDate("20141225"));
