...
public class KaigoShiharaiJohoModelTest extends DbzTestBase {
    ...
    public static class getterSetterTest extends DbzTestBase {
        ...
        public void 戻り値の証記載保険者番号は_設定した値と同じ証記載保険者番号を返す() {
            sut.set証記載保険者番号(DbT7004KaigoShiharaiJohoEntityGenerator.DEFAULT_市町村コード);
            assertThat(sut.get証記載保険者番号(), is(DbT7004KaigoShiharaiJohoEntityGenerator.DEFAULT_市町村コード));
        }
