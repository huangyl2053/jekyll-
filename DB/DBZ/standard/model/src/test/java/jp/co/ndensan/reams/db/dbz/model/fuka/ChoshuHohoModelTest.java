...
public class ChoshuHohoModelTest extends DbzTestBase {
    ...
    public static class getterSetterTest extends DbzTestBase {
        ...
        public void 戻り値の賦課年度は_設定した値と同じ賦課年度を返す() {
            sut.set賦課年度(new FukaNendo(DbT2001ChoshuHohoEntityGenerator.DEFAULT_賦課年度));
            assertThat(sut.get賦課年度().value(), is(DbT2001ChoshuHohoEntityGenerator.DEFAULT_賦課年度));
        }
        ...
        public void 戻り値の徴収方法4月は_設定した値と同じ徴収方法4月を返す() {
            ...
            sut.set徴収方法4月(徴収方法4月);
            assertThat(sut.get徴収方法4月(), is(徴収方法4月));
        }

        @Test
        public void 戻り値の徴収方法5月は_設定した値と同じ徴収方法5月を返す() {
            ChoshuHoho 徴収方法5月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法5月);
            sut.set徴収方法5月(徴収方法5月);
            assertThat(sut.get徴収方法5月(), is(徴収方法5月));
        }

        @Test
        public void 戻り値の徴収方法6月は_設定した値と同じ徴収方法6月を返す() {
            ChoshuHoho 徴収方法6月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法6月);
            sut.set徴収方法6月(徴収方法6月);
            assertThat(sut.get徴収方法6月(), is(徴収方法6月));
        }

        @Test
        public void 戻り値の徴収方法7月は_設定した値と同じ徴収方法7月を返す() {
            ChoshuHoho 徴収方法7月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法7月);
            sut.set徴収方法7月(徴収方法7月);
            assertThat(sut.get徴収方法7月(), is(徴収方法7月));
        }

        @Test
        public void 戻り値の徴収方法8月は_設定した値と同じ徴収方法8月を返す() {
            ChoshuHoho 徴収方法8月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法8月);
            sut.set徴収方法8月(徴収方法8月);
            assertThat(sut.get徴収方法8月(), is(徴収方法8月));
        }

        @Test
        public void 戻り値の徴収方法9月は_設定した値と同じ徴収方法9月を返す() {
            ChoshuHoho 徴収方法9月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法9月);
            sut.set徴収方法9月(徴収方法9月);
            assertThat(sut.get徴収方法9月(), is(徴収方法9月));
        }

        @Test
        public void 戻り値の徴収方法10月は_設定した値と同じ徴収方法10月を返す() {
            ChoshuHoho 徴収方法10月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法10月);
            sut.set徴収方法10月(徴収方法10月);
            assertThat(sut.get徴収方法10月(), is(徴収方法10月));
        }

        @Test
        public void 戻り値の徴収方法11月は_設定した値と同じ徴収方法11月を返す() {
            ChoshuHoho 徴収方法11月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法11月);
            sut.set徴収方法11月(徴収方法11月);
            assertThat(sut.get徴収方法11月(), is(徴収方法11月));
        }

        @Test
        public void 戻り値の徴収方法12月は_設定した値と同じ徴収方法12月を返す() {
            ChoshuHoho 徴収方法12月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法12月);
            sut.set徴収方法12月(徴収方法12月);
            assertThat(sut.get徴収方法12月(), is(徴収方法12月));
        }

        @Test
        public void 戻り値の徴収方法1月は_設定した値と同じ徴収方法1月を返す() {
            ChoshuHoho 徴収方法1月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法1月);
            sut.set徴収方法1月(徴収方法1月);
            assertThat(sut.get徴収方法1月(), is(徴収方法1月));
        }

        @Test
        public void 戻り値の徴収方法2月は_設定した値と同じ徴収方法2月を返す() {
            ChoshuHoho 徴収方法2月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法2月);
            sut.set徴収方法2月(徴収方法2月);
            assertThat(sut.get徴収方法2月(), is(徴収方法2月));
        }

        @Test
        public void 戻り値の徴収方法3月は_設定した値と同じ徴収方法3月を返す() {
            ChoshuHoho 徴収方法3月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法3月);
            sut.set徴収方法3月(徴収方法3月);
            assertThat(sut.get徴収方法3月(), is(徴収方法3月));
        }

        @Test
        public void 戻り値の徴収方法翌4月は_設定した値と同じ徴収方法翌4月を返す() {
            ChoshuHoho 徴収方法4月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法4月);
            sut.set徴収方法翌4月(徴収方法4月);
            assertThat(sut.get徴収方法翌4月(), is(徴収方法4月));
        }

        @Test
        public void 戻り値の徴収方法翌5月は_設定した値と同じ徴収方法翌5月を返す() {
            ChoshuHoho 徴収方法5月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法5月);
            sut.set徴収方法翌5月(徴収方法5月);
            assertThat(sut.get徴収方法翌5月(), is(徴収方法5月));
        }

        @Test
        public void 戻り値の徴収方法翌6月は_設定した値と同じ徴収方法翌6月を返す() {
            ChoshuHoho 徴収方法6月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法6月);
            sut.set徴収方法翌6月(徴収方法6月);
            assertThat(sut.get徴収方法翌6月(), is(徴収方法6月));
        }

        @Test
        public void 戻り値の徴収方法翌7月は_設定した値と同じ徴収方法翌7月を返す() {
            ChoshuHoho 徴収方法7月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法7月);
            sut.set徴収方法翌7月(徴収方法7月);
            assertThat(sut.get徴収方法翌7月(), is(徴収方法7月));
        }

        @Test
        public void 戻り値の徴収方法翌8月は_設定した値と同じ徴収方法翌8月を返す() {
            ChoshuHoho 徴収方法8月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法8月);
            sut.set徴収方法翌8月(徴収方法8月);
            assertThat(sut.get徴収方法翌8月(), is(徴収方法8月));
        }

        @Test
        public void 戻り値の徴収方法翌9月は_設定した値と同じ徴収方法翌9月を返す() {
            ChoshuHoho 徴収方法9月 = ChoshuHoho.toValue(DbT2001ChoshuHohoEntityGenerator.DEFAULT_徴収方法9月);
            sut.set徴収方法翌9月(徴収方法9月);
            assertThat(sut.get徴収方法翌9月(), is(徴収方法9月));
        }
        ...
        public void 戻り値の依頼情報送付済みフラグは_設定した値と同じ依頼情報送付済みフラグを返す() {
            ...
            assertThat(sut.is依頼情報送付済み(), is(DbT2001ChoshuHohoEntityGenerator.DEFAULT_依頼情報送付済みフラグ));
        }
        ...
        public void 戻り値の追加依頼情報送付済みフラグは_設定した値と同じ追加依頼情報送付済みフラグを返す() {
            ...
            assertThat(sut.is追加依頼情報送付済み(), is(DbT2001ChoshuHohoEntityGenerator.DEFAULT_追加依頼情報送付済みフラグ));
        }
    ...
    public static class getStateTest extends DbzTestBase {
        ...
        public void 状態Modifinedの取得確認() {
            ...
            sut.getEntity().setIraiSohuzumiFlag(true);
