...
public class HokenryoDankaiModelTest extends DbzTestBase {
    ...
    public static class getterSetterTest extends DbzTestBase {
        ...
        public void 戻り値の賦課年度は_設定した値と同じ賦課年度を返す() {
            sut.set賦課年度(new FukaNendo(DbT2013HokenryoDankaiEntityGenerator.DEFAULT_賦課年度));
            assertThat(sut.get賦課年度().value(), is(DbT2013HokenryoDankaiEntityGenerator.DEFAULT_賦課年度));
        }
