...
/**
 * サービス種類支給限度額のモデルクラスです。
 *
 * @author LDNS 宋文娟
 */
public class ServiceShuruiShikyuGendoGakuModel implements Serializable {

    private DbT7111ServiceShuruiShikyuGendoGakuEntity entity;

    /**
     * コンストラクタです。
     */
    public ServiceShuruiShikyuGendoGakuModel() {
        entity = new DbT7111ServiceShuruiShikyuGendoGakuEntity();
    }
     ...
     */
    public ServiceShuruiShikyuGendoGakuModel(DbT7111ServiceShuruiShikyuGendoGakuEntity entity) {
        this.entity = entity;
    }

    /**
     * DbT7111ServiceShuruiShikyuGendoGakuEntityを返します。
     *
     * @return DbT7111ServiceShuruiShikyuGendoGakuEntity
     */
    public DbT7111ServiceShuruiShikyuGendoGakuEntity getEntity() {
        return entity;
    }

    /**
     * DbT7111ServiceShuruiShikyuGendoGakuEntityを設定します。
     *
     * @param entity DbT7111ServiceShuruiShikyuGendoGakuEntity
     */
    public void setEntity(DbT7111ServiceShuruiShikyuGendoGakuEntity entity) {
        this.entity = entity;
    }
