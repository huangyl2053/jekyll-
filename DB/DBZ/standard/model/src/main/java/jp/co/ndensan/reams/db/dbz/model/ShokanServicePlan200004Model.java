...
/**
 * 償還払請求サービス計画200004のモデルクラスです。
 *
 * @author LDNS 周杏月
 */
public class ShokanServicePlan200004Model implements Serializable {
     ...
     * コンストラクタです。
     */
    public ShokanServicePlan200004Model() {
        entity = new DbT3045ShokanServicePlan200004Entity();
    }

    /**
     * コンストラクタです。
     *
     * @param entity DbT3045ShokanServicePlan200004Entity
     */
    public ShokanServicePlan200004Model(DbT3045ShokanServicePlan200004Entity entity) {
        this.entity = entity;
    }

    /**
     * DbT3045ShokanServicePlan200004Entityを返します。
     *
     * @return DbT3045ShokanServicePlan200004Entity
     */
    public DbT3045ShokanServicePlan200004Entity getEntity() {
        return entity;
    }

    /**
     * DbT3045ShokanServicePlan200004Entityを設定します。
     *
     * @param entity DbT3045ShokanServicePlan200004Entity
     */
    public void setEntity(DbT3045ShokanServicePlan200004Entity entity) {
        this.entity = entity;
    }
