...
public interface IHihokenshaDaicho {
     ...
     * @return 資格取得事由
     */
    KaigoshikakuShutokuJiyuHihokensha get資格取得事由コード();
     ...
     * @return 資格喪失事由コード
     */
    KaigoshikakuSoshitsuJiyuHihokennsha get資格喪失事由コード();
     ...
     * @return 被保険者区分コード
     */
    ShikakuHihokenshaKubun get被保険者区分コード();
     ...
     * @return 変更事由
     */
    KaigoshikakuHenkoJiyuHihokensha get資格変更事由コード();
     ...
     * @return 適用事由
     */
    KaigoshikakuJutokuTekiyo get住所地特例適用事由コード();
     ...
     * @return 第1号被保険者年齢到達日
     */
    FlexibleDate get第1号被保険者年齢到達年月日();
