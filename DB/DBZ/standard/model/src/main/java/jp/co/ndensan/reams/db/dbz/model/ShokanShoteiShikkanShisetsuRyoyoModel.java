...
/**
 * 償還払請求所定疾患施設療養費等のモデルクラスです。
 *
 * @author LDNS 周杏月
 */
public class ShokanShoteiShikkanShisetsuRyoyoModel implements Serializable {

    private DbT3052ShokanShoteiShikkanShisetsuRyoyoEntity entity;

    /**
     * コンストラクタです。
     */
    public ShokanShoteiShikkanShisetsuRyoyoModel() {
        entity = new DbT3052ShokanShoteiShikkanShisetsuRyoyoEntity();
    }

    /**
     * コンストラクタです。
     *
     * @param entity DbT3052ShokanShoteiShikkanShisetsuRyoyoEntity
     */
    public ShokanShoteiShikkanShisetsuRyoyoModel(DbT3052ShokanShoteiShikkanShisetsuRyoyoEntity entity) {
        this.entity = entity;
    }

    /**
     * DbT3052ShokanShoteiShikkanShisetsuRyoyoEntityを返します。
     *
     * @return DbT3052ShokanShoteiShikkanShisetsuRyoyoEntity
     */
    public DbT3052ShokanShoteiShikkanShisetsuRyoyoEntity getEntity() {
        return entity;
    }

    /**
     * DbT3052ShokanShoteiShikkanShisetsuRyoyoEntityを設定します。
     *
     * @param entity DbT3052ShokanShoteiShikkanShisetsuRyoyoEntity
     */
    public void setEntity(DbT3052ShokanShoteiShikkanShisetsuRyoyoEntity entity) {
        this.entity = entity;
    }
