...
public class HihokenshashoB4LowerEditData implements IHihokenshashoB4CommonEditData {
     ...
     */
    public HihokenshashoB4LowerEditData(HihokenshashoB4 hihokenshasho) throws NullPointerException {
    ...
    public RString getServicetani1() {
        return this.hihokenshasho.servicetani2;
    }

    @Override
    public void setServicetani1(RString servicetani1) {
        this.hihokenshasho.servicetani2 = servicetani1;
    }
