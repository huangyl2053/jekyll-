...
public class ChoshuHohoModel implements Serializable {
     ...
     * @param 徴収方法4月 徴収方法4月
     */
    public void set徴収方法4月(RString 徴収方法4月) {
     ...
     * @param 徴収方法5月 徴収方法5月
     */
    public void set徴収方法5月(RString 徴収方法5月) {
     ...
     * @param 徴収方法6月 徴収方法6月
     */
    public void set徴収方法6月(RString 徴収方法6月) {
     ...
     * @param 徴収方法7月 徴収方法7月
     */
    public void set徴収方法7月(RString 徴収方法7月) {
     ...
     * @param 徴収方法8月 徴収方法8月
     */
    public void set徴収方法8月(RString 徴収方法8月) {
     ...
     * @param 徴収方法9月 徴収方法9月
     */
    public void set徴収方法9月(RString 徴収方法9月) {
     ...
     */
    public void set徴収方法10月(RString 徴収方法10月) {
     ...
     */
    public void set徴収方法11月(RString 徴収方法11月) {
     ...
     */
    public void set徴収方法12月(RString 徴収方法12月) {
     ...
     * @param 徴収方法1月 徴収方法1月
     */
    public void set徴収方法1月(RString 徴収方法1月) {
     ...
     * @param 徴収方法2月 徴収方法2月
     */
    public void set徴収方法2月(RString 徴収方法2月) {
     ...
     * @param 徴収方法3月 徴収方法3月
     */
    public void set徴収方法3月(RString 徴収方法3月) {
     ...
     */
    public void set徴収方法翌4月(RString 徴収方法翌4月) {
     ...
     */
    public void set徴収方法翌5月(RString 徴収方法翌5月) {
     ...
     */
    public void set徴収方法翌6月(RString 徴収方法翌6月) {
     ...
     */
    public void set徴収方法翌7月(RString 徴収方法翌7月) {
     ...
     */
    public void set徴収方法翌8月(RString 徴収方法翌8月) {
     ...
     */
    public void set徴収方法翌9月(RString 徴収方法翌9月) {
     ...
     */
    public void set特別徴収停止事由コード(RString 特別徴収停止事由コード) {
