...
public interface IHihokensaDaicho {
     ...
     * @return 資格取得事由
     */
    KaigoshikakuShutokuJiyuHihokensha get取得事由();
     ...
     * @return 資格喪失事由
     */
    KaigoshikakuSoshitsuJiyuHihokennsha get喪失事由();
     ...
     * @return 変更事由
     */
    KaigoshikakuHenkoJiyuHihokensha get変更事由();
     ...
     * @return 適用事由
     */
    KaigoshikakuJutokuTekiyo get適用事由();
     ...
     * @return 解除事由
     */
    KaigoshikakuJutokuKaijo get解除事由();
