...
/**
 * 上乗せサービス種類支給限度額のモデルクラスです。
 *
 * @author LDNS 宋文娟
 */
public class UwanoseServiceShuruiShikyuGendoGakuModel implements Serializable {

    private DbT7114UwanoseServiceShuruiShikyuGendoGakuEntity entity;

    /**
     * コンストラクタです。
     */
    public UwanoseServiceShuruiShikyuGendoGakuModel() {
        entity = new DbT7114UwanoseServiceShuruiShikyuGendoGakuEntity();
    }

    /**
     * コンストラクタです。
     *
     * @param entity DbT7114UwanoseServiceShuruiShikyuGendoGakuEntity
     */
    public UwanoseServiceShuruiShikyuGendoGakuModel(DbT7114UwanoseServiceShuruiShikyuGendoGakuEntity entity) {
        this.entity = entity;
    }

    /**
     * DbT7114UwanoseServiceShuruiShikyuGendoGakuEntityを返します。
     *
     * @return DbT7114UwanoseServiceShuruiShikyuGendoGakuEntity
     */
    public DbT7114UwanoseServiceShuruiShikyuGendoGakuEntity getEntity() {
        return entity;
    }

    /**
     * DbT7114UwanoseServiceShuruiShikyuGendoGakuEntityを設定します。
     *
     * @param entity DbT7114UwanoseServiceShuruiShikyuGendoGakuEntity
     */
    public void setEntity(DbT7114UwanoseServiceShuruiShikyuGendoGakuEntity entity) {
        this.entity = entity;
    }
