...
/**
 * 居宅給付計画自己作成明細のモデルクラスです。
 *
 * @author LDNS 鄭雪双
 */
public class KyotakuKeikakuJikosakuseiMeisaiModel implements Serializable {

    private DbT3008KyotakuKeikakuJikosakuseiMeisaiEntity entity;

    /**
     * コンストラクタです。
     */
    public KyotakuKeikakuJikosakuseiMeisaiModel() {
        entity = new DbT3008KyotakuKeikakuJikosakuseiMeisaiEntity();
    }
     ...
     */
    public KyotakuKeikakuJikosakuseiMeisaiModel(DbT3008KyotakuKeikakuJikosakuseiMeisaiEntity entity) {
        this.entity = entity;
    }

    /**
     * DbT3008KyotakuKeikakuJikosakuseiMeisaiEntityを返します。
     *
     * @return DbT3008KyotakuKeikakuJikosakuseiMeisaiEntity
     */
    public DbT3008KyotakuKeikakuJikosakuseiMeisaiEntity getEntity() {
        return entity;
    }

    /**
     * DbT3008KyotakuKeikakuJikosakuseiMeisaiEntityを設定します。
     *
     * @param entity DbT3008KyotakuKeikakuJikosakuseiMeisaiEntity
     */
    public void setEntity(DbT3008KyotakuKeikakuJikosakuseiMeisaiEntity entity) {
        this.entity = entity;
    }
     ...
     * @param 給付対象日数 給付対象日数
     */
    public void set給付対象日数(Decimal 給付対象日数) {
