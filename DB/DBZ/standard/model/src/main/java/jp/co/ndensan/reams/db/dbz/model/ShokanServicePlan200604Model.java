...
/**
 * 償還払請求サービス計画200604のモデルクラスです。
 *
 * @author LDNS 周杏月
 */
public class ShokanServicePlan200604Model implements Serializable {
     ...
     * コンストラクタです。
     */
    public ShokanServicePlan200604Model() {
        entity = new DbT3046ShokanServicePlan200604Entity();
    }

    /**
     * コンストラクタです。
     *
     * @param entity DbT3046ShokanServicePlan200604Entity
     */
    public ShokanServicePlan200604Model(DbT3046ShokanServicePlan200604Entity entity) {
        this.entity = entity;
    }

    /**
     * DbT3046ShokanServicePlan200604Entityを返します。
     *
     * @return DbT3046ShokanServicePlan200604Entity
     */
    public DbT3046ShokanServicePlan200604Entity getEntity() {
        return entity;
    }

    /**
     * DbT3046ShokanServicePlan200604Entityを設定します。
     *
     * @param entity DbT3046ShokanServicePlan200604Entity
     */
    public void setEntity(DbT3046ShokanServicePlan200604Entity entity) {
        this.entity = entity;
    }
