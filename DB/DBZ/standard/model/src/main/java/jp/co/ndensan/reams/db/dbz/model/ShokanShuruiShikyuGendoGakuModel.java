...
/**
 * 償還払い給付種類支給限度額のモデルクラスです。
 *
 * @author LDNS 宋文娟
 */
public class ShokanShuruiShikyuGendoGakuModel implements Serializable {

    private DbT7112ShokanShuruiShikyuGendoGakuEntity entity;

    /**
     * コンストラクタです。
     */
    public ShokanShuruiShikyuGendoGakuModel() {
        entity = new DbT7112ShokanShuruiShikyuGendoGakuEntity();
    }
     ...
     */
    public ShokanShuruiShikyuGendoGakuModel(DbT7112ShokanShuruiShikyuGendoGakuEntity entity) {
        this.entity = entity;
    }

    /**
     * DbT7112ShokanShuruiShikyuGendoGakuEntityを返します。
     *
     * @return DbT7112ShokanShuruiShikyuGendoGakuEntity
     */
    public DbT7112ShokanShuruiShikyuGendoGakuEntity getEntity() {
        return entity;
    }

    /**
     * DbT7112ShokanShuruiShikyuGendoGakuEntityを設定します。
     *
     * @param entity DbT7112ShokanShuruiShikyuGendoGakuEntity
     */
    public void setEntity(DbT7112ShokanShuruiShikyuGendoGakuEntity entity) {
        this.entity = entity;
    }
