...
/**
 * 給付管理票200604のモデルクラスです。
 *
 * @author LDNS 鄭雪双
 */
public class KyufuKanrihyo200604Model implements Serializable {

    private DbT3015KyufuKanrihyo200604Entity entity;

    /**
     * コンストラクタです。
     */
    public KyufuKanrihyo200604Model() {
        entity = new DbT3015KyufuKanrihyo200604Entity();
    }
     ...
     */
    public KyufuKanrihyo200604Model(DbT3015KyufuKanrihyo200604Entity entity) {
        this.entity = entity;
    }

    /**
     * DbT3015KyufuKanrihyo200604Entityを返します。
     *
     * @return DbT3015KyufuKanrihyo200604Entity
     */
    public DbT3015KyufuKanrihyo200604Entity getEntity() {
        return entity;
    }

    /**
     * DbT3015KyufuKanrihyo200604Entityを設定します。
     *
     * @param entity DbT3015KyufuKanrihyo200604Entity
     */
    public void setEntity(DbT3015KyufuKanrihyo200604Entity entity) {
        this.entity = entity;
    }
     ...
     */
    public void set限度額適用開始年月(FlexibleYearMonth 限度額適用開始年月) {
        requireNonNull(限度額適用開始年月, UrSystemErrorMessages.値がnull.getReplacedMessage("限度額適用開始年月"));
        entity.setGendogakuTekiyoKaishiYMD(限度額適用開始年月);
    }
     ...
     */
    public void set限度額適用終了年月(FlexibleYearMonth 限度額適用終了年月) {
        requireNonNull(限度額適用終了年月, UrSystemErrorMessages.値がnull.getReplacedMessage("限度額適用終了年月"));
        entity.setGendogakuTekiyoShuryoYMD(限度額適用終了年月);
    }
     ...
     */
    public void set居宅_介護予防支給限度額(int 居宅_介護予防支給限度額) {
     ...
     */
    public void set給付計画単位数(int 給付計画単位数
    ) {
     ...
     */
    public void set限度額管理期間における前月までの給付計画日数(int 限度額管理期間における前月までの給付計画日数) {
     ...
     */
    public void set指定サービス分小計(int 指定サービス分小計) {
     ...
     */
    public void set基準該当サービス分小計(int 基準該当サービス分小計) {
     ...
     */
    public void set給付計画合計単位数_日数(int 給付計画合計単位数_日数) {
     ...
     */
    public void set委託先の居宅介護支援事業所番号(JigyoshaNo 委託先の居宅介護支援事業所番号) {
     ...
     */
    public void set委託先の担当介護支援専門員番号(RString 委託先の担当介護支援専門員番号) {
