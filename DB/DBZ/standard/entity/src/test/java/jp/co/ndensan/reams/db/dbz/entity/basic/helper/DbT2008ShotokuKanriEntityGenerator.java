...
public final class DbT2008ShotokuKanriEntityGenerator {
    ...
    public static final RString DEFAULT_課税区分_住民税減免前 = new RString("Data");
    public static final RString DEFAULT_課税区分_住民税減免後 = new RString("Data");
    ...
    public static DbT2008ShotokuKanriEntity createDbT2008ShotokuKanriEntity() {
        ...
        entity.setKazeiKubun(DEFAULT_課税区分_住民税減免前);
        entity.setKazeiKubunGemmenGo(DEFAULT_課税区分_住民税減免後);
