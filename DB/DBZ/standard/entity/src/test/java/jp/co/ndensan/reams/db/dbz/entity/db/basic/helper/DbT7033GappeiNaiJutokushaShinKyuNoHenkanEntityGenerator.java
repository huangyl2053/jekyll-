...
public final class DbT7033GappeiNaiJutokushaShinKyuNoHenkanEntityGenerator {
    ...
    public static final ShikibetsuCode DEFAULT_識別コード
    （措置元

    ） = new ShikibetsuCode(
    "000001234567890");
    public static final LasdecCode DEFAULT_市町村コード = new LasdecCode("202011");
    public static final LasdecCode DEFAULT_市町村コード
    （措置元
    ...
    public static DbT7033GappeiNaiJutokushaShinKyuNoHenkanEntity createDbT7033GappeiNaiJutokushaShinKyuNoHenkanEntity() {
        ...
        entity.setShikibetsuCodeSochiMoto(DEFAULT_識別コード（措置元
        ）);
        entity.setShichosonCode(DEFAULT_市町村コード);
        entity.setShichosonCodeSochiMoto(DEFAULT_市町村コード（措置元
        ）);
        entity.setHihokenshaNo(DEFAULT_被保険者番号);
        entity.setHihokenshaNoSochiMoto(DEFAULT_被保険者番号（措置元
        ）);
