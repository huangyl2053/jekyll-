...
public final class DbT4021ShiharaiHohoHenkoEntityGenerator {
    ...
    public static final RString DEFAULT_管理区分 = new RString("1");
    public static final YMDHMS DEFAULT_処理日時 = new YMDHMS("20140101102030");
    public static final RString DEFAULT_登録区分 = new RString("1");
    ...
    public static final RString DEFAULT_終了区分 = new RString("1");
    ...
    public static final RString DEFAULT_弁明理由コード = new RString("1");
    public static final FlexibleDate DEFAULT_弁明審査決定年月日 = new FlexibleDate("20140102");
    public static final RString DEFAULT_弁明審査結果区分 = new RString("1");
    ...
    public static final RString DEFAULT_終了申請理由コード = new RString("1");
    public static final FlexibleDate DEFAULT_終了申請審査決定年月日 = new FlexibleDate("20140102");
    public static final RString DEFAULT_終了申請審査結果区分 = new RString("1");
    ...
    public static DbT4021ShiharaiHohoHenkoEntity createDbT4021ShiharaiHohoHenkoEntity() {
        ...
        entity.setBemmei_RiyuCode(DEFAULT_弁明理由コード);
        entity.setBemmei_ShinsaKetteiYMD(DEFAULT_弁明審査決定年月日);
        entity.setBemmei_ShinsaKekkaKubun(DEFAULT_弁明審査結果区分);
        ...
        entity.setShuryoShinsei_RiyuCode(DEFAULT_終了申請理由コード);
        entity.setShuryoShinsei_ShinsaKetteiYMD(DEFAULT_終了申請審査決定年月日);
        entity.setShuryoShinsei_ShinsaKekkaKubun(DEFAULT_終了申請審査結果区分);
