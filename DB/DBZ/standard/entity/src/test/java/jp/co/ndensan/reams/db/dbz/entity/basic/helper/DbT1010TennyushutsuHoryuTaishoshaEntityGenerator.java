...
public final class DbT1010TennyushutsuHoryuTaishoshaEntityGenerator {
    ...
    public static final FlexibleDate DEFAULT_登録届出年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_消除異動年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_消除届出年月日 = new FlexibleDate("19900101");
    ...
    public static DbT1010TennyushutsuHoryuTaishoshaEntity createDbT1010TennyushutsuHoryuTaishoshaEntity() {
        ...
        entity.setTorokuTodokedeYMD(DEFAULT_登録届出年月日);
        entity.setShojoIdoYMD(DEFAULT_消除異動年月日);
        entity.setShojoIdoTodokedeYMD(DEFAULT_消除届出年月日);
        entity.setTenshutsuYoteiIdoYMD(DEFAULT_転出予定異動年月日);
        entity.setTenshutsuKakuteiIdoYMD(DEFAULT_転出確定異動年月日);
        entity.setTenshutsuKakuteiIdoTsuchiYMD(DEFAULT_転出確定異動通知年月日);
