...
/**
 * 賦課Aliveエンティティのテスト用インスタンスを作成する補助クラスです。
 */
public final class DbV2002FukaEntityGenerator {
    ...
    public static final RString DEFAULT_資格取得事由 = new RString("Data");
    public static final FlexibleDate DEFAULT_資格喪失日 = new FlexibleDate("19900101");
    public static final RString DEFAULT_資格喪失事由 = new RString("Data");
    public static final RString DEFAULT_生活保護扶助種類 = new RString("Data");
    ...
    public static final RString DEFAULT_課税区分 = new RString("Data");
    public static final RString DEFAULT_世帯課税区分 = new RString("Data");
    public static final Decimal DEFAULT_合計所得金額 = new Decimal(0);
    public static final Decimal DEFAULT_公的年金収入額 = new Decimal(0);
    public static final RString DEFAULT_保険料段階 = new RString("Data");
    public static final RString DEFAULT_保険料算定段階1 = new RString("Data");
    public static final Decimal DEFAULT_算定年額保険料1 = new Decimal(0);
    public static final FlexibleYearMonth DEFAULT_月割開始年月1 = new FlexibleYearMonth("199010");
    public static final FlexibleYearMonth DEFAULT_月割終了年月1 = new FlexibleYearMonth("199010");
    public static final RString DEFAULT_保険料算定段階2 = new RString("Data");
    public static final Decimal DEFAULT_算定年額保険料2 = new Decimal(0);
    public static final FlexibleYearMonth DEFAULT_月割開始年月2 = new FlexibleYearMonth("199010");
    public static final FlexibleYearMonth DEFAULT_月割終了年月2 = new FlexibleYearMonth("199010");
    public static final YMDHMS DEFAULT_調定日時 = new YMDHMS("20140328000000");
    public static final RString DEFAULT_調定事由1 = new RString("Data");
    public static final RString DEFAULT_調定事由2 = new RString("Data");
    public static final RString DEFAULT_調定事由3 = new RString("Data");
    public static final RString DEFAULT_調定事由4 = new RString("Data");
    public static final RString DEFAULT_更正月 = new RString("Data");
    ...
    public static final RString DEFAULT_保険料段階_仮算定時 = new RString("Data");
    public static final int DEFAULT_徴収方法履歴番号 = 1;
    public static final YMDHMS DEFAULT_異動基準日時 = new YMDHMS("20140328000000");
    public static final RString DEFAULT_口座区分 = new RString("Data");
    public static final RString DEFAULT_境界層区分 = new RString("Data");
    public static final RString DEFAULT_職権区分 = new RString("Data");
    public static final LasdecCode DEFAULT_賦課市町村コード = new LasdecCode("209007");

    /**
     * インスタンス化を防ぐためのプライベートコンストラクタです。
     */
    private DbV2002FukaEntityGenerator() {
    }

    public static DbV2002FukaEntity createDbV2002FukaEntity() {
        DbV2002FukaEntity entity = new DbV2002FukaEntity();
