...
public final class DbT2013HokenryoDankaiEntityGenerator {
    ...
    public static final DankaiIndex DEFAULT_段階インデックス = new DankaiIndex(new RString("04"));
    public static final RankKubun DEFAULT_ランク区分 = new RankKubun(new RString("00"));
