...
public final class DbT1003TashichosonJushochiTokureiEntityGenerator {
    ...
    public static final KaigoshikakuShutokuJiyuTatokuTekiyo DEFAULT_他市町村住所地特例適用事由コード = new KaigoshikakuShutokuJiyuTatokuTekiyo(new Code("21"));
    ...
    public static final KaigoshikakuSoshitsuJiyuTatokuTekiyo DEFAULT_他市町村住所地特例解除事由コード = new KaigoshikakuSoshitsuJiyuTatokuTekiyo(new Code("71"));
