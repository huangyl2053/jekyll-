...
public final class DbT1001HihokenshaDaichoEntityGenerator {
    ...
    public static final KaigoShikakuJutokuTekiyoJiyu DEFAULT_住所地特例適用事由コード = new KaigoShikakuJutokuTekiyoJiyu(new Code("99"));
    ...
    public static final KaigoShikakuJutokuKaijoJiyu DEFAULT_住所地特例解除事由コード = new KaigoShikakuJutokuKaijoJiyu(new Code("99"));
