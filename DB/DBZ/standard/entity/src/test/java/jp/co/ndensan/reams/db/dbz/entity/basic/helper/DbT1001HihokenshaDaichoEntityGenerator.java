...
public final class DbT1001HihokenshaDaichoEntityGenerator {
    ...
    public static final KaigoshikakuHenkoJiyuHihokensha DEFAULT_資格変更事由コード = new KaigoshikakuHenkoJiyuHihokensha(new Code("00"));
    ...
    public static final KaigoshikakuJutokuTekiyo DEFAULT_住所地特例適用事由コード = new KaigoshikakuJutokuTekiyo(new Code("00"));
    ...
    public static final KaigoshikakuJutokuKaijo DEFAULT_住所地特例解除事由コード = new KaigoshikakuJutokuKaijo(new Code("00"));
