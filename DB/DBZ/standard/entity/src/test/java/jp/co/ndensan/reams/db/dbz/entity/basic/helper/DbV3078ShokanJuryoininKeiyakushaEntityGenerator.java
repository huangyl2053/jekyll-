...
/**
 * 還受領委任契約者Aliveエンティティのテスト用インスタンスを作成する補助クラスです。
 */
public final class DbV3078ShokanJuryoininKeiyakushaEntityGenerator {
     ...
     */
    private DbV3078ShokanJuryoininKeiyakushaEntityGenerator() {
    }

    public static DbV3078ShokanJuryoininKeiyakushaEntity createDbV3078ShokanJuryoininKeiyakushaEntity() {
        DbV3078ShokanJuryoininKeiyakushaEntity entity = new DbV3078ShokanJuryoininKeiyakushaEntity();
