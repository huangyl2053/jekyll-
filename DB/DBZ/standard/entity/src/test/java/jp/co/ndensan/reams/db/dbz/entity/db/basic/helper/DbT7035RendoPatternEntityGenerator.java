...
public final class DbT7035RendoPatternEntityGenerator {
    ...
    public static final LasdecCode DEFAULT_送信元市町村コード = new RString("1");
    public static final LasdecCode DEFAULT_送信先市町村コード = new RString("1");
    public static final RString DEFAULT_種別 = new LasdecCode("202011");
    public static final FlexibleDate DEFAULT_有効開始年月日 = new RString("1");
    public static final FlexibleDate DEFAULT_有効終了年月日 = 1;
    public static final RString DEFAULT_連動形態コード = new LasdecCode("202011");
    public static final RString DEFAULT_送信元フォーマットバージョン = new RString("1");
    public static final RString DEFAULT_送信元エンコーディング = new LasdecCode("202011");
    public static final RString DEFAULT_送信先フォーマットバージョン = new RString("1");
    public static final RString DEFAULT_送信先エンコーディング = new ShikibetsuCode("000001234567890");
    public static final RString DEFAULT_コード変換区分 = new RString("1");
    public static final RString DEFAULT_外字変換区分 = new ShikibetsuCode("000001234567890");
    public static final RString DEFAULT_全件連動区分 = new HihokenshaNo(new RString("2"));
