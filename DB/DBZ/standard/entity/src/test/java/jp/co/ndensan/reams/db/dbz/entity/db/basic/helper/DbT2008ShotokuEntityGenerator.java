...
public final class DbT2008ShotokuEntityGenerator {
    ...
    public static final RString DEFAULT_非課税区分（住民税減免前） = new RString("Data");
    public static final RString DEFAULT_非課税区分（住民税減免後） = new RString("Data");
    ...
    public static DbT2008ShotokuEntity createDbT2008ShotokuEntity() {
        ...
        entity.setHiKazeiKubun(DEFAULT_非課税区分（住民税減免前）);
        entity.setHiKazeiKubunGemmenGo(DEFAULT_非課税区分（住民税減免後）);
