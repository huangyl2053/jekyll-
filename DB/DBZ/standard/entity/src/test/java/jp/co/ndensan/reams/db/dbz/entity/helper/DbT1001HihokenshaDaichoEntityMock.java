...
public final class DbT1001HihokenshaDaichoEntityMock {
    ...
    public static DbT1001HihokenshaDaichoEntity create() {
        ...
        entity.setShikakuSoshitsuJiyuCode(new KaigoShikakuSoshitsuJiyu(ShikakuSoshitsuJiyu.なし.getCode()));
        entity.setShikakuSoshitsuTodokedeYMD(new FlexibleDate("00000000"));
        entity.setShikakuSoshitsuYMD(new FlexibleDate("00000000"));
        entity.setShikakuHenkoJiyuCode(new KaigoShikakuHenkoJiyu(ShikakuHenkoJiyu.なし.getCode()));
        entity.setShikakuHenkoTodokedeYMD(new FlexibleDate("00000000"));
        entity.setShikakuHenkoYMD(new FlexibleDate("00000000"));
        entity.setJushochitokureiTekiyoJiyuCode(new KaigoShikakuJutokuTekiyoJiyu(JushochitokureiTekiyoJiyu.なし.getCode()));
        ...
        entity.setJushochitokureiKaijoJiyuCode(new KaigoShikakuJutokuKaijoJiyu(JushochitokureiKaijoJiyu.なし.getCode()));
