...
/**
 * 利用者負担割合明細Newestテーブルの項目定義クラスです。
 */
public enum DbV3114RiyoshaFutanWariaiMeisai implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.3">
    ...
    private DbV3114RiyoshaFutanWariaiMeisai(int maxLength, int scale) {
