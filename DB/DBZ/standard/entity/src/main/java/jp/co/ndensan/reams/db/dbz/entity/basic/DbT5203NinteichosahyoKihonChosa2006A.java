...
/**
 * 認定調査票（基本調査）2006Aテーブルの項目定義クラスです。
 */
public enum DbT5203NinteichosahyoKihonChosa2006A implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    ...
    private DbT5203NinteichosahyoKihonChosa2006A(int maxLength, int scale) {
