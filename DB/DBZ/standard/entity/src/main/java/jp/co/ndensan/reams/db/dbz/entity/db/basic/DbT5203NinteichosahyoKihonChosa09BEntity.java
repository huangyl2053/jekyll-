...
/**
 * 認定調査票（基本調査）09Bテーブルのエンティティクラスです。
 */
public class DbT5203NinteichosahyoKihonChosa09BEntity extends DbTableEntityBase<DbT5203NinteichosahyoKihonChosa09BEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.3">
    @TableName
    public static final RString TABLE_NAME = new RString("DbT5203NinteichosahyoKihonChosa09B");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT5203NinteichosahyoKihonChosa09BEntity}と等しいか判定します。
     * 
     * @param other 比較するエンティティ
     * @return 
     * 比較するエンティティが同じ主キーを持つ{@literal DbT5203NinteichosahyoKihonChosa09BEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT5203NinteichosahyoKihonChosa09BEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT5203NinteichosahyoKihonChosa09BEntity entity) {
