...
/**
 * 認定調査票（特記情報）テーブルの項目定義クラスです。
 */
public enum DbT5205NinteichosahyoTokkijiko implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">
    ...
    private DbT5205NinteichosahyoTokkijiko(int maxLength, int scale) {
