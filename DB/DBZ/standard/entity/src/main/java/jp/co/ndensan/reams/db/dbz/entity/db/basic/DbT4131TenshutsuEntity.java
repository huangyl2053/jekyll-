...
/**
 * 転出情報テーブルのエンティティクラスです。
 */
public class DbT4131TenshutsuEntity extends DbTableEntityBase<DbT4131TenshutsuEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">
    @TableName
    public static final RString TABLE_NAME = new RString("DbT4131Tenshutsu");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT4131TenshutsuEntity}と等しいか判定します。
     * 
     * @param other 比較するエンティティ
     * @return 
     * 比較するエンティティが同じ主キーを持つ{@literal DbT4131TenshutsuEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT4131TenshutsuEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT4131TenshutsuEntity entity) {
