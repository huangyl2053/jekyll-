...
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
     ...
     */
    @Override
    public boolean equalsPrimaryKeys(DbT4205NinteichosahyoTokkijikoChildEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT4205NinteichosahyoTokkijikoChildEntity entity) {
