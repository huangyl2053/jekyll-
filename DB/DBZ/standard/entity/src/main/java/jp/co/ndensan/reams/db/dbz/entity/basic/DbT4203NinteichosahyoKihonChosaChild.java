...
/**
 * 認定調査票（基本調査）（子）テーブルの項目定義クラスです。
 */
public enum DbT4203NinteichosahyoKihonChosaChild implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    ...
    private DbT4203NinteichosahyoKihonChosaChild(int maxLength, int scale) {
