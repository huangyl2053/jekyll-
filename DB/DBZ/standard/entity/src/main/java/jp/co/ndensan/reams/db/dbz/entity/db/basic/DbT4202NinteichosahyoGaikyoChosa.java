...
/**
 * 認定調査票（概況調査）テーブルの項目定義クラスです。
 */
public enum DbT4202NinteichosahyoGaikyoChosa implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">
    ...
    private DbT4202NinteichosahyoGaikyoChosa(int maxLength, int scale) {
