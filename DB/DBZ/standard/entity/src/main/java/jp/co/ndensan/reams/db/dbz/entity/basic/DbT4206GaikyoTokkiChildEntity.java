...
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
     ...
     * @@return 比較するエンティティが同じ主キーを持つ{@literal DbT4206GaikyoTokkiChildEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT4206GaikyoTokkiChildEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT4206GaikyoTokkiChildEntity entity) {
