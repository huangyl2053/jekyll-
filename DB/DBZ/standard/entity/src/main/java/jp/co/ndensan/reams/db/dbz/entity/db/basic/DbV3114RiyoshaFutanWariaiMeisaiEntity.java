...
/**
 * 利用者負担割合明細Newestテーブルのエンティティクラスです。
 */
public class DbV3114RiyoshaFutanWariaiMeisaiEntity extends DbTableEntityBase<DbV3114RiyoshaFutanWariaiMeisaiEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.3">
    @TableName
    public static final RString TABLE_NAME = new RString("DbV3114RiyoshaFutanWariaiMeisai");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbV3114RiyoshaFutanWariaiMeisaiEntity}と等しいか判定します。
     * 
     * @param other 比較するエンティティ
     * @return 
     * 比較するエンティティが同じ主キーを持つ{@literal DbV3114RiyoshaFutanWariaiMeisaiEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbV3114RiyoshaFutanWariaiMeisaiEntity other) {
        if (other == null) {
            return false;
        }
        return true;
     ...
     */
    @Override
    public void shallowCopy(DbV3114RiyoshaFutanWariaiMeisaiEntity entity) {
