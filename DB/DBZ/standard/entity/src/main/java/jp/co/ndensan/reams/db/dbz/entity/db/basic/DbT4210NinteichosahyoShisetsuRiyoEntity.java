 ...
 */
public class DbT4210NinteichosahyoShisetsuRiyoEntity extends DbTableEntityBase<DbT4210NinteichosahyoShisetsuRiyoEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">

    @TableName
    public static final RString TABLE_NAME = new RString("DbT4210NinteichosahyoShisetsuRiyo");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT4210NinteichosahyoShisetsuRiyoEntity}と等しいか判定します。
     *
     * @param other 比較するエンティティ
     * @return
     * 比較するエンティティが同じ主キーを持つ{@literal DbT4210NinteichosahyoShisetsuRiyoEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT4210NinteichosahyoShisetsuRiyoEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT4210NinteichosahyoShisetsuRiyoEntity entity) {
