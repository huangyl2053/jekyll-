...
/**
 * 認定調査票（概況調査）施設利用テーブルのエンティティクラスです。
 */
public class DbT5210NinteichosahyoShisetsuRiyoEntity extends DbTableEntityBase<DbT5210NinteichosahyoShisetsuRiyoEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">

    @TableName
    public static final RString TABLE_NAME = new RString("DbT5210NinteichosahyoShisetsuRiyo");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT5210NinteichosahyoShisetsuRiyoEntity}と等しいか判定します。
     *
     * @param other 比較するエンティティ
     * @return
     * 比較するエンティティが同じ主キーを持つ{@literal DbT5210NinteichosahyoShisetsuRiyoEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT5210NinteichosahyoShisetsuRiyoEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT5210NinteichosahyoShisetsuRiyoEntity entity) {
