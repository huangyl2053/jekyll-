 ...
 *
 */
public class DbT5001NinteiShinseiJohoEntity extends DbTableEntityBase<DbT5001NinteiShinseiJohoEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.7">
     ...
     */
    @Override
    public void shallowCopy(DbT5001NinteiShinseiJohoEntity entity) {
        ...
        this.zenYukoKikan = entity.zenYukoKikan;
        this.johoteikyoDouiUmuKubun = entity.johoteikyoDouiUmuKubun;
        this.ninteichosaIraiRirekiNo = entity.ninteichosaIraiRirekiNo;
        this.ninteichosaShikibetsuCode = entity.ninteichosaShikibetsuCode;
        ...
        this.enkitsuchiDoiUmuKubun = entity.enkitsuchiDoiUmuKubun;
        this.shisetsuNyushoUmuKubun = entity.shisetsuNyushoUmuKubun;
        ...
        this.shinsaKeizokuKubun = entity.shinsaKeizokuKubun;
    ...
    public RString getMd5() {
        return super.toMd5(shinseishoKanriNo, shoriTimestamp, shoKisaiHokenshaNo, shishoCode, hihokenshaNo, shikibetsuCode, ninteiShinseiYMD, ninteiShinseiEdabanCode, ninteiShinseiShinseijiKubunCode, ninteiShinseiHoreiKubunCode, ninteiShinseiYukoKubunCode, shienShinseiKubun, shinseiRiyu, zenYokaigoKubunCode, zenYukoKikan, johoteikyoDouiUmuKubun, ninteichosaIraiRirekiNo, ninteichosaShikibetsuCode, ikenshoIraiRirekiNo, kaigoIryokikanCode, kaigoIshiCode, minashiCode, enkitsuchiDoiUmuKubun, shisetsuNyushoUmuKubun, sichosonRenrakuJiko, torisageKubunCode, torisageRiyu, torisageYMD, shinsaKeizokuKubun, shinsakaiYusenWaritsukeKubunCode, ifSofuYMD);
    }
