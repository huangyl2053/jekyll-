 ...
 */
public class DbT4207NinteichosahyoServiceJokyoEntity extends DbTableEntityBase<DbT4207NinteichosahyoServiceJokyoEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">

    @TableName
    public static final RString TABLE_NAME = new RString("DbT4207NinteichosahyoServiceJokyo");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT4207NinteichosahyoServiceJokyoEntity}と等しいか判定します。
     *
     * @param other 比較するエンティティ
     * @return
     * 比較するエンティティが同じ主キーを持つ{@literal DbT4207NinteichosahyoServiceJokyoEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT4207NinteichosahyoServiceJokyoEntity other) {
        if (other == null) {
            return false;
        }
