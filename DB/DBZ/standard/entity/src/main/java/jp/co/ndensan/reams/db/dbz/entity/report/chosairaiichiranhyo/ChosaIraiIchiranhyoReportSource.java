...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "lbl_jigyoshaNo", length = 7, order = 15)
    public RString lbl_jigyoshaNo;
    ...
    @ReportItem(name = "pageCountForItakusaki", length = 10, order = 18)
    public RString pageCountForItakusaki;
    @ReportItem(name = "listIchiranhyo_1", length = 2, order = 19)
    public RString listIchiranhyo_1;
    @ReportItem(name = "listIchiranhyo_2", length = 18, order = 20)
    public RString listIchiranhyo_2;
    @ReportItem(name = "listIchiranhyo_3", length = 10, order = 21)
    public RString listIchiranhyo_3;
    @ReportItem(name = "listIchiranhyo_4", length = 10, order = 22)
    public RString listIchiranhyo_4;
    @ReportItem(name = "listIchiranhyo_5", length = 8, order = 23)
    public RString listIchiranhyo_5;
    @ReportItem(name = "listIchiranhyo_6", length = 16, order = 24)
    public RString listIchiranhyo_6;
    @ReportItem(name = "listIchiranhyo_7", length = 30, order = 25)
    public RString listIchiranhyo_7;
    @ReportItem(name = "listIchiranhyo_8", length = 2, order = 26)
    public RString listIchiranhyo_8;
    @ReportItem(name = "listIchiranhyo_9", length = 10, order = 27)
    public RString listIchiranhyo_9;
    @ReportItem(name = "listIchiranhyo_10", length = 30, order = 28)
    public RString listIchiranhyo_10;
    @ReportItem(name = "listIchiranhyo_11", length = 13, order = 29)
    public RString listIchiranhyo_11;
    @ReportItem(name = "listIchiranhyo_12", length = 10, order = 30)
    public RString listIchiranhyo_12;
    @ReportItem(name = "tsuchibun1", order = 31)
    public RString tsuchibun1;
    @ReportItem(name = "tsuchibun2", order = 32)
