...
/**
 * 認定調査票（概況調査）記入項目テーブルの項目定義クラスです。
 */
public enum DbT4209NinteichosahyoKinyuItem implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    ...
    private DbT4209NinteichosahyoKinyuItem(int maxLength, int scale) {
