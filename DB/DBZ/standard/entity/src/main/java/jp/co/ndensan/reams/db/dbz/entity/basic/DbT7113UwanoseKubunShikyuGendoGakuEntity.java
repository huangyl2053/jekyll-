...
/**
 * DbT7113UwanoseKubunShikyuGendoGakuの項目定義クラスです
 *
 */
public class DbT7113UwanoseKubunShikyuGendoGakuEntity extends DbTableEntityBase<DbT7113UwanoseKubunShikyuGendoGakuEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.1">
    @TableName
    public static final RString TABLE_NAME = new RString("DbT7113UwanoseKubunShikyuGendoGaku");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT7113UwanoseKubunShikyuGendoGakuEntity}と等しいか判定します。
     * 
     * @param other 比較するエンティティ
     * @@return 
     * 比較するエンティティが同じ主キーを持つ{@literal DbT7113UwanoseKubunShikyuGendoGakuEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT7113UwanoseKubunShikyuGendoGakuEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT7113UwanoseKubunShikyuGendoGakuEntity entity) {
    ...
    public RString getMd5() {
        return super.toMd5(yoKaigoJotaiKubun, tekiyoKaishiYM, shoriTimestamp, tekiyoShuryoYM, shikyuGendoTaniSu);
    }
