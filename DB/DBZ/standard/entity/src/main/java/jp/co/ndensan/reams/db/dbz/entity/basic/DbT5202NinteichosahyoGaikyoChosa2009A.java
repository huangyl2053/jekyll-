...
/**
 * 認定調査票（概況調査）2009Aテーブルの項目定義クラスです。
 */
public enum DbT5202NinteichosahyoGaikyoChosa2009A implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    ...
    private DbT5202NinteichosahyoGaikyoChosa2009A(int maxLength, int scale) {
