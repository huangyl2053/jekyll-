 ...
 */
public class DbT4209NinteichosahyoKinyuItemEntity extends DbTableEntityBase<DbT4209NinteichosahyoKinyuItemEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">

    @TableName
    public static final RString TABLE_NAME = new RString("DbT4209NinteichosahyoKinyuItem");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT4209NinteichosahyoKinyuItemEntity}と等しいか判定します。
     *
     * @param other 比較するエンティティ
     * @@return
     * 比較するエンティティが同じ主キーを持つ{@literal DbT4209NinteichosahyoKinyuItemEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT4209NinteichosahyoKinyuItemEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT4209NinteichosahyoKinyuItemEntity entity) {
