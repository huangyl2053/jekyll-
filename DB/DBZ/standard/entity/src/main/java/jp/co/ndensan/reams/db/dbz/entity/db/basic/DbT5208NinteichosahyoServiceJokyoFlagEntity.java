...
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">
     ...
     */
    @Override
    public boolean equalsPrimaryKeys(DbT5208NinteichosahyoServiceJokyoFlagEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT5208NinteichosahyoServiceJokyoFlagEntity entity) {
