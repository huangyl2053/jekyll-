package jp.co.ndensan.reams.db.dbz.divcontroller.entity.parentdiv.hihokenshainputguide;
/**
 * このコードはツールによって生成されました。
 * このファイルへの変更は、以下の状況下で不正な動作の原因になったり、
 * コードが再生成されるときに損失したりします。
 * Tue Jul 01 21:44:04 JST 2014 
 */
...
public class dgSearchResultOfHihokensha_Row extends DataRow {
    ...
    public dgSearchResultOfHihokensha_Row(Button btnToDecide, RString hihokenshaNo, RString shikibetsuCode, RString hihokenshaKubun, RString shimei, RString kanaShimsei, RString shimeiAndKanaShimsei, RString gender, TextBoxDate birthDay, RString yubinNo, RString jusho, RString kojinNo, RString juminShubetsu, RString setaiCode) {
        super();
