...
public class dgTainoJokyo1_Row extends DataRow {
    ...
    public dgTainoJokyo1_Row(RString txtKi, RString txtHokenryo, RString txtNokigen, RString txtTaino, RString txtJikoKisanYMD, RString txtJikoKisanbiKbn) {
        super();
