...
import jp.co.ndensan.reams.db.dbz.realservice.IShujiiIryokikanManager;
import jp.co.ndensan.reams.db.dbz.realservice.IShujiiManager;
...
import jp.co.ndensan.reams.db.dbz.realservice.ShujiiIryokikanManagerFactory;
import jp.co.ndensan.reams.db.dbz.realservice.ShujiiManagerFactory;
...
public class ShujiiIryokikanAndShujiiInputHandler {
    ...
    private void createZenkaiJoho(Optional<IShinseiRirekiJoho> 申請履歴情報) {
        ...
        Optional<IKoseiShichosonMaster> 構成市町村マスタ = koseiShichosonMaster.find構成市町村(RString.EMPTY);
