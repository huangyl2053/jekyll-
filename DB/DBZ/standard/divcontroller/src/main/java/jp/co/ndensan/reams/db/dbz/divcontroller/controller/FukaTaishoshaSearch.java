...
public class FukaTaishoshaSearch {
    ...
    private FukaTaishoshaSearchResult get対象者(IHihokenshaFinderDiv div) {
    ...
    private List<dgFukaGaitoshaList_Row> toRowList(FukaTaishoshaSearchResult result) {
        List<dgFukaGaitoshaList_Row> rowList = new ArrayList<>();
        for (FukaTaishoshaModel 対象者 : result.getList()) {
