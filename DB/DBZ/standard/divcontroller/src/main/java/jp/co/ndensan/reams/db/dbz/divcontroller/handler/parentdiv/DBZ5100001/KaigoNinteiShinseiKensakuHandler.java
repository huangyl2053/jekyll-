    ...
    public YouKaiGoNinTeiShinJyuKyuParameter 介護認定申請情報受給Parameter() {
        ...
        return YouKaiGoNinTeiShinJyuKyuParameter.
                createParam_受給(
                        ...
                        finderDiv.getTxtNinteiShinseiDateRange().getFromValue().toFlexibleDate(),
                        finderDiv.getTxtNinteiShinseiDateRange().getToValue().toFlexibleDate(),
                        finderDiv.getTxtBirthDateRange().getFromValue().toFlexibleDate(),
                        finderDiv.getTxtBirthDateRange().getToValue().toFlexibleDate(),
                        ...
                        finderDiv.getTxtChosaJisshiDateRange().getFromValue().toFlexibleDate(),
                        finderDiv.getTxtChosaJisshiDateRange().getToValue().toFlexibleDate(),
                        ...
                        finderDiv.getTxtIkenshoKinyuDateRange().getFromValue().toFlexibleDate(),
                        finderDiv.getTxtIkenshoKinyuDateRange().getToValue().toFlexibleDate(),
                        finderDiv.getDdlShujiJohoNetakirido().getSelectedKey(),
                        finderDiv.getDdlShujiJohoNinchido().getSelectedKey(),
                        finderDiv.getTxtIchijiHanteiDateRange().getFromValue().toFlexibleDate(),
                        finderDiv.getTxtIchijiHanteiDateRange().getToValue().toFlexibleDate(),
                        ...
                        認定有効期間,
                        finderDiv.getTxtZenkaiYukoKaishiDateRange().getFromValue().toFlexibleDate(),
                        finderDiv.getTxtZenkaiYukoKaishiDateRange().getToValue().toFlexibleDate(),
    ...
    public YouKaiGoNinTeiShinNiTeiParameter 介護認定申請情報認定Parameter() {
        ...
        return YouKaiGoNinTeiShinNiTeiParameter.
                createParam_認定(
                        ...
                        finderDiv.getTxtIchijiHanteiDateRange().getToValue().toFlexibleDate(),
                        new Code(finderDiv.getDdlIchijiHanteiKekka().getSelectedKey()),
                        finderDiv.getTxtIchiGoHanteiDateRange().getFromValue().toFlexibleDate(),
                        finderDiv.getTxtIchiGoHanteiDateRange().getToValue().toFlexibleDate(),
                        new Code(finderDiv.getDdlIchiGohanteiKekka().getSelectedKey()),
                        new Code(finderDiv.getDdlNijiHanteiKekka().getSelectedKey()),
                        認定有効期間,
                        finderDiv.getTxtNinteiYukoKaishiDateRange().getFromValue().toFlexibleDate(),
                        finderDiv.getTxtNinteiYukoKaishiDateRange().getToValue().toFlexibleDate(),
                        finderDiv.getTxtNinteiYukoShuryoDateRange().getFromValue().toFlexibleDate(),
                        finderDiv.getTxtNinteiYukoShuryoDateRange().getToValue().toFlexibleDate(),
                        finderDiv.getTxtNijiHanteiDateRange().getFromValue().toFlexibleDate(),
                        finderDiv.getTxtNijiHanteiDateRange().getToValue().toFlexibleDate(),
                        finderDiv.getTxtKaisaiDateRange().getFromValue().toFlexibleDate(),
                        finderDiv.getTxtKaisaiDateRange().getToValue().toFlexibleDate(),
