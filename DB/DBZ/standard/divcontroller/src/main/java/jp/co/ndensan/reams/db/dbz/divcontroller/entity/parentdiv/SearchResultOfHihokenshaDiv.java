 ...
 * 不正な動作の原因になります。
 */
import jp.co.ndensan.reams.db.dbz.divcontroller.entity.parentdiv.ISearchResultOfHihokenshaDiv;
import com.fasterxml.jackson.annotation.JsonProperty;
import jp.co.ndensan.reams.db.dbz.divcontroller.entity.parentdiv.ButtonsForSearchResultOfHihokenshaDiv;
 ...
 * @author 自動生成
 */
public class SearchResultOfHihokenshaDiv extends Panel implements ISearchResultOfHihokenshaDiv {
    /*
     * [ private の作成 ]
