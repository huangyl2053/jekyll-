package jp.co.ndensan.reams.db.dbz.divcontroller.entity.parentdiv.shujiiIryokikanandshujiiinput;
/*
...
public class ShujiiIryokikanAndShujiiInputDiv extends Panel implements IShujiiIryokikanAndShujiiInputDiv {
    ...
    public void setShiteiiFlag(boolean shiteiiFlag) {
        createHandler().setShiteiiFlag(shiteiiFlag);
    }
    ...
    public RString getShujiiCode() {
        return this.txtShujiiCode.getValue();
    }

    @Override
    public RString getIryoKikanCode() {
        return this.txtIryoKikanCode.getValue();
    }

    @Override
    public boolean getShiteiiFlag() {
        return !this.chkShiteii.getSelectedItems().isEmpty();
    }

    @Override
    public void setTxtIryoKikanCode(RString iryoKikanCode) {
        this.txtIryoKikanCode.setValue(iryoKikanCode);
    }

    @Override
    public void setTxtIryoKikanName(RString iryoKikanName) {
        this.txtIryoKikanName.setValue(iryoKikanName);
    }

    @Override
    public void setTxtShujiiCode(RString shujiiCode) {
        this.txtShujiiCode.setValue(shujiiCode);
    }

    @Override
    public void setTxtShujiiName(RString shujiiName) {
        this.txtShujiiName.setValue(shujiiName);
    }

    @Override
    public void setChkShiteii(RString chkShiteii) {
        this.chkShiteii.setSelectedItems(null);
    }
