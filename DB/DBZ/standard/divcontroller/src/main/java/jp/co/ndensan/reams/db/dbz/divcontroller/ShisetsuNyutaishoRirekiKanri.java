...
public class ShisetsuNyutaishoRirekiKanri {
    ...
    private void setInputMode(ShisetsuNyutaishoRirekiKanriDiv rirekiDiv, RString mode) {
        ShisetsuNyutaishoInputDiv inputDiv = rirekiDiv.getShisetsuNyutaishoInput();
    ...
    private void setShowShisetsuShurui(ShisetsuNyutaishoRirekiKanriDiv rirekiDiv) {
        ShisetsuNyutaishoInputDiv inputDiv = rirekiDiv.getShisetsuNyutaishoInput();
