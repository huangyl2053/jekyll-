...
public class SogoShokaiGenmenGengakuFutanDiv extends Panel {
    ...
    private TextBoxDate txtGenmenFutanKetteiYMD;
    @JsonProperty("txtGenmenFutanTekiyoKaishiYMD")
    private TextBoxDate txtGenmenFutanTekiyoKaishiYMD;
    @JsonProperty("txtGenmenFutanYukoKigen")
    private TextBoxDate txtGenmenFutanYukoKigen;
    @JsonProperty("txtGenmenFutanKyufuritsu")
    private TextBoxNum txtGenmenFutanKyufuritsu;
    @JsonProperty("txtGenmenFutanFutanshaNo")
    private TextBoxCode txtGenmenFutanFutanshaNo;
    @JsonProperty("txtGenmenFutanJukyushaNo")
    private TextBoxCode txtGenmenFutanJukyushaNo;
    @JsonProperty("txtGenmenFutanKyoshitsuShubetsu")
    private TextBox txtGenmenFutanKyoshitsuShubetsu;
    @JsonProperty("txtGenmenFutanShokuji")
    private TextBoxNum txtGenmenFutanShokuji;
    @JsonProperty("txtGenmenFutanUnit")
    private TextBoxNum txtGenmenFutanUnit;
    @JsonProperty("txtGenmenFutanUnitJun")
    private TextBoxNum txtGenmenFutanUnitJun;
    @JsonProperty("txtGenmenFutanTokuyo")
    private TextBoxNum txtGenmenFutanTokuyo;
    @JsonProperty("txtGenmenFutanRoken")
    private TextBoxNum txtGenmenFutanRoken;
    @JsonProperty("txtGenmenFutanTasho")
    private TextBoxNum txtGenmenFutanTasho;
    @JsonProperty("txtGenmenFutanSeigen")
    private TextBox txtGenmenFutanSeigen;
    @JsonProperty("txtGenmenFutanGengakuKubun")
    private TextBox txtGenmenFutanGengakuKubun;
    @JsonProperty("txtGenmenFutanFutangaku")
    private TextBoxNum txtGenmenFutanFutangaku;
     ...
     */
    @JsonProperty("txtGenmenFutanKetteiKubun")
    public TextBox getTxtGenmenFutanKetteiKubun() {
        return txtGenmenFutanKetteiKubun;
    }
    ...
    @JsonProperty("txtGenmenFutanKetteiYMD")
    public TextBoxDate getTxtGenmenFutanKetteiYMD() {
        return txtGenmenFutanKetteiYMD;
    }
    ...
    @JsonProperty("txtGenmenFutanTekiyoKaishiYMD")
    public TextBoxDate getTxtGenmenFutanTekiyoKaishiYMD() {
        return txtGenmenFutanTekiyoKaishiYMD;
    }
    ...
    @JsonProperty("txtGenmenFutanYukoKigen")
    public TextBoxDate getTxtGenmenFutanYukoKigen() {
        return txtGenmenFutanYukoKigen;
    }
    ...
    @JsonProperty("txtGenmenFutanKyufuritsu")
    public TextBoxNum getTxtGenmenFutanKyufuritsu() {
        return txtGenmenFutanKyufuritsu;
    }
    ...
    @JsonProperty("txtGenmenFutanFutanshaNo")
    public TextBoxCode getTxtGenmenFutanFutanshaNo() {
        return txtGenmenFutanFutanshaNo;
    }
    ...
    @JsonProperty("txtGenmenFutanJukyushaNo")
    public TextBoxCode getTxtGenmenFutanJukyushaNo() {
        return txtGenmenFutanJukyushaNo;
    }
    ...
    @JsonProperty("txtGenmenFutanKyoshitsuShubetsu")
    public TextBox getTxtGenmenFutanKyoshitsuShubetsu() {
        return txtGenmenFutanKyoshitsuShubetsu;
    }
    ...
    @JsonProperty("txtGenmenFutanShokuji")
    public TextBoxNum getTxtGenmenFutanShokuji() {
        return txtGenmenFutanShokuji;
    }
    ...
    @JsonProperty("txtGenmenFutanUnit")
    public TextBoxNum getTxtGenmenFutanUnit() {
        return txtGenmenFutanUnit;
    }
    ...
    @JsonProperty("txtGenmenFutanUnitJun")
    public TextBoxNum getTxtGenmenFutanUnitJun() {
        return txtGenmenFutanUnitJun;
    }
    ...
    @JsonProperty("txtGenmenFutanTokuyo")
    public TextBoxNum getTxtGenmenFutanTokuyo() {
        return txtGenmenFutanTokuyo;
    }
    ...
    @JsonProperty("txtGenmenFutanRoken")
    public TextBoxNum getTxtGenmenFutanRoken() {
        return txtGenmenFutanRoken;
    }
    ...
    @JsonProperty("txtGenmenFutanTasho")
    public TextBoxNum getTxtGenmenFutanTasho() {
        return txtGenmenFutanTasho;
    }
    ...
    @JsonProperty("txtGenmenFutanSeigen")
    public TextBox getTxtGenmenFutanSeigen() {
        return txtGenmenFutanSeigen;
    }
    ...
    @JsonProperty("txtGenmenFutanGengakuKubun")
    public TextBox getTxtGenmenFutanGengakuKubun() {
        return txtGenmenFutanGengakuKubun;
    }
    ...
    @JsonProperty("txtGenmenFutanFutangaku")
    public TextBoxNum getTxtGenmenFutanFutangaku() {
        return txtGenmenFutanFutangaku;
    }
