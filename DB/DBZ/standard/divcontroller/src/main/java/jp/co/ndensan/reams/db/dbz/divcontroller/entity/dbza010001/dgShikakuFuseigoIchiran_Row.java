...
public class dgShikakuFuseigoIchiran_Row extends DataRow {
    ...
    private TextBoxFlexibleDate txtSeiYmd;
    ...
    public dgShikakuFuseigoIchiran_Row() {
        super();
        this.txtIgnore = RString.EMPTY;
        this.btnDecide = new Button();
        this.txtShuseiZumi = RString.EMPTY;
        ...
        this.txtSeiYmd = new TextBoxFlexibleDate();
        this.txtKetsugo03 = RString.EMPTY;
        this.txtSeibetsu = RString.EMPTY;
        this.txtNenrei = RString.EMPTY;
        this.txtKetsugo04 = RString.EMPTY;
        this.txtFuseigo = RString.EMPTY;
        this.txtJukiTorokuJiyu = RString.EMPTY;
        this.txtShikakuShutokuJiyu = RString.EMPTY;
        this.txtKetsugo05 = RString.EMPTY;
        this.txtJukiTorokuYmd = new TextBoxFlexibleDate();
        this.txtShikakuShutokuYmd = new TextBoxFlexibleDate();
        this.txtKetsugo06 = RString.EMPTY;
        this.txtJukiShojoJiyu = RString.EMPTY;
        this.txtShikakuSoshitsuJiyu = RString.EMPTY;
        this.txtKetsugo07 = RString.EMPTY;
        this.txtJukiShojoYmd = new TextBoxFlexibleDate();
        this.txtShikakuSoshitsuYmd = new TextBoxFlexibleDate();
        this.txtKetsugo08 = RString.EMPTY;
        this.txtJukiTorokuTodokedeYmd = new TextBoxFlexibleDate();
        this.txtJukiShojoTodokedeYmd = new TextBoxFlexibleDate();
        this.txtShikakuShutokuTodokedeYmd = new TextBoxFlexibleDate();
        this.txtShikakuSoshitsuTodokedeYmd = new TextBoxFlexibleDate();
        this.txtDemoKey = RString.EMPTY;
    }
    ...
    public dgShikakuFuseigoIchiran_Row(RString txtIgnore, Button btnDecide, RString txtShuseiZumi, RString txtHihoNo, RString txtShikibetsuCode, RString txtKetsugo01, RString txtKanaShimei, RString txtShimei, RString txtKetsugo02, RString txtJuminShu, TextBoxFlexibleDate txtSeiYmd, RString txtKetsugo03, RString txtSeibetsu, RString txtNenrei, RString txtKetsugo04, RString txtFuseigo, RString txtJukiTorokuJiyu, RString txtShikakuShutokuJiyu, RString txtKetsugo05, TextBoxFlexibleDate txtJukiTorokuYmd, TextBoxFlexibleDate txtShikakuShutokuYmd, RString txtKetsugo06, RString txtJukiShojoJiyu, RString txtShikakuSoshitsuJiyu, RString txtKetsugo07, TextBoxFlexibleDate txtJukiShojoYmd, TextBoxFlexibleDate txtShikakuSoshitsuYmd, RString txtKetsugo08, TextBoxFlexibleDate txtJukiTorokuTodokedeYmd, TextBoxFlexibleDate txtJukiShojoTodokedeYmd, TextBoxFlexibleDate txtShikakuShutokuTodokedeYmd, TextBoxFlexibleDate txtShikakuSoshitsuTodokedeYmd, RString txtDemoKey) {
        ...
        this.setOriginalData("txtShuseiZumi", txtShuseiZumi);
        ...
        this.setOriginalData("txtSeiYmd", txtSeiYmd);
        ...
        this.setOriginalData("txtDemoKey", txtDemoKey);
        this.txtIgnore = txtIgnore;
        this.btnDecide = btnDecide;
        this.txtShuseiZumi = txtShuseiZumi;
        ...
        this.txtDemoKey = txtDemoKey;
    }

    public RString getTxtIgnore() {
        return txtIgnore;
    }
    ...
    public RString getTxtShuseiZumi() {
        return txtShuseiZumi;
    }
    ...
    public TextBoxFlexibleDate getTxtSeiYmd() {
        return txtSeiYmd;
    }
    ...
    public RString getTxtDemoKey() {
        return txtDemoKey;
    }

    public void setTxtIgnore(RString txtIgnore) {
        this.setOriginalData("txtIgnore", txtIgnore);
        this.txtIgnore = txtIgnore;
    }
    ...
    public void setTxtShuseiZumi(RString txtShuseiZumi) {
        this.setOriginalData("txtShuseiZumi", txtShuseiZumi);
        this.txtShuseiZumi = txtShuseiZumi;
    }
    ...
    public void setTxtSeiYmd(TextBoxFlexibleDate txtSeiYmd) {
        this.setOriginalData("txtSeiYmd", txtSeiYmd);
        this.txtSeiYmd = txtSeiYmd;
    }
    ...
    public void setTxtNenrei(RString txtNenrei) {
        this.setOriginalData("txtNenrei", txtNenrei);
        this.txtNenrei = txtNenrei;
    }
    ...
    public void setTxtFuseigo(RString txtFuseigo) {
        this.setOriginalData("txtFuseigo", txtFuseigo);
        this.txtFuseigo = txtFuseigo;
    }
    ...
    public void setTxtDemoKey(RString txtDemoKey) {
        this.setOriginalData("txtDemoKey", txtDemoKey);
        this.txtDemoKey = txtDemoKey;
    }
