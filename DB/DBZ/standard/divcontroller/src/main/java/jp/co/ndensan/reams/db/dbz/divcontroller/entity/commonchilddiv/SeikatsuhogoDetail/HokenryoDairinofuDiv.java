...
public class HokenryoDairinofuDiv extends Panel {
    ...
    @JsonProperty("txtDainoNofuYM")
    private TextBoxDate txtDainoNofuYM;
    ...
    /*
     * setradDairinofuKubun
     * @param radDairinofuKubun radDairinofuKubun
     */
    @JsonProperty("radDairinofuKubun")
    ...
    /*
     * settxtDainoNofuYM
     * @param txtDainoNofuYM txtDainoNofuYM
     */
    @JsonProperty("txtDainoNofuYM")
    public void setTxtDainoNofuYM(TextBoxDate txtDainoNofuYM) {
        this.txtDainoNofuYM = txtDainoNofuYM;
    }
