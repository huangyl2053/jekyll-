 ...
 */
package jp.co.ndensan.reams.db.dbz.divcontroller.handler.commonchilddiv.kihonchosainput6;
...
public class KihonChosaInputHandler6 {
    ...
    public void onClick_btnConfirm() {
        ArrayList<KihonChosaInput> 認定調査基本情報リスト = ViewStateHolder.get(ViewStateKey.第六群認定調査基本情報リスト, ArrayList.class);
        if (null == 認定調査基本情報リスト) {
