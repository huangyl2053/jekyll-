...
public class dgHihokenshaSearchGaitosha_Row extends DataRow {
    ...
    public dgHihokenshaSearchGaitosha_Row(Boolean chkCreateMoshitatesho, Button btnSelect, TextBoxCode txtJigyoshaNo, RString txtJigyoshaName, TextBoxCode txtHihoNo, RString txtHihoName, RString txtKagoForm, TextBoxDate txtTeikyoYM, RString txtKyufuJissekiSakuseiKubun, RString txtKyufuKubun, TextBoxDate txtShinsaYM) {
        super();
