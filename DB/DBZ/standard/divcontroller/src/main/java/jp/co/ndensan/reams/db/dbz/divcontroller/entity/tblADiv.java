 ...
 * @author 自動生成
 */
public class tblADiv extends TablePanel {
    /*
     * [ private の作成 ]
    ...
    private celJigyoshaTitleAttblA celJigyoshaTitle;
    @JsonProperty("celTodokedeDateTitle")
    private celTodokedeDateTitleAttblA celTodokedeDateTitle;
    @JsonProperty("celJigyosha1")
    private celJigyosha1AttblA celJigyosha1;
    @JsonProperty("celTodokedeDate1")
    private celTodokedeDate1AttblA celTodokedeDate1;
    @JsonProperty("celJigyosha2")
    private celJigyosha2AttblA celJigyosha2;
    @JsonProperty("celTodokedeDate2")
    private celTodokedeDate2AttblA celTodokedeDate2;
    @JsonProperty("celJigyosha3")
    private celJigyosha3AttblA celJigyosha3;
    @JsonProperty("celTodokedeDate3")
    private celTodokedeDate3AttblA celTodokedeDate3;
     ...
     */
    @JsonProperty("celJigyoshaTitle")
    private celJigyoshaTitleAttblA getCelJigyoshaTitle() {
        return celJigyoshaTitle;
    }

    @JsonProperty("celJigyoshaTitle")
    private void setCelJigyoshaTitle(celJigyoshaTitleAttblA celJigyoshaTitle) {
        this.celJigyoshaTitle=celJigyoshaTitle;
    }

    @JsonProperty("celTodokedeDateTitle")
    private celTodokedeDateTitleAttblA getCelTodokedeDateTitle() {
        return celTodokedeDateTitle;
    }

    @JsonProperty("celTodokedeDateTitle")
    private void setCelTodokedeDateTitle(celTodokedeDateTitleAttblA celTodokedeDateTitle) {
        this.celTodokedeDateTitle=celTodokedeDateTitle;
    }

    @JsonProperty("celJigyosha1")
    private celJigyosha1AttblA getCelJigyosha1() {
        return celJigyosha1;
    }

    @JsonProperty("celJigyosha1")
    private void setCelJigyosha1(celJigyosha1AttblA celJigyosha1) {
        this.celJigyosha1=celJigyosha1;
    }

    @JsonProperty("celTodokedeDate1")
    private celTodokedeDate1AttblA getCelTodokedeDate1() {
        return celTodokedeDate1;
    }

    @JsonProperty("celTodokedeDate1")
    private void setCelTodokedeDate1(celTodokedeDate1AttblA celTodokedeDate1) {
        this.celTodokedeDate1=celTodokedeDate1;
    }

    @JsonProperty("celJigyosha2")
    private celJigyosha2AttblA getCelJigyosha2() {
        return celJigyosha2;
    }

    @JsonProperty("celJigyosha2")
    private void setCelJigyosha2(celJigyosha2AttblA celJigyosha2) {
        this.celJigyosha2=celJigyosha2;
    }

    @JsonProperty("celTodokedeDate2")
    private celTodokedeDate2AttblA getCelTodokedeDate2() {
        return celTodokedeDate2;
    }

    @JsonProperty("celTodokedeDate2")
    private void setCelTodokedeDate2(celTodokedeDate2AttblA celTodokedeDate2) {
        this.celTodokedeDate2=celTodokedeDate2;
    }

    @JsonProperty("celJigyosha3")
    private celJigyosha3AttblA getCelJigyosha3() {
        return celJigyosha3;
    }

    @JsonProperty("celJigyosha3")
    private void setCelJigyosha3(celJigyosha3AttblA celJigyosha3) {
        this.celJigyosha3=celJigyosha3;
    }

    @JsonProperty("celTodokedeDate3")
    private celTodokedeDate3AttblA getCelTodokedeDate3() {
        return celTodokedeDate3;
    }

    @JsonProperty("celTodokedeDate3")
    private void setCelTodokedeDate3(celTodokedeDate3AttblA celTodokedeDate3) {
 ...
 * @author 自動生成
 */
class celJigyoshaTitleAttblA extends TableCell {
 ...
 * @author 自動生成
 */
class celTodokedeDateTitleAttblA extends TableCell {
 ...
 * @author 自動生成
 */
class celJigyosha1AttblA extends TableCell {
 ...
 * @author 自動生成
 */
class celTodokedeDate1AttblA extends TableCell {
 ...
 * @author 自動生成
 */
class celJigyosha2AttblA extends TableCell {
 ...
 * @author 自動生成
 */
class celTodokedeDate2AttblA extends TableCell {
 ...
 * @author 自動生成
 */
class celJigyosha3AttblA extends TableCell {
 ...
 * @author 自動生成
 */
class celTodokedeDate3AttblA extends TableCell {
