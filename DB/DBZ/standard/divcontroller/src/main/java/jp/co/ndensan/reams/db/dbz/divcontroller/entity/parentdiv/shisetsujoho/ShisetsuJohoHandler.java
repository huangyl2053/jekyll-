 ...
 */
package jp.co.ndensan.reams.db.dbz.divcontroller.entity.parentdiv.shisetsujoho;
...
public class ShisetsuJohoHandler {
     ...
     * @param riyokino 利用機能
     */
    public void set利用機能(int riyokino) {
        switch (riyokino) {
            case 0:
                div.setMode_利用機能(利用機能.台帳種別表示機能);
                break;
            case 1:
                div.setMode_利用機能(利用機能.被保険者対象機能);
                break;
            case 2:
                div.setMode_利用機能(利用機能.他市町村住所地特例者対象機能);
                break;
            case 3:
