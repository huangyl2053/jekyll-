...
public class JushochiTokureiRirekiListHandler {
    ...
    private static final RString PANEL_SESSION_EDITING_KEY = new RString("jushochiTokureiRireki_Editing");
...
//    }
    ...
    public IItemList<HihokenshaDaichoModel> getEditing被保険者台帳情報() {
        IItemList<HihokenshaDaichoModel> editing被保険者台帳List
                = ItemList.of(PanelSessionAccessor.get(jutokuRirekiDiv, PANEL_SESSION_EDITING_KEY, ArrayList.class));
...
//        return ItemList.of(mergedList);
    ...
    public void set被保険者台帳情報(IItemList<HihokenshaDaichoModel> 被保険者台帳List) {
        ...
        PanelSessionAccessor.put(jutokuRirekiDiv, PANEL_SESSION_EDITING_KEY, (ArrayList) 被保険者台帳List.toList());
    }
...
//    }
     ...
     */
    public Optional<HihokenshaDaicho> createEntryData() {

        return Optional.empty();
//        Optional<HihokenshaDaicho> baseDataModel;
//        IItemList<HihokenshaDaicho> sorted被保険者台帳履歴
//                = getEditing被保険者台帳情報().sorted(HihokenshaDaichoModelComparators.orderBy処理日時.desc());
