package jp.co.ndensan.reams.db.dbz.divcontroller.entity.parentdiv.NinteiChosaIkkatsuInput;
/*
...
public class tblJikanwaku1Div extends TablePanel {
    ...
    private celTab1R1C1AttblJikanwaku1 celTab1R1C1;
    @JsonProperty("celTab1R1C2")
    private celTab1R1C2AttblJikanwaku1 celTab1R1C2;
    @JsonProperty("celTab1R1C3")
    private celTab1R1C3AttblJikanwaku1 celTab1R1C3;
    @JsonProperty("celTab1R1C4")
    private celTab1R1C4AttblJikanwaku1 celTab1R1C4;
    @JsonProperty("celTab1R1C5")
    private celTab1R1C5AttblJikanwaku1 celTab1R1C5;
    @JsonProperty("celTab1R2C1")
    private celTab1R2C1AttblJikanwaku1 celTab1R2C1;
    @JsonProperty("celTab1R2C2")
    private celTab1R2C2AttblJikanwaku1 celTab1R2C2;
    @JsonProperty("celTab1R2C3")
    private celTab1R2C3AttblJikanwaku1 celTab1R2C3;
    @JsonProperty("celTab1R2C4")
    private celTab1R2C4AttblJikanwaku1 celTab1R2C4;
    @JsonProperty("celTab1R2C5")
    private celTab1R2C5AttblJikanwaku1 celTab1R2C5;
    @JsonProperty("celTab1R3C1")
    private celTab1R3C1AttblJikanwaku1 celTab1R3C1;
    @JsonProperty("celTab1R3C2")
    private celTab1R3C2AttblJikanwaku1 celTab1R3C2;
    @JsonProperty("celTab1R3C3")
    private celTab1R3C3AttblJikanwaku1 celTab1R3C3;
    @JsonProperty("celTab1R3C4")
    private celTab1R3C4AttblJikanwaku1 celTab1R3C4;
    @JsonProperty("celTab1R3C5")
    private celTab1R3C5AttblJikanwaku1 celTab1R3C5;
    ...
    public CheckBoxList getChkJikanwaku1() {
        return this.celTab1R1C1.getChkJikanwaku1();
    }

    @JsonIgnore
    public CheckBoxList getChkJikanwaku2() {
        return this.celTab1R1C2.getChkJikanwaku2();
    }

    @JsonIgnore
    public CheckBoxList getChkJikanwaku3() {
        return this.celTab1R1C3.getChkJikanwaku3();
    }

    @JsonIgnore
    public CheckBoxList getChkJikanwaku4() {
        return this.celTab1R1C4.getChkJikanwaku4();
    }

    @JsonIgnore
    public CheckBoxList getChkJikanwaku5() {
        return this.celTab1R1C5.getChkJikanwaku5();
    }

    @JsonIgnore
    public TextBoxTime getTxtStartTime1() {
        return this.celTab1R2C1.getTxtStartTime1();
    }

    @JsonIgnore
    public TextBoxTime getTxtStartTime2() {
        return this.celTab1R2C2.getTxtStartTime2();
    }

    @JsonIgnore
    public TextBoxTime getTxtStartTime3() {
        return this.celTab1R2C3.getTxtStartTime3();
    }

    @JsonIgnore
    public TextBoxTime getTxtStartTime4() {
        return this.celTab1R2C4.getTxtStartTime4();
    }

    @JsonIgnore
    public TextBoxTime getTxtStartTime5() {
        return this.celTab1R2C5.getTxtStartTime5();
    }

    @JsonIgnore
    public TextBoxTime getTxtEndTime1() {
        return this.celTab1R3C1.getTxtEndTime1();
    }

    @JsonIgnore
    public TextBoxTime getTxtEndTime2() {
        return this.celTab1R3C2.getTxtEndTime2();
    }

    @JsonIgnore
    public TextBoxTime getTxtEndTime3() {
        return this.celTab1R3C3.getTxtEndTime3();
    }

    @JsonIgnore
    public TextBoxTime getTxtEndTime4() {
        return this.celTab1R3C4.getTxtEndTime4();
    }

    @JsonIgnore
    public TextBoxTime getTxtEndTime5() {
        return this.celTab1R3C5.getTxtEndTime5();
    }
