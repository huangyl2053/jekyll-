...
public class dgTainoJokyo1_Row extends DataRow {
    ...
    public dgTainoJokyo1_Row(RString txtKi, RString txtHokenryo, RString txtNokigen, RString txtTaino, TextBoxFlexibleDate txtJikoKisanYMD, RString txtJikoKisanbiKbn) {
        super();
        this.setOriginalData("txtKi", txtKi);
        this.setOriginalData("txtHokenryo", txtHokenryo);
        this.setOriginalData("txtNokigen", txtNokigen);
