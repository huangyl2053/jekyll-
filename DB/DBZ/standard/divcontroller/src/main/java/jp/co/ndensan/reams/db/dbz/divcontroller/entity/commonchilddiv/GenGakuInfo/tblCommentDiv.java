...
public class tblCommentDiv extends TablePanel {
    ...
    /*
     * setcelTainocolorKanno
     * @param celTainocolorKanno celTainocolorKanno
     */
    @JsonProperty("celTainocolorKanno")
    ...
    /*
     * setcelTainoSetsumeiKanno
     * @param celTainoSetsumeiKanno celTainoSetsumeiKanno
     */
    @JsonProperty("celTainoSetsumeiKanno")
    ...
    /*
     * setcelTainocolorMitorai
     * @param celTainocolorMitorai celTainocolorMitorai
     */
    @JsonProperty("celTainocolorMitorai")
    ...
    /*
     * setcelTainoSetsumeiMiTorai
     * @param celTainoSetsumeiMiTorai celTainoSetsumeiMiTorai
     */
    @JsonProperty("celTainoSetsumeiMiTorai")
    ...
    /*
     * setcelTainocolorTorai
     * @param celTainocolorTorai celTainocolorTorai
     */
    @JsonProperty("celTainocolorTorai")
    ...
    /*
     * setcelTainoSetsumeiTorai
     * @param celTainoSetsumeiTorai celTainoSetsumeiTorai
     */
    @JsonProperty("celTainoSetsumeiTorai")
    ...
    /*
     * setcelTainocolorTaishoGai
     * @param celTainocolorTaishoGai celTainocolorTaishoGai
     */
    @JsonProperty("celTainocolorTaishoGai")
    ...
    /*
     * setcelTainoSetsumeiTaishoGai
     * @param celTainoSetsumeiTaishoGai celTainoSetsumeiTaishoGai
     */
    @JsonProperty("celTainoSetsumeiTaishoGai")
    ...
    /*
     * setcelTainocolorKano
     * @param celTainocolorKano celTainocolorKano
     */
    @JsonProperty("celTainocolorKano")
    ...
    /*
     * setcelTainoSetsumeiKano
     * @param celTainoSetsumeiKano celTainoSetsumeiKano
     */
    @JsonProperty("celTainoSetsumeiKano")
...
class celTainoSetsumeiKannoAttblComment extends TableCell {
    ...
    /*
     * setlblTainoSetsumeiKanno
     * @param lblTainoSetsumeiKanno lblTainoSetsumeiKanno
     */
    @JsonProperty("lblTainoSetsumeiKanno")
...
class celTainoSetsumeiMiToraiAttblComment extends TableCell {
    ...
    /*
     * setlblTainoSetsumeiMiTorai
     * @param lblTainoSetsumeiMiTorai lblTainoSetsumeiMiTorai
     */
    @JsonProperty("lblTainoSetsumeiMiTorai")
...
class celTainocolorToraiAttblComment extends TableCell {
    ...
    /*
     * setTainocolorTorai
     * @param TainocolorTorai TainocolorTorai
     */
    @JsonProperty("TainocolorTorai")
...
class celTainoSetsumeiToraiAttblComment extends TableCell {
    ...
    /*
     * setlblTainoSetsumeiTorai
     * @param lblTainoSetsumeiTorai lblTainoSetsumeiTorai
     */
    @JsonProperty("lblTainoSetsumeiTorai")
...
class celTainocolorTaishoGaiAttblComment extends TableCell {
    ...
    /*
     * setTainocolorTaishoGai
     * @param TainocolorTaishoGai TainocolorTaishoGai
     */
    @JsonProperty("TainocolorTaishoGai")
...
class celTainoSetsumeiTaishoGaiAttblComment extends TableCell {
    ...
    /*
     * setlblTainoSetsumeiTaishoGai
     * @param lblTainoSetsumeiTaishoGai lblTainoSetsumeiTaishoGai
     */
    @JsonProperty("lblTainoSetsumeiTaishoGai")
...
class celTainoSetsumeiKanoAttblComment extends TableCell {
    ...
    /*
     * setlblTainoSetsumeiKano
     * @param lblTainoSetsumeiKano lblTainoSetsumeiKano
     */
    @JsonProperty("lblTainoSetsumeiKano")
