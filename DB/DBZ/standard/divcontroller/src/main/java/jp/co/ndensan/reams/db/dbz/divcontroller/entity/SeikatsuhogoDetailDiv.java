 ...
 * 不正な動作の原因になります。
 */
import jp.co.ndensan.reams.db.dbz.divcontroller.entity.ISeikatsuhogoDetailDiv;
import com.fasterxml.jackson.annotation.JsonProperty;
import jp.co.ndensan.reams.db.dbz.divcontroller.entity.FujoShuruiDiv;
import jp.co.ndensan.reams.db.dbz.divcontroller.entity.SeikatsuhogoDetailSubDiv;
