...
public class NinteiShinseishaFinderDiv extends Panel implements INinteiShinseishaFinderDiv {
 ...
 /*
    ...
    public TextBox getTxtHihokenshaName() {
        return this.getTpl1().getTxtHihokenshaName();
    }

    @JsonIgnore
    public DropDownList getDdlHihokenshaNameMatchType() {
        return this.getTpl1().getDdlHihokenshaNameMatchType();
    }

    @JsonIgnore
    public CheckBoxList getChkMinashiFlag() {
        return this.getTpl1().getChkMinashiFlag();
    }

    @JsonIgnore
    public TextBoxFlexibleDate getTxtNinteiShinseiDateFrom() {
        return this.getTpl1().getTxtNinteiShinseiDateFrom();
    }

    @JsonIgnore
    public Label getLblNinteiShinseiDate() {
        return this.getTpl1().getLblNinteiShinseiDate();
    }

    @JsonIgnore
    public TextBoxFlexibleDate getTxtNinteiShinseiDateTo() {
        return this.getTpl1().getTxtNinteiShinseiDateTo();
    }

    @JsonIgnore
    public TextBoxFlexibleDate getTxtBirthDateFrom() {
        return this.getTpl1().getTxtBirthDateFrom();
    }

    @JsonIgnore
    public Label getLblBirthDate() {
        return this.getTpl1().getLblBirthDate();
    }

    @JsonIgnore
    public TextBoxFlexibleDate getTxtBirthDateTO() {
        return this.getTpl1().getTxtBirthDateTO();
    }

    @JsonIgnore
    public DropDownList getDdlShinseijiShinseiKubun() {
        return this.getTpl1().getDdlShinseijiShinseiKubun();
    }

    @JsonIgnore
    public CheckBoxList getChkSeibetsu() {
        return this.getTpl1().getChkSeibetsu();
    }

    @JsonIgnore
    public ISaikinShorishaDiv getCcdSaikinShorisha() {
        return this.getTpl1().getCcdSaikinShorisha();
    }
