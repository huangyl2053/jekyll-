...
public class NinteiShinseishaFinderDiv extends Panel implements INinteiShinseishaFinderDiv {
    ...
    @Override
    public void updateSaikinShorisha(ShoKisaiHokenshaNo shoKisaiHokenshaNo, RString hihokenshaNo, RString hihokenshaName) {
        this.getCcdSaikinShorisha().update(hihokenshaNo, hihokenshaName, shoKisaiHokenshaNo);
    }
