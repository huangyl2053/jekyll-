 ...
 * 不正な動作の原因になります。
 */
import jp.co.ndensan.reams.db.dbz.divcontroller.entity.IKaigoTeikeibunDiv;
import com.fasterxml.jackson.annotation.JsonProperty;
import jp.co.ndensan.reams.db.dbz.divcontroller.entity.dgTeikeibun_Row;
 ...
 * @author 自動生成
 */
public class KaigoTeikeibunDiv extends Panel implements IKaigoTeikeibunDiv {
    /*
     * [ private の作成 ]
