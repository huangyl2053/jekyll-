...
/**
 * dgShotokuRireki_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgShotokuRireki_Row extends DataRow {
    ...
    public dgShotokuRireki_Row(RString txtKetsugo01, RString txtRirekiNo, RString txtShimei, RString txtJuminzeiGenmenMae, RString txtJuminzeiGenmenAto, RString txtJuminzei, RString txtGekihenTaishosha, RString txtKetsugo03, RString txtKetsugo04, RString txtTorokuGyomu) {
        super();
        this.setOriginalData("txtKetsugo01", txtKetsugo01);
        this.setOriginalData("txtRirekiNo", txtRirekiNo);
        this.setOriginalData("txtShimei", txtShimei);
