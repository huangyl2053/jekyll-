...
public final class ShikakuHenkoRirekiValidationHelper {
    ...
    public static ValidationMessageControlPairs validate資格変更(TextBoxFlexibleDate 変更日, TextBoxFlexibleDate 変更届出日,
        ...
        ValidationMessageControlDictionary dictionary = new ValidationMessageControlDictionary(
                ...
                new ValidationMessageControlPair(ShikakuHenkoValidationMessage.変更事由が１号到達で年齢が65歳未満, 変更事由),
                new ValidationMessageControlPair(ShikakuHenkoValidationMessage.変更事由が１号到達以外年齢が40歳未満, 変更事由),
                new ValidationMessageControlPair(ShikakuHenkoValidationMessage.変更日と前の履歴データの変更日の期間が重複, 変更日),
                new ValidationMessageControlPair(ShikakuHenkoValidationMessage.取得日より前, 変更日),
                new ValidationMessageControlPair(ShikakuHenkoValidationMessage.喪失日より後, 変更日),
                new ValidationMessageControlPair(ShikakuHenkoValidationMessage.変更日と住所地特例履歴の期間が重複する履歴がある, 変更日),
                new ValidationMessageControlPair(ShikakuHenkoValidationMessage.変更日と次の履歴データの変更日の期間が重複, 変更日),
                new ValidationMessageControlPair(ShikakuHenkoValidationMessage.届出日設定なし, 変更届出日));
