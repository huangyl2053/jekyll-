...
public class HihokenshaShikakuHakkoDiv extends Panel implements IHihokenshaShikakuHakkoDiv {
    ...
    private RString hidden適用終了日１;
    @JsonProperty("hidden適用終了日２")
    private RString hidden適用終了日２;
    @JsonProperty("hidden適用終了日３")
    private RString hidden適用終了日３;
 ...
 /*
    ...
    /*
     * sethidden適用終了日１
     * @param hidden適用終了日１ hidden適用終了日１
     */
    @JsonProperty("hidden適用終了日１")
    public void setHidden適用終了日１(RString hidden適用終了日１) {
        this.hidden適用終了日１ = hidden適用終了日１;
    }
    ...
    /*
     * sethidden適用終了日２
     * @param hidden適用終了日２ hidden適用終了日２
     */
    @JsonProperty("hidden適用終了日２")
    public void setHidden適用終了日２(RString hidden適用終了日２) {
        this.hidden適用終了日２ = hidden適用終了日２;
    }
    ...
    /*
     * sethidden適用終了日３
     * @param hidden適用終了日３ hidden適用終了日３
     */
    @JsonProperty("hidden適用終了日３")
    public void setHidden適用終了日３(RString hidden適用終了日３) {
        this.hidden適用終了日３ = hidden適用終了日３;
    }
