...
(function (DBE) {
    ...
    (function (NinteichosaIraiListForByHandCom) {
        ...
        NinteichosaIraiListForByHandCom.Events = Events;
        ...
        var Controls = (function () {
            ...
            Controls.prototype.NinteichosaIraiListForByHandCom = function () {
                return new UZA.Panel(this.convFiledNameSelf());
            };

            Controls.prototype.dgNinteichosaIraiListForByHand = function () {
                return new UZA.DataGrid(this.convFiledName("dgNinteichosaIraiListForByHand"));
            };
            return Controls;
        })();
        NinteichosaIraiListForByHandCom.Controls = Controls;
