...
module DBZ {
    ...
    export module HokenshaInputGuide {
        ...
        export class Events {
            ...
            public static get onClick_btnSearchGaitoHokensha(): string {
                return "onClick_btnSearchGaitoHokensha";
            }
            public static get onSelectBySelectButton_dgSearchResultHokensha(): string {
                return "onSelectBySelectButton_dgSearchResultHokensha";
            }
            public static get onClick_btnHokenshaReturn(): string {
