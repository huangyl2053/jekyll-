...
public class HokenshaNinteichosaItakusakiJohoTest extends DbdTestBase {
    ...
    public static class getterSetterTest extends DbdTestBase {
        ...
        public void 引数に自動割付フラグを設定した場合_get自動割付フラグは_自動割付フラグと同じ自動割付フラグを返す() {
            assertThat(sut.get自動割付フラグ(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_自動割付フラグ));
        }
        ...
        public void 引数に状況フラグを設定した場合_get状況フラグは_状況フラグと同じ状況フラグを返す() {
            assertThat(sut.get状況フラグ(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_状況フラグ));
        }
    }
    ...
    public static class BuilderTest {
        ...
        public void setAutoWaritsukeFlagで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.get自動割付フラグ(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_自動割付フラグ));
        }
        ...
        public void setJokyoFlagで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.get状況フラグ(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_状況フラグ));
        }
    }
