...
/**
 * {@link HokenshaNinteichosaItakusakiJoho}のテストクラスです。
 *
 * @author n8223 朴義一
 */
...
public class HokenshaNinteichosaItakusakiJohoTest extends DbdTestBase {
    ...
    public static class getterSetterTest extends DbdTestBase {
        ...
        private static HokenshaNinteichosaItakusakiJoho sut;

        @BeforeClass
        public static void setUp() {
            sut = new HokenshaNinteichosaItakusakiJoho(DbT4910NinteichosaItakusakiJohoEntityGenerator.createDbT4910NinteichosaItakusakiJohoEntity());
        }

        @Test
        public void 引数に市町村コードを設定した場合_get市町村コードは_市町村コードと同じ市町村コードを返す() {
            assertThat(sut.get市町村コード(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_市町村コード));
        }

        @Test
        public void 引数に認定調査委託先コードを設定した場合_get認定調査委託先コードは_認定調査委託先コードと同じ認定調査委託先コードを返す() {
            assertThat(sut.get認定調査委託先コード(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_認定調査委託先コード));
        }

        @Test
        public void 引数に事業者番号を設定した場合_get事業者番号は_事業者番号と同じ事業者番号を返す() {
            assertThat(sut.get事業者番号(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_事業者番号));
        }

        @Test
        public void 引数に事業者名称を設定した場合_get事業者名称は_事業者名称と同じ事業者名称を返す() {
            assertThat(sut.get事業者名称(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_事業者名称));
        }

        @Test
        public void 引数に事業者名称カナを設定した場合_get事業者名称カナは_事業者名称カナと同じ事業者名称カナ称を返す() {
            assertThat(sut.get事業者名称カナ(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_事業者名称カナ));
        }

        @Test
        public void 引数に郵便番号を設定した場合_get郵便番号は_郵便番号と同じ郵便番号を返す() {
            assertThat(sut.get郵便番号(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_郵便番号));
        }

        @Test
        public void 引数に住所を設定した場合_get住所は_住所と同じ住所を返す() {
            assertThat(sut.get住所(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_住所));
        }

        @Test
        public void 引数に電話番号を設定した場合_get電話番号は_電話番号と同じ電話番号を返す() {
            assertThat(sut.get電話番号(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_電話番号));
        }

        @Test
        public void 引数にFAX番号を設定した場合_getFAX番号は_FAX番号と同じFAX番号を返す() {
            assertThat(sut.getFAX番号(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_FAX番号));
        }

        @Test
        public void 引数に代表者名を設定した場合_get代表者名は_代表者名と同じ代表者名を返す() {
            assertThat(sut.get代表者名(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_代表者名));
        }

        @Test
        public void 引数に調査委託区分を設定した場合_get調査委託区分は_調査委託区分と同じ調査委託区分を返す() {
            assertThat(sut.get調査委託区分(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_調査委託区分));
        }

        @Test
        public void 引数に割付定員を設定した場合_get割付定員は_割付定員と同じ割付定員を返す() {
            assertThat(sut.get割付定員(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_割付定員));
        }

        @Test
        public void 引数に割付地区を設定した場合_get割付地区は_割付地区と同じ割付地区を返す() {
            assertThat(sut.get割付地区(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_割付地区));
        }

        @Test
        public void 引数に自動割付フラグを設定した場合_get自動割付フラグは_自動割付フラグと同じ自動割付フラグを返す() {
            assertThat(sut.has自動割付フラグ(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_自動割付フラグ));
        }

        @Test
        public void 引数に機関の区分を設定した場合_get機関の区分は_機関の区分と同じ機関の区分を返す() {
            assertThat(sut.get機関の区分(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_機関の区分));
        }

        @Test
        public void 引数に状況フラグを設定した場合_get状況フラグは_状況フラグと同じ状況フラグを返す() {
            assertThat(sut.has状況フラグ(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_状況フラグ));
        }
    }
    ...
    public static class BuilderTest {
        ...
        public void setJigyoshaNoで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.get事業者番号(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_事業者番号));
        }
        ...
        public void setJigyoshaMeishoで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.get事業者名称(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_事業者名称));
        }
        ...
        public void setJigyoshaMeishoKanaで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.get事業者名称カナ(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_事業者名称カナ));
        }
        ...
        public void setYubinNoで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.get郵便番号(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_郵便番号));
        }
        ...
        public void setJushoで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.get住所(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_住所));
        }
        ...
        public void setTelNoで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.get電話番号(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_電話番号));
        }
        ...
        public void setFaxNoで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.getFAX番号(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_FAX番号));
        }
        ...
        public void setDaihyoshaNameで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.get代表者名(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_代表者名));
        }
        ...
        public void setWaritsukeTeiinで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.get割付定員(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_割付定員));
        }
        ...
        public void setWaritsukeChikuで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.get割付地区(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_割付地区));
        }
        ...
        public void setAutoWaritsukeFlagで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.has自動割付フラグ(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_自動割付フラグ));
        }
        ...
        public void setJokyoFlagで設定した値を_生成されたNinteichosaItakusakiJohoJukyuも保持する() {
            ...
            assertThat(result.has状況フラグ(), is(DbT4910NinteichosaItakusakiJohoEntityGenerator.DEFAULT_状況フラグ));
        }
    }
