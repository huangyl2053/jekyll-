...
public class KanendoConfigTest {
    ...
    private static IUrBusinessConfig createBusinessConfigMock() {
        ...
        when(mock.get(ConfigKeysKanendo.過年度期情報_月の期1, nowDate)).thenReturn(new RString("01"));
        when(mock.get(ConfigKeysKanendo.過年度期情報_月の期2, nowDate)).thenReturn(new RString("02"));
        when(mock.get(ConfigKeysKanendo.過年度期情報_月の期3, nowDate)).thenReturn(new RString("03"));
        when(mock.get(ConfigKeysKanendo.過年度期情報_月の期4, nowDate)).thenReturn(new RString("04"));
        when(mock.get(ConfigKeysKanendo.過年度期情報_月の期5, nowDate)).thenReturn(new RString("05"));
        when(mock.get(ConfigKeysKanendo.過年度期情報_月の期6, nowDate)).thenReturn(new RString("06"));
        when(mock.get(ConfigKeysKanendo.過年度期情報_月の期7, nowDate)).thenReturn(new RString("07"));
        when(mock.get(ConfigKeysKanendo.過年度期情報_月の期8, nowDate)).thenReturn(new RString("08"));
        when(mock.get(ConfigKeysKanendo.過年度期情報_月の期9, nowDate)).thenReturn(new RString("09"));
        when(mock.get(ConfigKeysKanendo.過年度期情報_月の期10, nowDate)).thenReturn(new RString("10"));
        when(mock.get(ConfigKeysKanendo.過年度期情報_月の期11, nowDate)).thenReturn(new RString("11"));
        when(mock.get(ConfigKeysKanendo.過年度期情報_月の期12, nowDate)).thenReturn(new RString("12"));
