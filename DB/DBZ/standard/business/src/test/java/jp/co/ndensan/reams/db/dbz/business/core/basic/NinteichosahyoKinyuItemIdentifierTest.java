...
/**
 * {@link NinteichosahyoKinyuItemIdentifier}のテストクラスです。
 */
@RunWith(Enclosed.class)
public class NinteichosahyoKinyuItemIdentifierTest extends DbzTestBase {
...
//TODO 主キー値を適切な値に置換してください
    ...
    public static class シリアライズテスト extends DbzTestBase {
        ...
        public void シリアライズできる() {
            NinteichosahyoKinyuItemIdentifier sut = new NinteichosahyoKinyuItemIdentifier(申請書管理番号, 認定調査依頼履歴番号, 連番);
