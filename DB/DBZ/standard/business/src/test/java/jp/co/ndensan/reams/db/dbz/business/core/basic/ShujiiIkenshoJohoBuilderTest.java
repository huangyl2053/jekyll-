...
//TODO 主キー値を適切な値に置換してください
        申請書管理番号 = DbT5302ShujiiIkenshoJohoEntityGenerator.DEFAULT_申請書管理番号;
        主治医意見書作成依頼履歴番号 = DbT5302ShujiiIkenshoJohoEntityGenerator.DEFAULT_主治医意見書作成依頼履歴番号;
    }
...
//TODO Key項目のテストメソッドは削除して下さい。
        ...
        @Test
        public void 戻り値の在宅_施設区分は_設定した値と同じ在宅_施設区分を返す() {
            business = sut.set在宅_施設区分(DbT5302ShujiiIkenshoJohoEntityGenerator.DEFAULT_在宅_施設区分).build();
            assertThat(business.get在宅_施設区分(), is(DbT5302ShujiiIkenshoJohoEntityGenerator.DEFAULT_在宅_施設区分));
        }
