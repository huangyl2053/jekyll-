...
/**
 * {@link ShujiiIkenshoKinyuItemIdentifier}のテストクラスです。
 */
@RunWith(Enclosed.class)
public class ShujiiIkenshoKinyuItemIdentifierTest extends DbzTestBase {
...
//TODO 主キー値を適切な値に置換してください
    ...
    public static class シリアライズテスト extends DbzTestBase {
        ...
        public void シリアライズできる() {
            ShujiiIkenshoKinyuItemIdentifier sut = new ShujiiIkenshoKinyuItemIdentifier(申請書管理番号, 主治医意見書作成依頼履歴番号 = DbT5303ShujiiIkenshoKinyuItemEntityGenerator.DEFAULT_主治医意見書作成依頼履歴番号);
