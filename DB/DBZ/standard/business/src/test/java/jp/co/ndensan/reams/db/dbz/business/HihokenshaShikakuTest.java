...
public class HihokenshaShikakuTest extends DbzTestBase {
    ...
    private static final RDateTime registerTimestamp = RDateTime.of(2014, Month.AUGUST, 2, 15, 37);
    ...
    public static class Builder extends DbzTestBase {
        ...
        public static class IKaigoShikakuを用いないConstructor {
            ...
            public static class NullCheck {
                ...
                public void Builderのコンストラクタは_引数の_地方公共団体コード_がnullのとき_NullPointerExceptionをスローする() {
                    HihokenshaShikaku.Builder sut = new HihokenshaShikaku.Builder(
                            null, shikibetsuCode, registerTimestamp, hihokenshaKubun,
                ...
                public void Builderのコンストラクタは_引数の_識別コード_がnullのとき_NullPointerExceptionをスローする() {
                    HihokenshaShikaku.Builder sut = new HihokenshaShikaku.Builder(
                            lasdecCode, null, registerTimestamp, hihokenshaKubun,
                            ichigoDate, ShikakuShutoku.NOTHING);
                }

                @Test(expected = NullPointerException.class)
                public void Builderのコンストラクタは_引数の_被保険者台帳登録日時_がnullのとき_NullPointerExceptionをスローする() {
                    HihokenshaShikaku.Builder sut = new HihokenshaShikaku.Builder(
                ...
                public void Builderのコンストラクタは_引数の_被保険者台区分_がnullのとき_NullPointerExceptionをスローする() {
                    HihokenshaShikaku.Builder sut = new HihokenshaShikaku.Builder(
                            lasdecCode, shikibetsuCode, registerTimestamp, null,
                            ichigoDate, ShikakuShutoku.NOTHING);
                }
                ...
                public void Builderのコンストラクタは_引数の_第1号年齢到達日_がnullのとき_NullPointerExceptionをスローする() {
                    HihokenshaShikaku.Builder sut = new HihokenshaShikaku.Builder(
                            lasdecCode, shikibetsuCode, registerTimestamp, hihokenshaKubun,
            ...
            public static class publicMethods extends DbzTestBase {
                ...
                public static class hihokenshaNo extends DbzTestBase {
                    ...
                    @Before
                    public void setUp() {
                        sut = new HihokenshaShikaku.Builder(
                                lasdecCode, shikibetsuCode, registerTimestamp, hihokenshaKubun, ichigoDate, shikakuShutokuFirst);
        ...
        public static class IKaigoShikakuを用いるConstructor {
            ...
            public static class NullCheck {
                ...
                public void BuilderのIKaigoShikakuを用いるコンストラクタは_引数の_介護資格_がnullのとき_NullPointerExceptionをスローする() {
                    HihokenshaShikaku.Builder sut = new HihokenshaShikaku.Builder(
                            null, lasdecCode, shikibetsuCode, registerTimestamp, hihokenshaKubun);
                }

                @Test(expected = NullPointerException.class)
                public void BuilderのIKaigoShikakuを用いるコンストラクタは_引数の_地方公共団体コード_がnullのとき_NullPointerExceptionをスローする() {
                    HihokenshaShikaku.Builder sut = new HihokenshaShikaku.Builder(
                            kaigoShikaku, null, shikibetsuCode, registerTimestamp, hihokenshaKubun);
                }

                @Test(expected = NullPointerException.class)
                public void BuilderのIKaigoShikakuを用いるコンストラクタは_引数の_識別コード_がnullのとき_NullPointerExceptionをスローする() {
                    HihokenshaShikaku.Builder sut = new HihokenshaShikaku.Builder(
                            kaigoShikaku, lasdecCode, null, registerTimestamp, hihokenshaKubun);
                }

                @Test(expected = NullPointerException.class)
                public void BuilderのIKaigoShikakuを用いるコンストラクタは_引数の_被保険者台帳登録日時_がnullのとき_NullPointerExceptionをスローする() {
                    HihokenshaShikaku.Builder sut = new HihokenshaShikaku.Builder(
                ...
                public void BuilderのIKaigoShikakuを用いるコンストラクタは_引数の_被保険者区分_がnullのとき_NullPointerExceptionをスローする() {
                    HihokenshaShikaku.Builder sut = new HihokenshaShikaku.Builder(
                            kaigoShikaku, lasdecCode, shikibetsuCode, registerTimestamp, null);
                }
            }
            ...
            public static class publicMethods extends DbzTestBase {
                ...
                static {
                    kaigoShikaku = KaigoShikakuFactory.createInstance(
                            ...
                            ichigoGaitoDate, hihokenshaKubun, JushochiTokureishaKubun.通常資格者);
                }
                ...
                public static class KaigoShikaku extends DbzTestBase {
                    ...
                    @Before
                    public void setUp() {
                        sut = new HihokenshaShikaku.Builder(kaigoShikaku, lasdecCode, shikibetsuCode, registerTimestamp, hihokenshaKubun);
                    }
