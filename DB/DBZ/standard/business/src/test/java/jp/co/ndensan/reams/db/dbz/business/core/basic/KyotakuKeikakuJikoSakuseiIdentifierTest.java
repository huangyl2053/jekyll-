...
import jp.co.ndensan.reams.db.dbz.business.core.KyotakuKeikakuJikoSakuseiIdentifier;
...
/**
 * {@link KyotakuKeikakuJikoSakuseiIdentifier}のテストクラスです。
 */
@RunWith(Enclosed.class)
public class KyotakuKeikakuJikoSakuseiIdentifierTest extends DbzTestBase {
...
//TODO 主キー値を適切な値に置換してください
    ...
    public static class シリアライズテスト extends DbzTestBase {
        ...
        public void シリアライズできる() {
            KyotakuKeikakuJikoSakuseiIdentifier sut = new KyotakuKeikakuJikoSakuseiIdentifier(被保険者番号, 対象年月, 履歴番号);
