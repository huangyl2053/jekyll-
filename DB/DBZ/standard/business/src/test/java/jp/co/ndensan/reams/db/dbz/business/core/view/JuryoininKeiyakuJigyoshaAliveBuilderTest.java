...
//TODO Key項目のテストメソッドは削除して下さい。
        ...
        public void 戻り値の住宅改修契約有無は_設定した値と同じ住宅改修契約有無を返す() {
            ...
            assertThat(business.is住宅改修契約有無(), is(DbV3077JuryoininKeiyakuJigyoshaEntityGenerator.DEFAULT_住宅改修契約有無));
        }
        ...
        public void 戻り値の特定福祉用具販売契約有無は_設定した値と同じ特定福祉用具販売契約有無を返す() {
            ...
            assertThat(business.is特定福祉用具販売契約有無(), is(DbV3077JuryoininKeiyakuJigyoshaEntityGenerator.DEFAULT_特定福祉用具販売契約有無));
        }
        ...
        public void 戻り値の償還払給付契約有無は_設定した値と同じ償還払給付契約有無を返す() {
            ...
            assertThat(business.is償還払給付契約有無(), is(DbV3077JuryoininKeiyakuJigyoshaEntityGenerator.DEFAULT_償還払給付契約有無));
        }
        ...
        public void 戻り値の高額給付契約有無は_設定した値と同じ高額給付契約有無を返す() {
            ...
            assertThat(business.is高額給付契約有無(), is(DbV3077JuryoininKeiyakuJigyoshaEntityGenerator.DEFAULT_高額給付契約有無));
        }
        ...
        public void 戻り値の取扱確約書有無は_設定した値と同じ取扱確約書有無を返す() {
            ...
            assertThat(business.is取扱確約書有無(), is(DbV3077JuryoininKeiyakuJigyoshaEntityGenerator.DEFAULT_取扱確約書有無));
        }
