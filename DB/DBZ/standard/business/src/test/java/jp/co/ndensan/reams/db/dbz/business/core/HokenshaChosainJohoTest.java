...
public class HokenshaChosainJohoTest extends DbdTestBase {
    ...
    public static class getterSetterTest extends DbdTestBase {
        ...
        public void 引数に調査可能人数月を設定した場合_get地区コードと同じ調査可能人数_月を返す() {
            assertThat(sut.get調査可能人数月(), is(DbT4913ChosainJohoEntityGenerator.DEFAULT_調査可能人数_月));
        }
        ...
        public void 引数に状況フラグを設定した場合_ge状況フラグと同じ状況フラグを返す() {
            assertThat(sut.has状況フラグ(), is(DbT4913ChosainJohoEntityGenerator.DEFAULT_状況フラグ));
        }
    ...
    public static class BuilderTest extends DbdTestBase {
        ...
        public void setChosaKanoNinzuPerMonthで設定した値を＿生成されたChosainJohoJukyuも保持する() {
            ...
            assertThat(result.get調査可能人数月(), is(DbT4913ChosainJohoEntityGenerator.DEFAULT_調査可能人数_月));
        }
