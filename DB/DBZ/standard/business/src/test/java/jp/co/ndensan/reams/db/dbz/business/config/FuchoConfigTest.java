...
import jp.co.ndensan.reams.db.dbz.definition.core.configkeys.ConfigKeysFucho;
...
public class FuchoConfigTest extends DbzTestBase {
    ...
    private static final RString 月の期13;
    private static final RString 月の期14;
    ...
    private static BusinessConfig createBusinessConfigMock() {
        ...
        when(mock.get(eq(ConfigKeysFucho.普徴期情報_月の期4), any(RDate.class))).thenReturn(月の期4);
        when(mock.get(eq(ConfigKeysFucho.普徴期情報_月の期5), any(RDate.class))).thenReturn(月の期5);
        when(mock.get(eq(ConfigKeysFucho.普徴期情報_月の期6), any(RDate.class))).thenReturn(月の期6);
        when(mock.get(eq(ConfigKeysFucho.普徴期情報_月の期7), any(RDate.class))).thenReturn(月の期7);
        when(mock.get(eq(ConfigKeysFucho.普徴期情報_月の期8), any(RDate.class))).thenReturn(月の期8);
        when(mock.get(eq(ConfigKeysFucho.普徴期情報_月の期9), any(RDate.class))).thenReturn(月の期9);
        when(mock.get(eq(ConfigKeysFucho.普徴期情報_月の期10), any(RDate.class))).thenReturn(月の期10);
        when(mock.get(eq(ConfigKeysFucho.普徴期情報_月の期11), any(RDate.class))).thenReturn(月の期11);
        when(mock.get(eq(ConfigKeysFucho.普徴期情報_月の期12), any(RDate.class))).thenReturn(月の期12);
        when(mock.get(eq(ConfigKeysFucho.普徴期情報_月の期13), any(RDate.class))).thenReturn(月の期13);
        when(mock.get(eq(ConfigKeysFucho.普徴期情報_月の期14), any(RDate.class))).thenReturn(月の期14);
        return mock;
    }
}
