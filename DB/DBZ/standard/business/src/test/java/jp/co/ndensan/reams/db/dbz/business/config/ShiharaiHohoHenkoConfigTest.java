...
public class ShiharaiHohoHenkoConfigTest extends DbzTestBase {
    ...
    public static class get extends DbzTestBase {
        ...
        public void 支払方法変更_証表示支払方法_終了分記載区分を指定したとき_業務コンフィグ設定値が返る() {
            RString result = sut.get支払方法変更_証表示支払方法_終了分記載区分();
            assertThat(result, is(証表示支払方法_終了分記載区分));
        }
        ...
        public void 支払方法変更_証表示差止_終了分記載区分を指定したとき_業務コンフィグ設定値が返る() {
            RString result = sut.get支払方法変更_証表示差止_終了分記載区分();
            assertThat(result, is(証表示差止_終了分記載区分));
        }
        ...
        public void 支払方法変更_証表示減額_終了分記載区分を指定したとき_業務コンフィグ設定値が返る() {
            RString result = sut.get支払方法変更_証表示減額_終了分記載区分();
            assertThat(result, is(証表示減額_終了分記載区分));
        }
        ...
        public void 支払方法変更_資格者証表示支払方法_終了分記載区分を指定したとき_業務コンフィグ設定値が返る() {
            RString result = sut.get支払方法変更_資格者証表示支払方法_終了分記載区分();
            assertThat(result, is(資格者証表示支払方法_終了分記載区分));
        }
        ...
        public void 支払方法変更_資格者証表示差止_終了分記載区分を指定したとき_業務コンフィグ設定値が返る() {
            RString result = sut.get支払方法変更_資格者証表示差止_終了分記載区分();
            assertThat(result, is(資格者証表示差止_終了分記載区分));
        }
        ...
        public void 支払方法変更_資格者証表示減額_終了分記載区分を指定したとき_業務コンフィグ設定値が返る() {
            RString result = sut.get支払方法変更_資格者証表示減額_終了分記載区分();
            assertThat(result, is(資格者証表示減額_終了分記載区分));
        }
    ...
    private static final RString 証表示支払方法_終了分記載区分;
    private static final RString 証表示支払方法_記載文言;
    private static final RString 証表示差止_終了分記載区分;
    private static final RString 証表示差止_記載文言;
    private static final RString 証表示減額_終了分記載区分;
    private static final RString 証表示減額_記載文言;
    private static final RString 資格者証表示支払方法_終了分記載区分;
    private static final RString 資格者証表示支払方法_記載文言;
    private static final RString 資格者証表示差止_終了分記載区分;
    private static final RString 資格者証表示差止_記載文言;
    private static final RString 資格者証表示減額_終了分記載区分;
    private static final RString 資格者証表示減額_記載文言;

    static {
        証表示支払方法_終了分記載区分 = new RString("1");
        証表示支払方法_記載文言 = new RString("支払方法変更ＭＡＸ１２３");
        証表示差止_終了分記載区分 = new RString("1");
        証表示差止_記載文言 = new RString("保険給付の差止Ｍ１Ａ２Ｘ");
        証表示減額_終了分記載区分 = new RString("0");
        証表示減額_記載文言 = new RString("給付額　減額Ｍ１Ａ２Ｘ３");
        資格者証表示支払方法_終了分記載区分 = new RString("1");
        資格者証表示支払方法_記載文言 = new RString("支払方法変更");
        資格者証表示差止_終了分記載区分 = new RString("1");
        資格者証表示差止_記載文言 = new RString("保険給付の差止");
        資格者証表示減額_終了分記載区分 = new RString("1");
