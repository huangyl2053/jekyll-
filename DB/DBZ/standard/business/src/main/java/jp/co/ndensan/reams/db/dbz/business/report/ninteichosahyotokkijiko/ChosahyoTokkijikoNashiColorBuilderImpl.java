...
/**
 * 要介護認定調査票（特記事項）なし-カラーBuilderのクラスです。
 *
 * @reamsid_L DBE-0080-040 xuyannan
 */
public class ChosahyoTokkijikoNashiColorBuilderImpl implements IChosahyoTokkijikoBuilder {
     ...
     */
    public ChosahyoTokkijikoNashiColorBuilderImpl(IChosahyoTokkijikoEditor editor) {
        this.editor = editor;
    }
