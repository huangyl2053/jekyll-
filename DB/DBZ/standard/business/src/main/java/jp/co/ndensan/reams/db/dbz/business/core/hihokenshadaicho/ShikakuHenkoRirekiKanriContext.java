...
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShikakuHenkoValidationMessage.取得日より前;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShikakuHenkoValidationMessage.喪失日より後;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShikakuHenkoValidationMessage.変更事由が未入力;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShikakuHenkoValidationMessage.変更事由が１号到達で年齢が65歳未満;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShikakuHenkoValidationMessage.変更事由が１号到達以外年齢が40歳未満;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShikakuHenkoValidationMessage.変更日が未入力;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShikakuHenkoValidationMessage.変更日と住所地特例履歴の期間が重複する履歴がある;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShikakuHenkoValidationMessage.変更日と前の履歴データの変更日の期間が重複;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShikakuHenkoValidationMessage.変更日と次の履歴データの変更日の期間が重複;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShikakuHenkoValidationMessage.届出日設定なし;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShikakuHenkoValidationMessage.最新の取得日として登録不可;
