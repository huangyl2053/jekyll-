 ...
 */
package jp.co.ndensan.reams.db.dbz.business.core.dbt5102ninteikekkajoho;
 ...
 */
public class DbT5102NinteiKekkaJohoBusiness {
     ...
     * コンストラクタです.
     *
     * @param entity 要介護認定結果情報(認定)Entity
     */
    public DbT5102NinteiKekkaJohoBusiness(DbT5102NinteiKekkaJohoEntity entity) {
        this.entity = entity;
    }
