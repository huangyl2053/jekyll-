...
/**
 * 要介護認定主治医意見書記入用紙OCRー裏Builderのクラスです。
 *
 * @reamsid_L DBE-0050-030 xuyannan
 */
public class IkenshokinyuyoshiOCRuraBuilderImpl implements IIkenshokinyuyoshiOCRBuilder {
     ...
     */
    public IkenshokinyuyoshiOCRuraBuilderImpl(IIkenshokinyuyoshiOCREditor editor) {
        this.editor = editor;
    }
