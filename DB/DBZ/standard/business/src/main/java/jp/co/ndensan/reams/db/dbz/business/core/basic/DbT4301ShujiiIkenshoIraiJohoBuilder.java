...
public class DbT4301ShujiiIkenshoIraiJohoBuilder {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set厚労省IF識別コード(Code 厚労省IF識別コード) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set主治医医療機関コード(RString 主治医医療機関コード) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set主治医コード(RString 主治医コード) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set主治医意見書依頼区分(RString 主治医意見書依頼区分) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set主治医意見書作成回数(int 主治医意見書作成回数) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set医師区分コード(Code 医師区分コード) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set主治医意見書作成依頼年月日(FlexibleDate 主治医意見書作成依頼年月日) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set主治医意見書作成期限年月日(FlexibleDate 主治医意見書作成期限年月日) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set依頼書出力年月日(FlexibleDate 依頼書出力年月日) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set意見書出力年月日(FlexibleDate 意見書出力年月日) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set請求書出力年月日(FlexibleDate 請求書出力年月日) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set作成料請求区分(Code 作成料請求区分) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set主治医意見書作成督促年月日(FlexibleDate 主治医意見書作成督促年月日) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set主治医意見書作成督促方法(RString 主治医意見書作成督促方法) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set主治医意見書作成督促回数(int 主治医意見書作成督促回数) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set主治医意見書作成督促メモ(RString 主治医意見書作成督促メモ) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set認定情報提供希望フラグ(boolean 認定情報提供希望フラグ) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set認定状況提供年月日(FlexibleDate 認定状況提供年月日) {
     ...
     * @return {@link DbT4301ShujiiIkenshoIraiJohoBuilder}
     */
    public DbT4301ShujiiIkenshoIraiJohoBuilder set論理削除フラグ(boolean 論理削除フラグ) {
    ...
    /**
     * {@link DbT4301ShujiiIkenshoIraiJoho}のインスタンスを生成します。
     *
     * @return {@link DbT4301ShujiiIkenshoIraiJoho}のインスタンス
     */
    public DbT4301ShujiiIkenshoIraiJoho build() {
        return new DbT4301ShujiiIkenshoIraiJoho(entity, id);
    }
}
