...
/**
 * 要介護認定調査票（特記事項）-両面-裏Builderのクラスです。
 *
 * @reamsid_L DBE-0080-040 xuyannan
 */
public class ChosahyoTokkijikoRyomenUraBuilderImpl implements IChosahyoTokkijikoBuilder {
     ...
     */
    public ChosahyoTokkijikoRyomenUraBuilderImpl(IChosahyoTokkijikoEditor editor) {
        this.editor = editor;
    }
