...
public class DbT4101NinteiShinseiJoho extends ParentModelBase<DbT4101NinteiShinseiJohoIdentifier, DbT4101NinteiShinseiJohoEntity, DbT4101NinteiShinseiJoho> implements Serializable {
     ...
     */
    public DbT4101NinteiShinseiJoho(ShinseishoKanriNo 申請書管理番号) {
        requireNonNull(申請書管理番号, UrSystemErrorMessages.値がnull.getReplacedMessage("申請書管理番号"));
        this.entity = new DbT4101NinteiShinseiJohoEntity();
        this.entity.setShinseishoKanriNo(申請書管理番号);
        this.id = new DbT4101NinteiShinseiJohoIdentifier(
                申請書管理番号
        );
    }
    ...
    /**
     * コンストラクタです。<br/>
     * DBより取得した{@link DbT4101NinteiShinseiJohoEntity}より{@link DbT4101NinteiShinseiJoho}を生成します。
     *
     * @param entity DBより取得した{@link DbT4101NinteiShinseiJohoEntity}
     */
    public DbT4101NinteiShinseiJoho(DbT4101NinteiShinseiJohoEntity entity) {
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * {@link DbT4101NinteiShinseiJohoEntity}のクローンを返します。
     *
     * @return {@link DbT4101NinteiShinseiJohoEntity}のクローン
     */
    @Override
    public DbT4101NinteiShinseiJohoEntity toEntity() {
        return this.entity.clone();
    }

    /**
     * 要介護認定申請情報の識別子{@link DbT4101NinteiShinseiJohoIdentifier}を返します。
     *
     * @return 要介護認定申請情報の識別子{@link DbT4101NinteiShinseiJohoIdentifier}
     */
    @Override
    public DbT4101NinteiShinseiJohoIdentifier identifier() {
        return this.id;
    }
     ...
     * {@link DbT4101NinteiShinseiJohoEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
     * @return 変更対象処理実施後の{@link DbT4101NinteiShinseiJoho}
     */
    @Override
    public DbT4101NinteiShinseiJoho modifiedModel() {
        DbT4101NinteiShinseiJohoEntity modifiedEntity = entity.clone();
        if (modifiedEntity.getState().equals(EntityDataState.Unchanged)) {
            modifiedEntity.setState(EntityDataState.Modified);
        }
        return new DbT4101NinteiShinseiJoho(
                modifiedEntity, id);
    }

    /**
     * 保持する要介護認定申請情報を削除対象とします。<br/>
     * {@link DbT4101NinteiShinseiJohoEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば削除状態にします。
     *
     * @return 削除対象処理実施後の{@link DbT4101NinteiShinseiJoho}
     */
    @Override
    public DbT4101NinteiShinseiJoho deleted() {
        DbT4101NinteiShinseiJohoEntity deletedEntity = this.toEntity();
        ...
        return new DbT4101NinteiShinseiJoho(deletedEntity, id);
    }

    /**
     * {@link DbT4101NinteiShinseiJoho}のシリアライズ形式を提供します。
     *
     * @return {@link DbT4101NinteiShinseiJoho}のシリアライズ形式
     */
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private _SerializationProxy(DbT4101NinteiShinseiJohoEntity entity, DbT4101NinteiShinseiJohoIdentifier id) {
            this.entity = entity;
            this.id = id;
        }

        private Object readResolve() {
            return new DbT4101NinteiShinseiJoho(this.entity, this.id);
        }
        private static final long serialVersionUID = 3922168515770998104L;
    }
     ...
     * @return Builder
     */
    public DbT4101NinteiShinseiJohoBuilder createBuilderForEdit() {
        return new DbT4101NinteiShinseiJohoBuilder(entity, id);
    }
