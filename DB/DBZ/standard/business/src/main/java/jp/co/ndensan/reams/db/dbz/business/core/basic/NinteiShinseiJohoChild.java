...
/**
 * 要介護認定申請情報を管理するクラスです。DbT4101NinteiShinseiJohoEntity
 *
 * @reamsid_L DBD-1400-010 tianyh
 */
public class NinteiShinseiJohoChild
        extends ModelBase<NinteiShinseiJohoIdentifier, DbT4101NinteiShinseiJohoEntity, NinteiShinseiJohoChild>
     ...
     */
    public NinteiShinseiJohoChild(ShinseishoKanriNo 申請書管理番号) {
    ...
    /**
     * コンストラクタです。<br/>
     * DBより取得した{@link DbT5101NinteiShinseiJohoEntity}より{@link NinteiShinseiJohoChild}を生成します。
     *
     * @param entity DBより取得した{@link DbT5101NinteiShinseiJohoEntity}
     */
    public NinteiShinseiJohoChild(DbT4101NinteiShinseiJohoEntity entity) {
     ...
     *
     * @return 変更対象処理実施後の{@link NinteiShinseiJohoChild}
     */
    public NinteiShinseiJohoChild modifiedModel() {
        DbT4101NinteiShinseiJohoEntity modifiedEntity = entity.clone();
        if (modifiedEntity.getState().equals(EntityDataState.Unchanged)) {
            modifiedEntity.setState(EntityDataState.Modified);
        }
        return new NinteiShinseiJohoChild(
                modifiedEntity, id);
    }
     ...
     *
     * @return 削除対象処理実施後の{@link NinteiShinseiJohoChild}
     */
    @Override
    public NinteiShinseiJohoChild deleted() {
        ...
        return new NinteiShinseiJohoChild(deletedEntity, id);
    }

    /**
     * {@link NinteiShinseiJohoChild}のシリアライズ形式を提供します。
     *
     * @return {@link NinteiShinseiJohoChild}のシリアライズ形式
     */
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private _SerializationProxy(DbT4101NinteiShinseiJohoEntity entity, NinteiShinseiJohoIdentifier id) {
            this.entity = entity;
            this.id = id;
        }

        private Object readResolve() {
            return new NinteiShinseiJohoChild(this.entity, this.id);
        }
    }
...
//    }
    ...
    public boolean equals(Object obj) {
        ...
        final NinteiShinseiJohoChild other = (NinteiShinseiJohoChild) obj;
