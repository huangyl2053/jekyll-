...
/**
 * 要介護認定調査票（特記事項）有り-白黒Builderのクラスです。
 *
 * @reamsid_L DBE-0080-040 xuyannan
 */
public class ChosahyoTokkijikoAriMonoBuilderImpl implements IChosahyoTokkijikoBuilder {
     ...
     */
    public ChosahyoTokkijikoAriMonoBuilderImpl(IChosahyoTokkijikoEditor editor) {
        this.editor = editor;
    }
