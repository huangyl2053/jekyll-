...
import jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShikakushashoKigen;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShikakushashoKigen.資格者証期限_有効期限初期表示;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShikakushashoKigen.資格者証期限_有効期限加算値;
import jp.co.ndensan.reams.db.dbz.definition.core.configvalues.YukoKigenShokiHyoji;
...
public class ShikakushashoKigenConfig {
    ...
    private Map<ConfigKeysShikakushashoKigen, RString> createMap() {
     ...
     */
    public YukoKigenShokiHyoji get資格者証期限_有効期限初期表示() {
        return YukoKigenShokiHyoji.toValue(configs.get(資格者証期限_有効期限初期表示));
    }
}
