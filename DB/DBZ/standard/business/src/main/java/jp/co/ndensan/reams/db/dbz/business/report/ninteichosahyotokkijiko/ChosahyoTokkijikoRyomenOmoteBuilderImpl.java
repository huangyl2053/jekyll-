...
/**
 * 要介護認定調査票（特記事項）-両面-表Builderのクラスです。
 *
 * @reamsid_L DBE-0080-040 xuyannan
 */
public class ChosahyoTokkijikoRyomenOmoteBuilderImpl implements IChosahyoTokkijikoBuilder {
     ...
     */
    public ChosahyoTokkijikoRyomenOmoteBuilderImpl(IChosahyoTokkijikoEditor editor) {
        this.editor = editor;
    }
