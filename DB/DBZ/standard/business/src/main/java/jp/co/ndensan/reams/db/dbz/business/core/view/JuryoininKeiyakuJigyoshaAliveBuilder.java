...
/**
 * {@link JuryoininKeiyakuJigyoshaAlive}の編集を行うビルダークラスです。
 */
public class JuryoininKeiyakuJigyoshaAliveBuilder {

    private final DbV3077JuryoininKeiyakuJigyoshaEntity entity;
    private final JuryoininKeiyakuJigyoshaAliveIdentifier id;

    /**
     * {@link DbV3077JuryoininKeiyakuJigyoshaEntity}より{@link JuryoininKeiyakuJigyoshaAlive}の編集用Builderクラスを生成します。
     *
     * @param entity {@link DbV3077JuryoininKeiyakuJigyoshaEntity}
     * @param id {@link JuryoininKeiyakuJigyoshaAliveIdentifier}
     *
     */
    JuryoininKeiyakuJigyoshaAliveBuilder(
...
//TODO 一緒に置換される値のまとまりで不変なクラスを作成し、その単位でsetterを作る様に見直してください。
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set事業者契約番号(RString 事業者契約番号) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set開始年月日(FlexibleDate 開始年月日) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set履歴番号(int 履歴番号) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set終了年月日(FlexibleDate 終了年月日) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set届出年月日(FlexibleDate 届出年月日) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set届出者住所(RString 届出者住所) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set届出者事業者名称(RString 届出者事業者名称) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set届出者代表者氏名(RString 届出者代表者氏名) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set口座種別(RString 口座種別) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set口座番号(RString 口座番号) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set通帳記号(RString 通帳記号) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set通帳番号(RString 通帳番号) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set口座名義人(AtenaKanaMeisho 口座名義人) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set口座名義人漢字(AtenaMeisho 口座名義人漢字) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set事業者FAX番号(TelNo 事業者FAX番号) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set契約登録年月日(FlexibleDate 契約登録年月日) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set送付先部署(RString 送付先部署) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set営業形態(RString 営業形態) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set住宅改修契約有無(boolean 住宅改修契約有無) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set特定福祉用具販売契約有無(boolean 特定福祉用具販売契約有無) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set償還払給付契約有無(boolean 償還払給付契約有無) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set高額給付契約有無(boolean 高額給付契約有無) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set契約事業者番号(JigyoshaNo 契約事業者番号) {
     ...
     * @return {@link JuryoininKeiyakuJigyoshaAliveBuilder}
     */
    public JuryoininKeiyakuJigyoshaAliveBuilder set取扱確約書有無(boolean 取扱確約書有無) {
    ...
    /**
     * {@link JuryoininKeiyakuJigyoshaAlive}のインスタンスを生成します。
     *
     * @return {@link JuryoininKeiyakuJigyoshaAlive}のインスタンス
     */
    public JuryoininKeiyakuJigyoshaAlive build() {
        return new JuryoininKeiyakuJigyoshaAlive(entity, id);
    }
}
