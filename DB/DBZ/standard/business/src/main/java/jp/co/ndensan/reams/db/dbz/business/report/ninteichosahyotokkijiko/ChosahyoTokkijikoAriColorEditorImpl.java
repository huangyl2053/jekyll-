...
/**
 * 要介護認定調査票（特記事項）有り-カラーのEditorです。
 *
 * @reamsid_L DBE-0080-040 xuyannan
 */
public class ChosahyoTokkijikoAriColorEditorImpl implements IChosahyoTokkijikoEditor {
     ...
     */
    protected ChosahyoTokkijikoAriColorEditorImpl(ChosahyoTokkijikoBusiness business) {
