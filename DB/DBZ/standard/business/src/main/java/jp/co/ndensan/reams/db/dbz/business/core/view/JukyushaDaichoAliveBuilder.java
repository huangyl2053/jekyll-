...
/**
 * {@link JukyushaDaichoAlive}の編集を行うビルダークラスです。
 */
public class JukyushaDaichoAliveBuilder {

    private final DbV4001JukyushaDaichoEntity entity;
    private final JukyushaDaichoAliveIdentifier id;

    /**
     * {@link DbV4001JukyushaDaichoEntity}より{@link JukyushaDaichoAlive}の編集用Builderクラスを生成します。
     *
     * @param entity {@link DbV4001JukyushaDaichoEntity}
     * @param id {@link JukyushaDaichoAliveIdentifier}
     *
     */
    JukyushaDaichoAliveBuilder(
            DbV4001JukyushaDaichoEntity entity,
            JukyushaDaichoAliveIdentifier id
    ) {
...
//TODO 一緒に置換される値のまとまりで不変なクラスを作成し、その単位でsetterを作る様に見直してください。
     ...
     */
    public JukyushaDaichoAliveBuilder set市町村コード(LasdecCode 市町村コード) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set被保険者番号(HihokenshaNo 被保険者番号) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set履歴番号(RString 履歴番号) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set枝番(RString 枝番) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set申請書管理番号(ShinseishoKanriNo 申請書管理番号) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set申請状況区分(RString 申請状況区分) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set支所コード(RString 支所コード) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set直近フラグ(boolean 直近フラグ) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set識別コード(ShikibetsuCode 識別コード) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set受給申請事由(Code 受給申請事由) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set申請理由(RString 申請理由) {
     ...
     * 届出者申請者関係コードを設定します。
     *
     * @param 届出者申請者関係コード 届出者申請者関係コード
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set届出者申請者関係コード(Code 届出者申請者関係コード) {
        requireNonNull(届出者申請者関係コード, UrSystemErrorMessages.値がnull.getReplacedMessage("届出者申請者関係コード"));
        entity.setShinseishaKankeiCode(届出者申請者関係コード);
        return this;
    }
     ...
     * 届出者本人との関係を設定します。
     *
     * @param 届出者本人との関係 届出者本人との関係
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set届出者本人との関係(RString 届出者本人との関係) {
        requireNonNull(届出者本人との関係, UrSystemErrorMessages.値がnull.getReplacedMessage("届出者本人との関係"));
        entity.setHomninKankei(届出者本人との関係);
        return this;
    }
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set受給申請年月日(FlexibleDate 受給申請年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set審査会依頼年月日(FlexibleDate 審査会依頼年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set要介護認定状態区分コード(Code 要介護認定状態区分コード) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set認定有効期間開始年月日(FlexibleDate 認定有効期間開始年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set認定有効期間終了年月日(FlexibleDate 認定有効期間終了年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set認定年月日(FlexibleDate 認定年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類01(ServiceShuruiCode 指定サービス種類01) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類02(ServiceShuruiCode 指定サービス種類02) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類03(ServiceShuruiCode 指定サービス種類03) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類04(ServiceShuruiCode 指定サービス種類04) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類05(ServiceShuruiCode 指定サービス種類05) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類06(ServiceShuruiCode 指定サービス種類06) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類07(ServiceShuruiCode 指定サービス種類07) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類08(ServiceShuruiCode 指定サービス種類08) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類09(ServiceShuruiCode 指定サービス種類09) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類10(ServiceShuruiCode 指定サービス種類10) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類11(ServiceShuruiCode 指定サービス種類11) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類12(ServiceShuruiCode 指定サービス種類12) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類13(ServiceShuruiCode 指定サービス種類13) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類14(ServiceShuruiCode 指定サービス種類14) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類15(ServiceShuruiCode 指定サービス種類15) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類16(ServiceShuruiCode 指定サービス種類16) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類17(ServiceShuruiCode 指定サービス種類17) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類18(ServiceShuruiCode 指定サービス種類18) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類19(ServiceShuruiCode 指定サービス種類19) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類20(ServiceShuruiCode 指定サービス種類20) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類21(ServiceShuruiCode 指定サービス種類21) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類22(ServiceShuruiCode 指定サービス種類22) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類23(ServiceShuruiCode 指定サービス種類23) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類24(ServiceShuruiCode 指定サービス種類24) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類25(ServiceShuruiCode 指定サービス種類25) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類26(ServiceShuruiCode 指定サービス種類26) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類27(ServiceShuruiCode 指定サービス種類27) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類28(ServiceShuruiCode 指定サービス種類28) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類29(ServiceShuruiCode 指定サービス種類29) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set指定サービス種類30(ServiceShuruiCode 指定サービス種類30) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set喪失年月日(FlexibleDate 喪失年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set直近異動年月日(FlexibleDate 直近異動年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set直近異動事由コード(Code 直近異動事由コード) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set有効無効区分(Code 有効無効区分) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder setデータ区分(Code データ区分) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set同一連番(RString 同一連番) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set異動理由(RString 異動理由) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set申請書区分(Code 申請書区分) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set削除事由コード(Code 削除事由コード) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set要支援者認定申請区分(boolean 要支援者認定申請区分) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set支給限度単位数(Decimal 支給限度単位数) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set支給限度有効開始年月日(FlexibleDate 支給限度有効開始年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set支給限度有効終了年月日(FlexibleDate 支給限度有効終了年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set短期入所支給限度日数(int 短期入所支給限度日数) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set短期入所支給限度開始年月日(FlexibleDate 短期入所支給限度開始年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set短期入所支給限度終了年月日(FlexibleDate 短期入所支給限度終了年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set当初認定有効開始年月日(FlexibleDate 当初認定有効開始年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set当初認定有効終了年月日(FlexibleDate 当初認定有効終了年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set受給資格証明書発行年月日１(FlexibleDate 受給資格証明書発行年月日１) {
     ...
     * 受給資格証明書発行年月日2を設定します。
     *
     * @param 受給資格証明書発行年月日2 受給資格証明書発行年月日2
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set受給資格証明書発行年月日2(FlexibleDate 受給資格証明書発行年月日2) {
        requireNonNull(受給資格証明書発行年月日2, UrSystemErrorMessages.値がnull.getReplacedMessage("受給資格証明書発行年月日2"));
        entity.setJukyuShikakuShomeishoHakkoYMD2(受給資格証明書発行年月日2);
        return this;
    }
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set診断命令書発行年月日(FlexibleDate 診断命令書発行年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set二号申請受理通知書発行年月日(FlexibleDate 二号申請受理通知書発行年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set認定結果通知書発行年月日(FlexibleDate 認定結果通知書発行年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set区分変更通知書発行年月日(FlexibleDate 区分変更通知書発行年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder setサービス変更通知書発行年月日(FlexibleDate サービス変更通知書発行年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set認定却下通知書発行年月日(FlexibleDate 認定却下通知書発行年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set認定取消通知書発行年月日(FlexibleDate 認定取消通知書発行年月日) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set資格取得前申請フラグ(boolean 資格取得前申請フラグ) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set旧措置者フラグ(boolean 旧措置者フラグ) {
     ...
     * @return {@link JukyushaDaichoAliveBuilder}
     */
    public JukyushaDaichoAliveBuilder set論理削除フラグ(boolean 論理削除フラグ) {
    ...
    /**
     * {@link JukyushaDaichoAlive}のインスタンスを生成します。
     *
     * @return {@link JukyushaDaichoAlive}のインスタンス
     */
    public JukyushaDaichoAlive build() {
        return new JukyushaDaichoAlive(entity, id);
    }
}
