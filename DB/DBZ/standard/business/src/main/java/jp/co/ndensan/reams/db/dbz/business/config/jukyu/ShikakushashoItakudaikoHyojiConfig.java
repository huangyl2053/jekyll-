...
import jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShikakushashoItakudaikoHyoji;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShikakushashoItakudaikoHyoji.資格者証表示方法_委託代行業者の表示有無;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShikakushashoItakudaikoHyoji.資格者証表示方法_委託代行業者表示終了文言;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShikakushashoItakudaikoHyoji.資格者証表示方法_委託代行業者表示開始文言;
import jp.co.ndensan.reams.db.dbz.definition.core.configvalues.ShikakushashoItakudaikoHyoji;
