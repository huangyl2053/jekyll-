 ...
 */
public class NinteiShinseiJohoDbT5101Child
        extends ModelBase<NinteiShinseiJohoIdentifier, DbT5101NinteiShinseiJohoEntity, NinteiShinseiJohoDbT5101Child>
     ...
     */
    public NinteiShinseiJohoDbT5101Child(ShinseishoKanriNo 申請書管理番号) {
     ...
     */
    public NinteiShinseiJohoDbT5101Child(DbT5101NinteiShinseiJohoEntity entity) {
     ...
     */
    public NinteiShinseiJohoDbT5101Child modifiedModel() {
        DbT5101NinteiShinseiJohoEntity modifiedEntity = entity.clone();
        if (modifiedEntity.getState().equals(EntityDataState.Unchanged)) {
            modifiedEntity.setState(EntityDataState.Modified);
        }
        return new NinteiShinseiJohoDbT5101Child(
                modifiedEntity, id);
    }
     ...
     */
    @Override
    public NinteiShinseiJohoDbT5101Child deleted() {
        ...
        return new NinteiShinseiJohoDbT5101Child(deletedEntity, id);
    }
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private Object readResolve() {
            return new NinteiShinseiJohoDbT5101Child(this.entity, this.id);
        }
    }
...
//    }
    ...
    public boolean equals(Object obj) {
        ...
        final NinteiShinseiJohoDbT5101Child other = (NinteiShinseiJohoDbT5101Child) obj;
