...
/**
 * 要介護認定調査票（特記事項）両面-裏のEditorです。
 *
 * @reamsid_L DBE-0080-040 xuyannan
 */
public class ChosahyoTokkijikoRyomenUraEditorImpl implements IChosahyoTokkijikoEditor {
     ...
     */
    protected ChosahyoTokkijikoRyomenUraEditorImpl(ChosahyoTokkijikoBusiness business) {
