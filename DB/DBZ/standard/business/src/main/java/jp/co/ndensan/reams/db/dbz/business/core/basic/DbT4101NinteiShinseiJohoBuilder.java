...
/**
 * {@link DbT4101NinteiShinseiJoho}の編集を行うビルダークラスです。
 */
public class DbT4101NinteiShinseiJohoBuilder {

    private final DbT4101NinteiShinseiJohoEntity entity;
    private final DbT4101NinteiShinseiJohoIdentifier id;

    /**
     * {@link DbT4101NinteiShinseiJohoEntity}より{@link DbT4101NinteiShinseiJoho}の編集用Builderクラスを生成します。
     *
     * @param entity {@link DbT4101NinteiShinseiJohoEntity}
     * @param id {@link DbT4101NinteiShinseiJohoIdentifier}
     *
     */
    DbT4101NinteiShinseiJohoBuilder(
            DbT4101NinteiShinseiJohoEntity entity,
            DbT4101NinteiShinseiJohoIdentifier id
    ) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set厚労省IF識別コード(Code 厚労省IF識別コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set証記載保険者番号(RString 証記載保険者番号) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set申請年度(FlexibleYear 申請年度) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set被保険者番号(RString 被保険者番号) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set認定申請年月日(FlexibleDate 認定申請年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set認定申請枝番コード(EdabanCode 認定申請枝番コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set認定申請区分_法令_コード(Code 認定申請区分_法令_コード) {
        requireNonNull(認定申請区分_法令_コード, UrSystemErrorMessages.値がnull.getReplacedMessage("認定申請区分（法令）コード"));
        entity.setNinteiShinseiHoreiKubunCode(認定申請区分_法令_コード);
        return this;
    }

    /**
     * 認定申請区分_申請時_コードを設定します。
     *
     * @param 認定申請区分_申請時_コード 認定申請区分_申請時_コード
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set認定申請区分_申請時_コード(Code 認定申請区分_申請時_コード) {
        requireNonNull(認定申請区分_申請時_コード, UrSystemErrorMessages.値がnull.getReplacedMessage("認定申請区分（申請時）コード"));
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set取下区分コード(Code 取下区分コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set被保険者区分コード(RString 被保険者区分コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set生年月日(FlexibleDate 生年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set年齢(int 年齢) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set性別(Code 性別) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set被保険者氏名カナ(AtenaKanaMeisho 被保険者氏名カナ) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set被保険者氏名(AtenaMeisho 被保険者氏名) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set郵便番号(YubinNo 郵便番号) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set住所(AtenaJusho 住所) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set電話番号(TelNo 電話番号) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set支所コード(RString 支所コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set識別コード(ShikibetsuCode 識別コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set地区コード(ChikuCode 地区コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder setみなし２号等対象フラグ(boolean みなし２号等対象フラグ) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set広域内転居区分(Code 広域内転居区分) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set認定申請有効区分(Code 認定申請有効区分) {
    ...
    /**
     * 要介護申請_要支援申請の区分の区分を設定します。
     *
     * @param 要介護申請_要支援申請の区分 要介護申請_要支援申請の区分
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set要介護申請_要支援申請の区分(RString 要介護申請_要支援申請の区分) {
        requireNonNull(要介護申請_要支援申請の区分, UrSystemErrorMessages.値がnull.getReplacedMessage("要介護申請・要支援申請の区分"));
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set認定申請理由(RString 認定申請理由) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set申請サービス削除の理由(RString 申請サービス削除の理由) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set前回要介護状態区分コード(Code 前回要介護状態区分コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set前回認定年月日(FlexibleDate 前回認定年月日) {
     ...
     * 前回認定有効期間_開始を設定します。
     *
     * @param 前回認定有効期間_開始 前回認定有効期間_開始
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set前回認定有効期間_開始(FlexibleDate 前回認定有効期間_開始) {
        requireNonNull(前回認定有効期間_開始, UrSystemErrorMessages.値がnull.getReplacedMessage("前回認定有効期間（開始）"));
        entity.setZenkaiYukoKikanStart(前回認定有効期間_開始);
        return this;
    }
     ...
     * 前回認定有効期間_終了を設定します。
     *
     * @param 前回認定有効期間_終了 前回認定有効期間_終了
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set前回認定有効期間_終了(FlexibleDate 前回認定有効期間_終了) {
        requireNonNull(前回認定有効期間_終了, UrSystemErrorMessages.値がnull.getReplacedMessage("前回認定有効期間（終了）"));
        entity.setZenkaiYukoKikanEnd(前回認定有効期間_終了);
        return this;
    }
     ...
     * ２号医療保険者名を設定します。
     *
     * @param 号医療保険者名 号医療保険者名
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set2号医療保険者名(RString 号医療保険者名) {
        requireNonNull(号医療保険者名, UrSystemErrorMessages.値がnull.getReplacedMessage("２号医療保険者名"));
        entity.setNigoIryoHokenshaName(号医療保険者名);
        return this;
    }
     ...
     * 2号医療保険記号番号を設定します。
     *
     * @param 号医療保険記号番号 号医療保険記号番号
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set2号医療保険記号番号(RString 号医療保険記号番号) {
        requireNonNull(号医療保険記号番号, UrSystemErrorMessages.値がnull.getReplacedMessage("２号医療保険記号番号"));
        entity.setNigoIryoHokenKigoBango(号医療保険記号番号);
        return this;
    }
     ...
     * ２号特定疾病コードを設定します。
     *
     * @param 号特定疾病コード 号特定疾病コード
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set2号特定疾病コード(Code 号特定疾病コード) {
        requireNonNull(号特定疾病コード, UrSystemErrorMessages.値がnull.getReplacedMessage("２号特定疾病コード"));
        entity.setNigoTokuteiShippeiCode(号特定疾病コード);
        return this;
    }
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set自動割当除外者区分(RString 自動割当除外者区分) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set情報提供への同意有無(boolean 情報提供への同意有無) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set情報提供資料出力年月日(FlexibleDate 情報提供資料出力年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set調査区分(Code 調査区分) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set認定調査委託先コード(ChosaItakusakiCode 認定調査委託先コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set認定調査員コード(ChosainCode 認定調査員コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set調査員への連絡事項(RString 調査員への連絡事項) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set主治医医療機関コード(RString 主治医医療機関コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set主治医コード(RString 主治医コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set指定医フラグ(boolean 指定医フラグ) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set意見書データ種別(Code 意見書データ種別) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set主治医への連絡事項(RString 主治医への連絡事項) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set認定延期通知発行しないことに対する同意有無(boolean 認定延期通知発行しないことに対する同意有無) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set施設入所の有無(boolean 施設入所の有無) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set入所施設コード(JigyoshaNo 入所施設コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set家庭訪問の有無(boolean 家庭訪問の有無) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set訪問調査先郵便番号(YubinNo 訪問調査先郵便番号) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set訪問調査先住所(AtenaJusho 訪問調査先住所) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set訪問調査先名称(AtenaMeisho 訪問調査先名称) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set訪問調査先電話番号(TelNo 訪問調査先電話番号) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set市町村連絡事項(RString 市町村連絡事項) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set処理状態区分(Code 処理状態区分) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set取下年月日(FlexibleDate 取下年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set取下理由(RString 取下理由) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set却下年月日(FlexibleDate 却下年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set却下理由(RString 却下理由) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set延期決定年月日(FlexibleDate 延期決定年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set延期理由(RString 延期理由) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set延期通知発行年月日(FlexibleDate 延期通知発行年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set延期通知発行回数(int 延期通知発行回数) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set延期見込期間開始年月日(FlexibleDate 延期見込期間開始年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set延期見込期間終了年月日(FlexibleDate 延期見込期間終了年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set審査継続区分(boolean 審査継続区分) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set介護認定審査会優先振分区分コード(Code 介護認定審査会優先振分区分コード) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set更新通知発行年月日(FlexibleDate 更新通知発行年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set更新通知発行完了年月日(FlexibleDate 更新通知発行完了年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set認定申請情報登録年月日(FlexibleDate 認定申請情報登録年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set再調査依頼回数(int 再調査依頼回数) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set再作成依頼回数(int 再作成依頼回数) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder setＩＦ送付年月日(FlexibleDate ＩＦ送付年月日) {
     ...
     * @return {@link DbT4101NinteiShinseiJohoBuilder}
     */
    public DbT4101NinteiShinseiJohoBuilder set論理削除フラグ(boolean 論理削除フラグ) {
    ...
    /**
     * {@link DbT4101NinteiShinseiJoho}のインスタンスを生成します。
     *
     * @return {@link DbT4101NinteiShinseiJoho}のインスタンス
     */
    public DbT4101NinteiShinseiJoho build() {
        return new DbT4101NinteiShinseiJoho(entity, id);
    }
}
