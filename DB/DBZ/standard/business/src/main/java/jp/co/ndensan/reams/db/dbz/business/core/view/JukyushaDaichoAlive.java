...
public class JukyushaDaichoAlive extends ParentModelBase<JukyushaDaichoAliveIdentifier, DbV4001JukyushaDaichoEntity, JukyushaDaichoAlive> implements Serializable {
     ...
     * @param 受給申請事由 受給申請事由
     */
    public JukyushaDaichoAlive(LasdecCode 市町村コード,
            HihokenshaNo 被保険者番号,
            RString 履歴番号,
            RString 枝番,
            Code 受給申請事由) {
    ...
    /**
     * コンストラクタです。<br/>
     * DBより取得した{@link DbV4001JukyushaDaichoEntity}より{@link JukyushaDaichoAlive}を生成します。
     *
     * @param entity DBより取得した{@link DbV4001JukyushaDaichoEntity}
     */
    public JukyushaDaichoAlive(DbV4001JukyushaDaichoEntity entity) {
        this.entity = requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage("受給者台帳Alive"));
        this.id = new JukyushaDaichoAliveIdentifier(
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * {@link DbV4001JukyushaDaichoEntity}のクローンを返します。
     *
     * @return {@link DbV4001JukyushaDaichoEntity}のクローン
     */
    @Override
    public DbV4001JukyushaDaichoEntity toEntity() {
        return this.entity.clone();
    }

    /**
     * 受給者台帳Aliveの識別子{@link JukyushaDaichoAliveIdentifier}を返します。
     *
     * @return 受給者台帳Aliveの識別子{@link JukyushaDaichoAliveIdentifier}
     */
    @Override
    public JukyushaDaichoAliveIdentifier identifier() {
        return this.id;
    }

    /**
     * 受給者台帳Aliveのみを変更対象とします。<br/>
     * {@link DbV4001JukyushaDaichoEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
     * @return 変更対象処理実施後の{@link JukyushaDaichoAlive}
     */
    @Override
    public JukyushaDaichoAlive modifiedModel() {
        DbV4001JukyushaDaichoEntity modifiedEntity = entity.clone();
        if (modifiedEntity.getState().equals(EntityDataState.Unchanged)) {
            modifiedEntity.setState(EntityDataState.Modified);
        }
        return new JukyushaDaichoAlive(
                modifiedEntity, id);
    }

    /**
     * 保持する受給者台帳Aliveを削除対象とします。<br/>
     * {@link DbV4001JukyushaDaichoEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば削除状態にします。
     *
     * @return 削除対象処理実施後の{@link JukyushaDaichoAlive}
     */
    @Override
    public JukyushaDaichoAlive deleted() {
        DbV4001JukyushaDaichoEntity deletedEntity = this.toEntity();
        ...
        return new JukyushaDaichoAlive(deletedEntity, id);
    }

    /**
     * {@link JukyushaDaichoAlive}のシリアライズ形式を提供します。
     *
     * @return {@link JukyushaDaichoAlive}のシリアライズ形式
     */
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private _SerializationProxy(DbV4001JukyushaDaichoEntity entity, JukyushaDaichoAliveIdentifier id) {
            this.entity = entity;
            this.id = id;
        }

        private Object readResolve() {
            return new JukyushaDaichoAlive(this.entity, this.id);
        }
    }
     ...
     * @return Builder
     */
    public JukyushaDaichoAliveBuilder createBuilderForEdit() {
        return new JukyushaDaichoAliveBuilder(entity, id);
    }
