 ...
 * @author n8235 船山洋介
 */
public class HokenshaNinteiShinseiJoho implements INinteiShinseiJoho {
     ...
     * コンストラクタです。
     */
    public HokenshaNinteiShinseiJoho() {
        entity = new DbT4101NinteiShinseiJohoEntity();
    }
     ...
     */
    public HokenshaNinteiShinseiJoho(DbT4101NinteiShinseiJohoEntity entity) {
        this.entity = entity;
    }

    /**
     * DbT4101NinteiShinseiJohoEntityを返します。
     *
    ...
    /**
     * DbT4101NinteiShinseiJohoEntityを設定します。
     *
     * @param entity DbT4101NinteiShinseiJohoEntity
     */
    public void setEntity(DbT4101NinteiShinseiJohoEntity entity) {
        this.entity = entity;
    }
    ...
    private HokenshaNinteiShinseiJoho(Builder builder) {
    ...
    /**
     * 新しい{@link HokenshaNinteiShinseiJoho}を生成するためのビルダーを返します。
     *
     * @return ビルダー
     */
    ...
    public static final class Builder extends INinteiShinseiJoho.Builder {
        ...
        Builder(HokenshaNinteiShinseiJoho hokenshaNinteiShinseiJoho) {
            this.entity = hokenshaNinteiShinseiJoho.entity.clone();
        }
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private static final long serialVersionUID = -5665578967306815534L;

        private final DbT4101NinteiShinseiJohoEntity entity;

        private _SerializationProxy(HokenshaNinteiShinseiJoho hokenshaNinteiShinseiJoho) {
            this.entity = hokenshaNinteiShinseiJoho.entity;
        }

        private Object readResolve() {
            return new HokenshaNinteiShinseiJoho(entity);
        }
    }
}
