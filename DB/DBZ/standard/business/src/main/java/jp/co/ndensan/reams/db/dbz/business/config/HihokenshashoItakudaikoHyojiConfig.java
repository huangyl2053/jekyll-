...
import jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysHihokenshashoItakudaikoHyoji;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysHihokenshashoItakudaikoHyoji.被保険者証表示方法_委託代行業者_表示有無;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysHihokenshashoItakudaikoHyoji.被保険者証表示方法_委託代行業者_表示終了文言;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysHihokenshashoItakudaikoHyoji.被保険者証表示方法_委託代行業者_表示開始文言;
import jp.co.ndensan.reams.db.dbz.definition.core.configvalues.HihokenshashoItakudaikoHyoji;
...
public class HihokenshashoItakudaikoHyojiConfig {
    ...
    private Map<ConfigKeysHihokenshashoItakudaikoHyoji, RString> createMap() {
     ...
     */
    public HihokenshashoItakudaikoHyoji get被保険者証表示方法_委託代行業者_表示有無() {
        return HihokenshashoItakudaikoHyoji.toValue(configs.get(被保険者証表示方法_委託代行業者_表示有無));
    }
