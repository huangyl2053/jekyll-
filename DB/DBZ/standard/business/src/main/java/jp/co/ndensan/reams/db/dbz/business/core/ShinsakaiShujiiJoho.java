...
/**
 * 認定(DBE)用の主治医情報のビジネスクラスです。
 *
 * @author n8235 船山洋介
 */
public class ShinsakaiShujiiJoho implements IShujiiJoho {

    private DbT5912ShujiiJohoEntity entity;

    /**
     * コンストラクタです。
     */
    public ShinsakaiShujiiJoho() {
        entity = new DbT5912ShujiiJohoEntity();
    }

    /**
     * 単体テスト用のコンストラクタです。
     *
     * @param entity DbT5912ShujiiJohoEntity
     */
    public ShinsakaiShujiiJoho(DbT5912ShujiiJohoEntity entity) {
        this.entity = entity;
    }

    /**
     * DbT5912ShujiiJohoEntityを返します。
     *
     ...
     * @param entity DbT5912ShujiiJohoEntity
     */
    public void setEntity(DbT5912ShujiiJohoEntity entity) {
        this.entity = entity;
    }
    ...
    private ShinsakaiShujiiJoho(Builder builder) {
    ...
    /**
     * 新しい{@link ShinsakaiShujiiJoho}を生成するためのビルダーを返します。
     *
     * @return ビルダー
     */
    ...
    public static final class Builder extends IShujiiJoho.Builder {
        ...
        Builder(ShinsakaiShujiiJoho shujiiJohoNintei) {
            this.entity = shujiiJohoNintei.entity.clone();
        }
        ...
        /**
         * {@link ShinsakaiShujiiJoho}を生成します。
         *
         * @return {@link ShinsakaiShujiiJoho}
         */
        @Override
        public ShinsakaiShujiiJoho build() {
            return new ShinsakaiShujiiJoho(this);
        }
    }
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private static final long serialVersionUID = 2075633791213153214L;

        private final DbT5912ShujiiJohoEntity entity;

        private _SerializationProxy(ShinsakaiShujiiJoho shujiiJohoNintei) {
            this.entity = shujiiJohoNintei.entity;
        }

        private Object readResolve() {
            return new ShinsakaiShujiiJoho(entity);
        }
    }
}
