...
/**
 * 主治医医療機関情報のビジネスクラスでです。
 *
 * @author n8235 船山洋介
 */
public class HokenshaShujiiIryoKikanJoho implements IShujiiIryokikanJoho {

    private DbT4911ShujiiIryoKikanJohoEntity entity;

    /**
     * コンストラクタです。
     */
    public HokenshaShujiiIryoKikanJoho() {
        entity = new DbT4911ShujiiIryoKikanJohoEntity();
    }

    /**
     * コンストラクタです。
     *
     * @param entity DbT4911ShujiiIryoKikanJohoEntity
     */
    public HokenshaShujiiIryoKikanJoho(DbT4911ShujiiIryoKikanJohoEntity entity) {
        this.entity = entity;
    }

    /**
     * DbT4911ShujiiIryoKikanJohoEntityを返します。
     *
     * @return DbT4911ShujiiIryoKikanJohoEntity
     */
    @Override
    public DbT4911ShujiiIryoKikanJohoEntity getEntity() {
        return entity;
    }

    /**
     * DbT4911ShujiiIryoKikanJohoEntityを設定します。
     *
     * @param entity DbT4911ShujiiIryoKikanJohoEntity
     */
    public void setEntity(DbT4911ShujiiIryoKikanJohoEntity entity) {
        this.entity = entity;
    }
    ...
    private HokenshaShujiiIryoKikanJoho(Builder builder) {
    ...
    /**
     * 新しい{@link HokenshaShujiiIryoKikanJoho}を生成するためのビルダーを返します。
     *
     * @return ビルダー
     */
    ...
    /**
     * {@link HokenshaShujiiIryoKikanJoho}を生成するためのビルダーです。
     */
    public static final class Builder extends IShujiiIryokikanJoho.Builder {
        ...
        Builder() {
            this.entity = new DbT4911ShujiiIryoKikanJohoEntity();
        }

        Builder(HokenshaShujiiIryoKikanJoho shujiiIryoKikanJohoJukyu) {
            this.entity = shujiiIryoKikanJohoJukyu.entity.clone();
        }
        ...
        /**
         * {@link HokenshaShujiiIryoKikanJoho}を生成します。
         *
         * @return {@link HokenshaShujiiIryoKikanJoho}
         */
        @Override
        public HokenshaShujiiIryoKikanJoho build() {
            return new HokenshaShujiiIryoKikanJoho(this);
        }
    }
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private static final long serialVersionUID = -2074926233795511795L;

        private final DbT4911ShujiiIryoKikanJohoEntity entity;

        private _SerializationProxy(HokenshaShujiiIryoKikanJoho shujiiIryoKikanJohoJukyu) {
            this.entity = shujiiIryoKikanJohoJukyu.entity;
        }

        private Object readResolve() {
            return new HokenshaShujiiIryoKikanJoho(entity);
        }
    }
}
