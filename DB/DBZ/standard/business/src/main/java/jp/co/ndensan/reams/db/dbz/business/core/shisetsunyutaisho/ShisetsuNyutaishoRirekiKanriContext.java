 ...
 */
package jp.co.ndensan.reams.db.dbz.business.core.shisetsunyutaisho;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.Collections;
import java.util.List;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShisetsuNyutaishoValidationMessage.入所年月日より前;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShisetsuNyutaishoValidationMessage.入所施設コードが未入力;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShisetsuNyutaishoValidationMessage.入所施設名称が未入力;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShisetsuNyutaishoValidationMessage.入所日が未入力;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShisetsuNyutaishoValidationMessage.入所日と前の履歴データの退所日の期間が重複;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShisetsuNyutaishoValidationMessage.入所日と期間が重複する履歴がある;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShisetsuNyutaishoValidationMessage.終了日設定なし;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShisetsuNyutaishoValidationMessage.退所日と期間が重複する履歴がある;
import static jp.co.ndensan.reams.db.dbz.business.core.validation.ShisetsuNyutaishoValidationMessage.退所日と次の履歴データの入所日の期間が重複;
