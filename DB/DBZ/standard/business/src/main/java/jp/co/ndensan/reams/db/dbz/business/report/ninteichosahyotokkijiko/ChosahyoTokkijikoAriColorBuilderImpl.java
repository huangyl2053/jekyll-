...
/**
 * 要介護認定調査票（特記事項）有り-カラーBuilderのクラスです。
 *
 * @reamsid_L DBE-0080-040 xuyannan
 */
public class ChosahyoTokkijikoAriColorBuilderImpl implements IChosahyoTokkijikoBuilder {
     ...
     */
    public ChosahyoTokkijikoAriColorBuilderImpl(IChosahyoTokkijikoEditor editor) {
        this.editor = editor;
    }
