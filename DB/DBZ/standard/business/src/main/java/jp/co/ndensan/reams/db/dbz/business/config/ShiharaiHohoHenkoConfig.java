...
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShiharaiHohoHenko.支払方法変更_証表示差止_終了分記載区分;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShiharaiHohoHenko.支払方法変更_証表示差止_記載文言;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShiharaiHohoHenko.支払方法変更_証表示支払方法_終了分記載区分;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShiharaiHohoHenko.支払方法変更_証表示支払方法_記載文言;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShiharaiHohoHenko.支払方法変更_証表示減額_終了分記載区分;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShiharaiHohoHenko.支払方法変更_証表示減額_記載文言;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShiharaiHohoHenko.支払方法変更_資格者証表示差止_終了分記載区分;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShiharaiHohoHenko.支払方法変更_資格者証表示差止_記載文言;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShiharaiHohoHenko.支払方法変更_資格者証表示支払方法_終了分記載区分;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShiharaiHohoHenko.支払方法変更_資格者証表示支払方法_記載文言;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShiharaiHohoHenko.支払方法変更_資格者証表示減額_終了分記載区分;
import static jp.co.ndensan.reams.db.dbz.definition.core.config.ConfigKeysShiharaiHohoHenko.支払方法変更_資格者証表示減額_記載文言;
