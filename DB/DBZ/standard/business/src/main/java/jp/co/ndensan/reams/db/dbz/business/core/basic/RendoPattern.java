...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * 連動パターンのみを変更対象とします。<br/> {@link DbT7035RendoPatternEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
    ...
    /**
     * 保持する連動パターンを削除対象とします。<br/> {@link DbT7035RendoPatternEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば削除状態にします。
     *
