...
/**
 * 要介護認定調査票（特記事項）-片面Builderのクラスです。
 *
 * @reamsid_L DBE-0080-040 xuyannan
 */
public class ChosahyoTokkijikoKatamenBuilderImpl implements IChosahyoTokkijikoBuilder {
     ...
     */
    public ChosahyoTokkijikoKatamenBuilderImpl(IChosahyoTokkijikoEditor editor) {
        this.editor = editor;
    }
