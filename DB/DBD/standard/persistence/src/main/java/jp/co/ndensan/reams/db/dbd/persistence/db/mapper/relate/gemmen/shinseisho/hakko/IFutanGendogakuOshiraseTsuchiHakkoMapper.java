...
/**
 * 負担限度額認定お知らせ通知書発行_出力対象者情報を取得のMapperクラスです。
 *
 * @reamsid_L DBD-3530-080 mawy
 */
public interface IFutanGendogakuOshiraseTsuchiHakkoMapper {

    /**
     * 出力対象者情報を取得します。
     *
     * @param parameter パラメータク
     * @return List<FutanGendogakuOshiraseTsuchiHakkoEntity>
     */
    List<FutanGendogakuOshiraseTsuchiHakkoEntity> get出力対象者情報(FutanGendogakuMybatisParameter parameter);
}
