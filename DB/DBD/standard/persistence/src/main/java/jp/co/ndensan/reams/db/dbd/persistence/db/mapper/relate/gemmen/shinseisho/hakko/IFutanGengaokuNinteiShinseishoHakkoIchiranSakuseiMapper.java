...
import jp.co.ndensan.reams.db.dbd.entity.db.relate.gemmen.shinseisho.hakko.FutanGengaokuNinteiShinseishoHakkoEntity;
...
public interface IFutanGengaokuNinteiShinseishoHakkoIchiranSakuseiMapper {
     ...
     * @return List<FutanGengaokuNinteiShinseishoHakkoEntity>
     */
    List<FutanGengaokuNinteiShinseishoHakkoEntity> get出力対象者情報(FutanGendogakuMybatisParameter parameter);
}
