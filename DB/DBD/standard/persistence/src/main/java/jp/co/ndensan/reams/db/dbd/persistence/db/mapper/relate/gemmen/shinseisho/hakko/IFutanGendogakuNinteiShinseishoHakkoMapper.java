...
/**
 * 介護保険負担限度額認定申請書_出力対象者情報を取得のMapperクラスです。
 *
 * @reamsid_L DBD-3530-080 mawy
 */
public interface IFutanGendogakuNinteiShinseishoHakkoMapper {

    /**
     * 出力対象者情報を取得します。
     *
     * @param parameter パラメータク
     * @return List<FutanGendogakuNinteiShinseishoHakkoEntity>
     */
    List<FutanGendogakuNinteiShinseishoHakkoEntity> get出力対象者情報(FutanGendogakuMybatisParameter parameter);
}
