...
public class DbT4016HomonKaigoRiyoshaFutangakuGengakuDac implements ISaveable<DbT4016HomonKaigoRiyoshaFutangakuGengakuEntity> {
    ...
    /**
     * DbT4016HomonKaigoRiyoshaFutangakuGengakuEntityを物理削除します。
     *
     * @param entity entity
     * @return 物理削除件数
     */
    @Transaction
    public int delete(DbT4016HomonKaigoRiyoshaFutangakuGengakuEntity entity) {
        requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage("訪問介護利用者負担額減額エンティティ"));
     ...
     */
    @Transaction
    public DbT4016HomonKaigoRiyoshaFutangakuGengakuEntity get訪問介護利用者負担額減額情報(HihokenshaNo 被保険者番号)
            throws NullPointerException {
        requireNonNull(被保険者番号, UrSystemErrorMessages.値がnull.getReplacedMessage("被保険者番号"));
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
