 ...
 */
package jp.co.ndensan.reams.db.dbd.persistence.db.mapper.relate.futanwariaihanteiichiran;

import java.util.List;
import jp.co.ndensan.reams.db.dbd.definition.mybatisprm.futanwariaihanteiichiran.FutanwariaiHanteiIchiranMybaticParameter;
import jp.co.ndensan.reams.db.dbd.entity.db.relate.futanwariaihanteiichiran.FutanwariaiHanteiIchiranEntity;
import jp.co.ndensan.reams.db.dbd.entity.db.relate.futanwariaihanteiichiran.MaeRiyoshaFutanWariaiHanteiEntity;
