...
import jp.co.ndensan.reams.db.dbd.entity.basic.DbT4912ShujiiJoho;
import static jp.co.ndensan.reams.db.dbd.entity.basic.DbT4912ShujiiJoho.*;
 ...
 * @author n8235 船山洋介
 */
public class DbT4912ShujiiJohoDac implements IModifiable<DbT4912ShujiiJohoEntity> {
    ...
    @Transaction
    @Override
    public int insert(DbT4912ShujiiJohoEntity entity) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
    ...
    @Transaction
    @Override
    public int update(DbT4912ShujiiJohoEntity entity) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
    ...
    @Transaction
    @Override
    public int delete(DbT4912ShujiiJohoEntity entity) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
