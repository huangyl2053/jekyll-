     ...
     export module KaigoNinteiShinseiKihonJohoInput {
        ...
        export class Controls {
            ...
            public convFiledNameSelf(): string {
                return this._myName + "_" + DBD.KaigoNinteiShinseiKihonJohoInput.Controls.myType();
            }

            public convFiledName(fieldName: string): string {
                return this._myName + "_" + DBD.KaigoNinteiShinseiKihonJohoInput.Controls.myType() + "_" + fieldName;
            }
