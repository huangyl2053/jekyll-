...
public class ShogaishaKojoTaishoshaNinteishoHakkoPanel {
    ...
    public ResponseData<SourceDataCollection> onClick_btnHakko(ShogaishaKojoTaishoshaNinteishoHakkoPanelDiv div) {
        ...
        try (ReportManager reportManager = new ReportManager()) {
            service.edit帳票発行(get識別コードFromViewState(), get被保険者番号FromViewState(), 発行日,
                    div.getShogaishaKojoNinteishoHakko().getShogaishaKojoNinteisho().getShogaishaKojoShinseisha().getTxtShinseishaJusho().getValue(),
                    div.getShogaishaKojoNinteishoHakko().getShogaishaKojoNinteisho().getShogaishaKojoShinseisha().getTxtShinseishaName().getValue(),
                    div.getTaishoshaAtena().getAtenaInfoDiv().getHdnTxtJuminShubetsu(), reportManager);
