...
/**
 * dgTainoJokyo1_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgTainoJokyo1_Row extends DataRow {
    ...
    public dgTainoJokyo1_Row(RString ki, RString tsuki, TextBoxNum txtHokenryo, TextBoxDate txtNokigen, TextBoxNum txtTaino, TextBoxFlexibleDate txtJikoKisanYMD, RString jikoKisanbiKubun) {
        super();
        this.setOriginalData("ki", ki);
        this.setOriginalData("tsuki", tsuki);
        this.setOriginalData("txtHokenryo", txtHokenryo);
