 ...
 */
package jp.co.ndensan.reams.db.dbd.divcontroller.handler.parentdiv.DBD2000022;
...
import jp.co.ndensan.reams.db.dbd.definition.core.futanwariai.FutanWariaiHakkoKubun;
import jp.co.ndensan.reams.db.dbd.definition.core.futanwariai.FutanWariaiHanteiKubun;
import jp.co.ndensan.reams.db.dbd.definition.core.futanwariai.FutanWariaiShikakuKubun;
...
import jp.co.ndensan.reams.db.dbd.service.core.futanwariai.RiyoshaFutanWariaiSokujiKouseiManager;
...
public class RiyoshaFutanWariaiSokujiKouseiPanelHandler {
    ...
    private final DBD2000022PanelAllDiv div;
    ...
    public void shinkiInitialize(RiyoshaFutanWariaiHanteiManagerResult 確認結果, TaishoshaKey 資格対象者) {
        ...
        if (!entityList.isEmpty()) {
            ...
            throw new ApplicationException(DbdErrorMessages.該当年度負担割合情報なし.getMessage());
        }
    ...
    public RiyoshaFutanWariai update利用者負担割合情報(RiyoshaFutanWariai 利用者負担割合, RString 処理モード) {
        RiyoshaFutanWariaiBuilder 利用者負担割合builder = 利用者負担割合.createBuilderForEdit();
        if (this.isAll削除() && DBD2000022StateName.修正.getName().equals(処理モード)) {
