 ...
 */
package jp.co.ndensan.reams.db.dbd.divcontroller.controller.parentdiv.DBD1740011;

import java.util.List;
import jp.co.ndensan.reams.db.dbd.business.core.basic.NijiYoboJigyoTaishosha;
import jp.co.ndensan.reams.db.dbd.business.core.nijiyobojigyotaishosha.NijiYoboJigyoTaishoshaHolder;
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD1740011.DBD1740011StateName;
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD1740011.DBD1740011TransitionEventName;
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD1740011.NijiyoboJohoTaishoshaTorokuPanelDiv;
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD1740011.dgNijiyoboJohoTaishoIchiran_Row;
import jp.co.ndensan.reams.db.dbd.divcontroller.handler.parentdiv.DBD1740011.NijiyoboJohoTaishoshaTorokuPanelHandler;
import jp.co.ndensan.reams.db.dbd.divcontroller.handler.parentdiv.DBD1740011.NijiyoboJohoTaishoshaTorokuPanelValidationHandler;
import jp.co.ndensan.reams.db.dbd.service.core.basic.NijiYoboJigyoTaishoshaManager;
...
public class NijiyoboJohoTaishoshaTorokuPanel {
    ...
    public ResponseData<NijiyoboJohoTaishoshaTorokuPanelDiv> onClick_btnConfim(NijiyoboJohoTaishoshaTorokuPanelDiv div) {
        ...
        return ResponseData.of(div).setState(DBD1740011StateName.Default);
    }
    ...
    public ResponseData<NijiyoboJohoTaishoshaTorokuPanelDiv> onClick_btnUpdate(NijiyoboJohoTaishoshaTorokuPanelDiv div) {
        ...
        if (ResponseHolder.getButtonType() == MessageDialogSelectedResult.Yes) {
            ...
            return ResponseData.of(div).setState(DBD1740011StateName.kanryo);
        }
        return ResponseData.of(div).respond();
    }
    ...
    public ResponseData<NijiyoboJohoTaishoshaTorokuPanelDiv> onState(NijiyoboJohoTaishoshaTorokuPanelDiv div) {
        ...
        boolean is一覧画面 = DBD1740011StateName.Default.getName().equals(ResponseHolder.getState())
                || DBD1740011StateName.NoChange.getName().equals(ResponseHolder.getState());
    ...
    public ResponseData<NijiyoboJohoTaishoshaTorokuPanelDiv> onClick_btnResearch(NijiyoboJohoTaishoshaTorokuPanelDiv div) {
        ...
        if (new RString(UrQuestionMessages.入力内容の破棄.getMessage().getCode()).equals(ResponseHolder.getMessageCode())
            ...
            前排他のロックを解除し(div);
            return ResponseData.of(div).forwardWithEventName(DBD1740011TransitionEventName.再検索).respond();
        }
        return ResponseData.of(div).respond();
    }
    ...
    public ResponseData<NijiyoboJohoTaishoshaTorokuPanelDiv> onClick_btnSearchResult(NijiyoboJohoTaishoshaTorokuPanelDiv div) {
        ...
        if (new RString(UrQuestionMessages.入力内容の破棄.getMessage().getCode()).equals(ResponseHolder.getMessageCode())
                && MessageDialogSelectedResult.Yes == ResponseHolder.getButtonType()) {
            前排他のロックを解除し(div);
            return ResponseData.of(div).forwardWithEventName(DBD1740011TransitionEventName.検索結果一覧).respond();
        }
        return ResponseData.of(div).respond();
    }
    ...
    public ResponseData<NijiyoboJohoTaishoshaTorokuPanelDiv> onClick_btnComplete(NijiyoboJohoTaishoshaTorokuPanelDiv div) {
        return ResponseData.of(div).forwardWithEventName(DBD1740011TransitionEventName.完了).respond();
    }
}
