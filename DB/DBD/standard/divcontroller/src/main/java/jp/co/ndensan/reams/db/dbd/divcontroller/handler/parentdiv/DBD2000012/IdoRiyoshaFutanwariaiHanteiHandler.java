 ...
 */
package jp.co.ndensan.reams.db.dbd.divcontroller.handler.parentdiv.DBD2000012;
...
public class IdoRiyoshaFutanwariaiHanteiHandler {
    ...
    public void 入力チェック(RDateTime 画面起動時_今回終了時間) {
        ...
        if (前回終了時間.isBefore(今回開始時間)) {
            throw new ApplicationException(DbdErrorMessages.負担割合判定_未抽出期間エラー.getMessage());
        }
