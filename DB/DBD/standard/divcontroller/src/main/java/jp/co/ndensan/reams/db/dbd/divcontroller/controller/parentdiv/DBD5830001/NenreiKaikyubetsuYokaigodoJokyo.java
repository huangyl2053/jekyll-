...
public class NenreiKaikyubetsuYokaigodoJokyo {
     ...
     */
    public ResponseData<NenreiKaikyubetsuYokaigodoJokyoParameter> onClick_btnBatchRegister(NenreiKaikyubetsuYokaigodoJokyoDiv div) {
        NenreiKaikyubetsuYokaigodoJokyoParameter parameter = getHandler(div).getParameter();
