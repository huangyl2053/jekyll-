...
public class BatchParameterDiv extends PanelBatchParameter {
    ...
    public NinteiEnkiTsuchishoBunshoBangoSettingDiv getNinteiEnkiTsuchishoBunshoBangoSetting() {
        return this.getEnkiTsuchiHakkoTaishosha().getNinteiEnkiTsuchishoBunshoBangoSetting();
    }
    ...
    public void  setNinteiEnkiTsuchishoBunshoBangoSetting(NinteiEnkiTsuchishoBunshoBangoSettingDiv NinteiEnkiTsuchishoBunshoBangoSetting) {
        this.getEnkiTsuchiHakkoTaishosha().setNinteiEnkiTsuchishoBunshoBangoSetting(NinteiEnkiTsuchishoBunshoBangoSetting);
    }

    @JsonIgnore
    public IBunshoBangoInputDiv getCcdNinteiEnkiTsuchishoBunshoBango() {
        return this.getEnkiTsuchiHakkoTaishosha().getNinteiEnkiTsuchishoBunshoBangoSetting().getCcdNinteiEnkiTsuchishoBunshoBango();
    }
