...
public class HanyoListPanel {
    ...
    public ResponseData<DBDHanyoListParameter> onClick_btnBatchRegister(HanyoListPanelDiv div) {
        ...
        parameter.setBatchKind(ResponseHolder.getState());
        ...
        shisetsuNyutaishoBatchParameter.set出力順(getSyutsuryokujun(div, new RString("DBD701014_HanyoListShisetsuNyutaisho")));
        ...
        kokuhoParameter.setSyutsuryokujun(getSyutsuryokujun(div, div.getTxtCyohyoid7().getValue()));
        ...
        kokiKoreishaParameter.setSyutsuryokujun(getSyutsuryokujun(div, div.getTxtCyohyoid8().getValue()));
        ...
        jigyoTaishoshaParameter.setSyutsuryokujun(getSyutsuryokujun(div, div.getTxtCyohyoid9().getValue()));
        ...
        riyoshaFutanwariaiParameter.setSyutsuryokujun(getSyutsuryokujun(div, div.getTxtCyohyoid10().getValue()));
    ...
    private long getSyutsuryokujun(HanyoListPanelDiv div, RString reportId) {
        div.getCcdShutsuryokujun().load(SubGyomuCode.DBD介護受給, new ReportId(reportId));
