...
public class dgJigyoTaishoshaJoho_Row extends DataRow {
    ...
    public dgJigyoTaishoshaJoho_Row(TextBoxFlexibleDate nyushoDate, TextBoxFlexibleDate taishoDate, RString jigyoshaName, RString jigyoshaCode, RString tenshutsusakiHokenshaNo) {
        super();
        this.setOriginalData("nyushoDate", nyushoDate);
        this.setOriginalData("taishoDate", taishoDate);
        this.setOriginalData("jigyoshaName", jigyoshaName);
