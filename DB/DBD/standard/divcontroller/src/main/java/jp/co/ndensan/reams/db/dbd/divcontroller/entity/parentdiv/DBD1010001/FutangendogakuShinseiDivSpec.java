...
public enum FutangendogakuShinseiDivSpec implements IPredicate<FutangendogakuShinseiDiv> {
    ...
    預貯金_1000万以下_Or_2000万以下 {
         ...
         *
         * @param div TaishouWaritsukeDiv
         * @return true:配偶者「無」のとき預貯金合計が1001万円以上（配偶者「有」のとき2001万円以上） false:配偶者「無」のとき預貯金合計が1000万円以下（配偶者「有」のとき2000万円以下）
         */
        @Override
        public boolean apply(FutangendogakuShinseiDiv div) {
            ...
            } else if (預貯金_配偶者_有.compareTo(div.getTxtYochokinGaku().getValue().add(div.getTxtYukaShoken().getValue()).add(div.getTxtSonota().getValue())) >= 0
                    && !div.getChkYochokinKijunIka().isAllSelected()) {
                return false;
            }
            return true;
