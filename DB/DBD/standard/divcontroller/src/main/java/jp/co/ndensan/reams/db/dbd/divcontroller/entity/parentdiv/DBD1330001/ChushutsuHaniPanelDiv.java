...
public class ChushutsuHaniPanelDiv extends Panel {
     ...
     */
    @JsonProperty("radNenSiteiSentaku")
    private RadioButton radNenSiteiSentaku;
     ...
     */
    /*
     * getradNenSiteiSentaku
     * @return radNenSiteiSentaku
     */
    @JsonProperty("radNenSiteiSentaku")
    ...
    /*
     * setradNenSiteiSentaku
     * @param radNenSiteiSentaku radNenSiteiSentaku
     */
    @JsonProperty("radNenSiteiSentaku")
    public void setRadNenSiteiSentaku(RadioButton radNenSiteiSentaku) {
        this.radNenSiteiSentaku = radNenSiteiSentaku;
    }
