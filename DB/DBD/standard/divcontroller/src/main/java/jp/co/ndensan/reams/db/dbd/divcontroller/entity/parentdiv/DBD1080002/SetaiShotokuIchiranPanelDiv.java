...
/**
 * SetaiShotokuIchiranPanel のクラスファイル 
 * 
 * @author 自動生成
 */
public class SetaiShotokuIchiranPanelDiv extends Panel {
     ...
     */
    @JsonProperty("ccdSetaiShotokuIchiranPanel")
    private SetaiShotokuIchiranDiv ccdSetaiShotokuIchiranPanel;
     ...
     */
    /*
     * getccdSetaiShotokuIchiranPanel
     * @return ccdSetaiShotokuIchiranPanel
     */
    @JsonProperty("ccdSetaiShotokuIchiranPanel")
    public ISetaiShotokuIchiranDiv getCcdSetaiShotokuIchiranPanel() {
        return ccdSetaiShotokuIchiranPanel;
    }
