...
public class FutanGendogakuNinteiRiyoshaFutanDiv extends Panel {
    ...
    /*
     * settxtKyushochisha
     * @param txtKyushochisha txtKyushochisha
     */
    @JsonProperty("txtKyushochisha")
    ...
    /*
     * settxtFutanDankai
     * @param txtFutanDankai txtFutanDankai
     */
    @JsonProperty("txtFutanDankai")
    ...
    /*
     * settxtKyoshitsuType
     * @param txtKyoshitsuType txtKyoshitsuType
     */
    @JsonProperty("txtKyoshitsuType")
    ...
    /*
     * settxtGekihenKanwa
     * @param txtGekihenKanwa txtGekihenKanwa
     */
    @JsonProperty("txtGekihenKanwa")
