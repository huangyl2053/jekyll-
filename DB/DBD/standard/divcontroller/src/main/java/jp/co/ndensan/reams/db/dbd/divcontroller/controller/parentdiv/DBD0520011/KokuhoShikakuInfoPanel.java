 ...
 */
package jp.co.ndensan.reams.db.dbd.divcontroller.controller.parentdiv.DBD0520011;

import jp.co.ndensan.reams.db.dbd.business.core.basic.KokuhoShikakuInfo;
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD0520011.DBD0520011StateName;
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD0520011.DBD0520011TransitionEventName;
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD0520011.KokuhoShikakuInfoPanelDiv;
import jp.co.ndensan.reams.db.dbd.divcontroller.handler.parentdiv.DBD0520011.KokuhoShikakuInfoPanelHandler;
import jp.co.ndensan.reams.db.dbd.divcontroller.handler.parentdiv.DBD0520011.MainPanelValidationHandler;
...
//        ShikibetsuCode 識別コード = new ShikibetsuCode(new RString("000000000000010"));
    ...
    public ResponseData<KokuhoShikakuInfoPanelDiv> onClick_btnSave(KokuhoShikakuInfoPanelDiv mainPanelDiv) {
        ...
        if (getHandler(mainPanelDiv).updateorinsert(taishoshaKey.get被保険者番号(),
            ...
            return ResponseData.of(mainPanelDiv).setState(DBD0520011StateName.完了);
        }
        return ResponseData.of(mainPanelDiv).respond();
    }
    ...
    public ResponseData<KokuhoShikakuInfoPanelDiv> onClick_btnBack(KokuhoShikakuInfoPanelDiv div) {
        ...
        return ResponseData.of(div).forwardWithEventName(DBD0520011TransitionEventName.対象者検索へ戻る).respond();
    }
