...
/**
 * dgTaishoShoriItchiran_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgTaishoShoriItchiran_Row extends DataRow {
    // <editor-fold defaultstate="collapsed" desc="Created By UIDesigner ver：UZ-deploy-2016-08-09_21-40-56">

    private RString txtTuki;
    private RString txtShori;
    private RString txtTaishoFuairu;
    private RString txtShoriJotai;
    private RString txtShoriNichiji;
    private RString hdnTukiCode;
    private RString hdnShoriCode;
    private RString hdnNendoNaiRenban;

    public dgTaishoShoriItchiran_Row() {
        super();
        this.txtTuki = RString.EMPTY;
        this.txtShori = RString.EMPTY;
        this.txtTaishoFuairu = RString.EMPTY;
        this.txtShoriJotai = RString.EMPTY;
    ...
    public dgTaishoShoriItchiran_Row(RString txtTuki, RString txtShori, RString txtTaishoFuairu, RString txtShoriJotai, RString txtShoriNichiji, RString hdnTukiCode, RString hdnShoriCode, RString hdnNendoNaiRenban) {
        super();
        this.setOriginalData("txtTuki", txtTuki);
        this.setOriginalData("txtShori", txtShori);
        this.setOriginalData("txtTaishoFuairu", txtTaishoFuairu);
    ...
    public RString getTxtTaishoFuairu() {
        return txtTaishoFuairu;
    }

    public RString getTxtShoriJotai() {
    ...
    public void setTxtTaishoFuairu(RString txtTaishoFuairu) {
        this.setOriginalData("txtTaishoFuairu", txtTaishoFuairu);
        this.txtTaishoFuairu = txtTaishoFuairu;
    }

    public void setTxtShoriJotai(RString txtShoriJotai) {
        this.setOriginalData("txtShoriJotai", txtShoriJotai);
        this.txtShoriJotai = txtShoriJotai;
    }
