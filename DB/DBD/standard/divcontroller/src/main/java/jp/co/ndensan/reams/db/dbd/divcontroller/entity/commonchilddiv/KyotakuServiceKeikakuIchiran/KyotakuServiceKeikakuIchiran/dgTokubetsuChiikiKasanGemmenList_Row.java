...
public class dgTokubetsuChiikiKasanGemmenList_Row extends DataRow {
    ...
    public dgTokubetsuChiikiKasanGemmenList_Row(TextBoxFlexibleDate taishoYM, RString keikakuSakuseiKubun, RString zan, RString jigyoshaNo, RString jigyoshaName, TextBoxFlexibleDate startDate, TextBoxFlexibleDate endDate, RString yukomuko) {
        super();
        this.setOriginalData("taishoYM", taishoYM);
        this.setOriginalData("keikakuSakuseiKubun", keikakuSakuseiKubun);
        this.setOriginalData("zan", zan);
