 ...
 */
package jp.co.ndensan.reams.db.dbd.divcontroller.controller.parentdiv.DBD2000023;

import jp.co.ndensan.reams.db.dbd.definition.message.DbdQuestionMessages;
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD2000023.DBD2000023StateName;
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD2000023.DBD2000023TransitionEventName;
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD2000023.RiyoshaFutanWariaiKoushiConfDiv;
import jp.co.ndensan.reams.db.dbd.divcontroller.handler.parentdiv.DBD2000023.RiyoshaFutanWariaiKoushiConfHandler;
...
public class RiyoshaFutanWariaiKoushiConf {
    ...
    public ResponseData<RiyoshaFutanWariaiKoushiConfDiv> onClick_btnPrint(RiyoshaFutanWariaiKoushiConfDiv div) {
        ...
        if (!ResponseHolder.isReRequest()) {
            QuestionMessage message = new QuestionMessage(DbdQuestionMessages.負担割合証単票発行確認.getMessage()
                    .getCode(),
                    DbdQuestionMessages.負担割合証単票発行確認.getMessage().evaluate(), ButtonSelectPattern.OKCancel);
    ...
    public ResponseData<SourceDataCollection> onClick_btnReportPublish(RiyoshaFutanWariaiKoushiConfDiv div) {
        ...
        return ResponseData.of(getHandler(div).getソースデータ取得(div, 資格対象者)).setState(DBD2000023StateName.初期表示);
    ...
    public ResponseData<RiyoshaFutanWariaiKoushiConfDiv> onClick_btnReSearch(RiyoshaFutanWariaiKoushiConfDiv div) {
        return ResponseData.of(div).forwardWithEventName(DBD2000023TransitionEventName.再検索).respond();
    }
    ...
    public ResponseData<RiyoshaFutanWariaiKoushiConfDiv> onClick_btnListSearchResult(RiyoshaFutanWariaiKoushiConfDiv div) {
        return ResponseData.of(div).forwardWithEventName(DBD2000023TransitionEventName.検索結果一覧).respond();
    }
