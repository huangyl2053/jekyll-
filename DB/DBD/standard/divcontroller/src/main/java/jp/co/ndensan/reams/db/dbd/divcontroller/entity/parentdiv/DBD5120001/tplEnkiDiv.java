...
public class tplEnkiDiv extends TabPanel {
    ...
    private TextBoxFlexibleDate txtEnkiKetteiYMD;
    @JsonProperty("txtEnkiMikomiKikanFrom")
    private TextBoxFlexibleDate txtEnkiMikomiKikanFrom;
    @JsonProperty("txtEnkiMikomiKikanTo")
    private TextBoxFlexibleDate txtEnkiMikomiKikanTo;
    ...
    private TextBoxFlexibleDate txtEnkiTsuchiHakkoYMD;
