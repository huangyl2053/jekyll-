 ...
 */
package jp.co.ndensan.reams.db.dbd.divcontroller.handler.parentdiv.DBD2000013;
...
public final class IdoufunRiyoushyafutanKanendoMainValidationHandler {
    ...
    private final IdoufunRiyoushyafutanKanendoMainDiv div;
     ...
     */
    public IdoufunRiyoushyafutanKanendoMainValidationHandler(IdoufunRiyoushyafutanKanendoMainDiv div) {
        this.div = div;
    }
    ...
    private static enum IdoufunRiyoushyafutanKanendoMessages implements IValidationMessage {
        ...
        前回終了日時と今回開始日時の比較チェック(DbdErrorMessages.抽出期間不正１),
        今回開始日時と今回終了日時の比較チェック(DbdErrorMessages.抽出期間不正２);
