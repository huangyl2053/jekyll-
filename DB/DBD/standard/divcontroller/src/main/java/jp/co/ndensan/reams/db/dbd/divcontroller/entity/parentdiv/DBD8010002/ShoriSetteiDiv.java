...
/**
 * ShoriSettei のクラスファイル 
 * 
 * @author 自動生成
 */
public class ShoriSetteiDiv extends Panel {
    ...
    /*
     * setlinShoriSettei
     * @param linShoriSettei linShoriSettei
     */
    @JsonProperty("linShoriSettei")
    public void setLinShoriSettei(HorizontalLine linShoriSettei) {
        this.linShoriSettei = linShoriSettei;
    }
