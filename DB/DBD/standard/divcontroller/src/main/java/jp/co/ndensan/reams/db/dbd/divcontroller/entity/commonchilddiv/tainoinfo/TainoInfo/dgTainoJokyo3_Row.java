...
public class dgTainoJokyo3_Row extends DataRow {
    ...
    public dgTainoJokyo3_Row(RString ki, RString tsuki, TextBoxNum txtHokenryo, TextBoxDate txtNokigen, TextBoxNum txtTaino, TextBoxFlexibleDate txtJikoKisanYMD, RString jikoKisanbiKubun) {
        super();
        this.setOriginalData("ki", ki);
        this.setOriginalData("tsuki", tsuki);
        this.setOriginalData("txtHokenryo", txtHokenryo);
