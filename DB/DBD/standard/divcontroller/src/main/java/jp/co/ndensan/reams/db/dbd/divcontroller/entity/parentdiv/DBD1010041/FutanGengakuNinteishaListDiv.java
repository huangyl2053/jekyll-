...
/**
 * FutanGengakuNinteishaList のクラスファイル 
 * 
 * @author 自動生成
 */
public class FutanGengakuNinteishaListDiv extends Panel {
    ...
    public DropDownList getDdlRiyoshaFutanDankai() {
        return this.getBatchParameter().getDdlRiyoshaFutanDankai();
    }

    @JsonIgnore
    public void  setDdlRiyoshaFutanDankai(DropDownList ddlRiyoshaFutanDankai) {
        this.getBatchParameter().setDdlRiyoshaFutanDankai(ddlRiyoshaFutanDankai);
    }
