...
/**
 * 要介護認定関連データ作成画面の入力チェックのメッセージクラスです。
 *
...
public enum RenekeiDataSakuseiFourMasterValidationMessage implements IValidationMessage {
    ...
    private RenekeiDataSakuseiFourMasterValidationMessage(IMessageGettable message) {
        this.message = message.getMessage();
    }

    private RenekeiDataSakuseiFourMasterValidationMessage(IMessageGettable message, String... replacements) {
