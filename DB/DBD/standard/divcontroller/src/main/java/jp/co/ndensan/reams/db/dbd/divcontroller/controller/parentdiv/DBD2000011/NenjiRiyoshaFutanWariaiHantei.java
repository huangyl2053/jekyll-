 ...
 */
package jp.co.ndensan.reams.db.dbd.divcontroller.controller.parentdiv.DBD2000011;
...
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD2000011.NenjiRiyoshaFutanWariaiHanteiDiv;
...
public class NenjiRiyoshaFutanWariaiHantei {
    ...
    public ResponseData<NenjiRiyoshaFutanWariaiHanteiDiv> onLoad(NenjiRiyoshaFutanWariaiHanteiDiv div) {
        ...
        if (年度.isBeforeOrEquals(TZOF) && !ResponseHolder.isReRequest()) {
            throw new ApplicationException(DbdErrorMessages.年次判定処理不可.getMessage());
    ...
    public ResponseData<NenjiRiyoshaFutanWariaiHanteiDiv> onClick_beforeBatch(NenjiRiyoshaFutanWariaiHanteiDiv div) {
        ...
        if (処理状態.equals(再処理前) && !ResponseHolder.isReRequest()) {
            QuestionMessage message = new QuestionMessage(DbdQuestionMessages.年次負担割合再処理.getMessage().getCode(),
                    DbdQuestionMessages.年次負担割合再処理.getMessage().replace(div.getPanelAll().getTxtNendo().getValue().
     ...
     * @return ResponseData
     */
    public ResponseData<DBD180010_NenjiRiyoshaFutanwariaiHanteiParameter> onClick_Batch(NenjiRiyoshaFutanWariaiHanteiDiv div) {
        DBD180010_NenjiRiyoshaFutanwariaiHanteiParameter parameter = new DBD180010_NenjiRiyoshaFutanwariaiHanteiParameter();
