 ...
 */
package jp.co.ndensan.reams.db.dbd.divcontroller.controller.parentdiv.DBD2000012;
...
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD2000012.DBD2000012StateName;
import jp.co.ndensan.reams.db.dbd.divcontroller.entity.parentdiv.DBD2000012.IdoRiyoshaFutanwariaiHanteiDiv;
import jp.co.ndensan.reams.db.dbd.divcontroller.handler.parentdiv.DBD2000012.IdoRiyoshaFutanwariaiHanteiHandler;
...
public class IdoRiyoshaFutanwariaiHantei {
    ...
    public ResponseData<IdoRiyoshaFutanwariaiHanteiDiv> onLoad(IdoRiyoshaFutanwariaiHanteiDiv div) {
        ...
        return ResponseData.of(div).setState(DBD2000012StateName.初期表示);
    }
    ...
    public ResponseData<IdoRiyoshaFutanwariaiHanteiDiv> onClick_beforeBtnBatchRegister(
        ...
        if (!ResponseHolder.isReRequest() && div.getChkTest().getSelectedKeys().contains(KEY0)) {
            QuestionMessage 利用者負担割合テストモード確認MESSAGE = new QuestionMessage(
                    DbdQuestionMessages.利用者負担割合テストモード確認.getMessage().getCode(),
                    DbdQuestionMessages.利用者負担割合テストモード確認.getMessage().evaluate(),
    ...
    public ResponseData<IdoRiyoshaFutanwariaiHanteiDiv> onStateTransition(
        ...
        if (ERRORFLAG_ERROR.equals(errorFlag)) {
            throw new ApplicationException(DbdErrorMessages.年次判定未処理.getMessage());
        }
