...
public class FutanGendogakuDiv extends Panel {
    ...
    /*
     * settxtUnitKoshitsu
     * @param txtUnitKoshitsu txtUnitKoshitsu
     */
    @JsonProperty("txtUnitKoshitsu")
    ...
    /*
     * settxtUnitJunKoshitsu
     * @param txtUnitJunKoshitsu txtUnitJunKoshitsu
     */
    @JsonProperty("txtUnitJunKoshitsu")
    ...
    /*
     * settxtJuraigataKoshitsuTokuyo
     * @param txtJuraigataKoshitsuTokuyo txtJuraigataKoshitsuTokuyo
     */
    @JsonProperty("txtJuraigataKoshitsuTokuyo")
    ...
    /*
     * settxtJuraigataKoshitsuRoken
     * @param txtJuraigataKoshitsuRoken txtJuraigataKoshitsuRoken
     */
    @JsonProperty("txtJuraigataKoshitsuRoken")
