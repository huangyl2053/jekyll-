...
/**
 * UketsukeKetteibi のクラスファイル 
 * 
 * @author 自動生成
 */
public class UketsukeKetteibiDiv extends Panel {
    ...
    /*
     * setddlBemmeiRiyu
     * @param ddlBemmeiRiyu ddlBemmeiRiyu
     */
    @JsonProperty("ddlBemmeiRiyu")
    public void setDdlBemmeiRiyu(DropDownList ddlBemmeiRiyu) {
        this.ddlBemmeiRiyu = ddlBemmeiRiyu;
    }
    ...
    /*
     * getddlBemmeiShinsaKekka
     * @return ddlBemmeiShinsaKekka
     */
    @JsonProperty("ddlBemmeiShinsaKekka")
    ...
    /*
     * setddlBemmeiShinsaKekka
     * @param ddlBemmeiShinsaKekka ddlBemmeiShinsaKekka
     */
    @JsonProperty("ddlBemmeiShinsaKekka")
    public void setDdlBemmeiShinsaKekka(DropDownList ddlBemmeiShinsaKekka) {
        this.ddlBemmeiShinsaKekka = ddlBemmeiShinsaKekka;
    }

    /*
     * gettxtHenkoKetteiYMD
    ...
    /*
     * getddlShinseiShinsaKekka
     * @return ddlShinseiShinsaKekka
     */
    @JsonProperty("ddlShinseiShinsaKekka")
    ...
    /*
     * setddlShinseiShinsaKekka
     * @param ddlShinseiShinsaKekka ddlShinseiShinsaKekka
     */
    @JsonProperty("ddlShinseiShinsaKekka")
    public void setDdlShinseiShinsaKekka(DropDownList ddlShinseiShinsaKekka) {
        this.ddlShinseiShinsaKekka = ddlShinseiShinsaKekka;
    }
