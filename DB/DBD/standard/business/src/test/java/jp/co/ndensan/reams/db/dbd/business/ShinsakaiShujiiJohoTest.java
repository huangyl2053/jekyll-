...
/**
 * {@link ShinsakaiShujiiJoho}のテストクラスです。
 *
 * @author n8235 船山洋介
 */
@RunWith(Enclosed.class)
public class ShinsakaiShujiiJohoTest extends DbdTestBase {

    public static class getterSetterTest extends DbdTestBase {

        private static ShinsakaiShujiiJoho sut;

        @BeforeClass
        public static void test() {
            sut = new ShinsakaiShujiiJoho(DbT5912ShujiiJohoEntityGenerator.createDbT5912ShujiiJohoEntity());
        }
    ...
    public static class BuilderTest {
        ...
        public void setShichosonCodeで設定した値を_生成されたShujiiJohoJukyuも保持する() {
            ShinsakaiShujiiJoho result = ShinsakaiShujiiJoho.newBuilder().setShichosonCode(new LasdecCode("100001")).build();
            assertThat(result.get市町村コード(), is(DbT5912ShujiiJohoEntityGenerator.DEFAULT_市町村コード));
        }
        ...
        public void setShujiiKanaで設定した値を_生成されたShujiiJohoJukyuも保持する() {
            ...
            assertThat(result.get主治医カナ(), is(DbT5912ShujiiJohoEntityGenerator.DEFAULT_主治医カナ));
        }

        @Test
        public void setYubinNoで設定した値を_生成されたShujiiJohoJukyuも保持する() {
            ShinsakaiShujiiJoho result = ShinsakaiShujiiJoho.newBuilder().setYubinNo(new YubinNo("1234567")).build();
            assertThat(result.get郵便番号(), is(DbT5912ShujiiJohoEntityGenerator.DEFAULT_郵便番号));
        }

        @Test
        public void setJushoで設定した値を_生成されたShujiiJohoJukyuも保持する() {
            ShinsakaiShujiiJoho result = ShinsakaiShujiiJoho.newBuilder().setJusho(new AtenaJusho("住所")).build();
            assertThat(result.get住所(), is(DbT5912ShujiiJohoEntityGenerator.DEFAULT_住所));
        }

        @Test
        public void setTelNoで設定した値を_生成されたShujiiJohoNinteiも保持する() {
            ShinsakaiShujiiJoho result = ShinsakaiShujiiJoho.newBuilder().setTelNo(new TelNo("99999999999")).build();
            assertThat(result.get電話番号(), is(DbT5912ShujiiJohoEntityGenerator.DEFAULT_電話番号));
        }

        @Test
        public void setFaxNoで設定した値を_生成されたShujiiJohoNinteiも保持する() {
            ShinsakaiShujiiJoho result = ShinsakaiShujiiJoho.newBuilder().setFaxNo(new TelNo("99999999990")).build();
            assertThat(result.getFAX番号(), is(DbT5912ShujiiJohoEntityGenerator.DEFAULT_FAX番号));
        }
        ...
        public void setShinryokaNameで設定した値を_生成されたShujiiJohoJukyuも保持する() {
            ...
            assertThat(result.get診療科名称(), is(DbT5912ShujiiJohoEntityGenerator.DEFAULT_診療科名称));
        }
        ...
        public void setShiteiiFlagで設定した値を_生成されたShujiiJohoJukyuも保持する() {
            ...
            assertThat(result.is指定医フラグ(), is(DbT5912ShujiiJohoEntityGenerator.DEFAULT_指定医フラグ));
        }
        ...
        public void setJokyoFlagで設定した値を_生成されたShujiiJohoJukyuも保持する() {
            ...
            assertThat(result.is状況フラグ(), is(DbT5912ShujiiJohoEntityGenerator.DEFAULT_状況フラグ));
        }
    }

    public static class SerializationProxyTest {

        private ShinsakaiShujiiJoho sut;

        @Before
        public void setUp() {
            sut = ShinsakaiShujiiJoho.newBuilder().build();
        }

        @Test
        public void serializeの戻り値は_デシリアライズすると_このクラスのインスタンスを生成する() {
            String b64 = _Base64Serializer.serialize(sut.serialize());
            ShinsakaiShujiiJoho desirialized = _Base64Serializer.deSerialize(b64, ShinsakaiShujiiJoho.class);
