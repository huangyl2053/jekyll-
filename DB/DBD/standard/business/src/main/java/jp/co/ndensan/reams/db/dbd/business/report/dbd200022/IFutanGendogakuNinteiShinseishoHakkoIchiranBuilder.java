...
/**
 * 負担限度額認定申請書発行一覧表Builderのインターフェースです。
 *
 * @reamsid_L DBD-3530-090 b_liuyang2
 */
interface IFutanGendogakuNinteiShinseishoHakkoIchiranBuilder extends
        IReportBuilder<FutanGendogakuNinteiShinseishoHakkoIchiranReportSource> {
