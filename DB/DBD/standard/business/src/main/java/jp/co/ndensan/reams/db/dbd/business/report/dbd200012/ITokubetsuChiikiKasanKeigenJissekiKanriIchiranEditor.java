...
/**
 * 特別地域加算軽減実績管理リストエディターのインターフェースクラスです。
 *
 * @reamsid_L DBD-3880-060 b_liuyang2
 */
interface ITokubetsuChiikiKasanKeigenJissekiKanriIchiranEditor extends
        IReportEditor<TokubetsuChiikiKasanKeigenJissekiKanriIchiranReportSource> {
