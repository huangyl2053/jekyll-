...
/**
 *
 * 汎用リスト出力(訪問介護利用者負担額減額)のOrderbyクラスです。
 *
 * @reamsid_L DBD-3940-030 panxiaobo
 */
public enum HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby implements IReportItems {
     ...
     */
    証記載保険者番号("0103", "証記載保険者番号", "訪問介護利用者負担額減額_証記載保険者番号"),
    /**
     * 項目ID:0104 フォームフィールド名:被保険者番号 MyBatis項目名:定義なし
     */
    被保険者番号("0104", "被保険者番号", "訪問介護利用者負担額減額_被保険者番号"),
    /**
    ...
    private HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby(String 項目ID, String フォームフィールド名, String 項目名) {
