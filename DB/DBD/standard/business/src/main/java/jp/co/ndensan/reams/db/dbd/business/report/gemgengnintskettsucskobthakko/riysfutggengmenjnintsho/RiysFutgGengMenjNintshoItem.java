...
public class RiysFutgGengMenjNintshoItem {
     ...
     * @param 認証者 認証者
     */
    public RiysFutgGengMenjNintshoItem(RiyoshaFutangakuGengaku 利用者負担額減額情報, IKojin iKojin, IAtesaki iAtesaki,
            ChohyoSeigyoKyotsu 帳票制御共通, List<DbT7067ChohyoSeigyoHanyoEntity> 帳票制御汎用List, Association 地方公共団体,
            RDate 交付日, ReportId 帳票分類ID, Ninshosha 認証者) {
