...
/**
 * 汎用リスト出力(特別地域加算減免)のOrderbyクラスです。
 *
 * @reamsid_L DBD-3910-030 panxiaobo
 */
public enum HanyoListTokubetsuChiikiKasanGemmenOrderby implements IReportItems {
     ...
     */
    証記載保険者番号("0103", "証記載保険者番号", "特別地域加算減免_証記載保険者番号"),
    /**
     * 項目ID:0104 フォームフィールド名:被保険者番号 MyBatis項目名:定義なし
     */
    被保険者番号("0104", "被保険者番号", "特別地域加算減免_被保険者番号"),
    /**
    ...
    private HanyoListTokubetsuChiikiKasanGemmenOrderby(String 項目ID, String フォームフィールド名, String 項目名) {
