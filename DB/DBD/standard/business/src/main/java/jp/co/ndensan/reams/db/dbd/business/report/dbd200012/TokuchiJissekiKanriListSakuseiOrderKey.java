...
/**
 * 特別地域加算軽減実績管理リスト 出力順設定可能項目です。
 *
 * @reamsid_L DBD-3880-050 jinge
 */
public enum TokuchiJissekiKanriListSakuseiOrderKey implements IReportItems {
    ...
    /**
     * 項目ID:0402 フォームフィールド名:審査年月 MyBatis項目名:審査年月
     */
    審査年月("0402", "審査年月", "審査年月"),
    /**
     * 項目ID:0301 フォームフィールド名:サービス年月 MyBatis項目名:サービス年月
     */
    サービス年月("0301", "サービス年月", "サービス年月");

    private final RString 項目ID;
    private final RString フォームフィールド名;
    private final RString 項目名;

    private TokuchiJissekiKanriListSakuseiOrderKey(String 項目ID, String フォームフィールド名, String 項目名) {
