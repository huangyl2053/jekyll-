...
public final class ShakaiFukushiHojinKeigenHakkoIchiranReport extends Report<ShakaiFukushiHojinKeigenHakkoIchiranReportSource> {
     ...
     */
    public static ShakaiFukushiHojinKeigenHakkoIchiranReport createReport(ShakaiFukushiHoujinnKeigenListRecordEntity 帳票情報,
    ...
    private ShakaiFukushiHojinKeigenHakkoIchiranReport(ShakaiFukushiHoujinnKeigenListRecordEntity 帳票情報,
            Association association, IOutputOrder iOutputOrder, IKojin 個人情報, int index) {
        this.帳票情報 = 帳票情報;
