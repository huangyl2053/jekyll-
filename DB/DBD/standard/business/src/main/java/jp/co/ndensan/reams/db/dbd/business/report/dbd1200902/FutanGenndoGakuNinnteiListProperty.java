...
public class FutanGenndoGakuNinnteiListProperty {

    /**
     * 帳票分類ID「DBD100020_FutanGendogakuNinteisho」(DBD介護受給) 出力順設定可能項目です。
     */
    public enum DBD100020_ResultListEnum implements IReportItems {
        /**
         * 郵便番号
         */
        ...
        private DBD100020_ResultListEnum(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
            this.項目ID = 項目ID;
