...
/**
 * 汎用リスト出力(施設入退所)事前準備のEnumクラスです。
 *
 * @reamsid_L DBD-1570-030 x_lilh
 */
public enum HanyoListShisetsuNyutaishoOrderKey implements IReportItems {
    ...
    private HanyoListShisetsuNyutaishoOrderKey(String 項目ID, String フォームフィールド名, String 項目名) {
