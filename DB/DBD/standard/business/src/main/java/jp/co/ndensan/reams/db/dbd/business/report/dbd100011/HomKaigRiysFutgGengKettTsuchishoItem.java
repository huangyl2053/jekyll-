...
public class HomKaigRiysFutgGengKettTsuchishoItem {
     ...
     * @param 認証者 認証者
     */
    public HomKaigRiysFutgGengKettTsuchishoItem(HomonKaigoRiyoshaFutangakuGengaku 訪問介護利用者負担額減額, IKojin iKojin, IAtesaki iAtesaki,
