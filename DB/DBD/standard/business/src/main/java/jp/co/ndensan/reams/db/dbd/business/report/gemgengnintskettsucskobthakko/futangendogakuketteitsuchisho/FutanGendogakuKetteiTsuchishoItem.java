...
/**
 * 減免減額認定証・決定通知書個別発行_負担限度額決定通知書情報
 *
 * @reamsid_L DBD-3540-050 wangchao
 */
@Getter
@SuppressWarnings("PMD.UnusedPrivateField")
public class FutanGendogakuKetteiTsuchishoItem {
     ...
     * @param 認証者 認証者
     */
    public FutanGendogakuKetteiTsuchishoItem(FutanGendogakuNintei 負担限度額認定, IKojin iKojin, IAtesaki iAtesaki, ChohyoSeigyoKyotsu 帳票制御共通,
