...
/**
 * 汎用リスト出力(国保)のOrderbyクラスです。
 *
 * @reamsid_L DBD-5510-030 mawy
 */
public enum HanyoListKokuhoOrderby implements IReportItems {
    ...
    private HanyoListKokuhoOrderby(String 項目ID, String フォームフィールド名, String 項目名) {
