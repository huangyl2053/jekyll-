...
public class YokaigoNinteiKekkaTshuchishoItem {
    ...
    private final RString kekkaKosho;
    private final RString kekkaName;
    private final RString kekkaYMDKosho;
    private final FlexibleDate kekkaYMD;
    private final RString riyu;
    private final RString serviceShurui1;
     ...
     * @param kekkaKosho 結果Kosho
     * @param kekkaName 結果名称
     * @param kekkaYMDKosho 結果年月日Kosho
     * @param kekkaYMD 結果年月日
     * @param riyu 理由
     * @param serviceShurui1 サービス種類
     ...
     * @param yubinNo 郵便番号
     * @param gyoseiku 行政区
     * @param jushoText 住所テキスト
     * @param jusho1 住所1
     * @param jusho2 住所2
     * @param jusho3 住所3
     * @param katagakiText 方書テキスト
     * @param katagaki1 方書1
     * @param katagaki2 方書2
     ...
     */
    public YokaigoNinteiKekkaTshuchishoItem(
            RString bunshoNo,
            RString title,
            RString tsuchibun1,
            ...
            RString kekkaKosho,
            RString kekkaName,
            RString kekkaYMDKosho,
            FlexibleDate kekkaYMD,
            RString riyu,
            RString serviceShurui1,
        ...
        this.kekkaKosho = kekkaKosho;
        this.kekkaName = kekkaName;
        this.kekkaYMDKosho = kekkaYMDKosho;
        this.kekkaYMD = kekkaYMD;
        this.riyu = riyu;
        this.serviceShurui1 = serviceShurui1;
