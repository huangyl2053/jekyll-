package jp.co.ndensan.reams.db.dbd.business.report.hakkorireki;
...
public enum GyomuKoyuJoho {
    ...
    /**
     * コード:ChohyoHakkoRirekiSearchDefault.帳票ID 名称:帳票ID 略称:定義なし
     */
    帳票ID(ChohyoHakkoRirekiSearchDefault.帳票ID.getCode().toString(), "帳票ID");
