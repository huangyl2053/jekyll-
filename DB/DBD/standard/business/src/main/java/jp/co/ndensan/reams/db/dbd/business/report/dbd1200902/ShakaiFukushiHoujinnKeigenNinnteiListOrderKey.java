 ...
 */
public enum ShakaiFukushiHoujinnKeigenNinnteiListOrderKey implements IReportItems {
    ...
    private ShakaiFukushiHoujinnKeigenNinnteiListOrderKey(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
        this.項目ID = 項目ID;
