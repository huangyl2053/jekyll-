...
import jp.co.ndensan.reams.db.dbd.business.report.dbd100009.ChohyoSeigyoHanyoKeysDBD100009;
 ...
 */
public class RiysFutgGengkMenjNintKetTsuchishoBodyEditor implements IRiysFutgGengkMenjNintKetTsuchishoEditor {
    ...
    private final RiysFutgGengkMenjNintKetTsuchishoItem item;
     ...
     */
    public RiysFutgGengkMenjNintKetTsuchishoBodyEditor(RiysFutgGengkMenjNintKetTsuchishoItem item) {
        this.item = item;
    }
     ...
     */
    @Override
    public RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource edit(RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource source) {
        return bodyEdit(source);
    }

    private RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource bodyEdit(RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource source) {
    ...
    private RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource setTitle(RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource source,
            RiysFutgGengkMenjNintKetTsuchishoItem item) {
    ...
    private RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource set通知書定型文(RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource source,
            int index, RiysFutgGengkMenjNintKetTsuchishoItem item, RString taisyou) {
    ...
    private RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource setCompNinshosha(RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource source,
            RiysFutgGengkMenjNintKetTsuchishoItem item) {
    ...
    private RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource setCompSofubutsuAtesaki(
            RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource source, RiysFutgGengkMenjNintKetTsuchishoItem item) {
    ...
    private static NinshoshaSource getCompNinshosha(RiysFutgGengkMenjNintKetTsuchishoItem item) {
