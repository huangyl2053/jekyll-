...
public class ShakfukusRiysFutKeigTaisKakuninshoBodyEditor implements IShakfukusRiysFutKeigTaisKakuninshoEditor {
     ...
     */
    public ShakfukusRiysFutKeigTaisKakuninshoBodyEditor(ShakaifukuRiyoshaFutanKeigen 社会福祉法人等利用者負担軽減, IKojin iKojin,
    ...
    private void setGenmenWariai(ShakfukusRiysFutKeigTaisKakuninshoReportSource source) {
    ...
    private void setgenmenNaiyo(ShakfukusRiysFutKeigTaisKakuninshoReportSource source) {
