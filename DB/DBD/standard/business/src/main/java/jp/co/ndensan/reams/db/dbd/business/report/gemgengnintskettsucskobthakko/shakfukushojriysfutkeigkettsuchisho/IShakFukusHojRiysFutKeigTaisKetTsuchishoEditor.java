...
/**
 * 社会福祉法人等利用者負担軽減対象決定通知書ヘッダエディターのインターフェースクラスです。
 *
 * @reamsid_L DBD-3540-110 wangchao
 */
interface IShakFukusHojRiysFutKeigTaisKetTsuchishoEditor extends IReportEditor<ShakaiFukushiHojinRiyoshaFutanKeigenKetteiTsuchishoReportSource> {
