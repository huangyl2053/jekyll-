 ...
 */
package jp.co.ndensan.reams.db.dbd.business.euc.riyoshafutanwariaihantei;

import jp.co.ndensan.reams.db.dbd.definition.message.DbdInformationMessages;
import jp.co.ndensan.reams.db.dbd.entity.csv.dbd180020.RiyoshaFutanWariaiHanteiCsvEntity;
...
public class RiyoshaFutanWariaiHanteiCsvEditor {
    ...
    public RiyoshaFutanWariaiHanteiCsvEntity edit() {
        ...
        if (処理区分1.equals(this.messageKubun)) {
            message = new RString(DbdInformationMessages.負担割合_職権データ.getMessage().toString());
        } else {
            message = new RString(DbdInformationMessages.負担割合_期間なし.getMessage().toString());
