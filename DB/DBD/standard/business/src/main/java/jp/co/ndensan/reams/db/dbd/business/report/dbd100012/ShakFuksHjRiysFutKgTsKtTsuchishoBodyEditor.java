...
public class ShakFuksHjRiysFutKgTsKtTsuchishoBodyEditor implements IShakFuksHjRiysFutKgTsKtTsuchishoEditor {
    ...
    private ShakFuksHojRiysFutKeigTsKetTsuchishoReportSource bodyEdit(
        ...
        source.hihokenshaNo1 = item.get社会福祉法人等利用者負担軽減().get被保険者番号().getColumnValue().substring(0, 1);
        source.hihokenshaNo2 = item.get社会福祉法人等利用者負担軽減().get被保険者番号().getColumnValue().substring(1, 2);
        source.hihokenshaNo3 = item.get社会福祉法人等利用者負担軽減().get被保険者番号().getColumnValue().substring(2, 3);
        source.hihokenshaNo4 = item.get社会福祉法人等利用者負担軽減().get被保険者番号().getColumnValue().substring(3, 4);
        source.hihokenshaNo5 = item.get社会福祉法人等利用者負担軽減().get被保険者番号().getColumnValue().substring(4, 5);
        source.hihokenshaNo6 = item.get社会福祉法人等利用者負担軽減().get被保険者番号().getColumnValue().substring(5, 6);
        source.hihokenshaNo7 = item.get社会福祉法人等利用者負担軽減().get被保険者番号().getColumnValue().substring(6, 7);
        source.hihokenshaNo8 = item.get社会福祉法人等利用者負担軽減().get被保険者番号().getColumnValue().substring(7, 8);
        source.hihokenshaNo9 = item.get社会福祉法人等利用者負担軽減().get被保険者番号().getColumnValue().substring(8, 9);
        source.hihokenshaNo10 = item.get社会福祉法人等利用者負担軽減().get被保険者番号().getColumnValue().substring(9, 10);
        ...
        if (KetteiKubun.承認する.getコード().equals(item.get社会福祉法人等利用者負担軽減().get決定区分())) {
            ...
            source.kakuninNo1 = item.get社会福祉法人等利用者負担軽減().get確認番号().substring(0, 1);
            source.kakuninNo2 = item.get社会福祉法人等利用者負担軽減().get確認番号().substring(1, 2);
            source.kakuninNo3 = item.get社会福祉法人等利用者負担軽減().get確認番号().substring(2, 3);
            source.kakuninNo4 = item.get社会福祉法人等利用者負担軽減().get確認番号().substring(3, 4);
            source.kakuninNo5 = item.get社会福祉法人等利用者負担軽減().get確認番号().substring(4, 5);
            source.kakuninNo6 = item.get社会福祉法人等利用者負担軽減().get確認番号().substring(5, 6);
            source.kakuninNo7 = item.get社会福祉法人等利用者負担軽減().get確認番号().substring(6, 7);
            source.kakuninNo8 = item.get社会福祉法人等利用者負担軽減().get確認番号().substring(7, 8);
            source.kakuninNo9 = item.get社会福祉法人等利用者負担軽減().get確認番号().substring(8, 9);
            source.kakuninNo10 = item.get社会福祉法人等利用者負担軽減().get確認番号().substring(9, 10);
    ...
    private ShakFuksHojRiysFutKeigTsKetTsuchishoReportSource setCompNinshosha(
            ShakFuksHojRiysFutKeigTsKetTsuchishoReportSource source,
    ...
    private ShakFuksHojRiysFutKeigTsKetTsuchishoReportSource setCompSofubutsuAtesaki(
            ShakFuksHojRiysFutKeigTsKetTsuchishoReportSource source, ShakFuksHjRiysFutKgTsKtTsuchishoItem item) {
    ...
    private static NinshoshaSource getCompNinshosha(ShakFuksHjRiysFutKgTsKtTsuchishoItem item) {
