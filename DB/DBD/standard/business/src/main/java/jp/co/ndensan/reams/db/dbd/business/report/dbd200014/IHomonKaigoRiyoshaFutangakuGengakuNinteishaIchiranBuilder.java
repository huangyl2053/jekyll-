...
/**
 * 訪問介護利用者負担額減額認定者リストBuilderのインターフェースです。
 *
 * @reamsid_L DBD-3970-060 b_liuyang2
 */
interface IHomonKaigoRiyoshaFutangakuGengakuNinteishaIchiranBuilder extends
        IReportBuilder<HomonKaigoRiyoshaFutangakuGengakuNinteishaIchiranReportSource> {
