 ...
 * @author n8223 朴義一
 */
public class HokenshaNinteichosaItakusakiJoho implements Serializable {

    private DbT4910NinteichosaItakusakiJohoEntity entity;

    private HokenshaNinteichosaItakusakiJoho() {
        this.entity = new DbT4910NinteichosaItakusakiJohoEntity();
    }
     ...
     */
    public HokenshaNinteichosaItakusakiJoho(DbT4910NinteichosaItakusakiJohoEntity entity) {
        this.entity = entity;
    }

    /**
     * DbT4910NinteichosaItakusakiJohoEntityを返します。
     *
     * @return DbT4910NinteichosaItakusakiJohoEntity
     */
    public DbT4910NinteichosaItakusakiJohoEntity getEntity() {
        return entity;
    }
    ...
    private HokenshaNinteichosaItakusakiJoho(Builder builder) {
    ...
    /**
     * 新しい{@link HokenshaNinteichosaItakusakiJoho}を生成するためのビルダーを返します。
     *
     * @return ビルダー
     */
    ...
    public static final class Builder {
        ...
        private Builder(HokenshaNinteichosaItakusakiJoho ninteichosaItakusakiJohoJukyu) {
            this.entity = ninteichosaItakusakiJohoJukyu.entity.clone();
        }
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private static final long serialVersionUID = 4859129729718519461L;

        private final DbT4910NinteichosaItakusakiJohoEntity entity;

        private _SerializationProxy(HokenshaNinteichosaItakusakiJoho ninteichosaItakusakiJohoJukyu) {
            this.entity = ninteichosaItakusakiJohoJukyu.entity;
        }

        private Object readResolve() {
            return new HokenshaNinteichosaItakusakiJoho(entity);
        }
    }
}
