...
/**
 *
 * 汎用リスト出力(負担限度額認定)のOrderbyクラスです。
 *
 * @reamsid_L DBD-3930-030 panxiaobo
 */
public enum HanyoListFutanGendoGakuNinteiOrderby implements IReportItems {
     ...
     */
    証記載保険者番号("0103", "証記載保険者番号", "介護保険負担限度額認定_証記載保険者番号"),
    /**
     * 項目ID:0104 フォームフィールド名:被保険者番号 MyBatis項目名:定義なし
     */
    被保険者番号("0104", "被保険者番号", "介護保険負担限度額認定_被保険者番号"),
    /**
    ...
    private HanyoListFutanGendoGakuNinteiOrderby(String 項目ID, String フォームフィールド名, String 項目名) {
