 ...
 */
package jp.co.ndensan.reams.db.dbd.business.report.gemmengengaku.ninteishoketteitsuchishokobetsuhakko;
...
/**
 * 減免減額認定証・決定通知書個別発行_利用者負担額減額情報
 *
 * @reamsid_L DBD-3540-030 wangchao
 */
public class RiyoshaFutangakuGengakuItem {
     ...
     * @param 認証者 認証者
     */
    public RiyoshaFutangakuGengakuItem(RiyoshaFutangakuGengaku 利用者負担額減額情報, IKojin iKojin, IAtesaki iAtesaki,
            ChohyoSeigyoKyotsu 帳票制御共通, List<DbT7067ChohyoSeigyoHanyoEntity> 帳票制御汎用List, Association 地方公共団体,
            RDate 発行日, RString 文書番号, List<RString> 通知書定型文List, ReportId 帳票分類ID, Ninshosha 認証者) {
