...
/**
 * 減免減額認定証・決定通知書個別発行_利用者負担額減額･免除認定決定通知書
 *
 * @reamsid_L DBD-3540-070 wangchao
 */
@Getter
@SuppressWarnings("PMD.UnusedPrivateField")
public class RiysFutgGengkMenjNintKetTsuchishoItem {
     ...
     * @param 認証者 認証者
     */
    public RiysFutgGengkMenjNintKetTsuchishoItem(RiyoshaFutangakuGengaku 利用者負担額減額情報, IKojin iKojin, IAtesaki iAtesaki,
