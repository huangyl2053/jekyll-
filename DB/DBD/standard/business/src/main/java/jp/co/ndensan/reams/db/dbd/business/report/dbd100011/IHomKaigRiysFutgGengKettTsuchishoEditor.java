...
/**
 * 訪問介護等利用者負担額減額決定通知書ヘッダエディターのインターフェースクラスです。
 *
 * @reamsid_L DBD-3540-090 wangchao
 */
interface IHomKaigRiysFutgGengKettTsuchishoEditor extends IReportEditor<HomKaigRiysFutgGengKettTsuchishoReportSource> {
