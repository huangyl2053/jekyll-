 ...
 */
public class HomKaigRiysFutgGengKettTsuchishoProerty extends ReportPropertyBase<HomKaigRiysFutgGengKettTsuchishoReportSource> {

    /**
     * コンストラクタです。
     */
    public HomKaigRiysFutgGengKettTsuchishoProerty() {
