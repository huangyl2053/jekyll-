...
/**
 * 訪問介護等利用者負担額減額決定通知書Builderのインターフェースです。
 *
 * @reamsid_L DBD-3540-090 wangchao
 */
interface IHomKaigRiysFutgGengKettsuchishoBuider extends IReportBuilder<HomonKaigoRiyoshaFutangakuGengakuKetteiTsuchishoReportSource> {
