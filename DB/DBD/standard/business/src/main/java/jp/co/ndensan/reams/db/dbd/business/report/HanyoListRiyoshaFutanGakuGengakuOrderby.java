...
/**
 *
 * 汎用リスト出力(利用者負担額減免)のOrderbyクラスです。
 *
 * @reamsid_L DBD-3950-030 panxiaobo
 */
public enum HanyoListRiyoshaFutanGakuGengakuOrderby implements IReportItems {
    ...
    private HanyoListRiyoshaFutanGakuGengakuOrderby(String 項目ID, String フォームフィールド名, String 項目名) {
