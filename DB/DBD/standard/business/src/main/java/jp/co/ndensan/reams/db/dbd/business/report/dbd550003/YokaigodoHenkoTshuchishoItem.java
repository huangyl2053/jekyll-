...
public class YokaigodoHenkoTshuchishoItem {
     ...
     * @param hihokenshaNo1 被保険者番号第1桁
     * @param hihokenshaNo2 被保険者番号第2桁
     * @param hihokenshaNo3 被保険者番号第3桁
     * @param hihokenshaNo4 被保険者番号第4桁
     * @param hihokenshaNo5 被保険者番号第5桁
     * @param hihokenshaNo6 被保険者番号第6桁
     * @param hihokenshaNo7 被保険者番号第7桁
     * @param hihokenshaNo8 被保険者番号第8桁
     * @param hihokenshaNo9 被保険者番号第9桁
     * @param hihokenshaNo10 被保険者番号第10桁
     * @param kosho1 Kosho1
     * @param kosho2 Kosho2
     * @param beforeYokaigoKubun 変更前要介護区分
     * @param afterYokaigoKubun 変更後要介護区分
     * @param henkoYmd 変更年月日
     * @param yukoKaishiYMD 有効開始年月日
     * @param yukoShuryoYMD 有効終了年月日
     * @param tsuchibun2 通知文2
     * @param kigenKosho 期限Kosho
     * @param kigenYMD 期限年月日
     ...
     */
    public YokaigodoHenkoTshuchishoItem(
            RString bunshoNo,
            RString title,
            RString tsuchibun1,
        ...
        this.kosho1 = kosho1;
        this.kosho2 = kosho2;
        this.beforeYokaigoKubun = beforeYokaigoKubun;
        this.afterYokaigoKubun = afterYokaigoKubun;
        this.henkoYmd = henkoYmd;
        this.yukoKaishiYMD = yukoKaishiYMD;
        this.yukoShuryoYMD = yukoShuryoYMD;
        this.tsuchibun2 = tsuchibun2;
        this.kigenKosho = kigenKosho;
        this.kigenYMD = kigenYMD;
