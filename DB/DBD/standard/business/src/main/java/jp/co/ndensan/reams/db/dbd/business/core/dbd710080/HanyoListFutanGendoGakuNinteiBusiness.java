 ...
 */
package jp.co.ndensan.reams.db.dbd.business.core.dbd710080;
...
/**
 *
 * 汎用リスト出力(負担限度額認定)_Business処理クラスです。
 *
 * @reamsid_L DBD-3930-030 panxiaobo
 */
public class HanyoListFutanGendoGakuNinteiBusiness {
    ...
    public void setEucCsvEntity(Association association, boolean Csvhitsukesurasyuhensyu,
            FutanGendoGakuNinteiEucCsvEntity eucCsvEntity, FutanGendoGakuNinteiEntity entity, HokenshaList hokenshaList) {
     ...
     */
    public FutanGendoGakuNinteiEucCsvEntity setNewBlank() {
