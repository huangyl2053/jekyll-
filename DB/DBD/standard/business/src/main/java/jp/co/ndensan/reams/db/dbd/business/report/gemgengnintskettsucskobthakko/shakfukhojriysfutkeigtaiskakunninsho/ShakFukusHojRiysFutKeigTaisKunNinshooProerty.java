 ...
 */
public class ShakFukusHojRiysFutKeigTaisKunNinshooProerty extends ReportPropertyBase<ShafukuRiyoshaFutanKeigenTaishoKakuninshoReportSource> {

    /**
     * コンストラクタです。
     */
    public ShakFukusHojRiysFutKeigTaisKunNinshooProerty() {
