...
public class NinteishaListSakuseiNoRenbaBusiness {
     ...
     *
     */
    public void set世帯員NoRennbannCsvEntity(ShakaiFukushiHojinKeigenNoRennbannCsvEntity eucCsvEntity, Setaiinshotokujoho joho) {
     ...
     *
     */
    public void setNoRennbannEucCsvEntity(ShakaiFukushiHojinKeigenNoRennbannCsvEntity eucCsvEntity,
            ShakaiFukushiHojinKeigenGaitoshaIchiranEntity entity, boolean 日付スラッシュ編集_flag) {
        ...
        eucCsvEntity.set認定日(toパターン32or34(日付スラッシュ編集, entity.get認定年月日()));
        eucCsvEntity.set認定開始日(toパターン32or34(日付スラッシュ編集, entity.get認定有効期間開始日()));
        eucCsvEntity.set認定終了日(toパターン32or34(日付スラッシュ編集, entity.get認定有効期間終了日()));
    }
     ...
     *
     */
    public void setNoRennbannCsvEntityEmptyNo世帯員(ShakaiFukushiHojinKeigenNoRennbannCsvEntity eucCsvEntity) {
        eucCsvEntity.setカナ氏名(RString.EMPTY);
        eucCsvEntity.set住所(RString.EMPTY);
        eucCsvEntity.set住所コード(RString.EMPTY);
        eucCsvEntity.set住民種別(RString.EMPTY);
