...
/**
 * 社会福祉法人軽減確認証・決定通知書発行一覧表エディターのインターフェースクラスです。
 *
 * @reamsid_L DBD-3981-070 b_liuyang2
 */
interface IShakaiFukushiHojinKeigenHakkoIchiranEditor extends IReportEditor<ShakaiFukushiHojinKeigenHakkoIchiranReportSource> {
