...
//        this.受給者台帳Entity.set(受給者台帳みなし要介護区分コード);
    ...
    public YokaigoNinteiJohoBuilder set要介護認定インターフェース情報消し込みフラグ(RString 要介護認定インターフェース情報消し込みフラグ) {
        requireNonNull(要介護認定インターフェース情報消し込みフラグ,
                UrSystemErrorMessages.値がnull.getReplacedMessage("要介護認定インターフェース情報消し込みフラグ"));
    ...
    public YokaigoNinteiJohoBuilder set要介護認定インターフェース情報消し込み日時(YMDHMS 要介護認定インターフェース情報消し込み日時) {
        requireNonNull(要介護認定インターフェース情報消し込み日時,
                UrSystemErrorMessages.値がnull.getReplacedMessage("要介護認定インターフェース情報消し込み日時"));
