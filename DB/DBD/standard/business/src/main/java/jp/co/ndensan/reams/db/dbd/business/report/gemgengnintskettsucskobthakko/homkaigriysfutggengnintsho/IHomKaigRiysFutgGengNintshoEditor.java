...
/**
 * 訪問介護等利用者負担額減額認定証ヘッダエディターのインターフェースクラスです。
 *
 * @reamsid_L DBD-3540-080 wangchao
 */
interface IHomKaigRiysFutgGengNintshoEditor extends IReportEditor<HomonKaigoRiyoshaFutangakuGengakuNinteishoReportSource> {
