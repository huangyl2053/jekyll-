...
/**
 * 受給者減免月別認定者数状況表Builderのインターフェースです。
 *
 * @reamsid_L DBD-3770-050 jinge
 */
interface IJukyushaGemmenTsukibetsuNinteishasuJokyohyoBuilder extends
        IReportBuilder<JukyushaGemmenTsukibetsuNinteishasuJokyohyoReportSource> {
