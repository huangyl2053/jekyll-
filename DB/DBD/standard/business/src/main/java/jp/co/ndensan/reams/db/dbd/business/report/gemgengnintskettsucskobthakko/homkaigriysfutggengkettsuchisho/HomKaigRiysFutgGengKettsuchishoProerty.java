 ...
 */
public class HomKaigRiysFutgGengKettsuchishoProerty extends ReportPropertyBase<HomonKaigoRiyoshaFutangakuGengakuKetteiTsuchishoReportSource> {

    /**
     * コンストラクタです。
     */
    public HomKaigRiysFutgGengKettsuchishoProerty() {
        super(SubGyomuCode.DBD介護受給, ReportIdDBD.DBD100011.getReportId());
    }
}
