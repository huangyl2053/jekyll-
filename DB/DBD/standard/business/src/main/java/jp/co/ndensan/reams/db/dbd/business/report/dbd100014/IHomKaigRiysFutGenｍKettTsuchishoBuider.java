...
/**
 * 特別地域加算減免・訪問介護利用者負担減額決定通知書Builderのインターフェースです。
 *
 * @reamsid_L DBD-3540-130 wangchao
 */
interface IHomKaigRiysFutGenｍKettTsuchishoBuider extends IReportBuilder<HomKaigRiysFutGenｍKettTsuchishoReportSource> {
