...
/**
 * 減免減額認定証・決定通知書個別発行_訪問介護利用者負担額減額情報
 *
 * @reamsid_L DBD-3540-030 wangchao
 */
public class HomonKaigoRiyoshaFutangakuGengakuItem {
     ...
     * @param 認証者 認証者
     */
    public HomonKaigoRiyoshaFutangakuGengakuItem(HomonKaigoRiyoshaFutangakuGengaku 訪問介護利用者負担額減額, IKojin iKojin, IAtesaki iAtesaki,
