...
/**
 * 要介護認定月別受給者数状況表（統計表）エディターのインターフェースクラスです。
 *
 * @reamsid_L DBD-1771-034 b_liuyang2
 */
interface IYokaigoNinteiTsukibetsuJukyushaSuJokyohyoEditor extends
        IReportEditor<YokaigoNinteiTsukibetsuJukyushaSuJokyohyoReportSource> {
