...
/**
 * 社会福祉法人等利用者負担軽減対象決定通知書Builderのインターフェースです。
 *
 * @reamsid_L DBD-3540-110 wangchao
 */
interface IShakFukusHojRiysFutKeigTaisKetTsuchishoBuider extends IReportBuilder<ShakaiFukushiHojinRiyoshaFutanKeigenKetteiTsuchishoReportSource> {
