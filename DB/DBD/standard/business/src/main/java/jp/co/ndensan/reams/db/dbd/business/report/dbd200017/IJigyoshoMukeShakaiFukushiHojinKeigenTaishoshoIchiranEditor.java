...
/**
 * 事業所向け社会福祉法人軽減対象者一覧表エディターのインターフェースクラスです。
 *
 * @reamsid_L DBD-3810-040 donghj
 */
interface IJigyoshoMukeShakaiFukushiHojinKeigenTaishoshoIchiranEditor extends
        IReportEditor<JigyoshoMukeShakaiFukushiHojinKeigenReportSource> {
