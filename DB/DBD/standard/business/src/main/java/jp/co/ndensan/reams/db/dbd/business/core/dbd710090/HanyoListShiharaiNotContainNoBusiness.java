 ...
 */
public class HanyoListShiharaiNotContainNoBusiness {
     ...
     */
    public void setEucCsvEntity(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, Association 地方公共団体情報, HokenshaList 保険者リスト, boolean 日付スラッシュ付加) {
    ...
    private void set宛先情報について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
    ...
    private void set医療保険加入状況について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity) {
        //医療保険加入状況
    ...
    private void set受給者台帳(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
    ...
    private void set今回申請届出について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity) {
        //今回申請届出
    ...
    private void set申請届出事業者について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity) {
        //申請届出事業者
    ...
    private void set今回申請について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //今回申請
    ...
    private void set今回調査委託先について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity) {
        //今回調査委託先
    ...
    private void set今回調査員について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity) {
    ...
    private void set今回主治医医療機関について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity) {
    ...
    private void set今回主治医について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity) {
    ...
    private void set今回調査依頼について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //今回調査依頼
        eucCsvEntity.set調査委託日(edit年月日_yyyymmdd(entity.get今回調査依頼_認定調査依頼年月日(), 日付スラッシュ付加));
    }

    private void set今回計画情報について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //今回計画情報
    ...
    private void set今回完了情報について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //今回完了情報
        eucCsvEntity.set調査終了日(edit年月日_yyyymmdd(entity.get今回完了情報_認定調査完了年月日(), 日付スラッシュ付加));
    }

    private void set今回意見書作成依頼について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //今回意見書作成依頼
        eucCsvEntity.set意見依頼日(edit年月日_yyyymmdd(entity.get今回意見書作成依頼_主治医意見書作成依頼年月日(), 日付スラッシュ付加));
    }

    private void set今回意見書情報について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //今回意見書情報
        eucCsvEntity.set意見取寄日(edit年月日_yyyymmdd(entity.get今回意見書情報_主治医意見書受領年月日(), 日付スラッシュ付加));
    }

    private void set今回一次判定結果について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //今回一次判定結果
        eucCsvEntity.set一次判定日(edit年月日_yyyymmdd(entity.get今回一次判定結果_要介護認定一次判定年月日(), 日付スラッシュ付加));
    }

    private void set今回結果情報について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //今回結果情報
    ...
    private void set初回受給情報について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //初回受給情報
    ...
    private void set初回申請について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity) {
        //初回申請
        eucCsvEntity.set初回支援申請事由(edit支援申請(entity.get初回申請_要支援者認定申請区分()));
    }

    private void set前回受給情報について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //前回受給情報
    ...
    private void set前回申請について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity) {
        //前回申請
        eucCsvEntity.set前回支援申請事由(edit支援申請(entity.get前回申請_要支援者認定申請区分()));
    }

    private void set前々回受給情報について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //前々回受給情報
    ...
    private void set今回調査結果_基本について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity) {
        //今回調査結果_基本
    ...
    private void set介護保険施設入退所について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //介護保険施設入退所
    ...
    private void set居宅届出について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //居宅届出
    ...
    private void set事業者作成について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //事業者作成
    ...
    private void set計画事業者について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity) {
        //計画事業者
    ...
    private void set計画事業者代表者について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity) {
        //計画事業者代表者
    ...
    private void set自己作成について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //自己作成
    ...
    private void set指定事業者について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //指定事業者
    ...
    private void set除外他特適用施設について(GeneralPurposeListOutputNotContainNoEucCsvEntity eucCsvEntity,
            GeneralPurposeListOutputEntity entity, boolean 日付スラッシュ付加) {
        //除外他特適用施設
