...
public class SokyuuFuicchiCsvProperty {

    /**
     * 帳票分類ID「DBD900004_HikazeiNenkinUmareYMDSeibetsuNameChackList」(DBD介護受給) 出力順設定可能項目です。
     */
    public enum DBD900007_ResultListEnum implements IReportItems {
        ...
        private DBD900007_ResultListEnum(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
            this.項目ID = 項目ID;
