...
/**
 * 負担限度額認定の通知書発行_出力順設定可能項目です。
 *
 * @reamsid_L DBD-3981-050 x_xuliang
 */
public enum FutanGenndoGakuNinnteiShouListOrderKey implements IReportItems {
    ...
    //TODO 入所施設コードは検索関連のテープルから取得できません。
    /**
     * 入所施設コード
     */
    ...
    private FutanGenndoGakuNinnteiShouListOrderKey(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
        this.項目ID = 項目ID;
