...
/**
 * 利用負担額減額免除認定証Editorのインターフェースクラスです。
 *
 * @reamsid_L DBD-3980-050 x_youyj
 */
public interface IRiyoshaFutangakuGemmenGaitoshaIchiranEditor extends IReportEditor<RiyoshaFutangakuGemmenGaitoshaIchiranReportSource>  {
