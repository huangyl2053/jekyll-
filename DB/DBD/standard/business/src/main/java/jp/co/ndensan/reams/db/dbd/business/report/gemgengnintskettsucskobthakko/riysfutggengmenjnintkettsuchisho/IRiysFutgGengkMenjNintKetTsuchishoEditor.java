...
/**
 * 利用者負担額減額･免除認定決定通知書ヘッダエディターのインターフェースクラスです。
 *
 * @reamsid_L DBD-3540-070 wangchao
 */
interface IRiysFutgGengkMenjNintKetTsuchishoEditor extends IReportEditor<RiyoshaFutangakuGengakuMenjoKetteiTsuchishoReportSource> {
