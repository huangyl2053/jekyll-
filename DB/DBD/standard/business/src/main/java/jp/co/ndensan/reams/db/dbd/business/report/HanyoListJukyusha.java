...
/**
 * 汎用リスト　受給者台帳のOrderbyクラスです。
 *
 * @reamsid_L DBD-1800-020 x_youyj
 */
public enum HanyoListJukyusha implements IReportItems {
     ...
     */
    証記載保険者番号("0103", "証記載保険者番号", "被保険者台帳管理_被保険者区分コード"),
    /**
     ...
     */
    要介護度("0403", "要介護度", "受給者台帳_要介護認定状態区分コード"),
    /**
     * 項目ID:0404 フォームフィールド名:受給申請区分 MyBatis項目名:定義なし
     */
    受給申請区分("0404", "受給申請区分", "受給者台帳_要支援者認定申請区分"),
    /**
     * 項目ID:0411 フォームフィールド名:認定開始日 MyBatis項目名:定義なし
     */
    認定開始日("0411", "認定開始日", "受給者台帳_認定有効期間開始年月日"),
    /**
    ...
    private HanyoListJukyusha(String 項目ID, String フォームフィールド名, String 項目名) {
