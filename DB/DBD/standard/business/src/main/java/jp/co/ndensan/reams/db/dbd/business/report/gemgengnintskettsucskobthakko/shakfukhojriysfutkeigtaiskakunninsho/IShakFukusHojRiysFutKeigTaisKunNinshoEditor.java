...
/**
 * 社会福祉法人等利用者負担軽減対象確認証ヘッダエディターのインターフェースクラスです。
 *
 * @reamsid_L DBD-3540-100 wangchao
 */
interface IShakFukusHojRiysFutKeigTaisKunNinshoEditor extends IReportEditor<ShafukuRiyoshaFutanKeigenTaishoKakuninshoReportSource> {
