...
public class FutanGenndoGakuNinnteiShouListPropery {

    public enum DBD1200902_FutanGenndoGakuNinnteiShouListEnum implements IReportItems {
        ...
        private DBD1200902_FutanGenndoGakuNinnteiShouListEnum(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
            this.項目ID = 項目ID;
