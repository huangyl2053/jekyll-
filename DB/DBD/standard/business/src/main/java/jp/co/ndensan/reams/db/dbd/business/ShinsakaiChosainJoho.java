 ...
 * @author n8223 朴義一
 */
public class ShinsakaiChosainJoho {
     ...
     */
    public ShinsakaiChosainJoho(DbT5913ChosainJohoEntity entity) {
        this.entity = entity;
    }
    ...
    private ShinsakaiChosainJoho(Builder builder) {
    ...
    /**
     * 新しい{@link ShinsakaiChosainJoho}を生成するためのビルダーを返します。
     *
     * @return ビルダー
     */
    ...
    public static final class Builder {
        ...
        private Builder(ShinsakaiChosainJoho chosainJohoNintei) {
            this.entity = chosainJohoNintei.entity.clone();
        }
        ...
        /**
         * {@link ShinsakaiChosainJoho}を生成します。
         *
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private static final long serialVersionUID = -6761190053650952580L;

        private final DbT5913ChosainJohoEntity entity;

        private _SerializationProxy(ShinsakaiChosainJoho chosainJohoNintei) {
            this.entity = chosainJohoNintei.entity;
        }

        private Object readResolve() {
            return new ShinsakaiChosainJoho(entity);
        }
    }
}
