 ...
 */
public class FutanGendogakuNinteiItem {
     ...
     * @param 認証者 認証者
     */
    public FutanGendogakuNinteiItem(FutanGendogakuNintei 負担限度額認定, IKojin iKojin, IAtesaki iAtesaki, ChohyoSeigyoKyotsu 帳票制御共通,
