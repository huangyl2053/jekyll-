...
/**
 * 事業所向け社会福祉法人軽減対象者一覧表Builderのインターフェースです。
 *
 * @reamsid_L DBD-3810-040 donghj
 */
interface IJigyoshoMukeShakaiFukushiHojinKeigenTaishoshoIchiranBuilder extends
        IReportBuilder<JigyoshoMukeShakaiFukushiHojinKeigenReportSource> {
