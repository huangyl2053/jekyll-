...
public class ShakaiFukushiHoujinnKeigenNinnteiListPropery {

    public enum DBD1200902_ShakaiFukushiHoujinnKeigenNinnteiListEnum implements IReportItems {
         ...
         * 確認番号
         */
        確認番号(new RString("0110"), new RString("確認番号"), new RString("")),
        /**
         * 決定区分
         */
        決定区分(new RString("0111"), new RString("決定区分"), new RString("")),
        /**
         * 計画事業者番号
         */
        ...
        private DBD1200902_ShakaiFukushiHoujinnKeigenNinnteiListEnum(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
            this.項目ID = 項目ID;
