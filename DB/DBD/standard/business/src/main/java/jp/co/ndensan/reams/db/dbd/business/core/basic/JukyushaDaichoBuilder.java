...
//TODO 一緒に置換される値のまとまりで不変なクラスを作成し、その単位でsetterを作る様に見直してください。
     ...
     */
    public JukyushaDaichoBuilder set市町村コード(LasdecCode 市町村コード) {
     ...
     * @return {@link JukyushaDaichoBuilder}
     */
    public JukyushaDaichoBuilder set被保険者番号(HihokenshaNo 被保険者番号) {
     ...
     * @return {@link JukyushaDaichoBuilder}
     */
    public JukyushaDaichoBuilder set履歴番号(RString 履歴番号) {
     ...
     * @return {@link JukyushaDaichoBuilder}
     */
    public JukyushaDaichoBuilder set枝番(RString 枝番) {
     ...
     * @return {@link JukyushaDaichoBuilder}
     */
    public JukyushaDaichoBuilder set受給申請事由(Code 受給申請事由) {
