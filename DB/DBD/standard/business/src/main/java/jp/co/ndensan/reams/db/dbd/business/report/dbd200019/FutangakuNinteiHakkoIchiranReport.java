...
public final class FutangakuNinteiHakkoIchiranReport extends Report<FutangakuNinteiHakkoIchiranReportSource> {
     ...
     */
    public static FutangakuNinteiHakkoIchiranReport createReport(FutanGenndoGakuNinnteiListRecordEntity 帳票情報,
    ...
    private FutangakuNinteiHakkoIchiranReport(FutanGenndoGakuNinnteiListRecordEntity 帳票情報,
            Association association, IOutputOrder iOutputOrder, IKojin 個人情報, int index) {
        this.帳票情報 = 帳票情報;
