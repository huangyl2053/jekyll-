...
//    private final FutangakuNinteiHakkoIchiranEntity 帳票情報;
     ...
     */
    public static FutangakuNinteiHakkoIchiranReport createReport(
            Association association, IOutputOrder iOutputOrder, IKojin 個人情報, int index) {
        return new FutangakuNinteiHakkoIchiranReport(association, iOutputOrder, 個人情報, index);
    }

    private FutangakuNinteiHakkoIchiranReport(
            Association association, IOutputOrder iOutputOrder, IKojin 個人情報, int index) {
//        this.帳票情報 = 帳票情報;
