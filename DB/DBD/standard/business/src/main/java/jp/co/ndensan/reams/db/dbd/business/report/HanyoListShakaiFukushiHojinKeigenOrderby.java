...
/**
 * 汎用リスト出力(社会福祉法人軽減)のOrderbyクラスです。
 *
 * @reamsid_L DBD-3900-030 mawy
 */
public enum HanyoListShakaiFukushiHojinKeigenOrderby implements IReportItems {
     ...
     */
    証記載保険者番号("0103", "証記載保険者番号", "社会福祉法人等利用者負担軽減_証記載保険者番号"),
    /**
     * 項目ID:0104 フォームフィールド名:被保険者番号 MyBatis項目名:定義なし
     */
    被保険者番号("0104", "被保険者番号", "社会福祉法人等利用者負担軽減_被保険者番号"),
    /**
    ...
    private HanyoListShakaiFukushiHojinKeigenOrderby(String 項目ID, String フォームフィールド名, String 項目名) {
