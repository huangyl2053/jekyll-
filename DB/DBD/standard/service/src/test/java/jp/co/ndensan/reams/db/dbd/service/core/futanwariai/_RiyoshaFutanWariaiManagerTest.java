...
@Ignore
public class _RiyoshaFutanWariaiManagerTest {

    private static DbT3113RiyoshaFutanWariaiDac dac;
    private static _RiyoshaFutanWariaiManager sut;

    @BeforeClass
    public static void test() {
        dac = mock(DbT3113RiyoshaFutanWariaiDac.class);
        sut = new _RiyoshaFutanWariaiManager(dac);
    }
    ...
    public static class get利用者負担割合 extends DbcTestBase {
        ...
        public void 引数の主キー型1にnullを指定した場合_NullPointerExceptionが発生する() {
            ...
            int 主キー3 = DbT3113RiyoshaFutanWariaiEntityGenerator.DEFAULT_履歴番号;
