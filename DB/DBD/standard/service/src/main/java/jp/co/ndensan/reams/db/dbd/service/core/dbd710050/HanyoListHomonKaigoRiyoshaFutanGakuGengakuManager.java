 ...
 */
package jp.co.ndensan.reams.db.dbd.service.core.dbd710050;

import java.util.ArrayList;
import java.util.List;
import jp.co.ndensan.reams.db.dbd.business.core.dbd710050.HanyoListHomonKaigoRiyoshaFutanGakuGengakuBusiness;
...
/**
 *
 * 汎用リスト出力(訪問介護利用者負担額減額)_ＣＳＶ編集クラスです．
 *
 * @reamsid_L DBD-3940-030 panxiaobo
 */
public class HanyoListHomonKaigoRiyoshaFutanGakuGengakuManager {
     ...
     */
    public static HanyoListHomonKaigoRiyoshaFutanGakuGengakuManager createInstance() {
        return InstanceProvider.create(HanyoListHomonKaigoRiyoshaFutanGakuGengakuManager.class);
    }
     ...
     */
    public void get情報設定(HomonKaigoRiyoshaFutanGakuGengakuEucCsvEntity eucCsvEntity, HomonKaigoRiyoshaFutanGakuGengakuEntity entity,
            Association 地方公共団体情報, HokenshaList 保険者リスト, boolean 日付スラッシュ付加) {
        HanyoListHomonKaigoRiyoshaFutanGakuGengakuBusiness bus = new HanyoListHomonKaigoRiyoshaFutanGakuGengakuBusiness();
     ...
     */
    public HomonKaigoRiyoshaFutanGakuGengakuEucCsvEntity setBlank() {
        HanyoListHomonKaigoRiyoshaFutanGakuGengakuBusiness bus = new HanyoListHomonKaigoRiyoshaFutanGakuGengakuBusiness();
     ...
     *
     */
    public void get方法(HomonKaigoRiyoshaFutanGakuGengakuEntity entity, HanyoListEntity hanyolistentity) {
        ...
        hanyolistentity.set証記載保険者番号(entity.get訪問介護利用者負担額減額_証記載保険者番号());
     ...
     *
     */
    public void バッチ出力条件リストの出力(HanyoListHomonKaigoRiyoshaFutanGakuGengakuProcessParameter processParamter, RString 導入団体コード,
    ...
    private RStringBuilder 宛名判定(List<RString> 出力条件, RStringBuilder builder,
            HanyoListHomonKaigoRiyoshaFutanGakuGengakuProcessParameter processParamter) {
        if (null != processParamter.getAtenacyusyutsujyoken()
    ...
    private RString 宛名判定(RString 帳票物理名, RString 項目ID) {
        if (HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby.郵便番号.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("yubinNo");
        } else if (HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby.町域コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("choikiCode");
        } else if (HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby.番地コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("banchi");
        } else if (HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby.行政区コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("gyoseikuCode");
        } else if (HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby.地区１.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("chikuCode1");
        } else if (HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby.地区２.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("chikuCode2");
        } else if (HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby.世帯コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("setaiCode");
        } else if (HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby.識別コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("shikibetsuCode");
        } else if (HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby.氏名５０音カナ.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("kanaShimei");
        } else if (HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby.生年月日.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("seinengappiYMD");
        } else if (HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby.性別.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("seibetsuCode");
        } else if (HanyoListHomonKaigoRiyoshaFutanGakuGengakuOrderby.市町村コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("shichosonCode1");
        }
        return 帳票物理名;
    }

    private void バッチ出力条件表出力(HanyoListHomonKaigoRiyoshaFutanGakuGengakuProcessParameter processParamter, RString 導入団体コード,
            RString 市町村名, RString 日本語ファイル名, RString 英数字ファイル名, RString ジョブ番号,
            List<RString> 出力条件, boolean is帳票出力, RString 出力ページ数, RString 出力件数) {
        if (is帳票出力) {
            RString csv出力有無;
            RString csvファイル名;
    ...
    private RStringBuilder get日付範囲(HanyoListHomonKaigoRiyoshaFutanGakuGengakuProcessParameter processParamter, RStringBuilder builder) {
    ...
    private RString get宛名抽出区分情報(HanyoListHomonKaigoRiyoshaFutanGakuGengakuProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString get地区選択区分情報(HanyoListHomonKaigoRiyoshaFutanGakuGengakuProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString get対象データ(HanyoListHomonKaigoRiyoshaFutanGakuGengakuProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString get特定対象データ(HanyoListHomonKaigoRiyoshaFutanGakuGengakuProcessParameter processParamter, RStringBuilder builder) {
    ...
    private RStringBuilder get年齢(HanyoListHomonKaigoRiyoshaFutanGakuGengakuProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RStringBuilder get生年月日(HanyoListHomonKaigoRiyoshaFutanGakuGengakuProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
