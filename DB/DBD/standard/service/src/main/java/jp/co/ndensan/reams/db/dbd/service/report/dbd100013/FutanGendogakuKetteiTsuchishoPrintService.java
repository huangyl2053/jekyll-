 ...
 */
package jp.co.ndensan.reams.db.dbd.service.report.dbd100013;
...
public class FutanGendogakuKetteiTsuchishoPrintService {
     ...
     */
    public void print(FutanGendogakuNintei 負担限度額認定, IKojin iKojin, IAtesaki iAtesaki, ChohyoSeigyoKyotsu 帳票制御共通,
            List<DbT7067ChohyoSeigyoHanyoEntity> 帳票制御汎用List, Association 地方公共団体, RDate 発行日, RString 文書番号,
            List<RString> 通知書定型文List, ReportId 帳票分類ID, ReportManager reportManager) {
        ...
        try (ReportAssembler<FutanGendogakuKetteiTsuchishoReportSource> assembler = createAssembler(property, reportManager)) {
            ...
            FutanGendogakuKetteiTsuchishoReport report = FutanGendogakuKetteiTsuchishoReport.createReport(負担限度額認定,
                    iKojin,
                    iAtesaki,
                    帳票制御共通,
                    帳票制御汎用List,
