...
public class RiyoshaFutanWariaiMeisaiManager {
    ...
    private final _RiyoshaFutanWariaiKonkyoManager 利用者負担割合世帯員Manager;
    ...
    RiyoshaFutanWariaiMeisaiManager() {
        ...
        this.利用者負担割合世帯員Manager = new _RiyoshaFutanWariaiKonkyoManager();
    }
    ...
    RiyoshaFutanWariaiMeisaiManager(
            ...
            _RiyoshaFutanWariaiKonkyoManager 利用者負担割合世帯員Manager
    ) {
