 ...
 */
package jp.co.ndensan.reams.db.dbd.service.report.genmengengaku.ninteishoketteitsuchishokobetsuhakko;
...
import jp.co.ndensan.reams.db.dbd.business.report.gemmengengaku.ninteishoketteitsuchishokobetsuhakko.FutanGendogakuNinteiItem;
import jp.co.ndensan.reams.db.dbd.business.report.gemmengengaku.ninteishoketteitsuchishokobetsuhakko.HomonKaigoRiyoshaFutangakuGengakuItem;
import jp.co.ndensan.reams.db.dbd.business.report.gemmengengaku.ninteishoketteitsuchishokobetsuhakko.RiyoshaFutangakuGengakuItem;
import jp.co.ndensan.reams.db.dbd.business.report.gemmengengaku.ninteishoketteitsuchishokobetsuhakko.ShakaifukuRiyoshaFutanKeigenItem;
import jp.co.ndensan.reams.db.dbd.business.report.gemmengengaku.ninteishoketteitsuchishokobetsuhakko.TokubetsuchiikiKasanGemmenItem;
...
public class GenmenGengakuNinteishoKetteiTsuchishoKobetsuHakko {
    ...
    public void publish(List<RString> 帳票タイプリスト, HihokenshaNo 被保険者番号, ShikibetsuCode 識別コード,
        ...
        if (GemmenGengakuNinteishoKetteiTsuchisho.利用者負担額減額_免除等認定証.get名称().equals(帳票タイプリスト.get(0))
                || GemmenGengakuNinteishoKetteiTsuchisho.利用者負担額減額_免除決定通知書.get名称().equals(帳票タイプリスト.get(0))) {
            RiyoshaFutangakuGengaku 利用者負担額減額情報
                    = getRiyoshaFutanGengaku(被保険者番号, GemmenGengakuShurui.利用者負担額減額.getコード(), 履歴番号);
            List<RiyoshaFutangakuGengakuItem> itemList = new ArrayList<>();
            RiyoshaFutangakuGengakuItem item = new RiyoshaFutangakuGengakuItem(
                    利用者負担額減額情報,
            ...
            List<FutanGendogakuNinteiItem> itemList = new ArrayList<>();
            FutanGendogakuNinteiItem item = new FutanGendogakuNinteiItem(
                    負担限度額認定,
                    ShikibetsuTaishoFactory.createKojin(uaFt200Entity),
                    AtesakiFactory.createInstance(uaFt250Entity),
                    new ChohyoSeigyoKyotsu(dbT7065Entity),
            ...
            List<HomonKaigoRiyoshaFutangakuGengakuItem> itemList = new ArrayList<>();
            HomonKaigoRiyoshaFutangakuGengakuItem item = new HomonKaigoRiyoshaFutangakuGengakuItem(
                    訪問介護利用者負担額減額,
                    ShikibetsuTaishoFactory.createKojin(uaFt200Entity),
                    AtesakiFactory.createInstance(uaFt250Entity),
                    new ChohyoSeigyoKyotsu(dbT7065Entity),
