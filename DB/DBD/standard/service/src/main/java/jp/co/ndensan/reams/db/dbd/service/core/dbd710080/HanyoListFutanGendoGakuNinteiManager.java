...
public class HanyoListFutanGendoGakuNinteiManager {
     ...
     *
     */
    public void get方法(FutanGendoGakuNinteiEntity entity, HanyoListEntity hanyolistentity) {
     ...
     *
     */
    public void バッチ出力条件リストの出力(HanyoListFutanGendoGakuNinteiProcessParameter processParamter, RString 導入団体コード,
        ...
        RString get対象データ = get対象データ(processParamter);
    ...
    private RStringBuilder get日付範囲(HanyoListFutanGendoGakuNinteiProcessParameter processParamter, RStringBuilder builder) {
    ...
    private RString get宛名抽出区分情報(HanyoListFutanGendoGakuNinteiProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString get地区選択区分情報(HanyoListFutanGendoGakuNinteiProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString get対象データ(HanyoListFutanGendoGakuNinteiProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString get特定対象データ(HanyoListFutanGendoGakuNinteiProcessParameter processParamter, RStringBuilder builder) {
    ...
    private RString get旧措置者(HanyoListFutanGendoGakuNinteiProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString get利用者負担段階(HanyoListFutanGendoGakuNinteiProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RStringBuilder get年齢(HanyoListFutanGendoGakuNinteiProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RStringBuilder get生年月日(HanyoListFutanGendoGakuNinteiProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString 宛名判定(RString 帳票物理名, RString 項目ID) {
        ...
        } else if (HanyoListFutanGendoGakuNinteiOrderby.番地コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("banchi");
        } else if (HanyoListFutanGendoGakuNinteiOrderby.行政区コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("gyoseikuCode");
        } else if (HanyoListFutanGendoGakuNinteiOrderby.地区１.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("chikuCode1");
        } else if (HanyoListFutanGendoGakuNinteiOrderby.地区２.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("chikuCode2");
        } else if (HanyoListFutanGendoGakuNinteiOrderby.世帯コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("setaiCode");
        } else if (HanyoListFutanGendoGakuNinteiOrderby.識別コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("shikibetsuCode");
        } else if (HanyoListFutanGendoGakuNinteiOrderby.氏名５０音カナ.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("kanaShimei");
        } else if (HanyoListFutanGendoGakuNinteiOrderby.生年月日.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("seinengappiYMD");
        } else if (HanyoListFutanGendoGakuNinteiOrderby.性別.get項目ID().equals(項目ID)) {
