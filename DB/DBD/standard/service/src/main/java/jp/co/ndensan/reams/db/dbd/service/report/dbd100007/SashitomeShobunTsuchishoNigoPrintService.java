 ...
 */
public class SashitomeShobunTsuchishoNigoPrintService {
    ...
    public void print(IKojin 個人情報, IAtesaki 宛先, ChohyoSeigyoKyotsu 帳票制御共通, Association 地方公共団体,
        ...
        try (ReportAssembler<SashitomeShobunTsuchishoNigoReportSource> assembler = createAssembler(property, reportManager)) {
            ReportSourceWriter<SashitomeShobunTsuchishoNigoReportSource> reportSourceWriter = new ReportSourceWriter(assembler);
            NinshoshaSource 認証者ソースビルダー = ReportUtil.get認証者情報(SubGyomuCode.DBD介護受給, 帳票分類ID, 発行日,
                    NinshoshaDenshikoinshubetsuCode.保険者印.getコード(), KenmeiFuyoKubunType.付与なし, reportSourceWriter);
            SashitomeShobunTsuchishoNigoReport report = SashitomeShobunTsuchishoNigoReport.createReport(個人情報, 宛先,
