...
import jp.co.ndensan.reams.db.dbd.business.report.HanyoListRiyoshaFutanGakuGengakuOrderby;
...
public class HanyoListRiyoshaFutanGakuGengakuManageer {
     ...
     */
    public void get情報設定(RiyoshaFutanGakuGengakuEucCsvEntity eucCsvEntity, RiyoshaFutanGakuGengakuEntity entity,
     ...
     *
     */
    public void バッチ出力条件リストの出力(HanyoListRiyoshaFutanGakuGengakuProcessParameter processParamter, RString 導入団体コード,
            RString 市町村名, boolean is帳票出力, RString 出力ページ数, RString 出力件数) {
        ...
        バッチ出力条件表出力(processParamter, 導入団体コード, 市町村名, 日本語ファイル名,
                英数字ファイル名, ジョブ番号, 出力条件, is帳票出力, 出力ページ数, 出力件数);
    }

    private void バッチ出力条件表出力(HanyoListRiyoshaFutanGakuGengakuProcessParameter processParamter, RString 導入団体コード,
    ...
    private RStringBuilder 宛名判定(List<RString> 出力条件, RStringBuilder builder, HanyoListRiyoshaFutanGakuGengakuProcessParameter processParamter) {
        if (null != processParamter.getAtenacyusyutsujyoken()
    ...
    private RStringBuilder get日付範囲(HanyoListRiyoshaFutanGakuGengakuProcessParameter processParamter, RStringBuilder builder) {
    ...
    private RString get宛名抽出区分情報(HanyoListRiyoshaFutanGakuGengakuProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString get地区選択区分情報(HanyoListRiyoshaFutanGakuGengakuProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString get対象データ(HanyoListRiyoshaFutanGakuGengakuProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString get特定対象データ(HanyoListRiyoshaFutanGakuGengakuProcessParameter processParamter, RStringBuilder builder) {
    ...
    private RStringBuilder get年齢(HanyoListRiyoshaFutanGakuGengakuProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RStringBuilder get生年月日(HanyoListRiyoshaFutanGakuGengakuProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString 宛名判定(RString 帳票物理名, RString 項目ID) {
        ...
        } else if (HanyoListRiyoshaFutanGakuGengakuOrderby.番地コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("banchi");
        } else if (HanyoListRiyoshaFutanGakuGengakuOrderby.行政区コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("gyoseikuCode");
        } else if (HanyoListRiyoshaFutanGakuGengakuOrderby.地区１.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("chikuCode1");
        } else if (HanyoListRiyoshaFutanGakuGengakuOrderby.地区２.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("chikuCode2");
        } else if (HanyoListRiyoshaFutanGakuGengakuOrderby.世帯コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("setaiCode");
        } else if (HanyoListRiyoshaFutanGakuGengakuOrderby.識別コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("shikibetsuCode");
        } else if (HanyoListRiyoshaFutanGakuGengakuOrderby.氏名５０音カナ.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("kanaShimei");
        } else if (HanyoListRiyoshaFutanGakuGengakuOrderby.生年月日.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("seinengappiYMD");
        } else if (HanyoListRiyoshaFutanGakuGengakuOrderby.性別.get項目ID().equals(項目ID)) {
