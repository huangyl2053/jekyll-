 ...
 * 利用者負担割合明細を管理するクラスです。
 */
public class _RiyoshaFutanWariaiMeisaiManager {
     ...
     * コンストラクタです。
     */
    public _RiyoshaFutanWariaiMeisaiManager() {
     ...
     */
    _RiyoshaFutanWariaiMeisaiManager(DbT3114RiyoshaFutanWariaiMeisaiDac dac) {
        this.dac = dac;
    }
