...
public class HanyoListKokuhoManager {
     ...
     */
    public void get情報設定(HanyoRisutoKokuhoEucCsvEntity eucCsvEntity, HanyoRisutoKokuhoEntity entity,
        ...
        RString 市町村名 = HanyoListManager.createInstance().
                get地方公共団体(new LasdecCode(entity.get最新被保台帳_市町村コード())).get市町村名();
     ...
     *
     */
    public void get方法(HanyoRisutoKokuhoEntity entity, HanyoListEntity hanyolistentity) {
     ...
     *
     */
    public void バッチ出力条件リストの出力(HanyoListKokuhoProcessParameter processParamter, RString 導入団体コード,
        ...
        宛名判定(出力条件, builder, processParamter);
    ...
    private void バッチ出力条件表出力(HanyoListKokuhoProcessParameter processParamter, RString 導入団体コード, RString 市町村名, RString 日本語ファイル名,
    ...
    private void 宛名判定(List<RString> 出力条件, RStringBuilder builder, HanyoListKokuhoProcessParameter processParamter) {
        if (null != processParamter.getAtenacyusyutsujyoken()
    ...
    private RStringBuilder get日付範囲(HanyoListKokuhoProcessParameter processParamter, RStringBuilder builder) {
    ...
    private RString get宛名抽出区分情報(HanyoListKokuhoProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString get地区選択区分情報(HanyoListKokuhoProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RStringBuilder get年齢(HanyoListKokuhoProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RStringBuilder get生年月日(HanyoListKokuhoProcessParameter processParamter) {
        RStringBuilder builder = new RStringBuilder();
    ...
    private RString to帳票物理名(RString 項目ID) {
        ...
        if (帳票物理名 != null && !帳票物理名.isEmpty()) {
            ...
            } else if (HanyoListKokuhoOrderby.受給申請区分.get項目ID().equals(項目ID)) {
                帳票物理名 = new RString("jukyuShinseiKubun");
            } else if (HanyoListKokuhoOrderby.受給申請日.get項目ID().equals(項目ID)) {
                帳票物理名 = new RString("jukyuShinseiYMD");
            } else if (HanyoListKokuhoOrderby.要介護度.get項目ID().equals(項目ID)) {
                帳票物理名 = new RString("yoKaigoJotaiKubunCode");
            } else if (HanyoListKokuhoOrderby.認定開始日.get項目ID().equals(項目ID)) {
                帳票物理名 = new RString("ninteiKaishiYMD");
            } else if (HanyoListKokuhoOrderby.資格取得日.get項目ID().equals(項目ID)) {
                帳票物理名 = new RString("shikakuShutokuYMD");
            } else if (HanyoListKokuhoOrderby.資格喪失日.get項目ID().equals(項目ID)) {
    ...
    private RString 宛名判定(RString 帳票物理名, RString 項目ID) {
        if (HanyoListKokuhoOrderby.郵便番号.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("yubinNo");
        } else if (HanyoListKokuhoOrderby.町域コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("choikiCode");
        } else if (HanyoListKokuhoOrderby.番地コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("banchi");
        } else if (HanyoListKokuhoOrderby.行政区コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("gyoseikuCode");
        } else if (HanyoListKokuhoOrderby.地区１.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("chikuCode1");
        } else if (HanyoListKokuhoOrderby.地区２.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("chikuCode2");
        } else if (HanyoListKokuhoOrderby.世帯コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("setaiCode");
        } else if (HanyoListKokuhoOrderby.識別コード.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("shikibetsuCode");
        } else if (HanyoListKokuhoOrderby.氏名５０音カナ.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("kanaShimei");
        } else if (HanyoListKokuhoOrderby.生年月日.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("seinengappiYMD");
        } else if (HanyoListKokuhoOrderby.性別.get項目ID().equals(項目ID)) {
            帳票物理名 = new RString("seibetsuCode");
        } else if (HanyoListKokuhoOrderby.市町村コード.get項目ID().equals(項目ID)) {
