 ...
 */
package jp.co.ndensan.reams.db.dbd.service.report.dbd100012;
...
public class ShakFukusHojRiysFutKeigTaisKetTsuchishoPrintService {
     ...
     */
    public void print(ShakaifukuRiyoshaFutanKeigen 社会福祉法人等利用者負担軽減, IKojin iKojin, IAtesaki iAtesaki,
        ...
        try (ReportAssembler<ShakFuksHojRiysFutKeigTsKetTsuchishoReportSource> assembler = createAssembler(property, reportManager)) {
            ...
            ShakFuksHjRiysFutKgTsKtTsuchishoReport report = ShakFuksHjRiysFutKgTsKtTsuchishoReport.createReport(社会福祉法人等利用者負担軽減, iKojin,
