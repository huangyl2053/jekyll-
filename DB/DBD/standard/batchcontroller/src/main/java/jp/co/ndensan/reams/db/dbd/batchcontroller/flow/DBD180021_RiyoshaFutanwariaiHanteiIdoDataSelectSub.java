...
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180021.HihokenshaDaichoIdoProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180021.JukyushaDaichoIdoProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180021.KaigoShotokuIdoProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180021.SeikatsuHogoJukyushaIdoProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180021.ShikibetsuTaishoIdoProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180021.SogoJigyoTaishoshaIdoProcess;
...
/**
 * バッチ設計_DBDMNK1002_異動データ抽出（共通）のクラスです。
 *
 * @reamsid_L DBC-4950-033 pengxingyi
 */
public class DBD180021_RiyoshaFutanwariaiHanteiIdoDataSelectSub
