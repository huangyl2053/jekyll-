...
public class HanyoRisutoJyukyusyaDaichoProcess extends BatchProcessBase<HanyoRisutoJyukyusyaDaichoEntity> {
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(MYBATIS_SELECT_ID, processParamter.toHanyoRisutoJyukyusyaDaichoMybatisParameter());
    }
    ...
    private void setEucCsvEntity(HanyoRisutoJyukyusyaDaichoEucCsvEntity eucCsvEntity, HanyoRisutoJyukyusyaDaichoEntity entity) {
        ...
        eucCsvEntity.set資格区分(HihokenshaKubunCode.toValue(entity.get被保険者台帳管理_被保険者区分コード()).toRString());
        ...
        eucCsvEntity.set主治医性別(Seibetsu.toValue(entity.get今回主治医_性別()).get名称());
    ...
    private void setEucCsvEntity2(HanyoRisutoJyukyusyaDaichoEucCsvEntity eucCsvEntity, HanyoRisutoJyukyusyaDaichoEntity entity) {
        ...
        eucCsvEntity.set削除理由文言(SakujoJiyuCode.toValue(entity.get受給者台帳_削除事由コード()).get名称());
    ...
    private void バッチ出力条件リストの出力() {
        ...
        builder.append(ChushutsuDataKubun.toValue(processParamter.getCyusyutsudatakubun()).get名称());
        ...
        出力条件.add(builder.toRString());
        builder = new RStringBuilder();
        RString tasyo = ChushutsuTaisho.toValue(processParamter.getCyusyutsutaisyo()).get名称();
