...
import jp.co.ndensan.reams.db.dbd.definition.core.hanyorisutokokikoreisha.KokiKoreishaCsvEnumEntity;
...
import jp.co.ndensan.reams.db.dbd.service.core.dbd710120.HanyoListKokiKoreishaManager;
...
public class HanyoListKokiKoreishaProcess extends BatchProcessBase<HanyoRisutoKokiKoreishaEntity> {
    ...
    protected void process(HanyoRisutoKokiKoreishaEntity entity) {
        ...
        HanyoListKokiKoreishaManager.createInstance().CSV情報設定(eucCsvEntity, entity, association,
    ...
    protected void afterExecute() {
        if (processParamter.isCsvkomokumeifuka() && eucCsvWriter.getCount() == 0) {
            eucCsvWriter.writeLine(HanyoListKokiKoreishaManager.createInstance().setBlank());
        }
        eucCsvWriter.close();
        eucCsvWriter1.close();
    ...
    private void get方法(HanyoRisutoKokiKoreishaEntity entity, HanyoListEntity hanyolistentity) {
