...
import jp.co.ndensan.reams.db.dbd.entity.db.relate.kyufugengakuhaakuichiran.ShounaQingbaoEntity;
...
import jp.co.ndensan.reams.db.dbd.entity.db.relate.kyufugengakulist.TaisyoSaisiJoho;
...
public class KyufuGengakuHaakuListSakuseiProcess extends BatchProcessBase<KyufuGengakuHaakuListSakuseiEntity> {
    ...
    private void set減額対象最新情報について(HihokenshaJohoEntity entity, KyufuGengakuHaakuListSakuseiEntity sjhe) {
