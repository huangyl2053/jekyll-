...
import jp.co.ndensan.reams.db.dbd.entity.db.relate.dbd130020.KokiKoreishaInfoCsvEntity;
import jp.co.ndensan.reams.db.dbd.entity.db.relate.dbd130020.KokiKoreshaJyohoRealEntity;
...
public class CreateCsvFileProcess extends BatchProcessBase<KokiKoreshaJyohoRealEntity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbd.persistence.db.mapper.relate.dbd130020.IKokikoreishaShikakuIdoInMapper.get取込後期高齢者情報");
