...
import jp.co.ndensan.reams.db.dbd.entity.db.relate.futanwariaihanteiichiran.RiyoshaFutanWariaiHanteiEntity;
...
public class MaeFutanWariaiHanteiIchiranTempProcess extends BatchKeyBreakBase<MaeRiyoshaFutanWariaiHanteiEntity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbd.persistence.db.mapper.relate.futanwariaihanteiichiran.IFutanwariaiHanteiIchiranMapper.get前回利用者負担割合判定");
