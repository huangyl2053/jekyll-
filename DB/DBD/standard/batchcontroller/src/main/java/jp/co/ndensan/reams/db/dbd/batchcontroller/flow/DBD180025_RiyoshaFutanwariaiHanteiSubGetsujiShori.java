...
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.ClearKonkaiRiyoshaFutanWariaiJohoTempProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.FutanWariaiHanteiMergeProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.FutanWariaiHanteiTukiziProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.FutanWariaiKonkyoLoginProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.FutanWariaiLoginProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.TsukibetsuFutanWariaiGenTempProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.TsukibetsuFutanWariaiNewTempProcess;
...
/**
 * バッチ設計_DBDMNK1002_利用者負担割合判定（共通）のフローです。<br/>
 * 負担割合判定（月次）
 *
 * @reamsid_L DBC-4950-030 liuyang
 */
public class DBD180025_RiyoshaFutanwariaiHanteiSubGetsujiShori
    ...
    protected void initialize() {
        ...
        processPrm = util.toProcessParameter(getParameter().toDBD180022_RiyoshaFutanwariaiHanteiSubParameter());
    }
    ...
    protected void defineFlow() {
        ...
        for (int i = 0; i < kijunbiSize; i++) {
            loopProcessPrm = new RiyoshaFutanWariaiHanteiUtil().toProcessParameter(
                    getParameter().toDBD180022_RiyoshaFutanwariaiHanteiSubParameter(), i);
