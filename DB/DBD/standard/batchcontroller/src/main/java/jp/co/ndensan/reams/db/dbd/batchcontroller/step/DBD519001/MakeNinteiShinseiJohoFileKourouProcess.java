...
import jp.co.ndensan.reams.db.dbd.business.core.dbd519001.MakeNinteiShinseiJohoFileKourouManager;
...
public class MakeNinteiShinseiJohoFileKourouProcess extends BatchProcessBase<KouikiyoukaigoNinteishinseiJouhouTempEntity> {
    ...
    protected void process(KouikiyoukaigoNinteishinseiJouhouTempEntity entity) {
        MakeNinteiShinseiJohoFileKourouManager manager = new MakeNinteiShinseiJohoFileKourouManager();
        kourouWriter.writeLine(manager.createKourouEntity(entity));
    ...
    protected void afterExecute() {
        MakeNinteiShinseiJohoFileKourouManager manager = new MakeNinteiShinseiJohoFileKourouManager();
        IEucFileOutputJokenhyoPrinter printer = EucFileOutputJokenhyoFactory.
