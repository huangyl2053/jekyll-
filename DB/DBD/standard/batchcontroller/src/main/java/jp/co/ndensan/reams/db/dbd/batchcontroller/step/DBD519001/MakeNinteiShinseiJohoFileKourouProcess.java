...
import jp.co.ndensan.reams.db.dbd.entity.db.relate.dbd519001.MakeNinteiShinseiJohoFileCsvKourouEntity;
...
/**
 * 申請情報IFファイル作成厚労省_process処理クラスです。
 *
 * @reamsid_L DBD-1480-040 liuyl
 */
public class MakeNinteiShinseiJohoFileKourouProcess extends BatchProcessBase<KouikiyoukaigoNinteishinseiJouhouTempEntity> {
    ...
    @BatchWriter
    private CsvWriter<MakeNinteiShinseiJohoFileCsvKourouEntity> kourouWriter;
    ...
    protected void createWriter() {
        ...
        if (要介護ＩＦ_類似変換.equals(new RString("1"))) {
            kourouWriter = new CsvWriter.InstanceBuilder(eucFilePath).
                    canAppend(false).
    ...
    protected void process(KouikiyoukaigoNinteishinseiJouhouTempEntity entity) {
        kourouWriter.writeLine(createKourouEntity(entity));
    ...
    private MakeNinteiShinseiJohoFileCsvKourouEntity createKourouEntity(KouikiyoukaigoNinteishinseiJouhouTempEntity entity) {
        MakeNinteiShinseiJohoFileCsvKourouEntity csvEntity = new MakeNinteiShinseiJohoFileCsvKourouEntity();
    ...
    private void setCsvKourouEntity(MakeNinteiShinseiJohoFileCsvKourouEntity csvEntity, KouikiyoukaigoNinteishinseiJouhouTempEntity entity) {
