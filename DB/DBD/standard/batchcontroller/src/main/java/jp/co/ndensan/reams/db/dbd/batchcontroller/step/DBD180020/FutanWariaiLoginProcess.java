...
import jp.co.ndensan.reams.db.dbd.business.euc.riyoshafutanwariaihantei.RiyoshaFutanWariaiHanteiCsvEditor;
...
public class FutanWariaiLoginProcess extends BatchKeyBreakBase<FutanWariaiRelateEntity> {
    ...
    private static final RString CSVFILENAME = new RString("DBD900004_ShoriKekkaKakuninList.csv");
