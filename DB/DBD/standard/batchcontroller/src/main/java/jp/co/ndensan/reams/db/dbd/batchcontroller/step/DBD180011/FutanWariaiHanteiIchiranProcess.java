 ...
 */
package jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180011;

import java.util.ArrayList;
import java.util.List;
import jp.co.ndensan.reams.db.dbd.business.euc.futanwariaihanteiichiran.FutanWariaiHanteiIchiranCsvEntityEditor;
import jp.co.ndensan.reams.db.dbd.business.report.futanwariaihanteiichiran.FutanWariaiHanteiIchiranPageBreak;
import jp.co.ndensan.reams.db.dbd.business.report.futanwariaihanteiichiran.FutanWariaiHanteiIchiranReport;
import jp.co.ndensan.reams.db.dbd.definition.core.riyoshafutan.RiyoshaFutanWaritaiHantei_ErrorKubun;
...
import jp.co.ndensan.reams.db.dbd.entity.csv.futanwariaihanteiichiran.FutanWariaiHanteiIchiranCsvEntity;
import jp.co.ndensan.reams.db.dbd.entity.db.relate.futanwariaihanteiichiran.FutanwariaiHanteiIchiranEntity;
import jp.co.ndensan.reams.db.dbd.entity.db.relate.nenjiriyoshafutanwariaihantei.DbWT1801ShoriKekkaKakuninListEntity;
import jp.co.ndensan.reams.db.dbd.entity.report.futanwariaihanteiichiran.FutanWariaiHanteiIchiranSource;
...
public class FutanWariaiHanteiIchiranProcess extends BatchKeyBreakBase<FutanwariaiHanteiIchiranEntity> {
    ...
    private static final ReportId ID = ReportIdDBD.DBD200089.getReportId();
    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbd.persistence.db.mapper.relate.futanwariaihanteiichiran.IFutanwariaiHanteiIchiranMapper.get負担割合判定一覧データ");
    private static final EucEntityId EUC_ENTITY_ID = new EucEntityId(new RString("DBD200089"));
