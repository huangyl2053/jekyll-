 ...
 */
package jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180010;

import jp.co.ndensan.reams.db.dbd.definition.core.riyoshafutan.RiyoshaFutanWaritaiHantei_ErrorKubun;
import jp.co.ndensan.reams.db.dbd.definition.processprm.nenjiriyoshafutanwariaihantei.NenjiRiyoshaFutanwariaiHanteiProcessParameter;
import jp.co.ndensan.reams.db.dbd.entity.db.relate.nenjiriyoshafutanwariaihantei.DbWT1801ShoriKekkaKakuninListEntity;
import jp.co.ndensan.reams.db.dbd.entity.db.relate.nenjiriyoshafutanwariaihantei.SogoJigyoTaishoshaTempEntity;
...
public class SogoJigyoTaishoshaTempProcess extends BatchProcessBase<SogoJigyoTaishoshaTempEntity> {
    ...
    private static final RString DB_READER_MAPPER_ID
            = new RString("jp.co.ndensan.reams.db.dbd.persistence.db.mapper.relate.nenjiriyoshafutanwariaihantei"
