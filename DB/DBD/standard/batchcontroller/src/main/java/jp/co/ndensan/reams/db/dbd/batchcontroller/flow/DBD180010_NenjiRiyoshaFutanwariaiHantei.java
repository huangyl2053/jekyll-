...
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180010.HanteiTaishoshaTempProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180010.HanteiTaishoshaTuikaTempProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180010.JukyushaTaichoTempProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180010.RiyoshaFutanWariaiDeleteProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180010.RiyoshaFutanWariaiKonkyoDeleteProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180010.RiyoshaFutanWariaiMeisaiDeleteProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180010.ShoriDateKanriProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180010.ShoriKekkaKakuninListProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180010.SinseicyuDateDeleteProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180010.SogoJigyoTaishoshaTempProcess;
import jp.co.ndensan.reams.db.dbd.definition.batchprm.DBD180010.DBD180010_NenjiRiyoshaFutanwariaiHanteiParameter;
 ...
 */
public class DBD180010_NenjiRiyoshaFutanwariaiHantei extends BatchFlowBase<DBD180010_NenjiRiyoshaFutanwariaiHanteiParameter> {
    ...
    private static final RString 負担割合判定一覧BATCH_ID = new RString("DBD180011_RiyoshaFutanwariaiHanteiIchiranSub");
    private static final RString 利用者負担割合判定BATCH_ID = new RString("DBD180022_RiyoshaFutanwariaiHanteiSub");
    ...
    protected IBatchFlowCommand riyoshaFutanWariaiHantei() {
        ...
        return otherBatchFlow(利用者負担割合判定BATCH_ID, SubGyomuCode.DBD介護受給,
                parameter).define();
    }
    ...
    protected IBatchFlowCommand futanwariaiHantei() {
        ...
        parameter.setShoriNichiji(getParameter().get処理日時());
        parameter.setNendoShuryoNengappi(getParameter().get年度終了年月日());
        return otherBatchFlow(負担割合判定一覧BATCH_ID, SubGyomuCode.DBD介護受給,
                parameter).define();
    }
