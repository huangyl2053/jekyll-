...
import jp.co.ndensan.reams.db.dbd.entity.csv.futanwariaihanteiichiran.ShoriKekkaKakuninListEntity;
...
public class ShoriKekkaKakuninListProcess extends BatchProcessBase<DbWT1801ShoriKekkaKakuninListEntity> {
    ...
    private static final RString CSVMEISHO = new RString("DBD900004_ShoriKekkaKakuninList.csv");
