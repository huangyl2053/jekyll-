...
import jp.co.ndensan.reams.db.dbd.service.core.dbd710080.HanyoListFutanGendoGakuNinteiManager;
...
public class HanyoListFutanGendoGakuNinteiProcess extends BatchProcessBase<FutanGendoGakuNinteiEntity> {
    ...
    protected void afterExecute() {
        if (processParamter.isCsvkomokumeifuka() && eucCsvWriter.getCount() == 0) {
            eucCsvWriter.writeLine(HanyoListFutanGendoGakuNinteiManager.createInstance().setBlank());
        }
        eucCsvWriter.close();
        eucCsvWriter1.close();
