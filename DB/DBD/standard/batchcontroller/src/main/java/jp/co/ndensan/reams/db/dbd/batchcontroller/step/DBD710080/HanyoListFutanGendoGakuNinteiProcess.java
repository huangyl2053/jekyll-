...
public class HanyoListFutanGendoGakuNinteiProcess extends BatchProcessBase<FutanGendoGakuNinteiEntity> {
    ...
    protected IBatchReader createReader() {
        ...
        return new BatchDbReader(MYBATIS_SELECT_ID,
                processParamter.toFutanGendoGakuNinteiMybatisParameter(psmShikibetsuTaisho, psmAtesaki));
    }

    @Override
    protected void createWriter() {
        manager = new FileSpoolManager(UzUDE0835SpoolOutputType.EucOther, EUC_ENTITY_ID, UzUDE0831EucAccesslogFileType.Csv);
        eucFilePath = Path.combinePath(manager.getEucOutputDirectry(), new RString("HanyoList_FutanGendoGakuNintei.csv"));
