 ...
 */
package jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD710040;
...
import jp.co.ndensan.reams.db.dbd.definition.core.hanyolistriyoshafutangakugengaku.RiyoshaFutanGakuGengakuCsvEnumEntity;
...
import jp.co.ndensan.reams.db.dbd.service.core.dbd710040.HanyoListRiyoshaFutanGakuGengakuManageer;
...
/**
 *
 * 汎用リスト出力(利用者負担額減免)_process処理クラスです。
 *
 * @reamsid_L DBD-3950-030 panxiaobo
 */
public class HanyoListRiyoshaFutanGakuGengakuProcess extends BatchProcessBase<RiyoshaFutanGakuGengakuEntity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbd.persistence.db.mapper.relate.hanyolistriyoshafutangakugengaku."
            + "IHanyoListRiyoshaFutanGakuGengakuMapper.get汎用リスト");
    ...
    private CsvWriter<RiyoshaFutanGakuGengakuEucCsvEntity> eucCsvWriter;
    ...
    protected void createWriter() {
        ...
        eucFilePath = Path.combinePath(manager.getEucOutputDirectry(), new RString("HanyoList_RiyoshaFutanGakuGengaku.csv"));
    ...
    @Override
    protected void process(RiyoshaFutanGakuGengakuEntity entity) {
        連番 = 連番 + 1;
        RiyoshaFutanGakuGengakuEucCsvEntity eucCsvEntity = new RiyoshaFutanGakuGengakuEucCsvEntity();
        HanyoListRiyoshaFutanGakuGengakuManageer.createInstance()
                .CSV情報設定(eucCsvEntity, entity, association, hokenshaList, processParamter.isCsvhitsukesurasyuhensyu());
    ...
    protected void afterExecute() {
        if (processParamter.isCsvkomokumeifuka() && eucCsvWriter.getCount() == 0) {
            eucCsvWriter.writeLine(HanyoListRiyoshaFutanGakuGengakuManageer.createInstance().setBlank());
        }
        eucCsvWriter.close();
        eucCsvWriter1.close();
    ...
    private RString get出力順() {
        ...
        RString 出力順 = MyBatisOrderByClauseCreator.create(HanyoListRiyoshaFutanGakuGengakuOrderby.class, order);
        return 出力順.concat(",利用者負担額減額_履歴番号");
    }

    private PersonalData toPersonalData(RiyoshaFutanGakuGengakuEntity entity) {
