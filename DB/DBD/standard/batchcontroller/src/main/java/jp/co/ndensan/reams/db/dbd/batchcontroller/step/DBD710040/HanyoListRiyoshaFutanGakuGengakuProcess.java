...
//                        new ReportId(processParamter.getCyohyoid()), Long.parseLong(processParamter.getSyutsuryokukomoku().toString()));
    ...
    protected void createWriter() {
        ...
        HanyoListRiyoshaFutanGakuGengakuManageer.createInstance().set改頁Key(outputOrder, pageBreakKeys);
    ...
    protected void process(RiyoshaFutanGakuGengakuEntity entity) {
        ...
        HanyoListRiyoshaFutanGakuGengakuManageer.createInstance()
                .get情報設定(eucCsvEntity, entity, association, hokenshaList, processParamter.isCsvhitsukesurasyuhensyu());
        ...
        int index = 0;
        for (RiyoshaFutanGakuGengakuCsvEnumEntity e : RiyoshaFutanGakuGengakuCsvEnumEntity.values()) {
...
//                    Method getMethod;
//                    try {
//                        getMethod = clazz.getDeclaredMethod(RiyoshaFutanGakuGengakuCsvEnumEntity
...
//            }
        ...
        HanyoListRiyoshaFutanGakuGengakuManageer.createInstance().バッチ出力条件リストの出力(processParamter, 導入団体コード,
    ...
    private RString get項目内容(Method getMethod, RString 項目内容new, RiyoshaFutanGakuGengakuEucCsvEntity eucCsvEntity, int i) {
        try {
