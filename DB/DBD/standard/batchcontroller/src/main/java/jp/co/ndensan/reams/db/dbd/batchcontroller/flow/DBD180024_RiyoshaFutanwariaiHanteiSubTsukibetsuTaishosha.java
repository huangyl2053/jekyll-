...
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.ClearHanteiHihonkenshaNoTempProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.ClearSetainHakuNyuryokuTempProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.ClearTmpSetaiShotokuProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.HanteiKijunbiSetteiProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.SetainHakunyuryokuProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.SetainJohoSakuseiProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.TsukibetsuHanteiTaishoshaTempNigaimeProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180020.TsukibetsuHanteiTaishoshaTempProcess;
...
/**
 * バッチ設計_DBDMNK1002_利用者負担割合判定（共通）のフローです。
 *
 * @reamsid_L DBC-4950-030 liuyang
 */
public class DBD180024_RiyoshaFutanwariaiHanteiSubTsukibetsuTaishosha
