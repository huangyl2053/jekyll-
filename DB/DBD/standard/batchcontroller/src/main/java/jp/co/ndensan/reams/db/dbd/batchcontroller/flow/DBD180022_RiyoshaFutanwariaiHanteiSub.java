...
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180022.FutanWariaiHanteiNenziProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180022.HanteiTaishoshaTuikaProcess;
import jp.co.ndensan.reams.db.dbd.batchcontroller.step.DBD180022.SeikatsuHogoGaitoJohoTempProcess;
...
/**
 * バッチ設計_DBDMNK1002_利用者負担割合判定（共通）のクラスです。
 *
 * @reamsid_L DBC-4950-030 liuyang
 */
public class DBD180022_RiyoshaFutanwariaiHanteiSub extends BatchFlowBase<DBD180022_RiyoshaFutanwariaiHanteiSubParameter> {
    ...
    private static final RString BATCHID_WORK2 = new RString("DBD180023_RiyoshaFutanwariaiHanteiSubTaishoshaTsuika");
    private static final RString BATCHID_WORK4 = new RString("DBD180024_RiyoshaFutanwariaiHanteiSubTsukibetsuTaishosha");
    private static final RString BATCHID_WORK7 = new RString("DBD180025_RiyoshaFutanwariaiHanteiSubGetsujiShori");
    ...
    IBatchFlowCommand work2() {
        return otherBatchFlow(BATCHID_WORK2, SubGyomuCode.DBD介護受給,
                getParameter().toDBD180023_RiyoshaFutanwariaiHanteiSubTaishoshaTsuikaParameter()).define();
    }
    ...
    IBatchFlowCommand work4() {
        return otherBatchFlow(BATCHID_WORK4, SubGyomuCode.DBD介護受給,
                getParameter().toDBD180024_RiyoshaFutanwariaiHanteiSubTsukibetsuTaishoshaParameter()).define();
    }
    ...
    IBatchFlowCommand work7() {
        return otherBatchFlow(BATCHID_WORK7, SubGyomuCode.DBD介護受給,
                getParameter().toDBD180025_RiyoshaFutanwariaiHanteiSubGetsujiShoriParameter()).define();
    }
}
