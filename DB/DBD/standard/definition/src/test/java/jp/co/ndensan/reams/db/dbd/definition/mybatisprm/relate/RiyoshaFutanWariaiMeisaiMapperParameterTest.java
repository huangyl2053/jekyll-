 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.mybatisprm.relate;
...
/**
 * {@link RiyoshaFutanWariaiMeisaiMapperParameter}のテストクラスです。
 */
@RunWith(Enclosed.class)
public class RiyoshaFutanWariaiMeisaiMapperParameterTest extends DbcTestBase {
...
// TODO 主キーの数が足りない場合、処理を追加してください。
    ...
    private Decimal 主キー4 = new Decimal(1);
...
// テストクラス名は適切に変更してください
    public static class createSelectByKeyParamテスト extends DbcTestBase {
        ...
        public void 主キー1にNullを指定すると_NullPointerExceptionが発生する() {
            RiyoshaFutanWariaiMeisaiMapperParameter sut = RiyoshaFutanWariaiMeisaiMapperParameter.createSelectByKeyParam(null, 主キー2);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー2にNullを指定すると_NullPointerExceptionが発生する() {
            RiyoshaFutanWariaiMeisaiMapperParameter sut = RiyoshaFutanWariaiMeisaiMapperParameter.createSelectByKeyParam(主キー1, null);
        }

        @Test
        public void 引数にNull以外を指定すると_パラメータが生成できる() {
            RiyoshaFutanWariaiMeisaiMapperParameter sut = RiyoshaFutanWariaiMeisaiMapperParameter.createSelectByKeyParam(主キー1, 主キー2);
...
// 用途に応じたパラメータ生成メソッドのテストクラスを追加してください。
    public static class createSelectListParamテスト extends DbcTestBase {
        ...
        @Test(expected = NullPointerException.class)
        public void 主キー1にNullを指定すると_NullPointerExceptionが発生する() {
            RiyoshaFutanWariaiMeisaiMapperParameter sut = RiyoshaFutanWariaiMeisaiMapperParameter.createSelectListParam(null);
        }

        @Test
        public void 引数にNull意外を指定すると_パラメータが生成できる() {
            RiyoshaFutanWariaiMeisaiMapperParameter sut = RiyoshaFutanWariaiMeisaiMapperParameter.createSelectListParam(主キー1);
