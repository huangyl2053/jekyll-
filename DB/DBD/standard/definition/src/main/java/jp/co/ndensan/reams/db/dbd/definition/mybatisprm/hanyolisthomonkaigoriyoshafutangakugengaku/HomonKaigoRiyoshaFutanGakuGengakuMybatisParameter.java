...
/**
 *
 * 汎用リスト出力(訪問介護利用者負担額減額)のMyBatis用パラメータクラスです。
 *
 * @reamsid_L DBD-3940-030 panxiaobo
 */
@SuppressWarnings("PMD.UnusedPrivateField")
@Getter
public class HomonKaigoRiyoshaFutanGakuGengakuMybatisParameter implements IMyBatisParameter {
    ...
    private final RString hobetsukubun;
    ...
    private boolean is施行時ホームヘルプ;
    private boolean is障害ホームヘルプ;
    private boolean is障害ヘルプ全額免除;
