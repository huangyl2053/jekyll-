 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.processprm.hanyorisutoshakaifukushihojinkeigen;
...
@Getter
@Setter
public class ShakaiFukushiHojinKeigenProcessParameter implements IBatchProcessParameter {
     ...
     */
    public ShakaiFukushiHojinKeigenProcessParameter(RString hyoudai, RString cyusyutsuhohokubun,
