 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.batchprm.gemmen.shinseisho.hakko;
...
public class GemmenGengakuShinseishoIkkatsuHakkoParameter extends BatchParameterBase {
     ...
     * @param 発行日 発行日
     */
    public GemmenGengakuShinseishoIkkatsuHakkoParameter(
            RString 発行処理ID,
            boolean 出力フラグ,
            long 改頁出力順ID,
            FlexibleDate 基準日,
