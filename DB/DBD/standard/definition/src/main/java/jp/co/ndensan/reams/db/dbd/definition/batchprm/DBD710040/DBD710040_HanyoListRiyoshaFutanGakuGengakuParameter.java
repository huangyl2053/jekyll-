 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.batchprm.DBD710040;
...
/**
 *
 * 汎用リスト出力(利用者負担額減免)_バッチ用のパラメータです。
 *
...
public class DBD710040_HanyoListRiyoshaFutanGakuGengakuParameter extends BatchParameterBase {
     ...
     * バーチのパラメータを作成します。
     *
     * @return HanyoListRiyoshaFutanGakuGengakuProcessParameter
     */
    public HanyoListRiyoshaFutanGakuGengakuProcessParameter toHanyoListRiyoshaFutanGakuGengakuProcessParameter() {
        return new HanyoListRiyoshaFutanGakuGengakuProcessParameter(
                hyoudai,
                detasyubetsumesyo,
                syutsuryoku,
                cyusyutsuhohokubun,
