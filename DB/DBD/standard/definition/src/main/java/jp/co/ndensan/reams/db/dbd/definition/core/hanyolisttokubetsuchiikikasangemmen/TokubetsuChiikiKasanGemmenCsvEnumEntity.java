 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.core.hanyolisttokubetsuchiikikasangemmen;
...
public enum TokubetsuChiikiKasanGemmenCsvEnumEntity {
    ...
    /**
     * コード:2160 名称:get確認番号 略称:定義なし
     */
    get確認番号("2160", "get確認番号"),
    /**
     * コード:2170 名称:get特別地域加算減免申請日 略称:定義なし
     */
    get特別地域加算減免申請日("20", "get特別地域加算減免申請日"),
    /**
     * コード:2180 名称:get特別地域加算減免決定日 略称:定義なし
     */
    get特別地域加算減免決定日("2180", "get特別地域加算減免決定日"),
    /**
     * コード:2190 名称:get特別地域加算減免承認区分 略称:定義なし
     */
    get特別地域加算減免承認区分("2190", "get特別地域加算減免承認区分"),
    /**
     * コード:2200 名称:get特別地域加算減免開始日 略称:定義なし
     */
    get特別地域加算減免開始日("2200", "get特別地域加算減免開始日"),
    /**
     * コード:2210 名称:get特別地域加算減免終了日 略称:定義なし
     */
    get特別地域加算減免終了日("2210", "get特別地域加算減免終了日"),
    /**
     * コード:2220 名称:get特別地域加算減免率 略称:定義なし
     */
    get特別地域加算減免率("2220", "get特別地域加算減免率"),
    /**
     * コード:2230 名称:get被保険者番号_総合事業対象者 略称:定義なし
     */
    get被保険者番号_総合事業対象者("2230", "get被保険者番号_総合事業対象者"),
    /**
     * コード:2240 名称:get履歴番号 略称:定義なし
     */
    get履歴番号("2240", "get履歴番号"),
    /**
     * コード:2250 名称:get事業適用開始日 略称:定義なし
     */
    get事業適用開始日("2250", "get事業適用開始日"),
    /**
     * コード:2260 名称:get事業適用終了日 略称:定義なし
     */
    get事業適用終了日("2260", "get事業適用終了日"),
    /**
     * コード:2270 名称:get事業チェック実施日 略称:定義なし
     */
    get事業チェック実施日("2270", "get事業チェック実施日"),
    /**
     * コード:2280 名称:get事業決定日 略称:定義なし
     */
    get事業決定日("2280", "get事業決定日"),
    /**
     * コード:2290 名称:get届出区分 略称:定義なし
     */
    get届出区分("2290", "get届出区分"),
    /**
     * コード:2300 名称:get居宅計画作成区分 略称:定義なし
     */
    get居宅計画作成区分("2300", "get居宅計画作成区分"),
    /**
     * コード:2310 名称:get計画事業者番号 略称:定義なし
     */
    get計画事業者番号("2310", "get計画事業者番号"),
    /**
     * コード:2320 名称:get計画事業者名 略称:定義なし
     */
    get計画事業者名("2320", "get計画事業者名"),
    /**
     * コード:2330 名称:get計画事業者カナ 略称:定義なし
     */
    get計画事業者カナ("2330", "get計画事業者カナ"),
    /**
     * コード:2340 名称:get計画管理者名 略称:定義なし
     */
    get計画管理者名("2340", "get計画管理者名"),
    /**
     * コード:2350 名称:get計画管理者カナ 略称:定義なし
     */
    get計画管理者カナ("2350", "get計画管理者カナ"),
    /**
     * コード:2360 名称:get計画適用開始日 略称:定義なし
     */
    get計画適用開始日("2360", "get計画適用開始日"),
    /**
     * コード:2370 名称:get計画適用終了日 略称:定義なし
     */
    get計画適用終了日("2370", "get計画適用終了日"),
    /**
     * コード:2380 名称:get計画届出日 略称:定義なし
     */
    get計画届出日("2380", "get計画届出日"),
    /**
     * コード:2390 名称:get計画作成日 略称:定義なし
     */
    get計画作成日("2390", "get計画作成日"),
    /**
     * コード:2400 名称:get計画変更日 略称:定義なし
     */
    get計画変更日("2400", "get計画変更日"),
    /**
     * コード:2410 名称:get変更理由 略称:定義なし
     */
    get変更理由("2410", "get変更理由");
    private final RString code;
    private final RString fullName;

    private TokubetsuChiikiKasanGemmenCsvEnumEntity(String code, String fullname) {
     ...
     */
    public static TokubetsuChiikiKasanGemmenCsvEnumEntity toValue(RString code) {
        for (TokubetsuChiikiKasanGemmenCsvEnumEntity tokubetsuChi : TokubetsuChiikiKasanGemmenCsvEnumEntity.values()) {
