 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.mybatisprm.hanyolisttokubetsuchiikikasangemmen;
...
/**
 * 汎用リスト出力(特別地域加算減免)のMyBatis用パラメータクラスです。
 *
 * @reamsid_L DBD-3910-030 panxiaobo
 */
@SuppressWarnings("PMD.UnusedPrivateField")
@Getter
public class TokubetsuChiikiKasanGemmenMybatisParameter implements IMyBatisParameter {
     ...
     * @param 出力順 出力順
     */
    public TokubetsuChiikiKasanGemmenMybatisParameter(
