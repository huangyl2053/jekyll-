 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.core.hanyolistfutangendogakunintei;
...
/**
 *
 * 汎用リスト出力(負担限度額認定)のEnumEntity処理クラスです。
 *
 * @reamsid_L DBD-3930-030 panxiaobo
 */
public enum FutanGendoGakuNinteiCsvEnumEntity {
     ...
     */
    get特定入所者申請日("2160", "get特定入所者申請日"),
    /**
     * コード:2170 名称:get特定入所者申請理由コード 略称:定義なし
     */
    get特定入所者申請理由コード("2170", "get特定入所者申請理由コード"),
    /**
     * コード:2180 名称:get特定入所者決定日 略称:定義なし
     */
    get特定入所者決定日("2180", "get特定入所者決定日"),
    /**
     * コード:2190 名称:get特定入所者決定区分 略称:定義なし
     */
    get特定入所者決定区分("2190", "get特定入所者決定区分"),
    /**
     * コード:2200 名称:get特定入所者開始日 略称:定義なし
     */
    get特定入所者開始日("2200", "get特定入所者開始日"),
    /**
     * コード:2210 名称:get特定入所者終了日 略称:定義なし
     */
    get特定入所者終了日("2210", "get特定入所者終了日"),
    /**
     * コード:2220 名称:get特定入所者旧措置者 略称:定義なし
     */
    get特定入所者旧措置者("2220", "get特定入所者旧措置者"),
    /**
     * コード:2230 名称:get特定入所者負担段階 略称:定義なし
     */
    get特定入所者負担段階("2230", "get特定入所者負担段階"),
    /**
     * コード:2240 名称:get食費 略称:定義なし
     */
    get食費("2240", "get食費"),
    /**
     * コード:2250 名称:get居住費ユニット型個室 略称:定義なし
     */
    get居住費ユニット型個室("2250", "get居住費ユニット型個室"),
    /**
     * コード:2260 名称:get居住費ユニット型準個室 略称:定義なし
     */
    get居住費ユニット型準個室("2260", "get居住費ユニット型準個室"),
    /**
     * コード:2270 名称:get居住費従来型個室／特養 略称:定義なし
     */
    get居住費従来型個室特養("2270", "get居住費従来型個室／特養"),
    /**
     * コード:2280 名称:get居住費従来型個室／老健 略称:定義なし
     */
    get居住費従来型個室老健("2280", "get居住費従来型個室／老健"),
    /**
     * コード:2290 名称:get居住費多床室 略称:定義なし
     */
    get居住費多床室("2290", "get居住費多床室"),
    /**
     * コード:2290 名称:get特例減額措置区分 略称:定義なし
     */
    get特例減額措置区分("2300", "get特例減額措置区分"),
    /**
     * コード:2290 名称:get居室種別 略称:定義なし
     */
    get居室種別("2310", "get居室種別"),
    /**
     * コード:2290 名称:get境界層 略称:定義なし
     */
    get境界層("2320", "get境界層"),
    /**
     * コード:2290 名称:get特定入所者激変緩和 略称:定義なし
     */
    get特定入所者激変緩和("2330", "get特定入所者激変緩和"),
    /**
     * コード:2290 名称:get配偶者の有無 略称:定義なし
     */
    get配偶者の有無("2340", "get配偶者の有無"),
    /**
     * コード:2350 名称:get配偶者氏名 略称:定義なし
     */
    get配偶者氏名("2350", "get配偶者氏名"),
    /**
     * コード:2360 名称:get配偶get配偶者氏名カナ者の有無 略称:定義なし
     */
    get配偶者氏名カナ("2360", "get配偶者氏名カナ"),
    /**
     * コード:2370 名称:get配偶者生年月日 略称:定義なし
     */
    get配偶者生年月日("2370", "get配偶者生年月日"),
    /**
     * コード:2380 名称:get配偶者住所 略称:定義なし
     */
    get配偶者住所("2380", "get配偶者住所"),
    /**
     * コード:2390 名称:get配偶者連絡先 略称:定義なし
     */
    get配偶者連絡先("2390", "get配偶者連絡先"),
    /**
     * コード:2400 名称:get配偶者住所２ 略称:定義なし
     */
    get配偶者住所２("2400", "get配偶者住所２"),
    /**
     * コード:2410 名称:ge配偶者課税区分 略称:定義なし
     */
    get配偶者課税区分("2410", "get配偶者課税区分"),
    /**
     * コード:2420 名称:get配偶者住民コード 略称:定義なし
     */
    get配偶者住民コード("2420", "get配偶者住民コード"),
    /**
     * コード:2430 名称:get預貯金額 略称:定義なし
     */
    get預貯金額("2430", "get預貯金額"),
    /**
     * コード:2440 名称:get有価証券評価概算額 略称:定義なし
     */
    get有価証券評価概算額("2440", "get有価証券評価概算額"),
    /**
     * コード:2450 名称:getその他金額 略称:定義なし
     */
    getその他金額("2450", "getその他金額"),
    /**
     * コード:2460 名称:get届出区分 略称:定義なし
     */
    get届出区分("2460", "get届出区分"),
    /**
     * コード:2470 名称:get居宅計画作成区分 略称:定義なし
     */
    get居宅計画作成区分("2470", "get居宅計画作成区分"),
    /**
     * コード:2480 名称:get計画事業者番号 略称:定義なし
     */
    get計画事業者番号("2480", "get計画事業者番号"),
    /**
     * コード:2490 名称:get計画事業者名 略称:定義なし
     */
    get計画事業者名("2490", "get計画事業者名"),
    /**
     * コード:2500 名称:get計画事業者カナ 略称:定義なし
     */
    get計画事業者カナ("2500", "get計画事業者カナ"),
    /**
     * コード:2510 名称:get計画管理者名 略称:定義なし
     */
    get計画管理者名("2510", "get計画管理者名"),
    /**
     * コード:2520 名称:get計画管理者カナ 略称:定義なし
     */
    get計画管理者カナ("2520", "get計画管理者カナ"),
    /**
     * コード:2530 名称:get計画適用開始日 略称:定義なし
     */
    get計画適用開始日("2530", "get計画適用開始日"),
    /**
     * コード:2540 名称:get計画適用終了日 略称:定義なし
     */
    get計画適用終了日("2540", "get計画適用終了日"),
    /**
     * コード:2550 名称:get計画届出日 略称:定義なし
     */
    get計画届出日("2550", "get計画届出日"),
    /**
     * コード:2560 名称:get計画作成日 略称:定義なし
     */
    get計画作成日("2560", "get計画作成日"),
    /**
     * コード:2570 名称:get計画変更日 略称:定義なし
     */
    get計画変更日("2570", "get計画変更日"),
    /**
     * コード:2580 名称:get変更理由 略称:定義なし
     */
    get変更理由("2580", "get変更理由");
    private final RString code;
    private final RString fullName;

    private FutanGendoGakuNinteiCsvEnumEntity(String code, String fullname) {
     ...
     */
    public static FutanGendoGakuNinteiCsvEnumEntity toValue(RString code) {
        for (FutanGendoGakuNinteiCsvEnumEntity tokubetsuChi : FutanGendoGakuNinteiCsvEnumEntity.values()) {
