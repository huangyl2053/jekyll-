 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.batchprm.hanyorisutokokuho;

import jp.co.ndensan.reams.db.dbd.definition.processprm.hanyorisutokokuho.HanyoRisutoKokuhoProcessParameter;
...
public class HanyoRisutoKokuhoBatchParameter extends BatchParameterBase {
     ...
     * バーチのパラメータを作成します。
     *
     * @return HanyoRisutoKokuhoProcessParameter
     */
    public HanyoRisutoKokuhoProcessParameter toHanyoRisutoKokuhoProcessParameter() {
        return new HanyoRisutoKokuhoProcessParameter(
                cyusyutsuhohokubun,
