...
public enum DbdWarningMessages implements IMessageGettable {
    ...
    既存データなし(5, "該当年度の非課税年金対象者情報が存在しません。<br>他市町村からの照会結果など、新規登録の必要がある場合登録してください。"),
    ...
    受給者なし確認(8, "対象年に受給者として登録されてしませんが、登録処理を継続しますか？"),
    発行対象外登録(9, "証明書、確認書の発行対象になりませんが、更新してもよろしいですか？"),
    負担段階確認(10, "申請理由と利用者負担段階が異なりますが、よろしいですか？");
