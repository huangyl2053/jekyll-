...
public enum ChokkinIdoJiyuCode {
    ...
    /**
     * コード:00 名称:未登録 略称:定義なし
     */
    未登録("00", "未登録"),
    /**
     * コード:01 名称:追加（認定） 略称:定義なし
     */
    追加_認定("01", "追加（認定）"),
    /**
     * コード:02 名称:要介護度変更申請認定 略称:定義なし
     */
    要介護度変更申請認定("02", "要介護度変更申請認定"),
    /**
     * コード:03 名称:要介護度変更申請却下 略称:定義なし
     */
    要介護度変更申請却下("03", "要介護度変更申請却下"),
    /**
     * コード:04 名称:サービス種類変更申請認定 略称:定義なし
     */
    サービス種類変更申請認定("04", "サービス種類変更申請認定"),
    /**
     * コード:05 名称:サービス種類変更申請却下 略称:定義なし
     */
    サービス種類変更申請却下("05", "サービス種類変更申請却下"),
    /**
