 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.core.hanyolisthomonkaigoriyoshafutangakugengaku;
...
/**
 *
 * 汎用リスト出力(訪問介護利用者負担額減額)のCsvEnumEntityクラスです。
 *
 * @reamsid_L DBD-3940-030 panxiaobo
 */
public enum HomonKaigoRiyoshaFutanGakuGengakuCsvEnumEntity {
    ...
    /**
     * コード:1980 名称:get特別対策減免申請日 略称:定義なし
     */
    get特別対策減免申請日("1980", "get特別対策減免申請日"),
    /**
     * コード:1990 名称:get特別対策減免決定日 略称:定義なし
     */
    get特別対策減免決定日("1990", "get特別対策減免決定日"),
    /**
     * コード:2000 名称:get特別対策減免承認区分 略称:定義なし
     */
    get特別対策減免承認区分("2000", "get特別対策減免承認区分"),
    /**
     * コード:2010 名称:get特別対策減免開始日 略称:定義なし
     */
    get特別対策減免開始日("2010", "get特別対策減免開始日"),
    /**
     * コード:2020 名称:get特別対策減免終了日 略称:定義なし
     */
    get特別対策減免終了日("2020", "get特別対策減免終了日"),
    /**
     * コード:2030 名称:get特別対策給付率 略称:定義なし
     */
    get特別対策給付率("2030", "get特別対策給付率"),
    /**
     * コード:2040 名称:get公費法別番号 略称:定義なし
     */
    get公費法別番号("2040", "get公費法別番号"),
    /**
     * コード:2050 名称:get公費受給者番号 略称:定義なし
     */
    get公費受給者番号("2050", "get公費受給者番号"),
    /**
     * コード:2060 名称:get障害者手帳有無 略称:定義なし
     */
    get障害者手帳有無("2060", "get障害者手帳有無"),
    /**
     * コード:2070 名称:get障害者等級 略称:定義なし
     */
    get障害者等級("2070", "get障害者等級"),
    /**
     * コード:2080 名称:get障害者手帳番号 略称:定義なし
     */
    get障害者手帳番号("2080", "get障害者手帳番号"),
    /**
     * コード:2090 名称:get被保険者番号_総合事業対象者 略称:定義なし
     */
    get被保険者番号_総合事業対象者("2090", "get被保険者番号_総合事業対象者"),
    /**
     * コード:2100 名称:get履歴番号 略称:定義なし
     */
    get履歴番号("2100", "get履歴番号"),
    /**
     * コード:2110 名称:get事業適用開始日 略称:定義なし
     */
    get事業適用開始日("2110", "get事業適用開始日"),
    /**
     * コード:2120 名称:get事業適用終了日 略称:定義なし
     */
    get事業適用終了日("2120", "get事業適用終了日"),
    /**
     * コード:2130 名称:get事業チェック実施日 略称:定義なし
     */
    get事業チェック実施日("2130", "get事業チェック実施日"),
    /**
     * コード:2140 名称:get事業決定日 略称:定義なし
     */
    get事業決定日("2140", "get事業決定日"),
    /**
     * コード:2150 名称:get届出区分 略称:定義なし
     */
    get届出区分("2150", "get届出区分"),
    /**
     * コード:2160 名称:get居宅計画作成区分 略称:定義なし
     */
    get居宅計画作成区分("2160", "get居宅計画作成区分"),
    /**
     * コード:2170 名称:get計画事業者番号 略称:定義なし
     */
    get計画事業者番号("2170", "get計画事業者番号"),
    /**
     * コード:2180 名称:get計画事業者名 略称:定義なし
     */
    get計画事業者名("2180", "get計画事業者名"),
    /**
     * コード:2190 名称:get計画事業者カナ 略称:定義なし
     */
    get計画事業者カナ("2190", "get計画事業者カナ"),
    /**
     * コード:2200 名称:get計画管理者名 略称:定義なし
     */
    get計画管理者名("2200", "get計画管理者名"),
    /**
     * コード:2210 名称:get計画管理者カナ 略称:定義なし
     */
    get計画管理者カナ("2210", "get計画管理者カナ"),
    /**
     * コード:2220 名称:get計画適用開始日 略称:定義なし
     */
    get計画適用開始日("2220", "get計画適用開始日"),
    /**
     * コード:2230 名称:get計画適用終了日 略称:定義なし
     */
    get計画適用終了日("2230", "get計画適用終了日"),
    /**
     * コード:2240 名称:get計画届出日 略称:定義なし
     */
    get計画届出日("2240", "get計画届出日"),
    /**
     * コード:2250 名称:get計画作成日 略称:定義なし
     */
    get計画作成日("2250", "get計画作成日"),
    /**
     * コード:2260 名称:get計画変更日 略称:定義なし
     */
    get計画変更日("2260", "get計画変更日"),
    /**
     * コード:2270 名称:get変更理由 略称:定義なし
     */
    get変更理由("2270", "get変更理由");
    private final RString code;
    private final RString fullName;

    private HomonKaigoRiyoshaFutanGakuGengakuCsvEnumEntity(String code, String fullname) {
        this.code = new RString(code);
        this.fullName = new RString(fullname);
    }

    /**
     * 訪問介護利用者負担額減額のコードを返します。
     *
     * @return 訪問介護利用者負担額減額のコード
     */
    ...
    /**
     * 訪問介護利用者負担額減額の名称を返します。
     *
     * @return 訪問介護利用者負担額減額の名称
     */
    ...
    /**
     * 訪問介護利用者負担額減額のコードと一致する内容を探します。
     *
     * @param code 訪問介護利用者負担額減額のコード
     * @return {@code code} に対応する対象リスト
     */
    public static HomonKaigoRiyoshaFutanGakuGengakuCsvEnumEntity toValue(RString code) {
        for (HomonKaigoRiyoshaFutanGakuGengakuCsvEnumEntity tokubetsuChi : HomonKaigoRiyoshaFutanGakuGengakuCsvEnumEntity.values()) {
            if (tokubetsuChi.code.equals(code)) {
                return tokubetsuChi;
            }
        }
        throw new IllegalArgumentException(UrSystemErrorMessages.変換不可.getReplacedMessage("訪問介護利用者負担額減額"));
    }
}
