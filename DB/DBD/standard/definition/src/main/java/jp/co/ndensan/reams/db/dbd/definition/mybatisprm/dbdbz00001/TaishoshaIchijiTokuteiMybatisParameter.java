...
public class TaishoshaIchijiTokuteiMybatisParameter implements IMyBatisParameter {
    ...
    private static final RString 旧措置者区分_旧措置者以外_に = new RString("2");
    private static final RString 旧措置者区分_旧措置者のみ_さん = new RString("3");
    ...
    private void edit旧措置者区分(KyusochishaJukyushaKubun 旧措置者区分) {
        if (旧措置者区分 != null) {
            if (旧措置者区分_旧措置者以外_に.equals(旧措置者区分.getコード())) {
                is旧措置者区分_旧措置者以外 = true;
            }
            if (旧措置者区分_旧措置者のみ_さん.equals(旧措置者区分.getコード())) {
