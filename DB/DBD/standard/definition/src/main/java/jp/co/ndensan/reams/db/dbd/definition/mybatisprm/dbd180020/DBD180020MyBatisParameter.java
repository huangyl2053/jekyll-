 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.mybatisprm.dbd180020;
...
@Getter
@Setter
public class DBD180020MyBatisParameter implements IMyBatisParameter {
     ...
     * @param 対象終了日 RString
     */
    public DBD180020MyBatisParameter(RString 判定基準日, RString 対象年度, RString 対象月, RString 対象開始日,
            RString 対象終了日) {
        this.判定基準日 = 判定基準日;
     ...
     * @param 対象月 RString
     */
    public DBD180020MyBatisParameter(RString 対象開始日, RString 対象終了日, RString 対象月) {
        this.対象開始日 = 対象開始日;
        this.対象終了日 = 対象終了日;
        this.対象月 = 対象月;
    }
