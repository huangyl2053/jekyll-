...
public class TorikomiProcessParameter implements IBatchProcessParameter {
    ...
    private UzT0885SharedFileEntryEntity entry;
     ...
     * @param entity UzT0885SharedFileEntryEntity
     */
    public TorikomiProcessParameter(FlexibleYear 処理年度, RString 処理区分, RString 対象月, List<RString> 構成市町村コードリスト, UzT0885SharedFileEntryEntity entity) {
        this.処理年度 = 処理年度;
        this.処理区分 = 処理区分;
        this.対象月 = 対象月;
