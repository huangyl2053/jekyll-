 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.batchprm.DBD710070;
...
/**
 *
 * 汎用リスト出力(特別地域加算減免)_バッチ用のパラメータです。
 *
...
public class DBD710070_HanyoListTokubetsuChiikiKasanGemmenParameter extends BatchParameterBase {
     ...
     * バーチのパラメータを作成します。
     *
     * @return HanyoListTokubetsuChiikiKasanGemmenProcessParameter
     */
    public HanyoListTokubetsuChiikiKasanGemmenProcessParameter toHanyoListTokubetsuChiikiKasanGemmenProcessParameter() {
        return new HanyoListTokubetsuChiikiKasanGemmenProcessParameter(
                hyoudai,
                detasyubetsumesyo,
                syutsuryoku,
                cyusyutsuhohokubun,
