...
public enum DbdInformationMessages implements IMessageGettable {
    ...
    被保険者でないデータ(10, "被保険者として登録されていないため、処理できません。"),
    受給申請中データなし(11, "受給申請中でないため、申請取消処理ができません。"),
    生活保護受給者(12, "生活保護受給者です。"),
    負担割合証発行不要(13, "所得や世帯構成の変更がありましたが、負担割合の変更がありませんでした。負担割合証の発行は不要です。"),
    負担割合_職権データ(14, "職権修正データのため、負担割合情報を変更していません。"),
    負担割合_期間なし(15, "受給者の認定期間または事業対象者の適用期間が無くなったため、画面から利用者負担割合更正を行ってください。");
