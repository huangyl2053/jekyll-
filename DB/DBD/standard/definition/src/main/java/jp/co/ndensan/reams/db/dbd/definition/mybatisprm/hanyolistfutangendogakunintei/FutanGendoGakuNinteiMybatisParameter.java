 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.mybatisprm.hanyolistfutangendogakunintei;
...
/**
 *
 * 汎用リスト出力(負担限度額認定)のMyBatis用パラメータクラスです。
 *
 * @reamsid_L DBD-3930-030 panxiaobo
 */
@SuppressWarnings("PMD.UnusedPrivateField")
@Getter
public class FutanGendoGakuNinteiMybatisParameter implements IMyBatisParameter {
    ...
    private final boolean isShinseishadatacyushutsu;
    private final boolean shiteinyushoshakyusochisha;
    private final boolean shiteinyushoshafutankeigensha;
    private final boolean shiteinyushoshasonota;
    private final boolean shiteinyushoshadaiichidankai;
    private final boolean shiteinyushoshadainidankai;
    private final boolean shiteinyushoshadaisandankai;
    private final boolean shiteinyushoshakazeisou;
     ...
     * @param isShinseishadatacyushutsu 申請者データ抽出
    ...
    public FutanGendoGakuNinteiMybatisParameter(
            ...
            boolean isShinseishadatacyushutsu,
            boolean shiteinyushoshakyusochisha,
            boolean shiteinyushoshafutankeigensha,
            boolean shiteinyushoshasonota,
            boolean shiteinyushoshadaiichidankai,
            boolean shiteinyushoshadainidankai,
            boolean shiteinyushoshadaisandankai,
            boolean shiteinyushoshakazeisou,
        ...
        this.isShinseishadatacyushutsu = isShinseishadatacyushutsu;
