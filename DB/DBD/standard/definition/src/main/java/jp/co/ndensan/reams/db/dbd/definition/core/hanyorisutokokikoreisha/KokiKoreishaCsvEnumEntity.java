 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.core.hanyorisutokokikoreisha;

import jp.co.ndensan.reams.ur.urz.definition.message.UrSystemErrorMessages;
import jp.co.ndensan.reams.uz.uza.lang.RString;

/**
 * 汎用リスト出力(後期高齢者)のEnumEntity処理クラスです。
 *
 * @reamsid_L DBD-5520-030 panxiaobo
 */
public enum KokiKoreishaCsvEnumEntity {
    ...
    /**
     * コード:1980 名称:get後期保険者番号 略称:定義なし
     */
    get後期保険者番号("1880", "get後期保険者番号"),
    /**
     * コード:1990 名称:get後期被保険者番号 略称:定義なし
     */
    get後期被保険者番号("1890", "get後期被保険者番号"),
    /**
     * コード:2000 名称:get後期取得日 略称:定義なし
     */
    get後期取得日("1900", "get後期取得日"),
    /**
     * コード:2010 名称:get後期喪失日 略称:定義なし
     */
    get後期喪失日("1910", "get後期喪失日"),
    /**
     * コード:2020 名称:get後期登録区分 略称:定義なし
     */
    get後期登録区分("1920", "get後期登録区分"),
    /**
     * コード:2280 名称:get届出区分 略称:定義なし
     */
    get届出区分("1930", "get届出区分"),
    /**
     * コード:2290 名称:get居宅計画作成区分 略称:定義なし
     */
    get居宅計画作成区分("1940", "get居宅計画作成区分"),
    /**
     * コード:2300 名称:get計画事業者番号 略称:定義なし
     */
    get計画事業者番号("1950", "get計画事業者番号"),
    /**
     * コード:2310 名称:get計画事業者名 略称:定義なし
     */
    get計画事業者名("1960", "get計画事業者名"),
    /**
     * コード:2320 名称:get計画事業者カナ 略称:定義なし
     */
    get計画事業者カナ("1970", "get計画事業者カナ"),
    /**
     * コード:2330 名称:get計画管理者名 略称:定義なし
     */
    get計画管理者名("1980", "get計画管理者名"),
    /**
     * コード:2340 名称:get計画管理者カナ 略称:定義なし
     */
    get計画管理者カナ("1990", "get計画管理者カナ"),
    /**
     * コード:2350 名称:get計画適用開始日 略称:定義なし
     */
    get計画適用開始日("2000", "get計画適用開始日"),
    /**
     * コード:2360 名称:get計画適用終了日 略称:定義なし
     */
    get計画適用終了日("2010", "get計画適用終了日"),
    /**
     * コード:2370 名称:get計画届出日 略称:定義なし
     */
    get計画届出日("2020", "get計画届出日"),
    /**
     * コード:2380 名称:get計画作成日 略称:定義なし
     */
    get計画作成日("2030", "get計画作成日"),
    /**
     * コード:2390 名称:get計画変更日 略称:定義なし
     */
    get計画変更日("2040", "get計画変更日"),
    /**
     * コード:2400 名称:get変更理由 略称:定義なし
     */
    get変更理由("2050", "get変更理由");
    private final RString code;
    private final RString fullName;

    private KokiKoreishaCsvEnumEntity(String code, String fullname) {
    ...
    /**
     * 後期高齢者のコードと一致する内容を探します。
     *
     * @param code 後期高齢者のコード
     * @return {@code code} に対応する対象リスト
     */
    public static KokiKoreishaCsvEnumEntity toValue(RString code) {
        for (KokiKoreishaCsvEnumEntity tokubetsuChi : KokiKoreishaCsvEnumEntity.values()) {
            if (tokubetsuChi.code.equals(code)) {
                return tokubetsuChi;
            }
        }
        throw new IllegalArgumentException(UrSystemErrorMessages.変換不可.getReplacedMessage("後期高齢者"));
    }
}
