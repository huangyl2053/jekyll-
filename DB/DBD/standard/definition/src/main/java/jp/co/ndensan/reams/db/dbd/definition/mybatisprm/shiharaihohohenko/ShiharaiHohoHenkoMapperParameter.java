...
/**
 * 支払方法変更を特定するためのMyBatis用パラメータクラスです。
 *
 * @reamsid_L DBB-9999-013 huangh
 */
@lombok.Getter
@SuppressWarnings("PMD.UnusedPrivateField")
public final class ShiharaiHohoHenkoMapperParameter {
     ...
     */
    private ShiharaiHohoHenkoMapperParameter(
     ...
     * @return 身体手帳検索パラメータ
     */
    public static ShiharaiHohoHenkoMapperParameter createSelectByKeyParam(
            HihokenshaNo 被保険者番号,
            RString 管理区分,
            int 履歴番号) {
        return new ShiharaiHohoHenkoMapperParameter(被保険者番号, 管理区分, 履歴番号, true, true, true);
    }
}
