 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.processprm.hanyorisutokokuho;
...
@Getter
@Setter
public class HanyoRisutoKokuhoProcessParameter implements IBatchProcessParameter {
     ...
     */
    public HanyoRisutoKokuhoProcessParameter(RString cyusyutsuhohokubun, RString cyusyutsukomokukubun,
