 ...
 */
package jp.co.ndensan.reams.db.dbd.definition.mybatisprm.hanyorisutokokuho;
...
/**
 * 汎用リスト出力(国保)のMyBatis用パラメータクラスです。
 *
...
@Getter
@Setter
public class HanyoRisutoKokuhoMybatisParameter implements IMyBatisParameter {
     ...
     */
    public HanyoRisutoKokuhoMybatisParameter(
