...
public class NinteishaListSakuseiCsvEntity {
    ...
    @CsvField(order = 19, name = "老齢福祉年金受給")
    private RString 老齢福祉年金受給;
    @CsvField(order = 20, name = "生活保護受給区分")
    private RString 生活保護受給区分;
    @CsvField(order = 21, name = "課税区分")
    private RString 課税区分;
    @CsvField(order = 22, name = "所得税課税区分")
    private RString 所得税課税区分;
    @CsvField(order = 23, name = "入所施設コード")
    private RString 入所施設コード;
    @CsvField(order = 24, name = "入所施設名称")
    private RString 入所施設名称;
    @CsvField(order = 25, name = "旧措置")
    private RString 旧措置;
    @CsvField(order = 26, name = "要介護度")
    private RString 要介護度;
    @CsvField(order = 27, name = "認定日")
    private RString 認定日;
    @CsvField(order = 28, name = "認定開始日")
    private RString 認定開始日;
    @CsvField(order = 29, name = "認定終了日")
    private RString 認定終了日;
    @CsvField(order = 30, name = "減免給付率")
    private RString 減免給付率;
    @CsvField(order = 31, name = "世帯員氏名")
    private RString 世帯員氏名;
    @CsvField(order = 32, name = "世帯員住民種別")
    private RString 世帯員住民種別;
    @CsvField(order = 33, name = "世帯員課税区分")
    private RString 世帯員課税区分;
    @CsvField(order = 34, name = "世帯員所得税課税区分")
