 ...
 */
package jp.co.ndensan.reams.db.dbd.entity.db.relate.nenjiriyoshafutanwariaihantei;
...
public class HanteiTaishoshaTempEntity extends DbTableEntityBase<HanteiTaishoshaTempEntity> implements IDbAccessable {
    ...
    //宛名異動日
    private FlexibleDate atenaIdoDate;
    @TempTableColumnOrder(9)
    //宛名異動事由コード
    private RString atenaIdoJiyuCode;
    @TempTableColumnOrder(10)
    //異動日
    private FlexibleDate idoDate;
