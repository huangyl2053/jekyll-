...
public class ChosaitakusakiDataCsvProcessEntity {
    ...
    @CsvField(order = 60, name = "事業者名称カナ")
    private RString 事業者名称カナ;
    @CsvField(order = 70, name = "郵便番号")
    private RString 郵便番号;
    @CsvField(order = 80, name = "住所")
    private RString 住所;
     ...
     * @param 状況フラグ 状況フラグ
     */
    public ChosaitakusakiDataCsvProcessEntity(
            RString シーケンシャル番号,
            RString 機能コード,
            RString 識別コード,
            RString 認定調査委託先コード,
