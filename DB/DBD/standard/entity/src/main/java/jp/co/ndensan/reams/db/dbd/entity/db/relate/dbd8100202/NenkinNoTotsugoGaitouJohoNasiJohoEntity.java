...
public class NenkinNoTotsugoGaitouJohoNasiJohoEntity {

    private int 連番;
    private RString 取込_DTレコード区分;
    private RString 取込_DT市町村コード;
    private RString 取込_DT年金保険者コード;
    private RString 取込_DT通知内容コード;
    private RString 取込_DT予備1;
    private RString 取込_DT制度コード;
    private RString 取込_DT作成年月日;
    private RString 取込_DT基礎年金番号;
    private RString 取込_DT年金コード;
    private RString 取込_DT予備2;
    private RString 取込_DT生年月日;
    private RString 取込_DT性別;
    private RString 取込_DTカナ氏名;
    private RString 取込_DTシフトコード1;
    private RString 取込_DT漢字氏名;
    private RString 取込_DTシフトコード2;
    private RString 取込_DT郵便番号;
    private RString 取込_DTカナ住所;
    private RString 取込_DTシフトコード3;
    private RString 取込_DT漢字住所;
    private RString 取込_DTシフトコード4;
    private RString 取込_DT対象年;
    private RString 取込_DT訂正表示;
    private RString 取込_DT各種区分;
    private RString 取込_DT処理結果;
    private RString 取込_DT予備3;
    private RString 取込_DT予備4;
    private RString 取込_DT金額1;
    private RString 取込_DT金額予備1;
    private RString 取込_DT金額予備2;
    private RString 取込_DT予備5;
    private RString 取込_DT共済年金証書記号番号;
    ...
    private RString 非課税_DT共済年金証書記号番;
}
