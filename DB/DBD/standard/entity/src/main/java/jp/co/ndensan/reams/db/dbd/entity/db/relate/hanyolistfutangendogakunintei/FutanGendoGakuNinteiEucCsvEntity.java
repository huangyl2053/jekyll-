...
/**
 *
 * 汎用リスト出力(負担限度額認定)のCSV用データEntity。
 *
...
public class FutanGendoGakuNinteiEucCsvEntity {
    ...
    @CsvField(order = 1650, name = "前々回申請日")
    private RString 前々回申請日;
    @CsvField(order = 1660, name = "前々回認定日")
    private RString 前々回認定日;
    @CsvField(order = 1670, name = "前々回要介護度")
    private RString 前々回要介護度;
    @CsvField(order = 1680, name = "前々回認定開始日")
    private RString 前々回認定開始日;
    @CsvField(order = 1690, name = "前々回認定終了日")
    private RString 前々回認定終了日;
    @CsvField(order = 1700, name = "前々回受給申請事由")
    private RString 前々回受給申請事由;
    @CsvField(order = 1710, name = "前々回みなし更新")
    private RString 前々回みなし更新;
    @CsvField(order = 1720, name = "前々回当初認定有効開始日")
    private RString 前々回当初認定有効開始日;
    @CsvField(order = 1730, name = "前々回当初認定有効終了日")
    private RString 前々回当初認定有効終了日;
    @CsvField(order = 1740, name = "前々回支援申請事由")
    private RString 前々回支援申請事由;
    @CsvField(order = 1750, name = "障害高齢者自立度")
    private RString 障害高齢者自立度;
    @CsvField(order = 1760, name = "認知症高齢者自立度")
    private RString 認知症高齢者自立度;
    @CsvField(order = 1770, name = "訪問支給限度額単位数")
    private RString 訪問支給限度額単位数;
    @CsvField(order = 1780, name = "訪問支給限度有効開始年月日")
    private RString 訪問支給限度有効開始年月日;
    @CsvField(order = 1790, name = "訪問支給限度有効終了年月日")
    private RString 訪問支給限度有効終了年月日;
    @CsvField(order = 1800, name = "短期入所支給限度日数")
    private RString 短期入所支給限度日数;
    @CsvField(order = 1810, name = "短期入所支給限度有効開始年月日")
    private RString 短期入所支給限度有効開始年月日;
    @CsvField(order = 1820, name = "短期入所支給限度有効終了年月日")
    private RString 短期入所支給限度有効終了年月日;
    @CsvField(order = 1830, name = "当初認定有効開始年月日")
    private RString 当初認定有効開始年月日;
    @CsvField(order = 1840, name = "当初認定有効終了年月日")
    private RString 当初認定有効終了年月日;
    @CsvField(order = 1850, name = "認定延期通知書発行年月日")
    private RString 認定延期通知書発行年月日;
    @CsvField(order = 1860, name = "認定延期通知書発行回数")
    private RString 認定延期通知書発行回数;
    @CsvField(order = 1870, name = "延期処理見込み開始年月日")
    private RString 延期処理見込み開始年月日;
    @CsvField(order = 1880, name = "延期処理見込み終了年月日")
    private RString 延期処理見込み終了年月日;
    @CsvField(order = 1890, name = "受給資格証明書発行日１")
    private RString 受給資格証明書発行日１;
    @CsvField(order = 1900, name = "受給資格証明書発行日２")
    private RString 受給資格証明書発行日２;
    @CsvField(order = 1910, name = "資格取得前申請区分")
    private RString 資格取得前申請区分;
    @CsvField(order = 1920, name = "一次判定結果（重み）")
    private RString 一次判定結果重み;
    @CsvField(order = 1930, name = "指定医区分")
    private RString 指定医区分;
    @CsvField(order = 1940, name = "訪問調査先郵便番号")
    private RString 訪問調査先郵便番号;
    @CsvField(order = 1950, name = "訪問調査先住所")
    private RString 訪問調査先住所;
    @CsvField(order = 1960, name = "訪問調査先名称")
    private RString 訪問調査先名称;
    @CsvField(order = 1970, name = "訪問調査先電話番号")
    private RString 訪問調査先電話番号;
    @CsvField(order = 1980, name = "指定事業者コード")
    private RString 指定事業者コード;
    @CsvField(order = 1990, name = "施設入所日")
    private RString 施設入所日;
    @CsvField(order = 2000, name = "施設退所日")
    private RString 施設退所日;
    @CsvField(order = 2010, name = "指定事業者名")
    private RString 指定事業者名;
    @CsvField(order = 2020, name = "指定事業者名カナ")
    private RString 指定事業者名カナ;
    @CsvField(order = 2030, name = "指定事業者郵便番号")
    private RString 指定事業者郵便番号;
    @CsvField(order = 2040, name = "指定事業者住所")
    private RString 指定事業者住所;
    @CsvField(order = 2050, name = "指定事業者代表者名")
    private RString 指定事業者代表者名;
    @CsvField(order = 2060, name = "指定事業者代表者名カナ")
    private RString 指定事業者代表者名カナ;
    @CsvField(order = 2070, name = "指定事業者代表者役職")
    private RString 指定事業者代表者役職;
    @CsvField(order = 2080, name = "指定事業者電話番号")
    private RString 指定事業者電話番号;
    @CsvField(order = 2090, name = "指定事業者ＦＡＸ番号")
    private RString 指定事業者ＦＡＸ番号;
    @CsvField(order = 2100, name = "指定事業者ケアマネ数")
    private RString 指定事業者ケアマネ数;
    @CsvField(order = 2110, name = "指定事業者利用者数")
    private RString 指定事業者利用者数;
    @CsvField(order = 2120, name = "指定事業者認定日")
    private RString 指定事業者認定日;
    @CsvField(order = 2130, name = "指定事業者取消日")
    private RString 指定事業者取消日;
    @CsvField(order = 2140, name = "指定事業者実施地域")
    private RString 指定事業者実施地域;
    @CsvField(order = 2150, name = "転出先保険者番号")
    private RString 転出先保険者番号;
    @CsvField(order = 2160, name = "特定入所者申請日")
    private RString 特定入所者申請日;
    @CsvField(order = 2170, name = "特定入所者申請理由コード")
    private RString 特定入所者申請理由コード;
    @CsvField(order = 2180, name = "特定入所者決定日")
    private RString 特定入所者決定日;
    @CsvField(order = 2190, name = "特定入所者決定区分")
    private RString 特定入所者決定区分;
    @CsvField(order = 2200, name = "特定入所者開始日")
    private RString 特定入所者開始日;
    @CsvField(order = 2210, name = "特定入所者終了日")
    private RString 特定入所者終了日;
    @CsvField(order = 2220, name = "特定入所者旧措置者")
    private RString 特定入所者旧措置者;
    @CsvField(order = 2230, name = "特定入所者負担段階")
    private RString 特定入所者負担段階;
    @CsvField(order = 2240, name = "食費")
    private RString 食費;
    @CsvField(order = 2250, name = "居住費ユニット型個室")
    private RString 居住費ユニット型個室;
    @CsvField(order = 2260, name = "居住費ユニット型準個室")
    private RString 居住費ユニット型準個室;
    @CsvField(order = 2270, name = "居住費従来型個室／特養")
    private RString 居住費従来型個室特養;
    @CsvField(order = 2280, name = "居住費従来型個室／老健")
    private RString 居住費従来型個室老健;
    @CsvField(order = 2290, name = "居住費多床室")
    private RString 居住費多床室;
    @CsvField(order = 2300, name = "特例減額措置区分")
    private RString 特例減額措置区分;
    @CsvField(order = 2310, name = "居室種別")
    private RString 居室種別;
    @CsvField(order = 2320, name = "境界層")
    private RString 境界層;
    @CsvField(order = 2330, name = "特定入所者激変緩和")
    private RString 特定入所者激変緩和;
    @CsvField(order = 2340, name = "配偶者の有無")
    private RString 配偶者の有無;
    @CsvField(order = 2350, name = "配偶者氏名")
    private RString 配偶者氏名;
    @CsvField(order = 2360, name = "配偶者氏名カナ")
    private RString 配偶者氏名カナ;
    @CsvField(order = 2370, name = "配偶者生年月日")
    private RString 配偶者生年月日;
    @CsvField(order = 2380, name = "配偶者住所")
    private RString 配偶者住所;
    @CsvField(order = 2390, name = "配偶者連絡先")
    private RString 配偶者連絡先;
    @CsvField(order = 2400, name = "配偶者住所２")
    private RString 配偶者住所２;
    @CsvField(order = 2410, name = "配偶者課税区分")
    private RString 配偶者課税区分;
    @CsvField(order = 2420, name = "配偶者住民コード")
    private RString 配偶者住民コード;
    @CsvField(order = 2430, name = "預貯金額")
    private RString 預貯金額;
    @CsvField(order = 2440, name = "有価証券評価概算額")
    private RString 有価証券評価概算額;
    @CsvField(order = 2450, name = "その他金額")
    private RString その他金額;
    @CsvField(order = 2460, name = "届出区分")
    private RString 届出区分;
    @CsvField(order = 2470, name = "居宅計画作成区分")
    private RString 居宅計画作成区分;
    @CsvField(order = 2480, name = "計画事業者番号")
    private RString 計画事業者番号;
    @CsvField(order = 2490, name = "計画事業者名")
    private RString 計画事業者名;
    @CsvField(order = 2500, name = "計画事業者カナ")
    private RString 計画事業者カナ;
    @CsvField(order = 2510, name = "計画管理者名")
    private RString 計画管理者名;
    @CsvField(order = 2520, name = "計画管理者カナ")
    private RString 計画管理者カナ;
    @CsvField(order = 2530, name = "計画適用開始日")
    private RString 計画適用開始日;
    @CsvField(order = 2540, name = "計画適用終了日")
    private RString 計画適用終了日;
    @CsvField(order = 2550, name = "計画届出日")
    private RString 計画届出日;
    @CsvField(order = 2560, name = "計画作成日")
    private RString 計画作成日;
    @CsvField(order = 2570, name = "計画変更日")
    private RString 計画変更日;
    @CsvField(order = 2580, name = "変更理由")
