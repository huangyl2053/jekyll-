package jp.co.ndensan.reams.db.dbd.entity.report.dbd200014;
 ...
 */
public class HomonKaigoRiyoshaFutangakuGengakuNinteishaIchiranReportSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listUpper_4", length = 3, order = 18)
    public RString listUpper_4;
    @ReportItem(name = "listUpper_5", length = 9, order = 19)
    public RString listUpper_5;
    @ReportItem(name = "listUpper_6", length = 9, order = 20)
    ...
    @ReportItem(name = "listUpper_12", length = 9, order = 26)
    public RString listUpper_12;
    @ReportItem(name = "listUpper_13", length = 8, order = 27)
    public RString listUpper_13;
    @ReportItem(name = "listUpper_14", length = 2, order = 28)
    ...
    @ReportItem(name = "listCenter_1", length = 10, order = 32)
    public RString listCenter_1;
    @ReportItem(name = "listCenter_2", length = 11, order = 33)
    public RString listCenter_2;
    @ReportItem(name = "listCenter_3", length = 20, order = 34)
    public RString listCenter_3;
    @ReportItem(name = "listCenter_4", length = 4, order = 35)
    public RString listCenter_4;
    @ReportItem(name = "listCenter_5", length = 9, order = 36)
    public RString listCenter_5;
    @ReportItem(name = "listCenter_6", length = 9, order = 37)
    public RString listCenter_6;
    @ReportItem(name = "listCenter_7", length = 3, order = 38)
    public RString listCenter_7;
    @ReportItem(name = "listCenter_8", length = 10, order = 39)
    public RString listCenter_8;
    @ReportItem(name = "listCenter_9", length = 4, order = 40)
    public RString listCenter_9;
    @ReportItem(name = "listCenter_10", length = 9, order = 41)
    public RString listCenter_10;
    @ReportItem(name = "listCenter_11", length = 8, order = 42)
    public RString listCenter_11;
    @ReportItem(name = "listCenter_12", length = 2, order = 43)
    public RString listCenter_12;
    @ReportItem(name = "listCenter_13", length = 1, order = 44)
    public RString listCenter_13;
    @ReportItem(name = "listCenter_14", length = 1, order = 45)
    public RString listCenter_14;
    @ReportItem(name = "listCenter_15", length = 1, order = 46)
    public RString listCenter_15;
    @ReportItem(name = "listLower_1", length = 10, order = 47)
    public RString listLower_1;
    @ReportItem(name = "listLower_2", length = 9, order = 48)
    public RString listLower_2;
    @ReportItem(name = "listLower_3", length = 20, order = 49)
    public RString listLower_3;
    @ReportItem(name = "listLower_4", length = 2, order = 50)
    public RString listLower_4;
    @ReportItem(name = "listLower_5", length = 5, order = 51)
    public RString listLower_5;
    @ReportItem(name = "listLower_6", length = 3, order = 52)
    public RString listLower_6;
    @ReportItem(name = "listLower_7", length = 1, order = 53)
    public RString listLower_7;
    @ReportItem(name = "listLower_8", length = 1, order = 54)
    public RString listLower_8;
    @ReportItem(name = "listLower_9", length = 9, order = 55)
    public RString listLower_9;
    @ReportItem(name = "listLower_10", length = 8, order = 56)
    public RString listLower_10;
    @ReportItem(name = "listLower_11", length = 2, order = 57)
    public RString listLower_11;
    @ReportItem(name = "listLower_12", length = 1, order = 58)
    public RString listLower_12;
    @ReportItem(name = "listLower_13", length = 1, order = 59)
    public RString listLower_13;
    @ReportItem(name = "listLower_14", length = 1, order = 60)
