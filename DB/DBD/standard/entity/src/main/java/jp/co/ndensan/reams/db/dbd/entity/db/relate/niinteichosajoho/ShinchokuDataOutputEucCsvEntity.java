 ...
 */
package jp.co.ndensan.reams.db.dbd.entity.db.relate.niinteichosajoho;

import jp.co.ndensan.reams.uz.uza.io.csv.CsvField;
import jp.co.ndensan.reams.uz.uza.lang.RString;

/**
 * バッチ設計_DBE491001_日次進捗データ作成ですためのBatch用CSVEntityクラスです。
 *
...
public class ShinchokuDataOutputEucCsvEntity {

    @CsvField(order = 1, name = "項番 ")
    private RString 項番;
    @CsvField(order = 2, name = "ステータス ")
    ...
    @CsvField(order = 54, name = "中間評価項目得点 第１群 ")
    private RString 中間評価項目得点第１群;
    @CsvField(order = 55, name = "中間評価項目得点 第２群 ")
