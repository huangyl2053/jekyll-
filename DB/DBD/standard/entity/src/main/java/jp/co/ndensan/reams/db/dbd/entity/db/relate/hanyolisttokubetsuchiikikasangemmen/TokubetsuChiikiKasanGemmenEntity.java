...
/**
 * 汎用リスト出力(特別地域加算減免)のRelateEntityクラスです。
 *
...
//    private RString 受給者台帳_みなし要介護区分コード;
    ...
    private RString 特別地域加算減免_証記載保険者番号;
    private RString 特別地域加算減免_被保険者番号;
    private int 特別地域加算減免_履歴番号;
    private RString 特別地域加算減免_確認番号;
    private FlexibleDate 特別地域加算減免_申請年月日;
    private FlexibleDate 特別地域加算減免_決定年月日;
    private RString 特別地域加算減免_決定区分;
    private FlexibleDate 特別地域加算減免_適用開始年月日;
    private FlexibleDate 特別地域加算減免_適用終了年月日;
    private RString 特別地域加算減免_減額率;
