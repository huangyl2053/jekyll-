...
public class HanyoRisutoJyukyusyaDaichoEntity {
    ...
    private RString 後期高齢者情報_後期高齢被保険者番号;
    ...
    private RString 今回申請_認定申請区分申請時コード;
    private RString 今回申請_認定申請区分法令コード;
    ...
    private RString 前回申請_認定調査委託先コード;
    private RString 前回申請_認定調査員コード;
    private RString 前回調査委託先_事業者名称;
    private RString 前回調査員_調査員氏名;
    private RString 前々回申請_厚労省IF識別コード;
    private RString 前々回申請_要支援者認定申請区分;
    private RString 前々回申請_認定調査委託先コード;
    private RString 前々回申請_認定調査員コード;
    ...
    private RString 前々回調査委託先_事業者名称;
    private RString 前々回調査員_調査員氏名;
    ...
    private FlexibleDate 国保資格情報_資格取得日;
    private FlexibleDate 国保資格情報_資格喪失日;
    private RString 国保資格情報_国保番号;
    private RString 国保資格情報_国保保険者番号;
    private RString 国保資格情報_国保保険証番号;
    private RString 国保資格情報_国保個人番号;
    private RString 国保資格情報_登録区分;
    private FlexibleDate 二次予防事業対象情報_適用開始年月日;
    private FlexibleDate 二次予防事業対象情報_適用終了年月日;
    private FlexibleDate 二次予防事業対象情報_調査実施日;
    private FlexibleDate 二次予防事業対象情報_決定年月日;
    ...
    private RString 計画事業者_委託先事業者番号;
    private RString 委託先事業者_事業者名称;
    private RString 委託先事業者_事業者名称カナ;
    private RString 委託先事業者代表者_代表者名;
    private RString 委託先事業者代表者_代表者名カナ;
