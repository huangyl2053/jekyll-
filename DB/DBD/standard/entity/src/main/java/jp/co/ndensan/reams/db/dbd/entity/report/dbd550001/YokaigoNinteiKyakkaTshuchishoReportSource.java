 ...
 */
package jp.co.ndensan.reams.db.dbd.entity.report.dbd550001;
...
/**
 * 要介護認定却下通知書のReportSource
 *
 * @reamsid_L DBD-1430-060 b_zhengs
 */
public class YokaigoNinteiKyakkaTshuchishoReportSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "hakkoYMD1", length = 12, order = 6)
    ...
    @ReportItem(name = "kyakkaYMD", length = 11, order = 61)
    public RString kyakkaYMD;
    @ReportItem(name = "riyu", order = 62)
    public RString riyu;
    @ReportItem(name = "tsuchibun2", order = 63)
