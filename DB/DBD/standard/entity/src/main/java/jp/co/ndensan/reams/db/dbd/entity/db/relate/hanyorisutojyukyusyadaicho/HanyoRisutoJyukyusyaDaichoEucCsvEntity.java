 ...
 */
package jp.co.ndensan.reams.db.dbd.entity.db.relate.hanyorisutojyukyusyadaicho;
...
public class HanyoRisutoJyukyusyaDaichoEucCsvEntity {
    ...
    @CsvField(order = 1650, name = "前回調査委託先コード")
    private RString 前回調査委託先コード;
    @CsvField(order = 1660, name = "前回調査員コード")
    private RString 前回調査員コード;
    @CsvField(order = 1670, name = "前回委託先名")
    private RString 前回委託先名;
    @CsvField(order = 1680, name = "前回調査員氏名")
    ...
    @CsvField(order = 1790, name = "前々回調査委託先コード")
    private RString 前々回調査委託先コード;
    @CsvField(order = 1800, name = "前々回調査員コード")
    private RString 前々回調査員コード;
    @CsvField(order = 1810, name = "前々回委託先名")
    private RString 前々回委託先名;
    @CsvField(order = 1820, name = "前々回調査員氏名")
    ...
    @CsvField(order = 2060, name = "申請区分（申請時）")
    private RString 申請区分申請時;
    @CsvField(order = 2070, name = "申請区分（法令）")
    private RString 申請区分法令;
    @CsvField(order = 2080, name = "指定事業者コード")
    private RString 指定事業者コード;
    @CsvField(order = 2090, name = "施設入所日")
    private RString 施設入所日;
    @CsvField(order = 2100, name = "施設退所日")
    private RString 施設退所日;
    @CsvField(order = 2110, name = "指定事業者名")
    private RString 指定事業者名;
    @CsvField(order = 2120, name = "指定事業者名カナ")
    private RString 指定事業者名カナ;
    @CsvField(order = 2130, name = "指定事業者郵便番号")
    private RString 指定事業者郵便番号;
    @CsvField(order = 2140, name = "指定事業者住所")
    private RString 指定事業者住所;
    @CsvField(order = 2150, name = "指定事業者代表者名")
    private RString 指定事業者代表者名;
    @CsvField(order = 2160, name = "指定事業者代表者名カナ")
    private RString 指定事業者代表者名カナ;
    @CsvField(order = 2170, name = "指定事業者代表者役職")
    private RString 指定事業者代表者役職;
    @CsvField(order = 2180, name = "指定事業者電話番号")
    private RString 指定事業者電話番号;
    @CsvField(order = 2190, name = "指定事業者ＦＡＸ番号")
    private RString 指定事業者ＦＡＸ番号;
    @CsvField(order = 2200, name = "指定事業者ケアマネ数")
    private RString 指定事業者ケアマネ数;
    @CsvField(order = 2210, name = "指定事業者利用者数")
    private RString 指定事業者利用者数;
    @CsvField(order = 2220, name = "指定事業者認定日")
    private RString 指定事業者認定日;
    @CsvField(order = 2230, name = "指定事業者取消日")
    private RString 指定事業者取消日;
    @CsvField(order = 2240, name = "指定事業者実施地域")
    private RString 指定事業者実施地域;
    @CsvField(order = 2250, name = "転出先保険者番号")
    private RString 転出先保険者番号;
    @CsvField(order = 2260, name = "所得段階")
    ...
    @CsvField(order = 2320, name = "国保番号")
    private RString 国保番号;
    @CsvField(order = 2330, name = "国保保険者番号")
    private RString 国保保険者番号;
    @CsvField(order = 2340, name = "国保保険証番号")
    private RString 国保保険証番号;
    @CsvField(order = 2350, name = "国保個人番号")
    private RString 国保個人番号;
    @CsvField(order = 2360, name = "国保取得日")
    private RString 国保取得日;
    @CsvField(order = 2370, name = "国保喪失日")
    private RString 国保喪失日;
    @CsvField(order = 2380, name = "国保登録区分")
    private RString 国保登録区分;
    @CsvField(order = 2390, name = "二次予防適用開始日")
    private RString 二次予防適用開始日;
    @CsvField(order = 2400, name = "二次予防適用終了日")
    private RString 二次予防適用終了日;
    @CsvField(order = 2410, name = "二次予防調査実施日")
    private RString 二次予防調査実施日;
    @CsvField(order = 2420, name = "二次予防決定日")
    ...
    @CsvField(order = 2560, name = "委託先計画事業者番号")
    private RString 委託先計画事業者番号;
    @CsvField(order = 2570, name = "委託先計画事業者名")
    private RString 委託先計画事業者名;
    @CsvField(order = 2580, name = "委託先計画事業者カナ")
    private RString 委託先計画事業者カナ;
    @CsvField(order = 2590, name = "委託先計画管理者名")
    private RString 委託先計画管理者名;
    @CsvField(order = 2600, name = "委託先計画管理者カナ")
