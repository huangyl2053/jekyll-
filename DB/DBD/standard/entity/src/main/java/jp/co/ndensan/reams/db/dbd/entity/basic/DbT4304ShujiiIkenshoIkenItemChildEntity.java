...
/**
 * 要介護認定主治医意見書意見項目（子）テーブルのエンティティクラスです。
 */
public class DbT4304ShujiiIkenshoIkenItemChildEntity extends DbTableEntityBase<DbT4304ShujiiIkenshoIkenItemChildEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    @TableName
    public static final RString TABLE_NAME = new RString("DbT4304ShujiiIkenshoIkenItemChild");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT4304ShujiiIkenshoIkenItemChildEntity}と等しいか判定します。
     * 
     * @param other 比較するエンティティ
     * @@return 
     * 比較するエンティティが同じ主キーを持つ{@literal DbT4304ShujiiIkenshoIkenItemChildEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT4304ShujiiIkenshoIkenItemChildEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT4304ShujiiIkenshoIkenItemChildEntity entity) {
