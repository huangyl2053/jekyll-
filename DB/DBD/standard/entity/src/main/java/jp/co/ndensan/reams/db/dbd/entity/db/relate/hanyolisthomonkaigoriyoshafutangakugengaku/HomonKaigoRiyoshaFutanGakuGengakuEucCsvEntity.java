 ...
 */
package jp.co.ndensan.reams.db.dbd.entity.db.relate.hanyolisthomonkaigoriyoshafutangakugengaku;
...
/**
 *
 * 汎用リスト出力(訪問介護利用者負担額減額)のCSV用データEntity。
 *
...
public class HomonKaigoRiyoshaFutanGakuGengakuEucCsvEntity {
    ...
    @CsvField(order = 1980, name = "特別対策減免申請日")
    private RString 特別対策減免申請日;
    @CsvField(order = 1990, name = "特別対策減免決定日")
    private RString 特別対策減免決定日;
    @CsvField(order = 2000, name = "特別対策減免承認区分")
    private RString 特別対策減免承認区分;
    @CsvField(order = 2010, name = "特別対策減免開始日")
    private RString 特別対策減免開始日;
    @CsvField(order = 2020, name = "特別対策減免終了日")
    private RString 特別対策減免終了日;
    @CsvField(order = 2030, name = "特別対策給付率")
    private RString 特別対策給付率;
    @CsvField(order = 2040, name = "公費法別番号")
    private RString 公費法別番号;
    @CsvField(order = 2050, name = "公費受給者番号")
    private RString 公費受給者番号;
    @CsvField(order = 2060, name = "障害者手帳有無")
    private RString 障害者手帳有無;
    @CsvField(order = 2070, name = "障害者等級")
    private RString 障害者等級;
    @CsvField(order = 2080, name = "障害者手帳番号")
    private RString 障害者手帳番号;
    @CsvField(order = 2090, name = "被保険者番号_総合事業対象者")
    private RString 被保険者番号_総合事業対象者;
    @CsvField(order = 2100, name = "履歴番号")
    private RString 履歴番号;
    @CsvField(order = 2110, name = "事業適用開始日")
    private RString 事業適用開始日;
    @CsvField(order = 2120, name = "事業適用終了日")
    private RString 事業適用終了日;
    @CsvField(order = 2130, name = "事業チェック実施日")
    private RString 事業チェック実施日;
    @CsvField(order = 2140, name = "事業決定日")
    private RString 事業決定日;
    @CsvField(order = 2150, name = "届出区分")
    private RString 届出区分;
    @CsvField(order = 2160, name = "居宅計画作成区分")
    private RString 居宅計画作成区分;
    @CsvField(order = 2170, name = "計画事業者番号")
    private RString 計画事業者番号;
    @CsvField(order = 2180, name = "計画事業者名")
    private RString 計画事業者名;
    @CsvField(order = 2190, name = "計画事業者カナ")
    private RString 計画事業者カナ;
    @CsvField(order = 2200, name = "計画管理者名")
    private RString 計画管理者名;
    @CsvField(order = 2210, name = "計画管理者カナ")
    private RString 計画管理者カナ;
    @CsvField(order = 2220, name = "計画適用開始日")
    private RString 計画適用開始日;
    @CsvField(order = 2230, name = "計画適用終了日")
    private RString 計画適用終了日;
    @CsvField(order = 2240, name = "計画届出日")
    private RString 計画届出日;
    @CsvField(order = 2250, name = "計画作成日")
    private RString 計画作成日;
    @CsvField(order = 2260, name = "計画変更日")
    private RString 計画変更日;
    @CsvField(order = 2270, name = "変更理由")
