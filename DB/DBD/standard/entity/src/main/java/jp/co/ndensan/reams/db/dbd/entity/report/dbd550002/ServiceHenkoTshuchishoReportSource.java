 ...
 */
package jp.co.ndensan.reams.db.dbd.entity.report.dbd550002;
...
/**
 * サービス変更通知書のReportSource
 *
 * @reamsid_L DBD-1430-040 b_zhengs
 */
public class ServiceHenkoTshuchishoReportSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "henkoYMD", length = 11, order = 61)
    public RString henkoYMD;
    @ReportItem(name = "maeService", order = 62)
    public RString maeService;
    @ReportItem(name = "atoService", order = 63)
    public RString atoService;
    @ReportItem(name = "riyu", order = 64)
    public RString riyu;
    @ReportItem(name = "tsuchibun2", order = 65)
