...
public class HanyoRisutoKokiKoreishaEucCsvEntity {
    ...
    @CsvField(order = 1880, name = "後期保険者番号")
    private RString 後期保険者番号;
    @CsvField(order = 1890, name = "後期被保険者番号")
    private RString 後期被保険者番号;
    @CsvField(order = 1900, name = "後期取得日")
    private RString 後期取得日;
    @CsvField(order = 1910, name = "後期喪失日")
    private RString 後期喪失日;
    @CsvField(order = 1920, name = "後期登録区分")
    private RString 後期登録区分;
    @CsvField(order = 1930, name = "届出区分")
    private RString 届出区分;
    @CsvField(order = 1940, name = "居宅計画作成区分")
    private RString 居宅計画作成区分;
    @CsvField(order = 1950, name = "計画事業者番号")
    private RString 計画事業者番号;
    @CsvField(order = 1960, name = "計画事業者名")
    private RString 計画事業者名;
    @CsvField(order = 1970, name = "計画事業者カナ")
    private RString 計画事業者カナ;
    @CsvField(order = 1980, name = "計画管理者名")
    private RString 計画管理者名;
    @CsvField(order = 1990, name = "計画管理者カナ")
    private RString 計画管理者カナ;
    @CsvField(order = 2000, name = "計画適用開始日")
    private RString 計画適用開始日;
    @CsvField(order = 2010, name = "計画適用終了日")
    private RString 計画適用終了日;
    @CsvField(order = 2020, name = "計画届出日")
    private RString 計画届出日;
    @CsvField(order = 2030, name = "計画作成日")
    private RString 計画作成日;
    @CsvField(order = 2040, name = "計画変更日")
    private RString 計画変更日;
    @CsvField(order = 2050, name = "変更理由")
