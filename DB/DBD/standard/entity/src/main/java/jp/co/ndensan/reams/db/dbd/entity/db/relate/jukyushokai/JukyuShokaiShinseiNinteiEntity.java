...
public class JukyuShokaiShinseiNinteiEntity {
    ...
    private RString dbT5101NinteiShinseiJoho_insertDantaiCd;
    private RDateTime dbT5101NinteiShinseiJoho_insertTimestamp;
    private RString dbT5101NinteiShinseiJoho_insertReamsLoginId;
    private UUID dbT5101NinteiShinseiJoho_insertContextId;
    private boolean dbT5101NinteiShinseiJoho_isDeleted;
    private int dbT5101NinteiShinseiJoho_updateCount;
    private RDateTime dbT5101NinteiShinseiJoho_lastUpdateTimestamp;
    private RString dbT5101NinteiShinseiJoho_lastUpdateReamsLoginId;
    private ShinseishoKanriNo dbT5101NinteiShinseiJoho_shinseishoKanriNo;
    private Code dbT5101NinteiShinseiJoho_koroshoIfShikibetsuCode;
    private RString dbT5101NinteiShinseiJoho_shoKisaiHokenshaNo;
    private FlexibleYear dbT5101NinteiShinseiJoho_shinseiNendo;
    private RString dbT5101NinteiShinseiJoho_hihokenshaNo;
    private FlexibleDate dbT5101NinteiShinseiJoho_ninteiShinseiYMD;
    private EdabanCode dbT5101NinteiShinseiJoho_ninteiShinseiEdabanCode;
    private Code dbT5101NinteiShinseiJoho_ninteiShinseiHoreiKubunCode;
    private Code dbT5101NinteiShinseiJoho_ninteiShinseiShinseijiKubunCode;
    private Code dbT5101NinteiShinseiJoho_torisageKubunCode;
    private RString dbT5101NinteiShinseiJoho_hihokenshaKubunCode;
    private FlexibleDate dbT5101NinteiShinseiJoho_seinengappiYMD;
    private int dbT5101NinteiShinseiJoho_age;
    private Code dbT5101NinteiShinseiJoho_seibetsu;
    private AtenaKanaMeisho dbT5101NinteiShinseiJoho_hihokenshaKana;
    private AtenaMeisho dbT5101NinteiShinseiJoho_hihokenshaName;
    private YubinNo dbT5101NinteiShinseiJoho_yubinNo;
    private AtenaJusho dbT5101NinteiShinseiJoho_jusho;
    private TelNo dbT5101NinteiShinseiJoho_telNo;
    private RString dbT5101NinteiShinseiJoho_shishoCode;
    private ShikibetsuCode dbT5101NinteiShinseiJoho_shikibetsuCode;
    private ChikuCode dbT5101NinteiShinseiJoho_chikuCode;
    private boolean dbT5101NinteiShinseiJoho_minashiNigoEtcTaishoFlag;
    private Code dbT5101NinteiShinseiJoho_koikinaiTenkyoKubun;
    private Code dbT5101NinteiShinseiJoho_ninteiShinseiYukoKubunCode;
    private RString dbT5101NinteiShinseiJoho_shienShinseiKubun;
    private RString dbT5101NinteiShinseiJoho_ninteiShinseiRiyu;
    private RString dbT5101NinteiShinseiJoho_shinseiServiceDeleteRiyu;
    private Code dbT5101NinteiShinseiJoho_zenYokaigoKubunCode;
    private FlexibleDate dbT5101NinteiShinseiJoho_zenkaiNinteiYMD;
    private FlexibleDate dbT5101NinteiShinseiJoho_zenkaiYukoKikanStart;
    private FlexibleDate dbT5101NinteiShinseiJoho_zenkaiYukoKikanEnd;
    private RString dbT5101NinteiShinseiJoho_nigoIryoHokenshaName;
    private RString dbT5101NinteiShinseiJoho_nigoIryoHokenKigoBango;
    private Code dbT5101NinteiShinseiJoho_nigoTokuteiShippeiCode;
    private RString dbT5101NinteiShinseiJoho_jidoWariateJogaishaKubun;
    private boolean dbT5101NinteiShinseiJoho_johoteikyoDoiFlag;
    private FlexibleDate dbT5101NinteiShinseiJoho_johoteikyoSiryoOutputYMD;
    private Code dbT5101NinteiShinseiJoho_chosaKubun;
    private ChosaItakusakiCode dbT5101NinteiShinseiJoho_ninteiChosaItakusakiCode;
    private ChosainCode dbT5101NinteiShinseiJoho_ninteiChosainCode;
    private RString dbT5101NinteiShinseiJoho_renrakuJikoToChosain;
    private RString dbT5101NinteiShinseiJoho_shujiiIryokikanCode;
    private RString dbT5101NinteiShinseiJoho_shujiiCode;
    private boolean dbT5101NinteiShinseiJoho_shiteiiFlag;
    private Code dbT5101NinteiShinseiJoho_ikenshoDataShubetsu;
    private RString dbT5101NinteiShinseiJoho_renrakuJikoToShujii;
    private boolean dbT5101NinteiShinseiJoho_enkitsuchiNashiDoiFlag;
    private boolean dbT5101NinteiShinseiJoho_shisetsuNyushoFlag;
    private JigyoshaNo dbT5101NinteiShinseiJoho_nyushoShisetsuCode;
    private boolean dbT5101NinteiShinseiJoho_kateiHomonFlag;
    private YubinNo dbT5101NinteiShinseiJoho_homonChosasakiYubinNo;
    private AtenaJusho dbT5101NinteiShinseiJoho_homonChosasakiJusho;
    private AtenaMeisho dbT5101NinteiShinseiJoho_homonChosasakiName;
    private TelNo dbT5101NinteiShinseiJoho_homonChosasakiTelNo;
    private RString dbT5101NinteiShinseiJoho_shichosonRenrakuJiko;
    private Code dbT5101NinteiShinseiJoho_shoriJotaiKubun;
    private FlexibleDate dbT5101NinteiShinseiJoho_torisageYMD;
    private RString dbT5101NinteiShinseiJoho_torisageRiyu;
    private FlexibleDate dbT5101NinteiShinseiJoho_kyakkaYMD;
    private RString dbT5101NinteiShinseiJoho_kyakkaRiyu;
    private FlexibleDate dbT5101NinteiShinseiJoho_enkiKetteiYMD;
    private RString dbT5101NinteiShinseiJoho_enkiRiyu;
    private FlexibleDate dbT5101NinteiShinseiJoho_enkiTsuchiHakkoYMD;
    private int dbT5101NinteiShinseiJoho_enkiTsuchiHakkoKaisu;
    private FlexibleDate dbT5101NinteiShinseiJoho_enkiMikomiKaishiYMD;
    private FlexibleDate dbT5101NinteiShinseiJoho_enkiMikomiShuryoYMD;
    private boolean dbT5101NinteiShinseiJoho_shinsaKeizokuFlag;
    private Code dbT5101NinteiShinseiJoho_shinsakaiYusenWaritsukeKubunCode;
    private FlexibleDate dbT5101NinteiShinseiJoho_koshinTsuchiHakkoYMD;
    private FlexibleDate dbT5101NinteiShinseiJoho_koshinTsuchiHakkoKanryoYMD;
    private FlexibleDate dbT5101NinteiShinseiJoho_ninteiShinseiJohoTorokuYMD;
    private int dbT5101NinteiShinseiJoho_saiChosaIraiKaisu;
    private int dbT5101NinteiShinseiJoho_saiSakuseiIraiKaisu;
    private FlexibleDate dbT5101NinteiShinseiJoho_ifSofuYMD;
    private boolean dbT5101NinteiShinseiJoho_logicalDeletedFlag;
