...
/**
 * 汎用リスト出力(社会福祉法人軽減)のRelateEntityクラスです。
 *
...
public class ShakaiFukushiHojinKeigenEntity {
...
//    private RString 受給者台帳_みなし要介護区分コード;
    ...
    private RString 社会福祉法人等利用者負担軽減_証記載保険者番号;
    private RString 社会福祉法人等利用者負担軽減_被保険者番号;
    private int 社会福祉法人等利用者負担軽減_履歴番号;
    private RString 社会福祉法人等利用者負担軽減_確認番号;
    private FlexibleDate 社会福祉法人等利用者負担軽減_申請年月日;
    private FlexibleDate 社会福祉法人等利用者負担軽減_決定年月日;
    private RString 社会福祉法人等利用者負担軽減_決定区分;
    private FlexibleDate 社会福祉法人等利用者負担軽減_適用開始年月日;
    private FlexibleDate 社会福祉法人等利用者負担軽減_適用終了年月日;
    private RString 社会福祉法人等利用者負担軽減_軽減率_分子;
    private RString 社会福祉法人等利用者負担軽減_軽減率_分母;
    private RString 社会福祉法人等利用者負担軽減_減免区分;
    private boolean 社会福祉法人等利用者負担軽減_居宅サービス限定;
    private boolean 社会福祉法人等利用者負担軽減_居住費_食費のみ;
    private boolean 社会福祉法人等利用者負担軽減_旧措置者ユニット型個室のみ;
