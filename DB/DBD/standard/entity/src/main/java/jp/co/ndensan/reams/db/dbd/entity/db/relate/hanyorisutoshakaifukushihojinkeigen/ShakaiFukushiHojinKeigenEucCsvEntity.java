 ...
 */
package jp.co.ndensan.reams.db.dbd.entity.db.relate.hanyorisutoshakaifukushihojinkeigen;
...
/**
 *
 * 汎用リスト出力(社会福祉法人軽減)CSV用データEntity。
 *
...
public class ShakaiFukushiHojinKeigenEucCsvEntity {
    ...
    @CsvField(order = 2160, name = "確認番号")
    private RString 確認番号;
    @CsvField(order = 2170, name = "社会福祉法人軽減申請日")
    private RString 社会福祉法人軽減申請日;
    @CsvField(order = 2180, name = "社会福祉法人軽減決定日")
    private RString 社会福祉法人軽減決定日;
    @CsvField(order = 2190, name = "社会福祉法人軽減承認区分")
    private RString 社会福祉法人軽減承認区分;
    @CsvField(order = 2200, name = "社会福祉法人軽減開始日")
    private RString 社会福祉法人軽減開始日;
    @CsvField(order = 2210, name = "社会福祉法人軽減終了日")
    private RString 社会福祉法人軽減終了日;
    @CsvField(order = 2220, name = "社会福祉法人軽減率")
    private RString 社会福祉法人軽減率;
    @CsvField(order = 2230, name = "社会福祉法人軽減事由")
    private RString 社会福祉法人軽減事由;
    @CsvField(order = 2240, name = "居宅サービス区分")
    private RString 居宅サービス区分;
    @CsvField(order = 2250, name = "居住費／食費限定区分")
    private RString 居住費_食費限定区分;
    @CsvField(order = 2260, name = "旧措置ユニット型個室限定区分")
    private RString 旧措置ユニット型個室限定区分;
    @CsvField(order = 2270, name = "被保険者番号_総合事業対象者")
    private RString 被保険者番号_総合事業対象者;
    @CsvField(order = 2280, name = "履歴番号")
    private RString 履歴番号;
    @CsvField(order = 2290, name = "事業適用開始日")
    private RString 事業適用開始日;
    @CsvField(order = 2300, name = "事業適用終了日")
    private RString 事業適用終了日;
    @CsvField(order = 2310, name = "事業チェック実施日")
    private RString 事業チェック実施日;
    @CsvField(order = 2320, name = "事業決定日")
    private RString 事業決定日;
    @CsvField(order = 2330, name = "届出区分")
    private RString 届出区分;
    @CsvField(order = 2340, name = "居宅計画作成区分")
    private RString 居宅計画作成区分;
    @CsvField(order = 2350, name = "計画事業者番号")
    private RString 計画事業者番号;
    @CsvField(order = 2360, name = "計画事業者名")
    private RString 計画事業者名;
    @CsvField(order = 2370, name = "計画事業者カナ")
    private RString 計画事業者カナ;
    @CsvField(order = 2380, name = "計画管理者名")
    private RString 計画管理者名;
    @CsvField(order = 2390, name = "計画管理者カナ")
    private RString 計画管理者カナ;
    @CsvField(order = 2400, name = "計画適用開始日")
    private RString 計画適用開始日;
    @CsvField(order = 2410, name = "計画適用終了日")
    private RString 計画適用終了日;
    @CsvField(order = 2420, name = "計画届出日")
    private RString 計画届出日;
    @CsvField(order = 2430, name = "計画作成日")
    private RString 計画作成日;
    @CsvField(order = 2440, name = "計画変更日")
    private RString 計画変更日;
    @CsvField(order = 2450, name = "変更理由")
