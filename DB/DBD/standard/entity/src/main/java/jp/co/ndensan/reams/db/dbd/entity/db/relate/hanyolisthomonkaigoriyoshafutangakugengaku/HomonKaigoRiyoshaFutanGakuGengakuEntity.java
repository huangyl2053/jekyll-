...
/**
 *
 * 汎用リスト出力(訪問介護利用者負担額減額)のRelateEntityクラスです
 *
...
//    private RString 受給者台帳_みなし要介護区分コード;
    ...
    private RString 訪問介護利用者負担額減額_証記載保険者番号;
    private RString 訪問介護利用者負担額減額_被保険者番号;
    private int 訪問介護利用者負担額減額_履歴番号;
    private RString 訪問介護利用者負担額減額_確認番号;
    private FlexibleDate 訪問介護利用者負担額減額_申請年月日;
    private FlexibleDate 訪問介護利用者負担額減額_決定年月日;
    private RString 訪問介護利用者負担額減額_決定区分;
    private FlexibleDate 訪問介護利用者負担額減額_適用開始年月日;
    private FlexibleDate 訪問介護利用者負担額減額_適用終了年月日;
    private RString 訪問介護利用者負担額減額_給付率;
    private RString 訪問介護利用者負担額減額_法別区分;
    private RString 訪問介護利用者負担額減額_公費受給者番号;
    private RString 訪問介護利用者負担額減額_障害者手帳有無;
    private RString 訪問介護利用者負担額減額_障害者手帳等級;
    private RString 訪問介護利用者負担額減額_障害者手帳番号;
