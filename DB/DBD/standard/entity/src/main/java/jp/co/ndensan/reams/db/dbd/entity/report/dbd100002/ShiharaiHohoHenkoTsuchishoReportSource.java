 ...
 */
package jp.co.ndensan.reams.db.dbd.entity.report.dbd100002;
 ...
 */
public class ShiharaiHohoHenkoTsuchishoReportSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "shimei4", length = 20, order = 55)
...
// <editor-fold defaultstate="collapsed" desc="User Customize Area">
    ...
    @ReportItem(name = "renrakusakiHokaJodanLarge", order = 78)
    public RString renrakusakiHokaJodanLarge;
    @ReportItem(name = "renrakusakiHokaGedanSmall", order = 79)
