...
public class SelectSyuuShadeTaCsvEntity {
    ...
    @CsvField(order = 34, name = "委託先の自動割付名称")
    private RString 委託先の自動割付名称;
    @CsvField(order = 35, name = "委託先の機関の区分")
    private RString 委託先の機関の区分;
    @CsvField(order = 36, name = "認定調査員コード")
    private RString 認定調査員コード;
    @CsvField(order = 37, name = "調査員氏名")
    private RString 調査員氏名;
    @CsvField(order = 38, name = "調査員の調査員氏名カナ")
    private RString 調査員の調査員氏名カナ;
    @CsvField(order = 39, name = "調査員の性別")
    private RString 調査員の性別;
    @CsvField(order = 40, name = "調査員の調査員資格")
    private RString 調査員の調査員資格;
    @CsvField(order = 41, name = "調査員の地区コード")
    private RString 調査員の地区コード;
    @CsvField(order = 42, name = "調査員の調査可能人数月")
    private RString 調査員の調査可能人数月;
    @CsvField(order = 43, name = "調査員の郵便番号")
    private RString 調査員の郵便番号;
    @CsvField(order = 44, name = "調査員の住所")
    private RString 調査員の住所;
    @CsvField(order = 45, name = "調査員の電話番号")
    private RString 調査員の電話番号;
    @CsvField(order = 46, name = "調査員のFAX番号")
    ...
    @CsvField(order = 51, name = "認定調査依頼区分")
    private RString 認定調査依頼区分;
    @CsvField(order = 52, name = "認定調査回数")
    private RString 認定調査回数;
    @CsvField(order = 53, name = "認定調査実施年月日")
    private FlexibleDate 認定調査実施年月日;
    @CsvField(order = 54, name = "認定調査受領年月日")
    private FlexibleDate 認定調査受領年月日;
    @CsvField(order = 55, name = "認定調査区分コード")
    private RString 認定調査区分コード;
    @CsvField(order = 56, name = "認定調査区分")
    private RString 認定調査区分;
    @CsvField(order = 57, name = "認定調査実施場所コード")
    private RString 認定調査実施場所コード;
    @CsvField(order = 58, name = "認定調査実施場所")
    ...
    @CsvField(order = 63, name = "利用施設住所")
    private RString 利用施設住所;
    @CsvField(order = 64, name = "利用施設電話番号")
    private RString 利用施設電話番号;
    @CsvField(order = 65, name = "利用施設郵便番号")
    private RString 利用施設郵便番号;
    @CsvField(order = 66, name = "特記")
    private RString 特記;
    @CsvField(order = 67, name = "認定調査特記事項受付年月日")
    ...
    @CsvField(order = 77, name = "認定調査特記事項連番")
    private RString 認定調査特記事項連番;
    @CsvField(order = 78, name = "原本マスク区分コード")
    private RString 原本マスク区分コード;
    @CsvField(order = 79, name = "原本マスク区分")
    private RString 原本マスク区分;
    @CsvField(order = 80, name = "特記事項")
    private RString 特記事項;
    @CsvField(order = 81, name = "サービスの状況連番")
    private RString サービスの状況連番;
    @CsvField(order = 82, name = "サービスの状況")
    private RString サービスの状況;
    @CsvField(order = 83, name = "サービスの状況フラグ連番")
    private RString サービスの状況フラグ連番;
    @CsvField(order = 84, name = "サービスの状況フラグ")
    private RString サービスの状況フラグ;
    @CsvField(order = 85, name = "記入項目連番")
    private RString 記入項目連番;
    @CsvField(order = 86, name = "サービスの状況記入")
    private RString サービスの状況記入;
    @CsvField(order = 87, name = "施設利用連番")
    ...
    @CsvField(order = 94, name = "調査項目文言")
    private RString 調査項目文言;
    @CsvField(order = 95, name = "内容")
    private RString 内容;
