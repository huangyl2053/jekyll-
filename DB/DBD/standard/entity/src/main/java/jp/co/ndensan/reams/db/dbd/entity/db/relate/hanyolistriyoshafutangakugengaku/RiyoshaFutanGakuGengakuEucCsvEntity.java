...
/**
 *
 * 汎用リスト出力(利用者負担額減免)のCSV用データEntity。
 *
...
public class RiyoshaFutanGakuGengakuEucCsvEntity {
    ...
    @CsvField(order = 2160, name = "利用者負担減免申請日")
    private RString 利用者負担減免申請日;
    @CsvField(order = 2170, name = "利用者負担減免決定日")
    private RString 利用者負担減免決定日;
    @CsvField(order = 2180, name = "利用者負担減免承認区分")
    private RString 利用者負担減免承認区分;
    @CsvField(order = 2190, name = "利用者負担減免開始日")
    private RString 利用者負担減免開始日;
    @CsvField(order = 2200, name = "利用者負担減免終了日")
    private RString 利用者負担減免終了日;
    @CsvField(order = 2210, name = "利用者負担減免給付率")
    private RString 利用者負担減免給付率;
    @CsvField(order = 2220, name = "被保険者番号_総合事業対象者")
    private RString 被保険者番号_総合事業対象者;
    @CsvField(order = 2230, name = "履歴番号")
    private RString 履歴番号;
    @CsvField(order = 2240, name = "事業適用開始日")
    private RString 事業適用開始日;
    @CsvField(order = 2250, name = "事業適用終了日")
    private RString 事業適用終了日;
    @CsvField(order = 2260, name = "事業チェック実施日")
    private RString 事業チェック実施日;
    @CsvField(order = 2270, name = "事業決定日")
    private RString 事業決定日;
    @CsvField(order = 2280, name = "届出区分")
    private RString 届出区分;
    @CsvField(order = 2290, name = "居宅計画作成区分")
    private RString 居宅計画作成区分;
    @CsvField(order = 2300, name = "計画事業者番号")
    private RString 計画事業者番号;
    @CsvField(order = 2310, name = "計画事業者名")
    private RString 計画事業者名;
    @CsvField(order = 2320, name = "計画事業者カナ")
    private RString 計画事業者カナ;
    @CsvField(order = 2330, name = "計画管理者名")
    private RString 計画管理者名;
    @CsvField(order = 2340, name = "計画管理者カナ")
    private RString 計画管理者カナ;
    @CsvField(order = 2350, name = "計画適用開始日")
    private RString 計画適用開始日;
    @CsvField(order = 2360, name = "計画適用終了日")
    private RString 計画適用終了日;
    @CsvField(order = 2370, name = "計画届出日")
    private RString 計画届出日;
    @CsvField(order = 2380, name = "計画作成日")
    private RString 計画作成日;
    @CsvField(order = 2390, name = "計画変更日")
    private RString 計画変更日;
    @CsvField(order = 2400, name = "変更理由")
