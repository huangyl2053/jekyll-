 ...
 */
package jp.co.ndensan.reams.db.dbd.entity.report.dbd550003;
...
/**
 * 要介護度変更通知書のReportSource
 *
 * @reamsid_L DBD-1430-050 b_zhengs
 */
public class YokaigodoHenkoTshuchishoReportSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">

    @ReportItem(name = "tsuchibun5", order = 1)
    public RString tsuchibun5;
    @ReportItem(name = "tsuchibun6", order = 2)
    public RString tsuchibun6;
    @ReportItem(name = "tsuchibun7", order = 3)
    public RString tsuchibun7;
    @ReportItem(name = "tsuchibun8", order = 4)
    public RString tsuchibun8;
    @ReportItem(name = "tsuchibun9", order = 5)
    ...
    @ReportItem(name = "title", length = 18, order = 48)
    public RString title;
    @ReportItem(name = "tsuchibun1", order = 49)
    public RString tsuchibun1;
    @ReportItem(name = "hihokenshaName", order = 50)
    public RString hihokenshaName;
    @ReportItem(name = "hihokenshaNo3", length = 1, order = 51)
    public RString hihokenshaNo3;
    @ReportItem(name = "hihokenshaNo1", length = 1, order = 52)
    @ReportExpandedInfo(id = "A", code = "0003", name = "被保険者番号")
    public RString hihokenshaNo1;
    @ReportItem(name = "hihokenshaNo2", length = 1, order = 53)
    ...
    @ReportItem(name = "kosho1", length = 12, order = 61)
    public RString kosho1;
    @ReportItem(name = "kosho2", length = 12, order = 62)
    public RString kosho2;
    @ReportItem(name = "beforeYokaigoKubun", length = 6, order = 63)
    public RString beforeYokaigoKubun;
    @ReportItem(name = "afterYokaigoKubun", length = 6, order = 64)
    public RString afterYokaigoKubun;
    @ReportItem(name = "henkoYMD", length = 11, order = 65)
    public RString henkoYMD;
    @ReportItem(name = "yukoKaishiYMD", length = 11, order = 66)
    public RString yukoKaishiYMD;
    @ReportItem(name = "yukoShuryoYMD", length = 11, order = 67)
    public RString yukoShuryoYMD;
    @ReportItem(name = "tsuchibun2", order = 68)
    public RString tsuchibun2;
    @ReportItem(name = "kigenKosho", length = 10, order = 69)
    public RString kigenKosho;
    @ReportItem(name = "kigenYMD", length = 11, order = 70)
    public RString kigenYMD;
    @ReportItem(name = "tsuchibun3", order = 71)
    public RString tsuchibun3;
    @ReportItem(name = "tsuchibun4", order = 72)
