...
public class ChosainDataReamsCsvProcessEntity {
    ...
    @CsvField(order = 7, name = "調査員資格")
    private RString 調査員資格;
    @CsvField(order = 8, name = "状況フラグ")
     ...
     * @param 状況フラグ 状況フラグ
     */
    public ChosainDataReamsCsvProcessEntity(
            RString シーケンシャル番号,
