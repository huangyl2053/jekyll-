...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "koinMojiretsu", length = 4, order = 17)
    public RString koinMojiretsu;
    @ReportItem(name = "ninshoshaShimeiKakenai", order = 18)
    public RString ninshoshaShimeiKakenai;
    @ReportItem(name = "ninshoshaShimeiKakeru", order = 19)
    public RString ninshoshaShimeiKakeru;
    @ReportItem(name = "koinShoryaku", length = 15, order = 20)
    public RString koinShoryaku;
    @ReportItem(name = "yubinNo", length = 8, order = 21)
    public RString yubinNo;
    @ReportItem(name = "gyoseiku", length = 14, order = 22)
    public RString gyoseiku;
    @ReportItem(name = "jusho3", length = 20, order = 23)
    public RString jusho3;
    @ReportItem(name = "jushoText", order = 24)
    public RString jushoText;
    @ReportItem(name = "jusho1", length = 20, order = 25)
    public RString jusho1;
    @ReportItem(name = "jusho2", length = 20, order = 26)
    public RString jusho2;
    @ReportItem(name = "katagakiText", order = 27)
    public RString katagakiText;
    @ReportItem(name = "katagaki2", length = 20, order = 28)
    public RString katagaki2;
    @ReportItem(name = "katagakiSmall2", length = 30, order = 29)
    public RString katagakiSmall2;
    @ReportItem(name = "katagaki1", length = 20, order = 30)
    public RString katagaki1;
    @ReportItem(name = "katagakiSmall1", length = 30, order = 31)
    public RString katagakiSmall1;
    @ReportItem(name = "shimei2", length = 20, order = 32)
    ...
    @ReportItem(name = "shimei1", length = 20, order = 38)
    ...
    @ReportItem(name = "renrakusakiHokaJodanSmall", order = 52)
    public RString renrakusakiHokaJodanSmall;
    @ReportItem(name = "renrakusakiHokaGedanLarge", order = 53)
    public RString renrakusakiHokaGedanLarge;
    @ReportItem(name = "renrakusakiHokaLarge", order = 54)
    public RString renrakusakiHokaLarge;
    @ReportItem(name = "renrakusakiHokaJodanLarge", order = 55)
    public RString renrakusakiHokaJodanLarge;
    @ReportItem(name = "renrakusakiHokaGedanSmall", order = 56)
