...
public class HanyoRisutoKokuhoEntity {

    private RString 最新被保台帳_被保険者番号;
    ...
    private RString 最新被保台帳_住所地特例フラグ;
    private RString 最新被保台帳_広域内住所地特例フラグ;
    private RString 最新被保台帳_広住特措置元市町村コード;
    private RString 最新被保台帳_市町村コード;
    ...
    private RString 今回一次判定結果_要介護認定一次判定結果;
...
//    private RString 受給者台帳_みなし要介護区分コード;
    ...
    private FlexibleDate 国保資格情報_喪失日;
    private RString 国保資格情報_登録区分;
    private RString 国保資格情報_識別コード;
    private int 国保資格情報_履歴番号;
