...
public final class DbT4001JukyushaDaichoEntityGenerator {
    ...
    public static final Code DEFAULT_みなし要介護区分コード = new Code("01");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類01 = new ServiceShuruiCode("01");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類02 = new ServiceShuruiCode("02");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類03 = new ServiceShuruiCode("03");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類04 = new ServiceShuruiCode("04");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類05 = new ServiceShuruiCode("05");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類06 = new ServiceShuruiCode("06");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類07 = new ServiceShuruiCode("07");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類08 = new ServiceShuruiCode("08");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類09 = new ServiceShuruiCode("09");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類10 = new ServiceShuruiCode("10");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類11 = new ServiceShuruiCode("11");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類12 = new ServiceShuruiCode("12");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類13 = new ServiceShuruiCode("13");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類14 = new ServiceShuruiCode("14");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類15 = new ServiceShuruiCode("15");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類16 = new ServiceShuruiCode("16");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類17 = new ServiceShuruiCode("17");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類18 = new ServiceShuruiCode("18");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類19 = new ServiceShuruiCode("19");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類20 = new ServiceShuruiCode("20");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類21 = new ServiceShuruiCode("21");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類22 = new ServiceShuruiCode("22");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類23 = new ServiceShuruiCode("23");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類24 = new ServiceShuruiCode("24");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類25 = new ServiceShuruiCode("25");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類26 = new ServiceShuruiCode("26");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類27 = new ServiceShuruiCode("27");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類28 = new ServiceShuruiCode("28");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類29 = new ServiceShuruiCode("29");
    public static final ServiceShuruiCode DEFAULT_指定サービス種類30 = new ServiceShuruiCode("30");
    public static final FlexibleDate DEFAULT_喪失年月日 = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_直近異動年月日 = new FlexibleDate("20141105");
    ...
    public static final FlexibleDate DEFAULT_支給限度有効開始年月日 = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_支給限度有効終了年月日 = new FlexibleDate("20141105");
    public static final int DEFAULT_短期入所支給限度日数 = 180;
    public static final FlexibleDate DEFAULT_短期入所支給限度開始年月日 = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_短期入所支給限度終了年月日 = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_当初認定有効開始年月日 = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_当初認定有効終了年月日 = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_受給資格証明書発行年月日１ = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_受給資格証明書発行年月日２ = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_診断命令書発行年月日 = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_２号申請受理通知書発行年月日 = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_認定結果通知書発行年月日 = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_区分変更通知書発行年月日 = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_サービス変更通知書発行年月日 = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_認定却下通知書発行年月日 = new FlexibleDate("20141105");
    public static final FlexibleDate DEFAULT_認定取消通知書発行年月日 = new FlexibleDate("20141105");
