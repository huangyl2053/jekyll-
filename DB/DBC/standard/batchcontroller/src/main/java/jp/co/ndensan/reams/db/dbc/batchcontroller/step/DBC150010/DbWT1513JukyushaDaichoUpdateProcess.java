 ...
 */
public class DbWT1513JukyushaDaichoUpdateProcess extends BatchProcessBase<DbWT1513RiyoJokyoTokeihyoEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper."
            + "relate.riyojokyotokeihyomeisailistsakusei.IRiyoJokyoTokeihyoMeisaiListSakuseiMapper.select受給者台帳情報");
    ...
    protected void process(DbWT1513RiyoJokyoTokeihyoEntity entity) {
        if (!(DonyuKeitaiCode.toValue(parameter.get導入形態コード()).is単一()
            ...
            entity.setShoriShichosonCode(RString.EMPTY);
        }
