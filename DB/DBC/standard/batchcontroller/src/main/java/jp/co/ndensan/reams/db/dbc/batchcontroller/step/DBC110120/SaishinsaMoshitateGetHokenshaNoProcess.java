 ...
 */
public class SaishinsaMoshitateGetHokenshaNoProcess extends BatchProcessBase<SaishinsaMoshitateGetHokenshaNoEntity> {
    ...
    @Override
    protected void process(SaishinsaMoshitateGetHokenshaNoEntity entity) {
