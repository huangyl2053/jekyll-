...
/**
 * 介護給付費再審査申立書情報作成・サービス名称エラー登録を実行する。
 *
 * @reamsid_L DBC-2540-030 liuhui
 */
public class SaishinsaMoshitateDoServiceNameErrTourokuProcess extends BatchProcessBase<DbWT1741SaishinsaMoshitateEntity> {

    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "saishinsamoshitateshoout.ISaishinsaMoshitateshoOutJohoMapper.selectサービス名称エラーデータ関連リスト");
