...
/**
 * 給付更新結果情報取込・マスタ登録・D8を実行する。
 *
 * @reamsid_L DBC-2440-010 zhangrui
 */
public class KyufuJissekiInMasterTorokuD8Process extends BatchProcessBase<DbT3028KyufujissekiKogakuKaigoServicehiEntity> {

    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "kyufujissekiin.IKyufuJissekiInMasterTorokuMapper.getマスタ登録データD8");
    @BatchWriter
    private BatchPermanentTableWriter 給付実績高額介護サービス費tableWriter;
    ...
    protected void process(DbT3028KyufujissekiKogakuKaigoServicehiEntity entity) {
        ...
        給付実績高額介護サービス費tableWriter.insert(entity);
    }
