...
/**
 * 保険者保有給付実績情報作成の福祉用具販売費データの取得Processです。
 *
 * @reamsid_L DBC-2460-010 gongliang
 */
public class InsFukushiYoguTempProcess extends BatchProcessBase<DbWT1111KyufuJissekiTempTempEntity> {
    ...
    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.hokenshakyufujisseki."
            + "IHokenshaKyufujissekiMapper.get福祉用具販売費");
    private static final RString データ区分 = new RString("08");
