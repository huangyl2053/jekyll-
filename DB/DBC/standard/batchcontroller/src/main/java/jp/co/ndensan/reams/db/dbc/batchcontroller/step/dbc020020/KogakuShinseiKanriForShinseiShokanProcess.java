...
/**
 * 高額申請管理のマスタテーブルから、申請償還情報の取得処理です。
 *
 * @reamsid_L DBC-4770-030 zhujun
 */
public class KogakuShinseiKanriForShinseiShokanProcess extends BatchProcessBase<KogakuKaigoServiceHiRelateEntity> {

    private static final RString MYBATIS_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "kogakukaigoservicehikyufuoshirasetsuchisho.IKogakuKaigoServicehiOshiraseHakkoMapper.get自動償還対象For高額介護サービス費");
    ...
    protected void process(KogakuKaigoServiceHiRelateEntity entity) {
        ...
        tmpEntity.setHanteiKekkaShikyuKubunCodeShokan(entity.get支給判定結果().getShikyuKubunCode());
        tmpEntity.setShikyuKingakuShokan(entity.get支給判定結果().getShikyuKingaku());
        ...
        tmpEntity.setGokeiKogakuShikyuGakuShokan(entity.get給付対象者合計().getKogakuShikyuGaku());
        ...
        tmpEntity.setKogakuKyufuKonkyoShokan(entity.get給付対象者明細().getKogakuKyufuKonkyo());
        ...
        tmpEntity.setKetteiKogakuShikyuGakuShokan(entity.get支給審査決定().getKogakuShikyuGaku());
