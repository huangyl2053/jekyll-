...
public class KogakuGassanJikofutangakuDoMasterTorokuMeisaiUpdateProcess
        extends BatchProcessBase<KogakuGassanJikofutangakuMeisaiMasterTorokuEntity> {
    ...
    @Override
    protected void process(KogakuGassanJikofutangakuMeisaiMasterTorokuEntity entity) {
        DbWT37H2KogakuGassanaJikofutangakuMeisaiCsvEntity 一時明細entity = entity.get高額合算自己負担額一時明細entity();
        DbT3071KogakuGassanJikoFutanGakuMeisaiCsvEntity 明細entity = entity.get高額合算自己負担額明細entity();
        this.do明細データ更新(明細entity, 一時明細entity);
    }

    private void do明細データ更新(DbT3071KogakuGassanJikoFutanGakuMeisaiCsvEntity 明細entity,
            DbWT37H2KogakuGassanaJikofutangakuMeisaiCsvEntity 一時明細entity) {
        ...
        updateEntity.setJikoFutanGaku(一時明細entity.get自己負担額());
        updateEntity.setUchisu_70_74JikoFutanGaku(一時明細entity.get自己負担額_内数70_74());
        updateEntity.setUnder_70KogakuShikyuGaku(一時明細entity.get未満70高額支給額());
        updateEntity.setOver_70_74KogakuShikyuGaku(一時明細entity.get高額支給額70_74());
        updateEntity.setTekiyo(一時明細entity.get摘要());
