...
import jp.co.ndensan.reams.db.dbc.business.core.dbc020080.KogakuShikyugakuJoho;
...
public class CalcKogakuShikyugakuProcess extends BatchProcessBase<CalcKogakuShikyugakuRelateEntity> {
    ...
    private static final RString PATH = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "dbc020080.IJigyobunKogakuGassanJikofutangakuKeisanMapper.get高額支給額集計");
    ...
    private void beforeUpdate() {
        ...
        DBC020080ShoriKekkaTempEntity errorEntity = util.toShoriKekkaTempEntity(updEntity, KaigoGassan_ErrorKubun.高額支給額集計エラー);
