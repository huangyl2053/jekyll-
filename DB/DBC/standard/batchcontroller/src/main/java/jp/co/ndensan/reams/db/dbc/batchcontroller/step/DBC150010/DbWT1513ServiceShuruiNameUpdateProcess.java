 ...
 */
public class DbWT1513ServiceShuruiNameUpdateProcess extends BatchProcessBase<DbWT1513RiyoJokyoTokeihyoEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper."
            + "relate.riyojokyotokeihyomeisailistsakusei.IRiyoJokyoTokeihyoMeisaiListSakuseiMapper.selectサービス種類名");
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(MYBATIS_SELECT_ID, new CreateRiyojokyoMybatisParameter());
    }
