 ...
 */
public class DelKogakuGassanKetteiProcess extends BatchProcessBase<DbT3074KogakuGassanShikyuFushikyuKetteiEntity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.dbc050021."
            + "IFurikomimeisaiFurikomiDataMapper.get依頼済の取消_高額合算");
    ...
    protected void process(DbT3074KogakuGassanShikyuFushikyuKetteiEntity entity) {
        entity.setFurikomiTsuchiSakuseiYMD(FlexibleDate.EMPTY);
