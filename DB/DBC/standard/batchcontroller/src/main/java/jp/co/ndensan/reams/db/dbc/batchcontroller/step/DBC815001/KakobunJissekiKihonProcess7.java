 ...
 */
public class KakobunJissekiKihonProcess7 extends BatchProcessBase<HihokenshaNoFukaEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper."
            + "relate.kogakukaigotaishoshachushutsusokyubun.IKogakuKaigoTaishoshaChushutsuSokyubunMapper.get被保険者番号付加");
    ...
    protected void afterExecute() {
        ...
        List<HihokenshaNoFukaEntity> hihokenlist = sokyubun.getKakobunJissekiKihon7(business.getHihokensha());
