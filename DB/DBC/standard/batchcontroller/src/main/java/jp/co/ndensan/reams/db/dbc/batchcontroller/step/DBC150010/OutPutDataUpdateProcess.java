 ...
 */
public class OutPutDataUpdateProcess extends BatchProcessBase<DbWT1510KyufuJissekiKihonEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper."
            + "relate.riyojokyotokeihyomeisailistsakusei.IRiyoJokyoTokeihyoMeisaiListSakuseiMapper.select出力対象データ");
    ...
    protected void process(DbWT1510KyufuJissekiKihonEntity entity) {
        entity.setShutsuryokuFlag(true);
