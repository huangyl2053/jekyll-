 ...
 */
public class JigyoKogakuServiceHiOshiraseTsuchishoKigenAriOutputProcess extends BatchProcessBase<ShinseiJohoChohyoTempRelateEntity> {
    ...
    @BatchWriter
    private BatchReportWriter<KogakuJigyoOshiraseTsuchishoKigenAriSource> 通常分BatchReportWriter;
    private ReportSourceWriter<KogakuJigyoOshiraseTsuchishoKigenAriSource> 通常分ReportSourceWriter;
    @BatchWriter
    private BatchReportWriter<KogakuJigyoOshiraseTsuchishoKigenAriSource> 自動償還分BatchReportWriter;
    private ReportSourceWriter<KogakuJigyoOshiraseTsuchishoKigenAriSource> 自動償還分ReportSourceWriter;
    ...
    protected void createWriter() {
        通常分BatchReportWriter = BatchReportFactory.createBatchReportWriter(ReportIdDBC.DBC100072.getReportId().value()).create();
        通常分ReportSourceWriter = new ReportSourceWriter<>(通常分BatchReportWriter);

        自動償還分BatchReportWriter = BatchReportFactory.createBatchReportWriter(ReportIdDBC.DBC100072.getReportId().value()).create();
