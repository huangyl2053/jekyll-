...
/**
 * 事業高額合算・事業分自己負担額計算結果一覧表出力順設定可能項目です。
 *
 * @reamsid_L DBC-4790-030 pengxingyi
 */
public enum DBC200203GassanJigyobunJikofutangakuKeisanKekkaIchiranOutputOrder implements IReportItems {
    ...
    private DBC200203GassanJigyobunJikofutangakuKeisanKekkaIchiranOutputOrder(
