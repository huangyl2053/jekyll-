...
public class DBC120050_KyufuJissekiIn extends BatchFlowBase<DBC120050_KyufuJissekiInParameter> {
    ...
    private static final String DB登録 = "DBLogin";
...
//                        ReadCsvFileProcess.PARAMETER_OUT_FLOWENTITY);
//                if (null != flowEntity) {
...
//     */
//    @Step(DB登録)
//    protected IBatchFlowCommand callDBLoginProcess() {
//        return loopBatch(DBLoginProcess.class).define();
//    }
    /**
     * 被保険者関連処理です。
     *
