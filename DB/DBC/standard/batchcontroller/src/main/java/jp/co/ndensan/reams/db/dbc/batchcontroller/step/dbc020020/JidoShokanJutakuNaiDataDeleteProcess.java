...
/**
 * 自動償還、受託ないの申請情報償還一時データを削除する処理クラスです。
 *
 * @reamsid_L DBC-4770-030 zhujun
 */
public class JidoShokanJutakuNaiDataDeleteProcess extends BatchProcessBase<ShinseiJohoShokanTempEntity> {

    private static final RString MYBATIS_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "kogakukaigoservicehikyufuoshirasetsuchisho.IKogakuKaigoServicehiOshiraseHakkoMapper.get自動償還For受託ないの申請情報償還一時");
