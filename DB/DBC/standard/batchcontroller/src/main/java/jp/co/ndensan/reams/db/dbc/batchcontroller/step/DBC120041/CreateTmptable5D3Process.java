...
import jp.co.ndensan.reams.db.dbc.entity.db.relate.kyodojukyushainsub.KyoudouShori5D3CsvEntity;
 ...
 */
public class CreateTmptable5D3Process extends BatchProcessBase<KyoudouShori5D3CsvEntity> {
    ...
    protected IBatchReader createReader() {
        ...
        CsvReader csvReader = new CsvReader.InstanceBuilder(filePath, KyoudouShori5D3CsvEntity.class)
    ...
    @Override
    protected void process(KyoudouShori5D3CsvEntity csvEntity) {
    ...
    private DbWT5C32ShoukanKyoudouShoriEntity getDbWT5C32Entity(KyoudouShori5D3CsvEntity csvEntity) {
