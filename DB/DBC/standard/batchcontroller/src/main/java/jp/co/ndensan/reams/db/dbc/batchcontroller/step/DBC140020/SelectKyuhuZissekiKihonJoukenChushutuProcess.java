...
public class SelectKyuhuZissekiKihonJoukenChushutuProcess extends BatchProcessBase<JukyushaKyufujissekiIchiranRelateEntity> {
    ...
    private static final RString 受給者給付実績 = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.jukyushakyufujissekiichiran."
            + "IJukyushaKyufujissekiIchiranMapper.get受給者給付実績");
    ...
    protected IBatchReader createReader() {
        ...
        return new BatchDbReader(受給者給付実績, processParamter.toJukyushaKyufujissekiIchiranMybatisParameter());
    }
