...
/**
 * 給付更新結果情報取込・マスタ登録・T1を実行する。
 *
 * @reamsid_L DBC-2440-010 zhangrui
 */
public class KyufuJissekiInMasterTorokuT1Process extends BatchProcessBase<DbT3033KyufujissekiShukeiEntity> {

    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "kyufujissekiin.IKyufuJissekiInMasterTorokuMapper.getマスタ登録データT1");
    @BatchWriter
    private BatchPermanentTableWriter 給付実績集計tableWriter;
    ...
    protected void createWriter() {
        給付実績集計tableWriter
                = new BatchPermanentTableWriter(DbT3033KyufujissekiShukeiEntity.class);
    }
    ...
    protected void process(DbT3033KyufujissekiShukeiEntity entity) {
        ...
        給付実績集計tableWriter.insert(entity);
    }
