 ...
 */
public class InsKyufuJissekiKihonKogakuTmpProcess3 extends BatchProcessBase<DbT3017KyufujissekiKihonEntity> {
    ...
    private static final RString 給付実績基本情報高額一時 = new RString("jp.co.ndensan.reams.db.dbc.persistence.db."
            ...
            + "get給付実績基本情報高額一時3リスト");
    private static final RString 給付実績基本情報高額一時3 = new RString("TempKyufujissekiKihon3");
    private static final int INDEX_2 = 2;

    @BatchWriter
    private BatchEntityCreatedTempTableWriter 一時給付実績基本情報高額一時3;
    ...
    protected void createWriter() {
        一時給付実績基本情報高額一時3 = new BatchEntityCreatedTempTableWriter(給付実績基本情報高額一時3,
