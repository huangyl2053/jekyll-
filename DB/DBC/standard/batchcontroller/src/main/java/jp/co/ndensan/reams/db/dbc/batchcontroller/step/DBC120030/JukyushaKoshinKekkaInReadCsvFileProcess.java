 ...
 */
public class JukyushaKoshinKekkaInReadCsvFileProcess extends BatchProcessBase<List<RString>> {
    ...
    private void 受給者情報明細一時TBLに登録() {
        ...
        受給者一時entity.setIdoYmd(toDate(受給者情報.getIdoYmd()));
        受給者一時entity.setIdoKubunCode(受給者情報.getIdoKubunCode());
        受給者一時entity.setTeiseiYmd(toDate(受給者情報.getTeiseiYmd()));
        受給者一時entity.setTeiseiKubunCode(受給者情報.getTeiseiKubunCode());
        受給者一時entity.setIdoJiyuKubun(受給者情報.getIdoJiyuKubun());
        受給者一時entity.setSeinengappiYmd(toDate(受給者情報.getSeinengappiYmd()));
        受給者一時entity.setSeibetsuCode(受給者情報.getSeibetsuCode());
        受給者一時entity.setShikakuShutokuYmd(toDate(受給者情報.getShikakuShutokuYmd()));
        受給者一時entity.setShikakuSoshitsuYmd(toDate(受給者情報.getShikakuSoshitsuYmd()));
        ...
        受給者一時entity.setShinseiYmd(toDate(受給者情報.getShinseiYmd()));
        受給者一時entity.setYokaigoJotaiKubunCode(受給者情報.getYokaigoJotaiKubunCode());
        受給者一時entity.setNinteiYukokikanFromYmd(toDate(受給者情報.getNinteiYukokikanFromYmd()));
        受給者一時entity.setNinteiYukokikanToYmd(toDate(受給者情報.getNinteiYukokikanToYmd()));
        ...
        受給者一時entity.setKyotakuServiceTekiyoFromYmd(toDate(受給者情報.getKyotakuServiceTekiyoFromYmd()));
        受給者一時entity.setKyotakuServiceTekiyoToYmd(toDate(受給者情報.getKyotakuServiceTekiyoToYmd()));
        受給者一時entity.setHomonShikyugendoKijungaku(toDecimal(受給者情報.getHomonShikyugendoKijungaku()));
        受給者一時entity.setHomonJogenKanriTekiyoKikanFromYmd(toDate(受給者情報.getHomonJogenKanriTekiyoKikanFromYmd()));
        受給者一時entity.setHomonJogenKanriTekiyoKikanToYmd(toDate(受給者情報.getHomonJogenKanriTekiyoKikanToYmd()));
        受給者一時entity.setTankiShikyugendoKijungaku(toDecimal(受給者情報.getTankiShikyugendoKijungaku()));
        受給者一時entity.setTankiJogenKanriTekiyoKikanFromYmd(toDate(受給者情報.getTankiJogenKanriTekiyoKikanFromYmd()));
        受給者一時entity.setTankiJogenKanriTekiyoKikanToYmd(toDate(受給者情報.getTankiJogenKanriTekiyoKikanToYmd()));
        受給者一時entity.setKohiFutanJogengakuGengakuUmu(受給者情報.getKohiFutanJogengakuGengakuUmu());
        受給者一時entity.setShokanHaraikaFromYmd(toDate(受給者情報.getShokanHaraikaFromYmd()));
        受給者一時entity.setShokanHaraikaToYmd(toDate(受給者情報.getShokanHaraikaToYmd()));
        受給者一時entity.setKyufuritsuHikisageFromYmd(toDate(受給者情報.getKyufuritsuHikisageFromYmd()));
        受給者一時entity.setKyufuritsuHikisageToYmd(toDate(受給者情報.getKyufuritsuHikisageToYmd()));
        ...
        受給者一時entity.setKyufuRitsu(toDecimal(受給者情報.getKyufuRitsu()));
        受給者一時entity.setRiyoshaFutanTekiyoFromYmd(toDate(受給者情報.getRiyoshaFutanTekiyoFromYmd()));
        受給者一時entity.setRiyoshaFutanTekiyoToYmd(toDate(受給者情報.getRiyoshaFutanTekiyoToYmd()));
        受給者一時entity.setHyojunFutanKubunCode(受給者情報.getHyojunFutanKubunCode());
        受給者一時entity.setFutanGaku(toDecimal(受給者情報.getFutanGaku()));
        受給者一時entity.setFutanGakuTekiyoFromYmd(toDate(受給者情報.getFutanGakuTekiyoFromYmd()));
        受給者一時entity.setFutanGakuTekiyoToYmd(toDate(受給者情報.getFutanGakuTekiyoToYmd()));
        ...
        受給者一時entity.setTokuteiNyushoshaShokuhiFutanGendoGaku(toDecimal(受給者情報.getTokuteiNyushoshaShokuhiFutanGendoGaku()));
        受給者一時entity.setKyojuhiUnitKoshitsuFutanGendoGaku(toDecimal(受給者情報.getKyojuhiUnitKoshitsuFutanGendoGaku()));
        受給者一時entity.setKyojuhiUnitJunkoshitsuFutanGendoGaku(toDecimal(受給者情報.getKyojuhiUnitJunkoshitsuFutanGendoGaku()));
        受給者一時entity.setKyojuhiTokuyotoFutanGenndoGaku(toDecimal(受給者情報.getKyojuhiTokuyotoFutanGenndoGaku()));
        受給者一時entity.setKyojuhiRokenRyoyotoFutanGendoGaku(toDecimal(受給者情報.getKyojuhiRokenRyoyotoFutanGendoGaku()));
        受給者一時entity.setKyojuhiTashoShitsuFutanGendoGaku(toDecimal(受給者情報.getKyojuhiTashoShitsuFutanGendoGaku()));
        受給者一時entity.setFutanGendoGakuTekiyoFromYmd(toDate(受給者情報.getFutanGendoGakuTekiyoFromYmd()));
        受給者一時entity.setFutanGendoGakuTekiyoToYmd(toDate(受給者情報.getFutanGendoGakuTekiyoToYmd()));
        受給者一時entity.setKeigenRitsu(toDecimal(受給者情報.getKeigenRitsu()));
        受給者一時entity.setKeigenRitsuTekiyoFromYmd(toDate(受給者情報.getKeigenRitsuTekiyoFromYmd()));
        受給者一時entity.setKeigenRitsuTekiyoToYmd(toDate(受給者情報.getKeigenRitsuTekiyoToYmd()));
        ...
        受給者一時entity.setNijiyoboJigyoYukokikanFromYmd(toDate(受給者情報.getNijiyoboJigyoYukokikanFromYmd()));
        受給者一時entity.setNijiyoboJigyoYukokikanToYmd(toDate(受給者情報.getNijiyoboJigyoYukokikanToYmd()));
        ...
        受給者一時entity.setJushochiTokureiTekiyoFromYmd(toDate(受給者情報.getJushochiTokureiTekiyoFromYmd()));
        受給者一時entity.setJushochiTokureiTekiyoToYmd(toDate(受給者情報.getJushochiTokureiTekiyoToYmd()));
        受給者一時entity.setKyojuhi1FutanGendogaku(toDecimal(受給者情報.getKyojuhi1FutanGendogaku()));
        受給者一時entity.setKyojuhi2FutanGendogaku(toDecimal(受給者情報.getKyojuhi2FutanGendogaku()));
        受給者一時entity.setKyojuhi3FutanGendogaku(toDecimal(受給者情報.getKyojuhi3FutanGendogaku()));
        受給者一時entity.setNiwariFutanTekiyoFromYmd(toDate(受給者情報.getNiwariFutanTekiyoFromYmd()));
        受給者一時entity.setNiwariFutanTekiyoToYmd(toDate(受給者情報.getNiwariFutanTekiyoToYmd()));
    ...
    private void 被保険者一時TBLに登録() {
        ...
        被保険者一時entity.setServiceTeikyoYmd(toDate(受給者情報.getIdoYmd()));
    ...
    private FlexibleDate toDate(RString dateStr) {
        if (RString.isNullOrEmpty(dateStr)) {
            return null;
        }
        return new FlexibleDate(dateStr);
    }

    private Decimal toDecimal(RString decimalStr) {
        if (RString.isNullOrEmpty(decimalStr)) {
            return null;
        }
