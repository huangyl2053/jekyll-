...
/**
 * 給付更新結果情報取込・マスタ登録・D4を実行する。
 *
 * @reamsid_L DBC-2440-010 zhangrui
 */
public class KyufuJissekiInMasterTorokuD4Process extends BatchProcessBase<DbT3022KyufujissekiShokujiHiyoEntity> {

    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "kyufujissekiin.IKyufuJissekiInMasterTorokuMapper.getマスタ登録データD4");
    @BatchWriter
    private BatchPermanentTableWriter 給付実績食事費用tableWriter;
    ...
    protected void createWriter() {
        給付実績食事費用tableWriter
                = new BatchPermanentTableWriter(DbT3022KyufujissekiShokujiHiyoEntity.class);
    }
    ...
    @Override
    protected void process(DbT3022KyufujissekiShokujiHiyoEntity entity) {
        ...
        給付実績食事費用tableWriter.insert(entity);
    }
