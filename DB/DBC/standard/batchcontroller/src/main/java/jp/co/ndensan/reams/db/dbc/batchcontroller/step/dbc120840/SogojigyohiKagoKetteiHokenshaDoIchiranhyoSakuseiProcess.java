...
import jp.co.ndensan.reams.db.dbc.business.report.dbc120840.SogojigyohiKagoKetteiHokenshaInPageBreak;
import jp.co.ndensan.reams.db.dbc.business.report.dbc120840.SogojigyohiKagoKetteiHokenshaInReport;
...
import jp.co.ndensan.reams.db.dbc.entity.db.relate.dbc120840.SogojigyohiKagoKetteiHokenshaIchiranCSVEntity;
...
public class SogojigyohiKagoKetteiHokenshaDoIchiranhyoSakuseiProcess extends BatchKeyBreakBase<SogojigyohiKagoKetteiHokenshaChohyoEntity> {
    ...
    private static final EucEntityId EUC_ENTITY_ID = new EucEntityId("DBC200085");
    private RString eucFilePath;
    private static final RString 出力ファイル名
            = new RString("DBC200085_SogojigyohiKagoKetteiTsuchishoTorikomiIchiran.csv");
    ...
    @BatchWriter
    private BatchReportWriter<SogojigyohiKagoKetteiTorikomiIchiranSource> batchReportWriter;
    private ReportSourceWriter<SogojigyohiKagoKetteiTorikomiIchiranSource> reportSourceWriter;
    private CsvWriter<SogojigyohiKagoKetteiHokenshaIchiranCSVEntity> sogojigyohiKagoKetteiInCsvWriter;
    ...
    protected void initialize() {
        ...
        pageBreakKeys.add(new RString(SogojigyohiKagoKetteiTorikomiIchiranSource.ReportSourceFields.shoKisaiHokenshaNo.name()));

    }

    @Override
    protected void createWriter() {
        PageBreaker<SogojigyohiKagoKetteiTorikomiIchiranSource> breaker = new SogojigyohiKagoKetteiHokenshaInPageBreak(pageBreakKeys);
        batchReportWriter = BatchReportFactory.createBatchReportWriter(ReportIdDBC.DBC200085.getReportId().value()).addBreak(breaker).create();
    ...
    @Override
    protected void keyBreakProcess(SogojigyohiKagoKetteiHokenshaChohyoEntity entity) {
    }

    @Override
    protected void usualProcess(SogojigyohiKagoKetteiHokenshaChohyoEntity entity) {
