...
import jp.co.ndensan.reams.db.dbc.definition.processprm.dbc040010.UpdJikofutangakuChukanTempProcessParameter;
...
public class UpdJikofutangakuChukanTempProcess extends BatchProcessBase<JissekiFutangakuDataTempEntity> {
    ...
    private static final RString PATH = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "dbc040010.IKogakuGassanJikofutangakuKeisanMapper.get実績負担額データ");
