 ...
 */
public class ShokanFushikyuKetteiDoDBTorokuProcess extends SimpleBatchProcessBase {

    private static final RString 支給不支給区分_不支給 = new RString("2");
    ...
    protected void process() {
        ...
        manager.checkDataAndDbRegister(parameter.get処理年月(), parameter.get再処理区分().getコード(), 支給不支給区分_不支給);
    }
