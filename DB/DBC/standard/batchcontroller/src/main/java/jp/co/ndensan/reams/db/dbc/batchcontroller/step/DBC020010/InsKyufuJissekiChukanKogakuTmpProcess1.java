...
/**
 *
 * 給付実績中間高額一時の作成１のProcessフロークラスです。
 *
 * @reamsid_L DBC-2010-040 tianshuai
 */
public class InsKyufuJissekiChukanKogakuTmpProcess1 extends BatchProcessBase<KyufujissekiTyukannInsertEntity> {
    ...
    private static final RString ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            ...
            + "select給付実績中間高額一時の作成１");
    private static final RString TABLE_給付実績中間高額一時１ = new RString("TempKyufujissekiTyukann1");
    ...
    protected void createWriter() {
        kyufujissekiTyukannWriter = new BatchEntityCreatedTempTableWriter(
                TABLE_給付実績中間高額一時１, TempKyufujissekiTyukannEntity.class);
    }
