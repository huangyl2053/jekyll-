...
/**
 * 介護給付費再審査申立書情報作成・サービス種類名称取得を実行する。
 *
 * @reamsid_L DBC-2540-030 liuhui
 */
public class SaishinsaMoshitateGetServiceTeikyoShuruiNameProcess extends BatchProcessBase<SaishinsaMoshitateMeisyoKanrenEntity> {

    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "saishinsamoshitateshoout.ISaishinsaMoshitateshoOutJohoMapper.selectサービス種類名称関連リスト");
    @BatchWriter
    ...
    protected void process(SaishinsaMoshitateMeisyoKanrenEntity entity) {
        ...
        DbT7130KaigoServiceShuruiEntity 介護サービス種類 = entity.get介護サービス種類();
        if (null != 介護サービス種類) {
            再審査申立.setServiceMeisho(介護サービス種類.getServiceShuruiMeisho());
