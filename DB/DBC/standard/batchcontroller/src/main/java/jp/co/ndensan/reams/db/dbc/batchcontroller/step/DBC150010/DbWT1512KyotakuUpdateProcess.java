...
/**
 * 居宅サービス計画データの取得のプロセスです。
 *
 * @reamsid_L DBC-3500-030 zuotao
 */
public class DbWT1512KyotakuUpdateProcess extends BatchProcessBase<DbWT1512JukyushaDaichoEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper."
            + "relate.riyojokyotokeihyomeisailistsakusei.IRiyoJokyoTokeihyoMeisaiListSakuseiMapper.select居宅サービス計画データ");
