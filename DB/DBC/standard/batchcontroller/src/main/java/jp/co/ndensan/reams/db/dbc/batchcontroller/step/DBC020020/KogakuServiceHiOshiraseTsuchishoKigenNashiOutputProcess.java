...
public class KogakuServiceHiOshiraseTsuchishoKigenNashiOutputProcess extends BatchProcessBase<ShinseiJohoChohyoTempRelateEntity> {
    ...
    @BatchWriter
    private BatchReportWriter<KogakuOshiraseTsuchiTeshutsuKigenNashiSource> batchReportWriter;
    private ReportSourceWriter<KogakuOshiraseTsuchiTeshutsuKigenNashiSource> reportSourceWriter;
    ...
    protected void createWriter() {
        batchReportWriter = BatchReportFactory.createBatchReportWriter(ReportIdDBC.DBC100012_Nashi.getReportId().value()).create();
