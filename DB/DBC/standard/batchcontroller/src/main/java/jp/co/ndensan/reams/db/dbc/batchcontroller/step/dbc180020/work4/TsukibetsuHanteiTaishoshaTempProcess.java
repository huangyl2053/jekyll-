...
/**
 * TsukibetsuHanteiTaishoshaTempProcessのクラスです。
 *
 * @reamsid_L DBC-4950-030 liuyang
 */
public class TsukibetsuHanteiTaishoshaTempProcess extends BatchProcessBase<TsukibetsuHanteiTaishoshaDaichoEntity> {
    ...
    private static final RString PATH = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "riyoshafutanwariaihantei.IRiyoshaFutanwariaiMapper.select月別判定対象者作成");
    ...
    protected void createWriter() {
        ...
        被保険者番号Temp = new BatchEntityCreatedTempTableWriter(TABLENAME被保険者番号, HihokenshaNoEntity.class);
    }
    ...
    protected void process(TsukibetsuHanteiTaishoshaDaichoEntity entity) {
        if (entity.get被保険者台帳().isEmpty()) {
            被保険者番号Temp.insert(new HihokenshaNoEntity(entity.get被保険者番号(), entity.get異動種別()));
            return;
        }
