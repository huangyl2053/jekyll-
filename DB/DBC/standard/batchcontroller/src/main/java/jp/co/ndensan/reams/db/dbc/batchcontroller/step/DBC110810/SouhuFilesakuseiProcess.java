...
public class SouhuFilesakuseiProcess extends BatchProcessBase<DbT3001JukyushaIdoRenrakuhyoEntity> {
    ...
    private SouhuFilesakuseiEntity getData(
        ...
        record2Entity.set異動年月日(new RString(entity.getIdoYMD().toString()));
        record2Entity.set異動区分コード(entity.getIdoKubunCode());
        record2Entity.set異動事由(entity.getJukyushaIdoJiyu());
        record2Entity.set証記載保険者番号(entity.getShoKisaiHokenshaNo().value());
        record2Entity.set被保険者番号(entity.getHiHokenshaNo().value());
        record2Entity.set被保険者氏名カナ(entity.getHiHokenshaNameKana());
        record2Entity.set生年月日(new RString(entity.getUmareYMD().toString()));
        record2Entity.set性別コード(entity.getSeibetsuCode());
        record2Entity.set資格取得年月日(new RString(entity.getShikakuShutokuYMD().toString()));
        record2Entity.set資格喪失年月日(change(entity.getShikakuSoshitsuYMD()));
        record2Entity.set老人保健市町村番号(entity.getRojinHokenShichosonNo());
        record2Entity.set老人保健受給者番号(entity.getRojinHokenJukyushaNo());
        record2Entity.set公費負担者番号(entity.getKohiFutanshaNo());
        record2Entity.set広域連合保険者番号(changeValue(entity.getKoikiRengoHokenshaNo()));
        record2Entity.set申請種別コード(entity.getShinseiShubetsuCode());
        record2Entity.set変更申請中区分コード(entity.getHenkoShinseichuKubunCode());
        record2Entity.set申請年月日(change(entity.getShinseiYMD()));
        record2Entity.setみなし要介護区分コード(entity.getMinashiYokaigoJotaiKubunCode());
        record2Entity.set要介護状態区分コード(entity.getYokaigoJotaiKubunCode());
        record2Entity.set認定有効期間開始年月日(change(entity.getNinteiYukoKikankaishiYMD()));
        record2Entity.set認定有効期間終了年月日(entity.getNinteiYukoKikanShuryoYMD());
        record2Entity.set居宅サービス計画作成区分コード(entity.getKyotakuServiceSakuseiKubunCode());
        record2Entity.set居宅介護支援事業所番号(entity.getKyotakuKaigoShienJigyoshoNo());
        record2Entity.set居宅サービス計画適用開始年月日(entity.getKyotakuServiceTekiyoKaishiYMD());
        record2Entity.set居宅サービス計画適用終了年月日(entity.getKyotakuServiceTekiyoShuryoYMD());
        record2Entity.set訪問支給限度基準額(new RString(entity.getHomonTsushoServiceShikyuGendoKijungaku()));
        record2Entity.set訪問開始年月日(change(entity.getHomonTsushoServiceJogenKanriTekiyoKaishiYMD()));
        record2Entity.set訪問終了年月日(entity.getHomonTsushoServiceJogenKanriTekiyoShuryoYMD());
        record2Entity.set短期支給限度基準額(new RString(entity.getTankiNyushoServiceShikyuGendoKijungaku()));
        ...
        record2Entity.set償還払化開始年月日(entity.getShokanbaraikaKaishiYMD());
        record2Entity.set償還払化終了年月日(entity.getShokanbaraikaShuryoYMD());
        record2Entity.set給付率引下げ開始年月日(entity.getKyufuritsuHikisageKaishiYMD());
        record2Entity.set給付率引下げ終了年月日(entity.getKyufuritsuHikisageShuryoYMD());
        record2Entity.set減免申請中区分コード(entity.getGemmenShinseichuKubunCode());
        record2Entity.set利用者負担区分コード(entity.getRiyoshaFutanKubunCode());
        record2Entity.set給付率(entity.getKyufuritsu());
        record2Entity.set適用開始年月日(entity.getTekiyoKaishiYMD());
        record2Entity.set適用終了年月日(entity.getTekiyoShuryoYMD());
        record2Entity.set標準負担区分コード(entity.getHyojunFutanKubunCode());
        record2Entity.set負担額(entity.getFutangaku());
        record2Entity.set負担額適用開始年月日(entity.getFutangakuTekiyoKaishiYMD());
        record2Entity.set負担額適用終了年月日(entity.getFutangakuTekiyoShuryoYMD());
        record2Entity.set特定入所者認定申請中区分コード(entity.getTokuteiNyushoshaNinteiShinseichuKubunCode());
        record2Entity.set特定入所者介護サービス区分コード(entity.getTokuteiNyushoshaKaigoServiceKubunCode());
        record2Entity.set課税層の特例減額措置対象(entity.getKaizeisoTokureiGengakuSochiTaishoFlag());
        record2Entity.set食費負担限度額(entity.getShokuhiFutanGendogaku());
        record2Entity.set居住費個室負担限度額(entity.getKyojuhiUnitGataKoshitsuFutanGendogaku());
        record2Entity.set居住費準個室負担限度額(entity.getKyojuhiUnitGataJunKoshitsuFutanGendogaku());
        record2Entity.set居住費特養負担限度額(entity.getKyojuhiJuraiGataKoshitsuTokuyoFutanGendogaku());
        record2Entity.set居住費従来型個室負担限度額(entity.getKyojuhiJuraiGataKoshitsuRokenRyoyoFutanGendogaku());
        record2Entity.set居住費多床室負担限度額(entity.getKyujuhiTashoshitsuFutanGendogaku());
        record2Entity.set負担限度額適用開始年月日(entity.getFutanGendogakuTekiyoKaishiYMD());
        record2Entity.set負担限度額適用終了年月日(entity.getFutanGendogakuTekiyoShuryoYMD());
        record2Entity.set軽減率(entity.getKeigenritsu());
        record2Entity.set軽減率適用開始年月日(entity.getKeigenritsuTekiyoKaishiYMD());
        record2Entity.set軽減率適用終了年月日(entity.getKeigenritsuTekiyoShuryoYMD());
