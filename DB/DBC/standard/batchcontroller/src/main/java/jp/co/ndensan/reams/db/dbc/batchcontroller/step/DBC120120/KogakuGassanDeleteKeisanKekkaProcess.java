...
/**
 * バッチ設計書_DBCMNF2002-386_高額合算支給額計算結果連絡票情報取込の高額合算支給額計算結果TBLを物理削除するクラスです。
 *
 * @reamsid_L DBC-2680-010 xicongwang
 */
public class KogakuGassanDeleteKeisanKekkaProcess extends BatchProcessBase<DbT3072KogakuGassanShikyuGakuKeisanKekkaEntity> {

    private static final RString MAPPERPATH = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "kogakugassan.IKogakuGassanShikyugakuKeisanKekkaInMapper.select高額合算支給額計算結果情報");
    ...
    protected void createWriter() {
        高額合算支給額計算結果tableWriter = new BatchPermanentTableWriter(DbT3072KogakuGassanShikyuGakuKeisanKekkaEntity.class);
    }
