 ...
 */
public class InsJigyoKogakuSetaiinHaakuNyuryokuTmpProcess1 extends BatchProcessBase<InsSetaiinHaakuNyuryokuKogakuTmpEntity1> {

    private static final RString 給付実績基本情報事業高額一時 = new RString("jp.co.ndensan.reams.db.dbc.persistence.db."
            + "mapper.relate.kogakukaigoservicehikyufutaishoshatoroku."
            + "IKogakuKaigoServicehiKyufugakuSanshutsuMapper.get給付実績基本情報事業高額一時3リスト");
