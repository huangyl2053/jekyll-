...
/**
 * 保険者保有給付実績情報作成の明細・住所地特例データの取得Processです。
 *
 * @reamsid_L DBC-2460-010 gongliang
 */
public class InsJutokuTempProcess extends BatchProcessBase<DbWT1111KyufuJissekiTempTempEntity> {
    ...
    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.hokenshakyufujisseki."
            + "IHokenshaKyufujissekiMapper.get明細_住所地特例");
    private static final RString データ区分 = new RString("13");
