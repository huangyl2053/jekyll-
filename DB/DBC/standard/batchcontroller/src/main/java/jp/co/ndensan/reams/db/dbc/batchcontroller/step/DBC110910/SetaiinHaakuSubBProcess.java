 ...
 */
public class SetaiinHaakuSubBProcess extends BatchProcessBase<SetaiYinEntity> {

    private static final RString 生保区分 = new RString("1");
    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.fuka.ISetaiShotokuKazeiHanteiMapper.select介護所得");
