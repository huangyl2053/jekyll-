...
import java.io.File;
import jp.co.ndensan.reams.db.dbc.batchcontroller.step.DBC120210.KohiJukyushaInReadCsvFileProcess;
import jp.co.ndensan.reams.db.dbc.batchcontroller.step.DBC120210.KohiJukyushaInReportProcess;
...
/**
 * バッチ設計書_DBCMNF2002-641_介護給付費公費受給者別一覧表情報取込のバッチFLOWです。
 *
 * @reamsid_L DBC-2800-010 duanzhanli
 */
public class DBC120210_KohiJukyushaIn extends BatchFlowBase<DBC120210_KohiJukyushaInParameter> {
    ...
    private static final RString ファイル格納フォルダ名 = new RString("DBC120210");
    ...
    protected IBatchFlowCommand callReadCsvFileProcess() {
        return loopBatch(KohiJukyushaInReadCsvFileProcess.class).arguments(csvParameter).define();
    }
    ...
    protected IBatchFlowCommand callDoIchiranhyoSakuseiProcess() {
        ...
        return loopBatch(KohiJukyushaInReportProcess.class).arguments(parameter).define();
    }
