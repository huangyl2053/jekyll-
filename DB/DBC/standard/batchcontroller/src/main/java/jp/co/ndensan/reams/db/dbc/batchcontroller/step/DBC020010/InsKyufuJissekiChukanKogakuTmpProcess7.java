...
public class InsKyufuJissekiChukanKogakuTmpProcess7 extends BatchProcessBase<InsKyufuJissekiChukanKogakuTmpProcess7Entity> {
    ...
    static final RString 給付実績中間高額一時7_TABLE_NAME = new RString("TempKyufujissekiTyukann");
    ...
    protected void process(InsKyufuJissekiChukanKogakuTmpProcess7Entity entity) {
        TempKyufujissekiTyukannEntity 給付実績中間高額一時7Entity;
        if (entity.get給付実績集計一時Entity() != null && entity.get給付実績社会福祉法人軽減額一時Entity() != null
            ...
            給付実績中間高額一時7Entity = set給付実績中間高額一時7Entity(entity);
