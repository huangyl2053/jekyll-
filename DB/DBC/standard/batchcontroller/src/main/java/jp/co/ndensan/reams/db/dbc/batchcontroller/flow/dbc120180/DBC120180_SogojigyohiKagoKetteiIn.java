...
public class DBC120180_SogojigyohiKagoKetteiIn extends BatchFlowBase<DBC120180_SogojigyohiKagoKetteiInParameter> {
    ...
    protected void defineFlow() {
        try {
            ...
            flowEntity = getResult(FlowEntity.class, new RString(CSVファイル取込),
                    KagoKetteiHokenshaInCsvFileReadProcess.PARAMETER_OUT_FLOWENTITY);
     ...
     * CSVファイル取込です。
     *
     * @return KagoKetteiHokenshaInCsvFileReadProcess
     */
    @Step(CSVファイル取込)
    IBatchFlowCommand tempSaveProcess() {
        ...
        return simpleBatch(KagoKetteiHokenshaInCsvFileReadProcess.class).arguments(parameter).define();
    }
     ...
     * 一覧表作成です。
     *
     * @return SogojigyohiKagoKetteiInDoIchiranhyoSakuseiProcess
     */
    @Step(一覧表作成)
