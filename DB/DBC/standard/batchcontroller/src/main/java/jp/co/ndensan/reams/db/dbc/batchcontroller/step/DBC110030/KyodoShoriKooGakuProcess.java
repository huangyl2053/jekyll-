 ...
 */
public class KyodoShoriKooGakuProcess extends BatchProcessBase<DbT3004KyodoShoriyoJukyushaIdoKogakuSofuEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.honnsanteifuka."
            + "IHonnSanteiFukaMapper.select共同処理高額送付");
    private static final RString TABLE_共同処理高額送付全件 = new RString("KyodoShoriKooGakuTemp");
    @BatchWriter
    BatchEntityCreatedTempTableWriter 共同処理高額送付全件一時;
    ...
    protected void createWriter() {
        共同処理高額送付全件一時 = new BatchEntityCreatedTempTableWriter(TABLE_共同処理高額送付全件,
    ...
    protected void process(DbT3004KyodoShoriyoJukyushaIdoKogakuSofuEntity entity) {
        共同処理高額送付全件一時.insert(business.set共同処理高額送付全件(entity));
    }
}
