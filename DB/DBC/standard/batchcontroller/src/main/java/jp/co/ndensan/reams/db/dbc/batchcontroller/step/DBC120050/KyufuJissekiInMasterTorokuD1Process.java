 ...
 */
public class KyufuJissekiInMasterTorokuD1Process extends BatchProcessBase<DbT3018KyufujissekiMeisaiEntity> {

    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "kyufujissekiin.IKyufuJissekiInMasterTorokuMapper.getマスタ登録データD1");
    @BatchWriter
    private BatchPermanentTableWriter 給付実績明細tableWriter;
    ...
    protected void createWriter() {
        給付実績明細tableWriter = new BatchPermanentTableWriter(DbT3018KyufujissekiMeisaiEntity.class);
    }
    ...
    @Override
    protected void process(DbT3018KyufujissekiMeisaiEntity entity) {
        ...
        給付実績明細tableWriter.insert(entity);
    }
