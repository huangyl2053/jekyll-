 ...
 */
public class CreateTmptable5C3Process extends BatchProcessBase<KyoudouShori5C3CsvEntity> {
    ...
    @Override
    protected void process(KyoudouShori5C3CsvEntity csvEntity) {
    ...
    private DbWT5C31KihonKyoudouShoriEntity getDbWT5C31Entity(KyoudouShori5C3CsvEntity csvEntity) {
