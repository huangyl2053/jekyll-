 ...
 */
public class KyodoShoriKihonSofuProcess extends BatchProcessBase<DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.honnsanteifuka."
            + "IHonnSanteiFukaMapper.select共同処理基本送付");
    private static final RString TABLE_共同処理基本全件送付 = new RString("KyodoShoriKihonSofuTemp");
    @BatchWriter
    BatchEntityCreatedTempTableWriter 共同処理基本送付全件一時;
    ...
    protected void createWriter() {
        共同処理基本送付全件一時 = new BatchEntityCreatedTempTableWriter(TABLE_共同処理基本全件送付,
    ...
    protected void process(DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntity entity) {
        共同処理基本送付全件一時.insert(business.set共同処理基本送付全件(entity));
    }
}
