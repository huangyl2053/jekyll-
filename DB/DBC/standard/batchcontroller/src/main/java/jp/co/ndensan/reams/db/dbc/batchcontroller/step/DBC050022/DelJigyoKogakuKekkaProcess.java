 ...
 */
public class DelJigyoKogakuKekkaProcess extends BatchProcessBase<DbT3111JigyoKogakuShikyuHanteiKekkaEntity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.dbc050021."
            + "IFurikomimeisaiFurikomiDataMapper.get依頼済の取消_事業高額");
