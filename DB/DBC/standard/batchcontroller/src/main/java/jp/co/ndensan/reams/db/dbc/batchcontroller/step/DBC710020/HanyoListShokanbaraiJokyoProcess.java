...
//        RString nowBreakKey = new RString(entity.get口座情報Entity().getUaT0310KozaEntity().getKozaId());
...
//            RString seiriNo = entity.get支給申請Entity().getSeiriNo();
//            if (hihokenshaNo != null && serviceTeikyoYM != null && seiriNo != null) {
