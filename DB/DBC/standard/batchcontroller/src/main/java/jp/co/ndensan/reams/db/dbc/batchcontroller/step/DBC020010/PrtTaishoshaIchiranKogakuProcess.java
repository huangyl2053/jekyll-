...
import jp.co.ndensan.reams.db.dbc.business.report.kogakuservicehitaishoshaichiran.KogakuServicehiTaishoshaIchiranPageBreak;
...
/**
 * 対象者一覧表発行処理_高額介護サービス費対象者一覧
 *
 * @reamsid_L DBC-2010-040 chenaoqi
 */
public class PrtTaishoshaIchiranKogakuProcess extends BatchProcessBase<KogakuKaigoServicehiReportEntity> {
    ...
    private static final RString MYBATISPATH = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate"
            ...
            + "IKogakuKaigoServicehiKyufugakuSanshutsuMapper.select高額介護サービス費対象者一覧");
    private static final ReportId 帳票分類ID = new ReportId("DBC200016_KogakuServicehiTaishoshaIchiran");
    private static final RString 出力ファイル名 = new RString("KogakuServicehiTaishoshaIchiran.csv");
    private static final RString EUC_WRITER_DELIMITER = new RString(",");
    private static final RString EUC_WRITER_ENCLOSURE = new RString("\"");
    private static final EucEntityId EUC_ENTITY_ID = new EucEntityId(new RString("DBC200016"));
    ...
    @BatchWriter
    private BatchReportWriter<KogakuServicehiTaishoshaIchiranSource> batchReportWriter;
    private ReportSourceWriter<KogakuServicehiTaishoshaIchiranSource> reportSourceWriter;
    ...
    protected void createWriter() {
        PageBreaker<KogakuServicehiTaishoshaIchiranSource> breaker = new KogakuServicehiTaishoshaIchiranPageBreak(breakKeyList);
        batchReportWriter = BatchReportFactory.createBatchReportWriter(ReportIdDBC.DBC200016.getReportId().value())
    ...
    protected void process(KogakuKaigoServicehiReportEntity entity) {
        KogakuServicehiTaishoshaIchiranEntity 対象者一覧表Entity = createReportData(entity);
        KogakuServicehiTaishoshaIchiranReport report = new KogakuServicehiTaishoshaIchiranReport(対象者一覧表Entity,
    ...
    private KogakuServicehiTaishoshaIchiranEntity createReportData(KogakuKaigoServicehiReportEntity entity) {
        ...
        対象者一覧表Entity.set旧措置者フラグ(entity.is旧措置者フラグ() ? KyusochishaKubun.旧措置者.getコード()
