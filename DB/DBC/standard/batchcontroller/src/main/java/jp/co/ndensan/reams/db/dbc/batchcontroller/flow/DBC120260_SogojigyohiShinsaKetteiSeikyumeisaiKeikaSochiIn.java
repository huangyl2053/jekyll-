...
import java.io.File;
import jp.co.ndensan.reams.db.dbc.batchcontroller.step.DBC120260.SogojigyohiShinsaKetteiSeikyumeisaiKeikaSochiInProcess;
...
import jp.co.ndensan.reams.db.dbc.definition.batchprm.DBC120260.DBC120260_SogojigyohiShinsaKetteiSeikyumeisaiKeikaSochiInParameter;
...
/**
 * 総合事業費（経過措置）審査決定請求明細表情報取込のバッチ処理フロークラスです
 *
 * @reamsid_L DBC-2500-011 jiangwenkai
 */
public class DBC120260_SogojigyohiShinsaKetteiSeikyumeisaiKeikaSochiIn
        extends BatchFlowBase<DBC120260_SogojigyohiShinsaKetteiSeikyumeisaiKeikaSochiInParameter> {
    ...
    private static final String 一覧表作成 = "sogojigyohiShinsaKetteiSeikyumeisaiKeikaSochiIn";
    private static final String 処理結果リスト作成 = "doShoriKekkaListSakusei";
    private static final String 取込済ファイル削除 = "deleteReveicedFile";
    private static final RString ファイル格納フォルダ名 = new RString("DBC120260");
    ...
    protected void defineFlow() {
        try {
            ...
            交換情報識別番号 = DbBusinessConfig.get(
                    ConfigNameDBC.国保連取込_総合事業費経過措置審査決定請求明細表情報_交換情報識別番号,
    ...
    protected IBatchFlowCommand callDoIchiranhyoSakuseiProcess() {
        SogojigyohiShinsaProcessParameter parameter
                = new SogojigyohiShinsaProcessParameter();
        parameter.set処理年月(getParameter().getShoriYM());
