 ...
 */
public class ClearRiyoshaFutanWariaiMeisaiTempProcess extends BatchProcessBase<RiyoshaFutanWariaiMeisaiTempEntity> {

    private static final RString TABLENAME = new RString("RiyoshaFutanWariaiMeisaiTemp");
    private static final RString PATH = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "riyoshafutanwariaihantei.IRiyoshaFutanwariaiMapper.select利用者負担割合明細Temp");
    @BatchWriter
    private BatchEntityCreatedTempTableWriter 利用者負担割合明細Temp;

    @Override
    protected void createWriter() {
        利用者負担割合明細Temp = new BatchEntityCreatedTempTableWriter(TABLENAME, RiyoshaFutanWariaiMeisaiTempEntity.class);
    }

    @Override
    protected void process(RiyoshaFutanWariaiMeisaiTempEntity entity) {
        利用者負担割合明細Temp.delete(entity);
    }
