...
public class DBC120200_SaishinsaKetteiKohifutanshaIn
        extends BatchFlowBase<DBC120200_SaishinsaKetteiKohifutanshaInParameter> {
    ...
    protected void defineFlow() {
        try {
            ...
            交換情報識別番号 = DbBusinessConfig.get(
                    ConfigNameDBC.国保連取込_介護給付費再審査決定通知書公費情報_交換情報識別番号,
    ...
    protected IBatchFlowCommand callDoIchiranhyoSakuseiProcess() {
        ...
        return simpleBatch(SaishinsaKohifutanshaDoIchiranhyoSakuseiProcess.class).arguments(parameter).
                define();
    }
