...
public class SelectKyuhuZissekiKougakuKaigoHiJoukenChushutuProcess extends BatchProcessBase<JukyushaKyufujissekiIchiranRelateEntity> {
    ...
    private static final RString 給付実績高額介護サービス費 = new RString("jp.co.ndensan.reams.db.dbc.persistence.db."
            + "mapper.relate.jukyushakyufujissekiichiran.IJukyushaKyufujissekiIchiranMapper.get給付実績高額介護サービス費");
    ...
    protected IBatchReader createReader() {
        ...
        return new BatchDbReader(給付実績高額介護サービス費, processParamter.toJukyushaKyufujissekiIchiranMybatisParameter(RString.EMPTY));
    }
    ...
    protected void process(JukyushaKyufujissekiIchiranRelateEntity entity) {
        if (entity.getKyufuJissekiKubunCode() != null && !entity.getKyufuJissekiKubunCode().isEmpty()) {
        ...
        tablEntity.set被保険者番号(entity.get被保険者氏名());
