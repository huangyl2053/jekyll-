 ...
 */
public class ShokanKetteiTsuchiShoMeisaiTempShitenUpdateProcess extends BatchProcessBase<ShokanKetteiTsuchiShoMeisaiTempTableEntity> {

    private static final RString 支店名称取得SQL = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "shokanketteitsuchishoikkatsusakusei.IShokanKetteiTsuchiShoIkkatsuSakuseiMapper.get支店名称");
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(支店名称取得SQL, new ShokanKetteiTsuchiShoUpdateParameter());
    }
