...
import jp.co.ndensan.reams.db.dbc.entity.db.relate.kyodojukyushainsub.KyoudouShori5E3CsvEntity;
 ...
 */
public class CreateTmptable5E3Process extends BatchProcessBase<KyoudouShori5E3CsvEntity> {
    ...
    protected IBatchReader createReader() {
        ...
        CsvReader csvReader = new CsvReader.InstanceBuilder(filePath, KyoudouShori5E3CsvEntity.class)
    ...
    @Override
    protected void process(KyoudouShori5E3CsvEntity csvEntity) {
    ...
    private DbWT5C33KougakuKyoudouShoriEntity getDbWT5C33Entity(KyoudouShori5E3CsvEntity csvEntity) {
