 ...
 */
public class InsKyufuJissekiChukanJigyoKogakuTmpProcess1 extends BatchProcessBase<KyufujissekiTyukannInsertEntity> {
    ...
    private static final RString ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            ...
            + "select給付実績中間事業高額一時の作成１");
    private static final RString TABLE_給付実績中間事業高額一時１ = new RString("TempKyufujissekiTyukannJigyo1");
