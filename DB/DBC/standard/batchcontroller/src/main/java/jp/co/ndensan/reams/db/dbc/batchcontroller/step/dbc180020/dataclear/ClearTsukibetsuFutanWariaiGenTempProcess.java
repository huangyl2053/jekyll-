...
/**
 * 月別負担割合現Tempの削除プロセスです。
 *
 * @reamsid_L DBC-4950-030 liuyang
 */
public class ClearTsukibetsuFutanWariaiGenTempProcess extends BatchProcessBase<TsukibetsuFutanWariaiTempEntity> {

    private static final RString TABLENAME = new RString("TsukibetsuFutanWariaiGenTemp");
    private static final RString PATH = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "riyoshafutanwariaihantei.IRiyoshaFutanwariaiMapper.select月別負担割合現Temp");
    @BatchWriter
    private BatchEntityCreatedTempTableWriter 月別負担割合現Temp;

    @Override
    protected void createWriter() {
        月別負担割合現Temp = new BatchEntityCreatedTempTableWriter(TABLENAME, TsukibetsuFutanWariaiTempEntity.class);
    }

    @Override
    protected void process(TsukibetsuFutanWariaiTempEntity entity) {
        月別負担割合現Temp.delete(entity);
    }
