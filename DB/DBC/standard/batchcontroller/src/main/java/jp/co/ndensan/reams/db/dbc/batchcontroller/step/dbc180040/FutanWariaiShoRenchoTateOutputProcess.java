...
/**
 * 帳票設計_DBC100066_負担割合証（連帳・縦）のProcessクラスです。
 *
 * @reamsid_L DBC-4990-030 pengxingyi
 */
public class FutanWariaiShoRenchoTateOutputProcess extends BatchProcessBase<RiyoshaFutanwariaishoTempEntity> {
    ...
    protected void initialize() {
        ...
        帳票制御共通 = new ChohyoSeigyoKyotsu(SubGyomuCode.DBC介護給付, ReportIdDBC.DBC100066.getReportId());
    ...
    protected void createWriter() {
        batchReportWriter = BatchReportFactory.createBatchReportWriter(ReportIdDBC.DBC100066.getReportId().value()).create();
    ...
    protected void process(RiyoshaFutanwariaishoTempEntity entity) {
        ...
        FutanWariaiShoRenchoTateReport report = new FutanWariaiShoRenchoTateReport(futanWariaiShoEntity);
    ...
    protected void afterExecute() {
        ...
        ReportOutputJokenhyoItem reportOutputJokenhyoItem = new ReportOutputJokenhyoItem(
                ...
                ReportIdDBC.DBC100066.getReportName(),
