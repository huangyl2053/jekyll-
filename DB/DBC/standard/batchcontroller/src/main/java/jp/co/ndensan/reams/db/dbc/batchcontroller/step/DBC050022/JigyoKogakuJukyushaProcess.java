...
/**
 * 受給取得状況データ取得_事業高額Process処理クラスです。
 *
 * @reamsid_L DBC-4870-030 gongliang
 */
public class JigyoKogakuJukyushaProcess extends BatchProcessBase<FurikomimeisaiDataJukyushaEntity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.dbc050021."
            + "IFurikomimeisaiFurikomiDataMapper.select受給取得状況情報_事業高額");
