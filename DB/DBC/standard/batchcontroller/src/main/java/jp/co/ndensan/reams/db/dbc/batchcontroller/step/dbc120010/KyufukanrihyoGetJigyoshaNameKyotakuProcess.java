 ...
 */
public class KyufukanrihyoGetJigyoshaNameKyotakuProcess extends BatchProcessBase<KyufukanrihyoJigyoshaEntity> {

    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "kyufukanrihyoin.IKyufukanrihyoInMapper.get事業者名称_居宅介護支援事業所作成の場合");
