 ...
 */
public class DbWT1510KyufuJissekiKihonDeleteProcess extends BatchProcessBase<DbWT1510KyufuJissekiKihonEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper."
            + "relate.riyojokyotokeihyomeisailistsakusei.IRiyoJokyoTokeihyoMeisaiListSakuseiMapper.select出力対象外データ");
