...
/**
 * 給付更新結果情報取込・マスタ登録・DBを実行する。
 *
 * @reamsid_L DBC-2440-010 zhangrui
 */
public class KyufuJissekiInMasterTorokuDBProcess extends BatchProcessBase<DbT3031KyufuJissekiCareManagementHiEntity> {

    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "kyufujissekiin.IKyufuJissekiInMasterTorokuMapper.getマスタ登録データDB");
    @BatchWriter
    private BatchPermanentTableWriter 給付実績ケアマネジメント費tableWriter;
    ...
    protected void createWriter() {
        給付実績ケアマネジメント費tableWriter
                = new BatchPermanentTableWriter(DbT3031KyufuJissekiCareManagementHiEntity.class);
    }
    ...
    @Override
    protected void process(DbT3031KyufuJissekiCareManagementHiEntity entity) {
        ...
        給付実績ケアマネジメント費tableWriter.insert(entity);
    }
