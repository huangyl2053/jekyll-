...
/**
 * 総合事業対象者異動データ抽出のprocessクラスです。
 *
 * @reamsid_L DBC-4950-033 pengxingyi
 */
public class SogoJigyoTaishoshaIdoProcess extends BatchProcessBase<IdoRiyoshaDateEntity> {

    private static final RString MYBATIS_SELECT_ID
            = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.idoriyoshafutanwariaihantei."
                    + "IIdoRiyoshaFutanwariaiHanteiMapper.select総合事業対象者異動");
    ...
    private static final RString 異動種別_2 = new RString("2");
    ...
    protected void process(IdoRiyoshaDateEntity entity) {
        ...
        HanteiTaishoshaTempEditor edit = new HanteiTaishoshaTempEditor(entity, 異動種別_2, 出力条件, parameter);
