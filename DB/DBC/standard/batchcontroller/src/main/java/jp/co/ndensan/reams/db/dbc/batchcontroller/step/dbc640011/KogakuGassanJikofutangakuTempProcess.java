...
/**
 * 高額合算自己負担額証明書情報の処理結果リスト一時登録processクラスです
 *
 * @reamsid_L DBC-2640-011 qinzhen
 */
public class KogakuGassanJikofutangakuTempProcess extends BatchProcessBase<Integer> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.kogakugassanjikofutangakushomeishoin."
            + "IKogakuGassanJikofutangakuShomeishoMapper.select高額合算自己負担額一時TBL件数");
