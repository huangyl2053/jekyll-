...
/**
 * 給付更新結果情報取込・マスタ登録・D3・1を実行する。
 *
 * @reamsid_L DBC-2440-010 zhangrui
 */
public class KyufuJissekiInMasterTorokuD31Process extends BatchProcessBase<DbT3020KyufujissekiTokuteiSinryohiEntity> {

    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "kyufujissekiin.IKyufuJissekiInMasterTorokuMapper.getマスタ登録データD31");
    @BatchWriter
    private BatchPermanentTableWriter 給付実績特定診療費tableWriter;
    ...
    protected void createWriter() {
        給付実績特定診療費tableWriter
                = new BatchPermanentTableWriter(DbT3020KyufujissekiTokuteiSinryohiEntity.class);
    }
    ...
    @Override
    protected void process(DbT3020KyufujissekiTokuteiSinryohiEntity entity) {
        ...
        給付実績特定診療費tableWriter.insert(entity);
    }
