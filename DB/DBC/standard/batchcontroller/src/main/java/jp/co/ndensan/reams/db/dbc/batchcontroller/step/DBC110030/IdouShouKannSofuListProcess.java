 ...
 */
public class IdouShouKannSofuListProcess extends BatchProcessBase<IdouChuukannShouKannTempEntity> {

    private static final RString MYBATIS_SELECT_ID = new RString(
            "jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.honnsanteifuka.IHonnSanteiFukaMapper.select異動中間償還送付");
    @BatchWriter
    ...
    @Override
    protected void process(IdouChuukannShouKannTempEntity entity) {
    }

    @Override
    protected void afterExecute() {
        List<IdouSofuListTempEntity> 送付対象リスト = HonnSanteiFukaManager.createInstance().set償還送付対象リスト();
