...
import jp.co.ndensan.reams.db.dbc.entity.db.relate.nenjiriyoshafutanwariaihantei.HanteiTaishoshaTempEntity;
...
public class HanteiTaishoshaTempProcess extends BatchProcessBase<HanteiTaishoshaEntity> {
    ...
    protected void process(HanteiTaishoshaEntity entity) {
        ...
        if (entity.get受給者台帳() != null) {
            ...
            hanteiTaishoshaTempEntity.setShikibetsuCode(entity.get受給者台帳().getDbT4001JukyushaDaicho_shikibetsuCode().value());
            hanteiTaishoshaTempEntity.setSetaiCode(entity.get受給者台帳().getSetaiCode().value());
            hanteiTaishoshaTempEntity.setIdoDate(entity.get受給者台帳().getIdoYMD());
            ...
            hanteiTaishoshaTempEntity.setSetaiCode(entity.get受給者台帳().getShichosonCode().value());
        ...
        if (entity.get総合事業対象者台帳() != null) {
            ...
            hanteiTaishoshaTempEntity.setShikibetsuCode(entity.get総合事業対象者台帳().getUaFt200FindShikibetsuTaisho_shikibetsuCode().value());
            hanteiTaishoshaTempEntity.setSetaiCode(entity.get総合事業対象者台帳().getSetaiCode().value());
            hanteiTaishoshaTempEntity.setIdoDate(entity.get総合事業対象者台帳().getIdoYMD());
