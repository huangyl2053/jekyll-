 ...
 */
public class DbWT1513JigyoshoNameUpdateProcess extends BatchProcessBase<DbWT1513RiyoJokyoTokeihyoEntity> {
    ...
    protected IBatchReader createReader() {
        ...
        parameter.set事業者名(true);
        parameter.set給付事業者名(false);
    ...
    protected void process(DbWT1513RiyoJokyoTokeihyoEntity entity) {
        if ((!RString.isNullOrEmpty(entity.getJigyoshoNo()) && !事業者番号_ALL0.equals(entity.getJigyoshoNo()))
                && RString.isNullOrEmpty(entity.getJigyoshoName()) && TRUE_1.equals(entity.getMeisaiOutFlag())) {
            ...
            処理結果確認リスト一時entity.setKey2(entity.getJigyoshoNo());
            処理結果確認リスト一時entity.setKey3(RString.EMPTY);
            処理結果確認リスト一時entity.setKey4(RString.EMPTY);
            処理結果確認リスト一時entity.setKey5(entity.getServiceShuruiCode());
            処理結果確認リスト一時entity.setHihokenshaShimei(entity.getShimei());
            処理結果確認リスト一時entity.setBiko(サービス事業者);
