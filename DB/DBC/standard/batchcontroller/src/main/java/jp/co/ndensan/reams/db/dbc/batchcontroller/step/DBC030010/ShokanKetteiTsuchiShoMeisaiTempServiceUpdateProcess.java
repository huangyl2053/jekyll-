 ...
 */
public class ShokanKetteiTsuchiShoMeisaiTempServiceUpdateProcess extends BatchProcessBase<ShokanKetteiTsuchiShoMeisaiTempTableEntity> {

    private static final RString サービス種類取得SQL = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "shokanketteitsuchishoikkatsusakusei.IShokanKetteiTsuchiShoIkkatsuSakuseiMapper.getサービス種類");
    ...
    protected IBatchReader createReader() {
        return new BatchDbReader(サービス種類取得SQL);
    }
