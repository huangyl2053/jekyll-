 ...
 */
public class ShokanKetteiTsuchiShoMeisaiTempServiceUpdateProcess extends SimpleBatchProcessBase {

    @Override
    protected void process() {
        getMapper(IShokanKetteiTsuchiShoIkkatsuSakuseiMapper.class).getサービス種類();
    }
}
