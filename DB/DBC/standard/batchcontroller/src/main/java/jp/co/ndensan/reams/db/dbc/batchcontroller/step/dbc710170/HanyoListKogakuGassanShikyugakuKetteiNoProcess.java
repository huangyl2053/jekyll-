...
import jp.co.ndensan.reams.db.dbc.entity.csv.hanyolistkogakugassanshikyugakukettei.HanyoListKogakuGassanShikyugakuKetteiNoCSVEntity;
 ...
 */
public class HanyoListKogakuGassanShikyugakuKetteiNoProcess
    ...
    @BatchWriter
    private CsvWriter<HanyoListKogakuGassanShikyugakuKetteiNoCSVEntity> hanyoListKogakuNoCSVWriter;
...
//    private static final RString 出力順_保険者番号 = new RString("保険者番号");
//    private static final RString 出力順_支給申請書整理番号 = new RString("支給申請書整理番号");
...
//        set並び順();
    ...
    protected void createWriter() {
        hanyoListKogakuFilePath = Path.combinePath(manager.getEucOutputDirectry(),
                出力ファイル名);
        hanyoListKogakuNoCSVWriter = BatchWriters.csvWriter(HanyoListKogakuGassanShikyugakuKetteiNoCSVEntity.class).
    ...
    private HanyoListKogakuGassanShikyugakuKetteiNoCSVEntity
            get帳票のCSVファイル作成(HanyoListKogakuGassanShikyugakuKetteiEntity entity) {
        HanyoListKogakuGassanShikyugakuKetteiNoCSVEntity output = new HanyoListKogakuGassanShikyugakuKetteiNoCSVEntity();
...
//        IOutputOrder 並び順;
//        並び順 = iChohyoShutsuryokujunFinder.get出力順(SubGyomuCode.DBC介護給付,
//                parameter.get帳票ID(), Long.valueOf(parameter.get出力順().toString()));
//        RString 出力順;
//        if (並び順 != null) {
//
//            for (ISetSortItem item : 並び順.get設定項目リスト()) {
//                if (item.get項目ID().equals(
//                        HanyoListKogakuGassanShikyugakuKetteiOutPutOrder.被保険者番号.get項目ID())) {
//                }
//            }
//        } else {
//            出力順 = new RString("").concat(ORDERBY);
//        }
//    }
    ...
    private RStringBuilder get対象年度() {
        ...
        builder.append(parameter.get対象年度());
        return builder;
    }
