...
/**
 * ビジネス設計_DBCMN62006_自己負担額計算（一括）の対象者抽出のプロセスです。
 *
 * @reamsid_L DBC-2060-050 liuyang
 */
public class TaishoshaChushuProcess extends BatchProcessBase<DBC020080TaishoDataEntity> {

    private static final RString PATH = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "dbc020080.IJigyobunKogakuGassanJikofutangakuKeisanMapper.get対象者抽出データ");
