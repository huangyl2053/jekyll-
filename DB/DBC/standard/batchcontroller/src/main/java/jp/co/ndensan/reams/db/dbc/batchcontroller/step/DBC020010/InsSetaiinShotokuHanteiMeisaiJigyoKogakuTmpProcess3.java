 ...
 */
public class InsSetaiinShotokuHanteiMeisaiJigyoKogakuTmpProcess3 extends BatchProcessBase<InsSetaiinShotokuHanteiMeisaiKogakuTmpProcess3Entity> {
    ...
    protected void process(InsSetaiinShotokuHanteiMeisaiKogakuTmpProcess3Entity entity) {
        ...
        setaiinShotokuHanteiJigyo3Writer.insert(世帯員所得判定明細高額一時Entity);
    }
}
