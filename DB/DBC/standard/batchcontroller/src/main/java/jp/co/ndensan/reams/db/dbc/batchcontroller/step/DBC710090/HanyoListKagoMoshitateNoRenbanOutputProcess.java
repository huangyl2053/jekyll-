...
/**
 * 汎用リスト(過誤申立情報)連番出力しないのバッチ用パラメータフロークラスです。
 *
 * @reamsid_L DBC-3095-020 pengxingyi
 */
public class HanyoListKagoMoshitateNoRenbanOutputProcess extends BatchProcessBase<HanyoListKagoMoshitateEntity> {
    ...
    @BatchWriter
    private CsvWriter<HanyoListKagoMoshitateNoRenbanCsvEntity> noRenbanCsvWriter;
    ...
    protected void process(HanyoListKagoMoshitateEntity entity) {
        ...
        noRenbanCsvWriter.writeLine(edit.noRenbanEdit(住所番地方書));
    ...
    protected void afterExecute() {
        ...
        ReportOutputJokenhyoItem reportOutputJokenhyoItem = new ReportOutputJokenhyoItem(
                ...
                日本語ファイル名,
                new RString(noRenbanCsvWriter.getCount()),
                csv出力Flag,
                csvFileName,
                get抽出条件()
        );
