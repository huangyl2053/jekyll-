 ...
 */
public class MoziCodeHenkanProcess extends BatchFileConvertBase {

    private static final RString CSV名称 = new RString("KoseiTaishoKyufuJissekiIchiran.csv");
    private static final EucEntityId EUC_ENTITY_ID = new EucEntityId(new RString("DBC200096"));
    ...
    protected ConvertReaderParameter createReaderParameter() {
        CsvListReaderParameter readParameter = new CsvListReaderParameterBuilder(processParameter.get給付実績ファイルパス())
                .encode(Encode.JIS)
