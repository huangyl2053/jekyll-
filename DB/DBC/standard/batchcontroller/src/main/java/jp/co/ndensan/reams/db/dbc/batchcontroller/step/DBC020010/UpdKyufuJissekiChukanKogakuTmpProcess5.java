...
/**
 *
 * 給付実績中間高額一時の更新１のProcessフロークラスです。
 *
 * @reamsid_L DBC-2010-040 tianshuai
 */
public class UpdKyufuJissekiChukanKogakuTmpProcess5 extends SimpleBatchProcessBase {

    @Override
    protected void process() {
        IKogakuKaigoServicehiKyufugakuSanshutsuMapper mapper = getMapper(IKogakuKaigoServicehiKyufugakuSanshutsuMapper.class);
        mapper.update給付実績中間高額一時5の更新1();
        mapper.update給付実績中間高額一時5の更新2();
    }
}
