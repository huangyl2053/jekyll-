 ...
 */
public class UpdJigyoKogakuGassanKetteiProcess extends BatchProcessBase<DbT3174JigyoKogakuGassanShikyuFushikyuKetteiEntity> {
    ...
    private static final RString MYBATIS_SELECT_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.dbc050021."
            + "IFurikomimeisaiFurikomiDataMapper.get依頼済の登録_事業高額合算");
    ...
    protected void process(DbT3174JigyoKogakuGassanShikyuFushikyuKetteiEntity t) {
        t.setFurikomiTsuchiSakuseiYMD(FlexibleDate.getNowDate());
