...
import jp.co.ndensan.reams.db.dbc.definition.processprm.sogojigyohiseikyugakutsuchishokohiin.TsuchishoKohiGetFileProcessParameter;
 ...
 */
public class TsuchishoKohiGetFileProcess extends SimpleBatchProcessBase {
    //パラメータ名
    /**
     * returnEntity
     */
    public static final RString PARAMETER_OUT_RETURNENTITY;
    private TsuchishoKohiGetFileProcessParameter parameter;
