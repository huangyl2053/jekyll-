...
/**
 * 高額申請管理のマスタテーブルから、申請情報の取得処理クラスです。
 *
 * @reamsid_L DBC-4770-030 zhujun
 */
public class KogakuShinseiKanriForShinseiJyohoProcess extends BatchProcessBase<KogakuKaigoServiceHiRelateEntity> {

    private static final RString MYBATIS_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate."
            + "kogakukaigoservicehikyufuoshirasetsuchisho.IKogakuKaigoServicehiOshiraseHakkoMapper.get高額介護サービス費情報");
    ...
    protected void process(KogakuKaigoServiceHiRelateEntity entity) {
        ...
        tmpEntity.setHanteiKekkaShikyuKubunCodeJoho(entity.get支給判定結果().getShikyuKubunCode());
        tmpEntity.setShikyuKingakuJoho(entity.get支給判定結果().getShikyuKingaku());
        ...
        tmpEntity.setGokeiKogakuShikyuGakuJoho(entity.get給付対象者合計().getKogakuShikyuGaku());
        ...
        tmpEntity.setKogakuKyufuKonkyoJoho(entity.get給付対象者明細().getKogakuKyufuKonkyo());
        ...
        tmpEntity.setKetteiKogakuShikyuGakuJoho(entity.get支給審査決定().getKogakuShikyuGaku());
