...
/**
 * 高額合算補正済自己負担額情報作成のDB更新_送付済Processです。
 *
 * @reamsid_L DBC-2660-030 gongliang
 */
public class UpdateKogakuGassanSofuProcess extends BatchProcessBase<DbT3070KogakuGassanJikoFutanGakuEntity> {
    ...
    private static final RString READ_DATA_ID = new RString("jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.kogakugassan."
            + "IKogakugassanHoseisumiJikofutangakuOutMapper.get送付済高額合算自己負担額データ");
    ...
    protected void process(DbT3070KogakuGassanJikoFutanGakuEntity entity) {
        entity.setHoseiZumi_SofuYM(processParameter.getShoriYM());
