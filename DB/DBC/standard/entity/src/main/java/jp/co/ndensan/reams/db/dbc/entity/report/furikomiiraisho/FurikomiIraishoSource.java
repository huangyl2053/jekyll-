package jp.co.ndensan.reams.db.dbc.entity.report.furikomiiraisho;
...
/**
 * 帳票設計_DBC100059_事業合算・事業分振込明細書作成（一括） Sourceクラスです。
 *
 * @reamsid_L DBC-4870-040 lijian
 */
public class FurikomiIraishoSource implements IReportSource {
