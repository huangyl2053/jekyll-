...
public class JigyoBunKogakuGassanShikyuKetteibanAriEUCEntity implements IJigyoBunKogakuGassanShikyuKetteiEUCEntity {
    ...
    @CsvField(order = 49, name = "送付先住所_番地_方書")
    ...
    @CsvField(order = 64, name = "受給申請事由")
    private RString 受給申請事由;
    @CsvField(order = 65, name = "受給申請日")
    private RString 受給申請日;
    @CsvField(order = 66, name = "受給要介護度")
    private RString 受給要介護度;
    @CsvField(order = 67, name = "受給認定開始日")
    private RString 受給認定開始日;
    @CsvField(order = 68, name = "受給認定終了日")
    private RString 受給認定終了日;
    @CsvField(order = 69, name = "受給認定日")
    private RString 受給認定日;
    @CsvField(order = 70, name = "受給旧措置")
    private RString 受給旧措置;
    @CsvField(order = 71, name = "受給みなし更新認定")
    private RString 受給みなし更新認定;
    @CsvField(order = 72, name = "受給直近事由")
    private RString 受給直近事由;
    @CsvField(order = 73, name = "対象年度")
    private RString 対象年度;
    @CsvField(order = 74, name = "保険者番号")
    private RString 保険者番号;
    @CsvField(order = 75, name = "連絡票整理番号")
    private RString 連絡票整理番号;
    @CsvField(order = 76, name = "履歴番号")
    private RString 履歴番号;
    @CsvField(order = 77, name = "自己負担額証明書整理番号")
    private RString 自己負担額証明書整理番号;
    @CsvField(order = 78, name = "対象計算期間_開始")
    private RString 対象計算期間_開始;
    @CsvField(order = 79, name = "対象計算期間_終了")
    private RString 対象計算期間_終了;
    @CsvField(order = 80, name = "申請日")
    private RString 申請日;
    @CsvField(order = 81, name = "決定日")
    private RString 決定日;
    @CsvField(order = 82, name = "自己負担総額")
    private Decimal 自己負担総額;
    @CsvField(order = 83, name = "支給区分コード")
    private RString 支給区分コード;
    @CsvField(order = 84, name = "支給額")
    private Decimal 支給額;
    @CsvField(order = 85, name = "給付の種類")
    private RString 給付の種類;
    @CsvField(order = 86, name = "不支給理由")
    private RString 不支給理由;
    @CsvField(order = 87, name = "支払方法区分")
    private RString 支払方法区分;
    @CsvField(order = 88, name = "支払場所")
    private RString 支払場所;
    @CsvField(order = 89, name = "支払期間開始日")
    private RString 支払期間開始日;
    @CsvField(order = 90, name = "支払期間終了日")
    private RString 支払期間終了日;
    @CsvField(order = 91, name = "支払期間開始日_曜日")
    private RString 支払期間開始日_曜日;
    @CsvField(order = 92, name = "支払期間終了日_曜日")
    private RString 支払期間終了日_曜日;
    @CsvField(order = 93, name = "支払期間開始日_時間")
    private RString 支払期間開始日_時間;
    @CsvField(order = 94, name = "支払期間終了日_時間")
    private RString 支払期間終了日_時間;
    @CsvField(order = 95, name = "金融機関コード")
    private KinyuKikanCode 金融機関コード;
    @CsvField(order = 96, name = "金融機関名")
    private RString 金融機関名;
    @CsvField(order = 97, name = "金融機関支店コード")
    private RString 金融機関支店コード;
    @CsvField(order = 98, name = "金融機関支店名")
    private RString 金融機関支店名;
    @CsvField(order = 99, name = "口座種目名")
    private RString 口座種目名;
    @CsvField(order = 100, name = "口座番号")
    private RString 口座番号;
    @CsvField(order = 101, name = "口座名義人_カナ")
    private AtenaKanaMeisho 口座名義人_カナ;
    @CsvField(order = 102, name = "決定通知書作成日")
    private RString 決定通知書作成日;
    @CsvField(order = 103, name = "振込通知書作成日")
    private RString 振込通知書作成日;
    @CsvField(order = 104, name = "受取年月")
    private RString 受取年月;
    @CsvField(order = 105, name = "給付の種類_短")
    private RString 給付の種類_短;
    @CsvField(order = 106, name = "不支給理由_短")
    private RString 不支給理由_短;
    @CsvField(order = 107, name = "支払場所_短")
