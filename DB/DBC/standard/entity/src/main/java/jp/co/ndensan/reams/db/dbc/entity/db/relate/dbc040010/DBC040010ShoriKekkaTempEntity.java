...
@lombok.Getter
@lombok.Setter
public class DBC040010ShoriKekkaTempEntity
        extends DbTableEntityBase<DBC040010ShoriKekkaTempEntity> implements IDbAccessable {
    ...
    static {
        TABLE_NAME = new RString("DBC040010ShoriKekkaListTemp");
    }
    @PrimaryKey
     ...
     */
    public DBC040010ShoriKekkaTempEntity() {
