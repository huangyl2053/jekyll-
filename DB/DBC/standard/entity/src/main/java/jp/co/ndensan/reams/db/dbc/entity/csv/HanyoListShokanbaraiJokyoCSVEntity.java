...
public class HanyoListShokanbaraiJokyoCSVEntity {
    ...
    @CsvField(order = 640, name = "資格証記載保険者番号")
    ...
    @CsvField(order = 820, name = "サービス提供年月")
    private RString サービス提供年月;
    @CsvField(order = 830, name = "整理番号")
    private RString 整理番号;
    @CsvField(order = 840, name = "様式番号")
    private RString 様式番号;
    @CsvField(order = 850, name = "給付証記載保険者番号")
    private RString 給付証記載保険者番号;
    @CsvField(order = 860, name = "申請日")
    private RString 申請日;
    @CsvField(order = 870, name = "申請理由")
    private RString 申請理由;
    @CsvField(order = 880, name = "申請区分")
    private RString 申請区分;
    @CsvField(order = 890, name = "申請氏名")
    private RString 申請氏名;
    @CsvField(order = 900, name = "申請氏名カナ")
    private RString 申請氏名カナ;
    @CsvField(order = 910, name = "申請電話番号")
    private RString 申請電話番号;
    @CsvField(order = 920, name = "申請支払金額")
    private RString 申請支払金額;
    @CsvField(order = 930, name = "受付日")
    private RString 受付日;
    @CsvField(order = 940, name = "保険請求額")
    private RString 保険請求額;
    @CsvField(order = 950, name = "自己負担額")
    private RString 自己負担額;
    @CsvField(order = 960, name = "決定日")
    private RString 決定日;
    @CsvField(order = 970, name = "支給不支給区分")
    private RString 支給不支給区分;
    @CsvField(order = 980, name = "支払金額")
    private RString 支払金額;
    @CsvField(order = 990, name = "通知書作成日")
    private RString 通知書作成日;
    @CsvField(order = 1000, name = "通知書Ｎo")
    private RString 通知書Ｎo;
    @CsvField(order = 1010, name = "振込書作成日")
    private RString 振込書作成日;
    @CsvField(order = 1020, name = "支払方法")
    private RString 支払方法;
    @CsvField(order = 1030, name = "国保連送付年月")
    private RString 国保連送付年月;
    @CsvField(order = 1040, name = "申請状態")
    private RString 申請状態;
    @CsvField(order = 1050, name = "施行完了予定日")
    private RString 施行完了予定日;
    @CsvField(order = 1060, name = "申請取消事由")
    private RString 申請取消事由;
    @CsvField(order = 1070, name = "支給届出年月日")
    private RString 支給届出年月日;
    @CsvField(order = 1080, name = "支給受付年月日")
    private RString 支給受付年月日;
    @CsvField(order = 1090, name = "領収年月日")
    private RString 領収年月日;
    @CsvField(order = 1100, name = "支払場所")
    private RString 支払場所;
    @CsvField(order = 1110, name = "支払開始日")
    private RString 支払開始日;
    @CsvField(order = 1120, name = "支払終了日")
    private RString 支払終了日;
    @CsvField(order = 1130, name = "支払開始曜日")
    private RString 支払開始曜日;
    @CsvField(order = 1140, name = "支払終了曜日")
    private RString 支払終了曜日;
    @CsvField(order = 1150, name = "支払開始時間")
    private RString 支払開始時間;
    @CsvField(order = 1160, name = "支払終了時間")
    private RString 支払終了時間;
    @CsvField(order = 1170, name = "購入年月日")
    private RString 購入年月日;
    @CsvField(order = 1180, name = "商品名")
    private RString 商品名;
    @CsvField(order = 1190, name = "種目名")
    private RString 種目名;
    @CsvField(order = 1200, name = "製造事業者名")
    private RString 製造事業者名;
    @CsvField(order = 1210, name = "販売事業者名")
    private RString 販売事業者名;
    @CsvField(order = 1220, name = "購入金額")
    private RString 購入金額;
    @CsvField(order = 1230, name = "品目名")
    private RString 品目名;
    @CsvField(order = 1240, name = "着工年月日")
    private RString 着工年月日;
    @CsvField(order = 1250, name = "完成年月日")
    private RString 完成年月日;
    @CsvField(order = 1260, name = "改修事業者名")
    private RString 改修事業者名;
    @CsvField(order = 1270, name = "住宅住所")
    private RString 住宅住所;
    @CsvField(order = 1280, name = "改修金額")
    private RString 改修金額;
    @CsvField(order = 1290, name = "銀行郵便区分")
    private RString 銀行郵便区分;
    @CsvField(order = 1300, name = "銀行コード")
    private RString 銀行コード;
    @CsvField(order = 1310, name = "支店コード")
    private RString 支店コード;
    @CsvField(order = 1320, name = "銀行名カナ")
    private RString 銀行名カナ;
    @CsvField(order = 1330, name = "銀行名")
    private RString 銀行名;
    @CsvField(order = 1340, name = "支店名カナ")
    private RString 支店名カナ;
    @CsvField(order = 1350, name = "支店名")
    private RString 支店名;
    @CsvField(order = 1360, name = "口座種目")
    private RString 口座種目;
    @CsvField(order = 1370, name = "口座番号")
    private RString 口座番号;
    @CsvField(order = 1380, name = "名義人カナ短")
    private RString 名義人カナ短;
    @CsvField(order = 1390, name = "名義人短")
    private RString 名義人短;
    @CsvField(order = 1400, name = "名義人カナ")
    private RString 名義人カナ;
    @CsvField(order = 1410, name = "名義人")
    private RString 名義人;
    @CsvField(order = 1420, name = "受給申請事由")
    private RString 受給申請事由;
    @CsvField(order = 1430, name = "受給申請日")
    private RString 受給申請日;
    @CsvField(order = 1440, name = "受給要介護度")
    private RString 受給要介護度;
    @CsvField(order = 1450, name = "受給認定開始日")
    private RString 受給認定開始日;
    @CsvField(order = 1460, name = "受給認定終了日")
    private RString 受給認定終了日;
    @CsvField(order = 1470, name = "受給認定日")
    private RString 受給認定日;
    @CsvField(order = 1480, name = "受給旧措置")
    private RString 受給旧措置;
    @CsvField(order = 1490, name = "受給みなし更新認定")
    private RString 受給みなし更新認定;
    @CsvField(order = 1500, name = "受給直近事由")
