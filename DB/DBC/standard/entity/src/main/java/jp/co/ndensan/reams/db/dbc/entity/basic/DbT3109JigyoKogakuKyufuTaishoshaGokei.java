...
/**
 * 事業高額介護サービス費給付対象者合計テーブルの項目定義クラスです。
 */
public enum DbT3109JigyoKogakuKyufuTaishoshaGokei implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    ...
    private DbT3109JigyoKogakuKyufuTaishoshaGokei(int maxLength, int scale) {
