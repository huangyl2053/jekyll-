...
public class KyoudouShori5D3CsvEntity implements Serializable {
    ...
    @CsvField(order = 22, name = "保険給付支払の一時差止の開始年月日")
    private RString 保険給付支払の一時差止の開始年月日;
    @CsvField(order = 23, name = "保険給付支払の一時差止の終了年月日")
    private RString 保険給付支払の一時差止の終了年月日;
    @CsvField(order = 24, name = "保険給付支払の一時差止区分")
    private RString 保険給付支払の一時差止区分;
    @CsvField(order = 25, name = "保険給付支払の一時差止金額")
