 ...
 */
public class GassanKyufujissekiTorikomiIchiranSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "list_4", length = 17, order = 18)
    public RString list_4;
    @ReportItem(name = "list_5", length = 20, order = 19)
    public RString list_5;
    @ReportItem(name = "list_6", length = 2, order = 20)
    public RString list_6;
    @ReportItem(name = "list_7", length = 6, order = 21)
    public RString list_7;
    @ReportItem(name = "list_8", length = 9, order = 22)
    public RString list_8;
    @ReportItem(name = "list_9", length = 9, order = 23)
    public RString list_9;
    @ReportItem(name = "list_10", length = 13, order = 24)
    public RString list_10;
    @ReportItem(name = "list_11", length = 13, order = 25)
    public RString list_11;
    @ReportItem(name = "yubinNo", length = 13, order = 26)
    public RString yubinNo;
    @ReportItem(name = "choikiCode", length = 20, order = 27)
    public RString choikiCode;
    @ReportItem(name = "gyoseikuCode", length = 20, order = 28)
    public RString gyoseikuCode;
    @ReportItem(name = "shichosonCode", length = 13, order = 29)
    public RString shichosonCode;
    @ReportItem(name = "shimei50onKana", length = 30, order = 30)
