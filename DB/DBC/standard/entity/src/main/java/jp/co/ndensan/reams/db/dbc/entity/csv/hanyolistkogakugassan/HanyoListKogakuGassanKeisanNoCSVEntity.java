...
/**
 * 汎用リスト出力(高額合算計算結果連絡票情報)NO連番CSVEntityクラスです。
 *
...
public class HanyoListKogakuGassanKeisanNoCSVEntity {
    ...
    @CsvField(order = 790, name = "世帯負担総額")
    private RString 世帯負担総額;
    @CsvField(order = 800, name = "介護一部世帯負担")
    private RString 介護一部世帯負担;
    @CsvField(order = 810, name = "７０介護一部世帯負担")
    private RString 介護一部世帯負担_７０;
    @CsvField(order = 820, name = "所得区分")
    private RString 所得区分;
    @CsvField(order = 830, name = "70歳以上の者に係る所得区分")
    private RString 係る所得区分_70歳以上の者に;
    @CsvField(order = 840, name = "介護等合算算定基準額")
    private RString 介護等合算算定基準額;
    @CsvField(order = 850, name = "70歳以上介護等合算算定基準額")
    private RString 合算算定基準額_70歳以上介護等;
    @CsvField(order = 860, name = "世帯支給総額")
    private RString 世帯支給総額;
    @CsvField(order = 870, name = "うち70歳以上分世帯支給総額")
    private RString うち70歳以上分世帯支給総額;
    @CsvField(order = 880, name = "按分後支給額")
    private RString 按分後支給額;
    @CsvField(order = 890, name = "うち70歳以上分按分後支給額")
    private RString うち70歳以上分按分後支給額;
    @CsvField(order = 900, name = "介護低所得者Ⅰ再計算実施の有無")
    private RString 介護低所得者Ⅰ再計算実施の有無;
    @CsvField(order = 910, name = "70歳以上負担額合計")
    private RString 負担額合計_70歳以上;
    @CsvField(order = 920, name = "70歳以上負担額合計にかかる支給額合計")
    private RString かかる支給額合計;
    @CsvField(order = 930, name = "70歳未満負担額合計")
    private RString 負担額合計_70歳未満;
    @CsvField(order = 940, name = "負担額の合計額")
    private RString 負担額の合計額;
    @CsvField(order = 950, name = "支給額合計額")
    private RString 支給額合計額;
    @CsvField(order = 960, name = "データ区分")
    private RString データ区分;
    @CsvField(order = 970, name = "受取年月")
    private RString 受取年月;
    @CsvField(order = 980, name = "送付年月")
    private RString 送付年月;
    @CsvField(order = 990, name = "支給額計算結果連絡票作成年月日")
    private RString 支給額計算結果連絡票作成年月日;
    @CsvField(order = 1000, name = "データ種類")
