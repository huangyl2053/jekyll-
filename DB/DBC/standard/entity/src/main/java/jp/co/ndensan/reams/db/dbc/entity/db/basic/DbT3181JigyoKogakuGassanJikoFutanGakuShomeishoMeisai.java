...
/**
 * 事業高額合算自己負担額証明書明細テーブルの項目定義クラスです。
 *
 * @reamsid_L DBC-9999-012 zhujun
 */
public enum DbT3181JigyoKogakuGassanJikoFutanGakuShomeishoMeisai implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">
    ...
    private DbT3181JigyoKogakuGassanJikoFutanGakuShomeishoMeisai(int maxLength, int scale) {
