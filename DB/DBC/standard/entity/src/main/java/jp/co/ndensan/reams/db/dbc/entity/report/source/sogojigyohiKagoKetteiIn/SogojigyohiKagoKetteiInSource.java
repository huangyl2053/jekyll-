 ...
 */
public class SogojigyohiKagoKetteiInSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "futangakuTitle", length = 6, order = 30)
    public RString futangakuTitle;
    @ReportItem(name = "kensuTitle", length = 2, order = 31)
    public RString kensuTitle;
    @ReportItem(name = "tanisuTitle", length = 3, order = 32)
