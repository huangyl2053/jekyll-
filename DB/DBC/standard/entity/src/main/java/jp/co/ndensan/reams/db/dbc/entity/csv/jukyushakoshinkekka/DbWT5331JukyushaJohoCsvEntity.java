...
public class DbWT5331JukyushaJohoCsvEntity {
    ...
    private RString 訪問通所_支給限度基準額;
    private RString 訪問通所_上限管理適用期間開始年月日;
    private RString 訪問通所_上限管理適用期間終了年月日;
    private RString 短期入所_支給限度基準額;
    private RString 短期入所_上限管理適用期間開始年月日;
    private RString 短期入所_上限管理適用期間終了年月日;
    ...
    private RString 給付率;
    private RString 利用者負担適用開始年月日;
    private RString 利用者負担適用終了年月日;
    ...
    private RString 住所地特例適用開始年月日;
    private RString 住所地特例適用終了年月日;
