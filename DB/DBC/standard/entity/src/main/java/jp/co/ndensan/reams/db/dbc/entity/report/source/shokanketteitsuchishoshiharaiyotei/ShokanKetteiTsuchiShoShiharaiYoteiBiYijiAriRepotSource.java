...
/**
 * 償還払い支給（不支給）決定通知書(支払予定日あり）のReportSourceです。
 */
public class ShokanKetteiTsuchiShoShiharaiYoteiBiYijiAriRepotSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "riyuTitle", length = 12, order = 30)
    public RString riyuTitle;
    @ReportItem(name = "riyu1", length = 76, order = 31)
    ...
    @ReportItem(name = "branchBankName", order = 40)
    public RString branchBankName;
    @ReportItem(name = "torikeshiMochimono2", length = 12, order = 41)
    public RString torikeshiMochimono2;
    @ReportItem(name = "mochimono3", length = 30, order = 42)
    public RString mochimono3;
    @ReportItem(name = "shiharaiBasho", order = 43)
    public RString shiharaiBasho;
    @ReportItem(name = "shumokuTitle", length = 8, order = 44)
    public RString shumokuTitle;
    @ReportItem(name = "kouzaShu", length = 30, order = 45)
    public RString kouzaShu;
    @ReportItem(name = "torikeshiShiharaibasho", length = 12, order = 46)
    public RString torikeshiShiharaibasho;
    @ReportItem(name = "bangoTitle", length = 8, order = 47)
    public RString bangoTitle;
    @ReportItem(name = "kouzaNo", length = 10, order = 48)
    public RString kouzaNo;
    @ReportItem(name = "shiharaiStartYMD", length = 17, order = 49)
    public RString shiharaiStartYMD;
    @ReportItem(name = "kouzaMeigi", order = 50)
    public RString kouzaMeigi;
    @ReportItem(name = "torikeshiShiharaikikan", length = 12, order = 51)
    public RString torikeshiShiharaikikan;
    @ReportItem(name = "shiharaiEndYMD", length = 14, order = 52)
    public RString shiharaiEndYMD;
    @ReportItem(name = "karaFugo", length = 2, order = 53)
    public RString karaFugo;
    @ReportItem(name = "shiharaiStartHMS", length = 12, order = 54)
    public RString shiharaiStartHMS;
    @ReportItem(name = "shiharaiEndHMS", length = 12, order = 55)
    public RString shiharaiEndHMS;
    @ReportItem(name = "sihaYoYmd", length = 11, order = 56)
    public RString sihaYoYmd;
    @ReportItem(name = "tsuchibun2", order = 57)
    public RString tsuchibun2;
    @ReportItem(name = "seirino", length = 10, order = 58)
    public RString seirino;
    @ReportItem(name = "tsuchino", length = 6, order = 59)
    public RString tsuchino;
    @ReportItem(name = "remban", length = 4, order = 60)
    public RString remban;
    @ReportItem(name = "tsuchibunLarge", order = 61)
    public RString tsuchibunLarge;
    @ReportItem(name = "tsuchibunMix1", order = 62)
    public RString tsuchibunMix1;
    @ReportItem(name = "tsuchibunMix2", order = 63)
    public RString tsuchibunMix2;
    @ReportItem(name = "tsuchibunMixTwo1", order = 64)
    public RString tsuchibunMixTwo1;
    @ReportItem(name = "tsuchibunMixTwo2", order = 65)
    public RString tsuchibunMixTwo2;
    @ReportItem(name = "yubinNo", length = 8, order = 66)
    public RString yubinNo;
    @ReportItem(name = "gyoseiku2", length = 14, order = 67)
    public RString gyoseiku2;
    @ReportItem(name = "jusho4", length = 20, order = 68)
    public RString jusho4;
    @ReportItem(name = "jushoText", order = 69)
    public RString jushoText;
    @ReportItem(name = "jusho5", length = 20, order = 70)
    public RString jusho5;
    @ReportItem(name = "jusho6", length = 20, order = 71)
    public RString jusho6;
    @ReportItem(name = "katagakiText", order = 72)
    public RString katagakiText;
    @ReportItem(name = "katagaki3", length = 20, order = 73)
    public RString katagaki3;
    @ReportItem(name = "katagakiSmall2", length = 30, order = 74)
    public RString katagakiSmall2;
    @ReportItem(name = "katagaki4", length = 20, order = 75)
    public RString katagaki4;
    @ReportItem(name = "katagakiSmall1", length = 30, order = 76)
    public RString katagakiSmall1;
    @ReportItem(name = "shimei5", length = 20, order = 77)
    public RString shimei5;
    @ReportItem(name = "shimeiSmall2", length = 40, order = 78)
    public RString shimeiSmall2;
    @ReportItem(name = "shimeiText", order = 79)
    public RString shimeiText;
    @ReportItem(name = "meishoFuyo2", length = 3, order = 80)
    public RString meishoFuyo2;
    @ReportItem(name = "shimeiSmall1", length = 40, order = 81)
    public RString shimeiSmall1;
    @ReportItem(name = "dainoKubunMei", length = 8, order = 82)
    public RString dainoKubunMei;
    @ReportItem(name = "shimei6", length = 20, order = 83)
    public RString shimei6;
    @ReportItem(name = "meishoFuyo1", length = 3, order = 84)
    public RString meishoFuyo1;
    @ReportItem(name = "samabunShimeiText", order = 85)
    public RString samabunShimeiText;
    @ReportItem(name = "samaBun2", length = 3, order = 86)
    public RString samaBun2;
    @ReportItem(name = "samabunShimeiSmall2", length = 40, order = 87)
    public RString samabunShimeiSmall2;
    @ReportItem(name = "kakkoRight2", length = 1, order = 88)
    public RString kakkoRight2;
    @ReportItem(name = "kakkoLeft2", length = 1, order = 89)
    public RString kakkoLeft2;
    @ReportItem(name = "samabunShimei2", length = 20, order = 90)
    public RString samabunShimei2;
    @ReportItem(name = "kakkoRight1", length = 1, order = 91)
    public RString kakkoRight1;
    @ReportItem(name = "kakkoLeft1", length = 1, order = 92)
    public RString kakkoLeft1;
    @ReportItem(name = "samabunShimei1", length = 20, order = 93)
    public RString samabunShimei1;
    @ReportItem(name = "samaBun1", length = 3, order = 94)
    public RString samaBun1;
    @ReportItem(name = "samabunShimeiSmall1", length = 40, order = 95)
    public RString samabunShimeiSmall1;
    @ReportItem(name = "customerBarCode", order = 96)
    public RString customerBarCode;
    @ReportItem(name = "hakkoYMD", length = 12, order = 97)
    public RString hakkoYMD;
    @ReportItem(name = "denshiKoin", order = 98)
    public RString denshiKoin;
    @ReportItem(name = "ninshoshaYakushokuMei", length = 15, order = 99)
    public RString ninshoshaYakushokuMei;
    @ReportItem(name = "ninshoshaYakushokuMei1", order = 100)
    public RString ninshoshaYakushokuMei1;
    @ReportItem(name = "koinMojiretsu", length = 4, order = 101)
    public RString koinMojiretsu;
    @ReportItem(name = "ninshoshaYakushokuMei2", order = 102)
    public RString ninshoshaYakushokuMei2;
    @ReportItem(name = "ninshoshaShimeiKakenai", order = 103)
    public RString ninshoshaShimeiKakenai;
    @ReportItem(name = "ninshoshaShimeiKakeru", order = 104)
    public RString ninshoshaShimeiKakeru;
    @ReportItem(name = "koinShoryaku", length = 15, order = 105)
