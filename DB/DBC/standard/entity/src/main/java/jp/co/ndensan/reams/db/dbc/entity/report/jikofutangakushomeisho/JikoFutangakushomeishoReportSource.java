package jp.co.ndensan.reams.db.dbc.entity.report.jikofutangakushomeisho;
...
/**
 * 自己負担証明書のReportSourceクラスです。
 *
 * @reamsid_L DBC-4810-030 sunhaidi
 */
public class JikoFutangakushomeishoReportSource implements IReportSource {
