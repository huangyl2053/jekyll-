 ...
 */
package jp.co.ndensan.reams.db.dbc.entity.report.source.kogakuservicehisofuichiran;
...
/**
 * 帳票設計_DBC200019_高額介護サービス費給付判定結果送付一覧表 のソースクラスです。
 *
 * @reamsid_L DBC-2610-040 qinzhen
 */
public class KogakuServicehiSofuIchiranSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listCenter_1", length = 5, order = 15)
    public RString listCenter_1;
    @ReportItem(name = "listCenter_2", length = 10, order = 16)
    public RString listCenter_2;
    @ReportItem(name = "listCenter_3", length = 20, order = 17)
    public RString listCenter_3;
    @ReportItem(name = "listLower_1", length = 15, order = 18)
    public RString listLower_1;
    @ReportItem(name = "listUpper_1", length = 25, order = 19)
    public RString listUpper_1;
    @ReportItem(name = "listLower_2", length = 9, order = 20)
    public RString listLower_2;
    @ReportItem(name = "listUpper_2", length = 11, order = 21)
    public RString listUpper_2;
    @ReportItem(name = "listLower_3", length = 20, order = 22)
    public RString listLower_3;
    @ReportItem(name = "listUpper_3", length = 8, order = 23)
    public RString listUpper_3;
    @ReportItem(name = "listLower_4", length = 6, order = 24)
    public RString listLower_4;
    @ReportItem(name = "listUpper_4", length = 30, order = 25)
    public RString listUpper_4;
    @ReportItem(name = "listLower_5", length = 5, order = 26)
    public RString listLower_5;
    @ReportItem(name = "listUpper_5", length = 10, order = 27)
    public RString listUpper_5;
    @ReportItem(name = "listLower_6", length = 5, order = 28)
    public RString listLower_6;
    @ReportItem(name = "listUpper_6", length = 7, order = 29)
    public RString listUpper_6;
    @ReportItem(name = "listLower_7", length = 10, order = 30)
    public RString listLower_7;
    @ReportItem(name = "listUpper_7", length = 20, order = 31)
    public RString listUpper_7;
    @ReportItem(name = "listLower_8", length = 7, order = 32)
