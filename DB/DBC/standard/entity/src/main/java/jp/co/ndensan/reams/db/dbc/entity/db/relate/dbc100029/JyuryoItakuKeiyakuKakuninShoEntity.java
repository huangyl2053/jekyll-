 ...
 */
package jp.co.ndensan.reams.db.dbc.entity.db.relate.dbc100029;
...
/**
 * 帳票設計_DBCMN32002_介護保険受領委任契約承認（不承認）確認書（利用者向け）のEntityクラスです
 *
...
public class JyuryoItakuKeiyakuKakuninShoEntity {
