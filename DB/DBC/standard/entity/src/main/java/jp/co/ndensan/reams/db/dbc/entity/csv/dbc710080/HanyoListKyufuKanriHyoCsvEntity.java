...
/**
 * 汎用リスト(給付管理票)CSVデータのEntityクラスです。
 *
...
public class HanyoListKyufuKanriHyoCsvEntity {
     ...
     * コンストラクタです。
     */
    public HanyoListKyufuKanriHyoCsvEntity() {
    }
     ...
     * @param 受給直近事由 受給直近事由
     */
    public HanyoListKyufuKanriHyoCsvEntity(RString 連番, RString 識別コード, RString 住民種別, RString 氏名, RString 氏名カナ,
            RString 生年月日, RString 年齢, RString 性別, RString 続柄コード, RString 世帯コード, RString 世帯主名, RString 住所コード,
            RString 郵便番号, RString 住所番地方書, RString 住所, RString 番地, RString 方書, RString 行政区コード, RString 行政区名,
            RString 地区１, RString 地区２, RString 地区３, RString 連絡先１, RString 連絡先２, RString 登録異動日, RString 登録事由,
            RString 登録届出日, RString 住定異動日, RString 住定事由, RString 住定届出日, RString 消除異動日, RString 消除事由,
            RString 消除届出日, RString 転出入理由, RString 前住所郵便番号, RString 前住所番地方書, RString 前住所, RString 前住所番地,
            RString 前住所方書, RString 市町村コード, RString 市町村名, RString 保険者コード, RString 保険者名, RString 空白,
            RString 被保険者番号, RString 資格取得事由, RString 資格取得日, RString 資格取得届出日, RString 喪失事由, RString 資格喪失日,
            RString 資格喪失届日, RString 資格区分, RString 住所地特例状態, RString 資格証記載保険者番号, RString 審査年月,
            RString サービス年月, RString 明細行番号, RString 計画事業者番号, RString 計画事業者名, RString 保険者番号,
            RString 管理票作成日, RString 管理票作成区分, RString 管理票種別区分, RString 管理票生年月日, RString 管理票性別,
            RString 管理票要介護度, RString 限度額適用開始, RString 限度額適用終了, RString 支給限度額, RString 計画作成区分,
            RString サービス事業者番号, RString サービス事業者名, RString 事業者区分, RString サービス種類, RString サービス種類名,
            RString 給付計画単位日数, RString 前月まで計画日数, RString 指定サービス小計, RString 基準該当サービス小計, RString 合計単位日数,
            RString 担当介護支援専門員番号, RString 委託先の居宅介護支援事業者番号, RString 委託先の居宅介護支援事業者名,
            RString 委託先の担当介護支援専門員番号, RString 受給申請事由, RString 受給申請日, RString 受給要介護度, RString 受給認定開始日,
            RString 受給認定終了日, RString 受給認定日, RString 受給旧措置, RString 受給みなし更新認定, RString 受給直近事由) {
        this.連番 = 連番;
        this.識別コード = 識別コード;
        this.住民種別 = 住民種別;
        this.氏名 = 氏名;
