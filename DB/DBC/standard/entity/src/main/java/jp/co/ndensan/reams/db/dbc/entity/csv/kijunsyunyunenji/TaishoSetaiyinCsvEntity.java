...
public class TaishoSetaiyinCsvEntity {
    ...
    @CsvField(order = 50, name = "年少扶養控除_16歳未満人数")
    private Integer 年少扶養控除_16歳未満人数;
    @CsvField(order = 60, name = "年少扶養控除_16歳から18歳人数")
    ...
    @CsvField(order = 150, name = "課税所得_控除後")
    ...
    @CsvField(order = 190, name = "宛名データ種別_1231")
    private RString 宛名データ種別_1231;
    @CsvField(order = 200, name = "宛名データ種別_基準日")
    private RString 宛名データ種別_基準日;
    @CsvField(order = 210, name = "氏名")
    private RString 氏名;
    @CsvField(order = 220, name = "氏名カナ")
    private RString 氏名カナ;
    @CsvField(order = 230, name = "性別")
    private RString 性別;
    @CsvField(order = 240, name = "生年月日")
    private RString 生年月日;
    @CsvField(order = 250, name = "資格区分")
    private RString 資格区分;
    @CsvField(order = 260, name = "受給区分")
    private RString 受給区分;
    @CsvField(order = 270, name = "要介護度")
    private RString 要介護度;
    @CsvField(order = 280, name = "認定開始日")
    private RString 認定開始日;
    @CsvField(order = 290, name = "認定終了日")
    private RString 認定終了日;
    @CsvField(order = 300, name = "適用開始日")
    private RString 適用開始日;
    @CsvField(order = 310, name = "適用終了日")
