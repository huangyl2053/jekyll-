 ...
 */
public class DbT3106ShokanMeisaiJushochiTokureiEntity extends DbTableEntityBase<DbT3106ShokanMeisaiJushochiTokureiEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    @TableName
    public static final RString TABLE_NAME = new RString("DbT3106ShokanMeisaiJushochiTokurei");
    ...
    private DbUDD015ShoKisaiHokenshaNo shisetsuShozaiHokenshaNo;
     ...
     * @return 施設所在保険者番号
     */
    public DbUDD015ShoKisaiHokenshaNo getShisetsuShozaiHokenshaNo() {
     ...
     */
    public void setShisetsuShozaiHokenshaNo(DbUDD015ShoKisaiHokenshaNo shisetsuShozaiHokenshaNo) {
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT3106ShokanMeisaiJushochiTokureiEntity}と等しいか判定します。
     * 
     * @param other 比較するエンティティ
     * @@return 
     * 比較するエンティティが同じ主キーを持つ{@literal DbT3106ShokanMeisaiJushochiTokureiEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT3106ShokanMeisaiJushochiTokureiEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT3106ShokanMeisaiJushochiTokureiEntity entity) {
