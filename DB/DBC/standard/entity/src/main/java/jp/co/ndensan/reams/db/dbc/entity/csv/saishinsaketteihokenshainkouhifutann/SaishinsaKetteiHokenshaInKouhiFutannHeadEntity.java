...
/**
 * 再審査決定通知書情報取込共通処理（公費負担者分・ファイル読込）のheadEntity。
 *
...
public class SaishinsaKetteiHokenshaInKouhiFutannHeadEntity {
    ...
    @CsvField(order = 60, name = "公費負担者番号")
    private RString 公費負担者番号;
    @CsvField(order = 70, name = "公費負担者名")
