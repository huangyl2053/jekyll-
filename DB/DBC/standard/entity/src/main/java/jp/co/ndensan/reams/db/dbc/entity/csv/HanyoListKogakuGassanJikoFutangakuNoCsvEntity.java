...
public class HanyoListKogakuGassanJikoFutangakuNoCsvEntity {
    ...
    @CsvField(order = 630, name = " 受給申請事由")
    private RString 受給申請事由;
    @CsvField(order = 640, name = " 受給申請日")
    private RString 受給申請日;
    @CsvField(order = 650, name = " 受給要介護度")
    private RString 受給要介護度;
    @CsvField(order = 660, name = " 受給認定開始日")
    private RString 受給認定開始日;
    @CsvField(order = 670, name = " 受給認定終了日")
    private RString 受給認定終了日;
    @CsvField(order = 680, name = " 受給認定日")
    private RString 受給認定日;
    @CsvField(order = 690, name = " 受給旧措置")
    private RString 受給旧措置;
    @CsvField(order = 700, name = " 受給みなし更新認定")
    private RString 受給みなし更新認定;
    @CsvField(order = 710, name = " 受給直近事由")
    private RString 受給直近事由;
    @CsvField(order = 720, name = " 対象年度")
    private RString 対象年度;
    @CsvField(order = 730, name = " 保険者番号")
    private RString 保険者番号;
    @CsvField(order = 740, name = " 支給申請書整理番号")
    private RString 支給申請書整理番号;
    @CsvField(order = 750, name = " 履歴番号")
    private RString 履歴番号;
    @CsvField(order = 760, name = " 所得区分")
    private RString 所得区分;
    @CsvField(order = 770, name = " 70歳以上の者に係る所得区分")
    private RString 所得区分_70歳以上;
    @CsvField(order = 780, name = " 自己負担額証明書整理番号")
    private RString 自己負担額証明書整理番号;
    @CsvField(order = 790, name = " 異動区分")
    private RString 異動区分;
    @CsvField(order = 800, name = " 補正済自己負担額送付区分")
    private RString 補正済自己負担額送付区分;
    @CsvField(order = 810, name = " 対象計算期間（開始）")
    private RString 対象計算期間_開始;
    @CsvField(order = 820, name = " 対象計算期間（終了）")
    private RString 対象計算期間_終了;
    @CsvField(order = 830, name = " 被保険者期間（開始）")
    private RString 被保険者期間_開始;
    @CsvField(order = 840, name = " 被保険者期間（終了）")
    private RString 被保険者期間_終了;
    @CsvField(order = 850, name = " 申請年月日")
    private RString 申請年月日;
    @CsvField(order = 860, name = " 当０４・自己負担額")
    private RString 当０４_自己負担額;
    @CsvField(order = 870, name = " 当０４・７０－７４")
    private RString 当０４_７０_７４;
    @CsvField(order = 880, name = " 当０４・高額支給額")
    private RString 当０４_高額支給額;
    @CsvField(order = 890, name = " 当０５・自己負担額")
    private RString 当０５_自己負担額;
    @CsvField(order = 900, name = " 当０５・７０－７４")
    private RString 当０５_７０_７４;
    @CsvField(order = 910, name = " 当０５・高額支給額")
    private RString 当０５_高額支給額;
    @CsvField(order = 920, name = " 当０６・自己負担額")
    private RString 当０６_自己負担額;
    @CsvField(order = 930, name = " 当０６・７０－７４")
    private RString 当０６_７０_７４;
    @CsvField(order = 940, name = " 当０６・高額支給額")
    private RString 当０６_高額支給額;
    @CsvField(order = 950, name = " 当０７・自己負担額")
    private RString 当０７_自己負担額;
    @CsvField(order = 960, name = " 当０７・７０－７４")
    private RString 当０７_７０_７４;
    @CsvField(order = 970, name = " 当０７・高額支給額")
    private RString 当０７_高額支給額;
    @CsvField(order = 980, name = " 当０８・自己負担額")
    private RString 当０８_自己負担額;
    @CsvField(order = 990, name = " 当０８・７０－７４")
    private RString 当０８_７０_７４;
    @CsvField(order = 1000, name = " 当０８・高額支給額")
    private RString 当０８_高額支給額;
    @CsvField(order = 1010, name = " 当０９・自己負担額")
    private RString 当０９_自己負担額;
    @CsvField(order = 1020, name = " 当０９・７０－７４")
    private RString 当０９_７０_７４;
    @CsvField(order = 1030, name = " 当０９・高額支給額")
    private RString 当０９_高額支給額;
    @CsvField(order = 1040, name = " 当１０・自己負担額")
    private RString 当１０_自己負担額;
    @CsvField(order = 1050, name = " 当１０・７０－７４")
    private RString 当１０_７０_７４;
    @CsvField(order = 1060, name = " 当１０・高額支給額")
    private RString 当１０_高額支給額;
    @CsvField(order = 1070, name = " 当１１・自己負担額")
    private RString 当１１_自己負担額;
    @CsvField(order = 1080, name = " 当１１・７０－７４")
    private RString 当１１_７０_７４;
    @CsvField(order = 1090, name = " 当１１・高額支給額")
    private RString 当１１_高額支給額;
    @CsvField(order = 1100, name = " 当１２・自己負担額")
    private RString 当１２_自己負担額;
    @CsvField(order = 1110, name = " 当１２・７０－７４")
    private RString 当１２_７０_７４;
    @CsvField(order = 1120, name = " 当１２・高額支給額")
    private RString 当１２_高額支給額;
    @CsvField(order = 1130, name = " 翌０１・自己負担額")
    private RString 翌０１_自己負担額;
    @CsvField(order = 1140, name = " 翌０１・７０－７４")
    private RString 翌０１_７０_７４;
    @CsvField(order = 1150, name = " 翌０１・高額支給額")
    private RString 翌０１_高額支給額;
    @CsvField(order = 1160, name = " 翌０２・自己負担額")
    private RString 翌０２_自己負担額;
    @CsvField(order = 1170, name = " 翌０２・７０－７４")
    private RString 翌０２_７０_７４;
    @CsvField(order = 1180, name = " 翌０２・高額支給額")
    private RString 翌０２_高額支給額;
    @CsvField(order = 1190, name = " 翌０３・自己負担額")
    private RString 翌０３_自己負担額;
    @CsvField(order = 1200, name = " 翌０３・７０－７４")
    private RString 翌０３_７０_７４;
    @CsvField(order = 1210, name = " 翌０３・高額支給額")
    private RString 翌０３_高額支給額;
    @CsvField(order = 1220, name = " 翌０４・自己負担額")
    private RString 翌０４_自己負担額;
    @CsvField(order = 1230, name = " 翌０４・７０－７４")
    private RString 翌０４_７０_７４;
    @CsvField(order = 1240, name = " 翌０４・高額支給額")
    private RString 翌０４_高額支給額;
    @CsvField(order = 1250, name = " 翌０５・自己負担額")
    private RString 翌０５_自己負担額;
    @CsvField(order = 1260, name = " 翌０５・７０－７４")
    private RString 翌０５_７０_７４;
    @CsvField(order = 1270, name = " 翌０５・高額支給額")
    private RString 翌０５_高額支給額;
    @CsvField(order = 1280, name = " 翌０６・自己負担額")
    private RString 翌０６_自己負担額;
    @CsvField(order = 1290, name = " 翌０６・７０－７４")
    private RString 翌０６_７０_７４;
    @CsvField(order = 1300, name = " 翌０６・高額支給額")
    private RString 翌０６_高額支給額;
    @CsvField(order = 1310, name = " 翌０７・自己負担額")
    private RString 翌０７_自己負担額;
    @CsvField(order = 1320, name = " 翌０７・７０－７４")
    private RString 翌０７_７０_７４;
    @CsvField(order = 1330, name = " 翌０７・高額支給額")
    private RString 翌０７_高額支給額;
    @CsvField(order = 1340, name = " 合計・自己負担額")
    private RString 合計_自己負担額;
    @CsvField(order = 1350, name = " 合計・７０－７４")
    private RString 合計_７０_７４;
    @CsvField(order = 1360, name = " 合計・高額支給額")
    private RString 合計_高額支給額;
    @CsvField(order = 1370, name = " 補当０４・自己負担額")
    private RString 補当０４_自己負担額;
    @CsvField(order = 1380, name = " 補当０４・７０－７４")
    private RString 補当０４_７０_７４;
    @CsvField(order = 1390, name = " 補当０４・高額支給額")
    private RString 補当０４_高額支給額;
    @CsvField(order = 1400, name = " 補当０５・自己負担額")
    private RString 補当０５_自己負担額;
    @CsvField(order = 1410, name = " 補当０５・７０－７４")
    private RString 補当０５_７０_７４;
    @CsvField(order = 1420, name = " 補当０５・高額支給額")
    private RString 補当０５_高額支給額;
    @CsvField(order = 1430, name = " 補当０６・自己負担額")
    private RString 補当０６_自己負担額;
    @CsvField(order = 1440, name = " 補当０６・７０－７４")
    private RString 補当０６_７０_７４;
    @CsvField(order = 1450, name = " 補当０６・高額支給額")
    private RString 補当０６_高額支給額;
    @CsvField(order = 1460, name = " 補当０７・自己負担額")
    private RString 補当０７_自己負担額;
    @CsvField(order = 1470, name = " 補当０７・７０－７４")
    private RString 補当０７_７０_７４;
    @CsvField(order = 1480, name = " 補当０７・高額支給額")
    private RString 補当０７_高額支給額;
    @CsvField(order = 1490, name = " 補当０８・自己負担額")
    private RString 補当０８_自己負担額;
    @CsvField(order = 1500, name = " 補当０８・７０－７４")
    private RString 補当０８_７０_７４;
    @CsvField(order = 1510, name = " 補当０８・高額支給額")
    private RString 補当０８_高額支給額;
    @CsvField(order = 1520, name = " 補当０９・自己負担額")
    private RString 補当０９_自己負担額;
    @CsvField(order = 1530, name = " 補当０９・７０－７４")
    private RString 補当０９_７０_７４;
    @CsvField(order = 1540, name = " 補当０９・高額支給額")
    private RString 補当０９_高額支給額;
    @CsvField(order = 1550, name = " 補当１０・自己負担額")
    private RString 補当１０_自己負担額;
    @CsvField(order = 1560, name = " 補当１０・７０－７４")
    private RString 補当１０_７０_７４;
    @CsvField(order = 1570, name = " 補当１０・高額支給額")
    private RString 補当１０_高額支給額;
    @CsvField(order = 1580, name = " 補当１１・自己負担額")
    private RString 補当１１_自己負担額;
    @CsvField(order = 1590, name = " 補当１１・７０－７４")
    private RString 補当１１_７０_７４;
    @CsvField(order = 1600, name = " 補当１１・高額支給額")
    private RString 補当１１_高額支給額;
    @CsvField(order = 1610, name = " 補当１２・自己負担額")
    private RString 補当１２_自己負担額;
    @CsvField(order = 1620, name = " 補当１２・７０－７４")
    private RString 補当１２_７０_７４;
    @CsvField(order = 1630, name = " 補当１２・高額支給額")
    private RString 補当１２_高額支給額;
    @CsvField(order = 1640, name = " 補翌０１・自己負担額")
    private RString 補翌０１_自己負担額;
    @CsvField(order = 1650, name = " 補翌０１・７０－７４")
    private RString 補翌０１_７０_７４;
    @CsvField(order = 1660, name = " 補翌０１・高額支給額")
    private RString 補翌０１_高額支給額;
    @CsvField(order = 1670, name = " 補翌０２・自己負担額")
    private RString 補翌０２_自己負担額;
    @CsvField(order = 1680, name = " 補翌０２・７０－７４")
    private RString 補翌０２_７０_７４;
    @CsvField(order = 1690, name = " 補翌０２・高額支給額")
    private RString 補翌０２_高額支給額;
    @CsvField(order = 1700, name = " 補翌０３・自己負担額")
    private RString 補翌０３_自己負担額;
    @CsvField(order = 1710, name = " 補翌０３・７０－７４")
    private RString 補翌０３_７０_７４;
    @CsvField(order = 1720, name = " 補翌０３・高額支給額")
    private RString 補翌０３_高額支給額;
    @CsvField(order = 1730, name = " 補翌０４・自己負担額")
    private RString 補翌０４_自己負担額;
    @CsvField(order = 1740, name = " 補翌０４・７０－７４")
    private RString 補翌０４_７０_７４;
    @CsvField(order = 1750, name = " 補翌０４・高額支給額")
    private RString 補翌０４_高額支給額;
    @CsvField(order = 1760, name = " 補翌０５・自己負担額")
    private RString 補翌０５_自己負担額;
    @CsvField(order = 1770, name = " 補翌０５・７０－７４")
    private RString 補翌０５_７０_７４;
    @CsvField(order = 1780, name = " 補翌０５・高額支給額")
    private RString 補翌０５_高額支給額;
    @CsvField(order = 1790, name = " 補翌０６・自己負担額")
    private RString 補翌０６_自己負担額;
    @CsvField(order = 1800, name = " 補翌０６・７０－７４")
    private RString 補翌０６_７０_７４;
    @CsvField(order = 1810, name = " 補翌０６・高額支給額")
    private RString 補翌０６_高額支給額;
    @CsvField(order = 1820, name = " 補翌０７・自己負担額")
    private RString 補翌０７_自己負担額;
    @CsvField(order = 1830, name = " 補翌０７・７０－７４")
    private RString 補翌０７_７０_７４;
    @CsvField(order = 1840, name = " 補翌０７・高額支給額")
    private RString 補翌０７_高額支給額;
    @CsvField(order = 1850, name = " 補合計・自己負担額")
    private RString 補合計_自己負担額;
    @CsvField(order = 1860, name = " 補合計・７０－７４")
    private RString 補合計_７０_７４;
    @CsvField(order = 1870, name = " 補合計・高額支給額")
    private RString 補合計_高額支給額;
    @CsvField(order = 1880, name = " データ作成区分")
    private RString データ作成区分;
    @CsvField(order = 1890, name = " 自己負担額確認情報受取年月")
    private RString 自己負担額確認情報受取年月;
    @CsvField(order = 1900, name = " 補正済自己負担額情報送付年月")
    private RString 補正済自己負担額情報送付年月;
    @CsvField(order = 1910, name = " 自己負担額証明書情報受取年月")
    private RString 自己負担額証明書情報受取年月;
    @CsvField(order = 1920, name = " 送付対象外フラグ")
    private RString 送付対象外フラグ;
    @CsvField(order = 1930, name = " 自己負担額計算年月日")
    private RString 自己負担額計算年月日;
    @CsvField(order = 1940, name = " 自己負担額証明書作成年月日")
    private RString 自己負担額証明書作成年月日;
    @CsvField(order = 1950, name = " バッチ補正実施年月日")
    private RString バッチ補正実施年月日;
    @CsvField(order = 1960, name = " リアル補正実施年月日")
