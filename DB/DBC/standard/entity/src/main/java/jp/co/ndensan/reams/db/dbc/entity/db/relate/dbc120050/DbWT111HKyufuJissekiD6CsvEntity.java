...
@lombok.Getter
@lombok.Setter
public class DbWT111HKyufuJissekiD6CsvEntity {
    ...
    @CsvField(order = 120, name = "福祉用具販売年月日")
    private FlexibleDate 福祉用具販売年月日;
    @CsvField(order = 130, name = "福祉用具商品名")
    private RString 福祉用具商品名;
    @CsvField(order = 140, name = "福祉用具種目コード")
    private RString 福祉用具種目コード;
    @CsvField(order = 150, name = "福祉用具製造事業者名")
    private RString 福祉用具製造事業者名;
    @CsvField(order = 160, name = "福祉用具販売事業者名")
    private RString 福祉用具販売事業者名;
    @CsvField(order = 170, name = "販売金額")
    private Decimal 販売金額;
    @CsvField(order = 180, name = "摘要_品目コード")
    private RString 摘要_品目コード;
    @CsvField(order = 190, name = "審査年月")
