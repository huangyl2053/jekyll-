 ...
 */
package jp.co.ndensan.reams.db.dbc.entity.report.jukyushakoshinkekkaichiran;

import jp.co.ndensan.reams.uz.uza.io.csv.CsvField;
import jp.co.ndensan.reams.uz.uza.lang.RString;

/**
 * 国保連保有受給者ファイル出力Entity項目定義クラスです。
 *
...
public class KokuhorenJukyushaOutCsvEntity {
    ...
    private RString 行政区;
    @CsvField(order = 150, name = "町域コード")
    private RString 町域コード;
    @CsvField(order = 160, name = "住所")
    private RString 住所;
    @CsvField(order = 170, name = "生年月日")
    private RString 生年月日;
    @CsvField(order = 180, name = "性別")
    private RString 性別;
    @CsvField(order = 190, name = "性別名称")
    private RString 性別名称;
    @CsvField(order = 200, name = "資格取得日")
    private RString 資格取得日;
    @CsvField(order = 210, name = "資格喪失日")
    private RString 資格喪失日;
    @CsvField(order = 220, name = "みなし区分")
    private RString みなし区分;
    @CsvField(order = 230, name = "みなし区分名称")
    private RString みなし区分名称;
    @CsvField(order = 240, name = "要介護区分")
    private RString 要介護区分;
    @CsvField(order = 250, name = "要介護区分名称")
    private RString 要介護区分名称;
    @CsvField(order = 260, name = "有効開始日")
    private RString 有効開始日;
    @CsvField(order = 270, name = "有効終了日")
    private RString 有効終了日;
    @CsvField(order = 280, name = "申請種別")
    private RString 申請種別;
    @CsvField(order = 290, name = "申請種別名称")
    private RString 申請種別名称;
    @CsvField(order = 300, name = "変更申請区分")
    private RString 変更申請区分;
    @CsvField(order = 310, name = "変更申請区分名称")
    private RString 変更申請区分名称;
    @CsvField(order = 320, name = "申請日")
    private RString 申請日;
    @CsvField(order = 330, name = "計画作成区分")
    private RString 計画作成区分;
    @CsvField(order = 340, name = "計画作成区分名称")
    private RString 計画作成区分名称;
    @CsvField(order = 350, name = "計画作成適用開始日")
    private RString 計画作成適用開始日;
    @CsvField(order = 360, name = "計画作成適用終了日")
    private RString 計画作成適用終了日;
    @CsvField(order = 370, name = "支援事業者番号")
    private RString 支援事業者番号;
    @CsvField(order = 380, name = "訪問通所支給限度基準額")
    private RString 訪問通所支給限度基準額;
    @CsvField(order = 390, name = "訪問通所管理開始日")
    private RString 訪問通所管理開始日;
    @CsvField(order = 400, name = "訪問通所管理終了日")
    private RString 訪問通所管理終了日;
    @CsvField(order = 410, name = "短期入所支給限度基準額")
    private RString 短期入所支給限度基準額;
    @CsvField(order = 420, name = "短期入所管理開始日")
    private RString 短期入所管理開始日;
    @CsvField(order = 430, name = "短期入所管理終了日")
    private RString 短期入所管理終了日;
    @CsvField(order = 440, name = "標準負担区分")
    private RString 標準負担区分;
    @CsvField(order = 450, name = "標準負担区分名称")
    private RString 標準負担区分名称;
    @CsvField(order = 460, name = "標準負担額")
    private RString 標準負担額;
    @CsvField(order = 470, name = "標準負担適用開始日")
    private RString 標準負担適用開始日;
    @CsvField(order = 480, name = "標準負担適用終了日")
    private RString 標準負担適用終了日;
    @CsvField(order = 490, name = "減免中区分")
    private RString 減免中区分;
    @CsvField(order = 500, name = "減免中区分名称")
    private RString 減免中区分名称;
    @CsvField(order = 510, name = "利用者負担区分")
    private RString 利用者負担区分;
    @CsvField(order = 520, name = "利用者負担区分名称")
    private RString 利用者負担区分名称;
    @CsvField(order = 530, name = "給付率")
    private RString 給付率;
    @CsvField(order = 540, name = "利用者負担適用開始日")
    private RString 利用者負担適用開始日;
    @CsvField(order = 550, name = "利用者負担適用終了日")
    private RString 利用者負担適用終了日;
    @CsvField(order = 560, name = "公費負担上限額減額")
    private RString 公費負担上限額減額;
    @CsvField(order = 570, name = "公費負担上限額減額名称")
    private RString 公費負担上限額減額名称;
    @CsvField(order = 580, name = "償還払化開始日")
    private RString 償還払化開始日;
    @CsvField(order = 590, name = "償還払化終了日")
    private RString 償還払化終了日;
    @CsvField(order = 600, name = "給付率引下げ開始日")
    private RString 給付率引下げ開始日;
    @CsvField(order = 610, name = "給付率引下げ終了日")
    private RString 給付率引下げ終了日;
    @CsvField(order = 620, name = "住所地特例区分")
    private RString 住所地特例区分;
    @CsvField(order = 630, name = "住所地特例区分名称")
    private RString 住所地特例区分名称;
    @CsvField(order = 640, name = "住所地特例施設所在保険者番号")
    private RString 住所地特例施設所在保険者番号;
    @CsvField(order = 650, name = "住所地特例適用開始日")
    private RString 住所地特例適用開始日;
    @CsvField(order = 660, name = "住所地特例適用終了日")
    private RString 住所地特例適用終了日;
    @CsvField(order = 670, name = "老人保健市町村番号")
    ...
    @CsvField(order = 710, name = "小規模居宅サービス利用の有無名称")
    private RString 小規模居宅サービス利用の有無名称;
    @CsvField(order = 720, name = "有料老人ホーム等同意書")
    private RString 有料老人ホーム等同意書;
    @CsvField(order = 730, name = "有料老人ホーム等同意書名称")
    private RString 有料老人ホーム等同意書名称;
