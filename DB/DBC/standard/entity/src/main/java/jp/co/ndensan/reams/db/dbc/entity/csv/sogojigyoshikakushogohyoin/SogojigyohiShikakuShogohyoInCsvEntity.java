 ...
 */
package jp.co.ndensan.reams.db.dbc.entity.csv.sogojigyoshikakushogohyoin;
...
public class SogojigyohiShikakuShogohyoInCsvEntity {
    ...
    @CsvField(order = 180, name = "限度額適用期間（開始）")
    private RString 限度額適用期間_開始;
    @CsvField(order = 190, name = "限度額適用期間（終了）")
    private RString 限度額適用期間_終了;
    @CsvField(order = 200, name = "支給限度額")
    private RString 支給限度額;
    @CsvField(order = 210, name = "居宅サービス計画作成区分コード")
    private RString 居宅サービス計画作成区分コード;
    @CsvField(order = 220, name = "居宅サービス計画作成区分")
    private RString 居宅サービス計画作成区分;
    @CsvField(order = 230, name = "支援事業者番号")
    private RString 支援事業者番号;
    @CsvField(order = 240, name = "単位数単価")
    private RString 単位数単価;
    @CsvField(order = 250, name = "保険給付率")
    private RString 保険給付率;
    @CsvField(order = 260, name = "公費1給付率")
    private RString 公費1給付率;
    @CsvField(order = 270, name = "公費2給付率")
    private RString 公費2給付率;
    @CsvField(order = 280, name = "公費3給付率")
    private RString 公費3給付率;
    @CsvField(order = 290, name = "サービス日数・回数")
    private RString サービス日数_回数;
    @CsvField(order = 300, name = "サービス単位数")
    private RString サービス単位数;
    @CsvField(order = 310, name = "利用者負担額")
    private RString 利用者負担額;
    @CsvField(order = 320, name = "証記載保険者番号")
