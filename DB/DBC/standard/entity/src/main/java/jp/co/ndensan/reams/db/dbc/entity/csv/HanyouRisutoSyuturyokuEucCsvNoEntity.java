...
public class HanyouRisutoSyuturyokuEucCsvNoEntity {
    ...
    @CsvField(order = 810, name = "支払場所")
    private RString 支払場所;
    @CsvField(order = 820, name = "支払開始日")
    private RString 支払開始日;
    @CsvField(order = 830, name = "支払終了日")
    private RString 支払終了日;
    @CsvField(order = 840, name = "支払開始曜日")
    private RString 支払開始曜日;
    @CsvField(order = 850, name = "支払終了曜日")
    private RString 支払終了曜日;
    @CsvField(order = 860, name = "支払開始時間")
    private RString 支払開始時間;
    @CsvField(order = 870, name = "支払終了時間")
    private RString 支払終了時間;
    @CsvField(order = 880, name = "銀行郵便区分")
    private RString 銀行郵便区分;
    @CsvField(order = 890, name = "銀行コード")
    private RString 銀行コード;
    @CsvField(order = 900, name = "支店コード")
    private RString 支店コード;
    @CsvField(order = 910, name = "銀行名カナ")
    private RString 銀行名カナ;
    @CsvField(order = 920, name = "銀行名")
    private RString 銀行名;
    @CsvField(order = 930, name = "支店名カナ")
    private RString 支店名カナ;
    @CsvField(order = 940, name = "支店名")
    private RString 支店名;
    @CsvField(order = 950, name = "口座種目")
    private RString 口座種目;
    @CsvField(order = 960, name = "口座番号")
    private RString 口座番号;
    @CsvField(order = 970, name = "名義人カナ（短）")
    private RString 名義人カナ短;
    @CsvField(order = 980, name = "名義人（短）")
    private RString 名義人短;
    @CsvField(order = 990, name = "名義人カナ")
    private RString 名義人カナ;
    @CsvField(order = 1000, name = "名義人")
    private RString 名義人;
    @CsvField(order = 1010, name = "サービス提供年月")
    private RString サービス提供年月;
    @CsvField(order = 1020, name = "管理番号")
    private RString 管理番号;
    @CsvField(order = 1030, name = "（給付）証記載保険者番号")
    private RString 給付証記載保険者番号;
    @CsvField(order = 1040, name = "申請日")
    private RString 申請日;
    @CsvField(order = 1050, name = "申請理由")
    private RString 申請理由;
    @CsvField(order = 1060, name = "申請区分")
    private RString 申請区分;
    @CsvField(order = 1070, name = "申請氏名")
    private RString 申請氏名;
    @CsvField(order = 1080, name = "申請氏名カナ")
    private RString 申請氏名カナ;
    @CsvField(order = 1090, name = "申請電話番号")
    private RString 申請電話番号;
    @CsvField(order = 1100, name = "申請支払額")
    private RString 申請支払額;
    @CsvField(order = 1110, name = "判定費用額")
    private RString 判定費用額;
    @CsvField(order = 1120, name = "判定利用負担額")
    private RString 判定利用負担額;
    @CsvField(order = 1130, name = "判定算定基準額")
    private RString 判定算定基準額;
    @CsvField(order = 1140, name = "判定支払済金額")
    private RString 判定支払済金額;
    @CsvField(order = 1150, name = "判定高額支給額")
    private RString 判定高額支給額;
    @CsvField(order = 1160, name = "受付日")
    private RString 受付日;
    @CsvField(order = 1170, name = "決定日")
    private RString 決定日;
    @CsvField(order = 1180, name = "保決定利用負担額")
    private RString 保決定利用負担額;
    @CsvField(order = 1190, name = "保決定支給区分")
    private RString 保決定支給区分;
    @CsvField(order = 1200, name = "保決定高額支給額")
    private RString 保決定高額支給額;
    @CsvField(order = 1210, name = "保決定不支給理由")
    private RString 保決定不支給理由;
    @CsvField(order = 1220, name = "審査方法")
    private RString 審査方法;
    @CsvField(order = 1230, name = "国決定通知書ＮＯ")
    private RString 国決定通知書ＮＯ;
    @CsvField(order = 1240, name = "国決定利用負担額")
    private RString 国決定利用負担額;
    @CsvField(order = 1250, name = "国決定支給区分")
    private RString 国決定支給区分;
    @CsvField(order = 1260, name = "国決定年月")
    private RString 国決定年月;
    @CsvField(order = 1270, name = "国決定高額支給額")
    private RString 国決定高額支給額;
    @CsvField(order = 1280, name = "判定受取年月")
    private RString 判定受取年月;
    @CsvField(order = 1290, name = "保決定送付年月")
    private RString 保決定送付年月;
    @CsvField(order = 1300, name = "国決定受取年月")
    private RString 国決定受取年月;
    @CsvField(order = 1310, name = "高額対象判定年月")
    private RString 高額対象判定年月;
    @CsvField(order = 1320, name = "通知書作成日")
    private RString 通知書作成日;
    @CsvField(order = 1330, name = "振込書作成日")
    private RString 振込書作成日;
    @CsvField(order = 1340, name = "支払方法")
    private RString 支払方法;
    @CsvField(order = 1350, name = "備考（算定基準）")
    private RString 備考算定基準;
    @CsvField(order = 1360, name = "国保連委託なし")
    private RString 国保連委託なし;
    @CsvField(order = 1370, name = "高額自動償還")
    private RString 高額自動償還;
    @CsvField(order = 1380, name = "利用者負担段階")
    private RString 利用者負担段階;
    @CsvField(order = 1390, name = "受給申請事由")
    private RString 受給申請事由;
    @CsvField(order = 1400, name = "受給申請日")
    private RString 受給申請日;
    @CsvField(order = 1410, name = "受給要介護度")
    private RString 受給要介護度;
    @CsvField(order = 1420, name = "受給認定開始日")
    private RString 受給認定開始日;
    @CsvField(order = 1430, name = "受給認定終了日")
    private RString 受給認定終了日;
    @CsvField(order = 1440, name = "受給認定日")
    private RString 受給認定日;
    @CsvField(order = 1450, name = "受給旧措置")
    private RString 受給旧措置;
    @CsvField(order = 1460, name = "受給みなし更新認定")
    private RString 受給みなし更新認定;
    @CsvField(order = 1470, name = "受給直近事由")
