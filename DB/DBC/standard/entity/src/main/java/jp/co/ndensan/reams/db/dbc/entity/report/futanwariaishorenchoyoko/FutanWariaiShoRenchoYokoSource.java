package jp.co.ndensan.reams.db.dbc.entity.report.futanwariaishorenchoyoko;
...
/**
 * 帳票設計_DBC100067_負担割合証（連帳・横）のReportSourceクラスです。
 *
 * @reamsid_L DBC-4990-060 pengxingyi
 */
public class FutanWariaiShoRenchoYokoSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">

    @ReportItem(name = "ocrRenban", length = 8, order = 1)
    public RString ocrRenban;
    @ReportItem(name = "renban", length = 6, order = 2)
    public RString renban;
    @ReportItem(name = "futanWariai2", length = 3, order = 3)
    public RString futanWariai2;
    @ReportItem(name = "futanWariai1", length = 3, order = 4)
    public RString futanWariai1;
    @ReportItem(name = "kofuYmd", length = 20, order = 5)
    public RString kofuYmd;
    @ReportItem(name = "tel", length = 20, order = 6)
    public RString tel;
    @ReportItem(name = "hokenshaJusho", order = 7)
    public RString hokenshaJusho;
    @ReportItem(name = "hokenshaCode1", length = 1, order = 8)
    public RString hokenshaCode1;
    @ReportItem(name = "tekiyoShuryoYmd2", length = 17, order = 9)
    public RString tekiyoShuryoYmd2;
    @ReportItem(name = "tekiyoKaishiYmd2", length = 17, order = 10)
    public RString tekiyoKaishiYmd2;
    @ReportItem(name = "tekiyoShuryoYmd1", length = 17, order = 11)
    public RString tekiyoShuryoYmd1;
    @ReportItem(name = "tekiyoKaishiYmd1", length = 17, order = 12)
    public RString tekiyoKaishiYmd1;
    @ReportItem(name = "umareYmd", length = 12, order = 13)
    public RString umareYmd;
    @ReportItem(name = "shimei", order = 14)
    public RString shimei;
    @ReportItem(name = "kanaMei", order = 15)
    public RString kanaMei;
    @ReportItem(name = "jusho", order = 16)
    public RString jusho;
    @ReportItem(name = "hihokenshaNo", length = 25, order = 17)
    public RString hihokenshaNo;
    @ReportItem(name = "hokenshaCode2", length = 1, order = 18)
    public RString hokenshaCode2;
    @ReportItem(name = "hokenshaCode3", length = 1, order = 19)
    public RString hokenshaCode3;
    @ReportItem(name = "hokenshaCode4", length = 1, order = 20)
    public RString hokenshaCode4;
    @ReportItem(name = "hokenshaCode5", length = 1, order = 21)
    public RString hokenshaCode5;
    @ReportItem(name = "hokenshaCode6", length = 1, order = 22)
    public RString hokenshaCode6;
    @ReportItem(name = "seibetsu", length = 1, order = 23)
    public RString seibetsu;
    @ReportItem(name = "ninshosha_ninshoshaShimeiKakenai", order = 24)
    public RString ninshosha_ninshoshaShimeiKakenai;
    @ReportItem(name = "ninshosha_denshiKoin", order = 25)
