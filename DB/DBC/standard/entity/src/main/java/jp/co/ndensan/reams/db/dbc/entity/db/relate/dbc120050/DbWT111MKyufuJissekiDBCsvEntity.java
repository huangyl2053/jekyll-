...
@lombok.Getter
@lombok.Setter
public class DbWT111MKyufuJissekiDBCsvEntity {
    ...
    @CsvField(order = 110, name = "指定_基準該当事業所区分コード")
    ...
    private RString 摘要;
    @CsvField(order = 230, name = "利用者負担額")
    private int 利用者負担額;
    @CsvField(order = 240, name = "後_単位数")
    private int 後_単位数;
    @CsvField(order = 250, name = "後_回数")
    private int 後_回数;
    @CsvField(order = 260, name = "後_サービス単位数")
    private int 後_サービス単位数;
    @CsvField(order = 270, name = "後_サービス単位数合計")
    private int 後_サービス単位数合計;
    @CsvField(order = 280, name = "後_請求金額")
    private int 後_請求金額;
    @CsvField(order = 290, name = "後_利用者負担額")
    private int 後_利用者負担額;
    @CsvField(order = 300, name = "再審査回数")
    private int 再審査回数;
    @CsvField(order = 310, name = "過誤回数")
    private int 過誤回数;
    @CsvField(order = 320, name = "審査年月")
