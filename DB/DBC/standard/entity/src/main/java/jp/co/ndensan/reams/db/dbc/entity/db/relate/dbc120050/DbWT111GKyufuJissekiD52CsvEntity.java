...
@lombok.Getter
@lombok.Setter
public class DbWT111GKyufuJissekiD52CsvEntity {
    ...
    @CsvField(order = 140, name = "サービスコード")
    private ServiceCode サービスコード;
    @CsvField(order = 150, name = "単位数")
    private Decimal 単位数;
    @CsvField(order = 160, name = "請求金額")
    private Decimal 請求金額;
    @CsvField(order = 170, name = "担当介護支援専門員番号")
    private RString 担当介護支援専門員番号;
    @CsvField(order = 180, name = "摘要")
    private RString 摘要;
    @CsvField(order = 190, name = "後_単位数")
    private Decimal 後_単位数;
    @CsvField(order = 200, name = "後_請求金額")
    private Decimal 後_請求金額;
    @CsvField(order = 210, name = "再審査回数")
    private Integer 再審査回数;
    @CsvField(order = 220, name = "過誤回数")
    private Integer 過誤回数;
    @CsvField(order = 230, name = "審査年月")
