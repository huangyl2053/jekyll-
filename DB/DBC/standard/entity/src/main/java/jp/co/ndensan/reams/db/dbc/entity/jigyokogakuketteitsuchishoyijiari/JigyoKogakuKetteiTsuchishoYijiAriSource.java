 ...
 */
public class JigyoKogakuKetteiTsuchishoYijiAriSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "shiharaiEndYMD", length = 14, order = 61)
    public RString shiharaiEndYMD;
    @ReportItem(name = "kouzaMeigi", order = 62)
    ...
    @ReportItem(name = "sihaYoYmd", length = 11, order = 66)
    public RString sihaYoYmd;
    @ReportItem(name = "toiawasesaki", order = 67)
    public RString toiawasesaki;
    @ReportItem(name = "tsuchiNo", length = 6, order = 68)
    public RString tsuchiNo;
    @ReportItem(name = "remban", length = 4, order = 69)
    public RString remban;
    @ReportItem(name = "tsuchibunLarge", order = 70)
    public RString tsuchibunLarge;
    @ReportItem(name = "tsuchibunMix1", order = 71)
    public RString tsuchibunMix1;
    @ReportItem(name = "tsuchibunMix2", order = 72)
    public RString tsuchibunMix2;
    @ReportItem(name = "tsuchibunMixTwo1", order = 73)
    public RString tsuchibunMixTwo1;
    @ReportItem(name = "tsuchibunMixTwo2", order = 74)
    public RString tsuchibunMixTwo2;
    @ReportItem(name = "gyoseiku", length = 14, order = 75)
    public RString gyoseiku;
    @ReportItem(name = "yubinNo", length = 8, order = 76)
    public RString yubinNo;
    @ReportItem(name = "jusho1", length = 20, order = 77)
    public RString jusho1;
    @ReportItem(name = "jushoText", order = 78)
    public RString jushoText;
    @ReportItem(name = "jusho2", length = 20, order = 79)
    public RString jusho2;
    @ReportItem(name = "jusho3", length = 20, order = 80)
    public RString jusho3;
    @ReportItem(name = "katagakiText", order = 81)
    public RString katagakiText;
    @ReportItem(name = "katagaki1", length = 20, order = 82)
    public RString katagaki1;
    @ReportItem(name = "katagakiSmall2", length = 30, order = 83)
    public RString katagakiSmall2;
    @ReportItem(name = "katagaki2", length = 20, order = 84)
    public RString katagaki2;
    @ReportItem(name = "katagakiSmall1", length = 30, order = 85)
    public RString katagakiSmall1;
    @ReportItem(name = "meishoFuyo2", length = 3, order = 86)
    public RString meishoFuyo2;
    @ReportItem(name = "shimei1", length = 20, order = 87)
    public RString shimei1;
    @ReportItem(name = "shimeiSmall2", length = 40, order = 88)
    public RString shimeiSmall2;
    @ReportItem(name = "shimeiText", order = 89)
    public RString shimeiText;
    @ReportItem(name = "shimeiSmall1", length = 40, order = 90)
    public RString shimeiSmall1;
    @ReportItem(name = "dainoKubunMei", length = 8, order = 91)
    public RString dainoKubunMei;
    @ReportItem(name = "shimei2", length = 20, order = 92)
    public RString shimei2;
    @ReportItem(name = "meishoFuyo1", length = 3, order = 93)
    public RString meishoFuyo1;
    @ReportItem(name = "samabunShimeiText", order = 94)
    public RString samabunShimeiText;
    @ReportItem(name = "samaBun2", length = 3, order = 95)
    public RString samaBun2;
    @ReportItem(name = "samabunShimeiSmall2", length = 40, order = 96)
    public RString samabunShimeiSmall2;
    @ReportItem(name = "kakkoLeft2", length = 1, order = 97)
    public RString kakkoLeft2;
    @ReportItem(name = "kakkoRight2", length = 1, order = 98)
    public RString kakkoRight2;
    @ReportItem(name = "samabunShimei2", length = 20, order = 99)
    public RString samabunShimei2;
    @ReportItem(name = "kakkoLeft1", length = 1, order = 100)
    public RString kakkoLeft1;
    @ReportItem(name = "kakkoRight1", length = 1, order = 101)
    public RString kakkoRight1;
    @ReportItem(name = "samaBun1", length = 3, order = 102)
    public RString samaBun1;
    @ReportItem(name = "samabunShimei1", length = 20, order = 103)
    public RString samabunShimei1;
    @ReportItem(name = "samabunShimeiSmall1", length = 40, order = 104)
    public RString samabunShimeiSmall1;
    @ReportItem(name = "customerBarCode", order = 105)
    public RString customerBarCode;
    @ReportItem(name = "denshiKoin", order = 106)
    public RString denshiKoin;
    @ReportItem(name = "hakkoYMD", length = 12, order = 107)
    public RString hakkoYMD;
    @ReportItem(name = "ninshoshaYakushokuMei", length = 15, order = 108)
    public RString ninshoshaYakushokuMei;
    @ReportItem(name = "ninshoshaYakushokuMei1", order = 109)
    public RString ninshoshaYakushokuMei1;
    @ReportItem(name = "koinMojiretsu", length = 4, order = 110)
    public RString koinMojiretsu;
    @ReportItem(name = "ninshoshaYakushokuMei2", order = 111)
    public RString ninshoshaYakushokuMei2;
    @ReportItem(name = "ninshoshaShimeiKakeru", order = 112)
    public RString ninshoshaShimeiKakeru;
    @ReportItem(name = "ninshoshaShimeiKakenai", order = 113)
