...
@lombok.Getter
@lombok.Setter
public class DbWT111IKyufuJissekiD7CsvEntity {
    ...
    @CsvField(order = 110, name = "サービスコード")
    private ServiceCode サービスコード;
    @CsvField(order = 120, name = "住宅改修着工年月日")
    private FlexibleDate 住宅改修着工年月日;
    @CsvField(order = 130, name = "住宅改修事業者名")
    private RString 住宅改修事業者名;
    @CsvField(order = 140, name = "住宅改修住宅住所")
    private RString 住宅改修住宅住所;
    @CsvField(order = 150, name = "改修金額")
    private Decimal 改修金額;
    @CsvField(order = 160, name = "審査年月")
