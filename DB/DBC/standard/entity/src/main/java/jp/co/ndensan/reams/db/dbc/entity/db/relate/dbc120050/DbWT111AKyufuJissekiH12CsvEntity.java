...
@lombok.Getter
@lombok.Setter
public class DbWT111AKyufuJissekiH12CsvEntity {
    ...
    @CsvField(order = 270, name = "保険者番号_後期")
    private RString 保険者番号_後期;
    @CsvField(order = 280, name = "被保険者番号_後期")
    private RString 被保険者番号_後期;
    @CsvField(order = 290, name = "保険者番号_国保")
    private RString 保険者番号_国保;
    @CsvField(order = 300, name = "被保険者証番号_国保")
    private RString 被保険者証番号_国保;
    @CsvField(order = 310, name = "宛名番号")
    private RString 宛名番号;
    @CsvField(order = 320, name = "居宅サービス計画作成区分コード")
    private RString 居宅サービス計画作成区分コード;
    @CsvField(order = 330, name = "事業所番号_居宅介護支援事業所等")
    ...
    @CsvField(order = 360, name = "中止理由_入所院前の状況コード")
    private RString 中止理由_入所院前の状況コード;
    @CsvField(order = 370, name = "入所年月日")
    private FlexibleDate 入所年月日;
    @CsvField(order = 380, name = "退所年月日")
    private FlexibleDate 退所年月日;
    @CsvField(order = 390, name = "入所実日数")
    private int 入所実日数;
    @CsvField(order = 400, name = "外泊日数")
    private int 外泊日数;
    @CsvField(order = 410, name = "退所後の状態コード")
    ...
    @CsvField(order = 460, name = "前_保険_サービス単位数")
    private int 前_保険_サービス単位数;
    @CsvField(order = 470, name = "前_保険_請求額")
    private Decimal 前_保険_請求額;
    @CsvField(order = 480, name = "前_保険_利用者負担額")
    private int 前_保険_利用者負担額;
    @CsvField(order = 490, name = "前_保険_緊急時施設療養費請求額")
    private Decimal 前_保険_緊急時施設療養費請求額;
    @CsvField(order = 500, name = "前_保険_特定診療費請求額")
    private Decimal 前_保険_特定診療費請求額;
    @CsvField(order = 510, name = "前_保険_特定入所者介護サービス費等請求額")
    private Decimal 前_保険_特定入所者介護サービス費等請求額;
    @CsvField(order = 520, name = "前_公費１_サービス単位数")
    private int 前_公費１_サービス単位数;
    @CsvField(order = 530, name = "前_公費１_請求額")
    private int 前_公費１_請求額;
    @CsvField(order = 540, name = "前_公費２_請求額")
    private int 前_公費１_本人負担額;
    @CsvField(order = 550, name = "前_公費１_緊急時施設療養費請求額")
    private int 前_公費１_緊急時施設療養費請求額;
    @CsvField(order = 560, name = "前_公費１_特定診療費請求額")
    private int 前_公費１_特定診療費請求額;
    @CsvField(order = 570, name = "前_公費１_特定入所者介護サービス費等請求額")
    private int 前_公費１_特定入所者介護サービス費等請求額;
    @CsvField(order = 580, name = "前_公費２_サービス単位数")
    private int 前_公費２_サービス単位数;
    @CsvField(order = 590, name = "前_公費２_請求額")
    private int 前_公費２_請求額;
    @CsvField(order = 600, name = "前_公費２_本人負担額")
    private int 前_公費２_本人負担額;
    @CsvField(order = 610, name = "前_公費２_緊急時施設療養費請求額")
    private int 前_公費２_緊急時施設療養費請求額;
    @CsvField(order = 620, name = "前_公費２_特定診療費請求額")
    private int 前_公費２_特定診療費請求額;
    @CsvField(order = 630, name = "前_公費２_特定入所者介護サービス費等請求額")
    private int 前_公費２_特定入所者介護サービス費等請求額;
    @CsvField(order = 640, name = "前_公費３_サービス単位数")
    private int 前_公費３_サービス単位数;
    @CsvField(order = 650, name = "前_公費３_請求額")
    private int 前_公費３_請求額;
    @CsvField(order = 660, name = "前_公費３_本人負担額")
    private int 前_公費３_本人負担額;
    @CsvField(order = 670, name = "前_公費３_緊急時施設療養費請求額")
    private int 前_公費３_緊急時施設療養費請求額;
    @CsvField(order = 680, name = "前_公費３_特定診療費請求額")
    private int 前_公費３_特定診療費請求額;
    @CsvField(order = 690, name = "前_公費３_特定入所者介護サービス費等請求額")
    private int 前_公費３_特定入所者介護サービス費等請求額;
    @CsvField(order = 700, name = "後_保険_サービス単位数")
    private int 後_保険_サービス単位数;
    @CsvField(order = 710, name = "後_保険_請求額")
    private Decimal 後_保険_請求額;
    @CsvField(order = 720, name = "後_保険_利用者負担額")
    private int 後_保険_利用者負担額;
    @CsvField(order = 730, name = "後_保険_緊急時施設療養費請求額")
    private Decimal 後_保険_緊急時施設療養費請求額;
    @CsvField(order = 740, name = "後_保険_特定診療費請求額")
    private Decimal 後_保険_特定診療費請求額;
    @CsvField(order = 750, name = "後_保険_特定入所者介護サービス費等請求額")
    private int 後_保険_特定入所者介護サービス費等請求額;
    @CsvField(order = 760, name = "後_公費１_サービス単位数")
    private int 後_公費１_サービス単位数;
    @CsvField(order = 770, name = "後_公費１_請求額")
    private int 後_公費１_請求額;
    @CsvField(order = 780, name = "後_公費１_本人負担額")
    private int 後_公費１_本人負担額;
    @CsvField(order = 790, name = "後_公費１_緊急時施設療養費請求額")
    private int 後_公費１_緊急時施設療養費請求額;
    @CsvField(order = 800, name = "後_公費１_特定診療費請求額")
    private int 後_公費１_特定診療費請求額;
    @CsvField(order = 810, name = "後_公費１_特定入所者介護サービス費等請求額")
    private int 後_公費１_特定入所者介護サービス費等請求額;
    @CsvField(order = 820, name = "後_公費２_サービス単位数")
    private int 後_公費２_サービス単位数;
    @CsvField(order = 830, name = "後_公費２_請求額")
    private int 後_公費２_請求額;
    @CsvField(order = 840, name = "後_公費２_本人負担額")
    private int 後_公費２_本人負担額;
    @CsvField(order = 850, name = "後_公費２_緊急時施設療養費請求額")
    private int 後_公費２_緊急時施設療養費請求額;
    @CsvField(order = 860, name = "後_公費２_特定診療費請求額")
    private int 後_公費２_特定診療費請求額;
    @CsvField(order = 870, name = "後_公費２_特定入所者介護サービス費等請求額")
    private int 後_公費２_特定入所者介護サービス費等請求額;
    @CsvField(order = 880, name = "後_公費３_サービス単位数")
    private int 後_公費３_サービス単位数;
    @CsvField(order = 890, name = "後_公費３_請求額")
    private int 後_公費３_請求額;
    @CsvField(order = 900, name = "後_公費３_本人負担額")
    private int 後_公費３_本人負担額;
    @CsvField(order = 910, name = "後_公費３_緊急時施設療養費請求額")
    private int 後_公費３_緊急時施設療養費請求額;
    @CsvField(order = 920, name = "後_公費３_特定診療費請求額")
    private int 後_公費３_特定診療費請求額;
    @CsvField(order = 930, name = "後_公費３_特定入所者介護サービス費等請求額")
