package jp.co.ndensan.reams.db.dbc.entity.euc.tankinyushokakudaigaitosha;
...
/**
 * 汎用リスト_短期入所拡大該当者情報連番があるCSV用データEntityです。
 *
...
@lombok.Setter
@OnNextSchema("rgdb")
public class TankiNyushoKakudaiGaitoshaReibanNashiEUCEntity implements ITankiNyushoKakudaiGaitoshaEUCEntity {
    ...
    @CsvField(order = 59, name = "登録年月日")
    private RString 登録年月日;
    @CsvField(order = 60, name = "変更年月日")
    private RString 変更年月日;
    @CsvField(order = 61, name = "受給申請事由")
    private RString 受給申請事由;
    @CsvField(order = 62, name = "受給申請日")
    private RString 受給申請日;
    @CsvField(order = 63, name = "受給要介護度")
    private RString 受給要介護度;
    @CsvField(order = 64, name = "受給認定開始日")
    private RString 受給認定開始日;
    @CsvField(order = 65, name = "受給認定終了日")
    private RString 受給認定終了日;
    @CsvField(order = 66, name = "受給認定日")
    private RString 受給認定日;
    @CsvField(order = 67, name = "受給旧措置")
    private RString 受給旧措置;
    @CsvField(order = 68, name = "受給みなし更新認定")
    private RString 受給みなし更新認定;
    @CsvField(order = 69, name = "受給直近事由")
