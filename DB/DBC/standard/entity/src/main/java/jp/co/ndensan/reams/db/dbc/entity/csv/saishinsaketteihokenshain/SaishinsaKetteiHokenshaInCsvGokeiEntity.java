...
/**
 * 再審査決定通知書情報取込共通処理（保険者分・ファイル読込）のGokeiEntity。
 *
...
public class SaishinsaKetteiHokenshaInCsvGokeiEntity {
    ...
    @CsvField(order = 70, name = "介護給付費・請求・保険者負担額")
    private RString 介護給付費請求保険者負担額;
    ...
    @CsvField(order = 100, name = "介護給付費／総合事業費・決定・保険者負担額")
    private RString 介護給付費総合事業費決定保険者負担額;
    ...
    @CsvField(order = 130, name = "介護給付費／総合事業費・調整・保険者負担額")
    private RString 介護給付費総合事業費調整保険者負担額;
    ...
    @CsvField(order = 160, name = "高額介護サービス費・請求・保険者負担額")
    private RString 高額介護サービス費請求保険者負担額;
    ...
    @CsvField(order = 190, name = "高額介護サービス費・決定・保険者負担額")
    private RString 高額介護サービス費決定保険者負担額;
    ...
    @CsvField(order = 220, name = "高額介護サービス費・調整・保険者負担額")
    private RString 高額介護サービス費調整保険者負担額;
