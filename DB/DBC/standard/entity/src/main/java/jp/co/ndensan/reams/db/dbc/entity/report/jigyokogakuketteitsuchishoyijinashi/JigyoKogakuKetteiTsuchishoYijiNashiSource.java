package jp.co.ndensan.reams.db.dbc.entity.report.jigyokogakuketteitsuchishoyijinashi;
...
/**
 * 帳票設計_DBCMN43002_事業高額決定通知書 Sourceするクラスです。
 *
 * @reamsid_L DBC-2000-100 lijian
 */
public class JigyoKogakuKetteiTsuchishoYijiNashiSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "torikeshiMochimono2", length = 12, order = 45)
    public RString torikeshiMochimono2;
    @ReportItem(name = "branchBankName", order = 46)
    public RString branchBankName;
    @ReportItem(name = "shiharaiBasho", order = 47)
    public RString shiharaiBasho;
    @ReportItem(name = "torikeshiShiharaibasho", length = 12, order = 48)
    public RString torikeshiShiharaibasho;
    @ReportItem(name = "shumokuTitle", length = 8, order = 49)
    public RString shumokuTitle;
    @ReportItem(name = "kouzaShu", length = 30, order = 50)
    ...
    @ReportItem(name = "renban", length = 4, order = 62)
    ...
    @ReportItem(name = "shimei2", length = 20, order = 84)
