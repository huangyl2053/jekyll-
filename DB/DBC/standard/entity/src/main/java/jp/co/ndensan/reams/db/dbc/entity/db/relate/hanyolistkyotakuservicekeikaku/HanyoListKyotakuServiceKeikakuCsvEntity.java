...
public class HanyoListKyotakuServiceKeikakuCsvEntity {
    ...
    @CsvField(order = 820, name = "届出区分")
    private RString 届出区分;
    @CsvField(order = 830, name = "居宅計画作成区分")
    private RString 居宅計画作成区分;
    @CsvField(order = 840, name = "計画事業者番号")
    private RString 計画事業者番号;
    @CsvField(order = 850, name = "計画事業者名")
    private RString 計画事業者名;
    @CsvField(order = 860, name = "計画事業者カナ")
    private RString 計画事業者カナ;
    @CsvField(order = 870, name = "計画管理者名")
    private RString 計画管理者名;
    @CsvField(order = 880, name = "計画管理者カナ")
    private RString 計画管理者カナ;
    @CsvField(order = 890, name = "計画適用開始日")
    private RString 計画適用開始日;
    @CsvField(order = 900, name = "計画適用終了日")
    private RString 計画適用終了日;
    @CsvField(order = 910, name = "計画届出日")
    private RString 計画届出日;
    @CsvField(order = 920, name = "計画作成日")
    private RString 計画作成日;
    @CsvField(order = 930, name = "計画変更日")
    private RString 計画変更日;
    @CsvField(order = 940, name = "変更理由")
    private RString 変更理由;
    @CsvField(order = 950, name = "委託先計画事業者番号")
    private RString 委託先計画事業者番号;
    @CsvField(order = 960, name = "委託先計画事業者名")
    private RString 委託先計画事業者名;
    @CsvField(order = 970, name = "受給申請事由")
    private RString 受給申請事由;
    @CsvField(order = 980, name = "受給申請日")
    private RString 受給申請日;
    @CsvField(order = 990, name = "受給要介護度")
    private RString 受給要介護度;
    @CsvField(order = 1000, name = "受給認定開始日")
    private RString 受給認定開始日;
    @CsvField(order = 1010, name = "受給認定終了日")
