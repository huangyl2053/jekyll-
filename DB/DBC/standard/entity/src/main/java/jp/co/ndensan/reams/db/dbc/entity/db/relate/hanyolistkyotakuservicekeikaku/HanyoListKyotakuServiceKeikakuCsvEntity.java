...
public class HanyoListKyotakuServiceKeikakuCsvEntity {
    ...
    @CsvField(order = 36, name = "前住所番地方書")
    ...
    @CsvField(order = 49, name = "送付先住所番地方書")
    ...
    @CsvField(order = 64, name = "資格証記載保険者番号")
    private RString 資格証記載保険者番号;
    @CsvField(order = 65, name = "指定事業者コード")
    private RString 指定事業者コード;
    @CsvField(order = 66, name = "施設入所日")
    private RString 施設入所日;
    @CsvField(order = 67, name = "施設退所日")
    private RString 施設退所日;
    @CsvField(order = 68, name = "指定事業者名")
    private RString 指定事業者名;
    @CsvField(order = 69, name = "指定事業者名カナ")
    private RString 指定事業者名カナ;
    @CsvField(order = 70, name = "指定事業者郵便番号")
    private RString 指定事業者郵便番号;
    @CsvField(order = 71, name = "指定事業者住所")
    private RString 指定事業者住所;
    @CsvField(order = 72, name = "指定事業者代表者名")
    private RString 指定事業者代表者名;
    @CsvField(order = 73, name = "指定事業者代表者名カナ")
    private RString 指定事業者代表者名カナ;
    @CsvField(order = 74, name = "指定事業者代表者役職")
    private RString 指定事業者代表者役職;
    @CsvField(order = 75, name = "指定事業者電話番号")
    private RString 指定事業者電話番号;
    @CsvField(order = 76, name = "指定事業者ＦＡＸ番号")
    private RString 指定事業者ＦＡＸ番号;
    @CsvField(order = 77, name = "指定事業者ケアマネ数")
    private RString 指定事業者ケアマネ数;
    @CsvField(order = 78, name = "指定事業者利用者数")
    private RString 指定事業者利用者数;
    @CsvField(order = 79, name = "指定事業者認定日")
    private RString 指定事業者認定日;
    @CsvField(order = 80, name = "指定事業者取消日")
    private RString 指定事業者取消日;
    @CsvField(order = 81, name = "指定事業者実施地域")
    private RString 指定事業者実施地域;
    @CsvField(order = 82, name = "届出区分")
    private RString 届出区分;
    @CsvField(order = 83, name = "居宅計画作成区分")
    private RString 居宅計画作成区分;
    @CsvField(order = 84, name = "計画事業者番号")
    private RString 計画事業者番号;
    @CsvField(order = 85, name = "計画事業者名")
    private RString 計画事業者名;
    @CsvField(order = 86, name = "計画事業者カナ")
    private RString 計画事業者カナ;
    @CsvField(order = 87, name = "計画管理者名")
    private RString 計画管理者名;
    @CsvField(order = 88, name = "計画管理者カナ")
    private RString 計画管理者カナ;
    @CsvField(order = 89, name = "計画適用開始日")
    private RString 計画適用開始日;
    @CsvField(order = 90, name = "計画適用終了日")
    private RString 計画適用終了日;
    @CsvField(order = 91, name = "計画届出日")
    private RString 計画届出日;
    @CsvField(order = 92, name = "計画作成日")
    private RString 計画作成日;
    @CsvField(order = 93, name = "計画変更日")
    private RString 計画変更日;
    @CsvField(order = 94, name = "変更理由")
    private RString 変更理由;
    @CsvField(order = 95, name = "委託先計画事業者番号")
    private RString 委託先計画事業者番号;
    @CsvField(order = 96, name = "委託先計画事業者名")
    private RString 委託先計画事業者名;
    @CsvField(order = 97, name = "受給申請事由")
    private RString 受給申請事由;
    @CsvField(order = 98, name = "受給申請日")
    private RString 受給申請日;
    @CsvField(order = 99, name = "受給要介護度")
    private RString 受給要介護度;
    @CsvField(order = 100, name = "受給認定開始日")
    private RString 受給認定開始日;
    @CsvField(order = 101, name = "受給認定終了日")
    private RString 受給認定終了日;
    @CsvField(order = 102, name = "受給認定日")
    private RString 受給認定日;
    @CsvField(order = 103, name = "受給旧措置")
    private boolean 受給旧措置;
    @CsvField(order = 104, name = "受給みなし更新認定")
    private RString 受給みなし更新認定;
    @CsvField(order = 105, name = "受給直近事由")
