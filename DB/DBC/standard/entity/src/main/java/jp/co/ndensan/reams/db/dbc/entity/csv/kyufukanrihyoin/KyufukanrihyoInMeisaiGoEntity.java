...
public class KyufukanrihyoInMeisaiGoEntity {
    ...
    @CsvField(order = 190, name = "居宅・介護予防・総合事業支給限度額")
    ...
    @CsvField(order = 220, name = "指定/基準該当/地域密着型サービス/総合事業識別コード")
    private RString 指定等事業識別コード;
