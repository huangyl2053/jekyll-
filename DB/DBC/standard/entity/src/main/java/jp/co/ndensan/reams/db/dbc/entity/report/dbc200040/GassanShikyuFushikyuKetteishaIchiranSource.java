...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "add_hokenshaNo", length = 38, order = 30)
    public RString add_hokenshaNo;
    @ReportItem(name = "add_shichosonCode", length = 38, order = 31)
    public RString add_shichosonCode;
    @ReportItem(name = "add_kanaMeisho", length = 38, order = 32)
    public RString add_kanaMeisho;
    @ReportItem(name = "add_choikiCode", length = 38, order = 33)
    public RString add_choikiCode;
    @ReportItem(name = "add_gyoseikuCode", length = 38, order = 34)
    public RString add_gyoseikuCode;
    @ReportItem(name = "add_yubinNo", length = 38, order = 35)
