...
/**
 * 汎用リスト出力(高額合算支給額決定情報)NoCSVEntityクラスです。
 *
...
public class HanyoListKogakuGassanShikyugakuKetteiNoCSVEntity {
    ...
    @CsvField(order = 740, name = "連絡票整理番号")
    private RString 連絡票整理番号;
    @CsvField(order = 750, name = "履歴番号")
    private RString 履歴番号;
    @CsvField(order = 760, name = "自己負担額証明書整理番号")
    private RString 自己負担額証明書整理番号;
    @CsvField(order = 770, name = "対象計算期間（開始）")
    private RString 対象計算期間_開始;
    @CsvField(order = 780, name = "対象計算期間（終了）")
    private RString 対象計算期間_終了;
    @CsvField(order = 790, name = "申請年月日")
    private RString 申請年月日;
    @CsvField(order = 800, name = "決定年月日")
    private RString 決定年月日;
    @CsvField(order = 810, name = "自己負担総額")
    private RString 自己負担総額;
    @CsvField(order = 820, name = "支給区分コード")
    private RString 支給区分コード;
    @CsvField(order = 830, name = "支給額")
    private RString 支給額;
    @CsvField(order = 840, name = "給付の種類")
    private RString 給付の種類;
    @CsvField(order = 850, name = "不支給理由")
    private RString 不支給理由;
    @CsvField(order = 860, name = "支払方法区分")
    private RString 支払方法区分;
    @CsvField(order = 870, name = "支払場所")
    private RString 支払場所;
    @CsvField(order = 880, name = "支払期間開始年月日")
    private RString 支払期間開始年月日;
    @CsvField(order = 890, name = "支払期間終了年月日")
    private RString 支払期間終了年月日;
    @CsvField(order = 900, name = "支払期間開始年月日(曜日)")
    private RString 支払期間開始年月日_曜日;
    @CsvField(order = 910, name = "支払期間終了年月日(曜日)")
    private RString 支払期間終了年月日_曜日;
    @CsvField(order = 920, name = "支払期間開始年月日(時間)")
    private RString 支払期間開始年月日_時間;
    @CsvField(order = 930, name = "支払期間終了年月日(時間)")
    private RString 支払期間終了年月日_時間;
    @CsvField(order = 940, name = "金融機関コード")
    private RString 金融機関コード;
    @CsvField(order = 950, name = "金融機関名")
    private RString 金融機関名;
    @CsvField(order = 960, name = "金融機関支店コード")
    private RString 金融機関支店コード;
    @CsvField(order = 970, name = "金融機関支店名")
    private RString 金融機関支店名;
    @CsvField(order = 980, name = "口座種目名")
    private RString 口座種目名;
    @CsvField(order = 990, name = "口座番号")
    private RString 口座番号;
    @CsvField(order = 1000, name = "口座名義人（カナ）")
    private RString 口座名義人_カナ;
    @CsvField(order = 1010, name = "決定通知書作成年月日")
    private RString 決定通知書作成年月日;
    @CsvField(order = 1020, name = "振込通知書作成年月日")
    private RString 振込通知書作成年月日;
    @CsvField(order = 1030, name = "受取年月")
    private RString 受取年月;
    @CsvField(order = 1040, name = "給付の種類(短)")
    private RString 給付の種類_短;
    @CsvField(order = 1050, name = "不支給理由(短)")
    private RString 不支給理由_短;
    @CsvField(order = 1060, name = "支払場所(短)")
