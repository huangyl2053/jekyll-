...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listUpper_5", length = 17, order = 19)
    ...
    @ReportItem(name = "listLower_2", length = 11, order = 26)
    public RString listLower_2;
    @ReportItem(name = "listLower_3", length = 20, order = 27)
    public RString listLower_3;
    @ReportItem(name = "listLower_4", length = 9, order = 28)
    public RString listLower_4;
    @ReportItem(name = "listLower_5", length = 17, order = 29)
    public RString listLower_5;
    @ReportItem(name = "listLower_6", length = 19, order = 30)
