 ...
 */
package jp.co.ndensan.reams.db.dbc.entity.csv.sogojigyohisaishinsa;
...
public class SogojigyohiSaishinsaCSVEntity {
    ...
    @CsvField(order = 240, name = "総合事業費・決定・公費負担額")
    ...
    @CsvField(order = 270, name = "総合事業費・調整・公費負担額")
