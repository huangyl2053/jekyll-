 ...
 */
package jp.co.ndensan.reams.db.dbc.entity.report.source.sogojigyohisaishin;
 ...
 */
public class SogojigyohiSaishinsaKetteitsuchishoTorikomiIchiranKohiSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listLower_4", length = 18, order = 20)
    public RString listLower_4;
    @ReportItem(name = "listLower_5", length = 15, order = 21)
    public RString listLower_5;
    @ReportItem(name = "listLower_6", length = 17, order = 22)
    public RString listLower_6;
    @ReportItem(name = "listUpper_1", length = 4, order = 23)
    public RString listUpper_1;
    @ReportItem(name = "listUpper_2", length = 6, order = 24)
    public RString listUpper_2;
    @ReportItem(name = "listUpper_3", length = 10, order = 25)
    public RString listUpper_3;
    @ReportItem(name = "listUpper_4", length = 20, order = 26)
    public RString listUpper_4;
    @ReportItem(name = "listUpper_5", length = 6, order = 27)
    public RString listUpper_5;
    @ReportItem(name = "listUpper_6", length = 2, order = 28)
    public RString listUpper_6;
    @ReportItem(name = "listUpper_7", length = 12, order = 29)
    public RString listUpper_7;
    @ReportItem(name = "listUpper_8", length = 15, order = 30)
    public RString listUpper_8;
    @ReportItem(name = "listUpper_9", length = 15, order = 31)
    public RString listUpper_9;
    @ReportItem(name = "listUpper_10", length = 17, order = 32)
    public RString listUpper_10;
    @ReportItem(name = "ketteiTitle", length = 7, order = 33)
    public RString ketteiTitle;
    @ReportItem(name = "choseiTitle", length = 4, order = 34)
    public RString choseiTitle;
    @ReportItem(name = "ketteiKensuTitle", length = 2, order = 35)
    public RString ketteiKensuTitle;
    @ReportItem(name = "ketteiTanisuTitle", length = 3, order = 36)
    public RString ketteiTanisuTitle;
    @ReportItem(name = "ketteiFutangakuTitle", length = 5, order = 37)
    public RString ketteiFutangakuTitle;
    @ReportItem(name = "choseiKensuTitle", length = 2, order = 38)
    public RString choseiKensuTitle;
    @ReportItem(name = "choseiTanisuTitle", length = 3, order = 39)
    public RString choseiTanisuTitle;
    @ReportItem(name = "choseiFutangakuTitle", length = 5, order = 40)
    public RString choseiFutangakuTitle;
    @ReportItem(name = "sogojigyohiTitle", length = 5, order = 41)
    public RString sogojigyohiTitle;
    @ReportItem(name = "sogojigyohiKetteiKensu", length = 7, order = 42)
    public RString sogojigyohiKetteiKensu;
    @ReportItem(name = "sogojigyohiKetteiTanisu", length = 15, order = 43)
    public RString sogojigyohiKetteiTanisu;
    @ReportItem(name = "sogojigyohiKetteiFutangaku", length = 15, order = 44)
    public RString sogojigyohiKetteiFutangaku;
    @ReportItem(name = "sogojigyohiChoseiKensu", length = 7, order = 45)
    public RString sogojigyohiChoseiKensu;
    @ReportItem(name = "sogojigyohiChoseiTanisu", length = 17, order = 46)
