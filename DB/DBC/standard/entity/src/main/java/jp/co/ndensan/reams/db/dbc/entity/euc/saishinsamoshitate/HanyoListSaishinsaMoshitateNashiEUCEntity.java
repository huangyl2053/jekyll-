...
/**
 * 汎用リスト 再審査申立情報_連番なしCSV用データEntityです。
 *
...
@lombok.Setter
@OnNextSchema("rgdb")
public class HanyoListSaishinsaMoshitateNashiEUCEntity {
    ...
    @CsvField(order = 53, name = "資格_証記載保険者番号")
    private RString 資格_証記載保険者番号;
    @CsvField(order = 54, name = "再審査事業者番号")
    private RString 再審査事業者番号;
    @CsvField(order = 55, name = "再審査事業者名")
    private RString 再審査事業者名;
    @CsvField(order = 56, name = "サービス提供年月")
    private RString サービス提供年月;
    @CsvField(order = 57, name = "サービス種類")
    private RString サービス種類;
    @CsvField(order = 58, name = "サービス種類名")
    private RString サービス種類名;
    @CsvField(order = 59, name = "サービス項目")
    private RString サービス項目;
    @CsvField(order = 60, name = "給付_証記載保険者番号")
    private RString 給付_証記載保険者番号;
    @CsvField(order = 61, name = "申立年月日")
    private RString 申立年月日;
    @CsvField(order = 62, name = "申立者区分")
    private RString 申立者区分;
    @CsvField(order = 63, name = "申立単位数")
    private RString 申立単位数;
    @CsvField(order = 64, name = "申立事由コード")
    private RString 申立事由コード;
    @CsvField(order = 65, name = "申立事由")
    private RString 申立事由;
    @CsvField(order = 66, name = "国保連送付年月")
    private RString 国保連送付年月;
    @CsvField(order = 67, name = "受給申請事由")
    private RString 受給申請事由;
    @CsvField(order = 68, name = "受給申請日")
    private RString 受給申請日;
    @CsvField(order = 69, name = "受給要介護度")
    private RString 受給要介護度;
    @CsvField(order = 70, name = "受給認定開始日")
    private RString 受給認定開始日;
    @CsvField(order = 71, name = "受給認定終了日")
    private RString 受給認定終了日;
    @CsvField(order = 72, name = "受給認定日")
    private RString 受給認定日;
    @CsvField(order = 73, name = "受給旧措置")
