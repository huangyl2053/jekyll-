...
/**
 * 償還払請求サービス計画200904テーブルのエンティティクラスです。
 */
public class DbT3047ShokanServicePlan200904Entity extends DbTableEntityBase<DbT3047ShokanServicePlan200904Entity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.1">

    @TableName
    public static final RString TABLE_NAME = new RString("DbT3047ShokanServicePlan200904");
     ...
     * @return 明細行番号
     */
    public RString getMeisaiLineNo() {
        return meisaiLineNo;
    }
     ...
     * 明細行番号のsetメソッドです。
     *
     * @param meisaiLineNo 明細行番号
     */
    public void setMeisaiLineNo(RString meisaiLineNo) {
        this.meisaiLineNo = meisaiLineNo;
    }
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT3047ShokanServicePlan200904Entity}と等しいか判定します。
     *
     * @param other 比較するエンティティ
     * @return
     * 比較するエンティティが同じ主キーを持つ{@literal DbT3047ShokanServicePlan200904Entity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT3047ShokanServicePlan200904Entity other) {
        if (other == null) {
            return false;
        }
        ...
        if (!Objects.equals(this.meisaiLineNo, other.meisaiLineNo)) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT3047ShokanServicePlan200904Entity entity) {
        ...
        this.meisaiLineNo = entity.meisaiLineNo;
    ...
    public RString getMd5() {
        return super.toMd5(hiHokenshaNo, serviceTeikyoYM, seiriNp, jigyoshaNo, yoshikiNo, rirekiNo, shiteiKijunGaitoJigyoshaKubunCode, meisaiLineNo, kyotakuServiceSakuseiIraiYMD, serviceCode, tanisu, kaisu, serviceTanisu, tanisuTanka, serviceTanisuTotal, seikyuKingaku, tantokangoshienSemmoninNo, tekiyo, shinsaHohoKubunCode, shinsaYM, shikyuKubunCode, tensuKingaku, shikyuKingaku, zougenTen, sagakuKingaku, zougenRiyu, fushikyuRiyu, kounyuKaishuRireki);
    }
