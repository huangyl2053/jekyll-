 ...
 */
package jp.co.ndensan.reams.db.dbc.entity.csv.sogojigyohishinsaketteiseikyumeisaikeikasochiin;
 ...
 *
 * @re1amsid_L DBC-2500-011 jiangwenkai
 */
@lombok.Setter
@lombok.Getter
@SuppressWarnings("PMD.UnusedPrivateField")
public class SogojigyohiShinsaKetteiSeikyumeisaiKeikaSochiInCsvEntity {
    ...
    private RString 金額;
    @CsvField(order = 150, name = "介護予防・日常生活支援総合事業費")
    private RString 介護予防_日常生活支援総合事業費;
