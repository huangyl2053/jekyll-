...
/**
 * 予防給付計画自己作成管理テーブルの項目定義クラスです。
 */
public enum DbT3120YoboKeikakuJikoSakuseiKanri implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">
    ...
    private DbT3120YoboKeikakuJikoSakuseiKanri(int maxLength, int scale) {
