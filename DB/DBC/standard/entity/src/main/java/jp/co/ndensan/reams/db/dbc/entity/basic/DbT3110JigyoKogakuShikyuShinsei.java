...
/**
 * 事業高額介護サービス費支給申請テーブルの項目定義クラスです。
 */
public enum DbT3110JigyoKogakuShikyuShinsei implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
    ...
    private DbT3110JigyoKogakuShikyuShinsei(int maxLength, int scale) {
