...
/**
 * 帳票設計_DBCZV00001_受給者異動連絡票（CSV） Entity
 *
...
public class JukyushaIdoRenrakuhyoCsvEntity {
    ...
    @CsvField(order = 150, name = "異動年月日")
    private RString 異動年月日;
    @CsvField(order = 160, name = "異動区分コード")
    private RString 異動区分コード;
    @CsvField(order = 170, name = "異動事由")
    private RString 異動事由;
    @CsvField(order = 180, name = "証記載保険者番号")
    private RString 証記載保険者番号;
    @CsvField(order = 190, name = "被保険者番号")
    private RString 被保険者番号;
    @CsvField(order = 200, name = "被保険者氏名カナ")
    private RString 被保険者氏名カナ;
    @CsvField(order = 210, name = "生年月日")
    private RString 生年月日;
    @CsvField(order = 220, name = "性別コード")
    private RString 性別コード;
    @CsvField(order = 230, name = "資格取得年月日")
    private RString 資格取得年月日;
    @CsvField(order = 240, name = "資格喪失年月日")
    private RString 資格喪失年月日;
    @CsvField(order = 250, name = "老人保健市町村番号")
    private RString 老人保健市町村番号;
    @CsvField(order = 260, name = "公費負担者番号")
    private RString 公費負担者番号;
    @CsvField(order = 270, name = "老人保健受給者番号")
    private RString 老人保健受給者番号;
    @CsvField(order = 280, name = "広域連合政令市保険者番号")
