...
public class KogakuKyufuTaishoshaIchiranCsvEntity {
    ...
    @CsvField(order = 100, name = "事業者番号")
    private RString 事業者番号;
    @CsvField(order = 110, name = "事業者名")
    private RString 事業者名;
    @CsvField(order = 120, name = "サービス種類コード")
    private RString サービス種類コード;
    @CsvField(order = 130, name = "サービス種類名")
    private RString サービス種類名;
    @CsvField(order = 140, name = "サービス費用合計額")
    private RString サービス費用合計額;
    @CsvField(order = 150, name = "利用者負担額")
    private RString 利用者負担額;
    @CsvField(order = 160, name = "資格喪失日")
    private RString 資格喪失日;
    @CsvField(order = 170, name = "備考")
    private RString 備考;
    @CsvField(order = 180, name = "サービス費用合計額合計")
    private RString サービス費用合計額合計;
    @CsvField(order = 190, name = "利用者負担額合計")
    private RString 利用者負担額合計;
    @CsvField(order = 200, name = "算定基準額")
    private RString 算定基準額;
    @CsvField(order = 210, name = "支払済金額合計")
    private RString 支払済金額合計;
    @CsvField(order = 220, name = "高額支給額")
