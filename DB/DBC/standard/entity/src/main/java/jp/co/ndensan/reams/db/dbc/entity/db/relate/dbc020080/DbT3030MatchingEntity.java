...
@lombok.Getter
@lombok.Setter
public class DbT3030MatchingEntity extends DbTableEntityBase<DbT3030MatchingEntity> implements IDbAccessable {

    private JissekiFutangakuDataTempEntity 実績負担額データ;
    private DbT3030KyufuJissekiShakaiFukushiHojinKeigengakuEntity 給付実績社会福祉法人軽減額;
    private DbT3033KyufujissekiShukeiEntity 給付実績集計;
