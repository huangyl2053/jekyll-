...
/**
 * 事業高額介護サービス費支給審査決定テーブルのエンティティクラスです。
 */
public class DbT3112KogakuShikyuShinsaKetteiEntity extends DbTableEntityBase<DbT3112KogakuShikyuShinsaKetteiEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">
    @TableName
    public static final RString TABLE_NAME = new RString("DbT3112KogakuShikyuShinsaKettei");
    ...
    private Decimal jigyoKogakuShikyuGaku;
     ...
     */
    @CheckForNull
    public Decimal getJigyoKogakuShikyuGaku() {
        return jigyoKogakuShikyuGaku;
    }

    /**
     * 事業高額支給額のsetメソッドです。
     * 
     * @param jigyoKogakuShikyuGaku 事業高額支給額
     */
    public void setJigyoKogakuShikyuGaku(Decimal jigyoKogakuShikyuGaku) {
        this.jigyoKogakuShikyuGaku = jigyoKogakuShikyuGaku;
    }

    /**
     * このエンティティの主キーが他の{@literal DbT3112KogakuShikyuShinsaKetteiEntity}と等しいか判定します。
     * 
     * @param other 比較するエンティティ
     * @return 
     * 比較するエンティティが同じ主キーを持つ{@literal DbT3112KogakuShikyuShinsaKetteiEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT3112KogakuShikyuShinsaKetteiEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT3112KogakuShikyuShinsaKetteiEntity entity) {
        ...
        this.jigyoKogakuShikyuGaku = entity.jigyoKogakuShikyuGaku;
    }
    ...
    public RString getMd5() {
        return super.toMd5(hihokenshaNo, serviceTeikyoYM, shoKisaiHokenshaNo, rirekiNo, ketteishaUketoriYM, tsuchishoNo, riyoshaFutanGaku, shikyuKubunCode, ketteiYM, jigyoKogakuShikyuGaku);
    }
