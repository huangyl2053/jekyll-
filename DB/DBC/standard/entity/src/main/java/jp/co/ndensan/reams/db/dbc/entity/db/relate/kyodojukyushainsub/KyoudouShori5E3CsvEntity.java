...
public class KyoudouShori5E3CsvEntity implements Serializable {
    ...
    @CsvField(order = 22, name = "世帯主被保険者番号")
    private RString 世帯主被保険者番号;
    @CsvField(order = 23, name = "世帯所得区分コード")
    private RString 世帯所得区分コード;
    @CsvField(order = 24, name = "所得区分コード")
    private RString 所得区分コード;
    @CsvField(order = 25, name = "老齢福祉年金受給の有無")
    private RString 老齢福祉年金受給の有無;
    @CsvField(order = 26, name = "利用者負担第２段階")
    private RString 利用者負担第２段階;
    @CsvField(order = 27, name = "支給申請書出力の有無")
