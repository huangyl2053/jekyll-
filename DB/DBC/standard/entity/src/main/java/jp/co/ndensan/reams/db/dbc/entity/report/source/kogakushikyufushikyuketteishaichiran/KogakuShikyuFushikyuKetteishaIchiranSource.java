 ...
 */
package jp.co.ndensan.reams.db.dbc.entity.report.source.kogakushikyufushikyuketteishaichiran;
 ...
 */
public class KogakuShikyuFushikyuKetteishaIchiranSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listUpper_2", length = 40, order = 16)
    public RString listUpper_2;
    @ReportItem(name = "listUpper_3", length = 6, order = 17)
    public RString listUpper_3;
    @ReportItem(name = "listUpper_4", length = 2, order = 18)
    public RString listUpper_4;
    @ReportItem(name = "listUpper_5", length = 11, order = 19)
    public RString listUpper_5;
    @ReportItem(name = "listUpper_6", length = 5, order = 20)
    public RString listUpper_6;
    @ReportItem(name = "listUpper_7", length = 11, order = 21)
    public RString listUpper_7;
    @ReportItem(name = "listUpper_8", length = 8, order = 22)
