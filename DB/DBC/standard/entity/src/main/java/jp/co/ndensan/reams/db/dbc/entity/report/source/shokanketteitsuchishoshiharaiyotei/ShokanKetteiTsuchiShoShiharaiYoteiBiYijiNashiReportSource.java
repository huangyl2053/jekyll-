...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "bankName", length = 30, order = 36)
    public RString bankName;
    @ReportItem(name = "mochimono1", length = 30, order = 37)
    ...
    @ReportItem(name = "torikeshiShiharaibasho", length = 12, order = 44)
    ...
    @ReportItem(name = "torikeshiShiharaikikan", length = 12, order = 50)
    public RString torikeshiShiharaikikan;
    @ReportItem(name = "shiharaiEndYMD", length = 14, order = 51)
    public RString shiharaiEndYMD;
    @ReportItem(name = "kouzaMeigi", order = 52)
    public RString kouzaMeigi;
    @ReportItem(name = "shiharaiStartHMS", length = 12, order = 53)
    public RString shiharaiStartHMS;
    @ReportItem(name = "shiharaiEndHMS", length = 12, order = 54)
    public RString shiharaiEndHMS;
    @ReportItem(name = "karaFugo", length = 2, order = 55)
    public RString karaFugo;
    @ReportItem(name = "tsuchibun2", order = 56)
    public RString tsuchibun2;
    @ReportItem(name = "seirino", length = 10, order = 57)
    public RString seirino;
    @ReportItem(name = "tsuchino", length = 6, order = 58)
    public RString tsuchino;
    @ReportItem(name = "remban", length = 4, order = 59)
    public RString remban;
    @ReportItem(name = "tsuchibunLarge", order = 60)
    public RString tsuchibunLarge;
    @ReportItem(name = "tsuchibunMix1", order = 61)
    public RString tsuchibunMix1;
    @ReportItem(name = "tsuchibunMix2", order = 62)
    public RString tsuchibunMix2;
    @ReportItem(name = "tsuchibunMixTwo1", order = 63)
    public RString tsuchibunMixTwo1;
    @ReportItem(name = "tsuchibunMixTwo2", order = 64)
    public RString tsuchibunMixTwo2;
    @ReportItem(name = "yubinNo", length = 8, order = 65)
    public RString yubinNo;
    @ReportItem(name = "gyoseiku2", length = 14, order = 66)
    public RString gyoseiku2;
    @ReportItem(name = "jusho4", length = 20, order = 67)
    public RString jusho4;
    @ReportItem(name = "jushoText", order = 68)
    public RString jushoText;
    @ReportItem(name = "jusho5", length = 20, order = 69)
    public RString jusho5;
    @ReportItem(name = "jusho6", length = 20, order = 70)
    public RString jusho6;
    @ReportItem(name = "katagakiText", order = 71)
    public RString katagakiText;
    @ReportItem(name = "katagaki3", length = 20, order = 72)
    public RString katagaki3;
    @ReportItem(name = "katagakiSmall2", length = 30, order = 73)
    public RString katagakiSmall2;
    @ReportItem(name = "katagaki4", length = 20, order = 74)
    public RString katagaki4;
    @ReportItem(name = "katagakiSmall1", length = 30, order = 75)
    public RString katagakiSmall1;
    @ReportItem(name = "shimei5", length = 20, order = 76)
    ...
    @ReportItem(name = "shimei6", length = 20, order = 82)
    ...
    @ReportItem(name = "kakkoRight2", length = 1, order = 87)
    public RString kakkoRight2;
    @ReportItem(name = "kakkoLeft2", length = 1, order = 88)
    public RString kakkoLeft2;
    @ReportItem(name = "samabunShimei2", length = 20, order = 89)
    public RString samabunShimei2;
    @ReportItem(name = "kakkoRight1", length = 1, order = 90)
    public RString kakkoRight1;
    @ReportItem(name = "kakkoLeft1", length = 1, order = 91)
    public RString kakkoLeft1;
    @ReportItem(name = "samabunShimei1", length = 20, order = 92)
    public RString samabunShimei1;
    @ReportItem(name = "samaBun1", length = 3, order = 93)
    public RString samaBun1;
    @ReportItem(name = "samabunShimeiSmall1", length = 40, order = 94)
    public RString samabunShimeiSmall1;
    @ReportItem(name = "customerBarCode", order = 95)
    public RString customerBarCode;
    @ReportItem(name = "hakkoYMD", length = 12, order = 96)
    public RString hakkoYMD;
    @ReportItem(name = "denshiKoin", order = 97)
    public RString denshiKoin;
    @ReportItem(name = "ninshoshaYakushokuMei", length = 15, order = 98)
    public RString ninshoshaYakushokuMei;
    @ReportItem(name = "ninshoshaYakushokuMei1", order = 99)
    public RString ninshoshaYakushokuMei1;
    @ReportItem(name = "koinMojiretsu", length = 4, order = 100)
    public RString koinMojiretsu;
    @ReportItem(name = "ninshoshaYakushokuMei2", order = 101)
    public RString ninshoshaYakushokuMei2;
    @ReportItem(name = "ninshoshaShimeiKakenai", order = 102)
    public RString ninshoshaShimeiKakenai;
    @ReportItem(name = "ninshoshaShimeiKakeru", order = 103)
    public RString ninshoshaShimeiKakeru;
    @ReportItem(name = "koinShoryaku", length = 15, order = 104)
