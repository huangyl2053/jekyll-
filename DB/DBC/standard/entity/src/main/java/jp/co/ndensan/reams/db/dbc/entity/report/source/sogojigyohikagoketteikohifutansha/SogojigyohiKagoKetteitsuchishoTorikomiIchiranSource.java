 ...
 */
public class SogojigyohiKagoKetteitsuchishoTorikomiIchiranSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listUpper_8", length = 28, order = 22)
    ...
    @ReportItem(name = "listLower_4", length = 28, order = 27)
    ...
    @ReportItem(name = "sogojigyohiTitle", length = 5, order = 32)
    public RString sogojigyohiTitle;
    @ReportItem(name = "sogojigyohiKensu", length = 7, order = 33)
    public RString sogojigyohiKensu;
    @ReportItem(name = "sogojigyohiTanisu", length = 17, order = 34)
