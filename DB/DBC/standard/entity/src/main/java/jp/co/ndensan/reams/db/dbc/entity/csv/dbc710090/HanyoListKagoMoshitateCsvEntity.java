...
/**
 * 汎用リスト(過誤申立情報)CSVデータのEntityクラスです。
 *
...
public class HanyoListKagoMoshitateCsvEntity {
     ...
     * コンストラクタです。
     */
    public HanyoListKagoMoshitateCsvEntity() {
    }
     ...
     * @param 受給直近事由 受給直近事由
     */
    public HanyoListKagoMoshitateCsvEntity(RString 連番, RString 識別コード, RString 住民種別, RString 氏名, RString 氏名カナ,
