...
/**
 * 汎用リスト_共同処理用受給者情報（基本）CSVデータのEntityクラスです。
 *
...
public class HanyoListKyodoJukyushaCsvEntity {
    ...
    @CsvField(order = 52, name = "被保険者氏名漢字")
    private RString 被保険者氏名漢字;
    @CsvField(order = 53, name = "送付郵便番号")
    private RString 送付郵便番号;
    @CsvField(order = 54, name = "送付住所カナ")
    private RString 送付住所カナ;
    @CsvField(order = 55, name = "送付住所")
    private RString 送付住所;
    @CsvField(order = 56, name = "電話番号")
    private RString 電話番号;
    @CsvField(order = 57, name = "帳票出力順序コード")
    private RString 帳票出力順序コード;

    /**
     * コンストラクタです。
     */
    public HanyoListKyodoJukyushaCsvEntity() {
    }
    ...
    public HanyoListKyodoJukyushaCsvEntity(RString 連番, RString 識別コード,
