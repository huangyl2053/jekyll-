package jp.co.ndensan.reams.db.dbc.entity.report.source.kyodoshorijukyushateiseirenrakuhyo;
...
/**
 * 共同処理用受給者訂正連絡票（紙媒体）Source
 *
 * @reamsid_L DBC-1951-060 chenaoqi
 */
public class KyodoShoriJukyushaTeiseiRenrakuhyoSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "teiseiKbn1", length = 1, order = 6)
    public RString teiseiKbn1;
    @ReportItem(name = "teiseiKbn2", length = 1, order = 7)
    ...
    @ReportItem(name = "teiseiGG", length = 2, order = 14)
    public RString teiseiGG;
    @ReportItem(name = "teiseiYY", length = 2, order = 15)
    public RString teiseiYY;
    @ReportItem(name = "teiseiMM", length = 2, order = 16)
    public RString teiseiMM;
    @ReportItem(name = "teiseiDD", length = 2, order = 17)
    public RString teiseiDD;
    ...
    @ReportItem(name = "jushoKana2", length = 37, order = 22)
    public RString jushoKana2;
    @ReportItem(name = "shutsuryokujunCode", length = 3, order = 23)
    ...
    @ReportItem(name = "shotokuKbn3", length = 1, order = 42)
    public RString shotokuKbn3;
    @ReportItem(name = "shotokuKbn4", length = 1, order = 43)
    public RString shotokuKbn4;
    @ReportItem(name = "riyoshaFutan1", length = 1, order = 44)
    public RString riyoshaFutan1;
    @ReportItem(name = "riyoshaFutan2", length = 1, order = 45)
    public RString riyoshaFutan2;
    @ReportItem(name = "shotokuKbn1", length = 1, order = 46)
    public RString shotokuKbn1;
    @ReportItem(name = "shotokuKbn2", length = 1, order = 47)
