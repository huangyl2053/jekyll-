...
/**
 * 帳票設計_DBC200036_高額合算支給額計算結果連絡票情報送付一覧表 Sourceクラスです。
 *
 * @reamsid_L DBC-2670-040 lijian
 */
public class GassanShikyugakuKeisankekkaSofuIchiranSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listUpper_2", length = 17, order = 16)
    public RString listUpper_2;
    @ReportItem(name = "listUpper_3", length = 20, order = 17)
    public RString listUpper_3;
    @ReportItem(name = "listUpper_4", length = 5, order = 18)
    public RString listUpper_4;
    @ReportItem(name = "listUpper_5", length = 13, order = 19)
    public RString listUpper_5;
    @ReportItem(name = "listUpper_6", length = 13, order = 20)
    public RString listUpper_6;
    @ReportItem(name = "listUpper_7", length = 5, order = 21)
    ...
    @ReportItem(name = "listUpper_10", length = 13, order = 24)
    ...
    @ReportItem(name = "listLower_3", length = 13, order = 28)
    public RString listLower_3;
    @ReportItem(name = "listLower_4", length = 5, order = 29)
    public RString listLower_4;
    @ReportItem(name = "listLower_5", length = 7, order = 30)
    public RString listLower_5;
    @ReportItem(name = "listLower_6", length = 13, order = 31)
    public RString listLower_6;
    @ReportItem(name = "listLower_7", length = 13, order = 32)
