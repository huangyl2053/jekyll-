...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listTaishoshaIchiran_1", length = 4, order = 15)
    public RString listTaishoshaIchiran_1;
    @ReportItem(name = "listTaishoshaIchiran_2", length = 10, order = 16)
    public RString listTaishoshaIchiran_2;
    @ReportItem(name = "listTaishoshaIchiran_3", length = 6, order = 17)
    public RString listTaishoshaIchiran_3;
    @ReportItem(name = "listTaishoshaIchiran_4", length = 10, order = 18)
    public RString listTaishoshaIchiran_4;
    @ReportItem(name = "listTaishoshaIchiran_5", length = 2, order = 19)
    public RString listTaishoshaIchiran_5;
    @ReportItem(name = "listTaishoshaIchiran_6", length = 15, order = 20)
    public RString listTaishoshaIchiran_6;
    @ReportItem(name = "listTaishoshaIchiran_7", length = 1, order = 21)
    public RString listTaishoshaIchiran_7;
    @ReportItem(name = "listTaishoshaIchiran_8", length = 10, order = 22)
    public RString listTaishoshaIchiran_8;
    @ReportItem(name = "listTaishoshaIchiran_9", length = 1, order = 23)
    public RString listTaishoshaIchiran_9;
    @ReportItem(name = "listTaishoshaIchiran_10", length = 13, order = 24)
