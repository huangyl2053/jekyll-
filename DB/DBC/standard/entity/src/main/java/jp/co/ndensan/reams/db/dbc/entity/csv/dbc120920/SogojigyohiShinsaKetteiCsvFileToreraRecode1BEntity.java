...
/**
 * 審査決定請求明細表情報取込共通処理（CSVファイル取込）のRecode1Bクラスです
 *
...
public class SogojigyohiShinsaKetteiCsvFileToreraRecode1BEntity {
