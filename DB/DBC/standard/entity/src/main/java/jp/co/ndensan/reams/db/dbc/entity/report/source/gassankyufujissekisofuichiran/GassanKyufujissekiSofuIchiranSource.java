 ...
 */
package jp.co.ndensan.reams.db.dbc.entity.report.source.gassankyufujissekisofuichiran;
...
/**
 * 帳票設計_DBC200042_高額合算給付実績情報送付一覧表 のソースクラスです。
 *
 * @reamsid_L DBC-2710-040 qinzhen
 */
public class GassanKyufujissekiSofuIchiranSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "list_3", length = 32, order = 17)
