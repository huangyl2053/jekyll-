 ...
 */
package jp.co.ndensan.reams.db.dbc.entity.csv.dbc120890;
...
public class SogojigyohiSeikyugakuTsuchishoCsvEntity {
    ...
    @CsvField(order = 130, name = "通常分_件数")
    private RString 通常分_件数;
    @CsvField(order = 140, name = "通常分_実日数")
    private RString 通常分_実日数;
    @CsvField(order = 150, name = "通常分_単位数")
    private RString 通常分_単位数;
    @CsvField(order = 160, name = "通常分_金額")
    private RString 通常分_金額;
    @CsvField(order = 170, name = "再審査_過誤_件数")
    private RString 再審査_過誤_件数;
    @CsvField(order = 180, name = "再審査_過誤_単位数")
    private RString 再審査_過誤_単位数;
    @CsvField(order = 190, name = "再審査_過誤_調整額")
    ...
    @CsvField(order = 230, name = "合計_通常分_件数")
    private RString 合計_通常分_件数;
    @CsvField(order = 240, name = "合計_通常分_単位数")
    private RString 合計_通常分_単位数;
    @CsvField(order = 250, name = "合計_通常分_金額")
    private RString 合計_通常分_金額;
    @CsvField(order = 260, name = "合計_再審査_過誤_件数")
    private RString 合計_再審査_過誤_件数;
    @CsvField(order = 270, name = "合計_再審査_過誤_単位数")
    private RString 合計_再審査_過誤_単位数;
    @CsvField(order = 280, name = "合計_再審査_過誤_調整額")
    private RString 合計_再審査_過誤_調整額;
    @CsvField(order = 290, name = "合計_総合事業費")
    private RString 合計_総合事業費;
    @CsvField(order = 300, name = "合計_利用者負担額")
    private RString 合計_利用者負担額;
    @CsvField(order = 310, name = "合計_公費負担額")
    private RString 合計_公費負担額;
    @CsvField(order = 320, name = "累計_通常分_件数")
    private RString 累計_通常分_件数;
    @CsvField(order = 330, name = "累計_通常分_単位数")
    private RString 累計_通常分_単位数;
    @CsvField(order = 340, name = "累計_通常分_金額")
    private RString 累計_通常分_金額;
    @CsvField(order = 350, name = "累計_再審査_過誤_件数")
    private RString 累計_再審査_過誤_件数;
    @CsvField(order = 360, name = "累計_再審査_過誤_単位数")
    private RString 累計_再審査_過誤_単位数;
    @CsvField(order = 370, name = "累計_再審査_過誤_調整額")
    private RString 累計_再審査_過誤_調整額;
    @CsvField(order = 380, name = "累計_総合事業費")
    private RString 累計_総合事業費;
    @CsvField(order = 390, name = "累計_利用者負担額")
    private RString 累計_利用者負担額;
    @CsvField(order = 400, name = "累計_公費負担額")
    private RString 累計_公費負担額;
    @CsvField(order = 410, name = "手数料_請求額")
    private RString 手数料_請求額;
    @CsvField(order = 420, name = "手数料_累計請求額")
