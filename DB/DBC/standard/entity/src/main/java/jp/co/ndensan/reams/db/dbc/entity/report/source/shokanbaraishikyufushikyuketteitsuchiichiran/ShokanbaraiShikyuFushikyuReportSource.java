...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listUpper_3", length = 6, order = 16)
    public RString listUpper_3;
    @ReportItem(name = "listUpper_4", length = 10, order = 17)
    public RString listUpper_4;
    @ReportItem(name = "listUpper_5", length = 24, order = 18)
    public RString listUpper_5;
    @ReportItem(name = "listUpper_6", length = 7, order = 19)
    public RString listUpper_6;
    @ReportItem(name = "listUpper_7", length = 6, order = 20)
    ...
    @ReportItem(name = "listUpper_10", length = 14, order = 23)
    public RString listUpper_10;
    @ReportItem(name = "listUpper_11", length = 14, order = 24)
    public RString listUpper_11;
    @ReportItem(name = "listUpper_12", length = 1, order = 25)
    public RString listUpper_12;
    @ReportItem(name = "listUpper_13", length = 4, order = 26)
    public RString listUpper_13;
    @ReportItem(name = "listUpper_14", length = 7, order = 27)
    public RString listUpper_14;
    @ReportItem(name = "listLower_1", length = 24, order = 28)
    public RString listLower_1;
    @ReportItem(name = "listLower_2", length = 6, order = 29)
    public RString listLower_2;
    @ReportItem(name = "listLower_3", length = 9, order = 30)
    public RString listLower_3;
    @ReportItem(name = "listLower_4", length = 9, order = 31)
