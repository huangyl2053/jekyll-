...
/**
 * 事業高額介護サービス費給付対象者合計テーブルのエンティティクラスです。
 */
public class DbT3109JigyoKogakuKyufuTaishoshaGokeiEntity extends DbTableEntityBase<DbT3109JigyoKogakuKyufuTaishoshaGokeiEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">

    @TableName
    public static final RString TABLE_NAME = new RString("DbT3109JigyoKogakuKyufuTaishoshaGokei");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT3109JigyoKogakuKyufuTaishoshaGokeiEntity}と等しいか判定します。
     *
     * @param other 比較するエンティティ
     * @@return
     * 比較するエンティティが同じ主キーを持つ{@literal DbT3109JigyoKogakuKyufuTaishoshaGokeiEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT3109JigyoKogakuKyufuTaishoshaGokeiEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT3109JigyoKogakuKyufuTaishoshaGokeiEntity entity) {
