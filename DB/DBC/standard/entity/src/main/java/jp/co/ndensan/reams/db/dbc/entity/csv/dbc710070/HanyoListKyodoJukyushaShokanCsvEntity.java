 ...
 */
package jp.co.ndensan.reams.db.dbc.entity.csv.dbc710070;
...
/**
 * 汎用リスト_共同処理用受給者情報（償還）CSVデータのEntityクラスです。
 *
...
public class HanyoListKyodoJukyushaShokanCsvEntity {
    ...
    private RString 空白;
    @CsvField(order = 45, name = "処理対象年月")
    private RString 処理対象年月;
    @CsvField(order = 46, name = "被保険者番号")
    private RString 被保険者番号;
    @CsvField(order = 47, name = "履歴番号")
    private RString 履歴番号;
    @CsvField(order = 48, name = "異動年月日")
    private RString 異動年月日;
    @CsvField(order = 49, name = "異動区分")
    private RString 異動区分;
    @CsvField(order = 50, name = "異動事由")
    private RString 異動事由;
    @CsvField(order = 51, name = "（給付）証記載保険者番号")
    private RString 給付_証記載保険者番号;
    @CsvField(order = 52, name = "差止開始日")
    private RString 差止開始日;
    @CsvField(order = 53, name = "差止終了日")
    private RString 差止終了日;
    @CsvField(order = 54, name = "差止区分")
    private RString 差止区分;
    @CsvField(order = 55, name = "差止サービス種類")
    private RString 差止サービス種類;
    @CsvField(order = 56, name = "差止サービス種類名")
    private RString 差止サービス種類名;
}
