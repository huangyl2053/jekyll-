...
public class HanyoListKyodoJukyushaKogakuCsvEntity {
    ...
    @CsvField(order = 52, name = "世帯集約番号")
    private RString 世帯集約番号;
    @CsvField(order = 53, name = "世帯所得区分")
    private RString 世帯所得区分;
    @CsvField(order = 54, name = "所得区分")
    private RString 所得区分;
    @CsvField(order = 55, name = "老齢福祉年金受給")
    private RString 老齢福祉年金受給;
    @CsvField(order = 56, name = "利用者負担第２段階")
    private RString 利用者負担第２段階;
    @CsvField(order = 57, name = "支給申請書出力の有無")
