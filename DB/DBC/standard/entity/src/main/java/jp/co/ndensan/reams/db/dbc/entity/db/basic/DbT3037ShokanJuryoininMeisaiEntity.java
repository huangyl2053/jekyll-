...
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.1">
     ...
     */
    @Override
    public boolean equalsPrimaryKeys(DbT3037ShokanJuryoininMeisaiEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT3037ShokanJuryoininMeisaiEntity entity) {
    ...
    public RString getMd5() {
        return super.toMd5(hiHokenshaNo, serviceTeikyoYM, seiriNo, rirekiNo, keiyakuNo, shiharaiKingaku);
    }
