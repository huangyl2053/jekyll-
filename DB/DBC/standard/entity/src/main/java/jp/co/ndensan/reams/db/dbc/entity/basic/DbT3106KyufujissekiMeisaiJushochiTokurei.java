...
/**
 * 給付実績明細・住所地特例テーブルの項目定義クラスです。
 */
public enum DbT3106KyufujissekiMeisaiJushochiTokurei implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.3.9">
     ...
     * 施設所在保険者番号
     */
    shisetsuShozaiHokenshaNo(2147483647, 0),
    /**
     * 摘要
     */
    tekiyo(20, 0),
    ...
    private DbT3106KyufujissekiMeisaiJushochiTokurei(int maxLength, int scale) {
