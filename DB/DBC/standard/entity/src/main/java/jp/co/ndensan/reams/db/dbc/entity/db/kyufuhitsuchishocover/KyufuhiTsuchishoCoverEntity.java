 ...
 */
package jp.co.ndensan.reams.db.dbc.entity.db.kyufuhitsuchishocover;

import jp.co.ndensan.reams.uz.uza.lang.RString;

/**
 * 帳票設計_DBC100041_介護保険給付費通知書のEntityクラスです。
 *
...
public class KyufuhiTsuchishoCoverEntity {

    private RString bunshoNo;
    private RString hokenshaNo;
    private RString hihokenshaName;
    private RString shukeiserviceSTYM;
    private RString shukeiserviceEDYM;
    private RString toiawasesakiTitle;
    private RString listServiceIchiranUpper_1;
    private RString listServiceIchiranUpper_2;
    private RString listServiceIchiranUpper_3;
    private RString listServiceIchiranUpper_4;
    private RString listServiceIchiranUpper_5;
    private RString listServiceIchiranUpper_6;
    private RString listServiceIchiranLower_1;
    private RString listServiceIchiranLower_2;
    private RString tsuchibun1;
    private RString tsuchibun2;
    private int pageBunshi;
    private int pageBunbo;
