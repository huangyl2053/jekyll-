...
/**
 * 居宅給付計画自己作成管理テーブルのエンティティクラスです。
 */
public class DbT3119KyotakuKeikakuJikosakuseiKanriEntity extends DbTableEntityBase<DbT3119KyotakuKeikakuJikosakuseiKanriEntity> implements IDbAccessable {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.2">
    @TableName
    public static final RString TABLE_NAME = new RString("DbT3119KyotakuKeikakuJikosakuseiKanri");
    ...
    /**
     * このエンティティの主キーが他の{@literal DbT3119KyotakuKeikakuJikosakuseiKanriEntity}と等しいか判定します。
     * 
     * @param other 比較するエンティティ
     * @return 
     * 比較するエンティティが同じ主キーを持つ{@literal DbT3119KyotakuKeikakuJikosakuseiKanriEntity}の場合{@literal true}、それ以外の場合は{@literal false}
     */
    @Override
    public boolean equalsPrimaryKeys(DbT3119KyotakuKeikakuJikosakuseiKanriEntity other) {
        if (other == null) {
            return false;
        }
     ...
     */
    @Override
    public void shallowCopy(DbT3119KyotakuKeikakuJikosakuseiKanriEntity entity) {
    ...
    public RString getMd5() {
        return super.toMd5(hihokenshaNo, taishoYM, rirekiNo, riyoYM, kyotakuServiceKubun, meisaiNo, serviceTeikyoJigyoshaNo, serviceShuruiCode, serviceKomokuCode, taniSu, kaisu_Nissu, waribikiGoTekiyoRitsu, waribikiGoTekiyoTaniSu, kyufuTaishoNissu, goukeiFlag, shuruiGendoNaiTaniSu_Nissu, shuruiGendoChokaTaniSu_Nissu, kubunGendoNaiTaniSu_Nissu, kubunGendoChokaTaniSu_Nissu, taniSuTanka, kyufuRitsu, kyufuKeikakuTaniSu);
    }
