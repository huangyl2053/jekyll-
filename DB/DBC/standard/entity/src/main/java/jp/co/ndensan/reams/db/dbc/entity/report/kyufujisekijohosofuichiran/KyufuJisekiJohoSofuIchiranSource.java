package jp.co.ndensan.reams.db.dbc.entity.report.kyufujisekijohosofuichiran;
...
/**
 * 帳票設計_DBC200053_給付実績情報送付一覧表　Sourceクラスです。
 *
 * @reamsid_L DBC-2460-030 lijian
 */
public class KyufuJisekiJohoSofuIchiranSource implements IReportSource {
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    @ReportItem(name = "listLower_1", length = 8, order = 38)
    public RString listLower_1;
    @ReportItem(name = "listLower_2", length = 20, order = 39)
    public RString listLower_2;
    @ReportItem(name = "listLower_3", length = 20, order = 40)
    public RString listLower_3;
    @ReportItem(name = "gokeiKensuTitle", length = 4, order = 41)
    public RString gokeiKensuTitle;
    @ReportItem(name = "gokeiKensu", length = 8, order = 42)
