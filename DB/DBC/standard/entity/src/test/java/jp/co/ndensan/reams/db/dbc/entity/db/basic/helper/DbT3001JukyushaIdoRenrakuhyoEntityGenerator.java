...
public final class DbT3001JukyushaIdoRenrakuhyoEntityGenerator {
    ...
    public static final HokenshaNo DEFAULT_広域連合（政令市）保険者番号 = new HokenshaNo();
    ...
    public static final JigyoshaNo DEFAULT_居宅介護支援事業所番号 = new JigyoshaNo();
    ...
    public static final Decimal DEFAULT_居宅費（新１）負担限度額 = new Decimal(0);
    public static final Decimal DEFAULT_居宅費（新２）負担限度額 = new Decimal(0);
    public static final Decimal DEFAULT_居宅費（新３）負担限度額 = new Decimal(0);
    ...
    public static DbT3001JukyushaIdoRenrakuhyoEntity createDbT3001JukyushaIdoRenrakuhyoEntity() {
        ...
        entity.setKoikiRengoHokenshaNo(DEFAULT_広域連合（政令市）保険者番号);
        ...
        entity.setKyotakuhiShin1FutanGendogaku(DEFAULT_居宅費（新１）負担限度額);
        entity.setKyotakuhiShin2FutanGendogaku(DEFAULT_居宅費（新２）負担限度額);
        entity.setKyotakuhiShin3FutanGendogaku(DEFAULT_居宅費（新３）負担限度額);
