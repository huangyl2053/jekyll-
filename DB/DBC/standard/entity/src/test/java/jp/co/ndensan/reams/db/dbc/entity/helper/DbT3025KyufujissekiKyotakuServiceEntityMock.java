...
public class DbT3025KyufujissekiKyotakuServiceEntityMock {
    ...
    public static DbT3025KyufujissekiKyotakuServiceEntity createEntity() {
        ...
        entity.setInputShikibetsuNo(new NyuryokuShikibetsuNo(new RString("0001")));
        ...
        entity.setTanisu(3);
        entity.setKaisu(2);
        entity.setServiceTanisu(3);
        entity.setServiceTanisuTotal(6);
        entity.setSeikyuKingaku(34000);
        entity.setTantouKaigoShienSemmoninNo(new RString("87654321"));
        entity.setTekiyo(new RString("てきようじょうほうてきすと"));
        entity.setAtoTanisu(2);
        entity.setAtoKaisu(3);
        entity.setAtoServiceTanisu(5);
        entity.setAtoServiceTanisuTotal(7);
        entity.setAtoSeikyuKingaku(42000);
