...
public final class DbT3104KokuhorenInterfaceKanriEntityGenerator {
    ...
    public static final FlexibleYearMonth DEFAULT_コントロール上処理年月 = new FlexibleYearMonth("199001");
    public static final int DEFAULT_過誤コントロール上レコード件数 = 1;
    public static final FlexibleYearMonth DEFAULT_過誤コントロール上処理年月 = new FlexibleYearMonth("199001");
    public static final FlexibleYearMonth DEFAULT_実績データ上審査年月 = new FlexibleYearMonth("199001");
