...
public final class DbT3109JigyoKogakuKyufuTaishoshaGokeiEntityGenerator {
    ...
    public static final FlexibleYearMonth DEFAULT_対象者受取年月 = new FlexibleYear("1990");
    public static final FlexibleYearMonth DEFAULT_対象者判定審査年月 = new FlexibleYear("1990");
