...
public final class DbT3032KyufujissekiShoteiShikkanShisetsuRyoyoEntityGenerator {
    ...
    public static final int DEFAULT_所定疾患施設療養費日数 = 0;
    public static final int DEFAULT_所定疾患施設療養費小計 = 1;
    public static final int DEFAULT_後_往診日数 = 0;
    public static final int DEFAULT_後_通院日数 = 0;
    public static final int DEFAULT_後_緊急時治療管理単位数 = 1;
    public static final int DEFAULT_後_緊急時治療管理日数 = 0;
    ...
    public static final int DEFAULT_後_所定疾患施設療養費日数 = 0;
