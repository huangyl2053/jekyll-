...
public final class DbT3071KogakuGassanJikoFutanGakuMeisaiEntityGenerator {
    ...
    public static final Decimal DEFAULT_70-74自己負担額（内数） = new Decimal(0);
    public static final Decimal DEFAULT_70未満高額支給額 = new Decimal(0);
    public static final Decimal DEFAULT_70-74高額支給額 = new Decimal(0);
    public static final RString DEFAULT_摘要 = new RString("Data");
    public static final Decimal DEFAULT_補正済・自己負担額 = new Decimal(0);
    public static final Decimal DEFAULT_補正済・70-74自己負担額（内数） = new Decimal(0);
    public static final Decimal DEFAULT_補正済・70未満高額支給額 = new Decimal(0);
    public static final Decimal DEFAULT_補正済・70-74高額支給額 = new Decimal(0);
    public static final RString DEFAULT_補正済・摘要 = new RString("Data");
    ...
    public static DbT3071KogakuGassanJikoFutanGakuMeisaiEntity createDbT3071KogakuGassanJikoFutanGakuMeisaiEntity() {
        ...
        entity.setUchisu_70_74JikoFutanGaku(DEFAULT_70-74自己負担額（内数）);
        entity.setUnder_70KogakuShikyuGaku(DEFAULT_70未満高額支給額);
        entity.setOver_70_74KogakuShikyuGaku(DEFAULT_70-74高額支給額);
        entity.setTekiyo(DEFAULT_摘要);
        entity.setSumi_JikoFutanGaku(DEFAULT_補正済・自己負担額);
        entity.setSumi_70_74JikoFutanGaku(DEFAULT_補正済・70-74自己負担額（内数）);
        entity.setSumi_under_70KogakuShikyuGaku(DEFAULT_補正済・70未満高額支給額);
        entity.setSumi_70_74KogakuShikyuGaku(DEFAULT_補正済・70-74高額支給額);
        entity.setSumi_Tekiyo(DEFAULT_補正済・摘要);
        return entity;
    }
}
