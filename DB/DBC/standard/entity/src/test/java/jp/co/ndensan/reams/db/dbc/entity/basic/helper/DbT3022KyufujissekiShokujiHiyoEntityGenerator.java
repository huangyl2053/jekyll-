...
public final class DbT3022KyufujissekiShokujiHiyoEntityGenerator {
    ...
    public static final int DEFAULT_基本_提供日数 = 0;
    public static final int DEFAULT_基本_提供単価 = 0;
    public static final int DEFAULT_基本_提供金額 = 0;
    public static final int DEFAULT_特別_提供日数 = 0;
    public static final int DEFAULT_特別_提供単価 = 0;
    public static final int DEFAULT_特別_提供金額 = 0;
    public static final int DEFAULT_食事提供延べ日数 = 0;
    public static final int DEFAULT_公費１対象食事提供延べ日数 = 0;
    public static final int DEFAULT_公費２対象食事提供延べ日数 = 0;
    public static final int DEFAULT_公費３対象食事提供延べ日数 = 0;
    public static final int DEFAULT_食事提供費合計 = 0;
    public static final int DEFAULT_標準負担額_月額 = 0;
    public static final int DEFAULT_食事提供費請求額 = 0;
    public static final int DEFAULT_公費１食事提供費請求額 = 0;
    public static final int DEFAULT_公費２食事提供費請求額 = 0;
    public static final int DEFAULT_公費３食事提供費請求額 = 0;
    public static final int DEFAULT_標準負担額_日額 = 0;
    public static final int DEFAULT_後_基本食提供費用提供単価 = 0;
    public static final int DEFAULT_後_特別食提供費用提供単価 = 0;
    public static final int DEFAULT_後_食事提供費請求額 = 0;
