...
public final class DbT3025KyufujissekiKyotakuServiceEntityGenerator {
    ...
    public static final RString DEFAULT_サービス計画費明細行番号 = new RString("1");
    public static final RString DEFAULT_指定基準該当等事業所区分コード = new RString("1");
    ...
    public static final int DEFAULT_後_回数 = 1;
    ...
    public static DbT3025KyufujissekiKyotakuServiceEntity createDbT3025KyufujissekiKyotakuServiceEntity() {
        ...
        entity.setShiteiKijunGaitoJigyoshaKubunCode(DEFAULT_指定基準該当等事業所区分コード);
