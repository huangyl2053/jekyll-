...
public final class DbT3068KogakuGassanShinseishoEntityGenerator {
    ...
    public static final RString DEFAULT_国保支給申請書整理番号 = new RString("Data");
    public static final RString DEFAULT_支給申請区分 = new RString("Data");
    ...
    public static final RString DEFAULT_支給申請形態 = new RString("Data");
    public static final RString DEFAULT_自己負担額証明書交付申請の有無 = new RString("Data");
    public static final AtenaMeisho DEFAULT_申請代表者氏名 = new AtenaMeisho("");
    public static final YubinNo DEFAULT_申請代表者郵便番号 = new YubinNo("0010001");
    public static final RString DEFAULT_申請代表者住所 = new RString("Data");
    public static final TelNo DEFAULT_申請代表者電話番号 = new TelNo("08011112222");
    ...
    public static final RString DEFAULT_国保保険者名称 = new RString("Data");
    ...
    public static final RString DEFAULT_国保世帯番号 = new RString("Data");
    public static final RString DEFAULT_国保続柄 = new RString("Data");
    public static final FlexibleDate DEFAULT_国保加入期間開始年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_国保加入期間終了年月日 = new FlexibleDate("19900101");
    public static final RString DEFAULT_後期保険者番号 = new RString("Data");
    public static final RString DEFAULT_後期広域連合名称 = new RString("Data");
    public static final RString DEFAULT_後期被保険者番号 = new RString("Data");
    public static final FlexibleDate DEFAULT_後期加入期間開始年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_後期加入期間終了年月日 = new FlexibleDate("19900101");
    ...
    public static final FlexibleYearMonth DEFAULT_支給申請書情報送付年月 = new FlexibleYearMonth("199001");
    public static final RString DEFAULT_再送フラグ = new RString("Data");
    public static final FlexibleYearMonth DEFAULT_自己負担額計算年月 = new FlexibleYearMonth("199001");
    public static final RString DEFAULT_再計算区分 = new RString("Data");
