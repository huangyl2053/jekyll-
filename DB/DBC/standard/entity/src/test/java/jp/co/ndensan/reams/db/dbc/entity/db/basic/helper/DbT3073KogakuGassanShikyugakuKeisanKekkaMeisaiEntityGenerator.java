...
public final class DbT3073KogakuGassanShikyugakuKeisanKekkaMeisaiEntityGenerator {
    ...
    public static final RString DEFAULT_被保険者（証）番号 = new RString("Data");
    ...
    public static final RString DEFAULT_対象者氏名（漢字） = new RString("Data");
