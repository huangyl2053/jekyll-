...
public final class DbT3015KyufuKanrihyo200604EntityGenerator {
    ...
    public static final FlexibleYearMonth DEFAULT_限度額適用開始年月 = new FlexibleYearMonth("199001");
    public static final FlexibleYearMonth DEFAULT_限度額適用終了年月 = new FlexibleYearMonth("199001");
    ...
    public static final JigyoshaNo DEFAULT_委託先の居宅介護支援事業所番号 = new JigyoshaNo("1");
