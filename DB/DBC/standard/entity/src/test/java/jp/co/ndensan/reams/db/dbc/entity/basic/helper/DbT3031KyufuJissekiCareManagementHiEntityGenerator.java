...
public final class DbT3031KyufuJissekiCareManagementHiEntityGenerator {
    ...
    public static final RString DEFAULT_指定_基準該当事業所区分コード = new RString("Data");
    ...
    public static final int DEFAULT_後_回数 = 0;
    ...
    public static DbT3031KyufuJissekiCareManagementHiEntity createDbT3031KyufuJissekiCareManagementHiEntity() {
        ...
        entity.setShiteiKijungaitoJigyoshoKubunCode(DEFAULT_指定_基準該当事業所区分コード);
