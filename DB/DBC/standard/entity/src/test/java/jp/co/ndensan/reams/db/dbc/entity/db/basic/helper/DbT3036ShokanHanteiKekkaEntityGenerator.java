...
public final class DbT3036ShokanHanteiKekkaEntityGenerator {
    ...
    public static final RString DEFAULT_支給・不支給決定区分 = new RString("Data");
    public static final Decimal DEFAULT_支払金額 = new Decimal(0);
    public static final Decimal DEFAULT_支払金額内訳・利用者分 = new Decimal(0);
    public static final FlexibleYearMonth DEFAULT_決定一覧取込年月 = new FlexibleYear("1990");
    ...
    public static DbT3036ShokanHanteiKekkaEntity createDbT3036ShokanHanteiKekkaEntity() {
        ...
        entity.setShikyuHushikyuKetteiKubun(DEFAULT_支給・不支給決定区分);
        entity.setShiharaiKingaku(DEFAULT_支払金額);
        entity.setShiharaiKingakuUchiwakeRiyoshabun(DEFAULT_支払金額内訳・利用者分);
