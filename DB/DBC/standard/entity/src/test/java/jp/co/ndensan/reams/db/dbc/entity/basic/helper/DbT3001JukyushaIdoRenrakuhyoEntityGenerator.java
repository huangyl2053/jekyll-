...
public final class DbT3001JukyushaIdoRenrakuhyoEntityGenerator {
    ...
    public static final RString DEFAULT_被保険者氏名カナ = new RString("Data");
    ...
    public static final ShoKisaiHokenshaNo DEFAULT_広域連合_政令市_保険者番号 = new ShoKisaiHokenshaNo("1");
    public static final RString DEFAULT_申請種別コード = new RString("Data");
    public static final RString DEFAULT_変更申請中区分コード = new RString("Data");
    public static final FlexibleDate DEFAULT_申請年月日 = new FlexibleDate("19900101");
    public static final RString DEFAULT_みなし要介護状態区分コード = new RString("Data");
    ...
    public static final RString DEFAULT_認定有効期間終了年月日 = new RString("19900101");
    public static final RString DEFAULT_居宅サービス計画作成区分コード = new RString("Data");
    public static final RString DEFAULT_居宅介護支援事業所番号 = new RString("1");
    public static final RString DEFAULT_居宅サービス計画適用開始年月日 = new RString("19900101");
    public static final RString DEFAULT_居宅サービス計画適用終了年月日 = new RString("19900101");
    public static final int DEFAULT_訪問通所サービス支給限度基準額 = 1;
    public static final FlexibleDate DEFAULT_訪問通所サービス上限管理適用期間開始年月日 = new FlexibleDate("19900101");
    public static final RString DEFAULT_訪問通所サービス上限管理適用期間終了年月日 = new RString("19900101");
    public static final int DEFAULT_短期入所サービス支給限度基準額 = 1;
    public static final FlexibleDate DEFAULT_短期入所サービス上限管理適用期間開始年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_短期入所サービス上限管理適用期間終了年月日 = new FlexibleDate("19900101");
    public static final boolean DEFAULT_公費負担上限額減額有フラグ = false;
    public static final RString DEFAULT_償還払化開始年月日 = new RString("19900101");
    public static final RString DEFAULT_償還払化終了年月日 = new RString("19900101");
    public static final RString DEFAULT_給付率引下げ開始年月日 = new RString("19900101");
    public static final RString DEFAULT_給付率引下げ終了年月日 = new RString("19900101");
    public static final RString DEFAULT_減免申請中区分コード = new RString("Data");
    public static final RString DEFAULT_利用者負担区分コード = new RString("Data");
    public static final Decimal DEFAULT_給付率 = new Decimal(1);
    public static final RString DEFAULT_適用開始年月日 = new RString("19900101");
    public static final RString DEFAULT_適用終了年月日 = new RString("19900101");
    public static final RString DEFAULT_標準負担区分コード = new RString("Data");
    public static final Decimal DEFAULT_負担額 = new Decimal(1);
    public static final RString DEFAULT_負担額適用開始年月日 = new RString("19900101");
    public static final RString DEFAULT_負担額適用終了年月日 = new RString("19900101");
    public static final RString DEFAULT_特定入所者認定申請中区分コード = new RString("Data");
    public static final RString DEFAULT_特定入所者介護サービス区分コード = new RString("Data");
    public static final RString DEFAULT_課税層の特例減額措置対象フラグ = new RString("0");
    public static final RString DEFAULT_食費負担限度額 = new RString("1");
    public static final RString DEFAULT_居住費ユニット型個室負担限度額 = new RString("1");
    public static final RString DEFAULT_居住費ユニット型準個室負担限度額 = new RString("1");
    public static final RString DEFAULT_居住費従来型個室特養等負担限度額 = new RString("1");
    public static final RString DEFAULT_居住費従来型個室老健療養等負担限度額 = new RString("1");
    public static final RString DEFAULT_居住費多床室負担限度額 = new RString("1");
    public static final RString DEFAULT_負担限度額適用開始年月日 = new RString("19900101");
    public static final RString DEFAULT_負担限度額適用終了年月日 = new RString("19900101");
    public static final RString DEFAULT_軽減率 = new RString("1");
    public static final RString DEFAULT_軽減率適用開始年月日 = new RString("19900101");
    public static final RString DEFAULT_軽減率適用終了年月日 = new RString("19900101");
    public static final boolean DEFAULT_小多機能居宅介護利用開始月利用有フラグ = false;
    public static final RString DEFAULT_後期高齢者医療保険者番号 = new RString("Data");
    public static final RString DEFAULT_後期高齢者医療被保険者番号 = new RString("Data");
    public static final RString DEFAULT_国民健康保険保険者番号 = new RString("Data");
    public static final RString DEFAULT_国民健康保険被保険者証番号 = new RString("Data");
    public static final RString DEFAULT_国民健康保険個人番号 = new RString("Data");
    public static final RString DEFAULT_二次予防事業区分コード = new RString("Data");
    public static final FlexibleDate DEFAULT_二次予防事業有効期間開始年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_二次予防事業有効期間終了年月日 = new FlexibleDate("19900101");
    ...
    public static final RString DEFAULT_住所地特例対象者区分コード = new RString("Data");
    public static final RString DEFAULT_施設所在保険者番号 = new RString("Data");
    public static final RString DEFAULT_住所地特例適用開始日 = new RString("19900101");
    public static final RString DEFAULT_住所地特例適用終了日 = new RString("19900101");
    public static final RString DEFAULT_居宅費_新１_負担限度額 = new RString("1");
    public static final RString DEFAULT_居宅費_新２_負担限度額 = new RString("1");
    public static final RString DEFAULT_居宅費_新３_負担限度額 = new RString("1");
    public static final RString DEFAULT_利用者負担割合有効開始日 = new RString("19900101");
    public static final RString DEFAULT_利用者負担割合有効終了日 = new RString("19900101");
    ...
    public static DbT3001JukyushaIdoRenrakuhyoEntity createDbT3001JukyushaIdoRenrakuhyoEntity() {
        ...
        entity.setKoikiRengoHokenshaNo(DEFAULT_広域連合_政令市_保険者番号);
        ...
        entity.setShoTakinoKyotakuKaigoRiyozukiRiyoAriFlag(DEFAULT_小多機能居宅介護利用開始月利用有フラグ);
        ...
        entity.setJushochiTokureiTaishoshaKubunCode(DEFAULT_住所地特例対象者区分コード);
        entity.setShisetsuShozaiHokenjaNo(DEFAULT_施設所在保険者番号);
        entity.setJushochiTokureiTekiyoKaishiYMD(DEFAULT_住所地特例適用開始日);
        entity.setJushochiTokureiTekiyoShuryoYMD(DEFAULT_住所地特例適用終了日);
        entity.setKyotakuhiShin1FutanGendogaku(DEFAULT_居宅費_新１_負担限度額);
        entity.setKyotakuhiShin2FutanGendogaku(DEFAULT_居宅費_新２_負担限度額);
        entity.setKyotakuhiShin3FutanGendogaku(DEFAULT_居宅費_新３_負担限度額);
        entity.setRiyosyaFutanWariaiYukoKaishiYMD(DEFAULT_利用者負担割合有効開始日);
        entity.setRiyosyaFutanWariaiYukoShuryoYMD(DEFAULT_利用者負担割合有効終了日);
        return entity;
    }
}
