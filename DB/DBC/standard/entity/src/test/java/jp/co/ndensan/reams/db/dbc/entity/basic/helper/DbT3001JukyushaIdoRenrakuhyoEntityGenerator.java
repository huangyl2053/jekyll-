...
public final class DbT3001JukyushaIdoRenrakuhyoEntityGenerator {
    ...
    public static final HokenshaNo DEFAULT_広域連合_政令市_保険者番号 = new HokenshaNo("1");
    ...
    public static final JigyoshaNo DEFAULT_居宅介護支援事業所番号 = new JigyoshaNo("1");
    public static final FlexibleDate DEFAULT_居宅サービス計画適用開始年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_居宅サービス計画適用終了年月日 = new FlexibleDate("19900101");
    ...
    public static final FlexibleDate DEFAULT_訪問通所サービス上限管理適用期間終了年月日 = new FlexibleDate("19900101");
    public static final Decimal DEFAULT_短期入所サービス支給限度基準額 = new Decimal(0);
    ...
    public static final FlexibleDate DEFAULT_償還払化開始年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_償還払化終了年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_給付率引下げ開始年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_給付率引下げ終了年月日 = new FlexibleDate("19900101");
    ...
    public static final FlexibleDate DEFAULT_負担額適用開始年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_負担額適用終了年月日 = new FlexibleDate("19900101");
    ...
    public static final Decimal DEFAULT_食費負担限度額 = new Decimal(0);
    public static final Decimal DEFAULT_居住費ユニット型個室負担限度額 = new Decimal(0);
    public static final Decimal DEFAULT_居住費ユニット型準個室負担限度額 = new Decimal(0);
    public static final Decimal DEFAULT_居住費従来型個室特養等負担限度額 = new Decimal(0);
    public static final Decimal DEFAULT_居住費従来型個室老健療養等負担限度額 = new Decimal(0);
    public static final Decimal DEFAULT_居住費多床室負担限度額 = new Decimal(0);
    public static final FlexibleDate DEFAULT_負担限度額適用開始年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_負担限度額適用終了年月日 = new FlexibleDate("19900101");
    public static final Decimal DEFAULT_軽減率 = new Decimal(0);
    public static final FlexibleDate DEFAULT_軽減率適用開始年月日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_軽減率適用終了年月日 = new FlexibleDate("19900101");
    ...
    public static final FlexibleDate DEFAULT_住所地特例適用開始日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_住所地特例適用終了日 = new FlexibleDate("19900101");
    public static final Decimal DEFAULT_居宅費_新１_負担限度額 = new Decimal(0);
    public static final Decimal DEFAULT_居宅費_新２_負担限度額 = new Decimal(0);
    public static final Decimal DEFAULT_居宅費_新３_負担限度額 = new Decimal(0);
    public static final FlexibleDate DEFAULT_利用者負担割合有効開始日 = new FlexibleDate("19900101");
    public static final FlexibleDate DEFAULT_利用者負担割合有効終了日 = new FlexibleDate("19900101");
