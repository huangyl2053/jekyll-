...
public final class DbT3015KyufuKanrihyo200604EntityGenerator {
    ...
    public static final FlexibleYearMonth DEFAULT_限度額適用開始年月 = new FlexibleYear("1990");
    public static final FlexibleYearMonth DEFAULT_限度額適用終了年月 = new FlexibleYear("1990");
    public static final int DEFAULT_居宅・介護予防支給限度額 = 1;
    ...
    public static final int DEFAULT_給付計画単位数／日数 = 1;
    ...
    public static final int DEFAULT_給付計画合計単位数/日数 = 1;
    public static final RString DEFAULT_担当介護支援専門員番号 = new RString("Data");
    public static final JigyoshaNo DEFAULT_委託先の居宅介護支援事業所番号 = new JigyoshaNo();
    public static final RString DEFAULT_委託先の担当介護支援専門員番号 = new RString("Data");
    ...
    public static DbT3015KyufuKanrihyo200604Entity createDbT3015KyufuKanrihyo200604Entity() {
        ...
        entity.setGendogakuTekiyoKaishiYM(DEFAULT_限度額適用開始年月);
        entity.setGendogakuTekiyoShuryoYM(DEFAULT_限度額適用終了年月);
