...
/**
 * 事業高額介護サービス費支給申請エンティティのテスト用インスタンスを作成する補助クラスです。
 */
public final class DbT3110JigyoKogakuShikyuShinseiEntityGenerator {
    ...
    public static final JigyoshaNo DEFAULT_申請事業者番号 = new JigyoshaNo();
     ...
     */
    private DbT3110JigyoKogakuShikyuShinseiEntityGenerator() {
    }

    public static DbT3110JigyoKogakuShikyuShinseiEntity createDbT3110JigyoKogakuShikyuShinseiEntity() {
        DbT3110JigyoKogakuShikyuShinseiEntity entity = new DbT3110JigyoKogakuShikyuShinseiEntity();
