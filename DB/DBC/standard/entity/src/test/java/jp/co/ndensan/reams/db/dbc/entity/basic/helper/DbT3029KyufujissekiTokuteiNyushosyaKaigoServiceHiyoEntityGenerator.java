...
public final class DbT3029KyufujissekiTokuteiNyushosyaKaigoServiceHiyoEntityGenerator {
    ...
    public static final Decimal DEFAULT_費用単価 = new Decimal(1);
    public static final Decimal DEFAULT_負担限度額 = new Decimal(1);
    ...
    public static final Decimal DEFAULT_後_費用単価 = new Decimal(1);
