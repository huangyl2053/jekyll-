...
public final class DbT3029KyufujissekiTokuteiNyushosyaKaigoServiceHiyoEntityGenerator {
    ...
    public static final int DEFAULT_日数 = 0;
    public static final int DEFAULT_公費１日数 = 0;
    public static final int DEFAULT_公費２日数 = 0;
    public static final int DEFAULT_公費３日数 = 0;
    public static final Decimal DEFAULT_費用額 = new Decimal(1);
    public static final Decimal DEFAULT_保険分請求額 = new Decimal(1);
    public static final Decimal DEFAULT_公費１負担額_明細 = new Decimal(1);
    public static final Decimal DEFAULT_公費２負担額_明細 = new Decimal(1);
    public static final Decimal DEFAULT_公費３負担額_明細 = new Decimal(1);
    public static final Decimal DEFAULT_利用者負担額 = new Decimal(1);
    public static final Decimal DEFAULT_費用額合計 = new Decimal(1);
    public static final Decimal DEFAULT_保険分請求額合計 = new Decimal(1);
    public static final Decimal DEFAULT_利用者負担額合計 = new Decimal(1);
    public static final Decimal DEFAULT_公費１_負担額合計 = new Decimal(1);
    public static final Decimal DEFAULT_公費１_請求額 = new Decimal(1);
    public static final Decimal DEFAULT_公費１_本人負担月額 = new Decimal(1);
    public static final Decimal DEFAULT_公費２_負担額合計 = new Decimal(1);
    public static final Decimal DEFAULT_公費２_請求額 = new Decimal(1);
    public static final Decimal DEFAULT_公費２_本人負担月額 = new Decimal(1);
    public static final Decimal DEFAULT_公費３_負担額合計 = new Decimal(1);
    public static final Decimal DEFAULT_公費３_請求額 = new Decimal(1);
    public static final Decimal DEFAULT_公費３_本人負担月額 = new Decimal(1);
    public static final Decimal DEFAULT_後_費用単価 = new Decimal(0);
    public static final int DEFAULT_後_日数 = 0;
    public static final int DEFAULT_後_公費１日数 = 0;
    public static final int DEFAULT_後_公費２日数 = 0;
    public static final int DEFAULT_後_公費３日数 = 0;
    public static final Decimal DEFAULT_後_費用額 = new Decimal(1);
    public static final Decimal DEFAULT_後_保険分請求額 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費１負担額_明細 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費２負担額_明細 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費３負担額_明細 = new Decimal(1);
    public static final Decimal DEFAULT_後_利用者負担額 = new Decimal(1);
    public static final Decimal DEFAULT_後_費用額合計 = new Decimal(1);
    public static final Decimal DEFAULT_後_保険分請求額合計 = new Decimal(1);
    public static final Decimal DEFAULT_後_利用者負担額合計 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費１_負担額合計 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費１_請求額 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費１_本人負担月額 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費２_負担額合計 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費２_請求額 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費２_本人負担月額 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費３_負担額合計 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費３_請求額 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費３_本人負担月額 = new Decimal(1);
