...
public final class DbT3029KyufujissekiTokuteiNyushosyaKaigoServiceHiyoEntityGenerator {
    ...
    public static final Decimal DEFAULT_後_日数 = new Decimal(0);
    public static final Decimal DEFAULT_後_公費１日数 = new Decimal(0);
    public static final Decimal DEFAULT_後_公費２日数 = new Decimal(0);
    public static final Decimal DEFAULT_後_公費３日数 = new Decimal(0);
