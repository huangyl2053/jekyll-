...
public final class DbT3068KogakuGassanShinseishoEntityGenerator {
    ...
    public static final FlexibleYearMonth DEFAULT_支給申請書情報送付年月 = new FlexibleYear("1990");
    public static final RString DEFAULT_再送フラグ = new RString("Data");
    public static final FlexibleYearMonth DEFAULT_自己負担額計算年月 = new FlexibleYear("1990");
