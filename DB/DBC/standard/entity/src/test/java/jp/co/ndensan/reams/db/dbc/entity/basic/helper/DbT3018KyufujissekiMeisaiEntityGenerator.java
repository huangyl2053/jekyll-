...
public final class DbT3018KyufujissekiMeisaiEntityGenerator {
    ...
    public static final int DEFAULT_公費１対象日数_回数 = 0;
    public static final int DEFAULT_公費２対象日数_回数 = 0;
    public static final int DEFAULT_公費３対象日数_回数 = 0;
    public static final Decimal DEFAULT_サービス単位数 = new Decimal(1);
    public static final Decimal DEFAULT_公費１対象サービス単位数 = new Decimal(1);
    public static final Decimal DEFAULT_公費２対象サービス単位数 = new Decimal(1);
    public static final Decimal DEFAULT_公費３対象サービス単位数 = new Decimal(1);
    public static final RString DEFAULT_摘要 = new RString("Data");
    public static final Decimal DEFAULT_後_単位数 = new Decimal(0);
    public static final int DEFAULT_後_日数_回数 = 0;
    public static final int DEFAULT_後_公費１対象日数_回数 = 0;
    public static final int DEFAULT_後_公費２対象日数_回数 = 0;
    public static final int DEFAULT_後_公費３対象日数_回数 = 0;
    public static final Decimal DEFAULT_後_サービス単位数 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費１対象サービス単位数 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費２対象サービス単位数 = new Decimal(1);
    public static final Decimal DEFAULT_後_公費３対象サービス単位数 = new Decimal(1);
