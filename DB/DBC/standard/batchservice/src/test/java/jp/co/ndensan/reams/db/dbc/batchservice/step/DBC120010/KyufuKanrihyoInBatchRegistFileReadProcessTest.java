...
public class KyufuKanrihyoInBatchRegistFileReadProcessTest extends DbcTestDacBase {
    ...
    public static class Test_KyufuKanrihyoInBatchRegistFileReadProcess extends DbcTestDacBase {
        ...
        private static final RString 実行前状態BackUp用CSV = new RString("bkup_KyufuKanrihyoInBatchRegistFileReadProcess_DbT3104KokuhorenInterfaceKanri.csv");
        private static final RString 想定する実行前状態CSV = new RString("before_KyufuKanrihyoInBatchRegistFileReadProcess_DbT3104KokuhorenInterfaceKanri.csv");

        private static final RString 実行結果CSV_給付管理票200004 = new RString("KyufuKanrihyoInBatchRegistFileReadProcessRunResult_DbT3014KyufuKanrihyo200004.csv");
        private static final RString 実行結果CSV_給付管理票200604 = new RString("KyufuKanrihyoInBatchRegistFileReadProcessRunResult_DbT3015KyufuKanrihyo200604.csv");
        private static final RString 想定結果CSV_給付管理票200004 = new RString("KyufuKanrihyoInBatchRegistFileReadProcessResult_DbT3014KyufuKanrihyo200004.csv");
        private static final RString 想定結果CSV_給付管理票200604 = new RString("KyufuKanrihyoInBatchRegistFileReadProcessResult_DbT3015KyufuKanrihyo200604.csv");
        ...
        private HashMap<RString, Object> createBatchParameter() {
            ...
            processParameter.put(KyufuKanrihyoInBatchRegistFileReadProcess.PARAMETER_SHORIYM, new RString("201410"));
