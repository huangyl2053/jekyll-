...
import jp.co.ndensan.reams.db.dbc.model.KyufujissekiKyotakuServiceModel;
...
public class KyufujissekiKyotakuServiceModelTest extends DbzTestBase {
    ...
    public static class getterSetterTest extends DbzTestBase {
        ...
        public void 戻り値の指定基準該当等事業所区分コードは_設定した値と同じ指定基準該当等事業所区分コードを返す() {
            sut.set指定基準該当等事業所区分コード(DbT3025KyufujissekiKyotakuServiceEntityGenerator.DEFAULT_指定_基準該当等事業所区分コード);
            assertThat(sut.get指定基準該当等事業所区分コード(), is(DbT3025KyufujissekiKyotakuServiceEntityGenerator.DEFAULT_指定_基準該当等事業所区分コード));
        }
