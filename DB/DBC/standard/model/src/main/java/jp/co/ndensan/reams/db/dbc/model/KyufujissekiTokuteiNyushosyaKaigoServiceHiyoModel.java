...
public class KyufujissekiTokuteiNyushosyaKaigoServiceHiyoModel implements Serializable {
     ...
     * @param 費用単価 費用単価
     */
    public void set費用単価(Decimal 費用単価) {
     ...
     * @param 負担限度額 負担限度額
     */
    public void set負担限度額(Decimal 負担限度額) {
     ...
     * @param 公費１日数 公費１日数
     */
    public void set公費１日数(Decimal 公費１日数) {
     ...
     * @param 公費２日数 公費２日数
     */
    public void set公費２日数(Decimal 公費２日数) {
     ...
     * @param 公費３日数 公費３日数
     */
    public void set公費３日数(Decimal 公費３日数) {
     ...
     * @param 費用額 費用額
     */
    public void set費用額(Decimal 費用額) {
     ...
     * @param 保険分請求額 保険分請求額
     */
    public void set保険分請求額(Decimal 保険分請求額) {
     ...
     */
    public void set公費１負担額_明細(Decimal 公費１負担額_明細) {
     ...
     */
    public void set公費２負担額_明細(Decimal 公費２負担額_明細) {
     ...
     */
    public void set公費３負担額_明細(Decimal 公費３負担額_明細) {
     ...
     */
    public void set保険分請求額合計(Decimal 保険分請求額合計) {
     ...
     */
    public void set公費１_負担額合計(Decimal 公費１_負担額合計) {
     ...
     */
    public void set公費１_本人負担月額(Decimal 公費１_本人負担月額) {
     ...
     */
    public void set公費２_負担額合計(Decimal 公費２_負担額合計) {
     ...
     */
    public void set公費２_本人負担月額(Decimal 公費２_本人負担月額) {
     ...
     */
    public void set公費３_負担額合計(Decimal 公費３_負担額合計) {
     ...
     */
    public void set公費３_本人負担月額(Decimal 公費３_本人負担月額) {
     ...
     * @param 後_費用単価 後_費用単価
     */
    public void set後_費用単価(Decimal 後_費用単価) {
     ...
     * @param 後_日数 後_日数
     */
    public void set後_日数(Decimal 後_日数) {
     ...
     */
    public void set後_公費１日数(Decimal 後_公費１日数) {
     ...
     */
    public void set後_公費２日数(Decimal 後_公費２日数) {
     ...
     */
    public void set後_公費３日数(Decimal 後_公費３日数) {
     ...
     * @param 後_費用額 後_費用額
     */
    public void set後_費用額(Decimal 後_費用額) {
     ...
     */
    public void set後_保険分請求額(Decimal 後_保険分請求額) {
     ...
     */
    public void set後_公費１負担額_明細(Decimal 後_公費１負担額_明細) {
     ...
     */
    public void set後_公費２負担額_明細(Decimal 後_公費２負担額_明細) {
     ...
     */
    public void set後_公費３負担額_明細(Decimal 後_公費３負担額_明細) {
     ...
     */
    public void set後_利用者負担額(Decimal 後_利用者負担額) {
     ...
     */
    public void set後_費用額合計(Decimal 後_費用額合計) {
     ...
     */
    public void set後_保険分請求額合計(Decimal 後_保険分請求額合計) {
     ...
     */
    public void set後_利用者負担額合計(Decimal 後_利用者負担額合計) {
     ...
     */
    public void set後_公費１_負担額合計(Decimal 後_公費１_負担額合計) {
     ...
     */
    public void set後_公費１_本人負担月額(Decimal 後_公費１_本人負担月額) {
     ...
     */
    public void set後_公費２_負担額合計(Decimal 後_公費２_負担額合計) {
     ...
     */
    public void set後_公費２_本人負担月額(Decimal 後_公費２_本人負担月額) {
     ...
     */
    public void set後_公費３_負担額合計(Decimal 後_公費３_負担額合計) {
     ...
     */
    public void set後_公費３_本人負担月額(Decimal 後_公費３_本人負担月額) {
