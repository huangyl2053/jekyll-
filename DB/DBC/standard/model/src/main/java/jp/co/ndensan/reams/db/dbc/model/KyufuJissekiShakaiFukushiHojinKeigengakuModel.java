...
public class KyufuJissekiShakaiFukushiHojinKeigengakuModel implements Serializable {
     ...
     */
    public void set受領すべき利用者負担の総額(Decimal 受領すべき利用者負担の総額) {
     ...
     * @param 軽減額 軽減額
     */
    public void set軽減額(Decimal 軽減額) {
     ...
     */
    public void set軽減後利用者負担額(Decimal 軽減後利用者負担額) {
     ...
     */
    public void set後_受領すべき利用者負担の総額(Decimal 後_受領すべき利用者負担の総額) {
     ...
     * @param 後_軽減額 後_軽減額
     */
    public void set後_軽減額(Decimal 後_軽減額) {
     ...
     */
    public void set後_軽減後利用者負担額(Decimal 後_軽減後利用者負担額) {
