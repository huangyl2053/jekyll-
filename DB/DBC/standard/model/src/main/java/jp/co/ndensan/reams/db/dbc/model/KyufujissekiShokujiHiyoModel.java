...
public class KyufujissekiShokujiHiyoModel implements Serializable {
     ...
     */
    public void set基本_提供日数(Decimal 基本_提供日数) {
     ...
     */
    public void set基本_提供単価(Decimal 基本_提供単価) {
     ...
     */
    public void set基本_提供金額(Decimal 基本_提供金額) {
     ...
     */
    public void set特別_提供日数(Decimal 特別_提供日数) {
     ...
     */
    public void set特別_提供単価(Decimal 特別_提供単価) {
     ...
     */
    public void set特別_提供金額(Decimal 特別_提供金額) {
     ...
     */
    public void set食事提供延べ日数(Decimal 食事提供延べ日数) {
     ...
     */
    public void set公費１対象食事提供延べ日数(Decimal 公費１対象食事提供延べ日数) {
     ...
     */
    public void set公費２対象食事提供延べ日数(Decimal 公費２対象食事提供延べ日数) {
     ...
     */
    public void set公費３対象食事提供延べ日数(Decimal 公費３対象食事提供延べ日数) {
     ...
     */
    public void set食事提供費合計(Decimal 食事提供費合計) {
     ...
     */
    public void set標準負担額_月額(Decimal 標準負担額_月額) {
     ...
     */
    public void set食事提供費請求額(Decimal 食事提供費請求額) {
     ...
     */
    public void set公費１食事提供費請求額(Decimal 公費１食事提供費請求額) {
     ...
     */
    public void set公費２食事提供費請求額(Decimal 公費２食事提供費請求額) {
     ...
     */
    public void set公費３食事提供費請求額(Decimal 公費３食事提供費請求額) {
     ...
     */
    public void set標準負担額_日額(Decimal 標準負担額_日額) {
     ...
     */
    public void set後_基本食提供費用提供単価(Decimal 後_基本食提供費用提供単価) {
     ...
     */
    public void set後_特別食提供費用提供単価(Decimal 後_特別食提供費用提供単価) {
     ...
     */
    public void set後_食事提供費請求額(Decimal 後_食事提供費請求額) {
