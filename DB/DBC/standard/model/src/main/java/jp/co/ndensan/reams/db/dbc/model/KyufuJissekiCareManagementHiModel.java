...
/**
 * 給付実績ケアマネジメント費のモデルクラスです。
 *
 * @author LDNS 周杏月
 */
public class KyufuJissekiCareManagementHiModel implements Serializable {

    private DbT3031KyufuJissekiCareManagementHiEntity entity;

    /**
     * コンストラクタです。
     */
    public KyufuJissekiCareManagementHiModel() {
        entity = new DbT3031KyufuJissekiCareManagementHiEntity();
    }

    /**
     * コンストラクタです。
     *
     * @param entity DbT3031KyufuJissekiCareManagementHiEntity
     */
    public KyufuJissekiCareManagementHiModel(DbT3031KyufuJissekiCareManagementHiEntity entity) {
        this.entity = entity;
    }

    /**
     * DbT3031KyufuJissekiCareManagementHiEntityを返します。
     *
     * @return DbT3031KyufuJissekiCareManagementHiEntity
     */
    public DbT3031KyufuJissekiCareManagementHiEntity getEntity() {
        return entity;
    }

    /**
     * DbT3031KyufuJissekiCareManagementHiEntityを設定します。
     *
     * @param entity DbT3031KyufuJissekiCareManagementHiEntity
     */
    public void setEntity(DbT3031KyufuJissekiCareManagementHiEntity entity) {
        this.entity = entity;
    }
     ...
     */
    public RString get指定基準該当事業所区分コード() {
    ...
    /**
     * 指定基準該当事業所区分コードを設定します。
     *
     * @param 指定基準該当事業所区分コード 指定基準該当事業所区分コード
     */
    public void set指定基準該当事業所区分コード(RString 指定基準該当事業所区分コード) {
     ...
     * @param 後_単位数 後_単位数
     */
    public void set後_単位数(Decimal 後_単位数) {
     ...
     * @param 後_回数 後_回数
     */
    public void set後_回数(Decimal 後_回数) {
