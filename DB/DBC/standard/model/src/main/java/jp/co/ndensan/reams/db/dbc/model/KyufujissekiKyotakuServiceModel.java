...
public class KyufujissekiKyotakuServiceModel implements Serializable {
     ...
     */
    public void setサービス単位数合計(Decimal サービス単位数合計) {
     ...
     * @param 請求金額 請求金額
     */
    public void set請求金額(Decimal 請求金額) {
     ...
     */
    public void set後_サービス単位数合計(Decimal 後_サービス単位数合計) {
     ...
     * @param 後_請求金額 後_請求金額
     */
    public void set後_請求金額(Decimal 後_請求金額) {
