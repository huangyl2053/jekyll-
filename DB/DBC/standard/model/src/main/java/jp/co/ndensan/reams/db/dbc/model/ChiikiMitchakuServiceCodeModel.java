...
/**
 * 地域密着型介護サービスコードのモデルクラスです。
 *
 * @author LDNS 宋文娟
 */
public class ChiikiMitchakuServiceCodeModel implements Serializable {

    private DbT7121ChiikiMitchakuServiceCodeEntity entity;

    /**
     * コンストラクタです。
     */
    public ChiikiMitchakuServiceCodeModel() {
        entity = new DbT7121ChiikiMitchakuServiceCodeEntity();
    }

    /**
     * コンストラクタです。
     *
     * @param entity DbT7121ChiikiMitchakuServiceCodeEntity
     */
    public ChiikiMitchakuServiceCodeModel(DbT7121ChiikiMitchakuServiceCodeEntity entity) {
        this.entity = entity;
    }

    /**
     * DbT7121ChiikiMitchakuServiceCodeEntityを返します。
     *
     * @return DbT7121ChiikiMitchakuServiceCodeEntity
     */
    public DbT7121ChiikiMitchakuServiceCodeEntity getEntity() {
        return entity;
    }

    /**
     * DbT7121ChiikiMitchakuServiceCodeEntityを設定します。
     *
     * @param entity DbT7121ChiikiMitchakuServiceCodeEntity
     */
    public void setEntity(DbT7121ChiikiMitchakuServiceCodeEntity entity) {
        this.entity = entity;
    }
