...
public class KyufujissekiMeisaiModel implements Serializable {
     ...
     * @param 日数_回数 日数_回数
     */
    public void set日数_回数(Decimal 日数_回数) {
     ...
     */
    public void set公費１対象日数_回数(Decimal 公費１対象日数_回数) {
     ...
     */
    public void set公費２対象日数_回数(Decimal 公費２対象日数_回数) {
     ...
     */
    public void set公費３対象日数_回数(Decimal 公費３対象日数_回数) {
     ...
     */
    public void setサービス単位数(Decimal サービス単位数) {
     ...
     */
    public void set公費１対象サービス単位数(Decimal 公費１対象サービス単位数) {
     ...
     */
    public void set公費２対象サービス単位数(Decimal 公費２対象サービス単位数) {
     ...
     */
    public void set公費３対象サービス単位数(Decimal 公費３対象サービス単位数) {
     ...
     */
    public void set後_日数_回数(Decimal 後_日数_回数) {
     ...
     */
    public void set後_公費１対象日数_回数(Decimal 後_公費１対象日数_回数) {
     ...
     */
    public void set後_公費２対象日数_回数(Decimal 後_公費２対象日数_回数) {
     ...
     */
    public void set後_公費３対象日数_回数(Decimal 後_公費３対象日数_回数) {
     ...
     */
    public void set後_サービス単位数(Decimal 後_サービス単位数) {
     ...
     */
    public void set後_公費１対象サービス単位数(Decimal 後_公費１対象サービス単位数) {
     ...
     */
    public void set後_公費２対象サービス単位数(Decimal 後_公費２対象サービス単位数) {
     ...
     */
    public void set後_公費３対象サービス単位数(Decimal 後_公費３対象サービス単位数) {
