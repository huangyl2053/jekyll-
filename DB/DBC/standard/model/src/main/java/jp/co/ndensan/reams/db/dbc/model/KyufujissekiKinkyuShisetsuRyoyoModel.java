...
/**
 * 給付実績緊急時施設療養のモデルクラスです。
 *
 * @author LDNS 鄭雪双
 */
public class KyufujissekiKinkyuShisetsuRyoyoModel implements Serializable {

    private DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity entity;

    /**
     * コンストラクタです。
     */
    public KyufujissekiKinkyuShisetsuRyoyoModel() {
        entity = new DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity();
    }
     ...
     */
    public KyufujissekiKinkyuShisetsuRyoyoModel(DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity entity) {
        this.entity = entity;
    }

    /**
     * DbT3019KyufujissekiKinkyuShisetsuRyoyoEntityを返します。
     *
     * @return DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity
     */
    public DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity getEntity() {
        return entity;
    }

    /**
     * DbT3019KyufujissekiKinkyuShisetsuRyoyoEntityを設定します。
     *
     * @param entity DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity
     */
    public void setEntity(DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity entity) {
        this.entity = entity;
    }
     ...
     * @param 往診日数 往診日数
     */
    public void set往診日数(Decimal 往診日数) {
     ...
     * @param 通院日数 通院日数
     */
    public void set通院日数(Decimal 通院日数) {
     ...
     */
    public void set緊急時治療管理日数(Decimal 緊急時治療管理日数) {
     ...
     * @param 後_往診日数 後_往診日数
     */
    public void set後_往診日数(Decimal 後_往診日数) {
     ...
     * @param 後_通院日数 後_通院日数
     */
    public void set後_通院日数(Decimal 後_通院日数) {
     ...
     */
    public void set後_緊急時治療管理日数(Decimal 後_緊急時治療管理日数) {
