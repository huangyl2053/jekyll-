...
public class KyufujissekiShukeiModel implements Serializable {
     ...
     */
    public void setサービス実日数(Decimal サービス実日数) {
     ...
     * @param 計画単位数 計画単位数
     */
    public void set計画単位数(Decimal 計画単位数) {
     ...
     */
    public void set限度額管理対象単位数(Decimal 限度額管理対象単位数) {
     ...
     */
    public void set限度額管理対象外単位数(Decimal 限度額管理対象外単位数) {
     ...
     */
    public void set短期入所計画日数(Decimal 短期入所計画日数) {
     ...
     */
    public void set短期入所実日数(Decimal 短期入所実日数) {
     ...
     */
    public void set保険_単位数合計(Decimal 保険_単位数合計) {
     ...
     * @param 保険_請求額 保険_請求額
     */
    public void set保険_請求額(Decimal 保険_請求額) {
     ...
     */
    public void set保険_利用者負担額(Decimal 保険_利用者負担額) {
     ...
     */
    public void set公費１_単位数合計(Decimal 公費１_単位数合計) {
     ...
     */
    public void set公費１_請求額(Decimal 公費１_請求額) {
     ...
     */
    public void set公費１_本人負担額(Decimal 公費１_本人負担額) {
     ...
     */
    public void set公費２_単位数合計(Decimal 公費２_単位数合計) {
     ...
     */
    public void set公費２_請求額(Decimal 公費２_請求額) {
     ...
     */
    public void set公費２_本人負担額(Decimal 公費２_本人負担額) {
     ...
     */
    public void set公費３_単位数合計(Decimal 公費３_単位数合計) {
     ...
     */
    public void set公費３_請求額(Decimal 公費３_請求額) {
     ...
     */
    public void set公費３_本人負担額(Decimal 公費３_本人負担額) {
     ...
     */
    public void set保険_出来高単位数合計(Decimal 保険_出来高単位数合計) {
     ...
     */
    public void set保険_出来高請求額(Decimal 保険_出来高請求額) {
     ...
     */
    public void set保険_出来高医療費利用者負担額(Decimal 保険_出来高医療費利用者負担額) {
     ...
     */
    public void set公費１_出来高単位数合計(Decimal 公費１_出来高単位数合計) {
     ...
     */
    public void set公費１_出来高請求額(Decimal 公費１_出来高請求額) {
     ...
     */
    public void set公費１_出来高医療費利用者負担額(Decimal 公費１_出来高医療費利用者負担額) {
     ...
     */
    public void set公費２_出来高単位数合計(Decimal 公費２_出来高単位数合計) {
     ...
     */
    public void set公費２_出来高請求額(Decimal 公費２_出来高請求額) {
     ...
     */
    public void set公費２_出来高医療費本人負担額(Decimal 公費２_出来高医療費本人負担額) {
     ...
     */
    public void set公費３_出来高単位数合計(Decimal 公費３_出来高単位数合計) {
     ...
     */
    public void set公費３_出来高請求額(Decimal 公費３_出来高請求額) {
     ...
     */
    public void set公費３_出来高医療費本人負担額(Decimal 公費３_出来高医療費本人負担額) {
     ...
     */
    public void set後_短期入所実日数(Decimal 後_短期入所実日数) {
     ...
     */
    public void set後_単位数合計(Decimal 後_単位数合計) {
     ...
     */
    public void set後_保険請求分請求額(Decimal 後_保険請求分請求額) {
     ...
     */
    public void set後_公費１_単位数合計(Decimal 後_公費１_単位数合計) {
     ...
     */
    public void set後_公費２_単位数合計(Decimal 後_公費２_単位数合計) {
     ...
     */
    public void set後_公費３_単位数合計(Decimal 後_公費３_単位数合計) {
     ...
     */
    public void set後_保険_出来高単位数合計(Decimal 後_保険_出来高単位数合計) {
     ...
     */
    public void set後_保険_出来高請求額(Decimal 後_保険_出来高請求額) {
     ...
     */
    public void set後_公費１_出来高単位数合計(Decimal 後_公費１_出来高単位数合計) {
     ...
     */
    public void set後_公費１_出来高請求額(Decimal 後_公費１_出来高請求額) {
     ...
     */
    public void set後_公費２_出来高単位数合計(Decimal 後_公費２_出来高単位数合計) {
     ...
     */
    public void set後_公費２_出来高請求額(Decimal 後_公費２_出来高請求額) {
     ...
     */
    public void set後_公費３_出来高単位数合計(Decimal 後_公費３_出来高単位数合計) {
     ...
     */
    public void set後_公費３_出来高請求額(Decimal 後_公費３_出来高請求額) {
     ...
     * @param 再審査回数 再審査回数
     */
    public void set再審査回数(Decimal 再審査回数) {
     ...
     * @param 過誤回数 過誤回数
     */
    public void set過誤回数(Decimal 過誤回数) {
     ...
     * @param 整理番号 整理番号
     */
    public void set整理番号(Decimal 整理番号) {
