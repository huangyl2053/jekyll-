...
public class KyufujissekiTokuteiSinryoTokubetsuRyoyoModel implements Serializable {
     ...
     * @param 保険_回数 保険_回数
     */
    public void set保険_回数(Decimal 保険_回数) {
     ...
     * @param 公費１_回数 公費１_回数
     */
    public void set公費１_回数(Decimal 公費１_回数) {
     ...
     * @param 公費２_回数 公費２_回数
     */
    public void set公費２_回数(Decimal 公費２_回数) {
     ...
     * @param 公費３_回数 公費３_回数
     */
    public void set公費３_回数(Decimal 公費３_回数) {
     ...
     */
    public void set後_保険_回数(Decimal 後_保険_回数) {
     ...
     */
    public void set後_公費１_回数(Decimal 後_公費１_回数) {
     ...
     */
    public void set後_公費２_回数(Decimal 後_公費２_回数) {
     ...
     */
    public void set後_公費３_回数(Decimal 後_公費３_回数) {
