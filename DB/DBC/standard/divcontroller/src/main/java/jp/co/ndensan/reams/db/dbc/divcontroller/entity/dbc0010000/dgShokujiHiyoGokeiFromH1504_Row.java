...
/**
 * dgShokujiHiyoGokeiFromH1504_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgShokujiHiyoGokeiFromH1504_Row extends DataRow {

    private RString txtShokujiTeikyohiGokei;
    private RString txtHyojunFutangakuTsuki;
    private RString txtHyojunFutangakuHi;
    private RString txtKohi;
    ...
    public dgShokujiHiyoGokeiFromH1504_Row(RString txtShokujiTeikyohiGokei, RString txtHyojunFutangakuTsuki, RString txtHyojunFutangakuHi, RString txtKohi, RString txtShokujiTeikyoNobeNissu, RString txtSeikyugakuZengo, RString txtKohiSeikyu, RString txtShokujiTeikyohiSeikyugaku, RString txtSaishinsaKaisu, RString txtKagoKaisu, RString txtShinsaYM) {
        ...
        this.setOriginalData("txtKohi", txtKohi);
    ...
    public RString getTxtHyojunFutangakuTsuki() {
        return txtHyojunFutangakuTsuki;
    }

    public RString getTxtHyojunFutangakuHi() {
        return txtHyojunFutangakuHi;
    }

    public RString getTxtKohi() {
        return txtKohi;
    }

    public RString getTxtShokujiTeikyoNobeNissu() {
        return txtShokujiTeikyoNobeNissu;
    }

    public RString getTxtSeikyugakuZengo() {
        return txtSeikyugakuZengo;
    }

    public RString getTxtKohiSeikyu() {
    ...
    public void setTxtHyojunFutangakuTsuki(RString txtHyojunFutangakuTsuki) {
        this.setOriginalData("txtHyojunFutangakuTsuki", txtHyojunFutangakuTsuki);
        this.txtHyojunFutangakuTsuki = txtHyojunFutangakuTsuki;
    }

    public void setTxtHyojunFutangakuHi(RString txtHyojunFutangakuHi) {
        this.setOriginalData("txtHyojunFutangakuHi", txtHyojunFutangakuHi);
        this.txtHyojunFutangakuHi = txtHyojunFutangakuHi;
    }

    public void setTxtKohi(RString txtKohi) {
        this.setOriginalData("txtKohi", txtKohi);
        this.txtKohi = txtKohi;
    }

    public void setTxtShokujiTeikyoNobeNissu(RString txtShokujiTeikyoNobeNissu) {
        this.setOriginalData("txtShokujiTeikyoNobeNissu", txtShokujiTeikyoNobeNissu);
        this.txtShokujiTeikyoNobeNissu = txtShokujiTeikyoNobeNissu;
    }

    public void setTxtSeikyugakuZengo(RString txtSeikyugakuZengo) {
        this.setOriginalData("txtSeikyugakuZengo", txtSeikyugakuZengo);
        this.txtSeikyugakuZengo = txtSeikyugakuZengo;
    }
