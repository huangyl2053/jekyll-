...
public class panelShokujiDiv extends Panel {
    ...
    @JsonProperty("panelShokujiGokei")
    private panelShokujiGokeiDiv panelShokujiGokei;
    ...
    /*
     * getpanelShokujiGokei
     * @return panelShokujiGokei
     */
    @JsonProperty("panelShokujiGokei")
    public panelShokujiGokeiDiv getPanelShokujiGokei() {
        return panelShokujiGokei;
    }

    /*
     * setpanelShokujiGokei
     * @param panelShokujiGokei panelShokujiGokei
     */
    @JsonProperty("panelShokujiGokei")
    public void setPanelShokujiGokei(panelShokujiGokeiDiv panelShokujiGokei) {
        this.panelShokujiGokei = panelShokujiGokei;
    }
