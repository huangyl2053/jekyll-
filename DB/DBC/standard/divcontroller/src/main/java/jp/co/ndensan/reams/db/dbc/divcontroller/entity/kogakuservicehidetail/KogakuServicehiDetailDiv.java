package jp.co.ndensan.reams.db.dbc.divcontroller.entity.kogakuservicehidetail;

/**
 * このコードはツールによって生成されました。 このファイルへの変更は、再生成時には損失するため 不正な動作の原因になります。
 */
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.kogakuservicehidetail.IKogakuServicehiDetailDiv;
import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.annotation.JsonProperty;
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.kogakuservicehidetail.tabKogakuServicehiDetailDiv;
