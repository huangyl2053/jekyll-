...
/**
 * ShokanShikyuKetteiShomeisho のクラスファイル 
 * 
 * @author 自動生成
 */
public class ShokanShikyuKetteiShomeishoDiv extends Panel {
    /*
     * [ private の作成 ]
    ...
    @JsonProperty("tabShokanShikyuKetteiShomeisho")
    private tabShokanShikyuKetteiShomeishoDiv tabShokanShikyuKetteiShomeisho;
    ...
    @JsonProperty("tabShokanShikyuKetteiShomeisho")
    public tabShokanShikyuKetteiShomeishoDiv getTabShokanShikyuKetteiShomeisho() {
        return tabShokanShikyuKetteiShomeisho;
    }

    @JsonProperty("tabShokanShikyuKetteiShomeisho")
    public void setTabShokanShikyuKetteiShomeisho(tabShokanShikyuKetteiShomeishoDiv tabShokanShikyuKetteiShomeisho) {
        this.tabShokanShikyuKetteiShomeisho=tabShokanShikyuKetteiShomeisho;
    }
