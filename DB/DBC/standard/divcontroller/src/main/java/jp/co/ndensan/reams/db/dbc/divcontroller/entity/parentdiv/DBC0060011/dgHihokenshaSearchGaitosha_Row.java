...
public class dgHihokenshaSearchGaitosha_Row extends DataRow implements Serializable {
    ...
    public dgHihokenshaSearchGaitosha_Row() {
        ...
        this.txtHiHokeNo = RString.EMPTY;
        this.txtJigyoshaNo = RString.EMPTY;
        this.txtHihoName = RString.EMPTY;
        this.txtKyufuKanrihyo200604 = RString.EMPTY;
        ...
        this.setOriginalData("txtHiHokeNo", txtHiHokeNo);
        this.setOriginalData("txtJigyoshaNo", txtJigyoshaNo);
        this.setOriginalData("txtHihoName", txtHihoName);
        this.setOriginalData("txtKyufuKanrihyo200604", txtKyufuKanrihyo200604);
    }

    public dgHihokenshaSearchGaitosha_Row(RString txtTeikyoYM, RString txtShinsaYM, RString txtKyufuJissekiSakuseiKubun, RString txtHiHokeNo, RString txtJigyoshaNo, RString txtHihoName, RString txtKyufuKanrihyo200604) {
        super();
        this.setOriginalData("txtTeikyoYM", txtTeikyoYM);
        this.setOriginalData("txtShinsaYM", txtShinsaYM);
        this.setOriginalData("txtKyufuJissekiSakuseiKubun", txtKyufuJissekiSakuseiKubun);
        ...
        this.txtHiHokeNo = txtHiHokeNo;
        this.txtJigyoshaNo = txtJigyoshaNo;
        this.txtHihoName = txtHihoName;
        this.txtKyufuKanrihyo200604 = txtKyufuKanrihyo200604;
    }
    ...
    public RString getTxtKyufuKanrihyo200604() {
        return txtKyufuKanrihyo200604;
    }
    ...
    public void setTxtHiHokeNo(RString txtHiHokeNo) {
        this.setOriginalData("txtHiHokeNo", txtHiHokeNo);
        this.txtHiHokeNo = txtHiHokeNo;
    }
    ...
    public void setTxtKyufuKanrihyo200604(RString txtKyufuKanrihyo200604) {
        this.setOriginalData("txtKyufuKanrihyo200604", txtKyufuKanrihyo200604);
        this.txtKyufuKanrihyo200604 = txtKyufuKanrihyo200604;
    }
