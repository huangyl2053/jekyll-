...
public class dgdYichiran_Row extends DataRow {
    ...
    public dgdYichiran_Row(RString defaultDataName1, RString defaultDataName6, TextBoxNum defaultDataName2, TextBoxNum defaultDataName3, TextBoxNum defaultDataName4, RString defaultDataName5, RString defaultDataName7) {
        super();
        this.setOriginalData("defaultDataName1", defaultDataName1);
        this.setOriginalData("defaultDataName6", defaultDataName6);
        this.setOriginalData("defaultDataName2", defaultDataName2);
