...
public class TsuchishoJoho642 {
     ...
     * @return ResponseData
     */
    public ResponseData<DBC120910_SogojigyohiKohiJukyushaInBatchParameter> onClick_btnExcute(TsuchishoJoho642Div div) {
        if (setBatchParameter(div) != null) {
            return ResponseData.of(setBatchParameter(div)).respond();
        }
        return ResponseData.of(new DBC120910_SogojigyohiKohiJukyushaInBatchParameter()).respond();
    }

    private DBC120910_SogojigyohiKohiJukyushaInBatchParameter setBatchParameter(TsuchishoJoho642Div div) {
        if (div.getCcdKokurenJohoTorikomi().get出力順ID() != null) {
            ...
            DBC120910_SogojigyohiKohiJukyushaInBatchParameter parameter = new DBC120910_SogojigyohiKohiJukyushaInBatchParameter();
