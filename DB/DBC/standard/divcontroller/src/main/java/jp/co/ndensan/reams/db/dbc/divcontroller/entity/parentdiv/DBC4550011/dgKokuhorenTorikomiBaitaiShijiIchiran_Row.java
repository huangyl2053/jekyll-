...
public class dgKokuhorenTorikomiBaitaiShijiIchiran_Row extends DataRow {
    ...
    public dgKokuhorenTorikomiBaitaiShijiIchiran_Row() {
        super();
    ...
    public dgKokuhorenTorikomiBaitaiShijiIchiran_Row(RString defaultDataName0, RString defaultDataName1, RString defaultDataName2) {
        super();
        this.setOriginalData("defaultDataName0", defaultDataName0);
        this.setOriginalData("defaultDataName1", defaultDataName1);
        this.setOriginalData("defaultDataName2", defaultDataName2);
