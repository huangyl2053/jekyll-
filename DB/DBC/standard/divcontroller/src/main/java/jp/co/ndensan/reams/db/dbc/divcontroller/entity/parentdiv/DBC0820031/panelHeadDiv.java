...
public class panelHeadDiv extends Panel {
    ...
    @JsonProperty("btnKinkyujiShotei")
    private Button btnKinkyujiShotei;
    ...
    /*
     * getbtnKinkyujiShotei
     * @return btnKinkyujiShotei
     */
    @JsonProperty("btnKinkyujiShotei")
    public Button getBtnKinkyujiShotei() {
        return btnKinkyujiShotei;
    }

    /*
     * setbtnKinkyujiShotei
     * @param btnKinkyujiShotei btnKinkyujiShotei
     */
    @JsonProperty("btnKinkyujiShotei")
    public void setBtnKinkyujiShotei(Button btnKinkyujiShotei) {
        this.btnKinkyujiShotei = btnKinkyujiShotei;
    }
