...
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.tabKyufuJissekiDiv;
...
public class KyufuJissekiDiv extends Panel {
    ...
    private TextBox txtKyufuJissekiJuminShubetsu;
    @JsonProperty("txtKyufuJissekiYokaigodo")
    private TextBox txtKyufuJissekiYokaigodo;
    @JsonProperty("txtKyufuJissekiNinteiYukoKikan")
    private TextBoxDateRange txtKyufuJissekiNinteiYukoKikan;
    @JsonProperty("txtKyufuJissekiName")
    private TextBox txtKyufuJissekiName;
    ...
    private TextBox txtKyufuJissekiSeiriNo;
    @JsonProperty("txtKyufuJissekiHokensha")
    private TextBox txtKyufuJissekiHokensha;
    @JsonProperty("txtKyufuJissekiShikibetsuCode")
    private TextBox txtKyufuJissekiShikibetsuCode;
    @JsonProperty("txtKyufuJissekiShikibetsuName")
    private TextBox txtKyufuJissekiShikibetsuName;
    @JsonProperty("ddlKyufuJissekiJigyosha")
    private DropDownList ddlKyufuJissekiJigyosha;
    @JsonProperty("btnKinkyujiShisetsuRyoyohi")
    private Button btnKinkyujiShisetsuRyoyohi;
    @JsonProperty("btnTokuteiShinryohi")
    private Button btnTokuteiShinryohi;
    @JsonProperty("btnShokujiHiyo")
    private Button btnShokujiHiyo;
    @JsonProperty("btnTokuteiNyushoshaKaigoServicehi")
    private Button btnTokuteiNyushoshaKaigoServicehi;
    @JsonProperty("btnShakaiFukushiHojinKeigengaku")
    private Button btnShakaiFukushiHojinKeigengaku;
    @JsonProperty("tabKyufuJisseki")
    private tabKyufuJissekiDiv tabKyufuJisseki;
    @JsonProperty("btnKyufuJissekiZengetsu")
    private Button btnKyufuJissekiZengetsu;
    @JsonProperty("btnKyufuJissekiJigetsu")
    private Button btnKyufuJissekiJigetsu;
    @JsonProperty("btnKyufuJissekiReturn")
    private Button btnKyufuJissekiReturn;
     ...
     */
    @JsonProperty("txtKyufuJissekiHihokenshaNo")
    public TextBox getTxtKyufuJissekiHihokenshaNo() {
        return txtKyufuJissekiHihokenshaNo;
    }
    ...
    @JsonProperty("txtKyufuJissekiJuminShubetsu")
    public TextBox getTxtKyufuJissekiJuminShubetsu() {
        return txtKyufuJissekiJuminShubetsu;
    }
    ...
    @JsonProperty("txtKyufuJissekiYokaigodo")
    public TextBox getTxtKyufuJissekiYokaigodo() {
        return txtKyufuJissekiYokaigodo;
    }
    ...
    @JsonProperty("txtKyufuJissekiNinteiYukoKikan")
    public TextBoxDateRange getTxtKyufuJissekiNinteiYukoKikan() {
        return txtKyufuJissekiNinteiYukoKikan;
    }
    ...
    @JsonProperty("txtKyufuJissekiName")
    public TextBox getTxtKyufuJissekiName() {
        return txtKyufuJissekiName;
    }
    ...
    @JsonProperty("txtKyufuJissekiSeibetsu")
    public TextBox getTxtKyufuJissekiSeibetsu() {
        return txtKyufuJissekiSeibetsu;
    }
    ...
    @JsonProperty("txtKyufuJissekiJissekiKubun")
    public TextBox getTxtKyufuJissekiJissekiKubun() {
        return txtKyufuJissekiJissekiKubun;
    }
    ...
    @JsonProperty("txtKyufuJissekiSeiriNo")
    public TextBox getTxtKyufuJissekiSeiriNo() {
        return txtKyufuJissekiSeiriNo;
    }
    ...
    @JsonProperty("txtKyufuJissekiHokensha")
    public TextBox getTxtKyufuJissekiHokensha() {
        return txtKyufuJissekiHokensha;
    }
    ...
    @JsonProperty("txtKyufuJissekiShikibetsuCode")
    public TextBox getTxtKyufuJissekiShikibetsuCode() {
        return txtKyufuJissekiShikibetsuCode;
    }
    ...
    @JsonProperty("txtKyufuJissekiShikibetsuName")
    public TextBox getTxtKyufuJissekiShikibetsuName() {
        return txtKyufuJissekiShikibetsuName;
    }

    @JsonProperty("txtKyufuJissekiShikibetsuName")
    public void setTxtKyufuJissekiShikibetsuName(TextBox txtKyufuJissekiShikibetsuName) {
        this.txtKyufuJissekiShikibetsuName=txtKyufuJissekiShikibetsuName;
    }

    @JsonProperty("ddlKyufuJissekiJigyosha")
    public DropDownList getDdlKyufuJissekiJigyosha() {
        return ddlKyufuJissekiJigyosha;
    }

    @JsonProperty("ddlKyufuJissekiJigyosha")
    public void setDdlKyufuJissekiJigyosha(DropDownList ddlKyufuJissekiJigyosha) {
        this.ddlKyufuJissekiJigyosha=ddlKyufuJissekiJigyosha;
    }

    @JsonProperty("btnKinkyujiShisetsuRyoyohi")
    public Button getBtnKinkyujiShisetsuRyoyohi() {
        return btnKinkyujiShisetsuRyoyohi;
    }
    ...
    @JsonProperty("btnTokuteiShinryohi")
    public Button getBtnTokuteiShinryohi() {
        return btnTokuteiShinryohi;
    }
    ...
    @JsonProperty("btnTokuteiNyushoshaKaigoServicehi")
    public Button getBtnTokuteiNyushoshaKaigoServicehi() {
        return btnTokuteiNyushoshaKaigoServicehi;
    }
    ...
    @JsonProperty("btnShakaiFukushiHojinKeigengaku")
    public Button getBtnShakaiFukushiHojinKeigengaku() {
        return btnShakaiFukushiHojinKeigengaku;
    }
    ...
    @JsonProperty("tabKyufuJisseki")
    public tabKyufuJissekiDiv getTabKyufuJisseki() {
        return tabKyufuJisseki;
    }
    ...
    @JsonProperty("btnKyufuJissekiZengetsu")
    public Button getBtnKyufuJissekiZengetsu() {
        return btnKyufuJissekiZengetsu;
    }
    ...
    @JsonProperty("btnKyufuJissekiJigetsu")
    public Button getBtnKyufuJissekiJigetsu() {
        return btnKyufuJissekiJigetsu;
    }
    ...
    @JsonProperty("btnKyufuJissekiReturn")
    public Button getBtnKyufuJissekiReturn() {
        return btnKyufuJissekiReturn;
    }
