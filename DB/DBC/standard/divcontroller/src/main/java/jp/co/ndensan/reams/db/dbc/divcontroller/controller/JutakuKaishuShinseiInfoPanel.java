...
public class JutakuKaishuShinseiInfoPanel {
    ...
    private void setShinseishaInfo(JutakuKaishuShinseiInfoPanelDiv panel, String ymlDataName) {
        ...
        //TO DO  JutakuData.xml Write　③
        //初期値を設定したいものに値を入れる。値をセットしなければ空欄
        panel.getJutakuKaishuShinseiContents().getJutakuKaishuShinseisha().getTxtShinseiDate().setValue(new RDate(shinseiYMD));
        panel.getJutakuKaishuShinseiContents().getJutakuKaishuShinseisha().getTxtUketsukeDate().setValue(new RDate(uketsukeYMD));
