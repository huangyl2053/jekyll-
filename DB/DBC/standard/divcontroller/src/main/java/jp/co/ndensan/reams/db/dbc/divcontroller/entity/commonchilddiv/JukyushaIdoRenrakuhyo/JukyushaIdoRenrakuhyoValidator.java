...
public class JukyushaIdoRenrakuhyoValidator {
    ...
    public IValidationMessages validate入力チェック() {
        ...
        messages.add(ValidateChain.validateStart(div)
                ...
                .ifNot(JukyushaIdoRenrakuhyoSpec.住特適用期間と異動日の関連チェック)
                .thenAdd(JukyushaIdoRenrakuhyoValidationMessage.住特適用情報が不正)
                ...
                .ifNot(JukyushaIdoRenrakuhyoSpec.社会福祉法人軽減情報適用期間と異動日の関連チェック)
                .thenAdd(JukyushaIdoRenrakuhyoValidationMessage.社会福祉法人軽減情報が不正)
                .ifNot(JukyushaIdoRenrakuhyoSpec.標準負担と異動日の関連チェック)
                .thenAdd(JukyushaIdoRenrakuhyoValidationMessage.標準負担と異動日が不正)
                ...
                .ifNot(JukyushaIdoRenrakuhyoSpec.食費限度額適用期間と異動日の関連チェック)
                .thenAdd(JukyushaIdoRenrakuhyoValidationMessage.食費限度額適用情報が不正)
