...
public class KogakuKaigoSabisuhiKyufuHanteiKekkaJohoHandler {
    ...
    private static final ReportId 帳票ID = new ReportId("DBC200019_KogakuServicehiKyufuHanteiKekkaSofuIchiran");
     ...
     * @return ResponseData
     */
    public ResponseData<DBC110040_KogakuServicehiHanteikekkaOutParameter> setBatchParameter(RString 再処理区分,
