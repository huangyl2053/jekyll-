...
public class KogakuGassanShikyuShinseiTorokuPanelValidationHandler {
    ...
    public ValidationMessageControlPairs validate() {
        ...
        messages.add(ValidateChain.validateStart(div).
                ...
                ifNot(KogakuGassanShikyuShinseiTorokuPanelSpec.介護支給申請書整理番号1必須).
                thenAdd(KjcheckMessages.介護支給申請書整理番号1必須).
                ifNot(KogakuGassanShikyuShinseiTorokuPanelSpec.介護支給申請書整理番号2必須).
                thenAdd(KjcheckMessages.介護支給申請書整理番号2必須).
                ifNot(KogakuGassanShikyuShinseiTorokuPanelSpec.介護支給申請書整理番号3必須).
                thenAdd(KjcheckMessages.介護支給申請書整理番号3必須).
                ifNot(KogakuGassanShikyuShinseiTorokuPanelSpec.介護支給申請書整理番号4必須).
                thenAdd(KjcheckMessages.介護支給申請書整理番号4必須).
                ifNot(KogakuGassanShikyuShinseiTorokuPanelSpec.介護支給申請書整理番号各項目の桁数チェック1).
                thenAdd(KjcheckMessages.介護支給申請書整理番号各項目の桁数チェック1).
                ifNot(KogakuGassanShikyuShinseiTorokuPanelSpec.医療支給申請書整理番号1必須).
                thenAdd(KjcheckMessages.医療支給申請書整理番号1必須).
                ifNot(KogakuGassanShikyuShinseiTorokuPanelSpec.医療支給申請書整理番号2必須).
                thenAdd(KjcheckMessages.医療支給申請書整理番号2必須).
                ifNot(KogakuGassanShikyuShinseiTorokuPanelSpec.医療支給申請書整理番号3必須).
                thenAdd(KjcheckMessages.医療支給申請書整理番号3必須).
                ifNot(KogakuGassanShikyuShinseiTorokuPanelSpec.医療支給申請書整理番号4必須).
                thenAdd(KjcheckMessages.医療支給申請書整理番号4必須).
    ...
    private ValidationDictionary createDictionary() {
        ...
        return new ValidationDictionaryBuilder()
                ...
                .add(KjcheckMessages.介護支給申請書整理番号1必須,
                        div.getKogakuGassanShikyuShinseiTorokuSearch().getTxtKaigoShikyuShinseishoSeiriBango1())
                .add(KjcheckMessages.介護支給申請書整理番号2必須,
                        div.getKogakuGassanShikyuShinseiTorokuSearch().getTxtKaigoShikyuShinseishoSeiriBango2())
                .add(KjcheckMessages.介護支給申請書整理番号3必須,
                        div.getKogakuGassanShikyuShinseiTorokuSearch().getDdlKaigoShikyuShinseishoSeiriBango3())
                .add(KjcheckMessages.介護支給申請書整理番号4必須,
                ...
                .add(KjcheckMessages.介護支給申請書整理番号各項目の桁数チェック1,
                        div.getKogakuGassanShikyuShinseiTorokuSearch().getTxtKaigoShikyuShinseishoSeiriBango4())
                .add(KjcheckMessages.医療支給申請書整理番号1必須,
                        div.getKogakuGassanShikyuShinseiTorokuSearch().getTxtIryoShikyuShinseishoSeiriBango1())
                .add(KjcheckMessages.医療支給申請書整理番号2必須,
                        div.getKogakuGassanShikyuShinseiTorokuSearch().getTxtIryoShikyuShinseishoSeiriBango2())
                .add(KjcheckMessages.医療支給申請書整理番号3必須,
                        div.getKogakuGassanShikyuShinseiTorokuSearch().getTxtIryoShikyuShinseishoSeiriBango3())
                .add(KjcheckMessages.医療支給申請書整理番号4必須,
    ...
    private static enum KjcheckMessages implements IValidationMessage {
        ...
        介護支給申請書整理番号1必須(UrErrorMessages.必須, 介護支給申請書整理番号チェックオン時介護支給申請書整理番号.toString()),
        介護支給申請書整理番号2必須(UrErrorMessages.必須, 介護支給申請書整理番号チェックオン時介護支給申請書整理番号.toString()),
        介護支給申請書整理番号3必須(UrErrorMessages.必須, 介護支給申請書整理番号チェックオン時介護支給申請書整理番号.toString()),
        介護支給申請書整理番号4必須(UrErrorMessages.必須, 介護支給申請書整理番号チェックオン時介護支給申請書整理番号.toString()),
        介護支給申請書整理番号各項目の桁数チェック1(UrErrorMessages.桁数が不正, 介護支給申請書整理番号4整理番号.toString(), 六.toString()),
        医療支給申請書整理番号1必須(UrErrorMessages.必須, 医療支給申請書整理番号チェックオン時医療支給申請書整理番号.toString()),
        医療支給申請書整理番号2必須(UrErrorMessages.必須, 医療支給申請書整理番号チェックオン時医療支給申請書整理番号.toString()),
        医療支給申請書整理番号3必須(UrErrorMessages.必須, 医療支給申請書整理番号チェックオン時医療支給申請書整理番号.toString()),
        医療支給申請書整理番号4必須(UrErrorMessages.必須, 医療支給申請書整理番号チェックオン時医療支給申請書整理番号.toString()),
