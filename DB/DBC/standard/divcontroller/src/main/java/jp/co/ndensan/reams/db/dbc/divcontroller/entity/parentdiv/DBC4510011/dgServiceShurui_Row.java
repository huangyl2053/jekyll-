...
/**
 * dgServiceShurui_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgServiceShurui_Row extends DataRow {
    ...
    public dgServiceShurui_Row(RString defaultDataName1, RString defaultDataName2, RString defaultDataName3, RString defaultDataName4, RString defaultDataName5, RString defaultDataName6) {
        super();
        this.setOriginalData("defaultDataName1", defaultDataName1);
        this.setOriginalData("defaultDataName2", defaultDataName2);
        this.setOriginalData("defaultDataName3", defaultDataName3);
