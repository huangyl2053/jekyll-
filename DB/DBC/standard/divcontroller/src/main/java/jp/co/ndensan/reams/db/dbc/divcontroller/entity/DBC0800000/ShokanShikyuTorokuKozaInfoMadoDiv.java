...
/**
 * ShokanShikyuTorokuKozaInfoMado のクラスファイル 
 * 
 * @author 自動生成
 */
public class ShokanShikyuTorokuKozaInfoMadoDiv extends Panel {
    /*
     * [ private の作成 ]
     ...
     */
    @JsonProperty("radShinseiMadoBarai")
    private RadioButton radShinseiMadoBarai;
     ...
     */
    @JsonProperty("radShinseiMadoBarai")
    public RadioButton getRadShinseiMadoBarai() {
        return radShinseiMadoBarai;
    }

    @JsonProperty("radShinseiMadoBarai")
    public void setRadShinseiMadoBarai(RadioButton radShinseiMadoBarai) {
        this.radShinseiMadoBarai=radShinseiMadoBarai;
    }
