...
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.DBZJuryoininDiv;
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.URKozaDiv;
import jp.co.ndensan.reams.uz.uza.ui.binding.*;
import jp.co.ndensan.reams.uz.uza.ui.binding.Panel;
import jp.co.ndensan.reams.uz.uza.ui.binding.domain.*;

/**
 * YoguKonyuhiShikyuShinseiPaymentMethod のクラスファイル 
 * 
 * @author 自動生成
 */
public class YoguKonyuhiShikyuShinseiPaymentMethodDiv extends Panel {
    /*
     * [ private の作成 ]
