...
public class ShikyugakuKeisanKekkaTorokuValidator {
    ...
    public IValidationMessages validate内訳を確定する() {
        ...
        messages.add(ValidateChain.validateStart(div)
                ...
                .ifNot(ShikyugakuKeisanKekkaTorokuSpec.保険者番号桁数不正のチェック)
                .thenAdd(ShikyugakuKeisanKekkaTorokuMessage.保険者番号桁数が不正)
                .ifNot(ShikyugakuKeisanKekkaTorokuSpec.被保険者記号桁数不正のチェック)
                .thenAdd(ShikyugakuKeisanKekkaTorokuMessage.被保険者記号桁数が不正)
                .ifNot(ShikyugakuKeisanKekkaTorokuSpec.被保険者証番号桁数不正のチェック)
                .thenAdd(ShikyugakuKeisanKekkaTorokuMessage.被保険者証番号桁数が不正)
