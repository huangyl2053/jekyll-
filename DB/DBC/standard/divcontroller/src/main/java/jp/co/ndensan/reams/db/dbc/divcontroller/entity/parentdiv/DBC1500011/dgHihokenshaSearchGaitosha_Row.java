...
public class dgHihokenshaSearchGaitosha_Row extends DataRow {
    ...
    public dgHihokenshaSearchGaitosha_Row() {
        ...
        this.setOriginalData("txtYosiki", txtYosiki);
    ...
    public dgHihokenshaSearchGaitosha_Row(Boolean chkCreateMoshitatesho, RString txtJigyoshaNo, RString txtJigyoshaName, RString txtHihoNo, RString txtName, RString txtYosiki, RString txtTeikyoYM, RString txtKyufuJissekiSakuseiKubun, RString txtKyufuKubun, RString txtShinsaYM) {
        super();
        this.setOriginalData("chkCreateMoshitatesho", chkCreateMoshitatesho);
        this.setOriginalData("txtJigyoshaNo", txtJigyoshaNo);
        this.setOriginalData("txtJigyoshaName", txtJigyoshaName);
    ...
    public void setTxtYosiki(RString txtYosiki) {
        this.setOriginalData("txtYosiki", txtYosiki);
        this.txtYosiki = txtYosiki;
    }
