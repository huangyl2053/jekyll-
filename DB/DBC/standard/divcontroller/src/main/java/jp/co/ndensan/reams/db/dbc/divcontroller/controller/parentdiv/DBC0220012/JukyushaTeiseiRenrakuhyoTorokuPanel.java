...
public class JukyushaTeiseiRenrakuhyoTorokuPanel {
    ...
    public ResponseData<SourceDataCollection> onClick_btnReportPublish(JukyushaTeiseiRenrakuhyoTorokuPanelDiv div) {
        ...
        get更新と状態遷移(div, 受給者訂正連絡票登録画面Div, 引き継ぎ情報);
     ...
     * @return ResponseData
     */
    public ResponseData<JukyushaTeiseiRenrakuhyoTorokuPanelDiv> onClick_btnSave(JukyushaTeiseiRenrakuhyoTorokuPanelDiv div) {
