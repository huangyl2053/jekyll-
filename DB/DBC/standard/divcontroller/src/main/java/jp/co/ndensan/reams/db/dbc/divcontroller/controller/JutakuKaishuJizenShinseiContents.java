 ...
 * @author n8223
 */
public class JutakuKaishuJizenShinseiContents {
     ...
     */
    public ResponseData<JutakuKaishuJizenShinseiContentsDiv> onLoad(JutakuKaishuJizenShinseiContentsDiv panel) {
    ...
    private void setJutakuOwnerData(JutakuKaishuJizenShinseiContentsDiv panel) {
        ...
        //JutakuData.xml Read　②
        String jutakuOwner = ymlData.get(2).get("jutakuOwner").toString();
        String relationWithHihokensha = ymlData.get(2).get("relationWithHihokensha").toString();
       ///////////////////////////////////////////////////////////////////////////////////////// 
    ...
    private void setZizenShinseiDetailInput(JutakuKaishuJizenShinseiContentsDiv panel) {
        ...
        //JutakuData.xml Read　②
        String kaishuContents = ymlData.get(3).get("kaishuContents").toString();
        String kaishuJigyoshaName = ymlData.get(3).get("kaishuJigyoshaName").toString();
        String kaishuTaishoAddress1 = ymlData.get(3).get("kaishuTaishoAddress1").toString();
        String chakkoDueDate = ymlData.get(3).get("chakkoDueDate").toString();
        String kanseiDueDate = ymlData.get(3).get("kanseiDueDate").toString();
        String estimatedAmount = ymlData.get(3).get("estimatedAmount").toString();
        ///////////////////////////////////////////////////////////////////////////////////////// 
    ...
    private void setShinseishaInfo(JutakuKaishuJizenShinseiContentsDiv panel) {
        ...
        //JutakuData.xml Read　② 
        String shinseiYMD = ymlData.get(5).get("shinseiYMD").toString();
        String uketsukeYMD = ymlData.get(5).get("uketsukeYMD").toString();
        String shinseishaName = ymlData.get(5).get("shinseishaName").toString();
        String yubinNo = ymlData.get(5).get("yubinNo").toString();
        String address = ymlData.get(5).get("address").toString();
        String telNo = ymlData.get(5).get("telNo").toString();
        String jigyoshaNo = ymlData.get(5).get("jigyoshaNo").toString();
       ///////////////////////////////////////////////////////////////////////////////////////// 
    ...
    private void setShinseiReason(JutakuKaishuJizenShinseiContentsDiv panel) {
        ...
        //JutakuData.xml Read　② 
        String createDate = ymlData.get(6).get("createDate").toString();
        String creationJigyoshaNo = ymlData.get(6).get("creationJigyoshaNo").toString();
        String creationJigyoshaName = ymlData.get(6).get("creationJigyoshaName").toString();
        String creatorKanaName = ymlData.get(6).get("creatorKanaName").toString();
        String creatorName = ymlData.get(6).get("creatorName").toString();
       /////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void setShinseiKozaInfo(JutakuKaishuJizenShinseiContentsDiv panel) {
        ...
        //JutakuData.xml Read　② 
        String kinyuKikanCode = ymlData.get(7).get("kinyuKikanCode").toString();
        String kinyuKikanName = ymlData.get(7).get("kinyuKikanName").toString();
        String kinyuBranchCode = ymlData.get(7).get("kinyuBranchCode").toString();
        String kinyuBranchName = ymlData.get(7).get("kinyuBranchName").toString();
        String kozaMeigininKanaName = ymlData.get(7).get("kozaMeigininKanaName").toString();
        String kozaMeigininName = ymlData.get(7).get("kozaMeigininName").toString();
        ///////////////////////////////////////////////////////////////////////////////////////// 
    ...
    private List<dgJutakuKaishuDetail_Row> createRowShikyuShinseiTestData() {
        ...
        //JutakuData.xml Read　② 
        String chakkoDueDate = ymlData.get(8).get("chakkoDueDate").toString();
        String kanseiDueDate = ymlData.get(8).get("kanseiDueDate").toString();
        String mitsumoriAmount = ymlData.get(8).get("mitsumoriAmount").toString();
        String kaishuJigyosha = ymlData.get(8).get("kaishuJigyosha").toString();
