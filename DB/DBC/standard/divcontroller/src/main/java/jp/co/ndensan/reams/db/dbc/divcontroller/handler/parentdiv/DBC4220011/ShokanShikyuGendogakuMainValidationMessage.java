 ...
 */
public enum ShokanShikyuGendogakuMainValidationMessage implements IValidationMessage {
    ...
    private ShokanShikyuGendogakuMainValidationMessage(IMessageGettable message, String... replacements) {
