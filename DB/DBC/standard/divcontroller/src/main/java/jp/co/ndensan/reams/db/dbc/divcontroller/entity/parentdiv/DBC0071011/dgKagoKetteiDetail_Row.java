...
/**
 * dgKagoKetteiDetail_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgKagoKetteiDetail_Row extends DataRow {
    ...
    public dgKagoKetteiDetail_Row() {
        ...
        this.setOriginalData("txtKohiMoshitateRiyuCode", txtKohiMoshitateRiyuCode);
        ...
        this.setOriginalData("txtKohiServiceTypeCode", txtKohiServiceTypeCode);
        this.setOriginalData("txtKohiServiceType", txtKohiServiceType);
        this.setOriginalData("txtKohiTanisu", txtKohiTanisu);
        this.setOriginalData("txtKohiFutangaku", txtKohiFutangaku);
    ...
    public dgKagoKetteiDetail_Row(RString txtKohiJigyoshaNo, RString txtKohiJigyoshaName, RString txtKohiHihoNo, RString txtKohiHihoName, RString txtKohiMoshitateRiyuCode, RString txtKohiStyle, RString txtKohiMoshitateRiyu, RString txtKohiServiceTeikyoYM, RString txtKohiServiceTypeCode, RString txtKohiServiceType, TextBoxNum txtKohiTanisu, TextBoxNum txtKohiFutangaku, RString txtKohiJukyushaNo, RString txtKohiFutanshaNo, RString txtHokenshaShokisaiHokenshaNo) {
        super();
        this.setOriginalData("txtKohiJigyoshaNo", txtKohiJigyoshaNo);
        this.setOriginalData("txtKohiJigyoshaName", txtKohiJigyoshaName);
        this.setOriginalData("txtKohiHihoNo", txtKohiHihoNo);
        ...
        this.txtKohiMoshitateRiyuCode = txtKohiMoshitateRiyuCode;
        ...
        this.txtKohiServiceTypeCode = txtKohiServiceTypeCode;
        this.txtKohiServiceType = txtKohiServiceType;
        this.txtKohiTanisu = txtKohiTanisu;
    ...
    public RString getTxtKohiMoshitateRiyuCode() {
        return txtKohiMoshitateRiyuCode;
    }
    ...
    public RString getTxtKohiServiceTypeCode() {
        return txtKohiServiceTypeCode;
    }
    ...
    public TextBoxNum getTxtKohiTanisu() {
        return txtKohiTanisu;
    }

    public TextBoxNum getTxtKohiFutangaku() {
    ...
    public void setTxtKohiMoshitateRiyuCode(RString txtKohiMoshitateRiyuCode) {
        this.setOriginalData("txtKohiMoshitateRiyuCode", txtKohiMoshitateRiyuCode);
        this.txtKohiMoshitateRiyuCode = txtKohiMoshitateRiyuCode;
    }
    ...
    public void setTxtKohiServiceTypeCode(RString txtKohiServiceTypeCode) {
        this.setOriginalData("txtKohiServiceTypeCode", txtKohiServiceTypeCode);
        this.txtKohiServiceTypeCode = txtKohiServiceTypeCode;
    }
    ...
    public void setTxtKohiTanisu(TextBoxNum txtKohiTanisu) {
        this.setOriginalData("txtKohiTanisu", txtKohiTanisu);
        this.txtKohiTanisu = txtKohiTanisu;
    }

    public void setTxtKohiFutangaku(TextBoxNum txtKohiFutangaku) {
        this.setOriginalData("txtKohiFutangaku", txtKohiFutangaku);
        this.txtKohiFutangaku = txtKohiFutangaku;
    }
