...
/**
 * JutakuKaishuShinsaShinseiContents のクラスファイル
 *
 * @author 自動生成
 */
public class JutakuKaishuShinsaShinseiContentsDiv extends Panel {
    /*
     * [ private の作成 ]
    ...
    @JsonProperty("JutakuKaishuShinsaKoza")
    private PaymentMethodDiv JutakuKaishuShinsaKoza;
    ...
    @JsonProperty("JutakuKaishuShinsaKoza")
    public PaymentMethodDiv getJutakuKaishuShinsaKoza() {
        return JutakuKaishuShinsaKoza;
    }

    @JsonProperty("JutakuKaishuShinsaKoza")
    public void setJutakuKaishuShinsaKoza(PaymentMethodDiv JutakuKaishuShinsaKoza) {
        this.JutakuKaishuShinsaKoza = JutakuKaishuShinsaKoza;
    }
