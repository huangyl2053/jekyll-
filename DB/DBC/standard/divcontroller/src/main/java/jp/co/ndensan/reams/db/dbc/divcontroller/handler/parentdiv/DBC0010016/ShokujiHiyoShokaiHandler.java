...
public class ShokujiHiyoShokaiHandler {
    ...
    public void setButton(ShikibetsuNoKanri 識別番号管理) {
        ...
        div.getBtnMeisaiShukei().setDisabled(ZERO.equals(識別番号管理.get明細設定区分()) && ZERO.equals(識別番号管理.get集計設定区分()));
        ...
        div.getBtnFukushiYoguKonyu().setDisabled(ZERO.equals(識別番号管理.get福祉用具購入費設定区分()));
