...
//dgKogakuServicehiRireki 高額介護サービス費一覧
    ...
    private dgKogakuServicehiRireki_Row createRowKogakuServicehiListData(
        ...
        //被保番号 
        rowKogakuServicehiData.setTxtHihoNo(new RString(hihoNo));
        //氏名
        rowKogakuServicehiData.setTxtHihoName(new RString(hihoName));
        //提供年月
        rowKogakuServicehiData.setTxtTeikyoYM(new RString(teikyoYM));
        //高額支給額
        rowKogakuServicehiData.getTxtKogakuShikyuAmount().setValue(new Decimal(kogakuShikyuAmount));
        //申請日
        rowKogakuServicehiData.setTxtShinseiDate(new RString(shinseiDate));
        //決定日
        rowKogakuServicehiData.setTxtKetteiDate(new RString(ketteiDate));
        //支給区分
