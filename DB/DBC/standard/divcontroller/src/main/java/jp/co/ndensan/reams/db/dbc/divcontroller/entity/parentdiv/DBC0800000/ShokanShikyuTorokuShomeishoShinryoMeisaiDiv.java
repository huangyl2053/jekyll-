...
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.DBC0800000.ShokanShikyuTorokuShomeishoShinryoMeisaiH1503Div;
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.DBC0800000.ShokanShikyuTorokuShomeishoShinryoMeisaiH1504Div;
...
public class ShokanShikyuTorokuShomeishoShinryoMeisaiDiv extends Panel {
    ...
    @JsonProperty("txtShinryoSelectedIndex")
    private TextBox txtShinryoSelectedIndex;
    ...
    @JsonProperty("txtShinryoSelectedIndex")
    public TextBox getTxtShinryoSelectedIndex() {
        return txtShinryoSelectedIndex;
    }

    @JsonProperty("txtShinryoSelectedIndex")
    public void setTxtShinryoSelectedIndex(TextBox txtShinryoSelectedIndex) {
        this.txtShinryoSelectedIndex=txtShinryoSelectedIndex;
    }
