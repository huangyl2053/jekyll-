...
/**
 * HanyoListParamete のクラスファイル
 *
 * @reamsid_L DBC-3101-010 qinzhen
 */
public class HanyoListParameteDiv extends PanelBatchParameter {
    ...
    public RadioButton getRadSikyuKubun() {
        return this.getChushutsuJokenPanel().getRadSikyuKubun();
    }

    @JsonIgnore
    public void setRadSikyuKubun(RadioButton radSikyuKubun) {
        this.getChushutsuJokenPanel().setRadSikyuKubun(radSikyuKubun);
    }
    ...
    public TextBoxDateRange getTxtKetteiJohoUketoriNengetsu() {
        return this.getChushutsuJokenPanel().getTxtKetteiJohoUketoriNengetsu();
    }

    @JsonIgnore
    public void setTxtKetteiJohoUketoriNengetsu(TextBoxDateRange txtKetteiJohoUketoriNengetsu) {
        this.getChushutsuJokenPanel().setTxtKetteiJohoUketoriNengetsu(txtKetteiJohoUketoriNengetsu);
    }
