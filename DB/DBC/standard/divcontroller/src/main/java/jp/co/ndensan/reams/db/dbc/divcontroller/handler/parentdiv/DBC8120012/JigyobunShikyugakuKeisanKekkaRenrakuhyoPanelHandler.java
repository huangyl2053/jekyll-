...
import jp.co.ndensan.reams.db.dbc.business.core.jigyobunshikyugakukeisanKekkarenrakuhyopanel.JigyobunShikyugakuKeisanKekkaRenrakuhyoPanelResult;
...
public class JigyobunShikyugakuKeisanKekkaRenrakuhyoPanelHandler {
    ...
    public JigyobunShikyugakuKeisanKekkaRenrakuhyoPanelBatchParameter onClick発行する(HihokenshaNo 被保険者番号) {
        ...
        parameter.setSyoridate(set前回作成日_和暦表示(new FlexibleDate(RDate.getNowDate().toDateString())));
    ...
    private static RString set前回作成日_和暦表示(FlexibleDate flexibleDate) {
        return flexibleDate.wareki().eraType(EraType.KANJI).firstYear(FirstYear.GAN_NEN)
