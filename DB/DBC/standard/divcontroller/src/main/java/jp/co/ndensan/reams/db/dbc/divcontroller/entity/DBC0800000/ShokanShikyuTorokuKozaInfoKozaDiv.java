...
/**
 * ShokanShikyuTorokuKozaInfoKoza のクラスファイル 
 * 
 * @author 自動生成
 */
public class ShokanShikyuTorokuKozaInfoKozaDiv extends Panel {
    /*
     * [ private の作成 ]
     ...
     */
    @JsonProperty("radShinseiKozaBarai")
    private RadioButton radShinseiKozaBarai;
    @JsonProperty("ddlShinseiRirekiNo")
    private DropDownList ddlShinseiRirekiNo;
    @JsonProperty("btnKozoRegist")
    private Button btnKozoRegist;
     ...
     */
    @JsonProperty("radShinseiKozaBarai")
    public RadioButton getRadShinseiKozaBarai() {
        return radShinseiKozaBarai;
    }

    @JsonProperty("radShinseiKozaBarai")
    public void setRadShinseiKozaBarai(RadioButton radShinseiKozaBarai) {
        this.radShinseiKozaBarai=radShinseiKozaBarai;
    }

    @JsonProperty("ddlShinseiRirekiNo")
    public DropDownList getDdlShinseiRirekiNo() {
        return ddlShinseiRirekiNo;
    }

    @JsonProperty("ddlShinseiRirekiNo")
    public void setDdlShinseiRirekiNo(DropDownList ddlShinseiRirekiNo) {
        this.ddlShinseiRirekiNo=ddlShinseiRirekiNo;
    }

    @JsonProperty("btnKozoRegist")
    public Button getBtnKozoRegist() {
        return btnKozoRegist;
    }

    @JsonProperty("btnKozoRegist")
    public void setBtnKozoRegist(Button btnKozoRegist) {
        this.btnKozoRegist=btnKozoRegist;
    }
