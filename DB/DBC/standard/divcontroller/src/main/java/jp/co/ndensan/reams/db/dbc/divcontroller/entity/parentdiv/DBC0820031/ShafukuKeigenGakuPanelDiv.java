...
public class ShafukuKeigenGakuPanelDiv extends Panel {
    ...
    public Button getBtnAdd() {
        return this.getPanelShafukukenngengaku().getBtnAdd();
    }

    @JsonIgnore
    public void  setBtnAdd(Button btnAdd) {
        this.getPanelShafukukenngengaku().setBtnAdd(btnAdd);
    }
    ...
    public TextBoxNum getRowId() {
        return this.getPanelShafukukenngengaku().getRowId();
    }

    @JsonIgnore
    public void  setRowId(TextBoxNum rowId) {
        this.getPanelShafukukenngengaku().setRowId(rowId);
    }
