package jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.DBC0010018;
/*
 * このコードはツールによって生成されました。
 * このファイルへの変更は、以下の状況下で不正な動作の原因になったり、
 * コードが再生成されるときに損失したりします。
 * Thu Aug 25 10:04:52 CST 2016 
 */
...
/**
 * dgFukushiYoguKonyuhi_Row のクラスファイル 
 * 
 * @author 自動生成
 */
...
public class dgFukushiYoguKonyuhi_Row extends DataRow {
    ...
    private RString txtSeizoJigyoshaName;
    ...
    public dgFukushiYoguKonyuhi_Row() {
        ...
        this.setOriginalData("txtSeizoJigyoshaName", txtSeizoJigyoshaName);
    ...
    public dgFukushiYoguKonyuhi_Row(RString txtService, RString txtKonyuYMD, RString txtShohinName, RString txtShumoku, RString txtSeizoJigyoshaName, RString txtHanbaiJigyoshaName, RString txtKonyuKingaku, RString txtShinsaYM, RString btnTekiyo) {
        ...
        this.txtSeizoJigyoshaName = txtSeizoJigyoshaName;
    ...
    public RString getTxtSeizoJigyoshaName() {
        return txtSeizoJigyoshaName;
    }

    public RString getTxtHanbaiJigyoshaName() {
        return txtHanbaiJigyoshaName;
    }

    public RString getTxtKonyuKingaku() {
    ...
    public void setTxtSeizoJigyoshaName(RString txtSeizoJigyoshaName) {
        this.setOriginalData("txtSeizoJigyoshaName", txtSeizoJigyoshaName);
        this.txtSeizoJigyoshaName = txtSeizoJigyoshaName;
    }

    public void setTxtHanbaiJigyoshaName(RString txtHanbaiJigyoshaName) {
        this.setOriginalData("txtHanbaiJigyoshaName", txtHanbaiJigyoshaName);
        this.txtHanbaiJigyoshaName = txtHanbaiJigyoshaName;
    }
