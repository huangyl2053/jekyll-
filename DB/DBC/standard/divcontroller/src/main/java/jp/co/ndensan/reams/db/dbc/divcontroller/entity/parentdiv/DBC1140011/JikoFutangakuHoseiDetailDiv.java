...
public class JikoFutangakuHoseiDetailDiv extends Panel {
    ...
    @JsonProperty("chkSaisouKBN")
    private CheckBoxList chkSaisouKBN;
    @JsonProperty("chkSoufuTaishougai")
    private CheckBoxList chkSoufuTaishougai;
    @JsonProperty("txtHoseibiKatsu")
    private TextBoxDate txtHoseibiKatsu;
    ...
    /*
     * setchkSaisouKBN
     * @param chkSaisouKBN chkSaisouKBN
     */
    @JsonProperty("chkSaisouKBN")
    public void setChkSaisouKBN(CheckBoxList chkSaisouKBN) {
        this.chkSaisouKBN = chkSaisouKBN;
    }

    /*
     * getchkSoufuTaishougai
     * @return chkSoufuTaishougai
     */
    @JsonProperty("chkSoufuTaishougai")
    ...
    /*
     * setchkSoufuTaishougai
     * @param chkSoufuTaishougai chkSoufuTaishougai
     */
    @JsonProperty("chkSoufuTaishougai")
    public void setChkSoufuTaishougai(CheckBoxList chkSoufuTaishougai) {
        this.chkSoufuTaishougai = chkSoufuTaishougai;
    }

    /*
     * gettxtHoseibiKatsu
     * @return txtHoseibiKatsu
     */
    @JsonProperty("txtHoseibiKatsu")
    ...
    /*
     * settxtHoseibiKatsu
     * @param txtHoseibiKatsu txtHoseibiKatsu
     */
    @JsonProperty("txtHoseibiKatsu")
    public void setTxtHoseibiKatsu(TextBoxDate txtHoseibiKatsu) {
        this.txtHoseibiKatsu = txtHoseibiKatsu;
    }
