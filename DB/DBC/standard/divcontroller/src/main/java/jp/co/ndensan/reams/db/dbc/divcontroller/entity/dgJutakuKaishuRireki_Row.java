...
public class dgJutakuKaishuRireki_Row extends DataRow {
    ...
    private TextBoxDate txtKaishuDueDate;
    ...
    public dgJutakuKaishuRireki_Row(TextBoxDate txtKaishuDueDate, TextBoxDate txtKanseiDueDate, TextBoxNum txtMitsumoriAmount, RString txtKaishuJigyosha, RString txtKaishuTaishoAddress, RString txtKaishuContents) {
        super();
        this.setOriginalData("txtKaishuDueDate", txtKaishuDueDate);
        ...
        this.txtKaishuDueDate = txtKaishuDueDate;
    ...
    public TextBoxDate getTxtKaishuDueDate() {
        return txtKaishuDueDate;
    }
    ...
    public void setTxtKaishuDueDate(TextBoxDate txtKaishuDueDate) {
        this.setOriginalData("txtKaishuDueDate", txtKaishuDueDate);
        this.txtKaishuDueDate = txtKaishuDueDate;
    }
