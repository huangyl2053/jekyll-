...
public class ShichosonTokubetuKyufuServiceTourokuValidator implements IValidatable {
    ...
    public IValidationMessages validate() {
        ...
        messages.add(ValidateChain.validateStart(div)
                ...
                .thenAdd(CommonButtonHolder.isDisplayNone(削除やめる)
                        ? ShichosonTokubetuKyufuServiceTourokuValidationMessage.更新不可
                        : ShichosonTokubetuKyufuServiceTourokuValidationMessage.削除不可)
                ...
                .ifNot(ShichosonTokubetuKyufuServiceTourokuSpec.有効開始日が前回の有効開始日以前の日付のチェック)
