...
public class KashitsukeShinseiHoshoninDiv extends Panel {
    ...
    @JsonProperty("radHoshoninSeibetsu")
    private RadioButton radHoshoninSeibetsu;
    ...
    @JsonProperty("radHoshoninSeibetsu")
    public RadioButton getRadHoshoninSeibetsu() {
        return radHoshoninSeibetsu;
    }

    @JsonProperty("radHoshoninSeibetsu")
    public void setRadHoshoninSeibetsu(RadioButton radHoshoninSeibetsu) {
        this.radHoshoninSeibetsu=radHoshoninSeibetsu;
    }
