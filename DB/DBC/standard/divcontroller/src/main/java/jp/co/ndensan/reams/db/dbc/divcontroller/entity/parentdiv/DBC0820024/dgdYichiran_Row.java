...
/**
 * dgdYichiran_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgdYichiran_Row extends DataRow {
    ...
    public dgdYichiran_Row(RString defaultDataName1, RString defaultDataName6, TextBoxNum defaultDataName2, TextBoxNum defaultDataName3, TextBoxNum defaultDataName4, RString defaultDataName5, RString rowNum, RString defaultDataName7, RString defaultDataName8, RString defaultDataName9, TextBoxDate defaultDataName10, RString defaultDataName11, TextBoxNum defaultDataName12) {
        super();
        this.setOriginalData("defaultDataName1", defaultDataName1);
        this.setOriginalData("defaultDataName6", defaultDataName6);
        this.setOriginalData("defaultDataName2", defaultDataName2);
    ...
    public TextBoxDate getDefaultDataName10() {
    ...
    public void setRowNum(RString rowNum) {
        this.setOriginalData("rowNum", rowNum);
        this.rowNum = rowNum;
    }
    ...
    public void setDefaultDataName10(TextBoxDate defaultDataName10) {
        this.setOriginalData("defaultDataName10", defaultDataName10);
        this.defaultDataName10 = defaultDataName10;
    }
