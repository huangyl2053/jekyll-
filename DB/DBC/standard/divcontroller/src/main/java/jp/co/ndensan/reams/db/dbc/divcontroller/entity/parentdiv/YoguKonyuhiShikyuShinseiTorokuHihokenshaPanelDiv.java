...
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.KariKaigoCommonPanelDiv;
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.KariKihonPanelDiv;
import jp.co.ndensan.reams.uz.uza.ui.binding.Panel;

/**
 * YoguKonyuhiShikyuShinseiTorokuHihokenshaPanel のクラスファイル 
 * 
 * @author 自動生成
 */
public class YoguKonyuhiShikyuShinseiTorokuHihokenshaPanelDiv extends Panel {
    /*
     * [ private の作成 ]
