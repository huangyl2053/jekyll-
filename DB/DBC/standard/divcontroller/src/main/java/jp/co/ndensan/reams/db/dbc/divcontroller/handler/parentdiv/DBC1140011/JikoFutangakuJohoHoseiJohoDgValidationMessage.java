 ...
 */
public enum JikoFutangakuJohoHoseiJohoDgValidationMessage implements IValidationMessage {
    ...
    private JikoFutangakuJohoHoseiJohoDgValidationMessage(IMessageGettable message, String... replacements) {
