 ...
 * 不正な動作の原因になります。
 */
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.IYoguKonyuhiShikyuShinseiContentsDiv;
import com.fasterxml.jackson.annotation.JsonProperty;
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.YoguKonyuhiShikyuShinseiPaymentMethodDiv;
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.YoguKonyuhiShikyuShinseiSeikyuDetailDiv;
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.YoguKonyuhiShikyuShinseishaJohoDiv;
 ...
 * @author 自動生成
 */
public class YoguKonyuhiShikyuShinseiContentsDiv extends Panel implements IYoguKonyuhiShikyuShinseiContentsDiv {
    /*
     * [ private の作成 ]
