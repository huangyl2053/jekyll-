...
import jp.co.ndensan.reams.db.dbc.divcontroller.entity.DBC0120000.KyotakuJikoRiyohyoListDiv;
 ...
 * @author N8187 久保田 英男
 */
public class KyotakuJikoRiyohyoList {
     ...
     * @return ResponseData
     */
    public ResponseData onLoad(KyotakuJikoRiyohyoListDiv panel) {
        ResponseData<KyotakuJikoRiyohyoListDiv> response = new ResponseData<>();
        setHihokenshaListData(panel);
        response.data = panel;
        return response;
    }

    private void setHihokenshaListData(KyotakuJikoRiyohyoListDiv panel) {
