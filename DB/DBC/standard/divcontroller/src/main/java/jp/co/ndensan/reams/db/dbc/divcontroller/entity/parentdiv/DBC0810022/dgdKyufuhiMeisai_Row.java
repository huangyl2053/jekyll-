...
public class dgdKyufuhiMeisai_Row extends DataRow {
    ...
    public dgdKyufuhiMeisai_Row(RString defaultDataName1, RString defaultDataName2, RString defaultDataName3, RString defaultDataName4, RString defaultDataName5, RString defaultDataName6) {
        super();
        this.setOriginalData("defaultDataName1", defaultDataName1);
        this.setOriginalData("defaultDataName2", defaultDataName2);
        this.setOriginalData("defaultDataName3", defaultDataName3);
