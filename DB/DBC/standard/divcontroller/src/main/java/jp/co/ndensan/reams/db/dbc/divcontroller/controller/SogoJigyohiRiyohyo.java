...
public class SogoJigyohiRiyohyo {
     ...
     * @return ResponseData
     */
    public ResponseData getOnLoadData(SogoJigyohiRiyohyoDiv panel) {
...
//        kyotsu.getBtnRiyohyoSave().setDisabled(true);
    ...
    /**
     * SogoJigyohiRiyohyoInfoの「前月の情報をコピー」ボタン押下時の処理
     *
     * @param panel panel
     * @return ResponseData
     */
    public ResponseData onClickZengetsuCopy(SogoJigyohiRiyohyoDiv panel) {
        ...
        setSogoJigyohiRiyohyoYobi(panel);
        setSogoJigyohiRiyohyoZengetsuData(panel);
        setSogoJigyohiRiyohyoBeppyoZengetsuData(panel);
...
//        validateRiyohyoSave(panel, kyotsu);
    ...
    /**
     * SogoJigyohiRiyohyoInfoのサービス利用票Tabの「明細行を追加する」ボタン押下時の処理
     *
     * @param panel panel
     * @return ResponseData
     */
...
//        validateRiyohyoSave(panel, kyotsu);
    ...
    /**
     * SogoJigyohiRiyohyoInfoのサービス利用票Tabの明細表の削除ボタン押下時の処理
     *
     * @param panel panel
     * @return ResponseData
     */
    public ResponseData onClickSogoJigyohiRiyohyoListDelete(SogoJigyohiRiyohyoDiv panel) {
        ResponseData<SogoJigyohiRiyohyoDiv> response = new ResponseData<>();
    ...
    /**
     * SogoJigyohiRiyohyoInfoの別票Tabの「明細情報を追加する」ボタン押下時の処理
     *
     * @param panel panel
     * @return ResponseData
     */
    ...
    /**
     * SogoJigyohiRiyohyoInfoの別票Tabの「合計情報を追加する」ボタン押下時の処理
     *
     * @param panel panel
     * @return ResponseData
     */
    ...
    /**
     * SogoJigyohiRiyohyoInfoのサービス別票Tabの明細表の選択ボタン押下時の処理
     *
     * @param panel panel
     * @return ResponseData
     */
    public ResponseData onClickSogoJigyohiRiyohyoBeppyoListSelect(SogoJigyohiRiyohyoDiv panel) {
        ResponseData<SogoJigyohiRiyohyoDiv> response = new ResponseData<>();
    ...
    /**
     * SogoJigyohiRiyohyoInfoのサービス別票Tabの明細表の削除ボタン押下時の処理
     *
     * @param panel panel
     * @return ResponseData
     */
    public ResponseData onClickSogoJigyohiRiyohyoBeppyoListDelete(SogoJigyohiRiyohyoDiv panel) {
        ResponseData<SogoJigyohiRiyohyoDiv> response = new ResponseData<>();
    ...
    /**
     * SogoJigyohiRiyohyoInfoの別票Tabの「明細情報を確定する」ボタン押下時の処理
     *
     * @param panel panel
     * @return ResponseData
     */
...
//        validateRiyohyoSave(panel, kyotsu);
    ...
    /**
     * SogoJigyohiRiyohyoInfoの別票Tabの「合計情報を確定する」ボタン押下時の処理
     *
     * @param panel panel
     * @return ResponseData
     */
...
//    }
     ...
     * 利用票のデータ設定
     */
    private void setRiyohyoData(SogoJigyohiRiyohyoDiv panel) {
        setSummaryData(panel);
        setSogoJigyohiRiyohyoYobi(panel);
        setSogoJigyohiRiyohyoBeppyoData(panel);
    }

    /**
     * SogoJigyohiRiyohyoInfoの別票Tabの明細のデータを一覧に反映する。
     *
     * @param panel panel
     */
    private void setBeppyoListMeisaiKakutei(SogoJigyohiRiyohyoDiv panel) {
    ...
    /**
     * SogoJigyohiRiyohyoInfoの別票Tabの合計のデータを一覧に反映する。
     *
     * @param panel panel
     */
    private void setBeppyoListGokeiKakutei(SogoJigyohiRiyohyoDiv panel) {
    ...
    /**
     * SogoJigyohiRiyohyoInfoの別票Tabの明細のデータ初期化
     *
     * @param panel panel
     */
    private void initRiyohyoBeppyoMeisaiData(SogoJigyohiRiyohyoDiv panel) {
    ...
    /**
     * SogoJigyohiRiyohyoInfoの別票Tabの合計のデータ初期化
     *
     * @param panel panel
     */
    private void initRiyohyoBeppyoGokeiData(SogoJigyohiRiyohyoDiv panel) {
        ServiceRiyohyoBeppyoGokeiDiv gokei = panel.getSogoJigyohiRiyohyoInfo().
                getTabServiceRiyohyo().getServiceRiyohyoBeppyo().getServiceRiyohyoBeppyoGokei();
    ...
    /**
     * SogoJigyohiRiyohyoInfoの別票Tabの明細のデモ向けデータ設定
     *
     * @param panel panel
     */
    private void setRiyohyoBeppyoMeisaiDemoData(SogoJigyohiRiyohyoDiv panel) {
        List<HashMap> sourceList = YamlLoader.FOR_DBC.loadAsList(new RString("SogoJigyohiRiyohyo.yml"));
        int yamlIndex = 3;
        ServiceRiyohyoBeppyoMeisaiDiv meisai = panel.getSogoJigyohiRiyohyoInfo().
                getTabServiceRiyohyo().getServiceRiyohyoBeppyo().getServiceRiyohyoBeppyoMeisai();
    ...
    /**
     * SogoJigyohiRiyohyoInfoの別票Tabの合計のデモ向けデータ設定
     *
     * @param panel panel
     */
    private void setRiyohyoBeppyoGokeiDemoData(SogoJigyohiRiyohyoDiv panel) {
        List<HashMap> sourceList = YamlLoader.FOR_DBC.loadAsList(new RString("SogoJigyohiRiyohyo.yml"));
        int yamlIndex = 4;
        ServiceRiyohyoBeppyoGokeiDiv gokei = panel.getSogoJigyohiRiyohyoInfo().
                getTabServiceRiyohyo().getServiceRiyohyoBeppyo().getServiceRiyohyoBeppyoGokei();
    ...
    /**
     * SogoJigyohiRiyohyoInfoの別票のPanel表示設定
     *
     * @param panel panel
     * @param 表示 表示
     */
    private void setRiyohyoBeppyoVisible(SogoJigyohiRiyohyoDiv panel, 別票画面表示 表示) {
     ...
     * @param panel panel
     */
    private void setSogoJigyohiRiyohyoYobi(SogoJigyohiRiyohyoDiv panel) {
     ...
     * @param panel panel
     */
    private void setSogoJigyohiRiyohyoZengetsuData(SogoJigyohiRiyohyoDiv panel) {
        ServiceRiyohyoDiv riyohyo = panel.getSogoJigyohiRiyohyoInfo().getTabServiceRiyohyo().getServiceRiyohyo();
        List<dgServiceRiyohyoList_Row> dgRowList = riyohyo.getDgServiceRiyohyoList().getDataSource();
        dgRowList.clear();

        for (int yamlIndex = 7; yamlIndex < 9; yamlIndex++) {
            dgServiceRiyohyoList_Row rowItem = createサービス利用票(yamlIndex);
    ...
    private void setSogoJigyohiRiyohyoBeppyoData(SogoJigyohiRiyohyoDiv panel) {
        ServiceRiyohyoBeppyoDiv beppyo = panel.getSogoJigyohiRiyohyoInfo().
                getTabServiceRiyohyo().getServiceRiyohyoBeppyo();
    ...
    private void setSogoJigyohiRiyohyoBeppyoZengetsuData(SogoJigyohiRiyohyoDiv panel) {
        ServiceRiyohyoBeppyoDiv beppyo = panel.getSogoJigyohiRiyohyoInfo().
                getTabServiceRiyohyo().getServiceRiyohyoBeppyo();
        ServiceRiyohyoBeppyoRiyoNissuDiv nissu = beppyo.getServiceRiyohyoBeppyoRiyoNissu();
    ...
    private void setBeppyoListZengetsuData(ServiceRiyohyoBeppyoListDiv list) {
        ...
        dgServiceRiyohyoBeppyoList_Row rowItem;
        for (int yamlIndex = 9; yamlIndex < 12; yamlIndex++) {
