package jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.DBC0060014;
/*
...
/**
 * KagoMoshitateTanPanel のクラスファイル 
 * 
 * @author 自動生成
 */
public class KagoMoshitateTanPanelDiv extends Panel {
    ...
    @JsonProperty("Homon")
    private Button Homon;
    @JsonProperty("lblTanshoNyusho")
    private Label lblTanshoNyusho;
    @JsonProperty("lin2")
     ...
     */
    @JsonProperty("Homon")
    public void setHomon(Button Homon) {
        this.Homon = Homon;
    }

    /*
     * getlblTanshoNyusho
     * @return lblTanshoNyusho
     */
    @JsonProperty("lblTanshoNyusho")
    public Label getLblTanshoNyusho() {
        return lblTanshoNyusho;
    }

    /*
     * setlblTanshoNyusho
     * @param lblTanshoNyusho lblTanshoNyusho
     */
    @JsonProperty("lblTanshoNyusho")
    public void setLblTanshoNyusho(Label lblTanshoNyusho) {
        this.lblTanshoNyusho = lblTanshoNyusho;
    }
