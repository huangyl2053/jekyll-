...
public class KyotakuKeikakuTodokedeSearch {
    ...
    public ResponseData onLoad(KyotakuKeikakuTodokedeSearchDiv panel) {
        ...
        panel.getKyotakuKeikakuTodokedeHihokenshaFinder().setIsOpen(true);
        panel.getKyotakuKeikakuTodokedeHihokenshaList().setIsOpen(false);
        response.data = panel;
        return response;
    }
...
//        kojin.getTxtJusho().setValue(cg.getAsRString("住所"));
     ...
     * @return ResponseData
     */
    public ResponseData onClickBtnToSearch(KyotakuKeikakuTodokedeSearchDiv panel) {
        ResponseData<KyotakuKeikakuTodokedeSearchDiv> response = new ResponseData<>();
        setHihokenshaListData(panel);
        panel.getKyotakuKeikakuTodokedeHihokenshaFinder().setIsOpen(false);
        panel.getKyotakuKeikakuTodokedeHihokenshaList().setIsOpen(true);
        response.data = panel;
        return response;
    }
     ...
     * @return ResponseData
     */
    public ResponseData onClickBtnToResearch(KyotakuKeikakuTodokedeSearchDiv panel) {
        ResponseData<KyotakuKeikakuTodokedeSearchDiv> response = new ResponseData<>();
    ...
    private void setHihokenshaListData(KyotakuKeikakuTodokedeSearchDiv panel) {
        SearchResultOfHihokenshaDiv hihokensha = panel.getKyotakuKeikakuTodokedeHihokenshaList();
        List<dgSearchResult_Row> dgList = hihokensha.getDgSearchResult().getDataSource();
        dgList.clear();
