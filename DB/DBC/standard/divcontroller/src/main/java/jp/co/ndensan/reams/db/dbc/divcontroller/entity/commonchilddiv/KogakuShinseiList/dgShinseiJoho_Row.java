...
public class dgShinseiJoho_Row extends DataRow {
    ...
    public void setData3(TextBoxNum data3) {
        this.setOriginalData("data3", data3);
        this.data3 = data3;
    }
    ...
    public void setData8(RString data8) {
        this.setOriginalData("data8", data8);
        this.data8 = data8;
    }
