...
public class KagoMoshitatePanelDiv extends Panel {
    ...
    @JsonProperty("DropDownList6")
    private DropDownList DropDownList6;
    @JsonProperty("DropDownList7")
    private DropDownList DropDownList7;
    ...
    @JsonProperty("hdn排他状態フラグ")
    private RString hdn排他状態フラグ;
    ...
    /*
     * setRadioButton1
     * @param RadioButton1 RadioButton1
     */
    @JsonProperty("RadioButton1")
    ...
    /*
     * setDropDownList3
     * @param DropDownList3 DropDownList3
     */
    @JsonProperty("DropDownList3")
    ...
    /*
     * setDropDownList6
     * @param DropDownList6 DropDownList6
     */
    @JsonProperty("DropDownList6")
    ...
    /*
     * setDropDownList7
     * @param DropDownList7 DropDownList7
     */
    @JsonProperty("DropDownList7")
    ...
    /*
     * setDropDownList2
     * @param DropDownList2 DropDownList2
     */
    @JsonProperty("DropDownList2")
    ...
    /*
     * setDropDownList4
     * @param DropDownList4 DropDownList4
     */
    @JsonProperty("DropDownList4")
    ...
    /*
     * setDropDownList5
     * @param DropDownList5 DropDownList5
     */
    @JsonProperty("DropDownList5")
     ...
     */
    @JsonProperty("hdn排他状態フラグ")
    public RString getHdn排他状態フラグ() {
        return hdn排他状態フラグ;
    }

    /*
     * sethdn排他状態フラグ
     * @param hdn排他状態フラグ hdn排他状態フラグ
     */
    @JsonProperty("hdn排他状態フラグ")
    public void setHdn排他状態フラグ(RString hdn排他状態フラグ) {
        this.hdn排他状態フラグ = hdn排他状態フラグ;
    }
