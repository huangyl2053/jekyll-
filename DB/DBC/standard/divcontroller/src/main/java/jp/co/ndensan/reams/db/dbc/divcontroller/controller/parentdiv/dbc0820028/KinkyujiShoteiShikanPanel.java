...
//        div.getPanelCcd().getCcdKaigoAtenaInfo().load(償還払費申請検索.get識別コード());
        ...
        DbT3118ShikibetsuNoKanriEntity 識別番号管理情報 = SyokanbaraihiShikyuShinseiKetteManager.createInstance()
...
//        }
    ...
    public ResponseData<KinkyujiShoteiShikanPanelDiv> onClick_btnDgdModify(
        ...
        if (登録.equals(ViewStateHolder.get(ViewStateKeys.状態, RString.class))
                && row.getRowState() == RowState.Added) {
    ...
    public ResponseData<KinkyujiShoteiShikanPanelDiv> onClick_btnConfirm(KinkyujiShoteiShikanPanelDiv div) {
        ...
        if (!new RString("").equals(div.getRowId())) {
