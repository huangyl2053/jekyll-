...
/**
 * TokubetsuKyufuJigyoshaDetailDaihyosha のクラスファイル 
 * 
 * @author 自動生成
 */
public class TokubetsuKyufuJigyoshaDetailDaihyoshaDiv extends Panel {
    ...
    private TextBoxKana txtDaihyoshaNameKana;
    ...
    private TextBoxKana txtDaihyoshaJushoKana;
    ...
    /*
     * gettxtDaihyoshaYakushoku
     * @return txtDaihyoshaYakushoku
     */
    @JsonProperty("txtDaihyoshaYakushoku")
    public TextBox getTxtDaihyoshaYakushoku() {
        return txtDaihyoshaYakushoku;
    }

    /*
     * settxtDaihyoshaYakushoku
     * @param txtDaihyoshaYakushoku txtDaihyoshaYakushoku
     */
    @JsonProperty("txtDaihyoshaYakushoku")
    public void setTxtDaihyoshaYakushoku(TextBox txtDaihyoshaYakushoku) {
        this.txtDaihyoshaYakushoku = txtDaihyoshaYakushoku;
    }
     ...
     */
    @JsonProperty("txtDaihyoshaNameKana")
    public TextBoxKana getTxtDaihyoshaNameKana() {
        return txtDaihyoshaNameKana;
    }
     ...
     */
    @JsonProperty("txtDaihyoshaNameKana")
    public void setTxtDaihyoshaNameKana(TextBoxKana txtDaihyoshaNameKana) {
     ...
     */
    @JsonProperty("txtDaihyoshaJushoKana")
    public TextBoxKana getTxtDaihyoshaJushoKana() {
        return txtDaihyoshaJushoKana;
    }
     ...
     */
    @JsonProperty("txtDaihyoshaJushoKana")
    public void setTxtDaihyoshaJushoKana(TextBoxKana txtDaihyoshaJushoKana) {
