...
/**
 * dgdKinkyujiShiseturyoyo_Row のクラスファイル 
 * 
 * @author 自動生成
 */

public class dgdKinkyujiShiseturyoyo_Row extends DataRow {
    // <editor-fold defaultstate="collapsed" desc="Created By UIDesigner ver：UZ-deploy-2016-11-04_20-51-13">

    private RString defaultDataName1;
    private RString defaultDataName2;
    private RString defaultDataName3;
    private TextBoxDate defaultDataName4;
    private TextBoxDate defaultDataName5;
    ...
    private TextBoxNum defaultDataName12;
    private TextBoxNum defaultDataName13;
    private TextBoxNum defaultDataName14;
    private TextBoxNum defaultDataName15;
    private TextBoxNum defaultDataName16;
    private TextBoxNum defaultDataName17;
    ...
    public dgdKinkyujiShiseturyoyo_Row() {
        super();
        this.defaultDataName1 = RString.EMPTY;
        this.defaultDataName2 = RString.EMPTY;
        this.defaultDataName3 = RString.EMPTY;
        this.defaultDataName4 = new TextBoxDate();
        this.defaultDataName5 = new TextBoxDate();
        ...
        this.defaultDataName12 = new TextBoxNum();
        this.defaultDataName13 = new TextBoxNum();
        this.defaultDataName14 = new TextBoxNum();
        this.defaultDataName15 = new TextBoxNum();
        this.defaultDataName16 = new TextBoxNum();
        this.defaultDataName17 = new TextBoxNum();
    ...
    public dgdKinkyujiShiseturyoyo_Row(RString defaultDataName1, RString defaultDataName2, RString defaultDataName3, TextBoxDate defaultDataName4, TextBoxDate defaultDataName5, TextBoxDate defaultDataName6, TextBoxNum defaultDataName7, RString defaultDataName8, TextBoxNum defaultDataName9, RString defaultDataName10, TextBoxNum defaultDataName11, TextBoxNum defaultDataName12, TextBoxNum defaultDataName13, TextBoxNum defaultDataName14, TextBoxNum defaultDataName15, TextBoxNum defaultDataName16, TextBoxNum defaultDataName17, TextBoxNum defaultDataName18, TextBoxNum defaultDataName19, RString defaultDataName20, RString defaultDataName21) {
        super();
        this.setOriginalData("defaultDataName1", defaultDataName1);
        this.setOriginalData("defaultDataName2", defaultDataName2);
        this.setOriginalData("defaultDataName3", defaultDataName3);
    ...
    public TextBoxDate getDefaultDataName4() {
        return defaultDataName4;
    }

    public TextBoxDate getDefaultDataName5() {
        return defaultDataName5;
    }

    public TextBoxDate getDefaultDataName6() {
    ...
    public TextBoxNum getDefaultDataName12() {
        return defaultDataName12;
    }

    public TextBoxNum getDefaultDataName13() {
        return defaultDataName13;
    }

    public TextBoxNum getDefaultDataName14() {
        return defaultDataName14;
    }

    public TextBoxNum getDefaultDataName15() {
    ...
    public TextBoxNum getDefaultDataName17() {
    ...
    public void setDefaultDataName4(TextBoxDate defaultDataName4) {
        this.setOriginalData("defaultDataName4", defaultDataName4);
        this.defaultDataName4 = defaultDataName4;
    }

    public void setDefaultDataName5(TextBoxDate defaultDataName5) {
        this.setOriginalData("defaultDataName5", defaultDataName5);
        this.defaultDataName5 = defaultDataName5;
    }

    public void setDefaultDataName6(TextBoxDate defaultDataName6) {
        this.setOriginalData("defaultDataName6", defaultDataName6);
        this.defaultDataName6 = defaultDataName6;
    }
    ...
    public void setDefaultDataName12(TextBoxNum defaultDataName12) {
        this.setOriginalData("defaultDataName12", defaultDataName12);
        this.defaultDataName12 = defaultDataName12;
    }

    public void setDefaultDataName13(TextBoxNum defaultDataName13) {
        this.setOriginalData("defaultDataName13", defaultDataName13);
        this.defaultDataName13 = defaultDataName13;
    }

    public void setDefaultDataName14(TextBoxNum defaultDataName14) {
        this.setOriginalData("defaultDataName14", defaultDataName14);
        this.defaultDataName14 = defaultDataName14;
    }

    public void setDefaultDataName15(TextBoxNum defaultDataName15) {
        this.setOriginalData("defaultDataName15", defaultDataName15);
        this.defaultDataName15 = defaultDataName15;
    }
    ...
    public void setDefaultDataName17(TextBoxNum defaultDataName17) {
        this.setOriginalData("defaultDataName17", defaultDataName17);
        this.defaultDataName17 = defaultDataName17;
    }
