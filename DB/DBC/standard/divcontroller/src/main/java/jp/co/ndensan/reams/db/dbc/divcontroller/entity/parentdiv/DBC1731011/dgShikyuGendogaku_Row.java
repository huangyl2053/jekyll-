...
public class dgShikyuGendogaku_Row extends DataRow {
    ...
    private TextBoxDate defaultDataName1;
    ...
    public dgShikyuGendogaku_Row() {
        ...
        this.defaultDataName1 = new TextBoxDate();
        this.defaultDataName2 = new TextBoxDate();
    ...
    public dgShikyuGendogaku_Row(RString defaultDataName0, TextBoxDate defaultDataName1, TextBoxDate defaultDataName2, TextBoxNum defaultDataName3, TextBoxNum defaultDataName4, TextBoxNum defaultDataName5) {
        super();
        this.setOriginalData("defaultDataName0", defaultDataName0);
        this.setOriginalData("defaultDataName1", defaultDataName1);
        this.setOriginalData("defaultDataName2", defaultDataName2);
    ...
    public TextBoxDate getDefaultDataName1() {
        return defaultDataName1;
    }

    public TextBoxDate getDefaultDataName2() {
    ...
    public void setDefaultDataName1(TextBoxDate defaultDataName1) {
        this.setOriginalData("defaultDataName1", defaultDataName1);
        this.defaultDataName1 = defaultDataName1;
    }

    public void setDefaultDataName2(TextBoxDate defaultDataName2) {
        this.setOriginalData("defaultDataName2", defaultDataName2);
        this.defaultDataName2 = defaultDataName2;
    }
