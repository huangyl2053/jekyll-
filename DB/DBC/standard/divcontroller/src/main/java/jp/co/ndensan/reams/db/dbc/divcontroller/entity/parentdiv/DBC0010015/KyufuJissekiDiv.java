...
public class KyufuJissekiDiv extends Panel {
    ...
    @JsonProperty("TokuteiShinryohiFromH1504Panel")
    private TokuteiShinryohiFromH1504PanelDiv TokuteiShinryohiFromH1504Panel;
    @JsonProperty("TokuteiShinryohiToH1503Panel")
    private TokuteiShinryohiToH1503PanelDiv TokuteiShinryohiToH1503Panel;
    ...
    /*
     * getTokuteiShinryohiFromH1504Panel
     * @return TokuteiShinryohiFromH1504Panel
     */
    @JsonProperty("TokuteiShinryohiFromH1504Panel")
    ...
    /*
     * setTokuteiShinryohiFromH1504Panel
     * @param TokuteiShinryohiFromH1504Panel TokuteiShinryohiFromH1504Panel
     */
    @JsonProperty("TokuteiShinryohiFromH1504Panel")
    public void setTokuteiShinryohiFromH1504Panel(TokuteiShinryohiFromH1504PanelDiv TokuteiShinryohiFromH1504Panel) {
        this.TokuteiShinryohiFromH1504Panel = TokuteiShinryohiFromH1504Panel;
    }

    /*
     * getTokuteiShinryohiToH1503Panel
     * @return TokuteiShinryohiToH1503Panel
     */
    @JsonProperty("TokuteiShinryohiToH1503Panel")
    ...
    /*
     * setTokuteiShinryohiToH1503Panel
     * @param TokuteiShinryohiToH1503Panel TokuteiShinryohiToH1503Panel
     */
    @JsonProperty("TokuteiShinryohiToH1503Panel")
    public void setTokuteiShinryohiToH1503Panel(TokuteiShinryohiToH1503PanelDiv TokuteiShinryohiToH1503Panel) {
        this.TokuteiShinryohiToH1503Panel = TokuteiShinryohiToH1503Panel;
    }
    ...
    public Label getLblTitle1() {
        return this.getTokuteiShinryohiFromH1504Panel().getLblTitle1();
    }

    @JsonIgnore
    public void setLblTitle1(Label lblTitle1) {
        this.getTokuteiShinryohiFromH1504Panel().setLblTitle1(lblTitle1);
    }

    @JsonIgnore
    public DataGrid<dgTokuteiShinryohiFromH1504_Row> getDgTokuteiShinryohiFromH1504() {
        return this.getTokuteiShinryohiFromH1504Panel().getDgTokuteiShinryohiFromH1504();
    }

    @JsonIgnore
    public void setDgTokuteiShinryohiFromH1504(DataGrid<dgTokuteiShinryohiFromH1504_Row> dgTokuteiShinryohiFromH1504) {
        this.getTokuteiShinryohiFromH1504Panel().setDgTokuteiShinryohiFromH1504(dgTokuteiShinryohiFromH1504);
    }

    @JsonIgnore
    public Label getLblTitle2() {
        return this.getTokuteiShinryohiToH1503Panel().getLblTitle2();
    }

    @JsonIgnore
    public void setLblTitle2(Label lblTitle2) {
        this.getTokuteiShinryohiToH1503Panel().setLblTitle2(lblTitle2);
    }

    @JsonIgnore
    public DataGrid<dgTokuteiShinryohiToH1503_Row> getDgTokuteiShinryohiToH1503() {
        return this.getTokuteiShinryohiToH1503Panel().getDgTokuteiShinryohiToH1503();
    }

    @JsonIgnore
    public void setDgTokuteiShinryohiToH1503(DataGrid<dgTokuteiShinryohiToH1503_Row> dgTokuteiShinryohiToH1503) {
        this.getTokuteiShinryohiToH1503Panel().setDgTokuteiShinryohiToH1503(dgTokuteiShinryohiToH1503);
    }
