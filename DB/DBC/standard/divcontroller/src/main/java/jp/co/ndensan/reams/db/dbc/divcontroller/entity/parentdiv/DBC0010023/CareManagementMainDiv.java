package jp.co.ndensan.reams.db.dbc.divcontroller.entity.parentdiv.DBC0010023;
/*
...
/**
 * CareManagementMain のクラスファイル
 *
 * @author 自動生成
 */
public class CareManagementMainDiv extends Panel {
    ...
    /*
     * setCareManagementhiEtc
     * @param CareManagementhiEtc CareManagementhiEtc
     */
    @JsonProperty("CareManagementhiEtc")
     ...
     */
    @JsonIgnore
    public DataGrid<dgCareManagement_Row> getDgCareManagement() {
        return this.getCareManagementhiEtc().getDgCareManagement();
    }

    @JsonIgnore
    public void setDgCareManagement(DataGrid<dgCareManagement_Row> dgCareManagement) {
        this.getCareManagementhiEtc().setDgCareManagement(dgCareManagement);
    }
