...
public class KashitsukeHenkanInfo {
     ...
     * @return ResponseData
     */
    public ResponseData<KashitsukeHenkanInfoDiv> onSelectedHenkanList(KashitsukeHenkanInfoDiv info, KashitsukeHenkanListDiv list) {
        ResponseData<KashitsukeHenkanInfoDiv> response = new ResponseData<>();

        setSummary1Data(info, list);
        setServiceData(info);
    ...
    private void setSummary1Data(KashitsukeHenkanInfoDiv info, KashitsukeHenkanListDiv list) {
        dgKyufuhiKashitsukekinList_Row row = list.getKashitsukeHenkanListInfo().getDgKyufuhiKashitsukekinList().getClickedItem();
