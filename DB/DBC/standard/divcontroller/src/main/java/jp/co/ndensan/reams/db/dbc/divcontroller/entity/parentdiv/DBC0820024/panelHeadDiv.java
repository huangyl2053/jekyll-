...
public class panelHeadDiv extends Panel {
    ...
    @JsonProperty("txtMeisayiBango")
    private TextBoxCode txtMeisayiBango;
    ...
    /*
     * gettxtMeisayiBango
     * @return txtMeisayiBango
     */
    @JsonProperty("txtMeisayiBango")
    public TextBoxCode getTxtMeisayiBango() {
        return txtMeisayiBango;
    }

    /*
     * settxtMeisayiBango
     * @param txtMeisayiBango txtMeisayiBango
     */
    @JsonProperty("txtMeisayiBango")
    public void setTxtMeisayiBango(TextBoxCode txtMeisayiBango) {
        this.txtMeisayiBango = txtMeisayiBango;
    }
