...
/**
 * dgJushochiTokutei_Row のクラスファイル
 *
...
public class dgJushochiTokutei_Row extends DataRow {
    ...
    public dgJushochiTokutei_Row(RString defaultDataName1, TextBoxNum defaultDataName2, RString defaultDataName3, TextBoxNum defaultDataName4, RString defaultDataName6, RString defaultDataName5, RString defaultDataName7, RString defaultDataName8, RString defaultDataName9) {
        super();
        this.setOriginalData("defaultDataName1", defaultDataName1);
        this.setOriginalData("defaultDataName2", defaultDataName2);
        this.setOriginalData("defaultDataName3", defaultDataName3);
