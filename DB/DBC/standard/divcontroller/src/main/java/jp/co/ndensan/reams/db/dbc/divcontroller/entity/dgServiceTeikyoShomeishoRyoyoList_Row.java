...
public class dgServiceTeikyoShomeishoRyoyoList_Row extends DataRow {
    ...
    public dgServiceTeikyoShomeishoRyoyoList_Row() {
        ...
        this.txtShoteiShikkanName = RString.EMPTY;
        this.txtRyoyoKaishiYMD = RString.EMPTY;
        this.txtShoteiShikkanGokei = RString.EMPTY;
        this.txtKinkyujiName = RString.EMPTY;
        this.txtChiryoKaishiYMD = RString.EMPTY;
        this.txtKinkyujiGokei = RString.EMPTY;
        this.txtRyoyohiGokei = RString.EMPTY;
    }
