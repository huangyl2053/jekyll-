/// <reference path="ServiceTeikyoShomeishoShinryoListH1503_Design.ts" />
    ...
    export module ServiceTeikyoShomeishoShinryoListH1503 {
        ...
        export class PublicProperties {
            ...
            public getMeisaiListGridSetting() {
                return this.controls.dgServiceTeikyoShomeishoShinryoListH1503().gridSetting;
            }

            public setMeisaiListGridSetting(value) {
                this.controls.dgServiceTeikyoShomeishoShinryoListH1503().gridSetting = value;
            }
            */
