/// <reference path="ServiceTeikyoShomeishoShokujiListH1503_Design.ts" />
    ...
    export module ServiceTeikyoShomeishoShokujiListH1503 {
        ...
        export class PublicProperties {
            ...
            public getMeisaiListGridSetting() {
                return this.controls.dgServiceTeikyoShomeishoShokujiListH1503().gridSetting;
            }

            public setMeisaiListGridSetting(value) {
                this.controls.dgServiceTeikyoShomeishoShokujiListH1503().gridSetting = value;
            }
            */
