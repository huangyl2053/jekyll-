/// <reference path="ServiceTeikyoShomeishoRyoyoList_Design.ts" />
    ...
    export module ServiceTeikyoShomeishoRyoyoList {
        ...
        export class PublicProperties {
            ...
            public getMeisaiListGridSetting() {
                return this.controls.dgServiceTeikyoShomeishoRyoyoList().gridSetting;
            }

            public setMeisaiListGridSetting(value) {
                this.controls.dgServiceTeikyoShomeishoRyoyoList().gridSetting = value;
            }
            */
