...
public class RiyoJokyoTokeihyoMeisaiListTokeiHyoSakuseiShukeiService {
     ...
     */
    public RiyoJokyoTokeihyoMeisaiListTokeiHyoSakuseiShukeiService(Map<RString, RiyoJokyoTokeihyoShukeiKekkaEntity> 利用状況統計表集計結果Map, boolean 利用実人員登録フラグ) {
    ...
    public void get社福軽減額(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類) {
        ...
        集計項目Entity.setサービス種類コード(tokeihyo_EditPattern.get集計項目名7());
    ...
    private void create集計項目7_1(RString 統計用サービス種類, Decimal 加算対象) {
        ...
        if (集計項目Entity == null) {
            ...
            集計項目Entity.set集計項目7_10(加算対象);
        } else {
            集計項目Entity.set集計項目7_1(集計項目Entity.get集計項目7_1().add(加算対象));
            集計項目Entity.set集計項目7_10(集計項目Entity.get集計項目7_10().add(加算対象));
        }
    }

    private void create社福軽減額7_1(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類, Decimal 加算対象) {
        RiyojokyoTokeihyo_EditPattern tokeihyo_EditPattern = RiyojokyoTokeihyo_EditPattern.toValue(entity.getYoKaigoJotaiKubunCode());
    ...
    private void create社福軽減額7_2(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類, Decimal 加算対象) {
        RiyojokyoTokeihyo_EditPattern tokeihyo_EditPattern = RiyojokyoTokeihyo_EditPattern.toValue(entity.getYoKaigoJotaiKubunCode());
    ...
    private void create社福軽減額7_3(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類, Decimal 加算対象) {
        RiyojokyoTokeihyo_EditPattern tokeihyo_EditPattern = RiyojokyoTokeihyo_EditPattern.toValue(entity.getYoKaigoJotaiKubunCode());
    ...
    private void create社福軽減額7_4(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類, Decimal 加算対象) {
        RiyojokyoTokeihyo_EditPattern tokeihyo_EditPattern = RiyojokyoTokeihyo_EditPattern.toValue(entity.getYoKaigoJotaiKubunCode());
    ...
    private void create社福軽減額7_5(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類, Decimal 加算対象) {
        RiyojokyoTokeihyo_EditPattern tokeihyo_EditPattern = RiyojokyoTokeihyo_EditPattern.toValue(entity.getYoKaigoJotaiKubunCode());
    ...
    private void create社福軽減額7_6(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類, Decimal 加算対象) {
        RiyojokyoTokeihyo_EditPattern tokeihyo_EditPattern = RiyojokyoTokeihyo_EditPattern.toValue(entity.getYoKaigoJotaiKubunCode());
    ...
    private void create社福軽減額7_7(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類, Decimal 加算対象) {
        RiyojokyoTokeihyo_EditPattern tokeihyo_EditPattern = RiyojokyoTokeihyo_EditPattern.toValue(entity.getYoKaigoJotaiKubunCode());
    ...
    private void create社福軽減額7_8(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類, Decimal 加算対象) {
        RiyojokyoTokeihyo_EditPattern tokeihyo_EditPattern = RiyojokyoTokeihyo_EditPattern.toValue(entity.getYoKaigoJotaiKubunCode());
    ...
    private void create社福軽減額7_9(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類, Decimal 加算対象) {
        RiyojokyoTokeihyo_EditPattern tokeihyo_EditPattern = RiyojokyoTokeihyo_EditPattern.toValue(entity.getYoKaigoJotaiKubunCode());
     ...
     * @param 統計用サービス種類 統計用サービス種類
     */
    public void get特定入所者介護サービス(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類) {
        RiyojokyoTokeihyo_EditPattern tokeihyo_EditPattern = RiyojokyoTokeihyo_EditPattern.toValue(entity.getYoKaigoJotaiKubunCode());
        if (!利用状況統計表集計結果Map.containsKey(統計用サービス種類)) {
            return;
        }
        ...
        if (is集計) {
            集計項目2集計.set集計項目2_10(集計項目2集計.get集計項目2_10().add(特定入所日数食費));
            集計項目3集計.set集計項目3_10(集計項目3集計.get集計項目3_10().add(特定入所費用額食費));
            集計項目4集計.set集計項目4_10(集計項目4集計.get集計項目4_10().add(特定入所保険分請求額食費));
            集計項目5集計.set集計項目5_10(集計項目5集計.get集計項目5_10().add(特定入所日数居住));
            集計項目6集計.set集計項目6_10(集計項目6集計.get集計項目6_10().add(特定入所費用額居住));
            集計項目7集計.set集計項目7_10(集計項目7集計.get集計項目7_10().add(特定入所保険分請求額居住));
        }
    }
    ...
    private boolean add特定入所者介護サービス(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類) {
        ...
        if (YoKaigoJotaiKubun.非該当.getCode().equals(entity.getYoKaigoJotaiKubunCode())) {
            集計項目2集計.set集計項目2_1(集計項目2集計.get集計項目2_1().add(特定入所日数食費));
            集計項目3集計.set集計項目3_1(集計項目3集計.get集計項目3_1().add(特定入所費用額食費));
            集計項目4集計.set集計項目4_1(集計項目4集計.get集計項目4_1().add(特定入所保険分請求額食費));
            集計項目5集計.set集計項目5_1(集計項目5集計.get集計項目5_1().add(特定入所日数居住));
            集計項目6集計.set集計項目6_1(集計項目6集計.get集計項目6_1().add(特定入所費用額居住));
            集計項目7集計.set集計項目7_1(集計項目7集計.get集計項目7_1().add(特定入所保険分請求額居住));
            isExists = true;
            if (is集計項目1(entity)) {
                集計項目1集計.set集計項目1_1(集計項目1集計.get集計項目1_1().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            }
        } else if (YoKaigoJotaiKubun.要支援1.getCode().equals(entity.getYoKaigoJotaiKubunCode())) {
            集計項目2集計.set集計項目2_2(集計項目2集計.get集計項目2_2().add(特定入所日数食費));
            集計項目3集計.set集計項目3_2(集計項目3集計.get集計項目3_2().add(特定入所費用額食費));
            集計項目4集計.set集計項目4_2(集計項目4集計.get集計項目4_2().add(特定入所保険分請求額食費));
            集計項目5集計.set集計項目5_2(集計項目5集計.get集計項目5_2().add(特定入所日数居住));
            集計項目6集計.set集計項目6_2(集計項目6集計.get集計項目6_2().add(特定入所費用額居住));
            集計項目7集計.set集計項目7_2(集計項目7集計.get集計項目7_2().add(特定入所保険分請求額居住));
            isExists = true;
            if (is集計項目1(entity)) {
            ...
            集計項目2集計.set集計項目2_3(集計項目2集計.get集計項目2_3().add(特定入所日数食費));
            集計項目3集計.set集計項目3_3(集計項目3集計.get集計項目3_3().add(特定入所費用額食費));
            集計項目4集計.set集計項目4_3(集計項目4集計.get集計項目4_3().add(特定入所保険分請求額食費));
            集計項目5集計.set集計項目5_3(集計項目5集計.get集計項目5_3().add(特定入所日数居住));
            集計項目6集計.set集計項目6_3(集計項目6集計.get集計項目6_3().add(特定入所費用額居住));
            集計項目7集計.set集計項目7_3(集計項目7集計.get集計項目7_3().add(特定入所保険分請求額居住));
            isExists = true;
            if (is集計項目1(entity)) {
            ...
            集計項目2集計.set集計項目2_4(集計項目2集計.get集計項目2_4().add(特定入所日数食費));
            集計項目3集計.set集計項目3_4(集計項目3集計.get集計項目3_4().add(特定入所費用額食費));
            集計項目4集計.set集計項目4_4(集計項目4集計.get集計項目4_4().add(特定入所保険分請求額食費));
            集計項目5集計.set集計項目5_4(集計項目5集計.get集計項目5_4().add(特定入所日数居住));
            集計項目6集計.set集計項目6_4(集計項目6集計.get集計項目6_4().add(特定入所費用額居住));
            集計項目7集計.set集計項目7_4(集計項目7集計.get集計項目7_4().add(特定入所保険分請求額居住));
            isExists = true;
            if (is集計項目1(entity)) {
            ...
            集計項目2集計.set集計項目2_5(集計項目2集計.get集計項目2_5().add(特定入所日数食費));
            集計項目3集計.set集計項目3_5(集計項目3集計.get集計項目3_5().add(特定入所費用額食費));
            集計項目4集計.set集計項目4_5(集計項目4集計.get集計項目4_5().add(特定入所保険分請求額食費));
            集計項目5集計.set集計項目5_5(集計項目5集計.get集計項目5_5().add(特定入所日数居住));
            集計項目6集計.set集計項目6_5(集計項目6集計.get集計項目6_5().add(特定入所費用額居住));
            集計項目7集計.set集計項目7_5(集計項目7集計.get集計項目7_5().add(特定入所保険分請求額居住));
            isExists = true;
            if (is集計項目1(entity)) {
                集計項目1集計.set集計項目1_5(集計項目1集計.get集計項目1_5().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            }
        } else if (YoKaigoJotaiKubun.要介護2.getCode().equals(entity.getYoKaigoJotaiKubunCode())) {
            集計項目2集計.set集計項目2_6(集計項目2集計.get集計項目2_6().add(特定入所日数食費));
            集計項目3集計.set集計項目3_6(集計項目3集計.get集計項目3_6().add(特定入所費用額食費));
            集計項目4集計.set集計項目4_6(集計項目4集計.get集計項目4_6().add(特定入所保険分請求額食費));
            集計項目5集計.set集計項目5_6(集計項目5集計.get集計項目5_6().add(特定入所日数居住));
            集計項目6集計.set集計項目6_6(集計項目6集計.get集計項目6_6().add(特定入所費用額居住));
            集計項目7集計.set集計項目7_6(集計項目7集計.get集計項目7_6().add(特定入所保険分請求額居住));
            if (is集計項目1(entity)) {
                集計項目1集計.set集計項目1_6(集計項目1集計.get集計項目1_6().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            }
        } else if (YoKaigoJotaiKubun.要介護3.getCode().equals(entity.getYoKaigoJotaiKubunCode())) {
            集計項目2集計.set集計項目2_7(集計項目2集計.get集計項目2_7().add(特定入所日数食費));
            集計項目3集計.set集計項目3_7(集計項目3集計.get集計項目3_7().add(特定入所費用額食費));
            集計項目4集計.set集計項目4_7(集計項目4集計.get集計項目4_7().add(特定入所保険分請求額食費));
            集計項目5集計.set集計項目5_7(集計項目5集計.get集計項目5_7().add(特定入所日数居住));
            集計項目6集計.set集計項目6_7(集計項目6集計.get集計項目6_7().add(特定入所費用額居住));
            集計項目7集計.set集計項目7_7(集計項目7集計.get集計項目7_7().add(特定入所保険分請求額居住));
            isExists = true;
            if (is集計項目1(entity)) {
                集計項目1集計.set集計項目1_7(集計項目1集計.get集計項目1_7().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            }
        } else if (YoKaigoJotaiKubun.要介護4.getCode().equals(entity.getYoKaigoJotaiKubunCode())) {
            集計項目2集計.set集計項目2_8(集計項目2集計.get集計項目2_8().add(特定入所日数食費));
            集計項目3集計.set集計項目3_8(集計項目3集計.get集計項目3_8().add(特定入所費用額食費));
            集計項目4集計.set集計項目4_8(集計項目4集計.get集計項目4_8().add(特定入所保険分請求額食費));
            集計項目5集計.set集計項目5_8(集計項目5集計.get集計項目5_8().add(特定入所日数居住));
            集計項目6集計.set集計項目6_8(集計項目6集計.get集計項目6_8().add(特定入所費用額居住));
            集計項目7集計.set集計項目7_8(集計項目7集計.get集計項目7_8().add(特定入所保険分請求額居住));
            isExists = true;
            if (is集計項目1(entity)) {
                集計項目1集計.set集計項目1_8(集計項目1集計.get集計項目1_8().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            }
        } else if (YoKaigoJotaiKubun.要介護5.getCode().equals(entity.getYoKaigoJotaiKubunCode())) {
            集計項目2集計.set集計項目2_9(集計項目2集計.get集計項目2_9().add(特定入所日数食費));
            集計項目3集計.set集計項目3_9(集計項目3集計.get集計項目3_9().add(特定入所費用額食費));
            集計項目4集計.set集計項目4_9(集計項目4集計.get集計項目4_9().add(特定入所保険分請求額食費));
            集計項目5集計.set集計項目5_9(集計項目5集計.get集計項目5_9().add(特定入所日数居住));
            集計項目6集計.set集計項目6_9(集計項目6集計.get集計項目6_9().add(特定入所費用額居住));
            集計項目7集計.set集計項目7_9(集計項目7集計.get集計項目7_9().add(特定入所保険分請求額居住));
            isExists = true;
            if (is集計項目1(entity)) {
                集計項目1集計.set集計項目1_9(集計項目1集計.get集計項目1_9().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            }
        }
        return isExists;
     ...
     * @param 統計用サービス種類 統計用サービス種類
     */
    public void get社会福祉法人軽減額(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類) {
        RiyojokyoTokeihyo_EditPattern tokeihyo_EditPattern = RiyojokyoTokeihyo_EditPattern.toValue(entity.getYoKaigoJotaiKubunCode());
        if (!利用状況統計表集計結果Map.containsKey(統計用サービス種類)) {
            return;
        }
        ...
        RiyoJokyoTokeihyoServiceShuruiShukeiEntity 集計項目6集計 = リスト_サービス種類集計.get(数字_5);
        if (is集計) {
            集計項目4集計.set集計項目4_10(集計項目4集計.get集計項目4_10().add(社福受領すべき利用者負担額));
            集計項目5集計.set集計項目5_10(集計項目5集計.get集計項目5_10().add(社福軽減額));
            集計項目6集計.set集計項目6_10(集計項目6集計.get集計項目6_10().add(社福軽減後利用者負担額));
        }
    }
    ...
    private boolean add社会福祉法人軽減額(DbWT1513RiyoJokyoTokeihyoEntity entity, RString 統計用サービス種類) {
        ...
        Decimal 社福軽減後利用者負担額 = new Decimal(entity.getShafukuKeigengoRiyoshaFutangaku().toString());
        if (YoKaigoJotaiKubun.非該当.getCode().equals(entity.getYoKaigoJotaiKubunCode())) {
            集計項目4集計.set集計項目4_1(集計項目4集計.get集計項目4_1().add(社福受領すべき利用者負担額));
            集計項目5集計.set集計項目5_1(集計項目5集計.get集計項目5_1().add(社福軽減額));
            集計項目6集計.set集計項目6_1(集計項目6集計.get集計項目6_1().add(社福軽減後利用者負担額));
            isExists = true;
            ...
            集計項目4集計.set集計項目4_2(集計項目4集計.get集計項目4_2().add(社福受領すべき利用者負担額));
            集計項目5集計.set集計項目5_2(集計項目5集計.get集計項目5_2().add(社福軽減額));
            集計項目6集計.set集計項目6_2(集計項目6集計.get集計項目6_2().add(社福軽減後利用者負担額));
            isExists = true;
            if (is社福計加算集計項目１(entity)) {
                集計項目1集計.set集計項目1_2(集計項目1集計.get集計項目1_2().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            ...
            集計項目4集計.set集計項目4_3(集計項目4集計.get集計項目4_3().add(社福受領すべき利用者負担額));
            集計項目5集計.set集計項目5_3(集計項目5集計.get集計項目5_3().add(社福軽減額));
            集計項目6集計.set集計項目6_3(集計項目6集計.get集計項目6_3().add(社福軽減後利用者負担額));
            isExists = true;
            if (is社福計加算集計項目１(entity)) {
                集計項目1集計.set集計項目1_3(集計項目1集計.get集計項目1_3().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            ...
            集計項目4集計.set集計項目4_4(集計項目4集計.get集計項目4_4().add(社福受領すべき利用者負担額));
            集計項目5集計.set集計項目5_4(集計項目5集計.get集計項目5_4().add(社福軽減額));
            集計項目6集計.set集計項目6_4(集計項目6集計.get集計項目6_4().add(社福軽減後利用者負担額));
            isExists = true;
            if (is社福計加算集計項目１(entity)) {
                集計項目1集計.set集計項目1_4(集計項目1集計.get集計項目1_4().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            ...
            集計項目4集計.set集計項目4_5(集計項目4集計.get集計項目4_5().add(社福受領すべき利用者負担額));
            集計項目5集計.set集計項目5_5(集計項目5集計.get集計項目5_5().add(社福軽減額));
            集計項目6集計.set集計項目6_5(集計項目6集計.get集計項目6_5().add(社福軽減後利用者負担額));
            isExists = true;
            if (is社福計加算集計項目１(entity)) {
                集計項目1集計.set集計項目1_5(集計項目1集計.get集計項目1_5().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            ...
            集計項目4集計.set集計項目4_6(集計項目4集計.get集計項目4_6().add(社福受領すべき利用者負担額));
            集計項目5集計.set集計項目5_6(集計項目5集計.get集計項目5_6().add(社福軽減額));
            集計項目6集計.set集計項目6_6(集計項目6集計.get集計項目6_6().add(社福軽減後利用者負担額));
            if (is集計項目1(entity)) {
                集計項目1集計.set集計項目1_6(集計項目1集計.get集計項目1_6().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            }
        } else if (YoKaigoJotaiKubun.要介護3.getCode().equals(entity.getYoKaigoJotaiKubunCode())) {
            集計項目4集計.set集計項目4_7(集計項目4集計.get集計項目4_7().add(社福受領すべき利用者負担額));
            集計項目5集計.set集計項目5_7(集計項目5集計.get集計項目5_7().add(社福軽減額));
            集計項目6集計.set集計項目6_7(集計項目6集計.get集計項目6_7().add(社福軽減後利用者負担額));
            isExists = true;
            if (is社福計加算集計項目１(entity)) {
                集計項目1集計.set集計項目1_7(集計項目1集計.get集計項目1_7().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            ...
            集計項目4集計.set集計項目4_8(集計項目4集計.get集計項目4_8().add(社福受領すべき利用者負担額));
            集計項目5集計.set集計項目5_8(集計項目5集計.get集計項目5_8().add(社福軽減額));
            集計項目6集計.set集計項目6_8(集計項目6集計.get集計項目6_8().add(社福軽減後利用者負担額));
            isExists = true;
            if (is社福計加算集計項目１(entity)) {
                集計項目1集計.set集計項目1_8(集計項目1集計.get集計項目1_8().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
            ...
            集計項目4集計.set集計項目4_9(集計項目4集計.get集計項目4_9().add(社福受領すべき利用者負担額));
            集計項目5集計.set集計項目5_9(集計項目5集計.get集計項目5_9().add(社福軽減額));
            集計項目6集計.set集計項目6_9(集計項目6集計.get集計項目6_9().add(社福軽減後利用者負担額));
            isExists = true;
            if (is社福計加算集計項目１(entity)) {
                集計項目1集計.set集計項目1_9(集計項目1集計.get集計項目1_9().add(Decimal.ONE));
                集計項目1集計.set集計項目1_10(集計項目1集計.get集計項目1_10().add(Decimal.ONE));
