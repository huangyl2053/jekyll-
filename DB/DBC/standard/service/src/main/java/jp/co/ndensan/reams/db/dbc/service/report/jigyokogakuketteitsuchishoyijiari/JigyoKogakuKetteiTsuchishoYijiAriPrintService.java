 ...
 */
package jp.co.ndensan.reams.db.dbc.service.report.jigyokogakuketteitsuchishoyijiari;

import java.util.List;
import jp.co.ndensan.reams.db.dbc.business.report.jigyokogakuketteitsuchishoyijiari.JigyoKogakuKetteiTsuchishoYijiAriProperty;
...
/**
 * 帳票設計_DBCMN43002_事業高額決定通知書(支払予定日あり） PrintServiceするクラスです。
 *
...
public class JigyoKogakuKetteiTsuchishoYijiAriPrintService {
    ...
    /**
     * 帳票設計_DBCMN43002_事業高額決定通知書(支払予定日あり）(単一帳票出力用)
     *
    ...
    /**
     * 帳票設計_DBCMN43002_事業高額決定通知書(支払予定日あり）(複数帳票出力用)。
     *
     * @param 帳票情報 KogakuKetteiTsuchiShoEntity
     * @param 発行日 RDate
     * @param 文書番号 RString
    ...
    public void print(
        ...
        JigyoKogakuKetteiTsuchishoYijiAriProperty property = new JigyoKogakuKetteiTsuchishoYijiAriProperty();

        try (ReportAssembler<JigyoKogakuKetteiTsuchishoYijiAriSource> assembler = createAssembler(property, reportManager)) {
            ...
            ReportSourceWriter<JigyoKogakuKetteiTsuchishoYijiAriSource> reportSourceWriter;
            reportSourceWriter = new ReportSourceWriter(assembler);

            new JigyoKogakuKetteiTsuchishoYijiAriReport(
                    titleList,
                    帳票情報,
                    認証者ソースデータ,
                    文書番号,
