...
import jp.co.ndensan.reams.db.dbc.business.report.gassanketteitsuchisho.GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiProperty;
import jp.co.ndensan.reams.db.dbc.business.report.gassanketteitsuchisho.GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiReport;
 ...
 */
public class GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiPrintService {
    ...
    public void print(KogakuGassanShikyuKetteiTsuchishoEntity tsuchisho, ReportManager reportManager) {
        GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiProperty property = new GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiProperty();
        try (ReportAssembler<GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiSource> assembler = createAssembler(property, reportManager)) {
            ReportSourceWriter<GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiSource> reportSourceWriter
            ...
            GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiReport report
                    = new GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiReport(tsuchisho, ninshoshaSource, 帳票制御汎用キー);
