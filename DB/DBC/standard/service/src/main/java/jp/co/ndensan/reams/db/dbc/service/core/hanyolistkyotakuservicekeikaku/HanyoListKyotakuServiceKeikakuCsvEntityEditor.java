...
public class HanyoListKyotakuServiceKeikakuCsvEntityEditor {
     ...
     * @param parameter HanyoListKyotakuServiceKeeikakuProcessParameter
     * @param 連番 Decimal
     * @param 住所 RString
    ...
    public HanyoListKyotakuServiceKeikakuCsvEntity editor(HanyoListKyotakuServiceKeikakuEntity entity,
            HanyoListKyotakuServiceKeikakuProcessParameter parameter, Decimal 連番, RString 住所) {
    ...
    private void editor地区(HanyoListKyotakuServiceKeikakuEntity entity,
            HanyoListKyotakuServiceKeikakuCsvEntity csvEntity, RString 住所) {
    ...
    private void editor計画(HanyoListKyotakuServiceKeikakuEntity entity,
        ...
        csvEntity.set計画事業者名(
                isNull(entity.getDbT7063_Keikaku事業者名称())
                ? RString.EMPTY
                : entity.getDbT7063_Keikaku事業者名称().value());
        csvEntity.set計画事業者カナ(
                isNull(entity.getDbT7063_Keikaku事業者カナ名称())
                ? RString.EMPTY
                : entity.getDbT7063_Keikaku事業者カナ名称().value());
        ...
        csvEntity.set変更理由(isNull(entity.getDbT3006事業者変更事由())
                ? RString.EMPTY : entity.getDbT3006事業者変更事由());
        ...
        csvEntity.set委託先計画事業者名(
                isNull(entity.getDbT7063_Itaku事業者名称())
                ? RString.EMPTY
                : entity.getDbT7063_Itaku事業者名称().value());
    }
    ...
    private void editor受給(HanyoListKyotakuServiceKeikakuEntity entity,
        ...
        if (ONE.equals(entity.getDbV4001旧措置フラグ())) {
