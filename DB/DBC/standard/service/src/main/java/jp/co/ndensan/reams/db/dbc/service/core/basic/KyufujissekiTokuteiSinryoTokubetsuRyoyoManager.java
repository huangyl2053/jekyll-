...
public class KyufujissekiTokuteiSinryoTokubetsuRyoyoManager {
     ...
     */
    @Transaction
    public KyufujissekiTokuteiSinryoTokubetsuRyoyo get給付実績特定診療費
     ...
     */
    @Transaction
    public List<KyufujissekiTokuteiSinryoTokubetsuRyoyo> get給付実績特定診療費
     ...
     */
    @Transaction
    public boolean save給付実績特定診療費

    ・特別療養費(KyufujissekiTokuteiSinryoTokubetsuRyoyo 給付実績特定診療費
        ・特別療養費) {
        requireNonNull(給付実績特定診療費・特別療養費
        , UrSystemErrorMessages.値がnull.getReplacedMessage("給付実績特定診療費・特別療養費")
        );
        if (!給付実績特定診療費 {
