 ...
 */
package jp.co.ndensan.reams.db.dbc.service.report.kagoketteikohifutanshain;

import java.util.HashMap;
import java.util.List;
import java.util.Map;
import jp.co.ndensan.reams.db.dbc.business.report.kagoketteikohifutanshain.KagoKetteiKohifutanshaInProperty;
...
/**
 *
 * 誤決定通知書情報取込一覧表（公費負担者分）帳票PrintService
 *
 * @reamsid_L DBC-0980-510 surun
 */
public class KagoKetteiKohifutanshaInPrintService {
     ...
     */
    public SourceDataCollection printTaitsu(List<KagoKetteiKohifutanshaChohyoEntity> 帳票出力対象データリスト,
     ...
     */
    public void printFukusu(List<KagoKetteiKohifutanshaChohyoEntity> 帳票出力対象データリスト,
            IOutputOrder 出力順情報, FlexibleYearMonth 処理年月, RDateTime 作成日時, ReportManager reportManager) {
        KagoKetteiKohifutanshaInProperty property = new KagoKetteiKohifutanshaInProperty();
        try (ReportAssembler<KagoKetteiKohifutanshaInSource> assembler = createAssembler(property, reportManager)) {
            ReportSourceWriter<KagoKetteiKohifutanshaInSource> reportSourceWriter = new ReportSourceWriter(assembler);
            int i = 0;
            ...
            new KagoKetteiKohifutanshaInReport(帳票出力対象データリスト,
