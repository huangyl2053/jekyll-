...
public class GassanJigyobunKetteiTsuchishoShiharaiYoteiBiYijiAriPrintService {
    ...
    public void print(KogakuGassanShikyuKetteiTsuchisho tsuchisho, ReportManager reportManager) {
        GassanJigyobunKetteiTsuchishoShiharaiYoteiBiYijiAriProperty property = new GassanJigyobunKetteiTsuchishoShiharaiYoteiBiYijiAriProperty();
        try (ReportAssembler<GassanJigyobunKetteiTsuchishoShiharaiYoteiBiYijiAriSource> assembler = createAssembler(property, reportManager)) {
            ReportSourceWriter<GassanJigyobunKetteiTsuchishoShiharaiYoteiBiYijiAriSource> reportSourceWriter
            ...
            GassanJigyobunKetteiTsuchishoShiharaiYoteiBiYijiAriReport report
                    = new GassanJigyobunKetteiTsuchishoShiharaiYoteiBiYijiAriReport(tsuchisho, ninshoshaSource, 帳票制御汎用キー);
