...
public class KogakuServiceKetteishaIchiranhyoData {
    ...
    /**
     * {@link InstanceProvider#create}にて生成した{@link KogakuServiceKetteishaIchiranhyoData}のインスタンスを返します。
     *
     * @return // * {@link InstanceProvider#create}にて生成した{@link KogakuServiceKetteishaIchiranhyoData}のインスタンス
     */
    public static KogakuServiceKetteishaIchiranhyoData createInstance() {
        return InstanceProvider.create(KogakuServiceKetteishaIchiranhyoData.class);
    }
