...
public class ShokanBaraiShikyuFushikyuKetteiTsuchishoBatch {
     ...
     *
     * @return {@link InstanceProvider#create}にて生成した{@link ShokanBaraiShikyuFushikyuKetteiTsuchishoBatch}のインスタンス
     */
    public static ShokanBaraiShikyuFushikyuKetteiTsuchishoBatch createInstance() {
        return InstanceProvider.create(ShokanBaraiShikyuFushikyuKetteiTsuchishoBatch.class);
    }
    ...
    private static class DateComparator implements Comparator<ShokanKetteiTsuchiShoShiharai>, Serializable {
        ...
        private static final long serialVersionUID = -8067792676257085578L;
