...
public class SyokanbaraihiShikyuShinseiManager {
    ...
    private boolean 明細証明書InputCheck(RString 証明書入力済フラグ, ShikibetsuNoKanri shikibetsuNoKanri) {
        if (shikibetsuNoKanri != null) {
    ...
    private boolean 特定診療費証明書InputCheck(RString 証明書入力済フラグ, ShikibetsuNoKanri shikibetsuNoKanri) {
        if (shikibetsuNoKanri != null) {
    ...
    private boolean 居宅計画費証明書InputCheck(RString 証明書入力済フラグ, ShikibetsuNoKanri shikibetsuNoKanri) {
        if (shikibetsuNoKanri != null) {
    ...
    private boolean 特定入所者証明書InputCheck(RString 証明書入力済フラグ, ShikibetsuNoKanri shikibetsuNoKanri) {
        if (shikibetsuNoKanri != null) {
    ...
    private boolean 明細住所地特例証明書InputCheck(RString 証明書入力済フラグ, ShikibetsuNoKanri shikibetsuNoKanri) {
        if (shikibetsuNoKanri != null) {
    ...
    private boolean 特定診療特別療養証明書InputCheck(RString 証明書入力済フラグ, ShikibetsuNoKanri shikibetsuNoKanri) {
        if (shikibetsuNoKanri != null) {
    ...
    private boolean 緊急時施設療養証明書InputCheck(RString 証明書入力済フラグ, ShikibetsuNoKanri shikibetsuNoKanri) {
        if (shikibetsuNoKanri != null) {
    ...
    private boolean 食事費用証明書InputCheck(RString 証明書入力済フラグ, ShikibetsuNoKanri shikibetsuNoKanri) {
        if (shikibetsuNoKanri != null) {
    ...
    private boolean 集計証明書InputCheck(RString 証明書入力済フラグ, ShikibetsuNoKanri shikibetsuNoKanri) {
        if (shikibetsuNoKanri != null) {
    ...
    private boolean 社会福祉法人軽減証明書InputCheck(RString 証明書入力済フラグ, ShikibetsuNoKanri shikibetsuNoKanri) {
        if (shikibetsuNoKanri != null) {
