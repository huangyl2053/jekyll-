...
public class YoboKeikakuJikoSakuseiMeisaiManagerTest {
    ...
    public static class get予防給付計画自己作成明細 extends DbcTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get主キー1().value(), is(DbT3011YoboKeikakuJikoSakuseiMeisaiEntityGenerator.DEFAULT_被保険者番号.value()));
        }
    }
    ...
    public static class get予防給付計画自己作成明細一覧 extends DbcTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get(0).get主キー1().value(), is(DbT3011YoboKeikakuJikoSakuseiMeisaiEntityGenerator.DEFAULT_被保険者番号.value()));
        }
    }
