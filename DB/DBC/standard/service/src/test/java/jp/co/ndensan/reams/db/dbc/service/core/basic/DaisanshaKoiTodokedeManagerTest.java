...
import jp.co.ndensan.reams.db.dbc.business.core.basic.DaisanshaKoiTodokede;
...
import jp.co.ndensan.reams.db.dbc.persistence.db.basic.DbT3084DaisanshaKoiTodokedeDac;
...
public class DaisanshaKoiTodokedeManagerTest {
    ...
    public static class get介護第三者行為届出 extends DbcTestBase {

        // TODO メソッドの引数の数に合わせて、NullPointerExceptionのテストケースを増減してください。
        @Test(expected = NullPointerException.class)
        public void 引数の主キー型1にnullを指定した場合_NullPointerExceptionが発生する() {
            RString 主キー2 = DbT3084DaisanshaKoiTodokedeEntityGenerator.DEFAULT_第三者行為届出管理番号;
            Decimal 主キー3 = DbT3084DaisanshaKoiTodokedeEntityGenerator.DEFAULT_履歴番号;
            sut.get介護第三者行為届出(null, 主キー2, 主キー3);
        }

        @Test(expected = NullPointerException.class)
        public void 引数の主キー型2にnullを指定した場合_NullPointerExceptionが発生する() {
            HihokenshaNo 主キー1 = DbT3084DaisanshaKoiTodokedeEntityGenerator.DEFAULT_被保険者番号;
            Decimal 主キー3 = DbT3084DaisanshaKoiTodokedeEntityGenerator.DEFAULT_履歴番号;
            sut.get介護第三者行為届出(主キー1, null, 主キー3);
        }
        ...
        public void 引数の主キー型3にnullを指定した場合_NullPointerExceptionが発生する() {
            HihokenshaNo 主キー1 = DbT3084DaisanshaKoiTodokedeEntityGenerator.DEFAULT_被保険者番号;
            RString 主キー2 = DbT3084DaisanshaKoiTodokedeEntityGenerator.DEFAULT_第三者行為届出管理番号;
            sut.get介護第三者行為届出(主キー1, 主キー2, null);
        }
    ...
    // TODO 主キー型、主キー値については使用するエンティティに合わせて適切に置換してください。
    public static class get介護第三者行為届出一覧 extends DbcTestBase {
    ...
    public static class save介護第三者行為届出 extends DbcTestBase {
