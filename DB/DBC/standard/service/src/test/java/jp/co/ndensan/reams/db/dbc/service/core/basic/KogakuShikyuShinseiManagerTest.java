...
import jp.co.ndensan.reams.db.dbc.entity.basic.DbT3056KogakuShikyuShinseiEntity;
...
public class KogakuShikyuShinseiManagerTest {
    ...
    public static class get高額介護サービス費支給申請 extends DbcTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get主キー1().value(), is(DbT3056KogakuShikyuShinseiEntityGenerator.DEFAULT_被保険者番号.value()));
        }
    }
    ...
    public static class get高額介護サービス費支給申請一覧 extends DbcTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get(0).get主キー1().value(), is(DbT3056KogakuShikyuShinseiEntityGenerator.DEFAULT_被保険者番号.value()));
        }
    }
