...
public class YoboKeikakuJikoSakuseiGokeiManagerTest {
    ...
    public static class get予防給付計画自己作成合計 extends DbcTestBase {
        ...
        public void 引数の主キー型1にnullを指定した場合_NullPointerExceptionが発生する() {
            FlexibleYearMonth 主キー2 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_対象年月;
            int 主キー3 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_履歴番号;
            RString 主キー4 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_居宅サービス区分;
            JigyoshaNo 主キー5 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_サービス提供事業者番号;
        ...
        public void 引数の主キー型2にnullを指定した場合_NullPointerExceptionが発生する() {
            HihokenshaNo 主キー1 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_被保険者番号;
            int 主キー3 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_履歴番号;
            RString 主キー4 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_居宅サービス区分;
            JigyoshaNo 主キー5 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_サービス提供事業者番号;
            ServiceShuruiCode 主キー6 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_サービス種類コード;
...
//            HihokenshaNo 主キー1 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_被保険者番号;
//            FlexibleYearMonth 主キー2 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_対象年月;
//            Decimal 主キー3 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_履歴番号;
//            RString 主キー4 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_居宅サービス区分;
//            JigyoshaNo 主キー5 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_サービス提供事業者番号;
//            ServiceShuruiCode 主キー6 = DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.DEFAULT_サービス種類コード;
//            YoboKeikakuJikoSakuseiGokei result = sut.get予防給付計画自己作成合計(主キー1, 主キー2, 主キー3, 主キー4, 主キー5, 主キー6);
...
//        @Test
//        public void 検索結果が存在する場合() {
//            List<DbT3012NichijoSeikatsuYoboKeikakuJikoSakuseiGokeiEntity> entityList = Arrays.asList(DbT3012YoboKeikakuJikoSakuseiGokeiEntityGenerator.createDbT3012YoboKeikakuJikoSakuseiGokeiEntity());
