...
//            HokenshaNo 主キー1 = DbT3100NijiYoboJigyoTaishoshaEntityGenerator.DEFAULT_証記載保険者番号;
            ...
            assertThat(result.get被保険者番号().value(), is(DbT3100NijiYoboJigyoTaishoshaEntityGenerator.DEFAULT_被保険者番号.value()));
        }
    }
    ...
    public static class get二次予防事業対象者一覧 extends DbcTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get(0).get被保険者番号().value(), is(DbT3100NijiYoboJigyoTaishoshaEntityGenerator.DEFAULT_被保険者番号.value()));
        }
    }
    ...
    public static class save二次予防事業対象者 extends DbcTestBase {
        ...
        public void updateに成功するとtrueが返る() {
            ...
            NijiYoboJigyoTaishosha 二次予防事業対象者 = new NijiYoboJigyoTaishosha(entity);
            二次予防事業対象者 = 二次予防事業対象者.createBuilderForEdit().set受付年月日(new FlexibleDate("2015/01/01")).build();
