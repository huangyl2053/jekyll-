...
public class ShokanShukeiManagerTest {
    ...
    public static class get償還払請求集計 extends DbcTestBase {
        ...
        public void 引数の主キー型1にnullを指定した場合_NullPointerExceptionが発生する() {
            ...
            RString 主キー6 = DbT3053ShokanShukeiEntityGenerator.DEFAULT_順次番号;
            Decimal 主キー7 = DbT3053ShokanShukeiEntityGenerator.DEFAULT_履歴番号;
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get主キー1().value(), is(DbT3053ShokanShukeiEntityGenerator.DEFAULT_被保険者番号.value()));
        }
    }
    ...
    public static class get償還払請求集計一覧 extends DbcTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get(0).get主キー1().value(), is(DbT3053ShokanShukeiEntityGenerator.DEFAULT_被保険者番号.value()));
        }
    }
