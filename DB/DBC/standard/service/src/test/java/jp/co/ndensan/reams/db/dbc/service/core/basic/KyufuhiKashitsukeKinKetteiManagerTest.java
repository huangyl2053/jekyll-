...
public class KyufuhiKashitsukeKinKetteiManagerTest {
    ...
    public static class get給付費貸付金決定 extends DbcTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get被保険者番号().value(), is(DbT3087KyufuhiKashitsukeKinKetteiEntityGenerator.DEFAULT_被保険者番号.value()));
        }
    }
    ...
    public static class get給付費貸付金決定一覧 extends DbcTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get(0).get被保険者番号().value(), is(DbT3087KyufuhiKashitsukeKinKetteiEntityGenerator.DEFAULT_被保険者番号.value()));
        }
    }
    ...
    public static class save給付費貸付金決定 extends DbcTestBase {
        ...
        public void updateに成功するとtrueが返る() {
            ...
            KyufuhiKashitsukeKinKettei 給付費貸付金決定 = new KyufuhiKashitsukeKinKettei(entity);
            給付費貸付金決定 = 給付費貸付金決定.createBuilderForEdit().set償還方法(new RString("任意項目1を変更")).build();
