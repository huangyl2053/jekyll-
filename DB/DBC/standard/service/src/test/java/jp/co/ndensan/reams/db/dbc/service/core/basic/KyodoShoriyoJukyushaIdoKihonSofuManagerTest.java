...
public class KyodoShoriyoJukyushaIdoKihonSofuManagerTest {
    ...
    public static class get共同処理用受給者異動基本送付 extends FdaTestBase {

        // TODO メソッドの引数の数に合わせて、NullPointerExceptionのテストケースを増減してください。
        @Test(expected = NullPointerException.class)
        public void 引数の主キー型1にnullを指定した場合_NullPointerExceptionが発生する() {
            主キー型2 主キー2 = DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntityGenerator.DEFAULT_主キー2;
            sut.get共同処理用受給者異動基本送付(null, 主キー2);
        }

        @Test(expected = NullPointerException.class)
        public void 引数の主キー型2にnullを指定した場合_NullPointerExceptionが発生する() {
            主キー型1 主キー1 = DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntityGenerator.DEFAULT_主キー1;
            sut.get共同処理用受給者異動基本送付(主キー1, null);
        }
        ...
        public void 検索結果がnullの場合() {
            ...
            主キー型1 主キー1 = DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntityGenerator.DEFAULT_主キー1;
            主キー型2 主キー2 = DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntityGenerator.DEFAULT_主キー2;
            KyodoShoriyoJukyushaIdoKihonSofu result = sut.get共同処理用受給者異動基本送付(主キー1, 主キー2);
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get主キー1().value(), is(DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntityGenerator.DEFAULT_主キー1.value()));
        }
    }

    // TODO 主キー型、主キー値については使用するエンティティに合わせて適切に置換してください。
    public static class get共同処理用受給者異動基本送付一覧 extends FdaTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get(0).get主キー1().value(), is(DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntityGenerator.DEFAULT_主キー1.value()));
        }
    }

    public static class save共同処理用受給者異動基本送付 extends XxxTestBase {
