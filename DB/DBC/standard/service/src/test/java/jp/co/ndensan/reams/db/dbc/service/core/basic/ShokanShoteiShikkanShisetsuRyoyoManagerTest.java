...
public class ShokanShoteiShikkanShisetsuRyoyoManagerTest {
    ...
    public static class get償還払請求所定疾患施設療養費等 extends DbcTestBase {
        ...
        public void 引数の主キー型1にnullを指定した場合_NullPointerExceptionが発生する() {
            ...
            RString 主キー6 = DbT3052ShokanShoteiShikkanShisetsuRyoyoEntityGenerator.DEFAULT_明細番号;
            RString 主キー7 = DbT3052ShokanShoteiShikkanShisetsuRyoyoEntityGenerator.DEFAULT_連番;
