...
public class KyufujissekiShokujiHiyoManagerTest {
    ...
    public static class get給付実績食事費用 extends DbcTestBase {

        // TODO メソッドの引数の数に合わせて、NullPointerExceptionのテストケースを増減してください。
        @Test(expected = NullPointerException.class)
        public void 引数の主キー型1にnullを指定した場合_NullPointerExceptionが発生する() {
            NyuryokuShikibetsuNo 主キー2 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_入力識別番号;
            RString 主キー3 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_レコード種別コード;
            HokenshaNo 主キー4 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_証記載保険者番号;
            HihokenshaNo 主キー5 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_被保険者番号;
            FlexibleYearMonth 主キー6 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_サービス提供年月;
            JigyoshaNo 主キー7 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_事業所番号;
            RString 主キー8 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_通し番号;
            sut.get給付実績食事費用(null, 主キー2, 主キー3, 主キー4, 主キー5, 主キー6, 主キー7, 主キー8);
        }

        @Test(expected = NullPointerException.class)
        public void 引数の主キー型2にnullを指定した場合_NullPointerExceptionが発生する() {
            KokanShikibetsuNo 主キー1 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_交換情報識別番号;
            RString 主キー3 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_レコード種別コード;
            HokenshaNo 主キー4 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_証記載保険者番号;
            HihokenshaNo 主キー5 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_被保険者番号;
            FlexibleYearMonth 主キー6 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_サービス提供年月;
            JigyoshaNo 主キー7 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_事業所番号;
            RString 主キー8 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_通し番号;
            sut.get給付実績食事費用(主キー1, null, 主キー3, 主キー4, 主キー5, 主キー6, 主キー7, 主キー8);
        }
        ...
        public void 引数の主キー型3にnullを指定した場合_NullPointerExceptionが発生する() {
            ...
            JigyoshaNo 主キー7 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_事業所番号;
            RString 主キー8 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_通し番号;
            sut.get給付実績食事費用(主キー1, 主キー2, null, 主キー4, 主キー5, 主キー6, 主キー7, 主キー8);
        }
        ...
        public void 引数の主キー型4にnullを指定した場合_NullPointerExceptionが発生する() {
            ...
            JigyoshaNo 主キー7 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_事業所番号;
            RString 主キー8 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_通し番号;
            sut.get給付実績食事費用(主キー1, 主キー2, 主キー3, null, 主キー5, 主キー6, 主キー7, 主キー8);
        }
        ...
        public void 引数の主キー型5にnullを指定した場合_NullPointerExceptionが発生する() {
            ...
            JigyoshaNo 主キー7 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_事業所番号;
            RString 主キー8 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_通し番号;
            sut.get給付実績食事費用(主キー1, 主キー2, 主キー3, 主キー4, null, 主キー6, 主キー7, 主キー8);
        }
        ...
        public void 引数の主キー型6にnullを指定した場合_NullPointerExceptionが発生する() {
            ...
            JigyoshaNo 主キー7 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_事業所番号;
            RString 主キー8 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_通し番号;
            sut.get給付実績食事費用(主キー1, 主キー2, 主キー3, 主キー4, 主キー5, null, 主キー7, 主キー8);
        }
        ...
        public void 引数の主キー型7にnullを指定した場合_NullPointerExceptionが発生する() {
            ...
            FlexibleYearMonth 主キー6 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_サービス提供年月;
            RString 主キー8 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_通し番号;
            sut.get給付実績食事費用(主キー1, 主キー2, 主キー3, 主キー4, 主キー5, 主キー6, null, 主キー8);
        }
        ...
        public void 引数の主キー型8にnullを指定した場合_NullPointerExceptionが発生する() {
            ...
            FlexibleYearMonth 主キー6 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_サービス提供年月;
            JigyoshaNo 主キー7 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_事業所番号;
            sut.get給付実績食事費用(主キー1, 主キー2, 主キー3, 主キー4, 主キー5, 主キー6, 主キー7, null);
        }
        ...
        public void 検索結果がnullの場合() {
            when(dac.selectByKey(any(KokanShikibetsuNo.class), any(NyuryokuShikibetsuNo.class), any(RString.class),
                    ...
                    any(JigyoshaNo.class), any(RString.class))).thenReturn(null);
            KokanShikibetsuNo 主キー1 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_交換情報識別番号;
            NyuryokuShikibetsuNo 主キー2 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_入力識別番号;
            RString 主キー3 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_レコード種別コード;
            HokenshaNo 主キー4 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_証記載保険者番号;
        ...
        public void 検索結果が存在する場合() {
            ...
            when(dac.selectByKey(any(KokanShikibetsuNo.class), any(NyuryokuShikibetsuNo.class), any(RString.class),
                    any(HokenshaNo.class), any(HihokenshaNo.class), any(FlexibleYearMonth.class),
                    any(JigyoshaNo.class), any(RString.class))).thenReturn(entity);
            KokanShikibetsuNo 主キー1 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_交換情報識別番号;
            NyuryokuShikibetsuNo 主キー2 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_入力識別番号;
            RString 主キー3 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_レコード種別コード;
            HokenshaNo 主キー4 = DbT3022KyufujissekiShokujiHiyoEntityGenerator.DEFAULT_証記載保険者番号;
    ...
    // TODO 主キー型、主キー値については使用するエンティティに合わせて適切に置換してください。
    public static class get給付実績食事費用一覧 extends DbcTestBase {
    ...
    public static class save給付実績食事費用 extends DbcTestBase {
