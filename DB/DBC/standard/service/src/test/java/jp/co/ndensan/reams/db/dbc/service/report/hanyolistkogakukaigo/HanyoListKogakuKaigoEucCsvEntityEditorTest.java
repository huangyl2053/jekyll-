...
public class HanyoListKogakuKaigoEucCsvEntityEditorTest {

    public static class convertDayOfWeekTest extends DbcTestBase {

        private static HanyoListKogakuKaigoEucCsvEntityEditor sut;
        private static Method method;

        @BeforeClass
        public static void test() throws NoSuchMethodException {
            sut = new HanyoListKogakuKaigoEucCsvEntityEditor(FlexibleDate.getNowDate());
            method = HanyoListKogakuKaigoEucCsvEntityEditor.class
                    .getDeclaredMethod(
