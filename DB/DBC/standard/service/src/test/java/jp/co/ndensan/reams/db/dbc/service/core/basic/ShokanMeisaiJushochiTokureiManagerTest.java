...
public class ShokanMeisaiJushochiTokureiManagerTest {
    ...
    public static class get償還払請求明細_住所地特例 extends DbcTestBase {
    ...
    // TODO 主キー型、主キー値については使用するエンティティに合わせて適切に置換してください。
    public static class get償還払請求明細_住所地特例一覧 extends DbcTestBase {
    ...
    public static class save償還払請求明細_住所地特例 extends DbcTestBase {
        ...
        public void deleteに成功するとtrueが返る() {
            ...
            entity.initializeMd5();
            ShokanMeisaiJushochiTokurei 償還払請求明細_住所地特例 = new ShokanMeisaiJushochiTokurei(entity);
            償還払請求明細_住所地特例 = 償還払請求明細_住所地特例.deleted();
