...
//            int 主キー4 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_履歴番号;
...
//            ShikibetsuCode 主キー1 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_識別コード;
            FlexibleDate 主キー3 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_受付年月日;
            int 主キー4 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_履歴番号;
            sut.get二次予防チェックリスト判定結果(null, 主キー3, 主キー4);
        }
...
//            ShikibetsuCode 主キー1 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_識別コード;
            HihokenshaNo 主キー2 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_被保険者番号;
            int 主キー4 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_履歴番号;
            sut.get二次予防チェックリスト判定結果(主キー2, null, 主キー4);
        }
...
//            HihokenshaNo 主キー2 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_被保険者番号;
//            FlexibleDate 主キー3 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_受付年月日;
//            sut.get二次予防チェックリスト判定結果(主キー2, 主キー3, null);
//        }
...
//            ShikibetsuCode 主キー1 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_識別コード;
            ...
            FlexibleDate 主キー3 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_受付年月日;
            int 主キー4 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_履歴番号;
            NijiYoboCheckListHanteiKekka result = sut.get二次予防チェックリスト判定結果(主キー2, 主キー3, 主キー4);
...
//            ShikibetsuCode 主キー1 = DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_識別コード;
            ...
            assertThat(result.get被保険者番号().value(), is(DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_被保険者番号.value()));
        }
    }
    ...
    public static class get二次予防チェックリスト判定結果一覧 extends DbcTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get(0).get被保険者番号().value(), is(DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_被保険者番号.value()));
        }
    }
