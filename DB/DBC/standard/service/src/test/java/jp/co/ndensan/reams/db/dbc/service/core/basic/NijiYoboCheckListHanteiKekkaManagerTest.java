...
public class NijiYoboCheckListHanteiKekkaManagerTest {
    ...
    public static class get二次予防チェックリスト判定結果 extends DbcTestBase {
        ...
        public void 引数の主キー型1にnullを指定した場合_NullPointerExceptionが発生する() {
            ...
            sut.get二次予防チェックリスト判定結果(主キー2, 主キー3, 主キー4);
        }
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get受付年月日(), is(DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_受付年月日));
        }
    }
    ...
    public static class get二次予防チェックリスト判定結果一覧 extends DbcTestBase {
        ...
        public void 検索結果が存在する場合() {
            ...
            assertThat(result.get(0).get受付年月日(), is(DbT3103NijiYoboCheckListHanteiKekkaEntityGenerator.DEFAULT_受付年月日));
        }
    }
