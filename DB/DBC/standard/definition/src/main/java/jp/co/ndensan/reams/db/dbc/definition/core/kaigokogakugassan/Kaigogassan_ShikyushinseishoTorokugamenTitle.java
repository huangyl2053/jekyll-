...
public enum Kaigogassan_ShikyushinseishoTorokugamenTitle {
     ...
     */
    高額合算支給申請書登録_変更申請("2", "高額合算支給申請書登録・変更申請", "高額合算支給申請書登録・変更"),
    /**
     * コード:3 名称:高額合算支給申請書登録・取下げ申請 略称:高額合算支給申請書登録・取下げ
     */
    高額合算支給申請書登録_取下げ申請("3", "高額合算支給申請書登録・取下げ申請", "高額合算支給申請書登録・取下げ"),
    /**
     * コード:4 名称:高額合算支給申請書訂正 略称:高額合算支給申請書・訂正
     */
    高額合算支給申請書訂正("4", "高額合算支給申請書訂正", "高額合算支給申請書・訂正"),
    /**
     * コード:5 名称:高額合算支給申請書（写）登録・新規申請 略称:高額合算支給申請書（写）・新規
     */
    高額合算支給申請書_写_登録_新規申請("5", "高額合算支給申請書（写）登録・新規申請", "高額合算支給申請書（写）・新規"),
    /**
     * コード:6 名称:高額合算支給申請書（写）登録・変更申請 略称:高額合算支給申請書（写）・変更
     */
    高額合算支給申請書_写_登録_変更申請("6", "高額合算支給申請書（写）登録・変更申請", "高額合算支給申請書（写）・変更"),
    /**
     * コード:7 名称:高額合算支給申請書（写）登録・取下げ申請 略称:高額合算支給申請書（写）・取下げ
     */
    高額合算支給申請書_写_登録_取下げ申請("7", "高額合算支給申請書（写）登録・取下げ申請", "高額合算支給申請書（写）・取下げ"),
    /**
     * コード:8 名称:高額合算支給申請書（写）訂正 略称:高額合算支給申請書（写）・訂正
     */
    高額合算支給申請書_写_訂正("8", "高額合算支給申請書（写）訂正", "高額合算支給申請書（写）・訂正"),
    /**
     * コード:9 名称:自己負担額証明書交付申請書登録・新規申請 略称:高額合算自己負担額証明書交付申請書登録・新規
     */
    自己負担額証明書交付申請書登録_新規申請("9", "自己負担額証明書交付申請書登録・新規申請", "高額合算自己負担額証明書交付申請書登録・新規"),
    /**
     * コード:10 名称:自己負担額証明書交付申請書登録・変更申請 略称:高額合算自己負担額証明書交付申請書登録・変更
     */
    自己負担額証明書交付申請書登録_変更申請("10", "自己負担額証明書交付申請書登録・変更申請", "高額合算自己負担額証明書交付申請書登録・変更"),
    /**
     * コード:11 名称:自己負担額証明書交付申請書登録・取下げ申請 略称:高額合算自己負担額証明書交付申請書登録・取下げ
     */
    自己負担額証明書交付申請書登録_取下げ申請("11", "自己負担額証明書交付申請書登録・取下げ申請", "高額合算自己負担額証明書交付申請書登録・取下げ"),
    /**
     * コード:12 名称:自己負担額証明書交付申請書訂正 略称:高額合算自己負担額証明書交付申請書登録・訂正
     */
    自己負担額証明書交付申請書訂正("12", "自己負担額証明書交付申請書訂正", "高額合算自己負担額証明書交付申請書登録・訂正");
