 ...
 */
package jp.co.ndensan.reams.db.dbc.definition.mybatisprm.kyotakukeika.kyotakukeikakujikosakusei;
...
public class KyotakuKeikakuJikoSakuseiMapperParameter {
     ...
     * @param 対象年月 対象年月
     * @param 履歴番号 履歴番号
     * @return 居宅給付計画自己作成検索パラメータ
     */
    public static KyotakuKeikakuJikoSakuseiMapperParameter createSelectByKeyParam(
            HihokenshaNo 被保険者番号,
            FlexibleYearMonth 対象年月,
            Decimal 履歴番号) {
        return new KyotakuKeikakuJikoSakuseiMapperParameter(被保険者番号, 対象年月, 履歴番号, true, true, true);
    }
}
