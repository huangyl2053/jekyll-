 ...
 */
package jp.co.ndensan.reams.db.dbc.definition.mybatisprm.kyotakukeika.yobokeikakujikosakuseimeisai;
...
public class YoboKeikakuJikoSakuseiMeisaiMapperParameter {
     ...
     */
    private YoboKeikakuJikoSakuseiMeisaiMapperParameter(
     ...
     * @param サービス種類コード サービス種類コード
     * @param サービス項目コード サービス項目コード
     * @return 予防給付計画自己作成明細検索パラメータ
     */
    public static YoboKeikakuJikoSakuseiMeisaiMapperParameter createSelectByKeyParam(
            HihokenshaNo 被保険者番号,
        ...
        return new YoboKeikakuJikoSakuseiMeisaiMapperParameter(被保険者番号,
                対象年月, 履歴番号, 居宅サービス区分,
                サービス提供事業者番号, サービス種類コード,
