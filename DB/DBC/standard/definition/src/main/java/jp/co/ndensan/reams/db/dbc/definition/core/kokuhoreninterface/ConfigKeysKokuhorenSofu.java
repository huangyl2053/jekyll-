...
public enum ConfigKeysKokuhorenSofu {
    ...
    /**
     * コード:37K2 名称:高額合算補正済自己負担額情報（国保分） 略称:高額合算補正済自己負担額情報（国保分） 表示順:10 スケジュール設定有無:true
     */
    高額合算補正済自己負担額情報_国保分("37K2", "高額合算補正済自己負担額情報（国保分）", "高額合算補正済自己負担額情報（国保分）", "10", true),
    /**
     * コード:37K1 名称:高額合算補正済自己負担額情報（後期分） 略称:高額合算補正済自己負担額情報（後期分） 表示順:11 スケジュール設定有無:true
     */
    高額合算補正済自己負担額情報_後期分("37K1", "高額合算補正済自己負担額情報（後期分）", "高額合算補正済自己負担額情報（後期分）", "11", true),
    /**
    ...
    /**
     * コード:5Ｈ1 名称:総合事業分サービスコード異動連絡票情報 略称:受給者突合情報 表示順:0 スケジュール設定有無:false
     */
    総合事業分サービスコード異動連絡票情報("5Ｈ1", "総合事業分サービスコード異動連絡票情報", "総合事業分サービスコード異動連絡票情報", "0", false);
