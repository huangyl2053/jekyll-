 ...
 */
public enum ConfigKeysSogoJigyoShikakuShogohyo implements IConfigKeysKokuhorenTorikomi {

    /**
     * コード:無し 名称:国保連取込_総合事業費資格照合表情報 略称:定義なし
     */
    国保連取込_総合事業費資格照合表情報("国保連取込_総合事業費資格照合表情報"),
    /**
     * コード:無し 名称:国保連取込_総合事業費資格照合表情報_バッチID 略称:定義なし
     */
    国保連取込_総合事業費資格照合表情報_バッチID("国保連取込_総合事業費資格照合表情報_バッチID"),
    /**
     * コード:無し 名称:国保連取込_総合事業費資格照合表情報_一覧表示順 略称:定義なし
     */
    国保連取込_総合事業費資格照合表情報_一覧表示順("国保連取込_総合事業費資格照合表情報_一覧表示順"),
    /**
     ...
     */
    国保連取込_総合事業費資格照合表情報_再処理不可区分("国保連取込_総合事業費資格照合表情報_再処理不可区分"),
    /**
     * コード:無し 名称:国保連取込_総合事業費資格照合表情報_処理サイクル区分 略称:定義なし
     */
    国保連取込_総合事業費資格照合表情報_処理サイクル区分("国保連取込_総合事業費資格照合表情報_処理サイクル区分"),
    /**
     * コード:無し 名称:国保連取込_総合事業費資格照合表情報_処理月 略称:定義なし
     */
    国保連取込_総合事業費資格照合表情報_処理月("国保連取込_総合事業費資格照合表情報_処理月"),
    /**
     * コード:無し 名称:国保連取込_総合事業費資格照合表情報_処理名称 略称:定義なし
     */
    国保連取込_総合事業費資格照合表情報_処理名称("国保連取込_総合事業費資格照合表情報_処理名称"),
    /**
     * コード:無し 名称:国保連取込_総合事業費資格照合表情報_排他チェック有り区分 略称:定義なし
     */
    国保連取込_総合事業費資格照合表情報_排他チェック有り区分("国保連取込_総合事業費資格照合表情報_排他チェック有り区分"),
    /**
     * コード:無し 名称:国保連取込_総合事業費資格照合表情報_有効区分 略称:定義なし
     */
    国保連取込_総合事業費資格照合表情報_有効区分("国保連取込_総合事業費資格照合表情報_有効区分");

    private final RString fullName;

    private ConfigKeysSogoJigyoShikakuShogohyo(String fullname) {
    ...
    public Enum getバッチID() {
        return 国保連取込_総合事業費資格照合表情報_バッチID;
    }

    @Override
    public Enum get一覧表示順() {
        return 国保連取込_総合事業費資格照合表情報_一覧表示順;
    }

    @Override
    public Enum get交換情報識別番号() {
        return 国保連取込_総合事業費資格照合表情報_交換情報識別番号;
    }

    @Override
    public Enum get再処理不可区分() {
        return 国保連取込_総合事業費資格照合表情報_再処理不可区分;
    }

    @Override
    public Enum get処理サイクル区分() {
        return 国保連取込_総合事業費資格照合表情報_処理サイクル区分;
    }

    @Override
    public Enum get処理月() {
        return 国保連取込_総合事業費資格照合表情報_処理月;
    }

    @Override
    public Enum get処理名称() {
        return 国保連取込_総合事業費資格照合表情報_処理名称;
    }

    @Override
    public Enum get排他チェック有り区分() {
        return 国保連取込_総合事業費資格照合表情報_排他チェック有り区分;
    }

    @Override
    public Enum get有効区分() {
        return 国保連取込_総合事業費資格照合表情報_有効区分;
    }

    /**
     * 国保連取込_総合事業費資格照合表情報
     *
     * @return 国保連取込_総合事業費資格照合表情報
     */
    ...
    /**
     * 総合事業費資格照合表情報コンフィグキーの名称と一致する内容を探します。
     *
     * @param fullName 総合事業費資格照合表情報コンフィグキーの名称
     * @return {@code code} に対応する総合事業費資格照合表情報コンフィグキー
     */
    public static ConfigKeysSogoJigyoShikakuShogohyo toValue(RString fullName) {
