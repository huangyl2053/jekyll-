 ...
 */
package jp.co.ndensan.reams.db.dbc.definition.processprm.hanyolistkogakugassanshinseishojoho;
...
/**
 * バッチ設計_DBCBT23014_汎用リスト出力(高額合算申請書情報)ProcessParameter
 *
...
public class HanyoListKogakuGassanShinseishoJohoProcessParameter implements IBatchProcessParameter {
     ...
     * コンストラクタです
     */
    public HanyoListKogakuGassanShinseishoJohoProcessParameter() {
    }
     ...
     * @return mybatisパラメータ
     */
    public HanyoListKogakuGassanShinseishoJohoMybatisParameter toMybatisParam() {
        return new HanyoListKogakuGassanShinseishoJohoMybatisParameter(
                searchkey,
                list,
                抽出区分,
                申請状況区分,
