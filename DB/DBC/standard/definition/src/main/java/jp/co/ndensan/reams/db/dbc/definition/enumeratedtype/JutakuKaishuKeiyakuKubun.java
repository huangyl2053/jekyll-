...
public enum JutakuKaishuKeiyakuKubun {
    ...
    private JutakuKaishuKeiyakuKubun(boolean 契約有無Flag) {
     ...
     * @return 契約区分（列挙型）
     */
    public static JutakuKaishuKeiyakuKubun toValue(boolean is契約有り) {
        return is契約有り ? JutakuKaishuKeiyakuKubun.契約有り : JutakuKaishuKeiyakuKubun.契約無し;
    }
}
