...
/**
 * バッチ設計_DBC110065_基準収入額適用申請書_異動分作成のプロセスパラメータです。
 *
...
@Getter
@Setter
public class DBC190030ProcessParameter implements IBatchProcessParameter {
     ...
     * @param 市町村名 RString
     */
    public DBC190030ProcessParameter(RString 抽出条件,
            RString 抽出対象,
            FlexibleYear 処理年度,
            HihokenshaNo 被保険者番号,
     ...
     */
    public DBC190030MyBatisParameter toDBC190030MyBatisParameter() {
        return new DBC190030MyBatisParameter(抽出条件,
                抽出対象,
                処理年度,
                被保険者番号,
                世帯員把握基準日,
    ...
    public DBC190030MyBatisParameter toDBC190030MyBatisParameter(RString 出力順) {
        DBC190030MyBatisParameter param = new DBC190030MyBatisParameter(抽出条件,
                抽出対象,
                処理年度,
                被保険者番号,
                世帯員把握基準日,
