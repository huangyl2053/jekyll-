...
public enum TokeiServiceShurui {
     ...
     * 統計表印字名称3:EMPTY
     */
    _介護予防_訪問介護("01", "(介護予防)訪問介護", 0, "（介護予防）", "　訪問介護", ""),
    /**
     * コード:02 名称:(介護予防)訪問入浴介護 略称:定義なし Y軸:1
     */
    _介護予防_訪問入浴介護("02", "(介護予防)訪問入浴介護", 1, "（介護予防）", "訪問入力介護", ""),
    /**
     * コード:03 名称:(介護予防)訪問看護 略称:定義なし Y軸:2
     */
    _介護予防_訪問看護("03", "(介護予防)訪問看護", 2, "（介護予防）", "　訪問看護", ""),
    /**
     * コード:04 名称:(介護予防)訪問リハビリ 略称:定義なし Y軸:3
     */
    _介護予防_訪問リハビリ("04", "(介護予防)訪問リハビリ", 3, "（介護予防）", "訪問リバビリ", ""),
    /**
     * コード:05 名称:(介護予防)通所介護 略称:定義なし Y軸:4
     */
    _介護予防_通所介護("05", "(介護予防)通所介護", 4, "（介護予防）", "　通所介護", ""),
    /**
     * コード:06 名称:(介護予防)通所リハビリ 略称:定義なし Y軸:5
     */
    _介護予防_通所リハビリ("06", "(介護予防)通所リハビリ", 5, "（介護予防）", "通所リハビリ", ""),
    /**
     * コード:07 名称:(介護予防)福祉用具貸与 略称:定義なし Y軸:6
     */
    _介護予防_福祉用具貸与("07", "(介護予防)福祉用具貸与", 6, "（介護予防）", "福祉用具貸与", ""),
    /**
     * コード:08 名称:(介護予防)短期入所生活介護 略称:定義なし Y軸:7
     */
    _介護予防_短期入所生活介護("08", "(介護予防)短期入所生活介護", 7, "（介護予防）", "　短期入所", "　生活介護"),
    /**
     * コード:09 名称:(介護予防)短期入所老健施設 略称:定義なし Y軸:8
     */
    _介護予防_短期入所老健施設("09", "(介護予防)短期入所老健施設", 8, "（介護予防）", "　短期入所", "　老健施設"),
    /**
     * コード:10 名称:(介護予防)短期入所医療施設 略称:定義なし Y軸:9
     */
    _介護予防_短期入所医療施設("10", "(介護予防)短期入所医療施設", 9, "（介護予防）", "　短期入所", "　医療施設"),
    /**
     * コード:11 名称:(介護予防)居宅療養管理指導 略称:定義なし Y軸:10
     */
    _介護予防_居宅療養管理指導("11", "(介護予防)居宅療養管理指導", 10, "（介護予防）", "　居宅療養", "　管理指導"),
    /**
     * コード:12 名称:(介護予防)特定施設生活介護（短期以外） 略称:定義なし Y軸:11
     */
    _介護予防_特定施設生活介護_短期以外("12", "(介護予防)特定施設生活介護（短期以外）", 11, "（介護予防）", "特定施設生活介護", "（短期以外）"),
    /**
     * コード:13 名称:(介護予防)特定施設生活介護（短期） 略称:定義なし Y軸:12
     */
    _介護予防_特定施設生活介護_短期("13", "(介護予防)特定施設生活介護（短期）", 12, "（介護予防）", "特定施設生活介護", "（短期）"),
    /**
     ...
     */
    _介護予防_認知症対応型通所介護("20", "(介護予防)認知症対応型通所介護", 19, "（介護予防）", "認知症対応型", "通所介護"),
    /**
     * コード:21 名称:(介護予防)小規模多機能型居宅介護（短期以外） 略称:定義なし Y軸:20
     */
    _介護予防_小規模多機能型居宅介護_短期以外("21", "(介護予防)小規模多機能型居宅介護（短期以外）", 20, "（介護予防）", "小規模多機能型居", "宅介護・短期以外"),
    /**
     * コード:22 名称:(介護予防)小規模多機能型居宅介護（短期） 略称:定義なし Y軸:21
     */
    _介護予防_小規模多機能型居宅介護_短期("22", "(介護予防)小規模多機能型居宅介護（短期）", 21, "（介護予防）", "小規模多機能型居", "宅介護・短期"),
    /**
     * コード:23 名称:(介護予防)認知症対応型共同生活 略称:定義なし Y軸:22
     */
    _介護予防_認知症対応型共同生活("23", "(介護予防)認知症対応型共同生活", 22, "（介護予防）", "認知症対応型", "共同生活"),
    /**
     * コード:24 名称:地域密着型特定施設入居者生活（短期以外） 略称:定義なし Y軸:23
     */
    地域密着型特定施設入居者生活_短期以外("24", "地域密着型特定施設入居者生活（短期以外）", 23, "地域密着型", "特定施設入居者", "生活・短期以外"),
    /**
     * コード:25 名称:地域密着型特定施設入居者生活（短期） 略称:定義なし Y軸:24
     */
    地域密着型特定施設入居者生活_短期("25", "地域密着型特定施設入居者生活（短期）", 24, "地域密着型", "特定施設入居者", "生活・短期"),
    /**
     * コード:26 名称:(介護予防)認知症対応型共同生活(短期) 略称:定義なし Y軸:25
     */
    _介護予防_認知症対応型共同生活_短期("26", "(介護予防)認知症対応型共同生活(短期)", 25, "（介護予防）", "認知症対応型", "共同生活・短期"),
    /**
     * コード:27 名称:地域密着型介護老人福祉施設 略称:定義なし Y軸:26
     */
    地域密着型介護老人福祉施設("27", "地域密着型介護老人福祉施設", 26, "地域密着型", "介護老人", "福祉施設"),
    /**
     ...
     */
    地域密着型通所介護("31", "地域密着型通所介護", 30, "地域密着型", "通所介護", ""),
    /**
     * コード:32 名称:地域密着型施設サービス計（19-31の合計） 略称:定義なし Y軸:1
     */
    地域密着型施設サービス計_19_31の合計("32", "地域密着型施設サービス計（19-31の合計）", 31, "地域密着型", "施設サービス計", "１９－３１の合計"),
    /**
     ...
     */
    _介護予防_特定福祉用具販売費("34", "(介護予防)特定福祉用具販売費", 33, "（介護予防）", "特定福祉用具", "販売費"),
    /**
     * コード:35 名称:(介護予防)住宅改修費 略称:定義なし Y軸:33
     */
    _介護予防_住宅改修費("35", "(介護予防)住宅改修費", 34, "（介護予防）", "住宅改修費", ""),
    /**
