...
public enum ConfigKeysKogakugassanJikofutangakuKakunin implements IConfigKeysKokuhorenTorikomi {
     ...
     */
    国保連取込_高額合算自己負担額確認情報("国保連取込_高額合算自己負担額確認情報"),
    /**
     * コード:無し 名称:国保連取込_高額合算自己負担額確認情報_バッチID 略称:定義なし
     */
    国保連取込_高額合算自己負担額確認情報_バッチID("国保連取込_高額合算自己負担額確認情報_バッチID"),
    /**
     * コード:無し 名称:国保連取込_高額合算自己負担額確認情報_一覧表示順 略称:定義なし
     */
    国保連取込_高額合算自己負担額確認情報_一覧表示順("国保連取込_高額合算自己負担額確認情報_一覧表示順"),
    /**
     ...
     */
    国保連取込_高額合算自己負担額確認情報_再処理不可区分("国保連取込_高額合算自己負担額確認情報_再処理不可区分"),
    /**
     * コード:無し 名称:国保連取込_高額合算自己負担額確認情報_処理サイクル区分 略称:定義なし
     */
    国保連取込_高額合算自己負担額確認情報_処理サイクル区分("国保連取込_高額合算自己負担額確認情報_処理サイクル区分"),
    /**
     * コード:無し 名称:国保連取込_高額合算自己負担額確認情報_処理月 略称:定義なし
     */
    国保連取込_高額合算自己負担額確認情報_処理月("国保連取込_高額合算自己負担額確認情報_処理月"),
    /**
     * コード:無し 名称:国保連取込_高額合算自己負担額確認情報_処理名称 略称:定義なし
     */
    国保連取込_高額合算自己負担額確認情報_処理名称("国保連取込_高額合算自己負担額確認情報_処理名称"),
    /**
     * コード:無し 名称:国保連取込_高額合算自己負担額確認情報_排他チェック有り区分 略称:定義なし
     */
    国保連取込_高額合算自己負担額確認情報_排他チェック有り区分("国保連取込_高額合算自己負担額確認情報_排他チェック有り区分"),
    /**
     * コード:無し 名称:国保連取込_高額合算自己負担額確認情報_有効区分 略称:定義なし
     */
    国保連取込_高額合算自己負担額確認情報_有効区分("国保連取込_高額合算自己負担額確認情報_有効区分");

    private final RString fullName;

    private ConfigKeysKogakugassanJikofutangakuKakunin(String fullname) {
    ...
    public Enum getバッチID() {
        return 国保連取込_高額合算自己負担額確認情報_バッチID;
    }

    @Override
    public Enum get一覧表示順() {
        return 国保連取込_高額合算自己負担額確認情報_一覧表示順;
    }

    @Override
    public Enum get交換情報識別番号() {
        return 国保連取込_高額合算自己負担額確認情報_交換情報識別番号;
    }

    @Override
    public Enum get再処理不可区分() {
        return 国保連取込_高額合算自己負担額確認情報_再処理不可区分;
    }

    @Override
    public Enum get処理サイクル区分() {
        return 国保連取込_高額合算自己負担額確認情報_処理サイクル区分;
    }

    @Override
    public Enum get処理月() {
        return 国保連取込_高額合算自己負担額確認情報_処理月;
    }

    @Override
    public Enum get処理名称() {
        return 国保連取込_高額合算自己負担額確認情報_処理名称;
    }

    @Override
    public Enum get排他チェック有り区分() {
        return 国保連取込_高額合算自己負担額確認情報_排他チェック有り区分;
    }
    ...
    /**
     * 高額合算自己負担額確認情報コンフィグキーの名称と一致する内容を探します。
     *
     * @param fullname 高額合算自己負担額確認情報コンフィグキーの名称
     * @return {@code code} に対応する高額合算自己負担額確認情報コンフィグキー
     */
    public static ConfigKeysKogakugassanJikofutangakuKakunin toValue(RString fullname) {
