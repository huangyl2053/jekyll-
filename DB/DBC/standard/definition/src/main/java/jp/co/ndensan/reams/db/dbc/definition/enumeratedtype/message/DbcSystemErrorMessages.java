 ...
 */
package jp.co.ndensan.reams.db.dbc.definition.enumeratedtype.message;
...
/**
 * DBCのシステムエラーメッセージ定義列挙型です。
 *
 * @author N9606 漢那 憲作
 */
public enum DbcSystemErrorMessages {
    ...
    private DbcSystemErrorMessages(int no, String message) {
