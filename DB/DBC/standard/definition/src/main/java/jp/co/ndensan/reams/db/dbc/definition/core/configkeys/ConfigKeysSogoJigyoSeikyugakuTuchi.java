...
public enum ConfigKeysSogoJigyoSeikyugakuTuchi implements IConfigKeysKokuhorenTorikomi {
     ...
     */
    国保連取込_総合事業費請求額通知書情報("国保連取込_総合事業費請求額通知書情報"),
    /**
     * コード:無し 名称:国保連取込_総合事業費請求額通知書情報_バッチID 略称:定義なし
     */
    国保連取込_総合事業費請求額通知書情報_バッチID("国保連取込_総合事業費請求額通知書情報_バッチID"),
    /**
     * コード:無し 名称:国保連取込_総合事業費請求額通知書情報_一覧表示順 略称:定義なし
     */
    国保連取込_総合事業費請求額通知書情報_一覧表示順("国保連取込_総合事業費請求額通知書情報_一覧表示順"),
    /**
     * コード:無し 名称:国保連取込_総合事業費請求額通知書情報_交換情報識別番号 略称:定義なし
     */
    国保連取込_総合事業費請求額通知書情報_交換情報識別番号("国保連取込_総合事業費請求額通知書情報_交換情報識別番号"),
    /**
     * コード:無し 名称:国保連取込_総合事業費請求額通知書情報_再処理不可区分 略称:定義なし
     */
    国保連取込_総合事業費請求額通知書情報_再処理不可区分("国保連取込_総合事業費請求額通知書情報_再処理不可区分"),
    /**
     * コード:無し 名称:国保連取込_総合事業費請求額通知書情報_処理サイクル区分 略称:定義なし
     */
    国保連取込_総合事業費請求額通知書情報_処理サイクル区分("国保連取込_総合事業費請求額通知書情報_処理サイクル区分"),
    /**
     * コード:無し 名称:国保連取込_総合事業費請求額通知書情報_処理月 略称:定義なし
     */
    国保連取込_総合事業費請求額通知書情報_処理月("国保連取込_総合事業費請求額通知書情報_処理月"),
    /**
     * コード:無し 名称:国保連取込_総合事業費請求額通知書情報_処理名称 略称:定義なし
     */
    国保連取込_総合事業費請求額通知書情報_処理名称("国保連取込_総合事業費請求額通知書情報_処理名称"),
    /**
     * コード:無し 名称:国保連取込_総合事業費請求額通知書情報_排他チェック有り区分 略称:定義なし
     */
    国保連取込_総合事業費請求額通知書情報_排他チェック有り区分("国保連取込_総合事業費請求額通知書情報_排他チェック有り区分"),
    /**
     * コード:無し 名称:国保連取込_総合事業費請求額通知書情報_有効区分 略称:定義なし
     */
    国保連取込_総合事業費請求額通知書情報_有効区分("国保連取込_総合事業費請求額通知書情報_有効区分");

    private final RString fullName;

    private ConfigKeysSogoJigyoSeikyugakuTuchi(String fullname) {
    ...
    /**
     * 総合事業費請求額通知書情報コンフィグキーの名称と一致する内容を探します。
     *
     * @param fullname 総合事業費請求額通知書情報コンフィグキーの名称
     * @return {@code code} に対応する総合事業費請求額通知書情報コンフィグキー
     */
    public static ConfigKeysSogoJigyoSeikyugakuTuchi toValue(RString fullname) {
