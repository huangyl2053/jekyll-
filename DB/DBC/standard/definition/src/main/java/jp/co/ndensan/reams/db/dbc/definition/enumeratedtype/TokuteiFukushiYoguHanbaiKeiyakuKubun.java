...
public enum TokuteiFukushiYoguHanbaiKeiyakuKubun {
    ...
    private TokuteiFukushiYoguHanbaiKeiyakuKubun(boolean 契約有無Flag) {
     ...
     * @return 契約区分（列挙型）
     */
    public static TokuteiFukushiYoguHanbaiKeiyakuKubun toValue(boolean is契約有り) {
        return is契約有り ? TokuteiFukushiYoguHanbaiKeiyakuKubun.契約有り : TokuteiFukushiYoguHanbaiKeiyakuKubun.契約無し;
    }
}
