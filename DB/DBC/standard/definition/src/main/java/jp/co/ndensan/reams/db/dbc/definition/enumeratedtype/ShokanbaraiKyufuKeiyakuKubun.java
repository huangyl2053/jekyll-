...
public enum ShokanbaraiKyufuKeiyakuKubun {
    ...
    private ShokanbaraiKyufuKeiyakuKubun(boolean 契約有無Flag) {
     ...
     * @return 契約区分（列挙型）
     */
    public static ShokanbaraiKyufuKeiyakuKubun toValue(boolean is契約有り) {
        return is契約有り ? ShokanbaraiKyufuKeiyakuKubun.契約有り : ShokanbaraiKyufuKeiyakuKubun.契約無し;
    }
}
