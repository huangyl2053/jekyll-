...
public class ShokanShoteiShikkanShisetsuRyoyoEntity {
    ...
    protected ShokanShoteiShikkanShisetsuRyoyoEntity(RString 連番, RString 緊急時傷病名1, RString 緊急時傷病名2,
            ...
            int 放射線治療単位数, RString 摘要, int 緊急時施設療養費合計単位数, RString 所定疾患施設療養費傷病名1,
     ...
     * @return
     */
    public static ShokanShoteiShikkanShisetsuRyoyoEntity createSelectByKeyParam(RString 連番, RString 緊急時傷病名1,
            ...
            int 緊急時治療管理単位数, Decimal 緊急時治療管理日数,
            int 緊急時治療管理小計, int リハビリテーション単位数, int 処置単位数, int 手術単位数, int 麻酔単位数,
            int 放射線治療単位数, RString 摘要, int 緊急時施設療養費合計単位数, RString 所定疾患施設療養費傷病名1,
            RString 所定疾患施設療養費傷病名2, RString 所定疾患施設療養費傷病名3,
            FlexibleDate 所定疾患施設療養費開始年月日1, FlexibleDate 所定疾患施設療養費開始年月日2,
        ...
        return new ShokanShoteiShikkanShisetsuRyoyoEntity(連番, 緊急時傷病名1, 緊急時傷病名2, 緊急時傷病名3,
                緊急時治療開始年月日1, 緊急時治療開始年月日2,
                緊急時治療開始年月日3, 往診日数, 往診医療機関名, 通院日数, 通院医療機関名, 緊急時治療管理単位数,
                緊急時治療管理日数, 緊急時治療管理小計, リハビリテーション単位数, 処置単位数, 手術単位数, 麻酔単位数,
                放射線治療単位数, 摘要, 緊急時施設療養費合計単位数, 所定疾患施設療養費傷病名1,
                所定疾患施設療養費傷病名2, 所定疾患施設療養費傷病名3, 所定疾患施設療養費開始年月日1,
                所定疾患施設療養費開始年月日2, 所定疾患施設療養費開始年月日3, 所定疾患施設療養費単位数,
                所定疾患施設療養費日数, 所定疾患施設療養費小計, 状態);
    }
}
