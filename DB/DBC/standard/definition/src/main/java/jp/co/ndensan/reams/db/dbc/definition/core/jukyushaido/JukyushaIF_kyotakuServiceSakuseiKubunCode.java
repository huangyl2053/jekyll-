...
/**
 *
 * @reamsid_L DBC-2100-010 x_youyj
 */
public enum JukyushaIF_kyotakuServiceSakuseiKubunCode {
    ...
    自己作成("2", "自己作成"),
    /**
     * コード:3 名称:介護予防支援事業所作成 表示名称:介護予防支援事業所作成
     */
    介護予防支援事業所作成("3", "介護予防支援事業所作成");

    private final RString code;
    private final RString fullName;

    private JukyushaIF_kyotakuServiceSakuseiKubunCode(String code, String fullname) {
     ...
     */
    public static JukyushaIF_kyotakuServiceSakuseiKubunCode toValue(RString code) {

        for (JukyushaIF_kyotakuServiceSakuseiKubunCode jukyushaIF : JukyushaIF_kyotakuServiceSakuseiKubunCode.values()) {
