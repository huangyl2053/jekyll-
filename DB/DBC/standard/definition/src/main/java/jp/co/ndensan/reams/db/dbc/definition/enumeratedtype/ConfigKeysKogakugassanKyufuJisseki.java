...
/**
 * 741 高額合算給付実績情報のコンフィグ名を表す列挙型です。
 *
 * @author N2810 久保 里史
 */
public enum ConfigKeysKogakugassanKyufuJisseki implements IConfigKeysKokuhorenTorikomi {

    国保連取込_高額合算給付実績情報_バッチID,
    国保連取込_高額合算給付実績情報_一覧表示順,
    国保連取込_高額合算給付実績情報_交換情報識別番号,
    国保連取込_高額合算給付実績情報_再処理不可区分,
    国保連取込_高額合算給付実績情報_処理サイクル区分,
    国保連取込_高額合算給付実績情報_処理月,
    国保連取込_高額合算給付実績情報_処理名称,
    国保連取込_高額合算給付実績情報_排他チェック有り区分,
    国保連取込_高額合算給付実績情報_有効区分;
