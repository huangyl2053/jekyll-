...
/**
 * 533 _受給者台帳情報一覧のコンフィグ名を表す列挙型です。
 *
 * @author N2810 久保 里史
 */
public enum ConfigKeysJukyushaDaichoJohoIchiran implements IConfigKeysKokuhorenTorikomi {

    国保連取込_受給者台帳情報一覧_バッチID,
    国保連取込_受給者台帳情報一覧_一覧表示順,
    国保連取込_受給者台帳情報一覧_交換情報識別番号,
    国保連取込_受給者台帳情報一覧_再処理不可区分,
    国保連取込_受給者台帳情報一覧_処理サイクル区分,
    国保連取込_受給者台帳情報一覧_処理月,
    国保連取込_受給者台帳情報一覧_処理名称,
    国保連取込_受給者台帳情報一覧_排他チェック有り区分,
    国保連取込_受給者台帳情報一覧_有効区分;
