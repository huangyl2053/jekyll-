...
public enum RiyojokyoTokeihyo_EditPattern {
    ...
    介護予防_訪問介護("01", "介護予防_訪問介護",
            ...
            true, false, true, true, false, false, true, false, true, "利用実人員", "回数", "単位数", "費用総額", "介護給付費", "", "社福軽減額"),
    /**
    ...
    介護予防_訪問入浴介護("02", "介護予防_訪問入浴介護",
            RiyojokyoTokeihyo_KaisuShukeiPattern.日数回数_内訳なし_合計加算あり,
            true, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.計算,
            true, false, false, true, false, false, true, false, false, "利用実人員", "回数", "単位数", "費用総額", "介護給付費", "", ""),
    /**
    ...
    介護予防_福祉用具貸与("07", "介護予防_福祉用具貸与",
            RiyojokyoTokeihyo_KaisuShukeiPattern.日数回数_内訳なし_合計加算あり,
            true, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.計算,
            true, false, false, true, false, false, true, false, false, "利用実人員", "件数", "単位数", "費用総額", "介護給付費", "", ""),
    /**
    ...
    介護予防_短期入所生活介護("08", "介護予防_短期入所生活介護",
            ...
            true, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.計算,
            true, true, true, true, false, false, true, true, true, "利用実人員", "日数", "単位数", "費用総額", "介護給付費", "特定入所費", "社福軽減額"),
    /**
    ...
    介護予防_短期入所老健施設("09", "介護予防_短期入所老健施設",
            RiyojokyoTokeihyo_KaisuShukeiPattern.短期入所実日数_内訳なし_合計加算あり,
            true, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.計算,
            true, true, false, true, false, false, true, true, false, "利用実人員", "日数", "単位数", "費用総額", "介護給付費", "特定入所費", ""),
    /**
    ...
    介護予防_特定施設生活介護_短期以外("12", "介護予防_特定施設生活介護_短期以外",
            ...
            true, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.計算,
            true, false, false, true, false, false, true, false, false, "利用実人員", "日数（外泊）", "単位数 ", "費用総額", "介護給付費", "", ""),
    /**
    ...
    居宅サービス計("14", "居宅サービス計", RiyojokyoTokeihyo_KaisuShukeiPattern.加算対象外,
            ...
            false, false, false, false, false, false, false, false, false, "利用実人員", "", "単位数", "費用総額", "介護給付費", "特定入所費", "社福軽減額"),
    /**
    ...
    介護福祉施設("15", "介護福祉施設",
            RiyojokyoTokeihyo_KaisuShukeiPattern.短期入所実日数_内訳あり_合計加算あり,
            true, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.計算,
            true, true, true, false, true, false, true, true, true, "利用実人員", "日数（外泊）", "単位数", "費用総額", "介護給付費", "特定入所費", "社福軽減額"),
    /**
    ...
    介護老健施設("16", "介護老健施設",
            RiyojokyoTokeihyo_KaisuShukeiPattern.短期入所実日数_内訳あり_合計加算あり,
            true, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.計算,
            true, true, false, false, true, false, true, true, false, "利用実人員", "日数（外泊）", "単位数", "費用総額", "介護給付費", "特定入所費", ""),
    /**
    ...
    施設サービス計("18", "施設サービス計",
            ...
            false, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.加算対象外,
            false, false, false, false, false, false, false, false, false, "利用実人員", "日数（外泊）", "単位数", "費用総額", "介護給付費", "特定入所費", "社福軽減額"),
    /**
    ...
    夜間対応型訪問介護("19", "夜間対応型訪問介護",
            ...
            true, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.計算,
            true, false, true, false, false, true, true, false, true, "利用実人員", "回数", "単位数", "費用総額", "介護給付費", "", "社福軽減額"),
    /**
    ...
    介護予防_認知症対応型共同生活("23", "介護予防_認知症対応型共同生活",
            ...
            true, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.計算,
            true, false, false, false, false, true, true, false, false, "利用実人員", "日数（外泊）", "単位数", "費用総額", "介護給付費", "", ""),
    /**
    ...
    介護予防_認知症対応型共同生活_短期("26", "介護予防_認知症対応型共同生活_短期",
            ...
            true, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.計算,
            true, false, false, false, false, true, true, false, false, "利用実人員", "日数", "単位数", "費用総額", "介護給付費", "", ""),
    /**
    ...
    地域密着型介護老人福祉施設("27", "地域密着型介護老人福祉施設",
            RiyojokyoTokeihyo_KaisuShukeiPattern.短期入所実日数_内訳あり_合計加算なし,
            true, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.計算,
            true, true, true, false, false, true, true, true, true, "利用実人員", "日数（外泊）", "単位数", "費用総額", "介護給付費", "特定入所費", "社福軽減額"),
    /**
    ...
    居宅介護支援介護要望支援("33", "居宅介護支援介護要望支援",
            ...
            true, false, false, false, false, false, true, false, false, "利用実人員", "回数（件数）", "単位数", "費用総額", "介護給付費", "", ""),
    /**
    ...
    介護予防_特定福祉用具販売費("34", "介護予防_特定福祉用具販売費",
            ...
            true, false, false, false, false, false, true, false, false, "利用実人員", "件数", "", "費用総額", "介護給付費", "", ""),
    /**
    ...
    特定入所者("37", "特定入所者",
            RiyojokyoTokeihyo_KaisuShukeiPattern.加算対象外,
            false, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.加算対象外,
            false, false, false, false, false, false, false, false, false, "利用実人員", "食費　　日数", "　　費用総額", "　介護給付費", "居住費　日数", "　　費用総額", "　介護給付費"),
    /**
    ...
    社福("38", "社福",
            RiyojokyoTokeihyo_KaisuShukeiPattern.加算対象外,
            false, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.加算対象外,
            false, false, false, false, false, false, false, false, false, "利用実人員", "", "", "利用者負担額", "軽減額", "軽減後負担額", ""),
    /**
    ...
    市町村特別給付("39", "市町村特別給付",
            RiyojokyoTokeihyo_KaisuShukeiPattern.加算対象外,
            true, RiyojokyoTokeihyo_HiyoSogakuShukeiPattern.計算,
            true, false, false, false, false, false, false, false, false, "利用実人員", "", "単位数", "費用総額", "介護給付費", "", "");
