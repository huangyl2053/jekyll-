...
public class JukyushaKyufujissekiDaichoProcessParameter implements IBatchProcessParameter {
     ...
     * @param 出力順ID 出力順ID
     */
    public JukyushaKyufujissekiDaichoProcessParameter(RString 対象年月,
            RString 年月範囲_開始,
            RString 年月範囲_終了,
            RString 被保険者番号_開始,
            RString 被保険者番号_終了,
    ...
    /**
     * 受給者給付実績台帳のMybaticParameter作成する。
     *
     * @return JukyushaKyufujissekiDaichoMybatisParameter
     */
    public JukyushaKyufujissekiDaichoMybatisParameter toJukyushaKyufujissekiDaichoMybatisParameter() {
        return JukyushaKyufujissekiDaichoMybatisParameter.createParam(対象年月,
                年月範囲_開始,
                年月範囲_終了,
                被保険者番号_開始,
                被保険者番号_終了,
