...
/**
 * 38P 請求明細・給付管理票返戻（保留）一覧表情報のコンフィグ名を表す列挙型です。
 *
 * @author N2810 久保 里史
 */
public enum ConfigKeysHenreiIchiranhyo implements IConfigKeysKokuhorenTorikomi {
    ...
    国保連取込_請求明細給付管理票返戻保留一覧表情報_バッチID,
    国保連取込_請求明細給付管理票返戻保留一覧表情報_一覧表示順,
    国保連取込_請求明細給付管理票返戻保留一覧表情報_交換情報識別番号,
    国保連取込_請求明細給付管理票返戻保留一覧表情報_再処理不可区分,
    国保連取込_請求明細給付管理票返戻保留一覧表情報_処理サイクル区分,
    国保連取込_請求明細給付管理票返戻保留一覧表情報_処理月,
    国保連取込_請求明細給付管理票返戻保留一覧表情報_処理名称,
    国保連取込_請求明細給付管理票返戻保留一覧表情報_排他チェック有り区分,
    国保連取込_請求明細給付管理票返戻保留一覧表情報_有効区分;
