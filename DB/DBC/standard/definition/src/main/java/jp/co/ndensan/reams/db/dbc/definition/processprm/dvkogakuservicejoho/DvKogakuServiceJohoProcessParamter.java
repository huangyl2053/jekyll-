 ...
 */
package jp.co.ndensan.reams.db.dbc.definition.processprm.dvkogakuservicejoho;

import jp.co.ndensan.reams.db.dbc.definition.mybatisprm.dvkogakuservicejoho.DvKogakuServiceJohoMybatisparamter;
...
@Getter
@Setter
public class DvKogakuServiceJohoProcessParamter implements IBatchProcessParameter {
     ...
     */
    public DvKogakuServiceJohoMybatisparamter toMybatisParamter(RString psmShikibetsuTaisho) {
        return DvKogakuServiceJohoMybatisparamter.createParamter(kouseiShichosonCode,
                serviceYmFrom,
                serviceYmTo,
                shoriJokyo,
                shinsaHoho,
                ...
                tomokumeFuka,
                rebanFuka,
                hizukeHeshu, psmShikibetsuTaisho);
    }
}
