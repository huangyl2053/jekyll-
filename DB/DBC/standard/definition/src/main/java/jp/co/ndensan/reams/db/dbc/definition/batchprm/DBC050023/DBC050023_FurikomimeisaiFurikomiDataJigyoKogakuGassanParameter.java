 ...
 */
package jp.co.ndensan.reams.db.dbc.definition.batchprm.DBC050023;
...
/**
 * 振込明細・振込みデータ作成（事業高額合算）のバッチパラメータです。
 *
...
public class DBC050023_FurikomimeisaiFurikomiDataJigyoKogakuGassanParameter extends BatchParameterBase {
    ...
    public FurikomimeisaiFurikomiDataProcessParameter toProcessParameter() {
        return new FurikomimeisaiFurikomiDataProcessParameter(
                支払方法, 抽出対象, 対象作成年月日, 再処理フラグ, 開始年月日, 終了年月日, 開始受取年月, 終了受取年月, 振込指定年月日, 処理区分);
    }
}
