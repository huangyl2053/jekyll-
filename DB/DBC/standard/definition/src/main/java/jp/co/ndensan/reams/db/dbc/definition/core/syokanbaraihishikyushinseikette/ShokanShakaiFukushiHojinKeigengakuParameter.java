...
public class ShokanShakaiFukushiHojinKeigengakuParameter {
    ...
    private final List<ShokanShakaiFukushiHojinKeigengakuEntity> 社福軽減額List;
    ...
    protected ShokanShakaiFukushiHojinKeigengakuParameter(HihokenshaNo 被保険者番号,
            ...
            RString 明細番号, List<ShokanShakaiFukushiHojinKeigengakuEntity> 社福軽減額List) {
        this.被保険者番号 = 被保険者番号;
        this.提供購入年月 = 提供購入年月;
        this.整理番号 = 整理番号;
        this.事業者番号 = 事業者番号;
    ...
    public static ShokanShakaiFukushiHojinKeigengakuParameter createSelectByKeyParam(HihokenshaNo 被保険者番号,
            ...
            List<ShokanShakaiFukushiHojinKeigengakuEntity> 社福軽減額List) {
