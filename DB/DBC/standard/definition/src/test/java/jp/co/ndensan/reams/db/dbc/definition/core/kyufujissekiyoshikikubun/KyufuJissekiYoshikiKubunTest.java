...
public class KyufuJissekiYoshikiKubunTest extends DbcTestBase {
    ...
    @Test
    public void 現物_高額介護給付費を指定した場合_get備考は_現物_高額介護給付費を返す() {
        assertThat(KyufuJissekiYoshikiKubun.現物_高額介護給付費.get備考(), is(new RString("現物_高額介護給付費")));
    }

    @Test
    public void _2131_様式第二を指定した場合_get備考は__2131_様式第二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2131_様式第二.get備考(), is(new RString("_2131_様式第二")));
    }

    @Test
    public void _2132_様式第二の二を指定した場合_get備考は__2132_様式第二の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2132_様式第二の二.get備考(), is(new RString("_2132_様式第二の二")));
    }

    @Test
    public void _2141_様式第三を指定した場合_get備考は__2141_様式第三を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2141_様式第三.get備考(), is(new RString("_2141_様式第三")));
    }

    @Test
    public void _2142_様式第三を指定した場合_get備考は__2142_様式第三を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2142_様式第三.get備考(), is(new RString("_2142_様式第三")));
    }

    @Test
    public void _2143_様式第三を指定した場合_get備考は__2143_様式第三を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2143_様式第三.get備考(), is(new RString("_2143_様式第三")));
    }

    @Test
    public void _2144_様式第三の二を指定した場合_get備考は__2144_様式第三の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2144_様式第三の二.get備考(), is(new RString("_2144_様式第三の二")));
    }

    @Test
    public void _2151_様式第四を指定した場合_get備考は__2151_様式第四を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2151_様式第四.get備考(), is(new RString("_2151_様式第四")));
    }

    @Test
    public void _2152_様式第四を指定した場合_get備考は__2152_様式第四を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2152_様式第四.get備考(), is(new RString("_2152_様式第四")));
    }

    @Test
    public void _2153_様式第四を指定した場合_get備考は__2153_様式第四を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2153_様式第四.get備考(), is(new RString("_2153_様式第四")));
    }

    @Test
    public void _2154_様式第四の二を指定した場合_get備考は__2154_様式第四の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2154_様式第四の二.get備考(), is(new RString("_2154_様式第四の二")));
    }

    @Test
    public void _2155_様式第四を指定した場合_get備考は__2155_様式第四を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2155_様式第四.get備考(), is(new RString("_2155_様式第四")));
    }

    @Test
    public void _2156_様式第四の二を指定した場合_get備考は__2156_様式第四の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2156_様式第四の二.get備考(), is(new RString("_2156_様式第四の二")));
    }

    @Test
    public void _2161_様式第五を指定した場合_get備考は__2161_様式第五を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2161_様式第五.get備考(), is(new RString("_2161_様式第五")));
    }

    @Test
    public void _2162_様式第五を指定した場合_get備考は__2162_様式第五を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2162_様式第五.get備考(), is(new RString("_2162_様式第五")));
    }

    @Test
    public void _2163_様式第五を指定した場合_get備考は__2163_様式第五を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2163_様式第五.get備考(), is(new RString("_2163_様式第五")));
    }

    @Test
    public void _2164_様式第五を指定した場合_get備考は__2164_様式第五を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2164_様式第五.get備考(), is(new RString("_2164_様式第五")));
    }

    @Test
    public void _2165_様式第五の二を指定した場合_get備考は__2165_様式第五の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2165_様式第五の二.get備考(), is(new RString("_2165_様式第五の二")));
    }

    @Test
    public void _2171_様式第六を指定した場合_get備考は__2171_様式第六を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2171_様式第六.get備考(), is(new RString("_2171_様式第六")));
    }

    @Test
    public void _2172_様式第六の二を指定した場合_get備考は__2172_様式第六の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2172_様式第六の二.get備考(), is(new RString("_2172_様式第六の二")));
    }

    @Test
    public void _2173_様式第六の三を指定した場合_get備考は__2173_様式第六の三を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2173_様式第六の三.get備考(), is(new RString("_2173_様式第六の三")));
    }

    @Test
    public void _2174_様式第六の四を指定した場合_get備考は__2174_様式第六の四を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2174_様式第六の四.get備考(), is(new RString("_2174_様式第六の四")));
    }

    @Test
    public void _2175_様式第六の五を指定した場合_get備考は__2175_様式第六の五を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2175_様式第六の五.get備考(), is(new RString("_2175_様式第六の五")));
    }

    @Test
    public void _2176_様式第六の六を指定した場合_get備考は__2176_様式第六の六を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2176_様式第六の六.get備考(), is(new RString("_2176_様式第六の六")));
    }

    @Test
    public void _2177_様式第六の七を指定した場合_get備考は__2177_様式第六の七を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2177_様式第六の七.get備考(), is(new RString("_2177_様式第六の七")));
    }

    @Test
    public void _2181_様式第八を指定した場合_get備考は__2181_様式第八を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2181_様式第八.get備考(), is(new RString("_2181_様式第八")));
    }

    @Test
    public void _2182_様式第八を指定した場合_get備考は__2182_様式第八を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2182_様式第八.get備考(), is(new RString("_2182_様式第八")));
    }

    @Test
    public void _2183_様式第八を指定した場合_get備考は__2183_様式第八を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2183_様式第八.get備考(), is(new RString("_2183_様式第八")));
    }

    @Test
    public void _2191_様式第九を指定した場合_get備考は__2191_様式第九を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2191_様式第九.get備考(), is(new RString("_2191_様式第九")));
    }

    @Test
    public void _2192_様式第九を指定した場合_get備考は__2192_様式第九を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2192_様式第九.get備考(), is(new RString("_2192_様式第九")));
    }

    @Test
    public void _2193_様式第九を指定した場合_get備考は__2193_様式第九を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2193_様式第九.get備考(), is(new RString("_2193_様式第九")));
    }

    @Test
    public void _2194_様式第九を指定した場合_get備考は__2194_様式第九を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2194_様式第九.get備考(), is(new RString("_2194_様式第九")));
    }

    @Test
    public void _2195_様式第九を指定した場合_get備考は__2195_様式第九を返す() {
        assertThat(KyufuJissekiYoshikiKubun._2195_様式第九.get備考(), is(new RString("_2195_様式第九")));
    }

    @Test
    public void _21A1_様式第十を指定した場合_get備考は__21A1_様式第十を返す() {
        assertThat(KyufuJissekiYoshikiKubun._21A1_様式第十.get備考(), is(new RString("_21A1_様式第十")));
    }

    @Test
    public void _21A2_様式第十を指定した場合_get備考は__21A2_様式第十を返す() {
        assertThat(KyufuJissekiYoshikiKubun._21A2_様式第十.get備考(), is(new RString("_21A2_様式第十")));
    }

    @Test
    public void _21A3_様式第十を指定した場合_get備考は__21A3_様式第十を返す() {
        assertThat(KyufuJissekiYoshikiKubun._21A3_様式第十.get備考(), is(new RString("_21A3_様式第十")));
    }

    @Test
    public void _21B1_様式第七を指定した場合_get備考は__21B1_様式第七を返す() {
        assertThat(KyufuJissekiYoshikiKubun._21B1_様式第七.get備考(), is(new RString("_21B1_様式第七")));
    }

    @Test
    public void _21B2_様式第七を指定した場合_get備考は__21B2_様式第七を返す() {
        assertThat(KyufuJissekiYoshikiKubun._21B2_様式第七.get備考(), is(new RString("_21B2_様式第七")));
    }

    @Test
    public void _21B3_様式第七の二を指定した場合_get備考は__21B3_様式第七の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._21B3_様式第七の二.get備考(), is(new RString("_21B3_様式第七の二")));
    }

    @Test
    public void _21B4_様式第七を指定した場合_get備考は__21B4_様式第七を返す() {
        assertThat(KyufuJissekiYoshikiKubun._21B4_様式第七.get備考(), is(new RString("_21B4_様式第七")));
    }

    @Test
    public void _21B5_様式第七の二を指定した場合_get備考は__21B5_様式第七の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._21B5_様式第七の二.get備考(), is(new RString("_21B5_様式第七の二")));
    }

    @Test
    public void _21C1_福祉用具販売費を指定した場合_get備考は__21C1_福祉用具販売費を返す() {
        assertThat(KyufuJissekiYoshikiKubun._21C1_福祉用具販売費.get備考(), is(new RString("_21C1_福祉用具販売費")));
    }

    @Test
    public void _21C2_予防用具販売費を指定した場合_get備考は__21C2_予防用具販売費を返す() {
        assertThat(KyufuJissekiYoshikiKubun._21C2_予防用具販売費.get備考(), is(new RString("_21C2_予防用具販売費")));
    }

    @Test
    public void _21D1_住宅改修費を指定した場合_get備考は__21D1_住宅改修費を返す() {
        assertThat(KyufuJissekiYoshikiKubun._21D1_住宅改修費.get備考(), is(new RString("_21D1_住宅改修費")));
    }

    @Test
    public void _21D2_予防住宅改修費を指定した場合_get備考は__21D2_予防住宅改修費を返す() {
        assertThat(KyufuJissekiYoshikiKubun._21D2_予防住宅改修費.get備考(), is(new RString("_21D2_予防住宅改修費")));
    }

    @Test
    public void _7131_様式第二を指定した場合_get備考は__7131_様式第二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7131_様式第二.get備考(), is(new RString("_7131_様式第二")));
    }

    @Test
    public void _7132_様式第二の二を指定した場合_get備考は__7132_様式第二の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7132_様式第二の二.get備考(), is(new RString("_7132_様式第二の二")));
    }

    @Test
    public void _7141_様式第三を指定した場合_get備考は__7141_様式第三を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7141_様式第三.get備考(), is(new RString("_7141_様式第三")));
    }

    @Test
    public void _7142_様式第三を指定した場合_get備考は__7142_様式第三を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7142_様式第三.get備考(), is(new RString("_7142_様式第三")));
    }

    @Test
    public void _7143_様式第三を指定した場合_get備考は__7143_様式第三を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7143_様式第三.get備考(), is(new RString("_7143_様式第三")));
    }

    @Test
    public void _7144_様式第三の二を指定した場合_get備考は__7144_様式第三の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7144_様式第三の二.get備考(), is(new RString("_7144_様式第三の二")));
    }

    @Test
    public void _7151_様式第四を指定した場合_get備考は__7151_様式第四を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7151_様式第四.get備考(), is(new RString("_7151_様式第四")));
    }

    @Test
    public void _7152_様式第四を指定した場合_get備考は__7152_様式第四を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7152_様式第四.get備考(), is(new RString("_7152_様式第四")));
    }

    @Test
    public void _7153_様式第四を指定した場合_get備考は__7153_様式第四を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7153_様式第四.get備考(), is(new RString("_7153_様式第四")));
    }

    @Test
    public void _7154_様式第四の二を指定した場合_get備考は__7154_様式第四の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7154_様式第四の二.get備考(), is(new RString("_7154_様式第四の二")));
    }

    @Test
    public void _7155_様式第四を指定した場合_get備考は__7155_様式第四を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7155_様式第四.get備考(), is(new RString("_7155_様式第四")));
    }

    @Test
    public void _7156_様式第四の二を指定した場合_get備考は__7156_様式第四の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7156_様式第四の二.get備考(), is(new RString("_7156_様式第四の二")));
    }

    @Test
    public void _7161_様式第五を指定した場合_get備考は__7161_様式第五を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7161_様式第五.get備考(), is(new RString("_7161_様式第五")));
    }

    @Test
    public void _7162_様式第五を指定した場合_get備考は__7162_様式第五を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7162_様式第五.get備考(), is(new RString("_7162_様式第五")));
    }

    @Test
    public void _7163_様式第五を指定した場合_get備考は__7163_様式第五を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7163_様式第五.get備考(), is(new RString("_7163_様式第五")));
    }

    @Test
    public void _7164_様式第五を指定した場合_get備考は__7164_様式第五を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7164_様式第五.get備考(), is(new RString("_7164_様式第五")));
    }

    @Test
    public void _7165_様式第五の二を指定した場合_get備考は__7165_様式第五の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7165_様式第五の二.get備考(), is(new RString("_7165_様式第五の二")));
    }

    @Test
    public void _7171_様式第六を指定した場合_get備考は__7171_様式第六を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7171_様式第六.get備考(), is(new RString("_7171_様式第六")));
    }

    @Test
    public void _7172_様式第六の二を指定した場合_get備考は__7172_様式第六の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7172_様式第六の二.get備考(), is(new RString("_7172_様式第六の二")));
    }

    @Test
    public void _7173_様式第六の三を指定した場合_get備考は__7173_様式第六の三を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7173_様式第六の三.get備考(), is(new RString("_7173_様式第六の三")));
    }

    @Test
    public void _7174_様式第六の四を指定した場合_get備考は__7174_様式第六の四を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7174_様式第六の四.get備考(), is(new RString("_7174_様式第六の四")));
    }

    @Test
    public void _7175_様式第六の五を指定した場合_get備考は__7175_様式第六の五を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7175_様式第六の五.get備考(), is(new RString("_7175_様式第六の五")));
    }

    @Test
    public void _7176_様式第六の六を指定した場合_get備考は__7176_様式第六の六を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7176_様式第六の六.get備考(), is(new RString("_7176_様式第六の六")));
    }

    @Test
    public void _7177_様式第六の七を指定した場合_get備考は__7177_様式第六の七を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7177_様式第六の七.get備考(), is(new RString("_7177_様式第六の七")));
    }

    @Test
    public void _7181_様式第八を指定した場合_get備考は__7181_様式第八を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7181_様式第八.get備考(), is(new RString("_7181_様式第八")));
    }

    @Test
    public void _7182_様式第八を指定した場合_get備考は__7182_様式第八を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7182_様式第八.get備考(), is(new RString("_7182_様式第八")));
    }

    @Test
    public void _7183_様式第八を指定した場合_get備考は__7183_様式第八を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7183_様式第八.get備考(), is(new RString("_7183_様式第八")));
    }

    @Test
    public void _7191_様式第九を指定した場合_get備考は__7191_様式第九を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7191_様式第九.get備考(), is(new RString("_7191_様式第九")));
    }

    @Test
    public void _7192_様式第九を指定した場合_get備考は__7192_様式第九を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7192_様式第九.get備考(), is(new RString("_7192_様式第九")));
    }

    @Test
    public void _7193_様式第九を指定した場合_get備考は__7193_様式第九を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7193_様式第九.get備考(), is(new RString("_7193_様式第九")));
    }

    @Test
    public void _7194_様式第九を指定した場合_get備考は__7194_様式第九を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7194_様式第九.get備考(), is(new RString("_7194_様式第九")));
    }

    @Test
    public void _7195_様式第九を指定した場合_get備考は__7195_様式第九を返す() {
        assertThat(KyufuJissekiYoshikiKubun._7195_様式第九.get備考(), is(new RString("_7195_様式第九")));
    }

    @Test
    public void _71A1_様式第十を指定した場合_get備考は__71A1_様式第十を返す() {
        assertThat(KyufuJissekiYoshikiKubun._71A1_様式第十.get備考(), is(new RString("_71A1_様式第十")));
    }

    @Test
    public void _71A2_様式第十を指定した場合_get備考は__71A2_様式第十を返す() {
        assertThat(KyufuJissekiYoshikiKubun._71A2_様式第十.get備考(), is(new RString("_71A2_様式第十")));
    }

    @Test
    public void _71A3_様式第十を指定した場合_get備考は__71A3_様式第十を返す() {
        assertThat(KyufuJissekiYoshikiKubun._71A3_様式第十.get備考(), is(new RString("_71A3_様式第十")));
    }

    @Test
    public void _71P1_予防サービス_生活支援サービスを指定した場合_get備考は__71P1_予防サービス_生活支援サービスを返す() {
        assertThat(KyufuJissekiYoshikiKubun._71P1_予防サービス_生活支援サービス.get備考(), is(new RString("_71P1_予防サービス・生活支援サービス")));
    }

    @Test
    public void _71R1_様式第二の三を指定した場合_get備考は__71R1_様式第二の三を返す() {
        assertThat(KyufuJissekiYoshikiKubun._71R1_様式第二の三.get備考(), is(new RString("_71R1_様式第二の三")));
    }

    @Test
    public void _8121_様式第七を指定した場合_get備考は__8121_様式第七を返す() {
        assertThat(KyufuJissekiYoshikiKubun._8121_様式第七.get備考(), is(new RString("_8121_様式第七")));
    }

    @Test
    public void _8122_様式第七を指定した場合_get備考は__8122_様式第七を返す() {
        assertThat(KyufuJissekiYoshikiKubun._8122_様式第七.get備考(), is(new RString("_8122_様式第七")));
    }

    @Test
    public void _8123_様式第七の二を指定した場合_get備考は__8123_様式第七の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._8123_様式第七の二.get備考(), is(new RString("_8123_様式第七の二")));
    }

    @Test
    public void _8124_様式第七を指定した場合_get備考は__8124_様式第七を返す() {
        assertThat(KyufuJissekiYoshikiKubun._8124_様式第七.get備考(), is(new RString("_8124_様式第七")));
    }

    @Test
    public void _8125_様式第七の二を指定した場合_get備考は__8125_様式第七の二を返す() {
        assertThat(KyufuJissekiYoshikiKubun._8125_様式第七の二.get備考(), is(new RString("_8125_様式第七の二")));
    }

    @Test
    public void _8161_ケアマネジメントを指定した場合_get備考は__8161_ケアマネジメントを返す() {
        assertThat(KyufuJissekiYoshikiKubun._8161_ケアマネジメント.get備考(), is(new RString("_8161_ケアマネジメント")));
    }

    @Test
    public void _8171_様式第七の三を指定した場合_get備考は__8171_様式第七の三を返す() {
        assertThat(KyufuJissekiYoshikiKubun._8171_様式第七の三.get備考(), is(new RString("_8171_様式第七の三")));
    }

    @Test
    public void _3411_高額介護給付費を指定した場合_get備考は__3411_高額介護給付費を返す() {
        assertThat(KyufuJissekiYoshikiKubun._3411_高額介護給付費.get備考(), is(new RString("_3411_高額介護給付費")));
    }
