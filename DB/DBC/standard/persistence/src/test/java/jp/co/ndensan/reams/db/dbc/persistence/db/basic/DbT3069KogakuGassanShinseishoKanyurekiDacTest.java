...
public class DbT3069KogakuGassanShinseishoKanyurekiDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 高額合算申請書加入歴エンティティを渡すと_updateは_高額合算申請書加入歴を更新する() {
            DbT3069KogakuGassanShinseishoKanyurekiEntity updateRecord = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_対象年度,
                    DEFAULT_保険者番号,
                    DEFAULT_整理番号,
                    DEFAULT_加入歴番号,
                    DEFAULT_履歴番号);
            updateRecord.setKanyurekiNo(new RString("001"));
            ...
            assertThat(updateRecord.getKanyurekiNo(), is(updatedRecord.getKanyurekiNo()));
        }
    }
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 高額合算申請書加入歴エンティティを渡すと_deleteは_高額合算申請書加入歴を削除する() {
            DbT3069KogakuGassanShinseishoKanyurekiEntity deletedEntity = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_対象年度,
                    DEFAULT_保険者番号,
                    DEFAULT_整理番号,
