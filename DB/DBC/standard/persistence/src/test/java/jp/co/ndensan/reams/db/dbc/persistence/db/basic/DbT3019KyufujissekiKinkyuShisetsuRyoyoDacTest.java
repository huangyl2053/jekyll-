...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3019KyufujissekiKinkyuShisetsuRyoyoEntityGenerator.*;
...
@Ignore
public class DbT3019KyufujissekiKinkyuShisetsuRyoyoDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 給付実績緊急時施設療養エンティティを渡すと_updateは_給付実績緊急時施設療養を更新する() {
            DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity updateRecord = sut.selectByKey(
                    DEFAULT_交換情報識別番号,
                    DEFAULT_入力識別番号,
                    DEFAULT_レコード種別コード,
                    DEFAULT_証記載保険者番号,
                    ...
                    DEFAULT_通し番号,
                    DEFAULT_緊急時施設療養情報レコード順次番号);
            updateRecord.setAtoRehabilitationTensu(75);
            ...
            assertThat(updateRecord.getAtoRehabilitationTensu(), is(updatedRecord.getAtoRehabilitationTensu()));
        }
    }
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 給付実績緊急時施設療養エンティティを渡すと_deleteは_給付実績緊急時施設療養を削除する() {
            DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity deletedEntity = sut.selectByKey(
                    DEFAULT_交換情報識別番号,
                    DEFAULT_入力識別番号,
                    DEFAULT_レコード種別コード,
                    DEFAULT_証記載保険者番号,
