...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3061KagoKetteiMeisaiEntityGenerator.*;
...
public class DbT3061KagoKetteiMeisaiDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 過誤決定明細エンティティを渡すと_updateは_過誤決定明細を更新する() {
            DbT3061KagoKetteiMeisaiEntity updateRecord = sut.selectByKey(
                    DEFAULT_取扱年月,
                    DEFAULT_保険者区分,
                    DEFAULT_履歴番号);
            updateRecord.setKagomoushitateJiyu(new RString("test"));
            ...
            assertThat(updateRecord.getKagomoushitateJiyu(), is(updatedRecord.getKagomoushitateJiyu()));
        }
    }
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 過誤決定明細エンティティを渡すと_deleteは_過誤決定明細を削除する() {
            DbT3061KagoKetteiMeisaiEntity deletedEntity = sut.selectByKey(
                    DEFAULT_取扱年月,
                    DEFAULT_保険者区分,
                    DEFAULT_履歴番号);
