...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3073KogakuGassanShikyugakuKeisanKekkaMeisaiEntityGenerator.*;
...
public class DbT3073KogakuGassanShikyugakuKeisanKekkaMeisaiDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 高額合算支給額計算結果明細エンティティを渡すと_updateは_高額合算支給額計算結果明細を更新する() {
            DbT3073KogakuGassanShikyugakuKeisanKekkaMeisaiEntity updateRecord = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_対象年度,
                    DEFAULT_証記載保険者番号,
                    DEFAULT_支給申請書整理番号,
                    DEFAULT_明細番号,
                    DEFAULT_履歴番号);
            updateRecord.setDataKubun(new RString("01"));
            ...
            assertThat(updateRecord.getDataKubun(), is(updatedRecord.getDataKubun()));
        }
    }
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 高額合算支給額計算結果明細エンティティを渡すと_deleteは_高額合算支給額計算結果明細を削除する() {
            DbT3073KogakuGassanShikyugakuKeisanKekkaMeisaiEntity deletedEntity = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_対象年度,
                    DEFAULT_証記載保険者番号,
                    DEFAULT_支給申請書整理番号,
