...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3030KyufuJissekiShakaiFukushiHojinKeigengakuEntityGenerator.*;
...
@Ignore
public class DbT3030KyufuJissekiShakaiFukushiHojinKeigengakuDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 給付実績社会福祉法人軽減額エンティティを渡すと_updateは_給付実績社会福祉法人軽減額を更新する() {
            DbT3030KyufuJissekiShakaiFukushiHojinKeigengakuEntity updateRecord = sut.selectByKey(
                    DEFAULT_交換情報識別番号,
                    DEFAULT_入力識別番号,
                    DEFAULT_レコード種別コード,
                    DEFAULT_証記載保険者番号,
                    ...
                    DEFAULT_通し番号,
                    DEFAULT_サービス種類コード);
            updateRecord.setAtoKeigengaku(new Decimal(100));
            ...
            assertThat(updateRecord.getAtoKeigengaku(), is(updatedRecord.getAtoKeigengaku()));
        }
    }
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 給付実績社会福祉法人軽減額エンティティを渡すと_deleteは_給付実績社会福祉法人軽減額を削除する() {
            DbT3030KyufuJissekiShakaiFukushiHojinKeigengakuEntity deletedEntity = sut.selectByKey(
                    DEFAULT_交換情報識別番号,
                    DEFAULT_入力識別番号,
                    DEFAULT_レコード種別コード,
                    DEFAULT_証記載保険者番号,
