...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3084DaisanshaKoiTodokedeEntityGenerator.*;
...
public class DbT3084DaisanshaKoiTodokedeDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 介護第三者行為届出エンティティを渡すと_updateは_介護第三者行為届出を更新する() {
            DbT3084DaisanshaKoiTodokedeEntity updateRecord = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_第三者行為届出管理番号,
                    DEFAULT_履歴番号);
            updateRecord.setYokaigoJotaiKubun(new Code("12"));
            ...
            assertThat(updateRecord.getYokaigoJotaiKubun(), is(updatedRecord.getYokaigoJotaiKubun()));
        }
    }
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 介護第三者行為届出エンティティを渡すと_deleteは_介護第三者行為届出を削除する() {
            DbT3084DaisanshaKoiTodokedeEntity deletedEntity = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_第三者行為届出管理番号,
                    DEFAULT_履歴番号);
