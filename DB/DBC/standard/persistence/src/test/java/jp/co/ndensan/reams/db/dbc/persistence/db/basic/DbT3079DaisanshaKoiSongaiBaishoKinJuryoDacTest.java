...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3079DaisanshaKoiSongaiBaishoKinJuryoEntityGenerator.*;
...
@Ignore
public class DbT3079DaisanshaKoiSongaiBaishoKinJuryoDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 介護第三者行為損害賠償金受領エンティティを渡すと_updateは_介護第三者行為損害賠償金受領を更新する() {
            DbT3079DaisanshaKoiSongaiBaishoKinJuryoEntity updateRecord = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_第三者行為届出管理番号,
                    DEFAULT_第三者行為求償請求番号,
                    DEFAULT_履歴番号);
            updateRecord.setRyoshuYMD(new FlexibleDate("20150101"));
            ...
            assertThat(updateRecord.getRyoshuYMD(), is(updatedRecord.getRyoshuYMD()));
        }
    }
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 介護第三者行為損害賠償金受領エンティティを渡すと_deleteは_介護第三者行為損害賠償金受領を削除する() {
            DbT3079DaisanshaKoiSongaiBaishoKinJuryoEntity deletedEntity = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_第三者行為届出管理番号,
                    DEFAULT_第三者行為求償請求番号,
                    DEFAULT_履歴番号);
