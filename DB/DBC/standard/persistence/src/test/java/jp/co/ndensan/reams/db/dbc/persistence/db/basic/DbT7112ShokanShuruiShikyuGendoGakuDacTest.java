...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT7112ShokanShuruiShikyuGendoGakuEntityGenerator.DEFAULT_サービス種類コード;
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT7112ShokanShuruiShikyuGendoGakuEntityGenerator.DEFAULT_履歴番号;
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT7112ShokanShuruiShikyuGendoGakuEntityGenerator.DEFAULT_適用開始年月;
...
public class DbT7112ShokanShuruiShikyuGendoGakuDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 償還払い給付種類支給限度額エンティティを渡すと_updateは_償還払い給付種類支給限度額を更新する() {
            DbT7112ShokanShuruiShikyuGendoGakuEntity updateRecord = sut.selectByKey(
                    DEFAULT_サービス種類コード,
                    DEFAULT_適用開始年月,
                    DEFAULT_履歴番号);
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 償還払い給付種類支給限度額エンティティを渡すと_deleteは_償還払い給付種類支給限度額を削除する() {
            DbT7112ShokanShuruiShikyuGendoGakuEntity deletedEntity = sut.selectByKey(
                    DEFAULT_サービス種類コード,
                    DEFAULT_適用開始年月,
                    DEFAULT_履歴番号);
