...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3027KyufujissekiJutakuKaishuhiEntityGenerator.*;
...
@Ignore
public class DbT3027KyufujissekiJutakuKaishuhiDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 給付実績住宅改修費エンティティを渡すと_updateは_給付実績住宅改修費を更新する() {
            DbT3027KyufujissekiJutakuKaishuhiEntity updateRecord = sut.selectByKey(
                    DEFAULT_交換情報識別番号,
                    DEFAULT_入力識別番号,
                    DEFAULT_レコード種別コード,
                    DEFAULT_証記載保険者番号,
                    ...
                    DEFAULT_通し番号,
                    DEFAULT_明細番号);
            updateRecord.setJutakuKaishuJigyoshaName(new RString("test"));
            ...
            assertThat(updateRecord.getJutakuKaishuJigyoshaName(), is(updatedRecord.getJutakuKaishuJigyoshaName()));
        }
    }
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 給付実績住宅改修費エンティティを渡すと_deleteは_給付実績住宅改修費を削除する() {
            DbT3027KyufujissekiJutakuKaishuhiEntity deletedEntity = sut.selectByKey(
                    DEFAULT_交換情報識別番号,
                    DEFAULT_入力識別番号,
                    DEFAULT_レコード種別コード,
                    DEFAULT_証記載保険者番号,
