...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT7121ChiikiMitchakuServiceCodeEntityGenerator.DEFAULT_サービス種類コード;
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT7121ChiikiMitchakuServiceCodeEntityGenerator.DEFAULT_サービス項目コード;
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT7121ChiikiMitchakuServiceCodeEntityGenerator.DEFAULT_履歴番号;
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT7121ChiikiMitchakuServiceCodeEntityGenerator.DEFAULT_適用開始年月;
...
public class DbT7121ChiikiMitchakuServiceCodeDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 地域密着型介護サービスコードエンティティを渡すと_updateは_地域密着型介護サービスコードを更新する() {
            DbT7121ChiikiMitchakuServiceCodeEntity updateRecord = sut.selectByKey(
                    DEFAULT_サービス種類コード,
                    DEFAULT_サービス項目コード,
                    DEFAULT_適用開始年月,
                    DEFAULT_履歴番号);
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 地域密着型介護サービスコードエンティティを渡すと_deleteは_地域密着型介護サービスコードを削除する() {
            DbT7121ChiikiMitchakuServiceCodeEntity deletedEntity = sut.selectByKey(
                    DEFAULT_サービス種類コード,
                    DEFAULT_サービス項目コード,
                    DEFAULT_適用開始年月,
                    DEFAULT_履歴番号);
