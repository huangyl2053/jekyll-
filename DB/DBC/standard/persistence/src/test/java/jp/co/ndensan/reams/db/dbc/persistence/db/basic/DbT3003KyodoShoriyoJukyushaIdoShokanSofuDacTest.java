...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3003KyodoShoriyoJukyushaIdoShokanSofuEntityGenerator.DEFAULT_受給者異動事由;
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3003KyodoShoriyoJukyushaIdoShokanSofuEntityGenerator.DEFAULT_履歴番号;
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3003KyodoShoriyoJukyushaIdoShokanSofuEntityGenerator.DEFAULT_異動区分コード;
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3003KyodoShoriyoJukyushaIdoShokanSofuEntityGenerator.DEFAULT_異動年月日;
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3003KyodoShoriyoJukyushaIdoShokanSofuEntityGenerator.DEFAULT_被保険者番号;
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3003KyodoShoriyoJukyushaIdoShokanSofuEntityGenerator.DEFAULT_証記載保険者番号;
...
@Ignore
public class DbT3003KyodoShoriyoJukyushaIdoShokanSofuDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 共同処理用受給者異動償還送付エンティティを渡すと_updateは_共同処理用受給者異動償還送付を更新する() {
            DbT3003KyodoShoriyoJukyushaIdoShokanSofuEntity updateRecord = sut.selectByKey(
                    DEFAULT_異動年月日,
                    DEFAULT_異動区分コード,
                    DEFAULT_受給者異動事由,
                    DEFAULT_証記載保険者番号,
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 共同処理用受給者異動償還送付エンティティを渡すと_deleteは_共同処理用受給者異動償還送付を削除する() {
            DbT3003KyodoShoriyoJukyushaIdoShokanSofuEntity deletedEntity = sut.selectByKey(
                    DEFAULT_異動年月日,
                    DEFAULT_異動区分コード,
                    DEFAULT_受給者異動事由,
                    DEFAULT_証記載保険者番号,
