...
/**
 * 給付実績集計のデータアクセスクラスのテストクラスです。
 *
 * @author N8156 宮本 康
 */
@RunWith(Enclosed.class)
public class KyufuJissekiShukeiDacTest extends DbcTestDacBase {

    private static IKyufuJissekiShukeiDac sut;
    ...
    public static void setUpClass() {
        sut = InstanceProvider.create(KyufuJissekiShukeiDac.class);
    }

    public static class select extends DbcTestDacBase {

        @Test
        public void 該当の給付実績集計が存在しない時_selectは_EMPTYを返す() {
        ...
        @Test
        public void 該当の給付実績集計が存在する時_selectは_該当のデータを返す() {
    ...
    private static DbT3033KyufujissekiShukeiEntity createEntity() {
        return DbT3033KyufujissekiShukeiEntityMock.createEntity();
    }
}
