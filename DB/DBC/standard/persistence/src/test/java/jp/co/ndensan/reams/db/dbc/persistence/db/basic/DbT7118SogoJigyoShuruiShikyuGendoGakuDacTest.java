...
public class DbT7118SogoJigyoShuruiShikyuGendoGakuDacTest extends DbcTestDacBase {
    ...
    public static class selectAllのテスト extends DbcTestDacBase {
        ...
        @Test
        public void 介護予防・日常生活支援総合事業種類支給限度額が存在する場合_selectAllは_全件を返す() {
            TestSupport.insert(
                    DEFAULT_サービス種類コード,
                    DEFAULT_要介護状態区分,
                    DEFAULT_適用開始年月,
        ...
        @Test
        public void 介護予防・日常生活支援総合事業種類支給限度額が存在しない場合_selectAllは_空のリストを返す() {
    ...
    public static class insertのテスト extends DbcTestDacBase {
        ...
        @Test
        public void 介護予防・日常生活支援総合事業種類支給限度額エンティティを渡すと_insertは_介護予防

        ・日常生活支援総合事業種類支給限度額を追加する() {
            TestSupport.insert(
                    DEFAULT_サービス種類コード,
                    DEFAULT_要介護状態区分,
                    DEFAULT_適用開始年月,
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        @Test
        public void 介護予防・日常生活支援総合事業種類支給限度額エンティティを渡すと_updateは_介護予防

        ・日常生活支援総合事業種類支給限度額を更新する() {
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        @Test
        public void 介護予防・日常生活支援総合事業種類支給限度額エンティティを渡すと_deleteは_介護予防

        ・日常生活支援総合事業種類支給限度額を削除する() {
