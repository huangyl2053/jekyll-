...
/**
 * 給付実績の特定入所者費情報のデータアクセスクラスのテストクラスです。
 *
 * @author N8156 宮本 康
 */
public class KyufuJissekiTokuteiNyushohiDacTest {

    private static IKyufuJissekiTokuteiNyushohiDac sut;
    ...
    public static void setUpClass() {
        sut = InstanceProvider.create(KyufuJissekiTokuteiNyushohiDac.class);
    }

    public static class select extends DbcTestDacBase {

        @Test
        public void 該当の給付実績特定入所者費用が存在しない時_selectは_EMPTYを返す() {
        ...
        @Test
        public void 該当の給付実績特定入所者費用が存在する時_selectは_該当のデータを返す() {
    ...
    private static DbT3029KyufujissekiTokuteiNyushosyaKaigoServiceHiyoEntity createEntity() {
        return DbT3029KyufujissekiTokuteiNyushosyaKaigoServiceHiyoEntityMock.createEntity();
    }
}
