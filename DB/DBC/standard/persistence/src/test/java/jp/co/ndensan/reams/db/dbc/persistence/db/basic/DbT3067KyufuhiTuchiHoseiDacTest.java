...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3067KyufuhiTuchiHoseiEntityGenerator.*;
...
public class DbT3067KyufuhiTuchiHoseiDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 給付費通知補正エンティティを渡すと_updateは_給付費通知補正を更新する() {
            DbT3067KyufuhiTuchiHoseiEntity updateRecord = sut.selectByKey(
                    DEFAULT_証記載保険者番号,
                    DEFAULT_被保険者番号,
                    DEFAULT_サービス提供年月,
                    DEFAULT_事業所番号,
                    DEFAULT_サービス種類コード,
                    DEFAULT_履歴番号);
            updateRecord.setServiceHiyoTotal(new Decimal(20000));
            ...
            assertThat(updateRecord.getServiceHiyoTotal(), is(updatedRecord.getServiceHiyoTotal()));
        }
    }
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 給付費通知補正エンティティを渡すと_deleteは_給付費通知補正を削除する() {
            DbT3067KyufuhiTuchiHoseiEntity deletedEntity = sut.selectByKey(
                    DEFAULT_証記載保険者番号,
                    DEFAULT_被保険者番号,
                    DEFAULT_サービス提供年月,
                    DEFAULT_事業所番号,
