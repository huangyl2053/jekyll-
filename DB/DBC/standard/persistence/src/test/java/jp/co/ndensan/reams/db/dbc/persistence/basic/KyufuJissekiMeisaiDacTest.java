...
/**
 * 給付実績明細のデータアクセスクラスのテストクラスです。
 *
 * @author N8156 宮本 康
 */
@RunWith(Enclosed.class)
public class KyufuJissekiMeisaiDacTest extends DbcTestDacBase {

    private static IKyufuJissekiMeisaiDac sut;
    ...
    public static void setUpClass() {
        sut = InstanceProvider.create(KyufuJissekiMeisaiDac.class);
    }

    public static class select extends DbcTestDacBase {

        @Test
        public void 該当の給付実績明細が存在しない時_selectは_EMPTYを返す() {
        ...
        @Test
        public void 該当の給付実績明細が存在する時_selectは_該当のデータを返す() {
    ...
    private static DbT3018KyufujissekiMeisaiEntity createEntity() {
        return DbT3018KyufujissekiMeisaiEntityMock.createEntity();
    }
}
