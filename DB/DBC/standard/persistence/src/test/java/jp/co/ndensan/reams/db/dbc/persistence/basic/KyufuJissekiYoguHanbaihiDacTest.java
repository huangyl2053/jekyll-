...
/**
 * 給付実績福祉用具購入費のデータアクセスクラスのテストクラスです。
 *
 * @author N8156 宮本 康
 */
...
public class KyufuJissekiYoguHanbaihiDacTest extends DbcTestDacBase {
    ...
    public static class select extends DbcTestDacBase {
        ...
        @Test
        public void 該当の給付実績福祉用具購入費が存在しない時_selectは_EMPTYを返す() {
        ...
        @Test
        public void 該当の給付実績福祉用具購入費が存在する時_selectは_該当のデータを返す() {
    ...
    private static DbT3026KyufujissekiFukushiYoguHanbaihiEntity createEntity() {
        return DbT3026KyufujissekiFukushiYoguHanbaihiEntityMock.createEntity();
    }
}
