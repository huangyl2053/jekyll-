...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3090KyufuhiKashitsukekinEntaiRisokuKeisanEntityGenerator.*;
...
@Ignore
public class DbT3090KyufuhiKashitsukekinEntaiRisokuKeisanDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 給付費貸付金延滞利息計算エンティティを渡すと_updateは_給付費貸付金延滞利息計算を更新する() {
            DbT3090KyufuhiKashitsukekinEntaiRisokuKeisanEntity updateRecord = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_貸付管理番号,
                    DEFAULT_履歴番号);
            updateRecord.setKashitsukeKanriNo(new RString("4"));
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 給付費貸付金延滞利息計算エンティティを渡すと_deleteは_給付費貸付金延滞利息計算を削除する() {
            DbT3090KyufuhiKashitsukekinEntaiRisokuKeisanEntity deletedEntity = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_貸付管理番号,
                    DEFAULT_履歴番号);
