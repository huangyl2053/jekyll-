...
/**
 * 給付実績住宅改修費のデータアクセスクラスのテストクラスです。
 *
 * @author N8156 宮本 康
 */
@RunWith(Enclosed.class)
public class KyufuJissekiJutakuKaishuhiDacTest extends DbcTestDacBase {

    private static IKyufuJissekiJutakuKaishuhiDac sut;
    ...
    public static void setUpClass() {
        sut = InstanceProvider.create(KyufuJissekiJutakuKaishuhiDac.class);
    }

    public static class select extends DbcTestDacBase {

        @Test
        public void 該当の給付実績住宅購入費が存在しない時_selectは_EMPTYを返す() {
        ...
        @Test
        public void 該当の給付実績住宅購入費が存在する時_selectは_該当のデータを返す() {
    ...
    private static DbT3027KyufujissekiJutakuKaishuhiEntity createEntity() {
        return DbT3027KyufujissekiJutakuKaishuhiEntityMock.createEntity();
    }
}
