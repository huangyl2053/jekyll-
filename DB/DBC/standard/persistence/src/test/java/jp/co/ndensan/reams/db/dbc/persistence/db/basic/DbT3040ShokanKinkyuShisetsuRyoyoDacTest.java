...
import static jp.co.ndensan.reams.db.dbc.entity.basic.helper.DbT3040ShokanKinkyuShisetsuRyoyoEntityGenerator.*;
...
@Ignore
public class DbT3040ShokanKinkyuShisetsuRyoyoDacTest extends DbcTestDacBase {
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        public void 償還払請求緊急時施設療養エンティティを渡すと_updateは_償還払請求緊急時施設療養を更新する() {
            DbT3040ShokanKinkyuShisetsuRyoyoEntity updateRecord = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_サービス提供年月,
                    DEFAULT_整理番号,
                    DEFAULT_事業者番号,
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        public void 償還払請求緊急時施設療養エンティティを渡すと_deleteは_償還払請求緊急時施設療養を削除する() {
            DbT3040ShokanKinkyuShisetsuRyoyoEntity deletedEntity = sut.selectByKey(
                    DEFAULT_被保険者番号,
                    DEFAULT_サービス提供年月,
                    DEFAULT_整理番号,
                    DEFAULT_事業者番号,
