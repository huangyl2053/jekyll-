...
public class DbT3021KyufujissekiTokuteiSinryoTokubetsuRyoyoDacTest extends DbcTestDacBase {
    ...
    public static class selectAllのテスト extends DbcTestDacBase {
        ...
        @Test
        public void 給付実績特定診療費・特別療養費が存在する場合_selectAllは_全件を返す() {
            TestSupport.insert(
                    DEFAULT_交換情報識別番号,
                    DEFAULT_入力識別番号,
                    DEFAULT_レコード種別コード,
        ...
        @Test
        public void 給付実績特定診療費・特別療養費が存在しない場合_selectAllは_空のリストを返す() {
    ...
    public static class insertのテスト extends DbcTestDacBase {
        ...
        @Test
        public void 給付実績特定診療費・特別療養費エンティティを渡すと_insertは_給付実績特定診療費・特別療養費を追加する() {
            TestSupport.insert(
                    DEFAULT_交換情報識別番号,
                    DEFAULT_入力識別番号,
                    DEFAULT_レコード種別コード,
    ...
    public static class updateのテスト extends DbcTestDacBase {
        ...
        @Test
        public void 給付実績特定診療費・特別療養費エンティティを渡すと_updateは_給付実績特定診療費・特別療養費を更新する() {
    ...
    public static class deleteのテスト extends DbcTestDacBase {
        ...
        @Test
        public void 給付実績特定診療費・特別療養費エンティティを渡すと_deleteは_給付実績特定診療費・特別療養費を削除する() {
