...
public class DbT3004KyodoShoriyoJukyushaIdoKogakuSofuDac implements ISaveable<DbT3004KyodoShoriyoJukyushaIdoKogakuSofuEntity> {
    ...
    private static final RString KEY_共同処理用受給者異動高額送付 = new RString("共同処理用受給者異動高額送付エンティティ");
     ...
     */
    @Transaction
    public DbT3004KyodoShoriyoJukyushaIdoKogakuSofuEntity select高額送付ByKey(
            HihokenshaNo 被保険者番号,
            FlexibleDate 異動年月日,
            int 履歴番号) throws NullPointerException {
        requireNonNull(被保険者番号, UrSystemErrorMessages.値がnull.getReplacedMessage(KEY_被保険者番号.toString()));
    ...
    public int save(DbT3004KyodoShoriyoJukyushaIdoKogakuSofuEntity entity) {
        requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage(KEY_共同処理用受給者異動高額送付.toString()));
     ...
     */
    @Transaction
    public int select高額送付情報の異動区分Count(
     ...
     */
    @Transaction
    public DbT3004KyodoShoriyoJukyushaIdoKogakuSofuEntity get高額送付情報の履歴番号Max(
