...
public interface IJutakuKaishuJizenShinseiMapper {
    ...
    List<FlexibleYearMonth> get支払結果計算の開始サービス提供年月限度額リセットがある(IJutakuKaishuJizenShinseiMapperParameter parameter);

    List<FlexibleYearMonth> get支払結果計算の開始サービス提供年月限度額リセットなし(IJutakuKaishuJizenShinseiMapperParameter parameter);

    List<ShiharaiKekkaEntity> get住宅改修費支払結果(IJutakuKaishuJizenShinseiMapperParameter parameter);
