...
/**
 * 居宅給付計画自己作成管理のデータアクセスクラスです。
 *
 * @reamsid_L DBC-9999-012 cuilin
 */
public class DbT3119KyotakuKeikakuJikosakuseiKanriDac implements ISaveable<DbT3119KyotakuKeikakuJikosakuseiKanriEntity> {

    @InjectSession
    private SqlSession session;

    /**
     * 主キーで居宅給付計画自己作成管理を取得します。
     *
     * @param 被保険者番号 被保険者番号
     * @param 対象年月 対象年月
     * @param 履歴番号 履歴番号
     ...
     * @param 明細番号 明細番号
     * @return DbT3119KyotakuKeikakuJikosakuseiKanriEntity
     * @throws NullPointerException 引数のいずれかがnullの場合
     */
    @Transaction
    public DbT3119KyotakuKeikakuJikosakuseiKanriEntity selectByKey(
            HihokenshaNo 被保険者番号,
        ...
        return accessor.select().
                ...
                where(and(
                                ...
                                eq(meisaiNo, 明細番号))).
                toObject(DbT3119KyotakuKeikakuJikosakuseiKanriEntity.class);
    }

    /**
     * 居宅給付計画自己作成管理を全件返します。
     *
     * @return List<DbT3119KyotakuKeikakuJikosakuseiKanriEntity>
     */
    @Transaction
    public List<DbT3119KyotakuKeikakuJikosakuseiKanriEntity> selectAll() {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);

        return accessor.select().
                table(DbT3119KyotakuKeikakuJikosakuseiKanri.class).
                toList(DbT3119KyotakuKeikakuJikosakuseiKanriEntity.class);
    }

    /**
     * DbT3119KyotakuKeikakuJikosakuseiKanriEntityを登録します。状態によってinsert/update/delete処理に振り分けられます。
     *
     * @param entity entity
     * @return 登録件数
     */
    @Transaction
    @Override
    public int save(DbT3119KyotakuKeikakuJikosakuseiKanriEntity entity) {
        requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage("居宅給付計画自己作成管理エンティティ"));
     ...
     */
    @Transaction
    public int delete(DbT3119KyotakuKeikakuJikosakuseiKanriEntity entity) {
        requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage("居宅給付計画自己作成管理エンティティ"));
