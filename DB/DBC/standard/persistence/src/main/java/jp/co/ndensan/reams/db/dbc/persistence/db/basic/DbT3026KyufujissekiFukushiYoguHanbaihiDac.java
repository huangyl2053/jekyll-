...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.kyufujisseki.DbT3026KyufujissekiFukushiYoguHanbaihi;
import static jp.co.ndensan.reams.db.dbc.entity.db.basic.kyufujisseki.DbT3026KyufujissekiFukushiYoguHanbaihi.*;
 ...
 */
public class DbT3026KyufujissekiFukushiYoguHanbaihiDac implements ISaveable<DbT3026KyufujissekiFukushiYoguHanbaihiEntity> {
    ...
    /**
     * DbT3026KyufujissekiFukushiYoguHanbaihiEntityを登録します。状態によってinsert/update/delete処理に振り分けられます。
     *
     * @param entity entity
     * @return 登録件数
     */
    @Transaction
    @Override
    public int save(DbT3026KyufujissekiFukushiYoguHanbaihiEntity entity) {
        requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage("給付実績福祉用具販売費エンティティ"));
