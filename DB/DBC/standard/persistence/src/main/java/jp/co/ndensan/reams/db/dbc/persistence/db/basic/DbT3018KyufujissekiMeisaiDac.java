...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.kyufujisseki.DbT3018KyufujissekiMeisai;
import static jp.co.ndensan.reams.db.dbc.entity.db.basic.kyufujisseki.DbT3018KyufujissekiMeisai.*;
 ...
 * 給付実績明細のデータアクセスクラスです。
 */
public class DbT3018KyufujissekiMeisaiDac implements ISaveable<DbT3018KyufujissekiMeisaiEntity> {
    ...
    /**
     * DbT3018KyufujissekiMeisaiEntityを登録します。状態によってinsert/update/delete処理に振り分けられます。
     *
     * @param entity entity
     * @return 登録件数
     */
    @Transaction
    @Override
    public int save(DbT3018KyufujissekiMeisaiEntity entity) {
        requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage("給付実績明細エンティティ"));
