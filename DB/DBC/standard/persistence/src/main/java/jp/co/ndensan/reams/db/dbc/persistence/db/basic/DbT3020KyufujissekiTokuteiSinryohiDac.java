...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.kyufujisseki.DbT3020KyufujissekiTokuteiSinryohi;
import static jp.co.ndensan.reams.db.dbc.entity.db.basic.kyufujisseki.DbT3020KyufujissekiTokuteiSinryohi.*;
 ...
 */
public class DbT3020KyufujissekiTokuteiSinryohiDac implements ISaveable<DbT3020KyufujissekiTokuteiSinryohiEntity> {
    ...
    /**
     * DbT3020KyufujissekiTokuteiSinryohiEntityを登録します。状態によってinsert/update/delete処理に振り分けられます。
     *
     * @param entity entity
     * @return 登録件数
     */
    @Transaction
    @Override
    public int save(DbT3020KyufujissekiTokuteiSinryohiEntity entity) {
        requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage("給付実績特定診療費エンティティ"));
