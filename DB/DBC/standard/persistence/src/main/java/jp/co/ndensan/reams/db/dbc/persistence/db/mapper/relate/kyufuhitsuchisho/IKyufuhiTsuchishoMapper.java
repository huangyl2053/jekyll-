...
public interface IKyufuhiTsuchishoMapper {
     ...
     */
    KyufuhiTuchiHakkoIchiranRelateEntity getSeikatsuHogoJukyusha();
     ...
     * @return 保険者構成＝単一の場合
     */
    List<KyufuhiTuchiHakkoIchiranRelateEntity> get単一の場合();
     ...
     * @return 保険者構成＝広域の場合
     */
    List<KyufuhiTuchiHakkoIchiranRelateEntity> get広域の場合();
}
