 ...
 * @author N8156 宮本 康
 */
public class KyufuJissekiMeisaiDac implements IKyufuJissekiMeisaiDac {

    @InjectSession
    private SqlSession session;

    @Override
    public List<DbT3018KyufujissekiMeisaiEntity> select(
    ...
    @Override
    public int insertOrUpdate(DbT3018KyufujissekiMeisaiEntity entity) {
    ...
    private int getMatchRowCount(DbT3018KyufujissekiMeisaiEntity entity) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select()
                .table(DbT3018KyufujissekiMeisai.class)
                .where(and(
