 ...
 */
package jp.co.ndensan.reams.db.dbc.persistence.db.mapper.relate.saishinsaketteihokenshaincsvfileread;
...
/**
 * 再審査決定通知書情報取込共通処理（保険者分・ファイル読込）DB操作です。
 *
 * @reamsid_L DBC-2520-012 surun
 */
public interface ISaishinsaKetteiHokenshaInCsvFileReadMapper {
