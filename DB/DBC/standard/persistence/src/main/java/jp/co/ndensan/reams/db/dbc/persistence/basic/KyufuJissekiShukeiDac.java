 ...
 * @author N8156 宮本 康
 */
public class KyufuJissekiShukeiDac implements IKyufuJissekiShukeiDac {
    ...
    @Override
    public int insertOrUpdate(DbT3033KyufujissekiShukeiEntity entity) {
    ...
    private int getMatchRowCount(DbT3033KyufujissekiShukeiEntity entity) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select()
                .table(DbT3033KyufujissekiShukei.class)
                .where(and(
