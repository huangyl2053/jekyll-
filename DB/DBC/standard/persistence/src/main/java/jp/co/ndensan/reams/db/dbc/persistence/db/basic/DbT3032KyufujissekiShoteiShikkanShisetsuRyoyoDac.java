...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.kyufujisseki.DbT3032KyufujissekiShoteiShikkanShisetsuRyoyo;
import static jp.co.ndensan.reams.db.dbc.entity.db.basic.kyufujisseki.DbT3032KyufujissekiShoteiShikkanShisetsuRyoyo.*;
 ...
 */
public class DbT3032KyufujissekiShoteiShikkanShisetsuRyoyoDac implements ISaveable<DbT3032KyufujissekiShoteiShikkanShisetsuRyoyoEntity> {
    ...
    /**
     * DbT3032KyufujissekiShoteiShikkanShisetsuRyoyoEntityを登録します。状態によってinsert/update/delete処理に振り分けられます。
     *
     * @param entity entity
     * @return 登録件数
     */
    @Transaction
    @Override
    public int save(DbT3032KyufujissekiShoteiShikkanShisetsuRyoyoEntity entity) {
        requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage("給付実績所定疾患施設療養費等エンティティ"));
