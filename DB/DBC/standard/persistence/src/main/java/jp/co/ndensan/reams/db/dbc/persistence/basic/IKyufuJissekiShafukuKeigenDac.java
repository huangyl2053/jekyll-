...
/**
 * 給付実績社会福祉法人軽減額のデータアクセスインターフェースです。
 *
 * @author N8156 宮本 康
 */
public interface IKyufuJissekiShafukuKeigenDac extends
        IReplaceable<DbT3030KyufuJissekiShakaiFukushiHojinKeigengakuEntity>,
        IDeletable<DbT3030KyufuJissekiShakaiFukushiHojinKeigengakuEntity> {

    /**
     * 引数の条件に該当する給付実績社会福祉法人軽減額エンティティを取得します。
     *
     ...
     * @param 事業所番号 事業所番号
     * @param 通番 通番
     * @return 給付実績社会福祉法人軽減額エンティティ
     */
    @Transaction
    List<DbT3030KyufuJissekiShakaiFukushiHojinKeigengakuEntity> select(
