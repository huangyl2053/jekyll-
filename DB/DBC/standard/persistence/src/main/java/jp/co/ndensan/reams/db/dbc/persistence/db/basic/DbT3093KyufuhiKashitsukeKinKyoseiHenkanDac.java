...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.DbT3093KyufuhiKashitsukeKinKyoseiHenkan;
import static jp.co.ndensan.reams.db.dbc.entity.db.basic.DbT3093KyufuhiKashitsukeKinKyoseiHenkan.*;
 ...
 */
public class DbT3093KyufuhiKashitsukeKinKyoseiHenkanDac implements ISaveable<DbT3093KyufuhiKashitsukeKinKyoseiHenkanEntity> {
    ...
    /**
     * DbT3093KyufuhiKashitsukeKinKyoseiHenkanEntityを登録します。状態によってinsert/update/delete処理に振り分けられます。
     *
     * @param entity entity
     * @return 登録件数
     */
    @Transaction
    @Override
    public int save(DbT3093KyufuhiKashitsukeKinKyoseiHenkanEntity entity) {
        requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage("給付費貸付金強制返還エンティティ"));
