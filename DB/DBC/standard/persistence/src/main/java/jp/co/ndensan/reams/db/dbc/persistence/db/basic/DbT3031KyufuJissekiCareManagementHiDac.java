...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.kyufujisseki.DbT3031KyufuJissekiCareManagementHi;
import static jp.co.ndensan.reams.db.dbc.entity.db.basic.kyufujisseki.DbT3031KyufuJissekiCareManagementHi.*;
...
public class DbT3031KyufuJissekiCareManagementHiDac implements ISaveable<DbT3031KyufuJissekiCareManagementHiEntity> {
    ...
    public DbT3031KyufuJissekiCareManagementHiEntity selectByKey(
        ...
        return accessor.select().
                ...
                where(and(eq(kokanJohoShikibetsuNo, 交換情報識別番号),
                                ...
                                eq(jigyoshoNo, 事業所番号),
                                eq(shiteiKijungaitoJigyoshoKubunCode, 指定_基準該当事業所区分コード),
