...
/**
 * 給付実績サービス計画費のデータアクセスインターフェースです。
 *
 * @author N8156 宮本 康
 */
public interface IKyufuJissekiKyotakuServiceDac extends
        IReplaceable<DbT3025KyufujissekiKyotakuServiceEntity>,
        IDeletable<DbT3025KyufujissekiKyotakuServiceEntity> {
     ...
     */
    @Transaction
    List<DbT3025KyufujissekiKyotakuServiceEntity> select(
