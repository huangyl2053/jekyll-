...
//TODO Key項目のテストメソッドは削除して下さい。
        ...
        @Test
        public void 戻り値の貸付承認・不承認区分は_設定した値と同じ貸付承認・不承認区分を返す() {
            business = sut.set貸付承認・不承認区分(DbT3087KyufuhiKashitsukeKinKetteiEntityGenerator.DEFAULT_貸付承認・不承認区分).build();
            assertThat(business.get貸付承認・不承認区分(), is(DbT3087KyufuhiKashitsukeKinKetteiEntityGenerator.DEFAULT_貸付承認・不承認区分));
        }
