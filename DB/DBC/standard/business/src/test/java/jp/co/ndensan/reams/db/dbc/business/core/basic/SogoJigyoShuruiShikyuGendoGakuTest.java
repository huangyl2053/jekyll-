...
//TODO 主キー値を適切な値に置換してください
        主キー名1 = DbT7118SogoJigyoShuruiShikyuGendoGakuEntityGenerator.DEFAULT_サービス種類コード;
        主キー名2 = DbT7118SogoJigyoShuruiShikyuGendoGakuEntityGenerator.DEFAULT_要介護状態区分;
    }
    ...
    public static class 主キーコンストラクタテスト extends DbcTestBase {
        ...
        public void setUp() {
            ...
            SogoJigyoShuruiShikyuGendoGakuEntity.setServiceShuruiCode(主キー名1);
            SogoJigyoShuruiShikyuGendoGakuEntity.setYoKaigoJotaiKubun(主キー名2);
        }

//TODO 主キー名を置換してください
        @Test(expected = NullPointerException.class)
        public void 主キー名1がnullである場合に_NullPointerExceptionが発生する() {
            sut = new SogoJigyoShuruiShikyuGendoGaku(null, 主キー名2, 主キー名3, 主キー名4);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー名2がnullである場合に_NullPointerExceptionが発生する() {
            sut = new SogoJigyoShuruiShikyuGendoGaku(主キー名1, null, 主キー名3, 主キー名4);
        }

        @Test
        public void 指定したキーが保持するDbT7118SogoJigyoShuruiShikyuGendoGakuEntityにセットされている() {
            sut = new SogoJigyoShuruiShikyuGendoGaku(主キー名1, 主キー名2, 主キー名3, 主キー名4);
