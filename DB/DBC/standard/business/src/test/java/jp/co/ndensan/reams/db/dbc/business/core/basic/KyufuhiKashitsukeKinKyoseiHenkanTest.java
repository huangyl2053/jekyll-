...
//TODO 主キー名を置換してください
        ...
        public void 主キー名1がnullである場合に_NullPointerExceptionが発生する() {
            sut = new KyufuhiKashitsukeKinKyoseiHenkan(null, 主キー名2);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー名2がnullである場合に_NullPointerExceptionが発生する() {
            sut = new KyufuhiKashitsukeKinKyoseiHenkan(主キー名1, null);
        }

        @Test
        public void 指定したキーが保持するDbT3093KyufuhiKashitsukeKinKyoseiHenkanEntityにセットされている() {
            sut = new KyufuhiKashitsukeKinKyoseiHenkan(主キー名1, 主キー名2);
