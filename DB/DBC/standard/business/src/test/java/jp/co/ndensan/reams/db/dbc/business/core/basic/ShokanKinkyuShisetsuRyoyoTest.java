...
//TODO 主キー値を適切な値に置換してください
        主キー名1 = DbT3040ShokanKinkyuShisetsuRyoyoEntityGenerator.DEFAULT_主キー名1;
        主キー名2 = DbT3040ShokanKinkyuShisetsuRyoyoEntityGenerator.DEFAULT_主キー名2;
    }
    ...
    public static class 主キーコンストラクタテスト extends DbcTestBase {
        ...
        public void setUp() {
            ...
            ShokanKinkyuShisetsuRyoyoEntity.setXXX(主キー名1);
            ShokanKinkyuShisetsuRyoyoEntity.setXXX(主キー名2);
        }

//TODO 主キー名を置換してください
        @Test(expected = NullPointerException.class)
        public void 主キー名1がnullである場合に_NullPointerExceptionが発生する() {
            sut = new ShokanKinkyuShisetsuRyoyo(null, 主キー名2);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー名2がnullである場合に_NullPointerExceptionが発生する() {
            sut = new ShokanKinkyuShisetsuRyoyo(主キー名1, null);
        }

        @Test
        public void 指定したキーが保持するDbT3040ShokanKinkyuShisetsuRyoyoEntityにセットされている() {
            sut = new ShokanKinkyuShisetsuRyoyo(主キー名1, 主キー名2);
    ...
    public static class getterテスト extends DbcTestBase {
        ...
        public void get順次番号は_entityが持つ順次番号を返す() {
            assertThat(sut.get順次番号(), is(ShokanKinkyuShisetsuRyoyoEntity.getJunjiNo()));
        }

        @Test
        public void get履歴番号は_entityが持つ履歴番号を返す() {
            assertThat(sut.get履歴番号(), is(ShokanKinkyuShisetsuRyoyoEntity.getRirekiNo()));
        }
