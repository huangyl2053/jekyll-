...
/**
 * {@link ShokanShoteiShikkanShisetsuRyoyoIdentifier}のテストクラスです。
 */
@RunWith(Enclosed.class)
public class ShokanShoteiShikkanShisetsuRyoyoIdentifierTest extends DbcTestBase {
...
//TODO 主キー値を適切な値に置換してください
    ...
    public static class シリアライズテスト extends DbcTestBase {
        ...
        public void シリアライズできる() {
            ShokanShoteiShikkanShisetsuRyoyoIdentifier sut = new ShokanShoteiShikkanShisetsuRyoyoIdentifier(主キー名1, 主キー名2, 主キー名3, 主キー名4, 主キー名5, 主キー名6, 主キー名7);
