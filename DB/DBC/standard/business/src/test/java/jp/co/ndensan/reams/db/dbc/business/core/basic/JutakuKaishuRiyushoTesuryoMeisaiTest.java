...
//TODO 主キー名を置換してください
        ...
        public void 主キー名1がnullである場合に_NullPointerExceptionが発生する() {
            sut = new JutakuKaishuRiyushoTesuryoMeisai(null, 主キー名2);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー名2がnullである場合に_NullPointerExceptionが発生する() {
            sut = new JutakuKaishuRiyushoTesuryoMeisai(主キー名1, null);
        }

        @Test
        public void 指定したキーが保持するDbT3095JutakuKaishuRiyushoTesuryoMeisaiEntityにセットされている() {
            sut = new JutakuKaishuRiyushoTesuryoMeisai(主キー名1, 主キー名2);
    ...
    public static class getterテスト extends DbcTestBase {
        ...
        @Test
        public void get改修内容・箇所及び規模は_entityが持つ改修内容・箇所及び規模を返す() {
            assertThat(sut.get改修内容・箇所及び規模(), is(JutakuKaishuRiyushoTesuryoMeisaiEntity.getKaishuNaiyo_kasho_Kibo()));
        }
