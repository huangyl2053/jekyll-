...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.helper.DbT7113UwanoseKubunShikyuGendoGakuEntityGenerator;
...
//TODO 主キー値を適切な値に置換してください
        主キー名1 = DbT7113UwanoseKubunShikyuGendoGakuEntityGenerator.DEFAULT_主キー名1;
        主キー名2 = DbT7113UwanoseKubunShikyuGendoGakuEntityGenerator.DEFAULT_主キー名2;
    }
    ...
    public static class 主キーコンストラクタテスト extends DbcTestBase {
        ...
        public void setUp() {
            ...
            UwanoseKubunShikyuGendoGakuEntity.setXXX(主キー名1);
            UwanoseKubunShikyuGendoGakuEntity.setXXX(主キー名2);
        }

//TODO 主キー名を置換してください
        @Test(expected = NullPointerException.class)
        public void 主キー名1がnullである場合に_NullPointerExceptionが発生する() {
            sut = new UwanoseKubunShikyuGendoGaku(null, 主キー名2);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー名2がnullである場合に_NullPointerExceptionが発生する() {
            sut = new UwanoseKubunShikyuGendoGaku(主キー名1, null);
        }

        @Test
        public void 指定したキーが保持するDbT7113UwanoseKubunShikyuGendoGakuEntityにセットされている() {
            sut = new UwanoseKubunShikyuGendoGaku(主キー名1, 主キー名2);
