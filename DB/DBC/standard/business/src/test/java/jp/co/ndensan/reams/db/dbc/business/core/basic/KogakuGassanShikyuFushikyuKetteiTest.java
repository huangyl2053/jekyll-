...
//TODO 主キー名を置換してください
        ...
        public void 主キー名1がnullである場合に_NullPointerExceptionが発生する() {
            sut = new KogakuGassanShikyuFushikyuKettei(null, 主キー名2);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー名2がnullである場合に_NullPointerExceptionが発生する() {
            sut = new KogakuGassanShikyuFushikyuKettei(主キー名1, null);
        }

        @Test
        public void 指定したキーが保持するDbT3074KogakuGassanShikyuFushikyuKetteiEntityにセットされている() {
            sut = new KogakuGassanShikyuFushikyuKettei(主キー名1, 主キー名2);
    ...
    public static class getterテスト extends DbcTestBase {
        ...
        public void get国保 被保険者証記号は_entityが持つ国保 被保険者証記号を返す() {
            assertThat(sut.get国保 被保険者証記号(), is(KogakuGassanShikyuFushikyuKetteiEntity.getKokuho_HihokenshaShoKigo()));
        }
