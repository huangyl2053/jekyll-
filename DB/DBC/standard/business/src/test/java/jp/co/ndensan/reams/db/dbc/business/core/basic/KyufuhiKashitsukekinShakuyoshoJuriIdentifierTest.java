...
/**
 * {@link KyufuhiKashitsukekinShakuyoshoJuriIdentifier}のテストクラスです。
 */
@RunWith(Enclosed.class)
public class KyufuhiKashitsukekinShakuyoshoJuriIdentifierTest extends DbcTestBase {
...
//TODO 主キー値を適切な値に置換してください
    ...
    public static class シリアライズテスト extends DbcTestBase {
        ...
        public void シリアライズできる() {
            KyufuhiKashitsukekinShakuyoshoJuriIdentifier sut = new KyufuhiKashitsukekinShakuyoshoJuriIdentifier(被保険者番号, 借入申請年月日, 履歴番号);
