...
//TODO 主キー名を置換してください
    ...
    public static class getterテスト extends DbcTestBase {
        ...
        public void get明細番号は_entityが持つ明細番号を返す() {
            assertThat(sut.get明細番号(), is(ShokanTokuteiNyushoshaKaigoServiceHiyoEntity.getMeisaiNo()));
        }

        @Test
        public void get連番は_entityが持つ連番を返す() {
            assertThat(sut.get連番(), is(ShokanTokuteiNyushoshaKaigoServiceHiyoEntity.getRenban()));
        }
