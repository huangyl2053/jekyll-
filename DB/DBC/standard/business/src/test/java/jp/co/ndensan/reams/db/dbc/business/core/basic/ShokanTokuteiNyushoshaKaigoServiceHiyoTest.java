...
//TODO 主キー名を置換してください
        ...
        public void 主キー名1がnullである場合に_NullPointerExceptionが発生する() {
            sut = new ShokanTokuteiNyushoshaKaigoServiceHiyo(null, 主キー名2);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー名2がnullである場合に_NullPointerExceptionが発生する() {
            sut = new ShokanTokuteiNyushoshaKaigoServiceHiyo(主キー名1, null);
        }

        @Test
        public void 指定したキーが保持するDbT3050ShokanTokuteiNyushoshaKaigoServiceHiyoEntityにセットされている() {
            sut = new ShokanTokuteiNyushoshaKaigoServiceHiyo(主キー名1, 主キー名2);
    ...
    public static class getterテスト extends DbcTestBase {
        ...
        public void get点数／金額は_entityが持つ点数／金額を返す() {
            assertThat(sut.get点数／金額(), is(ShokanTokuteiNyushoshaKaigoServiceHiyoEntity.getTensuKingaku()));
        }
