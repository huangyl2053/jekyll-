...
//TODO 主キー名を置換してください
        ...
        public void 主キー名1がnullである場合に_NullPointerExceptionが発生する() {
            sut = new KagoKetteiMeisai(null, 主キー名2);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー名2がnullである場合に_NullPointerExceptionが発生する() {
            sut = new KagoKetteiMeisai(主キー名1, null);
        }

        @Test
        public void 指定したキーが保持するDbT3061KagoKetteiMeisaiEntityにセットされている() {
            sut = new KagoKetteiMeisai(主キー名1, 主キー名2);
    ...
    public static class getterテスト extends DbcTestBase {
        ...
        @Test
        public void get単位数（特定入所者介護費等）は_entityが持つ単位数（特定入所者介護費等）を返す() {
            assertThat(sut.get単位数（特定入所者介護費等）(), is(KagoKetteiMeisaiEntity.getTanisu()));
        }
