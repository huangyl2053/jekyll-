...
//TODO 主キー値を適切な値に置換してください
        主キー名1 = DbT3087KyufuhiKashitsukeKinKetteiEntityGenerator.DEFAULT_主キー名1;
        主キー名2 = DbT3087KyufuhiKashitsukeKinKetteiEntityGenerator.DEFAULT_主キー名2;
    }
    ...
    public static class 主キーコンストラクタテスト extends DbcTestBase {
        ...
        public void setUp() {
            ...
            KyufuhiKashitsukeKinKetteiEntity.setXXX(主キー名1);
            KyufuhiKashitsukeKinKetteiEntity.setXXX(主キー名2);
        }

//TODO 主キー名を置換してください
        @Test(expected = NullPointerException.class)
        public void 主キー名1がnullである場合に_NullPointerExceptionが発生する() {
            sut = new KyufuhiKashitsukeKinKettei(null, 主キー名2);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー名2がnullである場合に_NullPointerExceptionが発生する() {
            sut = new KyufuhiKashitsukeKinKettei(主キー名1, null);
        }

        @Test
        public void 指定したキーが保持するDbT3087KyufuhiKashitsukeKinKetteiEntityにセットされている() {
            sut = new KyufuhiKashitsukeKinKettei(主キー名1, 主キー名2);
    ...
    public static class getterテスト extends DbcTestBase {
        ...
        @Test
        public void get貸付承認・不承認区分は_entityが持つ貸付承認・不承認区分を返す() {
            assertThat(sut.get貸付承認・不承認区分(), is(KyufuhiKashitsukeKinKetteiEntity.getKashitsukeShonin_FuShoninKubun()));
        }
