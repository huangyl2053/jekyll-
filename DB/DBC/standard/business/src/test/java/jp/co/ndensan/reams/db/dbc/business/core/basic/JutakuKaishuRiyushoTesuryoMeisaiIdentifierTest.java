...
/**
 * {@link JutakuKaishuRiyushoTesuryoMeisaiIdentifier}のテストクラスです。
 */
@RunWith(Enclosed.class)
public class JutakuKaishuRiyushoTesuryoMeisaiIdentifierTest extends DbcTestBase {
...
//TODO 主キー値を適切な値に置換してください
    ...
    public static class シリアライズテスト extends DbcTestBase {
        ...
        public void シリアライズできる() {
            JutakuKaishuRiyushoTesuryoMeisaiIdentifier sut = new JutakuKaishuRiyushoTesuryoMeisaiIdentifier(主キー名1, 主キー名2, new Decimal(主キー名3));
