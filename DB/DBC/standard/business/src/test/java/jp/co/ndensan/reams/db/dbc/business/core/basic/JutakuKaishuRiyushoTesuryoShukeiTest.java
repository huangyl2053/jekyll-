...
//TODO 主キー値を適切な値に置換してください
        主キー名1 = DbT3096JutakuKaishuRiyushoTesuryoShukeiEntityGenerator.DEFAULT_主キー名1;
        主キー名2 = DbT3096JutakuKaishuRiyushoTesuryoShukeiEntityGenerator.DEFAULT_主キー名2;
    }
    ...
    public static class 主キーコンストラクタテスト extends DbcTestBase {
        ...
        public void setUp() {
            ...
            JutakuKaishuRiyushoTesuryoShukeiEntity.setXXX(主キー名1);
            JutakuKaishuRiyushoTesuryoShukeiEntity.setXXX(主キー名2);
        }

//TODO 主キー名を置換してください
        @Test(expected = NullPointerException.class)
        public void 主キー名1がnullである場合に_NullPointerExceptionが発生する() {
            sut = new JutakuKaishuRiyushoTesuryoShukei(null, 主キー名2);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー名2がnullである場合に_NullPointerExceptionが発生する() {
            sut = new JutakuKaishuRiyushoTesuryoShukei(主キー名1, null);
        }

        @Test
        public void 指定したキーが保持するDbT3096JutakuKaishuRiyushoTesuryoShukeiEntityにセットされている() {
            sut = new JutakuKaishuRiyushoTesuryoShukei(主キー名1, 主キー名2);
    ...
    public static class getterテスト extends DbcTestBase {
        ...
        public void get履歴番号は_entityが持つ履歴番号を返す() {
            assertThat(sut.get履歴番号(), is(JutakuKaishuRiyushoTesuryoShukeiEntity.getRirekiNo()));
        }
