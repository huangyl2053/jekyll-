...
//TODO 主キー名を置換してください
        ...
        public void 主キー名1がnullである場合に_NullPointerExceptionが発生する() {
            sut = new JutakuKaishuRiyushoTesuryoShukei(null, 主キー名2, 主キー名3);
        }

        @Test(expected = NullPointerException.class)
        public void 主キー名2がnullである場合に_NullPointerExceptionが発生する() {
            sut = new JutakuKaishuRiyushoTesuryoShukei(主キー名1, null, 主キー名3);
        }

        @Test
        public void 指定したキーが保持するDbT3096JutakuKaishuRiyushoTesuryoShukeiEntityにセットされている() {
            sut = new JutakuKaishuRiyushoTesuryoShukei(主キー名1, 主キー名2, 主キー名3);
