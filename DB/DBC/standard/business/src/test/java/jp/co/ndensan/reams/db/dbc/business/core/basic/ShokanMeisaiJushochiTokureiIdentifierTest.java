...
/**
 * {@link ShokanMeisaiJushochiTokureiIdentifier}のテストクラスです。
 */
@RunWith(Enclosed.class)
public class ShokanMeisaiJushochiTokureiIdentifierTest extends DbcTestBase {
...
//TODO 主キー値を適切な値に置換してください
        ...
        主キー名6 = DbT3107ShokanMeisaiJushochiTokureiEntityGenerator.DEFAULT_明細番号;
        主キー名7 = DbT3107ShokanMeisaiJushochiTokureiEntityGenerator.DEFAULT_連番;
    }
    ...
    public static class シリアライズテスト extends DbcTestBase {
        ...
        public void シリアライズできる() {
            ShokanMeisaiJushochiTokureiIdentifier sut = new ShokanMeisaiJushochiTokureiIdentifier(主キー名1, 主キー名2, 主キー名3, 主キー名4,
                    主キー名5, 主キー名6, 主キー名7);
