...
/**
 * {@link KyufuhiKashitsukekinEntaiRisokuKeisanIdentifier}のテストクラスです。
 */
@RunWith(Enclosed.class)
public class KyufuhiKashitsukekinEntaiRisokuKeisanIdentifierTest extends DbcTestBase {
...
//TODO 主キー値を適切な値に置換してください
    ...
    public static class シリアライズテスト extends DbcTestBase {
        ...
        public void シリアライズできる() {
            KyufuhiKashitsukekinEntaiRisokuKeisanIdentifier sut = new KyufuhiKashitsukekinEntaiRisokuKeisanIdentifier(被保険者番号, 貸付管理番号, 履歴番号);
