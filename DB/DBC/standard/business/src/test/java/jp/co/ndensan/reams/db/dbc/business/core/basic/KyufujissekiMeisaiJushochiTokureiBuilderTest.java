...
//TODO Key項目のテストメソッドは削除して下さい。
        ...
        public void 戻り値の日数_回数は_設定した値と同じ日数_回数を返す() {
            business = sut.set日数_回数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_日数_回数).build();
            assertThat(business.get日数_回数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_日数_回数));
        }

        @Test
        public void 戻り値の公費１対象日数_回数は_設定した値と同じ公費１対象日数_回数を返す() {
            business = sut.set公費１対象日数_回数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_公費１対象日数_回数).build();
            assertThat(business.get公費１対象日数_回数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_公費１対象日数_回数));
        }

        @Test
        public void 戻り値の公費２対象日数_回数は_設定した値と同じ公費２対象日数_回数を返す() {
            business = sut.set公費２対象日数_回数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_公費２対象日数_回数).build();
            assertThat(business.get公費２対象日数_回数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_公費２対象日数_回数));
        }

        @Test
        public void 戻り値の公費３対象日数_回数は_設定した値と同じ公費３対象日数_回数を返す() {
            business = sut.set公費３対象日数_回数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_公費３対象日数_回数).build();
            assertThat(business.get公費３対象日数_回数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_公費３対象日数_回数));
        }
        ...
        public void 戻り値の後_単位数は_設定した値と同じ後_単位数を返す() {
            business = sut.set後_単位数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_単位数).build();
            assertThat(business.get後_単位数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_単位数));
        }

        @Test
        public void 戻り値の後_日数_回数は_設定した値と同じ後_日数_回数を返す() {
            business = sut.set後_日数_回数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_日数_回数).build();
            assertThat(business.get後_日数_回数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_日数_回数));
        }

        @Test
        public void 戻り値の後_公費１対象日数_回数は_設定した値と同じ後_公費１対象日数_回数を返す() {
            business = sut.set後_公費１対象日数_回数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_公費１対象日数_回数).build();
            assertThat(business.get後_公費１対象日数_回数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_公費１対象日数_回数));
        }

        @Test
        public void 戻り値の後_公費２対象日数_回数は_設定した値と同じ後_公費２対象日数_回数を返す() {
            business = sut.set後_公費２対象日数_回数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_公費２対象日数_回数).build();
            assertThat(business.get後_公費２対象日数_回数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_公費２対象日数_回数));
        }

        @Test
        public void 戻り値の後_公費３対象日数_回数は_設定した値と同じ後_公費３対象日数_回数を返す() {
            business = sut.set後_公費３対象日数_回数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_公費３対象日数_回数).build();
            assertThat(business.get後_公費３対象日数_回数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_公費３対象日数_回数));
        }

        @Test
        public void 戻り値の後_サービス単位数は_設定した値と同じ後_サービス単位数を返す() {
            business = sut.set後_サービス単位数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_サービス単位数).build();
            assertThat(business.get後_サービス単位数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_サービス単位数));
        }

        @Test
        public void 戻り値の後_公費１対象サービス単位数は_設定した値と同じ後_公費１対象サービス単位数を返す() {
            business = sut.set後_公費１対象サービス単位数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_公費１対象サービス単位数).build();
            assertThat(business.get後_公費１対象サービス単位数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_公費１対象サービス単位数));
        }

        @Test
        public void 戻り値の後_公費２対象サービス単位数は_設定した値と同じ後_公費２対象サービス単位数を返す() {
            business = sut.set後_公費２対象サービス単位数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_公費２対象サービス単位数).build();
            assertThat(business.get後_公費２対象サービス単位数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_公費２対象サービス単位数));
        }

        @Test
        public void 戻り値の後_公費３対象サービス単位数は_設定した値と同じ後_公費３対象サービス単位数を返す() {
            business = sut.set後_公費３対象サービス単位数(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_公費３対象サービス単位数).build();
            assertThat(business.get後_公費３対象サービス単位数(), is(DbT3106KyufujissekiMeisaiJushochiTokureiEntityGenerator.DEFAULT_後_公費３対象サービス単位数));
        }
