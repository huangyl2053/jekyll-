...
/**
 * 総合事業費再審査決定通知書情報取込一覧表（保険者分）帳票IEditor
 *
 * @reamsid_L DBC-4680-040 wangxue
 */
public interface ISogojigyohiSaishinsaKetteiHokenshaInEditor
        extends IReportEditor<SogojigyohiSaishinsaKetteiHokenshaInSource> {
