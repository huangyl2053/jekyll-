...
/**
 * 事業高額合算自己負担額管理するクラスです。
 *
 * @reamsid_L DBC-4810-010 yaoyahui
 */
public class JigyoKogakuGassanJikoFutanGaku extends
        ModelBase<KogakuGassanJikoFutanGakuIdentifier, DbT3170JigyoKogakuGassanJikoFutanGakuEntity, JigyoKogakuGassanJikoFutanGaku>
     ...
     * @param 履歴番号 履歴番号
     */
    public JigyoKogakuGassanJikoFutanGaku(HihokenshaNo 被保険者番号,
            FlexibleYear 対象年度,
            HokenshaNo 保険者番号,
            RString 支給申請書整理番号,
            int 履歴番号) {
        ...
        this.entity = new DbT3170JigyoKogakuGassanJikoFutanGakuEntity();
    ...
    /**
     * コンストラクタです。<br/>
     * DBより取得した{@link DbT3170KogakuGassanJikoFutanGakuEntity}より{@link KogakuGassanJikoFutanGaku}を生成します。
     *
     * @param entity DBより取得した{@link DbT3070KogakuGassanJikoFutanGakuEntity}
     */
    public JigyoKogakuGassanJikoFutanGaku(DbT3170JigyoKogakuGassanJikoFutanGakuEntity entity) {
     ...
     *
     * @param entity {@link DbT3170KogakuGassanJikoFutanGakuEntity}
     * @param id {@link KogakuGassanJikoFutanGakuIdentifier}
     */
    JigyoKogakuGassanJikoFutanGaku(
     ...
     */
    @Override
    public DbT3170JigyoKogakuGassanJikoFutanGakuEntity toEntity() {
     ...
     */
    @Override
    public JigyoKogakuGassanJikoFutanGaku deleted() {
        DbT3170JigyoKogakuGassanJikoFutanGakuEntity deletedEntity = this.toEntity();
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private _SerializationProxy(DbT3170JigyoKogakuGassanJikoFutanGakuEntity entity, KogakuGassanJikoFutanGakuIdentifier id) {
            this.entity = entity;
            this.id = id;
        }

        private Object readResolve() {
            return new JigyoKogakuGassanJikoFutanGaku(this.entity, this.id);
        }
    }
     ...
     * @return Builder
     */
    public JigyoKogakuGassanJikoFutanGakuBuilder createBuilderForEdit() {
        return new JigyoKogakuGassanJikoFutanGakuBuilder(entity, id);
    }
}
