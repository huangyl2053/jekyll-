...
public class ShokanKetteiTsuchiShoShiharaiYoteiBiYijiNashiItem {
     ...
     */
    public ShokanKetteiTsuchiShoShiharaiYoteiBiYijiNashiItem(RString bunshoNo, RString title, RString title2_1,
            RString title2_2_1, RString title2_2_2, RString title2_3_1, RString title2_3_2, RString title2_4,
            RString tsuchibun1, RString hihokenshaName, RString hihokenshaNo1, RString hihokenshaNo2,
            RString hihokenshaNo3, RString hihokenshaNo4, RString hihokenshaNo5, RString hihokenshaNo6,
            RString hihokenshaNo7, RString hihokenshaNo8, RString hihokenshaNo9, RString hihokenshaNo10,
            RString uketsukeYMD, RString ketteiYMD, RString honninShiharaiGaku, RString taishoYM, RString kyufuShu1,
            RString kyufuShu2, RString kyufuShu3, RString kekka, RString shikyuGaku, RString riyu1, RString riyuTitle,
            RString riyu2, RString riyu3, RString torikeshi1, RString torikeshi2, RString bankName, RString mochimono1,
            RString torikeshiMochimono1, RString branchBankName, RString mochimono2, RString torikeshiMochimono2,
            RString mochimono3, RString shiharaiBasho, RString torikeshiShiharaibasho, RString shumokuTitle, RString kouzaShu,
            RString bangoTitle, RString kouzaNo, RString shiharaiStartYMD, RString kouzaMeigi, RString torikeshiShiharaikikan,
            RString shiharaiEndYMD, RString karaFugo, RString shiharaiStartHMS, RString shiharaiEndHMS, RString tsuchibun2,
            RString seirino, RString tsuchino, RString remban, RString tsuchibunLarge, RString tsuchibunMix1, RString tsuchibunMix2,
            RString tsuchibunMixtwo1, RString tsuchibunMixtwo2, RString hakkoYMD, RString denshiKoin, RString ninshoshaYakushokuMei,
            RString ninshoshaYakushokuMei1, RString koinMojiretsu, RString ninshoshaYakushokuMei2, RString ninshoshaShimeiKakenai,
            RString ninshoshaShimeiKakeru, RString koinShoryaku, RString yubinNo, RString gyoseiku2, RString jusho4, RString jushoText,
            ...
            RString dainoKubunMei, RString shimei6, RString meishoFuyo1, RString samabunShimeiText, RString kakkoLeft2,
            RString samabunShimei2, RString samabunShimeiSmall2, RString samaBun2, RString kakkoRight2, RString kakkoLeft1,
            RString samabunShimei1, RString samaBun1, RString kakkoRight1, RString samabunShimeiSmall1, RString customerBarCode,
            RString 定型文文字サイズ) {
