...
/**
 * 帳票設計_DBCMN32002_介護保険受領委任契約承認（不承認）確認書（利用者向け）IEditor
 *
 * @reamsid_L DBC-1910-050 jiangxiaolong
 */
public interface IJyuryoItakuKeiyakuKakuninShoEditor extends
        IReportEditor<JyuryoItakuKeiyakuKakuninShoSource> {
