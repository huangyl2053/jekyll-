...
public class FutanWariaiSokujiKouseiResultEntity {
     ...
     * コンストラクタです。
     */
    public FutanWariaiSokujiKouseiResultEntity() {
        this.利用者負担割合明細 = new ArrayList<>();
    }

    /**
     * MyBatisで取得された場合に使用して下さい。<br/>
     * MyBatisで当クラス取得時は、新規追加(Added)となるため、変更無し(Unchanged)に設定します。<br/>
     * FutanWariaiSokujiKouseiResultEntityが持つ{@link xxxxxxEntity}と{@link xxxxxxEntity}と<br/>
    ...
    public void initializeMd5ToEntities() {
        ...
        for (DbT3114RiyoshaFutanWariaiMeisaiEntity entity : 利用者負担割合明細) {
