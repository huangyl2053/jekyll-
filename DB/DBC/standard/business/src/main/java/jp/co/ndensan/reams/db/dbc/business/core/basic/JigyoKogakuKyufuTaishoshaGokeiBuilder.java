...
/**
 * {@link JigyoKogakuKyufuTaishoshaGokei}の編集を行うビルダークラスです。
 */
public class JigyoKogakuKyufuTaishoshaGokeiBuilder {
    ...
    /**
     * {@link DbT3109JigyoKogakuKyufuTaishoshaGokeiEntity}より{@link JigyoKogakuKyufuTaishoshaGokei}の編集用Builderクラスを生成します。
     *
     * @param entity {@link DbT3109JigyoKogakuKyufuTaishoshaGokeiEntity}
     * @param id {@link JigyoKogakuKyufuTaishoshaGokeiIdentifier}
     *
     */
    JigyoKogakuKyufuTaishoshaGokeiBuilder(
...
//TODO 一緒に置換される値のまとまりで不変なクラスを作成し、その単位でsetterを作る様に見直してください。
     ...
     *
     * @param 被保険者番号 被保険者番号
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set被保険者番号(HihokenshaNo 被保険者番号) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder setサービス提供年月(FlexibleYearMonth サービス提供年月) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set履歴番号(Decimal 履歴番号) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder setサービス費用合計額合計(Decimal サービス費用合計額合計) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set利用者負担額合計(Decimal 利用者負担額合計) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set算定基準額(Decimal 算定基準額) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set支払済金額合計(Decimal 支払済金額合計) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set事業高額支給額(Decimal 事業高額支給額) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set対象者受取年月(FlexibleYearMonth 対象者受取年月) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set対象者判定審査年月(FlexibleYearMonth 対象者判定審査年月) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set世帯集約番号(RString 世帯集約番号) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set境界層対象者フラグ(boolean 境界層対象者フラグ) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set社会福祉法人軽減対象フラグ(boolean 社会福祉法人軽減対象フラグ) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set高額対象外フラグ(boolean 高額対象外フラグ) {
     ...
     * @return {@link JigyoKogakuKyufuTaishoshaGokeiBuilder}
     */
    public JigyoKogakuKyufuTaishoshaGokeiBuilder set自動償還対象フラグ(boolean 自動償還対象フラグ) {
    ...
    /**
     * {@link JigyoKogakuKyufuTaishoshaGokei}のインスタンスを生成します。
     *
     * @return {@link JigyoKogakuKyufuTaishoshaGokei}のインスタンス
     */
    public JigyoKogakuKyufuTaishoshaGokei build() {
        return new JigyoKogakuKyufuTaishoshaGokei(entity, id);
    }
}
