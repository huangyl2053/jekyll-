...
extends ModelBase<KyufujissekiKinkyuShisetsuRyoyoIdentifier,
        DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity, 
        KyufujissekiKinkyuShisetsuRyoyo> implements Serializable {
    ...
    public KyufujissekiKinkyuShisetsuRyoyo(KokanShikibetsuNo 交換情報識別番号,
        ...
        this.entity = new DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity();
     ...
     */
    KyufujissekiKinkyuShisetsuRyoyo(
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * {@link DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity}のクローンを返します。
     *
     * @return {@link DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity}のクローン
     */
    @Override
    public DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity toEntity() {
        return this.entity.clone();
    }

    /**
     * 給付実績緊急時施設療養の識別子{@link KyufujissekiKinkyuShisetsuRyoyoIdentifier}を返します。
     *
     * @return 給付実績緊急時施設療養の識別子{@link KyufujissekiKinkyuShisetsuRyoyoIdentifier}
     */
    @Override
    public KyufujissekiKinkyuShisetsuRyoyoIdentifier identifier() {
        return this.id;
    }
     ...
     *
     * @return 削除対象処理実施後の{@link KyufujissekiKinkyuShisetsuRyoyo}
     */
    @Override
    public KyufujissekiKinkyuShisetsuRyoyo deleted() {
        DbT3019KyufujissekiKinkyuShisetsuRyoyoEntity deletedEntity = this.toEntity();
     ...
     *
     * @return {@link KyufujissekiKinkyuShisetsuRyoyo}のシリアライズ形式
     */
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private Object readResolve() {
            return new KyufujissekiKinkyuShisetsuRyoyo(this.entity, this.id);
        }
    }
     ...
     * @return Builder
     */
    public KyufujissekiKinkyuShisetsuRyoyoBuilder createBuilderForEdit() {
        return new KyufujissekiKinkyuShisetsuRyoyoBuilder(entity, id);
    }
