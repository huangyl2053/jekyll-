...
/**
 * 給付実績所定疾患施設療養費等の識別子です。
 */
@Value
public class KyufujissekiShoteiShikkanShisetsuRyoyoIdentifier implements Serializable {
     ...
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoIdentifier(KokanShikibetsuCode 交換情報識別番号,
