...
/**
 * 帳票設計_DBCMN31003_介護保険受領委任契約承認（不承認）確認書（事業者用）Reportのインターフェースクラスです。
 *
 * @reamsid_L DBC-2130-020 liuxiaoyu
 */
public interface IJyuryoItakuKeiyakuKakuninShoKeiyakuBuilder extends
        IReportBuilder<JyuryoItakuKeiyakuKakuninShoKeiyakuJigyoshayoSource> {
