...
/**
 * 帳票設計_DBCMN43002_事業高額決定通知書(支払予定日あり） Editorするクラスです。
 *
 * @reamsid_L DBC-2000-090 lijian
 */
public interface IJigyoKogakuKetteiTsuchishoYijiAriEditor extends IReportEditor<JigyoKogakuKetteiTsuchishoYijiAriSource> {
