...
/**
 * 居宅給付計画自己作成管理を管理するクラスです。
 *
 * @reamsid_L DBC-9999-012 cuilin
 */
public class KyotakuKeikakuJikosakuseiKanri extends
        ModelBase<KyotakuKeikakuJikosakuseiKanriIdentifier, DbT3119KyotakuKeikakuJikosakuseiKanriEntity, KyotakuKeikakuJikosakuseiKanri>
     ...
     * @param 明細番号 明細番号
     */
    public KyotakuKeikakuJikosakuseiKanri(HihokenshaNo 被保険者番号,
        ...
        this.entity = new DbT3119KyotakuKeikakuJikosakuseiKanriEntity();
        ...
        this.id = new KyotakuKeikakuJikosakuseiKanriIdentifier(
                被保険者番号,
                対象年月,
                履歴番号,
                利用年月,
    ...
    /**
     * コンストラクタです。<br/>
     * DBより取得した{@link DbT3119KyotakuKeikakuJikosakuseiKanriEntity}より{@link KyotakuKeikakuJikosakuseiKanri}を生成します。
     *
     * @param entity DBより取得した{@link DbT3119KyotakuKeikakuJikosakuseiKanriEntity}
     */
    public KyotakuKeikakuJikosakuseiKanri(DbT3119KyotakuKeikakuJikosakuseiKanriEntity entity) {
        this.entity = requireNonNull(entity, UrSystemErrorMessages.値がnull.getReplacedMessage("居宅給付計画自己作成管理"));
        this.id = new KyotakuKeikakuJikosakuseiKanriIdentifier(
     ...
     */
    KyotakuKeikakuJikosakuseiKanri(
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * {@link DbT3119KyotakuKeikakuJikosakuseiKanriEntity}のクローンを返します。
     *
     * @return {@link DbT3119KyotakuKeikakuJikosakuseiKanriEntity}のクローン
     */
    @Override
    public DbT3119KyotakuKeikakuJikosakuseiKanriEntity toEntity() {
        return this.entity.clone();
    }

    /**
     * 居宅給付計画自己作成管理の識別子{@link KyotakuKeikakuJikosakuseiKanriIdentifier}を返します。
     *
     * @return 居宅給付計画自己作成管理の識別子{@link KyotakuKeikakuJikosakuseiKanriIdentifier}
     */
    @Override
    public KyotakuKeikakuJikosakuseiKanriIdentifier identifier() {
        return this.id;
    }

    /**
     * 居宅給付計画自己作成管理を削除対象とします。<br/>
     * {@link DbT3119KyotakuKeikakuJikosakuseiKanriEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば削除状態にします。
     *
     * @return 削除対象処理実施後の{@link ChiikiMitchakuServiceCode}
     */
    @Override
    public KyotakuKeikakuJikosakuseiKanri deleted() {
        DbT3119KyotakuKeikakuJikosakuseiKanriEntity deletedEntity = this.toEntity();
        ...
        return new KyotakuKeikakuJikosakuseiKanri(deletedEntity, id);
    }

    /**
     * {@link KyotakuKeikakuJikosakuseiKanri}のシリアライズ形式を提供します。
     *
     * @return {@link KyotakuKeikakuJikosakuseiKanri}のシリアライズ形式
     */
    ...
    private static final class _SerializationProxy implements Serializable {
        ...
        private _SerializationProxy(DbT3119KyotakuKeikakuJikosakuseiKanriEntity entity, KyotakuKeikakuJikosakuseiKanriIdentifier id) {
            this.entity = entity;
            this.id = id;
        }

        private Object readResolve() {
            return new KyotakuKeikakuJikosakuseiKanri(this.entity, this.id);
        }
    }
     ...
     * @return Builder
     */
    public KyotakuKeikakuJikosakuseiKanriBuilder createBuilderForEdit() {
        return new KyotakuKeikakuJikosakuseiKanriBuilder(entity, id);
    }
