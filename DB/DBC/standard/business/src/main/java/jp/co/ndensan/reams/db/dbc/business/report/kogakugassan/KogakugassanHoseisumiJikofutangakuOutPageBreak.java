 ...
 */
public class KogakugassanHoseisumiJikofutangakuOutPageBreak extends PageBreaker<JukyushaKoshinKekkaIchiranSource> {
    ...
    private boolean canBreak(ReportLineRecord<JukyushaKoshinKekkaIchiranSource> currentSource,
            ReportLineRecord<JukyushaKoshinKekkaIchiranSource> nextSource) {
