...
public class KogakuGassanJikofutangakuHosei implements Serializable {
    ...
    private Decimal 補正前_高額介護_予防_サービス費_1月分;
    private Decimal 補正前_高額介護_予防_サービス費_2月分;
    private Decimal 補正前_高額介護_予防_サービス費_3月分;
    ...
    private Decimal 変更前_補正後_高額介護_予防_サービス費_1月分;
    private Decimal 変更前_補正後_高額介護_予防_サービス費_2月分;
    private Decimal 変更前_補正後_高額介護_予防_サービス費_3月分;
    ...
    private Decimal 変更後_補正後_高額介護_予防_サービス費_1月分;
    private Decimal 変更後_補正後_高額介護_予防_サービス費_2月分;
    private Decimal 変更後_補正後_高額介護_予防_サービス費_3月分;
