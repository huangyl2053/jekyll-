...
/**
 * 帳票設計_DBC200039_高額合算支給不支給決定通知書情報取込一覧表 IEditor
 *
 * @reamsid_L DBC-2690-030 qinzhen
 */
public interface IGassanShikyuTsuchishoTorikomiIchiranEditor extends
        IReportEditor<GassanShikyuTsuchishoTorikomiIchiranSource> {
