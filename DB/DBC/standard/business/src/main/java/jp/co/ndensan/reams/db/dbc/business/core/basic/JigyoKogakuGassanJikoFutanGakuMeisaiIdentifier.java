...
public class JigyoKogakuGassanJikoFutanGakuMeisaiIdentifier implements Serializable {
     ...
     * @param 対象月 対象月
     */
    public JigyoKogakuGassanJikoFutanGakuMeisaiIdentifier(HihokenshaNo 被保険者番号,
            FlexibleYear 対象年度,
            HokenshaNo 保険者番号,
            RString 支給申請書整理番号,
            int 履歴番号,
