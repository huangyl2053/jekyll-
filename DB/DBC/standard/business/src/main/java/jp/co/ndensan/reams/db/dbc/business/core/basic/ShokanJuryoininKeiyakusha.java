...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.dbc.DbT3078ShokanJuryoininKeiyakushaEntity;
 ...
 * 償還受領委任契約者を管理するクラスです。
 */
public class ShokanJuryoininKeiyakusha extends ParentModelBase<ShokanJuryoininKeiyakushaIdentifier, DbT3078ShokanJuryoininKeiyakushaEntity, ShokanJuryoininKeiyakusha> implements Serializable {
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * 償還受領委任契約者のみを変更対象とします。<br/>
     * {@link DbT3078ShokanJuryoininKeiyakushaEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
     * @return 変更対象処理実施後の{@link ShokanJuryoininKeiyakusha}
     */
    @Override
    public ShokanJuryoininKeiyakusha modifiedModel() {
        DbT3078ShokanJuryoininKeiyakushaEntity modifiedEntity = this.toEntity();
        if (!modifiedEntity.getState().equals(EntityDataState.Added)) {
            modifiedEntity.setState(EntityDataState.Modified);
        }
        return new ShokanJuryoininKeiyakusha(
                modifiedEntity, id);
    }
