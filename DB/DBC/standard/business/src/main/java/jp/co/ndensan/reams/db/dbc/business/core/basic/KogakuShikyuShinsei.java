...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.dbc.DbT3056KogakuShikyuShinseiEntity;
 ...
 */
public class KogakuShikyuShinsei extends ParentModelBase<KogakuShikyuShinseiIdentifier, DbT3056KogakuShikyuShinseiEntity, KogakuShikyuShinsei> implements Serializable {
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * 高額介護サービス費支給申請のみを変更対象とします。<br/>
     * {@link DbT3056KogakuShikyuShinseiEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
     * @return 変更対象処理実施後の{@link KogakuShikyuShinsei}
     */
    @Override
    public KogakuShikyuShinsei modifiedModel() {
        DbT3056KogakuShikyuShinseiEntity modifiedEntity = this.toEntity();
        if (!modifiedEntity.getState().equals(EntityDataState.Added)) {
            modifiedEntity.setState(EntityDataState.Modified);
        }
        return new KogakuShikyuShinsei(
                modifiedEntity, id);
    }
