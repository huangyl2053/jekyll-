...
/**
 * 帳票設計_DBC100044_住宅改修理由書作成手数料支給（不支給）決定通知書IEditorインターフェースです。
 *
 * @reamsid_L DBC-2850-040 lizhuoxuan
 */
public interface IJutakuKaishuRiyushoSakuseiEditor extends IReportEditor<JutakuKaishuRiyushoSakuseiReportSource> {
