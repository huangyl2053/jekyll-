...
/**
 * 帳票設計_DBC200017_高額介護サービス費支給申請書発行一覧表IBuilder
 *
 * @reamsid_L DBC-4770-130 jiangxiaolong
 */
public interface IKogakuShikyuShinseishoHakkoIchiranBuilder extends
        IReportBuilder<KogakuShikyuShinseishoHakkoIchiranSource> {
