 ...
 */
public class SogojigyohiKagoKetteitsuchishoTorikomiInPageBreak extends PageBreaker<SogojigyohiKagoKetteitsuchishoTorikomiIchiranSource> {
     ...
     */
    public SogojigyohiKagoKetteitsuchishoTorikomiInPageBreak(List<RString> breakKeys) {
