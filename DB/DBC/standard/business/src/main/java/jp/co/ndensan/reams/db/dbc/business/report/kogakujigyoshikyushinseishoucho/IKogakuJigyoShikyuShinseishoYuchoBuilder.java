...
/**
 * 帳票設計_DBC100071_介護保険高額総合事業サービス費支給申請書（ゆうちょ銀行）IBuilder
 *
 * @reamsid_L DBC-4770-090 jianglaisheng
 */
public interface IKogakuJigyoShikyuShinseishoYuchoBuilder extends IReportBuilder<KogakuJigyoShikyuShinseishoYuchoSource> {
