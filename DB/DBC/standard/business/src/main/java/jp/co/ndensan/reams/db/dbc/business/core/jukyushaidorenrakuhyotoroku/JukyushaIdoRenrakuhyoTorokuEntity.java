 ...
 */
package jp.co.ndensan.reams.db.dbc.business.core.jukyushaidorenrakuhyotoroku;
...
public class JukyushaIdoRenrakuhyoTorokuEntity {
    ...
    private RString 居宅適用開始年月日;
    private RString 居宅適用終了年月日;
    private RString 減免申請中区分;
    private RString 利用者負担区分;
    private RString 利用給付率;
    private RString 利用適用開始年月日;
    private RString 利用適用終了年月日;
    ...
    private RString 新２;
    private RString 新３;
    private RString 特定入所者適用開始年月日;
    private RString 特定入所者適用終了年月日;
    ...
    private RString 住特適用開始年月日;
    private RString 住特適用終了年月日;
