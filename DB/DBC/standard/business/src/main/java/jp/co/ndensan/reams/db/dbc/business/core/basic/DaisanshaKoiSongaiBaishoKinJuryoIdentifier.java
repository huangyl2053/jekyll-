...
/**
 * 介護第三者行為損害賠償金受領の識別子です。
 */
@Value
public class DaisanshaKoiSongaiBaishoKinJuryoIdentifier implements Serializable {
     ...
     * @param 履歴番号 履歴番号
     */
    public DaisanshaKoiSongaiBaishoKinJuryoIdentifier(HihokenshaNo 被保険者番号,
            RString 第三者行為届出管理番号,
            RString 第三者行為求償請求番号,
            Decimal 履歴番号) {
        this.被保険者番号 = 被保険者番号;
