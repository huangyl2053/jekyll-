...
public class JukyushaKyufuJissekidaichoEditor implements IJukyushaKyufuJissekidaichoEditor {
    ...
    private void editSource2(JukyushaKyufuJissekidaichoReportSource source) {
        ...
        source.maeKeHiyogaku = data.get決定前_費用額合計_合計情報_s();
        source.atoKeHiyogaku = data.get決定後_費用額合計_合計情報_s();
        ...
        source.maeKeHiyogaku = data.get決定前_費用額合計_合計情報_x();
        source.atoKeHiyogaku = data.get決定後_費用額合計_合計情報_x();
        ...
        source.meisai2 = data.get明細1();
        source.meisai3 = data.get明細1();
        source.meisai4 = data.get明細1();
        source.meisai5 = data.get明細1();
        source.meisai6 = data.get明細1();
        source.meisai7 = data.get明細1();
        source.meisai8 = data.get明細1();
        source.meisai9 = data.get明細1();
        source.meisai10 = data.get明細1();
        source.meisai11 = data.get明細1();
        source.meisai12 = data.get明細1();
        source.meisai13 = data.get明細1();
        source.meisai14 = data.get明細1();
        source.meisai15 = data.get明細1();
        source.meisai16 = data.get明細1();
        source.meisai17 = data.get明細1();
        source.meisai18 = data.get明細1();
        source.meisai19 = data.get明細1();
        source.meisai20 = data.get明細1();
        source.meisai21 = data.get明細1();
        ...
        source.maeTankiNissu = data.getMaeTankiNissu();
        source.atoTankiNissu = data.getAtoTankiNissu();
    }
}
