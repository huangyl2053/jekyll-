...
public class FutanWariaiShoKattokamiProperty extends ReportPropertyBase<FutanWariaiShoKattokamiSource> {
    ...
    public enum DBB100065ShutsuryokujunEnum implements IReportItems {
         ...
         * 地区１
         */
        地区１(new RString("0005"), new RString("地区１"), new RString("\"atesaki_chiku1\"")),
        /**
         * 地区２
         */
        地区２(new RString("0006"), new RString("地区２"), new RString("\"atesaki_chiku2\"")),
        /**
         * 地区３
         */
        地区３(new RString("0007"), new RString("地区３"), new RString("\"atesaki_chiku3\"")),
        /**
         * 世帯コード
         */
         ...
         * 識別コード
         */
        識別コード(new RString("0009"), new RString("識別コード"), new RString("\"atesaki_shikibetsuCode\"")),
        /**
         * 氏名５０音カナ
         */
         ...
         * 市町村コード
         */
        市町村コード(new RString("0016"), new RString("市町村コード"), new RString("\"dbT1001HihokenshaDaicho_shichosonCode\"")),
        /**
         * 被保険者番号
         */
        被保険者番号(new RString("0104"), new RString("被保険者番号"), new RString("\"dbT3113RiyoshaFutanWariai_hihokenshaNo\"")),
        /**
         * 年金コード
         */
         ...
         * 納組コード
         */
        事業対象者受給者(new RString("0368"), new RString("事業対象者受給者"), new RString("\"kubun\""));
