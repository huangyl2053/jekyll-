...
/**
 * 住宅改修理由書作成手数料請求書兼申請書作成 のインターフェースクラスです。
 *
 * @reamsid_L DBC-2860-050 dangjingjing
 */
public interface IJutakukaishuRiyushoTesuryoSeikyuKenShinseishoIchiranEditor
        extends IReportEditor<JutakukaishuRiyushoTesuryoSeikyuKenShinseishoIchiranReportSource> {
