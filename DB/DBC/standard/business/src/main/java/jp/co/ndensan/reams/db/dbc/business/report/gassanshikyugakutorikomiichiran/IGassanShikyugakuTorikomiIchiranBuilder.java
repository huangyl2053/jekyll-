...
/**
 * 帳票設計_DBC200037_高額合算支給額計算結果連絡票情報取込一覧表 IBuilder
 *
 * @reamsid_L DBC-2680-030 qinzhen
 */
public interface IGassanShikyugakuTorikomiIchiranBuilder extends
        IReportBuilder<GassanShikyugakuTorikomiIchiranSource> {
