...
/**
 *
 * 誤決定通知書情報取込一覧表（公費負担者分）帳票IBuilder
 */
public interface IKagoKetteitsuchishoTorikomiIchiranKohifutanshaBunBuilder extends
        IReportBuilder<KagoKetteitsuchishoTorikomiIchiranKohifutanshaBunSource> {
