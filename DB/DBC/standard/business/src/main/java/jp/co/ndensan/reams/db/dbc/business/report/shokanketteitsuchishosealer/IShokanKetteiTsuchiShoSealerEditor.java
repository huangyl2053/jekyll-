...
/**
 * 償還払支給（不支給）決定通知書（ｼｰﾗﾀｲﾌﾟ）エディターのインターフェースクラスです。
 *
 * @reamsid_L DBC-1000-130 zhangzhiming
 */
public interface IShokanKetteiTsuchiShoSealerEditor extends IReportEditor<ShokanKetteiTsuchiShoSealerReportSource> {
}
