...
/**
 * 高額サービス等支給（不支給）決定通知書(支払予定日あり)Builderのインターフェースです。
 *
 * @reamsid_L DBC-5160-040 donghj
 */
interface IKogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriBuilder extends
        IReportBuilder<KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriSource> {
