...
/**
 * 振込明細一覧表作成_高額合算と事業高額合算の帳票出力項目管理Enumクラスです。
 *
 * @reamsid_L DBC-4870-030 gongliang
 */
public enum FurikomimeisaiDataOutOrder implements IReportItems {
     ...
     * 申請書整理番号
     */
    申請書整理番号(new RString("0337"), new RString("申請書整理番号"), new RString("\"DbWT0510FurikomiMeisai\".\"shikyuShinseishoSeiriNo\""));

    private final RString 項目ID;
    private final RString フォームフィールド名;
    private final RString myBatis項目名;

    private FurikomimeisaiDataOutOrder(RString 項目ID, RString フォームフィールド名,
            RString myBatis項目名) {
        this.項目ID = 項目ID;
