...
/**
 * 振込明細一覧表（合計）Editorのクラスです。
 *
 * @reamsid_L DBC-2180-050 x_lilh
 */
public class FurikomiMeisaiGokeiEditor {
     ...
     */
    protected FurikomiMeisaiGokeiEditor(GokeiDataEntity 合計データリスト, IOutputOrder 出力順,
    ...
    private void edit明細(FurikomiMeisaiIchiranDetailReportSource source) {
    ...
    private void get様式名称(FurikomiMeisaiIchiranDetailReportSource source) {
