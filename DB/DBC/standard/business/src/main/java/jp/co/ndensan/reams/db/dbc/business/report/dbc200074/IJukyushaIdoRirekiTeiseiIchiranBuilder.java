...
/**
 * 帳票設計_DBCMNF1001_1_国保連受給者異動情報履歴訂正リストIBuilder
 *
 * @reamsid_L DBC-2720-050 jiangxiaolong
 */
public interface IJukyushaIdoRirekiTeiseiIchiranBuilder extends
        IReportBuilder<JukyushaIdoRirekiTeiseiIchiranSource> {
