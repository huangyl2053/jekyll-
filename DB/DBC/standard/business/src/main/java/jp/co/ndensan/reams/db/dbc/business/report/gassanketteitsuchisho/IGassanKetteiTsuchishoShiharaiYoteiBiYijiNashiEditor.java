...
/**
 * 帳票設計_DBCMN63003_高額合算支給決定通知書（単）のエディターのインターフェースクラスです。
 *
 * @reamsid_L DBC-2310-035 chenyadong
 */
interface IGassanKetteiTsuchishoShiharaiYoteiBiYijiNashiEditor extends
        IReportEditor<GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiSource> {
