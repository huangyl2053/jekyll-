...
/**
 * 高額合算自己負担額確認情報取込一覧表OutPutOrder。
 *
 * @reamsid_L DBC-2650-030 chenjie
 */
public enum GassanJikofutangakuKakunOutPutOrder implements IReportItems {

    /**
     * 証記載保険者番号
     */
    証記載保険者番号(new RString("0103"), new RString("kohiFutanshaNo"), new RString("DbWT37H1.\"shoKisaiHokenshaNo\"")),
    /**
     * 郵便番号
     */
    ...
    private GassanJikofutangakuKakunOutPutOrder(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
        this.項目ID = 項目ID;
