 ...
 */
@Value
public class ShokanTokuteiShinryoTokubetsuRyoyoIdentifier implements Serializable {
     ...
     * @param 連番 連番
     */
    public ShokanTokuteiShinryoTokubetsuRyoyoIdentifier(HihokenshaNo 被保険者番号,
