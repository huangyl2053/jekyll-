 ...
 */
package jp.co.ndensan.reams.db.dbc.business.core.kyufuhitsuchishosealer;

import jp.co.ndensan.reams.db.dbc.entity.db.kyufuhitsuchishosealer.KyufuhiTsuchishoSealerEntity;
import jp.co.ndensan.reams.uz.uza.lang.RString;

/**
 * 帳票設計_DBC100042_介護保険給付費通知書(ｼｰﾗﾀｲﾌﾟ)の情報インターフェースです。
 *
 * @reamsid_L DBC-2280-070 lizhuoxuan
 */
public class KyufuhiTsuchishoSealerBusiness {
     ...
     * コンストラクタです。
     *
     * @param entity 帳票設計_DBC100042_介護保険給付費通知書(ｼｰﾗﾀｲﾌﾟ)情報Entityクラス
     */
    public KyufuhiTsuchishoSealerBusiness(KyufuhiTsuchishoSealerEntity entity) {
        this.entity = entity;
    }
     ...
     * @return 郵便番号1
     */
    public RString get郵便番号1() {
        return entity.getYubinNo1();
    }
     ...
     * @return 郵便番号2
     */
    public RString get郵便番号2() {
        return entity.getYubinNo2();
    }
     ...
     * @return 郵便番号3
     */
    public RString get郵便番号3() {
        return entity.getYubinNo3();
    }
     ...
     * @return 郵便番号4
     */
    public RString get郵便番号4() {
        return entity.getYubinNo4();
    }
     ...
     * @return 郵便番号5
     */
    public RString get郵便番号5() {
        return entity.getYubinNo5();
    }
     ...
     * @return 郵便番号6
     */
    public RString get郵便番号6() {
        return entity.getYubinNo6();
    }
     ...
     * @return 郵便番号7
     */
    public RString get郵便番号7() {
        return entity.getYubinNo7();
    }
    ...
    public RString getサービス年月() {
        return entity.getListServiceIchiran_1();
    }
    ...
    public RString getサービス事業者() {
        return entity.getListServiceIchiran_2();
    }
    ...
    public RString getサービス種類() {
        return entity.getListServiceIchiran_3();
    }
     ...
     * @return 日数_回数
     */
    public RString get日数_回数() {
        return entity.getListServiceIchiran_4();
    }
     ...
     * @return 利用者負担額_円
     */
    public RString get利用者負担額_円() {
        return entity.getListServiceIchiran_5();
    }
    ...
    public RString getサービス費用合計額_円() {
        return entity.getListServiceIchiran_6();
    }
