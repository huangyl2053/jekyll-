...
/**
 * 帳票設計_DBC200032_高額合算補正済自己負担額情報送付一覧表 Editorクラスです。
 *
 * @reamsid_L DBC-2660-040 lijian
 */
public interface IGassanHoseizumiJikofutangakuSofuchiranEditor extends IReportEditor<GassanHoseizumiJikofutangakuSofuchiranSource> {
