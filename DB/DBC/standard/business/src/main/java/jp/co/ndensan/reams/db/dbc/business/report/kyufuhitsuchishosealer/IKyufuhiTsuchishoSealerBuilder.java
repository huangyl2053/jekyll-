...
/**
 * 帳票設計_DBC100042_介護保険給付費通知書(ｼｰﾗﾀｲﾌﾟ)Builderのインターフェースクラスです。
 *
 * @reamsid_L DBC-2280-070 lizhuoxuan
 */
public interface IKyufuhiTsuchishoSealerBuilder extends IReportBuilder<KyufuhiTsuchishoSealerReportSource> {
