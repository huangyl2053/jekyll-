...
/**
 *高額総合事業サービス費給付お知らせ通知書（提出期限あり）IEditor
 * 
 * @reamsid_L DBC-4770-100 wangxingpeng
 */
public interface IKogakuJigyoOshiraseTsuchishoKigenAriEditor extends
        IReportEditor<KogakuJigyoOshiraseTsuchishoKigenAriSource> {
