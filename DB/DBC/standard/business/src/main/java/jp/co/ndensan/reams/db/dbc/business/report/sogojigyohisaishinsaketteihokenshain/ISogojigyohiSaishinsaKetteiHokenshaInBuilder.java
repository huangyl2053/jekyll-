...
/**
 * 総合事業費再審査決定通知書情報取込一覧表帳票IBuilder
 *
 * @reamsid_L DBC-4680-040 wangxue
 */
public interface ISogojigyohiSaishinsaKetteiHokenshaInBuilder
        extends IReportBuilder<SogojigyohiSaishinsaKetteiHokenshaInSource> {
