...
/**
 * 帳票設計_DBCMN81004_共同処理用受給者訂正連絡票（紙媒体）IBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBC-1951-060 chenaoqi
 */
public interface IKyodoShoriJukyushaTeiseiRenrakuhyoBuilder extends IReportBuilder<KyodoShoriJukyushaTeiseiRenrakuhyoSource> {
