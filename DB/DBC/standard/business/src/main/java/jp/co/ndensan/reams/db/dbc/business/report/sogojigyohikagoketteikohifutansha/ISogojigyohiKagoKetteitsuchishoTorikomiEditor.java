...
/**
 * 総合事業費過誤決定通知書情報取込（公費負担者分）一覧表帳票IEditor。
 *
 * @reamsid_L DBC-2810-030 chenjie
 */
public interface ISogojigyohiKagoKetteitsuchishoTorikomiEditor extends
        IReportEditor<SogojigyohiKagoKetteitsuchishoTorikomiIchiranSource> {
