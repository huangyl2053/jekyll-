...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.dbc.DbT3017KyufujissekiKihonEntity;
 ...
 * 給付実績基本を管理するクラスです。
 */
public class KyufujissekiKihon extends ParentModelBase<KyufujissekiKihonIdentifier, DbT3017KyufujissekiKihonEntity, KyufujissekiKihon> implements Serializable {
     ...
     * @param 通し番号 通し番号
     */
    public KyufujissekiKihon(KokanShikibetsuCode 交換情報識別番号,
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
     ...
     * @return 認定有効期間・開始年月日
     */
    public FlexibleDate get認定有効期間・開始年月日() {
     ...
     * @return 認定有功期間・終了年月日
     */
    public FlexibleDate get認定有功期間・終了年月日() {
     ...
     * @return 前・保険・利用者負担額
     */
    public int get前・保険・利用者負担額() {
        return entity.getMaeHokenRiyoshaFutangaku();
    }

    /**
     * 前・保険・緊急時施設療養費請求額を返します。
     *
     * @return 前・保険・緊急時施設療養費請求額
     */
    public Decimal get前・保険・緊急時施設療養費請求額() {
     ...
     */
    public Decimal get前・保険・特定診療費請求額() {
        return entity.getMaeHokenTokuteiShinryohiSeikyugaku();
    }

    /**
     * 前・保険・特定入所者介護サービス費等請求額を返します。
     *
     * @return 前・保険・特定入所者介護サービス費等請求額
     */
    public int get前・保険・特定入所者介護サービス費等請求額() {
     ...
     * @return 前・公費１・本人負担額
     */
    public int get前・公費１・本人負担額() {
        return entity.getMaeKohi1RiyoshaFutangaku();
    }

    /**
     * 前・公費１・緊急時施設療養費請求額を返します。
     *
     * @return 前・公費１・緊急時施設療養費請求額
     */
    public int get前・公費１・緊急時施設療養費請求額() {
     ...
     */
    public int get前・公費１・特定診療費請求額() {
        return entity.getMaeKohi1TokuteiShinryohiSeikyugaku();
    }

    /**
     * 前・公費１・特定入所者介護サービス費等請求額を返します。
     *
     * @return 前・公費１・特定入所者介護サービス費等請求額
     */
    public int get前・公費１・特定入所者介護サービス費等請求額() {
     ...
     * @return 前・公費２・本人負担額
     */
    public int get前・公費２・本人負担額() {
        return entity.getMaeKohi2RiyoshaFutangaku();
    }

    /**
     * 前・公費２・緊急時施設療養費請求額を返します。
     *
     * @return 前・公費２・緊急時施設療養費請求額
     */
    public int get前・公費２・緊急時施設療養費請求額() {
     ...
     */
    public int get前・公費２・特定診療費請求額() {
        return entity.getMaeKohi2TokuteiShinryohiSeikyugaku();
    }

    /**
     * 前・公費２・特定入所者介護サービス費等請求額を返します。
     *
     * @return 前・公費２・特定入所者介護サービス費等請求額
     */
    public int get前・公費２・特定入所者介護サービス費等請求額() {
     ...
     * @return 前・公費３・本人負担額
     */
    public int get前・公費３・本人負担額() {
        return entity.getMaeKohi3RiyoshaFutangaku();
    }

    /**
     * 前・公費３・緊急時施設療養費請求額を返します。
     *
     * @return 前・公費３・緊急時施設療養費請求額
     */
    public int get前・公費３・緊急時施設療養費請求額() {
     ...
     */
    public int get前・公費３・特定診療費請求額() {
        return entity.getMaeKohi3TokuteiShinryohiSeikyugaku();
    }

    /**
     * 前・公費３・特定入所者介護サービス費等請求額を返します。
     *
     * @return 前・公費３・特定入所者介護サービス費等請求額
     */
    public int get前・公費３・特定入所者介護サービス費等請求額() {
     ...
     */
    public Decimal get後・緊急時施設療養費請求額() {
     ...
     */
    public Decimal get後・保険・特定診療費請求額() {
        return entity.getAtoHokenTokuteiShinryohiSeikyugaku();
    }

    /**
     * 後・保険・特定入所者介護サービス費等請求額を返します。
     *
     * @return 後・保険・特定入所者介護サービス費等請求額
     */
    public int get後・保険・特定入所者介護サービス費等請求額() {
     ...
     * @return 後・公費１・本人負担額
     */
    public int get後・公費１・本人負担額() {
        return entity.getAtoKohi1RiyoshaFutangaku();
    }

    /**
     * 後・公費１・緊急時施設療養費請求額を返します。
     *
     * @return 後・公費１・緊急時施設療養費請求額
     */
    public int get後・公費１・緊急時施設療養費請求額() {
     ...
     */
    public int get後・公費１・特定診療費請求額() {
        return entity.getAtoKohi1TokuteiShinryohiSeikyugaku();
    }

    /**
     * 後・公費１・特定入所者介護サービス費等請求額を返します。
     *
     * @return 後・公費１・特定入所者介護サービス費等請求額
     */
    public int get後・公費１・特定入所者介護サービス費等請求額() {
     ...
     * @return 後・公費２・利用者負担額
     */
    public int get後・公費２・利用者負担額() {
        return entity.getAtoKohi2RiyoshaFutangaku();
    }

    /**
     * 後・公費２・緊急時施設療養費請求額を返します。
     *
     * @return 後・公費２・緊急時施設療養費請求額
     */
    public int get後・公費２・緊急時施設療養費請求額() {
     ...
     */
    public int get後・公費２・特定診療費請求額() {
        return entity.getAtoKohi2TokuteiShinryohiSeikyugaku();
    }

    /**
     * 後・公費２・特定入所者介護サービス費等請求額を返します。
     *
     * @return 後・公費２・特定入所者介護サービス費等請求額
     */
    public int get後・公費２・特定入所者介護サービス費等請求額() {
     ...
     * @return 後・公費３・利用者負担額
     */
    public int get後・公費３・利用者負担額() {
        return entity.getAtoKohi3RiyoshaFutangaku();
    }

    /**
     * 後・公費３・緊急時施設療養費請求額を返します。
     *
     * @return 後・公費３・緊急時施設療養費請求額
     */
    public int get後・公費３・緊急時施設療養費請求額() {
     ...
     */
    public int get後・公費３・特定診療費請求額() {
        return entity.getAtoKohi3TokuteiShinryohiSeikyugaku();
    }

    /**
     * 後・公費３・特定入所者介護サービス費等請求額を返します。
     *
     * @return 後・公費３・特定入所者介護サービス費等請求額
     */
    public int get後・公費３・特定入所者介護サービス費等請求額() {
    ...
    /**
     * 給付実績基本のみを変更対象とします。<br/>
     * {@link DbT3017KyufujissekiKihonEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
     * @return 変更対象処理実施後の{@link KyufujissekiKihon}
     */
    @Override
    public KyufujissekiKihon modifiedModel() {
        DbT3017KyufujissekiKihonEntity modifiedEntity = this.toEntity();
