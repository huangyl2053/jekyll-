...
/**
 * 高額介護サービス費支給（不支給）決定通知一覧表IEditor
 *
 * @reamsid_L DBC-2000-080 wangxingpeng
 */
public interface IKogakuShikyuFushikyuKetteiTsuchiHakkoEditor
        extends IReportEditor<KogakuShikyuFushikyuKetteiTsuchiHakkoSource> {
