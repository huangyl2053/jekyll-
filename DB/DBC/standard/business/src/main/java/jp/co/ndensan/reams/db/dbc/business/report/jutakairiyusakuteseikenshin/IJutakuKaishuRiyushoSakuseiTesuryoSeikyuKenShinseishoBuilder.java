...
/**
 * 住宅改修理由書作成手数料請求書兼申請書作成 Builderのインターフェースクラスです。
 *
 * @reamsid_L DBC-2860-040 dangjingjing
 */
public interface IJutakuKaishuRiyushoSakuseiTesuryoSeikyuKenShinseishoBuilder extends IReportBuilder<JutakuKaishuRSTSKSReportSource> {
