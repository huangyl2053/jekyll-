...
//TODO 一緒に置換される値のまとまりで不変なクラスを作成し、その単位でsetterを作る様に見直してください。
     ...
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set交換情報識別番号(KokanShikibetsuCode 交換情報識別番号) {
     ...
     * @return {@link KyufujissekiShoteiShikkanShisetsuRyoyoBuilder}
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set入力識別番号(NyuryokuShikibetsuCode 入力識別番号) {
     ...
     * @return {@link KyufujissekiShoteiShikkanShisetsuRyoyoBuilder}
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set後・往診日数(Decimal 後・往診日数) {
     ...
     * @return {@link KyufujissekiShoteiShikkanShisetsuRyoyoBuilder}
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set後・通院日数(Decimal 後・通院日数) {
     ...
     * @return {@link KyufujissekiShoteiShikkanShisetsuRyoyoBuilder}
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set後・緊急時治療管理単位数(int 後・緊急時治療管理単位数) {
     ...
     * @return {@link KyufujissekiShoteiShikkanShisetsuRyoyoBuilder}
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set後・緊急時治療管理日数(Decimal 後・緊急時治療管理日数) {
     ...
     * @return {@link KyufujissekiShoteiShikkanShisetsuRyoyoBuilder}
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set後・リハビリテーション点数(int 後・リハビリテーション点数) {
     ...
     * @return {@link KyufujissekiShoteiShikkanShisetsuRyoyoBuilder}
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set後・処置点数(int 後・処置点数) {
     ...
     * @return {@link KyufujissekiShoteiShikkanShisetsuRyoyoBuilder}
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set後・手術点数(int 後・手術点数) {
     ...
     * @return {@link KyufujissekiShoteiShikkanShisetsuRyoyoBuilder}
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set後・麻酔点数(int 後・麻酔点数) {
     ...
     * @return {@link KyufujissekiShoteiShikkanShisetsuRyoyoBuilder}
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set後・放射線治療点数(int 後・放射線治療点数) {
    ...
    /**
     * 後・所定疾患施設療養費単位数を設定します。
     *
     * @param 後・所定疾患施設療養費単位数 後・所定疾患施設療養費単位数
     * @return {@link KyufujissekiShoteiShikkanShisetsuRyoyoBuilder}
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set後・所定疾患施設療養費単位数(int 後・所定疾患施設療養費単位数) {
        requireNonNull(後・所定疾患施設療養費単位数, UrSystemErrorMessages.値がnull.getReplacedMessage("後・所定疾患施設療養費単位数"));
        entity.setAtoShoteiShikkanShisetsuRyoyoHiTanisu(後・所定疾患施設療養費単位数);
        return this;
    }
     ...
     * 後・所定疾患施設療養費日数を設定します。
     *
     * @param 後・所定疾患施設療養費日数 後・所定疾患施設療養費日数
     * @return {@link KyufujissekiShoteiShikkanShisetsuRyoyoBuilder}
     */
    public KyufujissekiShoteiShikkanShisetsuRyoyoBuilder set後・所定疾患施設療養費日数(Decimal 後・所定疾患施設療養費日数) {
        requireNonNull(後・所定疾患施設療養費日数, UrSystemErrorMessages.値がnull.getReplacedMessage("後・所定疾患施設療養費日数"));
        entity.setAtoShoteiShikkanShisetsuRyoyoHiNissu(後・所定疾患施設療養費日数);
        return this;
    }
