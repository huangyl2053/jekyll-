...
public class JigyoKogakuKetteiTsuchishoYijiAriEditor implements IJigyoKogakuKetteiTsuchishoYijiAriEditor {
    ...
    private void set種別と番号と口座名義(JigyoKogakuKetteiTsuchishoYijiAriSource source) {
    ...
    private void set金融機関(JigyoKogakuKetteiTsuchishoYijiAriSource source) {
        if (支給.equals(帳票情報.get支給不支給決定区分()) && !支払方法区分ONE.equals(帳票情報.get支払方法区分())
                && 帳票情報.get支給金額() != null && 0 < 帳票情報.get支給金額().compareTo(Decimal.ZERO)) {
    ...
    private void set持ちものと支払場所と期間(JigyoKogakuKetteiTsuchishoYijiAriSource source) {
        if (支給.equals(帳票情報.get支給不支給決定区分()) && 支払方法区分ONE.equals(帳票情報.get支払方法区分())
                && 帳票情報.get支給金額() != null && 0 < 帳票情報.get支給金額().compareTo(Decimal.ZERO)) {
    ...
    private void setTitle(JigyoKogakuKetteiTsuchishoYijiAriSource source) {
    ...
    private void set窓口払と口座払(JigyoKogakuKetteiTsuchishoYijiAriSource source) {
    ...
    private void set通知文(JigyoKogakuKetteiTsuchishoYijiAriSource source) {
