...
/**
 * {@link JigyoKogakuShikyuShinsei}の編集を行うビルダークラスです。
 */
public class JigyoKogakuShikyuShinseiBuilder {

    private final DbT3110JigyoKogakuShikyuShinseiEntity entity;
    private final JigyoKogakuShikyuShinseiIdentifier id;

    /**
     * {@link DbT3110JigyoKogakuShikyuShinseiEntity}より{@link JigyoKogakuShikyuShinsei}の編集用Builderクラスを生成します。
     *
     * @param entity {@link DbT3110JigyoKogakuShikyuShinseiEntity}
     * @param id {@link JigyoKogakuShikyuShinseiIdentifier}
     *
     */
    JigyoKogakuShikyuShinseiBuilder(
...
//TODO 一緒に置換される値のまとまりで不変なクラスを作成し、その単位でsetterを作る様に見直してください。
     ...
     *
     * @param 被保険者番号 被保険者番号
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set被保険者番号(HihokenshaNo 被保険者番号) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder setサービス提供年月(FlexibleYearMonth サービス提供年月) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set証記載保険者番号(HokenshaNo 証記載保険者番号) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set履歴番号(Decimal 履歴番号) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set受付年月日(FlexibleDate 受付年月日) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set申請年月日(FlexibleDate 申請年月日) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set申請理由(RString 申請理由) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set申請者区分(RString 申請者区分) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set申請者氏名(AtenaMeisho 申請者氏名) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set申請者氏名カナ(AtenaKanaMeisho 申請者氏名カナ) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set申請者住所(RString 申請者住所) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set申請者電話番号(TelNo 申請者電話番号) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set申請事業者番号(JigyoshaNo 申請事業者番号) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set支払方法区分コード(RString 支払方法区分コード) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set支払場所(RString 支払場所) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set支払期間開始年月日(FlexibleDate 支払期間開始年月日) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set支払期間終了年月日(FlexibleDate 支払期間終了年月日) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set閉庁内容(RString 閉庁内容) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set支払窓口開始時間(RString 支払窓口開始時間) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set支払窓口終了時間(RString 支払窓口終了時間) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set口座ID(long 口座ID) {
     ...
     * @return {@link JigyoKogakuShikyuShinseiBuilder}
     */
    public JigyoKogakuShikyuShinseiBuilder set受領委任契約番号(RString 受領委任契約番号) {
    ...
    /**
     * {@link JigyoKogakuShikyuShinsei}のインスタンスを生成します。
     *
     * @return {@link JigyoKogakuShikyuShinsei}のインスタンス
     */
    public JigyoKogakuShikyuShinsei build() {
        return new JigyoKogakuShikyuShinsei(entity, id);
    }
}
