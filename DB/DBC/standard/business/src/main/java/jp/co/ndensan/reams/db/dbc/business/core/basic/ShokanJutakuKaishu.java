...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.dbc.DbT3049ShokanJutakuKaishuEntity;
 ...
 * 償還払請求住宅改修を管理するクラスです。
 */
public class ShokanJutakuKaishu extends ParentModelBase<ShokanJutakuKaishuIdentifier, DbT3049ShokanJutakuKaishuEntity, ShokanJutakuKaishu> implements Serializable {
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * 償還払請求住宅改修のみを変更対象とします。<br/>
     * {@link DbT3049ShokanJutakuKaishuEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
     * @return 変更対象処理実施後の{@link ShokanJutakuKaishu}
     */
    @Override
    public ShokanJutakuKaishu modifiedModel() {
        DbT3049ShokanJutakuKaishuEntity modifiedEntity = this.toEntity();
        if (!modifiedEntity.getState().equals(EntityDataState.Added)) {
            modifiedEntity.setState(EntityDataState.Modified);
        }
        return new ShokanJutakuKaishu(
                modifiedEntity, id);
    }
