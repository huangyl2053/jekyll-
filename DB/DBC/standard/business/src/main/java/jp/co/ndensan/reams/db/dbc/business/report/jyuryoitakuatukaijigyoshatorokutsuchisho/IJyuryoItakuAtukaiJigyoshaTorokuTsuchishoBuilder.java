...
/**
 * 帳票設計_DBC100032_介護保険受領委任払い取扱事業者登録通知書のBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBC-2120-050 sunhui
 */
interface IJyuryoItakuAtukaiJigyoshaTorokuTsuchishoBuilder
        extends IReportBuilder<JyuryoItakuAtukaiJigyoshaTorokuTsuchishoSource> {
}
