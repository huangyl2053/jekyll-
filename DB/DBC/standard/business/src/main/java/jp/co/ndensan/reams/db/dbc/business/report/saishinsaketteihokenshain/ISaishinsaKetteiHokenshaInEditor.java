...
/**
 *
 * 再審査決定通知書情報取込一覧表（保険者分）エディターのインターフェースクラスです。
 *
 * @reamsid_L DBC-2520-040 chenaoqi
 */
public interface ISaishinsaKetteiHokenshaInEditor
        extends IReportEditor<SaishinsaKetteitsuchishoTorikomiIchiranHokenshaBunSource> {
}
