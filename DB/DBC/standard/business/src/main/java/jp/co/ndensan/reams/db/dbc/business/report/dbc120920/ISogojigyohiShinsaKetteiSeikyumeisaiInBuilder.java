...
/**
 * 帳票設計_DBC200084_総合事業費審査決定請求明細表帳票IBuilder
 *
 * @reamsid_L DBC-2500-032 jiangxiaolong
 */
public interface ISogojigyohiShinsaKetteiSeikyumeisaiInBuilder extends
        IReportBuilder<SogojigyohiShinsaKetteiSeikyumeisaihyoSource> {
