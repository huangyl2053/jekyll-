...
/**
 * 帳票設計_DBC200046_総合事業費（経過措置）過誤申立書情報送付一覧表 Builderクラスです。
 *
 * @reamsid_L DBC-2530-041 liuxiaoyu
 */
public interface ISogojigyohiKagoMoshitateshojohoSofuIchiranBuilder
        extends IReportBuilder<SogojigyohiKagoMoshitateshojohoSofuIchiranSource> {
