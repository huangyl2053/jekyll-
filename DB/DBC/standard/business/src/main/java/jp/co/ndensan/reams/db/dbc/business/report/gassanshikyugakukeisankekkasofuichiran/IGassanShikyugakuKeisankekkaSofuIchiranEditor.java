...
/**
 * 帳票設計_DBC200036_高額合算支給額計算結果連絡票情報送付一覧表 Editorクラスです。
 *
 * @reamsid_L DBC-2670-040 lijian
 */
public interface IGassanShikyugakuKeisankekkaSofuIchiranEditor extends IReportEditor<GassanShikyugakuKeisankekkaSofuIchiranSource> {
