...
/**
 * 帳票設計_DBC200091_高額総合事業サービス費申請書発行一覧表IBuilder
 *
 * @reamsid_L DBC-4770-120 jianglaisheng
 */
public interface IKogakuJigyoShinseishoHakkoIchiranBuilder extends IReportBuilder<KogakuJigyoShinseishoHakkoIchiranSource> {
