...
/**
 * 高額総合事業サービス費対象者一覧表IEditor
 *
 * @reamsid_L DBC-2010-120 surun
 */
public interface IKogakuSogoJigyoServiceHiTaishoshaIchiranEditor extends
        IReportEditor<KogakuSogoJigyoServiceHiTaishoshaIchiranSource> {
