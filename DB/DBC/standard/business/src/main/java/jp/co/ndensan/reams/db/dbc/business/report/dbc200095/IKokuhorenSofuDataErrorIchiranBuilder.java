...
/**
 * 帳票設計_DBCMNF1001_1_国保連送付データエラーリストIBuilder
 *
 * @reamsid_L DBC-2720-060 jiangxiaolong
 */
public interface IKokuhorenSofuDataErrorIchiranBuilder extends
        IReportBuilder<KokuhorenSofuDataErrorIchiranSource> {
