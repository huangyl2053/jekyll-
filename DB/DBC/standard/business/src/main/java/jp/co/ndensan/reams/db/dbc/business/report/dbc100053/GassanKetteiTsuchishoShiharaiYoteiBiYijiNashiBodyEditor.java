 ...
 */
public class GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiBodyEditor
        implements IGassanKetteiTsuchishoShiharaiYoteiBiYijiNashiEditor {
     ...
     */
    public GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiBodyEditor(
    ...
    private GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiSource edit文書(
            GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiSource source) {
    ...
    private void set高額合算支給不支給決定(GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiSource source) {
        ...
        if (entity.get通知書番号() != null) {
            source.tsuchiNo = entity.get通知書番号();
        }
    }
    ...
    private void set給付の種類(GassanKetteiTsuchishoShiharaiYoteiBiYijiNashiSource source, RString kyuhuShu) {
