 ...
 */
@Value
public class KyufujissekiFukushiYoguHanbaihiIdentifier implements Serializable {
     ...
     * @param 明細番号 明細番号
     */
    public KyufujissekiFukushiYoguHanbaihiIdentifier(KokanShikibetsuCode 交換情報識別番号,
