...
public class KogakuOshiraseTsuchiTeshutsuKigenNashiEditor implements IKogakuOshiraseTsuchiTeshutsuKigenNashiEditor {
     ...
     * @param target target
     */
    public KogakuOshiraseTsuchiTeshutsuKigenNashiEditor(KogakuOshiraseTsuchiTeshutsuKigenNashiEntity target) {
        this.target = target;
    }

    @Override
    public KogakuOshiraseTsuchiTeshutsuKigenNashiSource edit(KogakuOshiraseTsuchiTeshutsuKigenNashiSource source) {
