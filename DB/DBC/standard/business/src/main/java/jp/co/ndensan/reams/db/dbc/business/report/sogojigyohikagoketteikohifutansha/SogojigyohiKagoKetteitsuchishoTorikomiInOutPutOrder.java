 ...
 */
public enum SogojigyohiKagoKetteitsuchishoTorikomiInOutPutOrder implements IReportItems {
    ...
    private SogojigyohiKagoKetteitsuchishoTorikomiInOutPutOrder(RString 項目ID, RString フォームフィールド名, RString myBatis項目名) {
        this.項目ID = 項目ID;
