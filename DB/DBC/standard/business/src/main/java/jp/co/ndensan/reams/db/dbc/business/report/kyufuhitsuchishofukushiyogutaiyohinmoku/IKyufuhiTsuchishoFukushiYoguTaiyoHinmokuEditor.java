...
/**
 * 帳票設計_DBC100043_介護保険給付費通知書（福祉用具貸与品目）帳票IEditorインターフェースです。
 *
 * @reamsid_L DBC-2280-060 lizhuoxuan
 */
public interface IKyufuhiTsuchishoFukushiYoguTaiyoHinmokuEditor extends IReportEditor<KyufuhiTsuchishoFukushiYoguTaiyoHinmokuReportSource> {
