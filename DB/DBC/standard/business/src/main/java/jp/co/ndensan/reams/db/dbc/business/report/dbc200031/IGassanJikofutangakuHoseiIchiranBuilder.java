...
/**
 * 帳票設計_DBCMN62002_高額合算自己負担額補正結果一覧表 IBuilder
 *
 * @reamsid_L DBC-2320-040 jiangxiaolong
 */
public interface IGassanJikofutangakuHoseiIchiranBuilder extends
        IReportBuilder<GassanJikofutangakuHoseiIchiranSource> {
