...
//TODO 一緒に置換される値のまとまりで不変なクラスを作成し、その単位でsetterを作る様に見直してください。
     ...
     * @return {@link ShokanServicePlan200904Builder}
     */
    public ShokanServicePlan200904Builder set指定／基準該当事業者区分コード(RString 指定／基準該当事業者区分コード) {
     ...
     * @return {@link ShokanServicePlan200904Builder}
     */
    public ShokanServicePlan200904Builder set点数／金額(int 点数／金額) {
     ...
     * @return {@link ShokanServicePlan200904Builder}
     */
    public ShokanServicePlan200904Builder set購入・改修履歴等(RString 購入・改修履歴等) {
