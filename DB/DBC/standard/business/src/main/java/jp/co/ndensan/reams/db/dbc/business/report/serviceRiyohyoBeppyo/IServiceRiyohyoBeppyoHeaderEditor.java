...
/**
 * DBC-5100-030 帳票設計_DBC0150011_1_サービス提供票別表 IEditorのインターフェースクラスです。
 *
 * @reamsid_L DBC-5100-030 tianshuai
 */
public interface IServiceRiyohyoBeppyoHeaderEditor extends IReportEditor<ServiceRiyohyoBeppyoSource> {
