...
/**
 * 帳票設計_DBCMN32002_受領委任契約承認確認書発行一覧表IBuilder
 *
 * @reamsid_L DBC-1910-070 jiangxiaolong
 */
public interface IJuryoIninShoninKakuninshoIchiranBuilder extends
        IReportBuilder<JuryoIninShoninKakuninshoIchiranSource> {
