...
/**
 * 再審査決定通知書情報取込一覧表（公費負担者分）帳票IEditor
 *
 * @reamsid_L DBC-2820-050 sunhui
 */
public interface ISaishinsaKetteitsuchishoTorikomiIchiranKohifutanshaBunEditor extends
        IReportEditor<SaishinsaKetteitsuchishoTorikomiIchiranKohifutanshaBunSource> {
