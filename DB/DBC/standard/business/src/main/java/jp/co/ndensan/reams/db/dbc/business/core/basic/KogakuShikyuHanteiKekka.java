...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.dbc.DbT3057KogakuShikyuHanteiKekkaEntity;
 ...
 */
public class KogakuShikyuHanteiKekka extends ParentModelBase<KogakuShikyuHanteiKekkaIdentifier, DbT3057KogakuShikyuHanteiKekkaEntity, KogakuShikyuHanteiKekka> implements Serializable {
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * 高額介護サービス費支給判定結果のみを変更対象とします。<br/>
     * {@link DbT3057KogakuShikyuHanteiKekkaEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
     * @return 変更対象処理実施後の{@link KogakuShikyuHanteiKekka}
     */
    @Override
    public KogakuShikyuHanteiKekka modifiedModel() {
        DbT3057KogakuShikyuHanteiKekkaEntity modifiedEntity = this.toEntity();
        if (!modifiedEntity.getState().equals(EntityDataState.Added)) {
            modifiedEntity.setState(EntityDataState.Modified);
        }
        return new KogakuShikyuHanteiKekka(
                modifiedEntity, id);
    }
