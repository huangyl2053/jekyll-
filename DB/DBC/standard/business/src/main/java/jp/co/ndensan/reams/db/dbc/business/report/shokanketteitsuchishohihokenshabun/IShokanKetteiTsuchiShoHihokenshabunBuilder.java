...
/**
 * 償還払支給（不支給）決定通知書（受領委任払い・被保険者用）Builderのインターフェースクラスです。
 */
public interface IShokanKetteiTsuchiShoHihokenshabunBuilder
        extends IReportBuilder<ShokanKetteiTsuchiShoHihokenshabunReportSource> {
}
