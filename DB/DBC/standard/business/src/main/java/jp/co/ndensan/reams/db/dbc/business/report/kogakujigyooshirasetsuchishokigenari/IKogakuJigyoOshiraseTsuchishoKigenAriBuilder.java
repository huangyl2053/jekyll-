...
/**
 * 高額総合事業サービス費給付お知らせ通知書（提出期限あり）IBuilder
 *
 * @reamsid_L DBC-4770-100 wangxingpeng
 */
public interface IKogakuJigyoOshiraseTsuchishoKigenAriBuilder extends
        IReportBuilder<KogakuJigyoOshiraseTsuchishoKigenAriSource> {
