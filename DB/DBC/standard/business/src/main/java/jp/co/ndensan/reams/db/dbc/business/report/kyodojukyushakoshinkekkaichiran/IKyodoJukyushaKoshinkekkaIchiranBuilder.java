...
/**
 * 共同処理用受給者情報一覧表IBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBC-2780-030 lishengli
 */
public interface IKyodoJukyushaKoshinkekkaIchiranBuilder extends IReportBuilder<KyodoJukyushaKoshinkekkaIchiranReportSource> {
