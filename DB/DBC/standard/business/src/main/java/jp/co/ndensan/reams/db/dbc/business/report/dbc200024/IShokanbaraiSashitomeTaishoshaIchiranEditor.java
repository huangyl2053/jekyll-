...
/**
 * 帳票設計_DBC200024_償還払支給差止対象者一覧表のIEditor
 *
 * @reamsid_L DBC-1000-160 liwul
 */
public interface IShokanbaraiSashitomeTaishoshaIchiranEditor extends
        IReportEditor<ShokanbaraiSashitomeTaishoshaIchiranSource> {
