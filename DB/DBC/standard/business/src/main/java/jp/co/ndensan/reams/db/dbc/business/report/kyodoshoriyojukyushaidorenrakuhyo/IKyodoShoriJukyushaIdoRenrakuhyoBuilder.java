...
/**
 * 帳票設計_DBCMN81003_共同処理用受給者異動連絡票（紙媒体）IBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBC-1950-050 chenaoqi
 */
public interface IKyodoShoriJukyushaIdoRenrakuhyoBuilder extends IReportBuilder<KyodoShoriJukyushaIdoRenrakuhyoSource> {
