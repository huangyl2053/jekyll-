...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.dbc.DbT3034ShokanShinseiEntity;
 ...
 * 償還払支給申請を管理するクラスです。
 */
public class ShokanShinsei extends ParentModelBase<ShokanShinseiIdentifier, DbT3034ShokanShinseiEntity, ShokanShinsei> implements Serializable {
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * 償還払支給申請のみを変更対象とします。<br/>
     * {@link DbT3034ShokanShinseiEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
