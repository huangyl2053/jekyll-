...
/**
 *
 * 事業高額合算・事業分自己負担額計算結果一覧表帳票IEditorクラスです
 *
 * @reamsid_L DBC-4790-040 jiangwenkai
 */
public interface IGassanJigyobunJikofutangakuKeisanKekkaIchiranEditor extends
        IReportEditor<GassanJigyobunJikofutangakuKeisanKekkaIchiranSource> {
