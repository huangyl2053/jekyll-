...
public class KogakuGassanShikyuFushikyuKetteiBuilder {
    ...
    /**
     * {@link DbT3074KogakuGassanShikyuFushikyuKetteiEntity}より{@link KogakuGassanShikyuFushikyuKettei}の編集用Builderクラスを生成します。
     *
     * @param entity {@link DbT3074KogakuGassanShikyuFushikyuKetteiEntity}
     * @param id {@link KogakuGassanShikyuFushikyuKetteiIdentifier}
     *
     */
    KogakuGassanShikyuFushikyuKetteiBuilder(
...
//TODO 一緒に置換される値のまとまりで不変なクラスを作成し、その単位でsetterを作る様に見直してください。
     ...
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set被保険者番号(HihokenshaNo 被保険者番号) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set対象年度(FlexibleYear 対象年度) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set保険者番号(HokenshaNo 保険者番号) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set支給申請書整理番号(RString 支給申請書整理番号) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set履歴番号(Decimal 履歴番号) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set自己負担額証明書整理番号(RString 自己負担額証明書整理番号) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set保険制度コード(RString 保険制度コード) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set対象計算期間開始年月日(FlexibleDate 対象計算期間開始年月日) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set対象計算期間終了年月日(FlexibleDate 対象計算期間終了年月日) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set申請年月日(FlexibleDate 申請年月日) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set決定年月日(FlexibleDate 決定年月日) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set自己負担総額(Decimal 自己負担総額) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set支給区分コード(RString 支給区分コード) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set支給額(Decimal 支給額) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set給付の種類(RString 給付の種類) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set不支給理由(RString 不支給理由) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set備考(RString 備考) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set支払方法区分(RString 支払方法区分) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set支払場所(RString 支払場所) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set支払期間開始年月日(FlexibleDate 支払期間開始年月日) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set支払期間終了年月日(FlexibleDate 支払期間終了年月日) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set閉庁内容(RString 閉庁内容) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set支払期間開始時間(RString 支払期間開始時間) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set支払期間終了時間(RString 支払期間終了時間) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set決定通知書作成年月日(FlexibleDate 決定通知書作成年月日) {
     ...
     * @return {@link KogakuGassanShikyuFushikyuKetteiBuilder}
     */
    public KogakuGassanShikyuFushikyuKetteiBuilder set振込通知書作成年月日(FlexibleDate 振込通知書作成年月日) {
    ...
    /**
     * {@link KogakuGassanShikyuFushikyuKettei}のインスタンスを生成します。
     *
     * @return {@link KogakuGassanShikyuFushikyuKettei}のインスタンス
     */
    public KogakuGassanShikyuFushikyuKettei build() {
        return new KogakuGassanShikyuFushikyuKettei(entity, id);
    }
}
