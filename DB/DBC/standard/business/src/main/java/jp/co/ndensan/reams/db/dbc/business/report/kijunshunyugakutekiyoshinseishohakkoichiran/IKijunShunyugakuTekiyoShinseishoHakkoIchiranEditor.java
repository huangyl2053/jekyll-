...
/**
 * 帳票設計_DBC200088_基準収入額適用申請書一覧表 Editorするクラスです.
 *
 * @reamsid_L DBC-4640-060 lijian
 */
public interface IKijunShunyugakuTekiyoShinseishoHakkoIchiranEditor extends IReportEditor<KijunShunyugakuTekiyoShinseishoHakkoIchiranSource> {
