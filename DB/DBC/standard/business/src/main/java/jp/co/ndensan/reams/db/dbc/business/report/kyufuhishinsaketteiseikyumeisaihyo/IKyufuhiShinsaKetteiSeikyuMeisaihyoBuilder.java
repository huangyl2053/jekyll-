...
/**
 * 介護給付費等審査決定請求明細表のBuilderインターフェースです。
 *
 * @reamsid_L DBC-2500-030 jiangxiaolong
 */
public interface IKyufuhiShinsaKetteiSeikyuMeisaihyoBuilder extends IReportBuilder<KyufuhiShinsaKetteiSeikyuMeisaihyoSource> {
