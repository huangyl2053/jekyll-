...
/**
 * 高額サービス等支給（不支給）決定通知書（単）エディターのインターフェースクラスです。
 *
 * @reamsid_L DBC-5160-050 donghj
 */
interface IKogakuKetteiTsuchiShoShiharaiYoteiBiYijiNashiEditor extends
        IReportEditor<KogakuKetteiTsuchiShoShiharaiYoteiBiYijiNashiSource> {
