...
/**
 * 帳票設計_DBCMN32003_介護保険高額サービス費受領委任契約承認（不承認）確認書IEditor
 *
 * @reamsid_L DBC-1970-040 jiangxiaolong
 */
public interface IKogakuServiceHiJyuryoItakuKeiyakuKakuninShoEditor extends
        IReportEditor<KogakuServiceHiJyuryoItakuKeiyakuKakuninShoSource> {
