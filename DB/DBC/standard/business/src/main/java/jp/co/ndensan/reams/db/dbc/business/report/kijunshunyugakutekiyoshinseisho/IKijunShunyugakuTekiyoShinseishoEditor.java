...
/**
 * 帳票設計_DBC100064_基準収入額適用申請書 Editorするクラスです.
 *
 * @reamsid_L DBC-4640-040 lijian
 */
public interface IKijunShunyugakuTekiyoShinseishoEditor extends IReportEditor<KijunShunyugakuTekiyoShinseishoSource> {
