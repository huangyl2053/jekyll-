...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.dbc.DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntity;
 ...
 */
public class KyodoShoriyoJukyushaIdoKihonSofu extends ParentModelBase<KyodoShoriyoJukyushaIdoKihonSofuIdentifier, DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntity, KyodoShoriyoJukyushaIdoKihonSofu> implements Serializable {
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * 共同処理用受給者異動基本送付のみを変更対象とします。<br/>
     * {@link DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
     * @return 変更対象処理実施後の{@link KyodoShoriyoJukyushaIdoKihonSofu}
     */
    @Override
    public KyodoShoriyoJukyushaIdoKihonSofu modifiedModel() {
        DbT3002KyodoShoriyoJukyushaIdoKihonSofuEntity modifiedEntity = this.toEntity();
        if (!modifiedEntity.getState().equals(EntityDataState.Added)) {
            modifiedEntity.setState(EntityDataState.Modified);
        }
        return new KyodoShoriyoJukyushaIdoKihonSofu(
                modifiedEntity, id);
    }
