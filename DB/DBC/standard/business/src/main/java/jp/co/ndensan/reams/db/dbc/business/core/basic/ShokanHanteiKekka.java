...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.dbc.DbT3036ShokanHanteiKekkaEntity;
 ...
 * 償還払支給判定結果を管理するクラスです。
 */
public class ShokanHanteiKekka extends ParentModelBase<ShokanHanteiKekkaIdentifier, DbT3036ShokanHanteiKekkaEntity, ShokanHanteiKekka> implements Serializable {
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * 償還払支給判定結果のみを変更対象とします。<br/>
     * {@link DbT3036ShokanHanteiKekkaEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
     * @return 変更対象処理実施後の{@link ShokanHanteiKekka}
     */
    @Override
    public ShokanHanteiKekka modifiedModel() {
        DbT3036ShokanHanteiKekkaEntity modifiedEntity = this.toEntity();
        if (!modifiedEntity.getState().equals(EntityDataState.Added)) {
            modifiedEntity.setState(EntityDataState.Modified);
        }
        return new ShokanHanteiKekka(
                modifiedEntity, id);
    }
