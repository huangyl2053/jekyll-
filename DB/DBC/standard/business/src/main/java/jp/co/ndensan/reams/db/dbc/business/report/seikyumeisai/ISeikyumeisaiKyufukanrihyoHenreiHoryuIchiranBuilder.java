...
/**
 * 請求明細・給付管理票返戻（保留）一覧表Builderのインターフェースクラスです。
 *
 * @reamsid_L DBC-2830-030 xuyannan
 */
public interface ISeikyumeisaiKyufukanrihyoHenreiHoryuIchiranBuilder
        extends IReportBuilder<SeikyumeisaiKyufukanrihyoHenreiHoryuIchiranReportSource> {
}
