...
/**
 * 帳票設計_DBC200006_受給者台帳（一覧表）IBuilderのインターフェースクラスです。
 *
 * @reamsid_L DBC-2740-010 fuyanling
 */
public interface IKokuhorenJukyushaDaichoIchiranBuilder
        extends IReportBuilder<JukyushaKoshinkekkaIchiranSource> {
