...
/**
 *
 * 帳票設計_DBC200037_高額合算支給額計算結果連絡票情報取込一覧表のEditorrクラスです。
 *
 * @reamsid_L DBC-2680-030 qinzhen
 */
public class GassanShikyugakuTorikomiIchiranEditor implements
        IGassanShikyugakuTorikomiIchiranEditor {
     ...
     *
     */
    public GassanShikyugakuTorikomiIchiranEditor(KogakuGassanShikyugakuKeisanKekkaIn entity) {
        this.entity = entity;

    }

    @Override
    public GassanShikyugakuTorikomiIchiranSource edit(GassanShikyugakuTorikomiIchiranSource source) {
