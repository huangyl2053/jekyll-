...
/**
 * 帳票設計_DBC100031_高額サービス費受領委任契約承認（不承認）確認書IEditor
 *
 * @reamsid_L DBC-1980-040 qinzhen
 */
public interface IKogakuServiceJyuryoKakuninShoEditor extends
        IReportEditor<KogakuServiceJyuryoKakuninShoSource> {
