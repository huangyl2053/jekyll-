...
/**
 * 総合事業費等請求額通知書（公費負担者分）帳票Builderのインターフェースクラスです。
 *
 * @reamsid_L DBC-4700-040 zhangyaru
 */
public interface ISogojigyohiSeikyugakuTsuchishoKohiEditor
        extends IReportEditor<SogojigyohiSeikyugakuTsuchishoKohiSource> {
