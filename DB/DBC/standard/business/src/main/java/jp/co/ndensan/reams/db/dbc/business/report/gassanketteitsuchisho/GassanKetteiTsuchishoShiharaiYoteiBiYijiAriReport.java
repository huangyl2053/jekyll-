 ...
 */
public class GassanKetteiTsuchishoShiharaiYoteiBiYijiAriReport extends
        Report<GassanKetteiTsuchishoShiharaiYoteiBiYijiAriSource> {
     ...
     */
    public GassanKetteiTsuchishoShiharaiYoteiBiYijiAriReport(KogakuGassanShikyuKetteiTsuchishoEntity entity,
    ...
    public void writeBy(ReportSourceWriter<GassanKetteiTsuchishoShiharaiYoteiBiYijiAriSource> writer) {
        ...
        IGassanKetteiTsuchishoShiharaiYoteiBiYijiAriEditor editor
                = new GassanKetteiTsuchishoShiharaiYoteiBiYijiAriEditor(entity, ninshoshaSource, 帳票制御汎用キー);
        IGassanKetteiTsuchishoShiharaiYoteiBiYijiAriBuilder builder
                = new GassanKetteiTsuchishoShiharaiYoteiBiYijiAriBuilder(editor);
