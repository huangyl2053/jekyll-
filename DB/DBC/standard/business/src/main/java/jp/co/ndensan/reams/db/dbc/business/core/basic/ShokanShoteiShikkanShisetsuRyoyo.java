...
import jp.co.ndensan.reams.db.dbc.entity.db.basic.dbc.DbT3052ShokanShoteiShikkanShisetsuRyoyoEntity;
 ...
 */
public class ShokanShoteiShikkanShisetsuRyoyo extends ParentModelBase<ShokanShoteiShikkanShisetsuRyoyoIdentifier, DbT3052ShokanShoteiShikkanShisetsuRyoyoEntity, ShokanShoteiShikkanShisetsuRyoyo> implements Serializable {
...
//TODO getterを見直してください。意味のある単位でValueObjectを作成して公開してください。
    ...
    /**
     * 償還払請求所定疾患施設療養費等のみを変更対象とします。<br/>
     * {@link DbT3052ShokanShoteiShikkanShisetsuRyoyoEntity}の{@link EntityDataState}がすでにDBへ永続化されている物であれば変更状態にします。
     *
     * @return 変更対象処理実施後の{@link ShokanShoteiShikkanShisetsuRyoyo}
     */
    @Override
    public ShokanShoteiShikkanShisetsuRyoyo modifiedModel() {
        DbT3052ShokanShoteiShikkanShisetsuRyoyoEntity modifiedEntity = this.toEntity();
        if (!modifiedEntity.getState().equals(EntityDataState.Added)) {
            modifiedEntity.setState(EntityDataState.Modified);
        }
        return new ShokanShoteiShikkanShisetsuRyoyo(
                modifiedEntity, id);
    }
