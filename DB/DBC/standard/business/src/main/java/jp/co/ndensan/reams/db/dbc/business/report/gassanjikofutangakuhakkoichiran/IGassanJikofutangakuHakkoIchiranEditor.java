...
/**
 * 帳票設計_DBC200035_高額合算自己負担額証明書発行一覧表IEditor
 *
 * @reamsid_L DBC-2380-040 qinzhen
 */
public interface IGassanJikofutangakuHakkoIchiranEditor extends
        IReportEditor<GassanJikofutangakuHakkoIchiranSource> {
