...
/**
 * 帳票設計_DBC200022_償還払不支給決定者一覧表 IShokanFushikyuKetteiInBuilder
 *
 * @reamsid_L DBC-2590-040 xuhao
 */
public interface IShokanFushikyuKetteiInBuilder extends IReportBuilder<ShokanbaraiFushikyuKetteishaIchiranSource> {
