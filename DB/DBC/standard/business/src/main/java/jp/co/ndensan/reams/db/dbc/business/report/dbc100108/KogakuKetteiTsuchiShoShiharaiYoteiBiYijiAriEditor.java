...
/**
 * 高額サービス等支給（不支給）決定通知書(支払予定日あり)のEditorです。
 *
...
public class KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriEditor implements IKogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriEditor {
     ...
     */
    public KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriEditor(JigyouKetteiTutisyoEntity 決定通知書Entity,
    ...
    @Override
    public KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriSource edit(KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriSource source) {
        return editSource(source);
    }

    private KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriSource editSource(KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriSource source) {
    ...
    private void setCompSofubutsuAtesaki(KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriSource source) {
    ...
    private void setCompNinshosha(KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriSource source) {
    ...
    private void setレイヤ1(KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriSource source) {
    ...
    private void setレイヤ1通知文(KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriSource source) {
        source.toiawasesaki = 決定通知書Entity.get通知文1();
    }

    private void setレイヤフォント大(KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriSource source) {
        source.tsuchibunLarge = 決定通知書Entity.get通知文2大();
    }

    private void setレイヤフォント混在(KogakuKetteiTsuchiShoShiharaiYoteiBiYijiAriSource source) {
