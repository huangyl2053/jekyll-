...
/**
 *
 * 新総合事業・事業高額決定通知書（単）帳票Editor
 *
 * @reamsid_L DBC-4760-030 yebangqiang
 */
public class JigyoKogakuKetteiTsuchishoYoteiBiYijiNashiEditor implements IJigyoKogakuKetteiTsuchishoYoteiBiYijiNashiEditor {
     ...
     * @param kyotsu 帳票制御共通
     */
    protected JigyoKogakuKetteiTsuchishoYoteiBiYijiNashiEditor(JigyouKetteiTutisyoResult entity,
            NinshoshaSource 認証者情報, ChohyoSeigyoKyotsu kyotsu) {
        this.entity = entity;
        this.kyotsu = kyotsu;
        this.認証者情報 = 認証者情報;
    }
    ...
    @Override
    public JigyoKogakuKetteiTsuchishoYoteiBiYijiNashiSource edit(JigyoKogakuKetteiTsuchishoYoteiBiYijiNashiSource source) {
