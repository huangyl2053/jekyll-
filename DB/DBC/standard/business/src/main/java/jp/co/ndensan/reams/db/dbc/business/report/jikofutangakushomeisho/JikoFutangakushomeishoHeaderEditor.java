 ...
 */
public class JikoFutangakushomeishoHeaderEditor implements IJikoFutangakushomeishoEditor {
     ...
     * @param data 自己負担証明書
     */
    protected JikoFutangakushomeishoHeaderEditor(JikoFutangakushomeishoData data) {
        this.data = data;
    }
