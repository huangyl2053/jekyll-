 ...
 */
public class GassanKetteiTsuchishoShiharaiYoteiBiYijiAriEditor implements
        IGassanKetteiTsuchishoShiharaiYoteiBiYijiAriEditor {
     ...
     */
    protected GassanKetteiTsuchishoShiharaiYoteiBiYijiAriEditor(KogakuGassanShikyuKetteiTsuchishoEntity entity,
    ...
    @Override
    public GassanKetteiTsuchishoShiharaiYoteiBiYijiAriSource edit(GassanKetteiTsuchishoShiharaiYoteiBiYijiAriSource source) {
        editSource(source);
        return source;
    }
    ...
    private void set高額合算支給不支給決定(GassanKetteiTsuchishoShiharaiYoteiBiYijiAriSource source) {
        ...
        if (高額合算支給不支給決定.getShikyuSeiriNo() != null) {
            source.tsuchi_no = 高額合算支給不支給決定.getShikyuSeiriNo();
        }
    }
