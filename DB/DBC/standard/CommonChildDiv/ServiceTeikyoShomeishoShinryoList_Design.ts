...
module DBC {
     ...
     * ServiceTeikyoShomeishoShinryoListクラスのみで継承して使えます。
     */
    export class ServiceTeikyoShomeishoShinryoList_Design extends Uz.CommonChildDiv {
        ...
        constructor($parentElement: JQuery, isDesignMode: bool, fieldName: string) {
            super($parentElement, isDesignMode, ServiceTeikyoShomeishoShinryoList_Design.myLayout, fieldName);
        }
