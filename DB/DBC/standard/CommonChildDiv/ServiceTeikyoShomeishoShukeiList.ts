/// <reference path="ServiceTeikyoShomeishoShukeiList_Design.ts" />
    ...
    export module ServiceTeikyoShomeishoShukeiList {
        ...
        export class PublicProperties {
            ...
            public getMeisaiListGridSetting() {
                return this.controls.dgServiceTeikyoShomeishoShukeiList().gridSetting;
            }

            public setMeisaiListGridSetting(value) {
                this.controls.dgServiceTeikyoShomeishoShukeiList().gridSetting = value;
            }
            */
