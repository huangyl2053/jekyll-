...
/**
 * {@link HihokenshaShisetsuNyutaishoAliveIdentifier}のテストクラスです。
 */
@RunWith(Enclosed.class)
public class HihokenshaShisetsuNyutaishoAliveIdentifierTest extends DbxTestBase {
...
//TODO 主キー値を適切な値に置換してください
    ...
    public static class シリアライズテスト extends DbxTestBase {
        ...
        public void シリアライズできる() {
            HihokenshaShisetsuNyutaishoAliveIdentifier sut = new HihokenshaShisetsuNyutaishoAliveIdentifier(主キー名1, 主キー名2);
