...
//TODO 主キー値を適切な値に置換してください
    ...
    public static class getterSetterTest extends DbxTestBase {
        ...
        @Before
        public void setUp() {
            JuryoIninKeiyakuJigyoshaEntity = new DbT7061JuryoIninKeiyakuJigyoshaEntity();
...
//TODO Key項目のテストメソッドは削除して下さい。
        ...
        public void 戻り値の受領委任契約事業者番号は_設定した値と同じ受領委任契約事業者番号を返す() {
            business = sut.set受領委任契約事業者番号(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_受領委任契約事業者番号).build();
            assertThat(business.get受領委任契約事業者番号(), is(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_受領委任契約事業者番号));
        }

        @Test
        public void 戻り値の受領委任契約開始日は_設定した値と同じ受領委任契約開始日を返す() {
            business = sut.set受領委任契約開始日(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_受領委任契約開始日).build();
            assertThat(business.get受領委任契約開始日(), is(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_受領委任契約開始日));
        }

        @Test
        public void 戻り値の受領委任契約終了日は_設定した値と同じ受領委任契約終了日を返す() {
            business = sut.set受領委任契約終了日(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_受領委任契約終了日).build();
            assertThat(business.get受領委任契約終了日(), is(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_受領委任契約終了日));
        }
        ...
        public void 戻り値の契約事業者郵便番号は_設定した値と同じ契約事業者郵便番号を返す() {
            business = sut.set契約事業者郵便番号(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_契約事業者郵便番号).build();
            assertThat(business.get契約事業者郵便番号(), is(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_契約事業者郵便番号));
        }

        @Test
        public void 戻り値の契約事業者住所は_設定した値と同じ契約事業者住所を返す() {
            business = sut.set契約事業者住所(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_契約事業者住所).build();
            assertThat(business.get契約事業者住所(), is(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_契約事業者住所));
        }

        @Test
        public void 戻り値の契約事業者電話番号は_設定した値と同じ契約事業者電話番号を返す() {
            business = sut.set契約事業者電話番号(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_契約事業者電話番号).build();
            assertThat(business.get契約事業者電話番号(), is(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_契約事業者電話番号));
        }

        @Test
        public void 戻り値の契約事業者FAX番号は_設定した値と同じ契約事業者FAX番号を返す() {
            business = sut.set契約事業者FAX番号(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_契約事業者FAX番号).build();
            assertThat(business.get契約事業者FAX番号(), is(DbT7061JuryoIninKeiyakuJigyoshaEntityGenerator.DEFAULT_契約事業者FAX番号));
        }
