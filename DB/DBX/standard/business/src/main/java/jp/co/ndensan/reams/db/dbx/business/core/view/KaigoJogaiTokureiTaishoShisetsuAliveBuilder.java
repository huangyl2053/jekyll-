...
/**
 * {@link KaigoJogaiTokureiTaishoShisetsuAlive}の編集を行うビルダークラスです。
 */
public class KaigoJogaiTokureiTaishoShisetsuAliveBuilder {
    ...
    /**
     * {@link DbV1005KaigoJogaiTokureiTaishoShisetsuEntity}より{@link KaigoJogaiTokureiTaishoShisetsuAlive}の編集用Builderクラスを生成します。
     *
     ...
     *
     */
    KaigoJogaiTokureiTaishoShisetsuAliveBuilder(
...
//TODO 一緒に置換される値のまとまりで不変なクラスを作成し、その単位でsetterを作る様に見直してください。
     ...
     *
     * @param 事業者種別 事業者種別
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set事業者種別(RString 事業者種別) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set事業者番号(RString 事業者番号) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set有効開始年月日(FlexibleDate 有効開始年月日) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set有効終了年月日(FlexibleDate 有効終了年月日) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set管内管外区分(RString 管内管外区分) {
        requireNonNull(管内管外区分, UrSystemErrorMessages.値がnull.getReplacedMessage("管内管外区分"));
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set事業者名称(AtenaMeisho 事業者名称) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set事業者名称カナ(AtenaKanaMeisho 事業者名称カナ) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set郵便番号(YubinNo 郵便番号) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set事業者住所(RString 事業者住所) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set事業者住所カナ(RString 事業者住所カナ) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set電話番号(TelNo 電話番号) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder setFAX番号(TelNo FAX番号) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set異動事由(RString 異動事由) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set異動年月日(FlexibleDate 異動年月日) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set代表者名称(AtenaMeisho 代表者名称) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set代表者名称カナ(AtenaKanaMeisho 代表者名称カナ) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set役職(RString 役職) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set備考(RString 備考) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set事業開始年月日(FlexibleDate 事業開始年月日) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set事業休止年月日(FlexibleDate 事業休止年月日) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set事業廃止年月日(FlexibleDate 事業廃止年月日) {
     ...
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAliveBuilder}
     */
    public KaigoJogaiTokureiTaishoShisetsuAliveBuilder set事業再開年月日(FlexibleDate 事業再開年月日) {
    ...
    /**
     * {@link KaigoJogaiTokureiTaishoShisetsuAlive}のインスタンスを生成します。
     *
     * @return {@link KaigoJogaiTokureiTaishoShisetsuAlive}のインスタンス
     */
    public KaigoJogaiTokureiTaishoShisetsuAlive build() {
        return new KaigoJogaiTokureiTaishoShisetsuAlive(entity, id);
    }
}
