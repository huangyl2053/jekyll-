...
/**
 * 利用者負担割合・福祉Viewテーブルの項目定義クラスです。
 */
public enum DbV7511RiyoshaFutanWariaiFukushi implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.3">
    ...
    private DbV7511RiyoshaFutanWariaiFukushi(int maxLength, int scale) {
