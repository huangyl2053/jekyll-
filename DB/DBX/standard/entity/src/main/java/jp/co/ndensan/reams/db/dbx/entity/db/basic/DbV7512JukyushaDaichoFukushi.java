...
/**
 * 受給者台帳・福祉Viewテーブルの項目定義クラスです。
 */
@OnNextSchema("rgdb")
public enum DbV7512JukyushaDaichoFukushi implements IColumnDefinition {
// <editor-fold defaultstate="collapsed" desc="Created By POJO Tool ver 1.4.3">
    ...
    private DbV7512JukyushaDaichoFukushi(int maxLength, int scale) {
