 ...
 */
public class TokuchoTembikiChoshuhohoKoshinProcess
        extends BatchProcessBase<TokuchoTenbikiTeishiChoshuhohokoshinEntity> {
    ...
    private static final RString PATH = new RString("jp.co.ndensan.reams.db.dbx.persistence.db.mapper.relate"
            + ".tokuchotenbikiteishichoshuhohokoshin.ITokuchoTenbikiTeishiChoshuhohokoshinMapper.getResults");
    ...
    @Override
    protected void process(TokuchoTenbikiTeishiChoshuhohokoshinEntity entity) {
        List<DbV2001ChoshuHohoEntity> 介護徴収方法ビューリスト = entity.get介護徴収方法();
        if (介護徴収方法ビューリスト == null || 介護徴収方法ビューリスト.isEmpty()) {
            return;
        }
