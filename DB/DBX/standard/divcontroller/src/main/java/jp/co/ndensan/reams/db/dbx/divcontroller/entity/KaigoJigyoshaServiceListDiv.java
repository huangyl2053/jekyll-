 ...
 * 不正な動作の原因になります。
 */
import jp.co.ndensan.reams.db.dbx.divcontroller.entity.IKaigoJigyoshaServiceListDiv;
import com.fasterxml.jackson.annotation.JsonProperty;
import jp.co.ndensan.reams.db.dbx.divcontroller.entity.dgKaigoJigyoshaService_Row;
