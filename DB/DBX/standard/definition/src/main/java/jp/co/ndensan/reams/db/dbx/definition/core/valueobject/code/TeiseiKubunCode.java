 ...
 * @reference
 */
public class TeiseiKubunCode implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.訂正区分コード.getCodeShubetsu();
    }
     ...
     * @param code 訂正区分コード
     */
    public TeiseiKubunCode(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 訂正区分コードを表す文字列
     */
    public TeiseiKubunCode(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TeiseiKubunCode other = (TeiseiKubunCode) obj;
