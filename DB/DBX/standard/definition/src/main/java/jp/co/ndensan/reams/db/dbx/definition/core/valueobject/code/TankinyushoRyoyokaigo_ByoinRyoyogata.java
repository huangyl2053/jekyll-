...
/**
 * 短期入所療養介護_病院療養型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 短期入所療養介護_病院療養型
 * @bizDomain
 ...
 * @reference
 */
public class TankinyushoRyoyokaigo_ByoinRyoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所療養介護_病院療養型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_病院療養型
     */
    public TankinyushoRyoyokaigo_ByoinRyoyogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_病院療養型を表す文字列
     */
    public TankinyushoRyoyokaigo_ByoinRyoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigo_ByoinRyoyogata other = (TankinyushoRyoyokaigo_ByoinRyoyogata) obj;
