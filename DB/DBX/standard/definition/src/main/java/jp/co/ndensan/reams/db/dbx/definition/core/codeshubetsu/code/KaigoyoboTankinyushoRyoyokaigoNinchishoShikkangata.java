 ...
 * @reference
 */
public class KaigoyoboTankinyushoRyoyokaigoNinchishoShikkangata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KaigoyoboTankinyushoRyoyokaigoNinchishoShikkangata(Code code) {
        this.code = code;
    }
     ...
     */
    public KaigoyoboTankinyushoRyoyokaigoNinchishoShikkangata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTankinyushoRyoyokaigoNinchishoShikkangata other = (KaigoyoboTankinyushoRyoyokaigoNinchishoShikkangata) obj;
