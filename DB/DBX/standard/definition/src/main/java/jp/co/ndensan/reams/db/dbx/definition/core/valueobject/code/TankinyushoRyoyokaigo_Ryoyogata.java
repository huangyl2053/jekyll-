 ...
 * @reference
 */
public class TankinyushoRyoyokaigo_Ryoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所療養介護_療養型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_療養型
     */
    public TankinyushoRyoyokaigo_Ryoyogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_療養型を表す文字列
     */
    public TankinyushoRyoyokaigo_Ryoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigo_Ryoyogata other = (TankinyushoRyoyokaigo_Ryoyogata) obj;
