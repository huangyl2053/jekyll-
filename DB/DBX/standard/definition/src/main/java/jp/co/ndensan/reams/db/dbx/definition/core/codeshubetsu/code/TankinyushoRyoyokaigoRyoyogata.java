 ...
 * @reference
 */
public class TankinyushoRyoyokaigoRyoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public TankinyushoRyoyokaigoRyoyogata(Code code) {
        this.code = code;
    }
     ...
     */
    public TankinyushoRyoyokaigoRyoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigoRyoyogata other = (TankinyushoRyoyokaigoRyoyogata) obj;
