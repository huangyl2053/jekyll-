...
/**
 * 訪問看護_平成24年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 訪問看護_平成24年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class Homonkango_AfterH24_4 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.訪問看護_平成24年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 訪問看護_平成24年4月以降
     */
    public Homonkango_AfterH24_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 訪問看護_平成24年4月以降を表す文字列
     */
    public Homonkango_AfterH24_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Homonkango_AfterH24_4 other = (Homonkango_AfterH24_4) obj;
