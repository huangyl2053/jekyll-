 ...
 * @reference
 */
public class UnitCareTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.ユニットケア体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code ユニットケア体制の有無
     */
    public UnitCareTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code ユニットケア体制の有無を表す文字列
     */
    public UnitCareTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final UnitCareTaiseiUmu other = (UnitCareTaiseiUmu) obj;
