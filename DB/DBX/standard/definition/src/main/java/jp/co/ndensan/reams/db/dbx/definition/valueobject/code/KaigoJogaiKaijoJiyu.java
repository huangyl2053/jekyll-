 ...
 * @reference
 */
public class KaigoJogaiKaijoJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護除外解除事由.getCodeShubetsu();
    }
     ...
     * @param code 介護除外解除事由
     */
    public KaigoJogaiKaijoJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護除外解除事由を表す文字列
     */
    public KaigoJogaiKaijoJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoJogaiKaijoJiyu other = (KaigoJogaiKaijoJiyu) obj;
