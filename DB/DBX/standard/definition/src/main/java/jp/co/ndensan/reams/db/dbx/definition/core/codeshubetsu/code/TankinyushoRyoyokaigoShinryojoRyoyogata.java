 ...
 * @reference
 */
public class TankinyushoRyoyokaigoShinryojoRyoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public TankinyushoRyoyokaigoShinryojoRyoyogata(Code code) {
        this.code = code;
    }
     ...
     */
    public TankinyushoRyoyokaigoShinryojoRyoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigoShinryojoRyoyogata other = (TankinyushoRyoyokaigoShinryojoRyoyogata) obj;
