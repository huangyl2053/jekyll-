 ...
 * @reference
 */
public class TankinyushoRyoyokaigo_Tsujogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所療養介護_通常型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_通常型
     */
    public TankinyushoRyoyokaigo_Tsujogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_通常型を表す文字列
     */
    public TankinyushoRyoyokaigo_Tsujogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigo_Tsujogata other = (TankinyushoRyoyokaigo_Tsujogata) obj;
