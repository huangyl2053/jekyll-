 ...
 * @reference
 */
public class ShintaikosokuHaishiTorikumiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.身体拘束廃止取組の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 身体拘束廃止取組の有無
     */
    public ShintaikosokuHaishiTorikumiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 身体拘束廃止取組の有無を表す文字列
     */
    public ShintaikosokuHaishiTorikumiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShintaikosokuHaishiTorikumiUmu other = (ShintaikosokuHaishiTorikumiUmu) obj;
