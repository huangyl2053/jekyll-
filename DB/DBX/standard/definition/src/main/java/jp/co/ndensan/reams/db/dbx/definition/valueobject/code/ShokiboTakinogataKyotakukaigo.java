 ...
 * @reference
 */
public class ShokiboTakinogataKyotakukaigo implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.小規模多機能型居宅介護.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 小規模多機能型居宅介護
     */
    public ShokiboTakinogataKyotakukaigo(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 小規模多機能型居宅介護を表す文字列
     */
    public ShokiboTakinogataKyotakukaigo(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShokiboTakinogataKyotakukaigo other = (ShokiboTakinogataKyotakukaigo) obj;
