 ...
 * @reference
 */
public class RyoyoshokuKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.療養食加算.getCodeShubetsu();
    }
     ...
     * @param code 療養食加算
     */
    public RyoyoshokuKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 療養食加算を表す文字列
     */
    public RyoyoshokuKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RyoyoshokuKasan other = (RyoyoshokuKasan) obj;
