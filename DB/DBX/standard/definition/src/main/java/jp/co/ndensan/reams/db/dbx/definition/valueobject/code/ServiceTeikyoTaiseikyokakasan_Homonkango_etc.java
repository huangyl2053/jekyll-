...
/**
 * サービス提供体制強化加算_訪問看護等を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName サービス提供体制強化加算_訪問看護等
 * @bizDomain
 ...
 * @reference
 */
public class ServiceTeikyoTaiseikyokakasan_Homonkango_etc implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.サービス提供体制強化加算_訪問看護等.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code サービス提供体制強化加算_訪問看護等
     */
    public ServiceTeikyoTaiseikyokakasan_Homonkango_etc(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code サービス提供体制強化加算_訪問看護等を表す文字列
     */
    public ServiceTeikyoTaiseikyokakasan_Homonkango_etc(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ServiceTeikyoTaiseikyokakasan_Homonkango_etc other = (ServiceTeikyoTaiseikyokakasan_Homonkango_etc) obj;
