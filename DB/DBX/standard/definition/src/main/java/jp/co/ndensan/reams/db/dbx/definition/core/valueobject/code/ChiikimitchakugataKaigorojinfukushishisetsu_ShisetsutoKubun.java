...
/**
 * 地域密着型介護老人福祉施設_施設等の区分を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 地域密着型介護老人福祉施設_施設等区分
 * @bizDomain
 ...
 * @reference
 */
public class ChiikimitchakugataKaigorojinfukushishisetsu_ShisetsutoKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 地域密着型介護老人福祉施設_施設等の区分を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.地域密着型介護老人福祉施設_施設等の区分.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 地域密着型介護老人福祉施設_施設等の区分
     */
    public ChiikimitchakugataKaigorojinfukushishisetsu_ShisetsutoKubun(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 地域密着型介護老人福祉施設_施設等の区分を表す文字列
     */
    public ChiikimitchakugataKaigorojinfukushishisetsu_ShisetsutoKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ChiikimitchakugataKaigorojinfukushishisetsu_ShisetsutoKubun other = (ChiikimitchakugataKaigorojinfukushishisetsu_ShisetsutoKubun) obj;
