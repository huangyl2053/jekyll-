 ...
 * @reference
 */
public class KobetsuRehabilitationTeikyoTaiseiUmuGengoChokakuRyoho2 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuGengoChokakuRyoho2(Code code) {
        this.code = code;
    }
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuGengoChokakuRyoho2(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuRehabilitationTeikyoTaiseiUmuGengoChokakuRyoho2 other = (KobetsuRehabilitationTeikyoTaiseiUmuGengoChokakuRyoho2) obj;
