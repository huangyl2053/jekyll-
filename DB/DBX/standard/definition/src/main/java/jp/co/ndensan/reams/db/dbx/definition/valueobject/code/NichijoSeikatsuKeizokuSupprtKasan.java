 ...
 * @reference
 */
public class NichijoSeikatsuKeizokuSupprtKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.日常生活継続支援加算.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 日常生活継続支援加算
     */
    public NichijoSeikatsuKeizokuSupprtKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 日常生活継続支援加算を表す文字列
     */
    public NichijoSeikatsuKeizokuSupprtKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final NichijoSeikatsuKeizokuSupprtKasan other = (NichijoSeikatsuKeizokuSupprtKasan) obj;
