 ...
 * @reference
 */
public class KaigoyoboTankinyushoSeikatsukaigo implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防短期入所生活介護.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防短期入所生活介護
     */
    public KaigoyoboTankinyushoSeikatsukaigo(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防短期入所生活介護を表す文字列
     */
    public KaigoyoboTankinyushoSeikatsukaigo(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTankinyushoSeikatsukaigo other = (KaigoyoboTankinyushoSeikatsukaigo) obj;
