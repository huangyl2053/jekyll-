...
/**
 * 栄養マネジメント_改善_体制の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 栄養マネジメント_改善_体制有無
 * @bizDomain
 ...
 * @reference
 */
public class EiyoManagementTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.栄養マネジメント_改善_体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 栄養マネジメント_改善_体制の有無
     */
    public EiyoManagementTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 栄養マネジメント_改善_体制の有無を表す文字列
     */
    public EiyoManagementTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final EiyoManagementTaiseiUmu other = (EiyoManagementTaiseiUmu) obj;
