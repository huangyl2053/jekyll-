 ...
 * @reference
 */
public class KinkyujiHomonKaigoKasanUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.緊急時訪問看護加算の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 緊急時訪問看護加算の有無
     */
    public KinkyujiHomonKaigoKasanUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 緊急時訪問看護加算の有無を表す文字列
     */
    public KinkyujiHomonKaigoKasanUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KinkyujiHomonKaigoKasanUmu other = (KinkyujiHomonKaigoKasanUmu) obj;
