...
/**
 * 地域密着型特定施設入居者生活介護_短期利用型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 地域密着型特定施設入居者生活介護_短期利用型
 * @bizDomain
 ...
 * @reference
 */
public class ChiikimitchakugataTokuteishisetsunyukyoshaSeikatsukaigo_Tankiriyogata
    ...
    /**
     * 地域密着型特定施設入居者生活介護_短期利用型を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.地域密着型特定施設入居者生活介護_短期利用型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 地域密着型特定施設入居者生活介護_短期利用型
     */
    public ChiikimitchakugataTokuteishisetsunyukyoshaSeikatsukaigo_Tankiriyogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 地域密着型特定施設入居者生活介護_短期利用型を表す文字列
     */
    public ChiikimitchakugataTokuteishisetsunyukyoshaSeikatsukaigo_Tankiriyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ChiikimitchakugataTokuteishisetsunyukyoshaSeikatsukaigo_Tankiriyogata other
                = (ChiikimitchakugataTokuteishisetsunyukyoshaSeikatsukaigo_Tankiriyogata) obj;
