...
/**
 * 短期入所療養介護_病院経過型_平成20年5月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 短期入所療養介護_病院経過型_平成20年5月以降
 * @bizDomain
 ...
 * @reference
 */
public class TankinyushoRyoyokaigo_Byoinkeikagata_AfterH20_5 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 短期入所療養介護_病院経過型_平成20年5月以降を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所療養介護_病院経過型_平成20年5月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_病院経過型_平成20年5月以降
     */
    public TankinyushoRyoyokaigo_Byoinkeikagata_AfterH20_5(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_病院経過型_平成20年5月以降を表す文字列
     */
    public TankinyushoRyoyokaigo_Byoinkeikagata_AfterH20_5(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigo_Byoinkeikagata_AfterH20_5 other = (TankinyushoRyoyokaigo_Byoinkeikagata_AfterH20_5) obj;
