...
/**
 * 介護療養型医療施設_診療所型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護療養型医療施設_診療所型
 * @bizDomain
 ...
 * @reference
 */
public class KaigoryoyogataIryoshisetsu_Shinryojogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護療養型医療施設_診療所型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_診療所型
     */
    public KaigoryoyogataIryoshisetsu_Shinryojogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_診療所型を表す文字列
     */
    public KaigoryoyogataIryoshisetsu_Shinryojogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoryoyogataIryoshisetsu_Shinryojogata other = (KaigoryoyogataIryoshisetsu_Shinryojogata) obj;
