 ...
 * @reference
 */
public class NinchishoSemmontoUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.認知症専門棟の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 認知症専門棟の有無
     */
    public NinchishoSemmontoUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 認知症専門棟の有無を表す文字列
     */
    public NinchishoSemmontoUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final NinchishoSemmontoUmu other = (NinchishoSemmontoUmu) obj;
