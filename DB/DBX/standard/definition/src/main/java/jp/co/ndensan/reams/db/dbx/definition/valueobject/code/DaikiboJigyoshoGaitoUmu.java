 ...
 * @reference
 */
public class DaikiboJigyoshoGaitoUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.大規模事業所該当の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 大規模事業所該当の有無
     */
    public DaikiboJigyoshoGaitoUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 大規模事業所該当の有無を表す文字列
     */
    public DaikiboJigyoshoGaitoUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final DaikiboJigyoshoGaitoUmu other = (DaikiboJigyoshoGaitoUmu) obj;
