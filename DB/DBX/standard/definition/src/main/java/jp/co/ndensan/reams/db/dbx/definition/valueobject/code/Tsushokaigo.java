 ...
 * @reference
 */
public class Tsushokaigo implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.通所介護.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 通所介護を表す文字列
     */
    public Tsushokaigo(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Tsushokaigo other = (Tsushokaigo) obj;
