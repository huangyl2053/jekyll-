...
/**
 * 理学療法士の欠員による減算の状況の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 理学療法士の欠員による減算の状況有無
 * @bizDomain
 ...
 * @reference
 */
public class GenzanJokyoUmuByRigakuryohoshiKetsuin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.理学療法士の欠員による減算の状況の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 理学療法士の欠員による減算の状況の有無
     */
    public GenzanJokyoUmuByRigakuryohoshiKetsuin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 理学療法士の欠員による減算の状況の有無を表す文字列
     */
    public GenzanJokyoUmuByRigakuryohoshiKetsuin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final GenzanJokyoUmuByRigakuryohoshiKetsuin other = (GenzanJokyoUmuByRigakuryohoshiKetsuin) obj;
