 ...
 * @reference
 */
public class YakinStaffHaichiKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.夜勤職員配置加算.getCodeShubetsu();
    }
     ...
     * @param code 夜勤職員配置加算
     */
    public YakinStaffHaichiKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 夜勤職員配置加算を表す文字列
     */
    public YakinStaffHaichiKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final YakinStaffHaichiKasan other = (YakinStaffHaichiKasan) obj;
