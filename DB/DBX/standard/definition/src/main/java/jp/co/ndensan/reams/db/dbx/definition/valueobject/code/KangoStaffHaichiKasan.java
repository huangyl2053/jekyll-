 ...
 * @reference
 */
public class KangoStaffHaichiKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.看護職員配置加算.getCodeShubetsu();
    }
     ...
     * @param code 看護職員配置加算
     */
    public KangoStaffHaichiKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 看護職員配置加算を表す文字列
     */
    public KangoStaffHaichiKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KangoStaffHaichiKasan other = (KangoStaffHaichiKasan) obj;
