 ...
 * @reference
 */
public class ShokiboJigyoshoKasanInMountainAreaSituationAboutScale implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public ShokiboJigyoshoKasanInMountainAreaSituationAboutScale(Code code) {
        this.code = code;
    }
     ...
     */
    public ShokiboJigyoshoKasanInMountainAreaSituationAboutScale(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShokiboJigyoshoKasanInMountainAreaSituationAboutScale other = (ShokiboJigyoshoKasanInMountainAreaSituationAboutScale) obj;
