...
/**
 * 個別機能訓練体制の有無_通所介護_平成21年3月以前を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 個別機能訓練体制の有無_通所介護_平成21年3月以前
 * @bizDomain
 ...
 * @reference
 */
public class KobetsuKinokunrentaiseiUmu_Tsushokaigo_BeforeH21_3 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 個別機能訓練体制の有無_通所介護_平成21年3月以前を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.個別機能訓練体制の有無_通所介護_平成21年3月以前.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 個別機能訓練体制の有無_通所介護_平成21年3月以前
     */
    public KobetsuKinokunrentaiseiUmu_Tsushokaigo_BeforeH21_3(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 個別機能訓練体制の有無_通所介護_平成21年3月以前を表す文字列
     */
    public KobetsuKinokunrentaiseiUmu_Tsushokaigo_BeforeH21_3(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuKinokunrentaiseiUmu_Tsushokaigo_BeforeH21_3 other = (KobetsuKinokunrentaiseiUmu_Tsushokaigo_BeforeH21_3) obj;
