 ...
 * @reference
 */
public class KobetsuRehabilitationTeikyoTaiseiUmuSagyoRyoho implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuSagyoRyoho(Code code) {
        this.code = code;
    }
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuSagyoRyoho(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuRehabilitationTeikyoTaiseiUmuSagyoRyoho other = (KobetsuRehabilitationTeikyoTaiseiUmuSagyoRyoho) obj;
