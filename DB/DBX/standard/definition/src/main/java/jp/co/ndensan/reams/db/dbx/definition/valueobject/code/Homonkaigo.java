 ...
 * @reference
 */
public class Homonkaigo implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.訪問介護.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 訪問介護を表す文字列
     */
    public Homonkaigo(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Homonkaigo other = (Homonkaigo) obj;
