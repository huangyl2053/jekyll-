...
/**
 * 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_総合ﾘﾊﾋﾞﾘﾃｰｼｮﾝ施設_の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_総合ﾘﾊﾋﾞﾘﾃｰｼｮﾝ施設_の有無
 * @bizDomain
 ...
 * @reference
 */
public class KobetsuRehabilitationTeikyoTaiseiUmu_SogoRehabilitationShisetsu
    ...
    /**
     * 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_総合ﾘﾊﾋﾞﾘﾃｰｼｮﾝ施設_の有無を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_総合ﾘﾊﾋﾞﾘﾃｰｼｮﾝ施設_の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_総合ﾘﾊﾋﾞﾘﾃｰｼｮﾝ施設_の有無
     */
    public KobetsuRehabilitationTeikyoTaiseiUmu_SogoRehabilitationShisetsu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_総合ﾘﾊﾋﾞﾘﾃｰｼｮﾝ施設_の有無を表す文字列
     */
    public KobetsuRehabilitationTeikyoTaiseiUmu_SogoRehabilitationShisetsu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuRehabilitationTeikyoTaiseiUmu_SogoRehabilitationShisetsu other
                = (KobetsuRehabilitationTeikyoTaiseiUmu_SogoRehabilitationShisetsu) obj;
