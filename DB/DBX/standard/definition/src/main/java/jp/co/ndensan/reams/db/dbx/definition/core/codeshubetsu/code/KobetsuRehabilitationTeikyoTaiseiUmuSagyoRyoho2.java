 ...
 * @reference
 */
public class KobetsuRehabilitationTeikyoTaiseiUmuSagyoRyoho2 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuSagyoRyoho2(Code code) {
        this.code = code;
    }
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuSagyoRyoho2(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuRehabilitationTeikyoTaiseiUmuSagyoRyoho2 other = (KobetsuRehabilitationTeikyoTaiseiUmuSagyoRyoho2) obj;
