...
/**
 * 介護従業者の欠員による減算の状況の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護従業者の欠員による減算の状況有無
 * @bizDomain
 ...
 * @reference
 */
public class GenzanJokyoUmuByKaigojugyoshaKetsuin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護従業者の欠員による減算の状況の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護従業者の欠員による減算の状況の有無
     */
    public GenzanJokyoUmuByKaigojugyoshaKetsuin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護従業者の欠員による減算の状況の有無を表す文字列
     */
    public GenzanJokyoUmuByKaigojugyoshaKetsuin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final GenzanJokyoUmuByKaigojugyoshaKetsuin other = (GenzanJokyoUmuByKaigojugyoshaKetsuin) obj;
