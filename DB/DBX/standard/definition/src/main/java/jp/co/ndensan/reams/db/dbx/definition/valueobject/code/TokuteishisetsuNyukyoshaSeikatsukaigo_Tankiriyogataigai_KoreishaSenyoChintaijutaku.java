...
/**
 * 特定施設入居者生活介護_短期利用型以外_高齢者専用賃貸住宅を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 特定施設入居者生活介護_短期利用型以外_高齢者専用賃貸住宅
 * @bizDomain
 ...
 * @reference
 */
public class TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_KoreishaSenyoChintaijutaku
    ...
    /**
     * 特定施設入居者生活介護_短期利用型以外_高齢者専用賃貸住宅を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.特定施設入居者生活介護_短期利用型以外_高齢者専用賃貸住宅.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 特定施設入居者生活介護_短期利用型以外_高齢者専用賃貸住宅
     */
    public TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_KoreishaSenyoChintaijutaku(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 特定施設入居者生活介護_短期利用型以外_高齢者専用賃貸住宅を表す文字列
     */
    public TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_KoreishaSenyoChintaijutaku(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_KoreishaSenyoChintaijutaku other
                = (TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_KoreishaSenyoChintaijutaku) obj;
