 ...
 * @reference
 */
public class KaigoryoyogataIryoshisetsuByoinryoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KaigoryoyogataIryoshisetsuByoinryoyogata(Code code) {
        this.code = code;
    }
     ...
     */
    public KaigoryoyogataIryoshisetsuByoinryoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoryoyogataIryoshisetsuByoinryoyogata other = (KaigoryoyogataIryoshisetsuByoinryoyogata) obj;
