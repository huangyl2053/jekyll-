...
/**
 * 精神科医師定期的療養指導の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 精神科医師定期的療養指導有無
 * @bizDomain
 ...
 * @reference
 */
public class SeishinkaIshiTeikitekiRyoyoshidoUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.精神科医師定期的療養指導の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 精神科医師定期的療養指導の有無
     */
    public SeishinkaIshiTeikitekiRyoyoshidoUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 精神科医師定期的療養指導の有無を表す文字列
     */
    public SeishinkaIshiTeikitekiRyoyoshidoUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final SeishinkaIshiTeikitekiRyoyoshidoUmu other = (SeishinkaIshiTeikitekiRyoyoshidoUmu) obj;
