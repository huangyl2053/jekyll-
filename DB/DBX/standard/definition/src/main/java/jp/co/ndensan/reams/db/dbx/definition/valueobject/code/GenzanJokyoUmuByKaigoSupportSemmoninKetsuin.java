...
/**
 * 介護支援専門員の欠員による減算の状況の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護支援専門員の欠員による減算の状況有無
 * @bizDomain
 ...
 * @reference
 */
public class GenzanJokyoUmuByKaigoSupportSemmoninKetsuin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 介護支援専門員の欠員による減算の状況の有無を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護支援専門員の欠員による減算の状況の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護支援専門員の欠員による減算の状況の有無
     */
    public GenzanJokyoUmuByKaigoSupportSemmoninKetsuin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護支援専門員の欠員による減算の状況の有無を表す文字列
     */
    public GenzanJokyoUmuByKaigoSupportSemmoninKetsuin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final GenzanJokyoUmuByKaigoSupportSemmoninKetsuin other = (GenzanJokyoUmuByKaigoSupportSemmoninKetsuin) obj;
