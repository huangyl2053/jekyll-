 ...
 * @reference
 */
public class KinkyuTankinyushoTaiseiKakuhoKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.緊急短期入所体制確保加算.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 緊急短期入所体制確保加算
     */
    public KinkyuTankinyushoTaiseiKakuhoKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 緊急短期入所体制確保加算を表す文字列
     */
    public KinkyuTankinyushoTaiseiKakuhoKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KinkyuTankinyushoTaiseiKakuhoKasan other = (KinkyuTankinyushoTaiseiKakuhoKasan) obj;
