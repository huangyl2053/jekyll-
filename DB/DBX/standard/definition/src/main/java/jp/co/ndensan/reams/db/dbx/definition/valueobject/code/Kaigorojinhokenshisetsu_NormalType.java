 ...
 * @reference
 */
public class Kaigorojinhokenshisetsu_NormalType implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護老人保健施設_通常型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護老人保健施設_通常型
     */
    public Kaigorojinhokenshisetsu_NormalType(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護老人保健施設_通常型を表す文字列
     */
    public Kaigorojinhokenshisetsu_NormalType(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Kaigorojinhokenshisetsu_NormalType other = (Kaigorojinhokenshisetsu_NormalType) obj;
