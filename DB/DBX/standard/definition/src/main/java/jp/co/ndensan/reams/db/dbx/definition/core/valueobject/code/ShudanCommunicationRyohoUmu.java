...
/**
 * 集団コミュニケーション療法の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 集団コミュニケーション療法有無
 * @bizDomain
 ...
 * @reference
 */
public class ShudanCommunicationRyohoUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.集団コミュニケーション療法の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 集団コミュニケーション療法の有無
     */
    public ShudanCommunicationRyohoUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 集団コミュニケーション療法の有無を表す文字列
     */
    public ShudanCommunicationRyohoUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShudanCommunicationRyohoUmu other = (ShudanCommunicationRyohoUmu) obj;
