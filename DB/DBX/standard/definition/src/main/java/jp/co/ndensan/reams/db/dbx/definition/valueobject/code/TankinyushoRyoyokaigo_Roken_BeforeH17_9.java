...
/**
 * 短期入所療養介護_老健_平成17年9月以前を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 短期入所療養介護_老健_平成17年9月以前
 * @bizDomain
 ...
 * @reference
 */
public class TankinyushoRyoyokaigo_Roken_BeforeH17_9 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 短期入所療養介護_老健_平成17年9月以前を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所療養介護_老健_平成17年9月以前.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_老健_平成17年9月以前
     */
    public TankinyushoRyoyokaigo_Roken_BeforeH17_9(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_老健_平成17年9月以前を表す文字列
     */
    public TankinyushoRyoyokaigo_Roken_BeforeH17_9(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigo_Roken_BeforeH17_9 other = (TankinyushoRyoyokaigo_Roken_BeforeH17_9) obj;
