 ...
 * @reference
 */
public class KaigoServiceIdoJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護サービス異動事由.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護サービス異動事由
     */
    public KaigoServiceIdoJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護サービス異動事由を表す文字列
     */
    public KaigoServiceIdoJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoServiceIdoJiyu other = (KaigoServiceIdoJiyu) obj;
