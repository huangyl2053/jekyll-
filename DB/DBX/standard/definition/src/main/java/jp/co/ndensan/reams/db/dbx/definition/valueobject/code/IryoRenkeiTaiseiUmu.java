 ...
 * @reference
 */
public class IryoRenkeiTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.医療連携体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 医療連携体制の有無
     */
    public IryoRenkeiTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 医療連携体制の有無を表す文字列
     */
    public IryoRenkeiTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final IryoRenkeiTaiseiUmu other = (IryoRenkeiTaiseiUmu) obj;
