...
/**
 * 生活機能向上グループ活動加算を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 生活機能向上グループ活動加算
 * @bizDomain
 ...
 * @reference
 */
public class SeikatsuKinoKojoGroupKatsudoKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.生活機能向上グループ活動加算.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 生活機能向上グループ活動加算
     */
    public SeikatsuKinoKojoGroupKatsudoKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 生活機能向上グループ活動加算を表す文字列
     */
    public SeikatsuKinoKojoGroupKatsudoKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final SeikatsuKinoKojoGroupKatsudoKasan other = (SeikatsuKinoKojoGroupKatsudoKasan) obj;
