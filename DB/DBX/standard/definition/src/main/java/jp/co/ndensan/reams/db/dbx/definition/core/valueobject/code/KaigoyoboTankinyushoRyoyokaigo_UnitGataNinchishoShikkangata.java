...
/**
 * 介護予防短期入所療養介護_ユニット型認知症疾患型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防短期入所療養介護_ユニット型認知症疾患型
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboTankinyushoRyoyokaigo_UnitGataNinchishoShikkangata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 介護予防短期入所療養介護_ユニット型認知症疾患型を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防短期入所療養介護_ユニット型認知症疾患型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防短期入所療養介護_ユニット型認知症疾患型
     */
    public KaigoyoboTankinyushoRyoyokaigo_UnitGataNinchishoShikkangata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防短期入所療養介護_ユニット型認知症疾患型を表す文字列
     */
    public KaigoyoboTankinyushoRyoyokaigo_UnitGataNinchishoShikkangata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTankinyushoRyoyokaigo_UnitGataNinchishoShikkangata other = (KaigoyoboTankinyushoRyoyokaigo_UnitGataNinchishoShikkangata) obj;
