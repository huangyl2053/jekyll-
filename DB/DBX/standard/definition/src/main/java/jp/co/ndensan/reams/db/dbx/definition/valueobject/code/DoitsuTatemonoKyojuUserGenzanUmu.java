...
/**
 * 同一建物に居住する利用者の減算の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 同一建物に居住する利用者の減算有無
 * @bizDomain
 ...
 * @reference
 */
public class DoitsuTatemonoKyojuUserGenzanUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.同一建物に居住する利用者の減算の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 同一建物に居住する利用者の減算の有無
     */
    public DoitsuTatemonoKyojuUserGenzanUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 同一建物に居住する利用者の減算の有無を表す文字列
     */
    public DoitsuTatemonoKyojuUserGenzanUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final DoitsuTatemonoKyojuUserGenzanUmu other = (DoitsuTatemonoKyojuUserGenzanUmu) obj;
