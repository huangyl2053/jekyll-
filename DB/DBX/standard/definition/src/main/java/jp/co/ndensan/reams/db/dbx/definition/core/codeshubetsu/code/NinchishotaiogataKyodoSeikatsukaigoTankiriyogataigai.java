 ...
 * @reference
 */
public class NinchishotaiogataKyodoSeikatsukaigoTankiriyogataigai implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public NinchishotaiogataKyodoSeikatsukaigoTankiriyogataigai(Code code) {
        this.code = code;
    }
     ...
     */
    public NinchishotaiogataKyodoSeikatsukaigoTankiriyogataigai(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final NinchishotaiogataKyodoSeikatsukaigoTankiriyogataigai other = (NinchishotaiogataKyodoSeikatsukaigoTankiriyogataigai) obj;
