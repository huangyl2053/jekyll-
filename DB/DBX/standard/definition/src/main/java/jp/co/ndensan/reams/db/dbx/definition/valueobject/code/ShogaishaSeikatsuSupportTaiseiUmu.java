 ...
 * @reference
 */
public class ShogaishaSeikatsuSupportTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.障害者生活支援体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 障害者生活支援体制の有無
     */
    public ShogaishaSeikatsuSupportTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 障害者生活支援体制の有無を表す文字列
     */
    public ShogaishaSeikatsuSupportTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShogaishaSeikatsuSupportTaiseiUmu other = (ShogaishaSeikatsuSupportTaiseiUmu) obj;
