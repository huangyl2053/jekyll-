 ...
 * @reference
 */
public class CareerPathsTaioJokyo implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     * コンストラクタです。
     *
     * @param code キャリアパス対応の状況
     */
    public CareerPathsTaioJokyo(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code キャリアパス対応の状況を表す文字列
     */
    public CareerPathsTaioJokyo(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final CareerPathsTaioJokyo other = (CareerPathsTaioJokyo) obj;
