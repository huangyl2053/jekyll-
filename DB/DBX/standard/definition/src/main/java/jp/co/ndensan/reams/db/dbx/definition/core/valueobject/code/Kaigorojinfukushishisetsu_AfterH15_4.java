...
/**
 * 介護老人福祉施設_平成15年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護老人福祉施設_平成15年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class Kaigorojinfukushishisetsu_AfterH15_4 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護老人福祉施設_平成15年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護老人福祉施設_平成15年4月以降
     */
    public Kaigorojinfukushishisetsu_AfterH15_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護老人福祉施設_平成15年4月以降を表す文字列
     */
    public Kaigorojinfukushishisetsu_AfterH15_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Kaigorojinfukushishisetsu_AfterH15_4 other = (Kaigorojinfukushishisetsu_AfterH15_4) obj;
