 ...
 * @reference
 */
public class KaigoyoboTankinyushoRyoyokaigoByoinRyoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KaigoyoboTankinyushoRyoyokaigoByoinRyoyogata(Code code) {
        this.code = code;
    }
     ...
     */
    public KaigoyoboTankinyushoRyoyokaigoByoinRyoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTankinyushoRyoyokaigoByoinRyoyogata other = (KaigoyoboTankinyushoRyoyokaigoByoinRyoyogata) obj;
