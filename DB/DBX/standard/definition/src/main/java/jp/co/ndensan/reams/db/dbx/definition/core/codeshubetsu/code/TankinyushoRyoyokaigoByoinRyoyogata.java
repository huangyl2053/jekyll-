 ...
 * @reference
 */
public class TankinyushoRyoyokaigoByoinRyoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public TankinyushoRyoyokaigoByoinRyoyogata(Code code) {
        this.code = code;
    }
     ...
     */
    public TankinyushoRyoyokaigoByoinRyoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigoByoinRyoyogata other = (TankinyushoRyoyokaigoByoinRyoyogata) obj;
