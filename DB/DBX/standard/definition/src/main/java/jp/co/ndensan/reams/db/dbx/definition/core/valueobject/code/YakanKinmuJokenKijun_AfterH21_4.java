...
/**
 * 夜間勤務条件基準_平成21年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 夜間勤務条件基準_平成21年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class YakanKinmuJokenKijun_AfterH21_4 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.夜間勤務条件基準_平成21年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 夜間勤務条件基準_平成21年4月以降
     */
    public YakanKinmuJokenKijun_AfterH21_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 夜間勤務条件基準_平成21年4月以降を表す文字列
     */
    public YakanKinmuJokenKijun_AfterH21_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final YakanKinmuJokenKijun_AfterH21_4 other = (YakanKinmuJokenKijun_AfterH21_4) obj;
