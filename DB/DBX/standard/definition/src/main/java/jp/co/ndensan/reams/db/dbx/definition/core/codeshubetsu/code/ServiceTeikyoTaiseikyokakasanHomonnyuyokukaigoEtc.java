 ...
 * @reference
 */
public class ServiceTeikyoTaiseikyokakasanHomonnyuyokukaigoEtc implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public ServiceTeikyoTaiseikyokakasanHomonnyuyokukaigoEtc(Code code) {
        this.code = code;
    }
     ...
     */
    public ServiceTeikyoTaiseikyokakasanHomonnyuyokukaigoEtc(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ServiceTeikyoTaiseikyokakasanHomonnyuyokukaigoEtc other = (ServiceTeikyoTaiseikyokakasanHomonnyuyokukaigoEtc) obj;
