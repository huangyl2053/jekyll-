 ...
 * @reference
 */
public class TankinyushoRyoyokaigoUnitGataNinchishoShikkangata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public TankinyushoRyoyokaigoUnitGataNinchishoShikkangata(Code code) {
        this.code = code;
    }
     ...
     */
    public TankinyushoRyoyokaigoUnitGataNinchishoShikkangata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigoUnitGataNinchishoShikkangata other = (TankinyushoRyoyokaigoUnitGataNinchishoShikkangata) obj;
