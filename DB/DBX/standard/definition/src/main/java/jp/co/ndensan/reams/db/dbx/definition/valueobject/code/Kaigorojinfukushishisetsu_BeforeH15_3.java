...
/**
 * 介護老人福祉施設_平成15年3月以前を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護老人福祉施設_平成15年3月以前
 * @bizDomain
 ...
 * @reference
 */
public class Kaigorojinfukushishisetsu_BeforeH15_3 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護老人福祉施設_平成15年3月以前.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護老人福祉施設_平成15年3月以前
     */
    public Kaigorojinfukushishisetsu_BeforeH15_3(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護老人福祉施設_平成15年3月以前を表す文字列
     */
    public Kaigorojinfukushishisetsu_BeforeH15_3(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Kaigorojinfukushishisetsu_BeforeH15_3 other = (Kaigorojinfukushishisetsu_BeforeH15_3) obj;
