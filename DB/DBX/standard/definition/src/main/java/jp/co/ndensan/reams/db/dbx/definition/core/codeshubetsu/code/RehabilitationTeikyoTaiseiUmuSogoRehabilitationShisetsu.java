 ...
 * @reference
 */
public class RehabilitationTeikyoTaiseiUmuSogoRehabilitationShisetsu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public RehabilitationTeikyoTaiseiUmuSogoRehabilitationShisetsu(Code code) {
        this.code = code;
    }
     ...
     */
    public RehabilitationTeikyoTaiseiUmuSogoRehabilitationShisetsu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RehabilitationTeikyoTaiseiUmuSogoRehabilitationShisetsu other = (RehabilitationTeikyoTaiseiUmuSogoRehabilitationShisetsu) obj;
