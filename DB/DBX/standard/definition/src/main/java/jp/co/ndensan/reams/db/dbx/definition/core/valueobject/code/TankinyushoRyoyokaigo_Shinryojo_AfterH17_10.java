...
/**
 * 短期入所療養介護_診療所等_平成17年10月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 短期入所療養介護_診療所等_平成17年10月以降
 * @bizDomain
 ...
 * @reference
 */
public class TankinyushoRyoyokaigo_Shinryojo_AfterH17_10 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 短期入所療養介護_診療所等_平成17年10月以降を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所療養介護_診療所等_平成17年10月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_診療所等_平成17年10月以降
     */
    public TankinyushoRyoyokaigo_Shinryojo_AfterH17_10(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_診療所等_平成17年10月以降を表す文字列
     */
    public TankinyushoRyoyokaigo_Shinryojo_AfterH17_10(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigo_Shinryojo_AfterH17_10 other = (TankinyushoRyoyokaigo_Shinryojo_AfterH17_10) obj;
