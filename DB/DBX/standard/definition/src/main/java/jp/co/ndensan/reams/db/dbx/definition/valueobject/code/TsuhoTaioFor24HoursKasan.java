 ...
 * @reference
 */
public class TsuhoTaioFor24HoursKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.二十四時間通報対応加算.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 二十四時間通報対応加算
     */
    public TsuhoTaioFor24HoursKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 二十四時間通報対応加算を表す文字列
     */
    public TsuhoTaioFor24HoursKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TsuhoTaioFor24HoursKasan other = (TsuhoTaioFor24HoursKasan) obj;
