 ...
 * @reference
 */
public class KobetsuRehabilitationTeikyoTaiseiUmuRigakuRyoho2 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuRigakuRyoho2(Code code) {
        this.code = code;
    }
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuRigakuRyoho2(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuRehabilitationTeikyoTaiseiUmuRigakuRyoho2 other = (KobetsuRehabilitationTeikyoTaiseiUmuRigakuRyoho2) obj;
