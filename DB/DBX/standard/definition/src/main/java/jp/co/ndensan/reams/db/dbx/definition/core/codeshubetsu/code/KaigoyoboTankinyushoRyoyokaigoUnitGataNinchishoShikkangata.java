 ...
 * @reference
 */
public class KaigoyoboTankinyushoRyoyokaigoUnitGataNinchishoShikkangata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KaigoyoboTankinyushoRyoyokaigoUnitGataNinchishoShikkangata(Code code) {
        this.code = code;
    }
     ...
     */
    public KaigoyoboTankinyushoRyoyokaigoUnitGataNinchishoShikkangata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTankinyushoRyoyokaigoUnitGataNinchishoShikkangata other = (KaigoyoboTankinyushoRyoyokaigoUnitGataNinchishoShikkangata) obj;
