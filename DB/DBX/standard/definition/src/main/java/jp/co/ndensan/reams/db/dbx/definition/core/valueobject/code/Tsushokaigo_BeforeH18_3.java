...
/**
 * 通所介護_平成18年3月以前を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 通所介護_平成18年3月以前
 * @bizDomain
 ...
 * @reference
 */
public class Tsushokaigo_BeforeH18_3 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.通所介護_平成18年3月以前.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 通所介護_平成18年3月以前
     */
    public Tsushokaigo_BeforeH18_3(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 通所介護_平成18年3月以前を表す文字列
     */
    public Tsushokaigo_BeforeH18_3(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Tsushokaigo_BeforeH18_3 other = (Tsushokaigo_BeforeH18_3) obj;
