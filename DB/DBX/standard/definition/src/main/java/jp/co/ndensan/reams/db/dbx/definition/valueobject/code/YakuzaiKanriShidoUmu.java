 ...
 * @reference
 */
public class YakuzaiKanriShidoUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.薬剤管理指導の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 薬剤管理指導の有無
     */
    public YakuzaiKanriShidoUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 薬剤管理指導の有無を表す文字列
     */
    public YakuzaiKanriShidoUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final YakuzaiKanriShidoUmu other = (YakuzaiKanriShidoUmu) obj;
