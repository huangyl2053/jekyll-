...
/**
 * 通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ_平成21年3月以前を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ_平成21年3月以前
 * @bizDomain
 ...
 * @reference
 */
public class TsushoRehabilitation_BeforeH21_3 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ_平成21年3月以前を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ_平成21年3月以前.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ_平成21年3月以前
     */
    public TsushoRehabilitation_BeforeH21_3(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ_平成21年3月以前を表す文字列
     */
    public TsushoRehabilitation_BeforeH21_3(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TsushoRehabilitation_BeforeH21_3 other = (TsushoRehabilitation_BeforeH21_3) obj;
