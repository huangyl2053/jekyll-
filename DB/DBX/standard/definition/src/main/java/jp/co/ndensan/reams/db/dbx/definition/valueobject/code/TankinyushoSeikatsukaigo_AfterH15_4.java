...
/**
 * 短期入所生活介護_平成15年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 短期入所生活介護_平成15年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class TankinyushoSeikatsukaigo_AfterH15_4 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所生活介護_平成15年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 短期入所生活介護_平成15年4月以降
     */
    public TankinyushoSeikatsukaigo_AfterH15_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所生活介護_平成15年4月以降を表す文字列
     */
    public TankinyushoSeikatsukaigo_AfterH15_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoSeikatsukaigo_AfterH15_4 other = (TankinyushoSeikatsukaigo_AfterH15_4) obj;
