...
/**
 * 日中の身体介護２０分未満体制の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 日中の身体介護２０分未満体制有無
 * @bizDomain
 ...
 * @reference
 */
public class ShintaiKaigoUnder20minutesInDaytimeTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.日中の身体介護２０分未満体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 日中の身体介護２０分未満体制の有無
     */
    public ShintaiKaigoUnder20minutesInDaytimeTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 日中の身体介護２０分未満体制の有無を表す文字列
     */
    public ShintaiKaigoUnder20minutesInDaytimeTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShintaiKaigoUnder20minutesInDaytimeTaiseiUmu other = (ShintaiKaigoUnder20minutesInDaytimeTaiseiUmu) obj;
