 ...
 * @reference
 */
public class UndokiKinoKojoTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.運動器機能向上体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 運動器機能向上体制の有無
     */
    public UndokiKinoKojoTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 運動器機能向上体制の有無を表す文字列
     */
    public UndokiKinoKojoTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final UndokiKinoKojoTaiseiUmu other = (UndokiKinoKojoTaiseiUmu) obj;
