...
/**
 * 短期入所療養介護_病院療養型_平成15年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 短期入所療養介護_病院療養型_平成15年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class TankinyushoRyoyokaigo_ByoinRyoyogata_AfterH15_4 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 短期入所療養介護_病院療養型_平成15年4月以降を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所療養介護_病院療養型_平成15年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_病院療養型_平成15年4月以降
     */
    public TankinyushoRyoyokaigo_ByoinRyoyogata_AfterH15_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_病院療養型_平成15年4月以降を表す文字列
     */
    public TankinyushoRyoyokaigo_ByoinRyoyogata_AfterH15_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigo_ByoinRyoyogata_AfterH15_4 other = (TankinyushoRyoyokaigo_ByoinRyoyogata_AfterH15_4) obj;
