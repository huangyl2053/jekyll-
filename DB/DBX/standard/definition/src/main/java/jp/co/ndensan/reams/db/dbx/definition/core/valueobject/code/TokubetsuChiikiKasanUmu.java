 ...
 * @reference
 */
public class TokubetsuChiikiKasanUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.特別地域加算の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 特別地域加算の有無
     */
    public TokubetsuChiikiKasanUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 特別地域加算の有無を表す文字列
     */
    public TokubetsuChiikiKasanUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TokubetsuChiikiKasanUmu other = (TokubetsuChiikiKasanUmu) obj;
