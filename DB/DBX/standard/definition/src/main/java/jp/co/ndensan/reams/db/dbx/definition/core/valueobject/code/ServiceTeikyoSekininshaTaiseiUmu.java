...
/**
 * サービス提供責任者体制の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName サービス提供責任者体制有無
 * @bizDomain
 ...
 * @reference
 */
public class ServiceTeikyoSekininshaTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.サービス提供責任者体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code サービス提供責任者体制の有無
     */
    public ServiceTeikyoSekininshaTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code サービス提供責任者体制の有無を表す文字列
     */
    public ServiceTeikyoSekininshaTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ServiceTeikyoSekininshaTaiseiUmu other = (ServiceTeikyoSekininshaTaiseiUmu) obj;
