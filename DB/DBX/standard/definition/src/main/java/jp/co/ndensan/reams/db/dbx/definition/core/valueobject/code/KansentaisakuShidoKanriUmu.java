 ...
 * @reference
 */
public class KansentaisakuShidoKanriUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.感染対策指導管理の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 感染対策指導管理の有無
     */
    public KansentaisakuShidoKanriUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 感染対策指導管理の有無を表す文字列
     */
    public KansentaisakuShidoKanriUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KansentaisakuShidoKanriUmu other = (KansentaisakuShidoKanriUmu) obj;
