 ...
 * @reference
 */
public class ShokujiTeikyoJokyo implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.食事提供の状況.getCodeShubetsu();
    }
     ...
     * @param code 食事提供の状況
     */
    public ShokujiTeikyoJokyo(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 食事提供の状況を表す文字列
     */
    public ShokujiTeikyoJokyo(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShokujiTeikyoJokyo other = (ShokujiTeikyoJokyo) obj;
