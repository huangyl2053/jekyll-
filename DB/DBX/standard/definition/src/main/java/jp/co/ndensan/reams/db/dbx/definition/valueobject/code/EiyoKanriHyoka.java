 ...
 * @reference
 */
public class EiyoKanriHyoka implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.栄養管理の評価.getCodeShubetsu();
    }
     ...
     * @param code 栄養管理の評価
     */
    public EiyoKanriHyoka(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 栄養管理の評価を表す文字列
     */
    public EiyoKanriHyoka(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final EiyoKanriHyoka other = (EiyoKanriHyoka) obj;
