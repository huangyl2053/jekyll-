 ...
 * @reference
 */
public class JudokaTaioTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.重度化対応体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 重度化対応体制の有無
     */
    public JudokaTaioTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 重度化対応体制の有無を表す文字列
     */
    public JudokaTaioTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JudokaTaioTaiseiUmu other = (JudokaTaioTaiseiUmu) obj;
