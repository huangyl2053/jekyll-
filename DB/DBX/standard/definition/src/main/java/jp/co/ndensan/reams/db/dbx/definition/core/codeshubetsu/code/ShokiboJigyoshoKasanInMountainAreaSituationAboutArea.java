 ...
 * @reference
 */
public class ShokiboJigyoshoKasanInMountainAreaSituationAboutArea implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public ShokiboJigyoshoKasanInMountainAreaSituationAboutArea(Code code) {
        this.code = code;
    }
     ...
     */
    public ShokiboJigyoshoKasanInMountainAreaSituationAboutArea(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShokiboJigyoshoKasanInMountainAreaSituationAboutArea other = (ShokiboJigyoshoKasanInMountainAreaSituationAboutArea) obj;
