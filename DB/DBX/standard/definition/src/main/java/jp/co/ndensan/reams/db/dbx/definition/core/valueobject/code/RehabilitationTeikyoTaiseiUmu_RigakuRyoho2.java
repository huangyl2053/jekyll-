...
/**
 * ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅱ_の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法?_の有無
 * @bizDomain
 ...
 * @reference
 */
public class RehabilitationTeikyoTaiseiUmu_RigakuRyoho2 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅱ_の有無を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅱ_の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅱ_の有無
     */
    public RehabilitationTeikyoTaiseiUmu_RigakuRyoho2(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅱ_の有無を表す文字列
     */
    public RehabilitationTeikyoTaiseiUmu_RigakuRyoho2(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RehabilitationTeikyoTaiseiUmu_RigakuRyoho2 other = (RehabilitationTeikyoTaiseiUmu_RigakuRyoho2) obj;
