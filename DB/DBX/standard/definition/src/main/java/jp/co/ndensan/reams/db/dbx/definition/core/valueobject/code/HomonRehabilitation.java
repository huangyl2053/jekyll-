 ...
 * @reference
 */
public class HomonRehabilitation implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.訪問ﾘﾊﾋﾞﾘﾃｰｼｮﾝ.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 訪問ﾘﾊﾋﾞﾘﾃｰｼｮﾝ
     */
    public HomonRehabilitation(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 訪問ﾘﾊﾋﾞﾘﾃｰｼｮﾝを表す文字列
     */
    public HomonRehabilitation(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HomonRehabilitation other = (HomonRehabilitation) obj;
