 ...
 * @reference
 */
public class TokuteishisetsuNyukyoshaSeikatsukaigoTankiriyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public TokuteishisetsuNyukyoshaSeikatsukaigoTankiriyogata(Code code) {
        this.code = code;
    }
     ...
     */
    public TokuteishisetsuNyukyoshaSeikatsukaigoTankiriyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TokuteishisetsuNyukyoshaSeikatsukaigoTankiriyogata other = (TokuteishisetsuNyukyoshaSeikatsukaigoTankiriyogata) obj;
