...
/**
 * 通所介護_平成18年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 通所介護_平成18年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class Tsushokaigo_AfterH18_4 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.通所介護_平成18年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 通所介護_平成18年4月以降
     */
    public Tsushokaigo_AfterH18_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 通所介護_平成18年4月以降を表す文字列
     */
    public Tsushokaigo_AfterH18_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Tsushokaigo_AfterH18_4 other = (Tsushokaigo_AfterH18_4) obj;
