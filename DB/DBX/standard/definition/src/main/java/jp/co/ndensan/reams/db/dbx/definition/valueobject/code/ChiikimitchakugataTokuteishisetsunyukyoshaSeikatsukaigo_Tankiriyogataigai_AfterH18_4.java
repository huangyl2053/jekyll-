...
/**
 * 地域密着型特定施設入居者生活介護_短期利用型以外_平成18年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 地域密着型特定施設入居者生活介護_短期利用型以外_平成18年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class ChiikimitchakugataTokuteishisetsunyukyoshaSeikatsukaigo_Tankiriyogataigai_AfterH18_4
    ...
    /**
     * 地域密着型特定施設入居者生活介護_短期利用型以外_平成18年4月以降を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.地域密着型特定施設入居者生活介護_短期利用型以外_平成18年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 地域密着型特定施設入居者生活介護_短期利用型以外_平成18年4月以降
     */
    public ChiikimitchakugataTokuteishisetsunyukyoshaSeikatsukaigo_Tankiriyogataigai_AfterH18_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 地域密着型特定施設入居者生活介護_短期利用型以外_平成18年4月以降を表す文字列
     */
    public ChiikimitchakugataTokuteishisetsunyukyoshaSeikatsukaigo_Tankiriyogataigai_AfterH18_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ChiikimitchakugataTokuteishisetsunyukyoshaSeikatsukaigo_Tankiriyogataigai_AfterH18_4 other
                = (ChiikimitchakugataTokuteishisetsunyukyoshaSeikatsukaigo_Tankiriyogataigai_AfterH18_4) obj;
