 ...
 * @reference
 */
public class KaigoTatokuKaijoJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護他特解除事由.getCodeShubetsu();
    }
     ...
     * @param code 介護他特解除事由
     */
    public KaigoTatokuKaijoJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護他特解除事由を表す文字列
     */
    public KaigoTatokuKaijoJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoTatokuKaijoJiyu other = (KaigoTatokuKaijoJiyu) obj;
