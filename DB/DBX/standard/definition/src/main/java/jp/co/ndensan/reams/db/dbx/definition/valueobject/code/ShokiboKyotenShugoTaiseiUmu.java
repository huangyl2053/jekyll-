 ...
 * @reference
 */
public class ShokiboKyotenShugoTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.小規模拠点集合体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 小規模拠点集合体制の有無
     */
    public ShokiboKyotenShugoTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 小規模拠点集合体制の有無を表す文字列
     */
    public ShokiboKyotenShugoTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShokiboKyotenShugoTaiseiUmu other = (ShokiboKyotenShugoTaiseiUmu) obj;
