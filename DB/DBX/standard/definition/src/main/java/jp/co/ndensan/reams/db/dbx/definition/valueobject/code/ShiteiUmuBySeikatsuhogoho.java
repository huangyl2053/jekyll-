 ...
 * @reference
 */
public class ShiteiUmuBySeikatsuhogoho implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.生活保護法による指定の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 生活保護法による指定の有無
     */
    public ShiteiUmuBySeikatsuhogoho(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 生活保護法による指定の有無を表す文字列
     */
    public ShiteiUmuBySeikatsuhogoho(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShiteiUmuBySeikatsuhogoho other = (ShiteiUmuBySeikatsuhogoho) obj;
