 ...
 * @reference
 */
public class ServiceTeikyoTaiseikyokakasanHomonkangoEtc implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public ServiceTeikyoTaiseikyokakasanHomonkangoEtc(Code code) {
        this.code = code;
    }
     ...
     */
    public ServiceTeikyoTaiseikyokakasanHomonkangoEtc(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ServiceTeikyoTaiseikyokakasanHomonkangoEtc other = (ServiceTeikyoTaiseikyokakasanHomonkangoEtc) obj;
