 ...
 * @reference
 */
public class ShiteiKoshinShinseichuKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.指定更新申請中区分.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 指定更新申請中区分
     */
    public ShiteiKoshinShinseichuKubun(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 指定更新申請中区分を表す文字列
     */
    public ShiteiKoshinShinseichuKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShiteiKoshinShinseichuKubun other = (ShiteiKoshinShinseichuKubun) obj;
