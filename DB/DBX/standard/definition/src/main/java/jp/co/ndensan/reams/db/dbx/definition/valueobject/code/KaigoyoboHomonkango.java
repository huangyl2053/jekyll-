 ...
 * @reference
 */
public class KaigoyoboHomonkango implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防訪問看護.getCodeShubetsu();
    }
     ...
     * @param code 介護予防訪問看護
     */
    public KaigoyoboHomonkango(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防訪問看護を表す文字列
     */
    public KaigoyoboHomonkango(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboHomonkango other = (KaigoyoboHomonkango) obj;
