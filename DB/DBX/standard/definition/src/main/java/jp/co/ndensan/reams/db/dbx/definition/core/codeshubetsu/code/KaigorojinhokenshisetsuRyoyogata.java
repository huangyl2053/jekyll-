 ...
 * @reference
 */
public class KaigorojinhokenshisetsuRyoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KaigorojinhokenshisetsuRyoyogata(Code code) {
        this.code = code;
    }
     ...
     */
    public KaigorojinhokenshisetsuRyoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigorojinhokenshisetsuRyoyogata other = (KaigorojinhokenshisetsuRyoyogata) obj;
