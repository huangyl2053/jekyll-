...
/**
 * 中山間地域等における小規模事業所加算_地域に関する状況を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 中山間地域等における小規模事業所加算_地域に関する状況
 * @bizDomain
 ...
 * @reference
 */
public class ShokiboJigyoshoKasanInMountainArea_SituationAboutArea implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 中山間地域等における小規模事業所加算_地域に関する状況を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.中山間地域等における小規模事業所加算_地域に関する状況.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 中山間地域等における小規模事業所加算_地域に関する状況
     */
    public ShokiboJigyoshoKasanInMountainArea_SituationAboutArea(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 中山間地域等における小規模事業所加算_地域に関する状況を表す文字列
     */
    public ShokiboJigyoshoKasanInMountainArea_SituationAboutArea(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShokiboJigyoshoKasanInMountainArea_SituationAboutArea other = (ShokiboJigyoshoKasanInMountainArea_SituationAboutArea) obj;
