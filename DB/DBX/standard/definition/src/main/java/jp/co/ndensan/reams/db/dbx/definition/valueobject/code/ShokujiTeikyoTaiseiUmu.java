 ...
 * @reference
 */
public class ShokujiTeikyoTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.食事提供体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 食事提供体制の有無
     */
    public ShokujiTeikyoTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 食事提供体制の有無を表す文字列
     */
    public ShokujiTeikyoTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ShokujiTeikyoTaiseiUmu other = (ShokujiTeikyoTaiseiUmu) obj;
