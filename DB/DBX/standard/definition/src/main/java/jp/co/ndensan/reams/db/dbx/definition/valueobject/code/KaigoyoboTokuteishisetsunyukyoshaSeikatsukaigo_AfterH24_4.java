...
/**
 * 介護予防特定施設入居者生活介護_平成24年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防特定施設入居者生活介護_平成24年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboTokuteishisetsunyukyoshaSeikatsukaigo_AfterH24_4 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 介護予防特定施設入居者生活介護_平成24年4月以降を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防特定施設入居者生活介護_平成24年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防特定施設入居者生活介護_平成24年4月以降
     */
    public KaigoyoboTokuteishisetsunyukyoshaSeikatsukaigo_AfterH24_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防特定施設入居者生活介護_平成24年4月以降を表す文字列
     */
    public KaigoyoboTokuteishisetsunyukyoshaSeikatsukaigo_AfterH24_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTokuteishisetsunyukyoshaSeikatsukaigo_AfterH24_4 other = (KaigoyoboTokuteishisetsunyukyoshaSeikatsukaigo_AfterH24_4) obj;
