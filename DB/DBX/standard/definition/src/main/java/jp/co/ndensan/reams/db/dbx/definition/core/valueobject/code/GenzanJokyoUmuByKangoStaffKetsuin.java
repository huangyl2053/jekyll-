 ...
 * @reference
 */
public class GenzanJokyoUmuByKangoStaffKetsuin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.看護職員の欠員による減算の状況の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 看護職員の欠員による減算の状況の有無
     */
    public GenzanJokyoUmuByKangoStaffKetsuin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 看護職員の欠員による減算の状況の有無を表す文字列
     */
    public GenzanJokyoUmuByKangoStaffKetsuin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final GenzanJokyoUmuByKangoStaffKetsuin other = (GenzanJokyoUmuByKangoStaffKetsuin) obj;
