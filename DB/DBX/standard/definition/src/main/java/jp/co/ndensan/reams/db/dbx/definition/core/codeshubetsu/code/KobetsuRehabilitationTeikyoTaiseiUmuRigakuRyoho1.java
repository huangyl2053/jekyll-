 ...
 * @reference
 */
public class KobetsuRehabilitationTeikyoTaiseiUmuRigakuRyoho1 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuRigakuRyoho1(Code code) {
        this.code = code;
    }
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuRigakuRyoho1(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuRehabilitationTeikyoTaiseiUmuRigakuRyoho1 other = (KobetsuRehabilitationTeikyoTaiseiUmuRigakuRyoho1) obj;
