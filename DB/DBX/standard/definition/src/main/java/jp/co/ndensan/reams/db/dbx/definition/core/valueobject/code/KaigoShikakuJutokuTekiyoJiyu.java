 ...
 * @reference
 */
public class KaigoShikakuJutokuTekiyoJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護資格住特適用事由.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護資格住特適用事由
     */
    public KaigoShikakuJutokuTekiyoJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護資格住特適用事由を表す文字列
     */
    public KaigoShikakuJutokuTekiyoJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoShikakuJutokuTekiyoJiyu other = (KaigoShikakuJutokuTekiyoJiyu) obj;
