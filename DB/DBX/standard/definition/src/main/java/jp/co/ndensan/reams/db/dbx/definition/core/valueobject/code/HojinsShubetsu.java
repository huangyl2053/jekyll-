 ...
 * @reference
 */
public class HojinsShubetsu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.法人等種別.getCodeShubetsu();
    }
     ...
     * @param code 法人等種別
     */
    public HojinsShubetsu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 法人等種別を表す文字列
     */
    public HojinsShubetsu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final HojinsShubetsu other = (HojinsShubetsu) obj;
