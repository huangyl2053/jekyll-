 ...
 * @reference
 */
public class KaigoyoboTankinyushoRyoyokaigoNormalType implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KaigoyoboTankinyushoRyoyokaigoNormalType(Code code) {
        this.code = code;
    }
     ...
     */
    public KaigoyoboTankinyushoRyoyokaigoNormalType(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTankinyushoRyoyokaigoNormalType other = (KaigoyoboTankinyushoRyoyokaigoNormalType) obj;
