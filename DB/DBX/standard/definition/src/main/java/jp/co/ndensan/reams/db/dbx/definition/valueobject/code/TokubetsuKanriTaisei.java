 ...
 * @reference
 */
public class TokubetsuKanriTaisei implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.特別管理体制.getCodeShubetsu();
    }
     ...
     * @param code 特別管理体制
     */
    public TokubetsuKanriTaisei(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 特別管理体制を表す文字列
     */
    public TokubetsuKanriTaisei(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TokubetsuKanriTaisei other = (TokubetsuKanriTaisei) obj;
