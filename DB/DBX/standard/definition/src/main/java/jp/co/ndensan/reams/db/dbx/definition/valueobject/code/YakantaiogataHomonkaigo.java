 ...
 * @reference
 */
public class YakantaiogataHomonkaigo implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.夜間対応型訪問介護.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 夜間対応型訪問介護
     */
    public YakantaiogataHomonkaigo(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 夜間対応型訪問介護を表す文字列
     */
    public YakantaiogataHomonkaigo(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final YakantaiogataHomonkaigo other = (YakantaiogataHomonkaigo) obj;
