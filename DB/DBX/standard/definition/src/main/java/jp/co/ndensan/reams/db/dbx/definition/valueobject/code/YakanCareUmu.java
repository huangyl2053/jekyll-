 ...
 * @reference
 */
public class YakanCareUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.夜間ケアの有無.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 夜間ケアの有無を表す文字列
     */
    public YakanCareUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final YakanCareUmu other = (YakanCareUmu) obj;
