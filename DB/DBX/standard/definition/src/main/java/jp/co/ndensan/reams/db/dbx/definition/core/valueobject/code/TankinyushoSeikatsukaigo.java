 ...
 * @reference
 */
public class TankinyushoSeikatsukaigo implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所生活介護.getCodeShubetsu();
    }
     ...
     * @param code 短期入所生活介護
     */
    public TankinyushoSeikatsukaigo(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所生活介護を表す文字列
     */
    public TankinyushoSeikatsukaigo(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoSeikatsukaigo other = (TankinyushoSeikatsukaigo) obj;
