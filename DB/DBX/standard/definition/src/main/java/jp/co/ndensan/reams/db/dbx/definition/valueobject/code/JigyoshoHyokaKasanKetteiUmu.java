...
/**
 * 事業所評価加算_決定_の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 事業所評価加算_決定_の有無
 * @bizDomain
 ...
 * @reference
 */
public class JigyoshoHyokaKasanKetteiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.事業所評価加算_決定_の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 事業所評価加算_決定_の有無
     */
    public JigyoshoHyokaKasanKetteiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 事業所評価加算_決定_の有無を表す文字列
     */
    public JigyoshoHyokaKasanKetteiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JigyoshoHyokaKasanKetteiUmu other = (JigyoshoHyokaKasanKetteiUmu) obj;
