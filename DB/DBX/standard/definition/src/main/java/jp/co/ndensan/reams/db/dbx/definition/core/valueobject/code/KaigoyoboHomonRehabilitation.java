...
/**
 * 介護予防訪問ﾘﾊﾋﾞﾘﾃｰｼｮﾝを表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防訪問ﾘﾊﾋﾞﾘﾃｰｼｮﾝ
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboHomonRehabilitation implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防訪問ﾘﾊﾋﾞﾘﾃｰｼｮﾝ.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防訪問ﾘﾊﾋﾞﾘﾃｰｼｮﾝ
     */
    public KaigoyoboHomonRehabilitation(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防訪問ﾘﾊﾋﾞﾘﾃｰｼｮﾝを表す文字列
     */
    public KaigoyoboHomonRehabilitation(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboHomonRehabilitation other = (KaigoyoboHomonRehabilitation) obj;
