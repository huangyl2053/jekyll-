...
/**
 * 短期入所生活介護_平成15年3月以前を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 短期入所生活介護_平成15年3月以前
 * @bizDomain
 ...
 * @reference
 */
public class TankinyushoSeikatsukaigo_BeforeH15_3 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所生活介護_平成15年3月以前.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 短期入所生活介護_平成15年3月以前
     */
    public TankinyushoSeikatsukaigo_BeforeH15_3(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所生活介護_平成15年3月以前を表す文字列
     */
    public TankinyushoSeikatsukaigo_BeforeH15_3(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoSeikatsukaigo_BeforeH15_3 other = (TankinyushoSeikatsukaigo_BeforeH15_3) obj;
