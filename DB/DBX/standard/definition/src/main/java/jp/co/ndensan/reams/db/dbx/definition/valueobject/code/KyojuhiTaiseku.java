 ...
 * @reference
 */
public class KyojuhiTaiseku implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.居住費対策.getCodeShubetsu();
    }
     ...
     * @param code 居住費対策
     */
    public KyojuhiTaiseku(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 居住費対策を表す文字列
     */
    public KyojuhiTaiseku(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KyojuhiTaiseku other = (KyojuhiTaiseku) obj;
