...
/**
 * 介護療養型医療施設_診療所型_平成15年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護療養型医療施設_診療所型_平成15年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class KaigoryoyogataIryoshisetsu_shinryoujokata_AfterH15_4 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 介護療養型医療施設_診療所型_平成15年4月以降を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護療養型医療施設_診療所型_平成15年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_診療所型_平成15年4月以降
     */
    public KaigoryoyogataIryoshisetsu_shinryoujokata_AfterH15_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_診療所型_平成15年4月以降を表す文字列
     */
    public KaigoryoyogataIryoshisetsu_shinryoujokata_AfterH15_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoryoyogataIryoshisetsu_shinryoujokata_AfterH15_4 other = (KaigoryoyogataIryoshisetsu_shinryoujokata_AfterH15_4) obj;
