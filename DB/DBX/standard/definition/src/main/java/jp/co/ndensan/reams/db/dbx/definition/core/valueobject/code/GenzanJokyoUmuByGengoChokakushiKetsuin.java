...
/**
 * 言語聴覚士の欠員による減算の状況の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 言語聴覚士の欠員による減算の状況有無
 * @bizDomain
 ...
 * @reference
 */
public class GenzanJokyoUmuByGengoChokakushiKetsuin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.言語聴覚士の欠員による減算の状況の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 言語聴覚士の欠員による減算の状況の有無
     */
    public GenzanJokyoUmuByGengoChokakushiKetsuin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 言語聴覚士の欠員による減算の状況の有無を表す文字列
     */
    public GenzanJokyoUmuByGengoChokakushiKetsuin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final GenzanJokyoUmuByGengoChokakushiKetsuin other = (GenzanJokyoUmuByGengoChokakushiKetsuin) obj;
