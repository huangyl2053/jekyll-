...
/**
 * 介護療養型医療施設_平成18年7月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護療養型医療施設_平成18年7月以降
 * @bizDomain
 ...
 * @reference
 */
public class KaigoryoyogataIryoshisetsu_AfterH18_7 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護療養型医療施設_平成18年7月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_平成18年7月以降
     */
    public KaigoryoyogataIryoshisetsu_AfterH18_7(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_平成18年7月以降を表す文字列
     */
    public KaigoryoyogataIryoshisetsu_AfterH18_7(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoryoyogataIryoshisetsu_AfterH18_7 other = (KaigoryoyogataIryoshisetsu_AfterH18_7) obj;
