 ...
 * @reference
 */
public class GenzanJokyoUmuByKaigoStaffKetsuin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護職員の欠員による減算の状況の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護職員の欠員による減算の状況の有無
     */
    public GenzanJokyoUmuByKaigoStaffKetsuin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護職員の欠員による減算の状況の有無を表す文字列
     */
    public GenzanJokyoUmuByKaigoStaffKetsuin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final GenzanJokyoUmuByKaigoStaffKetsuin other = (GenzanJokyoUmuByKaigoStaffKetsuin) obj;
