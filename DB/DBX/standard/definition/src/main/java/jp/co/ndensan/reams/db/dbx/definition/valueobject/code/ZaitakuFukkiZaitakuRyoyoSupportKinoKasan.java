...
/**
 * 在宅復帰_在宅療養支援機能加算を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 在宅復帰_在宅療養支援機能加算
 * @bizDomain
 ...
 * @reference
 */
public class ZaitakuFukkiZaitakuRyoyoSupportKinoKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.在宅復帰_在宅療養支援機能加算.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 在宅復帰_在宅療養支援機能加算
     */
    public ZaitakuFukkiZaitakuRyoyoSupportKinoKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 在宅復帰_在宅療養支援機能加算を表す文字列
     */
    public ZaitakuFukkiZaitakuRyoyoSupportKinoKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ZaitakuFukkiZaitakuRyoyoSupportKinoKasan other = (ZaitakuFukkiZaitakuRyoyoSupportKinoKasan) obj;
