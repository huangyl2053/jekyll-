...
/**
 * 短期入所療養介護_認知症疾患型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 短期入所療養介護_認知症疾患型
 * @bizDomain
 ...
 * @reference
 */
public class TankinyushoRyoyokaigo_NinchishoShikkangata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所療養介護_認知症疾患型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_認知症疾患型
     */
    public TankinyushoRyoyokaigo_NinchishoShikkangata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_認知症疾患型を表す文字列
     */
    public TankinyushoRyoyokaigo_NinchishoShikkangata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigo_NinchishoShikkangata other = (TankinyushoRyoyokaigo_NinchishoShikkangata) obj;
