 ...
 * @reference
 */
public class ThirdGradeHelperTaisei implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.三級ヘルパー体制.getCodeShubetsu();
    }
     ...
     * @param code 三級ヘルパー体制
     */
    public ThirdGradeHelperTaisei(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 三級ヘルパー体制を表す文字列
     */
    public ThirdGradeHelperTaisei(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ThirdGradeHelperTaisei other = (ThirdGradeHelperTaisei) obj;
