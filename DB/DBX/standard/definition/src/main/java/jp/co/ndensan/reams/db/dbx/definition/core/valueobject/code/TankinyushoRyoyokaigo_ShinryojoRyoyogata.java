...
/**
 * 短期入所療養介護_診療所療養型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 短期入所療養介護_診療所療養型
 * @bizDomain
 ...
 * @reference
 */
public class TankinyushoRyoyokaigo_ShinryojoRyoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所療養介護_診療所療養型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_診療所療養型
     */
    public TankinyushoRyoyokaigo_ShinryojoRyoyogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_診療所療養型を表す文字列
     */
    public TankinyushoRyoyokaigo_ShinryojoRyoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigo_ShinryojoRyoyogata other = (TankinyushoRyoyokaigo_ShinryojoRyoyogata) obj;
