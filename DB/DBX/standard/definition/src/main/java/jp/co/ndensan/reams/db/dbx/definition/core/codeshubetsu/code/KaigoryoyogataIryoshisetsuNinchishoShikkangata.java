 ...
 * @reference
 */
public class KaigoryoyogataIryoshisetsuNinchishoShikkangata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KaigoryoyogataIryoshisetsuNinchishoShikkangata(Code code) {
        this.code = code;
    }
     ...
     */
    public KaigoryoyogataIryoshisetsuNinchishoShikkangata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoryoyogataIryoshisetsuNinchishoShikkangata other = (KaigoryoyogataIryoshisetsuNinchishoShikkangata) obj;
