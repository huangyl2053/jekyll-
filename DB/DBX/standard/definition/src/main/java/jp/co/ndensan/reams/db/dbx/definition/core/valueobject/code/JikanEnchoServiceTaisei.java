 ...
 * @reference
 */
public class JikanEnchoServiceTaisei implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.時間延長サービス体制.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 時間延長サービス体制
     */
    public JikanEnchoServiceTaisei(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 時間延長サービス体制を表す文字列
     */
    public JikanEnchoServiceTaisei(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JikanEnchoServiceTaisei other = (JikanEnchoServiceTaisei) obj;
