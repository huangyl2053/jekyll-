 ...
 * @reference
 */
public class TokubetsuNyuyokuKaijoTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.特別入浴介助体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 特別入浴介助体制の有無
     */
    public TokubetsuNyuyokuKaijoTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 特別入浴介助体制の有無を表す文字列
     */
    public TokubetsuNyuyokuKaijoTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TokubetsuNyuyokuKaijoTaiseiUmu other = (TokubetsuNyuyokuKaijoTaiseiUmu) obj;
