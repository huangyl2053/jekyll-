 ...
 * @reference
 */
public class KobetsuRehabilitationTeikyoTaiseiUmuGengoChokakuRyoho implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuGengoChokakuRyoho(Code code) {
        this.code = code;
    }
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuGengoChokakuRyoho(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuRehabilitationTeikyoTaiseiUmuGengoChokakuRyoho other = (KobetsuRehabilitationTeikyoTaiseiUmuGengoChokakuRyoho) obj;
