...
public enum ConfigNameDBE {
    ...
    /**
     * 主治医意見書作成料請求書_発行日_印字有無
     */
    主治医意見書作成料請求書_発行日_印字有無("主治医意見書作成料請求書_発行日_印字有無"),
    /**
     ...
     * 審査会順序３_表示用
     */
    審査会順序３_表示用("審査会順序３_表示用"),
    /**
     * 要介護認定情報提供_初期選択_認定調査票
     */
    要介護認定情報提供_初期選択_認定調査票("要介護認定情報提供_初期選択_認定調査票"),
    /**
     * 要介護認定情報提供_初期選択_特記事項
     */
    要介護認定情報提供_初期選択_特記事項("要介護認定情報提供_初期選択_特記事項"),
    /**
     * 要介護認定情報提供_初期選択_主治医意見書
     */
    要介護認定情報提供_初期選択_主治医意見書("要介護認定情報提供_初期選択_主治医意見書"),
    /**
     * 要介護認定情報提供_初期選択_その他資料
     */
    要介護認定情報提供_初期選択_その他資料("要介護認定情報提供_初期選択_その他資料"),
    /**
     * 要介護認定情報提供_初期選択_一次判定結果
     */
    要介護認定情報提供_初期選択_一次判定結果("要介護認定情報提供_初期選択_一次判定結果"),
    /*
     * 広域保険者市町村コード
     */
    広域保険者市町村コード("広域保険者市町村コード"),
    /**
     * 介護認定審査会資料_委員用_概況特記出力有無
     */
    介護認定審査会資料_委員用_概況特記出力有無("介護認定審査会資料_委員用_概況特記出力有無"),
    /**
     * 首長名
     */
    首長名("首長名");
