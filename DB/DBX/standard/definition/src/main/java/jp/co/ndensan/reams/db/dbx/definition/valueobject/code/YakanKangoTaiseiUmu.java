 ...
 * @reference
 */
public class YakanKangoTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.夜間看護体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 夜間看護体制の有無
     */
    public YakanKangoTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 夜間看護体制の有無を表す文字列
     */
    public YakanKangoTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final YakanKangoTaiseiUmu other = (YakanKangoTaiseiUmu) obj;
