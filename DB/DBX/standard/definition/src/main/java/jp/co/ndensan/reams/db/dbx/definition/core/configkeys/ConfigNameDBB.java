...
public enum ConfigNameDBB {
    ...
    /**
     * コード:無し 名称:年額計算_端数調整方法_ランク変更のみ 略称:定義なし
     */
    年額計算_端数調整方法_ランク変更のみ("年額計算_端数調整方法_ランク変更のみ"),
    /**
    ...
    /**
     * コード:無し 名称:納付額データ_集計日区分 略称:定義なし
     */
    納付額データ_集計日区分("納付額データ_集計日区分"),
    /**
     * コード:無し 名称:取込ファイルチェック期間 略称:定義なし
     */
    取込ファイルチェック期間("取込ファイルチェック期間"),
    /**
     * コード:無し 名称:業務有無_介護 略称:定義なし
     */
    業務有無_介護("業務有無_介護"),
    /**
     * コード:無し 名称:業務有無_国保 略称:定義なし
     */
    業務有無_国保("業務有無_国保"),
    /**
     * コード:無し 名称:業務有無_後期 略称:定義なし
     */
    業務有無_後期("業務有無_後期"),
    /**
     * コード:無し 名称:納付額データ_抽出期間補正 略称:定義なし
     */
    納付額データ_抽出期間補正("納付額データ_抽出期間補正");
