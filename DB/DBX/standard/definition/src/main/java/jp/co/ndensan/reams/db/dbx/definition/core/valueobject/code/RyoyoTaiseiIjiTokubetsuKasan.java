 ...
 * @reference
 */
public class RyoyoTaiseiIjiTokubetsuKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.療養体制維持特別加算.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 療養体制維持特別加算
     */
    public RyoyoTaiseiIjiTokubetsuKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 療養体制維持特別加算を表す文字列
     */
    public RyoyoTaiseiIjiTokubetsuKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RyoyoTaiseiIjiTokubetsuKasan other = (RyoyoTaiseiIjiTokubetsuKasan) obj;
