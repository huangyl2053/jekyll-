 ...
 * @reference
 */
public class TanisuSanteiTani implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.単位数算定単位.getCodeShubetsu();
    }
     ...
     * @param code 単位数算定単位
     */
    public TanisuSanteiTani(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 単位数算定単位を表す文字列
     */
    public TanisuSanteiTani(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TanisuSanteiTani other = (TanisuSanteiTani) obj;
