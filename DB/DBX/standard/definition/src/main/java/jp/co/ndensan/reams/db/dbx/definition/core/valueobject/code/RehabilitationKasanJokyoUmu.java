...
/**
 * ﾘﾊﾋﾞﾘﾃｰｼｮﾝ加算状況の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName ﾘﾊﾋﾞﾘﾃｰｼｮﾝ加算状況有無
 * @bizDomain
 ...
 * @reference
 */
public class RehabilitationKasanJokyoUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.ﾘﾊﾋﾞﾘﾃｰｼｮﾝ加算状況の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code ﾘﾊﾋﾞﾘﾃｰｼｮﾝ加算状況の有無
     */
    public RehabilitationKasanJokyoUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code ﾘﾊﾋﾞﾘﾃｰｼｮﾝ加算状況の有無を表す文字列
     */
    public RehabilitationKasanJokyoUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RehabilitationKasanJokyoUmu other = (RehabilitationKasanJokyoUmu) obj;
