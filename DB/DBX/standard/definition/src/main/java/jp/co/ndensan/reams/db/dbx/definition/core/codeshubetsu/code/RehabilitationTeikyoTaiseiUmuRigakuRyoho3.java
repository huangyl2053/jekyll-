 ...
 * @reference
 */
public class RehabilitationTeikyoTaiseiUmuRigakuRyoho3 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public RehabilitationTeikyoTaiseiUmuRigakuRyoho3(Code code) {
        this.code = code;
    }
     ...
     */
    public RehabilitationTeikyoTaiseiUmuRigakuRyoho3(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RehabilitationTeikyoTaiseiUmuRigakuRyoho3 other = (RehabilitationTeikyoTaiseiUmuRigakuRyoho3) obj;
