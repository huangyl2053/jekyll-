...
/**
 * ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅲ_の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 ...
 * @reference
 */
public class RehabilitationTeikyoTaiseiUmu_RigakuRyoho3 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅲ_の有無を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅲ_の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅲ_の有無
     */
    public RehabilitationTeikyoTaiseiUmu_RigakuRyoho3(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅲ_の有無を表す文字列
     */
    public RehabilitationTeikyoTaiseiUmu_RigakuRyoho3(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RehabilitationTeikyoTaiseiUmu_RigakuRyoho3 other = (RehabilitationTeikyoTaiseiUmu_RigakuRyoho3) obj;
