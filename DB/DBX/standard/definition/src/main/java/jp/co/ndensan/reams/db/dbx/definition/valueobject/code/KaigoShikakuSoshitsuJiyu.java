 ...
 * @reference
 */
public class KaigoShikakuSoshitsuJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護資格喪失事由.getCodeShubetsu();
    }
     ...
     * @param code 介護資格喪失事由
     */
    public KaigoShikakuSoshitsuJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護資格喪失事由を表す文字列
     */
    public KaigoShikakuSoshitsuJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoShikakuSoshitsuJiyu other = (KaigoShikakuSoshitsuJiyu) obj;
