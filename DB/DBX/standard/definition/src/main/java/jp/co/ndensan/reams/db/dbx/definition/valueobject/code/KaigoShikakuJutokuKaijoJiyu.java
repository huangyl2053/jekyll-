 ...
 * @reference
 */
public class KaigoShikakuJutokuKaijoJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護資格住特解除事由.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護資格住特解除事由
     */
    public KaigoShikakuJutokuKaijoJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護資格住特解除事由を表す文字列
     */
    public KaigoShikakuJutokuKaijoJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoShikakuJutokuKaijoJiyu other = (KaigoShikakuJutokuKaijoJiyu) obj;
