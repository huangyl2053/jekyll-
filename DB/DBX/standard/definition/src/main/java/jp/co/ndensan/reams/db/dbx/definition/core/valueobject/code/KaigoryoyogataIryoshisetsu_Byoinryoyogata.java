...
/**
 * 介護療養型医療施設_病院療養型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護療養型医療施設_病院療養型
 * @bizDomain
 ...
 * @reference
 */
public class KaigoryoyogataIryoshisetsu_Byoinryoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護療養型医療施設_病院療養型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_病院療養型
     */
    public KaigoryoyogataIryoshisetsu_Byoinryoyogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_病院療養型を表す文字列
     */
    public KaigoryoyogataIryoshisetsu_Byoinryoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoryoyogataIryoshisetsu_Byoinryoyogata other = (KaigoryoyogataIryoshisetsu_Byoinryoyogata) obj;
