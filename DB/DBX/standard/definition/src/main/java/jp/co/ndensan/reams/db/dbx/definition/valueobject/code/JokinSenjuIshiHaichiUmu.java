 ...
 * @reference
 */
public class JokinSenjuIshiHaichiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.常勤専従医師配置の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 常勤専従医師配置の有無
     */
    public JokinSenjuIshiHaichiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 常勤専従医師配置の有無を表す文字列
     */
    public JokinSenjuIshiHaichiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JokinSenjuIshiHaichiUmu other = (JokinSenjuIshiHaichiUmu) obj;
