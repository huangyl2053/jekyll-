...
/**
 * 特定施設入居者生活介護_短期利用型以外_軽費老人ホームを表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 特定施設入居者生活介護_短期利用型以外_軽費老人ホーム
 * @bizDomain
 ...
 * @reference
 */
public class TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_KeihiRojinHome
    ...
    /**
     * 特定施設入居者生活介護_短期利用型以外_軽費老人ホームを表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.特定施設入居者生活介護_短期利用型以外_軽費老人ホーム.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 特定施設入居者生活介護_短期利用型以外_軽費老人ホーム
     */
    public TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_KeihiRojinHome(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 特定施設入居者生活介護_短期利用型以外_軽費老人ホームを表す文字列
     */
    public TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_KeihiRojinHome(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_KeihiRojinHome other
                = (TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogataigai_KeihiRojinHome) obj;
