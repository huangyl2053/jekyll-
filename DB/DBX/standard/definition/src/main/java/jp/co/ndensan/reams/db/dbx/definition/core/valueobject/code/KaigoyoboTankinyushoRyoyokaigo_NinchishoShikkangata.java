...
/**
 * 介護予防短期入所療養介護_認知症疾患型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防短期入所療養介護_認知症疾患型
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboTankinyushoRyoyokaigo_NinchishoShikkangata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防短期入所療養介護_認知症疾患型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防短期入所療養介護_認知症疾患型
     */
    public KaigoyoboTankinyushoRyoyokaigo_NinchishoShikkangata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防短期入所療養介護_認知症疾患型を表す文字列
     */
    public KaigoyoboTankinyushoRyoyokaigo_NinchishoShikkangata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTankinyushoRyoyokaigo_NinchishoShikkangata other = (KaigoyoboTankinyushoRyoyokaigo_NinchishoShikkangata) obj;
