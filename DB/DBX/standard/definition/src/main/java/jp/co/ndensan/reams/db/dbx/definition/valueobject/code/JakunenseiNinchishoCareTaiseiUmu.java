 ...
 * @reference
 */
public class JakunenseiNinchishoCareTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.若年性認知症ケア体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 若年性認知症ケア体制の有無
     */
    public JakunenseiNinchishoCareTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 若年性認知症ケア体制の有無を表す文字列
     */
    public JakunenseiNinchishoCareTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JakunenseiNinchishoCareTaiseiUmu other = (JakunenseiNinchishoCareTaiseiUmu) obj;
