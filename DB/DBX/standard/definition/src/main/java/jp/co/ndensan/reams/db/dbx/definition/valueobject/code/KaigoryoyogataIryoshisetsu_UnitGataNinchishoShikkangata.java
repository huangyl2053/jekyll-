...
/**
 * 介護療養型医療施設_ユニット型認知症疾患型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護療養型医療施設_ユニット型認知症疾患型
 * @bizDomain
 ...
 * @reference
 */
public class KaigoryoyogataIryoshisetsu_UnitGataNinchishoShikkangata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 介護療養型医療施設_ユニット型認知症疾患型を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護療養型医療施設_ユニット型認知症疾患型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_ユニット型認知症疾患型
     */
    public KaigoryoyogataIryoshisetsu_UnitGataNinchishoShikkangata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_ユニット型認知症疾患型を表す文字列
     */
    public KaigoryoyogataIryoshisetsu_UnitGataNinchishoShikkangata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoryoyogataIryoshisetsu_UnitGataNinchishoShikkangata other = (KaigoryoyogataIryoshisetsu_UnitGataNinchishoShikkangata) obj;
