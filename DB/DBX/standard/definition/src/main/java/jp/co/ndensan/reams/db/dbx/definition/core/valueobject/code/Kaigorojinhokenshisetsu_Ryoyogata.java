 ...
 * @reference
 */
public class Kaigorojinhokenshisetsu_Ryoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護老人保健施設_療養型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護老人保健施設_療養型
     */
    public Kaigorojinhokenshisetsu_Ryoyogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護老人保健施設_療養型を表す文字列
     */
    public Kaigorojinhokenshisetsu_Ryoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Kaigorojinhokenshisetsu_Ryoyogata other = (Kaigorojinhokenshisetsu_Ryoyogata) obj;
