 ...
 * @reference
 */
public class KaigoJogaiTekiyoJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護除外適用事由.getCodeShubetsu();
    }
     ...
     * @param code 介護除外適用事由
     */
    public KaigoJogaiTekiyoJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護除外適用事由を表す文字列
     */
    public KaigoJogaiTekiyoJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoJogaiTekiyoJiyu other = (KaigoJogaiTekiyoJiyu) obj;
