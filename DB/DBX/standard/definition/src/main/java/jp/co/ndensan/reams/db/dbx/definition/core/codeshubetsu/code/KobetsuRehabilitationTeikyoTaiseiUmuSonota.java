 ...
 * @reference
 */
public class KobetsuRehabilitationTeikyoTaiseiUmuSonota implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuSonota(Code code) {
        this.code = code;
    }
     ...
     */
    public KobetsuRehabilitationTeikyoTaiseiUmuSonota(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuRehabilitationTeikyoTaiseiUmuSonota other = (KobetsuRehabilitationTeikyoTaiseiUmuSonota) obj;
