 ...
 * @reference
 */
public class RehabilitationTeikyoTaiseiUmuSagyoRyoho2 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public RehabilitationTeikyoTaiseiUmuSagyoRyoho2(Code code) {
        this.code = code;
    }
     ...
     */
    public RehabilitationTeikyoTaiseiUmuSagyoRyoho2(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RehabilitationTeikyoTaiseiUmuSagyoRyoho2 other = (RehabilitationTeikyoTaiseiUmuSagyoRyoho2) obj;
