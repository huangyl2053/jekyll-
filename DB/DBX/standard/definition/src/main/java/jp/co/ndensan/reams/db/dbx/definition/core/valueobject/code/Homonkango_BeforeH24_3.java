...
/**
 * 訪問看護_平成24年3月以前を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 訪問看護_平成24年3月以前
 * @bizDomain
 ...
 * @reference
 */
public class Homonkango_BeforeH24_3 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.訪問看護_平成24年3月以前.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 訪問看護_平成24年3月以前
     */
    public Homonkango_BeforeH24_3(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 訪問看護_平成24年3月以前を表す文字列
     */
    public Homonkango_BeforeH24_3(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Homonkango_BeforeH24_3 other = (Homonkango_BeforeH24_3) obj;
