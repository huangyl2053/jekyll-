...
/**
 * 療養環境基準_診療所療養型ユニット型_診療所療養型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 療養環境基準_診療所療養型ユニット型_診療所療養型
 * @bizDomain
 ...
 * @reference
 */
public class RyoyokankyoKijun_ShinryojoRyoyogataUnitGata_ShinryojoRyoyogata
    ...
    /**
     * 療養環境基準_診療所療養型ユニット型_診療所療養型を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.療養環境基準_診療所療養型ユニット型_診療所療養型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 療養環境基準_診療所療養型ユニット型_診療所療養型
     */
    public RyoyokankyoKijun_ShinryojoRyoyogataUnitGata_ShinryojoRyoyogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 療養環境基準_診療所療養型ユニット型_診療所療養型を表す文字列
     */
    public RyoyokankyoKijun_ShinryojoRyoyogataUnitGata_ShinryojoRyoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RyoyokankyoKijun_ShinryojoRyoyogataUnitGata_ShinryojoRyoyogata other
                = (RyoyokankyoKijun_ShinryojoRyoyogataUnitGata_ShinryojoRyoyogata) obj;
