 ...
 * @reference
 */
public class RehabilitationTeikyoTaiseiUmuRigakuRyoho2 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public RehabilitationTeikyoTaiseiUmuRigakuRyoho2(Code code) {
        this.code = code;
    }
     ...
     */
    public RehabilitationTeikyoTaiseiUmuRigakuRyoho2(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RehabilitationTeikyoTaiseiUmuRigakuRyoho2 other = (RehabilitationTeikyoTaiseiUmuRigakuRyoho2) obj;
