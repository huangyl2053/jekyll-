 ...
 * @reference
 */
public class SogeiTaisei implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.送迎体制.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 送迎体制を表す文字列
     */
    public SogeiTaisei(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final SogeiTaisei other = (SogeiTaisei) obj;
