...
/**
 * 介護療養型医療施設_病院経過型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護療養型医療施設_病院経過型
 * @bizDomain
 ...
 * @reference
 */
public class KaigoryoyogataIryoshisetsu_Byoinkeikagata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護療養型医療施設_病院経過型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_病院経過型
     */
    public KaigoryoyogataIryoshisetsu_Byoinkeikagata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_病院経過型を表す文字列
     */
    public KaigoryoyogataIryoshisetsu_Byoinkeikagata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoryoyogataIryoshisetsu_Byoinkeikagata other = (KaigoryoyogataIryoshisetsu_Byoinkeikagata) obj;
