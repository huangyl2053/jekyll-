...
/**
 * 介護療養型医療施設_認知症疾患型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護療養型医療施設_認知症疾患型
 * @bizDomain
 ...
 * @reference
 */
public class KaigoryoyogataIryoshisetsu_NinchishoShikkangata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護療養型医療施設_認知症疾患型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_認知症疾患型
     */
    public KaigoryoyogataIryoshisetsu_NinchishoShikkangata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護療養型医療施設_認知症疾患型を表す文字列
     */
    public KaigoryoyogataIryoshisetsu_NinchishoShikkangata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoryoyogataIryoshisetsu_NinchishoShikkangata other = (KaigoryoyogataIryoshisetsu_NinchishoShikkangata) obj;
