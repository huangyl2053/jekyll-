...
/**
 * 事業所評価加算_申出_の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 事業所評価加算_申出_の有無
 * @bizDomain
 ...
 * @reference
 */
public class JigyoshoHyokaKasanMoshideUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.事業所評価加算_申出_の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 事業所評価加算_申出_の有無
     */
    public JigyoshoHyokaKasanMoshideUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 事業所評価加算_申出_の有無を表す文字列
     */
    public JigyoshoHyokaKasanMoshideUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JigyoshoHyokaKasanMoshideUmu other = (JigyoshoHyokaKasanMoshideUmu) obj;
