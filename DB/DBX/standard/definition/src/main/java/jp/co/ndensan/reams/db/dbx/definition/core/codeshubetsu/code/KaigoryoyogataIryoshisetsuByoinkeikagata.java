 ...
 * @reference
 */
public class KaigoryoyogataIryoshisetsuByoinkeikagata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KaigoryoyogataIryoshisetsuByoinkeikagata(Code code) {
        this.code = code;
    }
     ...
     */
    public KaigoryoyogataIryoshisetsuByoinkeikagata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoryoyogataIryoshisetsuByoinkeikagata other = (KaigoryoyogataIryoshisetsuByoinkeikagata) obj;
