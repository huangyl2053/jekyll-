 ...
 * @reference
 */
public class RehabilitationTeikyoTaiseiUmuSonota implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public RehabilitationTeikyoTaiseiUmuSonota(Code code) {
        this.code = code;
    }
     ...
     */
    public RehabilitationTeikyoTaiseiUmuSonota(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RehabilitationTeikyoTaiseiUmuSonota other = (RehabilitationTeikyoTaiseiUmuSonota) obj;
