 ...
 * @reference
 */
public class KaigoyoboTokuteishisetsuNyukyoshaSeikatsukaigoYogoRojinHome implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KaigoyoboTokuteishisetsuNyukyoshaSeikatsukaigoYogoRojinHome(Code code) {
        this.code = code;
    }
     ...
     */
    public KaigoyoboTokuteishisetsuNyukyoshaSeikatsukaigoYogoRojinHome(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTokuteishisetsuNyukyoshaSeikatsukaigoYogoRojinHome other = (KaigoyoboTokuteishisetsuNyukyoshaSeikatsukaigoYogoRojinHome) obj;
