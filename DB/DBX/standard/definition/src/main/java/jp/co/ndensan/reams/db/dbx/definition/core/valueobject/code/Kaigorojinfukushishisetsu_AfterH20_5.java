...
/**
 * 介護老人保健施設_平成20年5月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護老人保健施設_平成20年5月以降
 * @bizDomain
 ...
 * @reference
 */
public class Kaigorojinfukushishisetsu_AfterH20_5 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護老人保健施設_平成20年5月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護老人保健施設_平成20年5月以降
     */
    public Kaigorojinfukushishisetsu_AfterH20_5(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護老人保健施設_平成20年5月以降を表す文字列
     */
    public Kaigorojinfukushishisetsu_AfterH20_5(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Kaigorojinfukushishisetsu_AfterH20_5 other = (Kaigorojinfukushishisetsu_AfterH20_5) obj;
