 ...
 * @reference
 */
public class TankinyushoRyoyokaigoNinchishoShikkangata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public TankinyushoRyoyokaigoNinchishoShikkangata(Code code) {
        this.code = code;
    }
     ...
     */
    public TankinyushoRyoyokaigoNinchishoShikkangata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigoNinchishoShikkangata other = (TankinyushoRyoyokaigoNinchishoShikkangata) obj;
