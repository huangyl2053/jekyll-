 ...
 * @reference
 */
public class ChiikimitchakugataKaigoRojinfukushishisetsuJininHaichiKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public ChiikimitchakugataKaigoRojinfukushishisetsuJininHaichiKubun(Code code) {
        this.code = code;
    }
     ...
     */
    public ChiikimitchakugataKaigoRojinfukushishisetsuJininHaichiKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ChiikimitchakugataKaigoRojinfukushishisetsuJininHaichiKubun other = (ChiikimitchakugataKaigoRojinfukushishisetsuJininHaichiKubun) obj;
