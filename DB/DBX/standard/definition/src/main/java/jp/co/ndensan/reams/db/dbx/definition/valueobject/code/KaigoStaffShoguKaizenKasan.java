 ...
 * @reference
 */
public class KaigoStaffShoguKaizenKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護職員処遇改善加算.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護職員処遇改善加算
     */
    public KaigoStaffShoguKaizenKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護職員処遇改善加算を表す文字列
     */
    public KaigoStaffShoguKaizenKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoStaffShoguKaizenKasan other = (KaigoStaffShoguKaizenKasan) obj;
