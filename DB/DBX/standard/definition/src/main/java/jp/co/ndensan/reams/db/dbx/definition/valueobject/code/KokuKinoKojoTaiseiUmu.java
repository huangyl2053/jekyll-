 ...
 * @reference
 */
public class KokuKinoKojoTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.口腔機能向上体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 口腔機能向上体制の有無
     */
    public KokuKinoKojoTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 口腔機能向上体制の有無を表す文字列
     */
    public KokuKinoKojoTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KokuKinoKojoTaiseiUmu other = (KokuKinoKojoTaiseiUmu) obj;
