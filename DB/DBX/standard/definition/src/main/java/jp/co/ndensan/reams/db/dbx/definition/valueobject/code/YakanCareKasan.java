 ...
 * @reference
 */
public class YakanCareKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.夜間ケア加算.getCodeShubetsu();
    }
     ...
     * @param code 夜間ケア加算
     */
    public YakanCareKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 夜間ケア加算を表す文字列
     */
    public YakanCareKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final YakanCareKasan other = (YakanCareKasan) obj;
