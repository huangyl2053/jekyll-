...
/**
 * 特定施設入居者生活介護_短期利用型以外_平成21年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 特定施設入居者生活介護_短期利用型以外_平成21年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class TokuteishisetsunyukyoshaSeikatsukaigo_tankiriyogataIgai_AfterH21_4
    ...
    /**
     * 特定施設入居者生活介護_短期利用型以外_平成21年4月以降を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.特定施設入居者生活介護_短期利用型以外_平成21年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 特定施設入居者生活介護_短期利用型以外_平成21年4月以降
     */
    public TokuteishisetsunyukyoshaSeikatsukaigo_tankiriyogataIgai_AfterH21_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 特定施設入居者生活介護_短期利用型以外_平成21年4月以降を表す文字列
     */
    public TokuteishisetsunyukyoshaSeikatsukaigo_tankiriyogataIgai_AfterH21_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TokuteishisetsunyukyoshaSeikatsukaigo_tankiriyogataIgai_AfterH21_4 other
                = (TokuteishisetsunyukyoshaSeikatsukaigo_tankiriyogataIgai_AfterH21_4) obj;
