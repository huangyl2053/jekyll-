...
/**
 * 短期入所療養介護_認知症疾患型_平成15年3月以前を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 短期入所療養介護_認知症疾患型_平成15年3月以前
 * @bizDomain
 ...
 * @reference
 */
public class TankinyushoRyoyokaigo_NinchishoShikkangata_BeforeH15_3 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 短期入所療養介護_認知症疾患型_平成15年3月以前を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.短期入所療養介護_認知症疾患型_平成15年3月以前.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_認知症疾患型_平成15年3月以前
     */
    public TankinyushoRyoyokaigo_NinchishoShikkangata_BeforeH15_3(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 短期入所療養介護_認知症疾患型_平成15年3月以前を表す文字列
     */
    public TankinyushoRyoyokaigo_NinchishoShikkangata_BeforeH15_3(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigo_NinchishoShikkangata_BeforeH15_3 other = (TankinyushoRyoyokaigo_NinchishoShikkangata_BeforeH15_3) obj;
