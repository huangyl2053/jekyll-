...
/**
 * 療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class RyoyokankyoKijun_AfterH19_4 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降
     */
    public RyoyokankyoKijun_AfterH19_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降を表す文字列
     */
    public RyoyokankyoKijun_AfterH19_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RyoyokankyoKijun_AfterH19_4 other = (RyoyokankyoKijun_AfterH19_4) obj;
