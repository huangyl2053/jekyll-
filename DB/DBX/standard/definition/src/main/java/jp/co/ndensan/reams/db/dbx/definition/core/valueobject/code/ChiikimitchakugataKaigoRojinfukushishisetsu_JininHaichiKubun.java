...
/**
 * 地域密着型介護老人福祉施設_人員配置区分を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 地域密着型介護老人福祉施設_人員配置区分
 * @bizDomain
 ...
 * @reference
 */
public class ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 地域密着型介護老人福祉施設_人員配置区分を表すコード種別です。
     */
     ...
     * コンストラクタです。
     *
     * @param code 地域密着型介護老人福祉施設_人員配置区分
     */
    public ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 地域密着型介護老人福祉施設_人員配置区分を表す文字列
     */
    public ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun other = (ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun) obj;
