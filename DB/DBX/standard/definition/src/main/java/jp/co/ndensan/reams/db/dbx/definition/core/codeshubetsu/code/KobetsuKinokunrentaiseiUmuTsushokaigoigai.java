 ...
 * @reference
 */
public class KobetsuKinokunrentaiseiUmuTsushokaigoigai implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KobetsuKinokunrentaiseiUmuTsushokaigoigai(Code code) {
        this.code = code;
    }
     ...
     */
    public KobetsuKinokunrentaiseiUmuTsushokaigoigai(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuKinokunrentaiseiUmuTsushokaigoigai other = (KobetsuKinokunrentaiseiUmuTsushokaigoigai) obj;
