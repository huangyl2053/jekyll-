 ...
 * @reference
 */
public class KinokunrenShidoTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.機能訓練指導体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 機能訓練指導体制の有無
     */
    public KinokunrenShidoTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 機能訓練指導体制の有無を表す文字列
     */
    public KinokunrenShidoTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KinokunrenShidoTaiseiUmu other = (KinokunrenShidoTaiseiUmu) obj;
