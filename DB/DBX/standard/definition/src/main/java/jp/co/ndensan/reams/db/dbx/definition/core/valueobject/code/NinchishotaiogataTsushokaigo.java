 ...
 * @reference
 */
public class NinchishotaiogataTsushokaigo implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.認知症対応型通所介護.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 認知症対応型通所介護
     */
    public NinchishotaiogataTsushokaigo(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 認知症対応型通所介護を表す文字列
     */
    public NinchishotaiogataTsushokaigo(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final NinchishotaiogataTsushokaigo other = (NinchishotaiogataTsushokaigo) obj;
