...
/**
 * 個別機能訓練体制の有無_通所介護_平成21年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 個別機能訓練体制の有無_通所介護_平成21年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class KobetsuKinokunrentaiseiUmu_Tsushokaigo_AfterH21_4 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 個別機能訓練体制の有無_通所介護_平成21年4月以降を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.個別機能訓練体制の有無_通所介護_平成21年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 個別機能訓練体制の有無_通所介護_平成21年4月以降
     */
    public KobetsuKinokunrentaiseiUmu_Tsushokaigo_AfterH21_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 個別機能訓練体制の有無_通所介護_平成21年4月以降を表す文字列
     */
    public KobetsuKinokunrentaiseiUmu_Tsushokaigo_AfterH21_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuKinokunrentaiseiUmu_Tsushokaigo_AfterH21_4 other = (KobetsuKinokunrentaiseiUmu_Tsushokaigo_AfterH21_4) obj;
