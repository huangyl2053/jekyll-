 ...
 * @reference
 */
public class NinchishoCareKasanUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.認知症ケア加算の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 認知症ケア加算の有無
     */
    public NinchishoCareKasanUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 認知症ケア加算の有無を表す文字列
     */
    public NinchishoCareKasanUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final NinchishoCareKasanUmu other = (NinchishoCareKasanUmu) obj;
