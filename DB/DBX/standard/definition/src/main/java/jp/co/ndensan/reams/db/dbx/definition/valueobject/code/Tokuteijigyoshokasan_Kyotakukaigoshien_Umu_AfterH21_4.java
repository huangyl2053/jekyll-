...
/**
 * 特定事業所加算_居宅介護支援_の有無_平成21年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 ...
 * @reference
 */
public class Tokuteijigyoshokasan_Kyotakukaigoshien_Umu_AfterH21_4 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 特定事業所加算_居宅介護支援_の有無_平成21年4月以降を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.特定事業所加算_居宅介護支援_の有無_平成21年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 特定事業所加算_居宅介護支援_の有無_平成21年4月以降
     */
    public Tokuteijigyoshokasan_Kyotakukaigoshien_Umu_AfterH21_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 特定事業所加算_居宅介護支援_の有無_平成21年4月以降を表す文字列
     */
    public Tokuteijigyoshokasan_Kyotakukaigoshien_Umu_AfterH21_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Tokuteijigyoshokasan_Kyotakukaigoshien_Umu_AfterH21_4 other = (Tokuteijigyoshokasan_Kyotakukaigoshien_Umu_AfterH21_4) obj;
