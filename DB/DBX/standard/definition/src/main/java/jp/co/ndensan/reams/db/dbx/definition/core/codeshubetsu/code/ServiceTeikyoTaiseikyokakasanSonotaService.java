 ...
 * @reference
 */
public class ServiceTeikyoTaiseikyokakasanSonotaService implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public ServiceTeikyoTaiseikyokakasanSonotaService(Code code) {
        this.code = code;
    }
     ...
     */
    public ServiceTeikyoTaiseikyokakasanSonotaService(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ServiceTeikyoTaiseikyokakasanSonotaService other = (ServiceTeikyoTaiseikyokakasanSonotaService) obj;
