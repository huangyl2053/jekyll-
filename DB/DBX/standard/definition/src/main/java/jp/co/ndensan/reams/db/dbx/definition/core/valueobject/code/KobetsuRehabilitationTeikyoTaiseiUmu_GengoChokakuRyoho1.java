...
/**
 * 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_作業療法Ⅱ_の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_作業療法?_の有無
 * @bizDomain
 ...
 * @reference
 */
public class KobetsuRehabilitationTeikyoTaiseiUmu_GengoChokakuRyoho1 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_作業療法Ⅱ_の有無を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_作業療法Ⅱ_の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_作業療法Ⅱ_の有無
     */
    public KobetsuRehabilitationTeikyoTaiseiUmu_GengoChokakuRyoho1(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_作業療法Ⅱ_の有無を表す文字列
     */
    public KobetsuRehabilitationTeikyoTaiseiUmu_GengoChokakuRyoho1(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuRehabilitationTeikyoTaiseiUmu_GengoChokakuRyoho1 other = (KobetsuRehabilitationTeikyoTaiseiUmu_GengoChokakuRyoho1) obj;
