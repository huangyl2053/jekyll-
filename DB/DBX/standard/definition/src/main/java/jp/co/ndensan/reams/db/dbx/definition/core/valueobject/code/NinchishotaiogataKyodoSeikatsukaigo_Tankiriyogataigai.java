...
/**
 * 認知症対応型共同生活介護_短期利用型以外を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 認知症対応型共同生活介護_短期利用型以外
 * @bizDomain
 ...
 * @reference
 */
public class NinchishotaiogataKyodoSeikatsukaigo_Tankiriyogataigai implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 認知症対応型共同生活介護_短期利用型以外を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.認知症対応型共同生活介護_短期利用型以外.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 認知症対応型共同生活介護_短期利用型以外
     */
    public NinchishotaiogataKyodoSeikatsukaigo_Tankiriyogataigai(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 認知症対応型共同生活介護_短期利用型以外を表す文字列
     */
    public NinchishotaiogataKyodoSeikatsukaigo_Tankiriyogataigai(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final NinchishotaiogataKyodoSeikatsukaigo_Tankiriyogataigai other = (NinchishotaiogataKyodoSeikatsukaigo_Tankiriyogataigai) obj;
