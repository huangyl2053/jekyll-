 ...
 * @reference
 */
public class TankinyushoRyoyokaigoTsujogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public TankinyushoRyoyokaigoTsujogata(Code code) {
        this.code = code;
    }
     ...
     */
    public TankinyushoRyoyokaigoTsujogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TankinyushoRyoyokaigoTsujogata other = (TankinyushoRyoyokaigoTsujogata) obj;
