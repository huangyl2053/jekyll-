...
/**
 * 認知症対応型共同生活介護_短期利用型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 認知症対応型共同生活介護_短期利用型
 * @bizDomain
 ...
 * @reference
 */
public class NinchishotaiogataKyodoSeikatsukaigo_Tankiriyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.認知症対応型共同生活介護_短期利用型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 認知症対応型共同生活介護_短期利用型
     */
    public NinchishotaiogataKyodoSeikatsukaigo_Tankiriyogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 認知症対応型共同生活介護_短期利用型を表す文字列
     */
    public NinchishotaiogataKyodoSeikatsukaigo_Tankiriyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final NinchishotaiogataKyodoSeikatsukaigo_Tankiriyogata other = (NinchishotaiogataKyodoSeikatsukaigo_Tankiriyogata) obj;
