...
/**
 * 特定施設入居者生活介護_短期利用型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 特定施設入居者生活介護_短期利用型
 * @bizDomain
 ...
 * @reference
 */
public class TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.特定施設入居者生活介護_短期利用型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 特定施設入居者生活介護_短期利用型
     */
    public TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 特定施設入居者生活介護_短期利用型を表す文字列
     */
    public TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogata other = (TokuteishisetsuNyukyoshaSeikatsukaigo_Tankiriyogata) obj;
