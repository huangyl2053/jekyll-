...
/**
 * ﾘﾊﾋﾞﾘﾃｰｼｮﾝ機能強化の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName ﾘﾊﾋﾞﾘﾃｰｼｮﾝ機能強化有無
 * @bizDomain
 ...
 * @reference
 */
public class RehabilitationKinoKyokaUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.ﾘﾊﾋﾞﾘﾃｰｼｮﾝ機能強化の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code ﾘﾊﾋﾞﾘﾃｰｼｮﾝ機能強化の有無
     */
    public RehabilitationKinoKyokaUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code ﾘﾊﾋﾞﾘﾃｰｼｮﾝ機能強化の有無を表す文字列
     */
    public RehabilitationKinoKyokaUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RehabilitationKinoKyokaUmu other = (RehabilitationKinoKyokaUmu) obj;
