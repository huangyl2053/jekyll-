...
/**
 * 特定事業所加算_訪問介護_の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 特定事業所加算_訪問介護_の有無
 * @bizDomain
 ...
 * @reference
 */
public class TokuteiJigyoshoKasanUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.特定事業所加算_訪問介護_の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 特定事業所加算_訪問介護_の有無
     */
    public TokuteiJigyoshoKasanUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 特定事業所加算_訪問介護_の有無を表す文字列
     */
    public TokuteiJigyoshoKasanUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TokuteiJigyoshoKasanUmu other = (TokuteiJigyoshoKasanUmu) obj;
