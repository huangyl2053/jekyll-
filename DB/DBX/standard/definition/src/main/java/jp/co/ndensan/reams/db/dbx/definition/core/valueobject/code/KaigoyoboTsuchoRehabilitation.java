...
/**
 * 介護予防通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝを表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboTsuchoRehabilitation implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ
     */
    public KaigoyoboTsuchoRehabilitation(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝを表す文字列
     */
    public KaigoyoboTsuchoRehabilitation(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTsuchoRehabilitation other = (KaigoyoboTsuchoRehabilitation) obj;
