 ...
 * @reference
 */
public class ChiikimitchakugataKaigorojinfukushishisetsuShisetsutoKubun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public ChiikimitchakugataKaigorojinfukushishisetsuShisetsutoKubun(Code code) {
        this.code = code;
    }
     ...
     */
    public ChiikimitchakugataKaigorojinfukushishisetsuShisetsutoKubun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ChiikimitchakugataKaigorojinfukushishisetsuShisetsutoKubun other = (ChiikimitchakugataKaigorojinfukushishisetsuShisetsutoKubun) obj;
