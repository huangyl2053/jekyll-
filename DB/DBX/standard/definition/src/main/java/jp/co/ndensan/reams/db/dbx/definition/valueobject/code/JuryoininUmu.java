 ...
 * @reference
 */
public class JuryoininUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.受領委任の有無.getCodeShubetsu();
    }
     ...
     * コンストラクタです。
     *
     * @param code 受領委任の有無を表す文字列
     */
    public JuryoininUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JuryoininUmu other = (JuryoininUmu) obj;
