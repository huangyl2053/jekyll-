...
/**
 * 介護予防短期入所療養介護_通常型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防短期入所療養介護_通常型
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboTankinyushoRyoyokaigo_NormalType implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防短期入所療養介護_通常型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防短期入所療養介護_通常型
     */
    public KaigoyoboTankinyushoRyoyokaigo_NormalType(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防短期入所療養介護_通常型を表す文字列
     */
    public KaigoyoboTankinyushoRyoyokaigo_NormalType(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTankinyushoRyoyokaigo_NormalType other = (KaigoyoboTankinyushoRyoyokaigo_NormalType) obj;
