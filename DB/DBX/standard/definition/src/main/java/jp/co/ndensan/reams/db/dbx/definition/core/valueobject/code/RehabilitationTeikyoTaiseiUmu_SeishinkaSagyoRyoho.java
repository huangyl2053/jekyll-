...
/**
 * ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_精神科作業療法_の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_精神科作業療法_の有無
 * @bizDomain
 ...
 * @reference
 */
public class RehabilitationTeikyoTaiseiUmu_SeishinkaSagyoRyoho implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_精神科作業療法_の有無を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_精神科作業療法_の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_精神科作業療法_の有無
     */
    public RehabilitationTeikyoTaiseiUmu_SeishinkaSagyoRyoho(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_精神科作業療法_の有無を表す文字列
     */
    public RehabilitationTeikyoTaiseiUmu_SeishinkaSagyoRyoho(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RehabilitationTeikyoTaiseiUmu_SeishinkaSagyoRyoho other = (RehabilitationTeikyoTaiseiUmu_SeishinkaSagyoRyoho) obj;
