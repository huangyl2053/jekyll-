 ...
 * @reference
 */
public class IshiHaichiKijun implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.医師の配置基準.getCodeShubetsu();
    }
     ...
     * @param code 医師の配置基準
     */
    public IshiHaichiKijun(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 医師の配置基準を表す文字列
     */
    public IshiHaichiKijun(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final IshiHaichiKijun other = (IshiHaichiKijun) obj;
