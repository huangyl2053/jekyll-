 ...
 * @reference
 */
public class KaigoShikakuShutokuJiyu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護資格取得事由.getCodeShubetsu();
    }
     ...
     * @param code 介護資格取得事由
     */
    public KaigoShikakuShutokuJiyu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護資格取得事由を表す文字列
     */
    public KaigoShikakuShutokuJiyu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoShikakuShutokuJiyu other = (KaigoShikakuShutokuJiyu) obj;
