...
public enum ConfigNameDBC {
     ...
     * 高額決定通知書_初期選択抽出条件
     */
    高額決定通知書_初期選択抽出条件("高額決定通知書_初期選択抽出条件"),
    /**
     * 初期表示_単位数単価
     */
    初期表示_単位数単価("初期表示_単位数単価"),
    /**
     * 初期表示_給付率。
     */
    ...
    /**
     * 国保連取込_総合事業費公費受給者別一覧表情報_交換情報識別番号
     */
    国保連取込_総合事業費公費受給者別一覧表情報_交換情報識別番号("国保連取込_総合事業費公費受給者別一覧表情報_交換情報識別番号"),
    /**
     ...
     * 国保連受給異動_区分認定履歴訂正出力
     */
    国保連受給異動_区分認定履歴訂正出力("国保連受給異動_区分認定履歴訂正出力"),
    /**
     * 受領委任払い管理_管理制御
     */
    受領委任払い管理_管理制御("受領委任払い管理_管理制御"),
    /**
     * 振込単位
     */
    振込単位("振込単位");
