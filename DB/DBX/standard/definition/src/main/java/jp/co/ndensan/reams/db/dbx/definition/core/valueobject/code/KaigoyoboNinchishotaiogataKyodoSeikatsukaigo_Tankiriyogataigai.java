...
/**
 * 介護予防認知症対応型共同生活介護_短期利用型以外を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防認知症対応型共同生活介護_短期利用型以外
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboNinchishotaiogataKyodoSeikatsukaigo_Tankiriyogataigai
    ...
    /**
     * 介護予防認知症対応型共同生活介護_短期利用型以外を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防認知症対応型共同生活介護_短期利用型以外.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防認知症対応型共同生活介護_短期利用型以外
     */
    public KaigoyoboNinchishotaiogataKyodoSeikatsukaigo_Tankiriyogataigai(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防認知症対応型共同生活介護_短期利用型以外を表す文字列
     */
    public KaigoyoboNinchishotaiogataKyodoSeikatsukaigo_Tankiriyogataigai(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboNinchishotaiogataKyodoSeikatsukaigo_Tankiriyogataigai other
                = (KaigoyoboNinchishotaiogataKyodoSeikatsukaigo_Tankiriyogataigai) obj;
