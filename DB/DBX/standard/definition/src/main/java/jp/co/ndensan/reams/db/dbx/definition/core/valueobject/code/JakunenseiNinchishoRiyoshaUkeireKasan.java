...
/**
 * 若年性認知症利用者_入所者_患者_受入加算を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 若年性認知症利用者_入所者_患者_受入加算
 * @bizDomain
 ...
 * @reference
 */
public class JakunenseiNinchishoRiyoshaUkeireKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 若年性認知症利用者_入所者_患者_受入加算を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.若年性認知症利用者_入所者_患者_受入加算.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 若年性認知症利用者_入所者_患者_受入加算
     */
    public JakunenseiNinchishoRiyoshaUkeireKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 若年性認知症利用者_入所者_患者_受入加算を表す文字列
     */
    public JakunenseiNinchishoRiyoshaUkeireKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final JakunenseiNinchishoRiyoshaUkeireKasan other = (JakunenseiNinchishoRiyoshaUkeireKasan) obj;
