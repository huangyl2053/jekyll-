 ...
 * @reference
 */
public class NyuyokuKaijoTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.入浴介助体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 入浴介助体制の有無
     */
    public NyuyokuKaijoTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 入浴介助体制の有無を表す文字列
     */
    public NyuyokuKaijoTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final NyuyokuKaijoTaiseiUmu other = (NyuyokuKaijoTaiseiUmu) obj;
