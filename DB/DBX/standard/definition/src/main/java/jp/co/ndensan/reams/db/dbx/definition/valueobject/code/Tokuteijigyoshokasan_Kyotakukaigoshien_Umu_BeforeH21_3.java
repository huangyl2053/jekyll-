...
/**
 * 特定事業所加算_居宅介護支援_の有無_平成21年3月以前を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 特定事業所加算_居宅介護支援_の有無_平成21年3月以前
 * @bizDomain
 ...
 * @reference
 */
public class Tokuteijigyoshokasan_Kyotakukaigoshien_Umu_BeforeH21_3 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 特定事業所加算_居宅介護支援_の有無_平成21年3月以前を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.特定事業所加算_居宅介護支援_の有無_平成21年3月以前.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 特定事業所加算_居宅介護支援_の有無_平成21年3月以前
     */
    public Tokuteijigyoshokasan_Kyotakukaigoshien_Umu_BeforeH21_3(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 特定事業所加算_居宅介護支援_の有無_平成21年3月以前を表す文字列
     */
    public Tokuteijigyoshokasan_Kyotakukaigoshien_Umu_BeforeH21_3(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Tokuteijigyoshokasan_Kyotakukaigoshien_Umu_BeforeH21_3 other = (Tokuteijigyoshokasan_Kyotakukaigoshien_Umu_BeforeH21_3) obj;
