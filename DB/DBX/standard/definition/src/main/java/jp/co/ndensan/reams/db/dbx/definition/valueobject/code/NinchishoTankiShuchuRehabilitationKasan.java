...
/**
 * 認知症短期集中リハビリテーション加算を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 認知症短期集中リハビリテーション加算
 * @bizDomain
 ...
 * @reference
 */
public class NinchishoTankiShuchuRehabilitationKasan implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.認知症短期集中リハビリテーション加算.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 認知症短期集中リハビリテーション加算
     */
    public NinchishoTankiShuchuRehabilitationKasan(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 認知症短期集中リハビリテーション加算を表す文字列
     */
    public NinchishoTankiShuchuRehabilitationKasan(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final NinchishoTankiShuchuRehabilitationKasan other = (NinchishoTankiShuchuRehabilitationKasan) obj;
