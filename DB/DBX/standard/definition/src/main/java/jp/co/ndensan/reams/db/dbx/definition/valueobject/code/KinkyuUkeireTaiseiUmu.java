 ...
 * @reference
 */
public class KinkyuUkeireTaiseiUmu implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.緊急受入体制の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 緊急受入体制の有無
     */
    public KinkyuUkeireTaiseiUmu(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 緊急受入体制の有無を表す文字列
     */
    public KinkyuUkeireTaiseiUmu(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KinkyuUkeireTaiseiUmu other = (KinkyuUkeireTaiseiUmu) obj;
