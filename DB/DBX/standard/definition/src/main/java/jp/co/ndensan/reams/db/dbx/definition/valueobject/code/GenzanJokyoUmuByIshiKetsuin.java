...
/**
 * 医師の欠員による減算の状況の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 医師の欠員による減算の状況有無
 * @bizDomain
 ...
 * @reference
 */
public class GenzanJokyoUmuByIshiKetsuin implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.医師の欠員による減算の状況の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 医師の欠員による減算の状況の有無
     */
    public GenzanJokyoUmuByIshiKetsuin(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 医師の欠員による減算の状況の有無を表す文字列
     */
    public GenzanJokyoUmuByIshiKetsuin(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final GenzanJokyoUmuByIshiKetsuin other = (GenzanJokyoUmuByIshiKetsuin) obj;
