...
/**
 * 介護予防短期入所療養介護_療養型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防短期入所療養介護_療養型
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboTankinyushoRyoyokaigo_Ryoyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防短期入所療養介護_療養型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防短期入所療養介護_療養型
     */
    public KaigoyoboTankinyushoRyoyokaigo_Ryoyogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防短期入所療養介護_療養型を表す文字列
     */
    public KaigoyoboTankinyushoRyoyokaigo_Ryoyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboTankinyushoRyoyokaigo_Ryoyogata other = (KaigoyoboTankinyushoRyoyokaigo_Ryoyogata) obj;
