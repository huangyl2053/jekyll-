...
/**
 * 介護予防認知症対応型共同生活介護_短期利用型を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防認知症対応型共同生活介護_短期利用型
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboNinchishotaiogataKyodoSeikatsukaigo_Tankiriyogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 介護予防認知症対応型共同生活介護_短期利用型を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防認知症対応型共同生活介護_短期利用型.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防認知症対応型共同生活介護_短期利用型
     */
    public KaigoyoboNinchishotaiogataKyodoSeikatsukaigo_Tankiriyogata(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防認知症対応型共同生活介護_短期利用型を表す文字列
     */
    public KaigoyoboNinchishotaiogataKyodoSeikatsukaigo_Tankiriyogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboNinchishotaiogataKyodoSeikatsukaigo_Tankiriyogata other = (KaigoyoboNinchishotaiogataKyodoSeikatsukaigo_Tankiriyogata) obj;
