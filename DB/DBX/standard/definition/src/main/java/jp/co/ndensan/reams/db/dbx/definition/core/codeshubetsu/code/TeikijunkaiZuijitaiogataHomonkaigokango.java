 ...
 * @reference
 */
public class TeikijunkaiZuijitaiogataHomonkaigokango implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public TeikijunkaiZuijitaiogataHomonkaigokango(Code code) {
        this.code = code;
    }
     ...
     */
    public TeikijunkaiZuijitaiogataHomonkaigokango(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TeikijunkaiZuijitaiogataHomonkaigokango other = (TeikijunkaiZuijitaiogataHomonkaigokango) obj;
