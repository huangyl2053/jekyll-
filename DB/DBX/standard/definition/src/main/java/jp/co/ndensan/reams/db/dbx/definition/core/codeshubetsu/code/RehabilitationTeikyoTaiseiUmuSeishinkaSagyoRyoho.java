 ...
 * @reference
 */
public class RehabilitationTeikyoTaiseiUmuSeishinkaSagyoRyoho implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public RehabilitationTeikyoTaiseiUmuSeishinkaSagyoRyoho(Code code) {
        this.code = code;
    }
     ...
     */
    public RehabilitationTeikyoTaiseiUmuSeishinkaSagyoRyoho(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final RehabilitationTeikyoTaiseiUmuSeishinkaSagyoRyoho other = (RehabilitationTeikyoTaiseiUmuSeishinkaSagyoRyoho) obj;
