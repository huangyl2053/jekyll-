...
/**
 * 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅱ_の有無_平成21年3月以前を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法?_の有無_平成21年3月以前
 * @bizDomain
 ...
 * @reference
 */
public class KobetsuRehabilitationTeikyoTaiseiUmu_RigakuRyoho2_BeforeH21_3
    ...
    /**
     * 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅱ_の有無_平成21年3月以前を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅱ_の有無_平成21年3月以前.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅱ_の有無_平成21年3月以前
     */
    public KobetsuRehabilitationTeikyoTaiseiUmu_RigakuRyoho2_BeforeH21_3(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_理学療法Ⅱ_の有無_平成21年3月以前を表す文字列
     */
    public KobetsuRehabilitationTeikyoTaiseiUmu_RigakuRyoho2_BeforeH21_3(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuRehabilitationTeikyoTaiseiUmu_RigakuRyoho2_BeforeH21_3 other
                = (KobetsuRehabilitationTeikyoTaiseiUmu_RigakuRyoho2_BeforeH21_3) obj;
