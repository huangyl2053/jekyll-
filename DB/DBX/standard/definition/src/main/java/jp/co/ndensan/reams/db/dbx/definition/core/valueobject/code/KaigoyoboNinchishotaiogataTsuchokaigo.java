...
/**
 * 介護予防認知症対応型通所介護を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 介護予防認知症対応型通所介護
 * @bizDomain
 ...
 * @reference
 */
public class KaigoyoboNinchishotaiogataTsuchokaigo implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.介護予防認知症対応型通所介護.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 介護予防認知症対応型通所介護
     */
    public KaigoyoboNinchishotaiogataTsuchokaigo(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 介護予防認知症対応型通所介護を表す文字列
     */
    public KaigoyoboNinchishotaiogataTsuchokaigo(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoyoboNinchishotaiogataTsuchokaigo other = (KaigoyoboNinchishotaiogataTsuchokaigo) obj;
