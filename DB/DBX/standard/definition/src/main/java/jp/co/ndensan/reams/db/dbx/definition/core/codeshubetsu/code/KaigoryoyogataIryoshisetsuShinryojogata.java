 ...
 * @reference
 */
public class KaigoryoyogataIryoshisetsuShinryojogata implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
     ...
     */
    public KaigoryoyogataIryoshisetsuShinryojogata(Code code) {
        this.code = code;
    }
     ...
     */
    public KaigoryoyogataIryoshisetsuShinryojogata(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KaigoryoyogataIryoshisetsuShinryojogata other = (KaigoryoyogataIryoshisetsuShinryojogata) obj;
