...
/**
 * 通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ_平成24年4月以降を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ_平成24年4月以降
 * @bizDomain
 ...
 * @reference
 */
public class TsushoRehabilitation_AfterH24_4 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ_平成24年4月以降を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ_平成24年4月以降.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ_平成24年4月以降
     */
    public TsushoRehabilitation_AfterH24_4(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 通所ﾘﾊﾋﾞﾘﾃｰｼｮﾝ_平成24年4月以降を表す文字列
     */
    public TsushoRehabilitation_AfterH24_4(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final TsushoRehabilitation_AfterH24_4 other = (TsushoRehabilitation_AfterH24_4) obj;
