...
/**
 * 定期巡回_随時対応型訪問介護看護を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName 定期巡回_随時対応型訪問介護看護
 * @bizDomain
 ...
 * @reference
 */
public class Teikijunkai_zuijitaiogataHomonkaigokango implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.定期巡回_随時対応型訪問介護看護.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 定期巡回_随時対応型訪問介護看護
     */
    public Teikijunkai_zuijitaiogataHomonkaigokango(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 定期巡回_随時対応型訪問介護看護を表す文字列
     */
    public Teikijunkai_zuijitaiogataHomonkaigokango(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final Teikijunkai_zuijitaiogataHomonkaigokango other = (Teikijunkai_zuijitaiogataHomonkaigokango) obj;
