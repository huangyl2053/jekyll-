...
/**
 * サービス提供体制強化加算_訪問入浴介護等を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 * @jpName サービス提供体制強化加算_訪問入浴介護等
 * @bizDomain
 ...
 * @reference
 */
public class ServiceTeikyoTaiseikyokakasan_Homonnyuyokukaigo_etc implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * サービス提供体制強化加算_訪問入浴介護等を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.サービス提供体制強化加算_訪問入浴介護等.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code サービス提供体制強化加算_訪問入浴介護等
     */
    public ServiceTeikyoTaiseikyokakasan_Homonnyuyokukaigo_etc(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code サービス提供体制強化加算_訪問入浴介護等を表す文字列
     */
    public ServiceTeikyoTaiseikyokakasan_Homonnyuyokukaigo_etc(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final ServiceTeikyoTaiseikyokakasan_Homonnyuyokukaigo_etc other = (ServiceTeikyoTaiseikyokakasan_Homonnyuyokukaigo_etc) obj;
