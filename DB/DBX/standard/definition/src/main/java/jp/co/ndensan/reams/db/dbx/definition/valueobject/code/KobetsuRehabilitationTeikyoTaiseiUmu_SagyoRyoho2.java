...
/**
 * 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_言語聴覚療法Ⅱ_の有無を表すドメインクラスです。
 *
 * @author n3317 塚田 萌
 ...
 * @reference
 */
public class KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2 implements ICodeValueObject, IDbColumnMappable, IValueObject<Code> {
    ...
    /**
     * 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_言語聴覚療法Ⅱ_の有無を表すコード種別です。
     */
    ...
    static {
        ...
        CODE_SHUBETSU = DBXCodeShubetsu.個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_言語聴覚療法Ⅱ_の有無.getCodeShubetsu();
    }

    /**
     * コンストラクタです。
     *
     * @param code 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_言語聴覚療法Ⅱ_の有無
     */
    public KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2(Code code) {
        this.code = code;
    }
     ...
     * コンストラクタです。
     *
     * @param code 個別ﾘﾊﾋﾞﾘﾃｰｼｮﾝ提供体制_言語聴覚療法Ⅱ_の有無を表す文字列
     */
    public KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2(RString code) {
    ...
    public boolean equals(Object obj) {
        ...
        final KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2 other = (KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2) obj;
