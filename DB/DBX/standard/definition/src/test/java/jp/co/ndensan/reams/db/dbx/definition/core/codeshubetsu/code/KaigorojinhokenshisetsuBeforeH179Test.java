...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.KaigorojinhokenshisetsuBeforeH179;
...
/**
 * 介護老人保健施設_平成17年9月以前を表すドメインのテストクラスです。
 *
 * @author LDNS 李増鋒
 */
@RunWith(Enclosed.class)
public class KaigorojinhokenshisetsuBeforeH179Test extends DbxTestBase {
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつKaigorojinhokenshisetsu_BeforeH17_9ではないの場合_equalsは_falseを戻す() {
