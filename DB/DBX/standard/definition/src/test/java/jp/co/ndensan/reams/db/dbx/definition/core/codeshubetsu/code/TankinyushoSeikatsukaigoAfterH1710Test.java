...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.TankinyushoSeikatsukaigoAfterH1710;
...
/**
 * 短期入所生活介護_平成17年10月以降を表すドメインクラスのテストクラスです。
 *
 * @author LDNS 袁国棟
 */
@RunWith(Enclosed.class)
public class TankinyushoSeikatsukaigoAfterH1710Test extends DbxTestBase {
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectが1234567かつTankinyushoSeikatsukaigo_AfterH17_10ではないの場合_equalsは_falseを返す() {
