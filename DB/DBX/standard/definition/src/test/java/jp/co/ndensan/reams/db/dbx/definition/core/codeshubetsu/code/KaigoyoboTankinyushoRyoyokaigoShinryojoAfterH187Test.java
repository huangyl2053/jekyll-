...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.KaigoyoboTankinyushoRyoyokaigoShinryojoAfterH187;
...
/**
 * 介護予防短期入所療養介護_診療所等_平成18年7月以降を表すドメインのテストクラスです。
 *
 * @author LDNS 李増鋒
 */
@RunWith(Enclosed.class)
public class KaigoyoboTankinyushoRyoyokaigoShinryojoAfterH187Test extends DbxTestBase {
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつKaigoyoboTankinyushoRyoyokaigo_Shinryojo_AfterH18_7ではないの場合_equalsは_falseを戻す() {
