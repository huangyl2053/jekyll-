...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.KaigoServiceBunruiCode;
...
/**
 * KaigoServiceBunruiCodeのテストクラスです。
 *
 * @author LDNS 顧偉剛
 */
@RunWith(Enclosed.class)
public class KaigoServiceBunruiCodeTest extends DbxTestBase {

    private static KaigoServiceBunruiCode sut;

    @BeforeClass
    public static void setUp() {
        sut = new KaigoServiceBunruiCode(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつKaigoServiceBunruiCodeではないの場合_equalsは_falseを返す() {
            assertFalse(sut.equals(new RString("1111")));
        }

        @Test
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            KaigoServiceBunruiCode sut2 = new KaigoServiceBunruiCode(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new KaigoServiceBunruiCode(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            KaigoServiceBunruiCode sut = new KaigoServiceBunruiCode((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            KaigoServiceBunruiCode sut = new KaigoServiceBunruiCode(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            KaigoServiceBunruiCode sut2 = new KaigoServiceBunruiCode(new RString("10"));
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_介護サービス分類コードを返す() {
            KaigoServiceBunruiCode sut = new KaigoServiceBunruiCode(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("介護サービス分類コード")));
        }
    }
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_介護サービス分類コードを返す() {
            KaigoServiceBunruiCode sut = new KaigoServiceBunruiCode(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("介護サービス分類コード")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_介護サービス分類コードを返す() {
            KaigoServiceBunruiCode sut = new KaigoServiceBunruiCode(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("介護サービス分類コード")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_介護サービス分類コードを返す() {
            KaigoServiceBunruiCode sut = new KaigoServiceBunruiCode(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("介護サービス分類コード")));
        }
    }
}
