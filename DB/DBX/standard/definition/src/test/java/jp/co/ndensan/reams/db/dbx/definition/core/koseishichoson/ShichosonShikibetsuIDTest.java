...
public class ShichosonShikibetsuIDTest extends DbxTestBase {

    public ShichosonShikibetsuIDTest() {
    }

    public static class hasValidLength extends DbxTestBase {
    ...
    public static class valueAndGetColumnValue_createFromRString extends DbxTestBase {
    ...
    public static class valueAndGetColumnValue_createFromString extends DbxTestBase {
    ...
    public static class CompareTo extends DbxTestBase {
    ...
    public static class equals extends DbxTestBase {
    ...
    public static class HashCode extends DbxTestBase {
