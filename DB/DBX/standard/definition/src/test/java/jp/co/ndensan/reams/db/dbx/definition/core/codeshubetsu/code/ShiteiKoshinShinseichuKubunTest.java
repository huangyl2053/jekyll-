...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.ShiteiKoshinShinseichuKubun;
...
/**
 * 指定更新申請中区分を表すドメインクラスのテストクラスです。
 * 
 * @author LDNS 陳羿
 */
@RunWith(Enclosed.class)
public class ShiteiKoshinShinseichuKubunTest extends DbxTestBase {

    private static ShiteiKoshinShinseichuKubun sut;

    @BeforeClass
    public static void setUp() {
        sut = new ShiteiKoshinShinseichuKubun(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつShiteiKoshinShinseichuKubunではないの場合_equalsは_falseを戻す() {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            ShiteiKoshinShinseichuKubun sut2 = new ShiteiKoshinShinseichuKubun(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new ShiteiKoshinShinseichuKubun(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            ShiteiKoshinShinseichuKubun sut = new ShiteiKoshinShinseichuKubun((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }
        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            ShiteiKoshinShinseichuKubun sut = new ShiteiKoshinShinseichuKubun(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを戻す() {
            ShiteiKoshinShinseichuKubun sut2=new ShiteiKoshinShinseichuKubun(new RString("10"));
    ...
    public static class getColumnValueテスト extends DbxTestBase {
        ...
        public void LDNS_codeを10指定した場合_getColumnValueは_10を戻す() {
            Code code = new Code(new RString("10"));
            assertThat(sut.getColumnValue(), is(code));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_指定更新申請中区分を戻す() {
            ShiteiKoshinShinseichuKubun sut = new ShiteiKoshinShinseichuKubun(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("指定更新申請中区分")));
        }
    }
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_指定更新申請中区分を戻す() {
            ShiteiKoshinShinseichuKubun sut = new ShiteiKoshinShinseichuKubun(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("指定更新申請中区分")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_指定更新申請中区分を戻す() {
            ShiteiKoshinShinseichuKubun sut = new ShiteiKoshinShinseichuKubun(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("指定更新申請中区分")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_指定更新申請中区分を戻す() {
            ShiteiKoshinShinseichuKubun sut = new ShiteiKoshinShinseichuKubun(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("指定更新申請中区分")));
        }
    }
}