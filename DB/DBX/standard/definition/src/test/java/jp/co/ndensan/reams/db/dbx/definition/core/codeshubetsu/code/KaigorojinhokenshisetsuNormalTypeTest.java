...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.KaigorojinhokenshisetsuNormalType;
...
/**
 * 介護老人保健施設_通常型を表すドメインのテストクラスです。
 *
 * @author LDNS 李増鋒
 */
@RunWith(Enclosed.class)
public class KaigorojinhokenshisetsuNormalTypeTest extends DbxTestBase {

    private static KaigorojinhokenshisetsuNormalType sut;

    @BeforeClass
    public static void setUp() {
        sut = new KaigorojinhokenshisetsuNormalType(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつKaigorojinhokenshisetsu_NormalTypeではないの場合_equalsは_falseを戻す() {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            KaigorojinhokenshisetsuNormalType sut2 = new KaigorojinhokenshisetsuNormalType(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new KaigorojinhokenshisetsuNormalType(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            KaigorojinhokenshisetsuNormalType sut = new KaigorojinhokenshisetsuNormalType((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            KaigorojinhokenshisetsuNormalType sut = new KaigorojinhokenshisetsuNormalType(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを戻す() {
            KaigorojinhokenshisetsuNormalType sut2 = new KaigorojinhokenshisetsuNormalType(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_介護老人保健施設_通常型を戻す() {
            KaigorojinhokenshisetsuNormalType sut = new KaigorojinhokenshisetsuNormalType(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("介護老人保健施設_通常型")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnull以外の場合_getMeishoは_介護老人保健施設_通常型を戻す() {
            KaigorojinhokenshisetsuNormalType sut = new KaigorojinhokenshisetsuNormalType(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("介護老人保健施設_通常型")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_介護老人保健施設_通常型を戻す() {
            KaigorojinhokenshisetsuNormalType sut = new KaigorojinhokenshisetsuNormalType(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("介護老人保健施設_通常型")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnull以外の場合_getRyakushoは_介護老人保健施設_通常型を戻す() {
            KaigorojinhokenshisetsuNormalType sut = new KaigorojinhokenshisetsuNormalType(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("介護老人保健施設_通常型")));
        }
    }
}
