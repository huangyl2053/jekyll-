...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.TankinyushoRyoyokaigoUnitGataNinchishoShikkangata;
...
/**
 * 短期入所療養介護_ユニット型認知症疾患型を表すドメインクラスのテストクラスです。
 *
 * @author LDNS 袁国棟
 */
@RunWith(Enclosed.class)
public class TankinyushoRyoyokaigoUnitGataNinchishoShikkangataTest extends DbxTestBase {
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectが1234567かつTankinyushoRyoyokaigo_UnitGataNinchishoShikkangataではないの場合_equalsは_falseを返す() {
