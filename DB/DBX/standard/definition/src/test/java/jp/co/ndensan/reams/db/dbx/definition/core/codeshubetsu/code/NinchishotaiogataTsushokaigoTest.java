...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.NinchishotaiogataTsushokaigo;
...
/**
 * 認知症対応型通所介護を表すドメインクラスのテストクラスです。
 *
 * @author LDNS 袁国棟
 */
@RunWith(Enclosed.class)
public class NinchishotaiogataTsushokaigoTest extends DbxTestBase {

    private static NinchishotaiogataTsushokaigo sut;

    @BeforeClass
    public static void setUp() {
        sut = new NinchishotaiogataTsushokaigo(new RString("10"));
    }
    ...
    public static class valueテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_認知症対応型通所介護コード種別に10を指定した場合_valueは_コード10を返す() {
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectが1234567かつNinchishotaiogataTsushokaigoではないの場合_equalsは_falseを返す() {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            NinchishotaiogataTsushokaigo sut2 = new NinchishotaiogataTsushokaigo(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new NinchishotaiogataTsushokaigo(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            NinchishotaiogataTsushokaigo sut = new NinchishotaiogataTsushokaigo((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            NinchishotaiogataTsushokaigo sut = new NinchishotaiogataTsushokaigo(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            NinchishotaiogataTsushokaigo sut2 = new NinchishotaiogataTsushokaigo(new RString("10"));
    ...
    public static class getColumnValueテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_認知症対応型通所介護コード種別に10を指定した場合_getColumnValueは_10を返す() {
    ...
    public static class toRStringテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_認知症対応型通所介護コード種別に10を指定した場合_toRStringは_10を返す() {
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_指定したコードが1234567の場合_getMeishoは_認知症対応型通所介護を返す() {
            NinchishotaiogataTsushokaigo sut = new NinchishotaiogataTsushokaigo(new Code("1234567"));
            assertThat(sut.getMeisho(kijunbi), is(new RString("認知症対応型通所介護")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeが1234567の場合_getMeishoは_認知症対応型通所介護を返す() {
            NinchishotaiogataTsushokaigo sut = new NinchishotaiogataTsushokaigo(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("認知症対応型通所介護")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeが1234567の場合_getRyakushoは_認知症対応型通所介護を返す() {

            NinchishotaiogataTsushokaigo sut = new NinchishotaiogataTsushokaigo(new Code("1234567"));
            assertThat(sut.getRyakusho(kijunbi), is(new RString("認知症対応型通所介護")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        public void LDNS_codeが1234567の場合_getRyakushoは_認知症対応型通所介護を返す() {
            NinchishotaiogataTsushokaigo sut = new NinchishotaiogataTsushokaigo(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("認知症対応型通所介護")));
        }
    }
}
