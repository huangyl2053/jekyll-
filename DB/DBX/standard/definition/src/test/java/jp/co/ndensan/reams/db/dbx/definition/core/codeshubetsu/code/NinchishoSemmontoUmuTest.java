...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.NinchishoSemmontoUmu;
...
/**
 * 認知症専門棟の有無を表すドメインクラスのテストクラスです。
 *
 * @author LDNS 袁国棟
 */
@RunWith(Enclosed.class)
public class NinchishoSemmontoUmuTest extends DbxTestBase {

    private static NinchishoSemmontoUmu sut;

    @BeforeClass
    public static void setUp() {
        sut = new NinchishoSemmontoUmu(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectが1234567かつNinchishoSemmontoUmuではないの場合_equalsは_falseを返す() {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            NinchishoSemmontoUmu sut2 = new NinchishoSemmontoUmu(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new NinchishoSemmontoUmu(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            NinchishoSemmontoUmu sut = new NinchishoSemmontoUmu((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            NinchishoSemmontoUmu sut = new NinchishoSemmontoUmu(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            NinchishoSemmontoUmu sut2 = new NinchishoSemmontoUmu(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_指定したコードが1234567の場合_getMeishoは_認知症専門棟の有無を返す() {
            NinchishoSemmontoUmu sut = new NinchishoSemmontoUmu(new Code("1234567"));
            assertThat(sut.getMeisho(kijunbi), is(new RString("認知症専門棟の有無")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeが1234567の場合_getMeishoは_認知症専門棟の有無を返す() {
            NinchishoSemmontoUmu sut = new NinchishoSemmontoUmu(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("認知症専門棟の有無")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeが1234567の場合_getRyakushoは_認知症専門棟の有無を返す() {

            NinchishoSemmontoUmu sut = new NinchishoSemmontoUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(kijunbi), is(new RString("認知症専門棟の有無")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        public void LDNS_codeが1234567の場合_getRyakushoは_認知症専門棟の有無を返す() {
            NinchishoSemmontoUmu sut = new NinchishoSemmontoUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("認知症専門棟の有無")));
        }
    }
}
