...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.SetsubiKijun;
...
/**
 * 設備基準を表すドメインクラスのテストクラスです。
 *
 * @author LDNS 宋文娟
 */
@RunWith(Enclosed.class)
public class SetsubiKijunTest extends DbxTestBase {

    private static SetsubiKijun sut;

    @BeforeClass
    public static void setUp() {
        sut = new SetsubiKijun(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつSetsubiKijunではないの場合_equalsは_falseを戻す() {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            SetsubiKijun sut2 = new SetsubiKijun(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new SetsubiKijun(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            SetsubiKijun sut = new SetsubiKijun((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            SetsubiKijun sut = new SetsubiKijun(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを戻す() {
            SetsubiKijun sut2 = new SetsubiKijun(new RString("10"));
    ...
    public static class getColumnValueテスト extends DbxTestBase {
        ...
        public void LDNS_codeを10指定した場合_getColumnValueは_10を戻す() {
            assertThat(sut.getColumnValue().getColumnValue(), is(new RString("10")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_設備基準を戻す() {
            SetsubiKijun sut = new SetsubiKijun(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("設備基準")));
        }
    }
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnull以外の場合_getMeishoは_設備基準を戻す() {
            SetsubiKijun sut = new SetsubiKijun(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("設備基準")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_設備基準を戻す() {
            SetsubiKijun sut = new SetsubiKijun(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("設備基準")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnull以外の場合_getRyakushoは_設備基準を戻す() {
            SetsubiKijun sut = new SetsubiKijun(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("設備基準")));
        }
    }
}
