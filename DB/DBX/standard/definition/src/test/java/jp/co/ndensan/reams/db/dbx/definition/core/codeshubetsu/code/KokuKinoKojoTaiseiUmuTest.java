...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.KokuKinoKojoTaiseiUmu;
...
/**
 * KokuKinoKojoTaiseiUmuのテストクラスです。
 *
 * @author LDNS 顧偉剛
 */
@RunWith(Enclosed.class)
public class KokuKinoKojoTaiseiUmuTest extends DbxTestBase {

    private static KokuKinoKojoTaiseiUmu sut;

    @BeforeClass
    public static void setUp() {
        sut = new KokuKinoKojoTaiseiUmu(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつKokuKinoKojoTaiseiUmuではないの場合_equalsは_falseを返す() {
            assertFalse(sut.equals(new RString("1111")));
        }

        @Test
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            KokuKinoKojoTaiseiUmu sut2 = new KokuKinoKojoTaiseiUmu(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new KokuKinoKojoTaiseiUmu(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            KokuKinoKojoTaiseiUmu sut = new KokuKinoKojoTaiseiUmu((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            KokuKinoKojoTaiseiUmu sut = new KokuKinoKojoTaiseiUmu(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            KokuKinoKojoTaiseiUmu sut2 = new KokuKinoKojoTaiseiUmu(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_口腔機能向上体制の有無を返す() {
            KokuKinoKojoTaiseiUmu sut = new KokuKinoKojoTaiseiUmu(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("口腔機能向上体制の有無")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_口腔機能向上体制の有無を返す() {
            KokuKinoKojoTaiseiUmu sut = new KokuKinoKojoTaiseiUmu(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("口腔機能向上体制の有無")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_口腔機能向上体制の有無を返す() {
            KokuKinoKojoTaiseiUmu sut = new KokuKinoKojoTaiseiUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("口腔機能向上体制の有無")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_口腔機能向上体制の有無を返す() {
            KokuKinoKojoTaiseiUmu sut = new KokuKinoKojoTaiseiUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("口腔機能向上体制の有無")));
        }
    }
}
