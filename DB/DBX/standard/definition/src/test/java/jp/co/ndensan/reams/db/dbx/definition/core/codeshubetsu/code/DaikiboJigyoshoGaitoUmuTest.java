...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.DaikiboJigyoshoGaitoUmu;
...
/**
 * DaikiboJigyoshoGaitoUmuのテストクラスです。
 *
 * @author LDNS 顧偉剛
 */
@RunWith(Enclosed.class)
public class DaikiboJigyoshoGaitoUmuTest extends DbxTestBase {

    private static DaikiboJigyoshoGaitoUmu sut;

    @BeforeClass
    public static void setUp() {
        sut = new DaikiboJigyoshoGaitoUmu(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつDaikiboJigyoshoGaitoUmuではないの場合_equalsは_falseを返す() {
            assertFalse(sut.equals(new RString("1111")));
        }

        @Test
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            DaikiboJigyoshoGaitoUmu sut2 = new DaikiboJigyoshoGaitoUmu(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new DaikiboJigyoshoGaitoUmu(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            DaikiboJigyoshoGaitoUmu sut = new DaikiboJigyoshoGaitoUmu((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            DaikiboJigyoshoGaitoUmu sut = new DaikiboJigyoshoGaitoUmu(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            DaikiboJigyoshoGaitoUmu sut2 = new DaikiboJigyoshoGaitoUmu(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_大規模事業所該当の有無を返す() {
            DaikiboJigyoshoGaitoUmu sut = new DaikiboJigyoshoGaitoUmu(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("大規模事業所該当の有無")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_大規模事業所該当の有無を返す() {
            DaikiboJigyoshoGaitoUmu sut = new DaikiboJigyoshoGaitoUmu(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("大規模事業所該当の有無")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_大規模事業所該当の有無を返す() {
            DaikiboJigyoshoGaitoUmu sut = new DaikiboJigyoshoGaitoUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("大規模事業所該当の有無")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_大規模事業所該当の有無を返す() {
            DaikiboJigyoshoGaitoUmu sut = new DaikiboJigyoshoGaitoUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("大規模事業所該当の有無")));
        }
    }
}
