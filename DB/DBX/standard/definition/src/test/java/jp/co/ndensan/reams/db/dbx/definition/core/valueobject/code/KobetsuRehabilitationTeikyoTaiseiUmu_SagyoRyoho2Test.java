...
/**
 * KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2のテストクラスです。
 * 
 * @author LDNS 徐宇聖
 */
...
public class KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2Test extends DbxTestBase {
    ...
    private static KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2 sut;

    @BeforeClass
    public static void setUp() {
        sut = new KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2 sut2 = new KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2 sut = new KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }
        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2 sut = new KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを戻す() {
            KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2 sut2=new KobetsuRehabilitationTeikyoTaiseiUmu_SagyoRyoho2(new RString("10"));
