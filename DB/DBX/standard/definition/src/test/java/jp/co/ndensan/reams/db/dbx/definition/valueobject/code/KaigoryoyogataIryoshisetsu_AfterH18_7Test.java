...
public class KaigoryoyogataIryoshisetsu_AfterH18_7Test extends DbxTestBase {
    ...
    private static KaigoryoyogataIryoshisetsu_AfterH18_7 sut;

    @BeforeClass
    public static void setUp() {
        sut = new KaigoryoyogataIryoshisetsu_AfterH18_7(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            KaigoryoyogataIryoshisetsu_AfterH18_7 sut2 = new KaigoryoyogataIryoshisetsu_AfterH18_7(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new KaigoryoyogataIryoshisetsu_AfterH18_7(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            KaigoryoyogataIryoshisetsu_AfterH18_7 sut = new KaigoryoyogataIryoshisetsu_AfterH18_7((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            KaigoryoyogataIryoshisetsu_AfterH18_7 sut = new KaigoryoyogataIryoshisetsu_AfterH18_7(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを戻す() {
            KaigoryoyogataIryoshisetsu_AfterH18_7 sut2 = new KaigoryoyogataIryoshisetsu_AfterH18_7(new RString("10"));
