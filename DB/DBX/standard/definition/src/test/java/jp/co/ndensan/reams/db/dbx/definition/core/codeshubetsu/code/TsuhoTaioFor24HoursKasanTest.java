...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.TsuhoTaioFor24HoursKasan;
...
/**
 * 二十四時間通報対応加算を表すドメインのテストクラスです。
 *
 * @author LDNS 梁百川
 */
@RunWith(Enclosed.class)
public class TsuhoTaioFor24HoursKasanTest extends DbxTestBase {

    private static TsuhoTaioFor24HoursKasan sut;

    @BeforeClass
    public static void setUp() {
        sut = new TsuhoTaioFor24HoursKasan(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつTsuhoTaioFor24HoursKasanではないの場合_equalsは_falseを戻す() {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            TsuhoTaioFor24HoursKasan sut2 = new TsuhoTaioFor24HoursKasan(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new TsuhoTaioFor24HoursKasan(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            TsuhoTaioFor24HoursKasan sut = new TsuhoTaioFor24HoursKasan((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            TsuhoTaioFor24HoursKasan sut = new TsuhoTaioFor24HoursKasan(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを戻す() {
            TsuhoTaioFor24HoursKasan sut2 = new TsuhoTaioFor24HoursKasan(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_二十四時間通報対応加算を戻す() {
            TsuhoTaioFor24HoursKasan sut = new TsuhoTaioFor24HoursKasan(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("二十四時間通報対応加算")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_二十四時間通報対応加算を戻す() {
            TsuhoTaioFor24HoursKasan sut = new TsuhoTaioFor24HoursKasan(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("二十四時間通報対応加算")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_二十四時間通報対応加算を戻す() {
            TsuhoTaioFor24HoursKasan sut = new TsuhoTaioFor24HoursKasan(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("二十四時間通報対応加算")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_XXXを戻す() {
            TsuhoTaioFor24HoursKasan sut = new TsuhoTaioFor24HoursKasan(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("二十四時間通報対応加算")));
        }
    }
}
