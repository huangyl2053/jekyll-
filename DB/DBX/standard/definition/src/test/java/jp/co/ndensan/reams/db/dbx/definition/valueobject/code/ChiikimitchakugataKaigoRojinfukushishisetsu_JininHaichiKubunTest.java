...
/**
 * ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubunのテストクラスです。
 *
 * @author LDNS 顧偉剛
 */
@RunWith(Enclosed.class)
public class ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubunTest extends DbxTestBase {

    private static ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun sut;

    @BeforeClass
    public static void setUp() {
        sut = new ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubunではないの場合_equalsは_falseを返す() {
            assertFalse(sut.equals(new RString("1111")));
        }

        @Test
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun sut2 = new ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun sut = new ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun sut = new ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun sut2 = new ChiikimitchakugataKaigoRojinfukushishisetsu_JininHaichiKubun(new RString("10"));
