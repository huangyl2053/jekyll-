...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.TokubetsuChiikiKasanUmu;
...
/**
 * 特別地域加算の有無を表すドメインテストクラスです。
 *
 * @author LDNS 孫亜威
 */
@RunWith(Enclosed.class)
public class TokubetsuChiikiKasanUmuTest extends DbxTestBase {

    private static TokubetsuChiikiKasanUmu sut;

    @BeforeClass
    public static void setUp() {
        sut = new TokubetsuChiikiKasanUmu(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつTokubetsuChiikiKasanUmuではないの場合_equalsは_falseを戻す() {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            TokubetsuChiikiKasanUmu sut2 = new TokubetsuChiikiKasanUmu(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new TokubetsuChiikiKasanUmu(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            TokubetsuChiikiKasanUmu sut = new TokubetsuChiikiKasanUmu((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            TokubetsuChiikiKasanUmu sut = new TokubetsuChiikiKasanUmu(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを戻す() {
            TokubetsuChiikiKasanUmu sut2 = new TokubetsuChiikiKasanUmu(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_特別地域加算の有無を戻す() {
            TokubetsuChiikiKasanUmu sut = new TokubetsuChiikiKasanUmu(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("特別地域加算の有無")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_特別地域加算の有無を戻す() {
            TokubetsuChiikiKasanUmu sut = new TokubetsuChiikiKasanUmu(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("特別地域加算の有無")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_特別地域加算の有無を戻す() {
            TokubetsuChiikiKasanUmu sut = new TokubetsuChiikiKasanUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("特別地域加算の有無")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_特別地域加算の有無を戻す() {
            TokubetsuChiikiKasanUmu sut = new TokubetsuChiikiKasanUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("特別地域加算の有無")));
        }
    }
}
