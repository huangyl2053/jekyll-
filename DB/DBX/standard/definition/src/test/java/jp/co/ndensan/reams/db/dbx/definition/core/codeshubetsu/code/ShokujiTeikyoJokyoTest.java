...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.ShokujiTeikyoJokyo;
...
/**
 * 食事提供の状況を表すドメインクラスのテストクラスです。
 *
 * @author LDNS 王峰
 */
@RunWith(Enclosed.class)
public class ShokujiTeikyoJokyoTest extends DbxTestBase {

    private static ShokujiTeikyoJokyo sut;

    @BeforeClass
    public static void setUp() {
        sut = new ShokujiTeikyoJokyo(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            ShokujiTeikyoJokyo sut2 = new ShokujiTeikyoJokyo(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new ShokujiTeikyoJokyo(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            ShokujiTeikyoJokyo sut = new ShokujiTeikyoJokyo((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            ShokujiTeikyoJokyo sut = new ShokujiTeikyoJokyo(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを戻す() {
            ShokujiTeikyoJokyo sut2 = new ShokujiTeikyoJokyo(new RString("10"));
    ...
    public static class getColumnValueテスト extends DbxTestBase {
        ...
        public void LDNS_codeを10指定した場合_getColumnValueは_10を戻す() {
            assertThat(sut.getColumnValue(), is(new Code(new RString("10"))));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_食事提供の状況を戻す() {
            ShokujiTeikyoJokyo sut = new ShokujiTeikyoJokyo(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("食事提供の状況")));
        }
    }
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnull以外の場合_getMeishoは_食事提供の状況を戻す() {
            ShokujiTeikyoJokyo sut = new ShokujiTeikyoJokyo(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("食事提供の状況")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_食事提供の状況を戻す() {
            ShokujiTeikyoJokyo sut = new ShokujiTeikyoJokyo(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("食事提供の状況")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnull以外の場合_getRyakushoは_食事提供の状況を戻す() {
            ShokujiTeikyoJokyo sut = new ShokujiTeikyoJokyo(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("食事提供の状況")));
        }
    }
}
