...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.TankinyushoRyoyokaigoTsujogata;
...
/**
 * 短期入所療養介護_通常型を表すドメインクラスです。
 *
 * @author LDNS 袁国棟
 */
@RunWith(Enclosed.class)
public class TankinyushoRyoyokaigoTsujogataTest {

    private static TankinyushoRyoyokaigoTsujogata sut;

    @BeforeClass
    public static void setUp() {
        sut = new TankinyushoRyoyokaigoTsujogata(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectが1234567かつTankinyushoRyoyokaigo_Tsujogataではないの場合_equalsは_falseを返す() {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            TankinyushoRyoyokaigoTsujogata sut2 = new TankinyushoRyoyokaigoTsujogata(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new TankinyushoRyoyokaigoTsujogata(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            TankinyushoRyoyokaigoTsujogata sut = new TankinyushoRyoyokaigoTsujogata((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            TankinyushoRyoyokaigoTsujogata sut = new TankinyushoRyoyokaigoTsujogata(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            TankinyushoRyoyokaigoTsujogata sut2 = new TankinyushoRyoyokaigoTsujogata(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_指定したコードが1234567の場合_getMeishoは_短期入所療養介護_通常型を返す() {
            TankinyushoRyoyokaigoTsujogata sut = new TankinyushoRyoyokaigoTsujogata(new Code("1234567"));
            assertThat(sut.getMeisho(kijunbi), is(new RString("短期入所療養介護_通常型")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeが1234567の場合_getMeishoは_短期入所療養介護_通常型を返す() {
            TankinyushoRyoyokaigoTsujogata sut = new TankinyushoRyoyokaigoTsujogata(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("短期入所療養介護_通常型")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeが1234567の場合_getRyakushoは_短期入所療養介護_通常型を返す() {

            TankinyushoRyoyokaigoTsujogata sut = new TankinyushoRyoyokaigoTsujogata(new Code("1234567"));
            assertThat(sut.getRyakusho(kijunbi), is(new RString("短期入所療養介護_通常型")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        public void LDNS_codeが1234567の場合_getRyakushoは_短期入所療養介護_通常型を返す() {
            TankinyushoRyoyokaigoTsujogata sut = new TankinyushoRyoyokaigoTsujogata(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("短期入所療養介護_通常型")));
        }
    }
}
