...
/**
 * RehabilitationTeikyoTaiseiUmu_Sonotaのテストクラスです。
 *
 * @author LDNS 顧偉剛
 */
...
public class RehabilitationTeikyoTaiseiUmu_SonotaTest extends DbxTestBase {
    ...
    private static RehabilitationTeikyoTaiseiUmu_Sonota sut;

    @BeforeClass
    public static void setUp() {
        sut = new RehabilitationTeikyoTaiseiUmu_Sonota(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            RehabilitationTeikyoTaiseiUmu_Sonota sut2 = new RehabilitationTeikyoTaiseiUmu_Sonota(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new RehabilitationTeikyoTaiseiUmu_Sonota(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            RehabilitationTeikyoTaiseiUmu_Sonota sut = new RehabilitationTeikyoTaiseiUmu_Sonota((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            RehabilitationTeikyoTaiseiUmu_Sonota sut = new RehabilitationTeikyoTaiseiUmu_Sonota(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            RehabilitationTeikyoTaiseiUmu_Sonota sut2 = new RehabilitationTeikyoTaiseiUmu_Sonota(new RString("10"));
