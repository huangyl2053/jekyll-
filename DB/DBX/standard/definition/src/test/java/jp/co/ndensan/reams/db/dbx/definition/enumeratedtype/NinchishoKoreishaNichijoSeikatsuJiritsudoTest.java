...
/**
 * 認知症高齢者の日常生活自立度を表す列挙型のテストクラスです。
 *
 * @author LDNS 代聡
 */
@RunWith(Enclosed.class)
public class NinchishoKoreishaNichijoSeikatsuJiritsudoTest extends DbxTestBase {

    public static class valueOfTest extends DbxTestBase {

        @Test
        public void LDNS_引数が自立を指定した場合_valueOfは_自立を返す() {
            assertThat(NinchishoKoreishaNichijoSeikatsuJiritsudo.valueOf("自立"), is(NinchishoKoreishaNichijoSeikatsuJiritsudo.自立));
        }
    }
}
