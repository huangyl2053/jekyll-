...
/**
 * KaigoShikakuHenkoJiyuのテストクラスです。
 *
 * @author LDNS 顧偉剛
 */
@RunWith(Enclosed.class)
public class KaigoShikakuHenkoJiyuTest extends DbxTestBase {

    private static KaigoShikakuHenkoJiyu sut;

    @BeforeClass
    public static void setUp() {
        sut = new KaigoShikakuHenkoJiyu(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつKaigoShikakuHenkoJiyuではないの場合_equalsは_falseを返す() {
            assertFalse(sut.equals(new RString("1111")));
        }

        @Test
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            KaigoShikakuHenkoJiyu sut2 = new KaigoShikakuHenkoJiyu(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new KaigoShikakuHenkoJiyu(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            KaigoShikakuHenkoJiyu sut = new KaigoShikakuHenkoJiyu((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            KaigoShikakuHenkoJiyu sut = new KaigoShikakuHenkoJiyu(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            KaigoShikakuHenkoJiyu sut2 = new KaigoShikakuHenkoJiyu(new RString("10"));
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_介護資格変更事由を返す() {
            KaigoShikakuHenkoJiyu sut = new KaigoShikakuHenkoJiyu(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("介護資格変更事由")));
        }
    }
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_介護資格変更事由を返す() {
            KaigoShikakuHenkoJiyu sut = new KaigoShikakuHenkoJiyu(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("介護資格変更事由")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_介護資格変更事由を返す() {
            KaigoShikakuHenkoJiyu sut = new KaigoShikakuHenkoJiyu(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("介護資格変更事由")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_介護資格変更事由を返す() {
            KaigoShikakuHenkoJiyu sut = new KaigoShikakuHenkoJiyu(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("介護資格変更事由")));
        }
    }
}
