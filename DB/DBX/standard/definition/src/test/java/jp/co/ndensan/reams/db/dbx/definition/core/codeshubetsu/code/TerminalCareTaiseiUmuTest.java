...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.TerminalCareTaiseiUmu;
...
/**
 * ターミナルケア体制_看取り介護体制_の有無テストクラスです。
 *
 * @author LDNS 孫亜威
 */
@RunWith(Enclosed.class)
public class TerminalCareTaiseiUmuTest extends DbxTestBase {

    private static TerminalCareTaiseiUmu sut;

    @BeforeClass
    public static void setUp() {
        sut = new TerminalCareTaiseiUmu(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつTerminalCareTaiseiUmuではないの場合_equalsは_falseを戻す() {
            assertFalse(sut.equals(new RString("1111")));
        }

        @Test
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            TerminalCareTaiseiUmu sut2 = new TerminalCareTaiseiUmu(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new TerminalCareTaiseiUmu(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            TerminalCareTaiseiUmu sut = new TerminalCareTaiseiUmu((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            TerminalCareTaiseiUmu sut = new TerminalCareTaiseiUmu(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_10を戻す() {
            TerminalCareTaiseiUmu sut2 = new TerminalCareTaiseiUmu(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_ターミナルケア体制_看取り介護体制_の有無を戻す() {
            TerminalCareTaiseiUmu sut = new TerminalCareTaiseiUmu(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("ターミナルケア体制_看取り介護体制_の有無")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_ターミナルケア体制_看取り介護体制_の有無を戻す() {
            TerminalCareTaiseiUmu sut = new TerminalCareTaiseiUmu(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("ターミナルケア体制_看取り介護体制_の有無")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_ターミナルケア体制_看取り介護体制_の有無を戻す() {
            TerminalCareTaiseiUmu sut = new TerminalCareTaiseiUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("ターミナルケア体制_看取り介護体制_の有無")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_ターミナルケア体制_看取り介護体制_の有無を戻す() {
            TerminalCareTaiseiUmu sut = new TerminalCareTaiseiUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("ターミナルケア体制_看取り介護体制_の有無")));
        }
    }
}
