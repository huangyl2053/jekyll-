...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.NinchishotaiogataKyodoSeikatsukaigoTankiriyogataigai;
...
/**
 * 認知症対応型共同生活介護_短期利用型以外を表すドメインクラスのテストクラスです。
 *
 * @author LDNS 袁国棟
 */
@RunWith(Enclosed.class)
public class NinchishotaiogataKyodoSeikatsukaigoTankiriyogataigaiTest extends DbxTestBase {
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectが1234567かつNinchishotaiogataKyodoSeikatsukaigo_Tankiriyogataigaiではないの場合_equalsは_falseを返す() {
