...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.ShintaikosokuHaishiTorikumiUmu;
...
/**
 * 身体拘束廃止取組の有無を表すドメインテストクラスです。
 *
 * @author LDNS 孫亜威
 */
@RunWith(Enclosed.class)
public class ShintaikosokuHaishiTorikumiUmuTest extends DbxTestBase {

    private static ShintaikosokuHaishiTorikumiUmu sut;

    @BeforeClass
    public static void setUp() {
        sut = new ShintaikosokuHaishiTorikumiUmu(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつShintaikosokuHaishiTorikumiUmuではないの場合_equalsは_falseを戻す() {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            ShintaikosokuHaishiTorikumiUmu sut2 = new ShintaikosokuHaishiTorikumiUmu(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new ShintaikosokuHaishiTorikumiUmu(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            ShintaikosokuHaishiTorikumiUmu sut = new ShintaikosokuHaishiTorikumiUmu((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            ShintaikosokuHaishiTorikumiUmu sut = new ShintaikosokuHaishiTorikumiUmu(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_10を戻す() {
            ShintaikosokuHaishiTorikumiUmu sut2 = new ShintaikosokuHaishiTorikumiUmu(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_身体拘束廃止取組の有無を戻す() {
            ShintaikosokuHaishiTorikumiUmu sut = new ShintaikosokuHaishiTorikumiUmu(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("身体拘束廃止取組の有無")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_身体拘束廃止取組の有無を戻す() {
            ShintaikosokuHaishiTorikumiUmu sut = new ShintaikosokuHaishiTorikumiUmu(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("身体拘束廃止取組の有無")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_身体拘束廃止取組の有無を戻す() {
            ShintaikosokuHaishiTorikumiUmu sut = new ShintaikosokuHaishiTorikumiUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("身体拘束廃止取組の有無")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_身体拘束廃止取組の有無を戻す() {
            ShintaikosokuHaishiTorikumiUmu sut = new ShintaikosokuHaishiTorikumiUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("身体拘束廃止取組の有無")));
        }
    }
}
