...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.ShudanCommunicationRyohoUmu;
...
/**
 * ShudanCommunicationRyohoUmuのテストクラスです。
 *
 * @author LDNS 顧偉剛
 */
@RunWith(Enclosed.class)
public class ShudanCommunicationRyohoUmuTest extends DbxTestBase {

    private static ShudanCommunicationRyohoUmu sut;

    @BeforeClass
    public static void setUp() {
        sut = new ShudanCommunicationRyohoUmu(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつShudanCommunicationRyohoUmuではないの場合_equalsは_falseを返す() {
            assertFalse(sut.equals(new RString("1111")));
        }

        @Test
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            ShudanCommunicationRyohoUmu sut2 = new ShudanCommunicationRyohoUmu(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new ShudanCommunicationRyohoUmu(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            ShudanCommunicationRyohoUmu sut = new ShudanCommunicationRyohoUmu((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            ShudanCommunicationRyohoUmu sut = new ShudanCommunicationRyohoUmu(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            ShudanCommunicationRyohoUmu sut2 = new ShudanCommunicationRyohoUmu(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_集団コミュニケーション療法の有無を返す() {
            ShudanCommunicationRyohoUmu sut = new ShudanCommunicationRyohoUmu(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("集団コミュニケーション療法の有無")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_集団コミュニケーション療法の有無を返す() {
            ShudanCommunicationRyohoUmu sut = new ShudanCommunicationRyohoUmu(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("集団コミュニケーション療法の有無")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_集団コミュニケーション療法の有無を返す() {
            ShudanCommunicationRyohoUmu sut = new ShudanCommunicationRyohoUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("集団コミュニケーション療法の有無")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_集団コミュニケーション療法の有無を返す() {
            ShudanCommunicationRyohoUmu sut = new ShudanCommunicationRyohoUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("集団コミュニケーション療法の有無")));
        }
    }
}
