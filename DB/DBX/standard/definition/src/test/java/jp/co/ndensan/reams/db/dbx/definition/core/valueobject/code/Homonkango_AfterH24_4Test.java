...
/**
 * 訪問看護_平成24年4月以降を表すドメインクラスのテストクラスです。
 *
 * @author LDNS 劉シンギョウ
 */
@RunWith(Enclosed.class)
public class Homonkango_AfterH24_4Test extends DbxTestBase {

    private static HomonkangoAfterH244 sut;

    @BeforeClass
    public static void setUp() {
        sut = new HomonkangoAfterH244(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつHomonkango_AfterH24_4ではないの場合_equalsは_falseを返す() {
            assertFalse(sut.equals(new RString("1111")));
        }

        @Test
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            HomonkangoAfterH244 sut2 = new HomonkangoAfterH244(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new HomonkangoAfterH244(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            HomonkangoAfterH244 sut = new HomonkangoAfterH244((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            HomonkangoAfterH244 sut = new HomonkangoAfterH244(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            HomonkangoAfterH244 sut2 = new HomonkangoAfterH244(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_訪問看護_平成24年4月以降を返す() {
            HomonkangoAfterH244 sut = new HomonkangoAfterH244(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("訪問看護_平成24年4月以降")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_訪問看護_平成24年4月以降を返す() {
            HomonkangoAfterH244 sut = new HomonkangoAfterH244(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("訪問看護_平成24年4月以降")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_訪問看護_平成24年4月以降を返す() {
            HomonkangoAfterH244 sut = new HomonkangoAfterH244(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("訪問看護_平成24年4月以降")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_訪問看護_平成24年4月以降を返す() {
            HomonkangoAfterH244 sut = new HomonkangoAfterH244(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("訪問看護_平成24年4月以降")));
        }
    }
}
