...
/**
 * YakanKinmuJokenKijunAfterH154のテストクラスです。
 * 
 * @author LDNS 黄陽
 */
@RunWith(Enclosed.class)
public class YakanKinmuJokenKijun_AfterH15_4Test extends DbxTestBase {

    private static YakanKinmuJokenKijunAfterH154 sut;

    @BeforeClass
    public static void setUp() {
        sut = new YakanKinmuJokenKijunAfterH154(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつYakanKinmuJokenKijun_AfterH15_4ではないの場合_equalsは_falseを返す() {
            assertFalse(sut.equals(new RString("1111")));
        }

        @Test
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            YakanKinmuJokenKijunAfterH154 sut2 = new YakanKinmuJokenKijunAfterH154(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new YakanKinmuJokenKijunAfterH154(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            YakanKinmuJokenKijunAfterH154 sut = new YakanKinmuJokenKijunAfterH154((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }
        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            YakanKinmuJokenKijunAfterH154 sut = new YakanKinmuJokenKijunAfterH154(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            YakanKinmuJokenKijunAfterH154 sut2=new YakanKinmuJokenKijunAfterH154(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_夜間勤務条件基準_平成15年4月以降を返す() {
            YakanKinmuJokenKijunAfterH154 sut = new YakanKinmuJokenKijunAfterH154(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("夜間勤務条件基準_平成15年4月以降")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeが1234567の場合_getMeishoは_夜間勤務条件基準_平成15年4月以降を返す() {
            YakanKinmuJokenKijunAfterH154 sut = new YakanKinmuJokenKijunAfterH154(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("夜間勤務条件基準_平成15年4月以降")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_夜間勤務条件基準_平成15年4月以降を返す() {
            YakanKinmuJokenKijunAfterH154 sut = new YakanKinmuJokenKijunAfterH154(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("夜間勤務条件基準_平成15年4月以降")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeが1234567の場合_getRyakushoは_夜間勤務条件基準_平成15年4月以降を返す() {
            YakanKinmuJokenKijunAfterH154 sut = new YakanKinmuJokenKijunAfterH154(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("夜間勤務条件基準_平成15年4月以降")));
        }
    }
}