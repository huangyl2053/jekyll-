...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.Homonkaigo;
...
/**
 * 訪問介護を表すドメインクラスのテストクラスです。
 *
 * @author LDNS 劉シンギョウ
 */
@RunWith(Enclosed.class)
public class HomonkaigoTest extends DbxTestBase {

    private static Homonkaigo sut;

    @BeforeClass
    public static void setUp() {
        sut = new Homonkaigo(new RString("10"));
    }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            Homonkaigo sut = new Homonkaigo((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            Homonkaigo sut = new Homonkaigo(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            Homonkaigo sut2 = new Homonkaigo(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_訪問介護を返す() {
            Homonkaigo sut = new Homonkaigo(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("訪問介護")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_訪問介護を返す() {
            Homonkaigo sut = new Homonkaigo(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("訪問介護")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_訪問介護を返す() {
            Homonkaigo sut = new Homonkaigo(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("訪問介護")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_訪問介護を返す() {
            Homonkaigo sut = new Homonkaigo(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("訪問介護")));
        }
    }
}
