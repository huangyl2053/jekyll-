...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.SeishinkaIshiTeikitekiRyoyoshidoUmu;
...
/**
 * SeishinkaIshiTeikitekiRyoyoshidoUmuのテストクラスです。
 * 
 * @author LDNS 徐宇聖
 */
@RunWith(Enclosed.class)
public class SeishinkaIshiTeikitekiRyoyoshidoUmuTest extends DbxTestBase {

    private static SeishinkaIshiTeikitekiRyoyoshidoUmu sut;

    @BeforeClass
    public static void setUp() {
        sut = new SeishinkaIshiTeikitekiRyoyoshidoUmu(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつSeishinkaIshiTeikitekiRyoyoshidoUmuではないの場合_equalsは_falseを戻す() {
            assertFalse(sut.equals(new RString("1111")));
        }

        @Test
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            SeishinkaIshiTeikitekiRyoyoshidoUmu sut2 = new SeishinkaIshiTeikitekiRyoyoshidoUmu(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new SeishinkaIshiTeikitekiRyoyoshidoUmu(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            SeishinkaIshiTeikitekiRyoyoshidoUmu sut = new SeishinkaIshiTeikitekiRyoyoshidoUmu((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }
        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            SeishinkaIshiTeikitekiRyoyoshidoUmu sut = new SeishinkaIshiTeikitekiRyoyoshidoUmu(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを戻す() {
            SeishinkaIshiTeikitekiRyoyoshidoUmu sut2=new SeishinkaIshiTeikitekiRyoyoshidoUmu(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_精神科医師定期的療養指導の有無を戻す() {
            SeishinkaIshiTeikitekiRyoyoshidoUmu sut = new SeishinkaIshiTeikitekiRyoyoshidoUmu(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("精神科医師定期的療養指導の有無")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_精神科医師定期的療養指導の有無を戻す() {
            SeishinkaIshiTeikitekiRyoyoshidoUmu sut = new SeishinkaIshiTeikitekiRyoyoshidoUmu(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("精神科医師定期的療養指導の有無")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_精神科医師定期的療養指導の有無を戻す() {
            SeishinkaIshiTeikitekiRyoyoshidoUmu sut = new SeishinkaIshiTeikitekiRyoyoshidoUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("精神科医師定期的療養指導の有無")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_精神科医師定期的療養指導の有無を戻す() {
            SeishinkaIshiTeikitekiRyoyoshidoUmu sut = new SeishinkaIshiTeikitekiRyoyoshidoUmu(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("精神科医師定期的療養指導の有無")));
        }
    }
}