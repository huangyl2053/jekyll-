...
/**
 * RyoyokankyoKijunAfterH194のテストクラスです。
 *
 * @author LDNS 顧偉剛
 */
@RunWith(Enclosed.class)
public class RyoyokankyoKijun_AfterH19_4Test extends DbxTestBase {

    private static RyoyokankyoKijunAfterH194 sut;

    @BeforeClass
    public static void setUp() {
        sut = new RyoyokankyoKijunAfterH194(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつRyoyokankyoKijun_AfterH19_4ではないの場合_equalsは_falseを返す() {
            assertFalse(sut.equals(new RString("1111")));
        }

        @Test
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを返す() {
            RyoyokankyoKijunAfterH194 sut2 = new RyoyokankyoKijunAfterH194(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを返す() {
            assertTrue(sut.equals(new RyoyokankyoKijunAfterH194(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを返す() {
            RyoyokankyoKijunAfterH194 sut = new RyoyokankyoKijunAfterH194((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を返す() {
            RyoyokankyoKijunAfterH194 sut = new RyoyokankyoKijunAfterH194(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを返す() {
            RyoyokankyoKijunAfterH194 sut2 = new RyoyokankyoKijunAfterH194(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getMeishoは_療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降を返す() {
            RyoyokankyoKijunAfterH194 sut = new RyoyokankyoKijunAfterH194(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降を返す() {
            RyoyokankyoKijunAfterH194 sut = new RyoyokankyoKijunAfterH194(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_入力のパラメタがnull以外の場合_getRyakushoは_療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降を返す() {
            RyoyokankyoKijunAfterH194 sut = new RyoyokankyoKijunAfterH194(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降を返す() {
            RyoyokankyoKijunAfterH194 sut = new RyoyokankyoKijunAfterH194(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("療養環境基準_病院療養型ユニット型_病院療養型_病院経過型_平成19年4月以降")));
        }
    }
}
