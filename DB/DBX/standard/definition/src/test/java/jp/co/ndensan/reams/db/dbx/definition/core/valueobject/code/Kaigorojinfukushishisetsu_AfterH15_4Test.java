...
/**
 * 介護老人福祉施設_平成15年4月以降を表すドメインのテストクラスです。
 *
 * @author LDNS 李増鋒
 */
@RunWith(Enclosed.class)
public class Kaigorojinfukushishisetsu_AfterH15_4Test extends DbxTestBase {

    private static KaigorojinfukushishisetsuAfterH154 sut;

    @BeforeClass
    public static void setUp() {
        sut = new KaigorojinfukushishisetsuAfterH154(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつKaigorojinfukushishisetsu_AfterH15_4ではないの場合_equalsは_falseを戻す() {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            KaigorojinfukushishisetsuAfterH154 sut2 = new KaigorojinfukushishisetsuAfterH154(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new KaigorojinfukushishisetsuAfterH154(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            KaigorojinfukushishisetsuAfterH154 sut = new KaigorojinfukushishisetsuAfterH154((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            KaigorojinfukushishisetsuAfterH154 sut = new KaigorojinfukushishisetsuAfterH154(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを戻す() {
            KaigorojinfukushishisetsuAfterH154 sut2 = new KaigorojinfukushishisetsuAfterH154(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_介護老人福祉施設_平成15年4月以降を戻す() {
            KaigorojinfukushishisetsuAfterH154 sut = new KaigorojinfukushishisetsuAfterH154(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("介護老人福祉施設_平成15年4月以降")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnull以外の場合_getMeishoは_介護老人福祉施設_平成15年4月以降を戻す() {
            KaigorojinfukushishisetsuAfterH154 sut = new KaigorojinfukushishisetsuAfterH154(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("介護老人福祉施設_平成15年4月以降")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_介護老人福祉施設_平成15年4月以降を戻す() {
            KaigorojinfukushishisetsuAfterH154 sut = new KaigorojinfukushishisetsuAfterH154(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("介護老人福祉施設_平成15年4月以降")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnull以外の場合_getRyakushoは_介護老人福祉施設_平成15年4月以降を戻す() {
            KaigorojinfukushishisetsuAfterH154 sut = new KaigorojinfukushishisetsuAfterH154(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("介護老人福祉施設_平成15年4月以降")));
        }
    }
}
