...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.TokuteijigyoshokasanKyotakukaigoshienUmuBeforeH213;
...
/**
 * 特定事業所加算_居宅介護支援_の有無_平成21年3月以前を表すドメインクラスのテストクラスです。
 *
 * @author LDNS 王峰
 */
@RunWith(Enclosed.class)
public class TokuteijigyoshokasanKyotakukaigoshienUmuBeforeH213Test extends DbxTestBase {
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつTokuteijigyoshokasan_Kyotakukaigoshien_Umu_BeforeH21_3ではないの場合_equalsは_falseを戻す() {
