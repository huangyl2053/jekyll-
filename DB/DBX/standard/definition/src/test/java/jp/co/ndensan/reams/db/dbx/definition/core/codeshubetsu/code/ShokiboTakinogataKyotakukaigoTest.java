...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.ShokiboTakinogataKyotakukaigo;
...
/**
 * 小規模多機能型居宅介護を表すドメインクラスのテストクラスです。
 *
 * @author LDNS 王峰
 */
@RunWith(Enclosed.class)
public class ShokiboTakinogataKyotakukaigoTest extends DbxTestBase {

    private static ShokiboTakinogataKyotakukaigo sut;

    @BeforeClass
    public static void setUp() {
        sut = new ShokiboTakinogataKyotakukaigo(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            ShokiboTakinogataKyotakukaigo sut2 = new ShokiboTakinogataKyotakukaigo(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new ShokiboTakinogataKyotakukaigo(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            ShokiboTakinogataKyotakukaigo sut = new ShokiboTakinogataKyotakukaigo((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            ShokiboTakinogataKyotakukaigo sut = new ShokiboTakinogataKyotakukaigo(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを戻す() {
            ShokiboTakinogataKyotakukaigo sut2 = new ShokiboTakinogataKyotakukaigo(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_小規模多機能型居宅介護を戻す() {
            ShokiboTakinogataKyotakukaigo sut = new ShokiboTakinogataKyotakukaigo(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("小規模多機能型居宅介護")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnull以外の場合_getMeishoは_小規模多機能型居宅介護を戻す() {
            ShokiboTakinogataKyotakukaigo sut = new ShokiboTakinogataKyotakukaigo(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("小規模多機能型居宅介護")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_小規模多機能型居宅介護を戻す() {
            ShokiboTakinogataKyotakukaigo sut = new ShokiboTakinogataKyotakukaigo(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("小規模多機能型居宅介護")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnull以外の場合_getRyakushoは_小規模多機能型居宅介護を戻す() {
            ShokiboTakinogataKyotakukaigo sut = new ShokiboTakinogataKyotakukaigo(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("小規模多機能型居宅介護")));
        }
    }
}
