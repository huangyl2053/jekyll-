...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.TsushokaigoAfterH214;
...
/**
 * 通所介護_平成21年4月以降を表すドメインのテストクラスです。
 *
 * @author LDNS 梁百川
 */
@RunWith(Enclosed.class)
public class TsushokaigoAfterH214Test extends DbxTestBase {
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつTsushokaigo_AfterH21_4ではないの場合_equalsは_falseを戻す() {
