...
import jp.co.ndensan.reams.db.dbx.definition.core.codeshubetsu.code.TokubetsuKanriTaisei;
...
/**
 * 特別管理体制を表すドメインクラスのテストクラスです。
 *
 * @author LDNS 王峰
 */
@RunWith(Enclosed.class)
public class TokubetsuKanriTaiseiTest extends DbxTestBase {

    private static TokubetsuKanriTaisei sut;

    @BeforeClass
    public static void setUp() {
        sut = new TokubetsuKanriTaisei(new RString("10"));
    }
    ...
    public static class equalsテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_Objectがnull以外かつTokubetsuKanriTaiseiではないの場合_equalsは_falseを戻す() {
        ...
        public void LDNS_Objectのcodeとコンストラクタのcodeが不一致の場合_equalsは_falseを戻す() {
            TokubetsuKanriTaisei sut2 = new TokubetsuKanriTaisei(new RString("90"));
            assertFalse(sut.equals(sut2));
        }

        @Test
        public void LDNS_Object値とコンストラクタ値が一致の場合_equalsは_trueを戻す() {
            assertTrue(sut.equals(new TokubetsuKanriTaisei(new RString("10"))));
        }
    ...
    public static class toStringテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnullの場合_toStringは_emptyを戻す() {
            TokubetsuKanriTaisei sut = new TokubetsuKanriTaisei((Code) null);
            assertThat(sut.toString(), is(RString.EMPTY.toString()));
        }

        @Test
        public void LDNS_codeが1234567の場合_toStringは_1234567を戻す() {
            TokubetsuKanriTaisei sut = new TokubetsuKanriTaisei(new Code("1234567"));
    ...
    public static class hashCodeテスト extends DbxTestBase {
        ...
        public void LDNS_設定した対象とコンストラクタ同じの場合_hashCodeは_同じhashCodeを戻す() {
            TokubetsuKanriTaisei sut2 = new TokubetsuKanriTaisei(new RString("10"));
    ...
    public static class getMeishoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getMeishoは_特別管理体制を戻す() {
            TokubetsuKanriTaisei sut = new TokubetsuKanriTaisei(new Code("1234567"));
            assertThat(sut.getMeisho(new FlexibleDate("20150303")), is(new RString("特別管理体制")));
        }
    }
    ...
    public static class getMeishoテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnull以外の場合_getMeishoは_特別管理体制を戻す() {
            TokubetsuKanriTaisei sut = new TokubetsuKanriTaisei(new Code("1234567"));
            assertThat(sut.getMeisho(), is(new RString("特別管理体制")));
        }
    }
    ...
    public static class getRyakushoパラメタあるテスト extends DbxTestBase {
        ...
        @Test
        public void LDNS_codeがnull以外の場合_getRyakushoは_特別管理体制を戻す() {
            TokubetsuKanriTaisei sut = new TokubetsuKanriTaisei(new Code("1234567"));
            assertThat(sut.getRyakusho(new FlexibleDate("20150303")), is(new RString("特別管理体制")));
        }
    }
    ...
    public static class getRyakushoテスト extends DbxTestBase {
        ...
        public void LDNS_codeがnull以外の場合_getRyakushoは_特別管理体制を戻す() {
            TokubetsuKanriTaisei sut = new TokubetsuKanriTaisei(new Code("1234567"));
            assertThat(sut.getRyakusho(), is(new RString("特別管理体制")));
        }
    }
}
