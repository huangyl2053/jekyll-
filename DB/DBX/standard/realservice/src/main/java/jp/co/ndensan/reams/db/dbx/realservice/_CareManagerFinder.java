...
class _CareManagerFinder implements ICareManagerFinder {
    ...
    public _CareManagerFinder() {
        dac = InstanceProvider.createWithCustomize(DbT7064CareManegerDac.class);
    }

    _CareManagerFinder(DbT7064CareManegerDac dac) {
        this.dac = dac;
    }
    ...
    public ICareManager getCareManager(RString 介護支援専門員番号) throws NullPointerException {
        ...
        DbT7064CareManegerEntity entity = dac.selectByKey(介護支援専門員番号);
        if (entity == null) {
            return null;
        }
