...
// TODO 検索条件に合わせてのテストケースを追記して下さい。
    @Ignore
    public static class select構成市町村マスタByKeyTest extends DbxTestDacBase {
...
// TODO 検索条件に合わせてのテストケースを追記して下さい。
    @Ignore
    public static class select構成市町村マスタ一覧By主キーTest extends DbxTestDacBase {
        ...
        public void データが見つかない検索条件を渡すと__空のリストを返す() {
            KoseiShichosonMasterMapperParameter 構成市町村マスタ検索条件 = KoseiShichosonMasterMapperParameter.createSelectByKeyParam(new RString("91"));
