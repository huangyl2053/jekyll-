...
import static jp.co.ndensan.reams.db.dbx.entity.db.basic.DbT7022ShoriDateKanri.isDeleted;
import static jp.co.ndensan.reams.db.dbx.entity.db.basic.DbT7022ShoriDateKanri.kijunTimestamp;
import static jp.co.ndensan.reams.db.dbx.entity.db.basic.DbT7022ShoriDateKanri.kijunYMD;
...
import static jp.co.ndensan.reams.db.dbx.entity.db.basic.DbT7022ShoriDateKanri.shoriEdaban;
...
import static jp.co.ndensan.reams.db.dbx.entity.db.basic.DbT7022ShoriDateKanri.taishoKaishiTimestamp;
import static jp.co.ndensan.reams.db.dbx.entity.db.basic.DbT7022ShoriDateKanri.taishoKaishiYMD;
import static jp.co.ndensan.reams.db.dbx.entity.db.basic.DbT7022ShoriDateKanri.taishoShuryoTimestamp;
import static jp.co.ndensan.reams.db.dbx.entity.db.basic.DbT7022ShoriDateKanri.taishoShuryoYMD;
...
public class DbT7022ShoriDateKanriDac implements ISaveable<DbT7022ShoriDateKanriEntity> {
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select処理日付管理BYサブ業務コードAND処理名(
            SubGyomuCode サブ業務コード,
    ...
    public List<DbT7022ShoriDateKanriEntity> selectChushutsukikan() {
        ...
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(eq(subGyomuCode, SubGyomuCode.DBU介護統計報告),
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select最大年度内連番(FlexibleYear 調定年度, RString 処理名) {
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select処理状況_異動通知書作成(FlexibleYear 調定年度, RString 処理名) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select抽出開始日時(FlexibleYear 調定年度, RString 処理名) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
     ...
     */
    @Transaction
    public List<DbT7022ShoriDateKanriEntity> get特徴対象者同定(FlexibleYear 調定年度, RString 処理名) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
     ...
     */
    @Transaction
    public List<DbT7022ShoriDateKanriEntity> get依頼金額計算(FlexibleYear 調定年度, RString 処理名) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select前回抽出期間情報の取得(LasdecCode 市町村コード, RString 処理名) throws NullPointerException {
        requireNonNull(市町村コード, UrSystemErrorMessages.値がnull.getReplacedMessage(市町村コードメッセージ.toString()));
     ...
     */
    @Transaction
    public List<DbT7022ShoriDateKanriEntity> select非課税年金対象者情報for広域BY主キー(SubGyomuCode サブ業務コード, RString 処理名, RString 処理枝番,
            FlexibleYear 年度) throws NullPointerException {
        requireNonNull(サブ業務コード, UrSystemErrorMessages.値がnull.getReplacedMessage(サブ業務コードメッセージ.toString()));
        requireNonNull(処理名, UrSystemErrorMessages.値がnull.getReplacedMessage(処理名メッセージ.toString()));
        requireNonNull(処理枝番, UrSystemErrorMessages.値がnull.getReplacedMessage(処理枝番メッセージ.toString()));
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select今回処理内容情報(SubGyomuCode サブ業務コード, FlexibleYear 年度, RString 処理名) throws NullPointerException {
        requireNonNull(サブ業務コード, UrSystemErrorMessages.値がnull.getReplacedMessage(サブ業務コードメッセージ.toString()));
        requireNonNull(年度, UrSystemErrorMessages.値がnull.getReplacedMessage(年度メッセージ.toString()));
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity selectkaisyuYMD(RString 処理名) throws NullPointerException {
     ...
     */
    @Transaction
    public List<DbT7022ShoriDateKanriEntity>
            select処理日付管理マスタ_当初所得引出以外(FlexibleYear 調定年度, RString 処理名, RString 処理名2, RString 処理名3) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
                                eq(subGyomuCode, SubGyomuCode.DBB介護賦課),
                                eq(nendo, 調定年度),
                                or(and(eq(shoriName, 処理名), eq(nendoNaiRenban, 年度内連番_2)),
                                        and(eq(shoriName, 処理名2), eq(nendoNaiRenban, 年度内連番_3)),
                                        and(eq(shoriName, 処理名3), eq(nendoNaiRenban, 年度内連番_1))))).
                toList(DbT7022ShoriDateKanriEntity.class);
    }
     ...
     */
    @Transaction
    public List<DbT7022ShoriDateKanriEntity> select処理状況_異動賦課(FlexibleYear 調定年度, RString 処理名, RString 処理名2) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select処理日付管理マスタ_当初所得引出(FlexibleYear 調定年度, RString 処理名) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
     ...
     */
    @Transaction
    public List<DbT7022ShoriDateKanriEntity> select処理状況_賦課(FlexibleYear 調定年度, RString 処理名, RString 処理名2) {
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity
            select処理日付管理マスタ_所得情報抽出連携異動(FlexibleYear 年度, LasdecCode 市町村コード, RString 市町村識別ID, RString 処理名) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select最大年度内連番BY調定年度(FlexibleYear 調定年度, RString 処理枝番, RString 処理名) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.selectSpecific(max(nendoNaiRenban)).
                table(DbT7022ShoriDateKanri.class).
                where(and(
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select処理日付管理マスタ_八月特徴開始情報抽出(FlexibleYear 調定年度, RString 処理名) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select前回処理日(LasdecCode 市町村コード, RString 処理名) throws NullPointerException {
        requireNonNull(市町村コード, UrSystemErrorMessages.値がnull.getReplacedMessage(市町村コードメッセージ.toString()));
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().table(DbT7022ShoriDateKanri.class).
                where(and(
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select直近の年次負担割合判定(RString 処理名) throws NullPointerException {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select当初発行チェック(FlexibleYear 年度, RString 処理枝番, RString 処理名) throws NullPointerException {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
    ...
    public List<DbT7022ShoriDateKanriEntity> selec対象終了日時(RString 導入形態コード,
            ...
            LasdecCode 市町村コード,
            FlexibleYear 処理年度, RString 処理名, RString 処理名2) throws NullPointerException {
     ...
     * @return DbT7022ShoriDateKanriEntity
     */
    public DbT7022ShoriDateKanriEntity get年次の最新実施年度(RString 処理名) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
     ...
     * @return DbT7022ShoriDateKanriEntity
     */
    public DbT7022ShoriDateKanriEntity get年次またはの実施日時(FlexibleYear 年度, RString 処理名) {
        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.select().
                table(DbT7022ShoriDateKanri.class).
                where(and(
                                ...
                                eq(shoriName, 処理名),
                                eq(nendo, 年度))).
                order(by(nendoNaiRenban, Order.DESC)).limit(1).
                toObject(DbT7022ShoriDateKanriEntity.class);
    }
     ...
     * @param 処理名 RString
     * @param 年度 nendo
     * @return DbT7022ShoriDateKanriEntityのリスト
     * @throws NullPointerException 引数のいずれかがnullの場合
     */
    @Transaction
    public List<DbT7022ShoriDateKanriEntity> select処理日付管理情報(RString 処理名, FlexibleYear 年度)
     ...
     */
    @Transaction
    public List<DbT7022ShoriDateKanriEntity> select特徴対象者同定_6月開始分(RString 処理名, FlexibleYear 年度)
            throws NullPointerException {
        requireNonNull(処理名, UrSystemErrorMessages.値がnull.getReplacedMessage(処理名メッセージ.toString()));
        requireNonNull(年度, UrSystemErrorMessages.値がnull.getReplacedMessage(年度メッセージ.toString()));
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select最大年度内連番_異動賦課(FlexibleYear 調定年度, RString 処理名) {
     ...
     */
    @Transaction
    public DbT7022ShoriDateKanriEntity select最大年度内連番_処理名(FlexibleYear 調定年度, RString 処理名) {

        DbAccessorNormalType accessor = new DbAccessorNormalType(session);
        return accessor.selectSpecific(max(nendoNaiRenban)).
                table(DbT7022ShoriDateKanri.class).
                where(and(eq(subGyomuCode, SubGyomuCode.DBB介護賦課),
                                eq(shoriName, 処理名),
                                eq(nendo, 調定年度))).
                toObject(DbT7022ShoriDateKanriEntity.class);
    }
    ...
    public DbT7022ShoriDateKanriEntity get最大基準日時(FlexibleYear 賦課年度) throws NullPointerException {
        ...
        return accessor.selectSpecific(max(kijunTimestamp)).
                table(DbT7022ShoriDateKanri.class).
                where(and(eq(shoriName, 処理名_本算定賦課),
                                eq(nendo, 賦課年度)
                        )).
                toObject(DbT7022ShoriDateKanriEntity.class);
    }
