...
import static jp.co.ndensan.reams.db.dbx.entity.db.basic.DbT7060KaigoJigyosha.yukoShuryoYMD;
...
public class DbT7060KaigoJigyoshaDac implements ISaveable<DbT7060KaigoJigyoshaEntity> {
    ...
    /**
     * 指定した事業者番号と基準日から、有効な事業者情報を取得します。
     *
     * @param 事業者番号 JigyoshaNo
     ...
     */
    @Transaction
    public DbT7060KaigoJigyoshaEntity select有効事業者(
            JigyoshaNo 事業者番号,
